...
# For docs/conf.py
project = "zathura-language-server"
author = """Wu Zhenyu <wuzhenyu@ustc.edu> """
copyright = "2023"

# For help2man
DESCRIPTION = "language server for zathurarc"
EPILOG = "Report bugs to https://github.com/Freed-Wu/zathura-language-server/issues"
# format __version__ by yourself
VERSION = """zathura-language-server {__version__}
Copyright (C) 2023
