...
class TestSuite(object):
    def __init__(self, name="", label="", details="", testcase_list=None, sub_suites=None, statistics=None):
        """
        TestSuite
        :param name: test suite name  > topic title
        :param label: test product label
    ...
    def to_dict(self):
        data = {"name": self.name, "label": self.label, "details": self.details, "testcase_list": [], "sub_suites": []}
