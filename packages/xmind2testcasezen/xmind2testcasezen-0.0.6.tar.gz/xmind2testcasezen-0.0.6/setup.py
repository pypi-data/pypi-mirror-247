...
with io.open(os.path.join(here, "xmind2testcasezen", "__about__.py"), encoding="utf-8") as f:  # custom
    exec(f.read(), about)
...
class PyPiCommand(Command):
    ...
    def run(self):
        ...
        try:
            ...
            rmtree(os.path.join(here, "xmind2testcasezen.egg-info"))  # custom
        except OSError:
            pass
...
setup(
    ...
    entry_points={  # custom
        "console_scripts": [
            "xmind2testcasezen=xmind2testcasezen.cli:cli_main",
        ]
    },
    cmdclass={
