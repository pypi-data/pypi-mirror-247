...
def update(report_filename, file):
    ...
    <div id="images">
        <img src="https://cdn.brandfolder.io/UEOJKODA/at/ntbjr5wtnmb66b7pkj8rw23/logo-perfecto.auto?height=57&amp;width=200" alt="Perfecto" id="perfecto" class="center">
        <img style="margin-left: 20px;" src="https://www.medanswering.com/images/MAS_web.png" alt="mas" id="mas" class="center">
        <a href='./""" + report_filename + """' download rel="noopener noreferrer" target="_blank" ><img style="margin-left: 20px;" width="40" height="35" src="https://img.icons8.com/fluency/48/graph-report.png" id="reporticon" alt="analytics-report" /></a>
    </div> """
...
def generate_advanced_analytics(df, report_filename, configpath, filename):
    ...
    my_report.show_html(filepath=output_file,
                        ...
                        layout='widescreen',
                        scale=None)
    update(report_filename, output_file)
