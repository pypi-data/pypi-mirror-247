...
from lamini.api.utils.upload_client import upload_to_blob, upload_to_local, get_dataset_name
import json
import os
...
class Lamini:
    ...
    def upload_data(self, data_pairs, blob_dir_name="default"):
        ...
        upload_base_path, dataset_location = output["upload_base_path"], output["dataset_location"]
    ...
    def upload_file(self, file_path, blob_dir_name="default"):
        if os.path.getsize(file_path) > 1e+7:
            raise Exception("File size is too large, please upload a file less than 10MB.")
        try:
