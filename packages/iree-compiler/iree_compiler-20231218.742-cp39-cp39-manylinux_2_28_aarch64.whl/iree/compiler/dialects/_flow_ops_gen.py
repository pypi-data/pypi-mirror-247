...
class CallOp(_ods_ir.OpView):
  ...
  def __init__(self, results_, callee, arguments, argument_dims, result_dims, *, tied_operands=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def call(results_, callee, arguments, argument_dims, result_dims, *, tied_operands=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(CallOp(results_=results_, callee=callee, arguments=arguments, argument_dims=argument_dims, result_dims=result_dims, tied_operands=tied_operands, loc=loc, ip=ip))
...
def channel_default(*, group=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(ChannelDefaultOp(group=group, loc=loc, ip=ip))
...
def collective_all_gather(element_type, target, target_dims, source, channel, *, tied_operands=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(CollectiveAllGatherOp(element_type=element_type, target=target, target_dims=target_dims, source=source, channel=channel, tied_operands=tied_operands, loc=loc, ip=ip))
...
def collective_all_reduce(reduction_op, element_type, target, target_dims, source, channel, *, tied_operands=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(CollectiveAllReduceOp(reduction_op=reduction_op, element_type=element_type, target=target, target_dims=target_dims, source=source, channel=channel, tied_operands=tied_operands, loc=loc, ip=ip))
...
def collective_all_to_all(element_type, target, target_dims, source, channel, *, tied_operands=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(CollectiveAllToAllOp(element_type=element_type, target=target, target_dims=target_dims, source=source, channel=channel, tied_operands=tied_operands, loc=loc, ip=ip))
...
def collective_reduce_scatter(reduction_op, element_type, target, target_dims, source, channel, *, tied_operands=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(CollectiveReduceScatterOp(reduction_op=reduction_op, element_type=element_type, target=target, target_dims=target_dims, source=source, channel=channel, tied_operands=tied_operands, loc=loc, ip=ip))
...
def collective_send_recv(element_type, target, target_dims, source, channel, send, recv, *, tied_operands=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(CollectiveSendRecvOp(element_type=element_type, target=target, target_dims=target_dims, source=source, channel=channel, send=send, recv=recv, tied_operands=tied_operands, loc=loc, ip=ip))
...
def dispatch(results_, workload, entry_points, arguments, argument_dims, result_dims, *, tied_operands=None, loc=None, ip=None) -> _SubClassValueT:
...
def dispatch_region(result, result_dims, workload, *, loc=None, ip=None) -> _SubClassValueT:
...
def dispatch_tensor_load(result, source, source_dims, offsets, sizes, strides, static_offsets, static_sizes, static_strides, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(DispatchTensorLoadOp(result=result, source=source, source_dims=source_dims, offsets=offsets, sizes=sizes, strides=strides, static_offsets=static_offsets, static_sizes=static_sizes, static_strides=static_strides, loc=loc, ip=ip))
...
def dispatch_tensor_store(value, target, target_dims, offsets, sizes, strides, static_offsets, static_sizes, static_strides, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(DispatchTensorStoreOp(value=value, target=target, target_dims=target_dims, offsets=offsets, sizes=sizes, strides=strides, static_offsets=static_offsets, static_sizes=static_sizes, static_strides=static_strides, loc=loc, ip=ip))
...
def dispatch_tie_shape(operand, dynamic_dims, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(DispatchTieShapeOp(operand=operand, dynamic_dims=dynamic_dims, loc=loc, ip=ip))
...
def dispatch_workgroup_count_from_dag_root(operands_, *, loc=None, ip=None) -> _Sequence[_SubClassValueT]:
  return _get_op_result_or_op_results(DispatchWorkgroupCountFromDagRootOp(operands_=operands_, loc=loc, ip=ip))
...
def dispatch_workgroup_count_from_slice(operands_, *, loc=None, ip=None) -> _Sequence[_SubClassValueT]:
  return _get_op_result_or_op_results(DispatchWorkgroupCountFromSliceOp(operands_=operands_, loc=loc, ip=ip))
...
def dispatch_workgroups(results_, workload, arguments, argument_dims, result_dims, *, tied_operands=None, loc=None, ip=None) -> _SubClassValueT:
...
def dispatch_workload_ordinal(operand, ordinal, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(DispatchWorkloadOrdinalOp(operand=operand, ordinal=ordinal, loc=loc, ip=ip))
...
class FuncOp(_ods_ir.OpView):
  ...
  def __init__(self, sym_name, function_type, *, tied_operands=None, sym_visibility=None, arg_attrs=None, res_attrs=None, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_591')) else
      _ods_ir.AttrBuilder.get('anonymous_591')(function_type, context=_ods_context))
    if tied_operands is not None: attributes["tied_operands"] = (tied_operands if (
        issubclass(type(tied_operands), _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('Util_TiedOpStorageAttr')) else
          _ods_ir.AttrBuilder.get('Util_TiedOpStorageAttr')(tied_operands, context=_ods_context))
...
def func(sym_name, function_type, *, tied_operands=None, sym_visibility=None, arg_attrs=None, res_attrs=None, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(FuncOp(sym_name=sym_name, function_type=function_type, tied_operands=tied_operands, sym_visibility=sym_visibility, arg_attrs=arg_attrs, res_attrs=res_attrs, loc=loc, ip=ip))
...
def tensor_alloca(result, result_dims, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(TensorAllocaOp(result=result, result_dims=result_dims, loc=loc, ip=ip))
...
def tensor_bitcast(result, source, source_dims, result_dims, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(TensorBitCastOp(result=result, source=source, source_dims=source_dims, result_dims=result_dims, loc=loc, ip=ip))
...
def tensor_clone(operand, argument_dims, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(TensorCloneOp(operand=operand, argument_dims=argument_dims, loc=loc, ip=ip))
...
def tensor_constant(result, value, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(TensorConstantOp(result=result, value=value, loc=loc, ip=ip))
...
def tensor_empty(result, result_dims, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(TensorEmptyOp(result=result, result_dims=result_dims, loc=loc, ip=ip))
...
def tensor_load(source, source_dims, indices, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(TensorLoadOp(source=source, source_dims=source_dims, indices=indices, loc=loc, ip=ip))
...
def tensor_reshape(result, source, source_dims, result_dims, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(TensorReshapeOp(result=result, source=source, source_dims=source_dims, result_dims=result_dims, loc=loc, ip=ip))
...
def tensor_slice(result, source, source_dims, start_indices, lengths, result_dims, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(TensorSliceOp(result=result, source=source, source_dims=source_dims, start_indices=start_indices, lengths=lengths, result_dims=result_dims, loc=loc, ip=ip))
...
def tensor_splat(result, value, result_dims, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(TensorSplatOp(result=result, value=value, result_dims=result_dims, loc=loc, ip=ip))
...
def tensor_store(value, target, target_dims, indices, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(TensorStoreOp(value=value, target=target, target_dims=target_dims, indices=indices, loc=loc, ip=ip))
...
def tensor_tie_shape(operand, dynamic_dims, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(TensorTieShapeOp(operand=operand, dynamic_dims=dynamic_dims, loc=loc, ip=ip))
...
def tensor_trace(key, values, value_dims, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(TensorTraceOp(key=key, values=values, value_dims=value_dims, loc=loc, ip=ip))
...
def tensor_update(target, target_dims, start_indices, update, update_dims, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(TensorUpdateOp(target=target, target_dims=target_dims, start_indices=start_indices, update=update, update_dims=update_dims, loc=loc, ip=ip))
