...
class BufferizeToAllocationOp(_ods_ir.OpView):
  ...
  def __init__(self, allocated_buffer, new_ops, target, *, memory_space=None, memcpy_op=None, alloc_op=None, bufferize_destination_only=None, emit_dealloc=None, loc=None, ip=None):
    ...
    if alloc_op is not None: attributes["alloc_op"] = (alloc_op if (
        issubclass(type(alloc_op), _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('StrAttr')) else
...
def structured_bufferize_to_allocation(allocated_buffer, new_ops, target, *, memory_space=None, memcpy_op=None, alloc_op=None, bufferize_destination_only=None, emit_dealloc=None, loc=None, ip=None) -> _Sequence[_SubClassValueT]:
...
def structured_convert_conv2d_to_img2col(img2col_tensor, transformed, target, *, loc=None, ip=None) -> _Sequence[_SubClassValueT]:
...
def structured_decompose_interface(transformed, target, *, loc=None, ip=None) -> _SubClassValueT:
...
def structured_decompose(transformed, target, *, loc=None, ip=None) -> _SubClassValueT:
...
def structured_fuse_into_containing_op(fused_op, new_containing_op, producer_op, containing_op, *, loc=None, ip=None) -> _Sequence[_SubClassValueT]:
...
def structured_fuse(transformed, loops, target, *, tile_sizes=None, tile_interchange=None, loc=None, ip=None) -> _Sequence[_SubClassValueT]:
...
def structured_generalize(transformed, target, *, loc=None, ip=None) -> _SubClassValueT:
...
def structured_hoist_pad_build_packing_loop_nest(packing_loop, target, loop, *, transpose=None, loc=None, ip=None) -> _SubClassValueT:
...
def structured_hoist_pad(transformed, target, num_loops, *, transpose=None, loc=None, ip=None) -> _SubClassValueT:
...
def structured_hoist_redundant_vector_transfers(transformed, target, *, loc=None, ip=None) -> _SubClassValueT:
...
def structured_insert_slice_to_copy(transformed, target, *, loc=None, ip=None) -> _SubClassValueT:
...
def structured_interchange(transformed, target, *, iterator_interchange=None, loc=None, ip=None) -> _SubClassValueT:
...
def structured_lower_pack(pad_op, expand_shape_op, transpose_op, target, *, loc=None, ip=None) -> _Sequence[_SubClassValueT]:
...
def structured_lower_unpack(empty_op, transpose_op, collapse_shape_op, extract_slice_op, target, *, loc=None, ip=None) -> _Sequence[_SubClassValueT]:
...
class MapCopyToThreadsOp(_ods_ir.OpView):
  ...
  def __init__(self, forall_op, tiled_op, target, total_num_threads, desired_bit_alignment, *, loc=None, ip=None):
    ...
    issubclass(type(total_num_threads), _ods_ir.Attribute) or
    not _ods_ir.AttrBuilder.contains('I64Attr')) else
    ...
    issubclass(type(desired_bit_alignment), _ods_ir.Attribute) or
    not _ods_ir.AttrBuilder.contains('I64Attr')) else
...
def structured_gpu_map_copy_to_threads(forall_op, tiled_op, target, total_num_threads, desired_bit_alignment, *, loc=None, ip=None) -> _Sequence[_SubClassValueT]:
...
class MatchOp(_ods_ir.OpView):
  ...
  def __init__(self, results_, target, *, ops=None, interface=None, op_attrs=None, filter_result_type=None, filter_operand_types=None, loc=None, ip=None):
    ...
    if filter_operand_types is not None: attributes["filter_operand_types"] = (filter_operand_types if (
        issubclass(type(filter_operand_types), _ods_ir.Attribute) or
...
def structured_match(results_, target, *, ops=None, interface=None, op_attrs=None, filter_result_type=None, filter_operand_types=None, loc=None, ip=None) -> _SubClassValueT:
...
def structured_multitile_sizes(low_size, high_size, split_point, target, dimension, target_size, *, divisor=None, loc=None, ip=None) -> _Sequence[_SubClassValueT]:
...
def structured_pack_greedily(packed_op, target, matmul_packed_sizes, *, static_matmul_packed_sizes=None, matmul_padded_sizes_next_multiple_of=None, matmul_inner_dims_order=None, loc=None, ip=None) -> _SubClassValueT:
...
def structured_pack(packed_op, target, packed_sizes, *, static_packed_sizes=None, loc=None, ip=None) -> _SubClassValueT:
...
def structured_pack_transpose(packed_op, pack_op, un_pack_op, target_pack_or_un_pack_op, target_linalg_op, *, outer_perm=None, inner_perm=None, loc=None, ip=None) -> _Sequence[_SubClassValueT]:
...
class PadOp(_ods_ir.OpView):
  ...
  def __init__(self, padded, pad, copy, target, *, padding_values=None, padding_dimensions=None, pad_to_multiple_of=None, pack_paddings=None, transpose_paddings=None, copy_back_op=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
    ...
    if transpose_paddings is not None: attributes["transpose_paddings"] = (transpose_paddings if (
        ...
        not _ods_ir.AttrBuilder.contains('anonymous_462')) else
          _ods_ir.AttrBuilder.get('anonymous_462')(transpose_paddings, context=_ods_context))
    if copy_back_op is not None: attributes["copy_back_op"] = (copy_back_op if (
        issubclass(type(copy_back_op), _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('StrAttr')) else
  ...
  def pad_to_multiple_of(self):
    if "pad_to_multiple_of" not in self.operation.attributes:
      return None
    return self.operation.attributes["pad_to_multiple_of"]

  @pad_to_multiple_of.setter
  def pad_to_multiple_of(self, value):
    if value is not None:
      self.operation.attributes["pad_to_multiple_of"] = value
...
def structured_pad(padded, pad, copy, target, *, padding_values=None, padding_dimensions=None, pad_to_multiple_of=None, pack_paddings=None, transpose_paddings=None, copy_back_op=None, loc=None, ip=None) -> _Sequence[_SubClassValueT]:
  return _get_op_result_or_op_results(PadOp(padded=padded, pad=pad, copy=copy, target=target, padding_values=padding_values, padding_dimensions=padding_dimensions, pad_to_multiple_of=pad_to_multiple_of, pack_paddings=pack_paddings, transpose_paddings=transpose_paddings, copy_back_op=copy_back_op, loc=loc, ip=ip))
...
def structured_promote(transformed, target, *, operands_to_promote=None, use_full_tile_buffers=None, use_full_tiles_by_default=None, use_alloca=None, memory_space=None, mapping=None, alignment=None, loc=None, ip=None) -> _SubClassValueT:
...
def structured_replace(replacement, target, *, loc=None, ip=None) -> _SubClassValueT:
...
def structured_rewrite_in_destination_passing_style(transformed, target, *, loc=None, ip=None) -> _SubClassValueT:
...
def structured_scalarize(result, target, *, loc=None, ip=None) -> _SubClassValueT:
...
def structured_specialize(transformed, target, *, loc=None, ip=None) -> _SubClassValueT:
...
def structured_split(first, second, target, dimension, static_split_point, *, dynamic_split_point=None, loc=None, ip=None) -> _Sequence[_SubClassValueT]:
...
def structured_split_reduction(init_or_alloc_op, fill_op, split_linalg_op, combining_linalg_op, target, *, split_factor=None, insert_split_dimension=None, inner_parallel=None, use_scaling_algorithm=None, use_alloc=None, loc=None, ip=None) -> _Sequence[_SubClassValueT]:
...
def structured_tile_reduction_using_for(fill_op, split_linalg_op, combining_linalg_op, for_op, target, *, tile_sizes=None, loc=None, ip=None) -> _Sequence[_SubClassValueT]:
...
def structured_tile_reduction_using_forall(fill_op, split_linalg_op, combining_linalg_op, forall_op, target, *, num_threads=None, tile_sizes=None, mapping=None, loc=None, ip=None) -> _Sequence[_SubClassValueT]:
...
class TileUsingForOp(_ods_ir.OpView):
  ...
  def __init__(self, tiled_linalg_op, loops, target, dynamic_sizes, *, static_sizes=None, interchange=None, scalable_sizes=None, loc=None, ip=None):
    ...
    if scalable_sizes is not None: attributes["scalable_sizes"] = (scalable_sizes if (
        issubclass(type(scalable_sizes), _ods_ir.Attribute) or
...
def structured_tile_using_for(tiled_linalg_op, loops, target, dynamic_sizes, *, static_sizes=None, interchange=None, scalable_sizes=None, loc=None, ip=None) -> _Sequence[_SubClassValueT]:
...
def structured_tile_using_forall(tiled_op, forall_op, target, num_threads, tile_sizes, *, packed_num_threads=None, packed_tile_sizes=None, static_num_threads=None, static_tile_sizes=None, mapping=None, loc=None, ip=None) -> _Sequence[_SubClassValueT]:
...
def structured_transpose_conv2d(transformed, target, *, loc=None, ip=None) -> _SubClassValueT:
...
def structured_vectorize_children_and_apply_patterns(transformed, target, *, vectorize_padding=None, vectorize_nd_extract=None, flatten_1d_depthwise_conv=None, disable_multi_reduction_to_contract_patterns=None, disable_transfer_permutation_map_lowering_patterns=None, loc=None, ip=None) -> _SubClassValueT:
...
class VectorizeOp(_ods_ir.OpView):
  ...
  def __init__(self, target, vector_sizes, *, vectorize_nd_extract=None, scalable_sizes=None, static_vector_sizes=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def structured_vectorize(target, vector_sizes, *, vectorize_nd_extract=None, scalable_sizes=None, static_vector_sizes=None, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(VectorizeOp(target=target, vector_sizes=vector_sizes, vectorize_nd_extract=vectorize_nd_extract, scalable_sizes=scalable_sizes, static_vector_sizes=static_vector_sizes, loc=loc, ip=ip))
