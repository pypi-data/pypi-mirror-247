...
def allocator_allocate(result, allocator, queue_affinity, memory_types, buffer_usage, result_size, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(AllocatorAllocateOp(result=result, allocator=allocator, queue_affinity=queue_affinity, memory_types=memory_types, buffer_usage=buffer_usage, result_size=result_size, loc=loc, ip=ip))
...
def allocator_import(did_import, result, allocator, queue_affinity, memory_types, buffer_usage, source, offset, length, *, loc=None, ip=None) -> _Sequence[_SubClassValueT]:
  return _get_op_result_or_op_results(AllocatorImportOp(did_import=did_import, result=result, allocator=allocator, queue_affinity=queue_affinity, memory_types=memory_types, buffer_usage=buffer_usage, source=source, offset=offset, length=length, loc=loc, ip=ip))
...
def buffer_assert(buffer, message, allocator, minimum_length, memory_types, buffer_usage, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(BufferAssertOp(buffer=buffer, message=message, allocator=allocator, minimum_length=minimum_length, memory_types=memory_types, buffer_usage=buffer_usage, loc=loc, ip=ip))
...
def buffer_load(result, source_buffer, source_offset, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(BufferLoadOp(result=result, source_buffer=source_buffer, source_offset=source_offset, loc=loc, ip=ip))
...
def buffer_store(value, target_buffer, target_offset, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(BufferStoreOp(value=value, target_buffer=target_buffer, target_offset=target_offset, loc=loc, ip=ip))
...
def buffer_subspan(result, source_buffer, source_offset, length, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(BufferSubspanOp(result=result, source_buffer=source_buffer, source_offset=source_offset, length=length, loc=loc, ip=ip))
...
def buffer_view_assert(buffer_view, message, element_type, encoding_type, shape, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(BufferViewAssertOp(buffer_view=buffer_view, message=message, element_type=element_type, encoding_type=encoding_type, shape=shape, loc=loc, ip=ip))
...
def buffer_view_buffer(result, buffer_view, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(BufferViewBufferOp(result=result, buffer_view=buffer_view, loc=loc, ip=ip))
...
class BufferViewCreateOp(_ods_ir.OpView):
  ...
  def __init__(self, result, source_buffer, source_offset, source_length, element_type, encoding_type, shape, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def buffer_view_create(result, source_buffer, source_offset, source_length, element_type, encoding_type, shape, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(BufferViewCreateOp(result=result, source_buffer=source_buffer, source_offset=source_offset, source_length=source_length, element_type=element_type, encoding_type=encoding_type, shape=shape, loc=loc, ip=ip))
...
def buffer_view_dim(result, buffer_view, index, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(BufferViewDimOp(result=result, buffer_view=buffer_view, index=index, loc=loc, ip=ip))
...
def buffer_view_element_type(result, buffer_view, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(BufferViewElementTypeOp(result=result, buffer_view=buffer_view, loc=loc, ip=ip))
...
def buffer_view_encoding_type(result, buffer_view, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(BufferViewEncodingTypeOp(result=result, buffer_view=buffer_view, loc=loc, ip=ip))
...
def buffer_view_rank(result, buffer_view, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(BufferViewRankOp(result=result, buffer_view=buffer_view, loc=loc, ip=ip))
...
def buffer_view_trace(key, operands_, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(BufferViewTraceOp(key=key, operands_=operands_, loc=loc, ip=ip))
...
def channel_create(result, device, queue_affinity, flags, id, group, rank, count, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(ChannelCreateOp(result=result, device=device, queue_affinity=queue_affinity, flags=flags, id=id, group=group, rank=rank, count=count, loc=loc, ip=ip))
...
def channel_rank_and_count(rank, count, channel, *, loc=None, ip=None) -> _Sequence[_SubClassValueT]:
  return _get_op_result_or_op_results(ChannelRankAndCountOp(rank=rank, count=count, channel=channel, loc=loc, ip=ip))
...
def channel_split(result, channel, color, key, flags, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(ChannelSplitOp(result=result, channel=channel, color=color, key=key, flags=flags, loc=loc, ip=ip))
...
def command_buffer_begin_debug_group(command_buffer, label, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(CommandBufferBeginDebugGroupOp(command_buffer=command_buffer, label=label, loc=loc, ip=ip))
...
def command_buffer_collective(command_buffer, channel, op, element_count, *, param=None, send_buffer=None, send_offset=None, send_length=None, recv_buffer=None, recv_offset=None, recv_length=None, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(CommandBufferCollectiveOp(command_buffer=command_buffer, channel=channel, op=op, element_count=element_count, param=param, send_buffer=send_buffer, send_offset=send_offset, send_length=send_length, recv_buffer=recv_buffer, recv_offset=recv_offset, recv_length=recv_length, loc=loc, ip=ip))
...
def command_buffer_copy_buffer(command_buffer, source_buffer, source_offset, target_buffer, target_offset, length, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(CommandBufferCopyBufferOp(command_buffer=command_buffer, source_buffer=source_buffer, source_offset=source_offset, target_buffer=target_buffer, target_offset=target_offset, length=length, loc=loc, ip=ip))
...
def command_buffer_create(result, device, modes, command_categories, *, binding_capacity=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(CommandBufferCreateOp(result=result, device=device, modes=modes, command_categories=command_categories, binding_capacity=binding_capacity, loc=loc, ip=ip))
...
def command_buffer_device(device, command_buffer, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(CommandBufferDeviceOp(device=device, command_buffer=command_buffer, loc=loc, ip=ip))
...
def command_buffer_dispatch_indirect(command_buffer, executable, entry_point, workgroups_buffer, workgroups_offset, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(CommandBufferDispatchIndirectOp(command_buffer=command_buffer, executable=executable, entry_point=entry_point, workgroups_buffer=workgroups_buffer, workgroups_offset=workgroups_offset, loc=loc, ip=ip))
...
def command_buffer_dispatch_indirect_symbol(command_buffer, entry_point, workgroups_buffer, workgroups_offset, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(CommandBufferDispatchIndirectSymbolOp(command_buffer=command_buffer, entry_point=entry_point, workgroups_buffer=workgroups_buffer, workgroups_offset=workgroups_offset, loc=loc, ip=ip))
...
def command_buffer_dispatch(command_buffer, executable, entry_point, workgroup_x, workgroup_y, workgroup_z, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(CommandBufferDispatchOp(command_buffer=command_buffer, executable=executable, entry_point=entry_point, workgroup_x=workgroup_x, workgroup_y=workgroup_y, workgroup_z=workgroup_z, loc=loc, ip=ip))
...
def command_buffer_dispatch_symbol(command_buffer, entry_point, workgroup_x, workgroup_y, workgroup_z, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(CommandBufferDispatchSymbolOp(command_buffer=command_buffer, entry_point=entry_point, workgroup_x=workgroup_x, workgroup_y=workgroup_y, workgroup_z=workgroup_z, loc=loc, ip=ip))
...
def command_buffer_end_debug_group(command_buffer, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(CommandBufferEndDebugGroupOp(command_buffer=command_buffer, loc=loc, ip=ip))
...
def command_buffer_execution_barrier(command_buffer, source_stage_mask, target_stage_mask, flags, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(CommandBufferExecutionBarrierOp(command_buffer=command_buffer, source_stage_mask=source_stage_mask, target_stage_mask=target_stage_mask, flags=flags, loc=loc, ip=ip))
...
def command_buffer_fill_buffer(command_buffer, target_buffer, target_offset, length, pattern, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(CommandBufferFillBufferOp(command_buffer=command_buffer, target_buffer=target_buffer, target_offset=target_offset, length=length, pattern=pattern, loc=loc, ip=ip))
...
def command_buffer_finalize(command_buffer, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(CommandBufferFinalizeOp(command_buffer=command_buffer, loc=loc, ip=ip))
...
def command_buffer_push_constants(command_buffer, pipeline_layout, offset, values, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(CommandBufferPushConstantsOp(command_buffer=command_buffer, pipeline_layout=pipeline_layout, offset=offset, values=values, loc=loc, ip=ip))
...
class CommandBufferPushDescriptorSetOp(_ods_ir.OpView):
  ...
  def __init__(self, command_buffer, pipeline_layout, set, binding_ordinals, binding_buffers, binding_offsets, binding_lengths, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
    ...
    operands.extend(_get_op_results_or_values(binding_ordinals))
...
def command_buffer_push_descriptor_set(command_buffer, pipeline_layout, set, binding_ordinals, binding_buffers, binding_offsets, binding_lengths, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(CommandBufferPushDescriptorSetOp(command_buffer=command_buffer, pipeline_layout=pipeline_layout, set=set, binding_ordinals=binding_ordinals, binding_buffers=binding_buffers, binding_offsets=binding_offsets, binding_lengths=binding_lengths, loc=loc, ip=ip))
...
def descriptor_set_layout_create(result, device, flags, bindings, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(DescriptorSetLayoutCreateOp(result=result, device=device, flags=flags, bindings=bindings, loc=loc, ip=ip))
...
def descriptor_set_layout_lookup(result, device, flags, bindings, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(DescriptorSetLayoutLookupOp(result=result, device=device, flags=flags, bindings=bindings, loc=loc, ip=ip))
...
class DeviceAllocatorOp(_ods_ir.OpView):
  ...
  def __init__(self, result, device, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def device_allocator(result, device, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(DeviceAllocatorOp(result=result, device=device, loc=loc, ip=ip))
...
def device_query(ok, value, device, category, key, *, default_value=None, loc=None, ip=None) -> _Sequence[_SubClassValueT]:
  return _get_op_result_or_op_results(DeviceQueryOp(ok=ok, value=value, device=device, category=category, key=key, default_value=default_value, loc=loc, ip=ip))
...
def device_queue_alloca(result, device, queue_affinity, wait_fence, signal_fence, pool, memory_types, buffer_usage, result_size, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(DeviceQueueAllocaOp(result=result, device=device, queue_affinity=queue_affinity, wait_fence=wait_fence, signal_fence=signal_fence, pool=pool, memory_types=memory_types, buffer_usage=buffer_usage, result_size=result_size, loc=loc, ip=ip))
...
def device_queue_dealloca(device, queue_affinity, wait_fence, signal_fence, buffer, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(DeviceQueueDeallocaOp(device=device, queue_affinity=queue_affinity, wait_fence=wait_fence, signal_fence=signal_fence, buffer=buffer, loc=loc, ip=ip))
...
def device_queue_execute(device, queue_affinity, wait_fence, signal_fence, command_buffers, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(DeviceQueueExecuteOp(device=device, queue_affinity=queue_affinity, wait_fence=wait_fence, signal_fence=signal_fence, command_buffers=command_buffers, loc=loc, ip=ip))
...
def device_queue_flush(device, queue_affinity, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(DeviceQueueFlushOp(device=device, queue_affinity=queue_affinity, loc=loc, ip=ip))
...
def device_queue_read(device, queue_affinity, wait_fence, signal_fence, source_file, source_offset, target_buffer, target_offset, length, flags, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(DeviceQueueReadOp(device=device, queue_affinity=queue_affinity, wait_fence=wait_fence, signal_fence=signal_fence, source_file=source_file, source_offset=source_offset, target_buffer=target_buffer, target_offset=target_offset, length=length, flags=flags, loc=loc, ip=ip))
...
def device_queue_write(device, queue_affinity, wait_fence, signal_fence, source_buffer, source_offset, target_file, target_offset, length, flags, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(DeviceQueueWriteOp(device=device, queue_affinity=queue_affinity, wait_fence=wait_fence, signal_fence=signal_fence, source_buffer=source_buffer, source_offset=source_offset, target_file=target_file, target_offset=target_offset, length=length, flags=flags, loc=loc, ip=ip))
...
def devices_count(result, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(DevicesCountOp(result=result, loc=loc, ip=ip))
...
class DevicesGetOp(_ods_ir.OpView):
  ...
  def __init__(self, result, index, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def devices_get(result, index, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(DevicesGetOp(result=result, index=index, loc=loc, ip=ip))
...
class DispatchExternOp(_ods_ir.OpView):
  ...
  def __init__(self, results_, export, workload, arguments, argument_dims, result_dims, layout, targets, target_ordinals, target_objects, num_target_regions, *, workgroup_size=None, subgroup_size=None, workgroup_local_memory=None, bindings=None, tied_operands=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
    ...
    issubclass(type(export), _ods_ir.Attribute) or
    not _ods_ir.AttrBuilder.contains('StrAttr')) else
    ...
    issubclass(type(target_objects), _ods_ir.Attribute) or
    not _ods_ir.AttrBuilder.contains('ArrayAttr')) else
    ...
    if bindings is not None: attributes["bindings"] = (bindings if (
        issubclass(type(bindings), _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('HAL_InterfaceBindingArrayAttr')) else
          _ods_ir.AttrBuilder.get('HAL_InterfaceBindingArrayAttr')(bindings, context=_ods_context))
  ...
  @builtins.property
  def bindings(self):
    if "bindings" not in self.operation.attributes:
      return None
    return self.operation.attributes["bindings"]
  ...
  def bindings(self, value):
    if value is not None:
      self.operation.attributes["bindings"] = value
    elif "bindings" in self.operation.attributes:
      del self.operation.attributes["bindings"]
...
def dispatch_extern(results_, export, workload, arguments, argument_dims, result_dims, layout, targets, target_ordinals, target_objects, num_target_regions, *, workgroup_size=None, subgroup_size=None, workgroup_local_memory=None, bindings=None, tied_operands=None, loc=None, ip=None) -> _SubClassValueT:
...
def ex_file_from_memory(result, device, queue_affinity, access, buffer, offset, length, flags, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(ExFileFromMemoryOp(result=result, device=device, queue_affinity=queue_affinity, access=access, buffer=buffer, offset=offset, length=length, flags=flags, loc=loc, ip=ip))
...
class ExecutableBinaryOp(_ods_ir.OpView):
  ...
  def __init__(self, sym_name, format, data, *, sym_visibility=None, mime_type=None, loc=None, ip=None):
    ...
    issubclass(type(data), _ods_ir.Attribute) or
    not _ods_ir.AttrBuilder.contains('HAL_ExecutableDataAttr')) else
      _ods_ir.AttrBuilder.get('HAL_ExecutableDataAttr')(data, context=_ods_context))
...
def executable_binary(sym_name, format, data, *, sym_visibility=None, mime_type=None, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(ExecutableBinaryOp(sym_name=sym_name, format=format, data=data, sym_visibility=sym_visibility, mime_type=mime_type, loc=loc, ip=ip))
...
def executable_calculate_workgroups(workgroup_x, workgroup_y, workgroup_z, device, entry_point, workload, *, loc=None, ip=None) -> _Sequence[_SubClassValueT]:
  return _get_op_result_or_op_results(ExecutableCalculateWorkgroupsOp(workgroup_x=workgroup_x, workgroup_y=workgroup_y, workgroup_z=workgroup_z, device=device, entry_point=entry_point, workload=workload, loc=loc, ip=ip))
...
class ExecutableConditionOp(_ods_ir.OpView):
  ...
  def __init__(self, function_type, *, arg_attrs=None, res_attrs=None, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_739')) else
      _ods_ir.AttrBuilder.get('anonymous_739')(function_type, context=_ods_context))
...
def executable_condition(function_type, *, arg_attrs=None, res_attrs=None, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(ExecutableConditionOp(function_type=function_type, arg_attrs=arg_attrs, res_attrs=res_attrs, loc=loc, ip=ip))
...
def executable_constant_block(function_type, keys, *, arg_attrs=None, res_attrs=None, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(ExecutableConstantBlockOp(function_type=function_type, keys=keys, arg_attrs=arg_attrs, res_attrs=res_attrs, loc=loc, ip=ip))
...
def executable_constant_load(result, key, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(ExecutableConstantLoadOp(result=result, key=key, loc=loc, ip=ip))
...
def executable_create(result, device, executable_target, layouts, constants, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(ExecutableCreateOp(result=result, device=device, executable_target=executable_target, layouts=layouts, constants=constants, loc=loc, ip=ip))
...
def executable_export(sym_name, layout, *, sym_visibility=None, ordinal=None, workgroup_size=None, subgroup_size=None, workgroup_local_memory=None, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(ExecutableExportOp(sym_name=sym_name, layout=layout, sym_visibility=sym_visibility, ordinal=ordinal, workgroup_size=workgroup_size, subgroup_size=subgroup_size, workgroup_local_memory=workgroup_local_memory, loc=loc, ip=ip))
...
class ExecutableLookupOp(_ods_ir.OpView):
  ...
  def __init__(self, result, device, executable, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
    ...
    issubclass(type(executable), _ods_ir.Attribute) or
...
def executable_lookup(result, device, executable, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(ExecutableLookupOp(result=result, device=device, executable=executable, loc=loc, ip=ip))
...
def executable_source_end(*, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(ExecutableSourceEndOp(loc=loc, ip=ip))
...
def executable_source(sym_name, *, sym_visibility=None, objects=None, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(ExecutableSourceOp(sym_name=sym_name, sym_visibility=sym_visibility, objects=objects, loc=loc, ip=ip))
...
def executable_variant_end(*, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(ExecutableVariantEndOp(loc=loc, ip=ip))
...
class ExecutableVariantOp(_ods_ir.OpView):
  ...
  def __init__(self, sym_name, target, *, sym_visibility=None, objects=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def executable_variant(sym_name, target, *, sym_visibility=None, objects=None, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(ExecutableVariantOp(sym_name=sym_name, target=target, sym_visibility=sym_visibility, objects=objects, loc=loc, ip=ip))
...
def fence_await(status, timeout_millis, fences, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(FenceAwaitOp(status=status, timeout_millis=timeout_millis, fences=fences, loc=loc, ip=ip))
...
def fence_create(result, device, flags, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(FenceCreateOp(result=result, device=device, flags=flags, loc=loc, ip=ip))
...
def fence_fail(fence, status, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(FenceFailOp(fence=fence, status=status, loc=loc, ip=ip))
...
def fence_join(result, fences, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(FenceJoinOp(result=result, fences=fences, loc=loc, ip=ip))
...
def fence_query(status, fence, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(FenceQueryOp(status=status, fence=fence, loc=loc, ip=ip))
...
def fence_signal(fence, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(FenceSignalOp(fence=fence, loc=loc, ip=ip))
...
def instrument_memory_load(result, buffer, workgroup_key, load_value, base, indices, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(InstrumentMemoryLoadOp(result=result, buffer=buffer, workgroupKey=workgroup_key, loadValue=load_value, base=base, indices=indices, loc=loc, ip=ip))
...
def instrument_memory_store(result, buffer, workgroup_key, store_value, base, indices, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(InstrumentMemoryStoreOp(result=result, buffer=buffer, workgroupKey=workgroup_key, storeValue=store_value, base=base, indices=indices, loc=loc, ip=ip))
...
def instrument_print(buffer, workgroup_key, format, values, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(InstrumentPrintOp(buffer=buffer, workgroupKey=workgroup_key, format=format, values=values, loc=loc, ip=ip))
...
def instrument_value(result, buffer, workgroup_key, ordinal, operand, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(InstrumentValueOp(result=result, buffer=buffer, workgroupKey=workgroup_key, ordinal=ordinal, operand=operand, loc=loc, ip=ip))
...
def instrument_workgroup(workgroup_key, buffer, dispatch_id, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(InstrumentWorkgroupOp(workgroupKey=workgroup_key, buffer=buffer, dispatchId=dispatch_id, loc=loc, ip=ip))
...
def interface_binding_subspan(result, set, binding, descriptor_type, dynamic_dims, *, byte_offset=None, alignment=None, descriptor_flags=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(InterfaceBindingSubspanOp(result=result, set=set, binding=binding, descriptor_type=descriptor_type, dynamic_dims=dynamic_dims, byte_offset=byte_offset, alignment=alignment, descriptor_flags=descriptor_flags, loc=loc, ip=ip))
...
def interface_constant_load(result, index, *, alignment=None, values=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(InterfaceConstantLoadOp(result=result, index=index, alignment=alignment, values=values, loc=loc, ip=ip))
...
def interface_workgroup_count(result, dimension, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(InterfaceWorkgroupCountOp(result=result, dimension=dimension, loc=loc, ip=ip))
...
def interface_workgroup_id(result, dimension, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(InterfaceWorkgroupIDOp(result=result, dimension=dimension, loc=loc, ip=ip))
...
def interface_workgroup_size(result, dimension, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(InterfaceWorkgroupSizeOp(result=result, dimension=dimension, loc=loc, ip=ip))
...
def pipeline_layout_create(result, device, push_constants, set_layouts, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(PipelineLayoutCreateOp(result=result, device=device, push_constants=push_constants, set_layouts=set_layouts, loc=loc, ip=ip))
...
def pipeline_layout_lookup(result, device, layout, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(PipelineLayoutLookupOp(result=result, device=device, layout=layout, loc=loc, ip=ip))
...
def tensor_barrier(results_, sources, signal_fence, *, loc=None, ip=None) -> _SubClassValueT:
...
def tensor_export(target, source, source_encoding, source_dims, *, target_storage=None, name=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(TensorExportOp(target=target, source=source, source_encoding=source_encoding, source_dims=source_dims, target_storage=target_storage, name=name, loc=loc, ip=ip))
...
def tensor_import(target, source, target_encoding, target_dims, *, wait_fence=None, name=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(TensorImportOp(target=target, source=source, target_encoding=target_encoding, target_dims=target_dims, wait_fence=wait_fence, name=name, loc=loc, ip=ip))
