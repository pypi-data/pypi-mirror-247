...
def async_alloca(result, storage_size, *, affinity=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(AsyncAllocaOp(result=result, storage_size=storage_size, affinity=affinity, loc=loc, ip=ip))
...
def async_call(results_, callee, resource_operands, resource_operand_sizes, resource_operand_offsets, resource_operand_ends, resource_operand_lengths, result_sizes, *, tied_operands=None, affinity=None, loc=None, ip=None) -> _SubClassValueT:
...
def async_clone(result, source, source_size, result_size, *, affinity=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(AsyncCloneOp(result=result, source=source, source_size=source_size, result_size=result_size, affinity=affinity, loc=loc, ip=ip))
...
def async_collective(op, target, target_size, target_offset, target_end, target_length, source, source_size, source_offset, source_end, source_length, element_count, channel, *, param=None, affinity=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(AsyncCollectiveOp(op=op, target=target, target_size=target_size, target_offset=target_offset, target_end=target_end, target_length=target_length, source=source, source_size=source_size, source_offset=source_offset, source_end=source_end, source_length=source_length, element_count=element_count, channel=channel, param=param, affinity=affinity, loc=loc, ip=ip))
...
def async_concurrent(results_, resource_operands, resource_operand_sizes, result_sizes, *, tied_operands=None, affinity=None, loc=None, ip=None) -> _SubClassValueT:
...
def async_constant(result, value, result_size, *, affinity=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(AsyncConstantOp(result=result, value=value, result_size=result_size, affinity=affinity, loc=loc, ip=ip))
...
def async_copy(target, target_size, target_offset, target_end, source, source_size, source_offset, source_end, length, *, affinity=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(AsyncCopyOp(target=target, target_size=target_size, target_offset=target_offset, target_end=target_end, source=source, source_size=source_size, source_offset=source_offset, source_end=source_end, length=length, affinity=affinity, loc=loc, ip=ip))
...
def async_dispatch(results_, workload, entry_points, resource_operands, resource_operand_sizes, resource_operand_offsets, resource_operand_ends, resource_operand_lengths, result_sizes, *, tied_operands=None, affinity=None, loc=None, ip=None) -> _SubClassValueT:
...
class AsyncExecuteOp(_ods_ir.OpView):
  ...
  def __init__(self, results_, result_timepoint, resource_operands, resource_operand_sizes, result_sizes, *, await_timepoint=None, tied_operands=None, affinity=None, loc=None, ip=None):
    ...
    operands.append(_get_op_results_or_values(resource_operand_sizes))
    operands.append(_get_op_results_or_values(result_sizes))
    operands.append(_get_op_result_or_value(await_timepoint) if await_timepoint is not None else None)
    _ods_context = _ods_get_default_loc_context(loc)
    if tied_operands is not None: attributes["tied_operands"] = (tied_operands if (
        issubclass(type(tied_operands), _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('Util_TiedOpStorageAttr')) else
...
def async_execute(results_, result_timepoint, resource_operands, resource_operand_sizes, result_sizes, *, await_timepoint=None, tied_operands=None, affinity=None, loc=None, ip=None) -> _Sequence[_SubClassValueT]:
...
def async_fill(target, target_size, target_offset, target_end, target_length, value, *, affinity=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(AsyncFillOp(target=target, target_size=target_size, target_offset=target_offset, target_end=target_end, target_length=target_length, value=value, affinity=affinity, loc=loc, ip=ip))
...
class AsyncFuncOp(_ods_ir.OpView):
  ...
  def __init__(self, sym_name, function_type, *, tied_operands=None, sym_visibility=None, arg_attrs=None, res_attrs=None, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_682')) else
      _ods_ir.AttrBuilder.get('anonymous_682')(function_type, context=_ods_context))
    if tied_operands is not None: attributes["tied_operands"] = (tied_operands if (
        issubclass(type(tied_operands), _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('Util_TiedOpStorageAttr')) else
          _ods_ir.AttrBuilder.get('Util_TiedOpStorageAttr')(tied_operands, context=_ods_context))
...
def async_func(sym_name, function_type, *, tied_operands=None, sym_visibility=None, arg_attrs=None, res_attrs=None, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(AsyncFuncOp(sym_name=sym_name, function_type=function_type, tied_operands=tied_operands, sym_visibility=sym_visibility, arg_attrs=arg_attrs, res_attrs=res_attrs, loc=loc, ip=ip))
...
def async_load(result, source, source_size, source_offset, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(AsyncLoadOp(result=result, source=source, source_size=source_size, source_offset=source_offset, loc=loc, ip=ip))
...
def async_slice(source, source_size, source_offset, source_end, result_size, *, affinity=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(AsyncSliceOp(source=source, source_size=source_size, source_offset=source_offset, source_end=source_end, result_size=result_size, affinity=affinity, loc=loc, ip=ip))
...
def async_splat(result, value, result_size, *, affinity=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(AsyncSplatOp(result=result, value=value, result_size=result_size, affinity=affinity, loc=loc, ip=ip))
...
def async_store(target, target_size, target_offset, value, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(AsyncStoreOp(target=target, target_size=target_size, target_offset=target_offset, value=value, loc=loc, ip=ip))
...
def async_transfer(result, source, source_size, result_size, *, source_affinity=None, result_affinity=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(AsyncTransferOp(result=result, source=source, source_size=source_size, result_size=result_size, source_affinity=source_affinity, result_affinity=result_affinity, loc=loc, ip=ip))
...
def async_update(target, target_size, target_offset, target_end, update, update_size, *, affinity=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(AsyncUpdateOp(target=target, target_size=target_size, target_offset=target_offset, target_end=target_end, update=update, update_size=update_size, affinity=affinity, loc=loc, ip=ip))
...
def binding_subspan(result, binding, byte_offset, dynamic_dims, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(BindingSubspanOp(result=result, binding=binding, byte_offset=byte_offset, dynamic_dims=dynamic_dims, loc=loc, ip=ip))
...
def channel_count(channel, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(ChannelCountOp(channel=channel, loc=loc, ip=ip))
...
def channel_create(*, id=None, group=None, rank=None, count=None, affinity=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(ChannelCreateOp(id=id, group=group, rank=rank, count=count, affinity=affinity, loc=loc, ip=ip))
...
def channel_rank(channel, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(ChannelRankOp(channel=channel, loc=loc, ip=ip))
...
def channel_split(channel, color, key, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(ChannelSplitOp(channel=channel, color=color, key=key, loc=loc, ip=ip))
...
def cmd_call(results_, callee, resource_operands, resource_operand_sizes, resource_operand_offsets, resource_operand_lengths, result_sizes, resource_operand_accesses, *, tied_operands=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(CmdCallOp(results_=results_, callee=callee, resource_operands=resource_operands, resource_operand_sizes=resource_operand_sizes, resource_operand_offsets=resource_operand_offsets, resource_operand_lengths=resource_operand_lengths, result_sizes=result_sizes, resource_operand_accesses=resource_operand_accesses, tied_operands=tied_operands, loc=loc, ip=ip))
...
def cmd_collective(op, channel, element_count, resources, resource_sizes, resource_offsets, resource_lengths, resource_accesses, *, param=None, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(CmdCollectiveOp(op=op, channel=channel, element_count=element_count, resources=resources, resource_sizes=resource_sizes, resource_offsets=resource_offsets, resource_lengths=resource_lengths, resource_accesses=resource_accesses, param=param, loc=loc, ip=ip))
...
def cmd_concurrent(*, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(CmdConcurrentOp(loc=loc, ip=ip))
...
def cmd_copy(source, source_size, source_offset, target, target_size, target_offset, length, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(CmdCopyOp(source=source, source_size=source_size, source_offset=source_offset, target=target, target_size=target_size, target_offset=target_offset, length=length, loc=loc, ip=ip))
...
def cmd_discard(target, target_size, target_offset, target_length, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(CmdDiscardOp(target=target, target_size=target_size, target_offset=target_offset, target_length=target_length, loc=loc, ip=ip))
...
def cmd_dispatch(workload, entry_points, uniform_operands, resources, resource_sizes, resource_offsets, resource_lengths, resource_accesses, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(CmdDispatchOp(workload=workload, entry_points=entry_points, uniform_operands=uniform_operands, resources=resources, resource_sizes=resource_sizes, resource_offsets=resource_offsets, resource_lengths=resource_lengths, resource_accesses=resource_accesses, loc=loc, ip=ip))
...
class CmdExecuteOp(_ods_ir.OpView):
  ...
  def __init__(self, result_timepoint, resource_operands, resource_operand_sizes, *, await_timepoint=None, affinity=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def cmd_execute(result_timepoint, resource_operands, resource_operand_sizes, *, await_timepoint=None, affinity=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(CmdExecuteOp(result_timepoint=result_timepoint, resource_operands=resource_operands, resource_operand_sizes=resource_operand_sizes, await_timepoint=await_timepoint, affinity=affinity, loc=loc, ip=ip))
...
def cmd_fill(target, target_size, target_offset, target_length, value, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(CmdFillOp(target=target, target_size=target_size, target_offset=target_offset, target_length=target_length, value=value, loc=loc, ip=ip))
...
def cmd_flush(target, target_size, target_offset, target_length, *, source_affinity=None, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(CmdFlushOp(target=target, target_size=target_size, target_offset=target_offset, target_length=target_length, source_affinity=source_affinity, loc=loc, ip=ip))
...
def cmd_func(sym_name, function_type, *, sym_visibility=None, arg_attrs=None, res_attrs=None, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(CmdFuncOp(sym_name=sym_name, function_type=function_type, sym_visibility=sym_visibility, arg_attrs=arg_attrs, res_attrs=res_attrs, loc=loc, ip=ip))
...
def cmd_invalidate(target, target_size, target_offset, target_length, *, source_affinity=None, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(CmdInvalidateOp(target=target, target_size=target_size, target_offset=target_offset, target_length=target_length, source_affinity=source_affinity, loc=loc, ip=ip))
...
def cmd_serial(*, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(CmdSerialOp(loc=loc, ip=ip))
...
def context_resolve(results_, *, affinity=None, loc=None, ip=None) -> _SubClassValueT:
...
def dispatch_workgroup_count(dimension, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(DispatchWorkgroupCountOp(dimension=dimension, loc=loc, ip=ip))
...
def dispatch_workgroup_id(dimension, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(DispatchWorkgroupIDOp(dimension=dimension, loc=loc, ip=ip))
...
def dispatch_workgroup_size(dimension, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(DispatchWorkgroupSizeOp(dimension=dimension, loc=loc, ip=ip))
...
def executable_end(*, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(ExecutableEndOp(loc=loc, ip=ip))
...
def executable_export(sym_name, function_ref, *, sym_visibility=None, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(ExecutableExportOp(sym_name=sym_name, function_ref=function_ref, sym_visibility=sym_visibility, loc=loc, ip=ip))
...
def executable(sym_name, *, sym_visibility=None, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(ExecutableOp(sym_name=sym_name, sym_visibility=sym_visibility, loc=loc, ip=ip))
...
def file_constant(source, source_size, source_offset, source_length, *, affinity=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(FileConstantOp(source=source, source_size=source_size, source_offset=source_offset, source_length=source_length, affinity=affinity, loc=loc, ip=ip))
...
def file_read(source, source_offset, target, target_size, target_offset, length, *, await_timepoint=None, affinity=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(FileReadOp(source=source, source_offset=source_offset, target=target, target_size=target_size, target_offset=target_offset, length=length, await_timepoint=await_timepoint, affinity=affinity, loc=loc, ip=ip))
...
def file_write(source, source_size, source_offset, target, target_offset, length, *, await_timepoint=None, affinity=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(FileWriteOp(source=source, source_size=source_size, source_offset=source_offset, target=target, target_offset=target_offset, length=length, await_timepoint=await_timepoint, affinity=affinity, loc=loc, ip=ip))
...
def parameter_gather(source_keys, source_offsets, target, target_size, target_offsets, target_lengths, *, source_scope=None, await_timepoint=None, affinity=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(ParameterGatherOp(source_keys=source_keys, source_offsets=source_offsets, target=target, target_size=target_size, target_offsets=target_offsets, target_lengths=target_lengths, source_scope=source_scope, await_timepoint=await_timepoint, affinity=affinity, loc=loc, ip=ip))
...
def parameter_load(results_, result_timepoint, source_keys, source_offsets, result_sizes, *, source_scope=None, await_timepoint=None, affinity=None, loc=None, ip=None) -> _Sequence[_SubClassValueT]:
...
class ParameterReadOp(_ods_ir.OpView):
  ...
  def __init__(self, source_key, source_offset, target, target_size, target_offset, target_length, *, source_scope=None, await_timepoint=None, affinity=None, loc=None, ip=None):
    ...
    issubclass(type(source_key), _ods_ir.Attribute) or
    not _ods_ir.AttrBuilder.contains('StrAttr')) else
...
def parameter_read(source_key, source_offset, target, target_size, target_offset, target_length, *, source_scope=None, await_timepoint=None, affinity=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(ParameterReadOp(source_key=source_key, source_offset=source_offset, target=target, target_size=target_size, target_offset=target_offset, target_length=target_length, source_scope=source_scope, await_timepoint=await_timepoint, affinity=affinity, loc=loc, ip=ip))
...
def parameter_scatter(source, source_size, source_offsets, source_lengths, target_keys, target_offsets, *, target_scope=None, await_timepoint=None, affinity=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(ParameterScatterOp(source=source, source_size=source_size, source_offsets=source_offsets, source_lengths=source_lengths, target_keys=target_keys, target_offsets=target_offsets, target_scope=target_scope, await_timepoint=await_timepoint, affinity=affinity, loc=loc, ip=ip))
...
class ParameterWriteOp(_ods_ir.OpView):
  ...
  def __init__(self, source, source_size, source_offset, source_length, target_key, target_offset, *, target_scope=None, await_timepoint=None, affinity=None, loc=None, ip=None):
    ...
    issubclass(type(target_key), _ods_ir.Attribute) or
    not _ods_ir.AttrBuilder.contains('StrAttr')) else
...
def parameter_write(source, source_size, source_offset, source_length, target_key, target_offset, *, target_scope=None, await_timepoint=None, affinity=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(ParameterWriteOp(source=source, source_size=source_size, source_offset=source_offset, source_length=source_length, target_key=target_key, target_offset=target_offset, target_scope=target_scope, await_timepoint=await_timepoint, affinity=affinity, loc=loc, ip=ip))
...
def resource_alloc(result, storage_size, *, uninitialized=None, affinity=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(ResourceAllocOp(result=result, storage_size=storage_size, uninitialized=uninitialized, affinity=affinity, loc=loc, ip=ip))
...
def resource_alloca(result, result_timepoint, storage_size, *, await_timepoint=None, affinity=None, loc=None, ip=None) -> _Sequence[_SubClassValueT]:
  return _get_op_result_or_op_results(ResourceAllocaOp(result=result, result_timepoint=result_timepoint, storage_size=storage_size, await_timepoint=await_timepoint, affinity=affinity, loc=loc, ip=ip))
...
class ResourceConstantsOp(_ods_ir.OpView):
  ...
  def __init__(self, results_, result_timepoint, values, result_sizes, *, affinity=None, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_646')) else
      _ods_ir.AttrBuilder.get('anonymous_646')(values, context=_ods_context))
    if affinity is not None: attributes["affinity"] = (affinity if (
        issubclass(type(affinity), _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('Stream_AffinityAttr')) else
          _ods_ir.AttrBuilder.get('Stream_AffinityAttr')(affinity, context=_ods_context))
...
def resource_constants(results_, result_timepoint, values, result_sizes, *, affinity=None, loc=None, ip=None) -> _Sequence[_SubClassValueT]:
...
def resource_dealloca(operand, operand_size, *, await_timepoint=None, affinity=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(ResourceDeallocaOp(operand=operand, operand_size=operand_size, await_timepoint=await_timepoint, affinity=affinity, loc=loc, ip=ip))
...
def resource_load(result, source, source_size, source_offset, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(ResourceLoadOp(result=result, source=source, source_size=source_size, source_offset=source_offset, loc=loc, ip=ip))
...
def resource_pack(total_length, packed_offsets, lifetime_intervals, dynamic_slice_sizes, *, offset=None, affinity=None, loc=None, ip=None) -> _Sequence[_SubClassValueT]:
...
def resource_size(operand, *, affinity=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(ResourceSizeOp(operand=operand, affinity=affinity, loc=loc, ip=ip))
...
def resource_store(target, target_size, target_offset, value, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(ResourceStoreOp(target=target, target_size=target_size, target_offset=target_offset, value=value, loc=loc, ip=ip))
...
def resource_subview(source, source_size, source_offset, result_size, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(ResourceSubviewOp(source=source, source_size=source_size, source_offset=source_offset, result_size=result_size, loc=loc, ip=ip))
...
def resource_try_map(did_map, result, source, source_offset, result_size, *, affinity=None, loc=None, ip=None) -> _Sequence[_SubClassValueT]:
  return _get_op_result_or_op_results(ResourceTryMapOp(did_map=did_map, result=result, source=source, source_offset=source_offset, result_size=result_size, affinity=affinity, loc=loc, ip=ip))
...
def tensor_clone(result, source, source_encoding, source_encoding_dims, source_size, result_encoding, result_encoding_dims, result_size, *, affinity=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(TensorCloneOp(result=result, source=source, source_encoding=source_encoding, source_encoding_dims=source_encoding_dims, source_size=source_size, result_encoding=result_encoding, result_encoding_dims=result_encoding_dims, result_size=result_size, affinity=affinity, loc=loc, ip=ip))
...
def tensor_constant(result, value, result_encoding, result_encoding_dims, *, affinity=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(TensorConstantOp(result=result, value=value, result_encoding=result_encoding, result_encoding_dims=result_encoding_dims, affinity=affinity, loc=loc, ip=ip))
...
def tensor_empty(result, result_encoding, result_encoding_dims, result_size, *, affinity=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(TensorEmptyOp(result=result, result_encoding=result_encoding, result_encoding_dims=result_encoding_dims, result_size=result_size, affinity=affinity, loc=loc, ip=ip))
...
def tensor_export(result, source, source_encoding, source_encoding_dims, source_size, *, affinity=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(TensorExportOp(result=result, source=source, source_encoding=source_encoding, source_encoding_dims=source_encoding_dims, source_size=source_size, affinity=affinity, loc=loc, ip=ip))
...
def tensor_fill(target, target_encoding, target_encoding_dims, target_size, start_indices, lengths, value, *, affinity=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(TensorFillOp(target=target, target_encoding=target_encoding, target_encoding_dims=target_encoding_dims, target_size=target_size, start_indices=start_indices, lengths=lengths, value=value, affinity=affinity, loc=loc, ip=ip))
...
def tensor_import(result, source, result_encoding, result_encoding_dims, result_size, *, affinity=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(TensorImportOp(result=result, source=source, result_encoding=result_encoding, result_encoding_dims=result_encoding_dims, result_size=result_size, affinity=affinity, loc=loc, ip=ip))
...
def tensor_load(result, source, source_encoding, source_encoding_dims, source_size, indices, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(TensorLoadOp(result=result, source=source, source_encoding=source_encoding, source_encoding_dims=source_encoding_dims, source_size=source_size, indices=indices, loc=loc, ip=ip))
...
def tensor_sizeof(encoding, encoding_dims, *, affinity=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(TensorSizeOfOp(encoding=encoding, encoding_dims=encoding_dims, affinity=affinity, loc=loc, ip=ip))
...
def tensor_slice(result, source, source_encoding, source_encoding_dims, source_size, start_indices, lengths, result_encoding, result_encoding_dims, result_size, *, affinity=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(TensorSliceOp(result=result, source=source, source_encoding=source_encoding, source_encoding_dims=source_encoding_dims, source_size=source_size, start_indices=start_indices, lengths=lengths, result_encoding=result_encoding, result_encoding_dims=result_encoding_dims, result_size=result_size, affinity=affinity, loc=loc, ip=ip))
...
def tensor_splat(result, value, result_encoding, result_encoding_dims, result_size, *, affinity=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(TensorSplatOp(result=result, value=value, result_encoding=result_encoding, result_encoding_dims=result_encoding_dims, result_size=result_size, affinity=affinity, loc=loc, ip=ip))
...
def tensor_store(target, target_encoding, target_encoding_dims, target_size, indices, value, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(TensorStoreOp(target=target, target_encoding=target_encoding, target_encoding_dims=target_encoding_dims, target_size=target_size, indices=indices, value=value, loc=loc, ip=ip))
...
class TensorTraceOp(_ods_ir.OpView):
  ...
  def __init__(self, key, resources, resource_sizes, resource_encodings, resource_encoding_dims, *, loc=None, ip=None):
    ...
    issubclass(type(resource_encodings), _ods_ir.Attribute) or
...
def tensor_trace(key, resources, resource_sizes, resource_encodings, resource_encoding_dims, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(TensorTraceOp(key=key, resources=resources, resource_sizes=resource_sizes, resource_encodings=resource_encodings, resource_encoding_dims=resource_encoding_dims, loc=loc, ip=ip))
...
def tensor_update(target, target_encoding, target_encoding_dims, target_size, start_indices, update, update_encoding, update_encoding_dims, update_size, *, affinity=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(TensorUpdateOp(target=target, target_encoding=target_encoding, target_encoding_dims=target_encoding_dims, target_size=target_size, start_indices=start_indices, update=update, update_encoding=update_encoding, update_encoding_dims=update_encoding_dims, update_size=update_size, affinity=affinity, loc=loc, ip=ip))
...
class TimepointAwaitOp(_ods_ir.OpView):
  ...
  def __init__(self, results_, resource_operands, resource_operand_sizes, await_timepoint, *, affinity=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def timepoint_await(results_, resource_operands, resource_operand_sizes, await_timepoint, *, affinity=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(TimepointAwaitOp(results_=results_, resource_operands=resource_operands, resource_operand_sizes=resource_operand_sizes, await_timepoint=await_timepoint, affinity=affinity, loc=loc, ip=ip))
...
def timepoint_barrier(resource, resource_size, *, affinity=None, loc=None, ip=None) -> _Sequence[_SubClassValueT]:
  return _get_op_result_or_op_results(TimepointBarrierOp(resource=resource, resource_size=resource_size, affinity=affinity, loc=loc, ip=ip))
...
def timepoint_chain_external(await_timepoint, external_values, *, affinity=None, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(TimepointChainExternalOp(await_timepoint=await_timepoint, external_values=external_values, affinity=affinity, loc=loc, ip=ip))
...
def timepoint_export(results_, await_timepoint, *, affinity=None, loc=None, ip=None) -> _SubClassValueT:
...
def timepoint_immediate(*, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(TimepointImmediateOp(loc=loc, ip=ip))
...
def timepoint_import(operands_, *, affinity=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(TimepointImportOp(operands_=operands_, affinity=affinity, loc=loc, ip=ip))
...
def timepoint_join(await_timepoints, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(TimepointJoinOp(await_timepoints=await_timepoints, loc=loc, ip=ip))
...
def yield_(resource_operands, resource_operand_sizes, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(YieldOp(resource_operands=resource_operands, resource_operand_sizes=resource_operand_sizes, loc=loc, ip=ip))
