...
def align(value, alignment, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(AlignOp(value=value, alignment=alignment, loc=loc, ip=ip))
...
def buffer_alloc(storage_size, *, alignment=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(BufferAllocOp(storage_size=storage_size, alignment=alignment, loc=loc, ip=ip))
...
def buffer_compare(lhs, lhs_size, lhs_offset, rhs, rhs_size, rhs_offset, length, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(BufferCompareOp(lhs=lhs, lhs_size=lhs_size, lhs_offset=lhs_offset, rhs=rhs, rhs_size=rhs_size, rhs_offset=rhs_offset, length=length, loc=loc, ip=ip))
...
def buffer_constant(value, *, name=None, alignment=None, mime_type=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(BufferConstantOp(value=value, name=name, alignment=alignment, mime_type=mime_type, loc=loc, ip=ip))
...
def buffer_copy(source, source_size, source_offset, target, target_size, target_offset, length, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(BufferCopyOp(source=source, source_size=source_size, source_offset=source_offset, target=target, target_size=target_size, target_offset=target_offset, length=length, loc=loc, ip=ip))
...
def buffer_dealloc(operand, operand_size, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(BufferDeallocOp(operand=operand, operand_size=operand_size, loc=loc, ip=ip))
...
def buffer_fill(pattern, target, target_size, target_offset, length, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(BufferFillOp(pattern=pattern, target=target, target_size=target_size, target_offset=target_offset, length=length, loc=loc, ip=ip))
...
def buffer_load(result, source, source_size, source_offset, length, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(BufferLoadOp(result=result, source=source, source_size=source_size, source_offset=source_offset, length=length, loc=loc, ip=ip))
...
def buffer_size(operand, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(BufferSizeOp(operand=operand, loc=loc, ip=ip))
...
def buffer_slice(source, source_size, source_offset, result_size, *, alignment=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(BufferSliceOp(source=source, source_size=source_size, source_offset=source_offset, result_size=result_size, alignment=alignment, loc=loc, ip=ip))
...
def buffer_storage(result, offset, operand, operand_size, *, loc=None, ip=None) -> _Sequence[_SubClassValueT]:
  return _get_op_result_or_op_results(BufferStorageOp(result=result, offset=offset, operand=operand, operand_size=operand_size, loc=loc, ip=ip))
...
def buffer_store(source, target, target_size, target_offset, length, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(BufferStoreOp(source=source, target=target, target_size=target_size, target_offset=target_offset, length=length, loc=loc, ip=ip))
...
def buffer_subspan(source, source_size, source_offset, result_size, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(BufferSubspanOp(source=source, source_size=source_size, source_offset=source_offset, result_size=result_size, loc=loc, ip=ip))
...
def cast(result, operand, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(CastOp(result=result, operand=operand, loc=loc, ip=ip))
...
def cmp_eq(lhs, rhs, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(CmpEQOp(lhs=lhs, rhs=rhs, loc=loc, ip=ip))
...
def global_load_indirect(result, global_, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(GlobalLoadIndirectOp(result=result, global_=global_, loc=loc, ip=ip))
...
def global_load(result, global_, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(GlobalLoadOp(result=result, global_=global_, loc=loc, ip=ip))
...
class GlobalOp(_ods_ir.OpView):
  ...
  def __init__(self, sym_name, type_, *, sym_visibility=None, is_mutable=None, initial_value=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def global_(sym_name, type_, *, sym_visibility=None, is_mutable=None, initial_value=None, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(GlobalOp(sym_name=sym_name, type_=type_, sym_visibility=sym_visibility, is_mutable=is_mutable, initial_value=initial_value, loc=loc, ip=ip))
...
def global_store_indirect(value, global_, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(GlobalStoreIndirectOp(value=value, global_=global_, loc=loc, ip=ip))
...
def global_store(value, global_, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(GlobalStoreOp(value=value, global_=global_, loc=loc, ip=ip))
...
class InitializerOp(_ods_ir.OpView):
  ...
  def __init__(self, function_type, *, arg_attrs=None, res_attrs=None, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_553')) else
      _ods_ir.AttrBuilder.get('anonymous_553')(function_type, context=_ods_context))
...
def initializer_return(*, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(InitializerReturnOp(loc=loc, ip=ip))
...
def list_create(result, *, initial_capacity=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(ListCreateOp(result=result, initial_capacity=initial_capacity, loc=loc, ip=ip))
...
def list_get(result, list, index, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(ListGetOp(result=result, list=list, index=index, loc=loc, ip=ip))
...
def list_set(list, index, value, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(ListSetOp(list=list, index=index, value=value, loc=loc, ip=ip))
...
def list_size(list, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(ListSizeOp(list=list, loc=loc, ip=ip))
...
def null(result, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(NullOp(result=result, loc=loc, ip=ip))
...
def numeric_optional_narrow(operand, semantic_type, *, min_value=None, max_value=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(NumericOptionalNarrowOp(operand=operand, semantic_type=semantic_type, min_value=min_value, max_value=max_value, loc=loc, ip=ip))
...
def optimization_barrier(results_, operands_, *, loc=None, ip=None) -> _SubClassValueT:
...
def range_extents(offsets, lengths, *, loc=None, ip=None) -> _Sequence[_SubClassValueT]:
  return _get_op_result_or_op_results(RangeExtentsOp(offsets=offsets, lengths=lengths, loc=loc, ip=ip))
...
def range_max(operands_, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(RangeMaxOp(operands_=operands_, loc=loc, ip=ip))
...
def range_min(operands_, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(RangeMinOp(operands_=operands_, loc=loc, ip=ip))
...
def sizeof(sized_type, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(SizeOfOp(sizedType=sized_type, loc=loc, ip=ip))
...
def status_check_ok(status, *, message=None, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(StatusCheckOkOp(status=status, message=message, loc=loc, ip=ip))
...
def switch(index, default_value, values, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(SwitchOp(index=index, default_value=default_value, values=values, loc=loc, ip=ip))
...
def unfoldable_constant(result, value, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(UnfoldableConstantOp(result=result, value=value, loc=loc, ip=ip))
...
def unreachable(message, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(UnreachableOp(message=message, loc=loc, ip=ip))
