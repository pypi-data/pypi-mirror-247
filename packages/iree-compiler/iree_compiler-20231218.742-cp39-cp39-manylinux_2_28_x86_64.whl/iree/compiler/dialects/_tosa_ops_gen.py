...
def abs(output, input1, *, loc=None, ip=None) -> _SubClassValueT:
...
def add(output, input1, input2, *, loc=None, ip=None) -> _SubClassValueT:
...
def apply_scale(output, value, multiplier, shift, double_round, *, loc=None, ip=None) -> _SubClassValueT:
...
def argmax(output, input, axis, *, loc=None, ip=None) -> _SubClassValueT:
...
def arithmetic_right_shift(output, input1, input2, round, *, loc=None, ip=None) -> _SubClassValueT:
...
class AvgPool2dOp(_ods_ir.OpView):
  ...
  def __init__(self, output, input, kernel, stride, pad, acc_type, *, quantization_info=None, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_514')) else
      _ods_ir.AttrBuilder.get('anonymous_514')(acc_type, context=_ods_context))
...
def avg_pool2d(output, input, kernel, stride, pad, acc_type, *, quantization_info=None, loc=None, ip=None) -> _SubClassValueT:
...
def bitwise_and(output, input1, input2, *, loc=None, ip=None) -> _SubClassValueT:
...
def bitwise_not(output, input1, *, loc=None, ip=None) -> _SubClassValueT:
...
def bitwise_or(output, input1, input2, *, loc=None, ip=None) -> _SubClassValueT:
...
def bitwise_xor(output, input1, input2, *, loc=None, ip=None) -> _SubClassValueT:
...
def cast(output, input, *, loc=None, ip=None) -> _SubClassValueT:
...
def ceil(output, input1, *, loc=None, ip=None) -> _SubClassValueT:
...
def clamp(output, input, min_int, max_int, min_fp, max_fp, *, loc=None, ip=None) -> _SubClassValueT:
...
def clz(output, input1, *, loc=None, ip=None) -> _SubClassValueT:
...
def concat(input1, axis, *, loc=None, ip=None) -> _SubClassValueT:
...
def const(value, *, loc=None, ip=None) -> _SubClassValueT:
...
class Conv2DOp(_ods_ir.OpView):
  ...
  def __init__(self, output, input, weight, bias, pad, stride, dilation, *, quantization_info=None, local_bound=None, loc=None, ip=None):
    ...
    if local_bound is not None: attributes["local_bound"] = (local_bound if (
        issubclass(type(local_bound), _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('BoolAttr')) else
...
def conv2d(output, input, weight, bias, pad, stride, dilation, *, quantization_info=None, local_bound=None, loc=None, ip=None) -> _SubClassValueT:
...
def conv3d(output, input, weight, bias, pad, stride, dilation, *, quantization_info=None, local_bound=None, loc=None, ip=None) -> _SubClassValueT:
...
def custom(outputs, operator_name, domain_name, implementation_attrs, inputs, *, loc=None, ip=None) -> _SubClassValueT:
...
def depthwise_conv2d(output, input, weight, bias, pad, stride, dilation, *, quantization_info=None, local_bound=None, loc=None, ip=None) -> _SubClassValueT:
...
def div(output, input1, input2, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(DivOp(output=output, input1=input1, input2=input2, loc=loc, ip=ip))
...
def equal(input1, input2, *, loc=None, ip=None) -> _SubClassValueT:
...
def erf(output, input, *, loc=None, ip=None) -> _SubClassValueT:
...
def exp(output, input1, *, loc=None, ip=None) -> _SubClassValueT:
...
def fft2d(output_real, output_imag, input_real, input_imag, inverse, *, local_bound=None, loc=None, ip=None) -> _Sequence[_SubClassValueT]:
...
def floor(output, input1, *, loc=None, ip=None) -> _SubClassValueT:
...
def fully_connected(output, input, weight, bias, *, quantization_info=None, loc=None, ip=None) -> _SubClassValueT:
...
def gather(output, values, indices, *, loc=None, ip=None) -> _SubClassValueT:
...
def greater_equal(output, input1, input2, *, loc=None, ip=None) -> _SubClassValueT:
...
def greater(output, input1, input2, *, loc=None, ip=None) -> _SubClassValueT:
...
def identity(output, input1, *, loc=None, ip=None) -> _SubClassValueT:
...
def cond_if(output, cond, inputs, *, loc=None, ip=None) -> _SubClassValueT:
...
def log(output, input1, *, loc=None, ip=None) -> _SubClassValueT:
...
def logical_and(z, input1, input2, *, loc=None, ip=None) -> _SubClassValueT:
...
def logical_left_shift(output, input1, input2, *, loc=None, ip=None) -> _SubClassValueT:
...
def logical_not(output, input1, *, loc=None, ip=None) -> _SubClassValueT:
...
def logical_or(z, input1, input2, *, loc=None, ip=None) -> _SubClassValueT:
...
def logical_right_shift(output, input1, input2, *, loc=None, ip=None) -> _SubClassValueT:
...
def logical_xor(z, input1, input2, *, loc=None, ip=None) -> _SubClassValueT:
...
def matmul(c, a, b, *, quantization_info=None, loc=None, ip=None) -> _SubClassValueT:
...
def max_pool2d(output, input, kernel, stride, pad, *, loc=None, ip=None) -> _SubClassValueT:
...
def maximum(output, input1, input2, *, loc=None, ip=None) -> _SubClassValueT:
...
def minimum(output, input1, input2, *, loc=None, ip=None) -> _SubClassValueT:
...
def mul(output, input1, input2, shift, *, loc=None, ip=None) -> _SubClassValueT:
...
def negate(output, input1, *, quantization_info=None, loc=None, ip=None) -> _SubClassValueT:
...
def pad(output, input1, padding, *, pad_const=None, quantization_info=None, loc=None, ip=None) -> _SubClassValueT:
...
def pow(z, input1, input2, *, loc=None, ip=None) -> _SubClassValueT:
...
def rfft2d(output_real, output_imag, input, *, local_bound=None, loc=None, ip=None) -> _Sequence[_SubClassValueT]:
...
def reciprocal(output, input1, *, loc=None, ip=None) -> _SubClassValueT:
...
def reduce_all(input, axis, *, loc=None, ip=None) -> _SubClassValueT:
...
def reduce_any(input, axis, *, loc=None, ip=None) -> _SubClassValueT:
...
def reduce_max(input, axis, *, loc=None, ip=None) -> _SubClassValueT:
...
def reduce_min(input, axis, *, loc=None, ip=None) -> _SubClassValueT:
...
def reduce_prod(input, axis, *, loc=None, ip=None) -> _SubClassValueT:
...
def reduce_sum(input, axis, *, loc=None, ip=None) -> _SubClassValueT:
...
def rescale(output, input, input_zp, output_zp, multiplier, shift, scale32, double_round, per_channel, *, loc=None, ip=None) -> _SubClassValueT:
...
def reshape(input1, new_shape, *, loc=None, ip=None) -> _SubClassValueT:
...
def resize(output, input, scale, offset, border, mode, *, loc=None, ip=None) -> _SubClassValueT:
...
def reverse(output, input, axis, *, loc=None, ip=None) -> _SubClassValueT:
...
def rsqrt(output, input1, *, loc=None, ip=None) -> _SubClassValueT:
...
def scatter(values_out, values_in, indices, input, *, loc=None, ip=None) -> _SubClassValueT:
...
def select(output, pred, on_true, on_false, *, loc=None, ip=None) -> _SubClassValueT:
...
def sigmoid(output, input, *, loc=None, ip=None) -> _SubClassValueT:
...
def slice(output, input, start, size, *, loc=None, ip=None) -> _SubClassValueT:
...
def sub(output, input1, input2, *, loc=None, ip=None) -> _SubClassValueT:
...
def table(output, input, table, *, loc=None, ip=None) -> _SubClassValueT:
...
def tanh(output, input, *, loc=None, ip=None) -> _SubClassValueT:
...
def tile(output, input1, multiples, *, loc=None, ip=None) -> _SubClassValueT:
...
def transpose_conv2d(output, input, filter, bias, out_pad, stride, out_shape, *, quantization_info=None, local_bound=None, loc=None, ip=None) -> _SubClassValueT:
...
def transpose(output, input1, perms, *, loc=None, ip=None) -> _SubClassValueT:
...
def variable_read(value, name, *, loc=None, ip=None) -> _SubClassValueT:
...
def while_loop(output, inputs, *, loc=None, ip=None) -> _SubClassValueT:
