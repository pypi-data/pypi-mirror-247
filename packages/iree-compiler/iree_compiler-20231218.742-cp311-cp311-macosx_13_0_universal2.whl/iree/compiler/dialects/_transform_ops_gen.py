...
def alternatives(results_, num_alternatives, *, scope=None, loc=None, ip=None) -> _SubClassValueT:
...
class ApplyConversionPatternsOp(_ods_ir.OpView):
  ...
  def __init__(self, target, num_default_type_converter_region, *, legal_ops=None, illegal_ops=None, legal_dialects=None, illegal_dialects=None, partial_conversion=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
    ...
    if legal_ops is not None: attributes["legal_ops"] = (legal_ops if (
        issubclass(type(legal_ops), _ods_ir.Attribute) or
    ...
    if illegal_ops is not None: attributes["illegal_ops"] = (illegal_ops if (
        issubclass(type(illegal_ops), _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('StrArrayAttr')) else
    ...
    if legal_dialects is not None: attributes["legal_dialects"] = (legal_dialects if (
        issubclass(type(legal_dialects), _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('StrArrayAttr')) else
    ...
    if illegal_dialects is not None: attributes["illegal_dialects"] = (illegal_dialects if (
        issubclass(type(illegal_dialects), _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('StrArrayAttr')) else
...
def apply_conversion_patterns(target, num_default_type_converter_region, *, legal_ops=None, illegal_ops=None, legal_dialects=None, illegal_dialects=None, partial_conversion=None, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(ApplyConversionPatternsOp(target=target, num_default_type_converter_region=num_default_type_converter_region, legal_ops=legal_ops, illegal_ops=illegal_ops, legal_dialects=legal_dialects, illegal_dialects=illegal_dialects, partial_conversion=partial_conversion, loc=loc, ip=ip))
...
class ApplyPatternsOp(_ods_ir.OpView):
  ...
  def __init__(self, target, *, apply_cse=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def apply_patterns(target, *, apply_cse=None, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(ApplyPatternsOp(target=target, apply_cse=apply_cse, loc=loc, ip=ip))
...
def apply_registered_pass(result, target, pass_name, *, options=None, loc=None, ip=None) -> _SubClassValueT:
...
class ForeachMatchOp(_ods_ir.OpView):
  ...
  def __init__(self, updated, root, matchers, actions, *, restrict_root=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def foreach_match(updated, root, matchers, actions, *, restrict_root=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(ForeachMatchOp(updated=updated, root=root, matchers=matchers, actions=actions, restrict_root=restrict_root, loc=loc, ip=ip))
...
def foreach(results_, target, *, loc=None, ip=None) -> _SubClassValueT:
...
def get_consumers_of_result(consumers, target, result_number, *, loc=None, ip=None) -> _SubClassValueT:
...
def get_defining_op(result, target, *, loc=None, ip=None) -> _SubClassValueT:
...
class GetParentOp(_ods_ir.OpView):
  ...
  def __init__(self, parent, target, *, isolated_from_above=None, allow_empty_results=None, op_name=None, deduplicate=None, nth_parent=None, loc=None, ip=None):
    ...
    if nth_parent is not None: attributes["nth_parent"] = (nth_parent if (
        issubclass(type(nth_parent), _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('I64Attr')) else
...
def get_parent_op(parent, target, *, isolated_from_above=None, allow_empty_results=None, op_name=None, deduplicate=None, nth_parent=None, loc=None, ip=None) -> _SubClassValueT:
...
def get_producer_of_operand(producer, target, operand_number, *, loc=None, ip=None) -> _SubClassValueT:
...
def get_result(result, target, result_number, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(GetResultOp(result=result, target=target, result_number=result_number, loc=loc, ip=ip))
...
def get_type(type_param, value, *, elemental=None, loc=None, ip=None) -> _SubClassValueT:
...
def include(results_, target, failure_propagation_mode, operands_, *, loc=None, ip=None) -> _SubClassValueT:
...
def merge_handles(handles, *, deduplicate=None, loc=None, ip=None) -> _SubClassValueT:
...
class NamedSequenceOp(_ods_ir.OpView):
  ...
  def __init__(self, sym_name, function_type, *, sym_visibility=None, arg_attrs=None, res_attrs=None, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_466')) else
      _ods_ir.AttrBuilder.get('anonymous_466')(function_type, context=_ods_context))
...
def param_constant(param, value, *, loc=None, ip=None) -> _SubClassValueT:
...
def print_(*, target=None, name=None, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(PrintOp(target=target, name=name, loc=loc, ip=ip))
...
def replicate(replicated, pattern, handles, *, loc=None, ip=None) -> _SubClassValueT:
...
def select(result, target, op_name, *, loc=None, ip=None) -> _SubClassValueT:
...
def sequence(results_, failure_propagation_mode, extra_bindings, *, root=None, loc=None, ip=None) -> _SubClassValueT:
...
def split_handle(results_, handle, *, pass_through_empty_handle=None, fail_on_payload_too_small=None, overflow_result=None, loc=None, ip=None) -> _SubClassValueT:
