            ...
            if not sub_goal:
                ...
                # If no sub-goal -> find best match of description from env 
                    ...
                    if not self.observed_states:
                        ...
                        self.observed_states = live_env.helios.observed_states.copy()
                        # for obs in env.helios.observed_states:
                        #     if obs not in self.observed_states:
                        #         self.observed_states[obs] = env.helios.observed_states[obs]
                        #observed_states = env.helios.observed_states
