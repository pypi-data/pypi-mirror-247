...
class TableQLearningAgent(QLearningAgent):
    ...
    def policy(self, state: Tensor, legal_actions: list) -> str:
        ...
        #     if self.debugging:
        #         print("\n --- Best known action value less than or equal to zero: ")
        #         print(list(self.q_table_max[state_tuple].items())[0:5])
        #     action_code = random.choice(legal_actions)
    ...
    # Danilo check - added total q and fixed these to correctly separate player side's learning
