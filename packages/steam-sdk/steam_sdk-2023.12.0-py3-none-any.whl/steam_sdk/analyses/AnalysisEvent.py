...
def get_number_of_magnets(circuit_name: str, simulation_name: str, circuit_type: str):
    """
...
def get_signal_keys_from_configurations_file(yaml_file_path,circuit_type):
    """
