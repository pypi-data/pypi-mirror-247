...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'ltyp.atyp': {},
            ...
            'ltyp.data': { 'ltyp.data.boolindex': ('data.html#boolindex', 'ltyp/data.py'),
            ...
            'ltyp.iter': { 'ltyp.iter.iterbool': ('iter.html#iterbool', 'ltyp/iter.py'),
                           'ltyp.iter.iternum': ('iter.html#iternum', 'ltyp/iter.py'),
                           'ltyp.iter.iterstr': ('iter.html#iterstr', 'ltyp/iter.py')},
