...
from anylearn.utils import DEFAULT_ANYLEARN_HOST, get_config_path
from anylearn.utils.api import raise_for_status
...
def _prompt_login(host: str) -> Optional[Auth]:
    ...
    if auth:
        print(f"Login to {host} as {auth.username} succeeded.")
    else:
