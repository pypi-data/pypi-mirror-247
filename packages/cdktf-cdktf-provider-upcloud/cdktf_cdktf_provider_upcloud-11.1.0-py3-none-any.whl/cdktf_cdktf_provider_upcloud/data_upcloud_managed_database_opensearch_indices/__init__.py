...
Refer to the Terraform Registory for docs: [`data_upcloud_managed_database_opensearch_indices`](https://registry.terraform.io/providers/upcloudltd/upcloud/3.3.0/docs/data-sources/managed_database_opensearch_indices).
'''
import abc
import builtins
import datetime
