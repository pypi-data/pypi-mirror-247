...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='waymo_open_dataset/protos/occupancy_flow_metrics.proto',
...
_OCCUPANCYFLOWMETRICS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='num_waypoints_with_observed_occupancy', full_name='waymo.open_dataset.OccupancyFlowMetrics.num_waypoints_with_observed_occupancy', index=0,
      number=8, type=5, cpp_type=1, label=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='num_waypoints_with_occluded_occupancy', full_name='waymo.open_dataset.OccupancyFlowMetrics.num_waypoints_with_occluded_occupancy', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='num_waypoints_with_flow', full_name='waymo.open_dataset.OccupancyFlowMetrics.num_waypoints_with_flow', index=2,
      number=10, type=5, cpp_type=1, label=1,
      has_default_value=True, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='vehicles_observed_auc', full_name='waymo.open_dataset.OccupancyFlowMetrics.vehicles_observed_auc', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='vehicles_observed_iou', full_name='waymo.open_dataset.OccupancyFlowMetrics.vehicles_observed_iou', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='vehicles_occluded_auc', full_name='waymo.open_dataset.OccupancyFlowMetrics.vehicles_occluded_auc', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='vehicles_occluded_iou', full_name='waymo.open_dataset.OccupancyFlowMetrics.vehicles_occluded_iou', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='vehicles_flow_epe', full_name='waymo.open_dataset.OccupancyFlowMetrics.vehicles_flow_epe', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='vehicles_flow_warped_occupancy_auc', full_name='waymo.open_dataset.OccupancyFlowMetrics.vehicles_flow_warped_occupancy_auc', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='vehicles_flow_warped_occupancy_iou', full_name='waymo.open_dataset.OccupancyFlowMetrics.vehicles_flow_warped_occupancy_iou', index=9,
...
OccupancyFlowTaskConfig = _reflection.GeneratedProtocolMessageType('OccupancyFlowTaskConfig', (_message.Message,), {
  ...
  '__module__' : 'waymo_open_dataset.protos.occupancy_flow_metrics_pb2'
