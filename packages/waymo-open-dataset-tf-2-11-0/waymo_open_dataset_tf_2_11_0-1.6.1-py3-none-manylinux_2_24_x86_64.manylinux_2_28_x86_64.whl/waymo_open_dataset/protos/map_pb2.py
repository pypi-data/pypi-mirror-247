...
_MAPFEATURE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='driveway', full_name='waymo.open_dataset.MapFeature.driveway', index=7,
...
_BOUNDARYSEGMENT = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='lane_start_index', full_name='waymo.open_dataset.BoundarySegment.lane_start_index', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='lane_end_index', full_name='waymo.open_dataset.BoundarySegment.lane_end_index', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='boundary_feature_id', full_name='waymo.open_dataset.BoundarySegment.boundary_feature_id', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='boundary_type', full_name='waymo.open_dataset.BoundarySegment.boundary_type', index=3,
...
_LANENEIGHBOR = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='feature_id', full_name='waymo.open_dataset.LaneNeighbor.feature_id', index=0,
      number=1, type=3, cpp_type=2, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='self_start_index', full_name='waymo.open_dataset.LaneNeighbor.self_start_index', index=1,
      number=2, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='self_end_index', full_name='waymo.open_dataset.LaneNeighbor.self_end_index', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='neighbor_start_index', full_name='waymo.open_dataset.LaneNeighbor.neighbor_start_index', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='neighbor_end_index', full_name='waymo.open_dataset.LaneNeighbor.neighbor_end_index', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='boundaries', full_name='waymo.open_dataset.LaneNeighbor.boundaries', index=5,
...
_LANECENTER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='entry_lanes', full_name='waymo.open_dataset.LaneCenter.entry_lanes', index=4,
    ...
    _descriptor.FieldDescriptor(
      name='exit_lanes', full_name='waymo.open_dataset.LaneCenter.exit_lanes', index=5,
      ...
      serialized_options=_b('\020\001'), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='left_boundaries', full_name='waymo.open_dataset.LaneCenter.left_boundaries', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='right_boundaries', full_name='waymo.open_dataset.LaneCenter.right_boundaries', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='left_neighbors', full_name='waymo.open_dataset.LaneCenter.left_neighbors', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='right_neighbors', full_name='waymo.open_dataset.LaneCenter.right_neighbors', index=9,
...
_DRIVEWAY = _descriptor.Descriptor(
  name='Driveway',
  full_name='waymo.open_dataset.Driveway',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='polygon', full_name='waymo.open_dataset.Driveway.polygon', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
