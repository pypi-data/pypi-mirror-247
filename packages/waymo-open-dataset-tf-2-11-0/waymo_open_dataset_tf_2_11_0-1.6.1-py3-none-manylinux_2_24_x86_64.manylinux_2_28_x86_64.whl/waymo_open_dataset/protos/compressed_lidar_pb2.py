...
_COMPRESSEDRANGEIMAGE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='range_image_delta_compressed', full_name='waymo.open_dataset.CompressedRangeImage.range_image_delta_compressed', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='range_image_pose_delta_compressed', full_name='waymo.open_dataset.CompressedRangeImage.range_image_pose_delta_compressed', index=1,
...
_METADATA = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='shape', full_name='waymo.open_dataset.Metadata.shape', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='quant_precision', full_name='waymo.open_dataset.Metadata.quant_precision', index=1,
...
_DELTAENCODEDDATA = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='residual', full_name='waymo.open_dataset.DeltaEncodedData.residual', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='mask', full_name='waymo.open_dataset.DeltaEncodedData.mask', index=1,
      ...
      serialized_options=_b('\020\001'), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='metadata', full_name='waymo.open_dataset.DeltaEncodedData.metadata', index=2,
...
_COMPRESSEDLASER = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='waymo.open_dataset.CompressedLaser.name', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='ri_return1', full_name='waymo.open_dataset.CompressedLaser.ri_return1', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='ri_return2', full_name='waymo.open_dataset.CompressedLaser.ri_return2', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_COMPRESSEDFRAMELASERDATA = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='lasers', full_name='waymo.open_dataset.CompressedFrameLaserData.lasers', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='laser_calibrations', full_name='waymo.open_dataset.CompressedFrameLaserData.laser_calibrations', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='pose', full_name='waymo.open_dataset.CompressedFrameLaserData.pose', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_COMPRESSEDLASER.fields_by_name['name'].enum_type = waymo__open__dataset_dot_dataset__pb2._LASERNAME_NAME
...
_COMPRESSEDFRAMELASERDATA.fields_by_name['laser_calibrations'].message_type = waymo__open__dataset_dot_dataset__pb2._LASERCALIBRATION
_COMPRESSEDFRAMELASERDATA.fields_by_name['pose'].message_type = waymo__open__dataset_dot_dataset__pb2._TRANSFORM
...
CompressedRangeImage = _reflection.GeneratedProtocolMessageType('CompressedRangeImage', (_message.Message,), {
  'DESCRIPTOR' : _COMPRESSEDRANGEIMAGE,
  '__module__' : 'waymo_open_dataset.protos.compressed_lidar_pb2'
...
DeltaEncodedData = _reflection.GeneratedProtocolMessageType('DeltaEncodedData', (_message.Message,), {
...
CompressedLaser = _reflection.GeneratedProtocolMessageType('CompressedLaser', (_message.Message,), {
...
CompressedFrameLaserData = _reflection.GeneratedProtocolMessageType('CompressedFrameLaserData', (_message.Message,), {
