...
_MOTIONMETRICSBUNDLE_CUSTOMMETRICSENTRY = _descriptor.Descriptor(
  name='CustomMetricsEntry',
  full_name='waymo.open_dataset.MotionMetricsBundle.CustomMetricsEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='waymo.open_dataset.MotionMetricsBundle.CustomMetricsEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='value', full_name='waymo.open_dataset.MotionMetricsBundle.CustomMetricsEntry.value', index=1,
...
_MOTIONMETRICSBUNDLE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='soft_mean_average_precision', full_name='waymo.open_dataset.MotionMetricsBundle.soft_mean_average_precision', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='custom_metrics', full_name='waymo.open_dataset.MotionMetricsBundle.custom_metrics', index=8,
  ...
  nested_types=[_MOTIONMETRICSBUNDLE_CUSTOMMETRICSENTRY, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_MOTIONMETRICSBUNDLE_CUSTOMMETRICSENTRY.containing_type = _MOTIONMETRICSBUNDLE
...
_MOTIONMETRICSBUNDLE.fields_by_name['custom_metrics'].message_type = _MOTIONMETRICSBUNDLE_CUSTOMMETRICSENTRY
