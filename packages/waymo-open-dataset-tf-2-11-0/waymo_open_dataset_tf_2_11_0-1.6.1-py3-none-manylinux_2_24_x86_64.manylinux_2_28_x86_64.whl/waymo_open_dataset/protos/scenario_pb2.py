...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[waymo__open__dataset_dot_protos_dot_compressed__lidar__pb2.DESCRIPTOR,waymo__open__dataset_dot_protos_dot_map__pb2.DESCRIPTOR,])
...
_DYNAMICMAPSTATE.fields_by_name['lane_states'].message_type = waymo__open__dataset_dot_protos_dot_map__pb2._TRAFFICSIGNALLANESTATE
...
_SCENARIO.fields_by_name['map_features'].message_type = waymo__open__dataset_dot_protos_dot_map__pb2._MAPFEATURE
_SCENARIO.fields_by_name['tracks_to_predict'].message_type = _REQUIREDPREDICTION
_SCENARIO.fields_by_name['compressed_frame_laser_data'].message_type = waymo__open__dataset_dot_protos_dot_compressed__lidar__pb2._COMPRESSEDFRAMELASERDATA
