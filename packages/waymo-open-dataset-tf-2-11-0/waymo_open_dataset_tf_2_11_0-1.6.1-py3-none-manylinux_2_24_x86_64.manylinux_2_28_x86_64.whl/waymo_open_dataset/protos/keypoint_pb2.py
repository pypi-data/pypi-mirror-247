...
_KEYPOINT2D.fields_by_name['location_px'].message_type = waymo__open__dataset_dot_protos_dot_vector__pb2._VECTOR2D
_KEYPOINT2D.fields_by_name['visibility'].message_type = _KEYPOINTVISIBILITY
_KEYPOINT3D.fields_by_name['location_m'].message_type = waymo__open__dataset_dot_protos_dot_vector__pb2._VECTOR3D
