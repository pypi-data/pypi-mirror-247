...
_LABEL.fields_by_name['laser_keypoints'].message_type = waymo__open__dataset_dot_protos_dot_keypoint__pb2._LASERKEYPOINTS
_LABEL.fields_by_name['camera_keypoints'].message_type = waymo__open__dataset_dot_protos_dot_keypoint__pb2._CAMERAKEYPOINTS
