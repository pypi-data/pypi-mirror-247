...
project_urls = {
    'Website': 'https://github.com/rijenkii/aiorwlock',
    'Issues': 'https://github.com/rijenkii/aiorwlock/issues',
}


setup(
    name='rijenkii-aiorwlock',
    ...
    url='https://github.com/rijenkii/aiorwlock',
