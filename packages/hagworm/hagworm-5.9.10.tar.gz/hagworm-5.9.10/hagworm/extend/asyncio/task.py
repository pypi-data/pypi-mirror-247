...
from .redis import LuaLock, RedisPool, RedisClusterPool
...
class DCSCronTask(TaskInterface):
    ...
    def __init__(
        ...
        self._task_lock: LuaLock = redis_client.allocate_lock(f'dcs_cron_task:{name}', timeout=60)
        self._task_func: typing.Callable = func

        self._heartbeat: IntervalTask = IntervalTask.create(30, self._do_heartbeat)
