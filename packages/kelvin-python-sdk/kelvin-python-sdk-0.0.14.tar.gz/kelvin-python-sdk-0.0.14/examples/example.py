...
from kelvin.message import Boolean, ControlChange, KRNAsset, KRNAssetDataStream, Message, Number, Recommendation, String
...
async def main() -> None:
    ...
    await app.connect()
    print("App and asset parameters available after connect", app.app_configuration, app.asset_parameters)
