...
if __name__ == "__main__":
    ...
    with DMSql() as dm:
        ...
        dm.delete(f'delete from APPLY where id = 1314286443279175680;'
                 f'delete from APPLY_DETAIL where APPLY_ID = 1314286443279175680;'
                 f'delete from OPERATE_RECORD where BUSINESS_ID = 1314286443279175680;')
    # print(result)
