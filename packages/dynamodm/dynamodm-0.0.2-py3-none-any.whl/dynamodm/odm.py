...
class DynamoDB(LazyProxy[Session], Generic[D]):
    ...
    def create_table(self) -> None:
        ...
        """
        self.client.create_table(  # type: ignore
        ...
        self.client.get_waiter("table_exists").wait(TableName=self.__table_name__)
    ...
    def drop_table(self) -> None:
        ...
        - None
        """
        self.client.delete_table(TableName=self.__table_name__)
    ...
    def put(self: DynamoDB[D], instance: D) -> None:
        ...
        """
        tablename = self.__table_name__
        self.client.put_item(TableName=tablename, Item=self.serialize(instance))  # type: ignore
    ...
    def delete(self: DynamoDB[D], pk: str, sk: str) -> None:
        ...
        Args:
            ...
            sk (str): The sort key.
        """
        self.client.delete_item(  # type: ignore
            TableName=self.__table_name__,
            Key={
...
class DynaModel(BaseModel):
    ...
    def get(cls: Type[D], pk: str, sk: str) -> D:
        ...
        """
        prefix = cls.__name__ + "#"
        return cls.db.get(prefix + pk, sk)  # type: ignore / MyPy complains
    ...
    def query(
        ...
        """
        prefix = cls.__name__ + "#"
        return cls.db.query(prefix + pk, sk, operator)  # type: ignore / MyPy complains
    ...
    def scan(cls: Type[D], **kwargs: Any) -> List[D]:
        ...
        - List[D]: The list of models.
        """
        return cls.db.scan(**kwargs)  # type: ignore
