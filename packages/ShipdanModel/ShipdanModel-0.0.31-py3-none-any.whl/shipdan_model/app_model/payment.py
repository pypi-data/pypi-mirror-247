...
class Order(models.Model):
    ...
    refunded_price = models.IntegerField(default=0, help_text='환불된 금액')
...
class OrderRefundLog(models.Model):
    order = models.ForeignKey(Order, on_delete=models.CASCADE, related_name='order_refund_logs')
    amount = models.IntegerField()
    content = models.TextField()
    pg_uid = models.CharField(max_length=100, help_text='PG사 승인번호')
