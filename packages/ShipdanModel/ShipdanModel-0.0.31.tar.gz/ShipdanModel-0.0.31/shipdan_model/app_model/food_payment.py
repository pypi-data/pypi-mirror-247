...
class OrderFoodProductRelation(models.Model):
    ...
    refund_quantity = models.IntegerField(default=0, help_text='환불완료된 상품 개수')
    refund_request_quantity = models.IntegerField(default=0, help_text='환불요청 하려는 상품 개수')
...
class OrderPointRelation(models.Model):
    # todo: related_name points_rel로 변경해야함.
