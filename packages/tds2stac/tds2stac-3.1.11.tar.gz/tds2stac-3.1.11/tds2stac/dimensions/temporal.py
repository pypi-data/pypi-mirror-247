...
class Temporal(object):
    def regulator(self, main_dict, temporal_format_by_dataname, data_name):
        ...
        if (
            ...
            and not main_dict["temporal_extent_start_datetime"].isspace()
            ...
            (
                ...
                or main_dict["temporal_extent_start_datetime"].isspace()
            )
            ...
            errors.append(
                "Start DateTime is None in the given dataset. Please review your `tag_config.json` file or use `temporal_format_by_dataname` attr to the date of your data will be read from file names and harverst again."
            )
        if (
            main_dict["temporal_extent_end_datetime"] is not None
            and not main_dict["temporal_extent_end_datetime"].isspace()
        ) and temporal_format_by_dataname is None:
            ...
            and (
                main_dict["temporal_extent_end_datetime"] is not None
                or main_dict["temporal_extent_end_datetime"].isspace()
            )
            and temporal_format_by_dataname is not None
        ):
            try:
            ...
            main_dict["temporal_extent_end_datetime"] is None
            or main_dict.get("temporal_extent_end_datetime").isspace()
        ) and temporal_format_by_dataname is None:
            errors.append(
                "End DateTime is None in the given dataset. Please review your `tag_config.json` file or use `temporal_format_by_dataname` attr to the date of your data will be read from file names and harvest again."
            )

        if (
            main_dict["temporal_extent_start_datetime"] is not None
            and main_dict["temporal_extent_end_datetime"] is not None
            and not main_dict["temporal_extent_start_datetime"].isspace()
            and not main_dict["temporal_extent_end_datetime"].isspace()
        ):
            try:
            ...
            errors.append(
                "Start or End DateTime is None in the given dataset. Please review your `tag_config.json` file or use `temporal_format_by_dataname` attr to the date of your data will be read from file names and harvest again."
            )
