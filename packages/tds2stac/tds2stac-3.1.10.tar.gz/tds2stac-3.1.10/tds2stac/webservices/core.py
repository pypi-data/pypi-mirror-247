...
class WebServiceContentScraper(object):
    ...
    def __init__(
        ...
        for extension in extensions_list:
            self.harvester(root, ncml_json, extension, harvesting_vars)
        ...
        for k, v in json_file[ext_name].items():
            ...
            if v is not None and isinstance(v, dict):
                ...
                if v["tds2stac_mode_analyser"] == "str":
                    ...
                    self.logger_properties[
                        "logger_msg"
                    ] = f"The list of {k} is empty or in a wrong format. Check the `tag_config.json` file."
                    Logger(self.logger_properties)
                    harvesting_vars[k] = (
                    ...
                    if v.get("tds2stac_reference_key") is not None:
                        ...
                        self.logger_properties[
                            "logger_msg"
                        ] = "Using `tds2stac_reference_key` is not recommended. It's better to use `tds2stac_webservice_analyser` instead."
                        Logger(self.logger_properties)
                                ...
                                if v1 is None:
                                    ...
                                    for k2, v2 in v1.items():
                                        ...
                                        # like  [[... ,... ], [... ,... ]].
                                            ...
                                            self.logger_properties[
                                                "logger_msg"
                                            ] = "It contains more than one null in the nested dict and you have to choose one of them. Revise your `tag_config.json` file."
                                            Logger(self.logger_properties)
                        ...
                        if namespaces_ != {}:
                                    ...
                                    if a.xpath(".//*") != []:
                                        ...
                                        for xx in a.xpath(".//*"):
                                            if (
                                                ...
                                                self.logger_properties[
                                                    "logger_msg"
                                                ] = "The `tds2stac_reference_key` is not valid. Check the `tag_config.json` file."
                                                Logger(self.logger_properties)
                                                continue
                            ...
                            if len(list_of_all_tags_with_none) == 0:
                                ...
                                self.logger_properties[
                                    "logger_msg"
                                ] = "It couldn't find any tag for the considered tag element. It means you should check the tag element name in the `tag_config.json` file."
                                Logger(self.logger_properties)
                                continue
                            elif (
