...
class Spatial(object):
    def regulator(self, main_dict, spatial_information):
        ...
        if (
            ...
            errors.append(
                "Minimum Longitude is None in the given dataset. Please review your `tag_config.json` file or use `spatial_information` attr to add the spatial coordinate"
            )
        ...
        if (
            ...
            errors.append(
                "Maximum Longitude is None in the given dataset. Please review your `tag_config.json` file or use `spatial_information` attr to add the spatial coordinate"
            )
        ...
        if (
            ...
            errors.append(
                "Minimum Latitude is None in the given dataset. Please review your `tag_config.json` file or use `spatial_information` attr to add the spatial coordinate"
            )
        ...
        if (
            ...
            errors.append(
                "Maximum Latitude is None in the given dataset. Please review your `tag_config.json` file or use `spatial_information` attr to add the spatial coordinate"
            )
        if errors == []:
    ...
    def harvester(self, main_dict, linestring=None):
        ...
        if (
            ...
            if main_dict["collection_footprint"] is None:
                main_dict["collection_footprint"] = main_dict["item_footprint"]
            main_dict["collection_footprint"] = geometry.shape(
                main_dict["item_footprint"]
            ).union(geometry.shape(main_dict["collection_footprint"]))
            main_dict["collection_bbox"] = list(
                main_dict["collection_footprint"].bounds
            )
        else:
