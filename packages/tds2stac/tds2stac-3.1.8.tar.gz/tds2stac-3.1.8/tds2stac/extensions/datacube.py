    ...
    def item_extension(
        ...
        if len(harvesting_vars["variable_ids"]) != len(variable_dimensions):
            ...
            self.logger_properties[
                "logger_msg"
            ] = "The length of the variable's IDs list and the variable's dimensions list are not equal. Check your dataset in Thredds or correct keys in your `tag_config.json` file to produce new lists."
        ...
        if all(
            ...
            logger_properties["logger_level"] = "ERROR"
            for key in list_of_required_keys:
                logger_string_output = (
                    logger_string_output
            ...
            logger_properties[
                "logger_msg"
            ] = f"Required attributes aren't involved in the output dictionary. Check your dataset in Thredds or check the following lists and reconfig your `tag_config.json` file. {logger_string_output}"
