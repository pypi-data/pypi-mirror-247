...
class Datacube(object):
    ...
    def item_extension(
        ...
        if all(
            ...
            logger_properties[
                "logger_msg"
            ] = f"Required vertical attributes for aren't involved in the output dictionary. Check your dataset in Thredds or check the following lists and reconfig your `tag_config.json` file. {logger_string_output}"
            # Logger(logger_properties)
