...
class N2PModelContent:
    ...
    def get_free_edges(self,
        ...
        the tuple will only be searched in that domain. Notice that connectors, although may be given in the domain, are never 
        included in the free edges.
    ...
    def new_derived_loadcase(self, name: str, formula: str) -> N2PLoadCase:
        ...
        py_lc = N2PLoadCase(cs_lc.ID, cs_lc.IDOriginal, cs_lc.Increments, cs_lc.IncrementsNumberList, cs_lc.IsComplex,
                            cs_lc.TypeLoadCase, cs_lc.Name, cs_lc.Results, cs_lc.SolutionType, self, cs_lc)
