...
from lusid_scheduler.extensions.retry import (
    RetryingRestWrapper,
...
from lusid_scheduler.extensions.socket_keep_alive import keep_alive_socket_options
from lusid_scheduler.extensions.tcp_keep_alive_connector import (
...
class SyncApiClientFactory:
    ...
    def build(
        ...
        ----------
        metaclass : Type[T]
            A lusid_scheduler.api class.


        Returns
        -------
        T
            An instance of the lusid_scheduler.api class with a configured ApiClient
        """
