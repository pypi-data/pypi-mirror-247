...
def pg1():
    ...
    file_name = os.path.join(current_path, 'pg1.py')
    with open(file_name, 'w') as file:
        file.write(r"""from sklearn.datasets import load_iris
...
for i in range(len(y_test)):
    if y_pred[i] == y_test[i]:
        print(f"Correct prediction: {x_test[i]} is class {names[y_pred[i]]}")
    else:
        print(f"Wrong prediction: {x_test[i]} is classified as {names[y_pred[i]]}, expected is {names[y_test[i]]}")
...
def pg2():
    current_path = os.getcwd()
    file_name = os.path.join(current_path, 'pg2.py')
    with open(file_name, 'w') as file:
        file.write(r"""import pandas as pd
import numpy as np
from sklearn.datasets import load_iris
...
def pg3():
    current_path = os.getcwd()
    file_name = os.path.join(current_path, 'pg3.py')
    with open(file_name, 'w') as file:
        file.write(r"""import numpy as np
import pandas as pd
import matplotlib.pyplot as plt
...
def pg4():
    current_path = os.getcwd()
    file_name = os.path.join(current_path, 'pg4.py')
    with open(file_name, 'w') as file:
        file.write(r"""import numpy as np
...
def pg5():
    current_path = os.getcwd()
    file_name = os.path.join(current_path, 'pg5.py')
    with open(file_name, 'w') as file:
        file.write(r"""import random
import numpy as np
...
for gen in range(10):
    ...
    for i in range(int(pop_size / 2)):
        ...
        nextgen_population += [mutation(offspring1), mutation(offspring2)]
...
def pg6():
    current_path = os.getcwd()
    file_name = os.path.join(current_path, 'pg6.py')
    with open(file_name, 'w') as file:
        file.write(r"""import pandas as pd
import numpy as np
