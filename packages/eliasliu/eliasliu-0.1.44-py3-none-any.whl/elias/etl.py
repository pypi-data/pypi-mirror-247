...
def sql_to_mail(m_id,mission_name,name,robot_key,sql,hosts,username,password,receivers=[],accs=[],subject='test',contents='test',hosts_records = u.all_hosts('bi_report')):
    '''
    ...
    try:
        u.Email_send(username, password, subject, contents, receivers=receivers, accs=accs, links={}, file_pathname=file_name, smtp='exmail')
