...
class Job(object):
    ...
    def metadata(self):
        ...
        TODO this doesn't seem like it should be a part of the job as it cannot be known by a client ahead of time.  # noqa: E501

        :return: The metadata of this Job.  # noqa: E501
        :rtype: AllOfJobMetadata
        """
