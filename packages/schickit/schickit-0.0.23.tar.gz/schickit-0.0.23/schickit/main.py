...
def main():
    ...
    count = subparsers1.add_parser('count', help='count')
    count.add_argument('-o', '--output', help='save path',
                        default='/cluster/home/Kangwen/Hic/data_new/sn_m3c_hg38/GSE130711')
    count.add_argument('-f', '--fastq', 
                        default='/cluster/home/Kangwen/Hic/data_new/sn_m3c_hg38/GSE130711', 
                        help='fastq_dir, run all if -s is not be specfied',)
    count.add_argument('--logging', help='logging', default='./sn_m3c_rees.log')
    count.add_argument('-t', '--type',
                        choices=['scHic', 'snHic','sciHic','scSPRITE','dipC','sn_m3c','HIRES', 'scNano'],
                         help='type of hic',default='sn_m3c', )
    count.add_argument('-e', '--enzyme', help='enzyme,mboi',nargs='+',type=str,
                        default='MboI')
    count.add_argument('-r', '--resolution', help='resoluation', default=10000)
    count.add_argument('-i', '--index', help='bwa fa file/bowtie fa file',
                        default='/cluster/home/Kangwen/common/bowtie2/hg38/hg38.fa', )
    count.add_argument('-s', '--sample', help='sample, txt',
                        default=None)
    count.add_argument('--exist-barcode' , action='store_true', help='barcode is exist')
    ...
    count.add_argument('--thread', help='thread', type=int, default=10)
    count.add_argument('--worker', help='simouteously run the worker of the pipeline', type=int, default=1)
    ...
    count.add_argument('--aligner', default='bowtie2', choices=['bwa', ' bowtie2'], help='aligner')
    count.add_argument('--repeat-masker', help='repeat masker(bed file) for scSPRITE', default='/cluster/home/Kangwen/common/mm10_rmsk.bed')
    count.add_argument('--sprite-config', help='sprite-config', default='/cluster/home/Kangwen/Hic/seq/4_scSPRITE/Code/config_dpm6_y-stag_scSPRITE2.txt')
    count.add_argument('--scNano-barcode',default='/cluster/home/Kangwen/Hic/data_new/scNano/barcode',
    ...
    index = subparsers1.add_parser('index', help='index')
