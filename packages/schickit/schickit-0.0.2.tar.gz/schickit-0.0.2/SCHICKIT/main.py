...
def main():
    ...
    parser.add_argument('--thread', help='thread', type=int, default=10)
    parser.add_argument('--worker', help='simouteously run the worker of the pipeline', type=int, default=1)
    ...
    parser.add_argument('--repeat-masker', help='repeat masker(bed file) for scSPRITE')
    parser.add_argument('--sprite-config', help='sprite-config')
    parser.add_argument('--scNano-barcode',help='scNano barcode for PCR and TN5, which should be stored in a folder and named as TN5.txt and PRC,index.txt.txt respectively')
    parser.add_argument('--zoomify-res', help='zoomify',type=str, default='10000,40000,100000,500000')
