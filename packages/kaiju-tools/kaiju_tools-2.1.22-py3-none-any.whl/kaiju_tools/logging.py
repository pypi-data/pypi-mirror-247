...
from kaiju_tools.encoding import ENCODERS, MimeTypes
...
class Logger(logging.Logger):
    ...
    def _log(
        ...
        **kws,
        ...
        if ctx:
            extra.update({'_cid': ctx['correlation_id'], '_sid': ctx['session_id']})
        extra['_data'] = kws
...
class DataFormatter(TextFormatter):
    ...
    def format(self, record):
        """Format log record."""
        return self._encoder.dumps(self.create_message(record))  # noqa
