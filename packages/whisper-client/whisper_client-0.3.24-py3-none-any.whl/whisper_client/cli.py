...
try:
    ...
    Gooey = lambda x: x  # Dummy decorator
...
parser.add_argument("-f", "--folder", default=False, help="Folder mode", action="store_true")
...
@Gooey
def cli(parser: GooeyParser = parser) -> None:
...
def manage_output(
    ...
    if isinstance(res, list) and isinstance(modes, list):
