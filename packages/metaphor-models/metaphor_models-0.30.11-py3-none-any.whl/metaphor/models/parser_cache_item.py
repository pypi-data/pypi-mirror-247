...
class GroupInfo:
    ...
    """Backing store for the aspect creation date"""
    aspect_type: Optional[AspectType] = None
    group_info_created_at: Optional[datetime] = None
    email: Optional[str] = None
    entity_id: Optional[str] = None
    id: Optional[str] = None
    members: Optional[List[str]] = None
    metaphor_managed: Optional[bool] = None
    name: Optional[str] = None
    ...
    def from_dict(obj: Any) -> 'GroupInfo':
        ...
        created_at = from_union([from_datetime, from_none], obj.get("_createdAt"))
        aspect_type = from_union([AspectType, from_none], obj.get("aspectType"))
        group_info_created_at = from_union([from_datetime, from_none], obj.get("createdAt"))
        email = from_union([from_str, from_none], obj.get("email"))
        entity_id = from_union([from_str, from_none], obj.get("entityId"))
        id = from_union([from_str, from_none], obj.get("id"))
        members = from_union([lambda x: from_list(from_str, x), from_none], obj.get("members"))
        metaphor_managed = from_union([from_bool, from_none], obj.get("metaphorManaged"))
        name = from_union([from_str, from_none], obj.get("name"))
        subgroups = from_union([lambda x: from_list(from_str, x), from_none], obj.get("subgroups"))
        return GroupInfo(created_at, aspect_type, group_info_created_at, email, entity_id, id, members, metaphor_managed, name, subgroups)
    ...
    def to_dict(self) -> dict:
        ...
        if self.aspect_type is not None:
            result["aspectType"] = from_union([lambda x: to_enum(AspectType, x), from_none], self.aspect_type)
        if self.group_info_created_at is not None:
            result["createdAt"] = from_union([lambda x: x.isoformat(), from_none], self.group_info_created_at)
        ...
        if self.metaphor_managed is not None:
            result["metaphorManaged"] = from_union([from_bool, from_none], self.metaphor_managed)
        if self.name is not None:
            result["name"] = from_union([from_str, from_none], self.name)
        if self.subgroups is not None:
            result["subgroups"] = from_union([lambda x: from_list(from_str, x), from_none], self.subgroups)
        return result
...
class HierarchyInfo:
    ...
    def from_dict(obj: Any) -> 'HierarchyInfo':
        ...
        return HierarchyInfo(created_at, aspect_type, hierarchy_info_created_at, description, entity_id, id, power_bi_workspace, type)
...
class ParsedLineage:
    ...
    """Backing store for the aspect creation date"""
    aspect_type: Optional[AspectType] = None
    parsed_lineage_created_at: Optional[datetime] = None
    entity_id: Optional[str] = None
    field_mappings: Optional[List[FieldMapping]] = None
    id: Optional[str] = None
    source_entities: Optional[List[str]] = None
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'ParsedLineage':
        assert isinstance(obj, dict)
        created_at = from_union([from_datetime, from_none], obj.get("_createdAt"))
        aspect_type = from_union([AspectType, from_none], obj.get("aspectType"))
        parsed_lineage_created_at = from_union([from_datetime, from_none], obj.get("createdAt"))
        entity_id = from_union([from_str, from_none], obj.get("entityId"))
        field_mappings = from_union([lambda x: from_list(FieldMapping.from_dict, x), from_none], obj.get("fieldMappings"))
        id = from_union([from_str, from_none], obj.get("id"))
        source_entities = from_union([lambda x: from_list(from_str, x), from_none], obj.get("sourceEntities"))
        transformation = from_union([from_str, from_none], obj.get("transformation"))
        return ParsedLineage(created_at, aspect_type, parsed_lineage_created_at, entity_id, field_mappings, id, source_entities, transformation)
    ...
    def to_dict(self) -> dict:
        ...
        if self.aspect_type is not None:
            result["aspectType"] = from_union([lambda x: to_enum(AspectType, x), from_none], self.aspect_type)
        if self.parsed_lineage_created_at is not None:
            result["createdAt"] = from_union([lambda x: x.isoformat(), from_none], self.parsed_lineage_created_at)
        if self.entity_id is not None:
            result["entityId"] = from_union([from_str, from_none], self.entity_id)
        if self.field_mappings is not None:
            result["fieldMappings"] = from_union([lambda x: from_list(lambda x: to_class(FieldMapping, x), x), from_none], self.field_mappings)
...
class PowerBIDataset:
    ...
    def from_dict(obj: Any) -> 'PowerBIDataset':
        ...
        url = from_union([from_str, from_none], obj.get("url"))
        workspace_id = from_union([from_str, from_none], obj.get("workspaceId"))
        return PowerBIDataset(created_at, aspect_type, configured_by, power_bi_dataset_created_at, created_date, description, endorsement, entity_id, id, last_refreshed, name, refresh_schedule, sensitivity_label, source_datasets, tables, url, workspace_id)
...
class DatasetSchema:
    ...
    def from_dict(obj: Any) -> 'DatasetSchema':
        ...
        tags = from_union([lambda x: from_list(from_str, x), from_none], obj.get("tags"))
        return DatasetSchema(created_at, aspect_type, dataset_schema_created_at, description, entity_id, fields, id, last_modified, raw_schema, schema_type, sql_schema, tags)
...
class Upstream:
    ...
    def from_dict(obj: Any) -> 'Upstream':
        ...
        source_code_url = from_union([from_str, from_none], obj.get("sourceCodeUrl"))
        transformation = from_union([from_str, from_none], obj.get("transformation"))
        return Upstream(created_at, aspect_type, upstream_created_at, entity_id, id, source_datasets, source_virtual_views, executor_url, field_mappings, source_code_url, transformation)
...
class Entity:
    ...
    Any FAILED, or WARNING status of upstreams will cause the overall data quality WARN
    """
    parsed_lineage: Optional[ParsedLineage] = None
    """Stores the lineage information generated by parser"""
    ...
    def from_dict(obj: Any) -> 'Entity':
        ...
        parsed_lineage = from_union([ParsedLineage.from_dict, from_none], obj.get("parsedLineage"))
        ...
        return Entity(created_at, id, versioned_id, asset_contacts, asset_followers, asset_governed_tags, entity_created_at, dashboard_info, deleted_at, display_name, entity_type, entity_upstream, force_shown, entity_id, is_complete, is_deleted, is_non_prod, is_production, last_ingested_at, last_modified_at, logical_id, overall_data_quality, parsed_lineage, source_info, structure, system_contacts, system_tags, upstream, entity_versioned_id, custom_metadata, data_quality, description_assignment, documentation, field_associations, field_statistics, ownership_assignment, pipeline_info, schema, snowflake_stream_info, soda_data_quality, statistics, tag_assignment, unity_catalog, usage, dbt_metric, azure_data_factory_pipeline, fivetran, power_bi_dataflow, spark, dbt_model, full_name, looker_explore, looker_view, power_bi_dataset, tableau_datasource, thought_spot, hierarchy_info, asset_likes, group_info, organization)
    ...
    def to_dict(self) -> dict:
        ...
        if self.parsed_lineage is not None:
            result["parsedLineage"] = from_union([lambda x: to_class(ParsedLineage, x), from_none], self.parsed_lineage)
...
class MapStringString:
    ...
    to_string_tag_4872: Optional[str] = None
    size: Optional[float] = None

    @staticmethod
    def from_dict(obj: Any) -> 'MapStringString':
        assert isinstance(obj, dict)
        to_string_tag_4872 = from_union([from_str, from_none], obj.get("__@toStringTag@4872"))
        size = from_union([from_float, from_none], obj.get("size"))
        return MapStringString(to_string_tag_4872, size)

    def to_dict(self) -> dict:
        result: dict = {}
        if self.to_string_tag_4872 is not None:
            result["__@toStringTag@4872"] = from_union([from_str, from_none], self.to_string_tag_4872)
