...
class DatasetUpstream:
    ...
    def from_dict(obj: Any) -> 'DatasetUpstream':
        ...
        source_datasets = from_union([lambda x: from_list(from_str, x), from_none], obj.get("sourceDatasets"))
        transformation = from_union([from_str, from_none], obj.get("transformation"))
        return DatasetUpstream(created_at, aspect_type, dataset_upstream_created_at, entity_id, executor_url, field_mappings, id, source_code_url, source_datasets, transformation)
...
class Hierarchy:
    ...
    def from_dict(obj: Any) -> 'Hierarchy':
        ...
        return Hierarchy(created_at, id, versioned_id, asset_contacts, asset_followers, asset_governed_tags, hierarchy_created_at, deleted_at, display_name, entity_type, hierarchy_info, hierarchy_id, is_deleted, last_ingested_at, last_modified_at, logical_id, system_tags, hierarchy_versioned_id)
...
class InputOrOutputType1:
    ...
    def from_dict(obj: Any) -> 'InputOrOutputType1':
        ...
        return InputOrOutputType1(asset_description, change_request, column_description, comment, data_document, deprecation, incident, type, usage)
...
class Metric:
    ...
    def from_dict(obj: Any) -> 'Metric':
        ...
        return Metric(created_at, id, versioned_id, asset_contacts, asset_followers, asset_governed_tags, metric_created_at, dbt_metric, deleted_at, display_name, entity_type, entity_upstream, force_shown, metric_id, is_complete, is_deleted, is_non_prod, is_production, last_ingested_at, last_modified_at, logical_id, metric_info, parsed_lineage, system_contacts, metric_versioned_id)
...
class Pipeline:
    ...
    def from_dict(obj: Any) -> 'Pipeline':
        ...
        return Pipeline(created_at, id, versioned_id, asset_contacts, asset_followers, asset_governed_tags, azure_data_factory_pipeline, pipeline_created_at, deleted_at, display_name, entity_type, entity_upstream, fivetran, force_shown, pipeline_id, is_complete, is_deleted, is_non_prod, is_production, last_ingested_at, last_modified_at, logical_id, parsed_lineage, power_bi_dataflow, spark, system_contacts, pipeline_versioned_id)
