...
class Workflow(BaseHandler):
    ...
    def get_by_id(self):
        ...
        result = (
            self.create_query(Methods.GET, f"/{self.workflow_guid}")
            .set_params(self.payload_params)
            .execute()
        )
        return TruStarResponse(
    ...
    def delete(self):
        ...
        self._raise_if_workflow_id_is_not_set_up()
        result = (
            self.create_query(Methods.DELETE, f"/{self.workflow_guid}")
            .set_params(self.payload_params)
            .execute()
        )
        return TruStarResponse(
    ...
    def update(self):
        ...
        self._raise_if_workflow_id_is_not_set_up()
        result = (
            self.create_query(Methods.PUT, f"/{self.workflow_guid}")
            .set_params(self.payload_params)
            .execute()
        )
        return TruStarResponse(
