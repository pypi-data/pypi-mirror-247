...
class SearchHandler(BaseHandler):
    ...
    def _get_value(arg, enum):
        ...
        raise AttributeError(f"Possible value types are: {list(enum.members())}")
    ...
    def set_enclave_ids(self, enclave_guids):
        self.set_payload_param(SearchEnum.ENCLAVE_GUIDS.value,
                               self._argument_to_unique_list(enclave_guids))
