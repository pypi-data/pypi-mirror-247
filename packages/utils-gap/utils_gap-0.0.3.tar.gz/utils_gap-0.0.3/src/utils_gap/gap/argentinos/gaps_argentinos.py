import pandas as pd
from src.utils_gap.gap.calcular_gaps import calcular_gaps
from src.utils_gap.gap.filtrar_gaps import filtrar_gaps
from src.utils_gap.fuentes_argentinas.fuentes_gap import FuentesGAP
