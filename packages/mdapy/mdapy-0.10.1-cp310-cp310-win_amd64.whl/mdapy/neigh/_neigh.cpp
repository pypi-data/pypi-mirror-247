...
void _build_cell_rec(py::array cpos, py::array catom_cell_list, py::array ccell_id_list, py::array corigin, py::array cncel, double bin_length)
{
...
void _build_cell_rec_with_jishu(py::array cpos, py::array catom_cell_list, py::array ccell_id_list, py::array corigin, py::array cncel, double bin_length, py::array cmax_neigh_list)
{
...
void _build_cell_tri(py::array cpos, py::array catom_cell_list, py::array ccell_id_list, py::array cbox, py::array cncel, double bin_length)
{
...
void _build_cell_tri_with_jishu(py::array cpos, py::array catom_cell_list, py::array ccell_id_list, py::array cbox, py::array cncel, double bin_length, py::array cmax_neigh_list)
{
