...
with open(os.path.join(package, "requirements.txt"), "r") as fileObj:
    for line in fileObj.readlines():
        ...
        if mod:
            ...
            if mod not in exclude_in_termux:
                install_requires_termux.append(mod)
...
setup(
    ...
    install_requires=install_requires_termux if os.path.expanduser("~") == "/data/data/com.termux/files/home" else install_requires,
    entry_points={
        "console_scripts": [
