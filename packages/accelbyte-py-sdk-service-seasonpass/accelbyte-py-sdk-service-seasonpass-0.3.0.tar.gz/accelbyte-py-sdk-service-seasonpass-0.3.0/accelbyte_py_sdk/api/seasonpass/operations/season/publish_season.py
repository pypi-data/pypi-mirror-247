...
class PublishSeason(Operation):
    ...
    _url: str = "/seasonpass/admin/namespaces/{namespace}/seasons/{seasonId}/publish"
    _method: str = "PUT"
    ...
    def with_namespace(self, value: str) -> PublishSeason:
        self.namespace = value
        return self

    def with_season_id(self, value: str) -> PublishSeason:
