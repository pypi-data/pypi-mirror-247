...
class ListUserSeasonInfoPagingSlicedResult(Model):
    ...
    def with_data(
        self, value: List[ListUserSeasonInfo]
    ...
    def create_from_dict(
        ...
        if "data" in dict_ and dict_["data"] is not None:
            instance.data = [
                ListUserSeasonInfo.create_from_dict(i0, include_empty=include_empty)
    ...
    def create_many_from_dict(
        cls, dict_: dict, include_empty: bool = False
    ) -> Dict[str, ListUserSeasonInfoPagingSlicedResult]:
        return (
    ...
    ) -> List[ListUserSeasonInfoPagingSlicedResult]:
        return (
    ...
    def create_from_any(
        ...
        ListUserSeasonInfoPagingSlicedResult,
        List[ListUserSeasonInfoPagingSlicedResult],
        Dict[Any, ListUserSeasonInfoPagingSlicedResult],
    ]:
        if many:
