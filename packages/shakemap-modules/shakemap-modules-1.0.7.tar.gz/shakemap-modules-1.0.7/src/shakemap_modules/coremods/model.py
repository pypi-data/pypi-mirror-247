...
import pandas as pd
from esi_core.shakemap.covariance_matrix import make_sd_array, make_sigma_matrix
...
class ModelModule(CoreModule):
    ...
    def execute(self, indir=None, outdir=None):
        ...
        # ---------------------------------------------------------------------
        self._setInputContainer(indir=indir)
    ...
    def _setInputContainer(self, indir=None):
        """
