...
def bake(
        ...
        *,
        ...
        channel_types: typing.Optional[typing.Any] = {
            'BBONE', 'LOCATION', 'ROTATION', 'SCALE'
        }):
    ''' Bake all selected objects location/scale/rotation animation to an action :File: `startup/bl_operators/anim.py\:262 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/anim.py#L262>`__
