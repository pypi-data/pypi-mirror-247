def color(clr):
    ...
    try:
        ...
        print(f"\033[1;33mInvalid Argument: '{clr}' is not a valid text color.\nConsequence: Text will be printed without changes.\033[0m")
        return("")
...
def style(styl):
    ...
    try:
        ...
        print(f"\033[1;33mInvalid Argument: '{styl}' is not a valid text style.\nConsequence: Text will be printed without changes.\033[0m")
        return("")
...
def bgcolor(bgclr):
    ...
    try:
        ...
        print(f"\033[1;33mInvalid Argument: '{bgclr}' is not a valid background color.\nConsequence: Text will be printed without changes.\033[0m")
        return("")
