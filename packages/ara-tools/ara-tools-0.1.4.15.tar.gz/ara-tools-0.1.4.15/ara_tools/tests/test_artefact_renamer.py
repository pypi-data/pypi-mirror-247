...
@patch("ara_tools.artefact_renamer.os.path.exists", side_effect=[True, True, False, False, True])
...
def test_rename_also_renames_related_data_folder(mock_exists, mock_rename, mock_open):
    ...
    assert mock_rename.call_count == 2
    mock_rename.assert_has_calls([
        call("ara/userstories/old_name.userstory", "ara/userstories/new_name.userstory"),
        call("ara/userstories/old_name.data", "ara/userstories/new_name.data")
    ])
