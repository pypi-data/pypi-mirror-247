...
from ara_tools.artefact_link_updater import ArtefactLinkUpdater  # Adjust this import path according to your setup
...
# Test case for updating link consistency within related artefact files


@patch("ara_tools.artefact_link_updater.os.listdir")
@patch("ara_tools.artefact_link_updater.os.path.isfile")
