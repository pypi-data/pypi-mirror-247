...
def step_remember_artefact_for_cleanup(context, artefact_name, classifier):
    artefact = Artefact(artefact_name, classifier)
    context.artefacts_to_cleanup.append(artefact)
