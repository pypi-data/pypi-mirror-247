...
class Config(BaseModel):
    dir: Path
    project: str
    scripts: Optional[List[ScriptConfig]] = None
    notebooks: Optional[List[NotebookConfig]] = None
    apis: Optional[List[APIConfig]] = None
    uis: Optional[List[UIConfig]] = None
    storage: Optional[List[StorageConfig]] = None
