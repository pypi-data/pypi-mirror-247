...
setuptools.setup(
    # TODO: Please update the name and delete this line i.e. XXX-local or XXX-remote (without the -python-package suffix) # noqa: E501
    name='source-data-local',
    version='0.0.6',  # https://pypi.org/project/source-data-local/
    author="Circles",
