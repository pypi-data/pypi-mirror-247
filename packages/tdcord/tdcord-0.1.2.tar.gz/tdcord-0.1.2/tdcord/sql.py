...
class DBHandler:
    ...
    **kwargs:
    ...
    .. code-block:: python3
            ...
            async with DBHandler("tdcord.db") as db:
                await db.exec("CREATE TABLE IF NOT EXISTS vip (id INTEGER PRIMARY KEY, name TEXT)")
                await db.exec("INSERT INTO vip (name) VALUES (?)", "Tdius")
    """
    ...
    async def exec(
        self, sql: str, *args, end: bool = False, **kwargs
    ) -> aiosqlite.Cursor:
