...
READY_TITLE: str = f"Bot is online with tdcord version {__version__}"
...
def box(
    infos: dict[str, str], colors: list[str], box_style: ReadyEvent, s: Style = Style()
):
