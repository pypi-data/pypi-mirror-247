...
from volstreet.config import logger, symbol_df
...
from volstreet.angel_interface.fetching import fetch_ltp
from volstreet.trade_interface.blocks import Straddle, Strangle, Option, OptionType
...
class Index:
    ...
    def get_basis_for_expiry(
        ...
        self.cached_basis[expiry] = adjusted_annualized_basis
    ...
    def get_active_strikes(self, range_of_strikes: int, offset: float = 0) -> list[int]:
        ltp = self.fetch_ltp()
