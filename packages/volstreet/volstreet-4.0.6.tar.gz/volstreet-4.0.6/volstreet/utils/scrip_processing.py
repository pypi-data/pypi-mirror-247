...
def get_expiry_dates(expiry_frequency: int):
    if expiry_frequency == "monthly":
        ...
        if nearest_monthly[0] - current_time() < timedelta(days=1):  # Special handling
            # On the day of monthly expiry because the weekly expiries will produce a different list
