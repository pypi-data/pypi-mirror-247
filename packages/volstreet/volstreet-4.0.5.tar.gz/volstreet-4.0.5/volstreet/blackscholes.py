...
from volstreet.config import iv_curve_model, expiry_day_model
import warnings
...
def simulate_iv(
    ...
    bs_logger.info(f"IV multiple post move: {iv_multiple_post_move}\n")
...
def simulate_price(
    ...
    bs_logger.info(f"**Simulate Price**\nNew IV: {new_iv}")
