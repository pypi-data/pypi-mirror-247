...
class BasePeliqanClient:
    ...
    def load_table(self, table_name='', query='', table_id=None, df=False, fillna_with=None, fillnat_with=None,
        ...
        return trino_db.fetch(db_name='', table_name=table_name, query=query, table_id=table_id, df=df,
    ...
    def get_refresh_table_status(self, connection_name=None, database_name=None, table_name=None, table_id=None,
                                 task_id=''):
    ...
    def refresh_connection(self, connection_name=None, connection_id=None, is_async=True):
    ...
    def refresh_table(self, connection_name=None, database_name=None, table_name=None, table_id=None, is_async=True):
