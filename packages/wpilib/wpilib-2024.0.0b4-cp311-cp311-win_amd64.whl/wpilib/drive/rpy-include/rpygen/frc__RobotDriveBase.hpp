...
struct PyTrampolineCfg_frc__RobotDriveBase :
...
using PyTrampolineBase_frc__RobotDriveBase =
...
template <typename PyTrampolineBase, typename PyTrampolineCfg>
struct PyTrampoline_frc__RobotDriveBase : PyTrampolineBase_frc__RobotDriveBase<PyTrampolineBase, PyTrampolineCfg> {
    using PyTrampolineBase_frc__RobotDriveBase<PyTrampolineBase, PyTrampolineCfg>::PyTrampolineBase_frc__RobotDriveBase;
