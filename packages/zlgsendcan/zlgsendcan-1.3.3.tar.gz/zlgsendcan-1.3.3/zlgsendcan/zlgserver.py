            ...
            for k, v in data.items():
                if k not in ['cycle_time', 'send_num', 'msg_id', 'is_crc']:
                    ...
                    if data['is_crc'] == '1':
                        ...
                        # dbc解析出来的数据
                        result = ob.dbc_parser()
                    data_obj, _ = canfd_msg(ob, result)
...
# 修改正在发送中的信号值
def update_signal_value(data_variable, message, signal, value: str, cycle_time=None):
    if cycle_time is not None:
        data_variable[message]['cycle_time'] = cycle_time
    data_variable[message][message][signal] = value
    ob = DbcInit(message, data_variable[message][message], GlobleValue.dbc_init)
    result = ob.dbc_parser()
    data_obj, _ = canfd_msg(ob, result)
...
if __name__ == '__main__':
    ...
    # uds=UDS('广汽')
    # contlist=['2E 01 00 80 03 8D 03 04 40 04 93 DA 00 ', '2E 01 01 33 4A 7E 17 3F 0C F9 02 00 00 91 CC 62 E2 70 78 FF 7F D7 B6 31 B4 02 3F 03 F0 EC 00 B0 99 35 A4 54 1E 1A 00 55 90 04 10 18 00 FF 00 ', '2E 01 02 B9 FF BF C2 99 D9 BF 09 C0 FF EF DF F3 F8 06 51 81 F3 CF C6 00 03 B3 00 00 0F 00 06 00 00 00 ', '2E 01 03 63 78 05 01 09 C8 B4 00 54 00 04 00 05 C8 C8 46 32 19 14 00 00 00 64 1E 00 C7 0A 1E 00 00 00 00 1E 1E 00 00 00 25 03 00 00 14 00 05 00 B4 03 02 00 00 ', '2E 01 11 8A BB FF 5A 50 F9 32 00 09 ', '2E 01 16 47 FF F6 FF D0 EF 7F FF FF FF 88 15 E1 EF 3D 20 04 00 ', '']
    # for con in contlist:
    # uds.can_send(zlg_init.zcanlib, zlg_init.chn_handle,config=con)
    # reset_device("1234567",get_adbpath())
    # 信号变化等差发送只需将对应的信号值改成{'步长':1,'最大值':1,'最小值':0}
    msgdata = {
        'GW_BSD_1_B': {'GW_BSD_1_B': {'RRR_RCWWarnType': '0'}, 'cycle_time': 50, 'msg_id': '0x311(785)', 'is_crc': '0',
                       'send_num': '-1'},
        'GW_CDC_1_B': {'GW_CDC_1_B': {'CDC_ProhibitChangingMode': '0'}, 'cycle_time': 100, 'msg_id': '0x2d8(728)',
                       'is_crc': '0', 'send_num': '-1'},
        'GW_BCS_2_B': {'GW_BCS_2_B': {'BCS_EBDFaultSt': '0'}, 'cycle_time': 10, 'msg_id': '0x260(608)', 'is_crc': '0',
                       'send_num': '-1'},
        'GW_VCU_1_B': {'GW_VCU_1_B': {'VCU_VehRdySt': '0'}, 'cycle_time': 100, 'msg_id': '0x350(848)', 'is_crc': '0',
                       'send_num': '-1'},
        'GW_ECAN_2_B': {'GW_ECAN_2_B': {'IPS_DCDCFaultLampInd': '1'}, 'cycle_time': 200, 'msg_id': '0x3e3(995)',
                        'is_crc': '0', 'send_num': '-1'},
        'BCM_TPMS_1': {'BCM_TPMS_1': {'TPMS_FLTyreWarn': '0'}, 'cycle_time': 100, 'msg_id': '0x325(805)', 'is_crc': '0',
                       'send_num': '-1'},
        'GW_EMS_1_B': {'GW_EMS_1_B': {'EMS_EngSt': '0', 'EMS_EngWaterTempVD': '1'}, 'cycle_time': 100,
                       'msg_id': '0x336(822)', 'is_crc': '0', 'send_num': '-1'},
        'GW_SRS_2_B': {'GW_SRS_2_B': {'SRS_DriverSeatBeltSt': '0'}, 'cycle_time': 100, 'msg_id': '0x330(816)',
                       'is_crc': '0', 'send_num': '-1'},
        'GW_EPB_1_B': {'GW_EPB_1_B': {'EPB_SysAudWarnReq': '0'}, 'cycle_time': 100, 'msg_id': '0x307(775)',
                       'is_crc': '0', 'send_num': '-1'},
        'PEPS_12': {'PEPS_12': {'PEPS_PsgSeatSts': '0'}, 'cycle_time': 100, 'msg_id': '0x3ea(1002)', 'is_crc': '0',
                    'send_num': '-1'},
        'GW_DMS_1_B': {'GW_DMS_1_B': {'DMS_DistrWarnSt': '0'}, 'cycle_time': 200, 'msg_id': '0x3c7(967)', 'is_crc': '0',
                       'send_num': '-1'},
        'GW_IFC_1_A_B': {'GW_IFC_1_A_B': {'IFC_LKS_TakeoverReq': '0'}, 'cycle_time': 50, 'msg_id': '0x3a3(931)',
                         'is_crc': '0', 'send_num': '-1'},
        'GW_IFC_MRR_1_B': {'GW_IFC_MRR_1_B': {'MRR_ObjectCapturedSt': '0'}, 'cycle_time': 100, 'msg_id': '0x312(786)',
                           'is_crc': '0', 'send_num': '-1'},
        'GW_EPS_1_B': {'GW_EPS_1_B': {'EPS_WarnLamp': '0'}, 'cycle_time': 100, 'msg_id': '0x348(840)', 'is_crc': '0',
                       'send_num': '-1'},
        'GW_BCS_3_B': {'GW_BCS_3_B': {'BCS_TCSOff': '0'}, 'cycle_time': 100, 'msg_id': '0x346(838)', 'is_crc': '0',
                       'send_num': '-1'}}
    for k, v in msgdata.items():
        ZlgSend(zlg_init, v, dbcpath)
    # 修改信号值
    # update_signal_value(msgdata,'GW_CDC_1_B','CDC_WarningLampReq','1')

    # 信号变化等差发送只需将对应的信号值改成{'步长':1,'最大值':1,'最小值':0}
    msgdata = {'SBM_5_B': {'SBM_5_B': {'SBM_OpIndicationWarning': '2'}, 'cycle_time': 100, 'msg_id': '0x3f5(1013)',
                           'is_crc': '0', 'send_num': '-1'}}
    for k, v in msgdata.items():
        ZlgSend(zlg_init, v, dbcpath)
    time.sleep(15.0)
