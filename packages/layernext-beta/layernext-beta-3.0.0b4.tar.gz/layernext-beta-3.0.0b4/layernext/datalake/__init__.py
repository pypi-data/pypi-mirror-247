...
class DatalakeClient:
    ...
    def upload_metadata_from_unique_name_json(self, file_path: str = None, json_data: dict = None):
        _metadata = Metadata(client=self)
        response = _metadata.upload_metadata_json(file_path=file_path, json_data=json_data)
        # print(response.get("message"))
        return response
    ...
    def upload_metadata_from_job_id(self, job_id: str, file_path: str = None, json_data: dict = None):
        ...
        response = _metadata.upload_metadata_json(file_path=file_path, json_data=json_data, job_id=job_id)
        # print(response.get("message"))
        return response
    ...
    def find_chunk(self, search_key_list: [str],
            unique_name_list: List[str], response_chunk_limit: int = 3, adjacent_chunk_limit: int = 0):
        payload = {
