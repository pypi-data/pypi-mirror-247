...
class TiersMode(sgqlc.types.Enum):
    __schema__ = schema
    __choices__ = ('GRADUATED', 'VOLUME', 'VOLUME_PER_UNIT')
...
class Environment(sgqlc.types.Type):
    __schema__ = schema
    __field_names__ = ('account', 'api_keys', 'color', 'created_at', 'description', 'display_name', 'harden_client_access_enabled', 'id', 'is_sandbox', 'permanent_deletion_date', 'provision_status', 'signing_token', 'slug')
