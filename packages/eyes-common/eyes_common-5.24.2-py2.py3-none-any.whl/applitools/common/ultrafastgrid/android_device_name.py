...
class AndroidDeviceName(Enum):
    ...
    def Galaxy_S20_PLUS(self):
        """`Galaxy_S20_PLUS` is deprecated. Use `Galaxy_S20_Plus` instead"""
        return self.Galaxy_S20_Plus

    Galaxy_S21_Ultra = "Galaxy S21 Ultra"

    @DeprecatedEnumVariant
    def Galaxy_S21_ULTRA(self):
        """`Galaxy_S21_ULTRA` is deprecated. Use `Galaxy_S21_Ultra` instead"""
        return self.Galaxy_S21_Ultra
    ...
    def Galaxy_S21_PLUS(self):
        """`Galaxy_S21_PLUS` is deprecated. Use `Galaxy_S21_Plus` instead"""
        return self.Galaxy_S21_Plus
