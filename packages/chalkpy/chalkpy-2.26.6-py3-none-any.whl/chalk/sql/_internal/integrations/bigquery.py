...
class BigQuerySourceImpl(BaseSQLSource):
    ...
    def compile_query(
        ...
        ast = sqlglot.parse_one(query_string, read=self.get_sqlglot_dialect())
    ...
    def execute_query_efficient(
        ...
        try:
            ...
            _logger.error(
                f"Failed to execute BigQuery query efficiently. Query: {finalized_query.query.text=}, {finalized_query.params=}",
                exc_info=e,
            )
