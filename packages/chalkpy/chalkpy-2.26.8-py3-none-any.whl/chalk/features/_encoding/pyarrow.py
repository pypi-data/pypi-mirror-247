...
def rich_to_pyarrow(
    python_type: Type, name: str, in_struct: bool = False, parent_namespaces: Tuple[str, ...] = ()
) -> pa.DataType:
    """
...
def _is_infinitely_recursive_features_class(parent_namespaces: Tuple[str, ...], typ: object) -> bool:
    """
