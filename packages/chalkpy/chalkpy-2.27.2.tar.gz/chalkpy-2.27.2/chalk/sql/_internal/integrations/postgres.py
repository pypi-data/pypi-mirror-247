...
class PostgreSQLSourceImpl(BaseSQLSource, TableIngestMixIn, SQLSourceWithTableIngestProtocol):
    ...
    def __init__(
        ...
        if name:
            ...
            connect_args_from_ui = engine_args_from_ui.get("connect_args", {})
            connect_args.update(connect_args_from_ui)
    ...
    def _get_result_csv_buffer(
        ...
        with _safe_trace("_get_result_csv_buffer"):
            ...
            if query_execution_parameters.postgres.skip_postgres_datetime_zone_cast:
                _logger.debug("skip datetime cast via 'CHALK_SKIP_PG_DATETIME_ZONE_CAST'")
    ...
    def execute_query_efficient(
        ...
        if query_execution_parameters is None:
            """Use defaults"""
            query_execution_parameters = QueryExecutionParameters(attempt_efficient_execution=True)
