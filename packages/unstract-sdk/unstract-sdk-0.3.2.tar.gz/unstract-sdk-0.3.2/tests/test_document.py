...
from unstract.sdk.documents import UnstractToolDocs
...
class UnstractToolDocsTest(unittest.TestCase):
    ...
    def test_insert_get_delete(self) -> None:
        ...
        result = docs.get(workflow_id="test", unique_file_id="test_unique_file_id2")
        print(result)
        self.assertIsNotNone(result)
        result = docs.delete(workflow_id="test", unique_file_id="test_unique_file_id2")
        self.assertTrue(result)
        result = docs.get(workflow_id="test", unique_file_id="test_unique_file_id2")
