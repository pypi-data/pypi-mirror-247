...
import requests
from unstract.connectors.filesystems.unstract_file_system import AbstractFileSystem
...
class UnstractToolDocs(UnstractPlatformBase):
    ...
    def index_file(
        ...
        """
        result = {"status": "ERROR", "error": "", "cost": 0, "unique_file_id": ""}
        upload_result = self._upload_file(file_path=file_path, fsspec_obj=fsspec_obj)
