...
class RepeatZoneItemAddOperator(RepeatZoneOperator, ZoneOperator,
                                ZoneItemAddOperator, bpy_types.Operator):
    active_index_name = None
    ''' '''
...
class RepeatZoneItemMoveOperator(RepeatZoneOperator, ZoneOperator,
                                 ZoneMoveItemOperator, bpy_types.Operator):
    active_index_name = None
    ''' '''
...
class RepeatZoneItemRemoveOperator(RepeatZoneOperator, ZoneOperator,
                                   ZoneItemRemoveOperator, bpy_types.Operator):
    active_index_name = None
    ''' '''
...
class SimulationZoneItemAddOperator(SimulationZoneOperator, ZoneOperator,
                                    ZoneItemAddOperator, bpy_types.Operator):
    active_index_name = None
    ''' '''
...
class SimulationZoneItemMoveOperator(SimulationZoneOperator, ZoneOperator,
                                     ZoneMoveItemOperator, bpy_types.Operator):
    active_index_name = None
    ''' '''
...
class SimulationZoneItemRemoveOperator(SimulationZoneOperator, ZoneOperator,
                                       ZoneItemRemoveOperator,
                                       bpy_types.Operator):
    active_index_name = None
    ''' '''
