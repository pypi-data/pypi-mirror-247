...
def channels_bake(
        ...
        *,
        ...
        remove_outside_range: typing.Optional[typing.Union[bool, typing.
                                                           Any]] = False,
        interpolation_type: typing.Optional[typing.Any] = 'BEZIER',
        bake_modifiers: typing.Optional[typing.Union[bool, typing.
                                                     Any]] = True):
...
def clear_useless_actions(
    ...
    ''' Mark actions with no F-Curves for deletion after save and reload of file preserving "action libraries" :File: `startup/bl_operators/anim.py\:337 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/anim.py#L337>`__
...
def keying_set_export(
    ...
    ''' Export Keying Set to a Python script :File: `startup/bl_operators/anim.py\:43 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/anim.py#L43>`__
...
def update_animated_transform_constraints(
        ...
        *,
        use_convert_to_radians: typing.Optional[typing.Union[bool, typing.
                                                             Any]] = True):
    ''' Update f-curves/drivers affecting Transform constraints (use it with files from 2.70 and earlier) :File: `startup/bl_operators/anim.py\:373 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/anim.py#L373>`__
