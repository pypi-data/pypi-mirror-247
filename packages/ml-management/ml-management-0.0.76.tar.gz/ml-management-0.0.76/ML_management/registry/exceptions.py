...
class ExperimentNotFoundName(RegistryException):
    ...
    def __reduce__(self):
        """Define reduce method to make exception picklable."""
        return (ExperimentNotFoundName, (self.experiment_name,))


class ExperimentNotFoundID(RegistryException):
    """Define Experiment not found exception."""
    ...
    def __reduce__(self):
        """Define reduce method to make exception picklable."""
        return (ExperimentNotFoundID, (self.experiment_id,))
