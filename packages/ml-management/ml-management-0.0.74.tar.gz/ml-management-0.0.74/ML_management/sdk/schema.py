...
class JobStatus(sgqlc.types.Enum):
    ...
    * `SUCCESSFUL`None
    ...
    __schema__ = schema
    __choices__ = ("FAILED", "PLANNED", "RUNNING", "SUCCESSFUL")
...
class JobSingleParameters(sgqlc.types.Input):
    __schema__ = schema
    __field_names__ = ("executor_params", "model_params", "data_params", "experiment_name", "cron_expression", "periodic_type", "gpu")
    executor_params = sgqlc.types.Field(sgqlc.types.non_null(ExecutorParamsInput), graphql_name="executorParams")
...
class BuildJob(sgqlc.types.Type):
    __schema__ = schema
    __field_names__ = ("start_timestamp", "end_timestamp", "exception", "docker_image_tag", "status")
    ...
    docker_image_tag = sgqlc.types.Field(String, graphql_name="dockerImageTag")
...
class DatasetLoaderVersion(sgqlc.types.Type):
    ...
    * `collector_name` (`String!`)None
    ...
    list_deployed_jobs = sgqlc.types.Field(
        sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null("ExecutionJob"))), graphql_name="listDeployedJobs"
    )
...
class Mutation(sgqlc.types.Type):
    ...
    * `new_name` (`String!`)None
    ...
    add_ml_job = sgqlc.types.Field(
        sgqlc.types.non_null(ExecutionJob),
    ...
    * `description` (`String!`)None
    ...
    rebuild_model_version_image = sgqlc.types.Field(
        sgqlc.types.non_null(String),
        graphql_name="rebuildModelVersionImage",
        args=sgqlc.types.ArgDict(
            (("model_version", sgqlc.types.Arg(sgqlc.types.non_null(ObjectVersionInput), graphql_name="modelVersion", default=None)),)
        ),
    )
...
class Query(sgqlc.types.Type):
    ...
    __field_names__ = (
        ...
        "pagination_initial_executor_version",
    )
    ...
    * `run_id` (`String!`)None
    ...
    pagination_initial_executor_version = sgqlc.types.Field(
        sgqlc.types.non_null(ExecutorVersionPagination),
        graphql_name="paginationInitialExecutorVersion",
        args=sgqlc.types.ArgDict(
            (
                ("limit", sgqlc.types.Arg(Int, graphql_name="limit", default=None)),
                ("offset", sgqlc.types.Arg(Int, graphql_name="offset", default=None)),
