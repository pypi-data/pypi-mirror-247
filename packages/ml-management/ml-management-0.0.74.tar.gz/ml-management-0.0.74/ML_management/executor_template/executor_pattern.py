...
class JobExecutorPattern(MultiModelExecutorPattern):
    ...
    def __init__(self, executor_name: str, desired_model_methods: List[ModelMethodName], upload_model_mode: UploadModelMode):
        """
        ...
        """
        super().__init__(executor_name, {self.DEFAULT_ROLE: desired_model_methods}, {self.DEFAULT_ROLE: upload_model_mode})
