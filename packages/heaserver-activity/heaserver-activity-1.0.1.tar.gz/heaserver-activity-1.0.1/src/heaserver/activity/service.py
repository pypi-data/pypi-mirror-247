...
async def _to_format(request: web.Request, data: DesktopObjectDict) -> tuple[str, str]:
    ...
    msg, mime_type = await formats_from_request(request, wstl_builder())
