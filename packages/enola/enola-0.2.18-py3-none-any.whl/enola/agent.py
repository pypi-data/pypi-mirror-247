...
class Agent:
    ...
    def close_step_video(self, step: Step, successfull: bool, video_num: int=0, video_sec: int=0, video_size: int=0, video_cost: float=0, enola_id: str="", agent_deploy_id: str="", step_id:str=""):
        """
    ...
    def close_step_audio(self, step: Step, successfull: bool, audio_num:int = 0, audio_sec:int = 0, audio_size:int = 0, audio_cost: float=0, enola_id: str="", agent_deploy_id: str="", step_id:str=""):
        """
    ...
    def close_step_image(self, step: Step, successfull: bool, image_num:int = 0, image_size:int = 0, image_cost: float = 0, enola_id: str="", agent_deploy_id: str="", step_id:str=""):
        """
    ...
    def close_step_doc(self, step: Step, successfull: bool, doc_num:int=0, doc_pages:int=0, doc_size:int = 0, doc_char:int=0, doc_cost: float=0, enola_id: str="", agent_deploy_id: str="", step_id:str=""):
        """
    ...
    def close_step_others(self, step: Step, successfull: bool, others_cost: float=0, enola_id: str="", agent_deploy_id: str="", step_id:str=""):
        """
