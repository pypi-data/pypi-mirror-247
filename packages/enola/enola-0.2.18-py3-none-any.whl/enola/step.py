...
class Step:
    ...
    def add_api_data(self, bodyToSend: str, headerToSend: str, payloadReceived: str):
        self.step_api_data_list.append(ApiDataModel(body=bodyToSend, header=headerToSend, payload=payloadReceived)) 
        #{"body": bodyToSend, "header": headerToSend, "payload": payloadReceived})

    def add_file_link(self, name: str, url: str, type: str, sizeKb: int):
        self.file_info_list.append(FileInfoModel(name=name, url=url, type=type, sizeKb=sizeKb))
