...
setup(
    name="asyncua-fork-for-eta-utility",
    version="1.0.7",
    description="Pure Python OPC-UA client and server library - Forked for ETA Utility",
    long_description=long_description,
    long_description_content_type='text/markdown',
    author="Olivier Roulet-Dubonnet",
    author_email="olivier.roulet@gmail.com",
    url='http://freeopcua.github.io/  Link to the fork: https://github.com/miki5799/opcua-asyncio/tree/master',
