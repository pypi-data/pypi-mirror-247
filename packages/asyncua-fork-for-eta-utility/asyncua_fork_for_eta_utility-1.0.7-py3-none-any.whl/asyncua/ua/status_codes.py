...
code_to_name_doc: Dict[int, Tuple[str, str]] = {
    0x00000000: ('Good', 'The operation succeeded.'),
    0x40000000: ('Uncertain', 'The operation was uncertain.'),
    ...
    0x800F0000: ('BadNothingToDo', 'No processing could be done because there was nothing to do.'),
    ...
    0x00DF0000: ('GoodRetransmissionQueueNotSupported', 'The Server does not support retransmission queue and acknowledgement of sequence numbers is not available.'),
    ...
    0x80800000: ('BadTcpMessageTooLarge', 'The size of the message chunk specified in the header is too large.'),
    ...
    0x80E80000: ('BadTransactionPending', 'The operation is not allowed because a transaction is in progress.'),
    ...
    0x42080000: ('UncertainTransducerInManual', 'The value may not be accurate because the transducer is in manual mode.'),
    0x42090000: ('UncertainSimulatedValue', 'The value is simulated.'),
    0x420A0000: ('UncertainSensorCalibration', 'The value may not be accurate due to a sensor calibration fault.'),
    0x420F0000: ('UncertainConfigurationError', 'The value may not be accurate due to a configuration issue.'),
    0x04010000: ('GoodCascadeInitializationAcknowledged', 'The value source supports cascade handshaking and the value has been Initialized based on an initialization request from a cascade secondary.'),
    0x04020000: ('GoodCascadeInitializationRequest', 'The value source supports cascade handshaking and is requesting initialization of a cascade primary.'),
    0x04030000: ('GoodCascadeNotInvited', 'The value source supports cascade handshaking, however, the source’s current state does not allow for cascade.'),
    0x04040000: ('GoodCascadeNotSelected', 'The value source supports cascade handshaking, however, the source has not selected the corresponding cascade primary for use.'),
    0x04070000: ('GoodFaultStateActive', 'There is a fault state condition active in the value source.'),
    0x04080000: ('GoodInitiateFaultState', 'A fault state condition is being requested of the destination.'),
    0x04090000: ('GoodCascade', 'The value is accurate, and the signal source supports cascade handshaking.'),
