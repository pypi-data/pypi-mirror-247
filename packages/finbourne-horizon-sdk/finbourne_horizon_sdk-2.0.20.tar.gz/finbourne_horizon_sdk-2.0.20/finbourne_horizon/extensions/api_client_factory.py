...
from finbourne_horizon.extensions.retry import (
    RetryingRestWrapper,
...
from finbourne_horizon.extensions.socket_keep_alive import keep_alive_socket_options
from finbourne_horizon.extensions.tcp_keep_alive_connector import (
...
class SyncApiClientFactory:
    ...
    def build(
        ...
        ----------
        metaclass : Type[T]
            A finbourne_horizon.api class.


        Returns
        -------
        T
            An instance of the finbourne_horizon.api class with a configured ApiClient
        """
