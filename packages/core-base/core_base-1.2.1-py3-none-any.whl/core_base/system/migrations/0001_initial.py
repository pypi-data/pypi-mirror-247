# Generated by Django 4.2 on 2023-12-20 10:50

import core_base.system.models
import core_base.utils.models
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mobile', models.CharField(blank=True, help_text='手机', max_length=255, null=True, verbose_name='手机')),
                ('landline', models.CharField(blank=True, help_text='固定电话', max_length=255, null=True, verbose_name='固定电话')),
                ...
                ('user_type', models.IntegerField(blank=True, choices=[(0, '后台用户'), (1, '前台用户'), (2, '开放服务用户')], default=0, help_text='用户类型', null=True, verbose_name='用户类型')),
                ('last_token', models.CharField(blank=True, help_text='最后一次登录Token', max_length=255, null=True, verbose_name='最后一次登录Token')),
            ],
            options={
                'verbose_name': '用户表',
                'verbose_name_plural': '用户表',
                'db_table': 'core_base_system_users',
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'db_table': 'core_base_api_white_list',
                'ordering': ('-create_datetime',),
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('short_name', models.CharField(blank=True, help_text='部门简称', max_length=64, null=True, verbose_name='部门简称')),
                ('key', models.CharField(blank=True, default=core_base.utils.models.newuuid, help_text='关联字符', max_length=255, null=True, unique=True, verbose_name='关联字符')),
            ...
            options={
                ...
                'db_table': 'core_base_system_dept',
                'ordering': ('sort',),
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url', models.FileField(blank=True, null=True, upload_to=core_base.system.models.media_file_name)),
                ...
                ('size', models.BigIntegerField(blank=True, default=0, help_text='文件大小', verbose_name='文件大小')),
                ('md5sum', models.CharField(blank=True, help_text='文件md5', max_length=36, verbose_name='文件md5')),
            ],
            options={
                'verbose_name': '文件管理',
                'verbose_name_plural': '文件管理',
                'db_table': 'core_base_system_file_list',
                'ordering': ('-create_datetime',),
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                'db_table': 'core_base_system_login_log',
                'ordering': ('-create_datetime',),
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('frame_out', models.BooleanField(blank=True, default=False, help_text='是否主框架外', verbose_name='是否主框架外')),
            ...
            options={
                ...
                'db_table': 'core_base_system_menu',
                'ordering': ('sort',),
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('method', models.IntegerField(blank=True, default=0, help_text='接口请求方法', null=True, verbose_name='接口请求方法')),
                ('menu', models.ForeignKey(db_constraint=False, help_text='关联菜单', on_delete=django.db.models.deletion.PROTECT, related_name='menuPermission', to='system.menu', verbose_name='关联菜单')),
            ],
            options={
                'verbose_name': '菜单权限表',
                'verbose_name_plural': '菜单权限表',
                'db_table': 'core_base_system_menu_button',
                'ordering': ('-name',),
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                'db_table': 'core_base_message_center',
                'ordering': ('-create_datetime',),
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                'db_table': 'core_base_system_operation_log',
                'ordering': ('-create_datetime',),
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                'db_table': 'core_base_system_post',
                'ordering': ('sort',),
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_datetime', models.DateTimeField(auto_now=True, help_text='修改时间', null=True, verbose_name='修改时间')),
                ('create_datetime', models.DateTimeField(auto_now_add=True, help_text='创建时间', null=True, verbose_name='创建时间')),
                ('code', models.CharField(blank=True, default=core_base.utils.models.newuuid, help_text='任务编号', max_length=255, null=True, verbose_name='任务编号')),
                ('task_name', models.CharField(default='', help_text='任务名称', max_length=255, verbose_name='任务名称')),
                ('task_type', models.IntegerField(choices=[(0, '定时任务'), (1, '周期性任务')], default=0, help_text='任务类型', verbose_name='任务类型')),
                ('task_status', models.BooleanField(default=False, help_text='任务状态', verbose_name='任务状态')),
                ('urls', models.JSONField(blank=True, default=dict, help_text='Urls地址', max_length=50000, null=True, verbose_name='Urls地址')),
                ('reqmethod', models.CharField(blank=True, default='', help_text='请求方式', max_length=255, null=True, verbose_name='请求方式')),
                ('reqheaders', models.TextField(blank=True, default='', help_text='请求头', max_length=50000, null=True, verbose_name='请求头')),
                ('proxies', models.TextField(blank=True, default="{'http': None,'https': None,}", help_text='请求代理', max_length=50000, null=True, verbose_name='请求代理')),
                ('payload', models.TextField(blank=True, default='', help_text='请求体', max_length=50000, null=True, verbose_name='请求体')),
                ('ext_kwargs', models.JSONField(default=dict, help_text='任务扩展参数', verbose_name='任务扩展参数')),
                ('task_desc', models.TextField(blank=True, default='', help_text='任务描述', null=True, verbose_name='任务描述')),
                ('periodic_task', models.ForeignKey(blank=True, help_text='周期性任务', null=True, on_delete=django.db.models.deletion.SET_NULL, to='django_celery_beat.periodictask', verbose_name='周期性任务')),
            ],
            options={
                'verbose_name': '任务管理',
                'verbose_name_plural': '任务管理',
                'db_table': 'core_base_task_management',
                'ordering': ('-id',),
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                'db_table': 'core_base_system_role',
                'ordering': ('sort',),
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                'db_table': 'core_base_message_center_target_user',
            },
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'db_table': 'core_base_system_dictionary',
                'ordering': ('sort',),
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pcode', models.ForeignKey(blank=True, db_constraint=False, help_text='父地区编码', null=True, on_delete=django.db.models.deletion.PROTECT, to='system.area', to_field='code', verbose_name='父地区编码')),
            ],
            options={
                'verbose_name': '地区表',
                'verbose_name_plural': '地区表',
                'db_table': 'core_base_system_area',
                'ordering': ('code',),
            },
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('key', models.CharField(db_index=True, help_text='键', max_length=200, verbose_name='键')),
                ('value', models.JSONField(blank=True, help_text='值', max_length=500, null=True, verbose_name='值')),
                ...
                ('placeholder', models.CharField(blank=True, help_text='提示信息', max_length=100, null=True, verbose_name='提示信息')),
                ('setting', models.JSONField(blank=True, help_text='配置', null=True, verbose_name='配置')),
                ('parent', models.ForeignKey(blank=True, db_constraint=False, help_text='父级', null=True, on_delete=django.db.models.deletion.PROTECT, to='system.systemconfig', verbose_name='父级')),
            ],
            options={
                'verbose_name': '系统配置表',
                'verbose_name_plural': '系统配置表',
                'db_table': 'core_base_system_config',
                'ordering': ('sort',),
