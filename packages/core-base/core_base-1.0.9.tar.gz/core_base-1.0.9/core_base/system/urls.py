...
from core_base.system.views.datav import DataVViewSet
...
from core_base.system.views.message_center import MessageCenterViewSet, WebSocketView
...
from core_base.system.views.task_management import TaskManagementViewSet
...
system_url.register(r'task', TaskManagementViewSet)
...
urlpatterns = [
    ...
    path('ws', WebSocketView),  # WebSoekcet测试
]
