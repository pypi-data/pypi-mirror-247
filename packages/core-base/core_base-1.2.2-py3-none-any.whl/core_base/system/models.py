...
from core_base.utils.models import CoreModel, table_prefix, newuuid
...
class Users(CoreModel, AbstractUser):
    ...
    mobile = models.CharField(max_length=255, verbose_name="手机", null=True, blank=True, help_text="手机")
    landline = models.CharField(max_length=255, verbose_name="固定电话", null=True, blank=True, help_text="固定电话")
...
class Dept(CoreModel):
    ...
    short_name = models.CharField(max_length=64, verbose_name="部门简称", help_text="部门简称", null=True, blank=True)
    key = models.CharField(max_length=255, unique=True, null=True, blank=True, verbose_name="关联字符",
                           help_text="关联字符", default=newuuid)
...
# 任务管理基础版
class TaskManagement(CoreModel):
    code = models.CharField(verbose_name="任务编号", max_length=255, default=newuuid, null=True, blank=True,
                            help_text="任务编号")
    task_name = models.CharField(verbose_name="任务名称", max_length=255, default="", null=False, blank=False,
                                 help_text="任务名称")
    task_type = models.IntegerField(choices=dispatch.get_dictionary_choices("task_type"),
                                    verbose_name="任务类型", default=0,
                                    null=False, blank=False,
                                    help_text="任务类型")
    periodic_task = models.ForeignKey(PeriodicTask, verbose_name="周期性任务", help_text="周期性任务", null=True, blank=True,
                                      on_delete=models.SET_NULL)
    task_status = models.BooleanField(default=False, verbose_name="任务状态", help_text="任务状态")
    urls = models.JSONField(verbose_name='Urls地址', max_length=50000, default=dict, null=True, blank=True,
                            help_text="Urls地址")
    reqmethod = models.CharField(verbose_name='请求方式', max_length=255, default="", null=True,
                                 blank=True, help_text="请求方式")
    reqheaders = models.TextField(verbose_name='请求头', max_length=50000, default="", null=True,
                                  blank=True, help_text="请求头")
    proxies = models.TextField(verbose_name='请求代理', max_length=50000, default="{'http': None,'https': None,}",
                               null=True,
                               blank=True, help_text="请求代理")
    payload = models.TextField(verbose_name='请求体', max_length=50000, default="", null=True,
                               blank=True, help_text="请求体")
    ext_kwargs = models.JSONField(verbose_name="任务扩展参数", null=False, blank=False, default=dict, help_text="任务扩展参数")
    task_desc = models.TextField(verbose_name="任务描述", default="", null=True, blank=True, help_text="任务描述")

    class Meta:
        db_table = table_prefix + "task_management"
        verbose_name = "任务管理"
        verbose_name_plural = verbose_name
        ordering = ("-id",)
