...
from core_base.websocketConfig import websocket_push
from core_base.system.models import MessageCenter, Users, MessageCenterTargetUser
...
def WebSocketView(request):
    ...
    if method == 'GET':
        ...
        return DetailResponse({"code": 200, "msg": "ok"})