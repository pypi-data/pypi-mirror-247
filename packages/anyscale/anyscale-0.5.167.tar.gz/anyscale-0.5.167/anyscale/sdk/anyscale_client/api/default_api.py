...
class DefaultApi(object):
    ...
    def start_cluster(self, cluster_id, start_cluster_options, **kwargs):  # noqa: E501
        ...
        Initializes workflow to transition the Cluster into the Running state. The Cluster will be updated if Cluster Environment Build or Cluster Compute is provided in the options. This is a long running operation. Clients will need to poll the operation's status to determine completion.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def start_session(self, session_id, start_session_options, **kwargs):  # noqa: E501
        """Start Session  # noqa: E501
             ...
             DEPRECATED: Use Clusters API instead.     Initializes workflow to transition the Session into the Running state.      The session's cluster config will be updated if it is provided in the options.      This is a long running operation.     Clients will need to poll the opertation's status to determine completion.       # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
