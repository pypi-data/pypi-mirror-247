...
from reytool.rsystem import ExceptionData
...
class RReceiver(object):
    ...
    def _start_receiver(
        ...
        def handles(message: RMessage) -> None:
            ...
            # Set parameter.
            exc_data_list: List[ExceptionData] = []
            handlers = [
                self._handler_room,
                self._handler_file,
                *self.handlers
            ...
            # Define.
            def handle_handler_exception(exception_data: ExceptionData) -> None:
                """
                ...
                # Save.
                exc_data_list.append(exception_data)
