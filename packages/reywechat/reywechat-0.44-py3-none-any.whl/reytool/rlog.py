...
class RLog(object):
    ...
    print_colour: ClassVar[bool] = True
    ...
    def _supply_format_file(
        ...
        if "%(format_message)s" in format_:
            pattern = "\033\[[\d;]+?m"
            record.format_message = re_sub(pattern, "", record.format_message)
    ...
    def debug(
        ...
        **params: Any
        ...
        # Record.
        self.log(*messages, level=DEBUG, **params)
    ...
    def info(
        ...
        **params: Any
        ...
        # Record.
        self.log(*messages, level=INFO, **params)
    ...
    def warning(
        ...
        **params: Any
        ...
        # Record.
        self.log(*messages, level=WARNING, **params)
    ...
    def error(
        ...
        **params: Any
        ...
        # Record.
        self.log(*messages, level=ERROR, **params)
    ...
    def critical(
        ...
        **params: Any
        ...
        # Record.
        self.log(*messages, level=CRITICAL, **params)
