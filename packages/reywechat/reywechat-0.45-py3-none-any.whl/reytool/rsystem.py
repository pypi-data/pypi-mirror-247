...
# Exception data type, contains exception report text and exception type and exception instance and exception position instance.
ExceptionData = Tuple[str, Type[BaseException], BaseException, TracebackType]
