...
from asyncio import Future as AFuture, Queue as AQueue, run as asyncio_run, gather as asyncio_gather, iscoroutine
...
class RAsyncPool(object):
    ...
    def all(self) -> List:
        """
        Get now all execution result of asynchronous `Coroutine`.

        Returns
        -------
        Now all execution result.
        """
