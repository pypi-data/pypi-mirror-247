...
class ModelsGetAllLeaderboardConfigsResp(Model):
    ...
    def with_data(
        self, value: List[ModelsGetLeaderboardConfigResp]
    ...
    def create_from_dict(
        ...
        if "data" in dict_ and dict_["data"] is not None:
            instance.data = [
                ModelsGetLeaderboardConfigResp.create_from_dict(
    ...
    def create_many_from_dict(
        cls, dict_: dict, include_empty: bool = False
    ) -> Dict[str, ModelsGetAllLeaderboardConfigsResp]:
        return (
    ...
    ) -> List[ModelsGetAllLeaderboardConfigsResp]:
        return (
    ...
    def create_from_any(
        ...
        ModelsGetAllLeaderboardConfigsResp,
        List[ModelsGetAllLeaderboardConfigsResp],
        Dict[Any, ModelsGetAllLeaderboardConfigsResp],
    ]:
        if many:
