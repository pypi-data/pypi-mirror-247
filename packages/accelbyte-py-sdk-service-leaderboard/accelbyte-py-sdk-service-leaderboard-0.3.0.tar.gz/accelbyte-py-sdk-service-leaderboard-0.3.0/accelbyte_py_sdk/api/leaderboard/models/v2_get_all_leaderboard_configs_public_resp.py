...
class V2GetAllLeaderboardConfigsPublicResp(Model):
    """V2 get all leaderboard configs public resp (v2.GetAllLeaderboardConfigsPublicResp)
    ...
    def with_data(
        self, value: List[V2GetLeaderboardConfigPublicResp]
    ...
    def create_from_dict(
        ...
        if "data" in dict_ and dict_["data"] is not None:
            instance.data = [
                V2GetLeaderboardConfigPublicResp.create_from_dict(
    ...
    def create_many_from_dict(
        cls, dict_: dict, include_empty: bool = False
    ) -> Dict[str, V2GetAllLeaderboardConfigsPublicResp]:
        return (
    ...
    ) -> List[V2GetAllLeaderboardConfigsPublicResp]:
        return (
    ...
    def create_from_any(
        ...
        V2GetAllLeaderboardConfigsPublicResp,
        List[V2GetAllLeaderboardConfigsPublicResp],
        Dict[Any, V2GetAllLeaderboardConfigsPublicResp],
    ]:
        if many:
