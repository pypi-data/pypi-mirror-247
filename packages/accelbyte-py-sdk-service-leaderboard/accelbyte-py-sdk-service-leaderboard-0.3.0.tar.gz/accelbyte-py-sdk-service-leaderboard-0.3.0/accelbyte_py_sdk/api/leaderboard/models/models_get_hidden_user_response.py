...
class ModelsGetHiddenUserResponse(Model):
    """Models get hidden user response (models.GetHiddenUserResponse)
    ...
    def with_data(self, value: List[str]) -> ModelsGetHiddenUserResponse:
        self.data = value
        return self

    def with_paging(self, value: ModelsPagination) -> ModelsGetHiddenUserResponse:
        self.paging = value
        return self
    ...
    def create_many_from_dict(
        cls, dict_: dict, include_empty: bool = False
    ) -> Dict[str, ModelsGetHiddenUserResponse]:
        return (
    ...
    ) -> List[ModelsGetHiddenUserResponse]:
        return (
    ...
    def create_from_any(
        ...
        ModelsGetHiddenUserResponse,
        List[ModelsGetHiddenUserResponse],
        Dict[Any, ModelsGetHiddenUserResponse],
    ]:
        if many:
