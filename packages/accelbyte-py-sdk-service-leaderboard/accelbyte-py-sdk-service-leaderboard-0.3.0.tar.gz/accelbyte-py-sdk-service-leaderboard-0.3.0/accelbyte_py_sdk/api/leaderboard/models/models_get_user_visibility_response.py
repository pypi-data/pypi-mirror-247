...
class ModelsGetUserVisibilityResponse(Model):
    ...
    @classmethod
    def create(
        cls, namespace: str, user_id: str, visibility: bool, **kwargs
    ...
    def create_many_from_dict(
        cls, dict_: dict, include_empty: bool = False
    ) -> Dict[str, ModelsGetUserVisibilityResponse]:
        return (
    ...
    ) -> List[ModelsGetUserVisibilityResponse]:
        return (
    ...
    def create_from_any(
        ...
        ModelsGetUserVisibilityResponse,
        List[ModelsGetUserVisibilityResponse],
        Dict[Any, ModelsGetUserVisibilityResponse],
    ]:
        if many:
