...
class CreateArchivedLeaderboardRankingDataV1Handler(Operation):
    ...
    def with_body(
        self, value: ModelsArchiveLeaderboardReq
    ...
    def parse_response(
        ...
        Union[None, Optional[str]], Union[None, HttpResponse, ResponseErrorResponse]
    ]:
    ...
    @classmethod
    def create(
        cls, body: ModelsArchiveLeaderboardReq, namespace: str, **kwargs
    ) -> CreateArchivedLeaderboardRankingDataV1Handler:
        instance = cls()
        instance.body = body
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelsArchiveLeaderboardReq.create_from_dict(
