...
class GetLeaderboardConfigurationsPublicV1(Operation):
    ...
    def with_namespace(self, value: str) -> GetLeaderboardConfigurationsPublicV1:
        self.namespace = value
        return self

    def with_is_archived(self, value: bool) -> GetLeaderboardConfigurationsPublicV1:
        self.is_archived = value
        return self

    def with_is_deleted(self, value: bool) -> GetLeaderboardConfigurationsPublicV1:
        self.is_deleted = value
        return self

    def with_limit(self, value: int) -> GetLeaderboardConfigurationsPublicV1:
        self.limit = value
        return self

    def with_offset(self, value: int) -> GetLeaderboardConfigurationsPublicV1:
        self.offset = value
        return self
    ...
    def parse_response(
        ...
        Union[None, ModelsGetAllLeaderboardConfigsPublicResp],
        ...
        if code == 200:
            return (
                ModelsGetAllLeaderboardConfigsPublicResp.create_from_dict(content),
                None,
            )
        if code == 400:
