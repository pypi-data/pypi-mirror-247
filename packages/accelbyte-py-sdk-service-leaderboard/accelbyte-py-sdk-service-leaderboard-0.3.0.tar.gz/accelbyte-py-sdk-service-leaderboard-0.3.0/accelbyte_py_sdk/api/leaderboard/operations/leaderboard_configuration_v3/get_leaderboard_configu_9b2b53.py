...
class GetLeaderboardConfigurationsAdminV3(Operation):
    ...
    _url: str = "/leaderboard/v3/admin/namespaces/{namespace}/leaderboards"
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    def with_namespace(self, value: str) -> GetLeaderboardConfigurationsAdminV3:
        self.namespace = value
        return self

    def with_is_deleted(self, value: bool) -> GetLeaderboardConfigurationsAdminV3:
        self.is_deleted = value
        return self

    def with_limit(self, value: int) -> GetLeaderboardConfigurationsAdminV3:
        self.limit = value
        return self

    def with_offset(self, value: int) -> GetLeaderboardConfigurationsAdminV3:
        self.offset = value
        return self
    ...
    def parse_response(
        ...
        Union[None, ModelsGetAllLeaderboardConfigsRespV3],
        ...
        if code == 200:
            return ModelsGetAllLeaderboardConfigsRespV3.create_from_dict(content), None
        if code == 400:
