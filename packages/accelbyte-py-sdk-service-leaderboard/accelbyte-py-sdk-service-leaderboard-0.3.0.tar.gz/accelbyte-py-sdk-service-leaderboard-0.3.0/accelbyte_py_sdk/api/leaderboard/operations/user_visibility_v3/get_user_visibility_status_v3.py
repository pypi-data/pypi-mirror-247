...
class GetUserVisibilityStatusV3(Operation):
    ...
    def with_leaderboard_code(self, value: str) -> GetUserVisibilityStatusV3:
        self.leaderboard_code = value
        return self

    def with_namespace(self, value: str) -> GetUserVisibilityStatusV3:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> GetUserVisibilityStatusV3:
        self.user_id = value
        return self
