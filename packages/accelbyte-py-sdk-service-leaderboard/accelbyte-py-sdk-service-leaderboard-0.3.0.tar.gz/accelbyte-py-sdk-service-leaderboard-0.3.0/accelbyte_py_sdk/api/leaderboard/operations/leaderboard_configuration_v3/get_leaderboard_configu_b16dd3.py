...
class GetLeaderboardConfigurationsPublicV3(Operation):
    ...
    _url: str = "/leaderboard/v3/public/namespaces/{namespace}/leaderboards"
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    def with_namespace(self, value: str) -> GetLeaderboardConfigurationsPublicV3:
        self.namespace = value
        return self

    def with_is_deleted(self, value: bool) -> GetLeaderboardConfigurationsPublicV3:
        self.is_deleted = value
        return self

    def with_limit(self, value: int) -> GetLeaderboardConfigurationsPublicV3:
        self.limit = value
        return self

    def with_offset(self, value: int) -> GetLeaderboardConfigurationsPublicV3:
        self.offset = value
        return self
    ...
    def parse_response(
        ...
        Union[None, ModelsGetAllLeaderboardConfigsPublicRespV3],
        ...
        if code == 200:
            return (
                ModelsGetAllLeaderboardConfigsPublicRespV3.create_from_dict(content),
                None,
            )
        if code == 400:
