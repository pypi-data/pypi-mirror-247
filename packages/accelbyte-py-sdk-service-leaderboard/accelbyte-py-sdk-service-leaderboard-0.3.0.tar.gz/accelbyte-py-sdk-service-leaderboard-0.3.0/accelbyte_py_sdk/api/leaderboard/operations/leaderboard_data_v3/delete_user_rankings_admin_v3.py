...
class DeleteUserRankingsAdminV3(Operation):
    ...
    _url: str = "/leaderboard/v3/admin/namespaces/{namespace}/users/{userId}"
    _method: str = "DELETE"
    ...
    def with_namespace(self, value: str) -> DeleteUserRankingsAdminV3:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> DeleteUserRankingsAdminV3:
        self.user_id = value
        return self

    def with_leaderboard_code(self, value: List[str]) -> DeleteUserRankingsAdminV3:
