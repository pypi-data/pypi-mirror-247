...
class ModelsGetLeaderboardRankingResp(Model):
    ...
    def with_data(
        self, value: List[ModelsUserPoint]
    ...
    def create_from_dict(
        ...
        if "data" in dict_ and dict_["data"] is not None:
            instance.data = [
                ModelsUserPoint.create_from_dict(i0, include_empty=include_empty)
    ...
    def create_many_from_dict(
        cls, dict_: dict, include_empty: bool = False
    ) -> Dict[str, ModelsGetLeaderboardRankingResp]:
        return (
    ...
    ) -> List[ModelsGetLeaderboardRankingResp]:
        return (
    ...
    def create_from_any(
        ...
        ModelsGetLeaderboardRankingResp,
        List[ModelsGetLeaderboardRankingResp],
        Dict[Any, ModelsGetLeaderboardRankingResp],
    ]:
        if many:
