...
class ModelsPaginationV3(Model):
    """Models pagination V3 (models.PaginationV3)
    ...
    def with_first(self, value: str) -> ModelsPaginationV3:
        self.first = value
        return self

    def with_last(self, value: str) -> ModelsPaginationV3:
        self.last = value
        return self

    def with_next(self, value: str) -> ModelsPaginationV3:
        self.next_ = value
        return self

    def with_previous(self, value: str) -> ModelsPaginationV3:
        self.previous = value
        return self
    ...
    def create_from_any(
        ...
        ModelsPaginationV3, List[ModelsPaginationV3], Dict[Any, ModelsPaginationV3]
    ]:
        if many:
