...
class GetLeaderboardConfigurationAdminV1(Operation):
    ...
    def with_leaderboard_code(self, value: str) -> GetLeaderboardConfigurationAdminV1:
        self.leaderboard_code = value
        return self

    def with_namespace(self, value: str) -> GetLeaderboardConfigurationAdminV1:
