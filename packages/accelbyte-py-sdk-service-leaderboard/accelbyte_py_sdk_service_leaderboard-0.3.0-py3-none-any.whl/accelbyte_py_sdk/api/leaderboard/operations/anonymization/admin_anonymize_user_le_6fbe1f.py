...
class AdminAnonymizeUserLeaderboardAdminV1(Operation):
    ...
    _url: str = "/leaderboard/v1/admin/namespaces/{namespace}/users/{userId}/anonymization/leaderboards"
    _method: str = "DELETE"
    ...
    def with_namespace(self, value: str) -> AdminAnonymizeUserLeaderboardAdminV1:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> AdminAnonymizeUserLeaderboardAdminV1:
        self.user_id = value
        return self
