...
class DeleteUserRankingByLeaderboardCodeAdminV3(Operation):
    ...
    _url: str = "/leaderboard/v3/admin/namespaces/{namespace}/leaderboards/{leaderboardCode}/reset"
    _method: str = "DELETE"
    _consumes: List[str] = []
    ...
    def with_namespace(self, value: str) -> DeleteUserRankingByLeaderboardCodeAdminV3:
