...
class GetUserLeaderboardRankingsAdminV1(Operation):
    ...
    def with_namespace(self, value: str) -> GetUserLeaderboardRankingsAdminV1:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> GetUserLeaderboardRankingsAdminV1:
        self.user_id = value
        return self

    def with_limit(self, value: int) -> GetUserLeaderboardRankingsAdminV1:
        self.limit = value
        return self

    def with_offset(self, value: int) -> GetUserLeaderboardRankingsAdminV1:
        self.offset = value
        return self
    ...
    def parse_response(
        ...
        Union[None, ModelsGetAllUserLeaderboardsResp],
        ...
        if code == 200:
            return ModelsGetAllUserLeaderboardsResp.create_from_dict(content), None
        if code == 401:
