...
class DeleteBulkLeaderboardConfigurationAdminV3(Operation):
    ...
    _url: str = "/leaderboard/v3/admin/namespaces/{namespace}/leaderboards/delete"
    _method: str = "POST"
    ...
    body: ModelsDeleteBulkLeaderboardsReq  # REQUIRED in [body]
    ...
    def with_body(
        self, value: ModelsDeleteBulkLeaderboardsReq
    ) -> DeleteBulkLeaderboardConfigurationAdminV3:
        self.body = value
        return self

    def with_namespace(self, value: str) -> DeleteBulkLeaderboardConfigurationAdminV3:
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = ModelsDeleteBulkLeaderboardsReq()
    ...
    def parse_response(
        ...
        Union[None, ModelsDeleteBulkLeaderboardsResp],
        ...
        if code == 200:
            return ModelsDeleteBulkLeaderboardsResp.create_from_dict(content), None
        if code == 400:
    ...
    @classmethod
    def create(
        cls, body: ModelsDeleteBulkLeaderboardsReq, namespace: str, **kwargs
    ) -> DeleteBulkLeaderboardConfigurationAdminV3:
        instance = cls()
        instance.body = body
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelsDeleteBulkLeaderboardsReq.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = ModelsDeleteBulkLeaderboardsReq()
