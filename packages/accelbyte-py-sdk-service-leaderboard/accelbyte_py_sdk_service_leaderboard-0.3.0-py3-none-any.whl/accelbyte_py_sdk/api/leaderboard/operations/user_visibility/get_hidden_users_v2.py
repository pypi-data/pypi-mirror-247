...
class GetHiddenUsersV2(Operation):
    ...
    _url: str = "/leaderboard/v2/admin/namespaces/{namespace}/leaderboards/{leaderboardCode}/users/hidden"
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    def with_leaderboard_code(self, value: str) -> GetHiddenUsersV2:
        self.leaderboard_code = value
        return self

    def with_namespace(self, value: str) -> GetHiddenUsersV2:
        self.namespace = value
        return self

    def with_limit(self, value: int) -> GetHiddenUsersV2:
        self.limit = value
        return self

    def with_offset(self, value: int) -> GetHiddenUsersV2:
        self.offset = value
        return self
    ...
    def parse_response(
        ...
        Union[None, ModelsGetHiddenUserResponse],
        ...
        if code == 200:
            return ModelsGetHiddenUserResponse.create_from_dict(content), None
        if code == 400:
