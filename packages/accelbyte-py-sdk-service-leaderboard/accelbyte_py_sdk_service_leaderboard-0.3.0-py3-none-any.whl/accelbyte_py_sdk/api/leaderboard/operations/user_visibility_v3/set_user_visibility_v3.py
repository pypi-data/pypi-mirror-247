...
class SetUserVisibilityV3(Operation):
    ...
    _url: str = "/leaderboard/v3/admin/namespaces/{namespace}/users/{userId}/visibility"
    _method: str = "PUT"
    ...
    def with_body(self, value: ModelsSetUserVisibilityRequest) -> SetUserVisibilityV3:
        self.body = value
        return self

    def with_namespace(self, value: str) -> SetUserVisibilityV3:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> SetUserVisibilityV3:
        self.user_id = value
        return self
