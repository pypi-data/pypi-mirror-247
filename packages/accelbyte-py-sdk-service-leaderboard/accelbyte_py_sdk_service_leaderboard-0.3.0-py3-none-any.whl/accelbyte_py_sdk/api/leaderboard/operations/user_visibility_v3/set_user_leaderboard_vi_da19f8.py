...
class SetUserLeaderboardVisibilityV3(Operation):
    ...
    _url: str = "/leaderboard/v3/admin/namespaces/{namespace}/leaderboards/{leaderboardCode}/users/{userId}/visibility"
    _method: str = "PUT"
    ...
    def with_leaderboard_code(self, value: str) -> SetUserLeaderboardVisibilityV3:
        self.leaderboard_code = value
        return self

    def with_namespace(self, value: str) -> SetUserLeaderboardVisibilityV3:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> SetUserLeaderboardVisibilityV3:
        self.user_id = value
        return self
