...
class GetHiddenUsersV3(Operation):
    ...
    _url: str = "/leaderboard/v3/admin/namespaces/{namespace}/leaderboards/{leaderboardCode}/users/hidden"
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    def with_leaderboard_code(self, value: str) -> GetHiddenUsersV3:
        self.leaderboard_code = value
        return self

    def with_namespace(self, value: str) -> GetHiddenUsersV3:
        self.namespace = value
        return self

    def with_limit(self, value: int) -> GetHiddenUsersV3:
        self.limit = value
        return self

    def with_offset(self, value: int) -> GetHiddenUsersV3:
        self.offset = value
        return self
