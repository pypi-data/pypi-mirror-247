...
Generated for TT API specification version 3.0.3
"""
...
class TTRESTService:
    ...
    def create_user(
        ...
        Example::
            ...
            >>> text
            {
                ...
                "activity": null,
                "created_ts": 234324323333.23,
                "updated_ts": 345345345.345
            } (str)
    ...
    def create_user_role(
        ...
        Example::
            ...
            >>> text
            {
                ...
                "created_ts": 234324323333.44,
                "updated_ts": 234324323333.44
            } (str)
            ...
            >>> text
            {
                "entries": {
                    "key1": {
                        ...
                        "visibility": "public",
                        "entry_created_ts": 213423423424.123,
                        "entry_updated_ts": 232342342234.123,
                        "value_changed_ts": 232342342234.123
                    },
                    "key2": {
                        "ref": {
                            "source": "twin://77f57a6e-1026-4272-8301-2a4419f32daa/e834214a-e13d-412b-ffd6-911ab58c8733/foreign_key",
            ...
            >>> text
            {
                "entries": {
                    "entry_1": {
                        "value": "123",
                        "entry_created_ts": 213423423424.123,
                        "entry_updated_ts": 213423423424.123,
                        "value_changed_ts": 204543545345.123
                    }
                }
            } (str)
    ...
    def get_timeseries_tables(
        ...
        Example::
            ...
            >>> text
            {
                "stats": {
                    "status": null,
                    "database_size": 32032768
                },
                "users": {
                    "dfe8e356-30a7-4b2c-bdfb-a7ae2c159f6d": "write",
                    "ec723d57-4cc0-4843-bfeb-3ebe2e884348": "read"
                },
                "timeseries": "None"
            } (str)
    ...
    def create_timeseries_table(
        ...
        """
    def update_timeseries_access(
        self, body: Optional[Dict] = None, dictionary: Optional[Dict] = None, **kwargs
    ) -> Tuple[int, str]:
        """Executes ``update_timeseries_access`` API operation.
        ...
        Body[Optional]::
            ...
            {
                "users": {
                    "fe8e356-30a7-4b2c-bdfb-a7ae2c159f6d": "write",
                    "ec723d57-4cc0-4843-bfeb-3ebe2e884348": "read"
                }
            }
        ...
        Example::
            ...
            >>> from trustedtwin.tt_api import TTRESTService
            >>> tt_client = TTRESTService(tt_auth="TT_SECRET")
            >>> status, text = tt_client.update_timeseries_access()
            >>> status
            200 (int)
            >>> text
            {
    ...
    def create_indexes_table(
        ...
        """
    def update_indexes_access(
        self, body: Optional[Dict] = None, dictionary: Optional[Dict] = None, **kwargs
    ) -> Tuple[int, str]:
        """Executes ``update_indexes_access`` API operation.
        ...
        Example::
            ...
            >>> from trustedtwin.tt_api import TTRESTService
            >>> tt_client = TTRESTService(tt_auth="TT_SECRET")
            >>> status, text = tt_client.update_indexes_access()
            >>> status
            200 (int)
            >>> text
            {
    ...
    def get_sticker(
        ...
        Example::
            ...
            >>> from trustedtwin.tt_api import TTRESTService
            >>> tt_client = TTRESTService(tt_auth="TT_SECRET")
            >>> status, text = tt_client.get_sticker('085c0f9f-427e-4e23-9a60-bacf6585a862', 'green')
            >>> status
            200 (int)
            >>> text
            {
    ...
    def remove_sticker(
        ...
        Example::
            ...
            >>> from trustedtwin.tt_api import TTRESTService
            >>> tt_client = TTRESTService(tt_auth="TT_SECRET")
            >>> status, text = tt_client.remove_sticker('085c0f9f-427e-4e23-9a60-bacf6585a862', 'green')
            >>> status
            200 (int)
            >>> text
            {
