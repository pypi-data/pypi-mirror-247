...
class TTAsyncRESTService:
    ...
    async def create_timeseries_table(
        ...
        """
    async def update_timeseries_access(
        self, body: Optional[Dict] = None, dictionary: Optional[Dict] = None, **kwargs
    ) -> Coroutine[int, str]:
        ...
        Example::
            ...
            >>> tt_client = TTAsyncRESTService(tt_auth="TT_SECRET")
            >>> async def loop():
            >>>   status, text = await tt_client.update_timeseries_access()
            >>> asyncio.run(loop())
            >>> status
            200 (int)
            >>> text
    ...
    async def create_indexes_table(
        ...
        """
    async def update_indexes_access(
        self, body: Optional[Dict] = None, dictionary: Optional[Dict] = None, **kwargs
    ) -> Coroutine[int, str]:
        ...
        Example::
            ...
            >>> tt_client = TTAsyncRESTService(tt_auth="TT_SECRET")
            >>> async def loop():
            >>>   status, text = await tt_client.update_indexes_access()
            >>> asyncio.run(loop())
            >>> status
            200 (int)
            >>> text
