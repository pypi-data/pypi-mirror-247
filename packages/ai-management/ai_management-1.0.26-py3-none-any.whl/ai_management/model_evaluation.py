...
class ModelEvaluation:
    ...
    def convert_to_list_if_numpy(array):
        """
    ...
    def convert_arrays_to_lists(y_test, y_pred):
        """
        ...
        """
        y_test = convert_to_list_if_numpy(y_test)
        y_pred = convert_to_list_if_numpy(y_pred)
        return y_test, y_pred
        
    def add_small_qty_list(lst):
      """
    ...
    def binary_classification_evaluation(self, lst_kpis, y_test, y_pred):
        ...
        Returns:
            lst_kpis : list
                List of existing KPIs (updated).
        """
        y_test, y_pred = convert_arrays_to_lists(y_test, y_pred)
...
#             lst.append([f'roc_auc - {multi_class}', roc_auc_score(y_test, y_pred, multi_class=multi_class)])
    ...
    def regression_evaluation(self, lst_kpis, y_test, y_pred):
        ...
        y_test_add = add_small_qty_list(y_test)
        y_pred_add = add_small_qty_list(y_pred)
