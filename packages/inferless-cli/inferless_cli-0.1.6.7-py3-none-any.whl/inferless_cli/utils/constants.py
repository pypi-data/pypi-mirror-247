...
BASE_URL = "https://api.inferless.com/api"
WEB_URL = "https://console.inferless.com"
...
GET_MODEL_BUILD_LOGS_URL = f"{BASE_URL}/models/logs/build/"
GET_MODEL_CALL_LOGS_URL = f"{BASE_URL}/models/logs/inference/"
...
PRESIGNED_URL_RUNTIME_UPLOAD_URL = f"{BASE_URL}/users/presigned-url"
