...
T = TypeVar("T", bound="V1WriteRelationshipsResponse")


@_attrs_define
class V1WriteRelationshipsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        v1_write_relationships_response = cls(
            written_at=written_at,
        )

        v1_write_relationships_response.additional_properties = d
        return v1_write_relationships_response
