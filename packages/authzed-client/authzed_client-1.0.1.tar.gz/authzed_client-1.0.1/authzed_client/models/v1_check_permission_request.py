...
if TYPE_CHECKING:
    from ..models.v1_check_permission_request_context_consists_of_named_values_that_are_injected_into_the_caveat_evaluation_context import (
...
T = TypeVar("T", bound="V1CheckPermissionRequest")


@_attrs_define
class V1CheckPermissionRequest:
    ...
    or is a member of a relation, on a specific resource.
        ...
        Attributes:
            ...
            permission (Union[Unset, str]): permission is the name of the permission (or relation) on which to execute
                the check.
    ...
    context: Union[
        Unset, "V1CheckPermissionRequestContextConsistsOfNamedValuesThatAreInjectedIntoTheCaveatEvaluationContext"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_context, Unset):
            ...
            context = V1CheckPermissionRequestContextConsistsOfNamedValuesThatAreInjectedIntoTheCaveatEvaluationContext.from_dict(
                _context
            )

        v1_check_permission_request = cls(
        ...
        v1_check_permission_request.additional_properties = d
        return v1_check_permission_request
