...
from seaplane.gen.carrier.models.switch_cases_inner import (
    SwitchCasesInner,
)  # noqa: E501
from seaplane.gen.carrier.rest import ApiException


class TestSwitchCasesInner(unittest.TestCase):
    """SwitchCasesInner unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SwitchCasesInner
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `SwitchCasesInner`
        """
        model = seaplane.gen.carrier.models.switch_cases_inner.SwitchCasesInner()  # noqa: E501
        if include_optional :
            return SwitchCasesInner(
                check = 'this.foo < 5', 
                output = seaplane.gen.carrier.models.switch_cases_inner_output.Switch_cases_inner_output(
