...
class GetStore200Response(BaseModel):
    ...
    config: Optional[KeyValueConfig] = None
    __properties = ["config"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetStore200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetStore200Response:
        """Create an instance of GetStore200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetStore200Response.parse_obj(obj)

        _obj = GetStore200Response.parse_obj(
            {
                "config": KeyValueConfig.from_dict(obj.get("config"))
