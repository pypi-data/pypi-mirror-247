...
def extract_user_data_from_object(user_object: dict) -> UserObject:
    """
    ...
    user.favorites_count = user_object.get("legacy").get("favourites_count")
