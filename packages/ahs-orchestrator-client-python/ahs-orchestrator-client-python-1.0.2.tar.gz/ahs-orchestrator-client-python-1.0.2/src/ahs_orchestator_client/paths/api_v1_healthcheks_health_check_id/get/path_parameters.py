...
from ahs_orchestator_client.paths.api_v1_healthcheks_health_check_id.get.parameters.parameter_0 import schema
Properties = typing.TypedDict(
    'Properties',
    {
        "health_check_id": typing.Type[schema.Schema],
    }
)
...
class PathParametersDict(schemas.immutabledict[str, int]):
    ...
    @property
    def health_check_id(self) -> int:
        return self.__getitem__("health_check_id")
