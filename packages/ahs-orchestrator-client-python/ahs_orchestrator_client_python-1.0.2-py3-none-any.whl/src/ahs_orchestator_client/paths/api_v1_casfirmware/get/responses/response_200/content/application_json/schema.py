...
from ahs_orchestator_client.components.schema import cas_firmware_config


class SchemaTuple(
    typing.Tuple[
        cas_firmware_config.CasFirmwareConfigDict,
        ...
    ]
):
...
SchemaTupleInput = typing.Union[
    typing.List[
        typing.Union[
            cas_firmware_config.CasFirmwareConfigDictInput,
            cas_firmware_config.CasFirmwareConfigDict,
        ],
    ],
    typing.Tuple[
...
class Schema(
    ...
    items: typing.Type[cas_firmware_config.CasFirmwareConfig] = dataclasses.field(default_factory=lambda: cas_firmware_config.CasFirmwareConfig) # type: ignore
