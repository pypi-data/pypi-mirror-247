...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_cas_firmware_api_v1_casfirmware_get(
        self,
...
class GetCasFirmwareApiV1CasfirmwareGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId.snakeCase fn names
    get_cas_firmware_api_v1_casfirmware_get = BaseApi._get_cas_firmware_api_v1_casfirmware_get


class ApiForGet(BaseApi):
    # this class is used by api classes that refer to endpoints by path and http method names
    get = BaseApi._get_cas_firmware_api_v1_casfirmware_get
