...
from ahs_orchestator_client.paths.api_v1_healthchekssequence_health_check_definition_id.get.parameters.parameter_0 import schema
Properties = typing.TypedDict(
    'Properties',
    {
        "health_check_definition_id": typing.Type[schema.Schema],
    }
)
...
class PathParametersDict(schemas.immutabledict[str, int]):
    ...
    def __new__(
        cls,
        *,
        health_check_definition_id: int,
        configuration_: typing.Optional[schema_configuration.SchemaConfiguration] = None,
    ):
        arg_: typing.Dict[str, typing.Any] = {
            "health_check_definition_id": health_check_definition_id,
        }
    ...
    @property
    def health_check_definition_id(self) -> int:
        return self.__getitem__("health_check_definition_id")
