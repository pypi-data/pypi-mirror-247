...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_testbed_by_id_api_v1_testbed__testbed_id__get(
        self,
...
class GetTestbedByIdApiV1TestbedTestbedIdGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId.snakeCase fn names
    get_testbed_by_id_api_v1_testbed__testbed_id__get = BaseApi._get_testbed_by_id_api_v1_testbed__testbed_id__get


class ApiForGet(BaseApi):
    # this class is used by api classes that refer to endpoints by path and http method names
    get = BaseApi._get_testbed_by_id_api_v1_testbed__testbed_id__get
