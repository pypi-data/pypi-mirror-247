...
from ahs_orchestator_client.paths.api_v1_healthchecks_testbed_build_build_number_status.get.parameters.parameter_0 import schema
Properties = typing.TypedDict(
    'Properties',
    {
        "build_number": typing.Type[schema.Schema],
    }
)
...
class PathParametersDict(schemas.immutabledict[str, int]):
    ...
    def build_number(self) -> int:
        return self.__getitem__("build_number")
