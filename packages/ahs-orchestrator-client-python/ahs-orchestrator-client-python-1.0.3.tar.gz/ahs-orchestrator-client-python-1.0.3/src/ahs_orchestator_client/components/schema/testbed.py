...
class TestbedDict(schemas.immutabledict[str, schemas.OUTPUT_BASE_TYPES]):
    ...
    def __new__(
        ...
        **kwargs: schemas.INPUT_TYPES_ALL,
        ...
        for key_, val in (
            ...
            arg_[key_] = val
        arg_.update(kwargs)
        used_arg_ = typing.cast(TestbedDictInput, arg_)
        return Testbed.validate(used_arg_, configuration=configuration_)
    ...
    def from_dict_(
        ...
        return Testbed.validate(arg, configuration=configuration)
...
TestbedDictInput = typing.Mapping[str, schemas.INPUT_TYPES_ALL]


@dataclasses.dataclass(frozen=True)
class Testbed(
    schemas.Schema[TestbedDict, tuple]
):
    ...
    type_to_output_cls: typing.Mapping[
        ...
        default_factory=lambda: {
            schemas.immutabledict: TestbedDict
        }
    )
