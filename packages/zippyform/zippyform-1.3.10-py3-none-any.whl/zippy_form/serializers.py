...
class AccountSerializer(serializers.ModelSerializer):
    ...
    def validate_stripe_connect_redirect_url(self, value):
    ...
    def validate(self, attrs):
        ...
        stripe_connect_redirect_url = attrs.get('stripe_connect_redirect_url', None)
        ...
        if is_payment_collect_enabled:
            ...
            if application_type == APPLICATION_TYPE[0][0]:
                if stripe_connect_redirect_url is None:
                    raise serializers.ValidationError({"stripe_connect_redirect_url": ["This field is required"]})
    ...
    class Meta:
        ...
        fields = ['id', 'name', 'admin_email', 'timezone', 'meta_detail', 'is_payment_collect_enabled',
                  'primary_payment_gateway', 'stripe_connect_redirect_url']
...
class FormPaymentSettingsSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'payment_type', 'payment_mode', 'currency', 'price', 'tax_enabled', 'tax', 'tax_display_name', 'form', 'account', 'redirect_url',
