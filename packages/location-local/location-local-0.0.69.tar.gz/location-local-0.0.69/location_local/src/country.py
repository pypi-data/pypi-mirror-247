...
class Country(GenericCRUD):
    ...
    def insert(self, coordinate: Dict[str, float],
               country: str, lang_code: str, title_approved: bool = False,
        ...
        try:
            insert_country_sql = "INSERT INTO country_table (coordinate, iso, `name`, nicename, iso3, numcode, phonecode)" + \
                                 "VALUES (POINT(%s, %s), %s, %s, %s, %s, %s, %s)"
            self.cursor.execute(
                insert_country_sql,
                (coordinate["latitude"],
