...
class Evm(Blockchain):
    ...
    def get_campaigns(self, newer_than: datetime = None) -> Iterable[CampaignDTO]:
        ...
        for campaign in bookio.get_campaigns():
            ...
            yield CampaignDTO(
                ...
                mint_pricing=parse_pricing(campaign.get("mint_price", {})),
                discount_pricing=parse_pricing(campaign.get("discount_price", {})),
                cover_url=campaign["cover_url"],
                explorer_url=self.explorer_url(collection_id=collection_id),
