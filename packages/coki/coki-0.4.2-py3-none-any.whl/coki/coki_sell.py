...
disponible = funcs.get_portfolio(op_type="sell")
...
while cantidad == "h":
    print(
        """Este parámetro permite definir la cantidad de acciones, cantidad de dinero, o el porcentaje del portfolio a invertir. Ejemplos:
          10a: Vende 10 acciones
          10%: Vende el 10% del portfolio
          a: Vende todo el capital disponible"""
    )
    cantidad = str(input("Invertir (h para ayuda): "))

acciones = funcs.calcula_op_sell(cantidad, disponible, precio, currency, data, ticker)
