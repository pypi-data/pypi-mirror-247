...
kwargs = json.loads(
    """
{
    "name": "cdk-cloudformation-github-organizations-secret",
    "version": "1.3.0.a7",
    ...
    "packages": [
        ...
        "cdk_cloudformation_github_organizations_secret._jsii"
    ],
    "package_data": {
        "cdk_cloudformation_github_organizations_secret._jsii": [
            "github-organizations-secret@1.3.0-alpha.7.jsii.tgz"
        ],
        "cdk_cloudformation_github_organizations_secret": [
            "py.typed"
        ]
