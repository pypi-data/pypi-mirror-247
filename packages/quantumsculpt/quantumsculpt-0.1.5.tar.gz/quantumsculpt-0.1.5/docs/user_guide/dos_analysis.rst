...
To efficiently build collections, there exist the convenience function :code:`dos_generate_sets`.
:code:`dos_generate_sets` takes two lists as input, one for the
