...
class SchemaManager(metaclass=Singleton):
    ...
    def get_schema_by_name(self, title: str, schema_type: SchemaTypes | None = ...) -> ObjectSchema | None: ...
    def get_schemas(self, schema_type: SchemaTypes | None = ...) -> list[ObjectSchema]: ...
