...
You can find details of recent changes to Symfem in [the changelog](https://raw.githubusercontent.com/mscroggs/symfem/main/CHANGELOG.md).
...
of Symfem can be found in the [`demo` folder](https://raw.githubusercontent.com/mscroggs/symfem/main/demo/) or viewed on
...
If you want to add a new element to Symfem, take a look at the [Adding an element guide](https://raw.githubusercontent.com/mscroggs/symfem/main/ADDING_AN_ELEMENT.md).
...
## Code of conduct
We expect all our contributors to follow [the Contributor Covenant](https://raw.githubusercontent.com/mscroggs/symfem/main/CODE_OF_CONDUCT.md). Any unacceptable
