...
class CncToolSubTypeDto(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    def __init__(  # pylint: disable=too-many-locals
        ...
        *,
        ...
        stick_out_helper_text: Optional[str] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword id: Required.
...
class CustomerOrderLineWorkOrderTraceStatusNodeDto(_serialization.Model):
...
class ProductionScheduleOperationDtoPagedResult(_serialization.Model):
