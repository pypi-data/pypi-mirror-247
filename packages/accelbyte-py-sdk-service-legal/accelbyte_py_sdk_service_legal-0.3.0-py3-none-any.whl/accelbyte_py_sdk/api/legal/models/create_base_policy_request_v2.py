...
class CreateBasePolicyRequestV2(Model):
    """Create base policy request V2 (CreateBasePolicyRequestV2)
    ...
    def with_affected_client_ids(self, value: List[str]) -> CreateBasePolicyRequestV2:
        self.affected_client_ids = value
        return self

    def with_affected_countries(self, value: List[str]) -> CreateBasePolicyRequestV2:
    ...
    def with_type_id(self, value: str) -> CreateBasePolicyRequestV2:
        self.type_id = value
        return self
    ...
    def create_many_from_dict(
        cls, dict_: dict, include_empty: bool = False
    ) -> Dict[str, CreateBasePolicyRequestV2]:
        return (
    ...
    ) -> List[CreateBasePolicyRequestV2]:
        return (
    ...
    def create_from_any(
        ...
        CreateBasePolicyRequestV2,
        List[CreateBasePolicyRequestV2],
        Dict[Any, CreateBasePolicyRequestV2],
    ]:
        if many:
