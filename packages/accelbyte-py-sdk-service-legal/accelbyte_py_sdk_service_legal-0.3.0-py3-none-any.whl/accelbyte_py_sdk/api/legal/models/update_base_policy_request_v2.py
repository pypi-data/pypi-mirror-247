...
class UpdateBasePolicyRequestV2(Model):
    """Update base policy request V2 (UpdateBasePolicyRequestV2)
    ...
    def with_affected_client_ids(self, value: List[str]) -> UpdateBasePolicyRequestV2:
        self.affected_client_ids = value
        return self

    def with_affected_countries(self, value: List[str]) -> UpdateBasePolicyRequestV2:
        self.affected_countries = value
        return self

    def with_base_policy_name(self, value: str) -> UpdateBasePolicyRequestV2:
    ...
    def create_many_from_dict(
        cls, dict_: dict, include_empty: bool = False
    ) -> Dict[str, UpdateBasePolicyRequestV2]:
        return (
    ...
    ) -> List[UpdateBasePolicyRequestV2]:
        return (
    ...
    def create_from_any(
        ...
        UpdateBasePolicyRequestV2,
        List[UpdateBasePolicyRequestV2],
        Dict[Any, UpdateBasePolicyRequestV2],
    ]:
        if many:
