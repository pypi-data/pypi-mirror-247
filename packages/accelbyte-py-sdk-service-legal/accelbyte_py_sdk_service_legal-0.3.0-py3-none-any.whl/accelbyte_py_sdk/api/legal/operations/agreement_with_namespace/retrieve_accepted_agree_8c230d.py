...
class RetrieveAcceptedAgreementsForMultiUsers(Operation):
    ...
    def with_body(
        self, value: UsersAgreementsRequest
    ) -> RetrieveAcceptedAgreementsForMultiUsers:
        self.body = value
        return self

    def with_namespace(self, value: str) -> RetrieveAcceptedAgreementsForMultiUsers:
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = UsersAgreementsRequest()
    ...
    def parse_response(
    ...
    ) -> Tuple[Union[None, List[UserAgreementsResponse]], Union[None, HttpResponse]]:
        ...
        if code == 200:
            return [UserAgreementsResponse.create_from_dict(i) for i in content], None
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = UsersAgreementsRequest.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = UsersAgreementsRequest()
