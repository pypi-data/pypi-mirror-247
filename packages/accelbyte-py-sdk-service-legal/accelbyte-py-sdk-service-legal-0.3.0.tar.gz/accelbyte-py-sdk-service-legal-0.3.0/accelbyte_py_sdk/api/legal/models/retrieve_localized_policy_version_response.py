...
class RetrieveLocalizedPolicyVersionResponse(Model):
    """Retrieve localized policy version response (RetrieveLocalizedPolicyVersionResponse)
    ...
    def with_id(self, value: str) -> RetrieveLocalizedPolicyVersionResponse:
        self.id_ = value
        return self
    ...
    def with_content_type(self, value: str) -> RetrieveLocalizedPolicyVersionResponse:
        self.content_type = value
        return self

    def with_created_at(self, value: str) -> RetrieveLocalizedPolicyVersionResponse:
        self.created_at = value
        return self

    def with_description(self, value: str) -> RetrieveLocalizedPolicyVersionResponse:
    ...
    def create_many_from_dict(
        cls, dict_: dict, include_empty: bool = False
    ) -> Dict[str, RetrieveLocalizedPolicyVersionResponse]:
        return (
    ...
    ) -> List[RetrieveLocalizedPolicyVersionResponse]:
        return (
    ...
    def create_from_any(
        ...
        RetrieveLocalizedPolicyVersionResponse,
        List[RetrieveLocalizedPolicyVersionResponse],
        Dict[Any, RetrieveLocalizedPolicyVersionResponse],
    ]:
        if many:
