...
class PagedRetrieveUserAcceptedAgreementResponse(Model):
    """Paged retrieve user accepted agreement response (PagedRetrieveUserAcceptedAgreementResponse)

    Properties:
        data: (data) OPTIONAL List[RetrieveUserAcceptedAgreementResponse]
    ...
    def with_paging(self, value: Paging) -> PagedRetrieveUserAcceptedAgreementResponse:
        self.paging = value
        return self
