...
class PolicyVersionWithLocalizedVersionObject(Model):
    """Policy version with localized version object (PolicyVersionWithLocalizedVersionObject)
    ...
    def with_display_version(
        self, value: str
    ) -> PolicyVersionWithLocalizedVersionObject:
        self.display_version = value
        return self

    def with_id(self, value: str) -> PolicyVersionWithLocalizedVersionObject:
        self.id_ = value
        return self

    def with_is_committed(self, value: bool) -> PolicyVersionWithLocalizedVersionObject:
        self.is_committed = value
        return self

    def with_is_in_effect(self, value: bool) -> PolicyVersionWithLocalizedVersionObject:
        self.is_in_effect = value
        return self

    def with_created_at(self, value: str) -> PolicyVersionWithLocalizedVersionObject:
        self.created_at = value
        return self

    def with_description(self, value: str) -> PolicyVersionWithLocalizedVersionObject:
    ...
    def with_status(self, value: str) -> PolicyVersionWithLocalizedVersionObject:
        self.status = value
        return self

    def with_updated_at(self, value: str) -> PolicyVersionWithLocalizedVersionObject:
    ...
    def create_many_from_dict(
        cls, dict_: dict, include_empty: bool = False
    ) -> Dict[str, PolicyVersionWithLocalizedVersionObject]:
        return (
    ...
    ) -> List[PolicyVersionWithLocalizedVersionObject]:
        return (
    ...
    def create_from_any(
        ...
        PolicyVersionWithLocalizedVersionObject,
        List[PolicyVersionWithLocalizedVersionObject],
        Dict[Any, PolicyVersionWithLocalizedVersionObject],
    ]:
        if many:
