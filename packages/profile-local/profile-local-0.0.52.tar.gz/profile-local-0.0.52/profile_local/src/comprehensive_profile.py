...
class ComprehensiveProfilesLocal:
    ...
    def insert(profile_json: str, lang_code: LangCode) -> int:
        ...
        if 'person' in data:
            ...
            id_dict['person_id'] = person_local_obj.insert(person=person_dto)
            person_local_obj._insert_person_ml(person_id=id_dict['person_id'],
        ...
        if "operational_hours" in data:
            ...
            id_dict['operational_hours_id'] = OperationalHours().insert(
    ...
    def delete(profile_id_dict: int) -> None:
        ...
        if profile_id_dict['location_id']:
            LocationLocal().delete(profile_id_dict['location_id'])
        # delete person
        ...
        if profile_id_dict['email_address_id']:
            EmailAddress().delete(profile_id_dict['email_address_id'])
