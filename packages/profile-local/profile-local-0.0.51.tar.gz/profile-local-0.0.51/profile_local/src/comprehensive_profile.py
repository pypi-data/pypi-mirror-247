...
from email_address_local.email_address import EmailAddress
...
class ComprehensiveProfilesLocal:
    ...
    @staticmethod
    def insert(profile_json: str, lang_code: LangCode) -> int:
        ...
        if "location" in data:
            ...
            location_id = location_obj.insert(
        ...
        if 'person' in data:
            ...
            person_local_obj = PersonsLocal()
            person_id = person_local_obj.insert(person=person_dto)
            profile_id = person_local_obj._insert_person_ml(
                person_id=person_id,
                lang_code=lang_code,
        ...
        if 'profile' in data:
            ...
            profile_id = ProfilesLocal().insert(person_id, profile_data)
        ...
        if 'profile_profile' in data:
            ...
            for i in profile_profile_entry:
                ...
                profile_profile_local_obj.insert_profile_profile(
                    profile_id1=profile_id, profile_id2=profile_profile_data['profile_id'],
        ...
        if 'group' in data:
            ...
            group_id = group_obj.create_group(group_data)
        ...
        if 'email' in data:
            ...
            email_obj.insert(email_data['email_address_id'],
        ...
        if 'profile_metrics' in data:
            ...
            profile_metrics_obj.insert(profile_metrics_data)
        ...
        if "reaction" in data:
            ...
            reaction_id = reaction_obj.insert(
                reaction_json, profile_id, lang_code)
        ...
        if "operational_hours" in data:
            ...
            OperationalHours().insert(profile_id, location_id, operational_hours_list_of_dicts)
