...
setuptools.setup(
    name=PACKAGE_NAME,
    version='0.0.51',  # https://pypi.org/project/profile-local/
    author="Circles",
    ...
    install_requires=["pytest>=7.4.0",
                      ...
                      "database-infrastructure-local>=0.0.17",
                      "database-infrastructure-local>=0.0.12",
                      "person-local>=0.0.20",
                      "gender-local>=0.0.6",
                      "location-local>=0.0.54",
                      "reaction-local>=0.0.8",
                      "profile-reaction-local>=0.0.14",
