...
class CompositeClient:
    ...
    def place_order(  # pylint: disable=too-many-arguments, too-many-locals
        ...
        return self.validator_client.post.send_message(
    ...
    def place_order_message(  # pylint: disable=too-many-arguments, too-many-locals
        ...
        time_in_force = calculate_time_in_force(
            type, time_in_force, execution, post_only
        )
        ...
        conditional_order_trigger_subticks = (
            self.calculate_conditional_order_trigger_subticks(
                type,
                atomic_resolution,
                quantum_conversion_exponent,
                subticks_per_tick,
