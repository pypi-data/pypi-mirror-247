...
class CheckPointApiKey(VendorAPI, RejectUnauthorized, DefaultRateLimiterSettings, BaseModel):
    """
...
class CheckPointUserAuth(VendorAPI, RejectUnauthorized, UserAuthBaseUrl, DefaultRateLimiterSettings, BaseModel):
    """
...
class CiscoFMC(VendorAPI, RejectUnauthorized, UserAuthBaseUrl, DefaultRateLimiterSettings, BaseModel):
    """
...
class SilverPeak(VendorAPI, RejectUnauthorized, UserAuthBaseUrl, DefaultRateLimiterSettings, BaseModel):
    ...
    @classmethod
    def check_login(cls, login_type):
