...
class Attributes:
    ...
    def update_local_attr_from_global(self) -> bool:
        ...
        local_sn = {i["sn"] for i in self.client.inventory.devices.all(columns=["sn"], snapshot_id=self.snapshot_id)}
        self.set_attributes_by_sn([g for g in g_attrs if g["sn"] in local_sn])
        return True
