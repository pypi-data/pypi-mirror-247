...
- API version: 0.11.6137
- Package version: 2.0.190
...
*TransactionPortfoliosApi* | [**create_trade_ticket**](docs/TransactionPortfoliosApi.md#create_trade_ticket) | **POST** /api/transactionportfolios/{scope}/{code}/$tradeticket | [EXPERIMENTAL] CreateTradeTicket: Create Trade Ticket
...
## Documentation For Models
 ...
 - [TransactionTemplateResponse](docs/TransactionTemplateResponse.md)
