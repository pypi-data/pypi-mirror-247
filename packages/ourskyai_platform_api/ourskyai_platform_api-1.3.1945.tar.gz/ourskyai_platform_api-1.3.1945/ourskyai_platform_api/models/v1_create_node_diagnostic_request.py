...
class V1CreateNodeDiagnosticRequest(BaseModel):
    """
    V1CreateNodeDiagnosticRequest
    """
    ...
    __properties = ["nodeId", "componentType", "componentId", "diagnosticType", "value", "measuredAt"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1CreateNodeDiagnosticRequest:
        """Create an instance of V1CreateNodeDiagnosticRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1CreateNodeDiagnosticRequest:
        """Create an instance of V1CreateNodeDiagnosticRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1CreateNodeDiagnosticRequest.parse_obj(obj)

        _obj = V1CreateNodeDiagnosticRequest.parse_obj({
