...
class V1GroundStationParticipant(BaseModel):
    ...
    __properties = ["nodeId", "location", "megapixels", "shutterType", "pixelSizeMicrons", "gpsTimestamps", "otaFocalLengthMm", "otaApertureMm", "mountType", "masterFlat", "masterDark", "masterBias"]
