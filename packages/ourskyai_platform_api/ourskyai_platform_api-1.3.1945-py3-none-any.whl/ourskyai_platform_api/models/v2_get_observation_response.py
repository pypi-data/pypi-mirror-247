...
class V2GetObservationResponse(BaseModel):
    """
    V2GetObservationResponse
    """
    id: StrictStr = Field(...)
    ...
    __properties = ["id", "imageSetId", "targetId", "trackingType", "exposureDuration", "binning", "gain", "gainMode", "ra", "dec", "captureStart", "captureEnd", "preCaptureWait", "startSlewAt", "cameraMode", "tleLine1", "tleLine2"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V2GetObservationResponse:
        """Create an instance of V2GetObservationResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V2GetObservationResponse:
        """Create an instance of V2GetObservationResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V2GetObservationResponse.parse_obj(obj)

        _obj = V2GetObservationResponse.parse_obj({
            "id": obj.get("id"),
