...
from finbourne_access.extensions.retry import (
    RetryingRestWrapper,
...
from finbourne_access.extensions.tcp_keep_alive_connector import (
...
class SyncApiClientFactory:
    ...
    def build(
        ...
        ----------
        metaclass : Type[T]
            A finbourne_access.api class.


        Returns
        -------
        T
            An instance of the finbourne_access.api class with a configured ApiClient
        """
