...
kwargs = json.loads(
    """
{
    "name": "cdk-cloudformation-fastly-services-version",
    "version": "1.8.0.a7",
    ...
    "packages": [
        "cdk_cloudformation_fastly_services_version",
        "cdk_cloudformation_fastly_services_version._jsii"
    ],
    "package_data": {
        "cdk_cloudformation_fastly_services_version._jsii": [
            "fastly-services-version@1.8.0-alpha.7.jsii.tgz"
        ],
        "cdk_cloudformation_fastly_services_version": [
            "py.typed"
        ]
