...
import botany.paths.directory.equalize as equalize_dir
...
import botany.paths.directory.check_equality as check_equality
import botany.paths.directory.size as dir_size
