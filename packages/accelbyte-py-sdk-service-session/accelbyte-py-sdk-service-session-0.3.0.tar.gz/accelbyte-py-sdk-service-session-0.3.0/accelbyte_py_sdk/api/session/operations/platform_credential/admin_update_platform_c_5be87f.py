...
class AdminUpdatePlatformCredentials(Operation):
    ...
    body: ApimodelsPutPlatformCredentialsRequest  # REQUIRED in [body]
    ...
    def with_body(
        self, value: ApimodelsPutPlatformCredentialsRequest
    ) -> AdminUpdatePlatformCredentials:
        self.body = value
        return self

    def with_namespace(self, value: str) -> AdminUpdatePlatformCredentials:
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = ApimodelsPutPlatformCredentialsRequest()
    ...
    @classmethod
    def create(
        cls, body: ApimodelsPutPlatformCredentialsRequest, namespace: str, **kwargs
    ) -> AdminUpdatePlatformCredentials:
        instance = cls()
        instance.body = body
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ApimodelsPutPlatformCredentialsRequest.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = ApimodelsPutPlatformCredentialsRequest()
