...
class PublicPartyReject(Operation):
    ...
    def with_namespace(self, value: str) -> PublicPartyReject:
        self.namespace = value
        return self

    def with_party_id(self, value: str) -> PublicPartyReject:
        self.party_id = value
        return self
    ...
    @classmethod
    def create(cls, namespace: str, party_id: str, **kwargs) -> PublicPartyReject:
        instance = cls()
