...
class UpdateGameSessionBackfillTicketID(Operation):
    ...
    body: ApimodelsUpdateGameSessionBackfillRequest  # REQUIRED in [body]
    ...
    def with_body(
        self, value: ApimodelsUpdateGameSessionBackfillRequest
    ) -> UpdateGameSessionBackfillTicketID:
        self.body = value
        return self

    def with_namespace(self, value: str) -> UpdateGameSessionBackfillTicketID:
        self.namespace = value
        return self

    def with_session_id(self, value: str) -> UpdateGameSessionBackfillTicketID:
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = ApimodelsUpdateGameSessionBackfillRequest()
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ApimodelsUpdateGameSessionBackfillRequest.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = ApimodelsUpdateGameSessionBackfillRequest()
