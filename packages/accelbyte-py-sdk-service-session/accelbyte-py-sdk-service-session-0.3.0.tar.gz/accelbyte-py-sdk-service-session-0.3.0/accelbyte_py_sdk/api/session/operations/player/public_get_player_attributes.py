...
class PublicGetPlayerAttributes(Operation):
    ...
    def with_namespace(self, value: str) -> PublicGetPlayerAttributes:
    ...
    @classmethod
    def create(cls, namespace: str, **kwargs) -> PublicGetPlayerAttributes:
        instance = cls()
