...
class GameSessionGenerateCode(Operation):
    ...
    def with_namespace(self, value: str) -> GameSessionGenerateCode:
        self.namespace = value
        return self

    def with_session_id(self, value: str) -> GameSessionGenerateCode:
