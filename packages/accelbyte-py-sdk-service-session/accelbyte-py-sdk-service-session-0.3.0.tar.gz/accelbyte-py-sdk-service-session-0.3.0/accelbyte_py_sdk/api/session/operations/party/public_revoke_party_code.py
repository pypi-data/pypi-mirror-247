...
class PublicRevokePartyCode(Operation):
    ...
    def with_namespace(self, value: str) -> PublicRevokePartyCode:
        self.namespace = value
        return self

    def with_party_id(self, value: str) -> PublicRevokePartyCode:
        self.party_id = value
        return self
    ...
    @classmethod
    def create(cls, namespace: str, party_id: str, **kwargs) -> PublicRevokePartyCode:
        instance = cls()
