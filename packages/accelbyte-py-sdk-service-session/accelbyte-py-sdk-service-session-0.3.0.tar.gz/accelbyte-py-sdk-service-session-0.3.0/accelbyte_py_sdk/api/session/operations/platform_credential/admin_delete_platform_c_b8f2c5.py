...
class AdminDeletePlatformCredentials(Operation):
    ...
    def with_namespace(self, value: str) -> AdminDeletePlatformCredentials:
    ...
    @classmethod
    def create(cls, namespace: str, **kwargs) -> AdminDeletePlatformCredentials:
        instance = cls()
