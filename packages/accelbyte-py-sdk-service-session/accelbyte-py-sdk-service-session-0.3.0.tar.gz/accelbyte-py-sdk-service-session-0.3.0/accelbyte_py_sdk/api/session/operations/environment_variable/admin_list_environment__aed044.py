...
class AdminListEnvironmentVariables(Operation):
    ...
    _url: str = "/session/v1/admin/environment-variables"
    _method: str = "GET"
    ...
    def parse_response(
        ...
        Union[None, ApimodelsEnvironmentVariableListResponse],
        ...
        if code == 200:
            return (
                ApimodelsEnvironmentVariableListResponse.create_from_dict(content),
                None,
            )
        if code == 401:
    ...
    @classmethod
    def create(cls, **kwargs) -> AdminListEnvironmentVariables:
        instance = cls()
        return instance
