...
class PublicGetParty(Operation):
    ...
    def with_namespace(self, value: str) -> PublicGetParty:
        self.namespace = value
        return self

    def with_party_id(self, value: str) -> PublicGetParty:
        self.party_id = value
        return self
    ...
    @classmethod
    def create(cls, namespace: str, party_id: str, **kwargs) -> PublicGetParty:
        instance = cls()
