...
class AdminReadUserSessionStorage(Operation):
    ...
    _url: str = "/session/v1/admin/namespaces/{namespace}/sessions/{sessionId}/storage/users/{userId}"
    _method: str = "GET"
    ...
    def with_namespace(self, value: str) -> AdminReadUserSessionStorage:
        self.namespace = value
        return self

    def with_session_id(self, value: str) -> AdminReadUserSessionStorage:
        self.session_id = value
        return self

    def with_user_id(self, value: str) -> AdminReadUserSessionStorage:
        self.user_id = value
        return self
