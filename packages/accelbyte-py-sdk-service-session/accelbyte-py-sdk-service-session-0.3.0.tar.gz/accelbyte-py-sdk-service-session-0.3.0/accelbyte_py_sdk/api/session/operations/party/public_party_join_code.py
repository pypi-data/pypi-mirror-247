...
class PublicPartyJoinCode(Operation):
    ...
    _url: str = "/session/v1/public/namespaces/{namespace}/parties/users/me/join/code"
    _method: str = "POST"
    ...
    def with_body(self, value: ApimodelsJoinByCodeRequest) -> PublicPartyJoinCode:
        self.body = value
        return self

    def with_namespace(self, value: str) -> PublicPartyJoinCode:
