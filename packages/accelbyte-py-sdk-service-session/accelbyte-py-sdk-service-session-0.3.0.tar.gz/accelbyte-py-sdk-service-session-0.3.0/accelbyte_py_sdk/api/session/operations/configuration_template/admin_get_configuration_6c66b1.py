...
class AdminGetConfigurationAlertV1(Operation):
    ...
    def with_namespace(self, value: str) -> AdminGetConfigurationAlertV1:
    ...
    @classmethod
    def create(cls, namespace: str, **kwargs) -> AdminGetConfigurationAlertV1:
        instance = cls()
