...
class AdminReconcileMaxActiveSession(Operation):
    ...
    body: ModelsRequestReconcileMaxActiveSession  # REQUIRED in [body]
    ...
    def with_body(
        self, value: ModelsRequestReconcileMaxActiveSession
    ) -> AdminReconcileMaxActiveSession:
        self.body = value
        return self

    def with_name(self, value: str) -> AdminReconcileMaxActiveSession:
        self.name = value
        return self

    def with_namespace(self, value: str) -> AdminReconcileMaxActiveSession:
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = ModelsRequestReconcileMaxActiveSession()
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelsRequestReconcileMaxActiveSession.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = ModelsRequestReconcileMaxActiveSession()
