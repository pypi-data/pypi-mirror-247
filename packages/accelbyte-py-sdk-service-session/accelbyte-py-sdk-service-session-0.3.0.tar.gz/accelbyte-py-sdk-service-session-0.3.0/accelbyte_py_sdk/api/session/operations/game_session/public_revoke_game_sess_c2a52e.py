...
class PublicRevokeGameSessionCode(Operation):
    ...
    def with_namespace(self, value: str) -> PublicRevokeGameSessionCode:
        self.namespace = value
        return self

    def with_session_id(self, value: str) -> PublicRevokeGameSessionCode:
