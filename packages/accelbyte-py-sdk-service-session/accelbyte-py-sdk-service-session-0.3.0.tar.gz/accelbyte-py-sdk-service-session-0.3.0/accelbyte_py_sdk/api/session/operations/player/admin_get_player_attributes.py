...
class AdminGetPlayerAttributes(Operation):
    ...
    def with_namespace(self, value: str) -> AdminGetPlayerAttributes:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> AdminGetPlayerAttributes:
        self.user_id = value
        return self
