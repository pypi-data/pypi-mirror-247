...
class PublicPromoteGameSessionLeader(Operation):
    ...
    def with_namespace(self, value: str) -> PublicPromoteGameSessionLeader:
        self.namespace = value
        return self

    def with_session_id(self, value: str) -> PublicPromoteGameSessionLeader:
