...
class GetGameSession(Operation):
    ...
    def with_namespace(self, value: str) -> GetGameSession:
        self.namespace = value
        return self

    def with_session_id(self, value: str) -> GetGameSession:
    ...
    @classmethod
    def create(cls, namespace: str, session_id: str, **kwargs) -> GetGameSession:
        instance = cls()
