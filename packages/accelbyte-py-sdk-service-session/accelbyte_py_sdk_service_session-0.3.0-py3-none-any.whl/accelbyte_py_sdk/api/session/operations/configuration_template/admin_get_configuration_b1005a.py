...
class AdminGetConfigurationTemplateV1(Operation):
    ...
    def with_name(self, value: str) -> AdminGetConfigurationTemplateV1:
        self.name = value
        return self

    def with_namespace(self, value: str) -> AdminGetConfigurationTemplateV1:
