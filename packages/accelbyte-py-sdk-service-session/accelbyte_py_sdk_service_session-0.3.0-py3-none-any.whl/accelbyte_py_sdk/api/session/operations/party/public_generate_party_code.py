...
class PublicGeneratePartyCode(Operation):
    ...
    _url: str = "/session/v1/public/namespaces/{namespace}/parties/{partyId}/code"
    _method: str = "POST"
    _consumes: List[str] = []
    ...
    def with_namespace(self, value: str) -> PublicGeneratePartyCode:
        self.namespace = value
        return self

    def with_party_id(self, value: str) -> PublicGeneratePartyCode:
        self.party_id = value
        return self
    ...
    @classmethod
    def create(cls, namespace: str, party_id: str, **kwargs) -> PublicGeneratePartyCode:
        instance = cls()
