...
class PublicPromotePartyLeader(Operation):
    ...
    _url: str = "/session/v1/public/namespaces/{namespace}/parties/{partyId}/leader"
    _method: str = "POST"
    ...
    body: ApimodelsPromoteLeaderRequest  # REQUIRED in [body]
    ...
    def with_body(
        self, value: ApimodelsPromoteLeaderRequest
    ) -> PublicPromotePartyLeader:
        self.body = value
        return self

    def with_namespace(self, value: str) -> PublicPromotePartyLeader:
        self.namespace = value
        return self

    def with_party_id(self, value: str) -> PublicPromotePartyLeader:
        self.party_id = value
        return self
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = ApimodelsPromoteLeaderRequest()
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ApimodelsPromoteLeaderRequest.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = ApimodelsPromoteLeaderRequest()
