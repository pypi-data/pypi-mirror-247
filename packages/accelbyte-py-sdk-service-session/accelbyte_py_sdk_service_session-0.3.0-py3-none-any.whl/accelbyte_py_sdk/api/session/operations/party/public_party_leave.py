...
class PublicPartyLeave(Operation):
    ...
    def with_namespace(self, value: str) -> PublicPartyLeave:
        self.namespace = value
        return self

    def with_party_id(self, value: str) -> PublicPartyLeave:
        self.party_id = value
        return self
    ...
    @classmethod
    def create(cls, namespace: str, party_id: str, **kwargs) -> PublicPartyLeave:
        instance = cls()
