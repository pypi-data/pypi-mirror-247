...
class PublicGameSessionInvite(Operation):
    ...
    def with_body(
        self, value: ApimodelsSessionInviteRequest
    ) -> PublicGameSessionInvite:
        self.body = value
        return self

    def with_namespace(self, value: str) -> PublicGameSessionInvite:
        self.namespace = value
        return self

    def with_session_id(self, value: str) -> PublicGameSessionInvite:
