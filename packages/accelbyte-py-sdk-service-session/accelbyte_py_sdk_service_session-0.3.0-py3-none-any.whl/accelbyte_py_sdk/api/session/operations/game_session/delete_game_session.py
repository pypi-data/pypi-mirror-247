...
class DeleteGameSession(Operation):
    ...
    def with_namespace(self, value: str) -> DeleteGameSession:
        self.namespace = value
        return self

    def with_session_id(self, value: str) -> DeleteGameSession:
    ...
    @classmethod
    def create(cls, namespace: str, session_id: str, **kwargs) -> DeleteGameSession:
        instance = cls()
