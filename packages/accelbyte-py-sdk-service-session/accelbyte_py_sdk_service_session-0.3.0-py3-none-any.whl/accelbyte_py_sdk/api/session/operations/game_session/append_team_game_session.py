...
class AppendTeamGameSession(Operation):
    ...
    body: ApimodelsAppendTeamGameSessionRequest  # REQUIRED in [body]
    ...
    def with_body(
        self, value: ApimodelsAppendTeamGameSessionRequest
    ) -> AppendTeamGameSession:
        self.body = value
        return self

    def with_namespace(self, value: str) -> AppendTeamGameSession:
        self.namespace = value
        return self

    def with_session_id(self, value: str) -> AppendTeamGameSession:
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = ApimodelsAppendTeamGameSessionRequest()
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ApimodelsAppendTeamGameSessionRequest.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = ApimodelsAppendTeamGameSessionRequest()
