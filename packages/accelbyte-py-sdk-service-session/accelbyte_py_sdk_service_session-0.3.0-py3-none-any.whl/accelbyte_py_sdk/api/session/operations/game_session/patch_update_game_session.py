...
class PatchUpdateGameSession(Operation):
    ...
    def with_body(
        self, value: ApimodelsUpdateGameSessionRequest
    ) -> PatchUpdateGameSession:
        self.body = value
        return self

    def with_namespace(self, value: str) -> PatchUpdateGameSession:
        self.namespace = value
        return self

    def with_session_id(self, value: str) -> PatchUpdateGameSession:
