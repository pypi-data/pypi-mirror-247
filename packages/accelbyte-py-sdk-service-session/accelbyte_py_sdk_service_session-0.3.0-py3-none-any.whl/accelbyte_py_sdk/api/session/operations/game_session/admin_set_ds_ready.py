...
class AdminSetDSReady(Operation):
    ...
    _url: str = "/session/v1/admin/namespaces/{namespace}/gamesessions/{sessionId}/ds"
    _method: str = "PUT"
    ...
    body: ApimodelsSetDSReadyRequest  # REQUIRED in [body]
    ...
    def with_body(self, value: ApimodelsSetDSReadyRequest) -> AdminSetDSReady:
        self.body = value
        return self

    def with_namespace(self, value: str) -> AdminSetDSReady:
        self.namespace = value
        return self

    def with_session_id(self, value: str) -> AdminSetDSReady:
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = ApimodelsSetDSReadyRequest()
    ...
    @classmethod
    def create(
        cls, body: ApimodelsSetDSReadyRequest, namespace: str, session_id: str, **kwargs
    ) -> AdminSetDSReady:
        instance = cls()
        instance.body = body
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ApimodelsSetDSReadyRequest.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = ApimodelsSetDSReadyRequest()
