...
class LeaveGameSession(Operation):
    ...
    def with_namespace(self, value: str) -> LeaveGameSession:
        self.namespace = value
        return self

    def with_session_id(self, value: str) -> LeaveGameSession:
    ...
    @classmethod
    def create(cls, namespace: str, session_id: str, **kwargs) -> LeaveGameSession:
        instance = cls()
