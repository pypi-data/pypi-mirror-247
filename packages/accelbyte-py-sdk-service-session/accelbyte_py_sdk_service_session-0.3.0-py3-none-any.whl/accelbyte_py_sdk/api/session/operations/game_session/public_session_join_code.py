...
class PublicSessionJoinCode(Operation):
    ...
    _url: str = "/session/v1/public/namespaces/{namespace}/gamesessions/join/code"
    _method: str = "POST"
    ...
    body: ApimodelsJoinByCodeRequest  # REQUIRED in [body]
    ...
    def with_body(self, value: ApimodelsJoinByCodeRequest) -> PublicSessionJoinCode:
        self.body = value
        return self

    def with_namespace(self, value: str) -> PublicSessionJoinCode:
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = ApimodelsJoinByCodeRequest()
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ApimodelsJoinByCodeRequest.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = ApimodelsJoinByCodeRequest()
