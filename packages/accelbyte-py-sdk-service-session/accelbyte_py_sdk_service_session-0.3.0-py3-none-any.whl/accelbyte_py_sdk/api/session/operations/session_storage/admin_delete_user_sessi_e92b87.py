...
class AdminDeleteUserSessionStorage(Operation):
    ...
    _url: str = "/session/v1/admin/namespaces/{namespace}/sessions/{sessionId}/storage"
    _method: str = "DELETE"
    ...
    def with_namespace(self, value: str) -> AdminDeleteUserSessionStorage:
        self.namespace = value
        return self

    def with_session_id(self, value: str) -> AdminDeleteUserSessionStorage:
