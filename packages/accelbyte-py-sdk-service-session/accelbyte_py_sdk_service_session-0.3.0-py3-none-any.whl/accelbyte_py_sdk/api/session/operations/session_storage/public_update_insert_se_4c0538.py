...
class PublicUpdateInsertSessionStorageLeader(Operation):
    ...
    def with_namespace(self, value: str) -> PublicUpdateInsertSessionStorageLeader:
        self.namespace = value
        return self

    def with_session_id(self, value: str) -> PublicUpdateInsertSessionStorageLeader:
