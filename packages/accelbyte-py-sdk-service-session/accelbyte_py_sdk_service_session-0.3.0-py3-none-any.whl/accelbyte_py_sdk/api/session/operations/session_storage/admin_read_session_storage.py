...
class AdminReadSessionStorage(Operation):
    ...
    def with_namespace(self, value: str) -> AdminReadSessionStorage:
        self.namespace = value
        return self

    def with_session_id(self, value: str) -> AdminReadSessionStorage:
