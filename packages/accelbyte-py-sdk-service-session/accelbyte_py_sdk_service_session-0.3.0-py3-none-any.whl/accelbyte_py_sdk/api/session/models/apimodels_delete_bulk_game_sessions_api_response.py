...
from ..models.apimodels_response_delete_bulk_game_sessions import (
    ApimodelsResponseDeleteBulkGameSessions,
)


class ApimodelsDeleteBulkGameSessionsAPIResponse(Model):
    ...
    def with_failed(
        self, value: List[ApimodelsResponseDeleteBulkGameSessions]
    ...
    def create_from_dict(
        ...
        if "failed" in dict_ and dict_["failed"] is not None:
            instance.failed = [
                ApimodelsResponseDeleteBulkGameSessions.create_from_dict(
    ...
    def create_many_from_dict(
        cls, dict_: dict, include_empty: bool = False
    ) -> Dict[str, ApimodelsDeleteBulkGameSessionsAPIResponse]:
        return (
    ...
    ) -> List[ApimodelsDeleteBulkGameSessionsAPIResponse]:
        return (
    ...
    def create_from_any(
        ...
        ApimodelsDeleteBulkGameSessionsAPIResponse,
        List[ApimodelsDeleteBulkGameSessionsAPIResponse],
        Dict[Any, ApimodelsDeleteBulkGameSessionsAPIResponse],
    ]:
        if many:
