...
from lusid_configuration.extensions.retry import (
    RetryingRestWrapper,
...
from lusid_configuration.extensions.tcp_keep_alive_connector import (
...
class SyncApiClientFactory:
    ...
    def build(
        ...
        ----------
        metaclass : Type[T]
            A lusid_configuration.api class.


        Returns
        -------
        T
            An instance of the lusid_configuration.api class with a configured ApiClient
        """
