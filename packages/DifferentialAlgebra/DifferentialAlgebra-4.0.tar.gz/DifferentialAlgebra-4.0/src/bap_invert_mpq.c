    ...
    bap_polynom_mpq B)
{
  ...
  bap_polynom_mpq quotient = (bap_polynom_mpq) 0;
  ba0_mpq_t b, q;
  ...
  if (Q != (bap_polynom_mpq) 0)
    {
      ...
      bap_begin_creator_mpq (&crea, quotient, &TQ,
    ...
    bap_polynom_mpq B)
{
  ...
  if (bap_is_zero_polynom_mpq (B))
    ...
    {
      bap_Euclidean_division_polynom_mpq ((bap_polynom_mpq) 0, V3, A, B);
      bap_set_polynom_mpq (U3, B);
      while (!bap_is_zero_polynom_mpq (V3))
        {
          bap_set_polynom_mpq (T3, V3);
          bap_Euclidean_division_polynom_mpq
              ((bap_polynom_mpq) 0, V3, U3, V3);
          BA0_SWAP (bap_polynom_mpq, U3, T3);
        }
    }
...
bap_extended_Euclid_polynom_mpq (
    ...
    bap_polynom_mpq B)
{
  bap_polynom_mpq U1, U3, V1, V3, T1, T3, Q;
  ba0_mpq_t a;
  struct ba0_mark M;
  ...
  while (!bap_is_zero_polynom_mpq (V3))
    {
      ...
      BA0_SWAP (bap_polynom_mpq, U1, T1);
    }
  if (!bap_is_zero_polynom_mpq (U3))
    {
      ba0_mpq_init (a);
