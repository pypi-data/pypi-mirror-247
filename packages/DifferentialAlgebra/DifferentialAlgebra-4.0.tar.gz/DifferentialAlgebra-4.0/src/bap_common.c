    ...
    ba0_int_p memory_limit)
{
  ...
  switch (level)
    {
    case ba0_init_level:
      ba0_define_format_with_sizelt ("Az",
      ...
      ba0_define_format_with_sizelt ("careful_expanded_Az",
          sizeof (struct bap_polynom_mpz),
      ...
      ba0_define_format_with_sizelt ("Azm",
          sizeof (struct bap_polynom_mpzm),
          &bap_scanf_polynom_mpzm,
          &bap_printf_polynom_mpzm,
          &bap_garbage1_polynom_mpzm,
          &bap_garbage2_polynom_mpzm, &bap_copy_polynom_mpzm);

      ba0_define_format_with_sizelt ("Aq",
      ...
      ba0_define_format_with_sizelt ("careful_expanded_Aq",
          sizeof (struct bap_polynom_mpq),
          &bap_scanf_careful_expanded_polynom_mpq,
          &bap_printf_polynom_mpq,
          &bap_garbage1_polynom_mpq,
          &bap_garbage2_polynom_mpq, &bap_copy_polynom_mpq);

      ba0_define_format_with_sizelt ("Aim",
          sizeof (struct bap_polynom_mint_hp),
          &bap_scanf_polynom_mint_hp,
          &bap_printf_polynom_mint_hp,
          &bap_garbage1_polynom_mint_hp,
          &bap_garbage2_polynom_mint_hp, &bap_copy_polynom_mint_hp);

      ba0_define_format_with_sizelt ("Pz",
          sizeof (struct bap_product_mpz),
          &bap_scanf_product_mpz,
          &bap_printf_product_mpz,
          &bap_garbage1_product_mpz,
          &bap_garbage2_product_mpz, &bap_copy_product_mpz);

      ba0_define_format_with_sizelt ("Pzm",
          sizeof (struct bap_product_mpzm),
          &bap_scanf_product_mpzm,
          &bap_printf_product_mpzm,
          &bap_garbage1_product_mpzm,
          &bap_garbage2_product_mpzm, &bap_copy_product_mpzm);

      ba0_define_format_with_sizelt ("Pq",
          sizeof (struct bap_product_mpq),
          &bap_scanf_product_mpq,
          &bap_printf_product_mpq,
          &bap_garbage1_product_mpq,
          &bap_garbage2_product_mpq, &bap_copy_product_mpq);

      ba0_define_format_with_sizelt ("Pim",
          sizeof (struct bap_product_mint_hp),
          &bap_scanf_product_mint_hp,
          &bap_printf_product_mint_hp,
          &bap_garbage1_product_mint_hp,
          &bap_garbage2_product_mint_hp, &bap_copy_product_mint_hp);
