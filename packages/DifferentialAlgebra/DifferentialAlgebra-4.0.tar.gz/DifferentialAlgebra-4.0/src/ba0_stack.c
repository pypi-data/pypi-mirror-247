    ...
    struct ba0_stack *H)
{
  ...
  ba0_init_table ((ba0_table) & H->sizes);
  ba0_re_malloc_table (&H->cells, ba0_nb_cells_per_stack);
  ba0_re_malloc_table ((ba0_table) & H->sizes, ba0_nb_cells_per_stack);
    ...
    ba0_int_p cell_size)
{
  ...
  ba0_re_malloc_table ((ba0_table) & H->sizes, 1);
 ...
 * allocated datas: the next call to the function will check that the 
...
ba0_init_stack_of_stacks (
    void)
{
  ba0_init_table ((ba0_table) & ba0_global.stack.stack_of_stacks);
  ba0_re_malloc_table ((ba0_table) & ba0_global.stack.stack_of_stacks,
 ...
 */
          if (H->cells.size == H->cells.alloc)
            {
              ba0_re_malloc_table ((ba0_table) & H->cells, 2 * H->cells.alloc);
              ba0_re_malloc_table ((ba0_table) & H->sizes, 2 * H->sizes.alloc);
            }
/*
