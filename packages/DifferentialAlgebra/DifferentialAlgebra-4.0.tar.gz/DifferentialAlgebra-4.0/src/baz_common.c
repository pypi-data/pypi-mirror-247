    ...
    ba0_int_p memory_limit)
{
  ...
  switch (level)
    {
    case ba0_init_level:
      ba0_define_format_with_sizelt ("Qz",
          sizeof (struct baz_ratfrac),
          &baz_scanf_ratfrac,
          &baz_printf_ratfrac,
          &baz_garbage1_ratfrac, &baz_garbage2_ratfrac, &baz_copy_ratfrac);

      ba0_define_format_with_sizelt ("expanded_Qz",
          sizeof (struct baz_ratfrac),
          &baz_scanf_expanded_ratfrac,
          &baz_printf_ratfrac,
          &baz_garbage1_ratfrac, &baz_garbage2_ratfrac, &baz_copy_ratfrac);

      ba0_define_format_with_sizelt ("careful_expanded_Qz",
          sizeof (struct baz_ratfrac),
          &baz_scanf_careful_expanded_ratfrac,
          &baz_printf_ratfrac,
          &baz_garbage1_ratfrac, &baz_garbage2_ratfrac, &baz_copy_ratfrac);

      ba0_define_format_with_sizelt ("relQz",
          sizeof (struct baz_rel_ratfrac),
          &baz_scanf_rel_ratfrac,
          &baz_printf_rel_ratfrac,
          &baz_garbage1_rel_ratfrac,
          &baz_garbage2_rel_ratfrac, &baz_copy_rel_ratfrac);

      ba0_define_format_with_sizelt ("gcd_data",
          sizeof (struct baz_gcd_data), 0, &baz_printf_gcd_data, 0, 0, 0);
