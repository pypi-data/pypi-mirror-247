...
/*
 * texinfo: bai_restart
 * Call the @code{bad_restart} function with the same parameters
 */
    ...
    ba0_int_p memory_limit)
{
  ...
  switch (level)
    ...
    case ba0_init_level:
      ...
      ba0_define_format_with_sizelt ("odex",
          sizeof (struct bai_odex_system),
          &bai_scanf_odex_system,
          &bai_printf_odex_system,
          &bai_garbage1_odex_system,
          &bai_garbage2_odex_system, &bai_copy_odex_system);
 ...
 * Call the @code{bad_terminate} function with the same parameter.
 */
