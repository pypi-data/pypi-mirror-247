...
static bap_polynom_mint_hp
bap_new_polynom_clot_mint_hp (
    bap_clot_mint_hp C)
{
  bap_polynom_mint_hp A;

  A = (bap_polynom_mint_hp) ba0_alloc (sizeof (struct bap_polynom_mint_hp));
  bap_init_polynom_clot_mint_hp (A, C);
  return A;
}
...
bap_gt_rank_polynom_mint_hp (
    ...
    void *Q)
{
  bap_polynom_mint_hp A = (bap_polynom_mint_hp) P;
  bap_polynom_mint_hp B = (bap_polynom_mint_hp) Q;
...
/*
 * texinfo: bap_involved_parameters_polynom_mint_hp
...
BAP_DLL void
bap_involved_parameters_polynom_mint_hp (
...
/*
 * texinfo: bap_mark_ranks_polynom_mint_hp
...
BAP_DLL void
bap_mark_ranks_polynom_mint_hp (
    bap_polynom_mint_hp A)
{
  ba0_int_p i;
    ...
    bap_polynom_mint_hp A)
{
  ...
  bap_change_ordering_clot_mint_hp (A->clot, bav_R_Iordering ());
}
...
bap_initial_and_reductum_polynom_mint_hp (
    bap_polynom_mint_hp initial,
    bap_polynom_mint_hp reductum,
    bap_polynom_mint_hp A)
{
  ...
  if (bap_is_numeric_polynom_mint_hp (A))
    BA0_RAISE_EXCEPTION (BAP_ERRCST);
  if ((A == initial && reductum != BAP_NOT_A_POLYNOM_mint_hp) ||
    ...
    bav_variable v)
{
  ...
  if (bap_is_numeric_polynom_mint_hp (A) ||
      (v != BAV_NOT_A_VARIABLE && v != bap_leader_polynom_mint_hp (A)))
    {
      if (!bap_depend_polynom_mint_hp (A, v))
      ...
      else
        {
          ...
          bap_initial_and_reductum_polynom_mint_hp
              (lcoeff != BAP_NOT_A_POLYNOM_mint_hp ?
              &lc : BAP_NOT_A_POLYNOM_mint_hp,
              reductum != BAP_NOT_A_POLYNOM_mint_hp ?
              &red : BAP_NOT_A_POLYNOM_mint_hp, &AA);
  ...
  else
    {
      ...
      bap_initial_and_reductum_polynom_mint_hp
          ...
          &lc : BAP_NOT_A_POLYNOM_mint_hp,
          reductum != BAP_NOT_A_POLYNOM_mint_hp ?
          &red : BAP_NOT_A_POLYNOM_mint_hp, A);
    ...
    bav_Idegree d)
{
  ...
  if (R == (bap_polynom_mint_hp) 0)
    ...
    BA0_RAISE_EXCEPTION (BA0_ERRALG);
  if (C != (bap_polynom_mint_hp) 0 && C->readonly)
    BA0_RAISE_EXCEPTION (BA0_ERRALG);
  if (C == R)
    BA0_RAISE_EXCEPTION (BA0_ERRALG);

  if (bap_is_numeric_polynom_mint_hp (A) ||
      (v != BAV_NOT_A_VARIABLE && !bap_depend_polynom_mint_hp (A, v)))
    {
      if (d == 0)
        {
          if (C != A && C != (bap_polynom_mint_hp) 0)
            bap_set_polynom_mint_hp (C, A);
          bap_set_polynom_zero_mint_hp (R);
        }
      else
        {
          if (C != (bap_polynom_mint_hp) 0)
  ...
  if (C != A && R != A)
    {
      ...
      bap_begin_creator_mint_hp (&creaR, R, &A->total_rank,
          ...
          if (C != A && R != A)
            {
              ...
              if (C != (bap_polynom_mint_hp) 0)
                bap_write_creator_mint_hp
                    (&creaC, &U, *bap_coeff_itermon_mint_hp (&iter));
              ba0_push_another_stack ();
            }
          else
            bap_write_creator_mint_hp
          ...
          if (C != A && R != A)
            {
              ba0_pull_stack ();
              bap_write_creator_mint_hp
                  (&creaR, &T, *bap_coeff_itermon_mint_hp (&iter));
              ba0_push_another_stack ();
            }
          else
            bap_write_creator_mint_hp
    ...
    bap_polynom_mint_hp A)
{
  ...
  P = bap_new_polynom_mint_hp ();
  bap_begin_creator_mint_hp (&crea, P, &T,
      bap_approx_total_rank, bap_nbmon_polynom_mint_hp (A));
...
comp_polynom_ascending (
    ...
    const void *y)
{
  bap_polynom_mint_hp A = *(bap_polynom_mint_hp *) x;
  bap_polynom_mint_hp B = *(bap_polynom_mint_hp *) y;
  struct bav_term TA, TB;
  struct ba0_mark M;
  enum ba0_compare_code code;
...
bap_sort_tableof_polynom_mint_hp (
    bap_tableof_polynom_mint_hp T,
    enum ba0_sort_mode mode)
{
  switch (mode)
    {
    case ba0_descending_mode:
      qsort (T->tab, T->size, sizeof (bap_polynom_mint_hp),
          &comp_polynom_descending);
      break;
...
static char _struct_polynom_rang[] = "bap_polynom_mint_hp->total_rank";
...
{
  bap_polynom_mint_hp A = (bap_polynom_mint_hp) AA;
  ba0_int_p n = 0;

  if (code == ba0_isolated)
    n += ba0_new_gc_info
        (A, sizeof (struct bap_polynom_mint_hp), _struct_polynom);
    ...
    enum ba0_garbage_code code)
{
  ...
  if (code == ba0_isolated)
    A = (bap_polynom_mint_hp) ba0_new_addr_gc_info (AA, _struct_polynom);
  else
    A = (bap_polynom_mint_hp) AA;

  A->clot = (bap_clot_mint_hp) bap_garbage2_clot_mint_hp (A->clot, ba0_isolated);
