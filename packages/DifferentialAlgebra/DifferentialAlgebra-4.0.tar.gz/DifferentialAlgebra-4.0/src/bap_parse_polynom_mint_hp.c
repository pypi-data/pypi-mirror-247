 ...
 * difference @math{p - q}.
 * This function relies of @code{bap_scanf_polynom_mint_hp}.
 */
...
bap_scanf_polynom_eqn_mint_hp (
    void *R)
{
  bap_polynom_mint_hp A = (bap_polynom_mint_hp) R;
  struct bap_polynom_mint_hp B, C;
  struct ba0_mark M;

  if (A == (bap_polynom_mint_hp) 0)
    A = bap_new_polynom_mint_hp ();
 ...
 */
  ...
  while (minus || plus)
    {
#if ! defined (BAD_FLAG_mint_hp)
      coeffs = (ba0_listof_mint_hp) ba0_cons_list
          (ba0_new_mint_hp (), (ba0_list) coeffs);
#else
      coeffs = (ba0_listof_mint_hp) ba0_cons_list (0, (ba0_list) coeffs);
#endif
 ...
 */
  ...
  while (coeffs != (ba0_listof_mint_hp) 0)
    {
#if ! defined (BAD_FLAG_mint_hp)
      bap_write_creator_mint_hp (&crea, (bav_term) terms->value, coeffs->value);
#else
      bap_write_creator_mint_hp (&crea, (bav_term) terms->value,
...
bap_printf_polynom_mint_hp (
    void *R)
{
  bap_polynom_mint_hp P = (bap_polynom_mint_hp) R;
...
/*
 * texinfo: bap_scanf_careful_expanded_polynom_mint_hp
...
BAP_DLL void *
bap_scanf_careful_expanded_polynom_mint_hp (
    void *A)
{
