  ...
  switch (level)
    ...
    case ba0_init_level:
      ba0_define_format_with_sizelt
          ("regchain", sizeof (struct bad_regchain),
          &bad_scanf_regchain,
          &bad_printf_regchain,
          &bad_garbage1_regchain, &bad_garbage2_regchain, &bad_copy_regchain);

      ba0_define_format_with_sizelt
          ("regchain_equations", sizeof (struct bad_regchain),
          &bad_scanf_regchain,
          &bad_printf_regchain_equations,
          &bad_garbage1_regchain, &bad_garbage2_regchain, &bad_copy_regchain);

      ba0_define_format_with_sizelt
          ("pretend_regchain", sizeof (struct bad_regchain),
          &bad_scanf_pretend_regchain,
          &bad_printf_regchain,
          &bad_garbage1_regchain, &bad_garbage2_regchain, &bad_copy_regchain);

      ba0_define_format_with_sizelt
          ("critic", sizeof (struct bad_critical_pair),
      ...
      ba0_define_format_with_sizelt
          ("splitting_edge", sizeof (struct bad_splitting_edge),
      ...
      ba0_define_format_with_sizelt
          ("splitting_tree", sizeof (struct bad_splitting_tree),
      ...
      ba0_define_format_with_sizelt
          ("quadruple", sizeof (struct bad_quadruple),
          &bad_scanf_quadruple,
      ...
      ba0_define_format_with_sizelt
          ("intersectof_regchain_equations",
          sizeof (struct bad_intersectof_regchain),
          &bad_scanf_intersectof_regchain,
      ...
      ba0_define_format
          ...
          0, &bad_printf_preparation_equation, 0, 0, 0);

      ba0_define_format_with_sizelt
          ("base_field",
          sizeof (struct bad_base_field),
          &bad_scanf_base_field, &bad_printf_base_field, 0, 0, 0);
