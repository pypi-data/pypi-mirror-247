...
baz_gcd_product_mpz (
    bap_product_mpz G,
    bap_product_mpz cofA,
    bap_product_mpz cofB,
    bap_product_mpz A,
    bap_product_mpz B)
{
 ...
 */
      ...
      baz_gcd_polynom_mpz (&g, &cofa, &cofb,
          &AA.tab[a].factor, &BB.tab[b].factor);
 ...
 */
  ...
  if (cofA != (bap_product_mpz) 0 && cofB != (bap_product_mpz) 0 &&
      ba0_mpz_sgn (cofA->num_factor) < 0 && ba0_mpz_sgn (cofB->num_factor) < 0)
    {
