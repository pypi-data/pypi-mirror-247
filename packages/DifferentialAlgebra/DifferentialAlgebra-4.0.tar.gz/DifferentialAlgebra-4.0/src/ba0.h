...
#   if defined (BA0_NEWDEF) || defined (__cplusplus)
#      undef BA0_OLDDEF
#   else
#      define BA0_OLDDEF
#   endif
...
/* 
 * _MSC_VER + BA0_64BITS ==> BA0_USE_X64_GMP
 */
...
#ifndef BA0_MESGERR_H
#   define BA0_MESGERR_H 1
...
typedef struct ba0_table *ba0_table;
#   endif
...
#   if defined (BA0_OLDDEF)
typedef struct ba0_tableof_table *ba0_tableof_table;
#   endif
...
#   if defined (BA0_OLDDEF)
typedef struct ba0_array *ba0_array;
#   endif
...
#   if defined (BA0_OLDDEF)
typedef struct ba0_list *ba0_list;
#   endif
...
#   if defined (BA0_OLDDEF)
typedef struct ba0_matrix *ba0_matrix;
#   endif
...
#   if defined (BA0_OLDDEF)
typedef struct ba0_tableof_int_p *ba0_tableof_int_p;
#   endif
...
#   if defined (BA0_OLDDEF)
typedef struct ba0_tableof_unsigned_int_p *ba0_tableof_unsigned_int_p;
#   endif
...
#   if defined (BA0_OLDDEF)
typedef struct ba0_matrixof_int_p *ba0_matrixof_int_p;
#   endif
...
#   if defined (BA0_OLDDEF)
typedef struct ba0_listof_int_p *ba0_listof_int_p;
#   endif
...
#   if defined (BA0_OLDDEF)
typedef struct ba0_tableof_tableof_int_p *ba0_tableof_tableof_int_p;
#   endif
...
#   if defined (BA0_OLDDEF)
typedef struct ba0_tableof_stack *ba0_tableof_stack;
#   endif
...
#   if defined (BA0_OLDDEF)
typedef struct ba0_tableof_double *ba0_tableof_double;
#   endif
...
#   if defined (BA0_OLDDEF)
typedef struct ba0_arrayof_double *ba0_arrayof_double;
#   endif
...
#   if defined (BA0_OLDDEF)
typedef struct ba0_matrixof_double *ba0_matrixof_double;
#   endif
...
#   if defined (BA0_OLDDEF)
typedef struct ba0_tableof_mpz *ba0_tableof_mpz;
#   endif
...
#   if defined (BA0_OLDDEF)
typedef struct ba0_listof_mpz *ba0_listof_mpz;
#   endif
...
#   if defined (BA0_OLDDEF)
typedef struct ba0_tableof_mpq *ba0_tableof_mpq;
#   endif
...
#   if defined (BA0_OLDDEF)
typedef struct ba0_listof_mpq *ba0_listof_mpq;
#   endif
...
#   if defined (BA0_OLDDEF)
typedef struct ba0_interval_mpq *ba0_interval_mpq;
#   endif
...
#   if defined (BA0_OLDDEF)
typedef struct ba0_tableof_interval_mpq *ba0_tableof_interval_mpq;
#   endif
...
#   if defined (BA0_OLDDEF)
typedef struct ba0_listof_interval_mpq *ba0_listof_interval_mpq;
#   endif
...
struct ba0_output_device
{
  ...
  FILE *file_flux;              /* if vers = ba0_file_device */
  char *string_flux;            /* if vers = ba0_string_device */
  ba0_int_p indice;             /* if vers = ba0_string_device */
  ba0_int_p counter;            /* nmbr of char already printed on the line */
};
...
struct ba0_input_device
{
  ...
  FILE *file_flux;              /* if from = ba0_file_device */
  char *string_flux;            /* if from = ba0_string_device */
  ba0_int_p indice;             /* if from = ba0_string_device */
};
...
#   if defined (BA0_OLDDEF)
typedef struct ba0_gc_info *ba0_gc_info;
#   endif
...
#   if defined (BA0_OLDDEF)
typedef struct ba0_tableof_mint_hp *ba0_tableof_mint_hp;
#   endif
...
#   if defined (BA0_OLDDEF)
typedef struct ba0_listof_mint_hp *ba0_listof_mint_hp;
#   endif
...
#   if defined (BA0_OLDDEF)
typedef struct ba0_tableof_mpzm *ba0_tableof_mpzm;
#   endif
...
#   if defined (BA0_OLDDEF)
typedef struct ba0_listof_mpzm *ba0_listof_mpzm;
#   endif
...
#   if defined (BA0_OLDDEF)
typedef struct ba0_tableof_string *ba0_tableof_string;
#   endif
...
#   if defined (BA0_OLDDEF)
typedef struct ba0_matrixof_string *ba0_matrixof_string;
#   endif
...
#   if defined (BA0_OLDDEF)
typedef struct ba0_listof_string *ba0_listof_string;
#   endif
...
#   if defined (BA0_OLDDEF)
typedef struct ba0_tableof_tableof_string *ba0_tableof_tableof_string;
#   endif
