 ...
 * difference @math{p - q}.
 * This function relies of @code{bap_scanf_polynom_mpq}.
 */
...
bap_scanf_polynom_eqn_mpq (
    void *R)
{
  bap_polynom_mpq A = (bap_polynom_mpq) R;
 ...
 */
  ...
  while (minus || plus)
    {
#if ! defined (BAD_FLAG_mint_hp)
      coeffs = (ba0_listof_mpq) ba0_cons_list
          (ba0_new_mpq (), (ba0_list) coeffs);
#else
      coeffs = (ba0_listof_mpq) ba0_cons_list (0, (ba0_list) coeffs);
#endif
 ...
 */
  ...
  while (coeffs != (ba0_listof_mpq) 0)
    {
#if ! defined (BAD_FLAG_mint_hp)
      bap_write_creator_mpq (&crea, (bav_term) terms->value, coeffs->value);
#else
      bap_write_creator_mpq (&crea, (bav_term) terms->value,
...
bap_printf_polynom_mpq (
    void *R)
{
  bap_polynom_mpq P = (bap_polynom_mpq) R;
...
/*
 * texinfo: bap_scanf_careful_expanded_polynom_mpq
