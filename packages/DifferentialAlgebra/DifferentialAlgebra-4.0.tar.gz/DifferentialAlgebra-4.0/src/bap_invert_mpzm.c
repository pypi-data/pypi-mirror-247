    ...
    bap_polynom_mpzm B)
{
  ...
  bap_polynom_mpzm quotient = (bap_polynom_mpzm) 0;
  ba0_mpzm_t b, q;
  ...
  if (Q != (bap_polynom_mpzm) 0)
    {
      ...
      bap_begin_creator_mpzm (&crea, quotient, &TQ,
    ...
    bap_polynom_mpzm B)
{
  ...
  if (bap_is_zero_polynom_mpzm (B))
    ...
    {
      bap_Euclidean_division_polynom_mpzm ((bap_polynom_mpzm) 0, V3, A, B);
      bap_set_polynom_mpzm (U3, B);
      while (!bap_is_zero_polynom_mpzm (V3))
        {
          bap_set_polynom_mpzm (T3, V3);
          bap_Euclidean_division_polynom_mpzm
              ((bap_polynom_mpzm) 0, V3, U3, V3);
          BA0_SWAP (bap_polynom_mpzm, U3, T3);
        }
    }
...
bap_extended_Euclid_polynom_mpzm (
    ...
    bap_polynom_mpzm B)
{
  bap_polynom_mpzm U1, U3, V1, V3, T1, T3, Q;
  ba0_mpzm_t a;
  struct ba0_mark M;
  ...
  while (!bap_is_zero_polynom_mpzm (V3))
    {
      ...
      BA0_SWAP (bap_polynom_mpzm, U1, T1);
    }
  if (!bap_is_zero_polynom_mpzm (U3))
    {
      ba0_mpzm_init (a);
