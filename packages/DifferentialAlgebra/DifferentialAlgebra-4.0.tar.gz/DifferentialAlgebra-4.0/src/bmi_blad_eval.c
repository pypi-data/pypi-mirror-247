...
#undef PRINT
#if defined (PRINT)
        ba0_printf ("bav_scanf_jet_variable\n");
#endif
        s = &bav_scanf_jet_variable;
        break;
      case bmi_diff_notation:
#if defined (PRINT)
        ba0_printf ("bav_scanf_diff_variable\n");
#endif
      ...
      case bmi_jet0_notation:
        s = &bav_scanf_jet0_variable;
        break;
      case bmi_D_notation:
#if defined (MAPLE)
#   if defined (PRINT)
        ba0_printf ("bav_scanf_maple_D_variable\n");
#   endif
        s = &bav_scanf_maple_D_variable;
#else
#   if defined (PRINT)
        ba0_printf ("bav_scanf_sage_D_variable\n");
#   endif
        s = &bav_scanf_sage_D_variable;
#endif
        break;
      case bmi_Derivative_notation:
#if defined (PRINT)
        ba0_printf ("bav_scanf_sympy_Derivative_variable\n");
#endif
        s = &bav_scanf_sympy_Derivative_variable;
        break;
 ...
 */
    switch (options->output_notation)
      ...
      case bmi_D_notation:
        ...
        break;
      case bmi_Derivative_notation:
        f = &bav_printf_sympy_Derivative_variable;
        break;
      default:                 /* to avoid a stupid warning */
        f = 0;
      }
    bav_set_settings_variable (s, f, 0, 0);
    bav_set_settings_ordering ("ranking");
 ...
 */
  ...
  if (!bmi_set_options (&options, callback, (ALGEB *) args + 2,
          nargs - 1))
    {
 ...
 * Sage specific
 */
  ba0_get_settings_gmp (&set, 0, 0);
  ba0_set_settings_gmp (set, true, "Integer");
  bav_set_settings_variable (0, 0, 0, 0);
