    ...
    bap_polynom_mint_hp Q)
{
  ...
  bap_polynom_mint_hp P = (bap_polynom_mint_hp) 0, R;
  ...
  if (Q != BAP_NOT_A_POLYNOM_mint_hp)
    {
      ...
      bap_begin_creator_mint_hp (&creaQ, P, &TQmax,
    ...
    bap_polynom_mint_hp Q)
{
  ...
  bap_polynom_mint_hp AA = (bap_polynom_mint_hp) 0, P = (bap_polynom_mint_hp) 0;
  struct bav_term T, U;
  bav_variable v, w;
  bool divisible;
  bav_Iordering r;
 ...
 */
  ...
  bap_mark_indets_polynom_mint_hp (B);
 ...
 */
  ...
  {
    bap_polynom_mint_hp AA0 = bap_new_readonly_polynom_mint_hp ();
 ...
 */
      ...
      bap_begin_creator_mint_hp
          (&crea, P, &T, bap_exact_total_rank, bap_nbmon_polynom_mint_hp (A));
    }
              ...
              while (!bap_outof_itermon_mint_hp (&itermon))
                {
                  ...
                  bap_write_creator_mint_hp
                      (&crea, &U, *bap_coeff_itermon_mint_hp (&itermon));
                  bap_next_itermon_mint_hp (&itermon);
                }
            }
        }
      else
        divisible = bap_is_factor_elem_polynom_mint_hp
            (&c, B, BAP_NOT_A_POLYNOM_mint_hp);
      if (divisible)
    ...
    bav_term T)
{
  ...
  P = bap_new_polynom_mint_hp ();
  bap_begin_creator_mint_hp
      (&crea, P, &U, bap_exact_total_rank, bap_nbmon_polynom_mint_hp (A));
...
bap_pseudo_division_elem_polynom_mint_hp (
    ...
    bap_polynom_mint_hp B,
    bav_variable x,
    bap_tableof_polynom_mint_hp ibp)
{
  ...
  bap_polynom_mint_hp P = (bap_polynom_mint_hp) 0;
  struct bav_term T;
    ...
    bav_variable x)
{
  ...
  bap_polynom_mint_hp AA, quotient, reste;
  bap_polynom_mint_hp Pquotient = (bap_polynom_mint_hp) 0,
      Preste = (bap_polynom_mint_hp) 0;
  ba0_mint_hp_t *lc;
  struct bav_term T, U;
  bav_variable v, w;
  bav_Iordering r;
  ...
  while (ddeg >= 0)
    {
      ...
      ddeg = bap_degree_polynom_mint_hp (&reste, v) -
