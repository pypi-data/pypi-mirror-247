    ...
    bap_polynom_mint_hp B)
{
  ...
  bap_polynom_mint_hp quotient = (bap_polynom_mint_hp) 0;
  ba0_mint_hp_t b, q;
  ...
  if (Q != (bap_polynom_mint_hp) 0)
    {
      ...
      bap_begin_creator_mint_hp (&crea, quotient, &TQ,
...
bap_Euclid_polynom_mint_hp (
    bap_polynom_mint_hp G,
    bap_polynom_mint_hp A,
    bap_polynom_mint_hp B)
{
  bap_polynom_mint_hp U3, V3, T3;
  struct ba0_mark M;
  ...
  if (bap_is_zero_polynom_mint_hp (B))
    ...
    {
      bap_Euclidean_division_polynom_mint_hp ((bap_polynom_mint_hp) 0, V3, A, B);
      bap_set_polynom_mint_hp (U3, B);
      while (!bap_is_zero_polynom_mint_hp (V3))
        {
          bap_set_polynom_mint_hp (T3, V3);
          bap_Euclidean_division_polynom_mint_hp
              ((bap_polynom_mint_hp) 0, V3, U3, V3);
          BA0_SWAP (bap_polynom_mint_hp, U3, T3);
        }
    }
...
bap_extended_Euclid_polynom_mint_hp (
    bap_polynom_mint_hp U,
    bap_polynom_mint_hp V,
    bap_polynom_mint_hp G,
    bap_polynom_mint_hp A,
    bap_polynom_mint_hp B)
{
  bap_polynom_mint_hp U1, U3, V1, V3, T1, T3, Q;
  ba0_mint_hp_t a;
  struct ba0_mark M;
  ...
  if (bap_lt_rank_polynom_mint_hp (A, B))
    {
      BA0_SWAP (bap_polynom_mint_hp, A, B);
      BA0_SWAP (bap_polynom_mint_hp, U, V);
    }
  ...
  while (!bap_is_zero_polynom_mint_hp (V3))
    {
      ...
      BA0_SWAP (bap_polynom_mint_hp, U1, T1);
    }
  if (!bap_is_zero_polynom_mint_hp (U3))
    {
      ba0_mint_hp_init (a);
