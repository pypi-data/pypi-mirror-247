 ...
 */
  ...
  ba0_realloc_table ((ba0_table) & U, bav_global.R.vars.size);
      ...
      if (v->hack)
        {
          if (allvars)
            ...
            U.tab[U.size++] = bav_order_zero_variable (v);
              ...
              (v->root, (ba0_int_p *) 0, &bav_global.parameters))
            U.tab[U.size++] = v;
            ...
            U.tab[U.size++] = v;
              ...
              bav_is_constant_variable (v, sym, &bav_global.parameters))
            U.tab[U.size++] = v;
        }
    }
