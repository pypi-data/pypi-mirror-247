    ...
    bap_polynom_mpq Q)
{
  ...
  bap_polynom_mpq P = (bap_polynom_mpq) 0, R;
  ...
  if (Q != BAP_NOT_A_POLYNOM_mpq)
    {
      ...
      bap_begin_creator_mpq (&creaQ, P, &TQmax,
    ...
    bap_polynom_mpq Q)
{
  ...
  bap_polynom_mpq AA = (bap_polynom_mpq) 0, P = (bap_polynom_mpq) 0;
  struct bav_term T, U;
  bav_variable v, w;
  bool divisible;
  bav_Iordering r;
 ...
 */
  ...
  {
    bap_polynom_mpq AA0 = bap_new_readonly_polynom_mpq ();
 ...
 */
      ...
      bap_begin_creator_mpq
          (&crea, P, &T, bap_exact_total_rank, bap_nbmon_polynom_mpq (A));
    }
              ...
              while (!bap_outof_itermon_mpq (&itermon))
                {
                  ...
                  bap_write_creator_mpq
                      (&crea, &U, *bap_coeff_itermon_mpq (&itermon));
                  bap_next_itermon_mpq (&itermon);
                }
            }
        }
      else
        divisible = bap_is_factor_elem_polynom_mpq
            (&c, B, BAP_NOT_A_POLYNOM_mpq);
      if (divisible)
    ...
    bav_term T)
{
  ...
  P = bap_new_polynom_mpq ();
  bap_begin_creator_mpq
      (&crea, P, &U, bap_exact_total_rank, bap_nbmon_polynom_mpq (A));
    ...
    bap_tableof_polynom_mpq ibp)
{
  ...
  bap_polynom_mpq P = (bap_polynom_mpq) 0;
  struct bav_term T;
    ...
    bav_variable x)
{
  ...
  bap_polynom_mpq AA, quotient, reste;
  bap_polynom_mpq Pquotient = (bap_polynom_mpq) 0,
      Preste = (bap_polynom_mpq) 0;
  ba0_mpq_t *lc;
  struct bav_term T, U;
  bav_variable v, w;
  bav_Iordering r;
  ...
  while (ddeg >= 0)
    {
      ...
      ddeg = bap_degree_polynom_mpq (&reste, v) -
