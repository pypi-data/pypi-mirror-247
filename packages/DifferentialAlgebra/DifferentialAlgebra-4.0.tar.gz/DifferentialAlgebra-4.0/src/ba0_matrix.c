    ...
    void)
{
  ...
  M = (ba0_matrix) ba0_alloc (sizeof (struct ba0_matrix));
  ba0_init_matrix (M);
  return M;
}
 ...
 * @end deftypefun
 * 
 * @deftypefun bool ba0_is_unity_matrix (ba0_matrix @var{A}, ba0_unary_predicate* @var{is_zero_object}, ba0_unary_predicate* @var{is_one_object})
 */
