...
{
  iv->t0 = iv->t1 = 0.;
  ba0_init_array ((ba0_array) & iv->y0);
}
...
{
  iv->t0 = iv->t1 = 0.;
  ba0_reset_array ((ba0_array) & iv->y0);
}
...
BAI_DLL bai_dop853_initial_values
bai_dop853_new_initial_values (
    void)
{
  bai_dop853_initial_values iv;

  iv = (bai_dop853_initial_values) ba0_alloc
      (sizeof (struct bai_dop853_initial_values));
...
bai_dop853_realloc_initial_values (
    ...
    ba0_int_p n)
{
  ba0_realloc_array ((ba0_array) & iv->y0, n, sizeof (double));
}
...
bai_dop853_set_initial_values (
    bai_dop853_initial_values iv,
    bai_dop853_initial_values iw)
{
  if (iv != iw)
    {
      iv->t0 = iw->t0;
      iv->t1 = iw->t1;
      ba0_set_array ((ba0_array) & iv->y0, (ba0_array) & iw->y0);
    }
}
...
{
  ba0_init_array ((ba0_array) & tol->relative);
  ba0_init_array ((ba0_array) & tol->absolute);
}
...
bai_dop853_reset_errtol (
    bai_dop853_errtol tol)
{
  ba0_reset_array ((ba0_array) & tol->relative);
  ba0_reset_array ((ba0_array) & tol->absolute);
}
...
bai_dop853_set_errtol (
    bai_dop853_errtol ttol,
    bai_dop853_errtol stol)
{
  if (ttol != stol)
    {
      ttol->type = stol->type;
      ba0_set_array ((ba0_array) & ttol->relative,
          (ba0_array) & stol->relative);
      ba0_set_array ((ba0_array) & ttol->absolute,
          (ba0_array) & stol->absolute);
    }
}
...
bai_dop853_realloc_errtol (
    ...
    ba0_int_p n)
{
  ba0_realloc_array ((ba0_array) & tol->relative, n, sizeof (double));
  ba0_realloc_array ((ba0_array) & tol->absolute, n, sizeof (double));
}
...
bai_dop853_init_view (
    bai_dop853_view view)
{
  view->view_t = false;
  ba0_init_array ((ba0_array) & view->elts);
}
...
{
  view->view_t = false;
  ba0_reset_array ((ba0_array) & view->elts);
}
...
{
  ba0_realloc_array
      ((ba0_array) & view->elts, n, sizeof (struct bai_dop853_view_elt));
}
      ...
      while (posneg * (w->t - t) > 0.)
        {
          ...
          for (i = 0; i < view->elts.size; i++)
            {
              if (view->elts.tab[i].isvar)
                y = bai_dop853_dense_output_evaluate
                    (view->elts.tab[i].varnum, t, w);
              else
    ...
    struct bai_dop853_workspace *w)
{
  ...
  w->t = 0.0;
  w->h = 0.0;
  ba0_init_array ((ba0_array) & w->y);
  ba0_init_array ((ba0_array) & w->y1);
  ba0_init_array ((ba0_array) & w->k1);
  ba0_init_array ((ba0_array) & w->k2);
  ba0_init_array ((ba0_array) & w->k3);
  ba0_init_array ((ba0_array) & w->k4);
  ba0_init_array ((ba0_array) & w->k5);
  ba0_init_array ((ba0_array) & w->k6);
  ba0_init_array ((ba0_array) & w->k7);
  ba0_init_array ((ba0_array) & w->k8);
  ba0_init_array ((ba0_array) & w->k9);
  ba0_init_array ((ba0_array) & w->k10);
  w->hlamb = 0.0;
  w->nb_stiffs = 0;
  w->nb_non_stiffs = 0;
  w->facold = 0.0;
    ...
    bai_dop853_workspace w)
{
  ...
  w->t = 0.0;
  w->h = 0.0;
  ba0_reset_array ((ba0_array) & w->y);
  ba0_reset_array ((ba0_array) & w->y1);
  ba0_reset_array ((ba0_array) & w->k1);
  ba0_reset_array ((ba0_array) & w->k2);
  ba0_reset_array ((ba0_array) & w->k3);
  ba0_reset_array ((ba0_array) & w->k4);
  ba0_reset_array ((ba0_array) & w->k5);
  ba0_reset_array ((ba0_array) & w->k6);
  ba0_reset_array ((ba0_array) & w->k7);
  ba0_reset_array ((ba0_array) & w->k8);
  ba0_reset_array ((ba0_array) & w->k9);
  ba0_reset_array ((ba0_array) & w->k10);
  w->hlamb = 0.0;
  w->nb_stiffs = 0;
  w->nb_non_stiffs = 0;
  w->facold = 0.0;
...
bai_dop853_realloc_workspace (
    ...
    ba0_int_p n)
{
  ba0_realloc_array ((ba0_array) & w->y, n, sizeof (double));
  ba0_realloc_array ((ba0_array) & w->y1, n, sizeof (double));
  ba0_realloc_array ((ba0_array) & w->k1, n, sizeof (double));
  ba0_realloc_array ((ba0_array) & w->k2, n, sizeof (double));
  ba0_realloc_array ((ba0_array) & w->k3, n, sizeof (double));
  ba0_realloc_array ((ba0_array) & w->k4, n, sizeof (double));
  ba0_realloc_array ((ba0_array) & w->k5, n, sizeof (double));
  ba0_realloc_array ((ba0_array) & w->k6, n, sizeof (double));
  ba0_realloc_array ((ba0_array) & w->k7, n, sizeof (double));
  ba0_realloc_array ((ba0_array) & w->k8, n, sizeof (double));
  ba0_realloc_array ((ba0_array) & w->k9, n, sizeof (double));
  ba0_realloc_array ((ba0_array) & w->k10, n, sizeof (double));
    ...
    bai_dop853_workspace w)
{
  ...
  v->t = w->t;
  v->h = w->h;
  ba0_set_array ((ba0_array) & v->y, (ba0_array) & w->y);
  ba0_set_array ((ba0_array) & v->y1, (ba0_array) & w->y1);
  ba0_set_array ((ba0_array) & v->k1, (ba0_array) & w->k1);
  ba0_set_array ((ba0_array) & v->k2, (ba0_array) & w->k2);
  ba0_set_array ((ba0_array) & v->k3, (ba0_array) & w->k3);
  ba0_set_array ((ba0_array) & v->k4, (ba0_array) & w->k4);
  ba0_set_array ((ba0_array) & v->k5, (ba0_array) & w->k5);
  ba0_set_array ((ba0_array) & v->k6, (ba0_array) & w->k6);
  ba0_set_array ((ba0_array) & v->k7, (ba0_array) & w->k7);
  ba0_set_array ((ba0_array) & v->k8, (ba0_array) & w->k8);
  ba0_set_array ((ba0_array) & v->k9, (ba0_array) & w->k9);
  ba0_set_array ((ba0_array) & v->k10, (ba0_array) & w->k10);
  v->hlamb = w->hlamb;
    ...
    bai_dop853_workspace w)
{
  ...
  bai_dop853_initial_values iv = &w->iv;
  bai_dop853_errtol tol = &w->tol;
  bai_dop853_control control = &w->control;
    ...
    void *params)
{
  ...
  w->t = iv->t0;
  ba0_set_array ((ba0_array) & w->y, (ba0_array) & iv->y0);
    ...
    bai_dop853_workspace w)
{
  ...
  bai_dop853_errtol tol = &w->tol;
  bai_dop853_control control = &w->control;
  bai_dop853_stats stat = &w->stat;
  bai_dop853_dense_output dow = &w->dow;
  void *params = w->params;
  double *y = w->y.tab;
  double *y1 = w->y1.tab;
  double *k1 = w->k1.tab;
...
*/
      for (i = 0; i < n; i++)
        y1[i] = y[i] + w->h * (a71 * k1[i] + a74 * k4[i] +
            a75 * k5[i] + a76 * k6[i]);
...
*/
      for (i = 0; i < n; i++)
        y1[i] = y[i] + w->h * (a81 * k1[i] + a84 * k4[i] +
...
*/
      for (i = 0; i < n; i++)
        y1[i] = y[i] + w->h * (a91 * k1[i] + a94 * k4[i] +
            a95 * k5[i] + a96 * k6[i] + a97 * k7[i] + a98 * k8[i]);
...
*/
      for (i = 0; i < n; i++)
        y1[i] = y[i] + w->h * (a101 * k1[i] + a104 * k4[i] +
            a105 * k5[i] + a106 * k6[i] +
            a107 * k7[i] + a108 * k8[i] + a109 * k9[i]);
...
*/
      for (i = 0; i < n; i++)
        y1[i] = y[i] + w->h * (a111 * k1[i] + a114 * k4[i] +
            a115 * k5[i] + a116 * k6[i] +
            a117 * k7[i] + a118 * k8[i] + a119 * k9[i] + a1110 * k10[i]);
...
*/
      for (i = 0; i < n; i++)
        y1[i] = y[i] + w->h * (a121 * k1[i] + a124 * k4[i] +
            a125 * k5[i] + a126 * k6[i] +
            a127 * k7[i] + a128 * k8[i] +
...
*/
      for (i = 0; i < n; i++)
        {
          k4[i] = b1 * k1[i] + b6 * k6[i] + b7 * k7[i] +
              b8 * k8[i] + b9 * k9[i] + b10 * k10[i] +
              b11 * k2[i] + b12 * k3[i];
          k5[i] = y[i] + w->h * k4[i];
        }
/*
      ...
      if (tol->type == bai_dop853_global_errtol)
          ...
          for (i = 0; i < n; i++)
            {
              ...
              err1 = er1 * k1[i] + er6 * k6[i] + er7 * k7[i] +
                  er8 * k8[i] + er9 * k9[i] + er10 * k10[i] +
                  er11 * k2[i] + er12 * k3[i];
      ...
      else
        {
          for (i = 0; i < n; i++)
            {
              double sk, err1;
              sk = tol->absolute.tab[i] + tol->relative.tab[i] *
                  _fmax (fabs (y[i]), fabs (k5[i]));
              err1 = k4[i] - bhh1 * k1[i] - bhh2 * k9[i] - bhh3 * k3[i];
              err2 = err2 + pow (err1 / sk, 2.);
              err1 = er1 * k1[i] + er6 * k6[i] + er7 * k7[i] +
                  er8 * k8[i] + er9 * k9[i] + er10 * k10[i] +
              ...
              for (j = 0; j < nrdens; j++)
                {
                  ...
                  dow->cont4.tab[j] = d41 * k1[i] + d46 * k6[i] +
                      d47 * k7[i] + d48 * k8[i] +
                      d49 * k9[i] + d410 * k10[i] + d411 * k2[i] + d412 * k3[i];
                  dow->cont5.tab[j] = d51 * k1[i] + d56 * k6[i] +
                      d57 * k7[i] + d58 * k8[i] +
                      d59 * k9[i] + d510 * k10[i] + d511 * k2[i] + d512 * k3[i];
                  dow->cont6.tab[j] = d61 * k1[i] + d66 * k6[i] +
                      d67 * k7[i] + d68 * k8[i] +
                      d69 * k9[i] + d610 * k10[i] + d611 * k2[i] + d612 * k3[i];
                  dow->cont7.tab[j] = d71 * k1[i] + d76 * k6[i] +
                      d77 * k7[i] + d78 * k8[i] +
                      d79 * k9[i] + d710 * k10[i] + d711 * k2[i] + d712 * k3[i];
                }
/*
...
*/
              for (i = 0; i < n; i++)
                y1[i] = y[i] + w->h * (a141 * k1[i] +
                    a147 * k7[i] + a148 * k8[i] +
                    a149 * k9[i] + a1410 * k10[i] +
                    a1411 * k2[i] + a1412 * k3[i] + a1413 * k4[i]);
...
*/
              for (i = 0; i < n; i++)
                y1[i] = y[i] + w->h * (a151 * k1[i] +
                    a156 * k6[i] + a157 * k7[i] + a158 * k8[i] +
...
*/
              for (i = 0; i < n; i++)
                y1[i] = y[i] + w->h * (a161 * k1[i] +
                    a166 * k6[i] + a167 * k7[i] + a168 * k8[i] +
              ...
              for (j = 0; j < nrdens; j++)
                {
                  i = dow->index.tab[j];
                  dow->cont4.tab[j] =
                      w->h * (dow->cont4.tab[j] + d413 * k4[i] +
                      d414 * k10[i] + d415 * k2[i] + d416 * k3[i]);
                  dow->cont5.tab[j] =
                      w->h * (dow->cont5.tab[j] + d513 * k4[i] +
                      d514 * k10[i] + d515 * k2[i] + d516 * k3[i]);
                  dow->cont6.tab[j] =
                      w->h * (dow->cont6.tab[j] + d613 * k4[i] +
                      d614 * k10[i] + d615 * k2[i] + d616 * k3[i]);
                  dow->cont7.tab[j] =
                      w->h * (dow->cont7.tab[j] + d713 * k4[i] +
...
bai_dop853_init_dense_output (
    bai_dop853_dense_output dow)
{
  ba0_init_table ((ba0_table) & dow->index);
  ba0_init_array ((ba0_array) & dow->cont0);
  ba0_init_array ((ba0_array) & dow->cont1);
  ba0_init_array ((ba0_array) & dow->cont2);
  ba0_init_array ((ba0_array) & dow->cont3);
  ba0_init_array ((ba0_array) & dow->cont4);
  ba0_init_array ((ba0_array) & dow->cont5);
  ba0_init_array ((ba0_array) & dow->cont6);
  ba0_init_array ((ba0_array) & dow->cont7);
}
...
bai_dop853_reset_dense_output (
    bai_dop853_dense_output dow)
{
  ba0_reset_table ((ba0_table) & dow->index);
  ba0_reset_array ((ba0_array) & dow->cont0);
  ba0_reset_array ((ba0_array) & dow->cont1);
  ba0_reset_array ((ba0_array) & dow->cont2);
  ba0_reset_array ((ba0_array) & dow->cont3);
  ba0_reset_array ((ba0_array) & dow->cont4);
  ba0_reset_array ((ba0_array) & dow->cont5);
  ba0_reset_array ((ba0_array) & dow->cont6);
  ba0_reset_array ((ba0_array) & dow->cont7);
}
...
bai_dop853_realloc_dense_output (
    ...
    ba0_int_p n)
{
  ba0_realloc_table ((ba0_table) & dow->index, n);
  ba0_realloc_array ((ba0_array) & dow->cont0, n, sizeof (double));
  ba0_realloc_array ((ba0_array) & dow->cont1, n, sizeof (double));
  ba0_realloc_array ((ba0_array) & dow->cont2, n, sizeof (double));
  ba0_realloc_array ((ba0_array) & dow->cont3, n, sizeof (double));
  ba0_realloc_array ((ba0_array) & dow->cont4, n, sizeof (double));
  ba0_realloc_array ((ba0_array) & dow->cont5, n, sizeof (double));
  ba0_realloc_array ((ba0_array) & dow->cont6, n, sizeof (double));
  ba0_realloc_array ((ba0_array) & dow->cont7, n, sizeof (double));
}
    ...
    bai_odex_system S)
{
  ...
  for (i = 0; i < S->lhs.size; i++)
    bai_dop853_set_dense_output_variable
        (dow, bav_order_zero_variable (S->lhs.tab[i]), S);
}
    ...
    bai_odex_system S)
{
  ...
  if (!ba0_member_table ((void *) i, (ba0_table) & dow->index))
    {
...
bai_dop853_set_dense_output (
    bai_dop853_dense_output dov,
    bai_dop853_dense_output dow)
{
  ba0_set_table ((ba0_table) & dov->index, (ba0_table) & dow->index);
  ba0_set_array ((ba0_array) & dov->cont0, (ba0_array) & dow->cont0);
  ba0_set_array ((ba0_array) & dov->cont1, (ba0_array) & dow->cont1);
  ba0_set_array ((ba0_array) & dov->cont2, (ba0_array) & dow->cont2);
  ba0_set_array ((ba0_array) & dov->cont3, (ba0_array) & dow->cont3);
  ba0_set_array ((ba0_array) & dov->cont4, (ba0_array) & dow->cont4);
  ba0_set_array ((ba0_array) & dov->cont5, (ba0_array) & dow->cont5);
  ba0_set_array ((ba0_array) & dov->cont6, (ba0_array) & dow->cont6);
  ba0_set_array ((ba0_array) & dov->cont7, (ba0_array) & dow->cont7);
}
...
*/
  if (!ba0_member2_table ((void *) ii, (ba0_table) & dow->index, &i))
...
*/
  ...
  s = (tt - w->told) / h;
  s1 = 1. - s;
  conpar = dow->cont4.tab[i] +
      s * (dow->cont5.tab[i] +
      s1 * (dow->cont6.tab[i] + s * dow->cont7.tab[i]));
  z = dow->cont0.tab[i] +
      s * (dow->cont1.tab[i] +
      s1 * (dow->cont2.tab[i] + s * (dow->cont3.tab[i] + s1 * conpar)));
  return z;
}
    ...
    bai_dop853_workspace w)
{
  ...
  if (t * posneg < w->told * posneg)
    bai_dop853_start_workspace (w, w->fcn, &w->iv, &w->tol,
        &w->control, &w->dow, w->params);
