    ...
    bap_polynom_mpzm Q)
{
  ...
  bap_polynom_mpzm P = (bap_polynom_mpzm) 0, R;
  ...
  if (Q != BAP_NOT_A_POLYNOM_mpzm)
    {
      ...
      bap_begin_creator_mpzm (&creaQ, P, &TQmax,
    ...
    bap_polynom_mpzm Q)
{
  ...
  bap_polynom_mpzm AA = (bap_polynom_mpzm) 0, P = (bap_polynom_mpzm) 0;
  struct bav_term T, U;
  bav_variable v, w;
  bool divisible;
  bav_Iordering r;
 ...
 */
  ...
  bap_mark_indets_polynom_mpzm (B);
 ...
 */
  ...
  {
    bap_polynom_mpzm AA0 = bap_new_readonly_polynom_mpzm ();
 ...
 */
      ...
      bap_begin_creator_mpzm
          (&crea, P, &T, bap_exact_total_rank, bap_nbmon_polynom_mpzm (A));
    }
              ...
              while (!bap_outof_itermon_mpzm (&itermon))
                {
                  ...
                  bap_write_creator_mpzm
                      (&crea, &U, *bap_coeff_itermon_mpzm (&itermon));
                  bap_next_itermon_mpzm (&itermon);
                }
            }
        }
      else
        divisible = bap_is_factor_elem_polynom_mpzm
            (&c, B, BAP_NOT_A_POLYNOM_mpzm);
      if (divisible)
    ...
    bav_term T)
{
  ...
  P = bap_new_polynom_mpzm ();
  bap_begin_creator_mpzm
      (&crea, P, &U, bap_exact_total_rank, bap_nbmon_polynom_mpzm (A));
    ...
    bap_tableof_polynom_mpzm ibp)
{
  ...
  bap_polynom_mpzm P = (bap_polynom_mpzm) 0;
  struct bav_term T;
    ...
    bav_variable x)
{
  ...
  bap_polynom_mpzm AA, quotient, reste;
  bap_polynom_mpzm Pquotient = (bap_polynom_mpzm) 0,
      Preste = (bap_polynom_mpzm) 0;
  ba0_mpzm_t *lc;
  struct bav_term T, U;
  bav_variable v, w;
  bav_Iordering r;
  ...
  while (ddeg >= 0)
    {
      ...
      ddeg = bap_degree_polynom_mpzm (&reste, v) -
