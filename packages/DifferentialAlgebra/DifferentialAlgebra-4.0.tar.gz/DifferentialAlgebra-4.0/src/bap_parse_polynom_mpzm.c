 ...
 * difference @math{p - q}.
 * This function relies of @code{bap_scanf_polynom_mpzm}.
 */
...
bap_scanf_polynom_eqn_mpzm (
    void *R)
{
  bap_polynom_mpzm A = (bap_polynom_mpzm) R;
  struct bap_polynom_mpzm B, C;
  struct ba0_mark M;

  if (A == (bap_polynom_mpzm) 0)
    A = bap_new_polynom_mpzm ();
 ...
 */
  ...
  while (minus || plus)
    {
#if ! defined (BAD_FLAG_mint_hp)
      coeffs = (ba0_listof_mpzm) ba0_cons_list
          (ba0_new_mpzm (), (ba0_list) coeffs);
#else
      coeffs = (ba0_listof_mpzm) ba0_cons_list (0, (ba0_list) coeffs);
#endif
 ...
 */
  ...
  while (coeffs != (ba0_listof_mpzm) 0)
    {
#if ! defined (BAD_FLAG_mint_hp)
      bap_write_creator_mpzm (&crea, (bav_term) terms->value, coeffs->value);
#else
      bap_write_creator_mpzm (&crea, (bav_term) terms->value,
...
bap_printf_polynom_mpzm (
    void *R)
{
  bap_polynom_mpzm P = (bap_polynom_mpzm) R;
...
/*
 * texinfo: bap_scanf_careful_expanded_polynom_mpzm
...
BAP_DLL void *
bap_scanf_careful_expanded_polynom_mpzm (
    void *A)
{
  bap_polynom_mpzm P;
