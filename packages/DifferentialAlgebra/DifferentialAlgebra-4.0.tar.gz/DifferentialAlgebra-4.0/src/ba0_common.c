    ...
    void)
{
  ...
  ba0_set_settings_gmp (0, false, 0);
  ba0_set_settings_analex (0);
}

/*
 * Sets the outer interrupt function as well as the delay.
 */
 ...
 * correponding variables. Parameters may be zero.
 */
...
/*
 * Indexed converted into strings
 */
 ...
 * Indexed "as is"
 */
      ba0_define_format_with_sizelt ("indexed", -1,
          &ba0_scanf_raw_indexed,
          &ba0_printf_indexed,
          &ba0_garbage1_indexed, &ba0_garbage2_indexed, &ba0_copy_indexed);
