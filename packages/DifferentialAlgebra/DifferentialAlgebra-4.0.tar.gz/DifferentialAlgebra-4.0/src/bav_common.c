 ...
 * The default function called when a @code{ba0_indexed} is not recognized.
 * This function can be changed by modifying 
 * @code{bav_initialized_global.common.unknown}.
    ...
    ba0_int_p memory_limit)
{
  ...
  switch (level)
    ...
    case ba0_reset_level:
      bav_reset_parameters (&bav_global.parameters);
