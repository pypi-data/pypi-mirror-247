 ...
 * Allocate a new @code{baz_rel_ratfrac}, initialize it and return it.
 */
 ...
 * Parsing function for @code{baz_rel_ratfrac}.
...
baz_scanf_rel_ratfrac (
    void *A)
{
  baz_rel_ratfrac R = (baz_rel_ratfrac) A;

  if (A == (baz_rel_ratfrac) 0)
 ...
 * Printing function for @code{baz_rel_ratfrac}.
    ...
    enum ba0_garbage_code code)
{
  ...
  if (code == ba0_isolated)
    n += ba0_new_gc_info
        (R, sizeof (struct baz_rel_ratfrac), _struct_rel_ratfrac);
    ...
    void *A)
{
  ...
  baz_set_rel_ratfrac (B, (baz_rel_ratfrac) A);
  return B;
}
