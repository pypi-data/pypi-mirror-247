...
from redrover_api import rest
from redrover_api.configuration import Configuration
from redrover_api.exceptions import ApiTypeError, ApiValueError, ApiException
from redrover_api.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = AbsenceApi()
        api_instance.create_absence  # this is an instance of the class Endpoint
        api_instance.create_absence()  # this invokes api_instance.create_absence.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create_absence.callable or self.callable in this class
