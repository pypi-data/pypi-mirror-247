...
class CreateSecretResponseSecret:
    ...
    def from_dict(obj: Any) -> 'CreateSecretResponseSecret':
        ...
        return CreateSecretResponseSecret(environment, secret_comment, secret_key, secret_value, type, version, workspace)
...
class DeleteSecretResponseSecret:
    ...
    def from_dict(obj: Any) -> 'DeleteSecretResponseSecret':
        ...
        version = from_int(obj.get("version"))
        workspace = from_str(obj.get("workspace"))
        return DeleteSecretResponseSecret(environment, secret_comment, secret_key, secret_value, type, version, workspace)
...
class GetSecretResponseSecret:
    ...
    def from_dict(obj: Any) -> 'GetSecretResponseSecret':
        ...
        version = from_int(obj.get("version"))
        workspace = from_str(obj.get("workspace"))
        return GetSecretResponseSecret(environment, secret_comment, secret_key, secret_value, type, version, workspace)
...
class SecretElement:
    ...
    def from_dict(obj: Any) -> 'SecretElement':
        ...
        version = from_int(obj.get("version"))
        workspace = from_str(obj.get("workspace"))
        return SecretElement(environment, secret_comment, secret_key, secret_value, type, version, workspace)
...
class UpdateSecretResponseSecret:
    ...
    def from_dict(obj: Any) -> 'UpdateSecretResponseSecret':
        ...
        version = from_int(obj.get("version"))
        workspace = from_str(obj.get("workspace"))
        return UpdateSecretResponseSecret(environment, secret_comment, secret_key, secret_value, type, version, workspace)
