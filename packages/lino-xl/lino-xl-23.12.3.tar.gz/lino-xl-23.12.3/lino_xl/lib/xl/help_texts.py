...
help_texts = {
    ...
    'lino_xl.lib.google.Plugin.sync_immediately' : _("""Not used yet."""),
    ...
    'lino_xl.lib.households.Plugin.person_model' : _("""A string referring to the model which represents a human in your application. Default value is 'contacts.Person' (referring to lino_xl.lib.contacts.models.Person)."""),
    ...
    'lino_xl.lib.ledger.fields.DcAmountField' : _("""An editable virtual PriceField to get and set both database fields amount and dc at once. It may be used only on models which also defines these two fields."""),
    'lino_xl.lib.lists.Plugin' : _("""See lino.core.Plugin."""),
    'lino_xl.lib.notes.Plugin' : _("""See lino.core.Plugin."""),
    'lino_xl.lib.online.users.UserStates' : _("""The list of possible choices for the state field of a User."""),
    'lino_xl.lib.online.users.MarkUserActive' : _("""Activate this user. This requires that the user has confirmed their verifcation code, and that a username and password are set."""),
    ...
    'lino_xl.lib.topics.Plugin' : _("""A subclass of Plugin for this plugin."""),
    'lino_xl.lib.topics.Plugin.partner_model' : _("""The Django model used to represent partners in the scope of this plugin."""),
    ...
    'lino_xl.lib.vatless.PartnerDetailMixin' : _("""Defines a panel ledger, to be added as a tab panel to your layout's main element."""),
    'lino_xl.lib.vatless.PartnerDetailMixin.ledger' : _("""Shows the tables vatless.VouchersByPartner and ledger.MovementsByPartner."""),
    ...
    'lino_xl.lib.votes.Plugin.use_candidatures' : _("""Whether to use votes for implementing a kind of polling: when somebody posts a ticket, other users are asked to vote on it, deciding whether they take it or not."""),
    ...
    'lino_xl.lib.contacts.PartnerEvents.has_open_movements' : _("""See has_open_movements in xl.specs.ledger. This choice exists only when lino_xl.lib.ledger is installed."""),
    ...
    'lino_xl.lib.invoicing.Plan.max_date' : _("""Don't invoice events after this date. If this is empty, Lino will use the day before the invoice date."""),
    ...
    'lino_xl.lib.ledger.AccountingReader' : _("""Can read all accounting data and create reports, but cannot change any relevant data."""),
    'lino_xl.lib.ledger.LedgerUser' : _("""Can see all journals, create vouchers of any kind, can see vouchers of other users but cannot edit them."""),
    ...
    'lino_xl.lib.ledger.Account.name' : _("""The multilingual designation of this account, as the users see it."""),
    'lino_xl.lib.ledger.Account.ref' : _("""An optional unique name which can be used to reference a given account."""),
    'lino_xl.lib.ledger.Account.type' : _("""The account type of this account. This points to an item of CommonAccounts."""),
    ...
    'lino_xl.lib.ledger.Account.default_amount' : _("""The default amount to book in bank statements or journal entries when this account has been selected manually. The default booking direction is that of the type."""),
    'lino_xl.lib.ledger.Account.FOO_allowed' : _("""These checkboxes indicate whether this account can be used on an item of a purchases (or sales or wages or FOO) invoice. There is one such checkbox for every trade type (TradeTypes). They exist only when the ledger plugin is installed as well. See also the get_allowed_accounts method."""),
    'lino_xl.lib.ledger.Account.needs_ana' : _("""Whether transactions on this account require the user to also specify an analytic account."""),
    'lino_xl.lib.ledger.Account.ana_account' : _("""Which analytic account to suggest for transactions on this account."""),
    'lino_xl.lib.ledger.Account.sheet_item' : _("""Pointer to the item of the balance sheet or income statement that will report the movements of this account."""),
    'lino_xl.lib.ledger.CommonAccounts' : _("""The global list of common accounts."""),
    'lino_xl.lib.ledger.CommonAccounts.waiting' : _("""The waiting account, used to temporarily book movements for which you do not know where to book them."""),
    'lino_xl.lib.ledger.CommonAccounts.undeclared_costs' : _("""Used to books costs that will be reculated internally and are irrelevant for VAT declaration and annual report."""),
    ...
    'lino_xl.lib.ledger.Balance' : _("""A light-weight object to represent a balance, i.e. an amount together with its booking direction (debiting or crediting)."""),
    ...
    'lino_xl.lib.ledger.Movement.value_date' : _("""The date at which this movement is to be entered into the ledger. This is usually the voucher's entry_date, except e.g. for bank statements where each item can have its own value date."""),
    ...
    'lino_xl.lib.ledger.Movement.match' : _("""Pointer to the Movement that is being cleared by this movement."""),
    'lino_xl.lib.ledger.Movement.cleared' : _("""Whether"""),
    'lino_xl.lib.ledger.Movement.voucher_partner' : _("""A virtual field which returns the partner of the voucher. For incoming invoices this is the supplier, for outgoing invoices this is the customer, for financial vouchers this is empty."""),
    'lino_xl.lib.ledger.Movement.voucher_link' : _("""A virtual field which shows a link to the voucher."""),
    'lino_xl.lib.ledger.Movement.match_link' : _("""A virtual field which shows a clickable variant of the match string. Clicking it will open a table with all movements having that match."""),
    ...
    'lino_xl.lib.ledger.MovementsByAccount.description' : _("""A virtual field showing a comma-separated list of the following items:"""),
    ...
    'lino_xl.lib.ledger.Voucher.state' : _("""The state of this voucher. It decides among others whether you can edit this voucher or not."""),
    'lino_xl.lib.ledger.Voucher.journal' : _("""The journal into which this voucher has been booked."""),
    'lino_xl.lib.ledger.Voucher.number' : _("""The sequence number of this voucher within its journal."""),
    'lino_xl.lib.ledger.Voucher.entry_date' : _("""The date of the journal entry, i.e. when this voucher is to be booked."""),
    'lino_xl.lib.ledger.Voucher.voucher_date' : _("""The date on the voucher (i.e. when it has been issued by its emitter)."""),
    'lino_xl.lib.ledger.Voucher.accounting_period' : _("""The accounting period to use when booking this voucher. The default value is determined from entry_date."""),
    'lino_xl.lib.ledger.Voucher.narration' : _("""A short explanation to explain the subject matter of this journal entry."""),
    'lino_xl.lib.ledger.Voucher.number_with_year' : _("""Shows the accounting year and the number of this voucher within its journal."""),
    'lino_xl.lib.ledger.Voucher.do_and_clear' : _("""Delete all movements of this voucher, then run the given callable func, passing it a set with all partners who had at least one movement in this voucher. The function is expected to add more partners to this set. Then call check_clearings() for all these partners."""),
    'lino_xl.lib.ledger.Voucher.get_partner' : _("""Return the partner related to this voucher. Overridden by lino_xl.lib.contacts.PartnerRelated vouchers."""),
    'lino_xl.lib.ledger.Voucher.get_movement_description' : _("""Generate a series of HTML chunks to be displayed in the Movment.description field."""),
    'lino_xl.lib.ledger.Voucher.get_wanted_movements' : _("""Subclasses must implement this. Supposed to return or yield a list of unsaved Movement instances."""),
    'lino_xl.lib.ledger.RegistrableVoucher.toggle_state' : _("""Toggle between "registered" and "draft" state."""),
    'lino_xl.lib.ledger.RegistrableVoucher.hide_editable_number' : _("""Whether to hide the number that will be used for this voucher in its journal as long as the voucher is in an editable state."""),
    ...
    'lino_xl.lib.ledger.Journal.yearly_numbering' : _("""Whether the number of vouchers should restart at 1 every year."""),
    ...
    'lino_xl.lib.ledger.Journal.account' : _("""The account to use for the counter-movements generated by vouchers in this journal."""),
    'lino_xl.lib.ledger.Journal.partner' : _("""The partner to use as default partner for vouchers in this journal."""),
    'lino_xl.lib.ledger.Journal.must_declare' : _("""Whether movements made by this journal should be included in VAT declarations."""),
    'lino_xl.lib.ledger.Journal.dc' : _("""The primary booking direction. Voucher items in this direction increase the total amount of the voucher."""),
    'lino_xl.lib.ledger.Journal.auto_check_clearings' : _("""Whether to automatically check and update the 'cleared' status of ledger movements when (de)registering a voucher of this journal."""),
    'lino_xl.lib.ledger.Journal.auto_fill_suggestions' : _("""Whether to automatically fill voucher item from due payments of the partner when entering a financial voucher."""),
    ...
    'lino_xl.lib.ledger.Journals' : _("""List of all Journals. Accessible via Configure ‣ Accounting ‣ Journals."""),
    ...
    'lino_xl.lib.ledger.LedgerInfo.entry_date' : _("""The last value this user typed as entry_date of a voucher. It is the default value for every new voucher."""),
    ...
    'lino_xl.lib.ledger.PaymentTerm.printed_text' : _("""Used in sales/VatProductInvoice/trailer.html as follows:"""),
    ...
    'lino_xl.lib.ledger.AccountingPeriod' : _("""An accounting period is the smallest time slice to be observed (declare) in accounting reports. Usually it corresponds to one month. Except for some small companies which declare per quarter."""),
    ...
    'lino_xl.lib.ledger.ExpectedMovements' : _("""A virtual table of DueMovement rows, showing all "expected" "movements (payments)"."""),
    ...
    'lino_xl.lib.ledger.ExpectedMovements.for_journal' : _("""Show only movements that may be matched by the given journal (i.e. for which a match rule exists)."""),
    ...
    'lino_xl.lib.ledger.ExpectedMovements.same_dc' : _("""Show only movements having the same booking direction as the target voucher."""),
    'lino_xl.lib.ledger.DebtsByAccount' : _("""The ExpectedMovements accessible by clicking the "Debts" action button on an account."""),
    'lino_xl.lib.ledger.DebtsByPartner' : _("""This is the table being printed in a Payment Reminder. Usually this table has one row per sales invoice which is not fully paid. But several invoices ("debts") may be grouped by match. If the partner has purchase invoices, these are deduced from the balance."""),
    'lino_xl.lib.ledger.PartnerVouchers' : _("""Base class for tables of partner vouchers."""),
    'lino_xl.lib.ledger.AccountsBalance' : _("""A virtual table, the base class for different reports that show a list of accounts with the following columns:"""),
    ...
    'lino_xl.lib.ledger.DebtorsCreditors' : _("""Abstract base class for different tables showing a list of partners with the following columns:"""),
    'lino_xl.lib.ledger.Debtors' : _("""Shows partners who have some debt against us. Inherits from DebtorsCreditors."""),
    'lino_xl.lib.ledger.Creditors' : _("""Shows partners who give us some form of credit. Inherits from DebtorsCreditors."""),
    ...
    'lino_xl.lib.ledger.TradeTypes.wages' : _("""When you write a payroll (declare the fact that you owe some wage to an employee) and later pay it (e.g. via a payment order)."""),
    'lino_xl.lib.ledger.TradeTypes.clearings' : _("""When an employee declares that he paid some invoice for you, and later you pay that money back to his account. Or the employee collects money for a sales invoice and later returns that money to you. See internal_clearings."""),
    'lino_xl.lib.ledger.TradeTypes.bank_po' : _("""When you ask your bank to execute a payment, and later the bank debits your account."""),
    ...
    'lino_xl.lib.ledger.TradeType.main_account' : _("""The common account into which the total amount of partner vouchers (base + taxes) and their payments should be booked."""),
    'lino_xl.lib.ledger.TradeType.base_account' : _("""The default common account into which the base amount of any operation should be booked."""),
    'lino_xl.lib.ledger.TradeType.invoice_account_field_name' : _("""The name of a field to be injected on the Partner model which points to an account to be used instead of the default base_account."""),
    'lino_xl.lib.ledger.TradeType.base_account_field_name' : _("""The name of a field to be injected on the Product database model which points to an account to be used instead of the default base_account."""),
    'lino_xl.lib.ledger.TradeType.price_field' : _("""The name and label of the price field to be defined on the Product database model."""),
    'lino_xl.lib.ledger.TradeType.get_product_base_account' : _("""Return the account into which the base amount of any operation of this rete type should be booked."""),
    'lino_xl.lib.ledger.TradeType.get_catalog_price' : _("""Return the catalog price of the given product for operations with this trade type."""),
    'lino_xl.lib.ledger.TradeType.get_partner_invoice_account' : _("""Return the account to use as default value for account invoice items. This is the invoice_account_field of the given partner and can be None."""),
    ...
    'lino_xl.lib.ledger.VoucherType.model' : _("""The database model used to store vouchers of this type. A subclass of lino_xl.lib.ledger.models.Voucher`."""),
    'lino_xl.lib.ledger.VoucherType.table_class' : _("""Must be a table on model having master_key set to the journal."""),
    ...
    'lino_xl.lib.ledger.VoucherStates.draft' : _("""Draft vouchers can be modified but are not yet visible as movements in the ledger."""),
    'lino_xl.lib.ledger.VoucherStates.registered' : _("""Registered vouchers cannot be modified, but are visible as movements in the ledger."""),
    'lino_xl.lib.ledger.VoucherStates.cancelled' : _("""The Cancelled state is similar to Draft, except that you cannot edit the fields. This is used e.g. for an invoice that has been sent, but the customer signaled that they don't agree. Instead of writing a credit nota, you can decide to just cancel the invoice."""),
    'lino_xl.lib.ledger.VoucherStates.signed' : _("""The Signed state is similar to registered, but cannot usually be deregistered any more. This state is not visible in the default configuration. In order to make it usable, you must define a custom workflow for VoucherStates."""),
    'lino_xl.lib.ledger.SequencedVoucherItem' : _("""A VoucherItem which also inherits from lino.mixins.sequenced.Sequenced."""),
    ...
    'lino_xl.lib.ledger.VoucherItem.voucher' : _("""Pointer to the ledger voucher that contains this item."""),
    'lino_xl.lib.ledger.VoucherItem.title' : _("""The heading of this voucher item."""),
    'lino_xl.lib.ledger.Matching' : _("""Model mixin for database objects that are considered matching transactions. A matching transaction is a transaction that points to some other movement which it "clears" at least partially."""),
    'lino_xl.lib.ledger.Matching.match' : _("""Pointer to the movement which is being cleared by this movement."""),
    'lino_xl.lib.ledger.PaymentRelated' : _("""This is base class for both (1) trade document vouchers (e.g. invoices or offers) and (2) for the individual entries of financial vouchers and ledger movements."""),
    'lino_xl.lib.ledger.PaymentRelated.payment_term' : _("""The payment term to apply for this transaction."""),
    'lino_xl.lib.ledger.PaymentRelated.payment_method' : _("""The payment method to to apply for this transaction."""),
    'lino_xl.lib.ledger.ProjectRelated' : _("""Model mixin for objects that are related to a project."""),
    'lino_xl.lib.ledger.ProjectRelated.project' : _("""Pointer to the "project". This field exists only if the project_model setting is nonempty."""),
    'lino_xl.lib.ledger.Payable' : _("""Model mixin for objects that represent a payable transaction."""),
    'lino_xl.lib.ledger.Payable.your_ref' : _("""The reference used by the business partner for referring to this voucher."""),
    'lino_xl.lib.ledger.Payable.due_date' : _("""The date when the invoice is expected to have been paid."""),
    'lino_xl.lib.ledger.Payable.get_payable_sums_dict' : _("""To be implemented by subclasses. Expected to return a dict which maps 4-tuples (acc_tuple, project, vat_class, vat_regime) to the payable amount. acc_tuple is itself a tuple (general_account, analytic_account), vat_class is a lino_xl.lib.vat.VatClasses choice and vat_regime a lino_xl.lib.vat.VatRegimes choice."""),
    ...
    'lino_xl.lib.ledger.PeriodRangeObservable' : _("""Model mixin for objects that can be filtered by a range of accounting periods. This adds two parameter fields start_period and end_period to every table on this model."""),
    ...
    'lino_xl.lib.ledger.DueMovement.dc' : _("""Whether I mean my debts and payments (towards that partner) or those of the partner (towards me)."""),
    'lino_xl.lib.ledger.AccountBalances' : _("""A table which shows a list of general ledger accounts during the observed period, showing their old and new balances and the sum of debit and credit movements."""),
    ...
    'lino_xl.lib.ledger.AccountingPeriodRange.end_period' : _("""Optional end of observed period range. Leave empty to consider only the Start period."""),
    ...
    'lino_xl.lib.pages.Page' : _("""The Django model that represents a content page."""),
    ...
    'lino_xl.lib.sales.VatProductInvoice' : _("""The Django model representing a product invoice."""),
    'lino_xl.lib.sales.VatProductInvoice.balance_before' : _("""The balance of payments or debts that existed already before this voucher."""),
    'lino_xl.lib.sales.VatProductInvoice.balance_to_pay' : _("""The balance of all movements matching this invoice."""),
    'lino_xl.lib.sales.InvoiceItem' : _("""The Django model representing an item of a product invoice."""),
    'lino_xl.lib.sales.InvoiceDetail' : _("""The Lino layout representing the detail view of a product invoice."""),
    'lino_xl.lib.sales.InvoicesByJournal' : _("""Shows all invoices of a given journal."""),
    'lino_xl.lib.sales.DueInvoices' : _("""Shows all due product invoices."""),
    'lino_xl.lib.sales.ProductDocItem' : _("""Model mixin for voucher items that potentially refer to a product."""),
    'lino_xl.lib.sales.ProductDocItem.product' : _("""The product that is being sold or purchased."""),
    'lino_xl.lib.sales.ProductDocItem.description' : _("""A multi-line rich text to be printed in the resulting printable document."""),
    'lino_xl.lib.sales.ProductDocItem.discount' : _("""The percentage to subtract from the price of this item."""),
    ...
    'lino_xl.lib.sales.SalesPrintable' : _("""Inherits from PartnerPrintable and Certifiable."""),
    'lino_xl.lib.sales.SalesPrintable.subject' : _("""A single-line text that describes this voucher."""),
    'lino_xl.lib.sales.SalesPrintable.paper_type' : _("""The type of paper to use when printing this voucher."""),
    'lino_xl.lib.sales.SalesDocument' : _("""Common base class for lino_xl.lib.orders.Order and VatProductInvoice."""),
    'lino_xl.lib.sales.SalesDocument.intro' : _("""An optional introduction text to be printed on the document."""),
    'lino_xl.lib.sales.SalesDocument.print_items_table' : _("""The table (column layout) to use in the printed document."""),
    'lino_xl.lib.sales.PaperType' : _("""Describes a paper type (document template) to be used when printing an invoice."""),
    ...
    'lino_xl.lib.sepa.AccountsByPartner' : _("""Show the bank account(s) defined for a given partner. To be included to a detail window on partner."""),
    ...
    'lino_xl.lib.sheets.ItemEntry' : _("""An entry is the computed value of given item for a given report."""),
    ...
    'lino_xl.lib.vat.VatRule' : _("""A rule which defines how VAT is to be handled for a given invoice item."""),
    ...
    'lino_xl.lib.addresses.Address.address_type' : _("""The type of this address record. A pointer to AddressTypes. The default value is AddressTypes.official."""),
    ...
    'lino_xl.lib.tickets.Project.assign_to' : _("""The user to whom new tickets will be assigned. See Ticket.assigned_to."""),
    'lino_xl.lib.tickets.ProjectType' : _("""The type of a Project."""),
    'lino_xl.lib.tickets.TimeInvestment' : _("""Model mixin for things which represent a time investment. This currently just defines a group of three fields:"""),
    ...
    'lino_xl.lib.tickets.TimeInvestment.private' : _("""Whether this investment is private, i.e. should not be publicly visible anywhere."""),
    ...
    'lino_xl.lib.topics.TopicGroup' : _("""This model is deprecated. We use the Topic.ref for structuring topics."""),
    'lino_xl.lib.topics.TopicGroups' : _("""Currently not used."""),
    'lino_xl.lib.topics.Interesting' : _("""Adds an add_interest field."""),
    'lino_xl.lib.topics.Interesting.add_interest' : _("""A virtual field that show topics added to this database row."""),
    ...
    'lino_xl.lib.working.Workable.is_workable_for' : _("""Return True if the given user can start a work session on this object."""),
    'lino_xl.lib.working.Workable.on_worked' : _("""This is automatically called when a work session has been created or modified."""),
