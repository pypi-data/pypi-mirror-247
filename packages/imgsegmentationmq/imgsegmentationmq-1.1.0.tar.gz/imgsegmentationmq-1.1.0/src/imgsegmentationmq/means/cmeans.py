from imgsegmentation import np
from imgsegmentation import initialize_centroids_data
from imgsegmentation.means import cmeans_centroid,cmeans_pxl_classes
def cmeans(k,image,m,max_it=100,init_centroids=None):
    '''
    k = number of clusters
    image = numpy array for the image
