...
def fpk_generate_text_with_image(image_np, model_name="microsoft/git-base-coco", max_length=64):
    """
    Generate text using a model that takes an image as input.
    Args:
        image_np (numpy.ndarray): The image data in numpy array format.
        model_name (str): The model to use for generating text.
