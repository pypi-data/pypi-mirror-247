...
Falco is a django-centric toolkit that aims to improve the development experience of django projects. It is made of the CLI that goes from starting a 
new django project, to generating simple CRUD views for rapide prototyping, and a collection of guides that address common issues in web development,
but tailiored to django projects.
