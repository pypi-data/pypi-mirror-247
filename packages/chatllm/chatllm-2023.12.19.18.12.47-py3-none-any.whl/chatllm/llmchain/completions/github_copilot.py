...
# @WeChat       : meutils
# @Software     : PyCharm
# @Description  : 不准白嫖 必须 star, todo: 位置错误结构体
...
class Completions(object):
    ...
    def _post(self, **data):
        ...
        url: str = "https://proxy.chatllm.vip/githubcopilot/chat/completions"
    ...
    @staticmethod
    @retrying(predicate=lambda x: False)
    ...
    def get_access_token(api_key: Optional[str] = None):
        ...
        url = "https://proxy.chatllm.vip/github/copilot_internal/v2/token"
        logger.debug(requests.get(url, headers=headers).text)
