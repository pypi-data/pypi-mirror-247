...
__all__ = ["parse_json_bytes", "parse_json_bytes_as_object", "parse_json_data_as"]
...
def parse_json_data_as(data: Json, *, type: type[T]) -> T:
    try:
        return loader.load(data, type_=type)
    except TypedloadException as exc:
        raise JsonParseTypeError(data=data, expected_type=type) from exc
