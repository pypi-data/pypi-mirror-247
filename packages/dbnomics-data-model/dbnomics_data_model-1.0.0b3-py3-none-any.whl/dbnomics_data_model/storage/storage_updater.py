...
class StorageUpdater:
    def __init__(
        self, *, check_series_dimensions_exist: bool = True, source_storage: Storage, target_storage: Storage
    ) -> None:
    ...
    def merge_dataset(self, dataset_id: DatasetId) -> None:
        ...
        # Merge all series
        target_series_iter = self.target_storage.iter_series(
            dataset_id, check_series_dimensions_exist=self.check_series_dimensions_exist
        )
        source_series_iter = self.source_storage.iter_series(
            dataset_id, check_series_dimensions_exist=self.check_series_dimensions_exist
        )
