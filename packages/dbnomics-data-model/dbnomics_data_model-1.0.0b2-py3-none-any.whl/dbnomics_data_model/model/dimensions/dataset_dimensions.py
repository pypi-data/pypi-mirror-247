...
from dbnomics_data_model.model.errors.dataset_dimensions import UndefinedDimension
...
class DatasetDimensions:
    ...
    def __post_init__(self) -> None:
        ...
        if frequency_dimension_code is not None and frequency_dimension_code not in self.dimension_codes:
            raise UndefinedDimension(dataset_dimensions=self, dimension_code=frequency_dimension_code)
