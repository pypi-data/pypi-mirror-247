...
class UnBanUsers(Operation):
    ...
    _url: str = "/basic/v1/admin/namespaces/{namespace}/actions/unban"
    _method: str = "POST"
    ...
    body: ADTOForUnbanUserAPICall  # OPTIONAL in [body]
    ...
    def with_body(self, value: ADTOForUnbanUserAPICall) -> UnBanUsers:
        self.body = value
        return self

    def with_namespace(self, value: str) -> UnBanUsers:
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = ADTOForUnbanUserAPICall()
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> UnBanUsers:
        instance = cls()
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ADTOForUnbanUserAPICall.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = ADTOForUnbanUserAPICall()
