...
class UpdateConfig(Operation):
    ...
    _url: str = "/basic/v1/admin/namespaces/{namespace}/equ8/config"
    _method: str = "PATCH"
    ...
    body: ADTOForUpdateEqu8ConfigAPICall  # OPTIONAL in [body]
    ...
    def with_body(self, value: ADTOForUpdateEqu8ConfigAPICall) -> UpdateConfig:
        self.body = value
        return self
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = ADTOForUpdateEqu8ConfigAPICall()
    ...
    def parse_response(
    ...
    ) -> Tuple[Union[None, Equ8Config], Union[None, ErrorEntity, HttpResponse]]:
        ...
        if code == 200:
            return Equ8Config.create_from_dict(content), None
        if code == 400:
    ...
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> UpdateConfig:
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ADTOForUpdateEqu8ConfigAPICall.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = ADTOForUpdateEqu8ConfigAPICall()
