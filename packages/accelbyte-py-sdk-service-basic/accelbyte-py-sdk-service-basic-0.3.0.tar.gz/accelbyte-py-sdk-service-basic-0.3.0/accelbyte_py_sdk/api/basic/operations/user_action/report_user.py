...
class ReportUser(Operation):
    ...
    _url: str = "/basic/v1/admin/namespaces/{namespace}/actions/report"
    _method: str = "POST"
    ...
    def with_body(self, value: UserReportRequest) -> ReportUser:
        self.body = value
        return self

    def with_namespace(self, value: str) -> ReportUser:
    ...
    @classmethod
    def create(
        cls, namespace: str, body: Optional[UserReportRequest] = None, **kwargs
    ) -> ReportUser:
        instance = cls()
