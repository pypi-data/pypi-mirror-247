...
class BanUsers(Operation):
    ...
    _url: str = "/basic/v1/admin/namespaces/{namespace}/actions/ban"
    _method: str = "POST"
    ...
    body: UserBanRequest  # OPTIONAL in [body]
    ...
    def with_body(self, value: UserBanRequest) -> BanUsers:
        self.body = value
        return self

    def with_namespace(self, value: str) -> BanUsers:
    ...
    @classmethod
    def create(
        cls, namespace: str, body: Optional[UserBanRequest] = None, **kwargs
    ) -> BanUsers:
        instance = cls()
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> BanUsers:
        instance = cls()
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = UserBanRequest.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = UserBanRequest()
