...
class GetConfig1(Operation):
    ...
    def with_config_key(self, value: str) -> GetConfig1:
        self.config_key = value
        return self

    def with_namespace(self, value: str) -> GetConfig1:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> GetConfig1:
        instance = cls()
