...
class PublicReportUser(Operation):
    ...
    _url: str = "/basic/v1/public/namespaces/{namespace}/users/{userId}/actions/report"
    _method: str = "POST"
    ...
    def with_body(self, value: UserReportRequest) -> PublicReportUser:
        self.body = value
        return self

    def with_namespace(self, value: str) -> PublicReportUser:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> PublicReportUser:
        self.user_id = value
        return self
