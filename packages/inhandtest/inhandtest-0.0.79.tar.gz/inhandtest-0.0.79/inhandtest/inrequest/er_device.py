...
from inhandtest.tools import dict_flatten, dict_in
...
if __name__ == '__main__':
    ...
    device = ErDevice('adm', '123456', '192.168.2.1')
    ...
    a = device.get_uuid_config(fields='ltp.client', condition={'interface': 'any'}, not_none=True)
    print(a)
