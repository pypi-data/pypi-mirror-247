...
class EAP600(BasePage):
    ...
    def __init__(self, host: str, super_user: str, super_password: str, page: Page = None, model='EAP600',
        ...
        self.config = Config(host, username, password, protocol, port, model, language, self.page,
                             locale=in_setting)
