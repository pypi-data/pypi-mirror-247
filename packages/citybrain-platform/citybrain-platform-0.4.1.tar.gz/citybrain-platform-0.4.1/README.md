...
result = citybrain_platform.Computing.create_function(
    name="test_udf", # udf name
    class_type="TestUDF2", # class name in resource
    comment="test function",
    resources=["testudf.py"] # resources used by this function
)
print(result)
```
...
```python
from citybrain_platform.computing.data_types import ResourceType
