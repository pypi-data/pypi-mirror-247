...
# res = citybrain_platform.Computing.create_resource(
#     name="testudf.py",
...
# res = citybrain_platform.Computing.create_function(
#     name="test_udf",
#     class_type="TestUDF2",
#     comment="test function",
#     resources=["testudf.py"]
# )
# print(res)
...
# job_id = citybrain_platform.Computing.create_job("select avg(12) from tbl_test_cmip limit 12;")
# print(job_id);

# # make a select query
# status = citybrain_platform.Computing.get_job_status(job_id='0401da24-e077-4476-b17a-22d22cf93b73');
# print(status);

# # get results of the query
citybrain_platform.Computing.get_job_results(job_id='0401da24-e077-4476-b17a-22d22cf93b73', filepath="tbl_test_cmip1.csv", header=False)
