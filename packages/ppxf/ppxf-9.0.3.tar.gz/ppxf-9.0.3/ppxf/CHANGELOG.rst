...
V9.0.3: MC, Vicenza, 20 December 2023
+++++++++++++++++++++++++++++++++++++

- ``sps_util.mass_to_light``: Generalized for any SPS model and any redshift,
  without relying on pre-computed tables.
- ``ppxf_util.varsmooth``: Added ``shift`` keyword to shift the spectrum during
  convolution by changing the analytic Fourier Transform of the Gaussian.
