...
from cmcccloudsdkcore.region.cache import ProfileRegionCache, EnvRegionCache
from cmcccloudsdkcore.region.region import Region

from cmcccloudsdkcore.utils import six_utils
...
class EnvRegionProvider(RegionProvider):
    _REGION_ENV_PREFIX = "CMCCCLOUD_SDK_REGION"
