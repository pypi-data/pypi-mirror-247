...
from cmcccloudsdkcore.auth.credentials import BasicCredentials, DerivedCredentials
from cmcccloudsdkcore.auth.provider import CredentialProviderChain
from cmcccloudsdkcore.exceptions.exceptions import HostUnreachableException
from cmcccloudsdkcore.exceptions.exception_handler import ExceptionHandler, DefaultExceptionHandler
from cmcccloudsdkcore.http import progress
from cmcccloudsdkcore.http.formdata import FormFile
from cmcccloudsdkcore.http.http_client import HttpClient
from cmcccloudsdkcore.http.http_config import HttpConfig
from cmcccloudsdkcore.http.http_handler import HttpHandler
from cmcccloudsdkcore.http.primitive_types import NATIVE_TYPES_MAPPING
from cmcccloudsdkcore.http.primitive_types import PRIMITIVE_TYPES
from cmcccloudsdkcore.sdk_request import SdkRequest
from cmcccloudsdkcore.sdk_response import FutureSdkResponse, SdkResponse
from cmcccloudsdkcore.sdk_stream_response import SdkStreamResponse
from cmcccloudsdkcore.utils import http_utils, core_utils
from cmcccloudsdkcore.utils.filepath_utils import ensure_file_in_rb_mode
from cmcccloudsdkcore.utils.xml_utils import XmlTransfer
...
class ClientBuilder(Generic[T]):
    ...
    def with_http_config(self, config):
        ...
        :type config: :class:`cmcccloudsdkcore.http.http_config.HttpConfig`
        """
        self._config = config
        return self
    ...
    def with_credentials(self, credentials):
        ...
        :type credentials: :class:`cmcccloudsdkcore.auth.credentials.Credentials`
        """
    ...
    def with_region(self, region):
        ...
        :type region: :class:`cmcccloudsdkcore.region.region.Region`
        """
        self._region = region
        return self
    ...
    def with_exception_handler(self, exception_handler):
        ...
        :type exception_handler: :class:`cmcccloudsdkcore.exceptions.exception_handler.ExceptionHandler`
        """
    ...
    def with_http_handler(self, http_handler):
        ...
        :type http_handler: :class:`cmcccloudsdkcore.http.http_handler.HttpHandler`
        """
...
class Client(object):
    ...
    def __init__(self):
        self.preset_headers = {}
        self._agent = {"User-Agent": "cmcccloud-usdk-python/3.0"}
    ...
    def _init_logger(cls):
        logger_name = 'CMCCCloud-SDK-%s' % cls.__name__
