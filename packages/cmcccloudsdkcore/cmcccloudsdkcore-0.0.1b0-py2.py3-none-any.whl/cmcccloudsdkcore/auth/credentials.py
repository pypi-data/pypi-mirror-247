...
from cmcccloudsdkcore.auth.cache import AuthCache
from cmcccloudsdkcore.auth.internal import Iam, Metadata
from cmcccloudsdkcore.exceptions.exceptions import ApiValueError, ServiceResponseException, SdkException
from cmcccloudsdkcore.signer.algorithm import SigningAlgorithm
from cmcccloudsdkcore.signer.signer import Signer, SM3Signer, DerivationAKSKSigner, P256SHA256Signer, SM2SM3Signer
from cmcccloudsdkcore.utils import time_utils, six_utils
...
class DerivedCredentials(six_utils.get_abstract_meta_class()):
    _DEFAULT_ENDPOINT_REG = "^[a-z][a-z0-9-]+(\\.[a-z]{2,}-[a-z]+-\\d{1,2})?\\.(my)?(cmecloud).(com|cn)"
...
class GlobalCredentials(Credentials):
    ...
    def __init__(self, ak=None, sk=None, domain_id=None):
        ...
        :param ak: The access key ID for your account
        :param sk: The secret access key for your account
        :param domain_id: The account ID of CMCC Cloud
        """
