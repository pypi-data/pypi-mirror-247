...
def make_rules():
	...
	if os.getuid() != 0 and system in ['Linux', 'FreeBSD']:
		raise OSError(
				'You must have root privileges to install udev/devd rules! sudo pip3 install eyes17lib')
	if system == 'Linux':
...
setuptools.setup(
    ...
    keywords = 'expeyes17 seelab3 data-acquisition lab-at-home oscilloscope waveform-generator sensors physics',
    python_requires='>=3',
