...
class Downloader(object):
    ...
    def drcd(self):
        """ DRCD 繁体阅读理解数据集
        """
        return fetch_data('drcd.zip')

    def dureader_robust(self):
        """ 百度阅读理解数据集
        https://aistudio.baidu.com/competition/detail/49/0/task-definition
        """
        return fetch_data('dureader_robust.zip')
