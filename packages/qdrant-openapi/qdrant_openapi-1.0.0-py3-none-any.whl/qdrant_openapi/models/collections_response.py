...
class CollectionsResponse(BaseModel):
    ...
    CollectionsResponse
    """
    collections: conlist(CollectionDescription) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CollectionsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CollectionsResponse:
        """Create an instance of CollectionsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CollectionsResponse.parse_obj(obj)

        _obj = CollectionsResponse.parse_obj({
            "collections": [CollectionDescription.from_dict(_item) for _item in obj.get("collections")] if obj.get("collections") is not None else None
        })
        return _obj
