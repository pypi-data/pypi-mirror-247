...
class MatchValue(BaseModel):
    """
    Exact match of the given value  # noqa: E501
    """
    value: ValueVariants = Field(...)
    __properties = ["value"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MatchValue:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MatchValue:
        """Create an instance of MatchValue from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MatchValue.parse_obj(obj)

        _obj = MatchValue.parse_obj({
            "value": ValueVariants.from_dict(obj.get("value")) if obj.get("value") is not None else None
        })
        return _obj
