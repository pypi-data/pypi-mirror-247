...
class PointStruct(BaseModel):
    ...
    vector: VectorStruct = Field(...)
    payload: Optional[Dict[str, Any]] = None
    __properties = ["id", "vector", "payload"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PointStruct:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PointStruct:
        """Create an instance of PointStruct from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PointStruct.parse_obj(obj)

        _obj = PointStruct.parse_obj({
