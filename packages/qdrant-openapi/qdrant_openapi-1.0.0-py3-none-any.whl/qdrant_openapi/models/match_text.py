...
class MatchText(BaseModel):
    """
    Full-text match of the strings.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MatchText:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MatchText:
        """Create an instance of MatchText from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MatchText.parse_obj(obj)

        _obj = MatchText.parse_obj({
            "text": obj.get("text")
        })
        return _obj
