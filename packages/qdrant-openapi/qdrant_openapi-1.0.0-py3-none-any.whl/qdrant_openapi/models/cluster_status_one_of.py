...
class ClusterStatusOneOf(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClusterStatusOneOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClusterStatusOneOf:
        """Create an instance of ClusterStatusOneOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClusterStatusOneOf.parse_obj(obj)

        _obj = ClusterStatusOneOf.parse_obj({
