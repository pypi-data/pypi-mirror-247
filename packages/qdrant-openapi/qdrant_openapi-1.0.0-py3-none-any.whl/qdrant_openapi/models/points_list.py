...
class PointsList(BaseModel):
    ...
    PointsList
    """
    points: conlist(PointStruct) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PointsList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PointsList:
        """Create an instance of PointsList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PointsList.parse_obj(obj)

        _obj = PointsList.parse_obj({
            "points": [PointStruct.from_dict(_item) for _item in obj.get("points")] if obj.get("points") is not None else None,
