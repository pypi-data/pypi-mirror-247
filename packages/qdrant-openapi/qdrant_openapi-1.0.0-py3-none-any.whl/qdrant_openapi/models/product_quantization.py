...
class ProductQuantization(BaseModel):
    ...
    ProductQuantization
    """
    product: ProductQuantizationConfig = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProductQuantization:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProductQuantization:
        """Create an instance of ProductQuantization from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProductQuantization.parse_obj(obj)

        _obj = ProductQuantization.parse_obj({
            "product": ProductQuantizationConfig.from_dict(obj.get("product")) if obj.get("product") is not None else None
        })
        return _obj
