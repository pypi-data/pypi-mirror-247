...
class CollectionsAliasesResponse(BaseModel):
    ...
    """
    aliases: conlist(AliasDescription) = Field(...)
    __properties = ["aliases"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CollectionsAliasesResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CollectionsAliasesResponse:
        """Create an instance of CollectionsAliasesResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CollectionsAliasesResponse.parse_obj(obj)

        _obj = CollectionsAliasesResponse.parse_obj({
            "aliases": [AliasDescription.from_dict(_item) for _item in obj.get("aliases")] if obj.get("aliases") is not None else None
        })
        return _obj
