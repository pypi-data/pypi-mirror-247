...
class AliasDescription(BaseModel):
    ...
    __properties = ["alias_name", "collection_name"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AliasDescription:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AliasDescription:
        """Create an instance of AliasDescription from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AliasDescription.parse_obj(obj)

        _obj = AliasDescription.parse_obj({
