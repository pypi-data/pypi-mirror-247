...
class RecommendStrategy(str, Enum):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RecommendStrategy:
        """Create an instance of RecommendStrategy from a JSON string"""
        return RecommendStrategy(json.loads(json_str))
