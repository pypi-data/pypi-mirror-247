...
class VectorParams(BaseModel):
    """
    Params of single vector data storage  # noqa: E501
    """
    size: conint(strict=True, ge=1) = Field(..., description="Size of a vectors used")
    distance: Distance = Field(...)
    hnsw_config: Optional[HnswConfigDiff] = None
    quantization_config: Optional[QuantizationConfig] = None
    on_disk: Optional[StrictBool] = Field(None, description="If true, vectors are served from disk, improving RAM usage at the cost of latency Default: false")
    __properties = ["size", "distance", "hnsw_config", "quantization_config", "on_disk"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VectorParams:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VectorParams:
        """Create an instance of VectorParams from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VectorParams.parse_obj(obj)

        _obj = VectorParams.parse_obj({
            "size": obj.get("size"),
