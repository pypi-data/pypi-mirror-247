...
class AppBuildTelemetry(BaseModel):
    ...
    features: Optional[AppFeaturesTelemetry] = None
    system: Optional[RunningEnvironmentTelemetry] = None
    startup: datetime = Field(...)
    __properties = ["name", "version", "features", "system", "startup"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AppBuildTelemetry:
    ...
    def to_dict(self):
        ...
        # and __fields_set__ contains the field
        if self.system is None and "system" in self.__fields_set__:
            _dict['system'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> AppBuildTelemetry:
        """Create an instance of AppBuildTelemetry from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AppBuildTelemetry.parse_obj(obj)

        _obj = AppBuildTelemetry.parse_obj({
            "name": obj.get("name"),
            "version": obj.get("version"),
            "features": AppFeaturesTelemetry.from_dict(obj.get("features")) if obj.get("features") is not None else None,
            "system": RunningEnvironmentTelemetry.from_dict(obj.get("system")) if obj.get("system") is not None else None,
