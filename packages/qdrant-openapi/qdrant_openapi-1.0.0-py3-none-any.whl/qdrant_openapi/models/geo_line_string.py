...
class GeoLineString(BaseModel):
    """
    Ordered sequence of GeoPoints representing the line  # noqa: E501
    """
    points: conlist(GeoPoint) = Field(...)
    __properties = ["points"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GeoLineString:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GeoLineString:
        """Create an instance of GeoLineString from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GeoLineString.parse_obj(obj)

        _obj = GeoLineString.parse_obj({
            "points": [GeoPoint.from_dict(_item) for _item in obj.get("points")] if obj.get("points") is not None else None
        })
        return _obj
