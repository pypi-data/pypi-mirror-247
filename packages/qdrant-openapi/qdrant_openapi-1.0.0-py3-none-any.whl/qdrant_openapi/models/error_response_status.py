...
class ErrorResponseStatus(BaseModel):
    ...
    ErrorResponseStatus
    """
    error: Optional[StrictStr] = Field(None, description="Description of the occurred error.")
    __properties = ["error"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ErrorResponseStatus:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ErrorResponseStatus:
        """Create an instance of ErrorResponseStatus from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ErrorResponseStatus.parse_obj(obj)

        _obj = ErrorResponseStatus.parse_obj({
            "error": obj.get("error")
        })
        return _obj
