...
class ShardSnapshotRecover(BaseModel):
    """
    ShardSnapshotRecover
    """
    location: ShardSnapshotLocation = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ShardSnapshotRecover:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ShardSnapshotRecover:
        """Create an instance of ShardSnapshotRecover from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ShardSnapshotRecover.parse_obj(obj)

        _obj = ShardSnapshotRecover.parse_obj({
            "location": ShardSnapshotLocation.from_dict(obj.get("location")) if obj.get("location") is not None else None,
