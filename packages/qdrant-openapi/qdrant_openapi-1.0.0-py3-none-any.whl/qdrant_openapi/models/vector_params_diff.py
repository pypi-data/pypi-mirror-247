...
class VectorParamsDiff(BaseModel):
    ...
    on_disk: Optional[StrictBool] = Field(None, description="If true, vectors are served from disk, improving RAM usage at the cost of latency")
    __properties = ["hnsw_config", "quantization_config", "on_disk"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VectorParamsDiff:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VectorParamsDiff:
        """Create an instance of VectorParamsDiff from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VectorParamsDiff.parse_obj(obj)

        _obj = VectorParamsDiff.parse_obj({
