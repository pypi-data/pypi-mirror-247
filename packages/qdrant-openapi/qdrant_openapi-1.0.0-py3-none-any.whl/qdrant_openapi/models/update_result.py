...
class UpdateResult(BaseModel):
    ...
    UpdateResult
    """
    operation_id: Optional[conint(strict=True, ge=0)] = Field(None, description="Sequential number of the operation")
    status: UpdateStatus = Field(...)
    __properties = ["operation_id", "status"]
    ...
    def to_dict(self):
        ...
        if self.operation_id is None and "operation_id" in self.__fields_set__:
