...
class DiscoverRequestBatch(BaseModel):
    """
    DiscoverRequestBatch
    """
    searches: conlist(DiscoverRequest) = Field(...)
    __properties = ["searches"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DiscoverRequestBatch:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DiscoverRequestBatch:
        """Create an instance of DiscoverRequestBatch from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DiscoverRequestBatch.parse_obj(obj)

        _obj = DiscoverRequestBatch.parse_obj({
            "searches": [DiscoverRequest.from_dict(_item) for _item in obj.get("searches")] if obj.get("searches") is not None else None
        })
        return _obj
