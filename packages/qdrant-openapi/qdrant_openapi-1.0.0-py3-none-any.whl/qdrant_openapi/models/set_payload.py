...
class SetPayload(BaseModel):
    ...
    points: Optional[conlist(ExtendedPointId)] = Field(None, description="Assigns payload to each point in this list")
    filter: Optional[Filter] = None
    shard_key: Optional[ShardKeySelector] = None
    __properties = ["payload", "points", "filter", "shard_key"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SetPayload:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SetPayload:
        """Create an instance of SetPayload from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SetPayload.parse_obj(obj)

        _obj = SetPayload.parse_obj({
