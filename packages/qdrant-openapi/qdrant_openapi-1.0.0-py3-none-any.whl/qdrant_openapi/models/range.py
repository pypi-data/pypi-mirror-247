...
class Range(BaseModel):
    """
    Range filter request  # noqa: E501
    """
    lt: Optional[Union[StrictFloat, StrictInt]] = Field(None, description="point.key < range.lt")
    gt: Optional[Union[StrictFloat, StrictInt]] = Field(None, description="point.key > range.gt")
    gte: Optional[Union[StrictFloat, StrictInt]] = Field(None, description="point.key >= range.gte")
    lte: Optional[Union[StrictFloat, StrictInt]] = Field(None, description="point.key <= range.lte")
