...
class DeleteAlias(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeleteAlias:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeleteAlias:
        """Create an instance of DeleteAlias from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeleteAlias.parse_obj(obj)

        _obj = DeleteAlias.parse_obj({
