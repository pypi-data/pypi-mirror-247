...
class RecommendRequestBatch(BaseModel):
    ...
    """
    searches: conlist(RecommendRequest) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RecommendRequestBatch:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RecommendRequestBatch:
        """Create an instance of RecommendRequestBatch from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RecommendRequestBatch.parse_obj(obj)

        _obj = RecommendRequestBatch.parse_obj({
            "searches": [RecommendRequest.from_dict(_item) for _item in obj.get("searches")] if obj.get("searches") is not None else None
        })
        return _obj
