...
class MatchAny(BaseModel):
    """
    Exact match on any of the given values  # noqa: E501
    """
    any: AnyVariants = Field(...)
    __properties = ["any"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MatchAny:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MatchAny:
        """Create an instance of MatchAny from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MatchAny.parse_obj(obj)

        _obj = MatchAny.parse_obj({
            "any": AnyVariants.from_dict(obj.get("any")) if obj.get("any") is not None else None
        })
        return _obj
