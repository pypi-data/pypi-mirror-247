...
class TestConsensusThreadStatusOneOf1(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ConsensusThreadStatusOneOf1:
        """Test ConsensusThreadStatusOneOf1
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConsensusThreadStatusOneOf1`
        """
        model = ConsensusThreadStatusOneOf1()  # noqa: E501
        if include_optional:
            return ConsensusThreadStatusOneOf1(
    ...
    def testConsensusThreadStatusOneOf1(self):
        """Test ConsensusThreadStatusOneOf1"""
