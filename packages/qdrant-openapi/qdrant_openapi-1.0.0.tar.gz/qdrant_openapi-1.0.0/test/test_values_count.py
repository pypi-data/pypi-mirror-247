...
class TestValuesCount(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ValuesCount:
        """Test ValuesCount
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValuesCount`
        """
        model = ValuesCount()  # noqa: E501
        if include_optional:
            return ValuesCount(
                lt = 0,
                gt = 0,
