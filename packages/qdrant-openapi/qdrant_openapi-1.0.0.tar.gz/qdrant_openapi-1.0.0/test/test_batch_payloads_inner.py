...
class TestBatchPayloadsInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> BatchPayloadsInner:
        """Test BatchPayloadsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BatchPayloadsInner`
        """
        model = BatchPayloadsInner()  # noqa: E501
        if include_optional:
            return BatchPayloadsInner(
            )
        else:
            return BatchPayloadsInner(
        )
    ...
    def testBatchPayloadsInner(self):
        """Test BatchPayloadsInner"""
