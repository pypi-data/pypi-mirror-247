...
class TestPayloadStorageTypeOneOf(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PayloadStorageTypeOneOf:
        """Test PayloadStorageTypeOneOf
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PayloadStorageTypeOneOf`
        """
        model = PayloadStorageTypeOneOf()  # noqa: E501
        if include_optional:
            return PayloadStorageTypeOneOf(
                type = 'in_memory'
            )
        else:
            return PayloadStorageTypeOneOf(
    ...
    def testPayloadStorageTypeOneOf(self):
        """Test PayloadStorageTypeOneOf"""
