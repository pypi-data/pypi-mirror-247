...
class TestRecommendRequestBatch(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> RecommendRequestBatch:
        """Test RecommendRequestBatch
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RecommendRequestBatch`
        """
        model = RecommendRequestBatch()  # noqa: E501
        if include_optional:
    ...
    def testRecommendRequestBatch(self):
        """Test RecommendRequestBatch"""
