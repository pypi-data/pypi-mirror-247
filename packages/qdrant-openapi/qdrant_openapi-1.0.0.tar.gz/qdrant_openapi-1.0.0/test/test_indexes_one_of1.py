...
class TestIndexesOneOf1(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> IndexesOneOf1:
        """Test IndexesOneOf1
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IndexesOneOf1`
        """
        model = IndexesOneOf1()  # noqa: E501
        if include_optional:
