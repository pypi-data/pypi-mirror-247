...
from qdrant_openapi.models.cluster_telemetry import ClusterTelemetry  # noqa: E501

class TestClusterTelemetry(unittest.TestCase):
    """ClusterTelemetry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClusterTelemetry:
        """Test ClusterTelemetry
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClusterTelemetry`
        """
        model = ClusterTelemetry()  # noqa: E501
        if include_optional:
