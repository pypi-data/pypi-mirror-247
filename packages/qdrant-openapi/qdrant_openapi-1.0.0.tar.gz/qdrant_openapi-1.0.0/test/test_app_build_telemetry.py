...
class TestAppBuildTelemetry(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AppBuildTelemetry:
        """Test AppBuildTelemetry
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppBuildTelemetry`
        """
        model = AppBuildTelemetry()  # noqa: E501
        if include_optional:
    ...
    def testAppBuildTelemetry(self):
        """Test AppBuildTelemetry"""
