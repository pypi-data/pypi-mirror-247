...
from qdrant_openapi.models.local_shard_telemetry import LocalShardTelemetry  # noqa: E501

class TestLocalShardTelemetry(unittest.TestCase):
    """LocalShardTelemetry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LocalShardTelemetry:
        """Test LocalShardTelemetry
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LocalShardTelemetry`
        """
        model = LocalShardTelemetry()  # noqa: E501
        if include_optional:
            return LocalShardTelemetry(
                variant_name = '',
                segments = [
    ...
    def testLocalShardTelemetry(self):
        """Test LocalShardTelemetry"""
