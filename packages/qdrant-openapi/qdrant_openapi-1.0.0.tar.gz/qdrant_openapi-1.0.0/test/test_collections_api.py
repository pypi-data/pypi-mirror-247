...
class TestCollectionsApi(unittest.TestCase):
    ...
    def test_collection_cluster_info(self) -> None:
    ...
    def test_create_field_index(self) -> None:
    ...
    def test_create_shard_key(self) -> None:
    ...
    def test_create_shard_snapshot(self) -> None:
    ...
    def test_delete_field_index(self) -> None:
    ...
    def test_delete_shard_key(self) -> None:
    ...
    def test_delete_shard_snapshot(self) -> None:
    ...
    def test_get_collection_aliases(self) -> None:
    ...
    def test_get_collections_aliases(self) -> None:
    ...
    def test_get_shard_snapshot(self) -> None:
    ...
    def test_list_shard_snapshots(self) -> None:
    ...
    def test_recover_from_snapshot(self) -> None:
    ...
    def test_recover_from_uploaded_snapshot(self) -> None:
    ...
    def test_recover_shard_from_snapshot(self) -> None:
    ...
    def test_recover_shard_from_uploaded_snapshot(self) -> None:
    ...
    def test_update_collection_cluster(self) -> None:
