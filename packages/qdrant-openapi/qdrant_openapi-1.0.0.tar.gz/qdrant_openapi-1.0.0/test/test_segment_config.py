...
class TestSegmentConfig(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SegmentConfig:
        """Test SegmentConfig
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SegmentConfig`
        """
        model = SegmentConfig()  # noqa: E501
        if include_optional:
