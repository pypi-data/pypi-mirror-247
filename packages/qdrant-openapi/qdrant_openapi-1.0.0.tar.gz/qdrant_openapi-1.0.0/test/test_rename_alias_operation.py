...
class TestRenameAliasOperation(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> RenameAliasOperation:
        """Test RenameAliasOperation
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RenameAliasOperation`
        """
    ...
    def testRenameAliasOperation(self):
        """Test RenameAliasOperation"""
