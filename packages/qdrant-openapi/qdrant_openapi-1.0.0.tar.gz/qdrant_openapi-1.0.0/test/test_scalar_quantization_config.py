...
class TestScalarQuantizationConfig(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ScalarQuantizationConfig:
        """Test ScalarQuantizationConfig
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ScalarQuantizationConfig`
        """
        model = ScalarQuantizationConfig()  # noqa: E501
        if include_optional:
            return ScalarQuantizationConfig(
                type = 'int8',
                quantile = 0.5,
                always_ram = True
            )
    ...
    def testScalarQuantizationConfig(self):
        """Test ScalarQuantizationConfig"""
