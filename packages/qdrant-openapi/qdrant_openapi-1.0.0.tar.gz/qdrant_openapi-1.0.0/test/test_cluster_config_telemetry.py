...
class TestClusterConfigTelemetry(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ClusterConfigTelemetry:
        """Test ClusterConfigTelemetry
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClusterConfigTelemetry`
        """
        model = ClusterConfigTelemetry()  # noqa: E501
        if include_optional:
    ...
    def testClusterConfigTelemetry(self):
        """Test ClusterConfigTelemetry"""
