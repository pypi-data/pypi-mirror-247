...
class TestSearchRequestBatch(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SearchRequestBatch:
        """Test SearchRequestBatch
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchRequestBatch`
        """
        model = SearchRequestBatch()  # noqa: E501
        if include_optional:
    ...
    def testSearchRequestBatch(self):
        """Test SearchRequestBatch"""
