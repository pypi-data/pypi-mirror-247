...
class TestPointsList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PointsList:
        """Test PointsList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PointsList`
        """
        model = PointsList()  # noqa: E501
        if include_optional:
            return PointsList(
                points = [
