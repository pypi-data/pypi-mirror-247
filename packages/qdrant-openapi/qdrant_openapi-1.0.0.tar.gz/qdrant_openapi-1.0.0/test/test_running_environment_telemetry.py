...
class TestRunningEnvironmentTelemetry(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> RunningEnvironmentTelemetry:
        """Test RunningEnvironmentTelemetry
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RunningEnvironmentTelemetry`
        """
        model = RunningEnvironmentTelemetry()  # noqa: E501
        if include_optional:
            return RunningEnvironmentTelemetry(
                distribution = '',
    ...
    def testRunningEnvironmentTelemetry(self):
        """Test RunningEnvironmentTelemetry"""
