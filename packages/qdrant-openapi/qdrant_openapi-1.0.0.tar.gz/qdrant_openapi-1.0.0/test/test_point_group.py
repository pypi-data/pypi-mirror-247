...
class TestPointGroup(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PointGroup:
        """Test PointGroup
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PointGroup`
        """
        model = PointGroup()  # noqa: E501
        if include_optional:
            return PointGroup(
                hits = [
