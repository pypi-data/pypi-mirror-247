...
class TestAnyVariants(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AnyVariants:
        """Test AnyVariants
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnyVariants`
        """
        model = AnyVariants()  # noqa: E501
        if include_optional:
            return AnyVariants(
            )
        else:
