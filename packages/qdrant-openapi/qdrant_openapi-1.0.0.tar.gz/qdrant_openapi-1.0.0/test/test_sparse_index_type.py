...
class TestSparseIndexType(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SparseIndexType:
        """Test SparseIndexType
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SparseIndexType`
        """
        model = SparseIndexType()  # noqa: E501
        if include_optional:
            return SparseIndexType(
            )
        else:
            return SparseIndexType(
        )
