...
class TestCollectionsAggregatedTelemetry(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CollectionsAggregatedTelemetry:
        """Test CollectionsAggregatedTelemetry
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionsAggregatedTelemetry`
        """
        model = CollectionsAggregatedTelemetry()  # noqa: E501
        if include_optional:
    ...
    def testCollectionsAggregatedTelemetry(self):
        """Test CollectionsAggregatedTelemetry"""
