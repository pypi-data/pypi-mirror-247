...
class TestGroupsResult(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GroupsResult:
        """Test GroupsResult
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupsResult`
        """
        model = GroupsResult()  # noqa: E501
        if include_optional:
            return GroupsResult(
                groups = [
