...
class TestClusterStatusTelemetry(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ClusterStatusTelemetry:
        """Test ClusterStatusTelemetry
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClusterStatusTelemetry`
        """
        model = ClusterStatusTelemetry()  # noqa: E501
        if include_optional:
            return ClusterStatusTelemetry(
                number_of_peers = 0,
                term = 0,
                commit = 0,
