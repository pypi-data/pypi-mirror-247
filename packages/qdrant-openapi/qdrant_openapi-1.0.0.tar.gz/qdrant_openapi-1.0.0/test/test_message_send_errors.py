...
class TestMessageSendErrors(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> MessageSendErrors:
        """Test MessageSendErrors
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MessageSendErrors`
        """
        model = MessageSendErrors()  # noqa: E501
        if include_optional:
            return MessageSendErrors(
                count = 0,
                latest_error = ''
            )
        else:
    ...
    def testMessageSendErrors(self):
        """Test MessageSendErrors"""
