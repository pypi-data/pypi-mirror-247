...
class TestBinaryQuantization(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> BinaryQuantization:
        """Test BinaryQuantization
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BinaryQuantization`
        """
    ...
    def testBinaryQuantization(self):
        """Test BinaryQuantization"""
