...
class TestOverwritePayloadOperation(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> OverwritePayloadOperation:
        """Test OverwritePayloadOperation
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OverwritePayloadOperation`
        """
    ...
    def testOverwritePayloadOperation(self):
        """Test OverwritePayloadOperation"""
