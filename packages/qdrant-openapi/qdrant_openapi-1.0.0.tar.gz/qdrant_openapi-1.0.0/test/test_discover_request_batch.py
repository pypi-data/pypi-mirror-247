...
class TestDiscoverRequestBatch(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DiscoverRequestBatch:
        """Test DiscoverRequestBatch
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DiscoverRequestBatch`
        """
        model = DiscoverRequestBatch()  # noqa: E501
        if include_optional:
    ...
    def testDiscoverRequestBatch(self):
        """Test DiscoverRequestBatch"""
