...
class TestConsensusConfigTelemetry(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ConsensusConfigTelemetry:
        """Test ConsensusConfigTelemetry
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConsensusConfigTelemetry`
        """
        model = ConsensusConfigTelemetry()  # noqa: E501
        if include_optional:
            return ConsensusConfigTelemetry(
    ...
    def testConsensusConfigTelemetry(self):
        """Test ConsensusConfigTelemetry"""
