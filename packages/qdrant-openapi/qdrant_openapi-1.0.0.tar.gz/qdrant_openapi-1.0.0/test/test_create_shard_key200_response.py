...
class TestCreateShardKey200Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CreateShardKey200Response:
        """Test CreateShardKey200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateShardKey200Response`
        """
        model = CreateShardKey200Response()  # noqa: E501
        if include_optional:
            return CreateShardKey200Response(
                time = 1.337,
                status = '',
                result = True
            )
    ...
    def testCreateShardKey200Response(self):
        """Test CreateShardKey200Response"""
