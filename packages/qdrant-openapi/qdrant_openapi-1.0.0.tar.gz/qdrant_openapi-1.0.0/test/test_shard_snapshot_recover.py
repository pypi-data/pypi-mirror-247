...
class TestShardSnapshotRecover(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ShardSnapshotRecover:
        """Test ShardSnapshotRecover
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShardSnapshotRecover`
        """
        model = ShardSnapshotRecover()  # noqa: E501
        if include_optional:
            return ShardSnapshotRecover(
                location = None,
                priority = 'no_sync'
            )
        else:
    ...
    def testShardSnapshotRecover(self):
        """Test ShardSnapshotRecover"""
