...
class TestLocalShardInfo(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> LocalShardInfo:
        """Test LocalShardInfo
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LocalShardInfo`
        """
        model = LocalShardInfo()  # noqa: E501
        if include_optional:
