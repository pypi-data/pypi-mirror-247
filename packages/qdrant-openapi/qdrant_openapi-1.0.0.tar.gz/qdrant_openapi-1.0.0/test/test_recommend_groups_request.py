...
class TestRecommendGroupsRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> RecommendGroupsRequest:
        """Test RecommendGroupsRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RecommendGroupsRequest`
        """
        model = RecommendGroupsRequest()  # noqa: E501
        if include_optional:
            return RecommendGroupsRequest(
                shard_key = None,
                positive = [
                    null
                    ],
    ...
    def testRecommendGroupsRequest(self):
        """Test RecommendGroupsRequest"""
