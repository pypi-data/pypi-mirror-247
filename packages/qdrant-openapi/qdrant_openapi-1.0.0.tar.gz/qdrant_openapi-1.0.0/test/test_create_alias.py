...
class TestCreateAlias(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CreateAlias:
        """Test CreateAlias
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateAlias`
        """
        model = CreateAlias()  # noqa: E501
        if include_optional:
            return CreateAlias(
                collection_name = '',
                alias_name = ''
