...
class TestContextExamplePair(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ContextExamplePair:
        """Test ContextExamplePair
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContextExamplePair`
        """
        model = ContextExamplePair()  # noqa: E501
        if include_optional:
    ...
    def testContextExamplePair(self):
        """Test ContextExamplePair"""
