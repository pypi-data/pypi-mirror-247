...
class TestGeoLineString(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GeoLineString:
        """Test GeoLineString
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GeoLineString`
        """
        model = GeoLineString()  # noqa: E501
        if include_optional:
