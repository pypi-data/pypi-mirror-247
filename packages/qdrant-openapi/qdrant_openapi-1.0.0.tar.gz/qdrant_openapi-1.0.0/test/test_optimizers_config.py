...
class TestOptimizersConfig(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> OptimizersConfig:
        """Test OptimizersConfig
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OptimizersConfig`
        """
        model = OptimizersConfig()  # noqa: E501
        if include_optional:
