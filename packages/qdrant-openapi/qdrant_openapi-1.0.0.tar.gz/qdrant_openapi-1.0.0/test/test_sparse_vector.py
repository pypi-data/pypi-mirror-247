...
class TestSparseVector(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SparseVector:
        """Test SparseVector
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SparseVector`
        """
        model = SparseVector()  # noqa: E501
        if include_optional:
            return SparseVector(
                indices = [
                    0
