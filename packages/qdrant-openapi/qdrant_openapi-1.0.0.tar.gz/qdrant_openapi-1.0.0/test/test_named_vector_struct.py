...
class TestNamedVectorStruct(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NamedVectorStruct:
        """Test NamedVectorStruct
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NamedVectorStruct`
        """
        model = NamedVectorStruct()  # noqa: E501
        if include_optional:
    ...
    def testNamedVectorStruct(self):
        """Test NamedVectorStruct"""
