...
class TestVectorIndexSearchesTelemetry(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> VectorIndexSearchesTelemetry:
        """Test VectorIndexSearchesTelemetry
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VectorIndexSearchesTelemetry`
        """
        model = VectorIndexSearchesTelemetry()  # noqa: E501
        if include_optional:
    ...
    def testVectorIndexSearchesTelemetry(self):
        """Test VectorIndexSearchesTelemetry"""
