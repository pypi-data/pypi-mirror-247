...
class TestVectorDataConfig(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> VectorDataConfig:
        """Test VectorDataConfig
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VectorDataConfig`
        """
        model = VectorDataConfig()  # noqa: E501
        if include_optional:
            return VectorDataConfig(
                size = 0,
                distance = 'Cosine',
                storage_type = None,
                index = None,
