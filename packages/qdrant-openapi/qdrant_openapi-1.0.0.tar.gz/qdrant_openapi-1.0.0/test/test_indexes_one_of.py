...
class TestIndexesOneOf(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> IndexesOneOf:
        """Test IndexesOneOf
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IndexesOneOf`
        """
        model = IndexesOneOf()  # noqa: E501
        if include_optional:
            return IndexesOneOf(
                type = 'plain',
