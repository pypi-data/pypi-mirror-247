...
class TestWithPayloadInterface(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> WithPayloadInterface:
        """Test WithPayloadInterface
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WithPayloadInterface`
        """
        model = WithPayloadInterface()  # noqa: E501
        if include_optional:
            return WithPayloadInterface(
                include = [
                    ''
                    ],
                exclude = [
    ...
    def testWithPayloadInterface(self):
        """Test WithPayloadInterface"""
