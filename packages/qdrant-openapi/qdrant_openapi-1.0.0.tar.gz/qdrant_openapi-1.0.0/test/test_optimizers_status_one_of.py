...
class TestOptimizersStatusOneOf(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> OptimizersStatusOneOf:
        """Test OptimizersStatusOneOf
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OptimizersStatusOneOf`
        """
        model = OptimizersStatusOneOf()  # noqa: E501
        if include_optional:
            return OptimizersStatusOneOf(
                error = ''
            )
        else:
            return OptimizersStatusOneOf(
    ...
    def testOptimizersStatusOneOf(self):
        """Test OptimizersStatusOneOf"""
