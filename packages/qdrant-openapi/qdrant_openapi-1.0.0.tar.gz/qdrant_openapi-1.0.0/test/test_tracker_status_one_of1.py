...
class TestTrackerStatusOneOf1(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TrackerStatusOneOf1:
        """Test TrackerStatusOneOf1
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TrackerStatusOneOf1`
        """
        model = TrackerStatusOneOf1()  # noqa: E501
        if include_optional:
            return TrackerStatusOneOf1(
                error = ''
            )
        else:
            return TrackerStatusOneOf1(
    ...
    def testTrackerStatusOneOf1(self):
        """Test TrackerStatusOneOf1"""
