...
class TestGetLocks200Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetLocks200Response:
        """Test GetLocks200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLocks200Response`
        """
        model = GetLocks200Response()  # noqa: E501
        if include_optional:
    ...
    def testGetLocks200Response(self):
        """Test GetLocks200Response"""
