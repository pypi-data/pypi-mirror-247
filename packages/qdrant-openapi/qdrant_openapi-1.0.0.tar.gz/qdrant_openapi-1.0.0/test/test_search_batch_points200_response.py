...
class TestSearchBatchPoints200Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SearchBatchPoints200Response:
        """Test SearchBatchPoints200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchBatchPoints200Response`
        """
        model = SearchBatchPoints200Response()  # noqa: E501
        if include_optional:
            return SearchBatchPoints200Response(
                time = 1.337,
                status = '',
                result = [
                    [
    ...
    def testSearchBatchPoints200Response(self):
        """Test SearchBatchPoints200Response"""
