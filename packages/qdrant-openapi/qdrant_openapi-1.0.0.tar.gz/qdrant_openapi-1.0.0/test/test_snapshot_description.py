...
class TestSnapshotDescription(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SnapshotDescription:
        """Test SnapshotDescription
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SnapshotDescription`
        """
        model = SnapshotDescription()  # noqa: E501
        if include_optional:
    ...
    def testSnapshotDescription(self):
        """Test SnapshotDescription"""
