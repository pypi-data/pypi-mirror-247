...
class TestP2pConfigTelemetry(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> P2pConfigTelemetry:
        """Test P2pConfigTelemetry
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `P2pConfigTelemetry`
        """
        model = P2pConfigTelemetry()  # noqa: E501
        if include_optional:
            return P2pConfigTelemetry(
    ...
    def testP2pConfigTelemetry(self):
        """Test P2pConfigTelemetry"""
