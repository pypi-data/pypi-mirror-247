...
class TestVectorStruct(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> VectorStruct:
        """Test VectorStruct
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VectorStruct`
        """
        model = VectorStruct()  # noqa: E501
        if include_optional:
            return VectorStruct(
            )
        else:
