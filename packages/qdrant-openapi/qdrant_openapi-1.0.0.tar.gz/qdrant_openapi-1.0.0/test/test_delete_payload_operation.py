...
class TestDeletePayloadOperation(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DeletePayloadOperation:
        """Test DeletePayloadOperation
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeletePayloadOperation`
        """
    ...
    def testDeletePayloadOperation(self):
        """Test DeletePayloadOperation"""
