...
class TestCollectionClusterInfo(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CollectionClusterInfo:
        """Test CollectionClusterInfo
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionClusterInfo`
        """
        model = CollectionClusterInfo()  # noqa: E501
        if include_optional:
    ...
    def testCollectionClusterInfo(self):
        """Test CollectionClusterInfo"""
