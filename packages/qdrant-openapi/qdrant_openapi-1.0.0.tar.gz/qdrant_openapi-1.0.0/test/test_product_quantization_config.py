...
class TestProductQuantizationConfig(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ProductQuantizationConfig:
        """Test ProductQuantizationConfig
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProductQuantizationConfig`
        """
        model = ProductQuantizationConfig()  # noqa: E501
        if include_optional:
            return ProductQuantizationConfig(
                compression = 'x4',
                always_ram = True
            )
        else:
    ...
    def testProductQuantizationConfig(self):
        """Test ProductQuantizationConfig"""
