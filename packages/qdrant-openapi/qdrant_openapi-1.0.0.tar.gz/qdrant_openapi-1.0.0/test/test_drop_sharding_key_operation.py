...
class TestDropShardingKeyOperation(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DropShardingKeyOperation:
        """Test DropShardingKeyOperation
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DropShardingKeyOperation`
        """
    ...
    def testDropShardingKeyOperation(self):
        """Test DropShardingKeyOperation"""
