...
class TestGetPoints200Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetPoints200Response:
        """Test GetPoints200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPoints200Response`
        """
        model = GetPoints200Response()  # noqa: E501
        if include_optional:
            return GetPoints200Response(
                time = 1.337,
                status = '',
                result = [
    ...
    def testGetPoints200Response(self):
        """Test GetPoints200Response"""
