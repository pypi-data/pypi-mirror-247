...
class TestCountResult(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CountResult:
        """Test CountResult
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CountResult`
        """
        model = CountResult()  # noqa: E501
        if include_optional:
            return CountResult(
                count = 0
            )
