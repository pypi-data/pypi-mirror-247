...
class TestProductQuantization(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ProductQuantization:
        """Test ProductQuantization
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProductQuantization`
        """
    ...
    def testProductQuantization(self):
        """Test ProductQuantization"""
