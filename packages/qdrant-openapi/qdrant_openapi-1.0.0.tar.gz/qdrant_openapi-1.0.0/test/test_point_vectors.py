...
class TestPointVectors(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PointVectors:
        """Test PointVectors
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PointVectors`
        """
        model = PointVectors()  # noqa: E501
        if include_optional:
            return PointVectors(
                id = None,
                vector = None
