...
class TestShardTransferInfo(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ShardTransferInfo:
        """Test ShardTransferInfo
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShardTransferInfo`
        """
        model = ShardTransferInfo()  # noqa: E501
        if include_optional:
    ...
    def testShardTransferInfo(self):
        """Test ShardTransferInfo"""
