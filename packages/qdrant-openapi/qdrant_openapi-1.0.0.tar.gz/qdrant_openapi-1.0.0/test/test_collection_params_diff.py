...
class TestCollectionParamsDiff(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CollectionParamsDiff:
        """Test CollectionParamsDiff
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionParamsDiff`
        """
        model = CollectionParamsDiff()  # noqa: E501
        if include_optional:
    ...
    def testCollectionParamsDiff(self):
        """Test CollectionParamsDiff"""
