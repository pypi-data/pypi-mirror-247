...
class TestShardSnapshotLocation(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ShardSnapshotLocation:
        """Test ShardSnapshotLocation
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShardSnapshotLocation`
        """
        model = ShardSnapshotLocation()  # noqa: E501
        if include_optional:
            return ShardSnapshotLocation(
            )
        else:
            return ShardSnapshotLocation(
        )
    ...
    def testShardSnapshotLocation(self):
        """Test ShardSnapshotLocation"""
