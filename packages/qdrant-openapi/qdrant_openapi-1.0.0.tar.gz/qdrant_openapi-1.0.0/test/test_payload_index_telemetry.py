...
class TestPayloadIndexTelemetry(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PayloadIndexTelemetry:
        """Test PayloadIndexTelemetry
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PayloadIndexTelemetry`
        """
        model = PayloadIndexTelemetry()  # noqa: E501
        if include_optional:
    ...
    def testPayloadIndexTelemetry(self):
        """Test PayloadIndexTelemetry"""
