...
class TestNamedSparseVector(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NamedSparseVector:
        """Test NamedSparseVector
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NamedSparseVector`
        """
        model = NamedSparseVector()  # noqa: E501
        if include_optional:
    ...
    def testNamedSparseVector(self):
        """Test NamedSparseVector"""
