...
class TestOptimizerTelemetry(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> OptimizerTelemetry:
        """Test OptimizerTelemetry
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OptimizerTelemetry`
        """
        model = OptimizerTelemetry()  # noqa: E501
        if include_optional:
    ...
    def testOptimizerTelemetry(self):
        """Test OptimizerTelemetry"""
