...
class TestWalConfigDiff(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> WalConfigDiff:
        """Test WalConfigDiff
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WalConfigDiff`
        """
        model = WalConfigDiff()  # noqa: E501
        if include_optional:
