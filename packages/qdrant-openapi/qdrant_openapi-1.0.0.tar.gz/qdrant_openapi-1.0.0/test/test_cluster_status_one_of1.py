...
class TestClusterStatusOneOf1(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ClusterStatusOneOf1:
        """Test ClusterStatusOneOf1
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClusterStatusOneOf1`
        """
        model = ClusterStatusOneOf1()  # noqa: E501
        if include_optional:
            return ClusterStatusOneOf1(
                status = 'enabled',
                peer_id = 0,
                peers = {
    ...
    def testClusterStatusOneOf1(self):
        """Test ClusterStatusOneOf1"""
