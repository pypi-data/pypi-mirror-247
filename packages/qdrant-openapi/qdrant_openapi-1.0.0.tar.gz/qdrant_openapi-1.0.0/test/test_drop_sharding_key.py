...
class TestDropShardingKey(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DropShardingKey:
        """Test DropShardingKey
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DropShardingKey`
        """
        model = DropShardingKey()  # noqa: E501
        if include_optional:
            return DropShardingKey(
                shard_key = None
            )
        else:
            return DropShardingKey(
