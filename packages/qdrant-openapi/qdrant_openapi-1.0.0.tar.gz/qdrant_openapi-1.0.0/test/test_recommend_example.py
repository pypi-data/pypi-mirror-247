...
class TestRecommendExample(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> RecommendExample:
        """Test RecommendExample
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RecommendExample`
        """
        model = RecommendExample()  # noqa: E501
        if include_optional:
            return RecommendExample(
                indices = [
                    0
                    ],
                values = [
