...
class TestCollectionTelemetry(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CollectionTelemetry:
        """Test CollectionTelemetry
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionTelemetry`
        """
        model = CollectionTelemetry()  # noqa: E501
        if include_optional:
    ...
    def testCollectionTelemetry(self):
        """Test CollectionTelemetry"""
