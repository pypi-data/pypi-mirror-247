...
class TestLocksOption(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> LocksOption:
        """Test LocksOption
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LocksOption`
        """
        model = LocksOption()  # noqa: E501
        if include_optional:
            return LocksOption(
                error_message = '',
                write = True
