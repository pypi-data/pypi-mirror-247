...
class TestRemoteShardTelemetry(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> RemoteShardTelemetry:
        """Test RemoteShardTelemetry
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RemoteShardTelemetry`
        """
        model = RemoteShardTelemetry()  # noqa: E501
        if include_optional:
    ...
    def testRemoteShardTelemetry(self):
        """Test RemoteShardTelemetry"""
