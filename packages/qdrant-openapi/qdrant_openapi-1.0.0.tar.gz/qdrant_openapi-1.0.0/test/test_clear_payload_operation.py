...
class TestClearPayloadOperation(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ClearPayloadOperation:
        """Test ClearPayloadOperation
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClearPayloadOperation`
        """
        model = ClearPayloadOperation()  # noqa: E501
        if include_optional:
            return ClearPayloadOperation(
                clear_payload = None
            )
        else:
            return ClearPayloadOperation(
    ...
    def testClearPayloadOperation(self):
        """Test ClearPayloadOperation"""
