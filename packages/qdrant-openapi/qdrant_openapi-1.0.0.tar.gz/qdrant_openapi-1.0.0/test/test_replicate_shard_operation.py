...
class TestReplicateShardOperation(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ReplicateShardOperation:
        """Test ReplicateShardOperation
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReplicateShardOperation`
        """
    ...
    def testReplicateShardOperation(self):
        """Test ReplicateShardOperation"""
