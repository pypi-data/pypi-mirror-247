...
class TestAppFeaturesTelemetry(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AppFeaturesTelemetry:
        """Test AppFeaturesTelemetry
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppFeaturesTelemetry`
        """
        model = AppFeaturesTelemetry()  # noqa: E501
        if include_optional:
            return AppFeaturesTelemetry(
                debug = True,
                web_feature = True,
    ...
    def testAppFeaturesTelemetry(self):
        """Test AppFeaturesTelemetry"""
