...
class TestClusterStatus200Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ClusterStatus200Response:
        """Test ClusterStatus200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClusterStatus200Response`
        """
        model = ClusterStatus200Response()  # noqa: E501
        if include_optional:
            return ClusterStatus200Response(
                time = 1.337,
                status = '',
                result = None
            )
    ...
    def testClusterStatus200Response(self):
        """Test ClusterStatus200Response"""
