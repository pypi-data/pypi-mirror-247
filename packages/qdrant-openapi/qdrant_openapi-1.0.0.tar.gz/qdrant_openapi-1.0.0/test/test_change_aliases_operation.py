...
class TestChangeAliasesOperation(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ChangeAliasesOperation:
        """Test ChangeAliasesOperation
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChangeAliasesOperation`
        """
        model = ChangeAliasesOperation()  # noqa: E501
        if include_optional:
            return ChangeAliasesOperation(
                actions = [
                    null
                    ]
            )
    ...
    def testChangeAliasesOperation(self):
        """Test ChangeAliasesOperation"""
