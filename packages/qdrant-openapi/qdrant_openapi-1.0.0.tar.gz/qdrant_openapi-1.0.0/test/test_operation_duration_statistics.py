...
class TestOperationDurationStatistics(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> OperationDurationStatistics:
        """Test OperationDurationStatistics
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OperationDurationStatistics`
        """
        model = OperationDurationStatistics()  # noqa: E501
        if include_optional:
            return OperationDurationStatistics(
                count = 0,
                fail_count = 0,
    ...
    def testOperationDurationStatistics(self):
        """Test OperationDurationStatistics"""
