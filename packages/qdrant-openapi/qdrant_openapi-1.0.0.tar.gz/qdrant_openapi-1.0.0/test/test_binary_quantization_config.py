...
class TestBinaryQuantizationConfig(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> BinaryQuantizationConfig:
        """Test BinaryQuantizationConfig
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BinaryQuantizationConfig`
        """
        model = BinaryQuantizationConfig()  # noqa: E501
        if include_optional:
            return BinaryQuantizationConfig(
                always_ram = True
            )
        else:
            return BinaryQuantizationConfig(
    ...
    def testBinaryQuantizationConfig(self):
        """Test BinaryQuantizationConfig"""
