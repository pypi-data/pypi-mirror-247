...
class TestRemoteShardInfo(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> RemoteShardInfo:
        """Test RemoteShardInfo
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RemoteShardInfo`
        """
        model = RemoteShardInfo()  # noqa: E501
        if include_optional:
