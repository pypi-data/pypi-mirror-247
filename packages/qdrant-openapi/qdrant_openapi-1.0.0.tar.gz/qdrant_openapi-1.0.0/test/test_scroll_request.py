...
class TestScrollRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ScrollRequest:
        """Test ScrollRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ScrollRequest`
        """
        model = ScrollRequest()  # noqa: E501
        if include_optional:
