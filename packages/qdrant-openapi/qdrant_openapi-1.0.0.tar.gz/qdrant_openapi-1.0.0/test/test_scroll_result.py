...
class TestScrollResult(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ScrollResult:
        """Test ScrollResult
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ScrollResult`
        """
        model = ScrollResult()  # noqa: E501
        if include_optional:
            return ScrollResult(
                points = [
