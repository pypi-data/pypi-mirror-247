...
class TestSetPayload(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SetPayload:
        """Test SetPayload
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SetPayload`
        """
        model = SetPayload()  # noqa: E501
        if include_optional:
            return SetPayload(
                payload = { },
                points = [
