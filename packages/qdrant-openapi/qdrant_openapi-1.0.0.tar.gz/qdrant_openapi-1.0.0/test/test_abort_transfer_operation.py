...
class TestAbortTransferOperation(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AbortTransferOperation:
        """Test AbortTransferOperation
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AbortTransferOperation`
        """
    ...
    def testAbortTransferOperation(self):
        """Test AbortTransferOperation"""
