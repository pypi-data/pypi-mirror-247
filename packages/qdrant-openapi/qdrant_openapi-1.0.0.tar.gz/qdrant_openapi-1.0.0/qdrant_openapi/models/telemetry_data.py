...
class TelemetryData(BaseModel):
    ...
    """
    id: StrictStr = Field(...)
    app: AppBuildTelemetry = Field(...)
    collections: CollectionsTelemetry = Field(...)
    cluster: ClusterTelemetry = Field(...)
    requests: RequestsTelemetry = Field(...)
    __properties = ["id", "app", "collections", "cluster", "requests"]
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TelemetryData:
        """Create an instance of TelemetryData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TelemetryData.parse_obj(obj)

        _obj = TelemetryData.parse_obj({
            "id": obj.get("id"),
            "app": AppBuildTelemetry.from_dict(obj.get("app")) if obj.get("app") is not None else None,
            "collections": CollectionsTelemetry.from_dict(obj.get("collections")) if obj.get("collections") is not None else None,
            "cluster": ClusterTelemetry.from_dict(obj.get("cluster")) if obj.get("cluster") is not None else None,
            "requests": RequestsTelemetry.from_dict(obj.get("requests")) if obj.get("requests") is not None else None
        })
        return _obj
