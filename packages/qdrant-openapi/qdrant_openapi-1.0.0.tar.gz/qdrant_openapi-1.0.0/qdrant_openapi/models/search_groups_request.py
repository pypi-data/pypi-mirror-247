...
class SearchGroupsRequest(BaseModel):
    ...
    __properties = ["shard_key", "vector", "filter", "params", "with_payload", "with_vector", "score_threshold", "group_by", "group_size", "limit", "with_lookup"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SearchGroupsRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SearchGroupsRequest:
        """Create an instance of SearchGroupsRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SearchGroupsRequest.parse_obj(obj)

        _obj = SearchGroupsRequest.parse_obj({
