...
class CreateAlias(BaseModel):
    """
    Create alternative name for a collection. Collection will be available under both names for search, retrieve,  # noqa: E501
    """
    collection_name: StrictStr = Field(...)
    alias_name: StrictStr = Field(...)
    __properties = ["collection_name", "alias_name"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateAlias:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateAlias:
        """Create an instance of CreateAlias from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateAlias.parse_obj(obj)

        _obj = CreateAlias.parse_obj({
