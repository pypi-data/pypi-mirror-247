...
class SnapshotRecover(BaseModel):
    ...
    SnapshotRecover
    """
    location: StrictStr = Field(..., description="Examples: - URL `http://localhost:8080/collections/my_collection/snapshots/my_snapshot` - Local path `file:///qdrant/snapshots/test_collection-2022-08-04-10-49-10.snapshot`")
    priority: Optional[SnapshotPriority] = None
    __properties = ["location", "priority"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SnapshotRecover:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SnapshotRecover:
        """Create an instance of SnapshotRecover from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SnapshotRecover.parse_obj(obj)

        _obj = SnapshotRecover.parse_obj({
