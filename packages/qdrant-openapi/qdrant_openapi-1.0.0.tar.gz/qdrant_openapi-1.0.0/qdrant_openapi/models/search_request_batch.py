...
class SearchRequestBatch(BaseModel):
    ...
    SearchRequestBatch
    """
    searches: conlist(SearchRequest) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SearchRequestBatch:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SearchRequestBatch:
        """Create an instance of SearchRequestBatch from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SearchRequestBatch.parse_obj(obj)

        _obj = SearchRequestBatch.parse_obj({
            "searches": [SearchRequest.from_dict(_item) for _item in obj.get("searches")] if obj.get("searches") is not None else None
        })
        return _obj
