...
class PointsBatch(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PointsBatch:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PointsBatch:
        """Create an instance of PointsBatch from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PointsBatch.parse_obj(obj)

        _obj = PointsBatch.parse_obj({
            "batch": Batch.from_dict(obj.get("batch")) if obj.get("batch") is not None else None,
