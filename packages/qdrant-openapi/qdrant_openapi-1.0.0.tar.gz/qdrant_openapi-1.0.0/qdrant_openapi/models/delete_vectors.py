...
class DeleteVectors(BaseModel):
    ...
    vector: conlist(StrictStr, min_items=1, unique_items=True) = Field(..., description="Vector names")
    shard_key: Optional[ShardKeySelector] = None
    __properties = ["points", "filter", "vector", "shard_key"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeleteVectors:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeleteVectors:
        """Create an instance of DeleteVectors from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeleteVectors.parse_obj(obj)

        _obj = DeleteVectors.parse_obj({
