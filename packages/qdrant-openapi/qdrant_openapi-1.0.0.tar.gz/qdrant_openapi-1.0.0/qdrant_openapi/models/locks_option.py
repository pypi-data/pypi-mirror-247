...
class LocksOption(BaseModel):
    ...
    __properties = ["error_message", "write"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LocksOption:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LocksOption:
        """Create an instance of LocksOption from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LocksOption.parse_obj(obj)

        _obj = LocksOption.parse_obj({
