...
class UpsertOperation(BaseModel):
    ...
    UpsertOperation
    """
    upsert: PointInsertOperations = Field(...)
    __properties = ["upsert"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpsertOperation:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpsertOperation:
        """Create an instance of UpsertOperation from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpsertOperation.parse_obj(obj)

        _obj = UpsertOperation.parse_obj({
            "upsert": PointInsertOperations.from_dict(obj.get("upsert")) if obj.get("upsert") is not None else None
        })
        return _obj
