...
class PayloadField(BaseModel):
    """
    Payload field  # noqa: E501
    """
    key: StrictStr = Field(..., description="Payload field name")
    __properties = ["key"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PayloadField:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PayloadField:
        """Create an instance of PayloadField from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PayloadField.parse_obj(obj)

        _obj = PayloadField.parse_obj({
            "key": obj.get("key")
        })
        return _obj
