...
class UpdateVectors(BaseModel):
    ...
    UpdateVectors
    """
    points: conlist(PointVectors, min_items=1) = Field(..., description="Points with named vectors")
    shard_key: Optional[ShardKeySelector] = None
    __properties = ["points", "shard_key"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateVectors:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateVectors:
        """Create an instance of UpdateVectors from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateVectors.parse_obj(obj)

        _obj = UpdateVectors.parse_obj({
            "points": [PointVectors.from_dict(_item) for _item in obj.get("points")] if obj.get("points") is not None else None,
