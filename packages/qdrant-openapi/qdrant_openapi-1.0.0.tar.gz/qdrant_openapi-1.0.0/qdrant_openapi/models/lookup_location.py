...
class LookupLocation(BaseModel):
    """
    Defines a location to use for looking up the vector. Specifies collection and vector field name.  # noqa: E501
    """
    collection: StrictStr = Field(..., description="Name of the collection used for lookup")
    vector: Optional[StrictStr] = Field(None, description="Optional name of the vector field within the collection. If not provided, the default vector field will be used.")
    shard_key: Optional[ShardKeySelector] = None
    __properties = ["collection", "vector", "shard_key"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LookupLocation:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LookupLocation:
        """Create an instance of LookupLocation from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LookupLocation.parse_obj(obj)

        _obj = LookupLocation.parse_obj({
