...
class UpdateOperations(BaseModel):
    ...
    UpdateOperations
    """
    operations: conlist(UpdateOperation) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateOperations:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateOperations:
        """Create an instance of UpdateOperations from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateOperations.parse_obj(obj)

        _obj = UpdateOperations.parse_obj({
            "operations": [UpdateOperation.from_dict(_item) for _item in obj.get("operations")] if obj.get("operations") is not None else None
        })
        return _obj
