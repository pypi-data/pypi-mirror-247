...
class MoveShard(BaseModel):
    ...
    to_peer_id: conint(strict=True, ge=0) = Field(...)
    from_peer_id: conint(strict=True, ge=0) = Field(...)
    method: Optional[ShardTransferMethod] = None
    __properties = ["shard_id", "to_peer_id", "from_peer_id", "method"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MoveShard:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MoveShard:
        """Create an instance of MoveShard from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MoveShard.parse_obj(obj)

        _obj = MoveShard.parse_obj({
            "shard_id": obj.get("shard_id"),
            "to_peer_id": obj.get("to_peer_id"),
            "from_peer_id": obj.get("from_peer_id"),
