...
class PointVectors(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PointVectors:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PointVectors:
        """Create an instance of PointVectors from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PointVectors.parse_obj(obj)

        _obj = PointVectors.parse_obj({
