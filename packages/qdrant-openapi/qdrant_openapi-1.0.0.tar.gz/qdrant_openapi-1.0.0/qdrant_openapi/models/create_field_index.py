...
class CreateFieldIndex(BaseModel):
    ...
    __properties = ["field_name", "field_schema"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateFieldIndex:
    ...
    def to_dict(self):
        ...
        if self.field_schema is None and "field_schema" in self.__fields_set__:
            _dict['field_schema'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> CreateFieldIndex:
        """Create an instance of CreateFieldIndex from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateFieldIndex.parse_obj(obj)

        _obj = CreateFieldIndex.parse_obj({
            "field_name": obj.get("field_name"),
            "field_schema": PayloadFieldSchema.from_dict(obj.get("field_schema")) if obj.get("field_schema") is not None else None
        })
        return _obj
