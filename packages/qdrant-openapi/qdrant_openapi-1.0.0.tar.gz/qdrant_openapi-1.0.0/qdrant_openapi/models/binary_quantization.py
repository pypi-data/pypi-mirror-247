...
class BinaryQuantization(BaseModel):
    ...
    BinaryQuantization
    """
    binary: BinaryQuantizationConfig = Field(...)
    __properties = ["binary"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BinaryQuantization:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BinaryQuantization:
        """Create an instance of BinaryQuantization from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BinaryQuantization.parse_obj(obj)

        _obj = BinaryQuantization.parse_obj({
            "binary": BinaryQuantizationConfig.from_dict(obj.get("binary")) if obj.get("binary") is not None else None
        })
        return _obj
