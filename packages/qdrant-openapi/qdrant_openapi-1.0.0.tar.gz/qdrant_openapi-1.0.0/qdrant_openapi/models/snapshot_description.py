...
class SnapshotDescription(BaseModel):
    ...
    size: conint(strict=True, ge=0) = Field(...)
    __properties = ["name", "creation_time", "size"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SnapshotDescription:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SnapshotDescription:
        """Create an instance of SnapshotDescription from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SnapshotDescription.parse_obj(obj)

        _obj = SnapshotDescription.parse_obj({
            "name": obj.get("name"),
