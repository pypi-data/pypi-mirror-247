...
class DeleteOperation(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeleteOperation:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeleteOperation:
        """Create an instance of DeleteOperation from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeleteOperation.parse_obj(obj)

        _obj = DeleteOperation.parse_obj({
            "delete": PointsSelector.from_dict(obj.get("delete")) if obj.get("delete") is not None else None
        })
        return _obj
