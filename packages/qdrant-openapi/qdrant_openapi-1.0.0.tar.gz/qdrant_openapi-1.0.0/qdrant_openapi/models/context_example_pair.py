...
class ContextExamplePair(BaseModel):
    ...
    ContextExamplePair
    """
    positive: RecommendExample = Field(...)
    negative: RecommendExample = Field(...)
    __properties = ["positive", "negative"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ContextExamplePair:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ContextExamplePair:
        """Create an instance of ContextExamplePair from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ContextExamplePair.parse_obj(obj)

        _obj = ContextExamplePair.parse_obj({
            "positive": RecommendExample.from_dict(obj.get("positive")) if obj.get("positive") is not None else None,
            "negative": RecommendExample.from_dict(obj.get("negative")) if obj.get("negative") is not None else None
        })
        return _obj
