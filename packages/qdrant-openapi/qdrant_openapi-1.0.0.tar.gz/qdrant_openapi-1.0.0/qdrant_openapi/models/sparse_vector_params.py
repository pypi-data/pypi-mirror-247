...
class SparseVectorParams(BaseModel):
    """
    Params of single sparse vector data storage  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SparseVectorParams:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SparseVectorParams:
        """Create an instance of SparseVectorParams from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SparseVectorParams.parse_obj(obj)

        _obj = SparseVectorParams.parse_obj({
            "index": SparseIndexParams.from_dict(obj.get("index")) if obj.get("index") is not None else None
        })
        return _obj
