...
class ClusterStatusTelemetry(BaseModel):
    ...
    """
    number_of_peers: conint(strict=True, ge=0) = Field(...)
    term: conint(strict=True, ge=0) = Field(...)
    commit: conint(strict=True, ge=0) = Field(...)
    pending_operations: conint(strict=True, ge=0) = Field(...)
    role: Optional[StateRole] = None
    is_voter: StrictBool = Field(...)
    peer_id: Optional[conint(strict=True, ge=0)] = None
    consensus_thread_status: ConsensusThreadStatus = Field(...)
    __properties = ["number_of_peers", "term", "commit", "pending_operations", "role", "is_voter", "peer_id", "consensus_thread_status"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClusterStatusTelemetry:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClusterStatusTelemetry:
        """Create an instance of ClusterStatusTelemetry from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClusterStatusTelemetry.parse_obj(obj)

        _obj = ClusterStatusTelemetry.parse_obj({
            "number_of_peers": obj.get("number_of_peers"),
            "term": obj.get("term"),
