...
class CollectionConfig(BaseModel):
    ...
    optimizer_config: OptimizersConfig = Field(...)
    wal_config: WalConfig = Field(...)
    quantization_config: Optional[QuantizationConfig] = None
    __properties = ["params", "hnsw_config", "optimizer_config", "wal_config", "quantization_config"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CollectionConfig:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CollectionConfig:
        """Create an instance of CollectionConfig from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CollectionConfig.parse_obj(obj)

        _obj = CollectionConfig.parse_obj({
            "params": CollectionParams.from_dict(obj.get("params")) if obj.get("params") is not None else None,
            "hnsw_config": HnswConfig.from_dict(obj.get("hnsw_config")) if obj.get("hnsw_config") is not None else None,
            "optimizer_config": OptimizersConfig.from_dict(obj.get("optimizer_config")) if obj.get("optimizer_config") is not None else None,
            "wal_config": WalConfig.from_dict(obj.get("wal_config")) if obj.get("wal_config") is not None else None,
