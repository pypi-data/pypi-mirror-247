...
class RemoteShardInfo(BaseModel):
    ...
    RemoteShardInfo
    """
    shard_id: conint(strict=True, ge=0) = Field(..., description="Remote shard id")
    shard_key: Optional[ShardKey] = None
    peer_id: conint(strict=True, ge=0) = Field(..., description="Remote peer id")
    state: ReplicaState = Field(...)
    __properties = ["shard_id", "shard_key", "peer_id", "state"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RemoteShardInfo:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RemoteShardInfo:
        """Create an instance of RemoteShardInfo from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RemoteShardInfo.parse_obj(obj)

        _obj = RemoteShardInfo.parse_obj({
