...
class PayloadStorageTypeOneOf1(BaseModel):
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('on_disk'):
            raise ValueError("must be one of enum values ('on_disk')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PayloadStorageTypeOneOf1:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PayloadStorageTypeOneOf1:
        """Create an instance of PayloadStorageTypeOneOf1 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PayloadStorageTypeOneOf1.parse_obj(obj)

        _obj = PayloadStorageTypeOneOf1.parse_obj({
            "type": obj.get("type")
        })
        return _obj
