...
class SparseVectorDataConfig(BaseModel):
    """
    Config of single sparse vector data storage  # noqa: E501
    """
    index: SparseIndexConfig = Field(...)
    __properties = ["index"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SparseVectorDataConfig:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SparseVectorDataConfig:
        """Create an instance of SparseVectorDataConfig from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SparseVectorDataConfig.parse_obj(obj)

        _obj = SparseVectorDataConfig.parse_obj({
            "index": SparseIndexConfig.from_dict(obj.get("index")) if obj.get("index") is not None else None
        })
        return _obj
