...
class PointIdsList(BaseModel):
    ...
    PointIdsList
    """
    points: conlist(ExtendedPointId) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PointIdsList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PointIdsList:
        """Create an instance of PointIdsList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PointIdsList.parse_obj(obj)

        _obj = PointIdsList.parse_obj({
