...
class CollectionDescription(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CollectionDescription:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CollectionDescription:
        """Create an instance of CollectionDescription from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CollectionDescription.parse_obj(obj)

        _obj = CollectionDescription.parse_obj({
            "name": obj.get("name")
        })
        return _obj
