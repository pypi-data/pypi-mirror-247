...
class NestedCondition(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NestedCondition:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NestedCondition:
        """Create an instance of NestedCondition from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NestedCondition.parse_obj(obj)

        _obj = NestedCondition.parse_obj({
            "nested": Nested.from_dict(obj.get("nested")) if obj.get("nested") is not None else None
        })
        return _obj

from qdrant_openapi.models.nested import Nested
NestedCondition.update_forward_refs()
