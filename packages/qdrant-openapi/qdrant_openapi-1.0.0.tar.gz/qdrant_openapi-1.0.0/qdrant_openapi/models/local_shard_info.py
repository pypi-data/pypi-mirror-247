...
class LocalShardInfo(BaseModel):
    ...
    LocalShardInfo
    """
    shard_id: conint(strict=True, ge=0) = Field(..., description="Local shard id")
    shard_key: Optional[ShardKey] = None
    points_count: conint(strict=True, ge=0) = Field(..., description="Number of points in the shard")
    state: ReplicaState = Field(...)
    __properties = ["shard_id", "shard_key", "points_count", "state"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LocalShardInfo:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LocalShardInfo:
        """Create an instance of LocalShardInfo from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LocalShardInfo.parse_obj(obj)

        _obj = LocalShardInfo.parse_obj({
