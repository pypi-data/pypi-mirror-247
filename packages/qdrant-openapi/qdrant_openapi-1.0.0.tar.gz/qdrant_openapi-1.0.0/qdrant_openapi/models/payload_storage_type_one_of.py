...
class PayloadStorageTypeOneOf(BaseModel):
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('in_memory'):
            raise ValueError("must be one of enum values ('in_memory')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PayloadStorageTypeOneOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PayloadStorageTypeOneOf:
        """Create an instance of PayloadStorageTypeOneOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PayloadStorageTypeOneOf.parse_obj(obj)

        _obj = PayloadStorageTypeOneOf.parse_obj({
            "type": obj.get("type")
        })
        return _obj
