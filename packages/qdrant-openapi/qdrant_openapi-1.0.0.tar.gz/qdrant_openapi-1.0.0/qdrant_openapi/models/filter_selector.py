...
class FilterSelector(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FilterSelector:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FilterSelector:
        """Create an instance of FilterSelector from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FilterSelector.parse_obj(obj)

        _obj = FilterSelector.parse_obj({
