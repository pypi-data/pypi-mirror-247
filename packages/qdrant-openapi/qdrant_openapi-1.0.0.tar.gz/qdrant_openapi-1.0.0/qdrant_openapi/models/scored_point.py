...
class ScoredPoint(BaseModel):
    """
    Search result  # noqa: E501
    """
    id: ExtendedPointId = Field(...)
    version: conint(strict=True, ge=0) = Field(..., description="Point version")
    score: Union[StrictFloat, StrictInt] = Field(..., description="Points vector distance to the query vector")
    payload: Optional[Dict[str, Any]] = None
    vector: Optional[VectorStruct] = None
    shard_key: Optional[ShardKey] = None
    __properties = ["id", "version", "score", "payload", "vector", "shard_key"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ScoredPoint:
    ...
    def to_dict(self):
        ...
        if self.vector is None and "vector" in self.__fields_set__:
            _dict['vector'] = None
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ScoredPoint:
        """Create an instance of ScoredPoint from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ScoredPoint.parse_obj(obj)

        _obj = ScoredPoint.parse_obj({
            "id": ExtendedPointId.from_dict(obj.get("id")) if obj.get("id") is not None else None,
            "version": obj.get("version"),
            "score": obj.get("score"),
            "payload": obj.get("payload"),
            "vector": VectorStruct.from_dict(obj.get("vector")) if obj.get("vector") is not None else None,
