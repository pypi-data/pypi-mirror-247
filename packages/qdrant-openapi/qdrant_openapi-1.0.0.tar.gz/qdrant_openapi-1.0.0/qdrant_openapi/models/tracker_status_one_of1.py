...
class TrackerStatusOneOf1(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TrackerStatusOneOf1:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TrackerStatusOneOf1:
        """Create an instance of TrackerStatusOneOf1 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TrackerStatusOneOf1.parse_obj(obj)

        _obj = TrackerStatusOneOf1.parse_obj({
            "error": obj.get("error")
        })
        return _obj
