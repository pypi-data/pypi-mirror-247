...
class DropShardingKey(BaseModel):
    """
    DropShardingKey
    """
    shard_key: ShardKey = Field(...)
    __properties = ["shard_key"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DropShardingKey:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DropShardingKey:
        """Create an instance of DropShardingKey from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DropShardingKey.parse_obj(obj)

        _obj = DropShardingKey.parse_obj({
