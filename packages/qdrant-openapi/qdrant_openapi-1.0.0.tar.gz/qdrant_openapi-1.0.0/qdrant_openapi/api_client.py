...
import qdrant_openapi.models
from qdrant_openapi import rest
from qdrant_openapi.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(qdrant_openapi.models, klass)
