...
"""
    ...
    OpenAPI spec version: 60.4.1-v202312202111
...
class ConditionMonitorNotificationConfigurationInputV1(object):
    ...
    def __init__(self, bcc_email_recipients=None, capsule_grouping=None, capsule_properties=None, cc_email_recipients=None, context_url=None, timezone=None, to_email_recipients=None):
        """
    ...
    def bcc_email_recipients(self):
        ...
        Email addresses or Seeq User IDs that will be in the Bcc list of the email
    ...
    def cc_email_recipients(self):
        ...
        Email addresses or Seeq User IDs that will be in the Cc list of the email
    ...
    def context_url(self):
        """
        Gets the context_url of this ConditionMonitorNotificationConfigurationInputV1.
        A URL that will be inserted into the notification to provide additional context, such as a URL to a worksheet

        :return: The context_url of this ConditionMonitorNotificationConfigurationInputV1.
        :rtype: str
        """
    ...
    def context_url(self, context_url):
        """
        Sets the context_url of this ConditionMonitorNotificationConfigurationInputV1.
        A URL that will be inserted into the notification to provide additional context, such as a URL to a worksheet

        :param context_url: The context_url of this ConditionMonitorNotificationConfigurationInputV1.
        :type: str
        """
    ...
    def to_email_recipients(self):
        ...
        Email addresses or Seeq User IDs that will be in the To list of the email
