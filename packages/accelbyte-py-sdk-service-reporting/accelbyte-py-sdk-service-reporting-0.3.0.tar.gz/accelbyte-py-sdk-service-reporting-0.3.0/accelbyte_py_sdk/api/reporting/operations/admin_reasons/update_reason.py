...
class UpdateReason(Operation):
    ...
    def with_body(self, value: RestapiCreateReasonRequest) -> UpdateReason:
        self.body = value
        return self

    def with_namespace(self, value: str) -> UpdateReason:
        self.namespace = value
        return self

    def with_reason_id(self, value: str) -> UpdateReason:
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> UpdateReason:
        instance = cls()
