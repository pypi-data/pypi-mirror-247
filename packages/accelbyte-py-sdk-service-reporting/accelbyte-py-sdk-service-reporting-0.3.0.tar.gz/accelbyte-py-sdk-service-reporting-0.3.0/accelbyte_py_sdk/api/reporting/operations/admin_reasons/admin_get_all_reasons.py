...
class AdminGetAllReasons(Operation):
    ...
    def with_namespace(self, value: str) -> AdminGetAllReasons:
    ...
    def parse_response(
        ...
        Union[None, RestapiAdminAllReasonsResponse],
        ...
        if code == 200:
            return RestapiAdminAllReasonsResponse.create_from_dict(content), None
        if code == 500:
