...
class GenericCRUDML:
    ...
    def __init__(self, schema_name: str, default_table_name: str = None,
        ...
        self.connection = connection or Connector.connect(schema_name=schema_name)  # noqa501
    ...
    def insert(self, table_name: str = None, data_json: dict = None,
        ...
        # TODO Add in the begging of the method if ignore_duplicate=TRUE logger.warning("Using ignore_duplicate,  # noqa501
        # is it needed?")
        validate_none_select_table_name(table_name)
        columns, values, data_json = process_insert_data_json(data_json=data_json)  # noqa501
        # We removed the IGNORE from the SQL Statement as we want to return the id of the existing row  # noqa501
        insert_query = "INSERT " + \
        ...
        try:
            ...
            logger.exception(self._log_error_message(message="Error inserting data_json",  # noqa501
                                                     sql_statement=insert_query), object=error)  # noqa501
            logger.end()
            raise
    ...
    def _get_existing_duplicate_id(self, table_name: str,
        ...
        if column_name:
            select_query = f"SELECT * FROM {table_name} WHERE {column_name} = %s"  # noqa501
    ...
    # Old name: update
    # TODO add @dispatch() to all insert and update methods - Usage of Python object oriented method overloading  # noqa501
    # in insert() and update()
    def update_by_id(self, table_name: str = None, id_column_name: str = None,
                     id_column_value: Any = None,
                     data_json: dict = None, limit: int = DEFAULT_LIMIT,
                     order_by: str = "") -> None:
    ...
    def update_by_where(self, table_name: str = None, where: str = None,
        ...
        data_json={"A": A_val, "B": B_val}, where="C=%s AND D=%s",
        params=(C_val, D_val)"""
        logger.start(object={"table_name": table_name,
        ...
        set_values = ', '.join(f"{k}=%s" for k in data_json.keys()) + ("," if data_json else "")  # noqa501
        print("before___")
        print(set_values, data_json)
        set_values, data_json = process_update_data_json(data_json=data_json)
        print("after___")
        print(set_values, data_json)
        if not where:
        ...
        update_query = f"UPDATE {self.schema_name}.{table_name} " \
                       ...
                       f"LIMIT {limit} "  # noqa501
        try:
            params = params or tuple()
            self.cursor.execute(update_query,
                                tuple(data_json.values()) + params)
            self.connection.commit()
            logger.end("Data updated successfully.")
        except Exception as e:
            logger.exception(self._log_error_message(message="Error updating data_json",  # noqa501
                                                     sql_statement=update_query), object=e)  # noqa501
            logger.end()
            raise
    ...
    def delete_by_id(self, table_name: str = None, id_column_name: str = None,
        ...
        if id_column_name:  # id_column_value can be empty
            ...
            message = "Delete by id requires an id_column_name and id_column_value."  # noqa501
            logger.error(message)
            logger.end()
            raise Exception(message)
    ...
    def select_one_dict_by_id(self, view_table_name: str = None,
                              ...
                              id_column_value: Any = None,
                              order_by: str = "") -> dict:
        """Selects one row from the table by ID and returns it as a dictionary (column_name: value)"""  # noqa501
    ...
    def select_one_tuple_by_where(self, view_table_name: str = None,
                                  ...
                                  order_by: str = "") -> tuple:
        """Selects one row from the table based on a WHERE clause and returns it as a tuple."""  # noqa501
    ...
    def select_one_dict_by_where(self, view_table_name: str = None,
                                 ...
                                 where: str = None, params: tuple = None,
                                 order_by: str = "") -> dict:
        """Selects one row from the table based on a WHERE clause and returns it as a dictionary."""  # noqa501
    ...
    def select_multi_tuple_by_id(self, view_table_name: str = None,
        ...
        send `id_column_name=''` if you want to select all rows and ignore default column"""  # noqa501
        id_column_name = id_column_name or self.default_column
    ...
    def select_multi_dict_by_id(
        ...
        """Selects multiple rows from the table by ID and returns them as a list of dictionaries."""  # noqa501
        result = self.select_multi_tuple_by_id(view_table_name,
                                               select_clause_value,
                                               id_column_name, id_column_value,
                                               limit=limit, order_by=order_by)
        return [self._convert_to_dict(row, select_clause_value) for row in result]  # noqa501
    ...
    def select_multi_tuple_by_where(self, view_table_name: str = None,
                                    ...
                                    limit: int = DEFAULT_LIMIT,
                                    order_by: str = "") -> list:
        """Selects multiple rows from the table based on a WHERE clause and returns them as a list of tuples."""  # noqa501
    ...
    def select_multi_dict_by_where(
            ...
            where: str = None, params: tuple = None,
            limit: int = DEFAULT_LIMIT, order_by: str = "") -> list:
        """Selects multiple rows from the table based on a WHERE clause and returns them as a list of dictionaries."""  # noqa501
        result = self.select_multi_tuple_by_where(view_table_name,
                                                  select_clause_value,
                                                  where=where, params=params,
                                                  limit=limit,
    ...
    def select_one_by_where_with_none_option(
        ...
        validate_select_table_name(view_table_name)
        select_query = f"SELECT {select_column_name} " f"FROM {self.schema_name}.{view_table_name} " + (  # noqa501
            f"WHERE {condition_column_name} = {condition_column_value} " if condition_column_name and condition_column_value  # noqa501
    ...
    def select_multi_tuple_by_where_with_none_option(self,
    ...
    def select_multi_dict_by_where_with_none_option(self,
                                                    condition_column_name,
                                                    condition_column_value,
                                                    view_table_name: str = None, select_clause_value: str = "*",  # noqa501
                                                    limit: int = DEFAULT_LIMIT, order_by: str = "") -> list:  # noqa501
        """Selects a column from the table based on a WHERE clause and returns it as a list of dictionaries."""  # noqa501
        result = self.select_multi_tuple_by_where_with_none_option(condition_column_name, condition_column_value,  # noqa501
