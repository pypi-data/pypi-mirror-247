...
DATABASE_MYSQL_PYTHON_GENERIC_CRUD_COMPONENT_NAME = 'circles_local_database_python\\generic_crud'  # noqa501
...
class GenericCRUD:
    ...
    def __init__(self, default_schema_name: str,
        ...
        """Initializes the GenericCRUD class. If connection is not provided, a new connection will be created."""  # noqa501
    ...
    def insert(self, table_name: str = None, data_json: dict = None,
        ...
        """Inserts a new row into the table and returns the id of the new row or -1 if an error occurred."""  # noqa501
    ...
    def _get_existing_duplicate_id(self, table_name: str,
        ...
        if column_name:
            select_query = f"SELECT * FROM {
                table_name} WHERE {column_name} = %s"
