...
class HTSDataPreprocessor:
    ...
    def load_preprocessed_data(self):
        ...
        for dataset_name in self.dataset_names:
            if dataset_name not in self.datasets:
                self.datasets[dataset_name] = self.DatasetContainer(dataset_name)
            self.datasets[dataset_name].training_set = pd.read_csv(path_to_datasets + dataset_name + "/" + dataset_name + "_train.csv")

            self.datasets[dataset_name].validation_set = pd.read_csv(path_to_datasets + dataset_name + "/" + dataset_name + "_val.csv")
