...
from ...pagination import SyncPageCursorSharedRef, AsyncPageCursorSharedRef
from ..._base_client import AsyncPaginator, make_request_options
from ...types.pagination_tests import ref_with_shared_model_ref_params
...
class Refs(SyncAPIResource):
    with_raw_response: RefsWithRawResponse

    def __init__(self, client: Sink) -> None:
        super().__init__(client)
        self.with_raw_response = RefsWithRawResponse(self)
...
class AsyncRefs(AsyncAPIResource):
    with_raw_response: AsyncRefsWithRawResponse

    def __init__(self, client: AsyncSink) -> None:
        super().__init__(client)
        self.with_raw_response = AsyncRefsWithRawResponse(self)
