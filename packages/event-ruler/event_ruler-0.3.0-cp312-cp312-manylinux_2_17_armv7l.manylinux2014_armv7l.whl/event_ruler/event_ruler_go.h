...
/* package event_ruler/build/lib.linux-armv7l-cpython-312/event_ruler */
...
extern long int Slice_int_elem(long long int handle, GoInt _idx);
extern long long int Slice_int_subslice(long long int handle, GoInt _st, GoInt _ed);
extern void Slice_int_set(long long int handle, GoInt _idx, long int _vl);
extern void Slice_int_append(long long int handle, long int _vl);
...
extern unsigned int Slice_uint_elem(long long int handle, GoInt _idx);
extern long long int Slice_uint_subslice(long long int handle, GoInt _st, GoInt _ed);
extern void Slice_uint_set(long long int handle, GoInt _idx, unsigned int _vl);
extern void Slice_uint_append(long long int handle, unsigned int _vl);
