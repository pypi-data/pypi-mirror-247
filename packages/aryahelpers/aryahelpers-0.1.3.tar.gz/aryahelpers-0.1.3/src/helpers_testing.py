...
# +++++++++++++++++
from aryahelpers.config import *
...
from aryahelpers.joboperations.aryajobapi import AryaJobOperations
# ==================================
...
if __name__ == "__main__":
    ...
    # MySQLHelpers.transact_to_jobsretain_tbl('database.staging', 'candidate_reservoir', [202524], 'insert')
    # MySQLHelpers()._get_sql_table_cols('database.staging', 'candidate_reservoir', 'toprocess_candidates')
