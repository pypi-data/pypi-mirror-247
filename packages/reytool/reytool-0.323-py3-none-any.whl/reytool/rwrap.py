...
from .rsystem import ExceptionData, throw, catch_exc, get_arg_info
...
def wrap_exc(
    ...
    *args: Any,
    _exception: Union[BaseException, Tuple[BaseException, ...]] = BaseException,
    _handler: Optional[Callable[[ExceptionData], Any]] = None,
    **kwargs: Any
) -> Optional[Any]:
    """
    ...
    _handler : Exception handle method.
        ...
        - `Callable` : Use this method, input parameter is exception data.
    ...
    # Exception handle.
        ...
        ## Custom.
            ...
            exception_data = catch_exc()
            _handler(exception_data)
