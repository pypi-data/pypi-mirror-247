...
from typing import Any, Tuple, Dict, Callable, Optional, Union, Literal, overload
...
from .rsystem import throw, catch_exc, get_arg_info
...
def wrap_exc(
    ...
    *args: Any,
    ...
    _handler_args: Optional[Tuple] = None,
    _handler_kwargs: Optional[Dict] = None,
    **kwargs: Any
) -> Optional[Any]: ...
...
def wrap_exc(
    ...
    **kwargs: Any
    ...
    _handler_args : Position arguments of exception handle method.
    _handler_kwargs : Keyword arguments of exception handle method.
    kwargs : Keyword arguments of decorated function.
    ...
    # Print exception information.
        ...
        if _handler is None:
            ...
            if _handler_args is None:
                _handler_args = ()
            if _handler_kwargs is None:
                _handler_kwargs = {}
            _handler(
                *_handler_args,
                **_handler_kwargs
