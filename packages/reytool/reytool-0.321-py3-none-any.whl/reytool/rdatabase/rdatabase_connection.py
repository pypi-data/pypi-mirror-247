...
from typing import Any, List, Dict, Tuple, Union, Optional, Literal, Iterable, ClassVar, Generator, NoReturn, overload
...
class RDatabase(object):
    ...
    def execute_select(
        ...
        **kwdata: Any
        ...
        # Execute SQL.
        result = self(sql, report=report, **kwdata)
    ...
    def execute_insert(
        ...
        **kwdata: Any
        ...
        # Execute SQL.
        result = self(sql, data, report, **kwdata_replace)
    ...
    def execute_update(
        ...
        **kwdata: Any
        ...
        # Execute SQL.
        result = self(sqls, data_flatten, report)
    ...
    def execute_delete(
        ...
        **kwdata: Any
        ...
        # Execute SQL.
        result = self(sqls, report=report, **kwdata)
    ...
    def exe(self):
        ...
        # Import.
        from .rdatabase_execute import RDBExecute
    ...
    def info(self):
        ...
        # Import.
        from .rdatabase_information import RDBISchema
    ...
    def build(self):
        ...
        # Import.
        from .rdatabase_build import RDBBuild
    ...
    def file(self):
        ...
        # Import.
        from .rdatabase_file import RDBFile
    ...
    def status(self):
        ...
        # Import.
        from .rdatabase_parameter import RDBPStatus
    ...
    def variables(self):
        ...
        # Import.
        from .rdatabase_parameter import RDBPVariable
