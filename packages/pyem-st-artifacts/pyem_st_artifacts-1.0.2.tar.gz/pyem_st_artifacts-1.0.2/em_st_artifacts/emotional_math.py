...
class EmotionalMath:
    class _NativeMathLibSetting(ctypes.Structure):
        _fields_ = [('sampling_rate', ctypes.c_int32), ('process_win_freq', ctypes.c_int32),
                    ...
                    ('channels_number', ctypes.c_int32), ('channel_for_analysis', ctypes.c_int32)]
    ...
    class _NativeArtifactDetectSetting(ctypes.Structure):
        _fields_ = [('art_bord', ctypes.c_int32), ('allowed_percent_artpoints', ctypes.c_int32),
                    ...
                    ('global_artwin_sec', ctypes.c_int32), ('spect_art_by_totalp', ctypes.c_int8),
                    ('hanning_win_spectrum', ctypes.c_int8), ('hamming_win_spectrum', ctypes.c_int8),
                    ('num_wins_for_quality_avg', ctypes.c_int32)]

    class _NativeShortArtifactDetectSetting(ctypes.Structure):
        _fields_ = [('ampl_art_detect_win_size', ctypes.c_int32), ('ampl_art_zerod_area', ctypes.c_int32),
                    ('ampl_art_extremum_border', ctypes.c_int32)]
