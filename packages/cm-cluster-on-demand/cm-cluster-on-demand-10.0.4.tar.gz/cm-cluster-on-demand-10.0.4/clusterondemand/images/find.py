...
class CODImage:
    ...
    def get_properties(self) -> dict[str, str]:
        ...
        return {
            ...
            "bcm_pkg_hashes": ",".join(f"{pkg}={git_hash}" for pkg, git_hash in self.pkg_hashes),
...
def get_latest_revisions(n: bool, invert: bool, images: list[CODImage]) -> dict[str, list[int]]:
    """
