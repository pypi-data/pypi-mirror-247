...
class Attribute:
    ...
    @property
    def (self) -> lagrange.core.AttributeCopyPolicy:
        ...
    @copy_policy.setter
    def (self, arg: lagrange.core.AttributeCopyPolicy, /) -> None:
        ...
    ...
    @property
    def (self) -> lagrange.core.AttributeElement:
        ...
    ...
    @property
    def (self) -> lagrange.core.AttributeGrowthPolicy:
        ...
    @growth_policy.setter
    def (self, arg: lagrange.core.AttributeGrowthPolicy, /) -> None:
        ...
    ...
    @property
    def (self) -> lagrange.core.AttributeUsage:
        ...
    
    @property
    def (self) -> lagrange.core.AttributeWritePolicy:
        ...
    @write_policy.setter
    def (self, arg: lagrange.core.AttributeWritePolicy, /) -> None:
        ...
    
class AttributeCopyPolicy:
    """
    <attribute '__doc__' of 'lagrange.core.AttributeCopyPolicy' objects>
    """

    @entries: dict
    
    CopyIfExternal: AttributeCopyPolicy
    
    ErrorIfExternal: AttributeCopyPolicy
    
    KeepExternalPtr: AttributeCopyPolicy
...
class AttributeCreatePolicy:
    """
    <attribute '__doc__' of 'lagrange.core.AttributeCreatePolicy' objects>
    """

    @entries: dict
    
    ErrorIfReserved: AttributeCreatePolicy
    
    Force: AttributeCreatePolicy
...
class AttributeDeletePolicy:
    """
    <attribute '__doc__' of 'lagrange.core.AttributeDeletePolicy' objects>
    """

    @entries: dict
    
    ErrorIfReserved: AttributeDeletePolicy
    
    Force: AttributeDeletePolicy
...
class AttributeElement:
    """
    <attribute '__doc__' of 'lagrange.core.AttributeElement' objects>
    """

    @entries: dict
    
    Corner: AttributeElement
    
    Edge: AttributeElement
    
    Facet: AttributeElement
    
    Indexed: AttributeElement
...
class AttributeExportPolicy:
    """
    <attribute '__doc__' of 'lagrange.core.AttributeExportPolicy' objects>
    """

    @entries: dict
    
    CopyIfExternal: AttributeExportPolicy
    
    ErrorIfExternal: AttributeExportPolicy
    
    KeepExternalPtr: AttributeExportPolicy
...
class AttributeGrowthPolicy:
    """
    <attribute '__doc__' of 'lagrange.core.AttributeGrowthPolicy' objects>
    """

    @entries: dict
    
    AllowWithinCapacity: AttributeGrowthPolicy
    
    ErrorIfExtenal: AttributeGrowthPolicy
    
    SilentCopy: AttributeGrowthPolicy
    
    WarnAndCopy: AttributeGrowthPolicy
...
class AttributeUsage:
    """
    <attribute '__doc__' of 'lagrange.core.AttributeUsage' objects>
    """

    @entries: dict
    
    Bitangent: AttributeUsage
    
    Color: AttributeUsage
    
    CornerIndex: AttributeUsage
    
    EdgeIndex: AttributeUsage
    
    FacetIndex: AttributeUsage
    
    Normal: AttributeUsage
    
    Position: AttributeUsage
    
    Scalar: AttributeUsage
    
    Tangent: AttributeUsage
    
    UV: AttributeUsage
    
    Vector: AttributeUsage
    
    VertexIndex: AttributeUsage
...
class AttributeWritePolicy:
    """
    <attribute '__doc__' of 'lagrange.core.AttributeWritePolicy' objects>
    """

    @entries: dict
    
    ErrorIfReadOnly: AttributeWritePolicy
    
    SilentCopy: AttributeWritePolicy
    
    WarnAndCopy: AttributeWritePolicy
...
class CentroidWeightingType:
    """
    <attribute '__doc__' of 'lagrange.core.CentroidWeightingType' objects>
    """

    @entries: dict
    
    Area: CentroidWeightingType
    
    Uniform: CentroidWeightingType
...
class ConnectivityType:
    """
    <attribute '__doc__' of 'lagrange.core.ConnectivityType' objects>
    """

    @entries: dict
    
    Edge: ConnectivityType
    
    Vertex: ConnectivityType
...
class IndexedAttribute:
    ...
    @property
    def (self) -> lagrange.core.Attribute:
        ...
...
class MappingPolicy:
    """
    <attribute '__doc__' of 'lagrange.core.MappingPolicy' objects>
    """

    @entries: dict
    
    Average: MappingPolicy
    
    Error: MappingPolicy
    
    KeepFirst: MappingPolicy
...
class MeshCentroidOptions:
    ...
    @property
    def (self) -> lagrange.core.CentroidWeightingType:
        ...
    @weighting_type.setter
    def (self, arg: lagrange.core.CentroidWeightingType, /) -> None:
        ...
...
class NormalOptions:
    ...
    @property
    def (self) -> lagrange.core.NormalWeightingType:
        ...
    @weight_type.setter
    def (self, arg: lagrange.core.NormalWeightingType, /) -> None:
        ...
    
class NormalWeightingType:
    """
    <attribute '__doc__' of 'lagrange.core.NormalWeightingType' objects>
    """
...
class RemapVerticesOptions:
    ...
    @property
    def (self) -> lagrange.core.MappingPolicy:
        ...
    @collision_policy_float.setter
    def (self, arg: lagrange.core.MappingPolicy, /) -> None:
        ...
...
class TangentBitangentOptions:
    ...
    def (self, arg: lagrange.core.AttributeElement, /) -> None:
        ...
...
def compute_facet_area(*args, **kwargs):
    """
    compute_facet_area(mesh: lagrange.core.SurfaceMesh, options: lagrange.core.FacetAreaOptions = <lagrange.core.FacetAreaOptions object at 0x0000023F6227A340>) -> int
    """
    ...

def compute_facet_centroid(*args, **kwargs):
    """
    compute_facet_centroid(mesh: lagrange.core.SurfaceMesh, options: lagrange.core.FacetCentroidOptions = <lagrange.core.FacetCentroidOptions object at 0x0000023F6227A430>) -> int
    """
    ...

def compute_facet_normal(*args, **kwargs):
    """
    compute_facet_normal(mesh: lagrange.core.SurfaceMesh, options: lagrange.core.FacetNormalOptions = <lagrange.core.FacetNormalOptions object at 0x0000023F6227A0D0>) -> int
    """
    ...

def compute_mesh_area(*args, **kwargs):
    """
    compute_mesh_area(mesh: lagrange.core.SurfaceMesh, options: lagrange.core.MeshAreaOptions = <lagrange.core.MeshAreaOptions object at 0x0000023F6227A3A0>) -> float
    """
    ...

def compute_mesh_centroid(*args, **kwargs):
    """
    compute_mesh_centroid(mesh: lagrange.core.SurfaceMesh, options: lagrange.core.MeshCentroidOptions = <lagrange.core.MeshCentroidOptions object at 0x0000023F622A4730>) -> list[float]
    """
    ...
...
def compute_tangent_bitangent(*args, **kwargs):
    """
    compute_tangent_bitangent(mesh: lagrange.core.SurfaceMesh, options: lagrange.core.TangentBitangentOptions = <lagrange.core.TangentBitangentOptions object at 0x0000023F62217450>) -> lagrange.core.TangentBitangentResult
    """
    ...

def compute_vertex_normal(*args, **kwargs):
    """
    compute_vertex_normal(mesh: lagrange.core.SurfaceMesh, options: lagrange.core.VertexNormalOptions = <lagrange.core.VertexNormalOptions object at 0x0000023F6228BD70>) -> int
    """
    ...

def compute_vertex_valence(*args, **kwargs):
    """
    compute_vertex_valence(mesh: lagrange.core.SurfaceMesh, options: lagrange.core.VertexValenceOptions = <lagrange.core.VertexValenceOptions object at 0x0000023F6227A220>) -> int
    """
    ...
...
def remap_vertices(*args, **kwargs):
    """
    remap_vertices(mesh: lagrange.core.SurfaceMesh, old_to_new: numpy.ndarray[dtype=uint32, order='C', device='cpu'], options: lagrange.core.RemapVerticesOptions = <lagrange.core.RemapVerticesOptions object at 0x0000023F619E2410>) -> None
    """
    ...
