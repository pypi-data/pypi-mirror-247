...
class FileEncoding:
    """
    <attribute '__doc__' of 'lagrange.io.FileEncoding' objects>
    """
...
class FileFormat:
    """
    <attribute '__doc__' of 'lagrange.io.FileFormat' objects>
    """
...
class SaveOptions:
    ...
    class AttributeConversionPolicy:
        """
        <attribute '__doc__' of 'lagrange.io.AttributeConversionPolicy' objects>
        """
    ...
    class OutputAttributes:
        """
        <attribute '__doc__' of 'lagrange.io.OutputAttributes' objects>
        """
...
def load_scene(*args, **kwargs):
    """
    load_scene(filename: os.PathLike, options: lagrange.io.LoadOptions = <lagrange.io.LoadOptions object at 0x0000023F622CC080>) -> lagrange.scene.Scene
...
def save_scene(*args, **kwargs):
    """
    save_scene(filename: os.PathLike, scene: lagrange.scene.Scene, options: lagrange.io.SaveOptions = <lagrange.io.SaveOptions object at 0x0000023F622D0070>) -> None
