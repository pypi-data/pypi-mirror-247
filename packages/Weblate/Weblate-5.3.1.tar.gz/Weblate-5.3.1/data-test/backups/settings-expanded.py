...
CACHE_DIR = '/home/nijel/weblate/weblate/data-test/cache'  ###
...
COMPRESS_JINJA2_GET_ENVIRONMENT = <function CompressorConf.JINJA2_GET_ENVIRONMENT at 0x7f31b343e480>  ###
...
COMPRESS_ROOT = '/home/nijel/weblate/weblate/data-test/static'  ###
...
DATABASES = {'default': {'ENGINE': 'django.db.backends.postgresql', 'NAME': 'test_weblate', 'USER': 'weblate', 'PASSWORD': 'weblate', 'HOST': '127.0.0.1', 'PORT': '', 'OPTIONS': {}, 'CONN_MAX_AGE': None, 'CONN_HEALTH_CHECKS': True, 'DISABLE_SERVER_SIDE_CURSORS': False, 'ATOMIC_REQUESTS': False, 'AUTOCOMMIT': True, 'TIME_ZONE': None, 'TEST': {'CHARSET': None, 'COLLATION': None, 'MIGRATE': True, 'MIRROR': None, 'NAME': None}}}
DATABASE_BACKUP = 'plain'  ###
DATA_DIR = '/home/nijel/weblate/weblate/data-test'  ###
...
LEGAL_TOS_DATE = datetime.date(2017, 7, 2)  ###
LEGAL_URL = None  ###
LICENSE_EXTRA = []  ###
LICENSE_FILTER = None  ###
LICENSE_REQUIRED = False  ###
LIMIT_TRANSLATION_LENGTH_BY_SOURCE_LENGTH = True  ###
LOCALE_PATHS = ['/home/nijel/weblate/weblate/weblate/locale']
LOCALIZE_CDN_PATH = '/home/nijel/weblate/weblate/data-test/l10n-cdn'  ###
LOCALIZE_CDN_URL = 'https://cdn.example.com/'  ###
LOGGING = {'version': 1, 'disable_existing_loggers': False, 'filters': {'require_debug_false': {'()': 'django.utils.log.RequireDebugFalse'}}, 'formatters': {'simple': {'format': '%(levelname)s %(message)s'}}, 'handlers': {'mail_admins': {'level': 'ERROR', 'filters': ['require_debug_false'], 'class': 'django.utils.log.AdminEmailHandler'}, 'console': {'level': 'DEBUG', 'class': 'logging.StreamHandler', 'formatter': 'simple'}}, 'loggers': {'django.request': {'handlers': ['mail_admins'], 'level': 'ERROR', 'propagate': True}, 'weblate': {'handlers': [], 'level': 'ERROR'}, 'social': {'handlers': [], 'level': 'ERROR'}}}
LOGIN_REDIRECT_URL = '/'
LOGIN_REQUIRED_URLS = []  ###
...
MATOMO_SITE_ID = None  ###
MATOMO_URL = None  ###
MEDIA_ROOT = '/home/nijel/weblate/weblate/data-test/media'
MEDIA_URL = '/media/'
...
STATIC_ROOT = '/home/nijel/weblate/weblate/data-test/static'
STATIC_URL = '/static/'
STATS_LAZY = True  ###
STATUS_URL = None  ###
