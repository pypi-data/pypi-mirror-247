...
class Calculator:
    ...
    def set_precision(self, precision: int) -> None:
        ...
        if precision > self.MAX_PRECISION:
            raise ValueError("Precision value too big. Allowed maximum= 300")
        self.precision = precision

    def print_history_logs(self) -> None:
        """
        Print the history log entries to the console.
        """
        for log_entry in self.logs:
            print(log_entry)

    def __history_log(self, symbol: str, number: float) -> List[str]:
        """
    ...
    def __clear_history_log(self) -> None:
    ...
    def reset_memory(self) -> float:
        ...
        """
        self.memory = 0
        self.__clear_history_log()
        return self.memory

    def __validate_input_value(self, number: float) -> float:
        """
    ...
    def __validate_power_input(self, power: float) -> float:
        """
    ...
    def __validate_result(self, result: float) -> float:
        """
    ...
    def add(self, number: float) -> float:
        ...
        """
        self.__validate_input_value(number)
        result: float = fsum([self.memory, number])
        self.__validate_result(result)
        self.__history_log("+", number)
        self.memory = result
    ...
    def power(self, number: float) -> float:
        ...
        """
        self.__validate_power_input(number)
        result: float = self.memory ** number
        self.__validate_result(result)
        self.__history_log("^", number)
        self.memory = result
    ...
    def root(self, number: float) -> float:
        ...
        self.__validate_result(result)
        self.__history_log("root", number)
        self.memory = result
        return round(result, self.precision)
