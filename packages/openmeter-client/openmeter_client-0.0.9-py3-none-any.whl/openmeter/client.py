...
class OpenMeterClient:
    ...
    def get_timeseries(
        ...
        Example 1:
            ...
            .. code-block:: python
                ...
                >>> print(ts_data)
                                timestamps  values
                0      2000-01-01T00:00:00    0.20
                1      2000-01-01T01:00:00    0.20
                2      2000-01-01T02:00:00    0.20
                3      2000-01-01T03:00:00    0.20
                4      2000-01-01T04:00:00    0.20
                ...                    ...     ...
                23276  2023-12-10T22:00:00  108.55
                23277  2023-12-10T22:15:00   27.15
                23278  2023-12-10T22:30:00   27.10
                23279  2023-12-10T22:45:00   27.15
                23280  2023-12-10T23:00:00  108.75
        ...
        Example 2:
            ...
            .. code-block:: python
                ...
                >>> print(ts_data)
                            timestamps  values
                0     2020-01-01T00:00:00   28.70
                1     2020-01-01T00:15:00   28.45
                2     2020-01-01T00:30:00   28.30
                3     2020-01-01T00:45:00   28.50
                4     2020-01-01T01:00:00   28.35
                ...                   ...     ...
                3038  2023-12-10T22:00:00  108.55
                3039  2023-12-10T22:15:00   27.15
                3040  2023-12-10T22:30:00   27.10
                3041  2023-12-10T22:45:00   27.15
                3042  2023-12-10T23:00:00  108.75
        ...
        return (
            pd.concat(timeseries_list)
            if len(timeseries_list) > 0
            else pd.DataFrame(columns=["timestamps", "values"])
        )
    ...
    def get_sensors_from_location(self, sensor_id):
        """
        Example method to retrives similar sensors based on a query sensor_id

        Args:
            :sensor_id: location id of an existing sensor

        Returns:
            pandas.DataFrame: The meta data of filtered sensors.
        """

        location_id = self.get_meta_data(sensor_id=sensor_id)["location_id"][0]
        return self.get_meta_data(location_id=location_id)