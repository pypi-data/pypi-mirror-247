...
class TestAlert(BaseTestCase):
    ...
    def test_enum_values(self) -> None:
        ...
        for metric in ['null_violation_count', 'range_violation_count', 'type_violation_count', 
            'expected_calibration_error', 'calibrated_threshold',
            'geometric_mean', 'ndcg_mean', 'traffic', 'frequency',]:
