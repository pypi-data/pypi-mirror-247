...
class Logger:
    ...
    """
    def __init__(self, console: bool = True, console_level: str = "debug",
                 file: str = None, file_level: str = "info",
    ...
    def _create_message(self, message: str, level: str) -> str:
        """
        Create a logging message from the given message and level.
    ...
    def _write_message(self, message: str) -> None:
        """
        Write a logging message in the defined file from the given message.
    ...
    def message(self, message: str, level: str = 'info') -> None:
        """
        Create and show a logging message from the given message and level.
