        ...
        def _hx_local_3(client,error):
            def _hx_local_2():
                if client.isDisposed():
                    return
                _gthis.evtCtrlError()
            _gthis.lock.synchronized(_hx_local_2)
        tmp1 = _hx_local_3
        def _hx_local_5(client):
            def _hx_local_4():
                if client.isDisposed():
                    return
                _gthis.evtCtrlDone()
            _gthis.lock.synchronized(_hx_local_4)
        tmp2 = _hx_local_5
...
OrderedIntMap._hx_class = OrderedIntMap
...
class com_lightstreamer_internal_OrderedIntMapImpl:
    ...
    _hx_methods = ["compact", "set", "get", "exists", "remove", "keys", "iterator", "keyValueIterator", "copy", "get_length", "get_orderedKeys", "keysCopy", "clear", "toString"]
    ...
    def iterator(self):
        return OrderedIntMapIterator(self)
...
class OrderedIntMapIterator:
    _hx_class_name = "OrderedIntMapIterator"
    _hx_is_interface = "False"
    __slots__ = ("map", "it")
    _hx_fields = ["map", "it"]
    _hx_methods = ["hasNext", "next"]
...
OrderedIntMapIterator._hx_class = OrderedIntMapIterator
...
com_lightstreamer_internal__Constants_Constants_Fields_.LS_LIB_VERSION = (("2.1.0" + " build ") + "20231219")
com_lightstreamer_internal__Constants_Constants_Fields_.LS_CID = "v Wntytg4pkpW37AL3M4hwLri8M4OA74gFa"
