...
/* Define to 1 if you have the `inflateInit', `inflate', `inflateEnd'
   functions. */
#define HAVE_ZLIB_INFLATE 1

/* Define to 1 if you have the `inflateInit2' function. */
#define HAVE_ZLIB_INFLATE_INIT2 1

/* Define to the sub-directory where libtool stores uninstalled libraries. */
#define LT_OBJDIR ".libs/"

/* Name of package */
#define PACKAGE "libgzipf"
...
#define PACKAGE_STRING "libgzipf 20231218"
...
#define PACKAGE_VERSION "20231218"
