...
class SerializerSettings(IteratorSettings):
    ...
    WRITE_GLTF_ECEF = _ifcopenshell_wrapper.SerializerSettings_WRITE_GLTF_ECEF
...
class GltfSerializer(WriteOnlyGeometrySerializer):
    ...
    def __init__(self, filename, settings):
        r"""__init__(GltfSerializer self, std::string const & filename, SerializerSettings settings) -> GltfSerializer"""
        _ifcopenshell_wrapper.GltfSerializer_swiginit(self, _ifcopenshell_wrapper.new_GltfSerializer(filename, settings))
...
def tree_vector_to_list(ps):
    r"""tree_vector_to_list(std::vector< IfcUtil::IfcBaseEntity *,std::allocator< IfcUtil::IfcBaseEntity * > > const & ps) -> aggregate_of_instance::ptr"""
    return _ifcopenshell_wrapper.tree_vector_to_list(ps)
