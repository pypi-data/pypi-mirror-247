...
from management.controllers import lvol_controller, storage_events, snapshot_controller
...
from management.pci_utils import get_nvme_devices, bind_spdk_driver
...
def restart_storage_node(
    ...
    logger.info(f"Add Storage node: {snode.mgmt_ip}")
    snode_api = SNodeClient(snode.api_endpoint)
...
def deploy(ifname):
    ...
    node_docker.images.pull("hamdykhader/spdk:latest")
