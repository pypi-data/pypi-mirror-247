...
from inductor import backend_client, quality_measures, wire_model
...
def _execute_test_case(
    ...
    quality_measures: List[wire_model.QualityMeasure],  # pylint: disable=redefined-outer-name
    ...
    if llm_program_error is None:
        ...
        for quality_measure, quality_measure_id in zip(
            ...
            if quality_measure.evaluator in ("FUNCTION", "LLM"):
