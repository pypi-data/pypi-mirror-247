...
import io
import sys
from typing import Any, Callable, Dict, Iterator, List, Optional, TextIO, Tuple, TypeVar, Union
        ...
        for arg in args:
            if isinstance(arg, TestCase):
                ...
                raise TypeError(
                    ...
                    f"or HparamSpec, but got {type(arg)}.")
                    ...
                    if isinstance(result, Iterator):
                        ...
                        class _IteratorWrapper:
                            ...
                            def __next__(self) -> Any:
                                ...
                                values. If the iterator is exhausted, log the
