...
def _uniffi_check_api_checksums(lib):
    ...
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_get_events_of() != 23606:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_handle_notifications() != 57318:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_is_running() != 15604:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_keys() != 35726:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_reconcile() != 28329:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_send_event() != 47519:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_send_event_to() != 14429:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_send_msg() != 58092:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_send_msg_to() != 17388:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_sdk_ffi_checksum_method_options_difficulty() != 36158:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_options_nip46_timeout() != 24058:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_sdk_ffi_checksum_method_options_timeout() != 43772:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_options_wait_for_connection() != 12978:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_sdk_ffi_checksum_method_profile_public_key() != 64123:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relay_connect() != 51651:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relay_req_events_of() != 17597:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relay_send_msg() != 24692:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relay_stop() != 54326:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relay_subscribe() != 47803:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relay_terminate() != 51591:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relay_unsubscribe() != 29805:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relayconnectionstats_uptime() != 18216:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_constructor_client_new() != 105:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_constructor_client_with_opts() != 56268:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_constructor_clientbuilder_new() != 10089:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
...
class ClientProtocol(typing.Protocol):
    ...
    def keys(self, ):
        raise NotImplementedError
    def reconcile(self, filter: "Filter"):
        raise NotImplementedError
    ...
    def send_event(self, event: "Event"):
        raise NotImplementedError
    def send_event_to(self, url: "str",event: "Event"):
        raise NotImplementedError
...
class Client:
    ...
    def handle_notifications(self, handler: "HandleNotification"):
        ...
        _rust_call(_UniffiLib.uniffi_nostr_sdk_ffi_fn_method_client_handle_notifications,self._uniffi_clone_pointer(),
    ...
    def is_running(self, ) -> "bool":
        return _UniffiConverterBool.lift(
            _rust_call(_UniffiLib.uniffi_nostr_sdk_ffi_fn_method_client_is_running,self._uniffi_clone_pointer(),)
        )
    ...
    def keys(self, ) -> "Keys":
        return _UniffiConverterTypeKeys.lift(
            _rust_call(_UniffiLib.uniffi_nostr_sdk_ffi_fn_method_client_keys,self._uniffi_clone_pointer(),)
        )
...
class OptionsProtocol(typing.Protocol):
    def difficulty(self, difficulty: "int"):
        raise NotImplementedError
    def nip46_timeout(self, nip46_timeout: "typing.Optional[Duration]"):
        raise NotImplementedError
    ...
    def timeout(self, timeout: "Duration"):
        raise NotImplementedError
    def wait_for_connection(self, wait: "bool"):
        raise NotImplementedError
...
class Options:
    ...
    def nip46_timeout(self, nip46_timeout: "typing.Optional[Duration]") -> "Options":
        _UniffiConverterOptionalDuration.check_lower(nip46_timeout)
        
        return _UniffiConverterTypeOptions.lift(
            _rust_call(_UniffiLib.uniffi_nostr_sdk_ffi_fn_method_options_nip46_timeout,self._uniffi_clone_pointer(),
    ...
    def wait_for_connection(self, wait: "bool") -> "Options":
        ...
        return _UniffiConverterTypeOptions.lift(
            _rust_call(_UniffiLib.uniffi_nostr_sdk_ffi_fn_method_options_wait_for_connection,self._uniffi_clone_pointer(),
...
class Relay:
    ...
    def connect(self, wait_for_connection: "bool"):
        _UniffiConverterBool.check_lower(wait_for_connection)
    ...
    def send_msg(self, msg: "ClientMessage",wait: "typing.Optional[Duration]"):
        ...
        _UniffiConverterOptionalDuration.check_lower(wait)
