...
def codetranslate0(code):
    ...
    codedict=pd.DataFrame([
        ...
        # 英国知名上市公司
        ['SHEL.UK','壳牌石油'],['AZN.UK','阿斯利康'],['HSBA.UK','汇丰集团'],
        ['HSBC.US','汇丰集团'],['ULVR.UK','联合利华'],['RIO.UK','力拓集团'],
        ...
        # 瑞典知名上市公司
        ['ATCO-A.ST','阿特拉斯-科普柯A'],['VOLCAR-B.ST','沃尔沃轿车B'],
        ...
        ['^AXJO','澳洲ASX200指数'],['^AORD','澳洲综合指数'],
        ['^JKSE','印尼雅加达综合指数'],['^GSPTSE','加拿大TSX综合指数'],
        ['^BVSP','巴西圣保罗指数'],['^MXX','墨西哥IPC指数'],
        ['^TA125.TA','特拉维夫125指数'],['^JN0U.JO','南非约翰内斯堡指数'],
        ['FXNAX','Fidelity美债指数'],
