...
from .http_logger import HttpLogger, HttpObjectType
...
class HttpRequestExecutor:
    ...
    def execute(
        ...
        **kwargs
        ...
        HttpLogger.log_http_object(HttpObjectType.REQUEST, req_log_entry)
        ...
        HttpLogger.log_http_object(HttpObjectType.RESPONSE, res_log_entry)
