...
from aos_prov.actions import create_new_unit, download_image, provision_unit, start_vm_unit, remove_vm_unit
...
def _parse_args():
    ...
    parser.add_argument(
        ...
        action='store',
        metavar='N',
        help=f'Wait for unit to respond for the first time in seconds. Default value 0 means wait for 5 seconds',
        dest='wait_unit',
        default=0,
        type=int
    )
