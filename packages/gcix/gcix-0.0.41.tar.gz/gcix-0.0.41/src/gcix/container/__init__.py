...
class BuildContainerCollectionProps:
    def __init__(
        self,
        *,
        registry: typing.Union[builtins.str, "Registry"],
        ...
        :param image_name: Image name with stage in the registry. e.g. username/imageName. Default: PredefinedVariables.ciProjectDir
