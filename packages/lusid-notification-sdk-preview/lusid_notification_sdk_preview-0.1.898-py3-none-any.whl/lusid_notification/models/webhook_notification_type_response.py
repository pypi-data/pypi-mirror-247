...
"""
    ...
    The version of the OpenAPI document: 0.1.898
...
class WebhookNotificationTypeResponse(object):
    ...
    def __init__(self, type=None, http_method=None, url=None, authentication_type=None, authentication_configuration_item_paths=None, content_type=None, content=None, local_vars_configuration=None):  # noqa: E501
        """WebhookNotificationTypeResponse - a model defined in OpenAPI"
    ...
    @property
    def type(self):
        """Gets the type of this WebhookNotificationTypeResponse.  # noqa: E501

        The type of delivery mechanism for this notification  # noqa: E501

        :return: The type of this WebhookNotificationTypeResponse.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this WebhookNotificationTypeResponse.

        The type of delivery mechanism for this notification  # noqa: E501

        :param type: The type of this WebhookNotificationTypeResponse.  # noqa: E501
        :type type: str
        """
    ...
    def http_method(self):
        """Gets the http_method of this WebhookNotificationTypeResponse.  # noqa: E501

        The HTTP method such as GET, POST, etc. to use on the request  # noqa: E501

        :return: The http_method of this WebhookNotificationTypeResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def http_method(self, http_method):
        """Sets the http_method of this WebhookNotificationTypeResponse.

        The HTTP method such as GET, POST, etc. to use on the request  # noqa: E501

        :param http_method: The http_method of this WebhookNotificationTypeResponse.  # noqa: E501
        :type http_method: str
        """
    ...
    @property
    def url(self):
        """Gets the url of this WebhookNotificationTypeResponse.  # noqa: E501

        The URL to send the request to  # noqa: E501

        :return: The url of this WebhookNotificationTypeResponse.  # noqa: E501
        :rtype: str
        """
        return self._url
    ...
    @url.setter
    def url(self, url):
        """Sets the url of this WebhookNotificationTypeResponse.

        The URL to send the request to  # noqa: E501

        :param url: The url of this WebhookNotificationTypeResponse.  # noqa: E501
        :type url: str
        """
    ...
    def authentication_type(self):
        """Gets the authentication_type of this WebhookNotificationTypeResponse.  # noqa: E501

        The type of authentication to use on the request  # noqa: E501

        :return: The authentication_type of this WebhookNotificationTypeResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def authentication_type(self, authentication_type):
        """Sets the authentication_type of this WebhookNotificationTypeResponse.

        The type of authentication to use on the request  # noqa: E501

        :param authentication_type: The authentication_type of this WebhookNotificationTypeResponse.  # noqa: E501
        :type authentication_type: str
        """
    ...
    def authentication_configuration_item_paths(self):
        """Gets the authentication_configuration_item_paths of this WebhookNotificationTypeResponse.  # noqa: E501
        ...
        :return: The authentication_configuration_item_paths of this WebhookNotificationTypeResponse.  # noqa: E501
        :rtype: dict[str, str]
        """
    ...
    def authentication_configuration_item_paths(self, authentication_configuration_item_paths):
        """Sets the authentication_configuration_item_paths of this WebhookNotificationTypeResponse.

        The paths of the Configuration Store configuration items that contain the authentication configuration. Each  authentication type requires different keys:  - Lusid - None required  - BasicAuth - Requires 'Username' and 'Password'  - BearerToken - Requires 'BearerToken' and optionally 'BearerScheme'                e.g. the following would be valid assuming that the config is present in the configuration store at the  specified paths:                    \"authenticationType\": \"BasicAuth\",      \"authenticationConfigurationItemPaths\": {          \"Username\": \"config://personal/myUserId/WebhookConfigurations/ExampleService/AdminUser\",          \"Password\": \"config://personal/myUserId/WebhookConfigurations/ExampleService/AdminPassword\"      }  # noqa: E501

        :param authentication_configuration_item_paths: The authentication_configuration_item_paths of this WebhookNotificationTypeResponse.  # noqa: E501
        :type authentication_configuration_item_paths: dict[str, str]
        """
    ...
    def content_type(self):
        """Gets the content_type of this WebhookNotificationTypeResponse.  # noqa: E501

        The type of the content e.g. Json  # noqa: E501

        :return: The content_type of this WebhookNotificationTypeResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def content_type(self, content_type):
        """Sets the content_type of this WebhookNotificationTypeResponse.

        The type of the content e.g. Json  # noqa: E501

        :param content_type: The content_type of this WebhookNotificationTypeResponse.  # noqa: E501
        :type content_type: str
        """
    ...
    @property
    def content(self):
        """Gets the content of this WebhookNotificationTypeResponse.  # noqa: E501

        The content of the request  # noqa: E501

        :return: The content of this WebhookNotificationTypeResponse.  # noqa: E501
        :rtype: object
        """
    ...
    def content(self, content):
        """Sets the content of this WebhookNotificationTypeResponse.

        The content of the request  # noqa: E501

        :param content: The content of this WebhookNotificationTypeResponse.  # noqa: E501
        :type content: object
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WebhookNotificationTypeResponse):
            return False
