...
def glyphBitmapRepresentationFactory(glyph, width=72, height=88, captionHeight=16):
    ...
    if glyph.markColor:
        ...
        gc.SetBrush(wx.TheBrushList.FindOrCreateBrush(wx.WHITE, wx.SOLID))
    ...
    glyph.draw(pen)
    gc.SetBrush(wx.TheBrushList.FindOrCreateBrush(wx.BLACK, wx.SOLID))
...
class GlyphGrid(wx.ScrolledWindow):
    ...
    @property
    def document(self):
        return self.GrandParent.document
    ...
    def refreshGlyphName(self, name):
