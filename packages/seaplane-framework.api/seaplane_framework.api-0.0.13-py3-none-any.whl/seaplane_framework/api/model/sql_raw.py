...
class SqlRaw(
    ...
    sql_raw: MetaOapg.properties.sql_raw
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["sql_raw"]) -> MetaOapg.properties.sql_raw: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["sql_raw"]) -> MetaOapg.properties.sql_raw: ...
    ...
    def __new__(
        cls,
        *_args: typing.Union[dict, frozendict.frozendict, ],
        sql_raw: typing.Union[MetaOapg.properties.sql_raw, dict, frozendict.frozendict, ],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'SqlRaw':
        return super().__new__(
            cls,
