...
# body param
SchemaForRequestBodyApplicationJson = SecretsManifest


request_body_secrets_manifest = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor200ResponseBodyApplicationJson = SecretsManifest
...
class BaseApi(api_client.Api):
    ...
    def _set_secrets_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_secrets_manifest.serialize(body, content_type)
