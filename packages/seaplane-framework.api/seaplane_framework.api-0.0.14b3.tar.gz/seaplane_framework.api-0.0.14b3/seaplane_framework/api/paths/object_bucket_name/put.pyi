...
RequestRequiredPathParams = typing_extensions.TypedDict(
    ...
    {
        'bucket_name': typing.Union[BucketNameSchema, str, ],
    }
)
...
request_path_bucket_name = api_client.PathParameter(
    name="bucket_name",
...
# body param
SchemaForRequestBodyApplicationJson = Bucket


request_body_bucket = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_bucket_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_bucket.serialize(body, content_type)
...
class CreateBucket(BaseApi):
    ...
    def create_bucket(
        ...
        return self._create_bucket_oapg(
            body=body,
