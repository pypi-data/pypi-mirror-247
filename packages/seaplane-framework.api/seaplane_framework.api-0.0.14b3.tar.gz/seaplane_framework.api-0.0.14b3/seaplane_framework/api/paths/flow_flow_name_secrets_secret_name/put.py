...
class SecretNameSchema(
    ...
    class MetaOapg:
        regex=[{
            'pattern': r'^[a-zA-Z_][a-zA-Z_0-9]*$',  # noqa: E501
        }]
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'flow_name': typing.Union[FlowNameSchema, str, ],
        'secret_name': typing.Union[SecretNameSchema, str, ],
    }
)
...
request_path_secret_name = api_client.PathParameter(
    name="secret_name",
    style=api_client.ParameterStyle.SIMPLE,
    schema=SecretNameSchema,
    required=True,
)
# body param
SchemaForRequestBodyApplicationJson = Secret


request_body_secret = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = Secret
...
class BaseApi(api_client.Api):
    ...
    def _set_secret_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_secret.serialize(body, content_type)
