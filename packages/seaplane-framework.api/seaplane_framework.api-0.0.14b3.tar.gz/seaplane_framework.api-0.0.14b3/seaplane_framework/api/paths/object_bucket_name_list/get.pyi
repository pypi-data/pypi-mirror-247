...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['ObjectStat']:
            return ObjectStat

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['ObjectStat'], typing.List['ObjectStat']],
    ...
    def __getitem__(self, i: int) -> 'ObjectStat':
...
class BaseApi(api_client.Api):
    ...
    def _list_objects_oapg(
        ...
        """
        Get an object in a bucket or list under a prefix
