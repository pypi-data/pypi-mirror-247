...
class StreamNameSchema(
    ...
    class MetaOapg:
        regex=[{
            'pattern': r'^[a-zA-Z0-9-_]{1,31}$',  # noqa: E501
        }]
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'stream_name': typing.Union[StreamNameSchema, str, ],
    }
)
...
request_path_stream_name = api_client.PathParameter(
    name="stream_name",
    style=api_client.ParameterStyle.SIMPLE,
    schema=StreamNameSchema,
    required=True,
)
# body param
SchemaForRequestBodyApplicationJson = CarrierStreamOptions


request_body_carrier_stream_options = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_stream_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_carrier_stream_options.serialize(body, content_type)
...
class CreateStream(BaseApi):
    ...
    def create_stream(
        ...
        return self._create_stream_oapg(
            body=body,
