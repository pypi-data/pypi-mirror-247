...
RequestRequiredQueryParams = typing_extensions.TypedDict(
    ...
    {
        'pattern': typing.Union[PatternSchema, str, ],
...
request_query_pattern = api_client.QueryParameter(
    name="pattern",
...
class MessageIdSchema(
    ...
    class MetaOapg:
        regex=[{
            'pattern': r'^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}((\.\d+|\.\*)*|\.\>)$',  # noqa: E501
        }]
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_archive_from_endpoint_oapg(
        self,
...
class GetArchiveFromEndpoint(BaseApi):
    ...
    def get_archive_from_endpoint(
        ...
        return self._get_archive_from_endpoint_oapg(
