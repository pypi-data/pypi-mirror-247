...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['KeyName']:
            return KeyName

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['KeyName'], typing.List['KeyName']],
    ...
    def __getitem__(self, i: int) -> 'KeyName':
...
class BaseApi(api_client.Api):
    ...
    def _list_keys_oapg(
        ...
        """
        Get the list of keys currently in a store.
