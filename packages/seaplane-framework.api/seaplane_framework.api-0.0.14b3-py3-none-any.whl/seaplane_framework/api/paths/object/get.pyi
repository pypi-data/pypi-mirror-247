...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def additional_properties() -> typing.Type['Bucket']:
            return Bucket
    
    def __getitem__(self, name: typing.Union[str, ]) -> 'Bucket':
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    def get_item_oapg(self, name: typing.Union[str, ]) -> 'Bucket':
...
class ListBuckets(BaseApi):
    ...
    def list_buckets(
        ...
        return self._list_buckets_oapg(
