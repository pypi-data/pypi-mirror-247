...
class AzureBlobStorageOutput(
    ...
    azure_blob_storage: MetaOapg.properties.azure_blob_storage
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["azure_blob_storage"]) -> MetaOapg.properties.azure_blob_storage: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["azure_blob_storage"], ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["azure_blob_storage"]) -> MetaOapg.properties.azure_blob_storage: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["azure_blob_storage"], ]):
        return super().get_item_oapg(name)

    def __new__(
        cls,
        *_args: typing.Union[dict, frozendict.frozendict, ],
        azure_blob_storage: typing.Union[MetaOapg.properties.azure_blob_storage, dict, frozendict.frozendict, ],
        _configuration: typing.Optional[schemas.Configuration] = None,
