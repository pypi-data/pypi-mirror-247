...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def config() -> typing.Type['KeyValueConfig']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["config"]) -> 'KeyValueConfig': ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["config"], ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["config"]) -> typing.Union['KeyValueConfig', schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["config"], ]):
        return super().get_item_oapg(name)

    def __new__(
        cls,
        *_args: typing.Union[dict, frozendict.frozendict, ],
        config: typing.Union['KeyValueConfig', schemas.Unset] = schemas.unset,
...
class BaseApi(api_client.Api):
    ...
    def _get_store_oapg(
        ...
        """
        Get information about a Key-Value store
