...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'internal': typing.Union[InternalSchema, str, ],
    },
    total=False
)
...
request_query_internal = api_client.QueryParameter(
    name="internal",
...
class ListStreams(BaseApi):
    ...
    def list_streams(
        ...
        return self._list_streams_oapg(
