...
class AllocSchema(
    ...
    class MetaOapg:
        regex=[{
            'pattern': r'^[a-fA-F0-9]{1,32}$',  # noqa: E501
        }]
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'alloc': typing.Union[AllocSchema, str, ],
...
request_query_alloc = api_client.QueryParameter(
    name="alloc",
...
# Header params
LastEventIDSchema = schemas.IntSchema
...
RequestOptionalHeaderParams = typing_extensions.TypedDict(
    ...
    {
        'Last-Event-ID': typing.Union[LastEventIDSchema, decimal.Decimal, int, ],
    },
    total=False
)
...
request_header_last_event_id = api_client.HeaderParameter(
    name="Last-Event-ID",
    style=api_client.ParameterStyle.SIMPLE,
    schema=LastEventIDSchema,
)
# Path params


class FlowNameSchema(
    schemas.StrSchema
):
...
RequestRequiredPathParams = typing_extensions.TypedDict(
    ...
    {
        'flow_name': typing.Union[FlowNameSchema, str, ],
    }
)
...
SchemaFor200ResponseBodyTextEventStream = schemas.StrSchema
...
class StreamFlowEvents(BaseApi):
    ...
    def stream_flow_events(
        ...
        return self._stream_flow_events_oapg(
