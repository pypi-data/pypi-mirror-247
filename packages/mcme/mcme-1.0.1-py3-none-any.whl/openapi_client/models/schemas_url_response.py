...
class SchemasURLResponse(BaseModel):
    """
    SchemasURLResponse
    """
    ...
    __properties = ["internal", "method", "path"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SchemasURLResponse:
        """Create an instance of SchemasURLResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SchemasURLResponse:
        """Create an instance of SchemasURLResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SchemasURLResponse.parse_obj(obj)

        _obj = SchemasURLResponse.parse_obj({
