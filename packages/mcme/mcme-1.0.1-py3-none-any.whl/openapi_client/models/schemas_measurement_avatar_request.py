...
class SchemasMeasurementAvatarRequest(BaseModel):
    """
    SchemasMeasurementAvatarRequest
    """
    gender: Optional[EnumsGender] = None
    measurements: Optional[Dict[str, Union[StrictFloat, StrictInt]]] = None
    model_version: Optional[EnumsModelVersion] = Field(None, alias="modelVersion")
    name: Optional[StrictStr] = None
    __properties = ["gender", "measurements", "modelVersion", "name"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SchemasMeasurementAvatarRequest:
        """Create an instance of SchemasMeasurementAvatarRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SchemasMeasurementAvatarRequest:
        """Create an instance of SchemasMeasurementAvatarRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SchemasMeasurementAvatarRequest.parse_obj(obj)

        _obj = SchemasMeasurementAvatarRequest.parse_obj({
