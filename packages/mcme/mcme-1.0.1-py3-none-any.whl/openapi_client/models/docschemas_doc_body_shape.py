...
class DocschemasDocBodyShape(BaseModel):
    """
    DocschemasDocBodyShape
    """
    gender: Optional[StrictStr] = None
    model_version: Optional[StrictStr] = Field(None, alias="modelVersion")
    shape_parameters: Optional[conlist(Union[StrictFloat, StrictInt])] = Field(None, alias="shapeParameters")
    __properties = ["gender", "modelVersion", "shapeParameters"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocschemasDocBodyShape:
        """Create an instance of DocschemasDocBodyShape from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocschemasDocBodyShape:
        """Create an instance of DocschemasDocBodyShape from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocschemasDocBodyShape.parse_obj(obj)

        _obj = DocschemasDocBodyShape.parse_obj({
            "gender": obj.get("gender"),
            "model_version": obj.get("modelVersion"),
            "shape_parameters": obj.get("shapeParameters")
        })
        return _obj
