...
class DocschemasDocMeshAttributes(BaseModel):
    """
    DocschemasDocMeshAttributes
    """
    created_at: Optional[StrictInt] = None
    metadata: Optional[DocschemasDocMeshMetadata] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocschemasDocMeshAttributes:
        """Create an instance of DocschemasDocMeshAttributes from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocschemasDocMeshAttributes:
        """Create an instance of DocschemasDocMeshAttributes from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocschemasDocMeshAttributes.parse_obj(obj)

        _obj = DocschemasDocMeshAttributes.parse_obj({
            "created_at": obj.get("created_at"),
            "metadata": DocschemasDocMeshMetadata.from_dict(obj.get("metadata")) if obj.get("metadata") is not None else None,
            "name": obj.get("name"),
