...
class DocschemasDocAFSInputs(BaseModel):
    """
    DocschemasDocAFSInputs
    """
    avatarname: Optional[StrictStr] = None
    gender: Optional[StrictStr] = None
    init_pose: Optional[StrictStr] = Field(None, alias="initPose")
    input_units: Optional[StrictStr] = Field(None, alias="inputUnits")
    look_axis: Optional[StrictStr] = Field(None, alias="lookAxis")
    up_axis: Optional[StrictStr] = Field(None, alias="upAxis")
    __properties = ["avatarname", "gender", "initPose", "inputUnits", "lookAxis", "upAxis"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocschemasDocAFSInputs:
        """Create an instance of DocschemasDocAFSInputs from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocschemasDocAFSInputs:
        """Create an instance of DocschemasDocAFSInputs from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocschemasDocAFSInputs.parse_obj(obj)

        _obj = DocschemasDocAFSInputs.parse_obj({
            "avatarname": obj.get("avatarname"),
            "gender": obj.get("gender"),
            "init_pose": obj.get("initPose"),
            "input_units": obj.get("inputUnits"),
            "look_axis": obj.get("lookAxis"),
            "up_axis": obj.get("upAxis")
        })
        return _obj
