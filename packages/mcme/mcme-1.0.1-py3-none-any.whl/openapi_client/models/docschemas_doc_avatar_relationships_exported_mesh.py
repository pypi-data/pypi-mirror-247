...
class DocschemasDocAvatarRelationshipsExportedMesh(BaseModel):
    """
    DocschemasDocAvatarRelationshipsExportedMesh
    """
    data: Optional[conlist(DocschemasDocAvatarRelationshipsExportedMeshDataInner)] = None
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocschemasDocAvatarRelationshipsExportedMesh:
        """Create an instance of DocschemasDocAvatarRelationshipsExportedMesh from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocschemasDocAvatarRelationshipsExportedMesh:
        """Create an instance of DocschemasDocAvatarRelationshipsExportedMesh from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocschemasDocAvatarRelationshipsExportedMesh.parse_obj(obj)

        _obj = DocschemasDocAvatarRelationshipsExportedMesh.parse_obj({
            "data": [DocschemasDocAvatarRelationshipsExportedMeshDataInner.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
