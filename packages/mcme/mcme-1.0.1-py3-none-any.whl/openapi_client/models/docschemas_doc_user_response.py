...
class DocschemasDocUserResponse(BaseModel):
    """
    DocschemasDocUserResponse
    """
    attributes: Optional[DocschemasDocUserAttributes] = None
    type: Optional[StrictStr] = None
    user: Optional[StrictStr] = None
    __properties = ["attributes", "type", "user"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocschemasDocUserResponse:
        """Create an instance of DocschemasDocUserResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocschemasDocUserResponse:
        """Create an instance of DocschemasDocUserResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocschemasDocUserResponse.parse_obj(obj)

        _obj = DocschemasDocUserResponse.parse_obj({
            "attributes": DocschemasDocUserAttributes.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None,
            "type": obj.get("type"),
            "user": obj.get("user")
        })
        return _obj
