...
class DocschemasDocErrorResponse(BaseModel):
    """
    DocschemasDocErrorResponse
    """
    errors: Optional[conlist(MesherrMeshErr)] = None
    __properties = ["errors"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocschemasDocErrorResponse:
        """Create an instance of DocschemasDocErrorResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocschemasDocErrorResponse:
        """Create an instance of DocschemasDocErrorResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocschemasDocErrorResponse.parse_obj(obj)

        _obj = DocschemasDocErrorResponse.parse_obj({
            "errors": [MesherrMeshErr.from_dict(_item) for _item in obj.get("errors")] if obj.get("errors") is not None else None
        })
        return _obj
