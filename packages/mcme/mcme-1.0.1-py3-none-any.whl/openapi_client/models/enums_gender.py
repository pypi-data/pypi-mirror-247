...
class EnumsGender(str, Enum):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EnumsGender:
        """Create an instance of EnumsGender from a JSON string"""
        return EnumsGender(json.loads(json_str))


    def enum_values():
        return [c.value for c in EnumsGender]
