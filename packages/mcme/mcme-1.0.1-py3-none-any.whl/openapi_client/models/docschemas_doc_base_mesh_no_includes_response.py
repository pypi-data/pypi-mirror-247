...
class DocschemasDocBaseMeshNoIncludesResponse(BaseModel):
    """
    DocschemasDocBaseMeshNoIncludesResponse
    """
    data: Optional[DocschemasDocMeshNoRelationResponse] = None
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocschemasDocBaseMeshNoIncludesResponse:
        """Create an instance of DocschemasDocBaseMeshNoIncludesResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocschemasDocBaseMeshNoIncludesResponse:
        """Create an instance of DocschemasDocBaseMeshNoIncludesResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocschemasDocBaseMeshNoIncludesResponse.parse_obj(obj)

        _obj = DocschemasDocBaseMeshNoIncludesResponse.parse_obj({
            "data": DocschemasDocMeshNoRelationResponse.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
