...
class DocschemasDocAvatarAttributes(BaseModel):
    """
    DocschemasDocAvatarAttributes
    """
    created_at: Optional[StrictInt] = None
    metadata: Optional[DocschemasDocAvatarMetadata] = None
    name: Optional[StrictStr] = None
    origin: Optional[PostgresqlBuildMethod] = None
    owner: Optional[StrictStr] = None
    source: Optional[PostgresqlFileSource] = None
    source_build_id: Optional[StrictStr] = None
    state: Optional[PostgresqlAssetState] = None
    type: Optional[PostgresqlAssetType] = None
    updated_at: Optional[StrictInt] = None
    url: Optional[SchemasURLResponse] = None
    __properties = ["created_at", "metadata", "name", "origin", "owner", "source", "source_build_id", "state", "type", "updated_at", "url"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocschemasDocAvatarAttributes:
        """Create an instance of DocschemasDocAvatarAttributes from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocschemasDocAvatarAttributes:
        """Create an instance of DocschemasDocAvatarAttributes from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocschemasDocAvatarAttributes.parse_obj(obj)

        _obj = DocschemasDocAvatarAttributes.parse_obj({
            "created_at": obj.get("created_at"),
            "metadata": DocschemasDocAvatarMetadata.from_dict(obj.get("metadata")) if obj.get("metadata") is not None else None,
            "name": obj.get("name"),
            "origin": obj.get("origin"),
            "owner": obj.get("owner"),
            "source": obj.get("source"),
            "source_build_id": obj.get("source_build_id"),
            "state": obj.get("state"),
            "type": obj.get("type"),
            "updated_at": obj.get("updated_at"),
            "url": SchemasURLResponse.from_dict(obj.get("url")) if obj.get("url") is not None else None
        })
        return _obj
