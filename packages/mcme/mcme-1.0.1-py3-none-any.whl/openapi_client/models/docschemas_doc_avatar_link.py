...
class DocschemasDocAvatarLink(BaseModel):
    """
    DocschemasDocAvatarLink
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocschemasDocAvatarLink:
        """Create an instance of DocschemasDocAvatarLink from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocschemasDocAvatarLink:
        """Create an instance of DocschemasDocAvatarLink from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocschemasDocAvatarLink.parse_obj(obj)

        _obj = DocschemasDocAvatarLink.parse_obj({
