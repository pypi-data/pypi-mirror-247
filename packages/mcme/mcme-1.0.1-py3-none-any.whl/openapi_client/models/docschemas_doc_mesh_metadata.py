...
class DocschemasDocMeshMetadata(BaseModel):
    """
    DocschemasDocMeshMetadata
    """
    filetype: Optional[StrictStr] = None
    gender: Optional[StrictStr] = None
    meshtype: Optional[StrictStr] = None
    parameters: Optional[Dict[str, StrictStr]] = None
    parent_id: Optional[StrictStr] = Field(None, alias="parentID")
    __properties = ["filetype", "gender", "meshtype", "parameters", "parentID"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocschemasDocMeshMetadata:
        """Create an instance of DocschemasDocMeshMetadata from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocschemasDocMeshMetadata:
        """Create an instance of DocschemasDocMeshMetadata from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocschemasDocMeshMetadata.parse_obj(obj)

        _obj = DocschemasDocMeshMetadata.parse_obj({
            "filetype": obj.get("filetype"),
            "gender": obj.get("gender"),
            "meshtype": obj.get("meshtype"),
