...
class DocschemasDocAvatarRelationships(BaseModel):
    """
    DocschemasDocAvatarRelationships
    """
    exported_mesh: Optional[DocschemasDocAvatarRelationshipsExportedMesh] = None
    __properties = ["exported_mesh"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocschemasDocAvatarRelationships:
        """Create an instance of DocschemasDocAvatarRelationships from a JSON string"""
    ...
    def to_dict(self):
        ...
        _dict = self.dict(by_alias=True,
                          ...
                          exclude_none=True)
        # override the default output from pydantic by calling `to_dict()` of exported_mesh
        if self.exported_mesh:
            _dict['exported_mesh'] = self.exported_mesh.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> DocschemasDocAvatarRelationships:
        """Create an instance of DocschemasDocAvatarRelationships from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocschemasDocAvatarRelationships.parse_obj(obj)

        _obj = DocschemasDocAvatarRelationships.parse_obj({
            "exported_mesh": DocschemasDocAvatarRelationshipsExportedMesh.from_dict(obj.get("exported_mesh")) if obj.get("exported_mesh") is not None else None
        })
        return _obj
