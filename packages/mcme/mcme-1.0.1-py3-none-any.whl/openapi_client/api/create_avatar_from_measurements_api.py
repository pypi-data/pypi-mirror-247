...
class CreateAvatarFromMeasurementsApi(object):
    ...
    def avatar_from_measurements(self, input : Annotated[SchemasMeasurementAvatarRequest, Field(..., description="Measurements for creating avatar")], **kwargs) -> DocschemasDocBaseSingleJSONAPIResponse:  # noqa: E501
        ...
        Create an avatar from measurements. All measurements are in centimeters. See the our notion page under the section [\"What measurement standard are we using?\"\"](https://meshcapade.notion.site/Meshcapade-Me-Support-1bfab171ac8440139090abeb4f7ec95c#8fcb1d0c2de748d8bc02d19632cb70e3) for a list of all available measurements <b>This is a paid endpoint</b> and requires credits to be available on the user's account. Creating an avatar from measurements costs 100 credits. Check out the <a href=\"https://me.meshcapade.com/credits\">credits</a> page for more information on credits. \\  # noqa: E501
