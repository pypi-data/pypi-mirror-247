...
class MesherrMeshErr(BaseModel):
    """
    MesherrMeshErr
    """
    ...
    __properties = ["code", "detail", "status", "title"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MesherrMeshErr:
        """Create an instance of MesherrMeshErr from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MesherrMeshErr:
        """Create an instance of MesherrMeshErr from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MesherrMeshErr.parse_obj(obj)

        _obj = MesherrMeshErr.parse_obj({
            "code": obj.get("code"),
