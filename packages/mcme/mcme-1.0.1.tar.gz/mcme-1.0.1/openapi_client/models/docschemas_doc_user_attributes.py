...
class DocschemasDocUserAttributes(BaseModel):
    """
    DocschemasDocUserAttributes
    """
    credits: Optional[StrictInt] = None
    email: Optional[StrictStr] = None
    name: Optional[StrictStr] = None
    __properties = ["credits", "email", "name"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocschemasDocUserAttributes:
        """Create an instance of DocschemasDocUserAttributes from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocschemasDocUserAttributes:
        """Create an instance of DocschemasDocUserAttributes from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocschemasDocUserAttributes.parse_obj(obj)

        _obj = DocschemasDocUserAttributes.parse_obj({
