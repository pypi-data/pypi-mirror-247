...
class DocschemasDocMeshNoRelationResponse(BaseModel):
    """
    DocschemasDocMeshNoRelationResponse
    """
    attributes: Optional[DocschemasDocMeshAttributes] = None
    id: Optional[StrictStr] = None
    links: Optional[DocschemasDocMeshLink] = None
    type: Optional[StrictStr] = None
    __properties = ["attributes", "id", "links", "type"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocschemasDocMeshNoRelationResponse:
        """Create an instance of DocschemasDocMeshNoRelationResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocschemasDocMeshNoRelationResponse:
        """Create an instance of DocschemasDocMeshNoRelationResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocschemasDocMeshNoRelationResponse.parse_obj(obj)

        _obj = DocschemasDocMeshNoRelationResponse.parse_obj({
            "attributes": DocschemasDocMeshAttributes.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None,
            "id": obj.get("id"),
            "links": DocschemasDocMeshLink.from_dict(obj.get("links")) if obj.get("links") is not None else None,
            "type": obj.get("type")
        })
        return _obj
