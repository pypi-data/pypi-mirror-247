...
class DocschemasDocUserJSONAPIResponse(BaseModel):
    """
    DocschemasDocUserJSONAPIResponse
    """
    data: Optional[DocschemasDocUserResponse] = None
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocschemasDocUserJSONAPIResponse:
        """Create an instance of DocschemasDocUserJSONAPIResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocschemasDocUserJSONAPIResponse:
        """Create an instance of DocschemasDocUserJSONAPIResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocschemasDocUserJSONAPIResponse.parse_obj(obj)

        _obj = DocschemasDocUserJSONAPIResponse.parse_obj({
            "data": DocschemasDocUserResponse.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
