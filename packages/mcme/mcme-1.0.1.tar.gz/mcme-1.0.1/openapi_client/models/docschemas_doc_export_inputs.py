...
class DocschemasDocExportInputs(BaseModel):
    """
    DocschemasDocExportInputs
    """
    animation: Optional[StrictStr] = None
    compatibility_mode: Optional[StrictStr] = Field(None, alias="compatibilityMode")
    filename: Optional[StrictStr] = None
    format: StrictStr = Field(...)
    pose: StrictStr = Field(...)
    __properties = ["animation", "compatibilityMode", "filename", "format", "pose"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocschemasDocExportInputs:
        """Create an instance of DocschemasDocExportInputs from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocschemasDocExportInputs:
        """Create an instance of DocschemasDocExportInputs from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocschemasDocExportInputs.parse_obj(obj)

        _obj = DocschemasDocExportInputs.parse_obj({
            "animation": obj.get("animation"),
            "compatibility_mode": obj.get("compatibilityMode"),
