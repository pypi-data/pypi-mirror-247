...
class DocschemasDocMeshResponse(BaseModel):
    """
    DocschemasDocMeshResponse
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocschemasDocMeshResponse:
        """Create an instance of DocschemasDocMeshResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocschemasDocMeshResponse:
        """Create an instance of DocschemasDocMeshResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocschemasDocMeshResponse.parse_obj(obj)

        _obj = DocschemasDocMeshResponse.parse_obj({
