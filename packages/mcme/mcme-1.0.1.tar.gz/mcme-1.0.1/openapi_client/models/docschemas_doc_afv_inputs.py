...
class DocschemasDocAFVInputs(BaseModel):
    """
    DocschemasDocAFVInputs
    """
    avatarname: Optional[StrictStr] = None
    gender: Optional[StrictStr] = None
    model_version: Optional[StrictStr] = Field(None, alias="modelVersion")
    __properties = ["avatarname", "gender", "modelVersion"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocschemasDocAFVInputs:
        """Create an instance of DocschemasDocAFVInputs from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocschemasDocAFVInputs:
        """Create an instance of DocschemasDocAFVInputs from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocschemasDocAFVInputs.parse_obj(obj)

        _obj = DocschemasDocAFVInputs.parse_obj({
