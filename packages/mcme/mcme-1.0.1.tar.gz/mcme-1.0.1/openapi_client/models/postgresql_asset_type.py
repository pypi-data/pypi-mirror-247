...
class PostgresqlAssetType(str, Enum):
    """
    PostgresqlAssetType
    """
    ...
    if enumtype == str:
        ...
        AssetTypeAVATAR = "AssetTypeAVATAR"
        AssetTypeANIMATION = "AssetTypeANIMATION"
        AssetTypePOSESEQUENCE = "AssetTypePOSESEQUENCE"
        AssetTypeTEXTURE = "AssetTypeTEXTURE"
        AssetTypeMESH = "AssetTypeMESH"
        AssetTypeVIDEO = "AssetTypeVIDEO"

    @classmethod
    def from_json(cls, json_str: str) -> PostgresqlAssetType:
        """Create an instance of PostgresqlAssetType from a JSON string"""
        return PostgresqlAssetType(json.loads(json_str))


    def enum_values():
        return [c.value for c in PostgresqlAssetType]
