...
class DocschemasDocAssetResponse(BaseModel):
    """
    DocschemasDocAssetResponse
    """
    attributes: Optional[DocschemasDocAvatarAttributes] = None
    id: Optional[StrictStr] = None
    links: Optional[DocschemasDocAvatarLink] = None
    relationships: Optional[DocschemasDocAvatarRelationships] = None
    type: Optional[StrictStr] = None
    __properties = ["attributes", "id", "links", "relationships", "type"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocschemasDocAssetResponse:
        """Create an instance of DocschemasDocAssetResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocschemasDocAssetResponse:
        """Create an instance of DocschemasDocAssetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocschemasDocAssetResponse.parse_obj(obj)

        _obj = DocschemasDocAssetResponse.parse_obj({
            "attributes": DocschemasDocAvatarAttributes.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None,
            "id": obj.get("id"),
            "links": DocschemasDocAvatarLink.from_dict(obj.get("links")) if obj.get("links") is not None else None,
            "relationships": DocschemasDocAvatarRelationships.from_dict(obj.get("relationships")) if obj.get("relationships") is not None else None,
            "type": obj.get("type")
        })
        return _obj
