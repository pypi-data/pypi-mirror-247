...
class EnumsModelVersion(str, Enum):
    """
    EnumsModelVersion
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EnumsModelVersion:
        """Create an instance of EnumsModelVersion from a JSON string"""
        return EnumsModelVersion(json.loads(json_str))


    def enum_values():
        return [c.value for c in EnumsModelVersion]
