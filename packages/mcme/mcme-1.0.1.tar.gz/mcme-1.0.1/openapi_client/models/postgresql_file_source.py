...
class PostgresqlFileSource(str, Enum):
    """
    PostgresqlFileSource
    """
    ...
    if enumtype == str:
        ...
        FileSourceMESHCAPADE = "FileSourceMESHCAPADE"
        FileSourceGENERATED = "FileSourceGENERATED"
        FileSourceUPLOAD = "FileSourceUPLOAD"

    @classmethod
    def from_json(cls, json_str: str) -> PostgresqlFileSource:
        """Create an instance of PostgresqlFileSource from a JSON string"""
        return PostgresqlFileSource(json.loads(json_str))


    def enum_values():
        return [c.value for c in PostgresqlFileSource]
