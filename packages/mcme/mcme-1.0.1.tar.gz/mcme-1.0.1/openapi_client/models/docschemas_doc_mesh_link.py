...
class DocschemasDocMeshLink(BaseModel):
    """
    DocschemasDocMeshLink
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocschemasDocMeshLink:
        """Create an instance of DocschemasDocMeshLink from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocschemasDocMeshLink:
        """Create an instance of DocschemasDocMeshLink from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocschemasDocMeshLink.parse_obj(obj)

        _obj = DocschemasDocMeshLink.parse_obj({
