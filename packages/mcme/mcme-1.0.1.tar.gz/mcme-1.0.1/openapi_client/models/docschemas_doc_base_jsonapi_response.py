...
class DocschemasDocBaseJSONAPIResponse(BaseModel):
    """
    DocschemasDocBaseJSONAPIResponse
    """
    data: Optional[conlist(DocschemasDocAssetResponse)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocschemasDocBaseJSONAPIResponse:
        """Create an instance of DocschemasDocBaseJSONAPIResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocschemasDocBaseJSONAPIResponse:
        """Create an instance of DocschemasDocBaseJSONAPIResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocschemasDocBaseJSONAPIResponse.parse_obj(obj)

        _obj = DocschemasDocBaseJSONAPIResponse.parse_obj({
            "data": [DocschemasDocAssetResponse.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
