...
class DocschemasDocAFIInputs(BaseModel):
    """
    ...
    image_mode: Optional[StrictStr] = Field(None, alias="imageMode")
    weight: Optional[Union[StrictFloat, StrictInt]] = None
    __properties = ["avatarname", "gender", "height", "imageMode", "weight"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocschemasDocAFIInputs:
        """Create an instance of DocschemasDocAFIInputs from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocschemasDocAFIInputs:
        """Create an instance of DocschemasDocAFIInputs from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocschemasDocAFIInputs.parse_obj(obj)

        _obj = DocschemasDocAFIInputs.parse_obj({
            "avatarname": obj.get("avatarname"),
            "gender": obj.get("gender"),
            "height": obj.get("height"),
            "image_mode": obj.get("imageMode"),
