...
class DocschemasDocBaseSingleJSONAPIResponse(BaseModel):
    """
    DocschemasDocBaseSingleJSONAPIResponse
    """
    data: Optional[DocschemasDocAssetResponse] = None
    included: Optional[conlist(DocschemasDocMeshResponse)] = None
    __properties = ["data", "included"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocschemasDocBaseSingleJSONAPIResponse:
        """Create an instance of DocschemasDocBaseSingleJSONAPIResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocschemasDocBaseSingleJSONAPIResponse:
        """Create an instance of DocschemasDocBaseSingleJSONAPIResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocschemasDocBaseSingleJSONAPIResponse.parse_obj(obj)

        _obj = DocschemasDocBaseSingleJSONAPIResponse.parse_obj({
            "data": DocschemasDocAssetResponse.from_dict(obj.get("data")) if obj.get("data") is not None else None,
            "included": [DocschemasDocMeshResponse.from_dict(_item) for _item in obj.get("included")] if obj.get("included") is not None else None
        })
        return _obj
