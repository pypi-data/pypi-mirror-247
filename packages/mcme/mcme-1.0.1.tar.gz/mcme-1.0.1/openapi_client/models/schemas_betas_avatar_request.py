...
class SchemasBetasAvatarRequest(BaseModel):
    """
    SchemasBetasAvatarRequest
    """
    betas: Optional[conlist(Union[StrictFloat, StrictInt])] = None
    gender: Optional[EnumsGender] = None
    input_measurements: Optional[Dict[str, Union[StrictFloat, StrictInt]]] = None
    model_version: Optional[EnumsModelVersion] = Field(None, alias="modelVersion")
    name: Optional[StrictStr] = None
    poses: Optional[conlist(conlist(Union[StrictFloat, StrictInt]))] = None
    predicted_measurements: Optional[Dict[str, Union[StrictFloat, StrictInt]]] = None
    __properties = ["betas", "gender", "input_measurements", "modelVersion", "name", "poses", "predicted_measurements"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SchemasBetasAvatarRequest:
        """Create an instance of SchemasBetasAvatarRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SchemasBetasAvatarRequest:
        """Create an instance of SchemasBetasAvatarRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SchemasBetasAvatarRequest.parse_obj(obj)

        _obj = SchemasBetasAvatarRequest.parse_obj({
            "betas": obj.get("betas"),
            "gender": obj.get("gender"),
            "input_measurements": obj.get("input_measurements"),
            "model_version": obj.get("modelVersion"),
            "name": obj.get("name"),
            "poses": obj.get("poses"),
            "predicted_measurements": obj.get("predicted_measurements")
        })
        return _obj
