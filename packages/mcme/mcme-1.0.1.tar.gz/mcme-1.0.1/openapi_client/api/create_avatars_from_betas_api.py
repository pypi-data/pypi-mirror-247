...
class CreateAvatarsFromBetasApi(object):
    ...
    @validate_arguments
    def create_avatar_from_betas(self, betas_request : Annotated[SchemasBetasAvatarRequest, Field(..., description="Betas for creating avatar")], **kwargs) -> DocschemasDocBaseSingleJSONAPIResponse:  # noqa: E501
        """Creates avatar from betas  # noqa: E501

        Creates an avatar from shape parameters. The betas are used to create a SMPL model. <b>This is a paid endpoint</b> and requires credits to be available on the user's account. Creating an avatar from shape betas costs 100 credits. Check out the <a href=\"https://me.meshcapade.com/credits\">credits</a> page for more information on credits. \\  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_avatar_from_betas(betas_request, async_req=True)
        >>> result = thread.get()

        :param betas_request: Betas for creating avatar (required)
        :type betas_request: SchemasBetasAvatarRequest
        ...
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the create_avatar_from_betas_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.create_avatar_from_betas_with_http_info(betas_request, **kwargs)  # noqa: E501

    @validate_arguments
    def create_avatar_from_betas_with_http_info(self, betas_request : Annotated[SchemasBetasAvatarRequest, Field(..., description="Betas for creating avatar")], **kwargs) -> ApiResponse:  # noqa: E501
        """Creates avatar from betas  # noqa: E501
        ...
        >>> thread = api.create_avatar_from_betas_with_http_info(betas_request, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method create_avatar_from_betas" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _body_params = None
        if _params['betas_request'] is not None:
            _body_params = _params['betas_request']
        ...
        return self.api_client.call_api(
            '/avatars/create/from-betas', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
