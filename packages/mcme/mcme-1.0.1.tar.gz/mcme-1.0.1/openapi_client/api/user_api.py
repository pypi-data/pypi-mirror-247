...
class UserApi(object):
    ...
    @validate_arguments
    def describe_user(self, **kwargs) -> DocschemasDocUserJSONAPIResponse:  # noqa: E501
        """Describes the user  # noqa: E501

        Describe the user name, email, and credit balance  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.describe_user(async_req=True)
        >>> result = thread.get()
        ...
        :rtype: DocschemasDocUserJSONAPIResponse
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the describe_user_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.describe_user_with_http_info(**kwargs)  # noqa: E501

    @validate_arguments
    def describe_user_with_http_info(self, **kwargs) -> ApiResponse:  # noqa: E501
        """Describes the user  # noqa: E501
        ...
        >>> thread = api.describe_user_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(DocschemasDocUserJSONAPIResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        _response_types_map = {
            '200': "DocschemasDocUserJSONAPIResponse",
            '404': "MesherrMeshErr",
        }
