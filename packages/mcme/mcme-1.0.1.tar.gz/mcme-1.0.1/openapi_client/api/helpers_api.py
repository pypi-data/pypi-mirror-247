...
class HelpersApi(object):
    ...
    @validate_arguments
    def random_name(self, amount : Annotated[Optional[StrictInt], Field(description="Number of generated random names")] = None, **kwargs) -> None:  # noqa: E501
        """Generate random asset names  # noqa: E501

        Generates a random asset name based on colors, adjectives and an animal name  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.random_name(amount, async_req=True)
        >>> result = thread.get()

        :param amount: Number of generated random names
        :type amount: int
        ...
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the random_name_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.random_name_with_http_info(amount, **kwargs)  # noqa: E501

    @validate_arguments
    def random_name_with_http_info(self, amount : Annotated[Optional[StrictInt], Field(description="Number of generated random names")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Generate random asset names  # noqa: E501
        ...
        >>> thread = api.random_name_with_http_info(amount, async_req=True)
        >>> result = thread.get()
