...
class AvatarsApi(object):
    ...
    def export_avatar(self, asset_id : Annotated[StrictStr, Field(..., description="Avatar ID")], input : Annotated[DocschemasDocExportInputs, Field(..., description="Request parameters")], **kwargs) -> DocschemasDocBaseMeshNoIncludesResponse:  # noqa: E501
        ...
        This endpoint exports avatars from the SMPL representation to obj or fbx format with different poses. Upon requesting this endpoint, an export job is triggered which completes after a short period of time. Once the export job is ready, the exported avatar can be downloaded by reading the url attribute and requesting the file from the specified URL. </br> The request returns a Mesh Asset with the status attribute `EMPTY`, `PENDING`, `PROCESSING` or `READY` </br> Use the `self` link of the returned asset to request the status of the export job. `GET /meshes/{meshID}` \\ Once the export job is ready, you can download the exported avatar by reading out the `url` attribute and request the file from the url within. Alternatively, you can check the status of the export job by calling the same`POST /avatar/{avatarID}/export` endpoint with the same body parameters until the `status` attribute is `READY`. Valid `pose` values for obj exports are: `t`, `a`, `u`, `i`. If the created avatar was created from images, ( It has the attribute `origin=\"AFI\"` ) then the pose `scan`  is also valid.\\ Valid `pose` values for FBX exports are: `t`, `a`, `u`, `i` \\ FBX exports also support animations. To export animations, set the `animation` a valid animation string. If `animation` is supplied, `pose` will be ignored \\ Valid `animation` values are: `a-walk`, and `a-salsa`. \\  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    @validate_arguments
    def list_avatars(self, include : Annotated[Optional[StrictStr], Field(description="Comma separated tags to include as relationships")] = None, limit : Annotated[Optional[conint(strict=True, ge=1)], Field(description="Paginated avatar limit amount (Default 20)")] = None, page : Annotated[Optional[conint(strict=True, ge=1)], Field(description="Pagination")] = None, **kwargs) -> DocschemasDocBaseJSONAPIResponse:  # noqa: E501
        ...
        >>> thread = api.list_avatars(include, limit, page, async_req=True)
        >>> result = thread.get()
        ...
        return self.list_avatars_with_http_info(include, limit, page, **kwargs)  # noqa: E501

    @validate_arguments
    def list_avatars_with_http_info(self, include : Annotated[Optional[StrictStr], Field(description="Comma separated tags to include as relationships")] = None, limit : Annotated[Optional[conint(strict=True, ge=1)], Field(description="Paginated avatar limit amount (Default 20)")] = None, page : Annotated[Optional[conint(strict=True, ge=1)], Field(description="Pagination")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """List all Avatars  # noqa: E501
        ...
        >>> thread = api.list_avatars_with_http_info(include, limit, page, async_req=True)
        >>> result = thread.get()
    ...
    def upload_preview_image_to_avatar(self, asset_id : Annotated[StrictStr, Field(..., description="Avatar ID")], **kwargs) -> None:  # noqa: E501
        ...
        Requests upload URL for a preview image. Links the preview image asset up with the avatar asset.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
