...
class CreateAvatarFromVideoApi(object):
    ...
    def create_avatar_from_video(self, **kwargs) -> DocschemasDocBaseSingleJSONAPIResponse:  # noqa: E501
        ...
        Constructs an empty avatar in preparation for creating an avatar from video. Part of the reply is a link for uploading Video for the avatar the client wants to create. </br> Request video uploads from [POST /avatars/{assetID}/video](#post-/avatars/-assetID-/video) </br> Start the process by calling [POST /avatars/{assetID}/fit-to-video](#post-/avatars/-assetID-/fit-to-video)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
