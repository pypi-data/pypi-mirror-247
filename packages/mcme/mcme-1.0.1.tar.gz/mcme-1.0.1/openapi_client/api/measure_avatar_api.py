...
class MeasureAvatarApi(object):
    ...
    @validate_arguments
    def measure_avatar(self, asset_id : Annotated[StrictStr, Field(..., description="Avatar ID")], **kwargs) -> DocschemasDocBaseJSONAPIResponse:  # noqa: E501
        """Measure Avatar  # noqa: E501

        Starts the measurement process that measures an avatar with state `READY`. </br> After a couple of seconds, the <a href=\"https://meshcapade.notion.site/Meshcapade-Me-Support-1bfab171ac8440139090abeb4f7ec95c#56681b8959674319860a209e62e0bfed\" target=\"_blank\">measurements</a>  will be included in the avatar metadata as entry `mesh_measurements`. To look up the avatar metadata you can list the avatar using the `GET /avatars/{assetID}` endpoint.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.measure_avatar(asset_id, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the measure_avatar_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.measure_avatar_with_http_info(asset_id, **kwargs)  # noqa: E501

    @validate_arguments
    def measure_avatar_with_http_info(self, asset_id : Annotated[StrictStr, Field(..., description="Avatar ID")], **kwargs) -> ApiResponse:  # noqa: E501
        """Measure Avatar  # noqa: E501
        ...
        >>> thread = api.measure_avatar_with_http_info(asset_id, async_req=True)
        >>> result = thread.get()
