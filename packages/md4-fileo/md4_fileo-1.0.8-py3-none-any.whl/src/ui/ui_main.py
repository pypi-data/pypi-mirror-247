...
class Ui_Sho(object):
    def setupUi(self, Sho):
        ...
        self.btnScan = QtWidgets.QToolButton(parent=self.toolBar)
        ...
        self.msg = QtWidgets.QLabel(parent=self.status)
        self.msg.setText("")
    ...
    def retranslateUi(self, Sho):
        ...
        self.recent_files.setToolTip(_translate("Sho", "List of recent files"))
        ...
        self.db_name.setToolTip(_translate("Sho", "Opened DB"))
        self.edited_file.setToolTip(_translate("Sho", "name of the file whose note is being edited"))
        self.current_filename.setToolTip(_translate("Sho", "Current file name"))
        self.folder_path.setToolTip(_translate("Sho", "Current branch of the folder tree"))
        self.file_count.setToolTip(_translate("Sho", "number of files in the list"))
