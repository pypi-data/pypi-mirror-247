...
@LastEditTime: 2023-11-23 10:13:47
...
class ErpConsoleModel():
    ...
    def __init__(self):
        ...
        """
        self.db_connect_key = "db_order" if config.get_value("db_order") else "db_cloudapp"
        self.redis_config_dict = config.get_value("redis_order") if config.get_value("redis_order") else None
