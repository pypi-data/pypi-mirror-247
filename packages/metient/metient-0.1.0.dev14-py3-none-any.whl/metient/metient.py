...
def evaluate(T, ref, var, ordered_sites, primary_site, node_idx_to_label,
             weights, print_config, output_dir, run_name, G=None, O=None, batch_size=1024, 
...
def calibrate(Ts, ref_matrices, var_matrices, ordered_sites, primary_sites, node_idx_to_labels,
              ...
              batch_size=1024, custom_colors=None, weight_init_primary=True,  solve_polytomies=False):
...
class Weights:
    def __init__(self,  mig=10.0, comig=5.0, seed_site=1.0, gen_dist=0.0, organotrop=0.0, data_fit=0.2, reg=2.0, entropy=0.1):
