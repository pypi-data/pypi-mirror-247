...
if TYPE_CHECKING:
    from BotnoiDevPlatform.operators.BotOpt import BotOperator
    from BotnoiDevPlatform.channels.BotChannel import BotChannel
...
class Bot:
    ...
    def reload(self) -> None:
        ...
        """
        from BotnoiDevPlatform.BotnoiChatbotServer import BotnoiChatbotServer
