...
if TYPE_CHECKING:
    from BotnoiDevPlatform.BotnoiClient import BotnoiClient
    from BotnoiDevPlatform.elements.Bot import Bot
    from BotnoiDevPlatform.elements.IntentKeyword import IntentKeyword
    from BotnoiDevPlatform.elements.IntentReaction import IntentReaction
    from BotnoiDevPlatform.elements.Intent import Intent
