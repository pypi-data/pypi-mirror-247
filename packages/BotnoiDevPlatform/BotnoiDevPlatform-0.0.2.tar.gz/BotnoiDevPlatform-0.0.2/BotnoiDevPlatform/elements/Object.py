...
if TYPE_CHECKING:
    from BotnoiDevPlatform.elements.Bot import Bot
    from BotnoiDevPlatform.elements.ImageObject import ImageObject
    from BotnoiDevPlatform.elements.AudioObject import AudioObject
    from BotnoiDevPlatform.elements.ApiObject import ApiObject
    from BotnoiDevPlatform.elements.ButtonObject import ButtonObject
    from BotnoiDevPlatform.elements.CustomPayloadObject import CustomPayloadObject
    from BotnoiDevPlatform.elements.DialogueObject import DialogueObject
    from BotnoiDevPlatform.elements.CarouselObject import CarouselObject
    from BotnoiDevPlatform.utils.ObjectType import ObjectType
    from BotnoiDevPlatform.utils.ObjectNamer import ObjectNamer
