...
class HybridWeaviate(VectorStore):
    ...
    def __init__(
        ...
        # self._query_attrs = [self._text_key, 'source', 'page_number', 'link', 'bounding_regions']
    ...
    def similarity_search(
        ...
        """
        rerank_param = f"""rerank(property: "{self._text_key}" query: "{query}") {{ score }}"""
        kwargs['additional'] = rerank_param
        if self._by_text:
    ...
    def similarity_search_by_text(
        ...
        if kwargs.get("hybrid_search_kwargs"):
            hybrid_search_kwargs = kwargs.get("hybrid_search_kwargs")
        else:
