...
class TestAlbums(unittest.TestCase):
    ...
    def test_release_date_formatting(self):
        releases = self.export.Album.get_range(datetime(2023, 11, 29), datetime(2023, 11, 29))
    ...
    def test_range(self):
        ...
        releases = export.Album.get_range(datetime(1990, 1, 1), datetime(1990, 1, 31), 
                                          verbose=True)
        self.assertIsNotNone(releases)
    ...
    def test_album_release(self):
        ...
        releases = export.Album.get_range(datetime(2023, 8, 11), 
                                          datetime(2023, 8, 11), 
                                          verbose=True)
        ...
        self.assertIsInstance(album_release.genres, interface.Subgenres)
