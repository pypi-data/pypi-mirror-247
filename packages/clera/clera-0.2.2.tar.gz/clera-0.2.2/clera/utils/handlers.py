...
class Processor:
    ...
    def start(self, func):
        self.process = Process().run(func)
        threadpool = self.threadpool.globalInstance()
        threadpool.start(self.process)
...
def FUSION_CONTROLS():
    ...
    return CONTROL_MINIMIZED, CONTROL_RESTORE, CONTROL_MAXIMIZED, CONTROL_CLOSE, CLOSE_EMPTY, MAXIMIZE_EMPTY, MINIMIZE_EMPTY
...
def WINDOWS_CONTROLS():
    ...
    return CONTROL_MINIMIZED, CONTROL_RESTORE, CONTROL_MAXIMIZED, CONTROL_CLOSE
