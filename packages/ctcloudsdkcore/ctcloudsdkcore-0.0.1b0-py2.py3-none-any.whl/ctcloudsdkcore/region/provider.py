...
from ctcloudsdkcore.region.cache import ProfileRegionCache, EnvRegionCache
from ctcloudsdkcore.region.region import Region

from ctcloudsdkcore.utils import six_utils
...
class EnvRegionProvider(RegionProvider):
    _REGION_ENV_PREFIX = "CTCLOUD_SDK_REGION"
