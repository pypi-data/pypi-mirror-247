...
from ctcloudsdkcore.auth.credentials import BasicCredentials, DerivedCredentials
from ctcloudsdkcore.auth.provider import CredentialProviderChain
from ctcloudsdkcore.exceptions.exceptions import HostUnreachableException
from ctcloudsdkcore.exceptions.exception_handler import ExceptionHandler, DefaultExceptionHandler
from ctcloudsdkcore.http import progress
from ctcloudsdkcore.http.formdata import FormFile
from ctcloudsdkcore.http.http_client import HttpClient
from ctcloudsdkcore.http.http_config import HttpConfig
from ctcloudsdkcore.http.http_handler import HttpHandler
from ctcloudsdkcore.http.primitive_types import NATIVE_TYPES_MAPPING
from ctcloudsdkcore.http.primitive_types import PRIMITIVE_TYPES
from ctcloudsdkcore.sdk_request import SdkRequest
from ctcloudsdkcore.sdk_response import FutureSdkResponse, SdkResponse
from ctcloudsdkcore.sdk_stream_response import SdkStreamResponse
from ctcloudsdkcore.utils import http_utils, core_utils
from ctcloudsdkcore.utils.filepath_utils import ensure_file_in_rb_mode
from ctcloudsdkcore.utils.xml_utils import XmlTransfer
...
class ClientBuilder(Generic[T]):
    ...
    def with_http_config(self, config):
        ...
        :type config: :class:`ctcloudsdkcore.http.http_config.HttpConfig`
        """
        self._config = config
        return self
    ...
    def with_credentials(self, credentials):
        ...
        :type credentials: :class:`ctcloudsdkcore.auth.credentials.Credentials`
        """
    ...
    def with_region(self, region):
        ...
        :type region: :class:`ctcloudsdkcore.region.region.Region`
        """
        self._region = region
        return self
    ...
    def with_exception_handler(self, exception_handler):
        ...
        :type exception_handler: :class:`ctcloudsdkcore.exceptions.exception_handler.ExceptionHandler`
        """
    ...
    def with_http_handler(self, http_handler):
        ...
        :type http_handler: :class:`ctcloudsdkcore.http.http_handler.HttpHandler`
        """
...
class Client(object):
    ...
    def __init__(self):
        self.preset_headers = {}
        self._agent = {"User-Agent": "ctcloud-usdk-python/3.0"}
    ...
    def _init_logger(cls):
        logger_name = 'CtCloud-SDK-%s' % cls.__name__
