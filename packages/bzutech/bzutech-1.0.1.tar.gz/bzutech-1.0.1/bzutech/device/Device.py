...
class Device:
    def __init__(self, chipid: int, token: str, dispname: str = "" ):
        self.chipid = chipid
        self.dispname = dispname
        self.httpheaders = {"Authorization": token} 
        self.sensores = {}
    ...
    def get_readings(self, nome_sensor):
        asyncio.run(self.sensores[nome_sensor].get_leitura())
