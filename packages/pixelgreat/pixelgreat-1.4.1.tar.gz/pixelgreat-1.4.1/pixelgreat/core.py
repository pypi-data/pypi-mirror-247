...
def parse_args_video():
    ...
    parser.add_argument("-i", "--input", dest="video_in", type=helpers.file_path, required=True,
                        help="the video to convert"
                        )

    parser.add_argument("-o", "--output", dest="video_out", type=str, required=True,
                        help="where to save the converted video, and what filetype to save it as"
                        )
...
def video():
    ...
    print("Preparing to process video...")
    ...
    # Get the size and color mode of the first image
    first_image_size = #TODO
    first_image_mode = #TODO
    ...
    # Open the destination video file
    #TODO

    # Loop through the frames
    image_count = #TODO
    for i, frame in enumerate():
        print(f"Converting frame {i + 1} of {image_count}...")

        # Open image
        frame_in = #TODO

        # Convert the image with the reusable converter
        frame_out = converter.apply(frame_in)
