...
# For docs/conf.py
project = "requirements-language-server"
author = """Wu Zhenyu <wuzhenyu@ustc.edu> """
copyright = "2023"

# For help2man
DESCRIPTION = "requirements.txt language server"
EPILOG = "Report bugs to https://github.com/Freed-Wu/requirements-language-server/issues"
# format __version__ by yourself
VERSION = """requirements-language-server {__version__}
Copyright (C) 2023
