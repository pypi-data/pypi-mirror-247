...
from finbourne_identity.extensions.retry import (
    RetryingRestWrapper,
...
from finbourne_identity.extensions.tcp_keep_alive_connector import (
...
class SyncApiClientFactory:
    ...
    def build(
        ...
        ----------
        metaclass : Type[T]
            A finbourne_identity.api class.


        Returns
        -------
        T
            An instance of the finbourne_identity.api class with a configured ApiClient
        """
