"""
Defines TS API v1.3 Base Page model
"""
...
class Page(ModelBase):
    """
    This is the base class used to define default methods and attributes for all
    classes which will be used for pagination of the TruSTAR public API.
    ...
    def get_generator(cls, page_generator):
        """
        Gets a generator for retrieving all results from a paginated endpoint.
        Pass exactly one of `page_generator` or `func`.  This method is intended
        for internal use.
