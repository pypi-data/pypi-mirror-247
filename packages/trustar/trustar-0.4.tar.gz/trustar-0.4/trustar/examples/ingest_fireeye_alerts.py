"""
TS SDK v1 Ingest Alerts example for ingesting FireEye Alerts into reports

Process a FireEye alerts API export csv and convert each row to an incident
report and submitting to TruSTAR
"""
