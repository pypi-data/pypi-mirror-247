"""
Implements TS API v1.3 Tags protocols
"""
...
from protocols.tags_protocol import TagsAPI


logger = get_logger(__name__)


class TagClient(TagsAPI):
    """
    Class which implements TruSTAR API v1.3 Tags protocols

    Tags: https://docs.trustar.co/api/v13/tags/index.html
    """

    def __init__(self, api_client: APIClient=None):
        """
        Constructs a |TagClient| object
        """
        self._api_client = api_client

    def get_enclave_tags(self, report_id, id_type=None):
        """
        Retrieves all enclave tags present in a specific reports
        ...
        resp = self._api_client.get(f"reports/{report_id}/tags", params=params)
    ...
    def alter_report_tags(self, report_id, added_tags, removed_tags, id_type=None):
        """
        Bulks add/remove tags from a report.
        ...
        resp = self._api_client.post(f"reports/{report_id}/alter-tags",
                                     params=params,
    ...
    def delete_enclave_tag(self, report_id, tag_id, id_type=None):
        ...
        :param string tag_id: name of the tag to delete
            NOTE: Report tags no longer have IDs, instead the name of the tag
            serves as its ID. Pass the name of the tag to delete in this field
        :param string id_type: indicates whether the ID internal or an external
    ...
    def get_all_enclave_tags(self, enclave_ids=None):
        """
        Retrieves all tags present in the given enclaves. If the enclave list
        is empty, the tags returned include all tags for all enclaves the user has
        access to
        ...
        resp = self._api_client.get("reports/tags", params=params)
    ...
    def get_all_indicator_tags(self, enclave_ids=None):
        ...
        params = {'enclaveIds': enclave_ids}
        resp = self._api_client.get("indicators/tags", params=params)
    ...
    def add_indicator_tag(self, indicator_value, name, enclave_id):
        ...
        resp = self._api_client.post("indicators/tags", data=json.dumps(data))
    ...
    def delete_indicator_tag(self, indicator_value, tag_id):
        ...
        self._api_client.delete(f"indicators/tags/{tag_id}", params=params)
