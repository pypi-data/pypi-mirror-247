...
from finbourne_insights.extensions.retry import (
    RetryingRestWrapper,
...
from finbourne_insights.extensions.socket_keep_alive import keep_alive_socket_options
from finbourne_insights.extensions.tcp_keep_alive_connector import (
...
class SyncApiClientFactory:
    ...
    def build(
        ...
        ----------
        metaclass : Type[T]
            A finbourne_insights.api class.


        Returns
        -------
        T
            An instance of the finbourne_insights.api class with a configured ApiClient
        """
