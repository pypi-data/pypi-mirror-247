...
class DistortionCorrection(betterproto.ServiceStub):
    ...
    async def async_enable(
        ...
        will be taken, otherwise the factory configuration will be used. NOTE:
        Enabling the distortion correction is persistent, meaning it will still
        be enabled after reboot.
        """
