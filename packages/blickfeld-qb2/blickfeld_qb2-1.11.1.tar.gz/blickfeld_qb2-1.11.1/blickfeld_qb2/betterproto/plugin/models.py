...
from blickfeld_qb2.betterproto import which_one_of
from blickfeld_qb2.betterproto.casing import sanitize_name
from blickfeld_qb2.betterproto.compile.importing import (
    get_type_reference,
    parse_source_type_name,
)
from blickfeld_qb2.betterproto.compile.naming import (
    pythonize_class_name,
    pythonize_field_name,
    pythonize_method_name,
)
from blickfeld_qb2.betterproto.lib.google.protobuf import (
    DescriptorProto,
    EnumDescriptorProto,
    FileDescriptorProto,
...
from blickfeld_qb2.betterproto.lib.google.protobuf.compiler import CodeGeneratorRequest
...
class FieldCompiler(MessageCompiler):
    ...
    def add_imports_to(self, output_file: OutputTemplate) -> None:
        ...
        if self.proto_obj.options.blickfeld_base_numpy_dtype:
            output_file.imports.add("import numpy as np")
...
class ServiceMethodCompiler(ProtoContentBase):
    ...
    def __post_init__(self) -> None:
        ...
        self.output_file.imports.add("import asyncio")
