...
PARSER.add_argument('--host', type=str, default=environ.get('HOST', '192.168.1.200'))
PARSER.add_argument('--port', type=int, default=environ.get('PORT', 22))
PARSER.add_argument('--username', type=str, default=environ.get('USER', 'root'))
PARSER.add_argument('--password', type=str, default=environ.get('PASS', 'elite2014'))
