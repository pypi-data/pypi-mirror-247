...
def create_artifacts(meta_dir: Path):
    decorators = decorator.collect_patterns(meta_dir)
    axioms = axiom.collect_patterns(meta_dir)
    monies = money.collect_patterns(meta_dir)
