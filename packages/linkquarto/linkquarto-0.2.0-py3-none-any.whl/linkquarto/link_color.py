...
def affiche_freq(y,xlab,ylab,titre):
    """
    Cette fonction affiche un value_counts
    params:
...
def affiche_freq(y,xlab,ylab,titre, pal):
    """
    Cette fonction affiche un value_counts
    params:
        y : la colonne à afficher
...
class Mise_enforme:
    ...
    def __init__(self) -> None:
        ...
        self.lkp_purple = rgb_to_hex(148, 0, 113)
