...
from .summarize_private_huggingface import summarize_private_huggingface_textsplitter
...
class textsplitter(textpart):
    ...
    def __init__(self):
        ...
        self.VERSION = "2.0.6"                # To keep track on which version (selection rules) was used in the analysis.
    ...
    summarize_private_huggingface = summarize_private_huggingface_textsplitter
