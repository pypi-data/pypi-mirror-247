...
class VisualizationConfig:
    ...
    default_illustration_color: Incomplete
    default_proximity_color: Incomplete
    delete_on_initialization_event: Incomplete
    enable_alpha_sliders: Incomplete
    enable_meshcat_creation: Incomplete
    lcm_bus: Incomplete
    publish_contacts: Incomplete
    publish_illustration: Incomplete
    publish_inertia: Incomplete
    publish_period: Incomplete
    publish_proximity: Incomplete
