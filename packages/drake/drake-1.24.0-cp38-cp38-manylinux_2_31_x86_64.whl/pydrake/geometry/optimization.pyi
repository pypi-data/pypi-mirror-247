...
class GraphOfConvexSetsOptions:
    _pybind11_del_orig: ClassVar[None] = ...
    convex_relaxation: Incomplete
    flow_tolerance: Incomplete
    max_rounded_paths: Incomplete
    max_rounding_trials: Incomplete
    preprocessing: Incomplete
    rounding_seed: Incomplete
    rounding_solver_options: Incomplete
    solver: Incomplete
...
class IrisOptions:
    _pybind11_del_orig: ClassVar[None] = ...
    bounding_region: Incomplete
    configuration_obstacles: Incomplete
    configuration_space_margin: Incomplete
    iteration_limit: Incomplete
    num_additional_constraint_infeasible_samples: Incomplete
    num_collision_infeasible_samples: Incomplete
    prog_with_additional_constraints: Incomplete
    random_seed: Incomplete
    relative_termination_threshold: Incomplete
    require_sample_point_is_contained: Incomplete
    starting_ellipse: Incomplete
    termination_threshold: Incomplete
    def __init__(self) -> None: ...
    def __del__(self, *args, **kwargs) -> None: ...
