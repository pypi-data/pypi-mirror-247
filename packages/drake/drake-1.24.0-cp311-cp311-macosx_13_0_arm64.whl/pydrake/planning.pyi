...
class CollisionChecker:
    ...
    def AddCollisionShapeToBody(self, group_name: str, bodyA: pydrake.multibody.tree.Body, shape: pydrake.geometry.Shape, X_AG: pydrake.math.RigidTransform) -> bool: ...
    ...
    @overload
    def GetPaddingBetween(self, bodyA: pydrake.multibody.tree.Body, bodyB: pydrake.multibody.tree.Body) -> float: ...
    ...
    @overload
    def IsCollisionFilteredBetween(self, bodyA: pydrake.multibody.tree.Body, bodyB: pydrake.multibody.tree.Body) -> bool: ...
    @overload
    def IsPartOfRobot(self, body: pydrake.multibody.tree.Body) -> bool: ...
    @overload
    ...
    @overload
    def SetCollisionFilteredBetween(self, bodyA: pydrake.multibody.tree.Body, bodyB: pydrake.multibody.tree.Body, filter_collision: bool) -> None: ...
    @overload
    def SetCollisionFilteredWithAllBodies(self, body_index: pydrake.multibody.tree.BodyIndex) -> None: ...
    @overload
    def SetCollisionFilteredWithAllBodies(self, body: pydrake.multibody.tree.Body) -> None: ...
    ...
    @overload
    def SetPaddingBetween(self, bodyA: pydrake.multibody.tree.Body, bodyB: pydrake.multibody.tree.Body, padding: float) -> None: ...
...
class CollisionCheckerParams:
    configuration_distance_function: Incomplete
    distance_and_interpolation_provider: Incomplete
    edge_step_size: Incomplete
    env_collision_padding: Incomplete
    implicit_context_parallelism: Incomplete
    model: Incomplete
    robot_model_instances: Incomplete
    self_collision_padding: Incomplete
    @overload
