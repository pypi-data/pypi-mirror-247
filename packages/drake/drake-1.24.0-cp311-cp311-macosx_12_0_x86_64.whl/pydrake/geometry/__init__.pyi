...
class DrakeVisualizerParams:
    ...
    publish_period: Incomplete
    role: Incomplete
    show_hydroelastic: Incomplete
    use_role_channel_suffix: Incomplete
...
class MeshcatParams:
    ...
    host: Incomplete
    port: Incomplete
    show_stats_plot: Incomplete
    web_url_pattern: Incomplete
    def __init__(self, **kwargs) -> None: ...
...
class MeshcatVisualizerParams:
    ...
    _pybind11_del_orig: ClassVar[None] = ...
    default_color: Incomplete
    delete_on_initialization_event: Incomplete
    enable_alpha_slider: Incomplete
    include_unspecified_accepting: Any
    prefix: Incomplete
    publish_period: Incomplete
    role: Incomplete
    show_hydroelastic: Incomplete
    visible_by_default: Incomplete
    def __init__(self, **kwargs) -> None: ...
...
class RenderEngineGlParams:
    __fields__: ClassVar[tuple] = ...  # read-only
    _pybind11_del_orig: ClassVar[None] = ...
    default_clear_color: Incomplete
    default_diffuse: Incomplete
    lights: Incomplete
    def __init__(self, **kwargs) -> None: ...
