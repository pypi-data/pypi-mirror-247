...
class MultibodyPlantConfig:
    ...
    adjacent_bodies_collision_filters: Incomplete
    contact_model: Incomplete
    contact_surface_representation: Incomplete
    discrete_contact_approximation: Incomplete
    discrete_contact_solver: Incomplete
    penetration_allowance: Incomplete
    sap_near_rigid_threshold: Incomplete
    stiction_tolerance: Incomplete
...
class MultibodyPlant_𝓣AutoDiffXd𝓤(pydrake.systems.framework.LeafSystem_TAutoDiffXdU):
    ...
    _original_qualname: ClassVar[str] = ...
    def __init__(self, time_step: float) -> None: ...
    def AddBallConstraint(self, body_A: pydrake.multibody.tree.Body_TAutoDiffXdU, p_AP: numpy.ndarray[numpy.float64[3, 1]], body_B: pydrake.multibody.tree.Body_TAutoDiffXdU, p_BQ: numpy.ndarray[numpy.float64[3, 1]]) -> pydrake.multibody.tree.MultibodyConstraintId: ...
    ...
    def AddDistanceConstraint(self, body_A: pydrake.multibody.tree.Body_TAutoDiffXdU, p_AP: numpy.ndarray[numpy.float64[3, 1]], body_B: pydrake.multibody.tree.Body_TAutoDiffXdU, p_BQ: numpy.ndarray[numpy.float64[3, 1]], distance: float, stiffness: float = ..., damping: float = ...) -> pydrake.multibody.tree.MultibodyConstraintId: ...
    ...
    def AddWeldConstraint(self, body_A: pydrake.multibody.tree.Body_TAutoDiffXdU, X_AP: pydrake.math.RigidTransform, body_B: pydrake.multibody.tree.Body_TAutoDiffXdU, X_BQ: pydrake.math.RigidTransform) -> pydrake.multibody.tree.MultibodyConstraintId: ...
    ...
    @overload
    def CollectRegisteredGeometries(self, bodies: List[pydrake.multibody.tree.Body_TAutoDiffXdU]) -> pydrake.geometry.GeometrySet: ...
    @overload
    def CollectRegisteredGeometries(self, bodies) -> Any: ...
    def EvalBodyPoseInWorld(self, context: pydrake.systems.framework.Context_TAutoDiffXdU, body: pydrake.multibody.tree.Body_TAutoDiffXdU) -> pydrake.math.RigidTransform_TAutoDiffXdU: ...
    def EvalBodySpatialVelocityInWorld(self, context: pydrake.systems.framework.Context_TAutoDiffXdU, body: pydrake.multibody.tree.Body_TAutoDiffXdU) -> pydrake.multibody.math.SpatialVelocity_TAutoDiffXdU: ...
    @overload
    def Finalize(self) -> None: ...
    @overload
    def Finalize(self) -> Any: ...
    ...
    def GetActuatorNames(self, model_instance: pydrake.multibody.tree.ModelInstanceIndex, add_model_instance_prefix: bool = ...) -> List[str]: ...
    def GetBodiesKinematicallyAffectedBy(self, joint_indexes: List[pydrake.multibody.tree.JointIndex]) -> List[pydrake.multibody.tree.BodyIndex]: ...
    def GetBodiesWeldedTo(self, body: pydrake.multibody.tree.Body_TAutoDiffXdU) -> List[pydrake.multibody.tree.Body_TAutoDiffXdU]: ...
    @overload
    def GetBodyByName(self, name: str) -> pydrake.multibody.tree.Body_TAutoDiffXdU: ...
    @overload
    def GetBodyByName(self, name: str, model_instance: pydrake.multibody.tree.ModelInstanceIndex) -> pydrake.multibody.tree.Body_TAutoDiffXdU: ...
    def GetBodyFrameIdIfExists(self, body_index: pydrake.multibody.tree.BodyIndex) -> Optional[pydrake.geometry.FrameId]: ...
    def GetBodyFrameIdOrThrow(self, body_index: pydrake.multibody.tree.BodyIndex) -> pydrake.geometry.FrameId: ...
    def GetBodyFromFrameId(self, arg0: pydrake.geometry.FrameId) -> pydrake.multibody.tree.Body_TAutoDiffXdU: ...
    def GetBodyIndices(self, model_instance: pydrake.multibody.tree.ModelInstanceIndex) -> List[pydrake.multibody.tree.BodyIndex]: ...
    def GetCollisionGeometriesForBody(self, body: pydrake.multibody.tree.Body_TAutoDiffXdU) -> List[pydrake.geometry.GeometryId]: ...
    ...
    @classmethod
    def GetDefaultContactSurfaceRepresentation(cls, time_step: float) -> pydrake.geometry.HydroelasticContactRepresentation: ...
    def GetDefaultFreeBodyPose(self, body: pydrake.multibody.tree.Body_TAutoDiffXdU) -> pydrake.math.RigidTransform: ...
    @overload
    ...
    def GetFrameIndices(self, model_instance: pydrake.multibody.tree.ModelInstanceIndex) -> List[pydrake.multibody.tree.FrameIndex]: ...
    def GetFreeBodyPose(self, context: pydrake.systems.framework.Context_TAutoDiffXdU, body: pydrake.multibody.tree.Body_TAutoDiffXdU) -> pydrake.math.RigidTransform_TAutoDiffXdU: ...
    @overload
    ...
    def GetMutablePositions(self, context: pydrake.systems.framework.Context_TAutoDiffXdU) -> numpy.ndarray[object[m, 1], flags.writeable]: ...
    def GetMutablePositionsAndVelocities(self, context: pydrake.systems.framework.Context_TAutoDiffXdU) -> numpy.ndarray[object[m, 1], flags.writeable]: ...
    def GetMutableVelocities(self, context: pydrake.systems.framework.Context_TAutoDiffXdU) -> numpy.ndarray[object[m, 1], flags.writeable]: ...
    def GetPositionLowerLimits(self) -> numpy.ndarray[numpy.float64[m, 1]]: ...
    @overload
    def GetPositionNames(self, add_model_instance_prefix: bool = ..., always_add_suffix: bool = ...) -> List[str]: ...
    @overload
    ...
    def GetStateNames(self, model_instance: pydrake.multibody.tree.ModelInstanceIndex, add_model_instance_prefix: bool = ...) -> List[str]: ...
    def GetTopologyGraphvizString(self) -> str: ...
    def GetUniqueFreeBaseBodyOrThrow(self, model_instance: pydrake.multibody.tree.ModelInstanceIndex) -> pydrake.multibody.tree.Body_TAutoDiffXdU: ...
    @overload
    ...
    @overload
    def RegisterCollisionGeometry(self, body: pydrake.multibody.tree.Body_TAutoDiffXdU, X_BG: pydrake.math.RigidTransform, shape: pydrake.geometry.Shape, name: str, properties: pydrake.geometry.ProximityProperties) -> pydrake.geometry.GeometryId: ...
    @overload
    def RegisterCollisionGeometry(self, body: pydrake.multibody.tree.Body_TAutoDiffXdU, X_BG: pydrake.math.RigidTransform, shape: pydrake.geometry.Shape, name: str, coulomb_friction: CoulombFriction) -> pydrake.geometry.GeometryId: ...
    def RegisterVisualGeometry(self, body: pydrake.multibody.tree.Body_TAutoDiffXdU, X_BG: pydrake.math.RigidTransform, shape: pydrake.geometry.Shape, name: str, diffuse_color: numpy.ndarray[numpy.float64[4, 1]]) -> pydrake.geometry.GeometryId: ...
    def RenameModelInstance(self, model_instance: pydrake.multibody.tree.ModelInstanceIndex, name: str) -> None: ...
    ...
    def SetDefaultFreeBodyPose(self, body: pydrake.multibody.tree.Body_TAutoDiffXdU, X_WB: pydrake.math.RigidTransform) -> None: ...
    @overload
    def SetDefaultPositions(self, q: numpy.ndarray[numpy.float64[m, 1]]) -> None: ...
    @overload
    def SetDefaultPositions(self, model_instance: pydrake.multibody.tree.ModelInstanceIndex, q_instance: numpy.ndarray[numpy.float64[m, 1]]) -> None: ...
    ...
    def SetFreeBodyPose(self, context: pydrake.systems.framework.Context_TAutoDiffXdU, body: pydrake.multibody.tree.Body_TAutoDiffXdU, X_WB: pydrake.math.RigidTransform_TAutoDiffXdU) -> None: ...
    def SetFreeBodySpatialVelocity(self, body: pydrake.multibody.tree.Body_TAutoDiffXdU, V_WB: pydrake.multibody.math.SpatialVelocity_TAutoDiffXdU, context: pydrake.systems.framework.Context_TAutoDiffXdU) -> None: ...
    @overload
    ...
    def get_body(self, body_index: pydrake.multibody.tree.BodyIndex) -> pydrake.multibody.tree.Body_TAutoDiffXdU: ...
    def get_body_poses_output_port(self, *args, **kwargs): ...
    @overload
    ...
    def world_frame(self) -> pydrake.multibody.tree.BodyFrame_TAutoDiffXdU: ...

class MultibodyPlant_𝓣Expression𝓤(pydrake.systems.framework.LeafSystem_TExpressionU):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    def __init__(self, time_step: float) -> None: ...
    def AddBallConstraint(self, body_A: pydrake.multibody.tree.Body_TExpressionU, p_AP: numpy.ndarray[numpy.float64[3, 1]], body_B: pydrake.multibody.tree.Body_TExpressionU, p_BQ: numpy.ndarray[numpy.float64[3, 1]]) -> pydrake.multibody.tree.MultibodyConstraintId: ...
    ...
    def AddDistanceConstraint(self, body_A: pydrake.multibody.tree.Body_TExpressionU, p_AP: numpy.ndarray[numpy.float64[3, 1]], body_B: pydrake.multibody.tree.Body_TExpressionU, p_BQ: numpy.ndarray[numpy.float64[3, 1]], distance: float, stiffness: float = ..., damping: float = ...) -> pydrake.multibody.tree.MultibodyConstraintId: ...
    ...
    def AddWeldConstraint(self, body_A: pydrake.multibody.tree.Body_TExpressionU, X_AP: pydrake.math.RigidTransform, body_B: pydrake.multibody.tree.Body_TExpressionU, X_BQ: pydrake.math.RigidTransform) -> pydrake.multibody.tree.MultibodyConstraintId: ...
    ...
    @overload
    def CollectRegisteredGeometries(self, bodies: List[pydrake.multibody.tree.Body_TExpressionU]) -> pydrake.geometry.GeometrySet: ...
    @overload
    def CollectRegisteredGeometries(self, bodies) -> Any: ...
    def EvalBodyPoseInWorld(self, context: pydrake.systems.framework.Context_TExpressionU, body: pydrake.multibody.tree.Body_TExpressionU) -> pydrake.math.RigidTransform_TExpressionU: ...
    def EvalBodySpatialVelocityInWorld(self, context: pydrake.systems.framework.Context_TExpressionU, body: pydrake.multibody.tree.Body_TExpressionU) -> pydrake.multibody.math.SpatialVelocity_TExpressionU: ...
    @overload
    def Finalize(self) -> None: ...
    @overload
    def Finalize(self) -> Any: ...
    ...
    def GetActuatorNames(self, model_instance: pydrake.multibody.tree.ModelInstanceIndex, add_model_instance_prefix: bool = ...) -> List[str]: ...
    def GetBodiesKinematicallyAffectedBy(self, joint_indexes: List[pydrake.multibody.tree.JointIndex]) -> List[pydrake.multibody.tree.BodyIndex]: ...
    def GetBodiesWeldedTo(self, body: pydrake.multibody.tree.Body_TExpressionU) -> List[pydrake.multibody.tree.Body_TExpressionU]: ...
    @overload
    def GetBodyByName(self, name: str) -> pydrake.multibody.tree.Body_TExpressionU: ...
    @overload
    def GetBodyByName(self, name: str, model_instance: pydrake.multibody.tree.ModelInstanceIndex) -> pydrake.multibody.tree.Body_TExpressionU: ...
    def GetBodyFrameIdIfExists(self, body_index: pydrake.multibody.tree.BodyIndex) -> Optional[pydrake.geometry.FrameId]: ...
    def GetBodyFrameIdOrThrow(self, body_index: pydrake.multibody.tree.BodyIndex) -> pydrake.geometry.FrameId: ...
    def GetBodyFromFrameId(self, arg0: pydrake.geometry.FrameId) -> pydrake.multibody.tree.Body_TExpressionU: ...
    def GetBodyIndices(self, model_instance: pydrake.multibody.tree.ModelInstanceIndex) -> List[pydrake.multibody.tree.BodyIndex]: ...
    def GetCollisionGeometriesForBody(self, body: pydrake.multibody.tree.Body_TExpressionU) -> List[pydrake.geometry.GeometryId]: ...
    ...
    @classmethod
    def GetDefaultContactSurfaceRepresentation(cls, time_step: float) -> pydrake.geometry.HydroelasticContactRepresentation: ...
    def GetDefaultFreeBodyPose(self, body: pydrake.multibody.tree.Body_TExpressionU) -> pydrake.math.RigidTransform: ...
    @overload
    def GetDefaultPositions(self) -> numpy.ndarray[object[m, 1]]: ...
    @overload
    def GetDefaultPositions(self, model_instance: pydrake.multibody.tree.ModelInstanceIndex) -> numpy.ndarray[object[m, 1]]: ...
    ...
    def GetFrameIndices(self, model_instance: pydrake.multibody.tree.ModelInstanceIndex) -> List[pydrake.multibody.tree.FrameIndex]: ...
    def GetFreeBodyPose(self, context: pydrake.systems.framework.Context_TExpressionU, body: pydrake.multibody.tree.Body_TExpressionU) -> pydrake.math.RigidTransform_TExpressionU: ...
    @overload
    ...
    def GetMutablePositions(self, context: pydrake.systems.framework.Context_TExpressionU) -> numpy.ndarray[object[m, 1], flags.writeable]: ...
    def GetMutablePositionsAndVelocities(self, context: pydrake.systems.framework.Context_TExpressionU) -> numpy.ndarray[object[m, 1], flags.writeable]: ...
    def GetMutableVelocities(self, context: pydrake.systems.framework.Context_TExpressionU) -> numpy.ndarray[object[m, 1], flags.writeable]: ...
    def GetPositionLowerLimits(self) -> numpy.ndarray[numpy.float64[m, 1]]: ...
    @overload
    def GetPositionNames(self, add_model_instance_prefix: bool = ..., always_add_suffix: bool = ...) -> List[str]: ...
    @overload
    ...
    def GetStateNames(self, model_instance: pydrake.multibody.tree.ModelInstanceIndex, add_model_instance_prefix: bool = ...) -> List[str]: ...
    def GetTopologyGraphvizString(self) -> str: ...
    def GetUniqueFreeBaseBodyOrThrow(self, model_instance: pydrake.multibody.tree.ModelInstanceIndex) -> pydrake.multibody.tree.Body_TExpressionU: ...
    @overload
    ...
    @overload
    def RegisterCollisionGeometry(self, body: pydrake.multibody.tree.Body_TExpressionU, X_BG: pydrake.math.RigidTransform, shape: pydrake.geometry.Shape, name: str, properties: pydrake.geometry.ProximityProperties) -> pydrake.geometry.GeometryId: ...
    @overload
    def RegisterCollisionGeometry(self, body: pydrake.multibody.tree.Body_TExpressionU, X_BG: pydrake.math.RigidTransform, shape: pydrake.geometry.Shape, name: str, coulomb_friction: CoulombFriction) -> pydrake.geometry.GeometryId: ...
    def RegisterVisualGeometry(self, body: pydrake.multibody.tree.Body_TExpressionU, X_BG: pydrake.math.RigidTransform, shape: pydrake.geometry.Shape, name: str, diffuse_color: numpy.ndarray[numpy.float64[4, 1]]) -> pydrake.geometry.GeometryId: ...
    def RenameModelInstance(self, model_instance: pydrake.multibody.tree.ModelInstanceIndex, name: str) -> None: ...
    def SetActuationInArray(self, model_instance: pydrake.multibody.tree.ModelInstanceIndex, u_instance: numpy.ndarray[object[m, 1]], u: Optional[numpy.ndarray[object[m, 1], flags.writeable]]) -> None: ...
    ...
    def SetDefaultFreeBodyPose(self, body: pydrake.multibody.tree.Body_TExpressionU, X_WB: pydrake.math.RigidTransform) -> None: ...
    @overload
    def SetDefaultPositions(self, q: numpy.ndarray[numpy.float64[m, 1]]) -> None: ...
    @overload
    def SetDefaultPositions(self, model_instance: pydrake.multibody.tree.ModelInstanceIndex, q_instance: numpy.ndarray[numpy.float64[m, 1]]) -> None: ...
    ...
    def SetFreeBodyPose(self, context: pydrake.systems.framework.Context_TExpressionU, body: pydrake.multibody.tree.Body_TExpressionU, X_WB: pydrake.math.RigidTransform_TExpressionU) -> None: ...
    def SetFreeBodySpatialVelocity(self, body: pydrake.multibody.tree.Body_TExpressionU, V_WB: pydrake.multibody.math.SpatialVelocity_TExpressionU, context: pydrake.systems.framework.Context_TExpressionU) -> None: ...
    @overload
    ...
    def get_body(self, body_index: pydrake.multibody.tree.BodyIndex) -> pydrake.multibody.tree.Body_TExpressionU: ...
    def get_body_poses_output_port(self, *args, **kwargs): ...
    @overload
    ...
    def world_frame(self) -> pydrake.multibody.tree.BodyFrame_TExpressionU: ...
...
class PropellerInfo:
    X_BP: Incomplete
    body_index: Incomplete
    moment_ratio: Incomplete
    thrust_ratio: Incomplete
    def __init__(self, body_index: pydrake.multibody.tree.BodyIndex, X_BP: pydrake.math.RigidTransform = ..., thrust_ratio: float = ..., moment_ratio: float = ...) -> None: ...
