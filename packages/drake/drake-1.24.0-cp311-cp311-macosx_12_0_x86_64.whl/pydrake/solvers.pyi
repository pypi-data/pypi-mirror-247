...
class Binding𝓣MinimumValueConstraint𝓤:
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    def __init__(self, c: MinimumValueConstraint, v: numpy.ndarray[object[m, 1]]) -> None: ...
    @overload
    def ToLatex(self, precision: int = ...) -> str: ...
    @overload
    def ToLatex(self) -> Any: ...
    def evaluator(self) -> MinimumValueConstraint: ...
    def variables(self) -> numpy.ndarray[object[m, 1]]: ...
...
class GurobiSolver(SolverInterface):
    ...
    class SolveStatusInfo:
        ...
        @property
        def explored_node_count(self): ...
        @property
        def feasible_solutions_count(self): ...
        @property
        def reported_runtime(self): ...
    def __init__(self) -> None: ...
    @classmethod
...
class MinimumValueConstraint(Constraint):
    @overload
    def __init__(self, num_vars: int, minimum_value: float, influence_value_offset: float, max_num_values: int, value_function: Callable[[numpy.ndarray[object[m, 1]], float], numpy.ndarray[object[m, 1]]], value_function_double: Callable[[numpy.ndarray[numpy.float64[m, 1]], float], numpy.ndarray[numpy.float64[m, 1]]] = ...) -> None: ...
    @overload
    def __init__(self, num_vars: int, minimum_value_lower: float, minimum_value_upper: float, influence_value: float, max_num_values: int, value_function: Callable[[numpy.ndarray[object[m, 1]], float], numpy.ndarray[object[m, 1]]], value_function_double: Callable[[numpy.ndarray[numpy.float64[m, 1]], float], numpy.ndarray[numpy.float64[m, 1]]] = ...) -> None: ...
...
class ScsSolverDetails:
    ...
    def primal_objective(self): ...
    @property
    def primal_residue(self): ...
    @property
    def residue_infeasibility(self): ...
    @property
    def residue_unbounded_a(self): ...
    @property
    def residue_unbounded_p(self): ...
    @property
    def s(self): ...
    @property
    def scs_setup_time(self): ...
    @property
    def scs_solve_time(self): ...
    @property
    def scs_status(self): ...
    @property
    def y(self): ...
...
class _TemporaryName_N5drake7solvers7BindingINS0_22MinimumValueConstraintEEE:
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    def __init__(self, c: MinimumValueConstraint, v: numpy.ndarray[object[m, 1]]) -> None: ...
    @overload
