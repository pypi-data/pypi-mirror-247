...
class ContactVisualizerParams:
    ...
    force_threshold: Incomplete
    hydro_force_color: Incomplete
    hydro_moment_color: Incomplete
    moment_threshold: Incomplete
    newton_meters_per_meter: Incomplete
    newtons_per_meter: Incomplete
    prefix: Incomplete
