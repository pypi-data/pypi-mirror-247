...
class GlobalInverseKinematics:
    class Options:
        ...
        linear_constraint_only: Incomplete
...
class InverseKinematics:
    ...
    def AddMinimumDistanceConstraint(self, minimum_distance: float, threshold_distance: float = ...) -> pydrake.solvers.BindingTConstraintU: ...
...
class MinimumDistanceConstraint(pydrake.solvers.Constraint):
    @overload
    def __init__(self, plant: pydrake.multibody.plant.MultibodyPlant, minimum_distance: float, plant_context: pydrake.systems.framework.Context, penalty_function: Callable[[float, float, float], None] = ..., influence_distance_offset: float = ...) -> None: ...
    @overload
    def __init__(self, plant: pydrake.multibody.plant.MultibodyPlant_TAutoDiffXdU, minimum_distance: float, plant_context: pydrake.systems.framework.Context_TAutoDiffXdU, penalty_function: Callable[[float, float, float], None] = ..., influence_distance_offset: float = ...) -> None: ...
    @overload
    def __init__(self, collision_checker: pydrake.planning.CollisionChecker, minimum_distance: float, collision_checker_context: pydrake.planning.CollisionCheckerContext, penalty_function: Callable[[float, bool], tuple] = ..., influence_distance_offset: float = ...) -> None: ...
    @overload
    def __init__(self, collision_checker: pydrake.planning.CollisionChecker, minimum_distance_lower: float, minimum_distance_upper: float, collision_checker_context: pydrake.planning.CollisionCheckerContext, penalty_function: Callable[[float, bool], tuple], influence_distance: float) -> None: ...
    @overload
    def __init__(self, plant: pydrake.multibody.plant.MultibodyPlant, minimum_distance_lower: float, minimum_distance_upper: float, plant_context: pydrake.systems.framework.Context, penalty_function: Callable[[float, bool], tuple], influence_distance: float) -> None: ...
    @overload
    def __init__(self, plant: pydrake.multibody.plant.MultibodyPlant_TAutoDiffXdU, minimum_distance_lower: float, minimum_distance_upper: float, plant_context: pydrake.systems.framework.Context_TAutoDiffXdU, penalty_function: Callable[[float, bool], tuple], influence_distance: float) -> None: ...
