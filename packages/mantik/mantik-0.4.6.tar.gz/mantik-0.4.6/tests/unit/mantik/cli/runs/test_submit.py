...
ENV_VARS = {
    ...
    env_vars._DATA_REPOSITORY_ID_ENV_VAR: str(uuid.uuid4()),
    env_vars._EXPERIMENT_REPOSITORY_ID_ENV_VAR: str(uuid.uuid4()),
    env_vars._CODE_REPOSITORY_ID_ENV_VAR: "test-project",
}
...
def test_run_project(
    ...
    with mock_mantik_api_request(
        method="POST",
        end_point=f"/mantik-api/projects/{project_id}/runs",
        status_code=201,
