...
import g4f7
from g4f7 import Provider

from g4f7.api import Api
from g4f7.gui.run import gui_parser, run_gui_args
...
def main():
    ...
    if args.mode == "api":
        controller=Api(engine=g4f7, debug=args.debug, list_ignored_providers=args.ignored_providers)
