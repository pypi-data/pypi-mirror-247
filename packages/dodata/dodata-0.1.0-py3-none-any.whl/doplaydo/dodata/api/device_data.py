...
def upload(
    ...
    if attributes:
        data["attributes"] = json.dumps(attributes)  # type: ignore
    if plotting_kwargs:
    ...
    with open(fp, "rb") as f:
        return post(url, params=params, files={"data_file": f}, data=data)
...
def get_data_by_id(device_data_id: int) -> pd.DataFrame | None:
