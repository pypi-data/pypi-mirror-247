...
def check_env():
    if os.environ.get("MANISBLE_DNS_TYPE") == None:
        print("MANISBLE_DNS_TYPE not set")
        exit(1)
    if os.environ.get("MANISBLE_DNS_URL") == None:
        print("MANISBLE_DNS_URL not set")
        exit(1)
    if os.environ.get("MANISBLE_DNS_TOKEN") == None:
        print("MANISBLE_DNS_TOKEN not set")
        exit(1)
    if os.environ.get("MANISBLE_DNS_DOMAIN") == None:
        print("MANISBLE_DNS_DOMAIN not set")
        exit(1)
    if os.environ.get("MANISBLE_DNS_PROVIDER") == None:
        print("MANISBLE_DNS_PROVIDER not set")
        exit(1)
    if os.environ.get("MANISBLE_DNS_ZONEID") == None:
        print("MANISBLE_DNS_ZONEID not set")
        exit(1)
    if os.environ.get("MANISBLE_DNS_RECORD_NAME") == None:
        print("MANISBLE_DNS_RECORD_NAME not set")
        exit(1)
    if os.environ.get("MANISBLE_DNS_RECORD_CONTENT") == None:
        print("MANISBLE_DNS_RECORD_CONTENT not set")
        exit(1)
    if os.environ.get("MANISBLE_DNS_RECORD_TTL") == None:
        os.environ.setdefault("MANISBLE_DNS_RECORD_TTL", "300")
    if os.environ.get("MANISBLE_DNS_RECORD_TYPE") == None:
        os.environ.setdefault("MANISBLE_DNS_RECORD_TYPE", "A")
    if os.environ.get("MANISBLE_DNS_RECORD_PROXIED") == None:
        os.environ.setdefault("MANISBLE_DNS_RECORD_PROXIED", False )
    return True
