...
class Meetup():
    ...
    def list_eligible_group_events(self, group_id: str) -> list[QuickEvent]:
        ...
        available_events_li = self.webdriver.find_elements(By.CSS_SELECTOR, '.eventList-list .list-item')
        ...
        logging.info(f'{events_url}. Scrapped: {total_events_count}. Eligible: {eligible_events_count}.')
