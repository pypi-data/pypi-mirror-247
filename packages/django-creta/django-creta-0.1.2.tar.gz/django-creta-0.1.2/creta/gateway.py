...
class GatewayV1(BaseGateway):
    ...
    def check_nft(self, request_id):
        ...
        if result['result']['token_id']:
            ...
            instance.save()
            {"collectionType": 200001, "address": "0x515bfd1614e3fc20aacbe177cb4b928e8dbd0ede", "nftType": 1,
                   "name": "Oliver", "image": "https://cf.dev.superclubs.io/media/club/club/default/profile.svg",
                   "external_url": "https://dev.superclubs.io/club/oliver"}
