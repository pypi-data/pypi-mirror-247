...
from constants import CTX_TIDAL, MediaType
from gui import gui_activate
from helper.path import path_file_settings
from helper.url import get_tidal_media_id, get_tidal_media_type
from helper.wrapper import WrapperLogger
from model.cfg import HelpSettings
...
def download(
    ctx: typer.Context,
    urls_or_ids: Annotated[list[str] | None, typer.Argument()] = None,
    list_urls: Annotated[
        Path | None,
        typer.Option(
            "--list",
    ...
    for item in urls_or_ids:
        ...
        with Live(progress_table, refresh_per_second=10):
            ...
            elif media_name in ["album", "playlist"]:
