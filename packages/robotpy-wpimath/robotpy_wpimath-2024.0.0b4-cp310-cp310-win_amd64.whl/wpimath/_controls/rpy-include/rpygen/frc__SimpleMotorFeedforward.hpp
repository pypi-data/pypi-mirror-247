...
":returns: The minimum possible acceleration at the given velocity.")
    ...
    .def_readonly("kS", &frc::SimpleMotorFeedforward<Distance>::kS)
  
    .def_readonly("kV", &frc::SimpleMotorFeedforward<Distance>::kV)
  
    .def_readonly("kA", &frc::SimpleMotorFeedforward<Distance>::kA)
  ;
