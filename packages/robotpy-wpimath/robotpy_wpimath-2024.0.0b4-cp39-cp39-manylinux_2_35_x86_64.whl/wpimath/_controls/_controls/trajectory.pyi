...
class ExponentialProfileMeterVolts:
    ...
    class ProfileTiming:
        def __init__(self) -> None:
            ...
        def isFinished(self, time: wpimath.units.seconds) -> bool:
            ...
        @property
...
class Trajectory:
    ...
    class State:
        ...
        """
        __hash__: typing.ClassVar[None] = None
        acceleration: wpimath.units.meters_per_second_squared
        curvature: wpimath.units.radians_per_meter
        pose: wpimath.geometry._geometry.Pose2d
        t: wpimath.units.seconds
        velocity: wpimath.units.meters_per_second
...
class TrapezoidProfile:
    ...
    """
    class Constraints:
        def __init__(self, maxVelocity: wpimath.units.units_per_second = 0, maxAcceleration: wpimath.units.units_per_second_squared = 0) -> None:
            ...
        @property
...
class TrapezoidProfileRadians:
    ...
    """
    class Constraints:
        def __init__(self, maxVelocity: wpimath.units.radians_per_second = 0, maxAcceleration: wpimath.units.radians_per_second_squared = 0) -> None:
            ...
        @property
