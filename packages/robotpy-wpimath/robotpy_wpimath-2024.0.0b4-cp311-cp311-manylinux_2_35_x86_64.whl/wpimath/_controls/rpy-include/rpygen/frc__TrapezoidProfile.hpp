...
":param t: The time since the beginning of the profile.")
  ...
  .def(py::init<Velocity_t, Acceleration_t>(),
    ...
    .def_readonly("maxVelocity", &frc::TrapezoidProfile<Distance>::Constraints::maxVelocity)
  
    .def_readonly("maxAcceleration", &frc::TrapezoidProfile<Distance>::Constraints::maxAcceleration)
  ;
  ...
  .def(py::self == State()
    ...
    .def_readonly("position", &frc::TrapezoidProfile<Distance>::State::position)
  
    .def_readonly("velocity", &frc::TrapezoidProfile<Distance>::State::velocity)
  ;
