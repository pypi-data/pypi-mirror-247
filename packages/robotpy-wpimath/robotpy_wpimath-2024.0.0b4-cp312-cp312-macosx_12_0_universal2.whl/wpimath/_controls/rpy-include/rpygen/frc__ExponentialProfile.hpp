...
"point, and the time it will take for this profile to reach the goal state.")
  ...
  .
def
("maxVelocity", &frc::ExponentialProfile<Distance, Input>::Constraints::MaxVelocity, release_gil()
  )
  
  
  
    .def_readonly("maxInput", &frc::ExponentialProfile<Distance, Input>::Constraints::maxInput)
  
    .def_readonly("A", &frc::ExponentialProfile<Distance, Input>::Constraints::A)
  
    .def_readonly("B", &frc::ExponentialProfile<Distance, Input>::Constraints::B)
...
;
  ...
  .def(py::self == py::self
    ...
    .def_readonly("position", &frc::ExponentialProfile<Distance, Input>::State::position)
  
    .def_readonly("velocity", &frc::ExponentialProfile<Distance, Input>::State::velocity)
...
("isFinished", &frc::ExponentialProfile<Distance, Input>::ProfileTiming::IsFinished,
      py::arg("time"), release_gil()
  )
  
  
  
    .def_readonly("inflectionTime", &frc::ExponentialProfile<Distance, Input>::ProfileTiming::inflectionTime)
  
    .def_readonly("totalTime", &frc::ExponentialProfile<Distance, Input>::ProfileTiming::totalTime)
  ;
