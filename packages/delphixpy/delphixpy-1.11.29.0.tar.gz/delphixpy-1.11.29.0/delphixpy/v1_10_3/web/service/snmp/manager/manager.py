...
def create(engine, snmp_manager=None):
    ...
    :type snmp_manager: :py:class:`v1_10_3.web.vo.SNMPManager`
    :rtype: ``str``
    """
...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_10_3.web.objects.SNMPManager.SNMPManager`
        object
    :type ref: ``str``
    :rtype: :py:class:`v1_10_3.web.vo.SNMPManager`
    """
...
def get_all(engine):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_10_3.delphix_engine.DelphixEngine`
    :rtype: ``list`` of :py:class:`v1_10_3.web.vo.SNMPManager`
    """
    url = "/resources/json/delphix/service/snmp/manager"
    response = engine.get(url)
    result = response_validator.validate(response, engine)
