...
class DelphixDataServicesComponentInfo(TypedObject):
    """
    *(extends* :py:class:`v1_10_3.web.vo.TypedObject` *)* Describes the current
    state of the Delphix Data Services Component.
    """
    ...
    def build_version(self):
        """
        The version of the Delphix Data Services Component.
    ...
    def build_timestamp(self):
        """
        The time at which the Delphix Data Services Component was built.
    ...
    def status(self):
        """
        Indicates the status of the Delphix Data Services Component.
