...
class Host(ReadonlyNamedUserObject):
    """
    *(extends* :py:class:`v1_10_3.web.vo.ReadonlyNamedUserObject` *)* The
    ...
    def __eq__(self, other):
        ...
        return super().__eq__(other) and \
               ...
               self.dsp_truststore_path == other.dsp_truststore_path
    ...
    def host_configuration(self):
        ...
        :rtype: :py:class:`v1_10_3.web.vo.HostConfiguration`
        """
    ...
    def host_runtime(self):
        ...
        :rtype: :py:class:`v1_10_3.web.vo.HostRuntime`
        """
