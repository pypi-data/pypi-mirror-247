...
from delphixpy.v1_10_3.web.objects.DbExportParameters import DbExportParameters
...
class PgSQLExportParameters(DbExportParameters):
    """
    *(extends* :py:class:`v1_10_3.web.vo.DbExportParameters` *)* The parameters
    ...
    def source_config(self):
        ...
        :rtype: :py:class:`v1_10_3.web.vo.PgSQLDBClusterConfig`
        """
    ...
    def filesystem_layout(self):
        ...
        :rtype: :py:class:`v1_10_3.web.vo.TimeflowFilesystemLayout`
        """
    ...
    def hba_entries(self):
        ...
        :rtype: ``list`` of :py:class:`v1_10_3.web.vo.PgSQLHBAEntry`
        """
    ...
    def ident_entries(self):
        ...
        :rtype: ``list`` of :py:class:`v1_10_3.web.vo.PgSQLIdentEntry`
        """
