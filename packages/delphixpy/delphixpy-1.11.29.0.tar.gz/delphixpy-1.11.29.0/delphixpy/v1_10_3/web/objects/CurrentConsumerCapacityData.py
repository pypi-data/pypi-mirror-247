...
from delphixpy.v1_10_3.web.objects.BaseConsumerCapacityData import BaseConsumerCapacityData
...
class CurrentConsumerCapacityData(BaseConsumerCapacityData):
    """
    *(extends* :py:class:`v1_10_3.web.vo.BaseConsumerCapacityData` *)* Current
