...
from delphixpy.v1_10_3.web.objects.BaseSystemCapacityData import BaseSystemCapacityData
...
class HistoricalSystemCapacityData(BaseSystemCapacityData):
    """
    *(extends* :py:class:`v1_10_3.web.vo.BaseSystemCapacityData` *)* Capacity
