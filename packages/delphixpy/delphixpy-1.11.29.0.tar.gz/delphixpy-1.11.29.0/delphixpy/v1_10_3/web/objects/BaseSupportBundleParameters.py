...
class BaseSupportBundleParameters(TypedObject):
    """
    *(extends* :py:class:`v1_10_3.web.vo.TypedObject` *)* Parameters to be used
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._bundle_type[0] is not None and obj._bundle_type[0] is not obj.__undef__:
            ...
            assert obj._bundle_type[0] in ['PHONEHOME', 'MDS', 'OS', 'CORE', 'LOG', 'TOOLKIT_LOG', 'DROPBOX', 'STORAGE_TEST', 'MASKING', 'ALL'], "Expected enum ['PHONEHOME', 'MDS', 'OS', 'CORE', 'LOG', 'TOOLKIT_LOG', 'DROPBOX', 'STORAGE_TEST', 'MASKING', 'ALL'] but got %s" % obj._bundle_type[0]
    ...
    def is_dirty(self):
        return any([self._include_analytics_data[1], self._bundle_type[1], self._environments[1], self._sources[1], self._toolkit[1]])
    ...
    def bundle_type(self):
        ...
        *(default value: ALL)* Type of support bundle to generate. Reserved for
        ...
        TOOLKIT_LOG, DROPBOX, STORAGE_TEST, MASKING, ALL)*
    ...
    def toolkit(self):
        """
        The reference of a toolkit from which logs should be collected.
