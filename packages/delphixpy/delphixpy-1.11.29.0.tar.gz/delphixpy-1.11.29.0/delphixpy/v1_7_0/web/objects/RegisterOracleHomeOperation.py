...
class RegisterOracleHomeOperation(Operation):
    """
    *(extends* :py:class:`v1_7_0.web.vo.Operation` *)* Register a manually
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._install_home[0] is not None and obj._install_home[0] is not obj.__undef__:
            assert isinstance(obj._install_home[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._install_home[0], type(obj._install_home[0])))
