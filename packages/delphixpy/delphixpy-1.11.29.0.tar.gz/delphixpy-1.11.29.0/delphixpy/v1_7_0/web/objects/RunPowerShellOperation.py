    ...
    *(extends* :py:class:`v1_7_0.web.vo.Operation` *)* A user-specifiable
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._command[0] is not None and obj._command[0] is not obj.__undef__:
            assert isinstance(obj._command[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._command[0], type(obj._command[0])))
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        def dictify(obj, prop_is_list_or_vo=False):
            if isinstance(obj, list):
                ...
                return obj
        if "command" == "type" or (self.command is not self.__undef__ and (not (dirty and not self._command[1]) or self.is_dirty_list(self.command, self._command) or belongs_to_parent)):
        ...
        if "variables" == "type" or (self.variables is not self.__undef__ and (not (dirty and not self._variables[1]) or self.is_dirty_list(self.variables, self._variables) or belongs_to_parent)):
    ...
    def is_dirty(self):
        return any([self._command[1], self._environment[1], self._host[1], self._output_schema[1], self._user[1], self._variables[1]])
