...
class AppDataSnapshot(TimeflowSnapshot):
    """
    *(extends* :py:class:`v1_7_0.web.vo.TimeflowSnapshot` *)* Snapshot of an
    AppData TimeFlow.
    """
    ...
    def first_change_point(self):
        ...
        :rtype: :py:class:`v1_7_0.web.vo.AppDataTimeflowPoint`
        """
    ...
    def metadata(self):
        ...
        :rtype: :py:class:`v1_7_0.web.vo.Json`
        """
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_7_0.web.vo.AppDataSnapshotRuntime`
        """
