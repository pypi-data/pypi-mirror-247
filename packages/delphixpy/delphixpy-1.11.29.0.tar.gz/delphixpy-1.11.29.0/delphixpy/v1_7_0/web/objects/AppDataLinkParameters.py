    ...
    *(extends* :py:class:`v1_7_0.web.vo.LinkParameters` *)* Represents the
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if "source" in data and data["source"] is not None:
            obj._source = (factory.create_object(data["source"], "AppDataLinkedSource"), dirty)
            factory.validate_type(obj._source[0], "AppDataLinkedSource")
        else:
    ...
    def container(self):
        ...
        :rtype: :py:class:`v1_7_0.web.vo.AppDataContainer`
        """
    ...
    def source(self):
        ...
        :rtype: :py:class:`v1_7_0.web.vo.AppDataLinkedSource`
        """
