...
from delphixpy.v1_7_0.web.objects.SystemInitializationParameters import SystemInitializationParameters
...
class DataNodeInitializationParameters(SystemInitializationParameters):
    """
    *(extends* :py:class:`v1_7_0.web.vo.SystemInitializationParameters` *)*
