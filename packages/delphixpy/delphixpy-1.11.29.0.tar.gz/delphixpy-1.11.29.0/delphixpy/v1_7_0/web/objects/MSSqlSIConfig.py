...
from delphixpy.v1_7_0.web.objects.MSSqlDBConfig import MSSqlDBConfig
...
class MSSqlSIConfig(MSSqlDBConfig):
    """
    *(extends* :py:class:`v1_7_0.web.vo.MSSqlDBConfig` *)* Configuration
    ...
    def instance(self):
        ...
        :rtype: :py:class:`v1_7_0.web.vo.MSSqlInstanceConfig`
        """
