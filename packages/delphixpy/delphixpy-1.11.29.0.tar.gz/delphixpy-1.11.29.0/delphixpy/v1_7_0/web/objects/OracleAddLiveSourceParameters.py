...
from delphixpy.v1_7_0.web.objects.AddLiveSourceParameters import AddLiveSourceParameters
...
class OracleAddLiveSourceParameters(AddLiveSourceParameters):
    """
    *(extends* :py:class:`v1_7_0.web.vo.AddLiveSourceParameters` *)* The
    ...
    def source(self):
        ...
        :rtype: :py:class:`v1_7_0.web.vo.OracleLiveSource`
        """
    ...
    def source_config(self):
        ...
        :rtype: :py:class:`v1_7_0.web.vo.OracleDBConfig`
        """
