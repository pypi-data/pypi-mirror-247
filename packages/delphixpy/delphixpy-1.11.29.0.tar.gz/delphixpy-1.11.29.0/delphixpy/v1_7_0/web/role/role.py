...
def create(engine, role=None):
    ...
    :type role: :py:class:`v1_7_0.web.vo.Role`
    :rtype: ``str``
    """
...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_7_0.web.objects.Role.Role` object
    :type ref: ``str``
    :rtype: :py:class:`v1_7_0.web.vo.Role`
    """
...
def get_all(engine):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_7_0.delphix_engine.DelphixEngine`
    :rtype: ``list`` of :py:class:`v1_7_0.web.vo.Role`
    """
    url = "/resources/json/delphix/role"
    response = engine.get(url)
    result = response_validator.validate(response, engine)
