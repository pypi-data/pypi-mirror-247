...
def create(engine, network_latency_test_parameters):
    ...
    :type network_latency_test_parameters:
        :py:class:`v1_7_0.web.vo.NetworkLatencyTestParameters`
    :rtype: ``str``
    """
...
def get(engine, ref):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_7_0.delphix_engine.DelphixEngine`
    :param ref: Reference to a :py:class:`delphixpy.v1_7_0.web.objects.NetworkL
        atencyTest.NetworkLatencyTest` object
    :type ref: ``str``
    :rtype: :py:class:`v1_7_0.web.vo.NetworkLatencyTest`
    """
...
def get_all(engine):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_7_0.delphix_engine.DelphixEngine`
    :rtype: ``list`` of :py:class:`v1_7_0.web.vo.NetworkLatencyTest`
    """
    url = "/resources/json/delphix/network/test/latency"
    response = engine.get(url)
    result = response_validator.validate(response, engine)
