...
class OracleVirtualSource(OracleManagedSource):
    """
    *(extends* :py:class:`v1_11_17.web.vo.OracleManagedSource` *)* A virtual
    Oracle source.
    """
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._source_status[0] is not None and obj._source_status[0] is not obj.__undef__:
            ...
            assert obj._source_status[0] in ['DEFAULT', 'PENDING_V2P_MOVE', 'PENDING_V2P_SWITCH_COPY', 'DISABLED_POST_V2P'], "Expected enum ['DEFAULT', 'PENDING_V2P_MOVE', 'PENDING_V2P_SWITCH_COPY', 'DISABLED_POST_V2P'] but got %s" % obj._source_status[0]
    ...
    def is_dirty(self):
        return any([self._operations[1], self._file_mapping_rules[1], self._redo_log_size_in_mb[1], self._redo_log_groups[1], self._archivelog_mode[1], self._custom_env_vars[1], self._allow_auto_vdb_restart_on_host_reboot[1], self._new_dbid[1], self._tde_key_identifier[1], self._source_status[1]])
    ...
    def operations(self):
        ...
        :rtype: :py:class:`v1_11_17.web.vo.VirtualSourceOperations`
        """
    ...
    def custom_env_vars(self):
        ...
        :rtype: ``list`` of :py:class:`v1_11_17.web.vo.OracleCustomEnvVar`
        """
    ...
    def source_status(self):
        ...
        *(default value: DEFAULT)* Virtual source status following a V2P
        operation. *(permitted values: DEFAULT, PENDING_V2P_MOVE,
        PENDING_V2P_SWITCH_COPY, DISABLED_POST_V2P)*
