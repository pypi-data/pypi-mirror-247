...
class SnapshotSpaceResult(TypedObject):
    """
    *(extends* :py:class:`v1_11_17.web.vo.TypedObject` *)* Result of the
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._total_size[0] is not None and obj._total_size[0] is not obj.__undef__:
            assert isinstance(obj._total_size[0], float), ("Expected one of ['number'], but got %s of type %s" % (obj._total_size[0], type(obj._total_size[0])))
