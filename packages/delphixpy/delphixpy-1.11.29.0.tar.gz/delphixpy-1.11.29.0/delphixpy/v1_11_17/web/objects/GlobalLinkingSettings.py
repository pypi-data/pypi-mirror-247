...
class GlobalLinkingSettings(TypedObject):
    """
    *(extends* :py:class:`v1_11_17.web.vo.TypedObject` *)* System-wide linking
    settings.
    """
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        def dictify(obj, prop_is_list_or_vo=False):
            if isinstance(obj, list):
                ...
                return obj
        if "encrypted_linking_enabled_by_default" == "type" or (self.encrypted_linking_enabled_by_default is not self.__undef__ and (not (dirty and not self._encrypted_linking_enabled_by_default[1]) or self.is_dirty_list(self.encrypted_linking_enabled_by_default, self._encrypted_linking_enabled_by_default) or belongs_to_parent)):
