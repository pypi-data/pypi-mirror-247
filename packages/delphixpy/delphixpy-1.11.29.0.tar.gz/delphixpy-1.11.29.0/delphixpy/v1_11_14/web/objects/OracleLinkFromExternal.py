...
from delphixpy.v1_11_14.web.objects.OracleBaseExternalLinkData import OracleBaseExternalLinkData
...
class OracleLinkFromExternal(OracleBaseExternalLinkData):
    """
    *(extends* :py:class:`v1_11_14.web.vo.OracleBaseExternalLinkData` *)*
