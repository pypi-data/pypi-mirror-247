...
from delphixpy.v1_11_14.web.objects.OracleSourceConnectionInfo import OracleSourceConnectionInfo
...
class OracleRACSourceConnectionInfo(OracleSourceConnectionInfo):
    """
    *(extends* :py:class:`v1_11_14.web.vo.OracleSourceConnectionInfo` *)*
