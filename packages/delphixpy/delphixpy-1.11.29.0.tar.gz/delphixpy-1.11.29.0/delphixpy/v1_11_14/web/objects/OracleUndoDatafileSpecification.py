...
from delphixpy.v1_11_14.web.objects.OracleDatafileTempfileSpecification import OracleDatafileTempfileSpecification
...
class OracleUndoDatafileSpecification(OracleDatafileTempfileSpecification):
    """
    *(extends* :py:class:`v1_11_14.web.vo.OracleDatafileTempfileSpecification`
