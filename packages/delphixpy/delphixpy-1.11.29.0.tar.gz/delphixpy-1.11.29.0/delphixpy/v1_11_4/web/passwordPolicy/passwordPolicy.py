...
def create(engine, password_policy=None):
    ...
    :type password_policy: :py:class:`v1_11_4.web.vo.PasswordPolicy`
    :rtype: ``str``
    """
...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_11_4.web.objects.PasswordPolicy.PasswordPolicy`
        object
    :type ref: ``str``
    :rtype: :py:class:`v1_11_4.web.vo.PasswordPolicy`
    """
...
def get_all(engine):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_11_4.delphix_engine.DelphixEngine`
    :rtype: ``list`` of :py:class:`v1_11_4.web.vo.PasswordPolicy`
    """
    url = "/resources/json/delphix/passwordPolicy"
    response = engine.get(url)
    result = response_validator.validate(response, engine)
...
def change_current_password_policy(engine, change_current_password_policy_parameters):
    ...
    :type change_current_password_policy_parameters:
        :py:class:`v1_11_4.web.vo.ChangeCurrentPasswordPolicyParameters`
    """
