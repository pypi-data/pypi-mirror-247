...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_11_4.web.objects.JSOperation.JSOperation`
        object
    :type ref: ``str``
...
def get_all(engine, data_layout=None, branch=None, data_time=None, before_count=None, after_count=None, data_start_time=None, data_end_time=None):
    ...
    :rtype: ``list`` of :py:class:`v1_11_4.web.vo.JSOperation`
    """
...
def endpoint(engine, js_operation_endpoint_parameters):
    ...
    :type js_operation_endpoint_parameters:
        :py:class:`v1_11_4.web.vo.JSOperationEndpointParameters`
    :rtype: :py:class:`v1_11_4.web.vo.JSOperationEndpoint`
    """
