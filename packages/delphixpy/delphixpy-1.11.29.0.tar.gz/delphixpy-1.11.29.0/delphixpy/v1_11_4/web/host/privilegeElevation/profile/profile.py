...
def create(engine, host_privilege_elevation_profile=None):
    ...
    :type host_privilege_elevation_profile:
        :py:class:`v1_11_4.web.vo.HostPrivilegeElevationProfile`
    :rtype: ``str``
    """
...
def get(engine, ref):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_11_4.delphix_engine.DelphixEngine`
    :param ref: Reference to a :py:class:`delphixpy.v1_11_4.web.objects.HostPri
        vilegeElevationProfile.HostPrivilegeElevationProfile` object
    :type ref: ``str``
    :rtype: :py:class:`v1_11_4.web.vo.HostPrivilegeElevationProfile`
    """
