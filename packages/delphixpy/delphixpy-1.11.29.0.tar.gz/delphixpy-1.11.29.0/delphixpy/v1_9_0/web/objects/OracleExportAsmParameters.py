...
from delphixpy.v1_9_0.web.objects.ExportParameters import ExportParameters
...
class OracleExportAsmParameters(ExportParameters):
    """
    *(extends* :py:class:`v1_9_0.web.vo.ExportParameters` *)* The parameters to
    ...
    def source_config(self):
        ...
        :rtype: :py:class:`v1_9_0.web.vo.OracleDBConfig`
        """
    ...
    def source(self):
        ...
        :rtype: :py:class:`v1_9_0.web.vo.OracleVirtualSource`
        """
