...
class MSSqlLinkData(LinkData):
    """
    *(extends* :py:class:`v1_9_0.web.vo.LinkData` *)* MSSQL specific parameters
    for a link request.
    """
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._delphix_managed_status[0] is not None and obj._delphix_managed_status[0] is not obj.__undef__:
            assert isinstance(obj._delphix_managed_status[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._delphix_managed_status[0], type(obj._delphix_managed_status[0])))
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "delphix_managed_status" == "type" or (self.delphix_managed_status is not self.__undef__ and (not (dirty and not self._delphix_managed_status[1]) or self.is_dirty_list(self.delphix_managed_status, self._delphix_managed_status) or belongs_to_parent)):
    ...
    def is_dirty(self):
        return any([self._config[1], self._external_file_path[1], self._shared_backup_location[1], self._backup_location_user[1], self._backup_location_credentials[1], self._encryption_key[1], self._sync_parameters[1], self._validated_sync_mode[1], self._operations[1], self._delphix_managed_status[1], self._source_host_user[1], self._db_user[1], self._db_credentials[1], self._ppt_repository[1], self._ppt_host_user[1], self._staging_pre_script[1], self._staging_post_script[1]])
    ...
    def sync_parameters(self):
        ...
        :rtype: :py:class:`v1_9_0.web.vo.MSSqlSyncParameters`
        """
