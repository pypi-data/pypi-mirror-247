...
from delphixpy.v1_9_0.web.objects.MySQLReplicationCoordinates import MySQLReplicationCoordinates
...
class MySQLGtidCoordinates(MySQLReplicationCoordinates):
    """
    *(extends* :py:class:`v1_9_0.web.vo.MySQLReplicationCoordinates` *)* The
