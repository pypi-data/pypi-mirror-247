...
from delphixpy.v1_9_0.web.objects.ToolkitLinkedSource import ToolkitLinkedSource
...
class ToolkitLinkedStagedSource(ToolkitLinkedSource):
    """
    *(extends* :py:class:`v1_9_0.web.vo.ToolkitLinkedSource` *)* A linked
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._worker[0] is not None and obj._worker[0] is not obj.__undef__:
            assert isinstance(obj._worker[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._worker[0], type(obj._worker[0])))
    ...
    def is_dirty(self):
        return any([self._resync[1], self._start_staging[1], self._stop_staging[1], self._status[1], self._worker[1], self._mount_spec[1]])
