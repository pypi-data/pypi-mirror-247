...
from delphixpy.v1_9_0.web.objects.VirtualDatasetCreationParameters import VirtualDatasetCreationParameters
...
class ProvisionParameters(VirtualDatasetCreationParameters):
    """
    *(extends* :py:class:`v1_9_0.web.vo.VirtualDatasetCreationParameters` *)*
    ...
    def is_dirty(self):
        return any([self._timeflow_point_parameters[1], self._masking_job[1]])
    ...
    def __eq__(self, other):
        ...
        return super().__eq__(other) and \
               ...
               self.masking_job == other.masking_job
