...
class ReplicationSpec(UserObject):
    """
    *(extends* :py:class:`v1_9_0.web.vo.UserObject` *)* Replication setup.
    """
    ...
    def object_specification(self):
        ...
        :rtype: :py:class:`v1_9_0.web.vo.ReplicationObjectSpecification`
        """
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_9_0.web.vo.ReplicationSpecRuntime`
        """
