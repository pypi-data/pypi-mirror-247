...
from delphixpy.v1_9_0.web.objects.MSSqlSource import MSSqlSource
...
class MSSqlLinkedSource(MSSqlSource):
    """
    *(extends* :py:class:`v1_9_0.web.vo.MSSqlSource` *)* A linked MSSQL source.
    """
    ...
    def is_dirty(self):
        return any([self._config[1], self._external_file_path[1], self._operations[1], self._shared_backup_location[1], self._backup_location_user[1], self._backup_location_credentials[1], self._staging_source[1], self._encryption_key[1], self._validated_sync_mode[1]])
