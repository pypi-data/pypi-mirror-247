...
class OracleClusterCreateParameters(SourceEnvironmentCreateParameters):
    ...
    *(extends* :py:class:`v1_9_0.web.vo.SourceEnvironmentCreateParameters` *)*
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "nodes" == "type" or (self.nodes is not self.__undef__ and (not (dirty and not self._nodes[1]) or self.is_dirty_list(self.nodes, self._nodes) or belongs_to_parent)):
    ...
    def cluster(self):
        ...
        :rtype: :py:class:`v1_9_0.web.vo.OracleCluster`
        """
