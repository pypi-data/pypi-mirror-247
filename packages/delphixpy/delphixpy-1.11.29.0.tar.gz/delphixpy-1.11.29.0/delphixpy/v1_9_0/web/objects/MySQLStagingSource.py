...
from delphixpy.v1_9_0.web.objects.MySQLSource import MySQLSource
...
class MySQLStagingSource(MySQLSource):
    """
    *(extends* :py:class:`v1_9_0.web.vo.MySQLSource` *)* A MySQL staging source
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_9_0.web.vo.MySQLSourceRuntime`
        """
