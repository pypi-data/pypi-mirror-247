...
class UnixHost(Host):
    """
    *(extends* :py:class:`v1_9_0.web.vo.Host` *)* The representation of a Unix
    host object.
    """
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._user_truststore_password[0] is not None and obj._user_truststore_password[0] is not obj.__undef__:
            assert isinstance(obj._user_truststore_password[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._user_truststore_password[0], type(obj._user_truststore_password[0])))
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "user_truststore_password" == "type" or (self.user_truststore_password is not self.__undef__ and (not (dirty and not self._user_truststore_password[1]) or self.is_dirty_list(self.user_truststore_password, self._user_truststore_password) or belongs_to_parent)):
    ...
    def is_dirty(self):
        return any([self._toolkit_path[1], self._user_truststore_password[1], self._ssh_verification_strategy[1], self._certificate_chain[1]])
    ...
    def __eq__(self, other):
        ...
        return super().__eq__(other) and \
               ...
               self.user_truststore_password == other.user_truststore_password and \
    ...
    def ssh_verification_strategy(self):
        ...
        :rtype: :py:class:`v1_9_0.web.vo.SshVerificationStrategy`
        """
