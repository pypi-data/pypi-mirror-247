...
Package "system"
"""
from delphixpy.v1_9_0.web.system import upgradeCheckResult
...
def get(engine):
    ...
    :rtype: :py:class:`v1_9_0.web.vo.SystemInfo`
    """
...
def set(engine, system_info=None):
    ...
    :type system_info: :py:class:`v1_9_0.web.vo.SystemInfo`
    """
    url = "/resources/json/delphix/system"
...
def enable_feature_flag(engine, feature_flag_parameters):
    ...
    :type feature_flag_parameters:
        :py:class:`v1_9_0.web.vo.FeatureFlagParameters`
    """
