...
from delphixpy.v1_11_22.web.objects.OracleManagedSource import OracleManagedSource
...
class OracleVirtualSource(OracleManagedSource):
    """
    *(extends* :py:class:`v1_11_22.web.vo.OracleManagedSource` *)* A virtual
    Oracle source.
    """
    ...
    def is_dirty(self):
        return any([self._operations[1], self._file_mapping_rules[1], self._redo_log_size_in_mb[1], self._redo_log_groups[1], self._archivelog_mode[1], self._custom_env_vars[1], self._allow_auto_vdb_restart_on_host_reboot[1], self._new_dbid[1], self._tde_key_identifier[1], self._source_status[1], self._invoke_datapatch[1]])
    ...
    def __eq__(self, other):
        ...
        return super().__eq__(other) and \
               ...
               self.invoke_datapatch == other.invoke_datapatch
    ...
    def operations(self):
        ...
        :rtype: :py:class:`v1_11_22.web.vo.VirtualSourceOperations`
        """
    ...
    def custom_env_vars(self):
        ...
        :rtype: ``list`` of :py:class:`v1_11_22.web.vo.OracleCustomEnvVar`
        """
