...
from delphixpy.v1_11_22.web.objects.NetworkTestParameters import NetworkTestParameters
...
class NetworkLatencyTestParameters(NetworkTestParameters):
    """
    *(extends* :py:class:`v1_11_22.web.vo.NetworkTestParameters` *)* Parameters
