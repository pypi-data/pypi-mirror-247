...
from delphixpy.v1_11_22.web.objects.SourceUpgradeParameters import SourceUpgradeParameters
...
class MSSqlLinkedSourceUpgradeParameters(SourceUpgradeParameters):
    """
    *(extends* :py:class:`v1_11_22.web.vo.SourceUpgradeParameters` *)* The
