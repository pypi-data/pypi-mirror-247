...
from delphixpy.v1_11_22.web.objects.PathConstraint import PathConstraint
...
class PathDescendantConstraint(PathConstraint):
    """
    *(extends* :py:class:`v1_11_22.web.vo.PathConstraint` *)* Constraint placed
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._descendant_of[0] is not None and obj._descendant_of[0] is not obj.__undef__:
            assert isinstance(obj._descendant_of[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._descendant_of[0], type(obj._descendant_of[0])))
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        def dictify(obj, prop_is_list_or_vo=False):
            if isinstance(obj, list):
                ...
                return obj
        if "descendant_of" == "type" or (self.descendant_of is not self.__undef__ and (not (dirty and not self._descendant_of[1]) or self.is_dirty_list(self.descendant_of, self._descendant_of) or belongs_to_parent)):
