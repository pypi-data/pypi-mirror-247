...
from delphixpy.v1_11_22.web.objects.OraclePDBAttachData import OraclePDBAttachData
...
class OracleSTConvertedToPDBAttachData(OraclePDBAttachData):
    """
    *(extends* :py:class:`v1_11_22.web.vo.OraclePDBAttachData` *)* Represents
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._new_pdb_container_name[0] is not None and obj._new_pdb_container_name[0] is not obj.__undef__:
            assert isinstance(obj._new_pdb_container_name[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._new_pdb_container_name[0], type(obj._new_pdb_container_name[0])))
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        def dictify(obj, prop_is_list_or_vo=False):
            if isinstance(obj, list):
                ...
                return obj
        if "new_pdb_container_name" == "type" or (self.new_pdb_container_name is not self.__undef__ and (not (dirty and not self._new_pdb_container_name[1]) or self.is_dirty_list(self.new_pdb_container_name, self._new_pdb_container_name) or belongs_to_parent)):
