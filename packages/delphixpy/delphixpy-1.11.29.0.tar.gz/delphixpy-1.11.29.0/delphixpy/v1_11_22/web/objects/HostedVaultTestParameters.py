...
from delphixpy.v1_11_22.web.objects.PasswordVaultTestParameters import PasswordVaultTestParameters
...
class HostedVaultTestParameters(PasswordVaultTestParameters):
    """
    *(extends* :py:class:`v1_11_22.web.vo.PasswordVaultTestParameters` *)*
