...
class RepaveEngineSummary(TypedObject):
    """
    *(extends* :py:class:`v1_11_22.web.vo.TypedObject` *)* Engine summary for
    Repave.
    """
    ...
    def is_dirty(self):
        return any([self._domain0_pool_guid[1], self._engine_type[1], self._engine_uuid[1], self._engine_installation_time[1], self._engine_build_version[1], self._engine_storage_type[1], self._cache_devices[1], self._hotfixes[1], self._ssh_public_key[1]])
