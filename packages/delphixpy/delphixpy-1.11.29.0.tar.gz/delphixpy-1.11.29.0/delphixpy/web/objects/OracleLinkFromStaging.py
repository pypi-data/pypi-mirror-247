...
from delphixpy.web.objects.OracleBaseStagingLinkData import OracleBaseStagingLinkData
...
class OracleLinkFromStaging(OracleBaseStagingLinkData):
    """
    *(extends* :py:class:`delphixpy.web.vo.OracleBaseStagingLinkData` *)*
    ...
    def staging_source_parameters(self):
        ...
        :rtype: :py:class:`delphixpy.web.vo.OracleStagingSourceParameters`
        """
