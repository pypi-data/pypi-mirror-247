...
from delphixpy.web.objects.OracleEnhancedExportParameters import OracleEnhancedExportParameters
...
class OraclePDBExportParameters(OracleEnhancedExportParameters):
    """
    *(extends* :py:class:`delphixpy.web.vo.OracleEnhancedExportParameters` *)*
    ...
    def transfer_strategy(self):
        ...
        :rtype: :py:class:`delphixpy.web.vo.OracleExportPDBTransferStrategy`
        """
