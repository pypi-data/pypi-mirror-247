...
#     /delphix-end-entity-certificate-replace-parameters.json
#
...
class EndEntityCertificateReplaceParameters(TypedObject):
    """
    *(extends* :py:class:`delphixpy.web.vo.TypedObject` *)* The parameters for
    replacing an end-entity certificate.
    """
    def __init__(self, undef_enabled=True):
        super().__init__()
        self._type = ("EndEntityCertificateReplaceParameters", True)
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if "endEntity" not in data:
            raise ValueError("Missing required property \"endEntity\".")
    ...
    def __eq__(self, other):
        if other is None:
            return False
        if not isinstance(other, EndEntityCertificateReplaceParameters):
            return False
    ...
    def end_entity(self):
        ...
        :rtype: :py:class:`delphixpy.web.vo.EndEntity`
        """
