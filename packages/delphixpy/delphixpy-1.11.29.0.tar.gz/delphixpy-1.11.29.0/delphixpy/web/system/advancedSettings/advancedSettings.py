...
def get(engine):
    ...
    :rtype: :py:class:`delphixpy.web.vo.AdvancedSettingsInfo`
    """
...
def get_tunable(engine, tunable_identifier):
    ...
    :type tunable_identifier: :py:class:`delphixpy.web.vo.TunableIdentifier`
    """
...
def set_tunable(engine, tunable):
    ...
    :type tunable: :py:class:`delphixpy.web.vo.Tunable`
    """
