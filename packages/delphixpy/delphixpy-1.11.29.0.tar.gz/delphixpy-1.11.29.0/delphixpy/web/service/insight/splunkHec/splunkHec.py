...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.web.objects.SplunkHecConfig.SplunkHecConfig`
        object
    :type ref: ``str``
    :rtype: :py:class:`delphixpy.web.vo.SplunkHecConfig`
    """
...
def get_all(engine):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.delphix_engine.DelphixEngine`
    :rtype: ``list`` of :py:class:`delphixpy.web.vo.SplunkHecConfig`
    """
    url = "/resources/json/delphix/service/insight/splunkHec"
    response = engine.get(url)
    result = response_validator.validate(response, engine)
