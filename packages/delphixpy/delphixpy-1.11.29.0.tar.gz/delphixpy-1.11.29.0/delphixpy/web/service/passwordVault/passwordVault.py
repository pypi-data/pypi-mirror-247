...
def create(engine, password_vault=None):
    ...
    :type password_vault: :py:class:`delphixpy.web.vo.PasswordVault`
    :rtype: ``str``
    """
...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.web.objects.PasswordVault.PasswordVault` object
    :type ref: ``str``
    :rtype: :py:class:`delphixpy.web.vo.PasswordVault`
    """
...
def get_all(engine):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.delphix_engine.DelphixEngine`
    :rtype: ``list`` of :py:class:`delphixpy.web.vo.PasswordVault`
    """
    url = "/resources/json/delphix/service/passwordVault"
    response = engine.get(url)
    result = response_validator.validate(response, engine)
...
def validate_vault(engine, password_vault_test_parameters=None):
    ...
    :type password_vault_test_parameters:
        :py:class:`delphixpy.web.vo.PasswordVaultTestParameters`
    """
