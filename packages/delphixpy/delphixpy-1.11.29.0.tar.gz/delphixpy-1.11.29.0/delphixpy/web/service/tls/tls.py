...
Package "service.tls"
"""
from delphixpy.web.service.tls import caCertificate
...
def get(engine):
    ...
    :rtype: :py:class:`delphixpy.web.vo.CertificateConfig`
    """
...
def set(engine, certificate_config=None):
    ...
    :type certificate_config: :py:class:`delphixpy.web.vo.CertificateConfig`
    """
    url = "/resources/json/delphix/service/tls"
