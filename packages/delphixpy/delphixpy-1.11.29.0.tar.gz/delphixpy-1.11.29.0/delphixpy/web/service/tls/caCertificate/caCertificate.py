...
def create(engine, pem_certificate):
    ...
    :type pem_certificate: :py:class:`delphixpy.web.vo.PemCertificate`
    :rtype: ``str``
    """
...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.web.objects.CaCertificate.CaCertificate` object
    :type ref: ``str``
    :rtype: :py:class:`delphixpy.web.vo.CaCertificate`
    """
...
def get_all(engine, delphix_ca=None):
    ...
    :rtype: ``list`` of :py:class:`delphixpy.web.vo.CaCertificate`
    """
    url = "/resources/json/delphix/service/tls/caCertificate"
