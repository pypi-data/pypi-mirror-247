...
def ssh(engine, ssh_connectivity=None):
    ...
    :type ssh_connectivity: :py:class:`v1_11_12.web.vo.SSHConnectivity`
    :rtype: ``str``
    """
...
def jdbc(engine, jdbc_connectivity=None):
    ...
    :type jdbc_connectivity: :py:class:`v1_11_12.web.vo.JDBCConnectivity`
    :rtype: ``str``
    """
...
def connector(engine, connector_connectivity=None):
    ...
    :type connector_connectivity:
        :py:class:`v1_11_12.web.vo.ConnectorConnectivity`
    :rtype: ``str``
    """
...
def netbackup(engine, netbackup_connectivity_parameters=None):
    ...
    :type netbackup_connectivity_parameters:
        :py:class:`v1_11_12.web.vo.NetbackupConnectivityParameters`
    :rtype: ``str``
    """
...
def dsp(engine, dsp_connectivity=None):
    ...
    :type dsp_connectivity: :py:class:`v1_11_12.web.vo.DspConnectivity`
    :rtype: ``str``
    """
...
def commvault(engine, commvault_connectivity_parameters=None):
    ...
    :type commvault_connectivity_parameters:
        :py:class:`v1_11_12.web.vo.CommvaultConnectivityParameters`
    :rtype: ``str``
    """
