...
class MSSqlBaseClusterRepository(MSSqlRepository):
    """
    *(extends* :py:class:`v1_11_12.web.vo.MSSqlRepository` *)* The
    ...
    def instances(self):
        ...
        :rtype: ``list`` of
            :py:class:`v1_11_12.web.vo.MSSqlBaseClusterInstance`
        """
    ...
    def listeners(self):
        ...
        :rtype: ``list`` of
            :py:class:`v1_11_12.web.vo.MSSqlBaseClusterListener`
        """
