    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        def dictify(obj, prop_is_list_or_vo=False):
            if isinstance(obj, list):
                ...
                return obj
        if "policy" == "type" or (self.policy is not self.__undef__ and (not (dirty and not self._policy[1]) or self.is_dirty_list(self.policy, self._policy) or belongs_to_parent)):
            dct["policy"] = dictify(self.policy, prop_is_list_or_vo=True)
