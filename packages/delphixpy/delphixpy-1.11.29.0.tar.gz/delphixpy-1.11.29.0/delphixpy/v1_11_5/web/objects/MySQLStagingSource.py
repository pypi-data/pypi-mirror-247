...
from delphixpy.v1_11_5.web.objects.MySQLSource import MySQLSource
...
class MySQLStagingSource(MySQLSource):
    """
    *(extends* :py:class:`v1_11_5.web.vo.MySQLSource` *)* A MySQL staging
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_11_5.web.vo.MySQLSourceRuntime`
        """
