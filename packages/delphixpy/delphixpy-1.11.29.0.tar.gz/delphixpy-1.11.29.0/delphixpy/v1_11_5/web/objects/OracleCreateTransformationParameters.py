...
from delphixpy.v1_11_5.web.objects.CreateTransformationParameters import CreateTransformationParameters
...
class OracleCreateTransformationParameters(CreateTransformationParameters):
    """
    *(extends* :py:class:`v1_11_5.web.vo.CreateTransformationParameters` *)*
