...
from delphixpy.v1_11_5.web.objects.OracleVirtualSource import OracleVirtualSource
...
class OracleVirtualPdbSource(OracleVirtualSource):
    """
    *(extends* :py:class:`v1_11_5.web.vo.OracleVirtualSource` *)* A virtual
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._parent_tde_keystore_password[0] is not None and obj._parent_tde_keystore_password[0] is not obj.__undef__:
            ...
            common.validate_format(obj._parent_tde_keystore_password[0], "password", 1, 256)
        ...
        if obj._tde_exported_key_file_secret[0] is not None and obj._tde_exported_key_file_secret[0] is not obj.__undef__:
            ...
            common.validate_format(obj._tde_exported_key_file_secret[0], "password", 1, 256)
