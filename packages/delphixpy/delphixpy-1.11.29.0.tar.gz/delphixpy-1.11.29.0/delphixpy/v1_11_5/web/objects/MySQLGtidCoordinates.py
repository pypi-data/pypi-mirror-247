...
from delphixpy.v1_11_5.web.objects.MySQLReplicationCoordinates import MySQLReplicationCoordinates
...
class MySQLGtidCoordinates(MySQLReplicationCoordinates):
    """
    *(extends* :py:class:`v1_11_5.web.vo.MySQLReplicationCoordinates` *)* The
