...
class ASESnapshot(TimeflowSnapshot):
    ...
    *(extends* :py:class:`v1_11_5.web.vo.TimeflowSnapshot` *)* Provisionable
    ...
    def is_dirty(self):
        return any([self._runtime[1], self._first_change_point[1], self._latest_change_point[1]])
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_11_5.web.vo.ASESnapshotRuntime`
        """
    ...
    def first_change_point(self):
        ...
        :rtype: :py:class:`v1_11_5.web.vo.ASETimeflowPoint`
        """
