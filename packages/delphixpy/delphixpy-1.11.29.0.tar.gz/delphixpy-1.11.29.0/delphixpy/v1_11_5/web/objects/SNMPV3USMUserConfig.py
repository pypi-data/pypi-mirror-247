    ...
    *(extends* :py:class:`v1_11_5.web.vo.PersistentObject` *)* SNMP USM User
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._authentication_protocol[0] is not None and obj._authentication_protocol[0] is not obj.__undef__:
            assert isinstance(obj._authentication_protocol[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._authentication_protocol[0], type(obj._authentication_protocol[0])))
        ...
        if obj._authentication_passphrase[0] is not None and obj._authentication_passphrase[0] is not obj.__undef__:
            assert isinstance(obj._authentication_passphrase[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._authentication_passphrase[0], type(obj._authentication_passphrase[0])))
        ...
        if obj._privacy_protocol[0] is not None and obj._privacy_protocol[0] is not obj.__undef__:
            assert isinstance(obj._privacy_protocol[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._privacy_protocol[0], type(obj._privacy_protocol[0])))
        ...
        if obj._privacy_passphrase[0] is not None and obj._privacy_passphrase[0] is not obj.__undef__:
            assert isinstance(obj._privacy_passphrase[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._privacy_passphrase[0], type(obj._privacy_passphrase[0])))
