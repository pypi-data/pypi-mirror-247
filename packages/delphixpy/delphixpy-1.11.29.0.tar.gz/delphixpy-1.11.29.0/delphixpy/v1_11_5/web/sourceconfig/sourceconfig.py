...
def create(engine, source_config=None):
    ...
    :type source_config: :py:class:`v1_11_5.web.vo.SourceConfig`
    :rtype: ``str``
    """
...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_11_5.web.objects.SourceConfig.SourceConfig`
        object
    :type ref: ``str``
    :rtype: :py:class:`v1_11_5.web.vo.SourceConfig`
    """
...
def get_all(engine, repository=None, environment=None, cdb_config=None, pdb_config_only=None):
    ...
    :rtype: ``list`` of :py:class:`v1_11_5.web.vo.SourceConfig`
    """
    url = "/resources/json/delphix/sourceconfig"
...
def validate_credentials(engine, ref, abstract_source_config_connectivity):
    ...
    :type abstract_source_config_connectivity:
        :py:class:`v1_11_5.web.vo.AbstractSourceConfigConnectivity`
    """
