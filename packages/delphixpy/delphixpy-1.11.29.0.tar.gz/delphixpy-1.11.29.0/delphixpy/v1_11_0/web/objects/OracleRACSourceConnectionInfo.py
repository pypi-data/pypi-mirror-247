...
from delphixpy.v1_11_0.web.objects.OracleSourceConnectionInfo import OracleSourceConnectionInfo
...
class OracleRACSourceConnectionInfo(OracleSourceConnectionInfo):
    """
    *(extends* :py:class:`v1_11_0.web.vo.OracleSourceConnectionInfo` *)*
