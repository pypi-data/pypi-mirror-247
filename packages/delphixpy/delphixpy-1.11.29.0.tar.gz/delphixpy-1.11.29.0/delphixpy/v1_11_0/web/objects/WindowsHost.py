...
from delphixpy.v1_11_0.web.objects.Host import Host
...
class WindowsHost(Host):
    """
    *(extends* :py:class:`v1_11_0.web.vo.Host` *)* The representation of a
    Windows host object.
    """
    ...
    def is_dirty(self):
        return any([self._connector_port[1], self._connector_authentication_key[1], self._toolkit_path[1]])
