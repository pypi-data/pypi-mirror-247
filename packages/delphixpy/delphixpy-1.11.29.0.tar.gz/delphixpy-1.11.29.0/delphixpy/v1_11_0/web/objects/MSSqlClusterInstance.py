...
from delphixpy.v1_11_0.web.objects.MSSqlBaseClusterInstance import MSSqlBaseClusterInstance
...
class MSSqlClusterInstance(MSSqlBaseClusterInstance):
    """
    *(extends* :py:class:`v1_11_0.web.vo.MSSqlBaseClusterInstance` *)* The
