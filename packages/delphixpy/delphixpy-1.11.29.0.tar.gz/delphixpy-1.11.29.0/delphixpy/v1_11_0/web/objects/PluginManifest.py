...
class PluginManifest(TypedObject):
    """
    *(extends* :py:class:`v1_11_0.web.vo.TypedObject` *)* A manifest describing
    a plugin.
    """
    ...
    def __eq__(self, other):
        ...
        return super().__eq__(other) and \
               ...
               self.has_initialize == other.has_initialize
