...
from delphixpy.v1_11_0.web.objects.MySQLExistingBackupSyncParameters import MySQLExistingBackupSyncParameters
...
class MySQLExistingMySQLDumpSyncParameters(MySQLExistingBackupSyncParameters):
    """
    *(extends* :py:class:`v1_11_0.web.vo.MySQLExistingBackupSyncParameters` *)*
