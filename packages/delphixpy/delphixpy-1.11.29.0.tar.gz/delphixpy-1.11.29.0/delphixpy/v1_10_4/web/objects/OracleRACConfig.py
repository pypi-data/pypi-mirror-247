...
from delphixpy.v1_10_4.web.objects.OracleDBConfig import OracleDBConfig
...
class OracleRACConfig(OracleDBConfig):
    """
    *(extends* :py:class:`v1_10_4.web.vo.OracleDBConfig` *)* Representation of
    ...
    def instances(self):
        ...
        :rtype: ``list`` of :py:class:`v1_10_4.web.vo.OracleRACInstance`
        """
