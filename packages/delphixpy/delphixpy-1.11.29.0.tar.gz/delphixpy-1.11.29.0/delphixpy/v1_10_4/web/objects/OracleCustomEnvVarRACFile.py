...
from delphixpy.v1_10_4.web.objects.OracleCustomEnvVarFile import OracleCustomEnvVarFile
...
class OracleCustomEnvVarRACFile(OracleCustomEnvVarFile):
    """
    *(extends* :py:class:`v1_10_4.web.vo.OracleCustomEnvVarFile` *)* Dictates
