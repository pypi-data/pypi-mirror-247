...
class Toolkit(NamedUserObject):
    """
    *(extends* :py:class:`v1_10_4.web.vo.NamedUserObject` *)* An installed
    toolkit.
    """
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "resources" == "type" or (self.resources is not self.__undef__ and (not (dirty and not self._resources[1]) or self.is_dirty_list(self.resources, self._resources) or belongs_to_parent)):
        ...
        if "source_code" == "type" or (self.source_code is not self.__undef__ and (not (dirty and not self._source_code[1]))):
            dct["sourceCode"] = dictify(self.source_code)
        if "entry_point" == "type" or (self.entry_point is not self.__undef__ and (not (dirty and not self._entry_point[1]))):
    ...
    def is_dirty(self):
        return any([self._pretty_name[1], self._language[1], self._name[1], self._version[1], self._build_api[1], self._host_types[1], self._root_squash_enabled[1], self._resources[1], self._virtual_source_definition[1], self._linked_source_definition[1], self._discovery_definition[1], self._upgrade_definition[1], self._default_locale[1], self._messages[1], self._snapshot_schema[1], self._source_code[1], self._entry_point[1]])
    ...
    def virtual_source_definition(self):
        ...
        :rtype: :py:class:`v1_10_4.web.vo.ToolkitVirtualSource`
        """
    ...
    def linked_source_definition(self):
        ...
        :rtype: :py:class:`v1_10_4.web.vo.ToolkitLinkedSource`
        """
    ...
    def discovery_definition(self):
        ...
        :rtype: :py:class:`v1_10_4.web.vo.ToolkitDiscoveryDefinition`
        """
    ...
    def upgrade_definition(self):
        ...
        :rtype: :py:class:`v1_10_4.web.vo.ToolkitUpgradeDefinition`
        """
    ...
    def messages(self):
        ...
        :rtype: ``list`` of :py:class:`v1_10_4.web.vo.ToolkitLocale`
        """
    ...
    def snapshot_schema(self):
        ...
        :rtype: :py:class:`v1_10_4.web.vo.SchemaDraftV4`
        """
    ...
    def source_code(self):
        """
        An encoded zip file of the toolkit's source directory.
    ...
    def entry_point(self):
        """
        A symbol that points to the toolkit's entry point.
