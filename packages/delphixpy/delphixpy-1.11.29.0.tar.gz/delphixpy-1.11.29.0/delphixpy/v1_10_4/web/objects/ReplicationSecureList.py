...
from delphixpy.v1_10_4.web.objects.ReplicationObjectSpecification import ReplicationObjectSpecification
...
class ReplicationSecureList(ReplicationObjectSpecification):
    """
    *(extends* :py:class:`v1_10_4.web.vo.ReplicationObjectSpecification` *)*
