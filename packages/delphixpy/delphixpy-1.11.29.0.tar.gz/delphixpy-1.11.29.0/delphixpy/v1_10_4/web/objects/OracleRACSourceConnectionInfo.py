...
from delphixpy.v1_10_4.web.objects.OracleSourceConnectionInfo import OracleSourceConnectionInfo
...
class OracleRACSourceConnectionInfo(OracleSourceConnectionInfo):
    """
    *(extends* :py:class:`v1_10_4.web.vo.OracleSourceConnectionInfo` *)*
