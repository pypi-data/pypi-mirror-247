...
from delphixpy.v1_10_4.web.objects.JSTimelinePointParameters import JSTimelinePointParameters
...
class JSTimelinePointBookmarkInput(JSTimelinePointParameters):
    """
    *(extends* :py:class:`v1_10_4.web.vo.JSTimelinePointParameters` *)*
