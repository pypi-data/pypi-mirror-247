...
from delphixpy.v1_10_4.web.objects.JSOperationEndpointParameters import JSOperationEndpointParameters
...
class JSOperationEndpointDataLayoutParameters(JSOperationEndpointParameters):
    """
    *(extends* :py:class:`v1_10_4.web.vo.JSOperationEndpointParameters` *)* The
