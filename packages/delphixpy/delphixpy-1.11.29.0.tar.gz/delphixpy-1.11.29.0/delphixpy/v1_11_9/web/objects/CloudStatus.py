...
class CloudStatus(TypedObject):
    """
    *(extends* :py:class:`v1_11_9.web.vo.TypedObject` *)* Delphix Cloud
    facilities.
    """
    ...
    def delphix_data_services_component_info(self):
        ...
        :rtype: :py:class:`v1_11_9.web.vo.DelphixDataServicesComponentInfo`
        """
    ...
    def proxy_configuration(self):
        ...
        :rtype: :py:class:`v1_11_9.web.vo.ProxyConfiguration`
        """
