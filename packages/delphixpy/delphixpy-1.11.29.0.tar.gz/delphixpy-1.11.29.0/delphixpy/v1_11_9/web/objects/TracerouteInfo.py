...
class TracerouteInfo(TypedObject):
    """
    *(extends* :py:class:`v1_11_9.web.vo.TypedObject` *)* Trace route info from
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._network_hops[0] is not None and obj._network_hops[0] is not obj.__undef__:
            assert isinstance(obj._network_hops[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._network_hops[0], type(obj._network_hops[0])))
