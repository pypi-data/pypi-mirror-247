...
def create(engine, network_dsp_test_parameters):
    ...
    :type network_dsp_test_parameters:
        :py:class:`v1_11_9.web.vo.NetworkDSPTestParameters`
    :rtype: ``str``
    """
...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_11_9.web.objects.NetworkDSPTest.NetworkDSPTest`
        object
    :type ref: ``str``
    :rtype: :py:class:`v1_11_9.web.vo.NetworkDSPTest`
    """
...
def get_all(engine, ascending=None):
    ...
    :type ascending: ``bool``
    :rtype: ``list`` of :py:class:`v1_11_9.web.vo.NetworkDSPTest`
    """
    url = "/resources/json/delphix/network/test/dsp"
