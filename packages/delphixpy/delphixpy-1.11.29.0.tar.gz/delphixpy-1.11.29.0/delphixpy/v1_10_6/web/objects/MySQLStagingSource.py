...
from delphixpy.v1_10_6.web.objects.MySQLSource import MySQLSource
...
class MySQLStagingSource(MySQLSource):
    """
    *(extends* :py:class:`v1_10_6.web.vo.MySQLSource` *)* A MySQL staging
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_10_6.web.vo.MySQLSourceRuntime`
        """
