...
class MSSqlAttachData(AttachData):
    """
    *(extends* :py:class:`v1_10_6.web.vo.AttachData` *)* Represents the MSSQL
    ...
    def ingestion_strategy(self):
        ...
        :rtype: :py:class:`v1_10_6.web.vo.IngestionStrategy`
        """
    ...
    def mssql_netbackup_config(self):
        ...
        :rtype: :py:class:`v1_10_6.web.vo.MSSqlNetbackupConfig`
        """
    ...
    def mssql_commvault_config(self):
        ...
        :rtype: :py:class:`v1_10_6.web.vo.MSSqlCommvaultConfig`
        """
