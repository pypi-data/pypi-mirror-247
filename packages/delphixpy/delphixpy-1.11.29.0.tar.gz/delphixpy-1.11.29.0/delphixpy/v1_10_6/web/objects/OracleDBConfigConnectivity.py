...
from delphixpy.v1_10_6.web.objects.AbstractSourceConfigConnectivity import AbstractSourceConfigConnectivity
...
class OracleDBConfigConnectivity(AbstractSourceConfigConnectivity):
    """
    *(extends* :py:class:`v1_10_6.web.vo.AbstractSourceConfigConnectivity` *)*
