...
from delphixpy.v1_10_6.web.objects.AbstractToolkit import AbstractToolkit
...
class Toolkit(AbstractToolkit):
    """
    *(extends* :py:class:`v1_10_6.web.vo.AbstractToolkit` *)* An installed Lua
    toolkit.
    """
    ...
    def is_dirty(self):
        return any([self._resources[1], self._virtual_source_definition[1], self._linked_source_definition[1], self._discovery_definition[1], self._upgrade_definition[1]])
    ...
    def virtual_source_definition(self):
        ...
        :rtype: :py:class:`v1_10_6.web.vo.ToolkitVirtualSource`
        """
    ...
    def linked_source_definition(self):
        ...
        :rtype: :py:class:`v1_10_6.web.vo.ToolkitLinkedSource`
        """
    ...
    def discovery_definition(self):
        ...
        :rtype: :py:class:`v1_10_6.web.vo.ToolkitDiscoveryDefinition`
        """
    ...
    def upgrade_definition(self):
        ...
        :rtype: :py:class:`v1_10_6.web.vo.ToolkitUpgradeDefinition`
        """
