...
from delphixpy.v1_10_6.web.objects.TimeflowPointParameters import TimeflowPointParameters
...
class TimeflowPointSnapshot(TimeflowPointParameters):
    """
    *(extends* :py:class:`v1_10_6.web.vo.TimeflowPointParameters` *)* TimeFlow
