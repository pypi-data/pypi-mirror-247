...
from delphixpy.v1_10_6.web.objects.MSSqlBaseClusterInstance import MSSqlBaseClusterInstance
...
class MSSqlFailoverClusterInstance(MSSqlBaseClusterInstance):
    """
    *(extends* :py:class:`v1_10_6.web.vo.MSSqlBaseClusterInstance` *)* The
