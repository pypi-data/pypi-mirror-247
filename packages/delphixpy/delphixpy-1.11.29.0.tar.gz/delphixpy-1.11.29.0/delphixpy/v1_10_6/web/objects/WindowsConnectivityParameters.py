...
from delphixpy.v1_10_6.web.objects.ConnectivityParameters import ConnectivityParameters
...
class WindowsConnectivityParameters(ConnectivityParameters):
    """
    *(extends* :py:class:`v1_10_6.web.vo.ConnectivityParameters` *)* Parameters
