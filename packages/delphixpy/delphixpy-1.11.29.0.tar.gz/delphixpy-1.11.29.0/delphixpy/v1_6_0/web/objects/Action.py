...
from delphixpy.v1_6_0.web.objects.PersistentObject import PersistentObject
...
class Action(PersistentObject):
    """
    *(extends* :py:class:`v1_6_0.web.vo.PersistentObject` *)* Represents an
    ...
    def is_dirty(self):
        return any([self._action_type[1], self._details[1], self._end_time[1], self._failure_action[1], self._failure_description[1], self._failure_message_code[1], self._parent_action[1], self._report[1], self._start_time[1], self._state[1], self._title[1], self._user[1], self._user_agent[1], self._work_source[1], self._work_source_name[1]])
