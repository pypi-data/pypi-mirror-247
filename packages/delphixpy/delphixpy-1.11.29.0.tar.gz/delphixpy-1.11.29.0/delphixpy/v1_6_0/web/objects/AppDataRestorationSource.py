...
from delphixpy.v1_6_0.web.objects.AppDataManagedSource import AppDataManagedSource
...
class AppDataRestorationSource(AppDataManagedSource):
    """
    *(extends* :py:class:`v1_6_0.web.vo.AppDataManagedSource` *)* A restoration
    AppData source.
    """
    ...
    def additional_mount_points(self):
        ...
        :rtype: ``list`` of
            :py:class:`v1_6_0.web.vo.AppDataAdditionalMountPoint`
        """
