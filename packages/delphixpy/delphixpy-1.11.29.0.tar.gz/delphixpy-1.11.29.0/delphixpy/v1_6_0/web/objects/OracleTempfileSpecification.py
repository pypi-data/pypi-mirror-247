...
from delphixpy.v1_6_0.web.objects.OracleDatafileTempfileSpecification import OracleDatafileTempfileSpecification
...
class OracleTempfileSpecification(OracleDatafileTempfileSpecification):
    """
    *(extends* :py:class:`v1_6_0.web.vo.OracleDatafileTempfileSpecification`
