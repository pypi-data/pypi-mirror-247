...
class SourcingPolicy(TypedObject):
    """
    *(extends* :py:class:`v1_6_0.web.vo.TypedObject` *)* Database policies for
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "logsync_enabled" == "type" or (self.logsync_enabled is not self.__undef__ and (not (dirty and not self._logsync_enabled[1]) or self.is_dirty_list(self.logsync_enabled, self._logsync_enabled) or belongs_to_parent)):
