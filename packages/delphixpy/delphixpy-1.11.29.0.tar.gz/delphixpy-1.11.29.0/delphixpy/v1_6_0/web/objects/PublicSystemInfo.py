...
class PublicSystemInfo(TypedObject):
    """
    *(extends* :py:class:`v1_6_0.web.vo.TypedObject` *)* Retrieve static
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        for item in data.get("enabledFeatures") or []:
            ...
            assert item in ['XPP', 'CONSPRO', 'NUCARD', 'REGISTRATIONREQUIRED', 'PHONEHOMEREQUIRED', 'MDD', 'MSSQLHOOKS'], "Expected enum ['XPP', 'CONSPRO', 'NUCARD', 'REGISTRATIONREQUIRED', 'PHONEHOMEREQUIRED', 'MDD', 'MSSQLHOOKS'] but got %s" % item
    ...
    def is_dirty(self):
        return any([self._api_version[1], self._banner[1], self._build_timestamp[1], self._build_title[1], self._build_version[1], self._configured[1], self._current_locale[1], self._enabled_features[1], self._locales[1], self._product_name[1], self._product_type[1]])
    ...
    def api_version(self):
        ...
        :rtype: :py:class:`v1_6_0.web.vo.APIVersion`
        """
    ...
    def build_version(self):
        ...
        :rtype: :py:class:`v1_6_0.web.vo.VersionInfo`
        """
