...
#     /delphix-timeflow-point-engine-time.json
#
# Do not edit this file manually!
#

from delphixpy.v1_6_0.web.objects.TimeflowPointParameters import TimeflowPointParameters
...
class TimeflowPointEngineTime(TimeflowPointParameters):
    """
    *(extends* :py:class:`v1_6_0.web.vo.TimeflowPointParameters` *)* TimeFlow
    point based on a Delphix Engine timestamp.
    """
    def __init__(self, undef_enabled=True):
        super().__init__()
        self._type = ("TimeflowPointEngineTime", True)
    ...
    def is_dirty(self):
        return any([self._container[1], self._timestamp[1]])
    ...
    def __eq__(self, other):
        if other is None:
            return False
        if not isinstance(other, TimeflowPointEngineTime):
            return False
    ...
    def container(self):
        """
        Reference to the container containing this point.
    ...
    def timestamp(self):
        """
        The desired date in Delphix Engine time.
