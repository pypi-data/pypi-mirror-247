...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_6_0.web.objects.JSDataSource.JSDataSource`
        object
    :type ref: ``str``
    :rtype: :py:class:`v1_6_0.web.vo.JSDataSource`
    """
...
def get_all(engine, container=None, data_layout=None):
    ...
    :rtype: ``list`` of :py:class:`v1_6_0.web.vo.JSDataSource`
    """
...
def update(engine, ref, js_data_source=None):
    ...
    :type js_data_source: :py:class:`v1_6_0.web.vo.JSDataSource`
    """
    url = "/resources/json/delphix/jetstream/datasource/%s" % ref
...
def data_timestamps(engine, js_source_data_timestamp_parameters):
    ...
    :type js_source_data_timestamp_parameters:
        :py:class:`v1_6_0.web.vo.JSSourceDataTimestampParameters`
    :rtype: ``list`` of :py:class:`v1_6_0.web.vo.JSSourceDataTimestamp`
    """
