...
class ProvisionParameters(TypedObject):
    ...
    *(extends* :py:class:`v1_4_3.web.vo.TypedObject` *)* The parameters to use
    ...
    def is_dirty(self):
        return any([self._container[1], self._source[1], self._source_config[1], self._timeflow_point_parameters[1]])
    ...
    def timeflow_point_parameters(self):
        ...
        :rtype: :py:class:`v1_4_3.web.vo.TimeflowPointParameters`
        """
