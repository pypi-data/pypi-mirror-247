...
from delphixpy.v1_4_3.web.objects.DatabaseContainer import DatabaseContainer
...
class OracleDatabaseContainer(DatabaseContainer):
    """
    *(extends* :py:class:`v1_4_3.web.vo.DatabaseContainer` *)* Data container
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_4_3.web.vo.OracleDBContainerRuntime`
        """
    ...
    def sourcing_policy(self):
        ...
        :rtype: :py:class:`v1_4_3.web.vo.OracleSourcingPolicy`
        """
