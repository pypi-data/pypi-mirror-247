...
class OracleLinkedSource(OracleSource):
    """
    *(extends* :py:class:`v1_4_3.web.vo.OracleSource` *)* A linked Oracle
    source.
    """
    ...
    def is_dirty(self):
        return any([self._backup_level_enabled[1], self._bandwidth_limit[1], self._check_logical[1], self._compressed_linking_enabled[1], self._config[1], self._encrypted_linking_enabled[1], self._external_file_path[1], self._files_per_set[1], self._number_of_connections[1], self._post_script[1], self._pre_script[1], self._rman_channels[1]])
