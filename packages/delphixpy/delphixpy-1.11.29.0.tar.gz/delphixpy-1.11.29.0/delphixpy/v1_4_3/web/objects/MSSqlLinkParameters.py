...
from delphixpy.v1_4_3.web.objects.LinkParameters import LinkParameters
...
class MSSqlLinkParameters(LinkParameters):
    """
    *(extends* :py:class:`v1_4_3.web.vo.LinkParameters` *)* MSSQL specific
    ...
    def container(self):
        ...
        :rtype: :py:class:`v1_4_3.web.vo.MSSqlDatabaseContainer`
        """
    ...
    def source(self):
        ...
        :rtype: :py:class:`v1_4_3.web.vo.MSSqlLinkedSource`
        """
