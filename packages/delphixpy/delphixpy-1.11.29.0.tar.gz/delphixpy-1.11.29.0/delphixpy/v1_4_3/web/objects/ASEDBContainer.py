...
class ASEDBContainer(DatabaseContainer):
    """
    *(extends* :py:class:`v1_4_3.web.vo.DatabaseContainer` *)* An SAP ASE
    Database Container.
    """
    ...
    def is_dirty(self):
        return any([self._os[1], self._processor[1], self._runtime[1], self._sourcing_policy[1]])
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_4_3.web.vo.ASEDBContainerRuntime`
        """
    ...
    def sourcing_policy(self):
        ...
        :rtype: :py:class:`v1_4_3.web.vo.SourcingPolicy`
        """
