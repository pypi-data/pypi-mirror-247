...
class PurgeLogsResult(TypedObject):
    """
    *(extends* :py:class:`v1_4_3.web.vo.TypedObject` *)* Represents the result
    ...
    def affected_snapshots(self):
        ...
        :rtype: ``list`` of :py:class:`v1_4_3.web.vo.TimeflowSnapshot`
        """
    ...
    def truncate_point(self):
        ...
        :rtype: :py:class:`v1_4_3.web.vo.OracleTimeflowPoint`
        """
