...
from delphixpy.v1_4_3.web.objects.ReadonlyNamedUserObject import ReadonlyNamedUserObject
...
class Authorization(ReadonlyNamedUserObject):
    """
    *(extends* :py:class:`v1_4_3.web.vo.ReadonlyNamedUserObject` *)* Describes
