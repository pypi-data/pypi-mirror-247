...
from delphixpy.v1_4_3.web.objects.MSSqlDBConfig import MSSqlDBConfig
...
class MSSqlSIConfig(MSSqlDBConfig):
    """
    *(extends* :py:class:`v1_4_3.web.vo.MSSqlDBConfig` *)* Configuration
    ...
    def instance(self):
        ...
        :rtype: :py:class:`v1_4_3.web.vo.MSSqlInstanceConfig`
        """
