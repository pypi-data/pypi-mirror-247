...
class OracleActiveInstance(TypedObject):
    """
    *(extends* :py:class:`v1_11_10.web.vo.TypedObject` *)* Active instance
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._host_name[0] is not None and obj._host_name[0] is not obj.__undef__:
            assert isinstance(obj._host_name[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._host_name[0], type(obj._host_name[0])))
