...
class RegistrationInfo(TypedObject):
    """
    *(extends* :py:class:`v1_11_10.web.vo.TypedObject` *)* The information
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._code[0] is not None and obj._code[0] is not obj.__undef__:
            assert isinstance(obj._code[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._code[0], type(obj._code[0])))
        ...
        if obj._registration_portal_hostname[0] is not None and obj._registration_portal_hostname[0] is not obj.__undef__:
            assert isinstance(obj._registration_portal_hostname[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._registration_portal_hostname[0], type(obj._registration_portal_hostname[0])))
