...
class SsoSuccessfulLoginRecord(TypedObject):
    """
    *(extends* :py:class:`v1_11_10.web.vo.TypedObject` *)* Represents a failed
    SSO login.
    """
    ...
    def is_dirty(self):
        return any([self._email[1], self._user_agent[1], self._origin_ip[1], self._asserting_entity_id[1]])
