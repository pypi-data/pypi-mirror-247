...
from delphixpy.v1_11_10.web.objects.AggregateCapacityData import AggregateCapacityData
...
class BaseSystemCapacityData(AggregateCapacityData):
    """
    *(extends* :py:class:`v1_11_10.web.vo.AggregateCapacityData` *)* Capacity
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._total_space[0] is not None and obj._total_space[0] is not obj.__undef__:
            assert isinstance(obj._total_space[0], float), ("Expected one of ['number'], but got %s of type %s" % (obj._total_space[0], type(obj._total_space[0])))
