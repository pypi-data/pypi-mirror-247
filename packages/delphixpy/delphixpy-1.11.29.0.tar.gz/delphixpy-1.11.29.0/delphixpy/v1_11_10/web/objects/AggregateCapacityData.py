...
class AggregateCapacityData(TypedObject):
    """
    *(extends* :py:class:`v1_11_10.web.vo.TypedObject` *)* Capacity data for an
    ...
    def is_dirty(self):
        return any([self._timestamp[1], self._source[1], self._virtual[1]])
    ...
    def source(self):
        ...
        :rtype: :py:class:`v1_11_10.web.vo.CapacityBreakdown`
        """
