...
from delphixpy.v1_11_10.web.objects.VirtualDatasetCreationParameters import VirtualDatasetCreationParameters
...
class ProvisionParameters(VirtualDatasetCreationParameters):
    """
    *(extends* :py:class:`v1_11_10.web.vo.VirtualDatasetCreationParameters` *)*
