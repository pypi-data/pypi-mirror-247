...
from delphixpy.v1_11_10.web.objects.NetworkTestParameters import NetworkTestParameters
...
class NetworkLatencyTestParameters(NetworkTestParameters):
    """
    *(extends* :py:class:`v1_11_10.web.vo.NetworkTestParameters` *)* Parameters
