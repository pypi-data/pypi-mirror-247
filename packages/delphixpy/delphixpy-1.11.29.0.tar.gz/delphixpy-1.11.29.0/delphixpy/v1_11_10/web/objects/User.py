...
from delphixpy.v1_11_10.web.objects.NamedUserObject import NamedUserObject
...
class User(NamedUserObject):
    """
    *(extends* :py:class:`v1_11_10.web.vo.NamedUserObject` *)* Delphix users.
    """
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "locale" == "type" or (self.locale is not self.__undef__ and (not (dirty and not self._locale[1]) or self.is_dirty_list(self.locale, self._locale) or belongs_to_parent)):
            ...
            dct["locale"] = "en-US"
        if "api_user" == "type" or (self.api_user is not self.__undef__ and (not (dirty and not self._api_user[1]) or self.is_dirty_list(self.api_user, self._api_user) or belongs_to_parent)):
