...
from delphixpy.v1_11_10.web.objects.JSTimelinePointParameters import JSTimelinePointParameters
...
class JSTimelinePointBookmarkInput(JSTimelinePointParameters):
    """
    *(extends* :py:class:`v1_11_10.web.vo.JSTimelinePointParameters` *)*
