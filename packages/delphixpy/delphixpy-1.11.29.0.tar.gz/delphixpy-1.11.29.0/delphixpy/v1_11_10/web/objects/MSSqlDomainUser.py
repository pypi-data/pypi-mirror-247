...
#     /delphix-mssql-domain-user.json
#
# Do not edit this file manually!
#

from delphixpy.v1_11_10.web.objects.MSSqlUser import MSSqlUser
...
class MSSqlDomainUser(MSSqlUser):
    """
    *(extends* :py:class:`v1_11_10.web.vo.MSSqlUser` *)* Represents the mssql
    domain user.
    """
    def __init__(self, undef_enabled=True):
        super().__init__()
        self._type = ("MSSqlDomainUser", True)
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if "password" in data and data["password"] is not None:
            obj._password = (factory.create_object(data["password"], "Credential"), dirty)
            factory.validate_type(obj._password[0], "Credential")
        else:
    ...
    def __eq__(self, other):
        if other is None:
            return False
        if not isinstance(other, MSSqlDomainUser):
            return False
