...
class S3ObjectStoreTest(TypedObject):
    """
    *(extends* :py:class:`v1_11_10.web.vo.TypedObject` *)* An Amazon S3 object
    store connectivity test object.
    """
    ...
    def access_credentials(self):
        ...
        :rtype: :py:class:`v1_11_10.web.vo.S3ObjectStoreAccess`
        """
