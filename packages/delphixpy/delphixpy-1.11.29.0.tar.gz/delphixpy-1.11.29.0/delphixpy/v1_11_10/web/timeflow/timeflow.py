...
Package "timeflow"
"""
from delphixpy.v1_11_10.web.timeflow import bookmark
from delphixpy.v1_11_10.web.timeflow import oracle
...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_11_10.web.objects.Timeflow.Timeflow` object
    :type ref: ``str``
    :rtype: :py:class:`v1_11_10.web.vo.Timeflow`
    """
...
def get_all(engine, database=None):
    ...
    :type database: ``str``
    :rtype: ``list`` of :py:class:`v1_11_10.web.vo.Timeflow`
    """
...
def update(engine, ref, timeflow=None):
    ...
    :type timeflow: :py:class:`v1_11_10.web.vo.Timeflow`
    """
    url = "/resources/json/delphix/timeflow/%s" % ref
...
def timeflow_ranges(engine, ref, timeflow_range_parameters=None):
    ...
    :type timeflow_range_parameters:
        :py:class:`v1_11_10.web.vo.TimeflowRangeParameters`
    :rtype: ``list`` of :py:class:`v1_11_10.web.vo.TimeflowRange`
    """
...
def repair(engine, ref, timeflow_repair_parameters=None):
    ...
    :type timeflow_repair_parameters:
        :py:class:`v1_11_10.web.vo.TimeflowRepairParameters`
    """
