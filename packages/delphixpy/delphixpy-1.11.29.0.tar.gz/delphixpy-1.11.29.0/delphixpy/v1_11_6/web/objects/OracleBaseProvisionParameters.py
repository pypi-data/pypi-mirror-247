...
class OracleBaseProvisionParameters(ProvisionParameters):
    """
    *(extends* :py:class:`v1_11_6.web.vo.ProvisionParameters` *)* Parameters
    ...
    def container(self):
        ...
        :rtype: :py:class:`v1_11_6.web.vo.OracleDatabaseContainer`
        """
    ...
    def source_config(self):
        ...
        :rtype: :py:class:`v1_11_6.web.vo.OracleBaseDBConfig`
        """
