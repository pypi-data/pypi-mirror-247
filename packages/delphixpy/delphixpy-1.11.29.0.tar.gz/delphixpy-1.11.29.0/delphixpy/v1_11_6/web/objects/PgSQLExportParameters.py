...
from delphixpy.v1_11_6.web.objects.DbExportParameters import DbExportParameters
...
class PgSQLExportParameters(DbExportParameters):
    """
    *(extends* :py:class:`v1_11_6.web.vo.DbExportParameters` *)* The parameters
    ...
    def is_dirty(self):
        return any([self._source_config[1], self._filesystem_layout[1], self._hba_entries[1], self._ident_entries[1]])
    ...
    def source_config(self):
        ...
        :rtype: :py:class:`v1_11_6.web.vo.PgSQLDBClusterConfig`
        """
    ...
    def filesystem_layout(self):
        ...
        :rtype: :py:class:`v1_11_6.web.vo.TimeflowFilesystemLayout`
        """
    ...
    def hba_entries(self):
        ...
        :rtype: ``list`` of :py:class:`v1_11_6.web.vo.PgSQLHBAEntry`
        """
    ...
    def ident_entries(self):
        ...
        :rtype: ``list`` of :py:class:`v1_11_6.web.vo.PgSQLIdentEntry`
        """
