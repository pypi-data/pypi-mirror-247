...
from delphixpy.v1_11_6.web.objects.OracleFileSpecification import OracleFileSpecification
...
class OracleDatafileTempfileSpecification(OracleFileSpecification):
    """
    *(extends* :py:class:`v1_11_6.web.vo.OracleFileSpecification` *)* Describes
