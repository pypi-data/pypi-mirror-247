...
from delphixpy.v1_11_6.web.objects.JSTimelinePointParameters import JSTimelinePointParameters
...
class JSTimelinePointTimeParameters(JSTimelinePointParameters):
    """
    *(extends* :py:class:`v1_11_6.web.vo.JSTimelinePointParameters` *)*
