...
def create(engine, snmpv3_usm_user_config=None):
    ...
    :type snmpv3_usm_user_config:
        :py:class:`v1_11_6.web.vo.SNMPV3USMUserConfig`
    :rtype: ``str``
    """
...
def get(engine, ref):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_11_6.delphix_engine.DelphixEngine`
    :param ref: Reference to a :py:class:`delphixpy.v1_11_6.web.objects.SNMPV3U
        SMUserConfig.SNMPV3USMUserConfig` object
    :type ref: ``str``
    :rtype: :py:class:`v1_11_6.web.vo.SNMPV3USMUserConfig`
    """
...
def get_all(engine):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_11_6.delphix_engine.DelphixEngine`
    :rtype: ``list`` of :py:class:`v1_11_6.web.vo.SNMPV3USMUserConfig`
    """
    url = "/resources/json/delphix/service/snmp/v3/usm"
    response = engine.get(url)
    result = response_validator.validate(response, engine)
