...
from delphixpy.v1_10_5.web.objects.ReplicationObjectSpecification import ReplicationObjectSpecification
...
class ReplicationList(ReplicationObjectSpecification):
    """
    *(extends* :py:class:`v1_10_5.web.vo.ReplicationObjectSpecification` *)*
