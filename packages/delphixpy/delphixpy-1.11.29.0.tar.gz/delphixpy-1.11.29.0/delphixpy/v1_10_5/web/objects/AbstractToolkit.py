...
class AbstractToolkit(NamedUserObject):
    """
    *(extends* :py:class:`v1_10_5.web.vo.NamedUserObject` *)* An installed
    toolkit.
    """
    ...
    def is_dirty(self):
        return any([self._pretty_name[1], self._language[1], self._name[1], self._version[1], self._build_api[1], self._host_types[1], self._root_squash_enabled[1], self._default_locale[1], self._messages[1], self._snapshot_schema[1]])
    ...
    def build_api(self):
        ...
        :rtype: :py:class:`v1_10_5.web.vo.APIVersion`
        """
    ...
    def messages(self):
        ...
        :rtype: ``list`` of :py:class:`v1_10_5.web.vo.ToolkitLocale`
        """
