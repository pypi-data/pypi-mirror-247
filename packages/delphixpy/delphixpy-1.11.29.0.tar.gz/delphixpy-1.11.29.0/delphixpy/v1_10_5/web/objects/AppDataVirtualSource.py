...
from delphixpy.v1_10_5.web.objects.AppDataManagedSource import AppDataManagedSource
...
class AppDataVirtualSource(AppDataManagedSource):
    """
    *(extends* :py:class:`v1_10_5.web.vo.AppDataManagedSource` *)* A virtual
    AppData source.
    """
    ...
    def additional_mount_points(self):
        ...
        :rtype: ``list`` of
            :py:class:`v1_10_5.web.vo.AppDataAdditionalMountPoint`
        """
