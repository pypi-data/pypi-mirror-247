...
from delphixpy.v1_10_5.web.objects.BaseSupportBundleParameters import BaseSupportBundleParameters
...
class SupportBundleUploadParameters(BaseSupportBundleParameters):
    """
    *(extends* :py:class:`v1_10_5.web.vo.BaseSupportBundleParameters` *)*
