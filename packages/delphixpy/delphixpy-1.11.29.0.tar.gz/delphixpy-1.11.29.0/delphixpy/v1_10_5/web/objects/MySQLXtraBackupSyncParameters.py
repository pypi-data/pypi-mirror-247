...
from delphixpy.v1_10_5.web.objects.MySQLExistingBackupSyncParameters import MySQLExistingBackupSyncParameters
...
class MySQLXtraBackupSyncParameters(MySQLExistingBackupSyncParameters):
    """
    *(extends* :py:class:`v1_10_5.web.vo.MySQLExistingBackupSyncParameters` *)*
