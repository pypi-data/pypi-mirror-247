...
#     /delphix-plugin-upgrade-definition.json
#
...
class PluginUpgradeDefinition(TypedObject):
    """
    *(extends* :py:class:`v1_10_5.web.vo.TypedObject` *)* The plugin upgrade
    logic to upgrade metadata from the previous version of the plugin.
    """
    def __init__(self, undef_enabled=True):
        super().__init__()
        self._type = ("PluginUpgradeDefinition", True)
    ...
    def is_dirty(self):
        return any([self._from_version[1]])
    ...
    def __eq__(self, other):
        if other is None:
            return False
        if not isinstance(other, PluginUpgradeDefinition):
            return False
    ...
    def from_version(self):
        """
        The version of the plugin that we are upgrading from.
