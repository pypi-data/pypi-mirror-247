...
from delphixpy.v1_10_5.web.objects.OracleSourceConnectionInfo import OracleSourceConnectionInfo
...
class OracleRACSourceConnectionInfo(OracleSourceConnectionInfo):
    """
    *(extends* :py:class:`v1_10_5.web.vo.OracleSourceConnectionInfo` *)*
