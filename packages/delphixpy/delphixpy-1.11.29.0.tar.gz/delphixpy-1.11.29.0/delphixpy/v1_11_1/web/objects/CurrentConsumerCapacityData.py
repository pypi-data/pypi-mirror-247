...
from delphixpy.v1_11_1.web.objects.BaseConsumerCapacityData import BaseConsumerCapacityData
...
class CurrentConsumerCapacityData(BaseConsumerCapacityData):
    """
    *(extends* :py:class:`v1_11_1.web.vo.BaseConsumerCapacityData` *)* Current
