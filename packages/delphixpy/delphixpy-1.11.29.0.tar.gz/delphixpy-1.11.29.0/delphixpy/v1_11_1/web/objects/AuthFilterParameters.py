    ...
    *(extends* :py:class:`v1_11_1.web.vo.TypedObject` *)* The parameters to use
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._permission[0] is not None and obj._permission[0] is not obj.__undef__:
            assert isinstance(obj._permission[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._permission[0], type(obj._permission[0])))
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        def dictify(obj, prop_is_list_or_vo=False):
            if isinstance(obj, list):
                ...
                return obj
        if "permission" == "type" or (self.permission is not self.__undef__ and (not (dirty and not self._permission[1]) or self.is_dirty_list(self.permission, self._permission) or belongs_to_parent)):
