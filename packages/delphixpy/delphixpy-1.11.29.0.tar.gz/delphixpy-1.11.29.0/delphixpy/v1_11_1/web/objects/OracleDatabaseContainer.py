...
from delphixpy.v1_11_1.web.objects.DatabaseContainer import DatabaseContainer
...
class OracleDatabaseContainer(DatabaseContainer):
    """
    *(extends* :py:class:`v1_11_1.web.vo.DatabaseContainer` *)* Data container
    ...
    def __init__(self, undef_enabled=True):
        ...
        self._tde_provisioning_enabled = (self.__undef__, True)
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        obj._tde_provisioning_enabled = (data.get("tdeProvisioningEnabled", obj.__undef__), dirty)
        if obj._tde_provisioning_enabled[0] is not None and obj._tde_provisioning_enabled[0] is not obj.__undef__:
            assert isinstance(obj._tde_provisioning_enabled[0], bool), ("Expected one of ['boolean'], but got %s of type %s" % (obj._tde_provisioning_enabled[0], type(obj._tde_provisioning_enabled[0])))
            common.validate_format(obj._tde_provisioning_enabled[0], "None", None, None)
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "tde_provisioning_enabled" == "type" or (self.tde_provisioning_enabled is not self.__undef__ and (not (dirty and not self._tde_provisioning_enabled[1]))):
            dct["tdeProvisioningEnabled"] = dictify(self.tde_provisioning_enabled)
    ...
    def force_dirty(self):
        ...
        self._tde_provisioning_enabled = (self._tde_provisioning_enabled[0], True)
        self._content_type = (self._content_type[0], True)
        self._performance_mode = (self._performance_mode[0], True)

    def is_dirty(self):
        return any([self._diagnose_no_logging_faults[1], self._runtime[1], self._pre_provisioning_enabled[1], self._sourcing_policy[1], self._physical_standby[1], self._live_source[1], self._tde_provisioning_enabled[1], self._content_type[1], self._performance_mode[1]])
    ...
    def __eq__(self, other):
        ...
        return super().__eq__(other) and \
               ...
               self.tde_provisioning_enabled == other.tde_provisioning_enabled and \
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_11_1.web.vo.OracleDBContainerRuntime`
        """
    ...
    def sourcing_policy(self):
        ...
        :rtype: :py:class:`v1_11_1.web.vo.OracleSourcingPolicy`
        """
    ...
    @property
    def tde_provisioning_enabled(self):
        """
        Indicates whether or not the data in this container is encrypted with
        TDE (Transparent Data Encryption).

        :rtype: ``bool``
        """
        return self._tde_provisioning_enabled[0]

    @tde_provisioning_enabled.setter
    def tde_provisioning_enabled(self, value):
        self._tde_provisioning_enabled = (value, True)
