...
from delphixpy.v1_11_7.web.objects.UserObject import UserObject
...
class NetworkInterface(UserObject):
    """
    *(extends* :py:class:`v1_11_7.web.vo.UserObject` *)* Configuration of an IP
    interface.
    """
    ...
    def addresses(self):
        ...
        :rtype: ``list`` of :py:class:`v1_11_7.web.vo.InterfaceAddress`
        """
