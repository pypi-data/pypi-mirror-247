...
from delphixpy.v1_11_7.web.objects.OracleDBConfig import OracleDBConfig
...
class OracleRACConfig(OracleDBConfig):
    """
    *(extends* :py:class:`v1_11_7.web.vo.OracleDBConfig` *)* Representation of
    ...
    def instances(self):
        ...
        :rtype: ``list`` of :py:class:`v1_11_7.web.vo.OracleRACInstance`
        """
