...
from delphixpy.v1_7_1.web.objects.OracleDBConfig import OracleDBConfig
...
class OracleRACConfig(OracleDBConfig):
    """
    *(extends* :py:class:`v1_7_1.web.vo.OracleDBConfig` *)* Representation of
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        def dictify(obj, prop_is_list_or_vo=False):
            if isinstance(obj, list):
                ...
                return obj
        if "crs_database_name" == "type" or (self.crs_database_name is not self.__undef__ and (not (dirty and not self._crs_database_name[1]) or self.is_dirty_list(self.crs_database_name, self._crs_database_name) or belongs_to_parent)):
            dct["crsDatabaseName"] = dictify(self.crs_database_name)
        if "instances" == "type" or (self.instances is not self.__undef__ and (not (dirty and not self._instances[1]) or self.is_dirty_list(self.instances, self._instances) or belongs_to_parent)):
    ...
    def is_dirty(self):
        return any([self._crs_database_name[1], self._instances[1]])
    ...
    def __eq__(self, other):
        ...
        return super().__eq__(other) and \
               self.crs_database_name == other.crs_database_name and \
    ...
    def instances(self):
        ...
        :rtype: ``list`` of :py:class:`v1_7_1.web.vo.OracleRACInstance`
        """
