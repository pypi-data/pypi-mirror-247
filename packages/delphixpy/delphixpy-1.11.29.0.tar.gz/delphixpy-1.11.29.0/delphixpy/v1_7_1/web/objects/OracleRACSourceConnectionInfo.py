...
from delphixpy.v1_7_1.web.objects.OracleSourceConnectionInfo import OracleSourceConnectionInfo
...
class OracleRACSourceConnectionInfo(OracleSourceConnectionInfo):
    """
    *(extends* :py:class:`v1_7_1.web.vo.OracleSourceConnectionInfo` *)*
