...
class Namespace(NamedUserObject):
    """
    *(extends* :py:class:`v1_7_1.web.vo.NamedUserObject` *)* Object namespace
    ...
    def is_dirty(self):
        return any([self._description[1], self._namespace_type[1], self._secure_namespace[1], self._source[1], self._tag[1]])
