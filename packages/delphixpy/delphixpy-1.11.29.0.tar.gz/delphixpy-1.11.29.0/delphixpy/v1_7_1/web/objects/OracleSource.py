...
from delphixpy.v1_7_1.web.objects.Source import Source
...
class OracleSource(Source):
    """
    *(extends* :py:class:`v1_7_1.web.vo.Source` *)* An Oracle source.
    """
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_7_1.web.vo.OracleBaseSourceRuntime`
        """
