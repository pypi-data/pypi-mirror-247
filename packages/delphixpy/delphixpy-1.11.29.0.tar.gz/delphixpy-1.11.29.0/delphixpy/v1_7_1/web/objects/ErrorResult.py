...
from delphixpy.v1_7_1.web.objects.CallResult import CallResult
...
class ErrorResult(CallResult):
    """
    *(extends* :py:class:`v1_7_1.web.vo.CallResult` *)* Result of a failed API
    call.
    """
    ...
    def error(self):
        ...
        :rtype: :py:class:`v1_7_1.web.vo.APIError`
        """
