...
from delphixpy.v1_7_1.web.objects.OracleCustomEnvVarPair import OracleCustomEnvVarPair
...
class OracleCustomEnvVarRACPair(OracleCustomEnvVarPair):
    """
    *(extends* :py:class:`v1_7_1.web.vo.OracleCustomEnvVarPair` *)* Dictates a
