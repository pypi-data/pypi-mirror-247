...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_7_1.web.objects.Container.Container` object
    :type ref: ``str``
    :rtype: :py:class:`v1_7_1.web.vo.Container`
    """
...
def get_all(engine, group=None, no_js_container_data_source=None, no_js_data_source=None, provision_container=None, restoration=None, valid_for_secure_replication=None):
    """
    ...
    :param restoration: Restrict listing to include only restoration datasets.
    :type restoration: ``bool``
    ...
    :rtype: ``list`` of :py:class:`v1_7_1.web.vo.Container`
    """
    url = "/resources/json/delphix/database"
    query_params = {"group": group, "noJSContainerDataSource": no_js_container_data_source, "noJSDataSource": no_js_data_source, "provisionContainer": provision_container, "restoration": restoration, "validForSecureReplication": valid_for_secure_replication}
...
def update(engine, ref, container=None):
    ...
    :type container: :py:class:`v1_7_1.web.vo.Container`
    """
    url = "/resources/json/delphix/database/%s" % ref
...
def delete(engine, ref, delete_parameters=None):
    ...
    :type delete_parameters: :py:class:`v1_7_1.web.vo.DeleteParameters`
    """
...
def add_live_source(engine, ref, add_live_source_parameters):
    ...
    :type add_live_source_parameters:
        :py:class:`v1_7_1.web.vo.AddLiveSourceParameters`
    """
...
def add_live_source_defaults(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_7_1.web.objects.Container.Container` object
    :type ref: ``str``
    :rtype: :py:class:`v1_7_1.web.vo.AddLiveSourceParameters`
    """
...
def attach_source(engine, ref, attach_source_parameters):
    ...
    :type attach_source_parameters:
        :py:class:`v1_7_1.web.vo.AttachSourceParameters`
    """
...
def connection_info(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_7_1.web.objects.Container.Container` object
    :type ref: ``str``
    :rtype: :py:class:`v1_7_1.web.vo.SourceConnectionInfo`
    """
...
def create_transformation(engine, ref, create_transformation_parameters):
    ...
    :type create_transformation_parameters:
        :py:class:`v1_7_1.web.vo.CreateTransformationParameters`
    :rtype: ``str``
    """
...
def detach_source(engine, ref, detach_source_parameters):
    ...
    :type detach_source_parameters:
        :py:class:`v1_7_1.web.vo.DetachSourceParameters`
    """
...
def purge_logs(engine, ref, purge_logs_parameters):
    ...
    :type purge_logs_parameters: :py:class:`v1_7_1.web.vo.PurgeLogsParameters`
    :rtype: :py:class:`v1_7_1.web.vo.PurgeLogsResult`
    """
...
def refresh(engine, ref, refresh_parameters):
    ...
    :type refresh_parameters: :py:class:`v1_7_1.web.vo.RefreshParameters`
    """
...
def request_xpp_download(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_7_1.web.objects.Container.Container` object
    :type ref: ``str``
    :rtype: :py:class:`v1_7_1.web.vo.FileDownloadResult`
    """
...
def request_xpp_upload(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_7_1.web.objects.Container.Container` object
    :type ref: ``str``
    :rtype: :py:class:`v1_7_1.web.vo.FileUploadResult`
    """
...
def rollback(engine, ref, rollback_parameters):
    ...
    :type rollback_parameters: :py:class:`v1_7_1.web.vo.RollbackParameters`
    """
...
def switch_timeflow(engine, ref, switch_timeflow_parameters):
    ...
    :type switch_timeflow_parameters:
        :py:class:`v1_7_1.web.vo.SwitchTimeflowParameters`
    """
...
def sync(engine, ref, sync_parameters=None):
    ...
    :type sync_parameters: :py:class:`v1_7_1.web.vo.SyncParameters`
    """
...
def xpp_status(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_7_1.web.objects.Container.Container` object
    :type ref: ``str``
    :rtype: :py:class:`v1_7_1.web.vo.XppStatus`
    """
...
def create_empty(engine, empty_dataset_creation_parameters):
    ...
    :type empty_dataset_creation_parameters:
        :py:class:`v1_7_1.web.vo.EmptyDatasetCreationParameters`
    :rtype: ``str``
    """
...
def create_restoration_dataset(engine, restoration_dataset_parameters):
    """
    Creates a new restoration dataset from the specified source.

    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_7_1.delphix_engine.DelphixEngine`
    :param restoration_dataset_parameters: Payload object.
    :type restoration_dataset_parameters:
        :py:class:`v1_7_1.web.vo.RestorationDatasetParameters`
    :rtype: ``str``
    """
    url = "/resources/json/delphix/database/createRestorationDataset"
    response = engine.post(url, restoration_dataset_parameters.to_dict(dirty=True) if restoration_dataset_parameters else None)
    result = response_validator.validate(response, engine)
    raw_result = getattr(engine, 'raw_result', False)
    return response_validator.parse_result(result, undef_enabled=True, return_types=['str'], returns_list=False, raw_result=raw_result)

def create_restoration_dataset_defaults(engine, timeflow_point_parameters):
    """
    Returns partially constructed parameters for creating a restoration
    dataset.
    ...
    :type timeflow_point_parameters:
        :py:class:`v1_7_1.web.vo.TimeflowPointParameters`
    """
    url = "/resources/json/delphix/database/createRestorationDataset/defaults"
...
def export(engine, export_parameters):
    ...
    :type export_parameters: :py:class:`v1_7_1.web.vo.ExportParameters`
    """
...
def file_mapping(engine, file_mapping_parameters):
    ...
    :type file_mapping_parameters:
        :py:class:`v1_7_1.web.vo.FileMappingParameters`
    :rtype: :py:class:`v1_7_1.web.vo.FileMappingResult`
    """
...
def link(engine, link_parameters):
    ...
    :type link_parameters: :py:class:`v1_7_1.web.vo.LinkParameters`
    :rtype: ``str``
    """
...
def oracle_supported_character_sets(engine):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_7_1.delphix_engine.DelphixEngine`
    :rtype: ``list`` of :py:class:`v1_7_1.web.vo.OracleCharacterSet`
    """
...
def provision(engine, provision_parameters):
    ...
    :type provision_parameters: :py:class:`v1_7_1.web.vo.ProvisionParameters`
    :rtype: ``str``
    """
...
def xpp(engine, oracle_provision_parameters):
    ...
    :type oracle_provision_parameters:
        :py:class:`v1_7_1.web.vo.OracleProvisionParameters`
    :rtype: ``str``
    """
