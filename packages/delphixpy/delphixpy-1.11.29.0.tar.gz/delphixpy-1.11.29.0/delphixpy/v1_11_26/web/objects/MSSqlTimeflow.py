...
from delphixpy.v1_11_26.web.objects.Timeflow import Timeflow
...
class MSSqlTimeflow(Timeflow):
    """
    *(extends* :py:class:`v1_11_26.web.vo.Timeflow` *)* TimeFlow representing
    ...
    def parent_point(self):
        ...
        :rtype: :py:class:`v1_11_26.web.vo.MSSqlTimeflowPoint`
        """
