...
from delphixpy.v1_11_26.web.objects.OracleVirtualSource import OracleVirtualSource
...
class OracleVirtualCdbSource(OracleVirtualSource):
    """
    *(extends* :py:class:`v1_11_26.web.vo.OracleVirtualSource` *)* A virtual
    ...
    def custom_env_vars(self):
        ...
        :rtype: ``list`` of :py:class:`v1_11_26.web.vo.OracleCustomEnvVar`
        """
