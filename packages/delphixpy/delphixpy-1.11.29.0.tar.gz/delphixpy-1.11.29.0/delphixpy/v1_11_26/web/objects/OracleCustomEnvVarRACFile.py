...
from delphixpy.v1_11_26.web.objects.OracleCustomEnvVarFile import OracleCustomEnvVarFile
...
class OracleCustomEnvVarRACFile(OracleCustomEnvVarFile):
    """
    *(extends* :py:class:`v1_11_26.web.vo.OracleCustomEnvVarFile` *)* Dictates
