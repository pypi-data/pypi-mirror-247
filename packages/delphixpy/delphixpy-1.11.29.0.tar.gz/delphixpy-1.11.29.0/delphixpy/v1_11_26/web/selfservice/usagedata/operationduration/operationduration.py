...
def get(engine, ref):
    ...
    :param ref: Reference to a :py:class:`delphixpy.v1_11_26.web.objects.JSDail
        yOperationDuration.JSDailyOperationDuration` object
    :type ref: ``str``
    :rtype: :py:class:`v1_11_26.web.vo.JSDailyOperationDuration`
    """
...
def get_all(engine, usage_object=None):
    ...
    :rtype: ``list`` of :py:class:`v1_11_26.web.vo.JSDailyOperationDuration`
    """
