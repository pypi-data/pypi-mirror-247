...
def create(engine, role=None):
    ...
    :type role: :py:class:`v1_11_16.web.vo.Role`
    :rtype: ``str``
    """
...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_11_16.web.objects.Role.Role` object
    :type ref: ``str``
    :rtype: :py:class:`v1_11_16.web.vo.Role`
    """
...
def get_all(engine):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_11_16.delphix_engine.DelphixEngine`
    :rtype: ``list`` of :py:class:`v1_11_16.web.vo.Role`
    """
    url = "/resources/json/delphix/role"
    response = engine.get(url)
    result = response_validator.validate(response, engine)
...
def jet_stream_user_role(engine):
    """
    Returns the Self-Service user role.
...
def self_service_user_role(engine):
    """
    Returns the Self-Service user role.
    ...
    :rtype: :py:class:`v1_11_16.web.vo.Role`
    """
    url = "/resources/json/delphix/role/selfServiceUserRole"
    response = engine.get(url)
    result = response_validator.validate(response, engine)
    raw_result = getattr(engine, 'raw_result', False)
    return response_validator.parse_result(result, undef_enabled=True, return_types=['Role'], returns_list=False, raw_result=raw_result)
