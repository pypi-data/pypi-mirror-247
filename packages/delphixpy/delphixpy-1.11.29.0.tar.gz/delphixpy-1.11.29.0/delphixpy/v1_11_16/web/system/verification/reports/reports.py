...
def get(engine, ref):
    ...
    :param ref: Reference to a :py:class:`delphixpy.v1_11_16.web.objects.Upgrad
        eVerificationReport.UpgradeVerificationReport` object
    :type ref: ``str``
    :rtype: :py:class:`v1_11_16.web.vo.UpgradeVerificationReport`
    """
...
def get_all(engine, version=None, page_size=None, page_offset=None, sort_by=None, ascending=None):
    ...
    :type ascending: ``bool``
    :rtype: ``list`` of :py:class:`v1_11_16.web.vo.UpgradeVerificationReport`
    """
