...
from delphixpy.v1_11_16.web.objects.OracleVirtualSource import OracleVirtualSource
...
class OracleVirtualPdbSource(OracleVirtualSource):
    """
    *(extends* :py:class:`v1_11_16.web.vo.OracleVirtualSource` *)* A virtual
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._target_vcdb_tde_keystore_path[0] is not None and obj._target_vcdb_tde_keystore_path[0] is not obj.__undef__:
            ...
            common.validate_format(obj._target_vcdb_tde_keystore_path[0], "unixrestrictedpath", None, 4096)
        return obj
