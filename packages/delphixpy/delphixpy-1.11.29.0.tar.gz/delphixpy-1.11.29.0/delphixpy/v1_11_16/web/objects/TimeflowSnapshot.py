...
from delphixpy.v1_11_16.web.objects.ReadonlyNamedUserObject import ReadonlyNamedUserObject
...
class TimeflowSnapshot(ReadonlyNamedUserObject):
    """
    *(extends* :py:class:`v1_11_16.web.vo.ReadonlyNamedUserObject` *)* Snapshot
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_11_16.web.vo.SnapshotRuntime`
        """
