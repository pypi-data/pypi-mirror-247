...
from delphixpy.v1_11_29.web.objects.JSDataLayoutCreateParameters import JSDataLayoutCreateParameters
...
class JSDataTemplateCreateParameters(JSDataLayoutCreateParameters):
    """
    *(extends* :py:class:`v1_11_29.web.vo.JSDataLayoutCreateParameters` *)* The
