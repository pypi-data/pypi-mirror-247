...
from delphixpy.v1_11_29.web.objects.SourceEnvironmentCreateParameters import SourceEnvironmentCreateParameters
...
class HostEnvironmentCreateParameters(SourceEnvironmentCreateParameters):
    """
    *(extends* :py:class:`v1_11_29.web.vo.SourceEnvironmentCreateParameters`
    *)* The parameters used for the host environment create operation.
    ...
    def host_environment(self):
        ...
        :rtype: :py:class:`v1_11_29.web.vo.HostEnvironment`
        """
    ...
    def host_parameters(self):
        ...
        :rtype: :py:class:`v1_11_29.web.vo.HostCreateParameters`
        """
