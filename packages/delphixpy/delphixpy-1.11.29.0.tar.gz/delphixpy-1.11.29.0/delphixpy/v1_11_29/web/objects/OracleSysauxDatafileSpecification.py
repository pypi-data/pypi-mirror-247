...
from delphixpy.v1_11_29.web.objects.OracleDatafileTempfileSpecification import OracleDatafileTempfileSpecification
...
class OracleSysauxDatafileSpecification(OracleDatafileTempfileSpecification):
    """
    *(extends* :py:class:`v1_11_29.web.vo.OracleDatafileTempfileSpecification`
