...
def create(engine, fluentd_config=None):
    ...
    :type fluentd_config: :py:class:`v1_11_29.web.vo.FluentdConfig`
    :rtype: ``str``
    """
...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_11_29.web.objects.FluentdConfig.FluentdConfig`
        object
    :type ref: ``str``
    :rtype: :py:class:`v1_11_29.web.vo.FluentdConfig`
    """
...
def get_all(engine):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_11_29.delphix_engine.DelphixEngine`
    :rtype: ``list`` of :py:class:`v1_11_29.web.vo.FluentdConfig`
    """
    url = "/resources/json/delphix/service/fluentd/configuration"
    response = engine.get(url)
    result = response_validator.validate(response, engine)
...
def test_splunk_hec(engine, splunk_hec_config=None):
    """
    Tests a given Splunk configuration by sending a test event to the specified
    index.

    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_11_29.delphix_engine.DelphixEngine`
    :param splunk_hec_config: Payload object.
    :type splunk_hec_config: :py:class:`v1_11_29.web.vo.SplunkHecConfig`
    :rtype: ``str``
    """
    url = "/resources/json/delphix/service/fluentd/configuration/testSplunkHec"
