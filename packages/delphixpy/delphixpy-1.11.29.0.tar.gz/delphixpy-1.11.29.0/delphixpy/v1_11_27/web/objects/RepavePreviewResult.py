...
class RepavePreviewResult(TypedObject):
    """
    *(extends* :py:class:`v1_11_27.web.vo.TypedObject` *)* Preview engine
    ...
    def source_engine_summary(self):
        ...
        :rtype: :py:class:`v1_11_27.web.vo.RepaveEngineSummary`
        """
    ...
    def source_engine_configurable_metadata(self):
        ...
        :rtype: :py:class:`v1_11_27.web.vo.RepaveConfigurableMetadata`
        """
