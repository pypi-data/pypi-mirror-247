...
from delphixpy.v1_11_27.web.objects.BasePlatformParameters import BasePlatformParameters
...
class AppDataPlatformParameters(BasePlatformParameters):
    """
    *(extends* :py:class:`v1_11_27.web.vo.BasePlatformParameters` *)* AppData
