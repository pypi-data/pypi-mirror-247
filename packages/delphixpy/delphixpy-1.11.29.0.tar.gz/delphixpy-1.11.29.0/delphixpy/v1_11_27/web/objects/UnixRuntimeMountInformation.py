...
from delphixpy.v1_11_27.web.objects.RuntimeMountInformation import RuntimeMountInformation
...
class UnixRuntimeMountInformation(RuntimeMountInformation):
    """
    *(extends* :py:class:`v1_11_27.web.vo.RuntimeMountInformation` *)* The
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "nfs_encryption_enabled" == "type" or (self.nfs_encryption_enabled is not self.__undef__ and (not (dirty and not self._nfs_encryption_enabled[1]))):
            dct["nfsEncryptionEnabled"] = dictify(self.nfs_encryption_enabled)
        if dirty and "nfsEncryptionEnabled" in dct:
            del dct["nfsEncryptionEnabled"]
        return dct
    ...
    def is_dirty(self):
        return any([self._nfs_version[1], self._nfs_version_reason[1], self._nfs_encryption_enabled[1]])
