...
from delphixpy.v1_10_1.web.objects.AppDataManagedSource import AppDataManagedSource
...
class AppDataVirtualSource(AppDataManagedSource):
    """
    *(extends* :py:class:`v1_10_1.web.vo.AppDataManagedSource` *)* A virtual
    AppData source.
    """
    ...
    def parameters(self):
        ...
        :rtype: :py:class:`v1_10_1.web.vo.Json`
        """
    ...
    def additional_mount_points(self):
        ...
        :rtype: ``list`` of
            :py:class:`v1_10_1.web.vo.AppDataAdditionalMountPoint`
        """
