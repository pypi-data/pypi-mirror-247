...
class CapacityBreakdown(TypedObject):
    """
    *(extends* :py:class:`v1_10_1.web.vo.TypedObject` *)* Storage stats
    breakdown.
    """
    ...
    def is_dirty(self):
        return any([self._actual_space[1], self._unvirtualized_space[1], self._timeflow_unvirtualized_space[1], self._active_space[1], self._log_space[1], self._sync_space[1], self._descendant_space[1], self._policy_space[1], self._manual_space[1], self._unowned_snapshot_space[1]])
    ...
    def __eq__(self, other):
        ...
        return super().__eq__(other) and \
               ...
               self.unowned_snapshot_space == other.unowned_snapshot_space
