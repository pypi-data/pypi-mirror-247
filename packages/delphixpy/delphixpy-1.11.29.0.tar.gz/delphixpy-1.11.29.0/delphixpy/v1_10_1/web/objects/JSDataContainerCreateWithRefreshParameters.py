...
from delphixpy.v1_10_1.web.objects.JSDataContainerCreateParameters import JSDataContainerCreateParameters
...
class JSDataContainerCreateWithRefreshParameters(JSDataContainerCreateParameters):
    """
    *(extends* :py:class:`v1_10_1.web.vo.JSDataContainerCreateParameters` *)*
