...
from delphixpy.v1_10_1.web.objects.BaseSupportBundleParameters import BaseSupportBundleParameters
...
class SupportBundleUploadParameters(BaseSupportBundleParameters):
    """
    *(extends* :py:class:`v1_10_1.web.vo.BaseSupportBundleParameters` *)*
