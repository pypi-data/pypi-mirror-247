...
from delphixpy.v1_10_1.web.objects.OracleCustomEnvVarPair import OracleCustomEnvVarPair
...
class OracleCustomEnvVarRACPair(OracleCustomEnvVarPair):
    """
    *(extends* :py:class:`v1_10_1.web.vo.OracleCustomEnvVarPair` *)* Dictates a
