...
from delphixpy.v1_10_1.web.objects.OracleDatafileTempfileSpecification import OracleDatafileTempfileSpecification
...
class OracleSystemDatafileSpecification(OracleDatafileTempfileSpecification):
    """
    *(extends* :py:class:`v1_10_1.web.vo.OracleDatafileTempfileSpecification`
