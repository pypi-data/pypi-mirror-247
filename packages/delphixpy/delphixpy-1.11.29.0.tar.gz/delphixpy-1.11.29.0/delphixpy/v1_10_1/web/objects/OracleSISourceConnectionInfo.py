...
from delphixpy.v1_10_1.web.objects.OracleSourceConnectionInfo import OracleSourceConnectionInfo
...
class OracleSISourceConnectionInfo(OracleSourceConnectionInfo):
    """
    *(extends* :py:class:`v1_10_1.web.vo.OracleSourceConnectionInfo` *)*
