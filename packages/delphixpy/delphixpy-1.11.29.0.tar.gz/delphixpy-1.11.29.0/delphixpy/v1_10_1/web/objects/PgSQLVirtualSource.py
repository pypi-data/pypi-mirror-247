...
from delphixpy.v1_10_1.web.objects.PgSQLSource import PgSQLSource
...
class PgSQLVirtualSource(PgSQLSource):
    """
    *(extends* :py:class:`v1_10_1.web.vo.PgSQLSource` *)* A virtual PostgreSQL
    source.
    """
    ...
    def hba_entries(self):
        ...
        :rtype: ``list`` of :py:class:`v1_10_1.web.vo.PgSQLHBAEntry`
        """
    ...
    def ident_entries(self):
        ...
        :rtype: ``list`` of :py:class:`v1_10_1.web.vo.PgSQLIdentEntry`
        """
