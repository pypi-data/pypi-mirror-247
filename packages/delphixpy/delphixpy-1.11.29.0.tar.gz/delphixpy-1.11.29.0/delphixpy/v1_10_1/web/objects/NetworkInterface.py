...
from delphixpy.v1_10_1.web.objects.UserObject import UserObject
...
class NetworkInterface(UserObject):
    """
    *(extends* :py:class:`v1_10_1.web.vo.UserObject` *)* Configuration of an IP
    interface.
    """
    ...
    def addresses(self):
        ...
        :rtype: ``list`` of :py:class:`v1_10_1.web.vo.InterfaceAddress`
        """
