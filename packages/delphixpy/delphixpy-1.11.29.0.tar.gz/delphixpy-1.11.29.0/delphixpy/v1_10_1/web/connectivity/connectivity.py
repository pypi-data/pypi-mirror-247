...
def ssh(engine, ssh_connectivity=None):
    ...
    :type ssh_connectivity: :py:class:`v1_10_1.web.vo.SSHConnectivity`
    :rtype: ``str``
    """
...
def jdbc(engine, jdbc_connectivity=None):
    ...
    :type jdbc_connectivity: :py:class:`v1_10_1.web.vo.JDBCConnectivity`
    :rtype: ``str``
    """
...
def connector(engine, connector_connectivity=None):
    ...
    :type connector_connectivity:
        :py:class:`v1_10_1.web.vo.ConnectorConnectivity`
    :rtype: ``str``
    """
...
def netbackup(engine, netbackup_connectivity_parameters=None):
    ...
    :type netbackup_connectivity_parameters:
        :py:class:`v1_10_1.web.vo.NetbackupConnectivityParameters`
    :rtype: ``str``
    """
