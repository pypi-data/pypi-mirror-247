...
def create(engine, js_data_template_create_parameters):
    ...
    :type js_data_template_create_parameters:
        :py:class:`v1_10_1.web.vo.JSDataTemplateCreateParameters`
    :rtype: ``str``
    """
...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_10_1.web.objects.JSDataTemplate.JSDataTemplate`
        object
    :type ref: ``str``
    :rtype: :py:class:`v1_10_1.web.vo.JSDataTemplate`
    """
...
def get_all(engine):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_10_1.delphix_engine.DelphixEngine`
    :rtype: ``list`` of :py:class:`v1_10_1.web.vo.JSDataTemplate`
    """
    url = "/resources/json/delphix/selfservice/template"
    response = engine.get(url)
    result = response_validator.validate(response, engine)
...
def update(engine, ref, js_data_template=None):
    ...
    :type js_data_template: :py:class:`v1_10_1.web.vo.JSDataTemplate`
    """
    url = "/resources/json/delphix/selfservice/template/%s" % ref
