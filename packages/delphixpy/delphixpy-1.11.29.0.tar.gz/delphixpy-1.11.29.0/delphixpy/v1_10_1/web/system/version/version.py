...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_10_1.web.objects.SystemVersion.SystemVersion`
        object
    :type ref: ``str``
    :rtype: :py:class:`v1_10_1.web.vo.SystemVersion`
    """
...
def get_all(engine):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_10_1.delphix_engine.DelphixEngine`
    :rtype: ``list`` of :py:class:`v1_10_1.web.vo.SystemVersion`
    """
...
def apply(engine, ref, apply_version_parameters=None):
    ...
    :type apply_version_parameters:
        :py:class:`v1_10_1.web.vo.ApplyVersionParameters`
    """
...
def verify(engine, ref, verify_version_parameters=None):
    ...
    :type verify_version_parameters:
        :py:class:`v1_10_1.web.vo.VerifyVersionParameters`
    """
...
def ignore_upgrade_check_results(engine, ref, upgrade_check_results_version_parameters):
    ...
    :type upgrade_check_results_version_parameters:
        :py:class:`v1_10_1.web.vo.UpgradeCheckResultsVersionParameters`
    """
