...
from delphixpy.v1_11_21.web.objects.MSSqlBaseClusterInstance import MSSqlBaseClusterInstance
...
class MSSqlFailoverClusterInstance(MSSqlBaseClusterInstance):
    """
    *(extends* :py:class:`v1_11_21.web.vo.MSSqlBaseClusterInstance` *)* The
