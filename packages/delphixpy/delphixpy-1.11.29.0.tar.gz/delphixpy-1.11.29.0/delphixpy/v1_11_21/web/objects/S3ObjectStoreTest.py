...
#     /delphix-s3-object-store-test.json
#
...
class S3ObjectStoreTest(ObjectStoreTest):
    """
    *(extends* :py:class:`v1_11_21.web.vo.ObjectStoreTest` *)* An Amazon S3
    object store connectivity test object.
    """
    def __init__(self, undef_enabled=True):
        super().__init__()
        self._type = ("S3ObjectStoreTest", True)
    ...
    def __eq__(self, other):
        if other is None:
            return False
        if not isinstance(other, S3ObjectStoreTest):
            return False
