...
class RepaveConfigurableMetadata(TypedObject):
    """
    *(extends* :py:class:`v1_11_21.web.vo.TypedObject` *)* Engine configurable
    metadata for Repave.
    """
    ...
    def ntp_config(self):
        ...
        :rtype: :py:class:`v1_11_21.web.vo.NTPConfig`
        """
    ...
    def dns_config(self):
        ...
        :rtype: :py:class:`v1_11_21.web.vo.RepaveDNSConfig`
        """
