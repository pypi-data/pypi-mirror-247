...
class CloudStatus(TypedObject):
    """
    *(extends* :py:class:`v1_11_21.web.vo.TypedObject` *)* Delphix Cloud
    facilities.
    """
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._delphix_data_services_component_status[0] is not None and obj._delphix_data_services_component_status[0] is not obj.__undef__:
            assert isinstance(obj._delphix_data_services_component_status[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._delphix_data_services_component_status[0], type(obj._delphix_data_services_component_status[0])))
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "proxy_mode" == "type" or (self.proxy_mode is not self.__undef__ and (not (dirty and not self._proxy_mode[1]) or self.is_dirty_list(self.proxy_mode, self._proxy_mode) or belongs_to_parent)):
        ...
        if "proxy_configuration" == "type" or (self.proxy_configuration is not self.__undef__ and (not (dirty and not self._proxy_configuration[1]) or self.is_dirty_list(self.proxy_configuration, self._proxy_configuration) or belongs_to_parent)):
            dct["proxyConfiguration"] = dictify(self.proxy_configuration, prop_is_list_or_vo=True)
        if "central_management_product_name" == "type" or (self.central_management_product_name is not self.__undef__ and (not (dirty and not self._central_management_product_name[1]) or self.is_dirty_list(self.central_management_product_name, self._central_management_product_name) or belongs_to_parent)):
    ...
    def delphix_data_services_component_info(self):
        ...
        :rtype: :py:class:`v1_11_21.web.vo.DelphixDataServicesComponentInfo`
        """
    ...
    def proxy_configuration(self):
        ...
        :rtype: :py:class:`v1_11_21.web.vo.ProxyConfiguration`
        """
