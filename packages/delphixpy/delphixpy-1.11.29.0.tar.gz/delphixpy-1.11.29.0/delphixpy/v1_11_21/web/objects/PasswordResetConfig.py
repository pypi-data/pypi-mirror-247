...
class PasswordResetConfig(TypedObject):
    """
    *(extends* :py:class:`v1_11_21.web.vo.TypedObject` *)* Password Reset
    Configuration.
    """
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        def dictify(obj, prop_is_list_or_vo=False):
            if isinstance(obj, list):
                ...
                return obj
        if "token_validity" == "type" or (self.token_validity is not self.__undef__ and (not (dirty and not self._token_validity[1]) or self.is_dirty_list(self.token_validity, self._token_validity) or belongs_to_parent)):
