...
from delphixpy.v1_11_21.web.objects.NetworkTest import NetworkTest
...
class NetworkLatencyTest(NetworkTest):
    """
    *(extends* :py:class:`v1_11_21.web.vo.NetworkTest` *)* Round-trip latency
    ...
    def parameters(self):
        ...
        :rtype: :py:class:`v1_11_21.web.vo.NetworkLatencyTestParameters`
        """
