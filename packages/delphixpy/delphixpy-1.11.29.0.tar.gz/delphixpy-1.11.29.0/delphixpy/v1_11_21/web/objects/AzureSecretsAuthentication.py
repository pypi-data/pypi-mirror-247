...
#     /delphix-azure-secrets-authentication.json
#
# Do not edit this file manually!
#

from delphixpy.v1_11_21.web.objects.AzureAuthentication import AzureAuthentication
...
class AzureSecretsAuthentication(AzureAuthentication):
    """
    *(extends* :py:class:`v1_11_21.web.vo.AzureAuthentication` *)* Secret
    credential for authenticating to an Azure vault.
    """
    def __init__(self, undef_enabled=True):
        super().__init__()
        self._type = ("AzureSecretsAuthentication", True)
        self._tenant_id = (self.__undef__, True)
        self._client_id = (self.__undef__, True)
        self._client_secret = (self.__undef__, True)
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        obj._client_secret = (data.get("clientSecret", obj.__undef__), dirty)
        if obj._client_secret[0] is not None and obj._client_secret[0] is not obj.__undef__:
            assert isinstance(obj._client_secret[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._client_secret[0], type(obj._client_secret[0])))
            common.validate_format(obj._client_secret[0], "password", None, None)
        return obj
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "client_secret" == "type" or (self.client_secret is not self.__undef__ and (not (dirty and not self._client_secret[1]) or self.is_dirty_list(self.client_secret, self._client_secret) or belongs_to_parent)):
            dct["clientSecret"] = dictify(self.client_secret)
        return dct
    ...
    def force_dirty(self):
        ...
        self._client_secret = (self._client_secret[0], True)

    def is_dirty(self):
        return any([self._tenant_id[1], self._client_id[1], self._client_secret[1]])
    ...
    def __eq__(self, other):
        if other is None:
            return False
        if not isinstance(other, AzureSecretsAuthentication):
            return False
    ...
    def tenant_id(self):
        """
        Tenant identifier in the vault.
    ...
    def client_id(self):
        """
        Client identifier in the vault.
    ...
    def client_secret(self):
        ...
        :rtype: ``str``
        """
        return self._client_secret[0]

    @client_secret.setter
    def client_secret(self, value):
        self._client_secret = (value, True)
