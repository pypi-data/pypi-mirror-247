...
from delphixpy.v1_11_21.web.objects.MySQLReplicationCoordinates import MySQLReplicationCoordinates
...
class MySQLGtidCoordinates(MySQLReplicationCoordinates):
    """
    *(extends* :py:class:`v1_11_21.web.vo.MySQLReplicationCoordinates` *)* The
