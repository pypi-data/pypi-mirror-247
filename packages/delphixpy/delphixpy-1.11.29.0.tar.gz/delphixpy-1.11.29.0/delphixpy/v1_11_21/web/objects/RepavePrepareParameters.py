...
class RepavePrepareParameters(TypedObject):
    """
    *(extends* :py:class:`v1_11_21.web.vo.TypedObject` *)* The parameters to
    ...
    def __init__(self, undef_enabled=True):
        ...
        self._unquiesce_sources_on_failure = (self.__undef__, True)
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        obj._unquiesce_sources_on_failure = (data.get("unquiesceSourcesOnFailure", obj.__undef__), dirty)
        if obj._unquiesce_sources_on_failure[0] is not None and obj._unquiesce_sources_on_failure[0] is not obj.__undef__:
            assert isinstance(obj._unquiesce_sources_on_failure[0], bool), ("Expected one of ['boolean'], but got %s of type %s" % (obj._unquiesce_sources_on_failure[0], type(obj._unquiesce_sources_on_failure[0])))
            common.validate_format(obj._unquiesce_sources_on_failure[0], "None", None, None)
        return obj
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "unquiesce_sources_on_failure" == "type" or (self.unquiesce_sources_on_failure is not self.__undef__ and (not (dirty and not self._unquiesce_sources_on_failure[1]) or self.is_dirty_list(self.unquiesce_sources_on_failure, self._unquiesce_sources_on_failure) or belongs_to_parent)):
            dct["unquiesceSourcesOnFailure"] = dictify(self.unquiesce_sources_on_failure)
        elif belongs_to_parent and self.unquiesce_sources_on_failure is self.__undef__:
            dct["unquiesceSourcesOnFailure"] = False
        return dct
    ...
    def force_dirty(self):
        ...
        self._unquiesce_sources_on_failure = (self._unquiesce_sources_on_failure[0], True)

    def is_dirty(self):
        return any([self._ignore_quiesce_sources_failures[1], self._unquiesce_sources_on_failure[1]])
    ...
    def __eq__(self, other):
        ...
        return super().__eq__(other) and \
               ...
               self.unquiesce_sources_on_failure == other.unquiesce_sources_on_failure
    ...
    @property
    def unquiesce_sources_on_failure(self):
        """
        If true, when repave fails at a point where the Delphix management
        stack is still running, data source quiesced by repave will be
        unquiesced again.

        :rtype: ``bool``
        """
        return self._unquiesce_sources_on_failure[0]

    @unquiesce_sources_on_failure.setter
    def unquiesce_sources_on_failure(self, value):
        self._unquiesce_sources_on_failure = (value, True)
