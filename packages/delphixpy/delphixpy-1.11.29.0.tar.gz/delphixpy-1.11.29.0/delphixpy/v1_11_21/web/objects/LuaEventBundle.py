...
class LuaEventBundle(TypedObject):
    """
    *(extends* :py:class:`v1_11_21.web.vo.TypedObject` *)* An opaque type
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._toolkit_name[0] is not None and obj._toolkit_name[0] is not obj.__undef__:
            assert isinstance(obj._toolkit_name[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._toolkit_name[0], type(obj._toolkit_name[0])))
        ...
        if obj._message_id[0] is not None and obj._message_id[0] is not obj.__undef__:
            assert isinstance(obj._message_id[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._message_id[0], type(obj._message_id[0])))
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        def dictify(obj, prop_is_list_or_vo=False):
            if isinstance(obj, list):
                ...
                return obj
        if "toolkit_name" == "type" or (self.toolkit_name is not self.__undef__ and (not (dirty and not self._toolkit_name[1]) or self.is_dirty_list(self.toolkit_name, self._toolkit_name) or belongs_to_parent)):
            dct["toolkitName"] = dictify(self.toolkit_name)
        if "message_id" == "type" or (self.message_id is not self.__undef__ and (not (dirty and not self._message_id[1]) or self.is_dirty_list(self.message_id, self._message_id) or belongs_to_parent)):
            dct["messageId"] = dictify(self.message_id)
        if "params" == "type" or (self.params is not self.__undef__ and (not (dirty and not self._params[1]) or self.is_dirty_list(self.params, self._params) or belongs_to_parent)):
