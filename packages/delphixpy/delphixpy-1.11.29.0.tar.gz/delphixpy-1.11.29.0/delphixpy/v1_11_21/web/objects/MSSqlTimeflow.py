...
from delphixpy.v1_11_21.web.objects.Timeflow import Timeflow
...
class MSSqlTimeflow(Timeflow):
    """
    *(extends* :py:class:`v1_11_21.web.vo.Timeflow` *)* TimeFlow representing
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._database_guid[0] is not None and obj._database_guid[0] is not obj.__undef__:
            assert isinstance(obj._database_guid[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._database_guid[0], type(obj._database_guid[0])))
