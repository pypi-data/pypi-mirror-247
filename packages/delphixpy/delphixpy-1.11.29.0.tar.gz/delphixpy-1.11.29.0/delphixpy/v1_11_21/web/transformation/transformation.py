...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_11_21.web.objects.Transformation.Transformation
        ` object
    :type ref: ``str``
    :rtype: :py:class:`v1_11_21.web.vo.Transformation`
    """
...
def get_all(engine, container=None, parent_container=None):
    ...
    :rtype: ``list`` of :py:class:`v1_11_21.web.vo.Transformation`
    """
...
def update(engine, ref, transformation=None):
    ...
    :type transformation: :py:class:`v1_11_21.web.vo.Transformation`
    """
    url = "/resources/json/delphix/transformation/%s" % ref
