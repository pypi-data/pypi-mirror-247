...
from delphixpy.v1_11_2.web.objects.ReplicationObjectSpecification import ReplicationObjectSpecification
...
class ReplicationSecureList(ReplicationObjectSpecification):
    """
    *(extends* :py:class:`v1_11_2.web.vo.ReplicationObjectSpecification` *)*
