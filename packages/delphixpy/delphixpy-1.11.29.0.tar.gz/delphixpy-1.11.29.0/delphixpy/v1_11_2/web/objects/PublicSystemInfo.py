...
class PublicSystemInfo(TypedObject):
    """
    *(extends* :py:class:`v1_11_2.web.vo.TypedObject` *)* Retrieve static
    ...
    def support_contacts(self):
        ...
        :rtype: ``list`` of :py:class:`v1_11_2.web.vo.SupportContact`
        """
    ...
    def build_version(self):
        ...
        :rtype: :py:class:`v1_11_2.web.vo.VersionInfo`
        """
