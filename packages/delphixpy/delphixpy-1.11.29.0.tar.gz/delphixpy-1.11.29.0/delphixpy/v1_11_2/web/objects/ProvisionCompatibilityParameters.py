...
from delphixpy.v1_11_2.web.objects.CompatibleRepositoriesParameters import CompatibleRepositoriesParameters
...
class ProvisionCompatibilityParameters(CompatibleRepositoriesParameters):
    """
    *(extends* :py:class:`v1_11_2.web.vo.CompatibleRepositoriesParameters` *)*
