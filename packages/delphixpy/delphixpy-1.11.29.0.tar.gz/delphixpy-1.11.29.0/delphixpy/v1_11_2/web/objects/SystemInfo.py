...
from delphixpy.v1_11_2.web.objects.PublicSystemInfo import PublicSystemInfo
...
class SystemInfo(PublicSystemInfo):
    """
    *(extends* :py:class:`v1_11_2.web.vo.PublicSystemInfo` *)* Retrieve system-
    ...
    def processors(self):
        ...
        :rtype: ``list`` of :py:class:`v1_11_2.web.vo.CPUInfo`
        """
    ...
    def up_time(self):
        ...
        :rtype: :py:class:`v1_11_2.web.vo.UpTimeInfo`
        """
