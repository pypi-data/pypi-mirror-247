...
class OracleSIConfig(OracleDBConfig):
    """
    *(extends* :py:class:`v1_11_2.web.vo.OracleDBConfig` *)* The representation
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        def dictify(obj, prop_is_list_or_vo=False):
            if isinstance(obj, list):
                ...
                return obj
        if "instance" == "type" or (self.instance is not self.__undef__ and (not (dirty and not self._instance[1]) or self.is_dirty_list(self.instance, self._instance) or belongs_to_parent)):
    ...
    def instance(self):
        ...
        :rtype: :py:class:`v1_11_2.web.vo.OracleInstance`
        """
