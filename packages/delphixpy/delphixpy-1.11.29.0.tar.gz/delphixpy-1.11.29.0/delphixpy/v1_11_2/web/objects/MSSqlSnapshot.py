...
from delphixpy.v1_11_2.web.objects.TimeflowSnapshot import TimeflowSnapshot
...
class MSSqlSnapshot(TimeflowSnapshot):
    """
    *(extends* :py:class:`v1_11_2.web.vo.TimeflowSnapshot` *)* Provisionable
    ...
    def is_dirty(self):
        return any([self._internal_version[1], self._runtime[1], self._backup_set_uuid[1], self._first_change_point[1], self._latest_change_point[1]])
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_11_2.web.vo.MSSqlSnapshotRuntime`
        """
    ...
    def first_change_point(self):
        ...
        :rtype: :py:class:`v1_11_2.web.vo.MSSqlTimeflowPoint`
        """
