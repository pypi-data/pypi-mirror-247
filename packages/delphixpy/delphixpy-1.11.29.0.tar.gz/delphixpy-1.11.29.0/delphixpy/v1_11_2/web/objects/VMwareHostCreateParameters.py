...
from delphixpy.v1_11_2.web.objects.HostCreateParameters import HostCreateParameters
...
class VMwareHostCreateParameters(HostCreateParameters):
    """
    *(extends* :py:class:`v1_11_2.web.vo.HostCreateParameters` *)* The
    ...
    def host(self):
        ...
        :rtype: :py:class:`v1_11_2.web.vo.VMwareHost`
        """
        return self._host[0]
