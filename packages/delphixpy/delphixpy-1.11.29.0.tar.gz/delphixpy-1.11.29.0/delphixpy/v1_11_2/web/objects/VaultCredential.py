    ...
    *(extends* :py:class:`v1_11_2.web.vo.Credential` *)* The password vault
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._vault_credential_id[0] is not None and obj._vault_credential_id[0] is not obj.__undef__:
            assert isinstance(obj._vault_credential_id[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._vault_credential_id[0], type(obj._vault_credential_id[0])))
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "vault_credential_id" == "type" or (self.vault_credential_id is not self.__undef__ and (not (dirty and not self._vault_credential_id[1]) or self.is_dirty_list(self.vault_credential_id, self._vault_credential_id) or belongs_to_parent)):
