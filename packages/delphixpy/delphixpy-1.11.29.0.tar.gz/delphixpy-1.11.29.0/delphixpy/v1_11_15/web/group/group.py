...
def create(engine, group=None):
    ...
    :type group: :py:class:`v1_11_15.web.vo.Group`
    :rtype: ``str``
    """
...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_11_15.web.objects.Group.Group` object
    :type ref: ``str``
    :rtype: :py:class:`v1_11_15.web.vo.Group`
    """
...
def get_all(engine):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_11_15.delphix_engine.DelphixEngine`
    :rtype: ``list`` of :py:class:`v1_11_15.web.vo.Group`
    """
    url = "/resources/json/delphix/group"
    response = engine.get(url)
    result = response_validator.validate(response, engine)
