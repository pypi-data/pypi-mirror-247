...
class NettyVersionInfo(TypedObject):
    """
    *(extends* :py:class:`v1_11_15.web.vo.TypedObject` *)* View netty version
    and switch between legacy and latest netty version.
    """
    def __init__(self, undef_enabled=True):
        super().__init__()
        self._type = ("NettyVersionInfo", True)
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._version[0] is not None and obj._version[0] is not obj.__undef__:
            ...
            assert obj._version[0] in ['3.10', '4.1'], "Expected enum ['3.10', '4.1'] but got %s" % obj._version[0]
    ...
    def __eq__(self, other):
        if other is None:
            return False
        if not isinstance(other, NettyVersionInfo):
            return False
    ...
    def version(self):
        """
        Current netty version. *(permitted values: 3.10, 4.1)*
