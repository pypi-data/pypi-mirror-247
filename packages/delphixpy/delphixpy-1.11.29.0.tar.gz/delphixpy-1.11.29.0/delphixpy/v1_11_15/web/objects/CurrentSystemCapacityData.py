...
from delphixpy.v1_11_15.web.objects.BaseSystemCapacityData import BaseSystemCapacityData
...
class CurrentSystemCapacityData(BaseSystemCapacityData):
    """
    *(extends* :py:class:`v1_11_15.web.vo.BaseSystemCapacityData` *)* Capacity
