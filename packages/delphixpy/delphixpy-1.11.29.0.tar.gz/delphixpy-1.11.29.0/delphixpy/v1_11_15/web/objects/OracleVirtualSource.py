...
from delphixpy.v1_11_15.web.objects.OracleManagedSource import OracleManagedSource
...
class OracleVirtualSource(OracleManagedSource):
    """
    *(extends* :py:class:`v1_11_15.web.vo.OracleManagedSource` *)* A virtual
    Oracle source.
    """
    ...
    def is_dirty(self):
        return any([self._operations[1], self._file_mapping_rules[1], self._redo_log_size_in_mb[1], self._redo_log_groups[1], self._archivelog_mode[1], self._custom_env_vars[1], self._allow_auto_vdb_restart_on_host_reboot[1], self._new_dbid[1]])
    ...
    def operations(self):
        ...
        :rtype: :py:class:`v1_11_15.web.vo.VirtualSourceOperations`
        """
    ...
    def custom_env_vars(self):
        ...
        :rtype: ``list`` of :py:class:`v1_11_15.web.vo.OracleCustomEnvVar`
        """
