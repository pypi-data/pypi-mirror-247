...
class ASEStagingSource(ASESource):
    """
    *(extends* :py:class:`v1_11_15.web.vo.ASESource` *)* An SAP ASE staging
    ...
    def is_dirty(self):
        return any([self._mount_base[1], self._pre_script[1], self._post_script[1], self._operations[1], self._runtime_mount_information[1], self._locked[1]])
