...
from delphixpy.v1_11_15.web.objects.NamedUserObject import NamedUserObject
...
class User(NamedUserObject):
    """
    *(extends* :py:class:`v1_11_15.web.vo.NamedUserObject` *)* Delphix users.
    """
    def __init__(self, undef_enabled=True):
        ...
        self._allow_password_authentication = (self.__undef__, True)
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._email_address[0] is not None and obj._email_address[0] is not obj.__undef__:
            assert isinstance(obj._email_address[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._email_address[0], type(obj._email_address[0])))
        ...
        if obj._first_name[0] is not None and obj._first_name[0] is not obj.__undef__:
            assert isinstance(obj._first_name[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._first_name[0], type(obj._first_name[0])))
        ...
        if obj._last_name[0] is not None and obj._last_name[0] is not obj.__undef__:
            assert isinstance(obj._last_name[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._last_name[0], type(obj._last_name[0])))
        ...
        if obj._password_update_request[0] is not None and obj._password_update_request[0] is not obj.__undef__:
            assert isinstance(obj._password_update_request[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._password_update_request[0], type(obj._password_update_request[0])))
        ...
        if obj._mobile_phone_number[0] is not None and obj._mobile_phone_number[0] is not obj.__undef__:
            assert isinstance(obj._mobile_phone_number[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._mobile_phone_number[0], type(obj._mobile_phone_number[0])))
        ...
        if obj._work_phone_number[0] is not None and obj._work_phone_number[0] is not obj.__undef__:
            assert isinstance(obj._work_phone_number[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._work_phone_number[0], type(obj._work_phone_number[0])))
        ...
        if obj._home_phone_number[0] is not None and obj._home_phone_number[0] is not obj.__undef__:
            assert isinstance(obj._home_phone_number[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._home_phone_number[0], type(obj._home_phone_number[0])))
        ...
        if obj._authentication_type[0] is not None and obj._authentication_type[0] is not obj.__undef__:
            assert isinstance(obj._authentication_type[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._authentication_type[0], type(obj._authentication_type[0])))
        ...
        if obj._locale[0] is not None and obj._locale[0] is not obj.__undef__:
            assert isinstance(obj._locale[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._locale[0], type(obj._locale[0])))
            common.validate_format(obj._locale[0], "locale", None, 16)
        obj._allow_password_authentication = (data.get("allowPasswordAuthentication", obj.__undef__), dirty)
        if obj._allow_password_authentication[0] is not None and obj._allow_password_authentication[0] is not obj.__undef__:
            assert isinstance(obj._allow_password_authentication[0], bool), ("Expected one of ['boolean'], but got %s of type %s" % (obj._allow_password_authentication[0], type(obj._allow_password_authentication[0])))
            common.validate_format(obj._allow_password_authentication[0], "None", None, None)
        return obj
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "user_type" == "type" or (self.user_type is not self.__undef__ and (not (dirty and not self._user_type[1]) or self.is_dirty_list(self.user_type, self._user_type) or belongs_to_parent)):
            ...
            dct["userType"] = "DOMAIN"
        if "email_address" == "type" or (self.email_address is not self.__undef__ and (not (dirty and not self._email_address[1]) or self.is_dirty_list(self.email_address, self._email_address) or belongs_to_parent)):
        ...
        if "enabled" == "type" or (self.enabled is not self.__undef__ and (not (dirty and not self._enabled[1]) or self.is_dirty_list(self.enabled, self._enabled) or belongs_to_parent)):
            ...
            dct["enabled"] = True
        if "first_name" == "type" or (self.first_name is not self.__undef__ and (not (dirty and not self._first_name[1]) or self.is_dirty_list(self.first_name, self._first_name) or belongs_to_parent)):
            dct["firstName"] = dictify(self.first_name)
        if "last_name" == "type" or (self.last_name is not self.__undef__ and (not (dirty and not self._last_name[1]) or self.is_dirty_list(self.last_name, self._last_name) or belongs_to_parent)):
            dct["lastName"] = dictify(self.last_name)
        if "password_update_request" == "type" or (self.password_update_request is not self.__undef__ and (not (dirty and not self._password_update_request[1]) or self.is_dirty_list(self.password_update_request, self._password_update_request) or belongs_to_parent)):
        ...
        if "is_default" == "type" or (self.is_default is not self.__undef__ and (not (dirty and not self._is_default[1]) or self.is_dirty_list(self.is_default, self._is_default) or belongs_to_parent)):
            dct["isDefault"] = dictify(self.is_default)
        if "mobile_phone_number" == "type" or (self.mobile_phone_number is not self.__undef__ and (not (dirty and not self._mobile_phone_number[1]) or self.is_dirty_list(self.mobile_phone_number, self._mobile_phone_number) or belongs_to_parent)):
            dct["mobilePhoneNumber"] = dictify(self.mobile_phone_number)
        if "work_phone_number" == "type" or (self.work_phone_number is not self.__undef__ and (not (dirty and not self._work_phone_number[1]) or self.is_dirty_list(self.work_phone_number, self._work_phone_number) or belongs_to_parent)):
            dct["workPhoneNumber"] = dictify(self.work_phone_number)
        if "home_phone_number" == "type" or (self.home_phone_number is not self.__undef__ and (not (dirty and not self._home_phone_number[1]) or self.is_dirty_list(self.home_phone_number, self._home_phone_number) or belongs_to_parent)):
            dct["homePhoneNumber"] = dictify(self.home_phone_number)
        if "authentication_type" == "type" or (self.authentication_type is not self.__undef__ and (not (dirty and not self._authentication_type[1]) or self.is_dirty_list(self.authentication_type, self._authentication_type) or belongs_to_parent)):
        ...
        if "session_timeout" == "type" or (self.session_timeout is not self.__undef__ and (not (dirty and not self._session_timeout[1]) or self.is_dirty_list(self.session_timeout, self._session_timeout) or belongs_to_parent)):
        ...
        if "locale" == "type" or (self.locale is not self.__undef__ and (not (dirty and not self._locale[1]) or self.is_dirty_list(self.locale, self._locale) or belongs_to_parent)):
            dct["locale"] = dictify(self.locale)
        elif belongs_to_parent and self.locale is self.__undef__:
            dct["locale"] = "en-US"
        if "allow_password_authentication" == "type" or (self.allow_password_authentication is not self.__undef__ and (not (dirty and not self._allow_password_authentication[1]) or self.is_dirty_list(self.allow_password_authentication, self._allow_password_authentication) or belongs_to_parent)):
            dct["allowPasswordAuthentication"] = dictify(self.allow_password_authentication)
        return dct
    ...
    def force_dirty(self):
        ...
        self._allow_password_authentication = (self._allow_password_authentication[0], True)

    def is_dirty(self):
        return any([self._name[1], self._user_type[1], self._email_address[1], self._enabled[1], self._first_name[1], self._last_name[1], self._password_update_request[1], self._is_default[1], self._mobile_phone_number[1], self._work_phone_number[1], self._home_phone_number[1], self._authentication_type[1], self._principal[1], self._credential[1], self._public_key[1], self._session_timeout[1], self._locale[1], self._allow_password_authentication[1]])
    ...
    def __eq__(self, other):
        ...
        return super().__eq__(other) and \
               ...
               self.allow_password_authentication == other.allow_password_authentication
    ...
    def credential(self):
        ...
        :rtype: :py:class:`v1_11_15.web.vo.PasswordCredential`
        """
    ...
    def allow_password_authentication(self):
        """
        If the Delphix Engine has been configured for SAML SSO, only users with
        this property set can authenticate with a username and password for API
        or CLI access.

        :rtype: ``bool``
        """
        return self._allow_password_authentication[0]

    @allow_password_authentication.setter
    def allow_password_authentication(self, value):
        self._allow_password_authentication = (value, True)
