...
from delphixpy.v1_11_15.web.objects.EndEntityCertificateReplaceParameters import EndEntityCertificateReplaceParameters
...
class EndEntityCertificateReplaceKeystoreParameters(EndEntityCertificateReplaceParameters):
    """
    *(extends*
    :py:class:`v1_11_15.web.vo.EndEntityCertificateReplaceParameters` *)* The
