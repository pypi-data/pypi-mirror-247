...
def create(engine, certificate_import_parameters):
    ...
    :type certificate_import_parameters:
        :py:class:`v1_9_1.web.vo.CertificateImportParameters`
    :rtype: ``str``
    """
...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_9_1.web.objects.TlsCaCert.TlsCaCert` object
    :type ref: ``str``
    :rtype: :py:class:`v1_9_1.web.vo.TlsCaCert`
    """
...
def get_all(engine, alias=None):
    ...
    :type alias: ``str``
    :rtype: ``list`` of :py:class:`v1_9_1.web.vo.TlsCaCert`
    """
    url = "/resources/json/delphix/service/tls/cacert"
