...
class HostEnvironmentCreateParameters(SourceEnvironmentCreateParameters):
    """
    *(extends* :py:class:`v1_9_1.web.vo.SourceEnvironmentCreateParameters` *)*
    ...
    def host_environment(self):
        ...
        :rtype: :py:class:`v1_9_1.web.vo.HostEnvironment`
        """
    ...
    def host_parameters(self):
        ...
        :rtype: :py:class:`v1_9_1.web.vo.HostCreateParameters`
        """
