...
class TlsCaCert(NamedUserObject):
    """
    *(extends* :py:class:`v1_9_1.web.vo.NamedUserObject` *)* Trusted CA
    certificate.
    """
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._issued_to_dn[0] is not None and obj._issued_to_dn[0] is not obj.__undef__:
            assert isinstance(obj._issued_to_dn[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._issued_to_dn[0], type(obj._issued_to_dn[0])))
        ...
        if obj._valid_from[0] is not None and obj._valid_from[0] is not obj.__undef__:
            assert isinstance(obj._valid_from[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._valid_from[0], type(obj._valid_from[0])))
        ...
        if obj._valid_to[0] is not None and obj._valid_to[0] is not obj.__undef__:
            assert isinstance(obj._valid_to[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._valid_to[0], type(obj._valid_to[0])))
    ...
    def is_dirty(self):
        return any([self._name[1], self._issued_by_dn[1], self._issued_to_dn[1], self._serial_number[1], self._valid_from[1], self._valid_to[1], self._sha1_fingerprint[1], self._md5_fingerprint[1]])
