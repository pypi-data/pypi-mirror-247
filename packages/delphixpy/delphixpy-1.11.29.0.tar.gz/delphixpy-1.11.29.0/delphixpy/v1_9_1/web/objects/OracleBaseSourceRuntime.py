...
class OracleBaseSourceRuntime(SourceRuntime):
    """
    *(extends* :py:class:`v1_9_1.web.vo.SourceRuntime` *)* Runtime (non-
    ...
    def active_instances(self):
        ...
        :rtype: ``list`` of :py:class:`v1_9_1.web.vo.OracleActiveInstance`
        """
    ...
    def database_stats(self):
        ...
        :rtype: ``list`` of
            :py:class:`v1_9_1.web.vo.OracleDatabaseStatsSection`
        """
