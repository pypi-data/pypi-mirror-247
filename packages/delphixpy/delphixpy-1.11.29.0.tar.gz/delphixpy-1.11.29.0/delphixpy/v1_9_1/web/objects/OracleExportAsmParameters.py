...
class OracleExportAsmParameters(ExportParameters):
    """
    *(extends* :py:class:`v1_9_1.web.vo.ExportParameters` *)* The parameters to
    ...
    def source_config(self):
        ...
        :rtype: :py:class:`v1_9_1.web.vo.OracleDBConfig`
        """
    ...
    def source(self):
        ...
        :rtype: :py:class:`v1_9_1.web.vo.OracleVirtualSource`
        """
