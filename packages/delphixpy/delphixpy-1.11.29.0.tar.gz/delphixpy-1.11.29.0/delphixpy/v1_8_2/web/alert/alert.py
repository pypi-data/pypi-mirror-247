...
Package "alert"
"""
from delphixpy.v1_8_2.web.alert import profile
...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_8_2.web.objects.Alert.Alert` object
    :type ref: ``str``
    :rtype: :py:class:`v1_8_2.web.vo.Alert`
    """
...
def get_all(engine, ascending=None, from_date=None, max_total=None, page_offset=None, page_size=None, search_text=None, sort_by=None, target=None, to_date=None):
    ...
    :type to_date: ``str``
    :rtype: ``list`` of :py:class:`v1_8_2.web.vo.Alert`
    """
