...
class MySQLAttachData(AttachData):
    """
    *(extends* :py:class:`v1_8_2.web.vo.AttachData` *)* Represents the MySQL
    ...
    def is_dirty(self):
        return any([self._config[1], self._config_params[1], self._db_credentials[1], self._db_user[1], self._operations[1], self._staging_host_user[1], self._staging_port[1], self._staging_repository[1]])
