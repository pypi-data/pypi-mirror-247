...
class JSDataContainerLockParameters(TypedObject):
    """
    *(extends* :py:class:`v1_8_2.web.vo.TypedObject` *)* The parameters used to
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._lock_user[0] is not None and obj._lock_user[0] is not obj.__undef__:
            assert isinstance(obj._lock_user[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._lock_user[0], type(obj._lock_user[0])))
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        def dictify(obj, prop_is_list_or_vo=False):
            if isinstance(obj, list):
                ...
                return obj
        if "lock_user" == "type" or (self.lock_user is not self.__undef__ and (not (dirty and not self._lock_user[1]) or self.is_dirty_list(self.lock_user, self._lock_user) or belongs_to_parent)):
