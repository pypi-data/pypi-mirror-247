...
from delphixpy.v1_8_2.web.objects.SourceEnvironmentCreateParameters import SourceEnvironmentCreateParameters
...
class HostEnvironmentCreateParameters(SourceEnvironmentCreateParameters):
    """
    *(extends* :py:class:`v1_8_2.web.vo.SourceEnvironmentCreateParameters` *)*
    ...
    def host_environment(self):
        ...
        :rtype: :py:class:`v1_8_2.web.vo.HostEnvironment`
        """
    ...
    def host_parameters(self):
        ...
        :rtype: :py:class:`v1_8_2.web.vo.HostCreateParameters`
        """
