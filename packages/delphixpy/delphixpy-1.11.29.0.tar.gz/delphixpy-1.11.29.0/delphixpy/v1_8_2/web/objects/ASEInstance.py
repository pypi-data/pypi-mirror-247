...
class ASEInstance(SourceRepository):
    """
    *(extends* :py:class:`v1_8_2.web.vo.SourceRepository` *)* The SAP ASE
    source repository.
    """
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._internal_version[0] is not None and obj._internal_version[0] is not obj.__undef__:
            assert isinstance(obj._internal_version[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._internal_version[0], type(obj._internal_version[0])))
    ...
    def is_dirty(self):
        return any([self._credentials[1], self._db_user[1], self._discovered[1], self._installation_path[1], self._instance_name[1], self._instance_owner[1], self._instance_owner_gid[1], self._instance_owner_uid[1], self._internal_version[1], self._page_size[1], self._ports[1], self._service_principal_name[1]])
    ...
    def __eq__(self, other):
        ...
        return super().__eq__(other) and \
               ...
               self.service_principal_name == other.service_principal_name
