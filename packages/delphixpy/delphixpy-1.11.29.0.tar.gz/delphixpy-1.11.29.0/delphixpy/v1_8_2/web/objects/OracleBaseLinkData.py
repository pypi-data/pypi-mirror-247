...
class OracleBaseLinkData(LinkData):
    """
    *(extends* :py:class:`v1_8_2.web.vo.LinkData` *)* Represents common
    ...
    def is_dirty(self):
        return any([self._backup_level_enabled[1], self._bandwidth_limit[1], self._check_logical[1], self._compressed_linking_enabled[1], self._config[1], self._db_credentials[1], self._db_user[1], self._diagnose_no_logging_faults[1], self._double_sync[1], self._encrypted_linking_enabled[1], self._environment_user[1], self._external_file_path[1], self._files_per_set[1], self._link_now[1], self._number_of_connections[1], self._operations[1], self._pre_provisioning_enabled[1], self._rman_channels[1], self._skip_space_check[1], self._sourcing_policy[1]])
    ...
    def sourcing_policy(self):
        ...
        :rtype: :py:class:`v1_8_2.web.vo.OracleSourcingPolicy`
        """
