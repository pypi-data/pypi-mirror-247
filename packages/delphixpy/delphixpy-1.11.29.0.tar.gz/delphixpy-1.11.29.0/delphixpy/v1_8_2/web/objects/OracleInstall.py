...
class OracleInstall(SourceRepository):
    """
    *(extends* :py:class:`v1_8_2.web.vo.SourceRepository` *)* The Oracle source
    repository.
    """
    ...
    def is_dirty(self):
        return any([self._applied_patches[1], self._bits[1], self._discovered[1], self._group_id[1], self._group_name[1], self._installation_home[1], self._logsync_possible[1], self._oracle_base[1], self._rac[1], self._user_id[1], self._user_name[1], self._version[1]])
