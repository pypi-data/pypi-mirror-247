...
from delphixpy.v1_8_2.web.objects.OracleBaseSourceRuntime import OracleBaseSourceRuntime
...
class OracleLiveSourceRuntime(OracleBaseSourceRuntime):
    """
    *(extends* :py:class:`v1_8_2.web.vo.OracleBaseSourceRuntime` *)* Runtime
