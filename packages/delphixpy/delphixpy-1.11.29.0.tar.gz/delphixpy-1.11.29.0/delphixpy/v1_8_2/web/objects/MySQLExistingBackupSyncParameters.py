...
from delphixpy.v1_8_2.web.objects.MySQLSyncParameters import MySQLSyncParameters
...
class MySQLExistingBackupSyncParameters(MySQLSyncParameters):
    """
    *(extends* :py:class:`v1_8_2.web.vo.MySQLSyncParameters` *)* The parameters
    ...
    def replication_coordinates(self):
        ...
        :rtype: :py:class:`v1_8_2.web.vo.MySQLReplicationCoordinates`
        """
