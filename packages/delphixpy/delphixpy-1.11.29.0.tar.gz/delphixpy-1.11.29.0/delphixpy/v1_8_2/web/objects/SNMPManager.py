...
class SNMPManager(PersistentObject):
    """
    *(extends* :py:class:`v1_8_2.web.vo.PersistentObject` *)* SNMP manager
    configuration.
    """
    ...
    def is_dirty(self):
        return any([self._address[1], self._community_string[1], self._last_send_status[1], self._port[1], self._use_inform[1]])
