...
class UnixHost(Host):
    """
    *(extends* :py:class:`v1_8_2.web.vo.Host` *)* The representation of a Unix
    host object.
    """
    def __init__(self, undef_enabled=True):
        ...
        self._truststore_password = (self.__undef__, True)
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        obj._truststore_password = (data.get("truststorePassword", obj.__undef__), dirty)
        if obj._truststore_password[0] is not None and obj._truststore_password[0] is not obj.__undef__:
            assert isinstance(obj._truststore_password[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._truststore_password[0], type(obj._truststore_password[0])))
            common.validate_format(obj._truststore_password[0], "password", 1, None)
        return obj
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "truststore_password" == "type" or (self.truststore_password is not self.__undef__ and (not (dirty and not self._truststore_password[1]) or self.is_dirty_list(self.truststore_password, self._truststore_password) or belongs_to_parent)):
            dct["truststorePassword"] = dictify(self.truststore_password)
        return dct
    ...
    def force_dirty(self):
        ...
        self._truststore_password = (self._truststore_password[0], True)

    def is_dirty(self):
        return any([self._toolkit_path[1], self._truststore_password[1]])
    ...
    def __eq__(self, other):
        ...
        return super().__eq__(other) and \
               ...
               self.truststore_password == other.truststore_password
    ...
    def truststore_password(self):
        ...
        :rtype: ``str``
        """
        return self._truststore_password[0]

    @truststore_password.setter
    def truststore_password(self, value):
        self._truststore_password = (value, True)
