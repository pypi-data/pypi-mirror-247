...
from delphixpy.v1_8_2.web.objects.OracleBaseLinkData import OracleBaseLinkData
...
class OracleLinkData(OracleBaseLinkData):
    """
    *(extends* :py:class:`v1_8_2.web.vo.OracleBaseLinkData` *)* Represents
    ...
    def is_dirty(self):
        return any([self._config[1], self._non_sys_credentials[1], self._non_sys_user[1]])
