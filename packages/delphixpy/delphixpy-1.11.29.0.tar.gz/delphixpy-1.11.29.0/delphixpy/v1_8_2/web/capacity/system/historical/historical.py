...
def get_all(engine, end_date=None, resolution=None, start_date=None):
    """
    ...
    :type start_date: ``str``
    :rtype: ``list`` of :py:class:`v1_8_2.web.vo.HistoricalSystemCapacityData`
    """
    url = "/resources/json/delphix/capacity/system/historical"
    query_params = {"endDate": end_date, "resolution": resolution, "startDate": start_date}
