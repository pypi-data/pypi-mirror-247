...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_5_0.web.objects.FaultEffect.FaultEffect` object
    :type ref: ``str``
    :rtype: :py:class:`v1_5_0.web.vo.FaultEffect`
    """
...
def get_all(engine, root_cause=None, severity=None, target=None):
    ...
    :type target: ``str``
    :rtype: ``list`` of :py:class:`v1_5_0.web.vo.FaultEffect`
    """
