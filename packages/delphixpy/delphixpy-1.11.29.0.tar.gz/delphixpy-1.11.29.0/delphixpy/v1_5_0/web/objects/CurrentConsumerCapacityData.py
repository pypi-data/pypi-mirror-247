...
from delphixpy.v1_5_0.web.objects.BaseConsumerCapacityData import BaseConsumerCapacityData
...
class CurrentConsumerCapacityData(BaseConsumerCapacityData):
    """
    *(extends* :py:class:`v1_5_0.web.vo.BaseConsumerCapacityData` *)* Current
