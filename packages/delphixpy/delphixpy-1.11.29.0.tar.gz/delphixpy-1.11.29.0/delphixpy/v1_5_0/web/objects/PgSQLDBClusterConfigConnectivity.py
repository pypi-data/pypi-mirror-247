...
from delphixpy.v1_5_0.web.objects.SourceConfigConnectivity import SourceConfigConnectivity
...
class PgSQLDBClusterConfigConnectivity(SourceConfigConnectivity):
    """
    *(extends* :py:class:`v1_5_0.web.vo.SourceConfigConnectivity` *)* Mechanism
