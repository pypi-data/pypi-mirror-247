...
class ASELinkParameters(LinkParameters):
    """
    *(extends* :py:class:`v1_5_0.web.vo.LinkParameters` *)* SAP ASE specific
    ...
    def source(self):
        ...
        :rtype: :py:class:`v1_5_0.web.vo.ASELinkedSource`
        """
    ...
    def sync_parameters(self):
        ...
        :rtype: :py:class:`v1_5_0.web.vo.ASESyncParameters`
        """
