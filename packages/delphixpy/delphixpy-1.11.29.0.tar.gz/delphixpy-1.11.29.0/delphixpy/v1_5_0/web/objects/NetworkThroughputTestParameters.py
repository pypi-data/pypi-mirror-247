...
from delphixpy.v1_5_0.web.objects.NetworkThroughputTestBaseParameters import NetworkThroughputTestBaseParameters
...
class NetworkThroughputTestParameters(NetworkThroughputTestBaseParameters):
    """
    *(extends* :py:class:`v1_5_0.web.vo.NetworkThroughputTestBaseParameters`
