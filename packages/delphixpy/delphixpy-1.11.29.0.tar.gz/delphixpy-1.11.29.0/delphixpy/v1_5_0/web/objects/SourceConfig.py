...
class SourceConfig(ReadonlyNamedUserObject):
    """
    *(extends* :py:class:`v1_5_0.web.vo.ReadonlyNamedUserObject` *)* The source
    ...
    def is_dirty(self):
        return any([self._discovered[1], self._environment_user[1], self._linking_enabled[1], self._repository[1]])
