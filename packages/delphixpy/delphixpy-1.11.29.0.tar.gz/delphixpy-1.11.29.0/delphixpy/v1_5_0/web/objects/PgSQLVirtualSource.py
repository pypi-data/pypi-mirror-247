...
from delphixpy.v1_5_0.web.objects.PgSQLSource import PgSQLSource
...
class PgSQLVirtualSource(PgSQLSource):
    """
    *(extends* :py:class:`v1_5_0.web.vo.PgSQLSource` *)* A virtual PostgreSQL
    source.
    """
    ...
    def is_dirty(self):
        return any([self._config_params[1], self._file_mapping_rules[1], self._hba_entries[1], self._ident_entries[1], self._mount_base[1], self._operations[1]])
