...
Package "system"
"""
from delphixpy.v1_10_0.web.system import package
...
def get(engine):
    ...
    :rtype: :py:class:`v1_10_0.web.vo.SystemInfo`
    """
...
def set(engine, system_info=None):
    ...
    :type system_info: :py:class:`v1_10_0.web.vo.SystemInfo`
    """
    url = "/resources/json/delphix/system"
...
def enable_feature_flag(engine, feature_flag_parameters):
    ...
    :type feature_flag_parameters:
        :py:class:`v1_10_0.web.vo.FeatureFlagParameters`
    """
