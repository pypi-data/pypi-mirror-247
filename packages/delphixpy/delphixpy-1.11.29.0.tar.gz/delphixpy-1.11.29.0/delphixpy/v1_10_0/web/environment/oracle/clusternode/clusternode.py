...
def create(engine, oracle_cluster_node_create_parameters):
    ...
    :type oracle_cluster_node_create_parameters:
        :py:class:`v1_10_0.web.vo.OracleClusterNodeCreateParameters`
    :rtype: ``str``
    """
...
def get(engine, ref):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_10_0.delphix_engine.DelphixEngine`
    :param ref: Reference to a :py:class:`delphixpy.v1_10_0.web.objects.OracleC
        lusterNode.OracleClusterNode` object
    :type ref: ``str``
    :rtype: :py:class:`v1_10_0.web.vo.OracleClusterNode`
    """
...
def get_all(engine, cluster=None):
    ...
    :type cluster: ``str``
    :rtype: ``list`` of :py:class:`v1_10_0.web.vo.OracleClusterNode`
    """
    url = "/resources/json/delphix/environment/oracle/clusternode"
...
def update(engine, ref, oracle_cluster_node=None):
    ...
    :type oracle_cluster_node: :py:class:`v1_10_0.web.vo.OracleClusterNode`
    """
    url = "/resources/json/delphix/environment/oracle/clusternode/%s" % ref
