...
from delphixpy.v1_10_0.web.objects.NetworkThroughputTestBaseParameters import NetworkThroughputTestBaseParameters
...
class NetworkDSPTestParameters(NetworkThroughputTestBaseParameters):
    """
    *(extends* :py:class:`v1_10_0.web.vo.NetworkThroughputTestBaseParameters`
    *)* Parameters used to execute a network throughput test using the Delphix
    ...
    def is_dirty(self):
        return any([self._destination_type[1], self._remote_delphix_engine_info[1], self._compression[1], self._encryption[1], self._queue_depth[1], self._block_size[1], self._send_socket_buffer[1], self._receive_socket_buffer[1]])
    ...
    def remote_delphix_engine_info(self):
        ...
        :rtype: :py:class:`v1_10_0.web.vo.RemoteDelphixEngineInfo`
        """
