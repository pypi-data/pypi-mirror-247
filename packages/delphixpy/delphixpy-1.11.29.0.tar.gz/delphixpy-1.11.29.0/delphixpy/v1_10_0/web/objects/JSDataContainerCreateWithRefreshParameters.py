...
from delphixpy.v1_10_0.web.objects.JSDataContainerCreateParameters import JSDataContainerCreateParameters
...
class JSDataContainerCreateWithRefreshParameters(JSDataContainerCreateParameters):
    """
    *(extends* :py:class:`v1_10_0.web.vo.JSDataContainerCreateParameters` *)*
