...
class StorageTest(ReadonlyNamedUserObject):
    """
    *(extends* :py:class:`v1_10_0.web.vo.ReadonlyNamedUserObject` *)* Test the
    ...
    def parameters(self):
        ...
        :rtype: :py:class:`v1_10_0.web.vo.StorageTestParameters`
        """
    ...
    def test_results(self):
        ...
        :rtype: ``list`` of :py:class:`v1_10_0.web.vo.StorageTestResult`
        """
