...
from delphixpy.v1_10_0.web.objects.EmptyDatasetCreationParameters import EmptyDatasetCreationParameters
...
class OracleDatabaseCreationParameters(EmptyDatasetCreationParameters):
    """
    *(extends* :py:class:`v1_10_0.web.vo.EmptyDatasetCreationParameters` *)*
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._national_character_set[0] is not None and obj._national_character_set[0] is not obj.__undef__:
            assert isinstance(obj._national_character_set[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._national_character_set[0], type(obj._national_character_set[0])))
        ...
        if obj._sys_password[0] is not None and obj._sys_password[0] is not obj.__undef__:
            assert isinstance(obj._sys_password[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._sys_password[0], type(obj._sys_password[0])))
        ...
        if obj._system_password[0] is not None and obj._system_password[0] is not obj.__undef__:
            assert isinstance(obj._system_password[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._system_password[0], type(obj._system_password[0])))
        ...
        if obj._delphix_username[0] is not None and obj._delphix_username[0] is not obj.__undef__:
            assert isinstance(obj._delphix_username[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._delphix_username[0], type(obj._delphix_username[0])))
        ...
        if obj._delphix_password[0] is not None and obj._delphix_password[0] is not obj.__undef__:
            assert isinstance(obj._delphix_password[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._delphix_password[0], type(obj._delphix_password[0])))
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "max_data_files" == "type" or (self.max_data_files is not self.__undef__ and (not (dirty and not self._max_data_files[1]) or self.is_dirty_list(self.max_data_files, self._max_data_files) or belongs_to_parent)):
            dct["maxDataFiles"] = dictify(self.max_data_files)
        elif belongs_to_parent and self.max_data_files is self.__undef__:
            dct["maxDataFiles"] = 32
        if "max_instances" == "type" or (self.max_instances is not self.__undef__ and (not (dirty and not self._max_instances[1]) or self.is_dirty_list(self.max_instances, self._max_instances) or belongs_to_parent)):
            dct["maxInstances"] = dictify(self.max_instances)
        elif belongs_to_parent and self.max_instances is self.__undef__:
            dct["maxInstances"] = 32
        if "redo_logs" == "type" or (self.redo_logs is not self.__undef__ and (not (dirty and not self._redo_logs[1]) or self.is_dirty_list(self.redo_logs, self._redo_logs) or belongs_to_parent)):
            dct["redoLogs"] = dictify(self.redo_logs, prop_is_list_or_vo=True)
        if "max_log_files" == "type" or (self.max_log_files is not self.__undef__ and (not (dirty and not self._max_log_files[1]) or self.is_dirty_list(self.max_log_files, self._max_log_files) or belongs_to_parent)):
            dct["maxLogFiles"] = dictify(self.max_log_files)
        elif belongs_to_parent and self.max_log_files is self.__undef__:
            dct["maxLogFiles"] = 64
        if "max_log_history" == "type" or (self.max_log_history is not self.__undef__ and (not (dirty and not self._max_log_history[1]) or self.is_dirty_list(self.max_log_history, self._max_log_history) or belongs_to_parent)):
        ...
        if "force_logging" == "type" or (self.force_logging is not self.__undef__ and (not (dirty and not self._force_logging[1]) or self.is_dirty_list(self.force_logging, self._force_logging) or belongs_to_parent)):
        ...
        if "sys_datafile" == "type" or (self.sys_datafile is not self.__undef__ and (not (dirty and not self._sys_datafile[1]) or self.is_dirty_list(self.sys_datafile, self._sys_datafile) or belongs_to_parent)):
            dct["sysDatafile"] = dictify(self.sys_datafile, prop_is_list_or_vo=True)
        if "sysaux_datafile" == "type" or (self.sysaux_datafile is not self.__undef__ and (not (dirty and not self._sysaux_datafile[1]) or self.is_dirty_list(self.sysaux_datafile, self._sysaux_datafile) or belongs_to_parent)):
            dct["sysauxDatafile"] = dictify(self.sysaux_datafile, prop_is_list_or_vo=True)
        if "undo_tablespace" == "type" or (self.undo_tablespace is not self.__undef__ and (not (dirty and not self._undo_tablespace[1]) or self.is_dirty_list(self.undo_tablespace, self._undo_tablespace) or belongs_to_parent)):
            dct["undoTablespace"] = dictify(self.undo_tablespace, prop_is_list_or_vo=True)
        if "temp_tablespace" == "type" or (self.temp_tablespace is not self.__undef__ and (not (dirty and not self._temp_tablespace[1]) or self.is_dirty_list(self.temp_tablespace, self._temp_tablespace) or belongs_to_parent)):
            dct["tempTablespace"] = dictify(self.temp_tablespace, prop_is_list_or_vo=True)
        if "character_set" == "type" or (self.character_set is not self.__undef__ and (not (dirty and not self._character_set[1]) or self.is_dirty_list(self.character_set, self._character_set) or belongs_to_parent)):
        ...
        if "national_character_set" == "type" or (self.national_character_set is not self.__undef__ and (not (dirty and not self._national_character_set[1]) or self.is_dirty_list(self.national_character_set, self._national_character_set) or belongs_to_parent)):
        ...
        if "sys_password" == "type" or (self.sys_password is not self.__undef__ and (not (dirty and not self._sys_password[1]) or self.is_dirty_list(self.sys_password, self._sys_password) or belongs_to_parent)):
            dct["sysPassword"] = dictify(self.sys_password)
        if "system_password" == "type" or (self.system_password is not self.__undef__ and (not (dirty and not self._system_password[1]) or self.is_dirty_list(self.system_password, self._system_password) or belongs_to_parent)):
            dct["systemPassword"] = dictify(self.system_password)
        if "delphix_username" == "type" or (self.delphix_username is not self.__undef__ and (not (dirty and not self._delphix_username[1]) or self.is_dirty_list(self.delphix_username, self._delphix_username) or belongs_to_parent)):
            dct["delphixUsername"] = dictify(self.delphix_username)
        if "delphix_password" == "type" or (self.delphix_password is not self.__undef__ and (not (dirty and not self._delphix_password[1]) or self.is_dirty_list(self.delphix_password, self._delphix_password) or belongs_to_parent)):
            dct["delphixPassword"] = dictify(self.delphix_password)
        if "grant_select_any_dictionary" == "type" or (self.grant_select_any_dictionary is not self.__undef__ and (not (dirty and not self._grant_select_any_dictionary[1]) or self.is_dirty_list(self.grant_select_any_dictionary, self._grant_select_any_dictionary) or belongs_to_parent)):
        ...
        if "timezone_file_version" == "type" or (self.timezone_file_version is not self.__undef__ and (not (dirty and not self._timezone_file_version[1]) or self.is_dirty_list(self.timezone_file_version, self._timezone_file_version) or belongs_to_parent)):
    ...
    def is_dirty(self):
        return any([self._container[1], self._source[1], self._source_config[1], self._max_data_files[1], self._max_instances[1], self._redo_logs[1], self._max_log_files[1], self._max_log_history[1], self._force_logging[1], self._sys_datafile[1], self._sysaux_datafile[1], self._undo_tablespace[1], self._temp_tablespace[1], self._character_set[1], self._national_character_set[1], self._sys_password[1], self._system_password[1], self._delphix_username[1], self._delphix_password[1], self._grant_select_any_dictionary[1], self._timezone_file_version[1]])
    ...
    def __eq__(self, other):
        ...
        return super().__eq__(other) and \
               ...
               self.timezone_file_version == other.timezone_file_version
    ...
    def container(self):
        ...
        :rtype: :py:class:`v1_10_0.web.vo.OracleDatabaseContainer`
        """
    ...
    def source(self):
        ...
        :rtype: :py:class:`v1_10_0.web.vo.OracleWarehouseSource`
        """
    ...
    def source_config(self):
        ...
        :rtype: :py:class:`v1_10_0.web.vo.OracleBaseDBConfig`
        """
    ...
    def redo_logs(self):
        ...
        :rtype: ``list`` of
            :py:class:`v1_10_0.web.vo.OracleRedoLogFileSpecification`
        """
    ...
    def sys_datafile(self):
        ...
        :rtype: :py:class:`v1_10_0.web.vo.OracleSystemDatafileSpecification`
        """
    ...
    def sysaux_datafile(self):
        ...
        :rtype: :py:class:`v1_10_0.web.vo.OracleSysauxDatafileSpecification`
        """
    ...
    def undo_tablespace(self):
        ...
        :rtype: :py:class:`v1_10_0.web.vo.OracleUndoDatafileSpecification`
        """
    ...
    def temp_tablespace(self):
        ...
        :rtype: :py:class:`v1_10_0.web.vo.OracleTempfileSpecification`
        """
