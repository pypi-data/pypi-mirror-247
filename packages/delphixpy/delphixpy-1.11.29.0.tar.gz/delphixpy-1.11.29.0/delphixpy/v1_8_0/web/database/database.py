...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_8_0.web.objects.Container.Container` object
    :type ref: ``str``
    :rtype: :py:class:`v1_8_0.web.vo.Container`
    """
...
def get_all(engine, group=None, no_js_container_data_source=None, no_js_data_source=None, provision_container=None, restoration=None, valid_for_secure_replication=None):
    ...
    :rtype: ``list`` of :py:class:`v1_8_0.web.vo.Container`
    """
...
def update(engine, ref, container=None):
    ...
    :type container: :py:class:`v1_8_0.web.vo.Container`
    """
    url = "/resources/json/delphix/database/%s" % ref
...
def delete(engine, ref, delete_parameters=None):
    ...
    :type delete_parameters: :py:class:`v1_8_0.web.vo.DeleteParameters`
    """
...
def add_live_source(engine, ref, add_live_source_parameters):
    ...
    :type add_live_source_parameters:
        :py:class:`v1_8_0.web.vo.AddLiveSourceParameters`
    """
...
def add_live_source_defaults(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_8_0.web.objects.Container.Container` object
    :type ref: ``str``
    :rtype: :py:class:`v1_8_0.web.vo.AddLiveSourceParameters`
    """
...
def attach_source(engine, ref, attach_source_parameters):
    ...
    :type attach_source_parameters:
        :py:class:`v1_8_0.web.vo.AttachSourceParameters`
    """
...
def connection_info(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_8_0.web.objects.Container.Container` object
    :type ref: ``str``
    :rtype: :py:class:`v1_8_0.web.vo.SourceConnectionInfo`
    """
...
def create_transformation(engine, ref, create_transformation_parameters):
    ...
    :type create_transformation_parameters:
        :py:class:`v1_8_0.web.vo.CreateTransformationParameters`
    :rtype: ``str``
    """
...
def detach_source(engine, ref, detach_source_parameters):
    ...
    :type detach_source_parameters:
        :py:class:`v1_8_0.web.vo.DetachSourceParameters`
    """
...
def purge_logs(engine, ref, purge_logs_parameters):
    ...
    :type purge_logs_parameters: :py:class:`v1_8_0.web.vo.PurgeLogsParameters`
    :rtype: :py:class:`v1_8_0.web.vo.PurgeLogsResult`
    """
...
def refresh(engine, ref, refresh_parameters):
    ...
    :type refresh_parameters: :py:class:`v1_8_0.web.vo.RefreshParameters`
    """
...
def request_xpp_download(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_8_0.web.objects.Container.Container` object
    :type ref: ``str``
    :rtype: :py:class:`v1_8_0.web.vo.FileDownloadResult`
    """
...
def request_xpp_upload(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_8_0.web.objects.Container.Container` object
    :type ref: ``str``
    :rtype: :py:class:`v1_8_0.web.vo.FileUploadResult`
    """
...
def rollback(engine, ref, rollback_parameters):
    ...
    :type rollback_parameters: :py:class:`v1_8_0.web.vo.RollbackParameters`
    """
...
def switch_timeflow(engine, ref, switch_timeflow_parameters):
    ...
    :type switch_timeflow_parameters:
        :py:class:`v1_8_0.web.vo.SwitchTimeflowParameters`
    """
...
def sync(engine, ref, sync_parameters=None):
    ...
    :type sync_parameters: :py:class:`v1_8_0.web.vo.SyncParameters`
    """
...
def xpp_status(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_8_0.web.objects.Container.Container` object
    :type ref: ``str``
    :rtype: :py:class:`v1_8_0.web.vo.XppStatus`
    """
...
def create_empty(engine, empty_dataset_creation_parameters):
    ...
    :type empty_dataset_creation_parameters:
        :py:class:`v1_8_0.web.vo.EmptyDatasetCreationParameters`
    :rtype: ``str``
    """
...
def create_restoration_dataset(engine, restoration_dataset_parameters):
    ...
    :type restoration_dataset_parameters:
        :py:class:`v1_8_0.web.vo.RestorationDatasetParameters`
    :rtype: ``str``
    """
...
def create_restoration_dataset_defaults(engine, timeflow_point_parameters):
    ...
    :type timeflow_point_parameters:
        :py:class:`v1_8_0.web.vo.TimeflowPointParameters`
    """
...
def export(engine, export_parameters):
    ...
    :type export_parameters: :py:class:`v1_8_0.web.vo.ExportParameters`
    """
...
def file_mapping(engine, file_mapping_parameters):
    ...
    :type file_mapping_parameters:
        :py:class:`v1_8_0.web.vo.FileMappingParameters`
    :rtype: :py:class:`v1_8_0.web.vo.FileMappingResult`
    """
...
def link(engine, link_parameters):
    ...
    :type link_parameters: :py:class:`v1_8_0.web.vo.LinkParameters`
    :rtype: ``str``
    """
...
def oracle_supported_character_sets(engine):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_8_0.delphix_engine.DelphixEngine`
    :rtype: ``list`` of :py:class:`v1_8_0.web.vo.OracleCharacterSet`
    """
...
def provision(engine, provision_parameters):
    ...
    :type provision_parameters: :py:class:`v1_8_0.web.vo.ProvisionParameters`
    :rtype: ``str``
    """
...
def xpp(engine, oracle_provision_parameters):
    ...
    :type oracle_provision_parameters:
        :py:class:`v1_8_0.web.vo.OracleProvisionParameters`
    :rtype: ``str``
    """
