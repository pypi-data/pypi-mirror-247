...
Package "fault"
"""
from delphixpy.v1_8_0.web.fault import effect
...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_8_0.web.objects.Fault.Fault` object
    :type ref: ``str``
    :rtype: :py:class:`v1_8_0.web.vo.Fault`
    """
...
def get_all(engine, from_date=None, max_total=None, page_offset=None, page_size=None, severity=None, status=None, target=None, to_date=None):
    ...
    :type to_date: ``str``
    :rtype: ``list`` of :py:class:`v1_8_0.web.vo.Fault`
    """
...
def resolve(engine, ref, fault_resolve_parameters):
    ...
    :type fault_resolve_parameters:
        :py:class:`v1_8_0.web.vo.FaultResolveParameters`
    """
