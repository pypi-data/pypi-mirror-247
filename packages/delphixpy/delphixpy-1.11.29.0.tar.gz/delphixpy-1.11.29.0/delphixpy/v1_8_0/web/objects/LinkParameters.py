...
class LinkParameters(TypedObject):
    """
    *(extends* :py:class:`v1_8_0.web.vo.TypedObject` *)* Represents the
    ...
    def is_dirty(self):
        return any([self._description[1], self._group[1], self._link_data[1], self._name[1]])
    ...
    def link_data(self):
        ...
        :rtype: :py:class:`v1_8_0.web.vo.LinkData`
        """
