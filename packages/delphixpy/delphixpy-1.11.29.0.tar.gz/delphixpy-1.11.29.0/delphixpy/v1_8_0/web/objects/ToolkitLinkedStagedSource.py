...
from delphixpy.v1_8_0.web.objects.ToolkitLinkedSource import ToolkitLinkedSource
...
class ToolkitLinkedStagedSource(ToolkitLinkedSource):
    """
    *(extends* :py:class:`v1_8_0.web.vo.ToolkitLinkedSource` *)* A linked
    ...
    def is_dirty(self):
        return any([self._resync[1], self._start_staging[1], self._status[1], self._stop_staging[1], self._worker[1]])
