...
class Transformation(UserObject):
    """
    *(extends* :py:class:`v1_8_0.web.vo.UserObject` *)* A data platform
    ...
    def is_dirty(self):
        return any([self._container[1], self._environment_user[1], self._operations[1], self._platform_params[1], self._repository[1]])
    ...
    def __eq__(self, other):
        ...
        return super().__eq__(other) and \
               ...
               self.platform_params == other.platform_params and \
    ...
    def platform_params(self):
        ...
        :rtype: :py:class:`v1_8_0.web.vo.BasePlatformParameters`
        """
