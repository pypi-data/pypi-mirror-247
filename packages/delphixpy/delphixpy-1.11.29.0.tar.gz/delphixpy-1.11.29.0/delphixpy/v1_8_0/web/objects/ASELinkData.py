...
class ASELinkData(LinkData):
    """
    *(extends* :py:class:`v1_8_0.web.vo.LinkData` *)* SAP ASE specific
    ...
    def load_location(self):
        ...
        :rtype: :py:class:`v1_8_0.web.vo.ASEBackupLocation`
        """
    ...
    def sync_parameters(self):
        ...
        :rtype: :py:class:`v1_8_0.web.vo.ASESyncParameters`
        """
