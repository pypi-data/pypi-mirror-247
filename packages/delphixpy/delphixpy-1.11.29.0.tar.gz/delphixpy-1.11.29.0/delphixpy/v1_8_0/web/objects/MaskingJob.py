...
class MaskingJob(UserObject):
    """
    *(extends* :py:class:`v1_8_0.web.vo.UserObject` *)* The Delphix Engine
    ...
    def is_dirty(self):
        return any([self._application_id[1], self._associated_container[1], self._masking_job_id[1], self._name[1]])
