...
from delphixpy.v1_8_0.web.objects.TimeflowSnapshot import TimeflowSnapshot
...
class ASESnapshot(TimeflowSnapshot):
    """
    *(extends* :py:class:`v1_8_0.web.vo.TimeflowSnapshot` *)* Provisionable
    ...
    def first_change_point(self):
        ...
        :rtype: :py:class:`v1_8_0.web.vo.ASETimeflowPoint`
        """
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_8_0.web.vo.ASESnapshotRuntime`
        """
