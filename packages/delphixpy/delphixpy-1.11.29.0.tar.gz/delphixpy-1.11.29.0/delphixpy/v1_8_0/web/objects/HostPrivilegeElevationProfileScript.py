...
class HostPrivilegeElevationProfileScript(PersistentObject):
    """
    *(extends* :py:class:`v1_8_0.web.vo.PersistentObject` *)* A script that is
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._contents[0] is not None and obj._contents[0] is not obj.__undef__:
            assert isinstance(obj._contents[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._contents[0], type(obj._contents[0])))
        ...
        if obj._profile[0] is not None and obj._profile[0] is not obj.__undef__:
            assert isinstance(obj._profile[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._profile[0], type(obj._profile[0])))
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        def dictify(obj, prop_is_list_or_vo=False):
            if isinstance(obj, list):
                ...
                return obj
        if "contents" == "type" or (self.contents is not self.__undef__ and (not (dirty and not self._contents[1]) or self.is_dirty_list(self.contents, self._contents) or belongs_to_parent)):
        ...
        if "profile" == "type" or (self.profile is not self.__undef__ and (not (dirty and not self._profile[1]) or self.is_dirty_list(self.profile, self._profile) or belongs_to_parent)):
    ...
    def is_dirty(self):
        return any([self._contents[1], self._name[1], self._profile[1]])
