...
from delphixpy.v1_8_0.web.objects.Container import Container
...
class VMwareContainer(Container):
    """
    *(extends* :py:class:`v1_8_0.web.vo.Container` *)* Data container for
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_8_0.web.vo.VMwareContainerRuntime`
        """
