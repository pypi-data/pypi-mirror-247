...
class MySQLInstall(SourceRepository):
    """
    *(extends* :py:class:`v1_8_0.web.vo.SourceRepository` *)* A MySQL
    installation.
    """
    ...
    def is_dirty(self):
        return any([self._discovered[1], self._installation_path[1], self._internal_version[1], self._version[1]])
