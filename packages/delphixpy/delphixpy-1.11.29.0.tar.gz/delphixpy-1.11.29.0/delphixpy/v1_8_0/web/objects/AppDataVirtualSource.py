...
from delphixpy.v1_8_0.web.objects.AppDataManagedSource import AppDataManagedSource
...
class AppDataVirtualSource(AppDataManagedSource):
    """
    *(extends* :py:class:`v1_8_0.web.vo.AppDataManagedSource` *)* A virtual
    AppData source.
    """
    ...
    def is_dirty(self):
        return any([self._additional_mount_points[1], self._allow_auto_vdb_restart_on_host_reboot[1], self._operations[1], self._parameters[1]])
    ...
    def additional_mount_points(self):
        ...
        :rtype: ``list`` of
            :py:class:`v1_8_0.web.vo.AppDataAdditionalMountPoint`
        """
    ...
    def parameters(self):
        ...
        :rtype: :py:class:`v1_8_0.web.vo.Json`
        """
