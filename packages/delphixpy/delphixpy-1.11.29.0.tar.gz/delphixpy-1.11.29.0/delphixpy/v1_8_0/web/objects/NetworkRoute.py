...
class NetworkRoute(TypedObject):
    """
    *(extends* :py:class:`v1_8_0.web.vo.TypedObject` *)* IP routing table.
    """
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._data_node[0] is not None and obj._data_node[0] is not obj.__undef__:
            assert isinstance(obj._data_node[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._data_node[0], type(obj._data_node[0])))
        ...
        if obj._gateway[0] is not None and obj._gateway[0] is not obj.__undef__:
            assert isinstance(obj._gateway[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._gateway[0], type(obj._gateway[0])))
        ...
        if obj._out_interface[0] is not None and obj._out_interface[0] is not obj.__undef__:
            assert isinstance(obj._out_interface[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._out_interface[0], type(obj._out_interface[0])))
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        def dictify(obj, prop_is_list_or_vo=False):
            if isinstance(obj, list):
                ...
                return obj
        if "data_node" == "type" or (self.data_node is not self.__undef__ and (not (dirty and not self._data_node[1]) or self.is_dirty_list(self.data_node, self._data_node) or belongs_to_parent)):
        ...
        if "gateway" == "type" or (self.gateway is not self.__undef__ and (not (dirty and not self._gateway[1]) or self.is_dirty_list(self.gateway, self._gateway) or belongs_to_parent)):
            dct["gateway"] = dictify(self.gateway)
        if "out_interface" == "type" or (self.out_interface is not self.__undef__ and (not (dirty and not self._out_interface[1]) or self.is_dirty_list(self.out_interface, self._out_interface) or belongs_to_parent)):
    ...
    def is_dirty(self):
        return any([self._data_node[1], self._destination[1], self._gateway[1], self._out_interface[1]])
