...
class JSOperation(NamedUserObject):
    """
    *(extends* :py:class:`v1_8_0.web.vo.NamedUserObject` *)* An operation that
    ...
    def is_dirty(self):
        return any([self._bookmark[1], self._branch[1], self._data_layout[1], self._data_parent[1], self._data_time[1], self._description[1], self._end_time[1], self._operation[1], self._root_action[1], self._start_time[1], self._user[1]])
    ...
    def data_parent(self):
        ...
        :rtype: :py:class:`v1_8_0.web.vo.JSDataParent`
        """
