...
from delphixpy.v1_8_0.web.objects.TimeflowPointParameters import TimeflowPointParameters
...
class TimeflowPointSnapshot(TimeflowPointParameters):
    """
    *(extends* :py:class:`v1_8_0.web.vo.TimeflowPointParameters` *)* TimeFlow
