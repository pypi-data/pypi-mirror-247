...
from delphixpy.v1_8_0.web.objects.UserObject import UserObject
...
class NetworkInterface(UserObject):
    """
    *(extends* :py:class:`v1_8_0.web.vo.UserObject` *)* Configuration of an IP
    interface.
    """
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._mac_address[0] is not None and obj._mac_address[0] is not obj.__undef__:
            assert isinstance(obj._mac_address[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._mac_address[0], type(obj._mac_address[0])))
        ...
        if obj._mtu_range[0] is not None and obj._mtu_range[0] is not obj.__undef__:
            assert isinstance(obj._mtu_range[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._mtu_range[0], type(obj._mtu_range[0])))
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "mtu" == "type" or (self.mtu is not self.__undef__ and (not (dirty and not self._mtu[1]) or self.is_dirty_list(self.mtu, self._mtu) or belongs_to_parent)):
    ...
    def is_dirty(self):
        return any([self._addresses[1], self._data_node[1], self._device[1], self._mac_address[1], self._mtu[1], self._mtu_range[1], self._state[1]])
    ...
    def addresses(self):
        ...
        :rtype: ``list`` of :py:class:`v1_8_0.web.vo.InterfaceAddress`
        """
