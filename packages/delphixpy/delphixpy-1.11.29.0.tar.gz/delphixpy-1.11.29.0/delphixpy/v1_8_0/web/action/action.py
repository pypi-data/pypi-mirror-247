...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_8_0.web.objects.Action.Action` object
    :type ref: ``str``
    :rtype: :py:class:`v1_8_0.web.vo.Action`
    """
...
def get_all(engine, ascending=None, from_date=None, page_offset=None, page_size=None, parent_action=None, root_action_only=None, search_text=None, sort_by=None, state=None, to_date=None, user=None):
    ...
    :type user: ``str``
    :rtype: ``list`` of :py:class:`v1_8_0.web.vo.Action`
    """
...
def get_job(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_8_0.web.objects.Action.Action` object
    :type ref: ``str``
    :rtype: :py:class:`v1_8_0.web.vo.Job`
    """
