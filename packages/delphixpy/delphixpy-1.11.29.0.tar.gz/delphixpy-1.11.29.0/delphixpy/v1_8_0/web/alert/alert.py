...
Package "alert"
"""
from delphixpy.v1_8_0.web.alert import profile
...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_8_0.web.objects.Alert.Alert` object
    :type ref: ``str``
    :rtype: :py:class:`v1_8_0.web.vo.Alert`
    """
...
def get_all(engine, ascending=None, from_date=None, max_total=None, page_offset=None, page_size=None, search_text=None, sort_by=None, target=None, to_date=None):
    """
    ...
    :type to_date: ``str``
    :rtype: ``list`` of :py:class:`v1_8_0.web.vo.Alert`
    """
    url = "/resources/json/delphix/alert"
    query_params = {"ascending": ascending, "fromDate": from_date, "maxTotal": max_total, "pageOffset": page_offset, "pageSize": page_size, "searchText": search_text, "sortBy": sort_by, "target": target, "toDate": to_date}
