...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_4_1.web.objects.AppDataToolkit.AppDataToolkit`
        object
    :type ref: ``str``
    :rtype: :py:class:`v1_4_1.web.vo.AppDataToolkit`
    """
...
def get_all(engine):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_4_1.delphix_engine.DelphixEngine`
    :rtype: ``list`` of :py:class:`v1_4_1.web.vo.AppDataToolkit`
    """
