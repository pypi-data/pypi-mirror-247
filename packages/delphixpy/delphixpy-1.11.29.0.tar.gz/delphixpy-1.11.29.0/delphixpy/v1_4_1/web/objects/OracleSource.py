...
from delphixpy.v1_4_1.web.objects.Source import Source
...
class OracleSource(Source):
    """
    *(extends* :py:class:`v1_4_1.web.vo.Source` *)* An Oracle source
    """
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._role[0] is not None and obj._role[0] is not obj.__undef__:
            ...
            assert obj._role[0] in ['PHYSICAL_STANDBY', 'PRIMARY', 'UNKNOWN'], "Expected enum ['PHYSICAL_STANDBY', 'PRIMARY', 'UNKNOWN'] but got %s" % obj._role[0]
    ...
    def is_dirty(self):
        return any([self._role[1], self._runtime[1]])
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_4_1.web.vo.OracleBaseSourceRuntime`
        """
