...
class MSSqlClusterInstance(TypedObject):
    """
    *(extends* :py:class:`v1_4_1.web.vo.TypedObject` *)* The representation of
    ...
    def is_dirty(self):
        return any([self._instance_owner[1], self._name[1], self._node[1], self._port[1], self._server_name[1], self._version[1]])
