...
from delphixpy.v1_4_1.web.objects.OracleBaseSourceRuntime import OracleBaseSourceRuntime
...
class OracleSourceRuntime(OracleBaseSourceRuntime):
    """
    *(extends* :py:class:`v1_4_1.web.vo.OracleBaseSourceRuntime` *)* Runtime
