...
from delphixpy.v1_4_1.web.objects.PublicSystemInfo import PublicSystemInfo
...
class SystemInfo(PublicSystemInfo):
    """
    *(extends* :py:class:`v1_4_1.web.vo.PublicSystemInfo` *)* Retrieve system-
    ...
    def processors(self):
        ...
        :rtype: ``list`` of :py:class:`v1_4_1.web.vo.CPUInfo`
        """
