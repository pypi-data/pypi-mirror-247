...
class PgSQLVirtualSource(PgSQLSource):
    """
    *(extends* :py:class:`v1_4_1.web.vo.PgSQLSource` *)* A virtual PostgreSQL
    source.
    """
    ...
    def hba_entries(self):
        ...
        :rtype: ``list`` of :py:class:`v1_4_1.web.vo.PgSQLHBAEntry`
        """
    ...
    def ident_entries(self):
        ...
        :rtype: ``list`` of :py:class:`v1_4_1.web.vo.PgSQLIdentEntry`
        """
