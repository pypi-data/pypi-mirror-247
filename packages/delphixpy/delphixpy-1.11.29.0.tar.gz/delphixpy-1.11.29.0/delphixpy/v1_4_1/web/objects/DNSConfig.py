...
class DNSConfig(TypedObject):
    """
    *(extends* :py:class:`v1_4_1.web.vo.TypedObject` *)* DNS Client
    Configuration.
    """
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._domain[0] is not None and obj._domain[0] is not obj.__undef__:
            assert isinstance(obj._domain[0], str), ("Expected one of ['string', 'null'], but got %s of type %s" % (obj._domain[0], type(obj._domain[0])))
