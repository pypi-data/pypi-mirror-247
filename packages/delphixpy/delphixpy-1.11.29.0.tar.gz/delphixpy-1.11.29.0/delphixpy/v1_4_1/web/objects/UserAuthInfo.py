...
class UserAuthInfo(TypedObject):
    """
    *(extends* :py:class:`v1_4_1.web.vo.TypedObject` *)* Summary authorization
    information about the current user.
    """
    def __init__(self, undef_enabled=True):
        super().__init__()
        self._type = ("UserAuthInfo", True)
        self._auditor_role = (self.__undef__, True)
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        obj._auditor_role = (data.get("auditorRole", obj.__undef__), dirty)
        if obj._auditor_role[0] is not None and obj._auditor_role[0] is not obj.__undef__:
            assert isinstance(obj._auditor_role[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._auditor_role[0], type(obj._auditor_role[0])))
            common.validate_format(obj._auditor_role[0], "objectReference", None, None)
        obj._authorizations = []
        ...
        if obj._jet_stream_user_role[0] is not None and obj._jet_stream_user_role[0] is not obj.__undef__:
            assert isinstance(obj._jet_stream_user_role[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._jet_stream_user_role[0], type(obj._jet_stream_user_role[0])))
        ...
        if obj._owner_role[0] is not None and obj._owner_role[0] is not obj.__undef__:
            assert isinstance(obj._owner_role[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._owner_role[0], type(obj._owner_role[0])))
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        def dictify(obj, prop_is_list_or_vo=False):
            if isinstance(obj, list):
                ...
                return obj
        if "auditor_role" == "type" or (self.auditor_role is not self.__undef__ and (not (dirty and not self._auditor_role[1]))):
            dct["auditorRole"] = dictify(self.auditor_role)
    ...
    def force_dirty(self):
        self._auditor_role = (self._auditor_role[0], True)
    ...
    def is_dirty(self):
        return any([self._auditor_role[1], self._authorizations[1], self._jet_stream_user_role[1], self._owner_role[1], self._user[1]])
    ...
    def __eq__(self, other):
        ...
        return super().__eq__(other) and \
               self.auditor_role == other.auditor_role and \
    ...
    @property
    def auditor_role(self):
        """
        A reference to the system-defined auditor role.

        :rtype: ``str``
        """
        return self._auditor_role[0]

    @auditor_role.setter
    def auditor_role(self, value):
        self._auditor_role = (value, True)
