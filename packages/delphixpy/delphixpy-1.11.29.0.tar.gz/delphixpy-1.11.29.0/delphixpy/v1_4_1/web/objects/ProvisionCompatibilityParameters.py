...
from delphixpy.v1_4_1.web.objects.CompatibleRepositoriesParameters import CompatibleRepositoriesParameters
...
class ProvisionCompatibilityParameters(CompatibleRepositoriesParameters):
    """
    *(extends* :py:class:`v1_4_1.web.vo.CompatibleRepositoriesParameters` *)*
