...
from delphixpy.v1_4_1.web.objects.JSDataLayoutCreateParameters import JSDataLayoutCreateParameters
...
class JSDataTemplateCreateParameters(JSDataLayoutCreateParameters):
    """
    *(extends* :py:class:`v1_4_1.web.vo.JSDataLayoutCreateParameters` *)* The
