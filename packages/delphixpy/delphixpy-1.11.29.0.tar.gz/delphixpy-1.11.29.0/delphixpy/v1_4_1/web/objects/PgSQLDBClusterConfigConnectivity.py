...
from delphixpy.v1_4_1.web.objects.SourceConfigConnectivity import SourceConfigConnectivity
...
class PgSQLDBClusterConfigConnectivity(SourceConfigConnectivity):
    """
    *(extends* :py:class:`v1_4_1.web.vo.SourceConfigConnectivity` *)* Mechanism
