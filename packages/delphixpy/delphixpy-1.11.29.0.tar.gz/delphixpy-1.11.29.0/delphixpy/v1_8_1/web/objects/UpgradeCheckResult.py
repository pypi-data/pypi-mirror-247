    ...
    *(extends* :py:class:`v1_8_1.web.vo.NamedUserObject` *)* Describes
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._severity[0] is not None and obj._severity[0] is not obj.__undef__:
            ...
            assert obj._severity[0] in ['WARNING', 'CRITICAL'], "Expected enum ['WARNING', 'CRITICAL'] but got %s" % obj._severity[0]
    ...
    def is_dirty(self):
        return any([self._action[1], self._description[1], self._severity[1], self._status[1], self._title[1], self._version[1]])
