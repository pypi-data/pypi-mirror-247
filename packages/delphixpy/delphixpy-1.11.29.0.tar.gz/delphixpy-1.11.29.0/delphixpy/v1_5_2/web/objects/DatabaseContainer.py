...
from delphixpy.v1_5_2.web.objects.Container import Container
...
class DatabaseContainer(Container):
    """
    *(extends* :py:class:`v1_5_2.web.vo.Container` *)* A container holding
    database data.
    """
    ...
    def is_dirty(self):
        return any([self._masked[1], self._os[1], self._performance_mode[1], self._processor[1], self._sourcing_policy[1]])
