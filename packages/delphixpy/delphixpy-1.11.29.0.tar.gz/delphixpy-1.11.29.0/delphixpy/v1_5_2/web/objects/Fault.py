...
class Fault(PersistentObject):
    """
    *(extends* :py:class:`v1_5_2.web.vo.PersistentObject` *)* A representation
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._date_resolved[0] is not None and obj._date_resolved[0] is not obj.__undef__:
            assert isinstance(obj._date_resolved[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._date_resolved[0], type(obj._date_resolved[0])))
        ...
        if obj._resolution_comments[0] is not None and obj._resolution_comments[0] is not obj.__undef__:
            assert isinstance(obj._resolution_comments[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._resolution_comments[0], type(obj._resolution_comments[0])))
        ...
        if obj._status[0] is not None and obj._status[0] is not obj.__undef__:
            ...
            assert obj._status[0] in ['ACTIVE', 'RESOLVED'], "Expected enum ['ACTIVE', 'RESOLVED'] but got %s" % obj._status[0]
    ...
    def is_dirty(self):
        return any([self._action[1], self._bundle_id[1], self._date_diagnosed[1], self._date_resolved[1], self._description[1], self._resolution_comments[1], self._response[1], self._severity[1], self._status[1], self._target[1], self._target_name[1], self._target_object_type[1], self._title[1]])
