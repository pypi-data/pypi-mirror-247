...
class AppDataSnapshot(TimeflowSnapshot):
    """
    *(extends* :py:class:`v1_5_2.web.vo.TimeflowSnapshot` *)* Snapshot of an
    AppData TimeFlow.
    """
    ...
    def is_dirty(self):
        return any([self._first_change_point[1], self._latest_change_point[1], self._runtime[1]])
    ...
    def first_change_point(self):
        ...
        :rtype: :py:class:`v1_5_2.web.vo.AppDataTimeflowPoint`
        """
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_5_2.web.vo.AppDataSnapshotRuntime`
        """
