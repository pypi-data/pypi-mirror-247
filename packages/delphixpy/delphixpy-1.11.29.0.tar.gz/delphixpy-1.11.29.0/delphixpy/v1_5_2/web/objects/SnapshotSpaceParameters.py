...
class SnapshotSpaceParameters(TypedObject):
    """
    *(extends* :py:class:`v1_5_2.web.vo.TypedObject` *)* Input to the operation
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        def dictify(obj, prop_is_list_or_vo=False):
            if isinstance(obj, list):
                ...
                return obj
        if "object_references" == "type" or (self.object_references is not self.__undef__ and (not (dirty and not self._object_references[1]) or self.is_dirty_list(self.object_references, self._object_references) or belongs_to_parent)):
