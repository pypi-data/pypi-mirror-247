...
from delphixpy.v1_5_2.web.objects.DynamicParameter import DynamicParameter
...
class DynamicEnumParameter(DynamicParameter):
    """
    *(extends* :py:class:`v1_5_2.web.vo.DynamicParameter` *)* A dynamic
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        def dictify(obj, prop_is_list_or_vo=False):
            if isinstance(obj, list):
                ...
                return obj
        if "enum_values" == "type" or (self.enum_values is not self.__undef__ and (not (dirty and not self._enum_values[1]) or self.is_dirty_list(self.enum_values, self._enum_values) or belongs_to_parent)):
            dct["enumValues"] = dictify(self.enum_values, prop_is_list_or_vo=True)
        return dct
