...
from delphixpy.v1_5_2.web.objects.SourceConfigConnectivity import SourceConfigConnectivity
...
class PgSQLDBClusterConfigConnectivity(SourceConfigConnectivity):
    """
    *(extends* :py:class:`v1_5_2.web.vo.SourceConfigConnectivity` *)* Mechanism
