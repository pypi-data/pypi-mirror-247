...
from delphixpy.v1_11_11.web.objects.NetworkThroughputTestBase import NetworkThroughputTestBase
...
class NetworkThroughputTest(NetworkThroughputTestBase):
    """
    *(extends* :py:class:`v1_11_11.web.vo.NetworkThroughputTestBase` *)* Bi-
    ...
    def parameters(self):
        ...
        :rtype: :py:class:`v1_11_11.web.vo.NetworkThroughputTestParameters`
        """
