...
class UserInterfaceConfig(TypedObject):
    """
    *(extends* :py:class:`v1_11_11.web.vo.TypedObject` *)* User Interface
    Configuration.
    """
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        def dictify(obj, prop_is_list_or_vo=False):
            if isinstance(obj, list):
                ...
                return obj
        if "analytics_enabled" == "type" or (self.analytics_enabled is not self.__undef__ and (not (dirty and not self._analytics_enabled[1]) or self.is_dirty_list(self.analytics_enabled, self._analytics_enabled) or belongs_to_parent)):
