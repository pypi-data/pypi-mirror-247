    ...
    *(extends* :py:class:`v1_11_11.web.vo.ProvisionParameters` *)* The
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if "sourceConfig" in data and data["sourceConfig"] is not None:
            obj._source_config = (factory.create_object(data["sourceConfig"], "AppDataDirectSourceConfig"), dirty)
            factory.validate_type(obj._source_config[0], "AppDataDirectSourceConfig")
        else:
    ...
    def container(self):
        ...
        :rtype: :py:class:`v1_11_11.web.vo.AppDataContainer`
        """
    ...
    def source(self):
        ...
        :rtype: :py:class:`v1_11_11.web.vo.AppDataVirtualSource`
        """
    ...
    def source_config(self):
        ...
        :rtype: :py:class:`v1_11_11.web.vo.AppDataDirectSourceConfig`
        """
