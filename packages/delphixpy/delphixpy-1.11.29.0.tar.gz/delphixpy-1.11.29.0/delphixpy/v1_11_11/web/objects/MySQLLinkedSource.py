...
from delphixpy.v1_11_11.web.objects.MySQLSource import MySQLSource
...
class MySQLLinkedSource(MySQLSource):
    """
    *(extends* :py:class:`v1_11_11.web.vo.MySQLSource` *)* A linked MySQL
    source.
    """
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_11_11.web.vo.MySQLSourceRuntime`
        """
