...
def create(engine, network_route=None):
    ...
    :type network_route: :py:class:`v1_11_11.web.vo.NetworkRoute`
    :rtype: ``str``
    """
...
def get_all(engine):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_11_11.delphix_engine.DelphixEngine`
    :rtype: ``list`` of :py:class:`v1_11_11.web.vo.NetworkRoute`
    """
    url = "/resources/json/delphix/network/route"
...
def lookup(engine, network_route_lookup_parameters):
    ...
    :type network_route_lookup_parameters:
        :py:class:`v1_11_11.web.vo.NetworkRouteLookupParameters`
    :rtype: :py:class:`v1_11_11.web.vo.NetworkRoute`
    """
