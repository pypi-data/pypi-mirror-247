...
from delphixpy.v1_10_2.web.objects.AttachData import AttachData
...
class ASEAttachData(AttachData):
    """
    *(extends* :py:class:`v1_10_2.web.vo.AttachData` *)* Represents the SAP ASE
