...
from delphixpy.v1_10_2.web.objects.AbstractSourceConfigConnectivity import AbstractSourceConfigConnectivity
...
class OracleDBConfigConnectivity(AbstractSourceConfigConnectivity):
    """
    *(extends* :py:class:`v1_10_2.web.vo.AbstractSourceConfigConnectivity` *)*
