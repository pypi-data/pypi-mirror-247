...
from delphixpy.v1_10_2.web.objects.OracleFileSpecification import OracleFileSpecification
...
class OracleDatafileTempfileSpecification(OracleFileSpecification):
    """
    *(extends* :py:class:`v1_10_2.web.vo.OracleFileSpecification` *)* Describes
