...
from delphixpy.v1_10_2.web.objects.MySQLExistingBackupSyncParameters import MySQLExistingBackupSyncParameters
...
class MySQLXtraBackupSyncParameters(MySQLExistingBackupSyncParameters):
    """
    *(extends* :py:class:`v1_10_2.web.vo.MySQLExistingBackupSyncParameters` *)*
