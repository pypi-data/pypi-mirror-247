...
from delphixpy.v1_10_2.web.objects.DatabaseContainer import DatabaseContainer
...
class OracleDatabaseContainer(DatabaseContainer):
    """
    *(extends* :py:class:`v1_10_2.web.vo.DatabaseContainer` *)* Data container
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_10_2.web.vo.OracleDBContainerRuntime`
        """
