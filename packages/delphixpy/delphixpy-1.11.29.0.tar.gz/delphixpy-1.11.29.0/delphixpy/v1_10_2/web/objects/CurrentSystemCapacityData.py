...
from delphixpy.v1_10_2.web.objects.BaseSystemCapacityData import BaseSystemCapacityData
...
class CurrentSystemCapacityData(BaseSystemCapacityData):
    """
    *(extends* :py:class:`v1_10_2.web.vo.BaseSystemCapacityData` *)* Capacity
