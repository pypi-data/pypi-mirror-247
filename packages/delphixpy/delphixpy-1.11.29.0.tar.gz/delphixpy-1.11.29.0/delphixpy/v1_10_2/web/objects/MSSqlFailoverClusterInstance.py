...
from delphixpy.v1_10_2.web.objects.MSSqlBaseClusterInstance import MSSqlBaseClusterInstance
...
class MSSqlFailoverClusterInstance(MSSqlBaseClusterInstance):
    """
    *(extends* :py:class:`v1_10_2.web.vo.MSSqlBaseClusterInstance` *)* The
