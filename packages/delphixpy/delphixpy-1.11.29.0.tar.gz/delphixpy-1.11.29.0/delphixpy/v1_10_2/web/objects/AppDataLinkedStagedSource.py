...
from delphixpy.v1_10_2.web.objects.AppDataLinkedSource import AppDataLinkedSource
...
class AppDataLinkedStagedSource(AppDataLinkedSource):
    """
    *(extends* :py:class:`v1_10_2.web.vo.AppDataLinkedSource` *)* An AppData
    ...
    def is_dirty(self):
        return any([self._staging_mount_base[1], self._staging_environment[1], self._staging_environment_user[1]])
