...
from delphixpy.v1_11_13.web.objects.DatabaseContainer import DatabaseContainer
...
class OracleDatabaseContainer(DatabaseContainer):
    """
    *(extends* :py:class:`v1_11_13.web.vo.DatabaseContainer` *)* Data container
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_11_13.web.vo.OracleDBContainerRuntime`
        """
