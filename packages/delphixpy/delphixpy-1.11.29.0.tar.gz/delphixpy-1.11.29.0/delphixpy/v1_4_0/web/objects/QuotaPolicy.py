...
class QuotaPolicy(Policy):
    """
    *(extends* :py:class:`v1_4_0.web.vo.Policy` *)* This policy limits the
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._crit_threshold[0] is not None and obj._crit_threshold[0] is not obj.__undef__:
            assert isinstance(obj._crit_threshold[0], int), ("Expected one of ['integer'], but got %s of type %s" % (obj._crit_threshold[0], type(obj._crit_threshold[0])))
        ...
        if obj._warn_threshold[0] is not None and obj._warn_threshold[0] is not obj.__undef__:
            assert isinstance(obj._warn_threshold[0], int), ("Expected one of ['integer'], but got %s of type %s" % (obj._warn_threshold[0], type(obj._warn_threshold[0])))
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "crit_threshold" == "type" or (self.crit_threshold is not self.__undef__ and (not (dirty and not self._crit_threshold[1]) or self.is_dirty_list(self.crit_threshold, self._crit_threshold) or belongs_to_parent)):
            dct["critThreshold"] = dictify(self.crit_threshold)
        elif belongs_to_parent and self.crit_threshold is self.__undef__:
            dct["critThreshold"] = 90
        ...
        if "warn_threshold" == "type" or (self.warn_threshold is not self.__undef__ and (not (dirty and not self._warn_threshold[1]) or self.is_dirty_list(self.warn_threshold, self._warn_threshold) or belongs_to_parent)):
            dct["warnThreshold"] = dictify(self.warn_threshold)
        elif belongs_to_parent and self.warn_threshold is self.__undef__:
            dct["warnThreshold"] = 80
        return dct
    ...
    def is_dirty(self):
        return any([self._crit_alert_time[1], self._crit_threshold[1], self._size[1], self._warn_alert_time[1], self._warn_threshold[1]])
