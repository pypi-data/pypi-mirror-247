...
class OracleBaseSourceRuntime(SourceRuntime):
    """
    *(extends* :py:class:`v1_4_0.web.vo.SourceRuntime` *)* Runtime (non-
    ...
    def active_instances(self):
        ...
        :rtype: ``list`` of :py:class:`v1_4_0.web.vo.OracleActiveInstance`
        """
    ...
    def database_stats(self):
        ...
        :rtype: ``list`` of
            :py:class:`v1_4_0.web.vo.OracleDatabaseStatsSection`
        """
