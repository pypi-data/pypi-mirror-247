...
class AppDataVirtualSource(AppDataSource):
    """
    *(extends* :py:class:`v1_4_0.web.vo.AppDataSource` *)* A virtual AppData
    source
    """
    ...
    def additional_mount_points(self):
        ...
        :rtype: ``list`` of
            :py:class:`v1_4_0.web.vo.AppDataAdditionalMountPoint`
        """
    ...
    def parameters(self):
        ...
        :rtype: ``list`` of :py:class:`v1_4_0.web.vo.DynamicParameterValue`
        """
