...
class SourceRuntime(TypedObject):
    """
    *(extends* :py:class:`v1_4_0.web.vo.TypedObject` *)* Runtime properties of
    ...
    def is_dirty(self):
        return any([self._accessible[1], self._database_size[1], self._not_accessible_reason[1], self._status[1]])
