    ...
    *(extends* :py:class:`v1_9_2.web.vo.SourcingPolicy` *)* Database policies
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._logsync_mode[0] is not None and obj._logsync_mode[0] is not obj.__undef__:
            ...
            assert obj._logsync_mode[0] in ['ARCHIVE_ONLY_MODE', 'ARCHIVE_REDO_MODE', 'STAGING_MODE', 'UNDEFINED'], "Expected enum ['ARCHIVE_ONLY_MODE', 'ARCHIVE_REDO_MODE', 'STAGING_MODE', 'UNDEFINED'] but got %s" % obj._logsync_mode[0]
    ...
    def logsync_mode(self):
        ...
        *(permitted values: ARCHIVE_ONLY_MODE, ARCHIVE_REDO_MODE, STAGING_MODE,
        UNDEFINED)*
