...
class ASELinkedSource(ASESource):
    """
    *(extends* :py:class:`v1_9_2.web.vo.ASESource` *)* A linked SAP ASE source.
    """
    ...
    def load_location(self):
        ...
        :rtype: :py:class:`v1_9_2.web.vo.ASEBackupLocation`
        """
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_9_2.web.vo.ASESourceRuntime`
        """
