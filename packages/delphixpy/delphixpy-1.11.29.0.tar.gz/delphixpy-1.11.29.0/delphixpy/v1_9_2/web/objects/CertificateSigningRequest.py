...
class CertificateSigningRequest(UserObject):
    """
    *(extends* :py:class:`v1_9_2.web.vo.UserObject` *)* Certificate signing
    request (CSR).
    """
    ...
    def is_dirty(self):
        return any([self._name[1], self._end_entity[1], self._key_pair[1], self._request_in_pem[1]])
    ...
    def __eq__(self, other):
        ...
        return super().__eq__(other) and \
               ...
               self.request_in_pem == other.request_in_pem
    ...
    def end_entity(self):
        ...
        :rtype: :py:class:`v1_9_2.web.vo.EndEntity`
        """
    ...
    def key_pair(self):
        ...
        :rtype: :py:class:`v1_9_2.web.vo.KeyPair`
        """
