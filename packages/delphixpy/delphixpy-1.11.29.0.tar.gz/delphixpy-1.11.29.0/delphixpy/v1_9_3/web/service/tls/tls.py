...
Package "service.tls"
"""
from delphixpy.v1_9_3.web.service.tls import csr
from delphixpy.v1_9_3.web.service.tls import caCertificate
from delphixpy.v1_9_3.web.service.tls import endEntityCertificate
...
def get(engine):
    ...
    :rtype: :py:class:`v1_9_3.web.vo.CertificateConfig`
    """
...
def set(engine, certificate_config=None):
    ...
    :type certificate_config: :py:class:`v1_9_3.web.vo.CertificateConfig`
    """
    url = "/resources/json/delphix/service/tls"
