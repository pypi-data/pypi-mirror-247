...
from delphixpy.v1_9_3.web.objects.OracleSource import OracleSource
...
class OracleVirtualSource(OracleSource):
    """
    *(extends* :py:class:`v1_9_3.web.vo.OracleSource` *)* A virtual Oracle
    source.
    """
    ...
    def is_dirty(self):
        return any([self._operations[1], self._mount_base[1], self._file_mapping_rules[1], self._config_params[1], self._config_template[1], self._node_listeners[1], self._redo_log_size_in_mb[1], self._redo_log_groups[1], self._archivelog_mode[1], self._custom_env_vars[1], self._allow_auto_vdb_restart_on_host_reboot[1]])
    ...
    def operations(self):
        ...
        :rtype: :py:class:`v1_9_3.web.vo.VirtualSourceOperations`
        """
    ...
    def custom_env_vars(self):
        ...
        :rtype: ``list`` of :py:class:`v1_9_3.web.vo.OracleCustomEnvVar`
        """
