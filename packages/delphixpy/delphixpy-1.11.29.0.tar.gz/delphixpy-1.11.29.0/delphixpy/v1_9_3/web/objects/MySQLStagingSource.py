...
from delphixpy.v1_9_3.web.objects.MySQLSource import MySQLSource
...
class MySQLStagingSource(MySQLSource):
    """
    *(extends* :py:class:`v1_9_3.web.vo.MySQLSource` *)* A MySQL staging source
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_9_3.web.vo.MySQLSourceRuntime`
        """
