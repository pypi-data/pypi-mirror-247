...
class ASELinkData(LinkData):
    """
    *(extends* :py:class:`v1_9_3.web.vo.LinkData` *)* SAP ASE specific
    ...
    def load_location(self):
        ...
        :rtype: :py:class:`v1_9_3.web.vo.ASEBackupLocation`
        """
    ...
    def db_credentials(self):
        ...
        :rtype: :py:class:`v1_9_3.web.vo.Credential`
        """
    ...
    def sync_parameters(self):
        ...
        :rtype: :py:class:`v1_9_3.web.vo.ASESyncParameters`
        """
