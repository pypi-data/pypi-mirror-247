...
from delphixpy.v1_9_3.web.objects.OracleBaseProvisionParameters import OracleBaseProvisionParameters
...
class OracleMultitenantProvisionParameters(OracleBaseProvisionParameters):
    """
    *(extends* :py:class:`v1_9_3.web.vo.OracleBaseProvisionParameters` *)* The
    ...
    def source_config(self):
        ...
        :rtype: :py:class:`v1_9_3.web.vo.OraclePDBConfig`
        """
    ...
    def source(self):
        ...
        :rtype: :py:class:`v1_9_3.web.vo.OracleVirtualPdbSource`
        """
    ...
    def virtual_cdb(self):
        ...
        :rtype: :py:class:`v1_9_3.web.vo.OracleVirtualCdbProvisionParameters`
        """
