...
from delphixpy.v1_9_3.web.objects.StringConstraint import StringConstraint
...
class StringEqualConstraint(StringConstraint):
    """
    *(extends* :py:class:`v1_9_3.web.vo.StringConstraint` *)* Constraint placed
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._equals[0] is not None and obj._equals[0] is not obj.__undef__:
            assert isinstance(obj._equals[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._equals[0], type(obj._equals[0])))
