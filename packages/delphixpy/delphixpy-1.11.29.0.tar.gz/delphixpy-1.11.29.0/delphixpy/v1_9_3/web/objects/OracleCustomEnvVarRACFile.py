...
from delphixpy.v1_9_3.web.objects.OracleCustomEnvVarFile import OracleCustomEnvVarFile
...
class OracleCustomEnvVarRACFile(OracleCustomEnvVarFile):
    """
    *(extends* :py:class:`v1_9_3.web.vo.OracleCustomEnvVarFile` *)* Dictates an
