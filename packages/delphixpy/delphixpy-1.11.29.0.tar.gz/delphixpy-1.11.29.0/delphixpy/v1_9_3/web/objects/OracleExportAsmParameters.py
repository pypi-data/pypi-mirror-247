...
from delphixpy.v1_9_3.web.objects.ExportParameters import ExportParameters
...
class OracleExportAsmParameters(ExportParameters):
    """
    *(extends* :py:class:`v1_9_3.web.vo.ExportParameters` *)* The parameters to
    use as input to export Oracle databases to ASM.
    """
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._data_diskgroup[0] is not None and obj._data_diskgroup[0] is not obj.__undef__:
            assert isinstance(obj._data_diskgroup[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._data_diskgroup[0], type(obj._data_diskgroup[0])))
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "data_diskgroup" == "type" or (self.data_diskgroup is not self.__undef__ and (not (dirty and not self._data_diskgroup[1]) or self.is_dirty_list(self.data_diskgroup, self._data_diskgroup) or belongs_to_parent)):
            dct["dataDiskgroup"] = dictify(self.data_diskgroup)
        if "parallel" == "type" or (self.parallel is not self.__undef__ and (not (dirty and not self._parallel[1]) or self.is_dirty_list(self.parallel, self._parallel) or belongs_to_parent)):
    ...
    def source_config(self):
        ...
        :rtype: :py:class:`v1_9_3.web.vo.OracleDBConfig`
        """
    ...
    def source(self):
        ...
        :rtype: :py:class:`v1_9_3.web.vo.OracleVirtualSource`
        """
