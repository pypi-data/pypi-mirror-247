...
from delphixpy.v1_9_3.web.objects.EndEntityCertificateReplaceParameters import EndEntityCertificateReplaceParameters
...
class EndEntityCertificateReplaceKeystoreParameters(EndEntityCertificateReplaceParameters):
    """
    *(extends* :py:class:`v1_9_3.web.vo.EndEntityCertificateReplaceParameters`
