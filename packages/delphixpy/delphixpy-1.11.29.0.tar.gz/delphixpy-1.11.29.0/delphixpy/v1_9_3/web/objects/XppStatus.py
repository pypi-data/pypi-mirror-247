...
from delphixpy.v1_9_3.web.objects.Checklist import Checklist
...
class XppStatus(Checklist):
    """
    *(extends* :py:class:`v1_9_3.web.vo.Checklist` *)* The current cross-
    ...
    def staging_status(self):
        ...
        :rtype: :py:class:`v1_9_3.web.vo.XppStagingStatus`
        """
    ...
    def target_status(self):
        ...
        :rtype: :py:class:`v1_9_3.web.vo.XppTargetStatus`
        """
    ...
    def validate_status(self):
        ...
        :rtype: :py:class:`v1_9_3.web.vo.XppValidateStatus`
        """
    ...
    def last_run_status(self):
        ...
        :rtype: :py:class:`v1_9_3.web.vo.XppLastRunStatus`
        """
