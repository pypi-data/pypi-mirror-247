...
from delphixpy.v1_9_3.web.objects.CompatibleRepositoriesParameters import CompatibleRepositoriesParameters
...
class XPPCompatibilityParameters(CompatibleRepositoriesParameters):
    """
    *(extends* :py:class:`v1_9_3.web.vo.CompatibleRepositoriesParameters` *)*
