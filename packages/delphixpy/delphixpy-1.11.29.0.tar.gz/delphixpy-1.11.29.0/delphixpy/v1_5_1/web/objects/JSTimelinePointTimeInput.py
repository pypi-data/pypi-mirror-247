...
from delphixpy.v1_5_1.web.objects.JSTimelinePointTimeParameters import JSTimelinePointTimeParameters
...
class JSTimelinePointTimeInput(JSTimelinePointTimeParameters):
    """
    *(extends* :py:class:`v1_5_1.web.vo.JSTimelinePointTimeParameters` *)*
