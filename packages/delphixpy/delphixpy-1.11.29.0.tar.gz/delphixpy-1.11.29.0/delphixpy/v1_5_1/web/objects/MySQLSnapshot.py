...
from delphixpy.v1_5_1.web.objects.TimeflowSnapshot import TimeflowSnapshot
...
class MySQLSnapshot(TimeflowSnapshot):
    """
    *(extends* :py:class:`v1_5_1.web.vo.TimeflowSnapshot` *)* Provisionable
    ...
    def first_change_point(self):
        ...
        :rtype: :py:class:`v1_5_1.web.vo.MySQLTimeflowPoint`
        """
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_5_1.web.vo.MySQLSnapshotRuntime`
        """
