...
class InterfaceAddress(TypedObject):
    """
    *(extends* :py:class:`v1_5_1.web.vo.TypedObject` *)* IP address assigned to
    a network interface.
    """
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._address_type[0] is not None and obj._address_type[0] is not obj.__undef__:
            assert isinstance(obj._address_type[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._address_type[0], type(obj._address_type[0])))
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "address_type" == "type" or (self.address_type is not self.__undef__ and (not (dirty and not self._address_type[1]) or self.is_dirty_list(self.address_type, self._address_type) or belongs_to_parent)):
        ...
        if "enable_ssh" == "type" or (self.enable_ssh is not self.__undef__ and (not (dirty and not self._enable_ssh[1]) or self.is_dirty_list(self.enable_ssh, self._enable_ssh) or belongs_to_parent)):
