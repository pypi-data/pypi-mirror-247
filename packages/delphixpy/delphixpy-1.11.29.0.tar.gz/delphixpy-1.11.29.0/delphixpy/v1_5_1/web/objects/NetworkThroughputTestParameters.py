...
from delphixpy.v1_5_1.web.objects.NetworkThroughputTestBaseParameters import NetworkThroughputTestBaseParameters
...
class NetworkThroughputTestParameters(NetworkThroughputTestBaseParameters):
    """
    *(extends* :py:class:`v1_5_1.web.vo.NetworkThroughputTestBaseParameters`
    *)* Parameters used to execute a network throughput test.
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "receive_socket_buffer" == "type" or (self.receive_socket_buffer is not self.__undef__ and (not (dirty and not self._receive_socket_buffer[1]) or self.is_dirty_list(self.receive_socket_buffer, self._receive_socket_buffer) or belongs_to_parent)):
            ...
            dct["receiveSocketBuffer"] = 4194304
    ...
    def is_dirty(self):
        return any([self._block_size[1], self._port[1], self._receive_socket_buffer[1], self._remote_host[1], self._send_socket_buffer[1]])
    ...
    def port(self):
        """
        *(default value: 50001)* The TCP port number that the server (the
        receiver) will be listening on.
    ...
    def receive_socket_buffer(self):
        """
        *(default value: 4194304)* The size of the receive socket buffer in
        bytes.
