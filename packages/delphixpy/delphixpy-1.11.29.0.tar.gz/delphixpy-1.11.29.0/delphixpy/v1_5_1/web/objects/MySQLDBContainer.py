...
class MySQLDBContainer(DatabaseContainer):
    """
    *(extends* :py:class:`v1_5_1.web.vo.DatabaseContainer` *)* A MySQL Database
    Container.
    """
    def __init__(self, undef_enabled=True):
        super().__init__()
        self._type = ("MySQLDBContainer", True)
    ...
    def __eq__(self, other):
        if other is None:
            return False
        if not isinstance(other, MySQLDBContainer):
            return False
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_5_1.web.vo.MySQLDBContainerRuntime`
        """
