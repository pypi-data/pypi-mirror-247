...
from delphixpy.v1_5_1.web.objects.HostEnvironment import HostEnvironment
...
class UnixHostEnvironment(HostEnvironment):
    """
    *(extends* :py:class:`v1_5_1.web.vo.HostEnvironment` *)* The representation
    ...
    def ase_host_environment_parameters(self):
        ...
        :rtype: :py:class:`v1_5_1.web.vo.ASEHostEnvironmentParameters`
        """
