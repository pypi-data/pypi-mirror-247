...
from delphixpy.v1_5_1.web.objects.VirtualDatasetCreationParameters import VirtualDatasetCreationParameters
...
class ProvisionParameters(VirtualDatasetCreationParameters):
    """
    *(extends* :py:class:`v1_5_1.web.vo.VirtualDatasetCreationParameters` *)*
