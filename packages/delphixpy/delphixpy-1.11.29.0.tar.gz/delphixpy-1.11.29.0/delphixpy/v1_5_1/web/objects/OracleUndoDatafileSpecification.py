...
from delphixpy.v1_5_1.web.objects.OracleDatafileTempfileSpecification import OracleDatafileTempfileSpecification
...
class OracleUndoDatafileSpecification(OracleDatafileTempfileSpecification):
    """
    *(extends* :py:class:`v1_5_1.web.vo.OracleDatafileTempfileSpecification`
