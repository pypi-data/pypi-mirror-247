...
from delphixpy.v1_5_1.web.objects.NetworkTest import NetworkTest
...
class NetworkLatencyTest(NetworkTest):
    """
    *(extends* :py:class:`v1_5_1.web.vo.NetworkTest` *)* Round-trip latency
    ...
    def is_dirty(self):
        return any([self._average[1], self._loss[1], self._maximum[1], self._minimum[1], self._parameters[1], self._stddev[1]])
    ...
    def parameters(self):
        ...
        :rtype: :py:class:`v1_5_1.web.vo.NetworkLatencyTestParameters`
        """
