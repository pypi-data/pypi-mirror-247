...
from delphixpy.v1_5_1.web.objects.TimeflowPointParameters import TimeflowPointParameters
...
class TimeflowPointTimestamp(TimeflowPointParameters):
    """
    *(extends* :py:class:`v1_5_1.web.vo.TimeflowPointParameters` *)* TimeFlow
