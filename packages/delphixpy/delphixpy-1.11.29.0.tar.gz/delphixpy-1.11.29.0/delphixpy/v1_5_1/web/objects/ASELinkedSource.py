...
from delphixpy.v1_5_1.web.objects.ASESource import ASESource
...
class ASELinkedSource(ASESource):
    """
    *(extends* :py:class:`v1_5_1.web.vo.ASESource` *)* A linked SAP ASE source.
    """
    ...
    def monitor_location(self):
        ...
        :rtype: :py:class:`v1_5_1.web.vo.ASEBackupLocation`
        """
    ...
    def operations(self):
        ...
        :rtype: :py:class:`v1_5_1.web.vo.LinkedSourceOperations`
        """
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_5_1.web.vo.ASESourceRuntime`
        """
