...
from delphixpy.v1_5_1.web.objects.ASEDBConfig import ASEDBConfig
...
class ASESIConfig(ASEDBConfig):
    """
    *(extends* :py:class:`v1_5_1.web.vo.ASEDBConfig` *)* A SAP ASE single
    ...
    def instance(self):
        ...
        :rtype: :py:class:`v1_5_1.web.vo.ASEInstanceConfig`
        """
