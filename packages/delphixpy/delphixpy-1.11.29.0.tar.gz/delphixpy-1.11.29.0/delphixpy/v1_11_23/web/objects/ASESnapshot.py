...
class ASESnapshot(TimeflowSnapshot):
    """
    *(extends* :py:class:`v1_11_23.web.vo.TimeflowSnapshot` *)* Provisionable
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_11_23.web.vo.ASESnapshotRuntime`
        """
    ...
    def first_change_point(self):
        ...
        :rtype: :py:class:`v1_11_23.web.vo.ASETimeflowPoint`
        """
