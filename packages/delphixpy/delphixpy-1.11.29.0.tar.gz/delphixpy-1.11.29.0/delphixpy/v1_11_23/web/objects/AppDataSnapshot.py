...
from delphixpy.v1_11_23.web.objects.TimeflowSnapshot import TimeflowSnapshot
...
class AppDataSnapshot(TimeflowSnapshot):
    """
    *(extends* :py:class:`v1_11_23.web.vo.TimeflowSnapshot` *)* Snapshot of an
    AppData TimeFlow.
    """
    ...
    def first_change_point(self):
        ...
        :rtype: :py:class:`v1_11_23.web.vo.AppDataTimeflowPoint`
        """
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_11_23.web.vo.AppDataSnapshotRuntime`
        """
