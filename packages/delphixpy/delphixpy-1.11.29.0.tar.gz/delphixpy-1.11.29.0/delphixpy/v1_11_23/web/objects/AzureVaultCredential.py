...
from delphixpy.v1_11_23.web.objects.AbstractVaultCredential import AbstractVaultCredential
...
class AzureVaultCredential(AbstractVaultCredential):
    """
    *(extends* :py:class:`v1_11_23.web.vo.AbstractVaultCredential` *)* The
