...
#     /delphix-connectivity-parameters.json
#
...
class ConnectivityParameters(TypedObject):
    """
    *(extends* :py:class:`v1_11_23.web.vo.TypedObject` *)* Parameters required
    to connect to a remote host.
    """
    def __init__(self, undef_enabled=True):
        super().__init__()
        self._type = ("ConnectivityParameters", True)
    ...
    def is_dirty(self):
        return any([self._address[1], self._username[1], self._credentials[1]])
    ...
    def __eq__(self, other):
        if other is None:
            return False
        if not isinstance(other, ConnectivityParameters):
            return False
