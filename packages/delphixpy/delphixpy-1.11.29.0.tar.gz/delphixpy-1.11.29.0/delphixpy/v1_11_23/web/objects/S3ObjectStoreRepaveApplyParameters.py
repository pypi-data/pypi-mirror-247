...
class S3ObjectStoreRepaveApplyParameters(RepaveApplyParameters):
    """
    *(extends* :py:class:`v1_11_23.web.vo.RepaveApplyParameters` *)* An Amazon
    ...
    def is_dirty(self):
        return any([self._endpoint[1], self._region[1], self._bucket[1], self._access_credentials[1], self._cache_devices[1], self._domain0_pool_guid[1]])
    ...
    def access_credentials(self):
        ...
        :rtype: :py:class:`v1_11_23.web.vo.S3ObjectStoreAccess`
        """
