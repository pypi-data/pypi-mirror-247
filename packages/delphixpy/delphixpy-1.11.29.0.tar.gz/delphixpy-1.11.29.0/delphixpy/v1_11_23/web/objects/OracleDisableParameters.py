...
from delphixpy.v1_11_23.web.objects.SourceDisableParameters import SourceDisableParameters
...
class OracleDisableParameters(SourceDisableParameters):
    """
    *(extends* :py:class:`v1_11_23.web.vo.SourceDisableParameters` *)* The
