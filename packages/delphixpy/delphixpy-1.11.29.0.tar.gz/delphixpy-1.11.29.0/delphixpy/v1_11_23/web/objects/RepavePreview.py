...
class RepavePreview(TypedObject):
    """
    *(extends* :py:class:`v1_11_23.web.vo.TypedObject` *)* Preview engine
    ...
    def state(self):
        ...
        *(default value: NONE)* Repave state. *(permitted values: UNSET,
        ...
        PREPARE_EXPORT_DOMAIN0_FAILED, PREPARE_SUCCESSFUL,
        APPLY_IMPORTING_DOMAIN0, APPLY_IMPORT_DOMAIN0_FAILED,
        APPLY_GENERATING_METADATA, APPLY_GENERATE_METADATA_FAILED,
        APPLY_SETTING_UP_MDS, APPLY_SETUP_MDS_FAILED,
        APPLY_SETUP_MDS_SUCCESSFUL, APPLY_REFRESHING_ENV,
        APPLY_REFRESH_ENV_FAILED, APPLY_UNQUIESCING_ENGINE,
        APPLY_UNQUIESCE_ENGINE_FAILED, APPLY_SUCCESSFUL)*
    ...
    def source_engine_summary(self):
        ...
        :rtype: :py:class:`v1_11_23.web.vo.RepaveEngineSummary`
        """
    ...
    def source_engine_configurable_metadata(self):
        ...
        :rtype: :py:class:`v1_11_23.web.vo.RepaveConfigurableMetadata`
        """
