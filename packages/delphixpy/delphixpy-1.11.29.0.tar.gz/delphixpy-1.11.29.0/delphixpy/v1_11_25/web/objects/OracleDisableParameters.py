...
from delphixpy.v1_11_25.web.objects.SourceDisableParameters import SourceDisableParameters
...
class OracleDisableParameters(SourceDisableParameters):
    """
    *(extends* :py:class:`v1_11_25.web.vo.SourceDisableParameters` *)* The
