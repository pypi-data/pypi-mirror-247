...
from delphixpy.v1_11_25.web.objects.AbstractVaultCredential import AbstractVaultCredential
...
class AzureVaultCredential(AbstractVaultCredential):
    """
    *(extends* :py:class:`v1_11_25.web.vo.AbstractVaultCredential` *)* The
