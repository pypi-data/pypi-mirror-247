...
from delphixpy.v1_11_25.web.objects.OracleBaseDBConfig import OracleBaseDBConfig
...
class OracleDBConfig(OracleBaseDBConfig):
    """
    *(extends* :py:class:`v1_11_25.web.vo.OracleBaseDBConfig` *)* The source
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._tde_keystore_config_type[0] is not None and obj._tde_keystore_config_type[0] is not obj.__undef__:
            ...
            assert obj._tde_keystore_config_type[0] in ['FILE', 'OKV', 'HSM', 'FILE|OKV', 'FILE|HSM', 'OKV|FILE', 'HSM|FILE'], "Expected enum ['FILE', 'OKV', 'HSM', 'FILE|OKV', 'FILE|HSM', 'OKV|FILE', 'HSM|FILE'] but got %s" % obj._tde_keystore_config_type[0]
    ...
    def tde_keystore_config_type(self):
        ...
        values: FILE, OKV, HSM, FILE|OKV, FILE|HSM, OKV|FILE, HSM|FILE)*
