...
from delphixpy.v1_11_25.web.objects.OracleBaseSourceRuntime import OracleBaseSourceRuntime
...
class OracleLiveSourceRuntime(OracleBaseSourceRuntime):
    """
    *(extends* :py:class:`v1_11_25.web.vo.OracleBaseSourceRuntime` *)* Runtime
