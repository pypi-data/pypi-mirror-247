...
from delphixpy.v1_11_25.web.objects.BaseGroupCapacityData import BaseGroupCapacityData
...
class HistoricalGroupCapacityData(BaseGroupCapacityData):
    """
    *(extends* :py:class:`v1_11_25.web.vo.BaseGroupCapacityData` *)* Historical
