...
from delphixpy.v1_11_25.web.objects.ReadonlyNamedUserObject import ReadonlyNamedUserObject
...
class Host(ReadonlyNamedUserObject):
    """
    *(extends* :py:class:`v1_11_25.web.vo.ReadonlyNamedUserObject` *)* The
    ...
    def __init__(self, undef_enabled=True):
        ...
        self._nfs_encryption_port = (self.__undef__, True)
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        for item in data.get("nfsAddressList") or []:
            ...
            common.validate_format(item, "hostOrCIDRAddress", None, None)
            obj._nfs_address_list.append(item)
        obj._nfs_address_list = (obj._nfs_address_list, dirty)
        obj._nfs_encryption_port = (data.get("nfsEncryptionPort", obj.__undef__), dirty)
        if obj._nfs_encryption_port[0] is not None and obj._nfs_encryption_port[0] is not obj.__undef__:
            assert isinstance(obj._nfs_encryption_port[0], int), ("Expected one of ['integer', 'null'], but got %s of type %s" % (obj._nfs_encryption_port[0], type(obj._nfs_encryption_port[0])))
            common.validate_format(obj._nfs_encryption_port[0], "None", None, None)
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "nfs_encryption_port" == "type" or (self.nfs_encryption_port is not self.__undef__ and (not (dirty and not self._nfs_encryption_port[1]))):
            dct["nfsEncryptionPort"] = dictify(self.nfs_encryption_port)
    ...
    def force_dirty(self):
        ...
        self._nfs_encryption_port = (self._nfs_encryption_port[0], True)
    ...
    def is_dirty(self):
        return any([self._address[1], self._nfs_address_list[1], self._nfs_encryption_port[1], self._ssh_port[1], self._date_added[1], self._host_configuration[1], self._host_runtime[1], self._privilege_elevation_profile[1], self._dsp_keystore_alias[1], self._dsp_keystore_password[1], self._dsp_keystore_path[1], self._dsp_truststore_password[1], self._dsp_truststore_path[1], self._java_home[1]])
    ...
    def __eq__(self, other):
        ...
        return super().__eq__(other) and \
               ...
               self.nfs_encryption_port == other.nfs_encryption_port and \
    ...
    @property
    def nfs_encryption_port(self):
        """
        The port number used for NFS encryption if NFS encryption is enabled
        for the environment.

        :rtype: ``int`` *or* ``null``
        """
        return self._nfs_encryption_port[0]

    @nfs_encryption_port.setter
    def nfs_encryption_port(self, value):
        self._nfs_encryption_port = (value, True)
    ...
    def host_configuration(self):
        ...
        :rtype: :py:class:`v1_11_25.web.vo.HostConfiguration`
        """
    ...
    def host_runtime(self):
        ...
        :rtype: :py:class:`v1_11_25.web.vo.HostRuntime`
        """
