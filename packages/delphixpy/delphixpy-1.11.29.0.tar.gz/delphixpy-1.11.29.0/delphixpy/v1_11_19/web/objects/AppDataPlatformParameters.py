...
from delphixpy.v1_11_19.web.objects.BasePlatformParameters import BasePlatformParameters
...
class AppDataPlatformParameters(BasePlatformParameters):
    """
    *(extends* :py:class:`v1_11_19.web.vo.BasePlatformParameters` *)* AppData
