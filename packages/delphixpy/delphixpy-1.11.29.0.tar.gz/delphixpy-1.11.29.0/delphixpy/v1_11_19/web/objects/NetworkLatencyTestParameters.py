...
from delphixpy.v1_11_19.web.objects.NetworkTestParameters import NetworkTestParameters
...
class NetworkLatencyTestParameters(NetworkTestParameters):
    """
    *(extends* :py:class:`v1_11_19.web.vo.NetworkTestParameters` *)* Parameters
