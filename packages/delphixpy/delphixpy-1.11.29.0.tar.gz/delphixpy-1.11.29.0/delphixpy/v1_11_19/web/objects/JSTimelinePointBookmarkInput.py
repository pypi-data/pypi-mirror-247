...
from delphixpy.v1_11_19.web.objects.JSTimelinePointParameters import JSTimelinePointParameters
...
class JSTimelinePointBookmarkInput(JSTimelinePointParameters):
    """
    *(extends* :py:class:`v1_11_19.web.vo.JSTimelinePointParameters` *)*
