...
from delphixpy.v1_11_19.web.objects.JSDataLayoutCreateParameters import JSDataLayoutCreateParameters
...
class JSDataTemplateCreateParameters(JSDataLayoutCreateParameters):
    """
    *(extends* :py:class:`v1_11_19.web.vo.JSDataLayoutCreateParameters` *)* The
