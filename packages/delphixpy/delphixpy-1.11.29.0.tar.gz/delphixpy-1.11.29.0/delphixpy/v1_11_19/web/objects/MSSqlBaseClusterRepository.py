...
from delphixpy.v1_11_19.web.objects.MSSqlRepository import MSSqlRepository
...
class MSSqlBaseClusterRepository(MSSqlRepository):
    """
    *(extends* :py:class:`v1_11_19.web.vo.MSSqlRepository` *)* The
    ...
    def instances(self):
        ...
        :rtype: ``list`` of
            :py:class:`v1_11_19.web.vo.MSSqlBaseClusterInstance`
        """
    ...
    def listeners(self):
        ...
        :rtype: ``list`` of
            :py:class:`v1_11_19.web.vo.MSSqlBaseClusterListener`
        """
