...
class Namespace(NamedUserObject):
    """
    *(extends* :py:class:`v1_11_19.web.vo.NamedUserObject` *)* Object namespace
    ...
    def is_dirty(self):
        return any([self._namespace_type[1], self._description[1], self._source[1], self._tag[1], self._secure_namespace[1], self._failed_over[1], self._failover_report[1], self._locked[1], self._failback_possible[1]])
    ...
    def __eq__(self, other):
        ...
        return super().__eq__(other) and \
               ...
               self.failback_possible == other.failback_possible
