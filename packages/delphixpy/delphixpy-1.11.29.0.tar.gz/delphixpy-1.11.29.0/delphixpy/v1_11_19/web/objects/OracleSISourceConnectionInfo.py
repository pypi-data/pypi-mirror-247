...
from delphixpy.v1_11_19.web.objects.OracleSourceConnectionInfo import OracleSourceConnectionInfo
...
class OracleSISourceConnectionInfo(OracleSourceConnectionInfo):
    """
    *(extends* :py:class:`v1_11_19.web.vo.OracleSourceConnectionInfo` *)*
