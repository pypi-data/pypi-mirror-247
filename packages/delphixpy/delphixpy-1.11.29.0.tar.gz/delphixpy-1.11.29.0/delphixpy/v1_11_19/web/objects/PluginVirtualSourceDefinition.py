...
#     /delphix-plugin-virtual-source-definition.json
#
...
class PluginVirtualSourceDefinition(TypedObject):
    """
    *(extends* :py:class:`v1_11_19.web.vo.TypedObject` *)* A virtual source
    definition for plugins.
    """
    def __init__(self, undef_enabled=True):
        super().__init__()
        self._type = ("PluginVirtualSourceDefinition", True)
    ...
    def __eq__(self, other):
        if other is None:
            return False
        if not isinstance(other, PluginVirtualSourceDefinition):
            return False
