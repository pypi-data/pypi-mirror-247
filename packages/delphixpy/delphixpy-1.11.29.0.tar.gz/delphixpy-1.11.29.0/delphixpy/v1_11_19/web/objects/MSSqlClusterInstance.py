...
from delphixpy.v1_11_19.web.objects.MSSqlBaseClusterInstance import MSSqlBaseClusterInstance
...
class MSSqlClusterInstance(MSSqlBaseClusterInstance):
    """
    *(extends* :py:class:`v1_11_19.web.vo.MSSqlBaseClusterInstance` *)* The
