...
#     /delphix-mssql-database-user.json
#
# Do not edit this file manually!
#

from delphixpy.v1_11_19.web.objects.MSSqlUser import MSSqlUser
...
class MSSqlDatabaseUser(MSSqlUser):
    """
    *(extends* :py:class:`v1_11_19.web.vo.MSSqlUser` *)* Represents the mssql
    database user.
    """
    def __init__(self, undef_enabled=True):
        super().__init__()
        self._type = ("MSSqlDatabaseUser", True)
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if "password" in data and data["password"] is not None:
            obj._password = (factory.create_object(data["password"], "PasswordCredential"), dirty)
            factory.validate_type(obj._password[0], "PasswordCredential")
        else:
            obj._password = (obj.__undef__, dirty)
        return obj
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "password" == "type" or (self.password is not self.__undef__ and (not (dirty and not self._password[1]) or self.is_dirty_list(self.password, self._password) or belongs_to_parent)):
            dct["password"] = dictify(self.password, prop_is_list_or_vo=True)
        return dct
    ...
    def is_dirty(self):
        return any([self._user[1], self._password[1]])
    ...
    def __eq__(self, other):
        if other is None:
            return False
        if not isinstance(other, MSSqlDatabaseUser):
            return False
