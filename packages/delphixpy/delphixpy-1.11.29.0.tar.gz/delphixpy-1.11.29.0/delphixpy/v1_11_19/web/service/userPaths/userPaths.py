...
def create(engine, user_path_storage=None):
    ...
    :type user_path_storage: :py:class:`v1_11_19.web.vo.UserPathStorage`
    :rtype: ``str``
    """
...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_11_19.web.objects.UserPathStorage.UserPathStora
        ge` object
    :type ref: ``str``
    :rtype: :py:class:`v1_11_19.web.vo.UserPathStorage`
    """
...
def get_all(engine, pathtype=None):
    ...
    :param pathtype: Type of path stored. *(permitted values:
        UPGRADE_STAGING_LOC)*
    :type pathtype: ``str``
    :rtype: ``list`` of :py:class:`v1_11_19.web.vo.UserPathStorage`
    """
    url = "/resources/json/delphix/service/userPaths"
