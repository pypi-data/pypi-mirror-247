...
def create(engine, network_latency_test_parameters):
    ...
    :type network_latency_test_parameters:
        :py:class:`v1_11_19.web.vo.NetworkLatencyTestParameters`
    :rtype: ``str``
    """
...
def get(engine, ref):
    ...
    :type ref: ``str``
    :rtype: :py:class:`v1_11_19.web.vo.NetworkLatencyTest`
    """
...
def get_all(engine, ascending=None):
    ...
    :type ascending: ``bool``
    :rtype: ``list`` of :py:class:`v1_11_19.web.vo.NetworkLatencyTest`
    """
    url = "/resources/json/delphix/network/test/latency"
