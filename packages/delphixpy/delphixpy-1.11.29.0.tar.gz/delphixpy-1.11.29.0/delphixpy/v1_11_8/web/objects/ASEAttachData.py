...
from delphixpy.v1_11_8.web.objects.AttachData import AttachData
...
class ASEAttachData(AttachData):
    """
    *(extends* :py:class:`v1_11_8.web.vo.AttachData` *)* Represents the SAP ASE
    ...
    def staging_operations(self):
        ...
        :rtype: :py:class:`v1_11_8.web.vo.StagingSourceOperations`
        """
