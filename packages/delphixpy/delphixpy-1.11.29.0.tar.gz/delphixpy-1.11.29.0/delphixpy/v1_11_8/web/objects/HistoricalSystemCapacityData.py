...
from delphixpy.v1_11_8.web.objects.BaseSystemCapacityData import BaseSystemCapacityData
...
class HistoricalSystemCapacityData(BaseSystemCapacityData):
    """
    *(extends* :py:class:`v1_11_8.web.vo.BaseSystemCapacityData` *)* Capacity
