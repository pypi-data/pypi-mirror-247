...
from delphixpy.v1_11_8.web.objects.OracleCustomEnvVarPair import OracleCustomEnvVarPair
...
class OracleCustomEnvVarRACPair(OracleCustomEnvVarPair):
    """
    *(extends* :py:class:`v1_11_8.web.vo.OracleCustomEnvVarPair` *)* Dictates a
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._cluster_node[0] is not None and obj._cluster_node[0] is not obj.__undef__:
            assert isinstance(obj._cluster_node[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._cluster_node[0], type(obj._cluster_node[0])))
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        def dictify(obj, prop_is_list_or_vo=False):
            if isinstance(obj, list):
                ...
                return obj
        if "cluster_node" == "type" or (self.cluster_node is not self.__undef__ and (not (dirty and not self._cluster_node[1]) or self.is_dirty_list(self.cluster_node, self._cluster_node) or belongs_to_parent)):
