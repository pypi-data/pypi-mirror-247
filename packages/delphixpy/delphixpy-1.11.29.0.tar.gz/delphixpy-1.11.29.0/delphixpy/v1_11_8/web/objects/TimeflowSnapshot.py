...
from delphixpy.v1_11_8.web.objects.ReadonlyNamedUserObject import ReadonlyNamedUserObject
...
class TimeflowSnapshot(ReadonlyNamedUserObject):
    """
    *(extends* :py:class:`v1_11_8.web.vo.ReadonlyNamedUserObject` *)* Snapshot
    ...
    def first_change_point(self):
        ...
        :rtype: :py:class:`v1_11_8.web.vo.TimeflowPoint`
        """
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_11_8.web.vo.SnapshotRuntime`
        """
