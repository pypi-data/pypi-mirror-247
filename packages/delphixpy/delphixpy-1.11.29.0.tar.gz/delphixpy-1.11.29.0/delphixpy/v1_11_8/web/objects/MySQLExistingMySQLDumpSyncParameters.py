...
from delphixpy.v1_11_8.web.objects.MySQLExistingBackupSyncParameters import MySQLExistingBackupSyncParameters
...
class MySQLExistingMySQLDumpSyncParameters(MySQLExistingBackupSyncParameters):
    """
    *(extends* :py:class:`v1_11_8.web.vo.MySQLExistingBackupSyncParameters` *)*
