...
from delphixpy.v1_11_8.web.objects.JSTimelinePointTimeParameters import JSTimelinePointTimeParameters
...
class JSTimelinePointLatestTimeInput(JSTimelinePointTimeParameters):
    """
    *(extends* :py:class:`v1_11_8.web.vo.JSTimelinePointTimeParameters` *)*
