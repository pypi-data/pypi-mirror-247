...
from delphixpy.v1_11_3.web.objects.CompatibilityCriteria import CompatibilityCriteria
...
class MySQLCompatibilityCriteria(CompatibilityCriteria):
    """
    *(extends* :py:class:`v1_11_3.web.vo.CompatibilityCriteria` *)* The
    ...
    def version(self):
        ...
        :rtype: :py:class:`v1_11_3.web.vo.MySQLVersion`
        """
