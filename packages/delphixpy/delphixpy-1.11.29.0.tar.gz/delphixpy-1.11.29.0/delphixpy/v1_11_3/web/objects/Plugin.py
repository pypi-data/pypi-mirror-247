...
from delphixpy.v1_11_3.web.objects.AbstractToolkit import AbstractToolkit
...
class Plugin(AbstractToolkit):
    """
    *(extends* :py:class:`v1_11_3.web.vo.AbstractToolkit` *)* An installed
    plugin.
    """
    ...
    def is_dirty(self):
        return any([self._external_version[1], self._build_number[1], self._virtual_source_definition[1], self._linked_source_definition[1], self._discovery_definition[1], self._upgrade_definition[1], self._entry_point[1], self._lua_name[1], self._minimum_lua_version[1], self._source_code[1], self._manifest[1]])
    ...
    def virtual_source_definition(self):
        ...
        :rtype: :py:class:`v1_11_3.web.vo.PluginVirtualSourceDefinition`
        """
    ...
    def linked_source_definition(self):
        ...
        :rtype: :py:class:`v1_11_3.web.vo.PluginLinkedSourceDefinition`
        """
    ...
    def discovery_definition(self):
        ...
        :rtype: :py:class:`v1_11_3.web.vo.PluginDiscoveryDefinition`
        """
    ...
    def upgrade_definition(self):
        ...
        :rtype: :py:class:`v1_11_3.web.vo.PluginUpgradeDefinition`
        """
    ...
    def manifest(self):
        ...
        :rtype: :py:class:`v1_11_3.web.vo.PluginManifest`
        """
