...
from delphixpy.v1_11_3.web.objects.ReplicationObjectSpecification import ReplicationObjectSpecification
...
class ReplicationList(ReplicationObjectSpecification):
    """
    *(extends* :py:class:`v1_11_3.web.vo.ReplicationObjectSpecification` *)*
