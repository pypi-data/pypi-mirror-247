...
from delphixpy.v1_5_3.web.objects.OracleBaseSourceRuntime import OracleBaseSourceRuntime
...
class OracleLiveSourceRuntime(OracleBaseSourceRuntime):
    """
    *(extends* :py:class:`v1_5_3.web.vo.OracleBaseSourceRuntime` *)* Runtime
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._apply_status[0] is not None and obj._apply_status[0] is not obj.__undef__:
            assert isinstance(obj._apply_status[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._apply_status[0], type(obj._apply_status[0])))
        ...
        if obj._last_update_time[0] is not None and obj._last_update_time[0] is not obj.__undef__:
            assert isinstance(obj._last_update_time[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._last_update_time[0], type(obj._last_update_time[0])))
        ...
        if obj._source_database_timezone[0] is not None and obj._source_database_timezone[0] is not obj.__undef__:
            assert isinstance(obj._source_database_timezone[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._source_database_timezone[0], type(obj._source_database_timezone[0])))
        ...
        if obj._transport_status[0] is not None and obj._transport_status[0] is not obj.__undef__:
            assert isinstance(obj._transport_status[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._transport_status[0], type(obj._transport_status[0])))
    ...
    def is_dirty(self):
        return any([self._apply_status[1], self._current_data_age[1], self._is_data_age_warning_exceeded[1], self._last_update_time[1], self._non_logged_data_detected[1], self._source_database_timezone[1], self._source_resetlogs_id_change_detected[1], self._transport_status[1], self._unexpected_role_change_detected[1]])
    ...
    def __eq__(self, other):
        ...
        return super().__eq__(other) and \
               ...
               self.source_database_timezone == other.source_database_timezone and \
               ...
               self.unexpected_role_change_detected == other.unexpected_role_change_detected
