...
from delphixpy.v1_5_3.web.objects.OracleSourceConnectionInfo import OracleSourceConnectionInfo
...
class OracleRACSourceConnectionInfo(OracleSourceConnectionInfo):
    """
    *(extends* :py:class:`v1_5_3.web.vo.OracleSourceConnectionInfo` *)*
