...
from delphixpy.v1_5_3.web.objects.ASEDBConfig import ASEDBConfig
...
class ASESIConfig(ASEDBConfig):
    """
    *(extends* :py:class:`v1_5_3.web.vo.ASEDBConfig` *)* A SAP ASE single
    ...
    def instance(self):
        ...
        :rtype: :py:class:`v1_5_3.web.vo.ASEInstanceConfig`
        """
