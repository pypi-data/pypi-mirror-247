...
class MSSqlProvisionParameters(ProvisionParameters):
    ...
    *(extends* :py:class:`v1_5_3.web.vo.ProvisionParameters` *)* The parameters
    ...
    def is_dirty(self):
        return any([self._container[1], self._recovery_model[1], self._source[1], self._source_config[1]])
    ...
    def source(self):
        ...
        :rtype: :py:class:`v1_5_3.web.vo.MSSqlVirtualSource`
        """
    ...
    def source_config(self):
        ...
        :rtype: :py:class:`v1_5_3.web.vo.MSSqlDBConfig`
        """
