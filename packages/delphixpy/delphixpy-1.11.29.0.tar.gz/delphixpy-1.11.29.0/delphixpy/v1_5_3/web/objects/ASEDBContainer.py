...
class ASEDBContainer(DatabaseContainer):
    """
    *(extends* :py:class:`v1_5_3.web.vo.DatabaseContainer` *)* An SAP ASE
    Database Container.
    """
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_5_3.web.vo.ASEDBContainerRuntime`
        """
    ...
    def sourcing_policy(self):
        ...
        :rtype: :py:class:`v1_5_3.web.vo.SourcingPolicy`
        """
