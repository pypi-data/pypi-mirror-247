...
def get(engine):
    ...
    :rtype: :py:class:`v1_11_24.web.vo.StorageDeviceRemovalStatus`
    """
...
def start(engine, storage_device_remove_parameters=None):
    ...
    :type storage_device_remove_parameters:
        :py:class:`v1_11_24.web.vo.StorageDeviceRemoveParameters`
    """
...
def verify(engine, storage_device_remove_parameters=None):
    ...
    :type storage_device_remove_parameters:
        :py:class:`v1_11_24.web.vo.StorageDeviceRemoveParameters`
    :rtype: :py:class:`v1_11_24.web.vo.StorageDeviceRemovalVerifyResult`
    """
