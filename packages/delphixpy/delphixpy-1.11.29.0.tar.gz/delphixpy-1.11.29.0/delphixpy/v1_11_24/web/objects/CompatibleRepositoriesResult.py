...
class CompatibleRepositoriesResult(TypedObject):
    """
    *(extends* :py:class:`v1_11_24.web.vo.TypedObject` *)* Result of a
    ...
    def repositories(self):
        ...
        :rtype: ``list`` of :py:class:`v1_11_24.web.vo.SourceRepository`
        """
    ...
    def criteria(self):
        ...
        :rtype: :py:class:`v1_11_24.web.vo.CompatibilityCriteria`
        """
