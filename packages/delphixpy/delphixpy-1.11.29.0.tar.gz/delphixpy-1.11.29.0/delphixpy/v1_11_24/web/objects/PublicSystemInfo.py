...
class PublicSystemInfo(TypedObject):
    """
    *(extends* :py:class:`v1_11_24.web.vo.TypedObject` *)* Retrieve static
    ...
    def __init__(self, undef_enabled=True):
        ...
        self._user_management_enabled = (self.__undef__, True)
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        obj._user_management_enabled = (data.get("userManagementEnabled", obj.__undef__), dirty)
        if obj._user_management_enabled[0] is not None and obj._user_management_enabled[0] is not obj.__undef__:
            assert isinstance(obj._user_management_enabled[0], bool), ("Expected one of ['boolean'], but got %s of type %s" % (obj._user_management_enabled[0], type(obj._user_management_enabled[0])))
            common.validate_format(obj._user_management_enabled[0], "None", None, None)
        ...
        if obj._central_management_product_name[0] is not None and obj._central_management_product_name[0] is not obj.__undef__:
            assert isinstance(obj._central_management_product_name[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._central_management_product_name[0], type(obj._central_management_product_name[0])))
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "user_management_enabled" == "type" or (self.user_management_enabled is not self.__undef__ and (not (dirty and not self._user_management_enabled[1]))):
            dct["userManagementEnabled"] = dictify(self.user_management_enabled)
        if "central_management_product_name" == "type" or (self.central_management_product_name is not self.__undef__ and (not (dirty and not self._central_management_product_name[1]))):
    ...
    def force_dirty(self):
        ...
        self._user_management_enabled = (self._user_management_enabled[0], True)
    ...
    def is_dirty(self):
        return any([self._product_type[1], self._engine_type[1], self._sso_enabled[1], self._user_management_enabled[1], self._central_management_product_name[1], self._vendor_name[1], self._vendor_address[1], self._vendor_phone_number[1], self._vendor_email[1], self._vendor_url[1], self._product_name[1], self._engine_qualifier[1], self._support_contacts[1], self._support_url[1], self._build_title[1], self._build_timestamp[1], self._build_version[1], self._configured[1], self._enabled_features[1], self._toggleable_features[1], self._api_version[1], self._banner[1], self._locales[1], self._current_locale[1], self._kernel_name[1], self._theme[1]])
    ...
    def __eq__(self, other):
        ...
        return super().__eq__(other) and \
               ...
               self.user_management_enabled == other.user_management_enabled and \
               self.central_management_product_name == other.central_management_product_name and \
    ...
    def user_management_enabled(self):
        """
        Indicates if user management operations (create, delete, changing email
        address, etc) are allowed on this Engine. Otherwise user management is
        performed in Central Management.

        :rtype: ``bool``
        """
        return self._user_management_enabled[0]

    @user_management_enabled.setter
    def user_management_enabled(self, value):
        self._user_management_enabled = (value, True)

    @property
    def central_management_product_name(self):
        """
        Name of the product which controls central access and management of
        this Engine.
    ...
    def support_contacts(self):
        ...
        :rtype: ``list`` of :py:class:`v1_11_24.web.vo.SupportContact`
        """
    ...
    def build_version(self):
        ...
        :rtype: :py:class:`v1_11_24.web.vo.VersionInfo`
        """
    ...
    def api_version(self):
        ...
        :rtype: :py:class:`v1_11_24.web.vo.APIVersion`
        """
