...
class DoseMigrationStatus(TypedObject):
    """
    *(extends* :py:class:`v1_11_24.web.vo.TypedObject` *)* Migrate block-based
    storage to object store.
    """
    def __init__(self, undef_enabled=True):
        super().__init__()
        self._type = ("DoseMigrationStatus", True)
    ...
    def __eq__(self, other):
        if other is None:
            return False
        if not isinstance(other, DoseMigrationStatus):
            return False
