...
from delphixpy.v1_11_24.web.objects.SourceRuntime import SourceRuntime
...
class OracleBaseSourceRuntime(SourceRuntime):
    """
    *(extends* :py:class:`v1_11_24.web.vo.SourceRuntime` *)* Runtime (non-
    ...
    def active_instances(self):
        ...
        :rtype: ``list`` of :py:class:`v1_11_24.web.vo.OracleActiveInstance`
        """
    ...
    def database_stats(self):
        ...
        :rtype: ``list`` of
            :py:class:`v1_11_24.web.vo.OracleDatabaseStatsSection`
        """
