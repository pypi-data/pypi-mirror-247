...
class EngineAggregateIngestedSize(TypedObject):
    """
    *(extends* :py:class:`v1_11_24.web.vo.TypedObject` *)* Object which holds
    ...
    def aggregates(self):
        ...
        :rtype: ``list`` of
            :py:class:`v1_11_24.web.vo.SourceTypeAggregateIngestedSize`
        """
    ...
    def source_ingestion_data(self):
        ...
        :rtype: ``list`` of :py:class:`v1_11_24.web.vo.SourceIngestionData`
        """
