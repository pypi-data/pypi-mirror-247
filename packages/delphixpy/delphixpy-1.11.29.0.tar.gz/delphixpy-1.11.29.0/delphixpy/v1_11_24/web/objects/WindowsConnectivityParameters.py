...
#     /delphix-windows-connectivity-parameters.json
#
# Do not edit this file manually!
#

from delphixpy.v1_11_24.web.objects.ConnectivityParameters import ConnectivityParameters
...
class WindowsConnectivityParameters(ConnectivityParameters):
    """
    *(extends* :py:class:`v1_11_24.web.vo.ConnectivityParameters` *)*
    Parameters required to connect to a remote Windows host.
    """
    def __init__(self, undef_enabled=True):
        super().__init__()
        self._type = ("WindowsConnectivityParameters", True)
    ...
    def __eq__(self, other):
        if other is None:
            return False
        if not isinstance(other, WindowsConnectivityParameters):
            return False
    ...
    def port(self):
        """
        *(default value: 9100)* Connector port on remote host.
