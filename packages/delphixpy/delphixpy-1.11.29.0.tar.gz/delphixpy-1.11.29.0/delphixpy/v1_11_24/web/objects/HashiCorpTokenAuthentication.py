...
#     /delphix-hashicorp-token-authentication.json
#
# Do not edit this file manually!
#

from delphixpy.v1_11_24.web.objects.HashiCorpAuthentication import HashiCorpAuthentication
...
class HashiCorpTokenAuthentication(HashiCorpAuthentication):
    """
    *(extends* :py:class:`v1_11_24.web.vo.HashiCorpAuthentication` *)* Token
    for authenticating to a HashiCorp vault.
    """
    def __init__(self, undef_enabled=True):
        super().__init__()
        self._type = ("HashiCorpTokenAuthentication", True)
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._token[0] is not None and obj._token[0] is not obj.__undef__:
            ...
            common.validate_format(obj._token[0], "password", None, None)
        return obj
    ...
    def __eq__(self, other):
        if other is None:
            return False
        if not isinstance(other, HashiCorpTokenAuthentication):
            return False
    ...
    def token(self):
        """
        Token for authenticating to the vault.
