...
class Namespace(NamedUserObject):
    """
    *(extends* :py:class:`v1_11_24.web.vo.NamedUserObject` *)* Object namespace
    ...
    def __init__(self, undef_enabled=True):
        ...
        self._failback_possible = (self.__undef__, True)
        self._failback_capability = (self.__undef__, True)
        self._failback_incapability_reason = (self.__undef__, True)
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._namespace_type[0] is not None and obj._namespace_type[0] is not obj.__undef__:
            assert isinstance(obj._namespace_type[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._namespace_type[0], type(obj._namespace_type[0])))
        ...
        if obj._failover_report[0] is not None and obj._failover_report[0] is not obj.__undef__:
            assert isinstance(obj._failover_report[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._failover_report[0], type(obj._failover_report[0])))
        ...
        obj._failback_possible = (data.get("failbackPossible", obj.__undef__), dirty)
        if obj._failback_possible[0] is not None and obj._failback_possible[0] is not obj.__undef__:
            assert isinstance(obj._failback_possible[0], bool), ("Expected one of ['boolean'], but got %s of type %s" % (obj._failback_possible[0], type(obj._failback_possible[0])))
            common.validate_format(obj._failback_possible[0], "None", None, None)
        obj._failback_capability = (data.get("failbackCapability", obj.__undef__), dirty)
        if obj._failback_capability[0] is not None and obj._failback_capability[0] is not obj.__undef__:
            assert isinstance(obj._failback_capability[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._failback_capability[0], type(obj._failback_capability[0])))
            assert obj._failback_capability[0] in ['FAILBACK_READY', 'FAILBACK_COMPATIBLE', 'FAILBACK_INCOMPATIBLE', 'FAILBACK_UNSUPPORTED', 'FAILOVER_COMMITED_CANNOT_FAILBACK'], "Expected enum ['FAILBACK_READY', 'FAILBACK_COMPATIBLE', 'FAILBACK_INCOMPATIBLE', 'FAILBACK_UNSUPPORTED', 'FAILOVER_COMMITED_CANNOT_FAILBACK'] but got %s" % obj._failback_capability[0]
            common.validate_format(obj._failback_capability[0], "None", None, None)
        obj._failback_incapability_reason = (data.get("failbackIncapabilityReason", obj.__undef__), dirty)
        if obj._failback_incapability_reason[0] is not None and obj._failback_incapability_reason[0] is not obj.__undef__:
            assert isinstance(obj._failback_incapability_reason[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._failback_incapability_reason[0], type(obj._failback_incapability_reason[0])))
            common.validate_format(obj._failback_incapability_reason[0], "None", None, None)
        return obj
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "failback_possible" == "type" or (self.failback_possible is not self.__undef__ and (not (dirty and not self._failback_possible[1]))):
            dct["failbackPossible"] = dictify(self.failback_possible)
        if "failback_capability" == "type" or (self.failback_capability is not self.__undef__ and (not (dirty and not self._failback_capability[1]))):
            dct["failbackCapability"] = dictify(self.failback_capability)
        if "failback_incapability_reason" == "type" or (self.failback_incapability_reason is not self.__undef__ and (not (dirty and not self._failback_incapability_reason[1]))):
            dct["failbackIncapabilityReason"] = dictify(self.failback_incapability_reason)
        return dct
    ...
    def force_dirty(self):
        ...
        self._failback_possible = (self._failback_possible[0], True)
        self._failback_capability = (self._failback_capability[0], True)
        self._failback_incapability_reason = (self._failback_incapability_reason[0], True)

    def is_dirty(self):
        return any([self._namespace_type[1], self._description[1], self._source[1], self._tag[1], self._secure_namespace[1], self._failed_over[1], self._failover_report[1], self._locked[1], self._failback_possible[1], self._failback_capability[1], self._failback_incapability_reason[1]])
    ...
    def __eq__(self, other):
        ...
        return super().__eq__(other) and \
               ...
               self.failback_possible == other.failback_possible and \
               self.failback_capability == other.failback_capability and \
               self.failback_incapability_reason == other.failback_incapability_reason
    ...
    def locked(self):
        """
        Indicates the namespace is locked.
    ...
    @property
    def failback_possible(self):
        """
        Indicates the namespace may be failed back.

        :rtype: ``bool``
        """
        return self._failback_possible[0]

    @failback_possible.setter
    def failback_possible(self, value):
        self._failback_possible = (value, True)

    @property
    def failback_capability(self):
        """
        ...
        :rtype: ``str``
        """
        return self._failback_capability[0]

    @failback_capability.setter
    def failback_capability(self, value):
        self._failback_capability = (value, True)

    @property
    def failback_incapability_reason(self):
        """
        When incompatible, reason why the namespace is incompatible with
        failback.

        :rtype: ``str``
        """
        return self._failback_incapability_reason[0]

    @failback_incapability_reason.setter
    def failback_incapability_reason(self, value):
        self._failback_incapability_reason = (value, True)
