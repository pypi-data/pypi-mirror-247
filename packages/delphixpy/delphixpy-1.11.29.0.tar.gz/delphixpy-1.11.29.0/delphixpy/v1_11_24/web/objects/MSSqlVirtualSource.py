...
from delphixpy.v1_11_24.web.objects.MSSqlSource import MSSqlSource
...
class MSSqlVirtualSource(MSSqlSource):
    """
    *(extends* :py:class:`v1_11_24.web.vo.MSSqlSource` *)* A virtual MSSQL
    source.
    """
    ...
    def operations(self):
        ...
        :rtype: :py:class:`v1_11_24.web.vo.VirtualSourceOperations`
        """
