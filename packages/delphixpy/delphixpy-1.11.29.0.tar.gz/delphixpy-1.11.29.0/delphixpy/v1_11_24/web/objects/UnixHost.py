    ...
    *(extends* :py:class:`v1_11_24.web.vo.Host` *)* The representation of a
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._toolkit_path[0] is not None and obj._toolkit_path[0] is not obj.__undef__:
            ...
            common.validate_format(obj._toolkit_path[0], "unixabsolutepath", None, None)
    ...
    def oracle_host_parameters(self):
        ...
        :rtype: :py:class:`v1_11_24.web.vo.OracleHostParameters`
        """
    ...
    def ssh_verification_strategy(self):
        ...
        :rtype: :py:class:`v1_11_24.web.vo.SshVerificationStrategy`
        """
