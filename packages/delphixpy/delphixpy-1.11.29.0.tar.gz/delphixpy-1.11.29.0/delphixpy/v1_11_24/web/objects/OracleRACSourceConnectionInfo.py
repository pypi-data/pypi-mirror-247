...
from delphixpy.v1_11_24.web.objects.OracleSourceConnectionInfo import OracleSourceConnectionInfo
...
class OracleRACSourceConnectionInfo(OracleSourceConnectionInfo):
    """
    *(extends* :py:class:`v1_11_24.web.vo.OracleSourceConnectionInfo` *)*
