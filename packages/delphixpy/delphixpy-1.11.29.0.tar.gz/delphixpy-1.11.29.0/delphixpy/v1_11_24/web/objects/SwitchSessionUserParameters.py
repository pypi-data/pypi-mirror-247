...
#     /delphix-switch-session-user-parameters.json
#
...
class SwitchSessionUserParameters(TypedObject):
    """
    *(extends* :py:class:`v1_11_24.web.vo.TypedObject` *)* Parameters to be
    used when switching user for an SSO session.
    """
    def __init__(self, undef_enabled=True):
        super().__init__()
        self._type = ("SwitchSessionUserParameters", True)
    ...
    def __eq__(self, other):
        if other is None:
            return False
        if not isinstance(other, SwitchSessionUserParameters):
            return False
    ...
    def user(self):
        """
        Reference of the user to switch to.
