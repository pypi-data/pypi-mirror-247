...
class OracleFileSpecification(TypedObject):
    """
    *(extends* :py:class:`v1_11_18.web.vo.TypedObject` *)* Describes an Oracle
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._filename[0] is not None and obj._filename[0] is not obj.__undef__:
            assert isinstance(obj._filename[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._filename[0], type(obj._filename[0])))
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        def dictify(obj, prop_is_list_or_vo=False):
            if isinstance(obj, list):
                ...
                return obj
        if "filename" == "type" or (self.filename is not self.__undef__ and (not (dirty and not self._filename[1]) or self.is_dirty_list(self.filename, self._filename) or belongs_to_parent)):
