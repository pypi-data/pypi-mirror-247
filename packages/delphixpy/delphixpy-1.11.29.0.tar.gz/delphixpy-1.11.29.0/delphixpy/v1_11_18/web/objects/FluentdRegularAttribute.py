...
#     /delphix-fluentd-regular-attribute.json
#
...
class FluentdRegularAttribute(FluentdAttribute):
    """
    *(extends* :py:class:`v1_11_18.web.vo.FluentdAttribute` *)* Fluentd
    attribute with a plain value.
    """
    def __init__(self, undef_enabled=True):
        super().__init__()
        self._type = ("FluentdRegularAttribute", True)
    ...
    def __eq__(self, other):
        if other is None:
            return False
        if not isinstance(other, FluentdRegularAttribute):
            return False
