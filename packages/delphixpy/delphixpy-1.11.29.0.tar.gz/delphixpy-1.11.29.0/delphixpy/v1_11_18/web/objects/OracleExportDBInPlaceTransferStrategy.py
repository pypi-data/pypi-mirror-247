...
from delphixpy.v1_11_18.web.objects.OracleExportDBTransferStrategy import OracleExportDBTransferStrategy
...
class OracleExportDBInPlaceTransferStrategy(OracleExportDBTransferStrategy):
    """
    *(extends* :py:class:`v1_11_18.web.vo.OracleExportDBTransferStrategy` *)*
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._db_unique_name[0] is not None and obj._db_unique_name[0] is not obj.__undef__:
            ...
            common.validate_format(obj._db_unique_name[0], "None", None, None)
