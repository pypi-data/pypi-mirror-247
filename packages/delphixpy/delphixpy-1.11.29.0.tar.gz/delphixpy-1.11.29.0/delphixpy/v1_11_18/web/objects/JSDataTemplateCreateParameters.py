...
from delphixpy.v1_11_18.web.objects.JSDataLayoutCreateParameters import JSDataLayoutCreateParameters
...
class JSDataTemplateCreateParameters(JSDataLayoutCreateParameters):
    """
    *(extends* :py:class:`v1_11_18.web.vo.JSDataLayoutCreateParameters` *)* The
