...
from delphixpy.v1_11_18.web.objects.SourceDisableParameters import SourceDisableParameters
...
class OracleDisableParameters(SourceDisableParameters):
    """
    *(extends* :py:class:`v1_11_18.web.vo.SourceDisableParameters` *)* The
