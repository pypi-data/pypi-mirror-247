...
from delphixpy.v1_11_18.web.objects.BaseSystemCapacityData import BaseSystemCapacityData
...
class HistoricalSystemCapacityData(BaseSystemCapacityData):
    """
    *(extends* :py:class:`v1_11_18.web.vo.BaseSystemCapacityData` *)* Capacity
