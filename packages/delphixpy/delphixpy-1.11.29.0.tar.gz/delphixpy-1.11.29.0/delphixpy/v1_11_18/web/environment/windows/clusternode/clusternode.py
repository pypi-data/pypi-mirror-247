...
def get(engine, ref):
    ...
    :param ref: Reference to a :py:class:`delphixpy.v1_11_18.web.objects.Window
        sClusterNode.WindowsClusterNode` object
    :type ref: ``str``
    :rtype: :py:class:`v1_11_18.web.vo.WindowsClusterNode`
    """
...
def get_all(engine, cluster=None):
    ...
    :param cluster: A reference to the Windows cluster environment this node
        belongs to.
    :type cluster: ``str``
    :rtype: ``list`` of :py:class:`v1_11_18.web.vo.WindowsClusterNode`
    """
