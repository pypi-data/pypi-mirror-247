...
class ASELinkedSource(ASESource):
    """
    *(extends* :py:class:`v1_6_2.web.vo.ASESource` *)* A linked SAP ASE source.
    """
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "load_backup_server_name" == "type" or (self.load_backup_server_name is not self.__undef__ and (not (dirty and not self._load_backup_server_name[1]) or self.is_dirty_list(self.load_backup_server_name, self._load_backup_server_name) or belongs_to_parent)):
            dct["loadBackupServerName"] = dictify(self.load_backup_server_name)
        if "monitor_location" == "type" or (self.monitor_location is not self.__undef__ and (not (dirty and not self._monitor_location[1]) or self.is_dirty_list(self.monitor_location, self._monitor_location) or belongs_to_parent)):
    ...
    def is_dirty(self):
        return any([self._config[1], self._dump_credentials[1], self._external_file_path[1], self._load_backup_path[1], self._load_backup_server_name[1], self._monitor_location[1], self._operations[1], self._runtime[1], self._staging_source[1]])
    ...
    def monitor_location(self):
        ...
        :rtype: :py:class:`v1_6_2.web.vo.ASEBackupLocation`
        """
    ...
    def operations(self):
        ...
        :rtype: :py:class:`v1_6_2.web.vo.LinkedSourceOperations`
        """
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_6_2.web.vo.ASESourceRuntime`
        """
