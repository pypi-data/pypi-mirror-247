...
class ASESnapshot(TimeflowSnapshot):
    """
    *(extends* :py:class:`v1_6_2.web.vo.TimeflowSnapshot` *)* Provisionable
    ...
    def first_change_point(self):
        ...
        :rtype: :py:class:`v1_6_2.web.vo.ASETimeflowPoint`
        """
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_6_2.web.vo.ASESnapshotRuntime`
        """
