...
class WorkflowFunctionDefinition(TypedObject):
    """
    *(extends* :py:class:`v1_6_2.web.vo.TypedObject` *)* The definition of a
    Workflow Function.
    """
    def __init__(self, undef_enabled=True):
        super().__init__()
        self._type = ("WorkflowFunctionDefinition", True)
        self._input_type = (self.__undef__, True)
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        obj._input_type = (data.get("inputType", obj.__undef__), dirty)
        if obj._input_type[0] is not None and obj._input_type[0] is not obj.__undef__:
            assert isinstance(obj._input_type[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._input_type[0], type(obj._input_type[0])))
            common.validate_format(obj._input_type[0], "type", None, None)
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        def dictify(obj, prop_is_list_or_vo=False):
            if isinstance(obj, list):
                ...
                return obj
        if "input_type" == "type" or (self.input_type is not self.__undef__ and (not (dirty and not self._input_type[1]) or self.is_dirty_list(self.input_type, self._input_type) or belongs_to_parent)):
            dct["inputType"] = dictify(self.input_type)
    ...
    def force_dirty(self):
        self._input_type = (self._input_type[0], True)
        self._name = (self._name[0], True)
        self._output_schema = (self._output_schema[0], True)

    def is_dirty(self):
        return any([self._input_type[1], self._name[1], self._output_schema[1]])
    ...
    def input_type(self):
        ...
        :rtype: ``str``
        """
        return self._input_type[0]

    @input_type.setter
    def input_type(self, value):
        self._input_type = (value, True)
    ...
    def output_schema(self):
        ...
        :rtype: :py:class:`v1_6_2.web.vo.SchemaDraftV4`
        """
