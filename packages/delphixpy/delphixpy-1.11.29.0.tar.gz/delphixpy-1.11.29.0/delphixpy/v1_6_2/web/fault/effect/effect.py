...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_6_2.web.objects.FaultEffect.FaultEffect` object
    :type ref: ``str``
    :rtype: :py:class:`v1_6_2.web.vo.FaultEffect`
    """
...
def get_all(engine, bundle_id=None, root_cause=None, severity=None, target=None):
    ...
    :type target: ``str``
    :rtype: ``list`` of :py:class:`v1_6_2.web.vo.FaultEffect`
    """
