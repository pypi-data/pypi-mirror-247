...
def create(engine, authorization=None):
    ...
    :type authorization: :py:class:`v1_6_2.web.vo.Authorization`
    :rtype: ``str``
    """
...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_6_2.web.objects.Authorization.Authorization`
        object
    :type ref: ``str``
    :rtype: :py:class:`v1_6_2.web.vo.Authorization`
    """
...
def get_all(engine, effective=None, target=None, user=None):
    ...
    :type user: ``str``
    :rtype: ``list`` of :py:class:`v1_6_2.web.vo.Authorization`
    """
    url = "/resources/json/delphix/authorization"
...
def filter_by_permission(engine, auth_filter_parameters):
    ...
    :type auth_filter_parameters:
        :py:class:`v1_6_2.web.vo.AuthFilterParameters`
    :rtype: :py:class:`v1_6_2.web.vo.AuthFilterResult`
    """
