...
class MSSqlDatabaseContainer(DatabaseContainer):
    """
    *(extends* :py:class:`v1_6_1.web.vo.DatabaseContainer` *)* A MSSQL Database
    Container.
    """
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._validated_sync_mode[0] is not None and obj._validated_sync_mode[0] is not obj.__undef__:
            ...
            assert obj._validated_sync_mode[0] in ['DELPHIX_MANAGED', 'TRANSACTION_LOG', 'FULL_OR_DIFFERENTIAL', 'FULL'], "Expected enum ['DELPHIX_MANAGED', 'TRANSACTION_LOG', 'FULL_OR_DIFFERENTIAL', 'FULL'] but got %s" % obj._validated_sync_mode[0]
    ...
    def is_dirty(self):
        return any([self._runtime[1], self._validated_sync_mode[1]])
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_6_1.web.vo.MSSqlDBContainerRuntime`
        """
    ...
    def validated_sync_mode(self):
        ...
        *(permitted values: DELPHIX_MANAGED, TRANSACTION_LOG,
        FULL_OR_DIFFERENTIAL, FULL)*
