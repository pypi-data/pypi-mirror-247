...
from delphixpy.v1_6_1.web.objects.MSSqlDBConfig import MSSqlDBConfig
...
class MSSqlSIConfig(MSSqlDBConfig):
    """
    *(extends* :py:class:`v1_6_1.web.vo.MSSqlDBConfig` *)* Configuration
    ...
    def instance(self):
        ...
        :rtype: :py:class:`v1_6_1.web.vo.MSSqlInstanceConfig`
        """
