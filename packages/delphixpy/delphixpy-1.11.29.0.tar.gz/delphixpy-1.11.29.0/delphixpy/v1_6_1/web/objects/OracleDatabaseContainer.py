...
from delphixpy.v1_6_1.web.objects.DatabaseContainer import DatabaseContainer
...
class OracleDatabaseContainer(DatabaseContainer):
    """
    *(extends* :py:class:`v1_6_1.web.vo.DatabaseContainer` *)* Data container
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_6_1.web.vo.OracleDBContainerRuntime`
        """
    ...
    def sourcing_policy(self):
        ...
        :rtype: :py:class:`v1_6_1.web.vo.OracleSourcingPolicy`
        """
