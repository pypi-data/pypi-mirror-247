...
class MSSqlVirtualSource(MSSqlSource):
    """
    *(extends* :py:class:`v1_6_1.web.vo.MSSqlSource` *)* A virtual MSSQL
    source.
    """
    ...
    def is_dirty(self):
        return any([self._config_params[1], self._file_mapping_rules[1], self._mount_base[1], self._operations[1], self._post_script[1], self._pre_script[1]])
