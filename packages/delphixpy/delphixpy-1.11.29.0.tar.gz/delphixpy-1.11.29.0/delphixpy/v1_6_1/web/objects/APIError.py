...
class APIError(TypedObject):
    """
    *(extends* :py:class:`v1_6_1.web.vo.TypedObject` *)* Description of an
    ...
    def is_dirty(self):
        return any([self._action[1], self._command_output[1], self._details[1], self._diagnoses[1], self._id[1]])
