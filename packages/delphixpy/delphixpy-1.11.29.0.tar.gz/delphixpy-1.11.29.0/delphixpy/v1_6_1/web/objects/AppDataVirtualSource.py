...
from delphixpy.v1_6_1.web.objects.AppDataManagedSource import AppDataManagedSource
...
class AppDataVirtualSource(AppDataManagedSource):
    """
    *(extends* :py:class:`v1_6_1.web.vo.AppDataManagedSource` *)* A virtual
    AppData source.
    """
    ...
    def additional_mount_points(self):
        ...
        :rtype: ``list`` of
            :py:class:`v1_6_1.web.vo.AppDataAdditionalMountPoint`
        """
    ...
    def parameters(self):
        ...
        :rtype: ``list`` of :py:class:`v1_6_1.web.vo.DynamicParameterValue`
        """
