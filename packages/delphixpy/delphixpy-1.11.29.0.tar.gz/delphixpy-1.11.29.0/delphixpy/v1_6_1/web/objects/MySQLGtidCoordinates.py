...
from delphixpy.v1_6_1.web.objects.MySQLReplicationCoordinates import MySQLReplicationCoordinates
...
class MySQLGtidCoordinates(MySQLReplicationCoordinates):
    """
    *(extends* :py:class:`v1_6_1.web.vo.MySQLReplicationCoordinates` *)* The
