...
from delphixpy.v1_6_1.web.objects.ReplicationObjectSpecification import ReplicationObjectSpecification
...
class ReplicationList(ReplicationObjectSpecification):
    """
    *(extends* :py:class:`v1_6_1.web.vo.ReplicationObjectSpecification` *)*
