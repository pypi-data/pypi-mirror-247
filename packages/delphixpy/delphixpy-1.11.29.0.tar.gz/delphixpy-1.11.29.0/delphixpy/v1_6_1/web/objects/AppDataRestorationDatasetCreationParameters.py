...
from delphixpy.v1_6_1.web.objects.RestorationDatasetParameters import RestorationDatasetParameters
...
class AppDataRestorationDatasetCreationParameters(RestorationDatasetParameters):
    """
    *(extends* :py:class:`v1_6_1.web.vo.RestorationDatasetParameters` *)* The
    ...
    def source(self):
        ...
        :rtype: :py:class:`v1_6_1.web.vo.AppDataRestorationSource`
        """
