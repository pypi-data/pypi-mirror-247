...
class WindowsCluster(SourceEnvironment):
    """
    *(extends* :py:class:`v1_6_1.web.vo.SourceEnvironment` *)* A Windows
    cluster environment.
    """
    ...
    def is_dirty(self):
        return any([self._address[1], self._proxy[1], self._target_proxy[1]])
    ...
    def __eq__(self, other):
        ...
        return super().__eq__(other) and \
               ...
               self.target_proxy == other.target_proxy
