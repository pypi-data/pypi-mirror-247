...
from delphixpy.v1_6_1.web.objects.OracleBaseSourceRuntime import OracleBaseSourceRuntime
...
class OracleLiveSourceRuntime(OracleBaseSourceRuntime):
    """
    *(extends* :py:class:`v1_6_1.web.vo.OracleBaseSourceRuntime` *)* Runtime
