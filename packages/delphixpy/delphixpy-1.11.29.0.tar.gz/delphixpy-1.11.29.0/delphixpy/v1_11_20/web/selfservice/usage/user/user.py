...
"""
Package "selfservice.usage.user"
"""
...
def list_user_usage_data(engine, user=None):
    """
    Lists the usage breakdown for Self-Service users.
    ...
    :type user: ``str``
    :rtype: ``list`` of :py:class:`v1_11_20.web.vo.JSUserUsageData`
    """
    url = "/resources/json/delphix/selfservice/usage/user/listUserUsageData"
