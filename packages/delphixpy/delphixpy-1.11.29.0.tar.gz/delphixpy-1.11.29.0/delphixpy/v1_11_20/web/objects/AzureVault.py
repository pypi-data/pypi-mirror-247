...
from delphixpy.v1_11_20.web.objects.PasswordVault import PasswordVault
...
class AzureVault(PasswordVault):
    """
    *(extends* :py:class:`v1_11_20.web.vo.PasswordVault` *)* Azure password
    vault configuration.
    """
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if "authentication" in data and data["authentication"] is not None:
            obj._authentication = (factory.create_object(data["authentication"], "AzureAuthentication"), dirty)
            factory.validate_type(obj._authentication[0], "AzureAuthentication")
        else:
    ...
    def authentication(self):
        ...
        :rtype: :py:class:`v1_11_20.web.vo.AzureAuthentication`
        """
