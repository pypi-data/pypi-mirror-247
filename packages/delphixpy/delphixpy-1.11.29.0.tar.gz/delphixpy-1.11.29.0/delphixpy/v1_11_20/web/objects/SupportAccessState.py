...
class SupportAccessState(TypedObject):
    """
    *(extends* :py:class:`v1_11_20.web.vo.TypedObject` *)* The state of the
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._access_type[0] is not None and obj._access_type[0] is not obj.__undef__:
            assert isinstance(obj._access_type[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._access_type[0], type(obj._access_type[0])))
        ...
        if obj._authentication_method[0] is not None and obj._authentication_method[0] is not obj.__undef__:
            assert isinstance(obj._authentication_method[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._authentication_method[0], type(obj._authentication_method[0])))
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        def dictify(obj, prop_is_list_or_vo=False):
            if isinstance(obj, list):
                ...
                return obj
        if "access_type" == "type" or (self.access_type is not self.__undef__ and (not (dirty and not self._access_type[1]) or self.is_dirty_list(self.access_type, self._access_type) or belongs_to_parent)):
