...
from delphixpy.v1_11_20.web.objects.MSSqlBaseClusterInstance import MSSqlBaseClusterInstance
...
class MSSqlFailoverClusterInstance(MSSqlBaseClusterInstance):
    """
    *(extends* :py:class:`v1_11_20.web.vo.MSSqlBaseClusterInstance` *)* The
