...
#     /delphix-connectivity-oracle-db-config.json
#
# Do not edit this file manually!
#

from delphixpy.v1_11_20.web.objects.AbstractSourceConfigConnectivity import AbstractSourceConfigConnectivity
...
class OracleDBConfigConnectivity(AbstractSourceConfigConnectivity):
    """
    *(extends* :py:class:`v1_11_20.web.vo.AbstractSourceConfigConnectivity` *)*
    Mechanism to test JDBC connectivity to Oracle source configs.
    """
    def __init__(self, undef_enabled=True):
        super().__init__()
        self._type = ("OracleDBConfigConnectivity", True)
    ...
    def __eq__(self, other):
        if other is None:
            return False
        if not isinstance(other, OracleDBConfigConnectivity):
            return False
