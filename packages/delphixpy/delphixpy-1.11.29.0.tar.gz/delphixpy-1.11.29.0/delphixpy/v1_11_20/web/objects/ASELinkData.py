...
from delphixpy.v1_11_20.web.objects.LinkData import LinkData
...
class ASELinkData(LinkData):
    """
    *(extends* :py:class:`v1_11_20.web.vo.LinkData` *)* SAP ASE specific
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "load_backup_path" == "type" or (self.load_backup_path is not self.__undef__ and (not (dirty and not self._load_backup_path[1]) or self.is_dirty_list(self.load_backup_path, self._load_backup_path) or belongs_to_parent)):
            dct["loadBackupPath"] = dictify(self.load_backup_path)
        if "load_location" == "type" or (self.load_location is not self.__undef__ and (not (dirty and not self._load_location[1]) or self.is_dirty_list(self.load_location, self._load_location) or belongs_to_parent)):
            dct["loadLocation"] = dictify(self.load_location)
        if "dump_credentials" == "type" or (self.dump_credentials is not self.__undef__ and (not (dirty and not self._dump_credentials[1]) or self.is_dirty_list(self.dump_credentials, self._dump_credentials) or belongs_to_parent)):
        ...
        if "staging_operations" == "type" or (self.staging_operations is not self.__undef__ and (not (dirty and not self._staging_operations[1]) or self.is_dirty_list(self.staging_operations, self._staging_operations) or belongs_to_parent)):
        ...
        if "dump_history_file_enabled" == "type" or (self.dump_history_file_enabled is not self.__undef__ and (not (dirty and not self._dump_history_file_enabled[1]) or self.is_dirty_list(self.dump_history_file_enabled, self._dump_history_file_enabled) or belongs_to_parent)):
    ...
    def is_dirty(self):
        return any([self._config[1], self._external_file_path[1], self._operations[1], self._mount_base[1], self._load_backup_path[1], self._load_location[1], self._dump_credentials[1], self._source_host_user[1], self._db_user[1], self._db_credentials[1], self._staging_repository[1], self._staging_host_user[1], self._staging_operations[1], self._sync_parameters[1], self._validated_sync_mode[1], self._dump_history_file_enabled[1]])
    ...
    def operations(self):
        ...
        :rtype: :py:class:`v1_11_20.web.vo.LinkedSourceOperations`
        """
    ...
    def load_location(self):
        ...
        :rtype: :py:class:`v1_11_20.web.vo.ASEBackupLocation`
        """
    ...
    def db_credentials(self):
        ...
        :rtype: :py:class:`v1_11_20.web.vo.Credential`
        """
    ...
    def staging_operations(self):
        ...
        :rtype: :py:class:`v1_11_20.web.vo.StagingSourceOperations`
        """
    ...
    def sync_parameters(self):
        ...
        :rtype: :py:class:`v1_11_20.web.vo.ASESyncParameters`
        """
