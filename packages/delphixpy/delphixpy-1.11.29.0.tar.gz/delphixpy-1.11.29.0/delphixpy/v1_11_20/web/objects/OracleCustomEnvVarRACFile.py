...
from delphixpy.v1_11_20.web.objects.OracleCustomEnvVarFile import OracleCustomEnvVarFile
...
class OracleCustomEnvVarRACFile(OracleCustomEnvVarFile):
    """
    *(extends* :py:class:`v1_11_20.web.vo.OracleCustomEnvVarFile` *)* Dictates
