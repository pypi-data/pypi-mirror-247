...
from delphixpy.v1_11_20.web.objects.AttachData import AttachData
...
class ASEAttachData(AttachData):
    """
    *(extends* :py:class:`v1_11_20.web.vo.AttachData` *)* Represents the SAP
