...
from delphixpy.v1_11_20.web.objects.AppDataSource import AppDataSource
...
class AppDataLinkedSource(AppDataSource):
    """
    *(extends* :py:class:`v1_11_20.web.vo.AppDataSource` *)* Base AppData
    linked source.
    """
    ...
    def is_dirty(self):
        return any([self._config[1], self._operations[1], self._parameters[1], self._locked[1]])
