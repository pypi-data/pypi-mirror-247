...
class AlertProfile(PersistentObject):
    """
    *(extends* :py:class:`v1_11_20.web.vo.PersistentObject` *)* A profile that
    ...
    def filter_spec(self):
        ...
        :rtype: :py:class:`v1_11_20.web.vo.AlertFilter`
        """
    ...
    def actions(self):
        ...
        :rtype: ``list`` of :py:class:`v1_11_20.web.vo.AlertAction`
        """
