...
class SystemVersion(NamedUserObject):
    """
    *(extends* :py:class:`v1_11_20.web.vo.NamedUserObject` *)* Describes a
    ...
    def __init__(self, undef_enabled=True):
        ...
        self._hotfix_version = (self.__undef__, True)
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        obj._hotfix_version = (data.get("hotfixVersion", obj.__undef__), dirty)
        if obj._hotfix_version[0] is not None and obj._hotfix_version[0] is not obj.__undef__:
            assert isinstance(obj._hotfix_version[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._hotfix_version[0], type(obj._hotfix_version[0])))
            common.validate_format(obj._hotfix_version[0], "None", None, None)
        return obj
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "hotfix_version" == "type" or (self.hotfix_version is not self.__undef__ and (not (dirty and not self._hotfix_version[1]))):
            dct["hotfixVersion"] = dictify(self.hotfix_version)
        return dct
    ...
    def force_dirty(self):
        ...
        self._hotfix_version = (self._hotfix_version[0], True)

    def is_dirty(self):
        return any([self._version[1], self._status[1], self._min_version[1], self._min_reboot_optional_version[1], self._build_date[1], self._install_date[1], self._verify_date[1], self._verification_version[1], self._hotfix_version[1]])
    ...
    @property
    def hotfix_version(self):
        """
        The hotfix version.

        :rtype: ``str``
        """
        return self._hotfix_version[0]

    @hotfix_version.setter
    def hotfix_version(self, value):
        self._hotfix_version = (value, True)
