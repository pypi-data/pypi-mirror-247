...
#     /delphix-js-bookmark-tag-capacity-data.json
#
...
class JSBookmarkTagCapacityData(TypedObject):
    """
    *(extends* :py:class:`v1_4_2.web.vo.TypedObject` *)* The capacity
    ...
    def __init__(self, undef_enabled=True):
        super().__init__()
        self._type = ("JSBookmarkTagCapacityData", True)
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._bookmark_tag[0] is not None and obj._bookmark_tag[0] is not obj.__undef__:
            assert isinstance(obj._bookmark_tag[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._bookmark_tag[0], type(obj._bookmark_tag[0])))
    ...
    def is_dirty(self):
        return any([self._bookmark_tag[1], self._referenced[1], self._unique[1]])
    ...
    def __eq__(self, other):
        if other is None:
            return False
        if not isinstance(other, JSBookmarkTagCapacityData):
            return False
    ...
    def referenced(self):
        """
        The amount of total space referenced by bookmarks with this tag.
