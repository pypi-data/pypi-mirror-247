...
class JSUserPreferences(PersistentObject):
    """
    *(extends* :py:class:`v1_4_2.web.vo.PersistentObject` *)* A Jet Stream
    user's preferences.
    """
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        def dictify(obj, prop_is_list_or_vo=False):
            if isinstance(obj, list):
                ...
                return obj
        if "breakdowns" == "type" or (self.breakdowns is not self.__undef__ and (not (dirty and not self._breakdowns[1]) or self.is_dirty_list(self.breakdowns, self._breakdowns) or belongs_to_parent)):
