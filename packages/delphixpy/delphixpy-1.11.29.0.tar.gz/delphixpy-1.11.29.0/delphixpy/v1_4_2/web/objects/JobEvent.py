...
class JobEvent(TypedObject):
    """
    *(extends* :py:class:`v1_4_2.web.vo.TypedObject` *)* Represents a job event
    ...
    def is_dirty(self):
        return any([self._message_action[1], self._message_code[1], self._message_command_output[1], self._message_details[1], self._percent_complete[1], self._state[1], self._timestamp[1]])
