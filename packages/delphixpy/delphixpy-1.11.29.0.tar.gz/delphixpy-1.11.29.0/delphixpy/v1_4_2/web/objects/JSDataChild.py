...
class JSDataChild(TypedObject):
    """
    *(extends* :py:class:`v1_4_2.web.vo.TypedObject` *)* A branch with data
    ...
    def is_dirty(self):
        return any([self._branch[1], self._branch_name[1], self._operation[1], self._user_name[1]])
    ...
    def branch(self):
        """
        Reference to the branch. This will be null if the user doesn't have
