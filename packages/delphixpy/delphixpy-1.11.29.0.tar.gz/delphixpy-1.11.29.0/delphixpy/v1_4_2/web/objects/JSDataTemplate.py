...
from delphixpy.v1_4_2.web.objects.JSDataLayout import JSDataLayout
...
class JSDataTemplate(JSDataLayout):
    """
    *(extends* :py:class:`v1_4_2.web.vo.JSDataLayout` *)* An data template is a
    collection of data sourcess and configuration representing a data layout
