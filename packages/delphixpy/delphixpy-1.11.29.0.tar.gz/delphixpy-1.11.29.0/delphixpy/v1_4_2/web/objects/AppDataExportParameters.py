...
from delphixpy.v1_4_2.web.objects.ExportParameters import ExportParameters
...
class AppDataExportParameters(ExportParameters):
    """
    *(extends* :py:class:`v1_4_2.web.vo.ExportParameters` *)* The parameters to
    ...
    def filesystem_layout(self):
        ...
        :rtype: :py:class:`v1_4_2.web.vo.AppDataFilesystemLayout`
        """
    ...
    def source_config(self):
        ...
        :rtype: :py:class:`v1_4_2.web.vo.AppDataSourceConfig`
        """
