...
class Job(NamedUserObject):
    """
    *(extends* :py:class:`v1_4_2.web.vo.NamedUserObject` *)* Represents a job
    object
    """
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._job_state[0] is not None and obj._job_state[0] is not obj.__undef__:
            ...
            assert obj._job_state[0] in ['INITIAL', 'RUNNING', 'SUSPENDED', 'CANCELED', 'COMPLETED', 'FAILED'], "Expected enum ['INITIAL', 'RUNNING', 'SUSPENDED', 'CANCELED', 'COMPLETED', 'FAILED'] but got %s" % obj._job_state[0]
    ...
    def is_dirty(self):
        return any([self._action_type[1], self._cancelable[1], self._email_addresses[1], self._events[1], self._job_state[1], self._parent_action[1], self._parent_action_state[1], self._percent_complete[1], self._start_time[1], self._suspendable[1], self._target[1], self._target_name[1], self._target_object_type[1], self._title[1], self._update_time[1], self._user[1]])
    ...
    def events(self):
        ...
        :rtype: ``list`` of :py:class:`v1_4_2.web.vo.JobEvent`
        """
