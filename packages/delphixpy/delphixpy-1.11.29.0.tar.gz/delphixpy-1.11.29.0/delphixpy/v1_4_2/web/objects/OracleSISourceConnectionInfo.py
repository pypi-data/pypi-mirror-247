...
from delphixpy.v1_4_2.web.objects.OracleSourceConnectionInfo import OracleSourceConnectionInfo
...
class OracleSISourceConnectionInfo(OracleSourceConnectionInfo):
    """
    *(extends* :py:class:`v1_4_2.web.vo.OracleSourceConnectionInfo` *)*
