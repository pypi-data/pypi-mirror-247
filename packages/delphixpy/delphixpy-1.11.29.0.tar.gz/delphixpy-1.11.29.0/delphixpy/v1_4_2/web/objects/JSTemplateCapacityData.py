...
#     /delphix-js-template-capacity-data.json
#
...
class JSTemplateCapacityData(TypedObject):
    """
    *(extends* :py:class:`v1_4_2.web.vo.TypedObject` *)* The capacity
    ...
    def __init__(self, undef_enabled=True):
        super().__init__()
        self._type = ("JSTemplateCapacityData", True)
    ...
    def is_dirty(self):
        return any([self._bookmarks[1], self._containers[1], self._template[1], self._unvirtualized[1]])
    ...
    def __eq__(self, other):
        if other is None:
            return False
        if not isinstance(other, JSTemplateCapacityData):
            return False
    ...
    def containers(self):
        ...
        of those data containers were purged.
    ...
    def template(self):
        """
        The data template that this capacity information is for.
