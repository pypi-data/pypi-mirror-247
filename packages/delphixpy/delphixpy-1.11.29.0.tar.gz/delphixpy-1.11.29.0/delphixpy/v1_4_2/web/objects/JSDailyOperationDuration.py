...
from delphixpy.v1_4_2.web.objects.JSUsageData import JSUsageData
...
class JSDailyOperationDuration(JSUsageData):
    """
    *(extends* :py:class:`v1_4_2.web.vo.JSUsageData` *)* Information about the
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._operation[0] is not None and obj._operation[0] is not obj.__undef__:
            ...
            assert obj._operation[0] in ['REFRESH', 'RESET', 'CREATE_BRANCH', 'RESTORE'], "Expected enum ['REFRESH', 'RESET', 'CREATE_BRANCH', 'RESTORE'] but got %s" % obj._operation[0]
    ...
    def is_dirty(self):
        return any([self._daily_average_duration[1], self._daily_count[1], self._daily_max_duration[1], self._daily_min_duration[1], self._operation[1]])
    ...
    def __eq__(self, other):
        ...
        return super().__eq__(other) and \
               ...
               self.daily_max_duration == other.daily_max_duration and \
