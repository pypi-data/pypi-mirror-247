...
from delphixpy.v1_4_2.web.objects.SourceEnvironmentCreateParameters import SourceEnvironmentCreateParameters
...
class OracleClusterCreateParameters(SourceEnvironmentCreateParameters):
    """
    *(extends* :py:class:`v1_4_2.web.vo.SourceEnvironmentCreateParameters` *)*
    ...
    def cluster(self):
        ...
        :rtype: :py:class:`v1_4_2.web.vo.OracleCluster`
        """
