...
def get_all(engine, end_date=None, group=None, start_date=None):
    """
    ...
    :type start_date: ``str``
    :rtype: ``list`` of :py:class:`v1_4_2.web.vo.HistoricalGroupCapacityData`
    """
    url = "/resources/json/delphix/capacity/group/historical"
    query_params = {"endDate": end_date, "group": group, "startDate": start_date}
