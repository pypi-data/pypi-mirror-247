...
from delphixpy.v1_10_0.web.objects.X500DistinguishedName import X500DistinguishedName
...
class X500DistinguishedNameComposite(X500DistinguishedName):
    """
    *(extends* :py:class:`v1_10_0.web.vo.X500DistinguishedName` *)* The
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._dname[0] is not None and obj._dname[0] is not obj.__undef__:
            assert isinstance(obj._dname[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._dname[0], type(obj._dname[0])))
            common.validate_format(obj._dname[0], "None", None, None)
        return obj
