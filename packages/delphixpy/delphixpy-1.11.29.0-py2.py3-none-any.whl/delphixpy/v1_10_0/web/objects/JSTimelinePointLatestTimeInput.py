...
from delphixpy.v1_10_0.web.objects.JSTimelinePointTimeParameters import JSTimelinePointTimeParameters
...
class JSTimelinePointLatestTimeInput(JSTimelinePointTimeParameters):
    """
    *(extends* :py:class:`v1_10_0.web.vo.JSTimelinePointTimeParameters` *)*
