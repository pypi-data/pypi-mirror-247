...
class OracleSnapshot(TimeflowSnapshot):
    """
    *(extends* :py:class:`v1_10_0.web.vo.TimeflowSnapshot` *)* Provisionable
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_10_0.web.vo.OracleSnapshotRuntime`
        """
    ...
    def first_change_point(self):
        ...
        :rtype: :py:class:`v1_10_0.web.vo.OracleTimeflowPoint`
        """
