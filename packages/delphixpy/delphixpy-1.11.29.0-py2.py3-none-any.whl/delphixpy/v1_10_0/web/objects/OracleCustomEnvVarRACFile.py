...
from delphixpy.v1_10_0.web.objects.OracleCustomEnvVarFile import OracleCustomEnvVarFile
...
class OracleCustomEnvVarRACFile(OracleCustomEnvVarFile):
    """
    *(extends* :py:class:`v1_10_0.web.vo.OracleCustomEnvVarFile` *)* Dictates
