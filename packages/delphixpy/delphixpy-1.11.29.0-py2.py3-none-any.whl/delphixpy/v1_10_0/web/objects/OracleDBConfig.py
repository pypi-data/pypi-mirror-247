...
from delphixpy.v1_10_0.web.objects.OracleBaseDBConfig import OracleBaseDBConfig
...
class OracleDBConfig(OracleBaseDBConfig):
    """
    *(extends* :py:class:`v1_10_0.web.vo.OracleBaseDBConfig` *)* The source
    ...
    def is_dirty(self):
        return any([self._database_name[1], self._unique_name[1], self._cdb_type[1], self._repository[1], self._non_sys_user[1], self._non_sys_credentials[1]])
