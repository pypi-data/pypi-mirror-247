...
from delphixpy.v1_10_0.web.objects.PgSQLSource import PgSQLSource
...
class PgSQLVirtualSource(PgSQLSource):
    """
    *(extends* :py:class:`v1_10_0.web.vo.PgSQLSource` *)* A virtual PostgreSQL
    source.
    """
    ...
    def hba_entries(self):
        ...
        :rtype: ``list`` of :py:class:`v1_10_0.web.vo.PgSQLHBAEntry`
        """
    ...
    def ident_entries(self):
        ...
        :rtype: ``list`` of :py:class:`v1_10_0.web.vo.PgSQLIdentEntry`
        """
