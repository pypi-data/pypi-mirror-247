...
from delphixpy.v1_10_0.web.objects.MySQLExistingBackupSyncParameters import MySQLExistingBackupSyncParameters
...
class MySQLExistingMySQLDumpSyncParameters(MySQLExistingBackupSyncParameters):
    """
    *(extends* :py:class:`v1_10_0.web.vo.MySQLExistingBackupSyncParameters` *)*
