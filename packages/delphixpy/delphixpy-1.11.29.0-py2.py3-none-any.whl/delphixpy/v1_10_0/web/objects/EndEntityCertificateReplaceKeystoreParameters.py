...
from delphixpy.v1_10_0.web.objects.EndEntityCertificateReplaceParameters import EndEntityCertificateReplaceParameters
...
class EndEntityCertificateReplaceKeystoreParameters(EndEntityCertificateReplaceParameters):
    """
    *(extends* :py:class:`v1_10_0.web.vo.EndEntityCertificateReplaceParameters`
    *)* The parameters for replacing an end-entity certificate with a
