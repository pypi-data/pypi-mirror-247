...
from delphixpy.v1_10_0.web.objects.VMwareSource import VMwareSource
...
class VMwareVirtualSource(VMwareSource):
    """
    *(extends* :py:class:`v1_10_0.web.vo.VMwareSource` *)* A virtual VMware
    source.
    """
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_10_0.web.vo.VMwareSourceRuntime`
        """
