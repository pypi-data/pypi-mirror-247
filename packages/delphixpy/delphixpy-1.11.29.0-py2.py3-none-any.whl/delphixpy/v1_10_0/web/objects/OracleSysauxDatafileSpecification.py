...
from delphixpy.v1_10_0.web.objects.OracleDatafileTempfileSpecification import OracleDatafileTempfileSpecification
...
class OracleSysauxDatafileSpecification(OracleDatafileTempfileSpecification):
    """
    *(extends* :py:class:`v1_10_0.web.vo.OracleDatafileTempfileSpecification`
