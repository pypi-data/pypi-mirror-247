...
from delphixpy.v1_10_0.web.objects.SourceRepository import SourceRepository
...
class MSSqlRepository(SourceRepository):
    """
    *(extends* :py:class:`v1_10_0.web.vo.SourceRepository` *)* The SQL Server
    source repository.
    """
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        def dictify(obj, prop_is_list_or_vo=False):
            if isinstance(obj, list):
                ...
                return obj
        if "internal_version" == "type" or (self.internal_version is not self.__undef__ and (not (dirty and not self._internal_version[1]) or self.is_dirty_list(self.internal_version, self._internal_version) or belongs_to_parent)):
