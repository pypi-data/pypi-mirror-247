...
def create(engine, host_privilege_elevation_profile_script=None):
    ...
    :type host_privilege_elevation_profile_script:
        :py:class:`v1_11_22.web.vo.HostPrivilegeElevationProfileScript`
    :rtype: ``str``
    """
...
def get(engine, ref):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_11_22.delphix_engine.DelphixEngine`
    :param ref: Reference to a :py:class:`delphixpy.v1_11_22.web.objects.HostPr
        ivilegeElevationProfileScript.HostPrivilegeElevationProfileScript`
        object
    :type ref: ``str``
    :rtype: :py:class:`v1_11_22.web.vo.HostPrivilegeElevationProfileScript`
    """
