...
def create(engine, static_host_address=None):
    ...
    :type static_host_address: :py:class:`v1_11_22.web.vo.StaticHostAddress`
    :rtype: ``str``
    """
...
def get(engine, ref):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_11_22.delphix_engine.DelphixEngine`
    :param ref: Reference to a :py:class:`delphixpy.v1_11_22.web.objects.Static
        HostAddress.StaticHostAddress` object
    :type ref: ``str``
    :rtype: :py:class:`v1_11_22.web.vo.StaticHostAddress`
    """
...
def get_all(engine):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_11_22.delphix_engine.DelphixEngine`
    :rtype: ``list`` of :py:class:`v1_11_22.web.vo.StaticHostAddress`
    """
    url = "/resources/json/delphix/service/host/address"
    response = engine.get(url)
    result = response_validator.validate(response, engine)
