...
def create(engine, js_bookmark_create_parameters):
    ...
    :type js_bookmark_create_parameters:
        :py:class:`v1_11_22.web.vo.JSBookmarkCreateParameters`
    :rtype: ``str``
    """
...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_11_22.web.objects.JSBookmark.JSBookmark` object
    :type ref: ``str``
    :rtype: :py:class:`v1_11_22.web.vo.JSBookmark`
    """
...
def get_all(engine, container=None, template=None):
    ...
    :type template: ``str``
    :rtype: ``list`` of :py:class:`v1_11_22.web.vo.JSBookmark`
    """
    url = "/resources/json/delphix/selfservice/bookmark"
...
def update(engine, ref, js_bookmark=None):
    ...
    :type js_bookmark: :py:class:`v1_11_22.web.vo.JSBookmark`
    """
    url = "/resources/json/delphix/selfservice/bookmark/%s" % ref
...
def get_create_bookmark_operation(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_11_22.web.objects.JSBookmark.JSBookmark` object
    :type ref: ``str``
    :rtype: :py:class:`v1_11_22.web.vo.JSOperation`
    """
...
def list_data_children(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_11_22.web.objects.JSBookmark.JSBookmark` object
    :type ref: ``str``
    :rtype: ``list`` of :py:class:`v1_11_22.web.vo.JSDataChild`
    """
