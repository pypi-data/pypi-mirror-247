...
from delphixpy.v1_11_22.web.objects.SourceConfig import SourceConfig
...
class ASEDBConfig(SourceConfig):
    """
    *(extends* :py:class:`v1_11_22.web.vo.SourceConfig` *)* A SAP ASE Database
    Config.
    """
    ...
    def is_dirty(self):
        return any([self._database_name[1], self._user[1], self._credentials[1], self._repository[1]])
