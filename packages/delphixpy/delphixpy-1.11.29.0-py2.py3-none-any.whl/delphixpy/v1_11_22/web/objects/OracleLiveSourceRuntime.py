...
from delphixpy.v1_11_22.web.objects.OracleBaseSourceRuntime import OracleBaseSourceRuntime
...
class OracleLiveSourceRuntime(OracleBaseSourceRuntime):
    """
    *(extends* :py:class:`v1_11_22.web.vo.OracleBaseSourceRuntime` *)* Runtime
