...
from delphixpy.v1_11_22.web.objects.PasswordVault import PasswordVault
...
class AzureVault(PasswordVault):
    """
    *(extends* :py:class:`v1_11_22.web.vo.PasswordVault` *)* Azure password
    vault configuration.
    """
    ...
    def azure_authentication(self):
        ...
        :rtype: :py:class:`v1_11_22.web.vo.AzureAuthentication`
        """
