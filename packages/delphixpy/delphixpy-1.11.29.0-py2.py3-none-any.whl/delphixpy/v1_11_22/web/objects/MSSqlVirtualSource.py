...
from delphixpy.v1_11_22.web.objects.MSSqlSource import MSSqlSource
...
class MSSqlVirtualSource(MSSqlSource):
    """
    *(extends* :py:class:`v1_11_22.web.vo.MSSqlSource` *)* A virtual MSSQL
    source.
    """
    ...
    def is_dirty(self):
        return any([self._pre_script[1], self._post_script[1], self._operations[1], self._mount_base[1], self._file_mapping_rules[1], self._config_template[1], self._config_params[1], self._allow_auto_vdb_restart_on_host_reboot[1], self._enable_cdc_on_provision[1], self._config[1]])
