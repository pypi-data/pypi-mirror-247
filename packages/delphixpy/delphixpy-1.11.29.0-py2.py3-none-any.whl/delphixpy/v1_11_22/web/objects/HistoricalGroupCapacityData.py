...
from delphixpy.v1_11_22.web.objects.BaseGroupCapacityData import BaseGroupCapacityData
...
class HistoricalGroupCapacityData(BaseGroupCapacityData):
    """
    *(extends* :py:class:`v1_11_22.web.vo.BaseGroupCapacityData` *)* Historical
