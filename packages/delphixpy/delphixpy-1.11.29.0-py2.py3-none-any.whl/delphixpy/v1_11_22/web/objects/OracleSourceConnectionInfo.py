...
from delphixpy.v1_11_22.web.objects.SourceConnectionInfo import SourceConnectionInfo
...
class OracleSourceConnectionInfo(SourceConnectionInfo):
    """
    *(extends* :py:class:`v1_11_22.web.vo.SourceConnectionInfo` *)* Contains
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._oracle_home[0] is not None and obj._oracle_home[0] is not obj.__undef__:
            assert isinstance(obj._oracle_home[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._oracle_home[0], type(obj._oracle_home[0])))
    ...
    def is_dirty(self):
        return any([self._database_name[1], self._oracle_home[1], self._jdbc_strings[1]])
    ...
    def __eq__(self, other):
        ...
        return super().__eq__(other) and \
               ...
               self.jdbc_strings == other.jdbc_strings
