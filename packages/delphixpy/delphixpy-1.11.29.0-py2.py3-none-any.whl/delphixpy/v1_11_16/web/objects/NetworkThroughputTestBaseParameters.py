...
from delphixpy.v1_11_16.web.objects.NetworkTestParameters import NetworkTestParameters
...
class NetworkThroughputTestBaseParameters(NetworkTestParameters):
    """
    *(extends* :py:class:`v1_11_16.web.vo.NetworkTestParameters` *)* Base type
