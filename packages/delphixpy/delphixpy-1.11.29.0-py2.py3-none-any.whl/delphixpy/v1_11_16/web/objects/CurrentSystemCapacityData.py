...
from delphixpy.v1_11_16.web.objects.BaseSystemCapacityData import BaseSystemCapacityData
...
class CurrentSystemCapacityData(BaseSystemCapacityData):
    """
    *(extends* :py:class:`v1_11_16.web.vo.BaseSystemCapacityData` *)* Capacity
