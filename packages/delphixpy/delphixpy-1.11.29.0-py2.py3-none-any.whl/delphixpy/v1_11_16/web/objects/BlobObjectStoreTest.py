...
#     /delphix-blob-object-store-test.json
#
# Do not edit this file manually!
#

from delphixpy.v1_11_16.web.objects.ObjectStoreTest import ObjectStoreTest
...
class BlobObjectStoreTest(ObjectStoreTest):
    """
    *(extends* :py:class:`v1_11_16.web.vo.ObjectStoreTest` *)* An Azure blob
    object store connectivity test object.
    """
    def __init__(self, undef_enabled=True):
        super().__init__()
        self._type = ("BlobObjectStoreTest", True)
    ...
    def __eq__(self, other):
        if other is None:
            return False
        if not isinstance(other, BlobObjectStoreTest):
            return False
    ...
    def access_credentials(self):
        ...
        :rtype: :py:class:`v1_11_16.web.vo.BlobObjectStoreAccess`
        """
