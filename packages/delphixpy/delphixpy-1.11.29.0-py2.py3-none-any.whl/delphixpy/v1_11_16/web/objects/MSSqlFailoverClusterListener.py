...
from delphixpy.v1_11_16.web.objects.MSSqlBaseClusterListener import MSSqlBaseClusterListener
...
class MSSqlFailoverClusterListener(MSSqlBaseClusterListener):
    """
    *(extends* :py:class:`v1_11_16.web.vo.MSSqlBaseClusterListener` *)* The
