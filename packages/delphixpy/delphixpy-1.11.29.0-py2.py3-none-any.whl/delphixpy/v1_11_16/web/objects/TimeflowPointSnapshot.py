...
from delphixpy.v1_11_16.web.objects.TimeflowPointParameters import TimeflowPointParameters
...
class TimeflowPointSnapshot(TimeflowPointParameters):
    """
    *(extends* :py:class:`v1_11_16.web.vo.TimeflowPointParameters` *)* TimeFlow
