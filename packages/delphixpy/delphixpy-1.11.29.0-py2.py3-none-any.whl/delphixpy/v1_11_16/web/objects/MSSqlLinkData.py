...
class MSSqlLinkData(LinkData):
    """
    *(extends* :py:class:`v1_11_16.web.vo.LinkData` *)* MSSQL specific
    ...
    def sync_parameters(self):
        ...
        :rtype: :py:class:`v1_11_16.web.vo.MSSqlSyncParameters`
        """
    ...
    def sync_strategy(self):
        ...
        :rtype: :py:class:`v1_11_16.web.vo.MSSqlSyncStrategy`
        """
