...
from delphixpy.v1_11_16.web.objects.MSSqlSourceSyncStrategy import MSSqlSourceSyncStrategy
...
class MSSqlExternalManagedSourceSyncStrategy(MSSqlSourceSyncStrategy):
    """
    *(extends* :py:class:`v1_11_16.web.vo.MSSqlSourceSyncStrategy` *)* MSSQL
    ...
    def mssql_netbackup_config(self):
        ...
        :rtype: :py:class:`v1_11_16.web.vo.MSSqlNetbackupConfig`
        """
    ...
    def mssql_commvault_config(self):
        ...
        :rtype: :py:class:`v1_11_16.web.vo.MSSqlCommvaultConfig`
        """
