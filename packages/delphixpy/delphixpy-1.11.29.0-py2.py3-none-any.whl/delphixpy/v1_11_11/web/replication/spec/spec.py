...
def create(engine, replication_spec=None):
    ...
    :type replication_spec: :py:class:`v1_11_11.web.vo.ReplicationSpec`
    :rtype: ``str``
    """
...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_11_11.web.objects.ReplicationSpec.ReplicationSp
        ec` object
    :type ref: ``str``
    :rtype: :py:class:`v1_11_11.web.vo.ReplicationSpec`
    """
...
def get_all(engine):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_11_11.delphix_engine.DelphixEngine`
    :rtype: ``list`` of :py:class:`v1_11_11.web.vo.ReplicationSpec`
    """
    url = "/resources/json/delphix/replication/spec"
    response = engine.get(url)
    result = response_validator.validate(response, engine)
