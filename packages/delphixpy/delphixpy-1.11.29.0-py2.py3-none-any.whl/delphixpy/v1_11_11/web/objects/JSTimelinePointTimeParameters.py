...
from delphixpy.v1_11_11.web.objects.JSTimelinePointParameters import JSTimelinePointParameters
...
class JSTimelinePointTimeParameters(JSTimelinePointParameters):
    """
    *(extends* :py:class:`v1_11_11.web.vo.JSTimelinePointParameters` *)*
