...
class Source(UserObject):
    """
    *(extends* :py:class:`v1_11_11.web.vo.UserObject` *)* A source represents
    ...
    def is_dirty(self):
        return any([self._description[1], self._linked[1], self._virtual[1], self._staging[1], self._container[1], self._status[1], self._runtime[1], self._hosts[1], self._log_collection_enabled[1]])
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_11_11.web.vo.SourceRuntime`
        """
