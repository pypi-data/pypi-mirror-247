...
from delphixpy.v1_11_11.web.objects.BasePlatformParameters import BasePlatformParameters
...
class AppDataPlatformParameters(BasePlatformParameters):
    """
    *(extends* :py:class:`v1_11_11.web.vo.BasePlatformParameters` *)* AppData
