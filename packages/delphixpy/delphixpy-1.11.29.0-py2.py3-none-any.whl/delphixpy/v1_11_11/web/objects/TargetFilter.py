...
from delphixpy.v1_11_11.web.objects.AlertFilter import AlertFilter
...
class TargetFilter(AlertFilter):
    """
    *(extends* :py:class:`v1_11_11.web.vo.AlertFilter` *)* An alert filter that
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        def dictify(obj, prop_is_list_or_vo=False):
            if isinstance(obj, list):
                ...
                return obj
        if "targets" == "type" or (self.targets is not self.__undef__ and (not (dirty and not self._targets[1]) or self.is_dirty_list(self.targets, self._targets) or belongs_to_parent)):
