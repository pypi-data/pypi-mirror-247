...
from delphixpy.v1_11_11.web.objects.BaseSystemCapacityData import BaseSystemCapacityData
...
class CurrentSystemCapacityData(BaseSystemCapacityData):
    """
    *(extends* :py:class:`v1_11_11.web.vo.BaseSystemCapacityData` *)* Capacity
