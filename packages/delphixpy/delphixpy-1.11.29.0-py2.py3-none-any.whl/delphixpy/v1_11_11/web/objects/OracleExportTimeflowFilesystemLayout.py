...
from delphixpy.v1_11_11.web.objects.TimeflowFilesystemLayout import TimeflowFilesystemLayout
...
class OracleExportTimeflowFilesystemLayout(TimeflowFilesystemLayout):
    """
    *(extends* :py:class:`v1_11_11.web.vo.TimeflowFilesystemLayout` *)* A
