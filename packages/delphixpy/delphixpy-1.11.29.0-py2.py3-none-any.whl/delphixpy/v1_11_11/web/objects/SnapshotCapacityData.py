...
class SnapshotCapacityData(TypedObject):
    """
    *(extends* :py:class:`v1_11_11.web.vo.TypedObject` *)* Capacity metrics for
    a single snapshot.
    """
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._snapshot[0] is not None and obj._snapshot[0] is not obj.__undef__:
            assert isinstance(obj._snapshot[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._snapshot[0], type(obj._snapshot[0])))
        ...
        if obj._snapshot_timestamp[0] is not None and obj._snapshot_timestamp[0] is not obj.__undef__:
            assert isinstance(obj._snapshot_timestamp[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._snapshot_timestamp[0], type(obj._snapshot_timestamp[0])))
        ...
        if obj._namespace[0] is not None and obj._namespace[0] is not obj.__undef__:
            assert isinstance(obj._namespace[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._namespace[0], type(obj._namespace[0])))
        ...
        if obj._snapshot_timezone[0] is not None and obj._snapshot_timezone[0] is not obj.__undef__:
            assert isinstance(obj._snapshot_timezone[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._snapshot_timezone[0], type(obj._snapshot_timezone[0])))
        ...
        if obj._snapshot_latest_change[0] is not None and obj._snapshot_latest_change[0] is not obj.__undef__:
            assert isinstance(obj._snapshot_latest_change[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._snapshot_latest_change[0], type(obj._snapshot_latest_change[0])))
