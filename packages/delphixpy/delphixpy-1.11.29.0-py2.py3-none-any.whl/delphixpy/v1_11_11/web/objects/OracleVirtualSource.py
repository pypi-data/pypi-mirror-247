...
from delphixpy.v1_11_11.web.objects.OracleManagedSource import OracleManagedSource
...
class OracleVirtualSource(OracleManagedSource):
    """
    *(extends* :py:class:`v1_11_11.web.vo.OracleManagedSource` *)* A virtual
    Oracle source.
    """
    ...
    def operations(self):
        ...
        :rtype: :py:class:`v1_11_11.web.vo.VirtualSourceOperations`
        """
    ...
    def custom_env_vars(self):
        ...
        :rtype: ``list`` of :py:class:`v1_11_11.web.vo.OracleCustomEnvVar`
        """
