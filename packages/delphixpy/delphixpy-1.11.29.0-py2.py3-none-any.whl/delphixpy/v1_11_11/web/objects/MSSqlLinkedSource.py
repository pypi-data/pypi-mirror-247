...
class MSSqlLinkedSource(MSSqlSource):
    """
    *(extends* :py:class:`v1_11_11.web.vo.MSSqlSource` *)* A linked MSSQL
    source.
    """
    ...
    def is_dirty(self):
        return any([self._sync_strategy[1], self._operations[1], self._staging_source[1], self._encryption_key[1]])
    ...
    def sync_strategy(self):
        ...
        :rtype: :py:class:`v1_11_11.web.vo.MSSqlSyncStrategy`
        """
