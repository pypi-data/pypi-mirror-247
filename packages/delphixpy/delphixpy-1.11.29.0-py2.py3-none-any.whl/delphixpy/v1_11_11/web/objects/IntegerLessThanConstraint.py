...
from delphixpy.v1_11_11.web.objects.IntegerConstraint import IntegerConstraint
...
class IntegerLessThanConstraint(IntegerConstraint):
    """
    *(extends* :py:class:`v1_11_11.web.vo.IntegerConstraint` *)* Constraint
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._less_than[0] is not None and obj._less_than[0] is not obj.__undef__:
            assert isinstance(obj._less_than[0], int), ("Expected one of ['integer'], but got %s of type %s" % (obj._less_than[0], type(obj._less_than[0])))
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        def dictify(obj, prop_is_list_or_vo=False):
            if isinstance(obj, list):
                ...
                return obj
        if "less_than" == "type" or (self.less_than is not self.__undef__ and (not (dirty and not self._less_than[1]) or self.is_dirty_list(self.less_than, self._less_than) or belongs_to_parent)):
