...
from delphixpy.v1_11_11.web.objects.OracleBaseProvisionParameters import OracleBaseProvisionParameters
...
class OracleMultitenantProvisionParameters(OracleBaseProvisionParameters):
    """
    *(extends* :py:class:`v1_11_11.web.vo.OracleBaseProvisionParameters` *)*
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "virtual_cdb" == "type" or (self.virtual_cdb is not self.__undef__ and (not (dirty and not self._virtual_cdb[1]) or self.is_dirty_list(self.virtual_cdb, self._virtual_cdb) or belongs_to_parent)):
    ...
    def source_config(self):
        ...
        :rtype: :py:class:`v1_11_11.web.vo.OraclePDBConfig`
        """
    ...
    def source(self):
        ...
        :rtype: :py:class:`v1_11_11.web.vo.OracleVirtualPdbSource`
        """
    ...
    def virtual_cdb(self):
        ...
        :rtype: :py:class:`v1_11_11.web.vo.OracleVirtualCdbProvisionParameters`
        """
