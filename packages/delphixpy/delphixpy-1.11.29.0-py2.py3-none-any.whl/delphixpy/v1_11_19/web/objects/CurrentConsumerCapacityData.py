...
from delphixpy.v1_11_19.web.objects.BaseConsumerCapacityData import BaseConsumerCapacityData
...
class CurrentConsumerCapacityData(BaseConsumerCapacityData):
    """
    *(extends* :py:class:`v1_11_19.web.vo.BaseConsumerCapacityData` *)* Current
