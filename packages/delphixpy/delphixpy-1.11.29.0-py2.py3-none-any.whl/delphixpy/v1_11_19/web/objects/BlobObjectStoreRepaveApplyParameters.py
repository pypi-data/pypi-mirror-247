...
#     /delphix-repave-apply-parameters-azure-blob-object-store.json
#
# Do not edit this file manually!
#

from delphixpy.v1_11_19.web.objects.RepaveApplyParameters import RepaveApplyParameters
...
class BlobObjectStoreRepaveApplyParameters(RepaveApplyParameters):
    """
    *(extends* :py:class:`v1_11_19.web.vo.RepaveApplyParameters` *)* An Azure
    blob object store.
    """
    def __init__(self, undef_enabled=True):
        super().__init__()
        self._type = ("BlobObjectStoreRepaveApplyParameters", True)
    ...
    def is_dirty(self):
        return any([self._endpoint[1], self._container[1], self._access_credentials[1], self._cache_devices[1], self._domain0_pool_guid[1]])
    ...
    def __eq__(self, other):
        if other is None:
            return False
        if not isinstance(other, BlobObjectStoreRepaveApplyParameters):
            return False
    ...
    def access_credentials(self):
        ...
        :rtype: :py:class:`v1_11_19.web.vo.BlobObjectStoreAccess`
        """
