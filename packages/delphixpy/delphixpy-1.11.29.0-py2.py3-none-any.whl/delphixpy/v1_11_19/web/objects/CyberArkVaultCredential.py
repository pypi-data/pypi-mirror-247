...
from delphixpy.v1_11_19.web.objects.AbstractVaultCredential import AbstractVaultCredential
...
class CyberArkVaultCredential(AbstractVaultCredential):
    """
    *(extends* :py:class:`v1_11_19.web.vo.AbstractVaultCredential` *)* The
