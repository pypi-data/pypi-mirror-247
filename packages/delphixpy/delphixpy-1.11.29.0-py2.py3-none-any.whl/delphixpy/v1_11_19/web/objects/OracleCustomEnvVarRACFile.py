...
from delphixpy.v1_11_19.web.objects.OracleCustomEnvVarFile import OracleCustomEnvVarFile
...
class OracleCustomEnvVarRACFile(OracleCustomEnvVarFile):
    """
    *(extends* :py:class:`v1_11_19.web.vo.OracleCustomEnvVarFile` *)* Dictates
