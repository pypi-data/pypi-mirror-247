...
def get(engine):
    ...
    :rtype: :py:class:`v1_11_19.web.vo.RepaveStatus`
    """
...
def prepare(engine, repave_prepare_parameters):
    """
    Prepare repave in the source engine.

    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_11_19.delphix_engine.DelphixEngine`
    :param repave_prepare_parameters: Payload object.
    :type repave_prepare_parameters:
        :py:class:`v1_11_19.web.vo.RepavePrepareParameters`
    """
...
def apply(engine, repave_apply_parameters):
    ...
    :type repave_apply_parameters:
        :py:class:`v1_11_19.web.vo.RepaveApplyParameters`
    """
