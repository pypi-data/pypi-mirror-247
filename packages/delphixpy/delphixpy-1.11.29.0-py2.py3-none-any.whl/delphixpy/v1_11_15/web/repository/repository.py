...
Package "repository"
"""
from delphixpy.v1_11_15.web.repository import template
...
def create(engine, source_repository=None):
    ...
    :type source_repository: :py:class:`v1_11_15.web.vo.SourceRepository`
    :rtype: ``str``
    """
...
def get(engine, ref):
    ...
    :type ref: ``str``
    :rtype: :py:class:`v1_11_15.web.vo.SourceRepository`
    """
...
def get_all(engine, environment=None):
    ...
    :rtype: ``list`` of :py:class:`v1_11_15.web.vo.SourceRepository`
    """
    url = "/resources/json/delphix/repository"
...
def compatible_repositories(engine, compatible_repositories_parameters):
    ...
    :type compatible_repositories_parameters:
        :py:class:`v1_11_15.web.vo.CompatibleRepositoriesParameters`
    :rtype: :py:class:`v1_11_15.web.vo.CompatibleRepositoriesResult`
    """
