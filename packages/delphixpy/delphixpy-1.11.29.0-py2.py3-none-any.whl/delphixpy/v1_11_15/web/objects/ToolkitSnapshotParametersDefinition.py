...
#     /delphix-toolkit-snapshot-parameters-definition.json
#
...
class ToolkitSnapshotParametersDefinition(TypedObject):
    """
    *(extends* :py:class:`v1_11_15.web.vo.TypedObject` *)* Defines the snapshot
    parameters schema for a Lua toolkit.
    """
    def __init__(self, undef_enabled=True):
        super().__init__()
        self._type = ("ToolkitSnapshotParametersDefinition", True)
    ...
    def __eq__(self, other):
        if other is None:
            return False
        if not isinstance(other, ToolkitSnapshotParametersDefinition):
            return False
