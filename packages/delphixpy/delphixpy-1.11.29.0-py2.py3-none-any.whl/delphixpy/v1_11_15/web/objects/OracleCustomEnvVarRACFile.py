...
from delphixpy.v1_11_15.web.objects.OracleCustomEnvVarFile import OracleCustomEnvVarFile
...
class OracleCustomEnvVarRACFile(OracleCustomEnvVarFile):
    """
    *(extends* :py:class:`v1_11_15.web.vo.OracleCustomEnvVarFile` *)* Dictates
