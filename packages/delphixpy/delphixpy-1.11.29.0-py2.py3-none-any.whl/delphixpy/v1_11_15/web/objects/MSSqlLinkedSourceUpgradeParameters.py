...
from delphixpy.v1_11_15.web.objects.SourceUpgradeParameters import SourceUpgradeParameters
...
class MSSqlLinkedSourceUpgradeParameters(SourceUpgradeParameters):
    """
    *(extends* :py:class:`v1_11_15.web.vo.SourceUpgradeParameters` *)* The
