...
from delphixpy.v1_11_15.web.objects.BasePlatformParameters import BasePlatformParameters
...
class AppDataPlatformParameters(BasePlatformParameters):
    """
    *(extends* :py:class:`v1_11_15.web.vo.BasePlatformParameters` *)* AppData
