...
Package "environment"
"""
from delphixpy.v1_5_3.web.environment import windows
from delphixpy.v1_5_3.web.environment import oracle
from delphixpy.v1_5_3.web.environment import user
...
def create(engine, source_environment_create_parameters):
    ...
    :type source_environment_create_parameters:
        :py:class:`v1_5_3.web.vo.SourceEnvironmentCreateParameters`
    :rtype: ``str``
    """
...
def get(engine, ref):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_5_3.delphix_engine.DelphixEngine`
    :param ref: Reference to a :py:class:`delphixpy.v1_5_3.web.objects.SourceEn
        vironment.SourceEnvironment` object
    :type ref: ``str``
    :rtype: :py:class:`v1_5_3.web.vo.SourceEnvironment`
    """
...
def get_all(engine, type=None):
    ...
    :type type: ``str``
    :rtype: ``list`` of :py:class:`v1_5_3.web.vo.SourceEnvironment`
    """
    url = "/resources/json/delphix/environment"
...
def update(engine, ref, source_environment=None):
    ...
    :type source_environment: :py:class:`v1_5_3.web.vo.SourceEnvironment`
    """
    url = "/resources/json/delphix/environment/%s" % ref
