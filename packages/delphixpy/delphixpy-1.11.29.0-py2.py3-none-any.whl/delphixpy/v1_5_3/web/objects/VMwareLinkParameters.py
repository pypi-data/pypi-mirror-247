...
from delphixpy.v1_5_3.web.objects.LinkParameters import LinkParameters
...
class VMwareLinkParameters(LinkParameters):
    """
    *(extends* :py:class:`v1_5_3.web.vo.LinkParameters` *)* Represents the
    VMware specific parameters of a link request.
    """
    def __init__(self, undef_enabled=True):
        super().__init__()
        self._type = ("VMwareLinkParameters", True)
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if "source" in data and data["source"] is not None:
            obj._source = (factory.create_object(data["source"], "VMwareLinkedSource"), dirty)
            factory.validate_type(obj._source[0], "VMwareLinkedSource")
        else:
    ...
    def is_dirty(self):
        return any([self._container[1], self._environment_user[1], self._source[1]])
    ...
    def __eq__(self, other):
        if other is None:
            return False
        if not isinstance(other, VMwareLinkParameters):
            return False
    ...
    def container(self):
        ...
        :rtype: :py:class:`v1_5_3.web.vo.VMwareContainer`
        """
    ...
    def source(self):
        ...
        :rtype: :py:class:`v1_5_3.web.vo.VMwareLinkedSource`
        """
