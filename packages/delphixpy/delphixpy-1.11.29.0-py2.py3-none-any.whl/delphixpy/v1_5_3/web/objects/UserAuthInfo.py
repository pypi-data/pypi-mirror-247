...
class UserAuthInfo(TypedObject):
    """
    *(extends* :py:class:`v1_5_3.web.vo.TypedObject` *)* Summary authorization
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._provisioner_role[0] is not None and obj._provisioner_role[0] is not obj.__undef__:
            assert isinstance(obj._provisioner_role[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._provisioner_role[0], type(obj._provisioner_role[0])))
    ...
    def is_dirty(self):
        return any([self._provisioner_role[1], self._authorizations[1], self._jet_stream_user_role[1], self._owner_role[1], self._user[1]])
