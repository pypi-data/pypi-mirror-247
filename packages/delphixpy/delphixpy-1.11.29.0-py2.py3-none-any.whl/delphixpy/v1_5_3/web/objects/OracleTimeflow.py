...
from delphixpy.v1_5_3.web.objects.Timeflow import Timeflow
...
class OracleTimeflow(Timeflow):
    """
    *(extends* :py:class:`v1_5_3.web.vo.Timeflow` *)* TimeFlow representing
    ...
    def parent_point(self):
        ...
        :rtype: :py:class:`v1_5_3.web.vo.OracleTimeflowPoint`
        """
