...
class Toolkit(NamedUserObject):
    """
    *(extends* :py:class:`v1_5_3.web.vo.NamedUserObject` *)* An installed
    toolkit.
    """
    ...
    def linked_source_definition(self):
        ...
        :rtype: :py:class:`v1_5_3.web.vo.ToolkitLinkedSource`
        """
    ...
    def virtual_source_definition(self):
        ...
        :rtype: :py:class:`v1_5_3.web.vo.ToolkitVirtualSource`
        """
