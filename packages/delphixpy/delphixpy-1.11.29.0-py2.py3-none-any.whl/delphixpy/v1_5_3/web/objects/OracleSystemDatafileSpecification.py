...
from delphixpy.v1_5_3.web.objects.OracleDatafileTempfileSpecification import OracleDatafileTempfileSpecification
...
class OracleSystemDatafileSpecification(OracleDatafileTempfileSpecification):
    """
    *(extends* :py:class:`v1_5_3.web.vo.OracleDatafileTempfileSpecification`
