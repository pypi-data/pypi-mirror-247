...
from delphixpy.v1_5_3.web.objects.AttachSourceParameters import AttachSourceParameters
...
class VMwareAttachSourceParameters(AttachSourceParameters):
    """
    *(extends* :py:class:`v1_5_3.web.vo.AttachSourceParameters` *)* Represents
    ...
    def source(self):
        ...
        :rtype: :py:class:`v1_5_3.web.vo.VMwareSource`
        """
