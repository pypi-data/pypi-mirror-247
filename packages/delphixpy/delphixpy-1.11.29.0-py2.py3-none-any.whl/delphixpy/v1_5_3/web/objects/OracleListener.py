...
class OracleListener(NamedUserObject):
    """
    *(extends* :py:class:`v1_5_3.web.vo.NamedUserObject` *)* An Oracle
    listener.
    """
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "end_points" == "type" or (self.end_points is not self.__undef__ and (not (dirty and not self._end_points[1]) or self.is_dirty_list(self.end_points, self._end_points) or belongs_to_parent)):
