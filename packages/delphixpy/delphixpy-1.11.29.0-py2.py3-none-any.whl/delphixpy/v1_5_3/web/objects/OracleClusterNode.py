...
class OracleClusterNode(NamedUserObject):
    """
    *(extends* :py:class:`v1_5_3.web.vo.NamedUserObject` *)* The representation
    ...
    def is_dirty(self):
        return any([self._cluster[1], self._discovered[1], self._enabled[1], self._host[1], self._virtual_i_ps[1]])
