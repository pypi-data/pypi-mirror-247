...
def create(engine, operation_template=None):
    ...
    :type operation_template: :py:class:`v1_5_3.web.vo.OperationTemplate`
    :rtype: ``str``
    """
...
def get(engine, ref):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_5_3.delphix_engine.DelphixEngine`
    :param ref: Reference to a :py:class:`delphixpy.v1_5_3.web.objects.Operatio
        nTemplate.OperationTemplate` object
    :type ref: ``str``
    :rtype: :py:class:`v1_5_3.web.vo.OperationTemplate`
    """
...
def get_all(engine):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_5_3.delphix_engine.DelphixEngine`
    :rtype: ``list`` of :py:class:`v1_5_3.web.vo.OperationTemplate`
    """
    url = "/resources/json/delphix/source/operationTemplate"
    response = engine.get(url)
    result = response_validator.validate(response, engine)
