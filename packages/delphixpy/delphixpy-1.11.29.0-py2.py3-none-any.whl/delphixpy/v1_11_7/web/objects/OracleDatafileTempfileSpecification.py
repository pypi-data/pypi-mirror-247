...
from delphixpy.v1_11_7.web.objects.OracleFileSpecification import OracleFileSpecification
...
class OracleDatafileTempfileSpecification(OracleFileSpecification):
    """
    *(extends* :py:class:`v1_11_7.web.vo.OracleFileSpecification` *)* Describes
