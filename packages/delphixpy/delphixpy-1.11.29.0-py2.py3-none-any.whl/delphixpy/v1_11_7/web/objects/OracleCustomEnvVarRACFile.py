...
from delphixpy.v1_11_7.web.objects.OracleCustomEnvVarFile import OracleCustomEnvVarFile
...
class OracleCustomEnvVarRACFile(OracleCustomEnvVarFile):
    """
    *(extends* :py:class:`v1_11_7.web.vo.OracleCustomEnvVarFile` *)* Dictates
