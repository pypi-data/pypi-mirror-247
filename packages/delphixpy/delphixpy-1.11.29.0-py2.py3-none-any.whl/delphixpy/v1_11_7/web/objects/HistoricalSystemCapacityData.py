...
from delphixpy.v1_11_7.web.objects.BaseSystemCapacityData import BaseSystemCapacityData
...
class HistoricalSystemCapacityData(BaseSystemCapacityData):
    """
    *(extends* :py:class:`v1_11_7.web.vo.BaseSystemCapacityData` *)* Capacity
