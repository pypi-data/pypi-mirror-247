...
def get(engine, ref):
    ...
    :param ref: Reference to a :py:class:`delphixpy.v1_11_7.web.objects.EndEnti
        tyCertificate.EndEntityCertificate` object
    :type ref: ``str``
    :rtype: :py:class:`v1_11_7.web.vo.EndEntityCertificate`
    """
...
def get_all(engine):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_11_7.delphix_engine.DelphixEngine`
    :rtype: ``list`` of :py:class:`v1_11_7.web.vo.EndEntityCertificate`
    """
...
def to_pem(engine, ref):
    ...
    :param ref: Reference to a :py:class:`delphixpy.v1_11_7.web.objects.EndEnti
        tyCertificate.EndEntityCertificate` object
    :type ref: ``str``
    :rtype: :py:class:`v1_11_7.web.vo.PemCertificate`
    """
...
def replace(engine, end_entity_certificate_replace_parameters):
    ...
    :type end_entity_certificate_replace_parameters:
        :py:class:`v1_11_7.web.vo.EndEntityCertificateReplaceParameters`
    """
...
def show_provided_certificate_chain(engine, end_entity_certificate_replace_parameters):
    ...
    :type end_entity_certificate_replace_parameters:
        :py:class:`v1_11_7.web.vo.EndEntityCertificateReplaceParameters`
    :rtype: ``list`` of :py:class:`v1_11_7.web.vo.Certificate`
    """
...
def request_key_pair_and_cert_chain_upload(engine, certificate_upload_parameters):
    ...
    :type certificate_upload_parameters:
        :py:class:`v1_11_7.web.vo.CertificateUploadParameters`
    :rtype: :py:class:`v1_11_7.web.vo.FileUploadResult`
    """
