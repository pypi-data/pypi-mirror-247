...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_11_28.web.objects.MaskingJob.MaskingJob` object
    :type ref: ``str``
    :rtype: :py:class:`v1_11_28.web.vo.MaskingJob`
    """
...
def get_all(engine, container=None):
    ...
    :param container: List only the Masking Jobs that are associated with the
        provided container.
    :type container: ``str``
    :rtype: ``list`` of :py:class:`v1_11_28.web.vo.MaskingJob`
    """
...
def update(engine, ref, masking_job=None):
    ...
    :type masking_job: :py:class:`v1_11_28.web.vo.MaskingJob`
    """
    url = "/resources/json/delphix/maskingjob/%s" % ref
