...
from delphixpy.v1_11_28.web.objects.OracleVirtualSource import OracleVirtualSource
...
class OracleVirtualCdbSource(OracleVirtualSource):
    """
    *(extends* :py:class:`v1_11_28.web.vo.OracleVirtualSource` *)* A virtual
    ...
    def custom_env_vars(self):
        ...
        :rtype: ``list`` of :py:class:`v1_11_28.web.vo.OracleCustomEnvVar`
        """
