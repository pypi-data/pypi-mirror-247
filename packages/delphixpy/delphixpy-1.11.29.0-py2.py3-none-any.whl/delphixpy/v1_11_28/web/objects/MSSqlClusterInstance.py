...
from delphixpy.v1_11_28.web.objects.MSSqlBaseClusterInstance import MSSqlBaseClusterInstance
...
class MSSqlClusterInstance(MSSqlBaseClusterInstance):
    """
    *(extends* :py:class:`v1_11_28.web.vo.MSSqlBaseClusterInstance` *)* The
