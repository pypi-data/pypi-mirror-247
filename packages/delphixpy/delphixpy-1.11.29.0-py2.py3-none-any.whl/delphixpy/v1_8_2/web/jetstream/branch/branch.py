...
def create(engine, js_branch_create_parameters):
    ...
    :type js_branch_create_parameters:
        :py:class:`v1_8_2.web.vo.JSBranchCreateParameters`
    :rtype: ``str``
    """
...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_8_2.web.objects.JSBranch.JSBranch` object
    :type ref: ``str``
    :rtype: :py:class:`v1_8_2.web.vo.JSBranch`
    """
...
def get_all(engine, data_layout=None):
    ...
    :rtype: ``list`` of :py:class:`v1_8_2.web.vo.JSBranch`
    """
    url = "/resources/json/delphix/jetstream/branch"
...
def update(engine, ref, js_branch=None):
    ...
    :type js_branch: :py:class:`v1_8_2.web.vo.JSBranch`
    """
    url = "/resources/json/delphix/jetstream/branch/%s" % ref
