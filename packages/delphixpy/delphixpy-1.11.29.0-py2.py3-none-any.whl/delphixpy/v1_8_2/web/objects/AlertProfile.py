...
class AlertProfile(PersistentObject):
    """
    *(extends* :py:class:`v1_8_2.web.vo.PersistentObject` *)* A profile that
    ...
    def is_dirty(self):
        return any([self._actions[1], self._filter_spec[1]])
    ...
    def __eq__(self, other):
        ...
        return super().__eq__(other) and \
               ...
               self.filter_spec == other.filter_spec
    ...
    def actions(self):
        ...
        :rtype: ``list`` of :py:class:`v1_8_2.web.vo.AlertAction`
        """
    ...
    def filter_spec(self):
        ...
        :rtype: :py:class:`v1_8_2.web.vo.AlertFilter`
        """
