...
from delphixpy.v1_8_2.web.objects.ASESource import ASESource
...
class ASELinkedSource(ASESource):
    """
    *(extends* :py:class:`v1_8_2.web.vo.ASESource` *)* A linked SAP ASE source.
    """
    ...
    def is_dirty(self):
        return any([self._config[1], self._dump_credentials[1], self._external_file_path[1], self._load_backup_path[1], self._load_location[1], self._operations[1], self._runtime[1], self._staging_source[1], self._validated_sync_mode[1]])
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_8_2.web.vo.ASESourceRuntime`
        """
