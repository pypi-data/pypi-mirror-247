...
class SNMPConfig(TypedObject):
    """
    *(extends* :py:class:`v1_8_2.web.vo.TypedObject` *)* SNMP configuration.
    """
    ...
    def is_dirty(self):
        return any([self._authorized_network[1], self._community[1], self._enabled[1], self._location[1], self._severity[1]])
