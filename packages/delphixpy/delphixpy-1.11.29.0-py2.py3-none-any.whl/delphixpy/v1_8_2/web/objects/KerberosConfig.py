...
class KerberosConfig(TypedObject):
    """
    *(extends* :py:class:`v1_8_2.web.vo.TypedObject` *)* Kerberos Client
    Configuration.
    """
    ...
    def is_dirty(self):
        return any([self._enabled[1], self._kdcs[1], self._keytab[1], self._principal[1], self._realm[1]])
    ...
    def kdcs(self):
        ...
        :rtype: ``list`` of :py:class:`v1_8_2.web.vo.KerberosKDC`
        """
        return self._kdcs[0]
