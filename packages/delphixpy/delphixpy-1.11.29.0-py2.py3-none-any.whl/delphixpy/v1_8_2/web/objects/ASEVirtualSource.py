...
class ASEVirtualSource(ASESource):
    """
    *(extends* :py:class:`v1_8_2.web.vo.ASESource` *)* A virtual SAP ASE
    source.
    """
    ...
    def is_dirty(self):
        return any([self._allow_auto_vdb_restart_on_host_reboot[1], self._config_params[1], self._file_mapping_rules[1], self._mount_base[1], self._operations[1], self._runtime[1]])
