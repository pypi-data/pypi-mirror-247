...
class JSDataSource(NamedUserObject):
    """
    *(extends* :py:class:`v1_8_2.web.vo.NamedUserObject` *)* The data source
    ...
    def is_dirty(self):
        return any([self._container[1], self._data_layout[1], self._description[1], self._enabled[1], self._masked[1], self._priority[1], self._properties[1], self._runtime[1]])
