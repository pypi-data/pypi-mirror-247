...
from delphixpy.v1_8_2.web.objects.CreateTransformationParameters import CreateTransformationParameters
...
class MSSqlCreateTransformationParameters(CreateTransformationParameters):
    """
    *(extends* :py:class:`v1_8_2.web.vo.CreateTransformationParameters` *)*
