...
from delphixpy.v1_8_2.web.objects.AppDataLinkData import AppDataLinkData
...
class AppDataStagedLinkData(AppDataLinkData):
    """
    *(extends* :py:class:`v1_8_2.web.vo.AppDataLinkData` *)* Represents the
    ...
    def is_dirty(self):
        return any([self._config[1], self._staging_environment[1], self._staging_environment_user[1], self._staging_mount_base[1]])
