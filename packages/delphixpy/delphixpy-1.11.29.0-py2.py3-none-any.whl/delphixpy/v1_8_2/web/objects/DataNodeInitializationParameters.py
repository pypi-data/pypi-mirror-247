...
from delphixpy.v1_8_2.web.objects.SystemInitializationParameters import SystemInitializationParameters
...
class DataNodeInitializationParameters(SystemInitializationParameters):
    """
    *(extends* :py:class:`v1_8_2.web.vo.SystemInitializationParameters` *)*
