...
class StatisticAxis(TypedObject):
    """
    *(extends* :py:class:`v1_8_2.web.vo.TypedObject` *)* The attributes of a
    statistic axis.
    """
    ...
    def is_dirty(self):
        return any([self._axis_name[1], self._constraint_type[1], self._explanation[1], self._stream_attribute[1], self._value_type[1]])
    ...
    def __eq__(self, other):
        ...
        return super().__eq__(other) and \
               ...
               self.stream_attribute == other.stream_attribute and \
