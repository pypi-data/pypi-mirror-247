    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        def dictify(obj, prop_is_list_or_vo=False):
            if isinstance(obj, list):
                ...
                return obj
        if "delete_data_sources" == "type" or (self.delete_data_sources is not self.__undef__ and (not (dirty and not self._delete_data_sources[1]) or self.is_dirty_list(self.delete_data_sources, self._delete_data_sources) or belongs_to_parent)):
