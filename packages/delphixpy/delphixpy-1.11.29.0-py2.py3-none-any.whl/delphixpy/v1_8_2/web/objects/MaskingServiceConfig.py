...
class MaskingServiceConfig(UserObject):
    """
    *(extends* :py:class:`v1_8_2.web.vo.UserObject` *)* Configuration for the
    ...
    def is_dirty(self):
        return any([self._credentials[1], self._name[1], self._port[1], self._scheme[1], self._server[1], self._username[1]])
