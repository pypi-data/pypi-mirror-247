...
from delphixpy.v1_8_2.web.objects.RestorationDatasetParameters import RestorationDatasetParameters
...
class AppDataRestorationDatasetCreationParameters(RestorationDatasetParameters):
    """
    *(extends* :py:class:`v1_8_2.web.vo.RestorationDatasetParameters` *)* The
    ...
    def container(self):
        ...
        :rtype: :py:class:`v1_8_2.web.vo.AppDataContainer`
        """
    ...
    def source(self):
        ...
        :rtype: :py:class:`v1_8_2.web.vo.AppDataRestorationSource`
        """
    ...
    def source_config(self):
        ...
        :rtype: :py:class:`v1_8_2.web.vo.AppDataSourceConfig`
        """
