...
from delphixpy.v1_8_2.web.objects.OracleCustomEnvVarPair import OracleCustomEnvVarPair
...
class OracleCustomEnvVarRACPair(OracleCustomEnvVarPair):
    """
    *(extends* :py:class:`v1_8_2.web.vo.OracleCustomEnvVarPair` *)* Dictates a
