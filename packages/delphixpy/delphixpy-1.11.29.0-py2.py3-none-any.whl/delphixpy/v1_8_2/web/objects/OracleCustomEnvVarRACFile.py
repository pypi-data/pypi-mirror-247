...
from delphixpy.v1_8_2.web.objects.OracleCustomEnvVarFile import OracleCustomEnvVarFile
...
class OracleCustomEnvVarRACFile(OracleCustomEnvVarFile):
    """
    *(extends* :py:class:`v1_8_2.web.vo.OracleCustomEnvVarFile` *)* Dictates an
