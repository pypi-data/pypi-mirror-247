...
from delphixpy.v1_8_2.web.objects.NetworkTestParameters import NetworkTestParameters
...
class NetworkThroughputTestBaseParameters(NetworkTestParameters):
    """
    *(extends* :py:class:`v1_8_2.web.vo.NetworkTestParameters` *)* Base type
    ...
    def is_dirty(self):
        return any([self._direction[1], self._duration[1], self._num_connections[1]])
