...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_8_2.web.objects.TimeflowSnapshot.TimeflowSnapsh
        ot` object
    :type ref: ``str``
    :rtype: :py:class:`v1_8_2.web.vo.TimeflowSnapshot`
    """
...
def get_all(engine, database=None, from_date=None, page_size=None, timeflow=None, to_date=None, traverse_timeflows=None):
    ...
    :rtype: ``list`` of :py:class:`v1_8_2.web.vo.TimeflowSnapshot`
    """
...
def update(engine, ref, timeflow_snapshot=None):
    ...
    :type timeflow_snapshot: :py:class:`v1_8_2.web.vo.TimeflowSnapshot`
    """
    url = "/resources/json/delphix/snapshot/%s" % ref
...
def space(engine, snapshot_space_parameters):
    ...
    :type snapshot_space_parameters:
        :py:class:`v1_8_2.web.vo.SnapshotSpaceParameters`
    :rtype: :py:class:`v1_8_2.web.vo.SnapshotSpaceResult`
    """
