...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_8_2.web.objects.StorageDevice.StorageDevice`
        object
    :type ref: ``str``
    :rtype: :py:class:`v1_8_2.web.vo.StorageDevice`
    """
...
def get_all(engine):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_8_2.delphix_engine.DelphixEngine`
    :rtype: ``list`` of :py:class:`v1_8_2.web.vo.StorageDevice`
    """
...
def remove_verify(engine, ref):
    ...
    :param ref: Reference to a
        ...
        object
    :type ref: ``str``
    :rtype: :py:class:`v1_8_2.web.vo.StorageDeviceRemovalVerifyResult`
    """
...
def initialize(engine, storage_initialization_parameters):
    ...
    :type storage_initialization_parameters:
        :py:class:`v1_8_2.web.vo.StorageInitializationParameters`
    """
