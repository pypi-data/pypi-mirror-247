...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_8_2.web.objects.Action.Action` object
    :type ref: ``str``
    :rtype: :py:class:`v1_8_2.web.vo.Action`
    """
...
def get_all(engine, ascending=None, from_date=None, page_offset=None, page_size=None, parent_action=None, root_action_only=None, search_text=None, sort_by=None, state=None, to_date=None, user=None):
    """
    ...
    :type user: ``str``
    :rtype: ``list`` of :py:class:`v1_8_2.web.vo.Action`
    """
    url = "/resources/json/delphix/action"
    query_params = {"ascending": ascending, "fromDate": from_date, "pageOffset": page_offset, "pageSize": page_size, "parentAction": parent_action, "rootActionOnly": root_action_only, "searchText": search_text, "sortBy": sort_by, "state": state, "toDate": to_date, "user": user}
...
def get_job(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_8_2.web.objects.Action.Action` object
    :type ref: ``str``
    :rtype: :py:class:`v1_8_2.web.vo.Job`
    """
