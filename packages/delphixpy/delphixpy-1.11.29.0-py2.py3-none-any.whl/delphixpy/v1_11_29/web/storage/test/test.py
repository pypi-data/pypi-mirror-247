...
def create(engine, storage_test_parameters=None):
    ...
    :type storage_test_parameters:
        :py:class:`v1_11_29.web.vo.StorageTestParameters`
    :rtype: ``str``
    """
...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_11_29.web.objects.StorageTest.StorageTest`
        object
    :type ref: ``str``
    :rtype: :py:class:`v1_11_29.web.vo.StorageTest`
    """
...
def get_all(engine):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_11_29.delphix_engine.DelphixEngine`
    :rtype: ``list`` of :py:class:`v1_11_29.web.vo.StorageTest`
    """
    url = "/resources/json/delphix/storage/test"
    response = engine.get(url)
    result = response_validator.validate(response, engine)
