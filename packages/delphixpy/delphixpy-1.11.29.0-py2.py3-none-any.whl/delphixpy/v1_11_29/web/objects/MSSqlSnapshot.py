...
from delphixpy.v1_11_29.web.objects.TimeflowSnapshot import TimeflowSnapshot
...
class MSSqlSnapshot(TimeflowSnapshot):
    """
    *(extends* :py:class:`v1_11_29.web.vo.TimeflowSnapshot` *)* Provisionable
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_11_29.web.vo.MSSqlSnapshotRuntime`
        """
    ...
    def additional_database_parameters(self):
        ...
        :rtype: :py:class:`v1_11_29.web.vo.MSSqlAdditionalDatabaseParameters`
        """
