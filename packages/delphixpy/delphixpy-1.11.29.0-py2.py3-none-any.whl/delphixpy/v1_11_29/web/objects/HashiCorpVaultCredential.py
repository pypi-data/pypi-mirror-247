...
from delphixpy.v1_11_29.web.objects.AbstractVaultCredential import AbstractVaultCredential
...
class HashiCorpVaultCredential(AbstractVaultCredential):
    """
    *(extends* :py:class:`v1_11_29.web.vo.AbstractVaultCredential` *)* The
