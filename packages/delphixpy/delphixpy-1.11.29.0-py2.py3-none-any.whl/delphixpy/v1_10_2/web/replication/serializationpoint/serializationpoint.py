...
def get(engine, ref):
    ...
    :param ref: Reference to a :py:class:`delphixpy.v1_10_2.web.objects.Seriali
        zationPoint.SerializationPoint` object
    :type ref: ``str``
    :rtype: :py:class:`v1_10_2.web.vo.SerializationPoint`
    """
...
def get_all(engine):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_10_2.delphix_engine.DelphixEngine`
    :rtype: ``list`` of :py:class:`v1_10_2.web.vo.SerializationPoint`
    """
