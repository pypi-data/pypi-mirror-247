...
from delphixpy.v1_10_2.web.objects.TimeflowSnapshot import TimeflowSnapshot
...
class OracleSnapshot(TimeflowSnapshot):
    """
    *(extends* :py:class:`v1_10_2.web.vo.TimeflowSnapshot` *)* Provisionable
    ...
    def is_dirty(self):
        return any([self._runtime[1], self._from_physical_standby_vdb[1], self._first_change_point[1], self._latest_change_point[1], self._fraction_timeflows[1], self._redo_log_size_in_bytes[1]])
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_10_2.web.vo.OracleSnapshotRuntime`
        """
    ...
    def first_change_point(self):
        ...
        :rtype: :py:class:`v1_10_2.web.vo.OracleTimeflowPoint`
        """
