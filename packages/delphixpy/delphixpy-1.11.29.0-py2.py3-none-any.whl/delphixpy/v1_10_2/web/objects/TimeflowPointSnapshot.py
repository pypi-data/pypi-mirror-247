...
from delphixpy.v1_10_2.web.objects.TimeflowPointParameters import TimeflowPointParameters
...
class TimeflowPointSnapshot(TimeflowPointParameters):
    """
    *(extends* :py:class:`v1_10_2.web.vo.TimeflowPointParameters` *)* TimeFlow
