...
from delphixpy.v1_10_2.web.objects.MySQLSyncParameters import MySQLSyncParameters
...
class MySQLExistingBackupSyncParameters(MySQLSyncParameters):
    """
    *(extends* :py:class:`v1_10_2.web.vo.MySQLSyncParameters` *)* The
    ...
    def replication_coordinates(self):
        ...
        :rtype: :py:class:`v1_10_2.web.vo.MySQLReplicationCoordinates`
        """
