...
from delphixpy.v1_10_2.web.objects.MSSqlBaseClusterListener import MSSqlBaseClusterListener
...
class MSSqlAvailabilityGroupListener(MSSqlBaseClusterListener):
    """
    *(extends* :py:class:`v1_10_2.web.vo.MSSqlBaseClusterListener` *)* The
