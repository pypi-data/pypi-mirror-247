...
def create(engine, policy=None):
    ...
    :type policy: :py:class:`v1_11_1.web.vo.Policy`
    :rtype: ``str``
    """
...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_11_1.web.objects.Policy.Policy` object
    :type ref: ``str``
    :rtype: :py:class:`v1_11_1.web.vo.Policy`
    """
...
def get_all(engine, type=None, target=None, effective=None):
    ...
    :type effective: ``str``
    :rtype: ``list`` of :py:class:`v1_11_1.web.vo.Policy`
    """
    url = "/resources/json/delphix/policy"
...
def apply(engine, ref, policy_apply_target_parameters):
    ...
    :type policy_apply_target_parameters:
        :py:class:`v1_11_1.web.vo.PolicyApplyTargetParameters`
    """
...
def create_and_apply(engine, policy_create_and_apply_parameters):
    ...
    :type policy_create_and_apply_parameters:
        :py:class:`v1_11_1.web.vo.PolicyCreateAndApplyParameters`
    :rtype: ``str``
    """
