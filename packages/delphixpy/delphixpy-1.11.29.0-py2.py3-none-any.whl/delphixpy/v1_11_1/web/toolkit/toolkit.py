...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_11_1.web.objects.AbstractToolkit.AbstractToolki
        t` object
    :type ref: ``str``
    :rtype: :py:class:`v1_11_1.web.vo.AbstractToolkit`
    """
...
def get_all(engine, source_environment=None):
    ...
    :rtype: ``list`` of :py:class:`v1_11_1.web.vo.AbstractToolkit`
    """
...
def supported_virtualization_api_range(engine):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_11_1.delphix_engine.DelphixEngine`
    :rtype: :py:class:`v1_11_1.web.vo.VirtualizationPlatformAPIRange`
    """
