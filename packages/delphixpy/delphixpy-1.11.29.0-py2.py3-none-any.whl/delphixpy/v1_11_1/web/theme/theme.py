...
def create(engine, theme=None):
    ...
    :type theme: :py:class:`v1_11_1.web.vo.Theme`
    :rtype: ``str``
    """
...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_11_1.web.objects.Theme.Theme` object
    :type ref: ``str``
    :rtype: :py:class:`v1_11_1.web.vo.Theme`
    """
...
def get_all(engine, page_size=None, page_offset=None, active=None):
    ...
    :type active: ``bool``
    :rtype: ``list`` of :py:class:`v1_11_1.web.vo.Theme`
    """
    url = "/resources/json/delphix/theme"
...
def set_active_theme(engine, theme_reference_parameter=None):
    ...
    :type theme_reference_parameter:
        :py:class:`v1_11_1.web.vo.ThemeReferenceParameter`
    """
