...
from delphixpy.v1_11_1.web.objects.OracleCustomEnvVarFile import OracleCustomEnvVarFile
...
class OracleCustomEnvVarRACFile(OracleCustomEnvVarFile):
    """
    *(extends* :py:class:`v1_11_1.web.vo.OracleCustomEnvVarFile` *)* Dictates
