...
from delphixpy.v1_11_1.web.objects.AbstractSourceConfigConnectivity import AbstractSourceConfigConnectivity
...
class OracleDBConfigConnectivity(AbstractSourceConfigConnectivity):
    """
    *(extends* :py:class:`v1_11_1.web.vo.AbstractSourceConfigConnectivity` *)*
