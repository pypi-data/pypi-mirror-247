...
from delphixpy.v1_11_1.web.objects.JSOperationEndpointParameters import JSOperationEndpointParameters
...
class JSOperationEndpointDataLayoutParameters(JSOperationEndpointParameters):
    """
    *(extends* :py:class:`v1_11_1.web.vo.JSOperationEndpointParameters` *)* The
