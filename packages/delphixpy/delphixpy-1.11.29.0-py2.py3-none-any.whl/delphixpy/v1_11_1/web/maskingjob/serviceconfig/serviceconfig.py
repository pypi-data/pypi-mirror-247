...
def get(engine, ref):
    ...
    :param ref: Reference to a :py:class:`delphixpy.v1_11_1.web.objects.Masking
        ServiceConfig.MaskingServiceConfig` object
    :type ref: ``str``
    :rtype: :py:class:`v1_11_1.web.vo.MaskingServiceConfig`
    """
...
def get_all(engine):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_11_1.delphix_engine.DelphixEngine`
    :rtype: ``list`` of :py:class:`v1_11_1.web.vo.MaskingServiceConfig`
    """
...
def update(engine, ref, masking_service_config=None):
    ...
    :type masking_service_config:
        :py:class:`v1_11_1.web.vo.MaskingServiceConfig`
    """
    url = "/resources/json/delphix/maskingjob/serviceconfig/%s" % ref
