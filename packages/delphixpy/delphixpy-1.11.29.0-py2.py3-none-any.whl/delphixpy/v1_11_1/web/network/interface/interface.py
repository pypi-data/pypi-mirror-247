...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_11_1.web.objects.NetworkInterface.NetworkInterf
        ace` object
    :type ref: ``str``
    :rtype: :py:class:`v1_11_1.web.vo.NetworkInterface`
    """
...
def get_all(engine):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_11_1.delphix_engine.DelphixEngine`
    :rtype: ``list`` of :py:class:`v1_11_1.web.vo.NetworkInterface`
    """
...
def update(engine, ref, network_interface=None):
    ...
    :type network_interface: :py:class:`v1_11_1.web.vo.NetworkInterface`
    """
    url = "/resources/json/delphix/network/interface/%s" % ref
