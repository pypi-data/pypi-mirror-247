...
from delphixpy.v1_11_25.web.objects.DbExportParameters import DbExportParameters
...
class OracleExportParameters(DbExportParameters):
    """
    *(extends* :py:class:`v1_11_25.web.vo.DbExportParameters` *)* The
    ...
    def dsp_options(self):
        ...
        :rtype: :py:class:`v1_11_25.web.vo.DSPOptions`
        """
    ...
    def filesystem_layout(self):
        ...
        :rtype:
            :py:class:`v1_11_25.web.vo.OracleExportTimeflowFilesystemLayout`
        """
