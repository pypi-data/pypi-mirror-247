...
from delphixpy.v1_11_25.web.objects.PublicSystemInfo import PublicSystemInfo
...
class SystemInfo(PublicSystemInfo):
    """
    *(extends* :py:class:`v1_11_25.web.vo.PublicSystemInfo` *)* Retrieve
    ...
    def processors(self):
        ...
        :rtype: ``list`` of :py:class:`v1_11_25.web.vo.CPUInfo`
        """
    ...
    def up_time(self):
        ...
        :rtype: :py:class:`v1_11_25.web.vo.UpTimeInfo`
        """
