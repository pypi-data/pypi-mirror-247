...
from delphixpy.v1_11_25.web.objects.SourceUpgradeParameters import SourceUpgradeParameters
...
class MSSqlLinkedSourceUpgradeParameters(SourceUpgradeParameters):
    """
    *(extends* :py:class:`v1_11_25.web.vo.SourceUpgradeParameters` *)* The
