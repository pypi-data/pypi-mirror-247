...
from delphixpy.v1_11_25.web.objects.HostedVaultTestParameters import HostedVaultTestParameters
...
class HashiCorpVaultTestParameters(HostedVaultTestParameters):
    """
    *(extends* :py:class:`v1_11_25.web.vo.HostedVaultTestParameters` *)*
