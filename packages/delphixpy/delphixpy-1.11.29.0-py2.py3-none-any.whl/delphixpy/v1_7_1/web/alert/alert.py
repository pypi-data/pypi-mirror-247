...
Package "alert"
"""
from delphixpy.v1_7_1.web.alert import profile
...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_7_1.web.objects.Alert.Alert` object
    :type ref: ``str``
    :rtype: :py:class:`v1_7_1.web.vo.Alert`
    """
...
def get_all(engine, from_date=None, max_total=None, page_offset=None, page_size=None, search_text=None, target=None, to_date=None):
    ...
    :type to_date: ``str``
    :rtype: ``list`` of :py:class:`v1_7_1.web.vo.Alert`
    """
