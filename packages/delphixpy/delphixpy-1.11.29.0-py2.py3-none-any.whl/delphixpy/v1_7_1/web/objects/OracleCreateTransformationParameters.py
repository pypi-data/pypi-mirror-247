...
from delphixpy.v1_7_1.web.objects.CreateTransformationParameters import CreateTransformationParameters
...
class OracleCreateTransformationParameters(CreateTransformationParameters):
    """
    *(extends* :py:class:`v1_7_1.web.vo.CreateTransformationParameters` *)*
