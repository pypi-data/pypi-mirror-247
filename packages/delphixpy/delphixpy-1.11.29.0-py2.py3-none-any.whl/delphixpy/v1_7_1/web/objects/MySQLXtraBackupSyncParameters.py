...
from delphixpy.v1_7_1.web.objects.MySQLExistingBackupSyncParameters import MySQLExistingBackupSyncParameters
...
class MySQLXtraBackupSyncParameters(MySQLExistingBackupSyncParameters):
    """
    *(extends* :py:class:`v1_7_1.web.vo.MySQLExistingBackupSyncParameters` *)*
