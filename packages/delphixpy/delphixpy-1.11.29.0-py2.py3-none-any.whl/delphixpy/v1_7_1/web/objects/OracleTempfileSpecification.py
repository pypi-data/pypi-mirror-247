...
from delphixpy.v1_7_1.web.objects.OracleDatafileTempfileSpecification import OracleDatafileTempfileSpecification
...
class OracleTempfileSpecification(OracleDatafileTempfileSpecification):
    """
    *(extends* :py:class:`v1_7_1.web.vo.OracleDatafileTempfileSpecification`
