...
class OracleInstance(TypedObject):
    """
    *(extends* :py:class:`v1_7_1.web.vo.TypedObject` *)* Representation of an
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "instance_number" == "type" or (self.instance_number is not self.__undef__ and (not (dirty and not self._instance_number[1]) or self.is_dirty_list(self.instance_number, self._instance_number) or belongs_to_parent)):
    ...
    def is_dirty(self):
        return any([self._instance_name[1], self._instance_number[1]])
