...
class MSSqlBaseClusterRepository(MSSqlRepository):
    """
    *(extends* :py:class:`v1_7_1.web.vo.MSSqlRepository` *)* The representation
    ...
    def instances(self):
        ...
        :rtype: ``list`` of :py:class:`v1_7_1.web.vo.MSSqlBaseClusterInstance`
        """
    ...
    def listeners(self):
        ...
        :rtype: ``list`` of :py:class:`v1_7_1.web.vo.MSSqlBaseClusterListener`
        """
