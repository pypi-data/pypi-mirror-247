...
class VirtualSourceOperations(TypedObject):
    """
    *(extends* :py:class:`v1_7_1.web.vo.TypedObject` *)* Describes operations
    ...
    def is_dirty(self):
        return any([self._configure_clone[1], self._post_refresh[1], self._post_rollback[1], self._post_snapshot[1], self._pre_refresh[1], self._pre_rollback[1], self._pre_snapshot[1]])
    ...
    def configure_clone(self):
        ...
        :rtype: ``list`` of :py:class:`v1_7_1.web.vo.SourceOperation`
        """
