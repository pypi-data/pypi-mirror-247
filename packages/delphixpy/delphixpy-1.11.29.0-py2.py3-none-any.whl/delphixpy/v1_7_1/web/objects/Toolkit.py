...
class Toolkit(NamedUserObject):
    """
    *(extends* :py:class:`v1_7_1.web.vo.NamedUserObject` *)* An installed
    toolkit.
    """
    ...
    def build_api(self):
        ...
        :rtype: :py:class:`v1_7_1.web.vo.APIVersion`
        """
    ...
    def discovery_definition(self):
        ...
        :rtype: :py:class:`v1_7_1.web.vo.ToolkitDiscoveryDefinition`
        """
    ...
    def linked_source_definition(self):
        ...
        :rtype: :py:class:`v1_7_1.web.vo.ToolkitLinkedSource`
        """
    ...
    def messages(self):
        ...
        :rtype: ``list`` of :py:class:`v1_7_1.web.vo.ToolkitLocale`
        """
    ...
    def virtual_source_definition(self):
        ...
        :rtype: :py:class:`v1_7_1.web.vo.ToolkitVirtualSource`
        """
