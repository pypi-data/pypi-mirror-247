...
class DatapointSet(TypedObject):
    """
    *(extends* :py:class:`v1_7_1.web.vo.TypedObject` *)* A set of datapoints
    ...
    def is_dirty(self):
        return any([self._datapoint_streams[1], self._overflow[1], self._resolution[1]])
    ...
    def datapoint_streams(self):
        ...
        :rtype: ``list`` of :py:class:`v1_7_1.web.vo.DatapointStream`
        """
