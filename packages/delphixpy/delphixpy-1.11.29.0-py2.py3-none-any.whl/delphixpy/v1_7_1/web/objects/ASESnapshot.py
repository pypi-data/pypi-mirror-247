...
class ASESnapshot(TimeflowSnapshot):
    """
    *(extends* :py:class:`v1_7_1.web.vo.TimeflowSnapshot` *)* Provisionable
    ...
    def first_change_point(self):
        ...
        :rtype: :py:class:`v1_7_1.web.vo.ASETimeflowPoint`
        """
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_7_1.web.vo.ASESnapshotRuntime`
        """
