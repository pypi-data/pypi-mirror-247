...
from delphixpy.v1_7_1.web.objects.RestorationDatasetParameters import RestorationDatasetParameters
...
class AppDataRestorationDatasetCreationParameters(RestorationDatasetParameters):
    """
    *(extends* :py:class:`v1_7_1.web.vo.RestorationDatasetParameters` *)* The
    ...
    def source(self):
        ...
        :rtype: :py:class:`v1_7_1.web.vo.AppDataRestorationSource`
        """
