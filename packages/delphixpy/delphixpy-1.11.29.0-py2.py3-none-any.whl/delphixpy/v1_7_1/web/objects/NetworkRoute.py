...
class NetworkRoute(TypedObject):
    """
    *(extends* :py:class:`v1_7_1.web.vo.TypedObject` *)* IP routing table.
    """
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._node[0] is not None and obj._node[0] is not obj.__undef__:
            assert isinstance(obj._node[0], str), ("Expected one of ['string', 'null'], but got %s of type %s" % (obj._node[0], type(obj._node[0])))
    ...
    def is_dirty(self):
        return any([self._destination[1], self._gateway[1], self._node[1], self._out_interface[1]])
