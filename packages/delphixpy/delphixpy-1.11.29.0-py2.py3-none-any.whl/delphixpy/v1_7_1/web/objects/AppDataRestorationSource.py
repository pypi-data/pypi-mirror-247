...
from delphixpy.v1_7_1.web.objects.AppDataManagedSource import AppDataManagedSource
...
class AppDataRestorationSource(AppDataManagedSource):
    """
    *(extends* :py:class:`v1_7_1.web.vo.AppDataManagedSource` *)* A restoration
    AppData source.
    """
    ...
    def additional_mount_points(self):
        ...
        :rtype: ``list`` of
            :py:class:`v1_7_1.web.vo.AppDataAdditionalMountPoint`
        """
