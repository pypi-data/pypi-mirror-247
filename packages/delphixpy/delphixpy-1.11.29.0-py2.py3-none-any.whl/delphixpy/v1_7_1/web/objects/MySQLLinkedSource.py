...
from delphixpy.v1_7_1.web.objects.MySQLSource import MySQLSource
...
class MySQLLinkedSource(MySQLSource):
    """
    *(extends* :py:class:`v1_7_1.web.vo.MySQLSource` *)* A linked MySQL source.
    """
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_7_1.web.vo.MySQLSourceRuntime`
        """
