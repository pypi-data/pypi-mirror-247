...
class SecurityConfig(TypedObject):
    """
    *(extends* :py:class:`v1_7_1.web.vo.TypedObject` *)* System wide security
    configuration.
    """
    ...
    def is_dirty(self):
        return any([self._allowed_cors_origins[1], self._banner[1], self._boot_password[1], self._is_cors_enabled[1]])
    ...
    def __eq__(self, other):
        ...
        return super().__eq__(other) and \
               ...
               self.boot_password == other.boot_password and \
               self.is_cors_enabled == other.is_cors_enabled
