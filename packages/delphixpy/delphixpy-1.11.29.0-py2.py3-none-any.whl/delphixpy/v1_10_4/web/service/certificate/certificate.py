...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_10_4.web.objects.X509Certificate.X509Certificat
        e` object
    :type ref: ``str``
    :rtype: :py:class:`v1_10_4.web.vo.X509Certificate`
    """
...
def get_all(engine):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_10_4.delphix_engine.DelphixEngine`
    :rtype: ``list`` of :py:class:`v1_10_4.web.vo.X509Certificate`
    """
