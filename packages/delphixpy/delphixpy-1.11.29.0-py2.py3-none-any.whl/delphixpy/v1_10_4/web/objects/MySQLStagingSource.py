...
from delphixpy.v1_10_4.web.objects.MySQLSource import MySQLSource
...
class MySQLStagingSource(MySQLSource):
    """
    *(extends* :py:class:`v1_10_4.web.vo.MySQLSource` *)* A MySQL staging
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_10_4.web.vo.MySQLSourceRuntime`
        """
