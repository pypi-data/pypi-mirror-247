...
from delphixpy.v1_10_4.web.objects.Timeflow import Timeflow
...
class OracleTimeflow(Timeflow):
    """
    *(extends* :py:class:`v1_10_4.web.vo.Timeflow` *)* TimeFlow representing
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._warehouse_timeflow[0] is not None and obj._warehouse_timeflow[0] is not obj.__undef__:
            assert isinstance(obj._warehouse_timeflow[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._warehouse_timeflow[0], type(obj._warehouse_timeflow[0])))
