...
class MSSqlBaseClusterRepository(MSSqlRepository):
    """
    *(extends* :py:class:`v1_10_4.web.vo.MSSqlRepository` *)* The
    ...
    def instances(self):
        ...
        :rtype: ``list`` of :py:class:`v1_10_4.web.vo.MSSqlBaseClusterInstance`
        """
    ...
    def listeners(self):
        ...
        :rtype: ``list`` of :py:class:`v1_10_4.web.vo.MSSqlBaseClusterListener`
        """
