...
from delphixpy.v1_10_4.web.objects.TimeflowSnapshot import TimeflowSnapshot
...
class OracleSnapshot(TimeflowSnapshot):
    """
    *(extends* :py:class:`v1_10_4.web.vo.TimeflowSnapshot` *)* Provisionable
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_10_4.web.vo.OracleSnapshotRuntime`
        """
    ...
    def first_change_point(self):
        ...
        :rtype: :py:class:`v1_10_4.web.vo.OracleTimeflowPoint`
        """
