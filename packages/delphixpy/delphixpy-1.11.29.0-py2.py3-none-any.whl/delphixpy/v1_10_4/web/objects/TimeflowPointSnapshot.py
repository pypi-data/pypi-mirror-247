...
from delphixpy.v1_10_4.web.objects.TimeflowPointParameters import TimeflowPointParameters
...
class TimeflowPointSnapshot(TimeflowPointParameters):
    """
    *(extends* :py:class:`v1_10_4.web.vo.TimeflowPointParameters` *)* TimeFlow
