...
from delphixpy.v1_10_4.web.objects.Container import Container
...
class VMwareContainer(Container):
    """
    *(extends* :py:class:`v1_10_4.web.vo.Container` *)* Data container for
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_10_4.web.vo.VMwareContainerRuntime`
        """
