...
from delphixpy.v1_10_4.web.objects.PublicSystemInfo import PublicSystemInfo
...
class SystemInfo(PublicSystemInfo):
    """
    *(extends* :py:class:`v1_10_4.web.vo.PublicSystemInfo` *)* Retrieve system-
    ...
    def processors(self):
        ...
        :rtype: ``list`` of :py:class:`v1_10_4.web.vo.CPUInfo`
        """
    ...
    def up_time(self):
        ...
        :rtype: :py:class:`v1_10_4.web.vo.UpTimeInfo`
        """
