...
from delphixpy.v1_10_4.web.objects.MySQLReplicationCoordinates import MySQLReplicationCoordinates
...
class MySQLGtidCoordinates(MySQLReplicationCoordinates):
    """
    *(extends* :py:class:`v1_10_4.web.vo.MySQLReplicationCoordinates` *)* The
