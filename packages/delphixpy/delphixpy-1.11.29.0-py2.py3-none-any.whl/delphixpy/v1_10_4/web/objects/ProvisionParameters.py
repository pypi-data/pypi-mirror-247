...
from delphixpy.v1_10_4.web.objects.VirtualDatasetCreationParameters import VirtualDatasetCreationParameters
...
class ProvisionParameters(VirtualDatasetCreationParameters):
    """
    *(extends* :py:class:`v1_10_4.web.vo.VirtualDatasetCreationParameters` *)*
