...
from delphixpy.v1_4_1.web.objects.SyncParameters import SyncParameters
...
class MSSqlSyncParameters(SyncParameters):
    """
    *(extends* :py:class:`v1_4_1.web.vo.SyncParameters` *)* The parameters to
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._backup_uuid[0] is not None and obj._backup_uuid[0] is not obj.__undef__:
            assert isinstance(obj._backup_uuid[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._backup_uuid[0], type(obj._backup_uuid[0])))
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        def dictify(obj, prop_is_list_or_vo=False):
            if isinstance(obj, list):
                ...
                return obj
        if "backup_uuid" == "type" or (self.backup_uuid is not self.__undef__ and (not (dirty and not self._backup_uuid[1]) or self.is_dirty_list(self.backup_uuid, self._backup_uuid) or belongs_to_parent)):
            dct["backupUUID"] = dictify(self.backup_uuid)
        if "load_from_backup" == "type" or (self.load_from_backup is not self.__undef__ and (not (dirty and not self._load_from_backup[1]) or self.is_dirty_list(self.load_from_backup, self._load_from_backup) or belongs_to_parent)):
