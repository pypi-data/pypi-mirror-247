...
from delphixpy.v1_4_1.web.objects.OracleBaseDBConfig import OracleBaseDBConfig
...
class OracleDBConfig(OracleBaseDBConfig):
    """
    *(extends* :py:class:`v1_4_1.web.vo.OracleBaseDBConfig` *)* The source
    ...
    def non_sys_credentials(self):
        ...
        :rtype: :py:class:`v1_4_1.web.vo.Credential`
        """
