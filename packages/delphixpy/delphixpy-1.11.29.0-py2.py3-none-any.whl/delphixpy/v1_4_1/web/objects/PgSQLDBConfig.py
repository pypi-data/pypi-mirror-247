...
class PgSQLDBConfig(TypedObject):
    """
    *(extends* :py:class:`v1_4_1.web.vo.TypedObject` *)* Configuration
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._database_cluster[0] is not None and obj._database_cluster[0] is not obj.__undef__:
            assert isinstance(obj._database_cluster[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._database_cluster[0], type(obj._database_cluster[0])))
    ...
    def is_dirty(self):
        return any([self._credentials[1], self._database_cluster[1], self._database_name[1], self._user[1]])
