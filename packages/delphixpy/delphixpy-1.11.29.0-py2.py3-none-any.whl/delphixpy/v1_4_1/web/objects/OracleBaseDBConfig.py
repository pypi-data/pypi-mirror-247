...
class OracleBaseDBConfig(SourceConfig):
    """
    *(extends* :py:class:`v1_4_1.web.vo.SourceConfig` *)* The source config
    ...
    def is_dirty(self):
        return any([self._credentials[1], self._services[1], self._user[1]])
    ...
    def services(self):
        ...
        :rtype: ``list`` of :py:class:`v1_4_1.web.vo.OracleService`
        """
