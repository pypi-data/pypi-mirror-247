...
from delphixpy.v1_4_1.web.objects.MSSqlSource import MSSqlSource
...
class MSSqlLinkedSource(MSSqlSource):
    """
    *(extends* :py:class:`v1_4_1.web.vo.MSSqlSource` *)* A linked MSSQL source.
    """
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._shared_backup_location[0] is not None and obj._shared_backup_location[0] is not obj.__undef__:
            assert isinstance(obj._shared_backup_location[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._shared_backup_location[0], type(obj._shared_backup_location[0])))
    ...
    def is_dirty(self):
        return any([self._backup_location_credentials[1], self._backup_location_user[1], self._config[1], self._external_file_path[1], self._post_script[1], self._pre_script[1], self._shared_backup_location[1], self._staging_source[1]])
