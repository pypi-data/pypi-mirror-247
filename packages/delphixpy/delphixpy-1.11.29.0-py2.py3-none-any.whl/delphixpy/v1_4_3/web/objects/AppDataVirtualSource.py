...
from delphixpy.v1_4_3.web.objects.AppDataSource import AppDataSource
...
class AppDataVirtualSource(AppDataSource):
    """
    *(extends* :py:class:`v1_4_3.web.vo.AppDataSource` *)* A virtual AppData
    source
    """
    ...
    def additional_mount_points(self):
        ...
        :rtype: ``list`` of
            :py:class:`v1_4_3.web.vo.AppDataAdditionalMountPoint`
        """
    ...
    def parameters(self):
        ...
        :rtype: ``list`` of :py:class:`v1_4_3.web.vo.DynamicParameterValue`
        """
