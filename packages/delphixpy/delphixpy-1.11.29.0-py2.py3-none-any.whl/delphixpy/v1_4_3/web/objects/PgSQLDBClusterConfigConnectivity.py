...
from delphixpy.v1_4_3.web.objects.SourceConfigConnectivity import SourceConfigConnectivity
...
class PgSQLDBClusterConfigConnectivity(SourceConfigConnectivity):
    """
    *(extends* :py:class:`v1_4_3.web.vo.SourceConfigConnectivity` *)* Mechanism
