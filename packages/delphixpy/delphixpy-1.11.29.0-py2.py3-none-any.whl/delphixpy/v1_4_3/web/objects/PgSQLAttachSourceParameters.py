...
from delphixpy.v1_4_3.web.objects.AttachSourceParameters import AttachSourceParameters
...
class PgSQLAttachSourceParameters(AttachSourceParameters):
    """
    *(extends* :py:class:`v1_4_3.web.vo.AttachSourceParameters` *)* Represents
