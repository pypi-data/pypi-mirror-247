...
from delphixpy.v1_4_3.web.objects.SourceStopParameters import SourceStopParameters
...
class OracleStopParameters(SourceStopParameters):
    """
    *(extends* :py:class:`v1_4_3.web.vo.SourceStopParameters` *)* The
    ...
    def is_dirty(self):
        return any([self._abort[1], self._credential[1], self._instances[1], self._username[1]])
