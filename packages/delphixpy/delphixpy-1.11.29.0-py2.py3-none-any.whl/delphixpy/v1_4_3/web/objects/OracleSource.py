...
from delphixpy.v1_4_3.web.objects.Source import Source
...
class OracleSource(Source):
    """
    *(extends* :py:class:`v1_4_3.web.vo.Source` *)* An Oracle source
    """
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_4_3.web.vo.OracleBaseSourceRuntime`
        """
