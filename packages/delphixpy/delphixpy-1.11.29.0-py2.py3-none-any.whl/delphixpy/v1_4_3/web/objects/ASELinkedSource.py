...
from delphixpy.v1_4_3.web.objects.ASESource import ASESource
...
class ASELinkedSource(ASESource):
    """
    *(extends* :py:class:`v1_4_3.web.vo.ASESource` *)* A linked SAP ASE source.
    """
    ...
    def monitor_location(self):
        ...
        :rtype: :py:class:`v1_4_3.web.vo.ASEBackupLocation`
        """
