...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_11_18.web.objects.Statistic.Statistic` object
    :type ref: ``str``
    :rtype: :py:class:`v1_11_18.web.vo.Statistic`
    """
...
def get_all(engine):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_11_18.delphix_engine.DelphixEngine`
    :rtype: ``list`` of :py:class:`v1_11_18.web.vo.Statistic`
    """
...
def show_axes(engine, statistic_type=None):
    ...
    :rtype: ``list`` of :py:class:`v1_11_18.web.vo.StatisticAxis`
    """
