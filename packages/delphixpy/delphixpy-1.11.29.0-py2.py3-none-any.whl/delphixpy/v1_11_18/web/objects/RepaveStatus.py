...
class RepaveStatus(TypedObject):
    """
    *(extends* :py:class:`v1_11_18.web.vo.TypedObject` *)* The status of
    repave.
    """
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._state[0] is not None and obj._state[0] is not obj.__undef__:
            ...
            assert obj._state[0] in ['NONE', 'PREPARING', 'PREPARE_SUCCESSFUL', 'PREPARE_FAILED', 'READY_FOR_APPLY', 'APPLYING', 'APPLY_SUCCESSFUL', 'APPLY_FAILED'], "Expected enum ['NONE', 'PREPARING', 'PREPARE_SUCCESSFUL', 'PREPARE_FAILED', 'READY_FOR_APPLY', 'APPLYING', 'APPLY_SUCCESSFUL', 'APPLY_FAILED'] but got %s" % obj._state[0]
    ...
    def is_dirty(self):
        return any([self._state[1], self._state_detail[1], self._domain0_pool_guid[1]])
    ...
    def state(self):
        """
        *(default value: NONE)* Repave state. *(permitted values: NONE,
        PREPARING, PREPARE_SUCCESSFUL, PREPARE_FAILED, READY_FOR_APPLY,
        APPLYING, APPLY_SUCCESSFUL, APPLY_FAILED)*
