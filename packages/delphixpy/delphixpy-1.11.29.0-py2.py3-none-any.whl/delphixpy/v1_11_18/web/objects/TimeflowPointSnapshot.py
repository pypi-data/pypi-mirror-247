...
from delphixpy.v1_11_18.web.objects.TimeflowPointParameters import TimeflowPointParameters
...
class TimeflowPointSnapshot(TimeflowPointParameters):
    """
    *(extends* :py:class:`v1_11_18.web.vo.TimeflowPointParameters` *)* TimeFlow
