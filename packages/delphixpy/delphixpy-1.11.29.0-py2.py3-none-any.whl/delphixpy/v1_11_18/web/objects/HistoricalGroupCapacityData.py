...
from delphixpy.v1_11_18.web.objects.BaseGroupCapacityData import BaseGroupCapacityData
...
class HistoricalGroupCapacityData(BaseGroupCapacityData):
    """
    *(extends* :py:class:`v1_11_18.web.vo.BaseGroupCapacityData` *)* Historical
