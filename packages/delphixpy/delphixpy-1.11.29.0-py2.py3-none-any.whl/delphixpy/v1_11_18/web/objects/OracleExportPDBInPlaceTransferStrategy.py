...
from delphixpy.v1_11_18.web.objects.OracleExportPDBTransferStrategy import OracleExportPDBTransferStrategy
...
class OracleExportPDBInPlaceTransferStrategy(OracleExportPDBTransferStrategy):
    """
    *(extends* :py:class:`v1_11_18.web.vo.OracleExportPDBTransferStrategy` *)*
    Convert a single tenant vPDB to a physical PDB in-place.
    """
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._pdb_name[0] is not None and obj._pdb_name[0] is not obj.__undef__:
            ...
            common.validate_format(obj._pdb_name[0], "None", None, None)
    ...
    def is_dirty(self):
        return any([self._pdb_name[1], self._virtual_source[1]])
