...
from delphixpy.v1_11_18.web.objects.SourceEnvironmentCreateParameters import SourceEnvironmentCreateParameters
...
class HostEnvironmentCreateParameters(SourceEnvironmentCreateParameters):
    """
    *(extends* :py:class:`v1_11_18.web.vo.SourceEnvironmentCreateParameters`
    *)* The parameters used for the host environment create operation.
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        def dictify(obj, prop_is_list_or_vo=False):
            if isinstance(obj, list):
                ...
                return obj
        if "host_environment" == "type" or (self.host_environment is not self.__undef__ and (not (dirty and not self._host_environment[1]) or self.is_dirty_list(self.host_environment, self._host_environment) or belongs_to_parent)):
            dct["hostEnvironment"] = dictify(self.host_environment, prop_is_list_or_vo=True)
        if "host_parameters" == "type" or (self.host_parameters is not self.__undef__ and (not (dirty and not self._host_parameters[1]) or self.is_dirty_list(self.host_parameters, self._host_parameters) or belongs_to_parent)):
    ...
    def host_environment(self):
        ...
        :rtype: :py:class:`v1_11_18.web.vo.HostEnvironment`
        """
    ...
    def host_parameters(self):
        ...
        :rtype: :py:class:`v1_11_18.web.vo.HostCreateParameters`
        """
