...
def create(engine, statistic_slice=None):
    ...
    :type statistic_slice: :py:class:`v1_11_21.web.vo.StatisticSlice`
    :rtype: ``str``
    """
...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_11_21.web.objects.StatisticSlice.StatisticSlice
        ` object
    :type ref: ``str``
    :rtype: :py:class:`v1_11_21.web.vo.StatisticSlice`
    """
...
def get_all(engine):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_11_21.delphix_engine.DelphixEngine`
    :rtype: ``list`` of :py:class:`v1_11_21.web.vo.StatisticSlice`
    """
    url = "/resources/json/delphix/analytics"
    response = engine.get(url)
    result = response_validator.validate(response, engine)
...
def get_data(engine, ref, start_time=None, end_time=None, resolution=None, count=None):
    ...
    :type count: ``int``
    :rtype: :py:class:`v1_11_21.web.vo.DatapointSet`
    """
...
def remember_range(engine, ref, time_range_parameters):
    ...
    :type time_range_parameters:
        :py:class:`v1_11_21.web.vo.TimeRangeParameters`
    """
