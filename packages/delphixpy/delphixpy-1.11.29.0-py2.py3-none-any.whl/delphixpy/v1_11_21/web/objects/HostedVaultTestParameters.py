...
#     /delphix-hosted-vault-test-parameters.json
#
...
class HostedVaultTestParameters(PasswordVaultTestParameters):
    """
    *(extends* :py:class:`v1_11_21.web.vo.PasswordVaultTestParameters` *)*
    Hosted password vault test configuration.
    """
    def __init__(self, undef_enabled=True):
        super().__init__()
        self._type = ("HostedVaultTestParameters", True)
    ...
    def __eq__(self, other):
        if other is None:
            return False
        if not isinstance(other, HostedVaultTestParameters):
            return False
