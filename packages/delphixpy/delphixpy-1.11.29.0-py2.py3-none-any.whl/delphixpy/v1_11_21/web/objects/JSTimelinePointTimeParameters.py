...
from delphixpy.v1_11_21.web.objects.JSTimelinePointParameters import JSTimelinePointParameters
...
class JSTimelinePointTimeParameters(JSTimelinePointParameters):
    """
    *(extends* :py:class:`v1_11_21.web.vo.JSTimelinePointParameters` *)*
