...
from delphixpy.v1_11_21.web.objects.FluentdAttribute import FluentdAttribute
...
class FluentdSecretAttribute(FluentdAttribute):
    """
    *(extends* :py:class:`v1_11_21.web.vo.FluentdAttribute` *)* Fluentd
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._secret_value[0] is not None and obj._secret_value[0] is not obj.__undef__:
            assert isinstance(obj._secret_value[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._secret_value[0], type(obj._secret_value[0])))
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        def dictify(obj, prop_is_list_or_vo=False):
            if isinstance(obj, list):
                ...
                return obj
        if "secret_value" == "type" or (self.secret_value is not self.__undef__ and (not (dirty and not self._secret_value[1]) or self.is_dirty_list(self.secret_value, self._secret_value) or belongs_to_parent)):
