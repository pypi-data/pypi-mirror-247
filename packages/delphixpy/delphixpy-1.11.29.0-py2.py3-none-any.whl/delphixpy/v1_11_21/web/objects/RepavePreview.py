...
class RepavePreview(TypedObject):
    """
    *(extends* :py:class:`v1_11_21.web.vo.TypedObject` *)* Preview engine
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._state[0] is not None and obj._state[0] is not obj.__undef__:
            ...
            assert obj._state[0] in ['UNSET', 'QUIESCING_ENGINE', 'EXTRACTING_METADATA', 'EXPORTING_DOMAIN0', 'PREPARE_SUCCESSFUL', 'QUIESCE_ENGINE_FAILED', 'EXTRACT_METADATA_FAILED', 'EXPORT_DOMAIN0_FAILED', 'APPLYING', 'APPLY_SUCCESSFUL', 'APPLY_FAILED'], "Expected enum ['UNSET', 'QUIESCING_ENGINE', 'EXTRACTING_METADATA', 'EXPORTING_DOMAIN0', 'PREPARE_SUCCESSFUL', 'QUIESCE_ENGINE_FAILED', 'EXTRACT_METADATA_FAILED', 'EXPORT_DOMAIN0_FAILED', 'APPLYING', 'APPLY_SUCCESSFUL', 'APPLY_FAILED'] but got %s" % obj._state[0]
    ...
    def state(self):
        ...
        *(default value: NONE)* Repave state. *(permitted values: UNSET,
        QUIESCING_ENGINE, EXTRACTING_METADATA, EXPORTING_DOMAIN0,
        PREPARE_SUCCESSFUL, QUIESCE_ENGINE_FAILED, EXTRACT_METADATA_FAILED,
        EXPORT_DOMAIN0_FAILED, APPLYING, APPLY_SUCCESSFUL, APPLY_FAILED)*
    ...
    def source_engine_summary(self):
        ...
        :rtype: :py:class:`v1_11_21.web.vo.RepaveEngineSummary`
        """
    ...
    def source_engine_configurable_metadata(self):
        ...
        :rtype: :py:class:`v1_11_21.web.vo.RepaveConfigurableMetadata`
        """
