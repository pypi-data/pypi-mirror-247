...
#     /delphix-oracle-pdb-export-parameters.json
#
# Do not edit this file manually!
#

from delphixpy.v1_11_21.web.objects.OracleEnhancedExportParameters import OracleEnhancedExportParameters
...
class OraclePDBExportParameters(OracleEnhancedExportParameters):
    """
    *(extends* :py:class:`v1_11_21.web.vo.OracleEnhancedExportParameters` *)*
    Parameters to use as input to export Oracle PDB databases.
    """
    def __init__(self, undef_enabled=True):
        super().__init__()
        self._type = ("OraclePDBExportParameters", True)
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if "transferStrategy" in data and data["transferStrategy"] is not None:
            obj._transfer_strategy = (factory.create_object(data["transferStrategy"], "OracleExportPDBTransferStrategy"), dirty)
            factory.validate_type(obj._transfer_strategy[0], "OracleExportPDBTransferStrategy")
        else:
    ...
    def __eq__(self, other):
        if other is None:
            return False
        if not isinstance(other, OraclePDBExportParameters):
            return False
    ...
    def transfer_strategy(self):
        ...
        :rtype: :py:class:`v1_11_21.web.vo.OracleExportPDBTransferStrategy`
        """
