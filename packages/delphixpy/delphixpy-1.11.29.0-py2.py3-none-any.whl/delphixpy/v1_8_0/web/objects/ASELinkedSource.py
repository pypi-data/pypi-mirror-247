...
from delphixpy.v1_8_0.web.objects.ASESource import ASESource
...
class ASELinkedSource(ASESource):
    """
    *(extends* :py:class:`v1_8_0.web.vo.ASESource` *)* A linked SAP ASE source.
    """
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_8_0.web.vo.ASESourceRuntime`
        """
