...
from delphixpy.v1_8_0.web.objects.MySQLExistingBackupSyncParameters import MySQLExistingBackupSyncParameters
...
class MySQLXtraBackupSyncParameters(MySQLExistingBackupSyncParameters):
    """
    *(extends* :py:class:`v1_8_0.web.vo.MySQLExistingBackupSyncParameters` *)*
