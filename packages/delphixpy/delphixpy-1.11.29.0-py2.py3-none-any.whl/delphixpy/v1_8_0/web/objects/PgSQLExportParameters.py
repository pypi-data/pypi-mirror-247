...
from delphixpy.v1_8_0.web.objects.DbExportParameters import DbExportParameters
...
class PgSQLExportParameters(DbExportParameters):
    """
    *(extends* :py:class:`v1_8_0.web.vo.DbExportParameters` *)* The parameters
    ...
    def filesystem_layout(self):
        ...
        :rtype: :py:class:`v1_8_0.web.vo.TimeflowFilesystemLayout`
        """
    ...
    def source_config(self):
        ...
        :rtype: :py:class:`v1_8_0.web.vo.PgSQLDBClusterConfig`
        """
