...
class CompatibilityCriteria(TypedObject):
    """
    *(extends* :py:class:`v1_8_0.web.vo.TypedObject` *)* The compatibility
    ...
    def is_dirty(self):
        return any([self._architecture[1], self._environment[1], self._os[1], self._processor[1], self._staging_enabled[1]])
