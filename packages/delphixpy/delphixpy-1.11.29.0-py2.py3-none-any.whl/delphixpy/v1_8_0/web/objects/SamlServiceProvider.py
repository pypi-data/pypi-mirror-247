...
from delphixpy.v1_8_0.web.objects.ReadonlyNamedUserObject import ReadonlyNamedUserObject
...
class SamlServiceProvider(ReadonlyNamedUserObject):
    """
    *(extends* :py:class:`v1_8_0.web.vo.ReadonlyNamedUserObject` *)* SAML
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._base_url[0] is not None and obj._base_url[0] is not obj.__undef__:
            assert isinstance(obj._base_url[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._base_url[0], type(obj._base_url[0])))
        ...
        if obj._decrypting_key[0] is not None and obj._decrypting_key[0] is not obj.__undef__:
            assert isinstance(obj._decrypting_key[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._decrypting_key[0], type(obj._decrypting_key[0])))
        ...
        if obj._destination[0] is not None and obj._destination[0] is not obj.__undef__:
            assert isinstance(obj._destination[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._destination[0], type(obj._destination[0])))
        ...
        if obj._hash_alg_url[0] is not None and obj._hash_alg_url[0] is not obj.__undef__:
            assert isinstance(obj._hash_alg_url[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._hash_alg_url[0], type(obj._hash_alg_url[0])))
        ...
        if obj._issuer_id[0] is not None and obj._issuer_id[0] is not obj.__undef__:
            assert isinstance(obj._issuer_id[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._issuer_id[0], type(obj._issuer_id[0])))
        ...
        if obj._signing_key[0] is not None and obj._signing_key[0] is not obj.__undef__:
            assert isinstance(obj._signing_key[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._signing_key[0], type(obj._signing_key[0])))
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        def dictify(obj, prop_is_list_or_vo=False):
            if isinstance(obj, list):
                ...
                return obj
        if "base_url" == "type" or (self.base_url is not self.__undef__ and (not (dirty and not self._base_url[1]) or self.is_dirty_list(self.base_url, self._base_url) or belongs_to_parent)):
            dct["baseUrl"] = dictify(self.base_url)
        if "decrypting_key" == "type" or (self.decrypting_key is not self.__undef__ and (not (dirty and not self._decrypting_key[1]) or self.is_dirty_list(self.decrypting_key, self._decrypting_key) or belongs_to_parent)):
            dct["decryptingKey"] = dictify(self.decrypting_key)
        if "destination" == "type" or (self.destination is not self.__undef__ and (not (dirty and not self._destination[1]) or self.is_dirty_list(self.destination, self._destination) or belongs_to_parent)):
        ...
        if "hash_alg_url" == "type" or (self.hash_alg_url is not self.__undef__ and (not (dirty and not self._hash_alg_url[1]) or self.is_dirty_list(self.hash_alg_url, self._hash_alg_url) or belongs_to_parent)):
            dct["hashAlgUrl"] = dictify(self.hash_alg_url)
        if "issuer_id" == "type" or (self.issuer_id is not self.__undef__ and (not (dirty and not self._issuer_id[1]) or self.is_dirty_list(self.issuer_id, self._issuer_id) or belongs_to_parent)):
            dct["issuerId"] = dictify(self.issuer_id)
        if "signing_key" == "type" or (self.signing_key is not self.__undef__ and (not (dirty and not self._signing_key[1]) or self.is_dirty_list(self.signing_key, self._signing_key) or belongs_to_parent)):
    ...
    def is_dirty(self):
        return any([self._base_url[1], self._decrypting_key[1], self._destination[1], self._entity_id[1], self._hash_alg_url[1], self._issuer_id[1], self._signing_key[1]])
