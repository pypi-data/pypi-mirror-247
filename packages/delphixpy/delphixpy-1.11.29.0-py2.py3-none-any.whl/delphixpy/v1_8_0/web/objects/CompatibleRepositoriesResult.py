...
class CompatibleRepositoriesResult(TypedObject):
    """
    *(extends* :py:class:`v1_8_0.web.vo.TypedObject` *)* Result of a compatible
    ...
    def is_dirty(self):
        return any([self._criteria[1], self._repositories[1]])
    ...
    def criteria(self):
        ...
        :rtype: :py:class:`v1_8_0.web.vo.CompatibilityCriteria`
        """
