...
from delphixpy.v1_8_0.web.objects.Source import Source
...
class OracleSource(Source):
    """
    *(extends* :py:class:`v1_8_0.web.vo.Source` *)* An Oracle source.
    """
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_8_0.web.vo.OracleBaseSourceRuntime`
        """
