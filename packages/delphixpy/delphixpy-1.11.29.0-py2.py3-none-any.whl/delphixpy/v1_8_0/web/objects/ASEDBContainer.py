...
class ASEDBContainer(DatabaseContainer):
    """
    *(extends* :py:class:`v1_8_0.web.vo.DatabaseContainer` *)* An SAP ASE
    Database Container.
    """
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_8_0.web.vo.ASEDBContainerRuntime`
        """
    ...
    def sourcing_policy(self):
        ...
        :rtype: :py:class:`v1_8_0.web.vo.SourcingPolicy`
        """
