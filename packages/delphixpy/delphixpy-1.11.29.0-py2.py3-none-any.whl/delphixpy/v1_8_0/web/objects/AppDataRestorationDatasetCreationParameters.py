...
from delphixpy.v1_8_0.web.objects.RestorationDatasetParameters import RestorationDatasetParameters
...
class AppDataRestorationDatasetCreationParameters(RestorationDatasetParameters):
    """
    *(extends* :py:class:`v1_8_0.web.vo.RestorationDatasetParameters` *)* The
    ...
    def source(self):
        ...
        :rtype: :py:class:`v1_8_0.web.vo.AppDataRestorationSource`
        """
