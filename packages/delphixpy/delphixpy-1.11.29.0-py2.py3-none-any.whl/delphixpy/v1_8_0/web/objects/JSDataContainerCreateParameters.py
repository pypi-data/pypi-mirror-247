...
from delphixpy.v1_8_0.web.objects.JSDataLayoutCreateParameters import JSDataLayoutCreateParameters
...
class JSDataContainerCreateParameters(JSDataLayoutCreateParameters):
    """
    *(extends* :py:class:`v1_8_0.web.vo.JSDataLayoutCreateParameters` *)* The
