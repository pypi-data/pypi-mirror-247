...
class AlertProfile(PersistentObject):
    """
    *(extends* :py:class:`v1_8_0.web.vo.PersistentObject` *)* A profile that
    ...
    def actions(self):
        ...
        :rtype: ``list`` of :py:class:`v1_8_0.web.vo.AlertAction`
        """
    ...
    def filter_spec(self):
        ...
        :rtype: :py:class:`v1_8_0.web.vo.AlertFilter`
        """
