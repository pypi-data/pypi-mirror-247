...
def connector(engine, connector_connectivity=None):
    ...
    :type connector_connectivity:
        :py:class:`v1_8_0.web.vo.ConnectorConnectivity`
    """
...
def jdbc(engine, jdbc_connectivity=None):
    ...
    :type jdbc_connectivity: :py:class:`v1_8_0.web.vo.JDBCConnectivity`
    """
...
def ssh(engine, ssh_connectivity=None):
    ...
    :type ssh_connectivity: :py:class:`v1_8_0.web.vo.SSHConnectivity`
    """
