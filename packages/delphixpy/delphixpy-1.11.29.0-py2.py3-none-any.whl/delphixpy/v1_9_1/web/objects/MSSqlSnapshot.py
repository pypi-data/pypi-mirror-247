...
class MSSqlSnapshot(TimeflowSnapshot):
    """
    *(extends* :py:class:`v1_9_1.web.vo.TimeflowSnapshot` *)* Provisionable
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_9_1.web.vo.MSSqlSnapshotRuntime`
        """
    ...
    def first_change_point(self):
        ...
        :rtype: :py:class:`v1_9_1.web.vo.MSSqlTimeflowPoint`
        """
