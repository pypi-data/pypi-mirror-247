...
class OracleDatabaseContainer(DatabaseContainer):
    """
    *(extends* :py:class:`v1_9_1.web.vo.DatabaseContainer` *)* Data container
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_9_1.web.vo.OracleDBContainerRuntime`
        """
    ...
    def sourcing_policy(self):
        ...
        :rtype: :py:class:`v1_9_1.web.vo.OracleSourcingPolicy`
        """
