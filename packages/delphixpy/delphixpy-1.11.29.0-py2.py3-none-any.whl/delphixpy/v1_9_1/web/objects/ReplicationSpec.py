...
class ReplicationSpec(UserObject):
    """
    *(extends* :py:class:`v1_9_1.web.vo.UserObject` *)* Replication setup.
    """
    ...
    def object_specification(self):
        ...
        :rtype: :py:class:`v1_9_1.web.vo.ReplicationObjectSpecification`
        """
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_9_1.web.vo.ReplicationSpecRuntime`
        """
