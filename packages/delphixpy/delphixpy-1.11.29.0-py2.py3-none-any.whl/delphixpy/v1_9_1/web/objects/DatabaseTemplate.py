...
class DatabaseTemplate(NamedUserObject):
    """
    *(extends* :py:class:`v1_9_1.web.vo.NamedUserObject` *)* Parameter
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._source_type[0] is not None and obj._source_type[0] is not obj.__undef__:
            ...
            assert obj._source_type[0] in ['MySQLVirtualSource', 'OracleVirtualSource', 'MSSqlVirtualSource', 'PgSQLVirtualSource'], "Expected enum ['MySQLVirtualSource', 'OracleVirtualSource', 'MSSqlVirtualSource', 'PgSQLVirtualSource'] but got %s" % obj._source_type[0]
