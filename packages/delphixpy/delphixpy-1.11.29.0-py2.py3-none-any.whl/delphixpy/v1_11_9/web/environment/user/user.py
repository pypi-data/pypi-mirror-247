...
def create(engine, environment_user=None):
    ...
    :type environment_user: :py:class:`v1_11_9.web.vo.EnvironmentUser`
    :rtype: ``str``
    """
...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_11_9.web.objects.EnvironmentUser.EnvironmentUse
        r` object
    :type ref: ``str``
...
def get_all(engine, environment=None):
    ...
    :rtype: ``list`` of :py:class:`v1_11_9.web.vo.EnvironmentUser`
    """
    url = "/resources/json/delphix/environment/user"
