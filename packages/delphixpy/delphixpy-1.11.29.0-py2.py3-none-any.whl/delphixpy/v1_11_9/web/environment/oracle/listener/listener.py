...
def create(engine, oracle_listener=None):
    ...
    :type oracle_listener: :py:class:`v1_11_9.web.vo.OracleListener`
    :rtype: ``str``
    """
...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_11_9.web.objects.OracleListener.OracleListener`
        object
    :type ref: ``str``
    :rtype: :py:class:`v1_11_9.web.vo.OracleListener`
    """
...
def get_all(engine, type=None, environment=None):
    ...
    :rtype: ``list`` of :py:class:`v1_11_9.web.vo.OracleListener`
    """
    url = "/resources/json/delphix/environment/oracle/listener"
