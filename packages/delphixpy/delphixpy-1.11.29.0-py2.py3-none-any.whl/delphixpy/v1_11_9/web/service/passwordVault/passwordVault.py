...
def create(engine, password_vault=None):
    ...
    :type password_vault: :py:class:`v1_11_9.web.vo.PasswordVault`
    :rtype: ``str``
    """
...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_11_9.web.objects.PasswordVault.PasswordVault`
        object
    :type ref: ``str``
    :rtype: :py:class:`v1_11_9.web.vo.PasswordVault`
    """
...
def get_all(engine):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_11_9.delphix_engine.DelphixEngine`
    :rtype: ``list`` of :py:class:`v1_11_9.web.vo.PasswordVault`
    """
    url = "/resources/json/delphix/service/passwordVault"
    response = engine.get(url)
    result = response_validator.validate(response, engine)
...
def validate_vault(engine, password_vault_test_parameters=None):
    ...
    :type password_vault_test_parameters:
        :py:class:`v1_11_9.web.vo.PasswordVaultTestParameters`
    """
