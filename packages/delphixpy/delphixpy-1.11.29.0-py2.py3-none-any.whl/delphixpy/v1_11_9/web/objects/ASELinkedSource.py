...
from delphixpy.v1_11_9.web.objects.ASESource import ASESource
...
class ASELinkedSource(ASESource):
    """
    *(extends* :py:class:`v1_11_9.web.vo.ASESource` *)* A linked SAP ASE
    source.
    """
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_11_9.web.vo.ASESourceRuntime`
        """
