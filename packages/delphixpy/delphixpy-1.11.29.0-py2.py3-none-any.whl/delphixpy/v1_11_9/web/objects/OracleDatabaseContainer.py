...
from delphixpy.v1_11_9.web.objects.DatabaseContainer import DatabaseContainer
...
class OracleDatabaseContainer(DatabaseContainer):
    """
    *(extends* :py:class:`v1_11_9.web.vo.DatabaseContainer` *)* Data container
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_11_9.web.vo.OracleDBContainerRuntime`
        """
    ...
    def sourcing_policy(self):
        ...
        :rtype: :py:class:`v1_11_9.web.vo.OracleSourcingPolicy`
        """
    ...
    def rac_max_instance_lag(self):
        """
        Maximum number of log sequences that a node can lag behind on RAC
        before considering instance offline.
