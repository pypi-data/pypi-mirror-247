...
from delphixpy.v1_11_9.web.objects.VirtualDatasetCreationParameters import VirtualDatasetCreationParameters
...
class ProvisionParameters(VirtualDatasetCreationParameters):
    """
    *(extends* :py:class:`v1_11_9.web.vo.VirtualDatasetCreationParameters` *)*
    ...
    def timeflow_point_parameters(self):
        ...
        :rtype: :py:class:`v1_11_9.web.vo.TimeflowPointParameters`
        """
