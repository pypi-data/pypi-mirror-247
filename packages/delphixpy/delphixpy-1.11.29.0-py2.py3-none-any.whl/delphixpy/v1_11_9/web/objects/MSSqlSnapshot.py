...
from delphixpy.v1_11_9.web.objects.TimeflowSnapshot import TimeflowSnapshot
...
class MSSqlSnapshot(TimeflowSnapshot):
    """
    *(extends* :py:class:`v1_11_9.web.vo.TimeflowSnapshot` *)* Provisionable
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_11_9.web.vo.MSSqlSnapshotRuntime`
        """
    ...
    def first_change_point(self):
        ...
        :rtype: :py:class:`v1_11_9.web.vo.MSSqlTimeflowPoint`
        """
