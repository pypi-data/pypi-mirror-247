...
class ASEVirtualSource(ASESource):
    """
    *(extends* :py:class:`v1_11_9.web.vo.ASESource` *)* A virtual SAP ASE
    source.
    """
    ...
    def operations(self):
        ...
        :rtype: :py:class:`v1_11_9.web.vo.VirtualSourceOperations`
        """
    ...
    def runtime_mount_information(self):
        ...
        :rtype: :py:class:`v1_11_9.web.vo.RuntimeMountInformation`
        """
