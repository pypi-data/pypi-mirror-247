...
from delphixpy.v1_11_9.web.objects.CreateTransformationParameters import CreateTransformationParameters
...
class AppDataCreateTransformationParameters(CreateTransformationParameters):
    """
    *(extends* :py:class:`v1_11_9.web.vo.CreateTransformationParameters` *)*
