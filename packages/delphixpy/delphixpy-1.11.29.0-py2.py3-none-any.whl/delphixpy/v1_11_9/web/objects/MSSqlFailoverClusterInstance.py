...
from delphixpy.v1_11_9.web.objects.MSSqlBaseClusterInstance import MSSqlBaseClusterInstance
...
class MSSqlFailoverClusterInstance(MSSqlBaseClusterInstance):
    """
    *(extends* :py:class:`v1_11_9.web.vo.MSSqlBaseClusterInstance` *)* The
