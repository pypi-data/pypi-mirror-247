...
from delphixpy.v1_4_2.web.objects.SourceRuntime import SourceRuntime
...
class OracleBaseSourceRuntime(SourceRuntime):
    """
    *(extends* :py:class:`v1_4_2.web.vo.SourceRuntime` *)* Runtime (non-
    ...
    def is_dirty(self):
        return any([self._active_instances[1], self._database_mode[1], self._database_stats[1], self._last_non_logged_location[1]])
    ...
    def active_instances(self):
        ...
        :rtype: ``list`` of :py:class:`v1_4_2.web.vo.OracleActiveInstance`
        """
    ...
    def database_stats(self):
        ...
        :rtype: ``list`` of
            :py:class:`v1_4_2.web.vo.OracleDatabaseStatsSection`
        """
