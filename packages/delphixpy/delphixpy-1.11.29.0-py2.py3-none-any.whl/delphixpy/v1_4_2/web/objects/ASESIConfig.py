...
from delphixpy.v1_4_2.web.objects.ASEDBConfig import ASEDBConfig
...
class ASESIConfig(ASEDBConfig):
    """
    *(extends* :py:class:`v1_4_2.web.vo.ASEDBConfig` *)* A SAP ASE single
    ...
    def instance(self):
        ...
        :rtype: :py:class:`v1_4_2.web.vo.ASEInstanceConfig`
        """
