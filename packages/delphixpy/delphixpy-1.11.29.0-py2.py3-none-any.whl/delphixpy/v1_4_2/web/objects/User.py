...
class User(NamedUserObject):
    """
    *(extends* :py:class:`v1_4_2.web.vo.NamedUserObject` *)* Delphix users.
    """
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._locale[0] is not None and obj._locale[0] is not obj.__undef__:
            ...
            assert obj._locale[0] in ['en_US'], "Expected enum ['en_US'] but got %s" % obj._locale[0]
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "password_update_requested" == "type" or (self.password_update_requested is not self.__undef__ and (not (dirty and not self._password_update_requested[1]) or self.is_dirty_list(self.password_update_requested, self._password_update_requested) or belongs_to_parent)):
