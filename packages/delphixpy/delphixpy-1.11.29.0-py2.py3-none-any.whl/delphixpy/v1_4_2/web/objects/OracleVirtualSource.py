...
from delphixpy.v1_4_2.web.objects.OracleSource import OracleSource
...
class OracleVirtualSource(OracleSource):
    """
    *(extends* :py:class:`v1_4_2.web.vo.OracleSource` *)* A virtual Oracle
    source.
    """
    ...
    def operations(self):
        ...
        :rtype: :py:class:`v1_4_2.web.vo.VirtualSourceOperations`
        """
