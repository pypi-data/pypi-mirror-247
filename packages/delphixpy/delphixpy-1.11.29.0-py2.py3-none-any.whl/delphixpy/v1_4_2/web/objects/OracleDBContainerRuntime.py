...
from delphixpy.v1_4_2.web.objects.DBContainerRuntime import DBContainerRuntime
...
class OracleDBContainerRuntime(DBContainerRuntime):
    """
    *(extends* :py:class:`v1_4_2.web.vo.DBContainerRuntime` *)* Runtime
    ...
    def is_dirty(self):
        return any([self._cross_platform_eligible[1], self._cross_platform_script_uploaded[1]])
