...
from delphixpy.v1_4_2.web.objects.BaseConsumerCapacityData import BaseConsumerCapacityData
...
class CurrentConsumerCapacityData(BaseConsumerCapacityData):
    """
    *(extends* :py:class:`v1_4_2.web.vo.BaseConsumerCapacityData` *)* Current
