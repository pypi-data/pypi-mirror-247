...
from delphixpy.v1_4_2.web.objects.JSOperationEndpointParameters import JSOperationEndpointParameters
...
class JSOperationEndpointDataLayoutParameters(JSOperationEndpointParameters):
    """
    *(extends* :py:class:`v1_4_2.web.vo.JSOperationEndpointParameters` *)* The
