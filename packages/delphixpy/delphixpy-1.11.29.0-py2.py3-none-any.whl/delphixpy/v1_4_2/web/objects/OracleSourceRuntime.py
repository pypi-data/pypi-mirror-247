...
from delphixpy.v1_4_2.web.objects.OracleBaseSourceRuntime import OracleBaseSourceRuntime
...
class OracleSourceRuntime(OracleBaseSourceRuntime):
    """
    *(extends* :py:class:`v1_4_2.web.vo.OracleBaseSourceRuntime` *)* Runtime
