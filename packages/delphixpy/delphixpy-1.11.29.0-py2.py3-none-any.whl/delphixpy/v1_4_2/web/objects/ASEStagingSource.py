...
class ASEStagingSource(ASESource):
    """
    *(extends* :py:class:`v1_4_2.web.vo.ASESource` *)* An SAP ASE staging
    ...
    def is_dirty(self):
        return any([self._mount_base[1], self._post_script[1], self._pre_script[1]])
    ...
    def mount_base(self):
        """
        The base mountpoint for the NFS mounts.
