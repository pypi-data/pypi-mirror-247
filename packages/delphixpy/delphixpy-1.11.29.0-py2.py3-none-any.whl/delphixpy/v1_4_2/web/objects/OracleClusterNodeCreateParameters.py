...
class OracleClusterNodeCreateParameters(TypedObject):
    """
    *(extends* :py:class:`v1_4_2.web.vo.TypedObject` *)* The parameters used
    ...
    def host_parameters(self):
        ...
        :rtype: :py:class:`v1_4_2.web.vo.HostCreateParameters`
        """
    ...
    def virtual_i_ps(self):
        ...
        :rtype: ``list`` of :py:class:`v1_4_2.web.vo.OracleVirtualIP`
        """
