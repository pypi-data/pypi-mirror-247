...
from delphixpy.v1_4_2.web.objects.TimeflowPointParameters import TimeflowPointParameters
...
class TimeflowPointTimestamp(TimeflowPointParameters):
    """
    *(extends* :py:class:`v1_4_2.web.vo.TimeflowPointParameters` *)* Timeflow
    ...
    def is_dirty(self):
        return any([self._timeflow[1], self._timestamp[1]])
