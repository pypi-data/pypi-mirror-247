...
class AppDataAdditionalMountPoint(TypedObject):
    """
    *(extends* :py:class:`v1_4_2.web.vo.TypedObject` *)* Specifies an
    ...
    def is_dirty(self):
        return any([self._environment[1], self._environment_user[1], self._mount_path[1], self._shared_path[1]])
    ...
    def environment_user(self):
        """
        Reference to the environment user that will perform the mount
        operation.
