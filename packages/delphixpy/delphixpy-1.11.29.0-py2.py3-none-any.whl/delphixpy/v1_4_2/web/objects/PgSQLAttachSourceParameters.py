...
from delphixpy.v1_4_2.web.objects.AttachSourceParameters import AttachSourceParameters
...
class PgSQLAttachSourceParameters(AttachSourceParameters):
    """
    *(extends* :py:class:`v1_4_2.web.vo.AttachSourceParameters` *)* Represents
    ...
    def is_dirty(self):
        return any([self._connection_database[1], self._db_credentials[1], self._db_user[1], self._ppt_host_user[1], self._ppt_repository[1]])
