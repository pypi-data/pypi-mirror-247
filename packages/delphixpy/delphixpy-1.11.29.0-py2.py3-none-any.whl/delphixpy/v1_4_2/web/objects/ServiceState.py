...
class ServiceState(TypedObject):
    """
    *(extends* :py:class:`v1_4_2.web.vo.TypedObject` *)* The runtime state of a
    Delphix service.
    """
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        def dictify(obj, prop_is_list_or_vo=False):
            if isinstance(obj, list):
                ...
                return obj
        if "state" == "type" or (self.state is not self.__undef__ and (not (dirty and not self._state[1]) or self.is_dirty_list(self.state, self._state) or belongs_to_parent)):
