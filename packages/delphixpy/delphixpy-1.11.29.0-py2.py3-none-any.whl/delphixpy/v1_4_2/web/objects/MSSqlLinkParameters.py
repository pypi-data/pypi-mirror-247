...
class MSSqlLinkParameters(LinkParameters):
    """
    *(extends* :py:class:`v1_4_2.web.vo.LinkParameters` *)* MSSQL specific
    ...
    def container(self):
        ...
        :rtype: :py:class:`v1_4_2.web.vo.MSSqlDatabaseContainer`
        """
    ...
    def source(self):
        ...
        :rtype: :py:class:`v1_4_2.web.vo.MSSqlLinkedSource`
        """
