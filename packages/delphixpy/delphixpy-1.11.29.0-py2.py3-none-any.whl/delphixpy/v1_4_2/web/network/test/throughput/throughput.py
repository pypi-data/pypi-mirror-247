...
def create(engine, network_throughput_test_execute_parameters):
    """
    Create a new NetworkThroughputTest object.

    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_4_2.delphix_engine.DelphixEngine`
    :param network_throughput_test_execute_parameters: Payload object.
    :type network_throughput_test_execute_parameters:
        :py:class:`v1_4_2.web.vo.NetworkThroughputTestExecuteParameters`
    :rtype: ``str``
    """
    url = "/resources/json/delphix/network/test/throughput"
    response = engine.post(url, network_throughput_test_execute_parameters.to_dict(dirty=True) if network_throughput_test_execute_parameters else None)
...
def get(engine, ref):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_4_2.delphix_engine.DelphixEngine`
    :param ref: Reference to a :py:class:`delphixpy.v1_4_2.web.objects.NetworkT
        hroughputTest.NetworkThroughputTest` object
    :type ref: ``str``
    :rtype: :py:class:`v1_4_2.web.vo.NetworkThroughputTest`
    """
...
def get_all(engine):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_4_2.delphix_engine.DelphixEngine`
    :rtype: ``list`` of :py:class:`v1_4_2.web.vo.NetworkThroughputTest`
    """
    url = "/resources/json/delphix/network/test/throughput"
    response = engine.get(url)
    result = response_validator.validate(response, engine)
