...
from delphixpy.v1_11_14.web.objects.OracleDBConfig import OracleDBConfig
...
class OracleRACConfig(OracleDBConfig):
    """
    *(extends* :py:class:`v1_11_14.web.vo.OracleDBConfig` *)* Representation of
    ...
    def instances(self):
        ...
        :rtype: ``list`` of :py:class:`v1_11_14.web.vo.OracleRACInstance`
        """
