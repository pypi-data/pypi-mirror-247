...
from delphixpy.v1_11_14.web.objects.OracleSyncParameters import OracleSyncParameters
...
class OracleSyncFromExternalParameters(OracleSyncParameters):
    """
    *(extends* :py:class:`v1_11_14.web.vo.OracleSyncParameters` *)* The
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        def dictify(obj, prop_is_list_or_vo=False):
            if isinstance(obj, list):
                ...
                return obj
        if "force_full_backup" == "type" or (self.force_full_backup is not self.__undef__ and (not (dirty and not self._force_full_backup[1]) or self.is_dirty_list(self.force_full_backup, self._force_full_backup) or belongs_to_parent)):
        ...
        if "skip_space_check" == "type" or (self.skip_space_check is not self.__undef__ and (not (dirty and not self._skip_space_check[1]) or self.is_dirty_list(self.skip_space_check, self._skip_space_check) or belongs_to_parent)):
        ...
        if "do_not_resume" == "type" or (self.do_not_resume is not self.__undef__ and (not (dirty and not self._do_not_resume[1]) or self.is_dirty_list(self.do_not_resume, self._do_not_resume) or belongs_to_parent)):
        ...
        if "files_for_full_backup" == "type" or (self.files_for_full_backup is not self.__undef__ and (not (dirty and not self._files_for_full_backup[1]) or self.is_dirty_list(self.files_for_full_backup, self._files_for_full_backup) or belongs_to_parent)):
