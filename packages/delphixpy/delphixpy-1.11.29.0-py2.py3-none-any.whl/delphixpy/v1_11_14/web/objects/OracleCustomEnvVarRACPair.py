...
from delphixpy.v1_11_14.web.objects.OracleCustomEnvVarPair import OracleCustomEnvVarPair
...
class OracleCustomEnvVarRACPair(OracleCustomEnvVarPair):
    """
    *(extends* :py:class:`v1_11_14.web.vo.OracleCustomEnvVarPair` *)* Dictates
