...
from delphixpy.v1_11_14.web.objects.BaseSystemCapacityData import BaseSystemCapacityData
...
class CurrentSystemCapacityData(BaseSystemCapacityData):
    """
    *(extends* :py:class:`v1_11_14.web.vo.BaseSystemCapacityData` *)* Capacity
