...
Package "host"
"""
from delphixpy.v1_11_5.web.host import privilegeElevation
...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_11_5.web.objects.Host.Host` object
    :type ref: ``str``
    :rtype: :py:class:`v1_11_5.web.vo.Host`
    """
...
def get_all(engine, environment=None):
    ...
    :rtype: ``list`` of :py:class:`v1_11_5.web.vo.Host`
    """
...
def update(engine, ref, host=None):
    ...
    :type host: :py:class:`v1_11_5.web.vo.Host`
    """
    url = "/resources/json/delphix/host/%s" % ref
...
def validate_java(engine, validate_java_parameters=None):
    ...
    :type validate_java_parameters:
        :py:class:`v1_11_5.web.vo.ValidateJavaParameters`
    :rtype: ``str``
    """
