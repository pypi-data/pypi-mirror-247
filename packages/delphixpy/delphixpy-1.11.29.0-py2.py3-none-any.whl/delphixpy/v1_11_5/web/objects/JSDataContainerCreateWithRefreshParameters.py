...
from delphixpy.v1_11_5.web.objects.JSDataContainerCreateParameters import JSDataContainerCreateParameters
...
class JSDataContainerCreateWithRefreshParameters(JSDataContainerCreateParameters):
    """
    *(extends* :py:class:`v1_11_5.web.vo.JSDataContainerCreateParameters` *)*
