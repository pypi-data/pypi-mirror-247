...
from delphixpy.v1_11_5.web.objects.HostEnvironment import HostEnvironment
...
class UnixHostEnvironment(HostEnvironment):
    """
    *(extends* :py:class:`v1_11_5.web.vo.HostEnvironment` *)* The
    ...
    def ase_host_environment_parameters(self):
        ...
        :rtype: :py:class:`v1_11_5.web.vo.ASEHostEnvironmentParameters`
        """
