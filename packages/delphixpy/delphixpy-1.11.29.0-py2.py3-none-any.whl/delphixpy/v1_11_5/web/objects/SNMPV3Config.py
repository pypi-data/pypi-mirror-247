...
class SNMPV3Config(TypedObject):
    """
    *(extends* :py:class:`v1_11_5.web.vo.TypedObject` *)* SNMP configuration.
    """
    ...
    def is_dirty(self):
        return any([self._enabled[1], self._authorized_network[1], self._engine_id[1], self._security_model[1], self._location[1], self._severity[1]])
