...
def create(engine, pem_certificate):
    ...
    :type pem_certificate: :py:class:`v1_11_13.web.vo.PemCertificate`
    :rtype: ``str``
    """
...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_11_13.web.objects.CaCertificate.CaCertificate`
        object
    :type ref: ``str``
    :rtype: :py:class:`v1_11_13.web.vo.CaCertificate`
    """
...
def get_all(engine, delphix_ca=None):
    ...
    :rtype: ``list`` of :py:class:`v1_11_13.web.vo.CaCertificate`
    """
    url = "/resources/json/delphix/service/tls/caCertificate"
...
def fetch(engine, certificate_fetch_parameters=None):
    ...
    :type certificate_fetch_parameters:
        :py:class:`v1_11_13.web.vo.CertificateFetchParameters`
    :rtype: :py:class:`v1_11_13.web.vo.CaCertificate`
    """
