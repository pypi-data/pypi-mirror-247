...
from delphixpy.v1_11_13.web.objects.OracleBaseStagingLinkData import OracleBaseStagingLinkData
...
class OraclePDBLinkFromStaging(OracleBaseStagingLinkData):
    """
    *(extends* :py:class:`v1_11_13.web.vo.OracleBaseStagingLinkData` *)*
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if "cdbConfig" in data and data["cdbConfig"] is not None:
            obj._cdb_config = (factory.create_object(data["cdbConfig"], "OracleDBConfig"), dirty)
            factory.validate_type(obj._cdb_config[0], "OracleDBConfig")
        else:
            obj._cdb_config = (obj.__undef__, dirty)
        return obj
