...
from delphixpy.v1_11_13.web.objects.MySQLReplicationCoordinates import MySQLReplicationCoordinates
...
class MySQLGtidCoordinates(MySQLReplicationCoordinates):
    """
    *(extends* :py:class:`v1_11_13.web.vo.MySQLReplicationCoordinates` *)* The
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        def dictify(obj, prop_is_list_or_vo=False):
            if isinstance(obj, list):
                ...
                return obj
        if "gtids" == "type" or (self.gtids is not self.__undef__ and (not (dirty and not self._gtids[1]) or self.is_dirty_list(self.gtids, self._gtids) or belongs_to_parent)):
