...
from delphixpy.v1_11_13.web.objects.OracleSyncStrategy import OracleSyncStrategy
...
class OracleSourceLessSyncStrategy(OracleSyncStrategy):
    """
    *(extends* :py:class:`v1_11_13.web.vo.OracleSyncStrategy` *)* Base type for
    ...
    def is_dirty(self):
        return any([self._staging_source[1]])
