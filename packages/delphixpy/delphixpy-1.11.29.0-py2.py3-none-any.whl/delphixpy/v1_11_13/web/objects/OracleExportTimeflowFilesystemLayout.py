...
from delphixpy.v1_11_13.web.objects.TimeflowFilesystemLayout import TimeflowFilesystemLayout
...
class OracleExportTimeflowFilesystemLayout(TimeflowFilesystemLayout):
    """
    *(extends* :py:class:`v1_11_13.web.vo.TimeflowFilesystemLayout` *)* A
