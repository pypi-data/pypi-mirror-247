...
class OracleStagingSourceParameters(TypedObject):
    """
    *(extends* :py:class:`v1_11_13.web.vo.TypedObject` *)* Parameters provided
    ...
    def is_dirty(self):
        return any([self._repository[1], self._environment_user[1], self._mount_base[1], self._config_params[1], self._config_template[1], self._instance_name[1]])
