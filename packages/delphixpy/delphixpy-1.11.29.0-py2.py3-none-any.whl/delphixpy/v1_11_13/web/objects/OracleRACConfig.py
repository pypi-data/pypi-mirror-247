...
from delphixpy.v1_11_13.web.objects.OracleDBConfig import OracleDBConfig
...
class OracleRACConfig(OracleDBConfig):
    """
    *(extends* :py:class:`v1_11_13.web.vo.OracleDBConfig` *)* Representation of
    ...
    def instances(self):
        ...
        :rtype: ``list`` of :py:class:`v1_11_13.web.vo.OracleRACInstance`
        """
