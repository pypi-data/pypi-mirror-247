...
def get(engine):
    ...
    :rtype: :py:class:`v1_11_13.web.vo.S3ObjectStore`
    """
...
def set(engine, s3_object_store=None):
    ...
    :type s3_object_store: :py:class:`v1_11_13.web.vo.S3ObjectStore`
    """
    url = "/resources/json/delphix/storage/objectStorage"
...
def test_connection(engine, s3_object_store_test):
    ...
    :type s3_object_store_test: :py:class:`v1_11_13.web.vo.S3ObjectStoreTest`
    """
