...
class DynamicParameterValue(TypedObject):
    """
    *(extends* :py:class:`v1_6_2.web.vo.TypedObject` *)* A settable value for a
    ...
    def definition(self):
        """
        The constraints this value will be validated against.

        :rtype: :py:class:`v1_6_2.web.vo.DynamicParameter`
        """
