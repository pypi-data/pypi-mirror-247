...
class AppDataVirtualSource(AppDataManagedSource):
    """
    *(extends* :py:class:`v1_6_2.web.vo.AppDataManagedSource` *)* A virtual
    AppData source.
    """
    ...
    def additional_mount_points(self):
        ...
        :rtype: ``list`` of
            :py:class:`v1_6_2.web.vo.AppDataAdditionalMountPoint`
        """
    ...
    def parameters(self):
        ...
        :rtype: ``list`` of :py:class:`v1_6_2.web.vo.DynamicParameterValue`
        """
