...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_6_2.web.objects.Namespace.Namespace` object
    :type ref: ``str``
    :rtype: :py:class:`v1_6_2.web.vo.Namespace`
    """
...
def get_all(engine):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_6_2.delphix_engine.DelphixEngine`
    :rtype: ``list`` of :py:class:`v1_6_2.web.vo.Namespace`
    """
...
def update(engine, ref, namespace=None):
    ...
    :type namespace: :py:class:`v1_6_2.web.vo.Namespace`
    """
    url = "/resources/json/delphix/namespace/%s" % ref
