...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_11_4.web.objects.SystemPackage.SystemPackage`
        object
    :type ref: ``str``
    :rtype: :py:class:`v1_11_4.web.vo.SystemPackage`
    """
...
def get_all(engine):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_11_4.delphix_engine.DelphixEngine`
    :rtype: ``list`` of :py:class:`v1_11_4.web.vo.SystemPackage`
    """
...
def update(engine, ref, system_package=None):
    ...
    :type system_package: :py:class:`v1_11_4.web.vo.SystemPackage`
    """
    url = "/resources/json/delphix/system/package/%s" % ref
