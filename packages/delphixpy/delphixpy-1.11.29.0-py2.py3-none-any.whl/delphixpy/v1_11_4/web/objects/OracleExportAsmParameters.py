...
class OracleExportAsmParameters(ExportParameters):
    """
    *(extends* :py:class:`v1_11_4.web.vo.ExportParameters` *)* The parameters
    ...
    def source_config(self):
        ...
        :rtype: :py:class:`v1_11_4.web.vo.OracleDBConfig`
        """
    ...
    def source(self):
        ...
        :rtype: :py:class:`v1_11_4.web.vo.OracleVirtualSource`
        """
