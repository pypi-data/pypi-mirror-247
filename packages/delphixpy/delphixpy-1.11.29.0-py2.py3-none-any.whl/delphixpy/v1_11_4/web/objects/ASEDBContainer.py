...
class ASEDBContainer(DatabaseContainer):
    """
    *(extends* :py:class:`v1_11_4.web.vo.DatabaseContainer` *)* An SAP ASE
    Database Container.
    """
    ...
    def sourcing_policy(self):
        ...
        :rtype: :py:class:`v1_11_4.web.vo.SourcingPolicy`
        """
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_11_4.web.vo.ASEDBContainerRuntime`
        """
