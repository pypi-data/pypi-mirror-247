...
def create(engine, alert_profile=None):
    ...
    :type alert_profile: :py:class:`v1_9_0.web.vo.AlertProfile`
    :rtype: ``str``
    """
...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_9_0.web.objects.AlertProfile.AlertProfile`
        object
    :type ref: ``str``
    :rtype: :py:class:`v1_9_0.web.vo.AlertProfile`
    """
...
def get_all(engine):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_9_0.delphix_engine.DelphixEngine`
    :rtype: ``list`` of :py:class:`v1_9_0.web.vo.AlertProfile`
    """
    url = "/resources/json/delphix/alert/profile"
    response = engine.get(url)
    result = response_validator.validate(response, engine)
