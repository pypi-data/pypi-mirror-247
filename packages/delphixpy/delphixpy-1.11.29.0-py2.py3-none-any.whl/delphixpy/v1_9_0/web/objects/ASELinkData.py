...
from delphixpy.v1_9_0.web.objects.LinkData import LinkData
...
class ASELinkData(LinkData):
    """
    *(extends* :py:class:`v1_9_0.web.vo.LinkData` *)* SAP ASE specific
    ...
    def sync_parameters(self):
        ...
        :rtype: :py:class:`v1_9_0.web.vo.ASESyncParameters`
        """
