...
class Toolkit(NamedUserObject):
    """
    *(extends* :py:class:`v1_9_0.web.vo.NamedUserObject` *)* An installed
    toolkit.
    """
    ...
    def virtual_source_definition(self):
        ...
        :rtype: :py:class:`v1_9_0.web.vo.ToolkitVirtualSource`
        """
    ...
    def linked_source_definition(self):
        ...
        :rtype: :py:class:`v1_9_0.web.vo.ToolkitLinkedSource`
        """
    ...
    def discovery_definition(self):
        ...
        :rtype: :py:class:`v1_9_0.web.vo.ToolkitDiscoveryDefinition`
        """
    ...
    def upgrade_definition(self):
        ...
        :rtype: :py:class:`v1_9_0.web.vo.ToolkitUpgradeDefinition`
        """
    ...
    def messages(self):
        ...
        :rtype: ``list`` of :py:class:`v1_9_0.web.vo.ToolkitLocale`
        """
