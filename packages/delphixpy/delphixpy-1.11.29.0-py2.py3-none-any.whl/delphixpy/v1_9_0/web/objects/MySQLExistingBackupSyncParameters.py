...
from delphixpy.v1_9_0.web.objects.MySQLSyncParameters import MySQLSyncParameters
...
class MySQLExistingBackupSyncParameters(MySQLSyncParameters):
    """
    *(extends* :py:class:`v1_9_0.web.vo.MySQLSyncParameters` *)* The parameters
    ...
    def replication_coordinates(self):
        ...
        :rtype: :py:class:`v1_9_0.web.vo.MySQLReplicationCoordinates`
        """
