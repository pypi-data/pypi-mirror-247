...
class ToolkitVirtualSource(TypedObject):
    """
    *(extends* :py:class:`v1_9_0.web.vo.TypedObject` *)* A virtual source
    ...
    def is_dirty(self):
        return any([self._parameters[1], self._configure[1], self._unconfigure[1], self._reconfigure[1], self._initialize[1], self._start[1], self._stop[1], self._pre_snapshot[1], self._post_snapshot[1], self._mount_spec[1], self._status[1]])
