...
from delphixpy.v1_9_0.web.objects.OracleBaseProvisionParameters import OracleBaseProvisionParameters
...
class OracleMultitenantProvisionParameters(OracleBaseProvisionParameters):
    """
    *(extends* :py:class:`v1_9_0.web.vo.OracleBaseProvisionParameters` *)* The
    ...
    def source_config(self):
        ...
        :rtype: :py:class:`v1_9_0.web.vo.OraclePDBConfig`
        """
    ...
    def source(self):
        ...
        :rtype: :py:class:`v1_9_0.web.vo.OracleVirtualPdbSource`
        """
    ...
    def virtual_cdb(self):
        ...
        :rtype: :py:class:`v1_9_0.web.vo.OracleVirtualCdbProvisionParameters`
        """
