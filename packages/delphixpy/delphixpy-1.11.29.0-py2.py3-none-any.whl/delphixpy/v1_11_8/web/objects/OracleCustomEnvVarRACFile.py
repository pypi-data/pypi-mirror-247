...
from delphixpy.v1_11_8.web.objects.OracleCustomEnvVarFile import OracleCustomEnvVarFile
...
class OracleCustomEnvVarRACFile(OracleCustomEnvVarFile):
    """
    *(extends* :py:class:`v1_11_8.web.vo.OracleCustomEnvVarFile` *)* Dictates
