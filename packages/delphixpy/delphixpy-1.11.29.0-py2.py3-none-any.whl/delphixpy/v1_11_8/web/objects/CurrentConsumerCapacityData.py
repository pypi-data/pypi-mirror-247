...
from delphixpy.v1_11_8.web.objects.BaseConsumerCapacityData import BaseConsumerCapacityData
...
class CurrentConsumerCapacityData(BaseConsumerCapacityData):
    """
    *(extends* :py:class:`v1_11_8.web.vo.BaseConsumerCapacityData` *)* Current
