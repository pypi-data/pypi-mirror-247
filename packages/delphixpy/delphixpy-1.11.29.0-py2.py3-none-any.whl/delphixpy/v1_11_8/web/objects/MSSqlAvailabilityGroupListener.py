...
from delphixpy.v1_11_8.web.objects.MSSqlBaseClusterListener import MSSqlBaseClusterListener
...
class MSSqlAvailabilityGroupListener(MSSqlBaseClusterListener):
    """
    *(extends* :py:class:`v1_11_8.web.vo.MSSqlBaseClusterListener` *)* The
