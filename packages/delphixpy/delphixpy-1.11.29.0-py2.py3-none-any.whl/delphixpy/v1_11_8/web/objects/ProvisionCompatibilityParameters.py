...
from delphixpy.v1_11_8.web.objects.CompatibleRepositoriesParameters import CompatibleRepositoriesParameters
...
class ProvisionCompatibilityParameters(CompatibleRepositoriesParameters):
    """
    *(extends* :py:class:`v1_11_8.web.vo.CompatibleRepositoriesParameters` *)*
    ...
    def timeflow_point_parameters(self):
        ...
        :rtype: :py:class:`v1_11_8.web.vo.TimeflowPointParameters`
        """
