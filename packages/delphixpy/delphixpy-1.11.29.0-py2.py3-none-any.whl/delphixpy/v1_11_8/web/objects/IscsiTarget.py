...
class IscsiTarget(PersistentObject):
    """
    *(extends* :py:class:`v1_11_8.web.vo.PersistentObject` *)* Configuration of
    an iSCSI target endpoint.
    """
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._state[0] is not None and obj._state[0] is not obj.__undef__:
            ...
            assert obj._state[0] in ['NOT_CONNECTED', 'CONNECTED', 'IN_USE'], "Expected enum ['NOT_CONNECTED', 'CONNECTED', 'IN_USE'] but got %s" % obj._state[0]
    ...
    def is_dirty(self):
        return any([self._name[1], self._iqn[1], self._portal[1], self._port[1], self._state[1]])
