...
from delphixpy.v1_11_8.web.objects.JSDataContainerCreateParameters import JSDataContainerCreateParameters
...
class JSDataContainerCreateWithRefreshParameters(JSDataContainerCreateParameters):
    """
    *(extends* :py:class:`v1_11_8.web.vo.JSDataContainerCreateParameters` *)*
