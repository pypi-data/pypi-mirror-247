...
class Schema(TypedObject):
    """
    *(extends* :py:class:`v1_11_24.web.vo.TypedObject` *)* Schema object.
    """
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._schema[0] is not None and obj._schema[0] is not obj.__undef__:
            assert isinstance(obj._schema[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._schema[0], type(obj._schema[0])))
