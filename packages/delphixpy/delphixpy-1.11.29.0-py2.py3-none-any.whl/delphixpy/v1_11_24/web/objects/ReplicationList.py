...
from delphixpy.v1_11_24.web.objects.ReplicationObjectSpecification import ReplicationObjectSpecification
...
class ReplicationList(ReplicationObjectSpecification):
    """
    *(extends* :py:class:`v1_11_24.web.vo.ReplicationObjectSpecification` *)*
