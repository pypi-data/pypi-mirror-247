...
from delphixpy.v1_11_24.web.objects.AppDataManagedSource import AppDataManagedSource
...
class AppDataVirtualSource(AppDataManagedSource):
    """
    *(extends* :py:class:`v1_11_24.web.vo.AppDataManagedSource` *)* A virtual
    AppData source.
    """
    ...
    def additional_mount_points(self):
        ...
        :rtype: ``list`` of
            :py:class:`v1_11_24.web.vo.AppDataAdditionalMountPoint`
        """
