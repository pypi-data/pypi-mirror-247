...
from delphixpy.v1_11_24.web.objects.OracleVirtualSource import OracleVirtualSource
...
class OracleVirtualCdbSource(OracleVirtualSource):
    """
    *(extends* :py:class:`v1_11_24.web.vo.OracleVirtualSource` *)* A virtual
    ...
    def is_dirty(self):
        return any([self._custom_env_vars[1], self._file_mapping_rules[1], self._operations[1], self._archivelog_mode[1], self._redo_log_size_in_mb[1], self._redo_log_groups[1]])
    ...
    def custom_env_vars(self):
        ...
        :rtype: ``list`` of :py:class:`v1_11_24.web.vo.OracleCustomEnvVar`
        """
