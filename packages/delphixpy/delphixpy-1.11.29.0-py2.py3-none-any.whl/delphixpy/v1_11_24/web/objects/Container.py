...
class Container(NamedUserObject):
    """
    *(extends* :py:class:`v1_11_24.web.vo.NamedUserObject` *)* A container
    holding data.
    """
    def __init__(self, undef_enabled=True):
        ...
        self._container_storage_info = (self.__undef__, True)
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._provision_container[0] is not None and obj._provision_container[0] is not obj.__undef__:
            assert isinstance(obj._provision_container[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._provision_container[0], type(obj._provision_container[0])))
        ...
        if obj._current_timeflow[0] is not None and obj._current_timeflow[0] is not obj.__undef__:
            assert isinstance(obj._current_timeflow[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._current_timeflow[0], type(obj._current_timeflow[0])))
        ...
        if obj._previous_timeflow[0] is not None and obj._previous_timeflow[0] is not obj.__undef__:
            assert isinstance(obj._previous_timeflow[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._previous_timeflow[0], type(obj._previous_timeflow[0])))
        ...
        if "containerStorageInfo" in data and data["containerStorageInfo"] is not None:
            obj._container_storage_info = (factory.create_object(data["containerStorageInfo"], "ContainerStorageInfo"), dirty)
            factory.validate_type(obj._container_storage_info[0], "ContainerStorageInfo")
        else:
            obj._container_storage_info = (obj.__undef__, dirty)
        return obj
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "container_storage_info" == "type" or (self.container_storage_info is not self.__undef__ and (not (dirty and not self._container_storage_info[1]))):
            dct["containerStorageInfo"] = dictify(self.container_storage_info)
        return dct
    ...
    def force_dirty(self):
        ...
        self._container_storage_info = (self._container_storage_info[0], True)

    def is_dirty(self):
        return any([self._group[1], self._provision_container[1], self._creation_time[1], self._current_timeflow[1], self._previous_timeflow[1], self._description[1], self._runtime[1], self._transformation[1], self._masked[1], self._container_storage_info[1]])
    ...
    def __eq__(self, other):
        ...
        return super().__eq__(other) and \
               ...
               self.container_storage_info == other.container_storage_info
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_11_24.web.vo.DBContainerRuntime`
        """
    ...
    @property
    def container_storage_info(self):
        """
        Container Storage Information.

        :rtype: :py:class:`v1_11_24.web.vo.ContainerStorageInfo`
        """
        return self._container_storage_info[0]

    @container_storage_info.setter
    def container_storage_info(self, value):
        self._container_storage_info = (value, True)
