...
class JSOperation(NamedUserObject):
    """
    *(extends* :py:class:`v1_11_24.web.vo.NamedUserObject` *)* An operation
    that occurred on a Self-Service data layout.
    """
    ...
    def data_parent(self):
        ...
        :rtype: :py:class:`v1_11_24.web.vo.JSDataParent`
        """
