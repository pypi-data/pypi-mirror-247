...
def create(engine, splunk_hec_config=None):
    ...
    :type splunk_hec_config: :py:class:`v1_9_2.web.vo.SplunkHecConfig`
    :rtype: ``str``
    """
    url = "/resources/json/delphix/insight/splunkHec"
...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_9_2.web.objects.SplunkHecConfig.SplunkHecConfig
        ` object
    :type ref: ``str``
    :rtype: :py:class:`v1_9_2.web.vo.SplunkHecConfig`
    """
    url = "/resources/json/delphix/insight/splunkHec/%s" % ref
...
def get_all(engine):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_9_2.delphix_engine.DelphixEngine`
    :rtype: ``list`` of :py:class:`v1_9_2.web.vo.SplunkHecConfig`
    """
    url = "/resources/json/delphix/insight/splunkHec"
    response = engine.get(url)
    result = response_validator.validate(response, engine)
...
def delete(engine, ref):
    ...
    :type ref: ``str``
    """
    url = "/resources/json/delphix/insight/splunkHec/%s/delete" % ref
