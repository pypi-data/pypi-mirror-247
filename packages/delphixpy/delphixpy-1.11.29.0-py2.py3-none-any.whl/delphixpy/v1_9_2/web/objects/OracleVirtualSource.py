...
class OracleVirtualSource(OracleSource):
    """
    *(extends* :py:class:`v1_9_2.web.vo.OracleSource` *)* A virtual Oracle
    source.
    """
    ...
    def operations(self):
        ...
        :rtype: :py:class:`v1_9_2.web.vo.VirtualSourceOperations`
        """
    ...
    def custom_env_vars(self):
        ...
        :rtype: ``list`` of :py:class:`v1_9_2.web.vo.OracleCustomEnvVar`
        """
