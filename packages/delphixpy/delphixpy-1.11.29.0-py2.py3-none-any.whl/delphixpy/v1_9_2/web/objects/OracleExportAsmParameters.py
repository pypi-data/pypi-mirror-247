...
class OracleExportAsmParameters(ExportParameters):
    """
    *(extends* :py:class:`v1_9_2.web.vo.ExportParameters` *)* The parameters to
    ...
    def source_config(self):
        ...
        :rtype: :py:class:`v1_9_2.web.vo.OracleDBConfig`
        """
    ...
    def source(self):
        ...
        :rtype: :py:class:`v1_9_2.web.vo.OracleVirtualSource`
        """
