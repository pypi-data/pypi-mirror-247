    ...
    *(extends* :py:class:`v1_9_2.web.vo.MSSqlSource` *)* A linked MSSQL source.
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "mssql_netbackup_config" == "type" or (self.mssql_netbackup_config is not self.__undef__ and (not (dirty and not self._mssql_netbackup_config[1]) or self.is_dirty_list(self.mssql_netbackup_config, self._mssql_netbackup_config) or belongs_to_parent)):
            dct["mssqlNetbackupConfig"] = dictify(self.mssql_netbackup_config, prop_is_list_or_vo=True)
        return dct
    ...
    def is_dirty(self):
        return any([self._config[1], self._external_file_path[1], self._operations[1], self._shared_backup_location[1], self._backup_location_user[1], self._backup_location_credentials[1], self._staging_source[1], self._encryption_key[1], self._ingestion_strategy[1], self._mssql_netbackup_config[1]])
