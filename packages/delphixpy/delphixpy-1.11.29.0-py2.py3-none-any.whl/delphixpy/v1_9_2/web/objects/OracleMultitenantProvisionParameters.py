...
class OracleMultitenantProvisionParameters(OracleBaseProvisionParameters):
    """
    *(extends* :py:class:`v1_9_2.web.vo.OracleBaseProvisionParameters` *)* The
    ...
    def source_config(self):
        ...
        :rtype: :py:class:`v1_9_2.web.vo.OraclePDBConfig`
        """
    ...
    def source(self):
        ...
        :rtype: :py:class:`v1_9_2.web.vo.OracleVirtualPdbSource`
        """
    ...
    def virtual_cdb(self):
        ...
        :rtype: :py:class:`v1_9_2.web.vo.OracleVirtualCdbProvisionParameters`
        """
