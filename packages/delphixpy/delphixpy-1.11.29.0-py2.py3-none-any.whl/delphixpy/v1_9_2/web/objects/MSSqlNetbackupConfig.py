...
class MSSqlNetbackupConfig(TypedObject):
    """
    *(extends* :py:class:`v1_9_2.web.vo.TypedObject` *)* MSSql NetBackup
    configuration.
    """
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._master_name[0] is not None and obj._master_name[0] is not obj.__undef__:
            assert isinstance(obj._master_name[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._master_name[0], type(obj._master_name[0])))
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        def dictify(obj, prop_is_list_or_vo=False):
            if isinstance(obj, list):
                ...
                return obj
        if "master_name" == "type" or (self.master_name is not self.__undef__ and (not (dirty and not self._master_name[1]) or self.is_dirty_list(self.master_name, self._master_name) or belongs_to_parent)):
    ...
    def config_template(self):
        """
        Optional config template selection for NetBackup configruations. If
