    ...
    *(extends* :py:class:`v1_9_2.web.vo.TypedObject` *)* Parameters for
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._certificate[0] is not None and obj._certificate[0] is not obj.__undef__:
            assert isinstance(obj._certificate[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._certificate[0], type(obj._certificate[0])))
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        def dictify(obj, prop_is_list_or_vo=False):
            if isinstance(obj, list):
                ...
                return obj
        if "certificate" == "type" or (self.certificate is not self.__undef__ and (not (dirty and not self._certificate[1]) or self.is_dirty_list(self.certificate, self._certificate) or belongs_to_parent)):
