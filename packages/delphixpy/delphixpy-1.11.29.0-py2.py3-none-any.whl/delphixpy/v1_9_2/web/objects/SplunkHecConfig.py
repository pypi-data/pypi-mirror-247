...
class SplunkHecConfig(UserObject):
    """
    *(extends* :py:class:`v1_9_2.web.vo.UserObject` *)* Splunk HTTP Event
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._metrics_index[0] is not None and obj._metrics_index[0] is not obj.__undef__:
            assert isinstance(obj._metrics_index[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._metrics_index[0], type(obj._metrics_index[0])))
    ...
    def is_dirty(self):
        return any([self._enabled[1], self._host[1], self._hec_port[1], self._hec_token[1], self._main_index[1], self._enable_ssl[1], self._enable_metrics[1], self._metrics_index[1]])
    ...
    def __eq__(self, other):
        ...
        return super().__eq__(other) and \
               ...
               self.metrics_index == other.metrics_index
    ...
    def enabled(self):
        """
        *(default value: True)* Whether we should send Delphix Insight data to
        Splunk using this configuration.
