...
from delphixpy.v1_9_2.web.objects.IngestionStrategy import IngestionStrategy
...
class ExternalBackupIngestionStrategy(IngestionStrategy):
    """
    *(extends* :py:class:`v1_9_2.web.vo.IngestionStrategy` *)* This link source
    has an external ingestion strategy that will pull in backups via
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._validated_sync_mode[0] is not None and obj._validated_sync_mode[0] is not obj.__undef__:
            ...
            assert obj._validated_sync_mode[0] in ['TRANSACTION_LOG', 'FULL_OR_DIFFERENTIAL', 'FULL'], "Expected enum ['TRANSACTION_LOG', 'FULL_OR_DIFFERENTIAL', 'FULL'] but got %s" % obj._validated_sync_mode[0]
