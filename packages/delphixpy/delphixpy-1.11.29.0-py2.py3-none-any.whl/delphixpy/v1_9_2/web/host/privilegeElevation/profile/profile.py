...
def create(engine, host_privilege_elevation_profile=None):
    ...
    :type host_privilege_elevation_profile:
        :py:class:`v1_9_2.web.vo.HostPrivilegeElevationProfile`
    :rtype: ``str``
    """
...
def get(engine, ref):
    ...
    :type ref: ``str``
    :rtype: :py:class:`v1_9_2.web.vo.HostPrivilegeElevationProfile`
    """
...
def get_all(engine):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_9_2.delphix_engine.DelphixEngine`
    :rtype: ``list`` of :py:class:`v1_9_2.web.vo.HostPrivilegeElevationProfile`
    """
    url = "/resources/json/delphix/host/privilegeElevation/profile"
    response = engine.get(url)
    result = response_validator.validate(response, engine)
