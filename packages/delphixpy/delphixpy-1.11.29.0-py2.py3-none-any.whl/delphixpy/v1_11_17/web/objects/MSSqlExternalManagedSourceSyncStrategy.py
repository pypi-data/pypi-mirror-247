...
class MSSqlExternalManagedSourceSyncStrategy(MSSqlSourceSyncStrategy):
    """
    *(extends* :py:class:`v1_11_17.web.vo.MSSqlSourceSyncStrategy` *)* MSSQL
    ...
    def mssql_netbackup_config(self):
        ...
        :rtype: :py:class:`v1_11_17.web.vo.MSSqlNetbackupConfig`
        """
    ...
    def mssql_commvault_config(self):
        ...
        :rtype: :py:class:`v1_11_17.web.vo.MSSqlCommvaultConfig`
        """
