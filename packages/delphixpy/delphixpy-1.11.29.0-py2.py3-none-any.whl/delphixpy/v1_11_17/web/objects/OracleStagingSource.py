...
class OracleStagingSource(OracleManagedSource):
    """
    *(extends* :py:class:`v1_11_17.web.vo.OracleManagedSource` *)* A staging
    ...
    def is_dirty(self):
        return any([self._locked[1], self._physical_standby[1], self._allow_auto_staging_restart_on_host_reboot[1]])
