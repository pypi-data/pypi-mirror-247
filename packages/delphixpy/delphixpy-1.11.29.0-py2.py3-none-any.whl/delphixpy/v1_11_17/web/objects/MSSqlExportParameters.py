...
class MSSqlExportParameters(DbExportParameters):
    """
    *(extends* :py:class:`v1_11_17.web.vo.DbExportParameters` *)* The
    ...
    def __init__(self, undef_enabled=True):
        ...
        self._prod_sync_config_param = (self.__undef__, True)
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if "prodSyncConfigParam" in data and data["prodSyncConfigParam"] is not None:
            obj._prod_sync_config_param = (factory.create_object(data["prodSyncConfigParam"], "MSSqlProdSyncExportConfigParam"), dirty)
            factory.validate_type(obj._prod_sync_config_param[0], "MSSqlProdSyncExportConfigParam")
        else:
            obj._prod_sync_config_param = (obj.__undef__, dirty)
        return obj
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "enable_cdc" == "type" or (self.enable_cdc is not self.__undef__ and (not (dirty and not self._enable_cdc[1]) or self.is_dirty_list(self.enable_cdc, self._enable_cdc) or belongs_to_parent)):
            ...
            dct["enableCdc"] = False
        if "prod_sync_config_param" == "type" or (self.prod_sync_config_param is not self.__undef__ and (not (dirty and not self._prod_sync_config_param[1]) or self.is_dirty_list(self.prod_sync_config_param, self._prod_sync_config_param) or belongs_to_parent)):
            dct["prodSyncConfigParam"] = dictify(self.prod_sync_config_param, prop_is_list_or_vo=True)
        return dct
    ...
    def force_dirty(self):
        ...
        self._prod_sync_config_param = (self._prod_sync_config_param[0], True)

    def is_dirty(self):
        return any([self._source_config[1], self._recovery_model[1], self._filesystem_layout[1], self._enable_cdc[1], self._prod_sync_config_param[1]])
    ...
    def __eq__(self, other):
        ...
        return super().__eq__(other) and \
               ...
               self.prod_sync_config_param == other.prod_sync_config_param
    ...
    def source_config(self):
        ...
        :rtype: :py:class:`v1_11_17.web.vo.MSSqlDBConfig`
        """
    ...
    def filesystem_layout(self):
        ...
        :rtype: :py:class:`v1_11_17.web.vo.MSSqlTimeflowFilesystemLayout`
        """
    ...
    @property
    def prod_sync_config_param(self):
        """
        The prod sync configuration of the exported MSSQL database.

        :rtype: :py:class:`v1_11_17.web.vo.MSSqlProdSyncExportConfigParam`
        """
        return self._prod_sync_config_param[0]

    @prod_sync_config_param.setter
    def prod_sync_config_param(self, value):
        self._prod_sync_config_param = (value, True)
