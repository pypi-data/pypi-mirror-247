...
def create(engine, environment_user=None):
    ...
    :type environment_user: :py:class:`v1_11_17.web.vo.EnvironmentUser`
    :rtype: ``str``
    """
...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_11_17.web.objects.EnvironmentUser.EnvironmentUs
        er` object
    :type ref: ``str``
    :rtype: :py:class:`v1_11_17.web.vo.EnvironmentUser`
    """
...
def get_all(engine, environment=None):
    ...
    :rtype: ``list`` of :py:class:`v1_11_17.web.vo.EnvironmentUser`
    """
    url = "/resources/json/delphix/environment/user"
