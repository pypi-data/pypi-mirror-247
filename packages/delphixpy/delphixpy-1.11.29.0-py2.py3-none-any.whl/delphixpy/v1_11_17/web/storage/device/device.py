...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_11_17.web.objects.StorageDevice.StorageDevice`
        object
    :type ref: ``str``
    :rtype: :py:class:`v1_11_17.web.vo.StorageDevice`
    """
...
def get_all(engine):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_11_17.delphix_engine.DelphixEngine`
    :rtype: ``list`` of :py:class:`v1_11_17.web.vo.StorageDevice`
    """
