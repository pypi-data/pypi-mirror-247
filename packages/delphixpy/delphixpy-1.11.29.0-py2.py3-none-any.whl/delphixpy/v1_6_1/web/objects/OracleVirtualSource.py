...
from delphixpy.v1_6_1.web.objects.OracleSource import OracleSource
...
class OracleVirtualSource(OracleSource):
    """
    *(extends* :py:class:`v1_6_1.web.vo.OracleSource` *)* A virtual Oracle
    source.
    """
    ...
    def is_dirty(self):
        return any([self._archivelog_mode[1], self._config_params[1], self._config_template[1], self._file_mapping_rules[1], self._manual_provisioning[1], self._mount_base[1], self._node_listener_list[1], self._operations[1], self._redo_log_groups[1], self._redo_log_size_in_mb[1]])
    ...
    def operations(self):
        ...
        :rtype: :py:class:`v1_6_1.web.vo.VirtualSourceOperations`
        """
