...
from delphixpy.v1_6_1.web.objects.DbExportParameters import DbExportParameters
...
class PgSQLExportParameters(DbExportParameters):
    """
    *(extends* :py:class:`v1_6_1.web.vo.DbExportParameters` *)* The parameters
    ...
    def filesystem_layout(self):
        ...
        :rtype: :py:class:`v1_6_1.web.vo.TimeflowFilesystemLayout`
        """
    ...
    def hba_entries(self):
        ...
        :rtype: ``list`` of :py:class:`v1_6_1.web.vo.PgSQLHBAEntry`
        """
    ...
    def ident_entries(self):
        ...
        :rtype: ``list`` of :py:class:`v1_6_1.web.vo.PgSQLIdentEntry`
        """
    ...
    def source_config(self):
        ...
        :rtype: :py:class:`v1_6_1.web.vo.PgSQLDBClusterConfig`
        """
