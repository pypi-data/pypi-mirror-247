...
class SourceRepository(ReadonlyNamedUserObject):
    """
    *(extends* :py:class:`v1_6_1.web.vo.ReadonlyNamedUserObject` *)* A source
    ...
    def is_dirty(self):
        return any([self._environment[1], self._linking_enabled[1], self._provisioning_enabled[1], self._staging[1], self._version[1]])
