...
from delphixpy.v1_6_1.web.objects.MySQLSource import MySQLSource
...
class MySQLLinkedSource(MySQLSource):
    """
    *(extends* :py:class:`v1_6_1.web.vo.MySQLSource` *)* A linked MySQL source.
    """
    ...
    def is_dirty(self):
        return any([self._config[1], self._config_params[1], self._operations[1], self._runtime[1], self._staging_source[1]])
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_6_1.web.vo.MySQLSourceRuntime`
        """
