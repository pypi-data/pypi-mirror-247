...
from delphixpy.v1_6_1.web.objects.VirtualDatasetCreationParameters import VirtualDatasetCreationParameters
...
class RestorationDatasetParameters(VirtualDatasetCreationParameters):
    """
    *(extends* :py:class:`v1_6_1.web.vo.VirtualDatasetCreationParameters` *)*
