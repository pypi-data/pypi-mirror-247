...
from delphixpy.v1_6_1.web.objects.TimeflowPointParameters import TimeflowPointParameters
...
class TimeflowPointEngineTime(TimeflowPointParameters):
    """
    *(extends* :py:class:`v1_6_1.web.vo.TimeflowPointParameters` *)* TimeFlow
