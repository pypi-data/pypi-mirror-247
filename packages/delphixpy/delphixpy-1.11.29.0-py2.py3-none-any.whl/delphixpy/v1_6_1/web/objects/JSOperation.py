...
class JSOperation(NamedUserObject):
    """
    *(extends* :py:class:`v1_6_1.web.vo.NamedUserObject` *)* An operation that
    ...
    def __init__(self, undef_enabled=True):
        ...
        self._undo_time = (self.__undef__, True)
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        obj._undo_time = (data.get("undoTime", obj.__undef__), dirty)
        if obj._undo_time[0] is not None and obj._undo_time[0] is not obj.__undef__:
            assert isinstance(obj._undo_time[0], str), ("Expected one of ['string', 'null'], but got %s of type %s" % (obj._undo_time[0], type(obj._undo_time[0])))
            common.validate_format(obj._undo_time[0], "date", None, None)
        return obj
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "undo_time" == "type" or (self.undo_time is not self.__undef__ and (not (dirty and not self._undo_time[1]))):
            dct["undoTime"] = dictify(self.undo_time)
        return dct
    ...
    def force_dirty(self):
        ...
        self._undo_time = (self._undo_time[0], True)

    def is_dirty(self):
        return any([self._bookmark[1], self._branch[1], self._data_layout[1], self._data_parent[1], self._data_time[1], self._description[1], self._end_time[1], self._operation[1], self._root_action[1], self._start_time[1], self._undo_time[1]])
    ...
    def __eq__(self, other):
        ...
        return super().__eq__(other) and \
               ...
               self.undo_time == other.undo_time
    ...
    def data_parent(self):
        ...
        :rtype: :py:class:`v1_6_1.web.vo.JSDataParent`
        """
    ...
    def undo_time(self):
        """
        Restore to this time to undo this operation. This will only be present
        for RESET, RESTORE, REFRESH, and DEACTIVATE operations.

        :rtype: ``str`` *or* ``null``
        """
        return self._undo_time[0]

    @undo_time.setter
    def undo_time(self, value):
        self._undo_time = (value, True)
