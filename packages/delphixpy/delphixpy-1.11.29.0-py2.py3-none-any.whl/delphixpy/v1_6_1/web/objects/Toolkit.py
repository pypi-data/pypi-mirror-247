...
class Toolkit(NamedUserObject):
    """
    *(extends* :py:class:`v1_6_1.web.vo.NamedUserObject` *)* An installed
    toolkit.
    """
    ...
    def is_dirty(self):
        return any([self._discovery_definition[1], self._host_types[1], self._linked_source_definition[1], self._name[1], self._pretty_name[1], self._resources[1], self._virtual_source_definition[1]])
    ...
    def discovery_definition(self):
        ...
        :rtype: :py:class:`v1_6_1.web.vo.ToolkitDiscoveryDefinition`
        """
    ...
    def linked_source_definition(self):
        ...
        :rtype: :py:class:`v1_6_1.web.vo.ToolkitLinkedSource`
        """
    ...
    def virtual_source_definition(self):
        ...
        :rtype: :py:class:`v1_6_1.web.vo.ToolkitVirtualSource`
        """
