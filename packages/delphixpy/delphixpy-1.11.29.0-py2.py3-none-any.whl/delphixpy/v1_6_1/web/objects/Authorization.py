...
from delphixpy.v1_6_1.web.objects.ReadonlyNamedUserObject import ReadonlyNamedUserObject
...
class Authorization(ReadonlyNamedUserObject):
    """
    *(extends* :py:class:`v1_6_1.web.vo.ReadonlyNamedUserObject` *)* Describes
