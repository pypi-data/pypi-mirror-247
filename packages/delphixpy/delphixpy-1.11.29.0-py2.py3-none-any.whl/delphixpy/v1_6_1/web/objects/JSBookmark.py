...
class JSBookmark(NamedUserObject):
    """
    *(extends* :py:class:`v1_6_1.web.vo.NamedUserObject` *)* A named entity
    ...
    def is_dirty(self):
        return any([self._bookmark_type[1], self._branch[1], self._checkout_count[1], self._container[1], self._container_name[1], self._description[1], self._shared[1], self._tags[1], self._template[1], self._template_name[1], self._timestamp[1], self._usable[1]])
