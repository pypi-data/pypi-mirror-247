...
def create(engine, timeflow_bookmark_create_parameters):
    ...
    :type timeflow_bookmark_create_parameters:
        :py:class:`v1_6_1.web.vo.TimeflowBookmarkCreateParameters`
    :rtype: ``str``
    """
...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_6_1.web.objects.TimeflowBookmark.TimeflowBookma
        rk` object
    :type ref: ``str``
    :rtype: :py:class:`v1_6_1.web.vo.TimeflowBookmark`
    """
...
def get_all(engine, database=None):
    ...
    :type database: ``str``
    :rtype: ``list`` of :py:class:`v1_6_1.web.vo.TimeflowBookmark`
    """
    url = "/resources/json/delphix/timeflow/bookmark"
