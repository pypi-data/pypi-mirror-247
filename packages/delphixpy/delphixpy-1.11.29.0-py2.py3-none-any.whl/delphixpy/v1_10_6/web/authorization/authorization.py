...
"""
from delphixpy.v1_10_6.web.authorization import configuration
...
def create(engine, authorization=None):
    ...
    :type authorization: :py:class:`v1_10_6.web.vo.Authorization`
    :rtype: ``str``
    """
...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_10_6.web.objects.Authorization.Authorization`
        object
    :type ref: ``str``
    :rtype: :py:class:`v1_10_6.web.vo.Authorization`
    """
...
def get_all(engine, user=None, target=None, effective=None):
    ...
    :type effective: ``str``
    :rtype: ``list`` of :py:class:`v1_10_6.web.vo.Authorization`
    """
    url = "/resources/json/delphix/authorization"
...
def filter_by_permission(engine, auth_filter_parameters):
    ...
    :type auth_filter_parameters:
        :py:class:`v1_10_6.web.vo.AuthFilterParameters`
    :rtype: :py:class:`v1_10_6.web.vo.AuthFilterResult`
    """
...
def get_by_properties(engine, auth_get_by_properties_parameters):
    ...
    :type auth_get_by_properties_parameters:
        :py:class:`v1_10_6.web.vo.AuthGetByPropertiesParameters`
    :rtype: :py:class:`v1_10_6.web.vo.Authorization`
    """
