...
from delphixpy.v1_10_6.web.objects.BaseSystemCapacityData import BaseSystemCapacityData
...
class CurrentSystemCapacityData(BaseSystemCapacityData):
    """
    *(extends* :py:class:`v1_10_6.web.vo.BaseSystemCapacityData` *)* Capacity
