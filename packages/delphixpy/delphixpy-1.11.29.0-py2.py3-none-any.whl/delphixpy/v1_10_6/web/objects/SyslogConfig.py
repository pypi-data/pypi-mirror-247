...
class SyslogConfig(TypedObject):
    """
    *(extends* :py:class:`v1_10_6.web.vo.TypedObject` *)* Syslog configuration.
    """
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._pattern[0] is not None and obj._pattern[0] is not obj.__undef__:
            assert isinstance(obj._pattern[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._pattern[0], type(obj._pattern[0])))
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "pattern" == "type" or (self.pattern is not self.__undef__ and (not (dirty and not self._pattern[1]) or self.is_dirty_list(self.pattern, self._pattern) or belongs_to_parent)):
    ...
    def servers(self):
        ...
        :rtype: ``list`` of :py:class:`v1_10_6.web.vo.SyslogServer`
        """
