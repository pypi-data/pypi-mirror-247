...
from delphixpy.v1_10_6.web.objects.NetworkThroughputTestBaseParameters import NetworkThroughputTestBaseParameters
...
class NetworkDSPTestParameters(NetworkThroughputTestBaseParameters):
    """
    *(extends* :py:class:`v1_10_6.web.vo.NetworkThroughputTestBaseParameters`
    *)* Parameters used to execute a network throughput test using the Delphix
    ...
    def remote_delphix_engine_info(self):
        ...
        :rtype: :py:class:`v1_10_6.web.vo.RemoteDelphixEngineInfo`
        """
