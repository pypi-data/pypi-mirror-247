...
from delphixpy.v1_10_6.web.objects.MSSqlBaseClusterListener import MSSqlBaseClusterListener
...
class MSSqlAvailabilityGroupListener(MSSqlBaseClusterListener):
    """
    *(extends* :py:class:`v1_10_6.web.vo.MSSqlBaseClusterListener` *)* The
