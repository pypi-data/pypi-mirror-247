...
class UnixHost(Host):
    """
    *(extends* :py:class:`v1_10_6.web.vo.Host` *)* The representation of a Unix
    host object.
    """
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._oracle_jdbc_keystore_password[0] is not None and obj._oracle_jdbc_keystore_password[0] is not obj.__undef__:
            assert isinstance(obj._oracle_jdbc_keystore_password[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._oracle_jdbc_keystore_password[0], type(obj._oracle_jdbc_keystore_password[0])))
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "oracle_jdbc_keystore_password" == "type" or (self.oracle_jdbc_keystore_password is not self.__undef__ and (not (dirty and not self._oracle_jdbc_keystore_password[1]) or self.is_dirty_list(self.oracle_jdbc_keystore_password, self._oracle_jdbc_keystore_password) or belongs_to_parent)):
    ...
    def ssh_verification_strategy(self):
        ...
        :rtype: :py:class:`v1_10_6.web.vo.SshVerificationStrategy`
        """
