...
from delphixpy.v1_10_6.web.objects.VirtualDatasetCreationParameters import VirtualDatasetCreationParameters
...
class EmptyDatasetCreationParameters(VirtualDatasetCreationParameters):
    """
    *(extends* :py:class:`v1_10_6.web.vo.VirtualDatasetCreationParameters` *)*
