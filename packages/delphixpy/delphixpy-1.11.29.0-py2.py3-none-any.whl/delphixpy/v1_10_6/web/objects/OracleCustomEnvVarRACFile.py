...
from delphixpy.v1_10_6.web.objects.OracleCustomEnvVarFile import OracleCustomEnvVarFile
...
class OracleCustomEnvVarRACFile(OracleCustomEnvVarFile):
    """
    *(extends* :py:class:`v1_10_6.web.vo.OracleCustomEnvVarFile` *)* Dictates
