...
from delphixpy.v1_10_6.web.objects.ReplicationObjectSpecification import ReplicationObjectSpecification
...
class ReplicationList(ReplicationObjectSpecification):
    """
    *(extends* :py:class:`v1_10_6.web.vo.ReplicationObjectSpecification` *)*
