...
from delphixpy.v1_10_6.web.objects.BaseConsumerCapacityData import BaseConsumerCapacityData
...
class CurrentConsumerCapacityData(BaseConsumerCapacityData):
    """
    *(extends* :py:class:`v1_10_6.web.vo.BaseConsumerCapacityData` *)* Current
