...
from delphixpy.v1_10_6.web.objects.CreateTransformationParameters import CreateTransformationParameters
...
class OracleCreateTransformationParameters(CreateTransformationParameters):
    """
    *(extends* :py:class:`v1_10_6.web.vo.CreateTransformationParameters` *)*
