...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_10_6.web.objects.FaultEffect.FaultEffect`
        object
    :type ref: ``str``
    :rtype: :py:class:`v1_10_6.web.vo.FaultEffect`
    """
...
def get_all(engine, severity=None, target=None, root_cause=None, bundle_id=None):
    ...
    :param bundle_id: A unique dot delimited identifier associated with the
        fault effect.
    :type bundle_id: ``str``
    :rtype: ``list`` of :py:class:`v1_10_6.web.vo.FaultEffect`
    """
