...
class RefreshParameters(TypedObject):
    """
    *(extends* :py:class:`v1_5_1.web.vo.TypedObject` *)* The parameters to use
    as input to refresh MSSQL databases or AppData vFiles.
    """
    def __init__(self, undef_enabled=True):
        super().__init__()
        self._type = ("RefreshParameters", True)
        self._timeflow_name = (self.__undef__, True)
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        obj._timeflow_name = (data.get("timeflowName", obj.__undef__), dirty)
        if obj._timeflow_name[0] is not None and obj._timeflow_name[0] is not obj.__undef__:
            assert isinstance(obj._timeflow_name[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._timeflow_name[0], type(obj._timeflow_name[0])))
            common.validate_format(obj._timeflow_name[0], "None", None, None)
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        def dictify(obj, prop_is_list_or_vo=False):
            if isinstance(obj, list):
                ...
                return obj
        if "timeflow_name" == "type" or (self.timeflow_name is not self.__undef__ and (not (dirty and not self._timeflow_name[1]))):
            dct["timeflowName"] = dictify(self.timeflow_name)
    ...
    def force_dirty(self):
        self._timeflow_name = (self._timeflow_name[0], True)
        self._timeflow_point_parameters = (self._timeflow_point_parameters[0], True)

    def is_dirty(self):
        return any([self._timeflow_name[1], self._timeflow_point_parameters[1]])
    ...
    def __eq__(self, other):
        ...
        return super().__eq__(other) and \
               self.timeflow_name == other.timeflow_name and \
    ...
    @property
    def timeflow_name(self):
        """
        Optional user-specified name for the new TimeFlow created by this
        operation.

        :rtype: ``str``
        """
        return self._timeflow_name[0]

    @timeflow_name.setter
    def timeflow_name(self, value):
        self._timeflow_name = (value, True)
    ...
    def timeflow_point_parameters(self):
        ...
        :rtype: :py:class:`v1_5_1.web.vo.TimeflowPointParameters`
        """
