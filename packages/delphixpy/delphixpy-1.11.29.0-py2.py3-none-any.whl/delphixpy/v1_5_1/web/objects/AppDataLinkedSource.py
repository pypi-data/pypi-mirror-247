...
from delphixpy.v1_5_1.web.objects.AppDataSource import AppDataSource
...
class AppDataLinkedSource(AppDataSource):
    """
    *(extends* :py:class:`v1_5_1.web.vo.AppDataSource` *)* Base AppData linked
    source.
    """
    ...
    def parameters(self):
        ...
        :rtype: ``list`` of :py:class:`v1_5_1.web.vo.DynamicParameterValue`
        """
