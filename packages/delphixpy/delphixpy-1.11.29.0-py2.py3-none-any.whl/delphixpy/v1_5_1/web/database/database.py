...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_5_1.web.objects.Container.Container` object
    :type ref: ``str``
    :rtype: :py:class:`v1_5_1.web.vo.Container`
    """
...
def get_all(engine, group=None, no_js_container_data_source=None, no_js_data_source=None, provision_container=None):
    ...
    :rtype: ``list`` of :py:class:`v1_5_1.web.vo.Container`
    """
...
def update(engine, ref, container=None):
    ...
    :type container: :py:class:`v1_5_1.web.vo.Container`
    """
    url = "/resources/json/delphix/database/%s" % ref
...
def delete(engine, ref, delete_parameters=None):
    ...
    :type delete_parameters: :py:class:`v1_5_1.web.vo.DeleteParameters`
    """
...
def add_live_source(engine, ref, add_live_source_parameters):
    ...
    :type add_live_source_parameters:
        :py:class:`v1_5_1.web.vo.AddLiveSourceParameters`
    """
...
def attach_source(engine, ref, attach_source_parameters):
    ...
    :type attach_source_parameters:
        :py:class:`v1_5_1.web.vo.AttachSourceParameters`
    """
...
def detach_source(engine, ref, detach_source_parameters):
    ...
    :type detach_source_parameters:
        :py:class:`v1_5_1.web.vo.DetachSourceParameters`
    """
...
def purge_logs(engine, ref, purge_logs_parameters):
    ...
    :type purge_logs_parameters: :py:class:`v1_5_1.web.vo.PurgeLogsParameters`
    :rtype: :py:class:`v1_5_1.web.vo.PurgeLogsResult`
    """
...
def refresh(engine, ref, refresh_parameters):
    ...
    :type refresh_parameters: :py:class:`v1_5_1.web.vo.RefreshParameters`
    """
...
def request_xpp_upload(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_5_1.web.objects.Container.Container` object
    :type ref: ``str``
    :rtype: :py:class:`v1_5_1.web.vo.FileUploadResult`
    """
...
def rollback(engine, ref, rollback_parameters):
    ...
    :type rollback_parameters: :py:class:`v1_5_1.web.vo.RollbackParameters`
    """
...
def switch_timeflow(engine, ref, switch_timeflow_parameters):
    ...
    :type switch_timeflow_parameters:
        :py:class:`v1_5_1.web.vo.SwitchTimeflowParameters`
    """
...
def sync(engine, ref, sync_parameters=None):
    ...
    :type sync_parameters: :py:class:`v1_5_1.web.vo.SyncParameters`
    """
...
def xpp_status(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_5_1.web.objects.Container.Container` object
    :type ref: ``str``
    :rtype: :py:class:`v1_5_1.web.vo.XppStatus`
    """
...
def create_empty(engine, empty_dataset_creation_parameters):
    ...
    :type empty_dataset_creation_parameters:
        :py:class:`v1_5_1.web.vo.EmptyDatasetCreationParameters`
    :rtype: ``str``
    """
...
def export(engine, export_parameters):
    ...
    :type export_parameters: :py:class:`v1_5_1.web.vo.ExportParameters`
    """
...
def file_mapping(engine, file_mapping_parameters):
    ...
    :type file_mapping_parameters:
        :py:class:`v1_5_1.web.vo.FileMappingParameters`
    :rtype: :py:class:`v1_5_1.web.vo.FileMappingResult`
    """
...
def link(engine, link_parameters):
    ...
    :type link_parameters: :py:class:`v1_5_1.web.vo.LinkParameters`
    :rtype: ``str``
    """
...
def provision(engine, provision_parameters):
    ...
    :type provision_parameters: :py:class:`v1_5_1.web.vo.ProvisionParameters`
    :rtype: ``str``
    """
...
def provision_defaults(engine, timeflow_point_parameters):
    ...
    :type timeflow_point_parameters:
        :py:class:`v1_5_1.web.vo.TimeflowPointParameters`
    """
...
def xpp(engine, oracle_provision_parameters):
    ...
    :type oracle_provision_parameters:
        :py:class:`v1_5_1.web.vo.OracleProvisionParameters`
    :rtype: ``str``
    """
