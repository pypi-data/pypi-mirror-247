...
"""
from delphixpy.v1_5_1.web.host.privilegeElevation import profile
...
def get(engine):
    ...
    :rtype: :py:class:`v1_5_1.web.vo.HostPrivilegeElevationSettings`
    """
...
def set(engine, host_privilege_elevation_settings=None):
    ...
    :type host_privilege_elevation_settings:
        :py:class:`v1_5_1.web.vo.HostPrivilegeElevationSettings`
    """
    url = "/resources/json/delphix/host/privilegeElevation"
