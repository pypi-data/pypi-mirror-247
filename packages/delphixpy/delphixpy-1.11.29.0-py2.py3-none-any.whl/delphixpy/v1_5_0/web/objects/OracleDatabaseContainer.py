...
class OracleDatabaseContainer(DatabaseContainer):
    """
    *(extends* :py:class:`v1_5_0.web.vo.DatabaseContainer` *)* Data container
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_5_0.web.vo.OracleDBContainerRuntime`
        """
    ...
    def sourcing_policy(self):
        ...
        :rtype: :py:class:`v1_5_0.web.vo.OracleSourcingPolicy`
        """
