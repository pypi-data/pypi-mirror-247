...
class StorageTest(PersistentObject):
    """
    *(extends* :py:class:`v1_5_0.web.vo.PersistentObject` *)* Test the
    ...
    def parameters(self):
        ...
        :rtype: :py:class:`v1_5_0.web.vo.StorageTestParameters`
        """
    ...
    def test_results(self):
        ...
        :rtype: ``list`` of :py:class:`v1_5_0.web.vo.StorageTestResult`
        """
