...
from delphixpy.v1_5_0.web.objects.OracleSource import OracleSource
...
class OracleVirtualSource(OracleSource):
    """
    *(extends* :py:class:`v1_5_0.web.vo.OracleSource` *)* A virtual Oracle
    source.
    """
    ...
    def operations(self):
        ...
        :rtype: :py:class:`v1_5_0.web.vo.VirtualSourceOperations`
        """
