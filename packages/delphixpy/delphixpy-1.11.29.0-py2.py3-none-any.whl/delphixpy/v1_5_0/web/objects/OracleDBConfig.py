...
from delphixpy.v1_5_0.web.objects.OracleBaseDBConfig import OracleBaseDBConfig
...
class OracleDBConfig(OracleBaseDBConfig):
    """
    *(extends* :py:class:`v1_5_0.web.vo.OracleBaseDBConfig` *)* The source
    ...
    def non_sys_credentials(self):
        ...
        :rtype: :py:class:`v1_5_0.web.vo.Credential`
        """
