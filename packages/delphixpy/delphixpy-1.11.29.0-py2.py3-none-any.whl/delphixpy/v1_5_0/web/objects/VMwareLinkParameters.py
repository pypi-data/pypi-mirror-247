...
class VMwareLinkParameters(LinkParameters):
    """
    *(extends* :py:class:`v1_5_0.web.vo.LinkParameters` *)* Represents the
    ...
    def container(self):
        ...
        :rtype: :py:class:`v1_5_0.web.vo.VMwareContainer`
        """
    ...
    def source(self):
        ...
        :rtype: :py:class:`v1_5_0.web.vo.VMwareLinkedSource`
        """
