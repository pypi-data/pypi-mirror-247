...
from delphixpy.v1_5_0.web.objects.VirtualDatasetCreationParameters import VirtualDatasetCreationParameters
...
class ProvisionParameters(VirtualDatasetCreationParameters):
    """
    *(extends* :py:class:`v1_5_0.web.vo.VirtualDatasetCreationParameters` *)*
