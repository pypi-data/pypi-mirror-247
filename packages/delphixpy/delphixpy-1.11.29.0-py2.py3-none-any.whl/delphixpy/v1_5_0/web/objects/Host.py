...
class Host(ReadonlyNamedUserObject):
    """
    *(extends* :py:class:`v1_5_0.web.vo.ReadonlyNamedUserObject` *)* The
    ...
    def is_dirty(self):
        return any([self._address[1], self._date_added[1], self._enabled[1], self._host_configuration[1], self._host_runtime[1], self._privilege_elevation_profile[1], self._ssh_port[1], self._toolkit_path[1]])
    ...
    def host_configuration(self):
        ...
        :rtype: :py:class:`v1_5_0.web.vo.HostConfiguration`
        """
    ...
    def host_runtime(self):
        ...
        :rtype: :py:class:`v1_5_0.web.vo.HostRuntime`
        """
