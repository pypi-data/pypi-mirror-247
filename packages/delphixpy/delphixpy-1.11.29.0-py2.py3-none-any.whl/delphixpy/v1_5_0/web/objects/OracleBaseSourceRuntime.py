...
from delphixpy.v1_5_0.web.objects.SourceRuntime import SourceRuntime
...
class OracleBaseSourceRuntime(SourceRuntime):
    """
    *(extends* :py:class:`v1_5_0.web.vo.SourceRuntime` *)* Runtime (non-
    ...
    def active_instances(self):
        ...
        :rtype: ``list`` of :py:class:`v1_5_0.web.vo.OracleActiveInstance`
        """
    ...
    def database_stats(self):
        ...
        :rtype: ``list`` of
            :py:class:`v1_5_0.web.vo.OracleDatabaseStatsSection`
        """
