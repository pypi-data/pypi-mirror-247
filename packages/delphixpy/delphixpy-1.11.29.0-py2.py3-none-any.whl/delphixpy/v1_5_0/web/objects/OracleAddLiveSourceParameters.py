...
from delphixpy.v1_5_0.web.objects.AddLiveSourceParameters import AddLiveSourceParameters
...
class OracleAddLiveSourceParameters(AddLiveSourceParameters):
    """
    *(extends* :py:class:`v1_5_0.web.vo.AddLiveSourceParameters` *)* The
    ...
    def is_dirty(self):
        return any([self._credential[1], self._source[1], self._source_config[1], self._username[1]])
    ...
    def source(self):
        ...
        :rtype: :py:class:`v1_5_0.web.vo.OracleLiveSource`
        """
    ...
    def source_config(self):
        ...
        :rtype: :py:class:`v1_5_0.web.vo.OracleDBConfig`
        """
