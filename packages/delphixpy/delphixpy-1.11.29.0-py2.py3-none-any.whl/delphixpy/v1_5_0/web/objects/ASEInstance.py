...
from delphixpy.v1_5_0.web.objects.SourceRepository import SourceRepository
...
class ASEInstance(SourceRepository):
    """
    *(extends* :py:class:`v1_5_0.web.vo.SourceRepository` *)* The SAP ASE
    source repository.
    """
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "page_size" == "type" or (self.page_size is not self.__undef__ and (not (dirty and not self._page_size[1]) or self.is_dirty_list(self.page_size, self._page_size) or belongs_to_parent)):
