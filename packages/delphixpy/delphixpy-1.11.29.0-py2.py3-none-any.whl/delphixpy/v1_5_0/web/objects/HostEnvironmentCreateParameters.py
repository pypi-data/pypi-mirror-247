...
from delphixpy.v1_5_0.web.objects.SourceEnvironmentCreateParameters import SourceEnvironmentCreateParameters
...
class HostEnvironmentCreateParameters(SourceEnvironmentCreateParameters):
    """
    *(extends* :py:class:`v1_5_0.web.vo.SourceEnvironmentCreateParameters` *)*
    ...
    def host_environment(self):
        ...
        :rtype: :py:class:`v1_5_0.web.vo.HostEnvironment`
        """
    ...
    def host_parameters(self):
        ...
        :rtype: :py:class:`v1_5_0.web.vo.HostCreateParameters`
        """
