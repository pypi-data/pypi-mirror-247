...
from delphixpy.v1_5_0.web.objects.Policy import Policy
...
class SchedulePolicy(Policy):
    """
    *(extends* :py:class:`v1_5_0.web.vo.Policy` *)* The base type for all
    schedule policies.
    """
    ...
    def schedule_list(self):
        ...
        :rtype: ``list`` of :py:class:`v1_5_0.web.vo.Schedule`
        """
