...
def create(engine, js_data_container_create_parameters):
    ...
    :type js_data_container_create_parameters:
        :py:class:`v1_7_0.web.vo.JSDataContainerCreateParameters`
    :rtype: ``str``
    """
...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_7_0.web.objects.JSDataContainer.JSDataContainer
        ` object
    :type ref: ``str``
    :rtype: :py:class:`v1_7_0.web.vo.JSDataContainer`
    """
...
def get_all(engine, owner=None, template=None):
    ...
    :param template: Restrict data containers to those provisioned from the
        ...
        option.
    :type template: ``str``
    :rtype: ``list`` of :py:class:`v1_7_0.web.vo.JSDataContainer`
    """
    url = "/resources/json/delphix/jetstream/container"
...
def update(engine, ref, js_data_container=None):
    ...
    :type js_data_container: :py:class:`v1_7_0.web.vo.JSDataContainer`
    """
    url = "/resources/json/delphix/jetstream/container/%s" % ref
...
def delete(engine, ref, js_data_container_delete_parameters=None):
    ...
    :type js_data_container_delete_parameters:
        :py:class:`v1_7_0.web.vo.JSDataContainerDeleteParameters`
    """
...
def add_owner(engine, ref, js_data_container_modify_owner_parameters):
    ...
    :type js_data_container_modify_owner_parameters:
        :py:class:`v1_7_0.web.vo.JSDataContainerModifyOwnerParameters`
    """
...
def get_active_branch_at_time(engine, ref, js_data_container_active_branch_parameters):
    ...
    :type js_data_container_active_branch_parameters:
        :py:class:`v1_7_0.web.vo.JSDataContainerActiveBranchParameters`
    :rtype: ``str``
    """
...
def restore(engine, ref, js_timeline_point_parameters):
    ...
    :type js_timeline_point_parameters:
        :py:class:`v1_7_0.web.vo.JSTimelinePointParameters`
    """
