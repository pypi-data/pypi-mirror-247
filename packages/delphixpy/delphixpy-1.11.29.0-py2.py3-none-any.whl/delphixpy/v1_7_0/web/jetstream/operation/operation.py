...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_7_0.web.objects.JSOperation.JSOperation` object
    :type ref: ``str``
...
def get_all(engine, after_count=None, before_count=None, branch=None, data_end_time=None, data_layout=None, data_start_time=None, data_time=None):
    ...
    :type data_time: ``str``
    :rtype: ``list`` of :py:class:`v1_7_0.web.vo.JSOperation`
    """
...
def endpoint(engine, js_operation_endpoint_parameters):
    ...
    :type js_operation_endpoint_parameters:
        :py:class:`v1_7_0.web.vo.JSOperationEndpointParameters`
    :rtype: :py:class:`v1_7_0.web.vo.JSOperationEndpoint`
    """
