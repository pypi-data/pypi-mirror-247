...
class JobEvent(TypedObject):
    """
    *(extends* :py:class:`v1_7_0.web.vo.TypedObject` *)* Represents a job event
    ...
    def is_dirty(self):
        return any([self._diagnoses[1], self._event_type[1], self._message_action[1], self._message_code[1], self._message_command_output[1], self._message_details[1], self._percent_complete[1], self._state[1], self._timestamp[1]])
    ...
    def diagnoses(self):
        ...
        :rtype: ``list`` of :py:class:`v1_7_0.web.vo.DiagnosisResult`
        """
