...
from delphixpy.v1_7_0.web.objects.Operation import Operation
...
class RunSyncOperation(Operation):
    """
    *(extends* :py:class:`v1_7_0.web.vo.Operation` *)* A user-specifiable
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._source_directory[0] is not None and obj._source_directory[0] is not obj.__undef__:
            assert isinstance(obj._source_directory[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._source_directory[0], type(obj._source_directory[0])))
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "exclude_paths" == "type" or (self.exclude_paths is not self.__undef__ and (not (dirty and not self._exclude_paths[1]) or self.is_dirty_list(self.exclude_paths, self._exclude_paths) or belongs_to_parent)):
            dct["excludePaths"] = dictify(self.exclude_paths, prop_is_list_or_vo=True)
        if "follow_symlink_paths" == "type" or (self.follow_symlink_paths is not self.__undef__ and (not (dirty and not self._follow_symlink_paths[1]) or self.is_dirty_list(self.follow_symlink_paths, self._follow_symlink_paths) or belongs_to_parent)):
        ...
        if "source_directory" == "type" or (self.source_directory is not self.__undef__ and (not (dirty and not self._source_directory[1]) or self.is_dirty_list(self.source_directory, self._source_directory) or belongs_to_parent)):
