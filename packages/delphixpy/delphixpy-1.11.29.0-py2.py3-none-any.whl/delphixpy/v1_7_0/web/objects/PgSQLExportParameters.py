...
from delphixpy.v1_7_0.web.objects.DbExportParameters import DbExportParameters
...
class PgSQLExportParameters(DbExportParameters):
    """
    *(extends* :py:class:`v1_7_0.web.vo.DbExportParameters` *)* The parameters
    ...
    def filesystem_layout(self):
        ...
        :rtype: :py:class:`v1_7_0.web.vo.TimeflowFilesystemLayout`
        """
    ...
    def hba_entries(self):
        ...
        :rtype: ``list`` of :py:class:`v1_7_0.web.vo.PgSQLHBAEntry`
        """
    ...
    def ident_entries(self):
        ...
        :rtype: ``list`` of :py:class:`v1_7_0.web.vo.PgSQLIdentEntry`
        """
    ...
    def source_config(self):
        ...
        :rtype: :py:class:`v1_7_0.web.vo.PgSQLDBClusterConfig`
        """
