...
from delphixpy.v1_7_0.web.objects.ProvisionParameters import ProvisionParameters
...
class ASEProvisionParameters(ProvisionParameters):
    """
    *(extends* :py:class:`v1_7_0.web.vo.ProvisionParameters` *)* The parameters
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "truncate_log_on_checkpoint" == "type" or (self.truncate_log_on_checkpoint is not self.__undef__ and (not (dirty and not self._truncate_log_on_checkpoint[1]) or self.is_dirty_list(self.truncate_log_on_checkpoint, self._truncate_log_on_checkpoint) or belongs_to_parent)):
    ...
    def container(self):
        ...
        :rtype: :py:class:`v1_7_0.web.vo.ASEDBContainer`
        """
    ...
    def source(self):
        ...
        :rtype: :py:class:`v1_7_0.web.vo.ASEVirtualSource`
        """
    ...
    def source_config(self):
        ...
        :rtype: :py:class:`v1_7_0.web.vo.ASEDBConfig`
        """
