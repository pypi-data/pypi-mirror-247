...
class Container(NamedUserObject):
    """
    *(extends* :py:class:`v1_7_0.web.vo.NamedUserObject` *)* A container
    holding data.
    """
    ...
    def is_dirty(self):
        return any([self._creation_time[1], self._current_timeflow[1], self._description[1], self._group[1], self._masked[1], self._previous_timeflow[1], self._provision_container[1], self._restoration[1], self._runtime[1], self._transformation[1]])
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_7_0.web.vo.DBContainerRuntime`
        """
