...
from delphixpy.v1_7_0.web.objects.BaseConsumerCapacityData import BaseConsumerCapacityData
...
class CurrentConsumerCapacityData(BaseConsumerCapacityData):
    """
    *(extends* :py:class:`v1_7_0.web.vo.BaseConsumerCapacityData` *)* Current
