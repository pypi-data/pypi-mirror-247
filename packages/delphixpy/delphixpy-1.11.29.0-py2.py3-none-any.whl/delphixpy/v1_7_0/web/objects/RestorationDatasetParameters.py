...
from delphixpy.v1_7_0.web.objects.VirtualDatasetCreationParameters import VirtualDatasetCreationParameters
...
class RestorationDatasetParameters(VirtualDatasetCreationParameters):
    """
    *(extends* :py:class:`v1_7_0.web.vo.VirtualDatasetCreationParameters` *)*
