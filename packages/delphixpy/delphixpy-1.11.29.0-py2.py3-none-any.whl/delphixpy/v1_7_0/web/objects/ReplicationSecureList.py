...
from delphixpy.v1_7_0.web.objects.ReplicationObjectSpecification import ReplicationObjectSpecification
...
class ReplicationSecureList(ReplicationObjectSpecification):
    """
    *(extends* :py:class:`v1_7_0.web.vo.ReplicationObjectSpecification` *)*
