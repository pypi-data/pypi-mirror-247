...
from delphixpy.v1_7_0.web.objects.OracleDatafileTempfileSpecification import OracleDatafileTempfileSpecification
...
class OracleUndoDatafileSpecification(OracleDatafileTempfileSpecification):
    """
    *(extends* :py:class:`v1_7_0.web.vo.OracleDatafileTempfileSpecification`
