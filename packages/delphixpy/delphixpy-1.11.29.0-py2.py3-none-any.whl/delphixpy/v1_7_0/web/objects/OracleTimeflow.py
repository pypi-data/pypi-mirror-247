...
from delphixpy.v1_7_0.web.objects.Timeflow import Timeflow
...
class OracleTimeflow(Timeflow):
    """
    *(extends* :py:class:`v1_7_0.web.vo.Timeflow` *)* TimeFlow representing
    ...
    def parent_point(self):
        ...
        :rtype: :py:class:`v1_7_0.web.vo.OracleTimeflowPoint`
        """
