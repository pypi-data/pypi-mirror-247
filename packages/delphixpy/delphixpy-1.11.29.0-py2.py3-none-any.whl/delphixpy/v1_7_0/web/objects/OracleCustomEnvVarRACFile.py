...
from delphixpy.v1_7_0.web.objects.OracleCustomEnvVarFile import OracleCustomEnvVarFile
...
class OracleCustomEnvVarRACFile(OracleCustomEnvVarFile):
    """
    *(extends* :py:class:`v1_7_0.web.vo.OracleCustomEnvVarFile` *)* Dictates an
