...
from delphixpy.v1_10_1.web.objects.Container import Container
...
class VMwareContainer(Container):
    """
    *(extends* :py:class:`v1_10_1.web.vo.Container` *)* Data container for
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_10_1.web.vo.VMwareContainerRuntime`
        """
