...
from delphixpy.v1_10_1.web.objects.HostEnvironment import HostEnvironment
...
class UnixHostEnvironment(HostEnvironment):
    """
    *(extends* :py:class:`v1_10_1.web.vo.HostEnvironment` *)* The
    ...
    def ase_host_environment_parameters(self):
        ...
        :rtype: :py:class:`v1_10_1.web.vo.ASEHostEnvironmentParameters`
        """
