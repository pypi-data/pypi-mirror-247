...
class FractionPlugParameters(TypedObject):
    """
    *(extends* :py:class:`v1_10_1.web.vo.TypedObject` *)* The parameters to use
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._schemas_prefix[0] is not None and obj._schemas_prefix[0] is not obj.__undef__:
            assert isinstance(obj._schemas_prefix[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._schemas_prefix[0], type(obj._schemas_prefix[0])))
        ...
        if obj._tablespaces_prefix[0] is not None and obj._tablespaces_prefix[0] is not obj.__undef__:
            assert isinstance(obj._tablespaces_prefix[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._tablespaces_prefix[0], type(obj._tablespaces_prefix[0])))
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "schemas_prefix" == "type" or (self.schemas_prefix is not self.__undef__ and (not (dirty and not self._schemas_prefix[1]) or self.is_dirty_list(self.schemas_prefix, self._schemas_prefix) or belongs_to_parent)):
            dct["schemasPrefix"] = dictify(self.schemas_prefix)
        if "tablespaces_prefix" == "type" or (self.tablespaces_prefix is not self.__undef__ and (not (dirty and not self._tablespaces_prefix[1]) or self.is_dirty_list(self.tablespaces_prefix, self._tablespaces_prefix) or belongs_to_parent)):
    ...
    def timeflow_point_parameters(self):
        ...
        :rtype: :py:class:`v1_10_1.web.vo.TimeflowPointParameters`
        """
