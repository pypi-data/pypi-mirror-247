...
from delphixpy.v1_10_1.web.objects.CompatibleRepositoriesParameters import CompatibleRepositoriesParameters
...
class XPPCompatibilityParameters(CompatibleRepositoriesParameters):
    """
    *(extends* :py:class:`v1_10_1.web.vo.CompatibleRepositoriesParameters` *)*
