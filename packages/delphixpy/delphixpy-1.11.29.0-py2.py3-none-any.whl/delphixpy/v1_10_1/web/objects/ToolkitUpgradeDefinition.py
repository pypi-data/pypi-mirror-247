...
class ToolkitUpgradeDefinition(TypedObject):
    """
    *(extends* :py:class:`v1_10_1.web.vo.TypedObject` *)* The toolkit upgrade
    ...
    def is_dirty(self):
        return any([self._from_version[1], self._upgrade_snapshot[1], self._upgrade_virtual_source[1], self._upgrade_linked_source[1], self._upgrade_manual_source_config[1]])
    ...
    def __eq__(self, other):
        ...
        return super().__eq__(other) and \
               ...
               self.upgrade_manual_source_config == other.upgrade_manual_source_config
