...
from delphixpy.v1_10_1.web.objects.MSSqlBaseClusterRepository import MSSqlBaseClusterRepository
...
class MSSqlFailoverClusterRepository(MSSqlBaseClusterRepository):
    """
    *(extends* :py:class:`v1_10_1.web.vo.MSSqlBaseClusterRepository` *)* The
    ...
    def drives(self):
        ...
        :rtype: ``list`` of
            :py:class:`v1_10_1.web.vo.MSSqlFailoverClusterDriveLetter`
        """
