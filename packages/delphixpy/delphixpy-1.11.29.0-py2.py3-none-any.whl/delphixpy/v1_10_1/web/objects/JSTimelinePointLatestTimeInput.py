...
from delphixpy.v1_10_1.web.objects.JSTimelinePointTimeParameters import JSTimelinePointTimeParameters
...
class JSTimelinePointLatestTimeInput(JSTimelinePointTimeParameters):
    """
    *(extends* :py:class:`v1_10_1.web.vo.JSTimelinePointTimeParameters` *)*
