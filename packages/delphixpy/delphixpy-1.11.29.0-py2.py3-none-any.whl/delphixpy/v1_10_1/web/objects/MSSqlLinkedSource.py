...
from delphixpy.v1_10_1.web.objects.MSSqlSource import MSSqlSource
...
class MSSqlLinkedSource(MSSqlSource):
    """
    *(extends* :py:class:`v1_10_1.web.vo.MSSqlSource` *)* A linked MSSQL
    source.
    """
    ...
    def ingestion_strategy(self):
        ...
        :rtype: :py:class:`v1_10_1.web.vo.IngestionStrategy`
        """
    ...
    def mssql_netbackup_config(self):
        ...
        :rtype: :py:class:`v1_10_1.web.vo.MSSqlNetbackupConfig`
        """
