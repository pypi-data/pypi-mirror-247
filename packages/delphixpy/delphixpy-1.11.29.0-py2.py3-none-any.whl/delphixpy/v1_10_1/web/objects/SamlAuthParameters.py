...
class SamlAuthParameters(TypedObject):
    """
    *(extends* :py:class:`v1_10_1.web.vo.TypedObject` *)* The parameter to use
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        def dictify(obj, prop_is_list_or_vo=False):
            if isinstance(obj, list):
                ...
                return obj
        if "encode_request" == "type" or (self.encode_request is not self.__undef__ and (not (dirty and not self._encode_request[1]) or self.is_dirty_list(self.encode_request, self._encode_request) or belongs_to_parent)):
