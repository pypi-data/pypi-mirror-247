...
def create(engine, user=None):
    ...
    :type user: :py:class:`v1_9_3.web.vo.User`
    :rtype: ``str``
    """
...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_9_3.web.objects.User.User` object
    :type ref: ``str``
    :rtype: :py:class:`v1_9_3.web.vo.User`
    """
...
def get_all(engine, type=None, domain_user_type=None):
    ...
    :rtype: ``list`` of :py:class:`v1_9_3.web.vo.User`
    """
    url = "/resources/json/delphix/user"
...
def update_credential(engine, ref, credential_update_parameters=None):
    ...
    :type credential_update_parameters:
        :py:class:`v1_9_3.web.vo.CredentialUpdateParameters`
    """
...
def current_auth_info(engine):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_9_3.delphix_engine.DelphixEngine`
    :rtype: :py:class:`v1_9_3.web.vo.UserAuthInfo`
    """
