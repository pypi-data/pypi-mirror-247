...
class PublicSystemInfo(TypedObject):
    """
    *(extends* :py:class:`v1_9_3.web.vo.TypedObject` *)* Retrieve static
    ...
    def is_dirty(self):
        return any([self._product_type[1], self._vendor_name[1], self._vendor_address[1], self._vendor_phone_number[1], self._vendor_email[1], self._vendor_url[1], self._product_name[1], self._engine_qualifier[1], self._support_contacts[1], self._support_url[1], self._build_title[1], self._build_timestamp[1], self._build_version[1], self._configured[1], self._enabled_features[1], self._api_version[1], self._banner[1], self._locales[1], self._current_locale[1]])
    ...
    def support_contacts(self):
        ...
        :rtype: ``list`` of :py:class:`v1_9_3.web.vo.SupportContact`
        """
    ...
    def build_version(self):
        ...
        :rtype: :py:class:`v1_9_3.web.vo.VersionInfo`
        """
