...
from delphixpy.v1_9_3.web.objects.ReplicationObjectSpecification import ReplicationObjectSpecification
...
class ReplicationSecureList(ReplicationObjectSpecification):
    """
    *(extends* :py:class:`v1_9_3.web.vo.ReplicationObjectSpecification` *)*
