...
class CertificateSigningRequestCreateParameters(TypedObject):
    ...
    *(extends* :py:class:`v1_9_3.web.vo.TypedObject` *)* The parameters used to
    ...
    def is_dirty(self):
        return any([self._end_entity[1], self._dname[1], self._force_replace[1], self._key_pair[1]])
    ...
    def dname(self):
        ...
        :rtype: :py:class:`v1_9_3.web.vo.X500DistinguishedName`
        """
    ...
    def key_pair(self):
        ...
        :rtype: :py:class:`v1_9_3.web.vo.KeyPair`
        """
