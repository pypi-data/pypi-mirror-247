...
class OracleClusterNodeCreateParameters(TypedObject):
    """
    *(extends* :py:class:`v1_9_3.web.vo.TypedObject` *)* The parameters used
    ...
    def host_parameters(self):
        ...
        :rtype: :py:class:`v1_9_3.web.vo.HostCreateParameters`
        """
    ...
    def virtual_i_ps(self):
        ...
        :rtype: ``list`` of :py:class:`v1_9_3.web.vo.OracleVirtualIP`
        """
