...
Package "host"
"""
from delphixpy.v1_9_3.web.host import privilegeElevation
...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_9_3.web.objects.Host.Host` object
    :type ref: ``str``
    :rtype: :py:class:`v1_9_3.web.vo.Host`
    """
...
def get_all(engine, environment=None):
    ...
    :rtype: ``list`` of :py:class:`v1_9_3.web.vo.Host`
    """
...
def update(engine, ref, host=None):
    ...
    :type host: :py:class:`v1_9_3.web.vo.Host`
    """
    url = "/resources/json/delphix/host/%s" % ref
...
def import_certificate_chain(engine, ref, certificate_chain_import_parameters):
    ...
    :type certificate_chain_import_parameters:
        :py:class:`v1_9_3.web.vo.CertificateChainImportParameters`
    """
