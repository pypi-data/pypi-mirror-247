...
from delphixpy.v1_11_27.web.objects.ReplicationObjectSpecification import ReplicationObjectSpecification
...
class ReplicationList(ReplicationObjectSpecification):
    """
    *(extends* :py:class:`v1_11_27.web.vo.ReplicationObjectSpecification` *)*
