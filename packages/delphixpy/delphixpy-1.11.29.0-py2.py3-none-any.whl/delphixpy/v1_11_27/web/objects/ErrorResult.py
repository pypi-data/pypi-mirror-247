...
from delphixpy.v1_11_27.web.objects.CallResult import CallResult
...
class ErrorResult(CallResult):
    """
    *(extends* :py:class:`v1_11_27.web.vo.CallResult` *)* Result of a failed
    API call.
    """
    ...
    def error(self):
        ...
        :rtype: :py:class:`v1_11_27.web.vo.APIError`
        """
