...
from delphixpy.v1_11_27.web.objects.BaseGroupCapacityData import BaseGroupCapacityData
...
class HistoricalGroupCapacityData(BaseGroupCapacityData):
    """
    *(extends* :py:class:`v1_11_27.web.vo.BaseGroupCapacityData` *)* Historical
