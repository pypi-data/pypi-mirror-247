...
def create(engine, fluentd_config=None):
    ...
    :type fluentd_config: :py:class:`delphixpy.web.vo.FluentdConfig`
    :rtype: ``str``
    """
...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.web.objects.FluentdConfig.FluentdConfig` object
    :type ref: ``str``
    :rtype: :py:class:`delphixpy.web.vo.FluentdConfig`
    """
...
def get_all(engine):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.delphix_engine.DelphixEngine`
    :rtype: ``list`` of :py:class:`delphixpy.web.vo.FluentdConfig`
    """
    url = "/resources/json/delphix/service/fluentd/configuration"
    response = engine.get(url)
    result = response_validator.validate(response, engine)
...
def test_splunk_hec(engine, splunk_hec_config=None):
    ...
    :type splunk_hec_config: :py:class:`delphixpy.web.vo.SplunkHecConfig`
    :rtype: ``str``
    """
