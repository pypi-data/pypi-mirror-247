...
#     /delphix-theme-reference-parameter.json
#
...
class ThemeReferenceParameter(TypedObject):
    """
    *(extends* :py:class:`delphixpy.web.vo.TypedObject` *)* Parameters that
    need object reference as an input.
    """
    def __init__(self, undef_enabled=True):
        super().__init__()
        self._type = ("ThemeReferenceParameter", True)
    ...
    def __eq__(self, other):
        if other is None:
            return False
        if not isinstance(other, ThemeReferenceParameter):
            return False
