...
class DeletionDependency(TypedObject):
    ...
    *(extends* :py:class:`delphixpy.web.vo.TypedObject` *)* Representation of
    an object that needs to be deleted before the object it depended on can be
    deleted.
    """
    ...
    def prerequisites(self):
        ...
        :rtype: ``list`` of
            :py:class:`delphixpy.web.vo.DeletionDependencyPrerequisite`
        """
    ...
    def dependencies(self):
        ...
        :rtype: ``list`` of :py:class:`delphixpy.web.vo.TypedObject`
        """
    ...
    def size(self):
        """
        The size of this object. Valid for TimeFlowSnapshot and HeldSpace
        objects.
