...
from delphixpy.web.objects.OracleSyncStrategy import OracleSyncStrategy
...
class OracleSourceBasedSyncStrategy(OracleSyncStrategy):
    """
    *(extends* :py:class:`delphixpy.web.vo.OracleSyncStrategy` *)* Base type
    for Oracle source based sync strategy and associated parameters.
    """
