...
class BlobObjectStoreAccess(TypedObject):
    """
    *(extends* :py:class:`delphixpy.web.vo.TypedObject` *)* Blob object store
    access.
    """
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._azure_account[0] is not None and obj._azure_account[0] is not obj.__undef__:
            assert isinstance(obj._azure_account[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._azure_account[0], type(obj._azure_account[0])))
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        def dictify(obj, prop_is_list_or_vo=False):
            if isinstance(obj, list):
                ...
                return obj
        if "azure_account" == "type" or (self.azure_account is not self.__undef__ and (not (dirty and not self._azure_account[1]) or self.is_dirty_list(self.azure_account, self._azure_account) or belongs_to_parent)):
