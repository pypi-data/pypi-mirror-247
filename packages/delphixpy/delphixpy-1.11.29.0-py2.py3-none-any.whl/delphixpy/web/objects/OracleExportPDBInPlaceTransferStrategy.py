...
from delphixpy.web.objects.OracleExportPDBTransferStrategy import OracleExportPDBTransferStrategy
...
class OracleExportPDBInPlaceTransferStrategy(OracleExportPDBTransferStrategy):
    """
    *(extends* :py:class:`delphixpy.web.vo.OracleExportPDBTransferStrategy` *)*
    ...
    def operations_post_v2_p(self):
        ...
        :rtype: :py:class:`delphixpy.web.vo.OracleExportOperationsPostV2P`
        """
