...
class EngineAggregateIngestedSize(TypedObject):
    """
    *(extends* :py:class:`delphixpy.web.vo.TypedObject` *)* Object which holds
    ...
    def aggregates(self):
        ...
        :rtype: ``list`` of
            :py:class:`delphixpy.web.vo.SourceTypeAggregateIngestedSize`
        """
    ...
    def source_ingestion_data(self):
        ...
        :rtype: ``list`` of :py:class:`delphixpy.web.vo.SourceIngestionData`
        """
