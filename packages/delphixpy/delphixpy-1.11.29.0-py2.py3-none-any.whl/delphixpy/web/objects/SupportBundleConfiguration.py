...
class SupportBundleConfiguration(TypedObject):
    """
    *(extends* :py:class:`delphixpy.web.vo.TypedObject` *)* Generates a
    "support bundle" that contains logs, metadata, and other supporting data
    used by the Delphix support.
    """
