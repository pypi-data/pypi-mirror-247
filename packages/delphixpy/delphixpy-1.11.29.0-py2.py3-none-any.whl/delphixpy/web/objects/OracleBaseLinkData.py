...
class OracleBaseLinkData(LinkData):
    ...
    *(extends* :py:class:`delphixpy.web.vo.LinkData` *)* Represents common
    ...
    def sync_strategy(self):
        ...
        :rtype: :py:class:`delphixpy.web.vo.OracleSyncStrategy`
        """
    ...
    def operations(self):
        ...
        :rtype: :py:class:`delphixpy.web.vo.OracleLinkedSourceOperations`
        """
    ...
    def sync_parameters(self):
        ...
        :rtype: :py:class:`delphixpy.web.vo.OracleSyncParameters`
        """
