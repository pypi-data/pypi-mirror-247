...
#     /delphix-fluentd-attribute.json
#
...
class FluentdAttribute(TypedObject):
    """
    *(extends* :py:class:`delphixpy.web.vo.TypedObject` *)* Fluentd attribute.
    """
    def __init__(self, undef_enabled=True):
        super().__init__()
        self._type = ("FluentdAttribute", True)
    ...
    def __eq__(self, other):
        if other is None:
            return False
        if not isinstance(other, FluentdAttribute):
            return False
