...
from delphixpy.web.objects.OracleExportStorageStrategy import OracleExportStorageStrategy
...
class OracleExportASMStorageStrategy(OracleExportStorageStrategy):
    """
    *(extends* :py:class:`delphixpy.web.vo.OracleExportStorageStrategy` *)*
    ...
    def asm_layout(self):
        ...
        :rtype: :py:class:`delphixpy.web.vo.OracleASMLayout`
        """
