...
#     /delphix-object-store-migration-status.json
#
...
class ObjectStoreMigrationStatus(TypedObject):
    """
    *(extends* :py:class:`delphixpy.web.vo.TypedObject` *)* Migrate block-based
    storage to object store.
    """
    def __init__(self, undef_enabled=True):
        super().__init__()
        self._type = ("ObjectStoreMigrationStatus", True)
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._state[0] is not None and obj._state[0] is not obj.__undef__:
            ...
            assert obj._state[0] in ['NONE', 'ACTIVE', 'COMPLETED'], "Expected enum ['NONE', 'ACTIVE', 'COMPLETED'] but got %s" % obj._state[0]
    ...
    def __eq__(self, other):
        if other is None:
            return False
        if not isinstance(other, ObjectStoreMigrationStatus):
            return False
    ...
    def state(self):
        """
        Migration state. *(permitted values: NONE, ACTIVE, COMPLETED)*
    ...
    def copied(self):
        """
        Amount of data migrated, in bytes.
    ...
    def total(self):
        """
        Total amount of data to migrate (including completed), in bytes.
