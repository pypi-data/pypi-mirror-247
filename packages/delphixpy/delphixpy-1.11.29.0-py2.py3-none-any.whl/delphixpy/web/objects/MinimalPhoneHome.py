...
#     /delphix-minimal-phone-home.json
#
...
class MinimalPhoneHome(TypedObject):
    """
    *(extends* :py:class:`delphixpy.web.vo.TypedObject` *)* Collect minimal
    phonehome data part of support bundle.
    """
    def __init__(self, undef_enabled=True):
        super().__init__()
        self._type = ("MinimalPhoneHome", True)
    ...
    def __eq__(self, other):
        if other is None:
            return False
        if not isinstance(other, MinimalPhoneHome):
            return False
    ...
    def enabled(self):
        """
        True if minimal phonehome is enabled.
