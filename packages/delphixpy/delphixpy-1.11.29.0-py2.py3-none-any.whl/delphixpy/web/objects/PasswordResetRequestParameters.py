...
#     /delphix-password-reset-request-parameters.json
#
...
class PasswordResetRequestParameters(TypedObject):
    """
    *(extends* :py:class:`delphixpy.web.vo.TypedObject` *)* Parameters in a
    password reset request.
    """
    def __init__(self, undef_enabled=True):
        super().__init__()
        self._type = ("PasswordResetRequestParameters", True)
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        def dictify(obj, prop_is_list_or_vo=False):
            if isinstance(obj, list):
                ...
                return obj
        if "user_name" == "type" or (self.user_name is not self.__undef__ and (not (dirty and not self._user_name[1]) or self.is_dirty_list(self.user_name, self._user_name) or belongs_to_parent)):
    ...
    def is_dirty(self):
        return any([self._user_name[1], self._user_type[1]])
    ...
    def __eq__(self, other):
        if other is None:
            return False
        if not isinstance(other, PasswordResetRequestParameters):
            return False
    ...
    def user_name(self):
        """
        The username for a user account on this engine.
    ...
    def user_type(self):
        """
        The authentication domain to which the user belongs. *(permitted
        values: SYSTEM, DOMAIN)*
