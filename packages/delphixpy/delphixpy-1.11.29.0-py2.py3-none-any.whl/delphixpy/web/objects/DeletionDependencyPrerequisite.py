...
class DeletionDependencyPrerequisite(TypedObject):
    """
    *(extends* :py:class:`delphixpy.web.vo.TypedObject` *)* The prerequisite
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._operation_type[0] is not None and obj._operation_type[0] is not obj.__undef__:
            assert isinstance(obj._operation_type[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._operation_type[0], type(obj._operation_type[0])))
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "operation_type" == "type" or (self.operation_type is not self.__undef__ and (not (dirty and not self._operation_type[1]) or self.is_dirty_list(self.operation_type, self._operation_type) or belongs_to_parent)):
