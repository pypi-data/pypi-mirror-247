...
from delphixpy.web.objects.OracleExportDBTransferStrategy import OracleExportDBTransferStrategy
...
class OracleExportDBTimeflowPointTransferStrategy(OracleExportDBTransferStrategy):
    """
    *(extends* :py:class:`delphixpy.web.vo.OracleExportDBTransferStrategy` *)*
