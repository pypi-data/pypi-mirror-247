...
def get(engine, ref):
    ...
    :param ref: Reference to a :py:class:`delphixpy.web.objects.UpgradeVerifica
        tionReport.UpgradeVerificationReport` object
    :type ref: ``str``
    :rtype: :py:class:`delphixpy.web.vo.UpgradeVerificationReport`
    """
...
def get_all(engine, version=None, page_size=None, page_offset=None, sort_by=None, ascending=None):
    ...
    :type ascending: ``bool``
    :rtype: ``list`` of :py:class:`delphixpy.web.vo.UpgradeVerificationReport`
    """
