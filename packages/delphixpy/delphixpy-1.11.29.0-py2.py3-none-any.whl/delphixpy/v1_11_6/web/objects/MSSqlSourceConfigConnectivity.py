...
from delphixpy.v1_11_6.web.objects.AbstractSourceConfigConnectivity import AbstractSourceConfigConnectivity
...
class MSSqlSourceConfigConnectivity(AbstractSourceConfigConnectivity):
    """
    *(extends* :py:class:`v1_11_6.web.vo.AbstractSourceConfigConnectivity` *)*
