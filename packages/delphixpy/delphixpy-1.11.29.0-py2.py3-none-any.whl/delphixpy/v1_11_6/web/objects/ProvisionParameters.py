...
from delphixpy.v1_11_6.web.objects.VirtualDatasetCreationParameters import VirtualDatasetCreationParameters
...
class ProvisionParameters(VirtualDatasetCreationParameters):
    """
    *(extends* :py:class:`v1_11_6.web.vo.VirtualDatasetCreationParameters` *)*
