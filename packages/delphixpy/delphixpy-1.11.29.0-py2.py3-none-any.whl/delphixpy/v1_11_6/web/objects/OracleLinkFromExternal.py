...
from delphixpy.v1_11_6.web.objects.OracleBaseLinkData import OracleBaseLinkData
...
class OracleLinkFromExternal(OracleBaseLinkData):
    """
    *(extends* :py:class:`v1_11_6.web.vo.OracleBaseLinkData` *)* Represents
    ...
    def is_dirty(self):
        return any([self._config[1], self._non_sys_user[1], self._non_sys_credentials[1]])
