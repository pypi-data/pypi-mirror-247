...
from delphixpy.v1_11_6.web.objects.OracleManagedSource import OracleManagedSource
...
class OracleVirtualSource(OracleManagedSource):
    """
    *(extends* :py:class:`v1_11_6.web.vo.OracleManagedSource` *)* A virtual
    Oracle source.
    """
    ...
    def custom_env_vars(self):
        ...
        :rtype: ``list`` of :py:class:`v1_11_6.web.vo.OracleCustomEnvVar`
        """
