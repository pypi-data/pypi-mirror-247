...
from delphixpy.v1_11_6.web.objects.JSOperationEndpointParameters import JSOperationEndpointParameters
...
class JSOperationEndpointDataLayoutParameters(JSOperationEndpointParameters):
    """
    *(extends* :py:class:`v1_11_6.web.vo.JSOperationEndpointParameters` *)* The
