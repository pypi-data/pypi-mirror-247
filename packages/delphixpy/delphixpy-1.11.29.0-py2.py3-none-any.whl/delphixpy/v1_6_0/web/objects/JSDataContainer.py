...
from delphixpy.v1_6_0.web.objects.JSDataLayout import JSDataLayout
...
class JSDataContainer(JSDataLayout):
    """
    *(extends* :py:class:`v1_6_0.web.vo.JSDataLayout` *)* A container
    ...
    def is_dirty(self):
        return any([self._operation_count[1], self._owner[1], self._state[1], self._template[1]])
