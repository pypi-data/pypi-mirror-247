...
from delphixpy.v1_6_0.web.objects.Timeflow import Timeflow
...
class MSSqlTimeflow(Timeflow):
    """
    *(extends* :py:class:`v1_6_0.web.vo.Timeflow` *)* TimeFlow representing
    ...
    def parent_point(self):
        ...
        :rtype: :py:class:`v1_6_0.web.vo.MSSqlTimeflowPoint`
        """
