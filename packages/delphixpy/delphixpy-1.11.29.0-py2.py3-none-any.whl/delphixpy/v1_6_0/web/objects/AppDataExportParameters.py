...
from delphixpy.v1_6_0.web.objects.ExportParameters import ExportParameters
...
class AppDataExportParameters(ExportParameters):
    """
    *(extends* :py:class:`v1_6_0.web.vo.ExportParameters` *)* The parameters to
    ...
    def filesystem_layout(self):
        ...
        :rtype: :py:class:`v1_6_0.web.vo.AppDataFilesystemLayout`
        """
