...
from delphixpy.v1_6_0.web.objects.DatabaseContainer import DatabaseContainer
...
class OracleDatabaseContainer(DatabaseContainer):
    """
    *(extends* :py:class:`v1_6_0.web.vo.DatabaseContainer` *)* Data container
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._endianness[0] is not None and obj._endianness[0] is not obj.__undef__:
            assert isinstance(obj._endianness[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._endianness[0], type(obj._endianness[0])))
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_6_0.web.vo.OracleDBContainerRuntime`
        """
    ...
    def sourcing_policy(self):
        ...
        :rtype: :py:class:`v1_6_0.web.vo.OracleSourcingPolicy`
        """
