...
class Toolkit(NamedUserObject):
    """
    *(extends* :py:class:`v1_6_0.web.vo.NamedUserObject` *)* An installed
    toolkit.
    """
    ...
    def discovery_definition(self):
        ...
        :rtype: :py:class:`v1_6_0.web.vo.ToolkitDiscoveryDefinition`
        """
    ...
    def linked_source_definition(self):
        ...
        :rtype: :py:class:`v1_6_0.web.vo.ToolkitLinkedSource`
        """
    ...
    def virtual_source_definition(self):
        ...
        :rtype: :py:class:`v1_6_0.web.vo.ToolkitVirtualSource`
        """
