...
class ReplicationSpecRuntime(TypedObject):
    """
    *(extends* :py:class:`v1_6_0.web.vo.TypedObject` *)* Runtime properties for
    a replication spec.
    """
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._next_scheduled_execution[0] is not None and obj._next_scheduled_execution[0] is not obj.__undef__:
            assert isinstance(obj._next_scheduled_execution[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._next_scheduled_execution[0], type(obj._next_scheduled_execution[0])))
