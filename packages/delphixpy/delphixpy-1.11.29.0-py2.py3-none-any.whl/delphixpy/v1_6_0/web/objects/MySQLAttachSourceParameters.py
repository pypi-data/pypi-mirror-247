...
#     /delphix-mysql-attach-source-parameters.json
#
...
class MySQLAttachSourceParameters(AttachSourceParameters):
    """
    *(extends* :py:class:`v1_6_0.web.vo.AttachSourceParameters` *)* The
    parameters to use as input to attach requests for MySQL.
    """
    def __init__(self, undef_enabled=True):
        super().__init__()
        self._type = ("MySQLAttachSourceParameters", True)
    ...
    def is_dirty(self):
        return any([self._db_credentials[1], self._db_user[1], self._source[1], self._staging_host_user[1], self._staging_port[1], self._staging_repository[1]])
    ...
    def __eq__(self, other):
        if other is None:
            return False
        if not isinstance(other, MySQLAttachSourceParameters):
            return False
