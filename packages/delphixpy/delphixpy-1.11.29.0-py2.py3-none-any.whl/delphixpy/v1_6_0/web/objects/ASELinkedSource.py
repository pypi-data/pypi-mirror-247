...
from delphixpy.v1_6_0.web.objects.ASESource import ASESource
...
class ASELinkedSource(ASESource):
    """
    *(extends* :py:class:`v1_6_0.web.vo.ASESource` *)* A linked SAP ASE source.
    """
    ...
    def monitor_location(self):
        ...
        :rtype: :py:class:`v1_6_0.web.vo.ASEBackupLocation`
        """
    ...
    def operations(self):
        ...
        :rtype: :py:class:`v1_6_0.web.vo.LinkedSourceOperations`
        """
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_6_0.web.vo.ASESourceRuntime`
        """
