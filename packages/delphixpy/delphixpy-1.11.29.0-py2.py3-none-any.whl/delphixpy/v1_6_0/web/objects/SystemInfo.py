...
from delphixpy.v1_6_0.web.objects.PublicSystemInfo import PublicSystemInfo
...
class SystemInfo(PublicSystemInfo):
    """
    *(extends* :py:class:`v1_6_0.web.vo.PublicSystemInfo` *)* Retrieve system-
    ...
    def processors(self):
        ...
        :rtype: ``list`` of :py:class:`v1_6_0.web.vo.CPUInfo`
        """
