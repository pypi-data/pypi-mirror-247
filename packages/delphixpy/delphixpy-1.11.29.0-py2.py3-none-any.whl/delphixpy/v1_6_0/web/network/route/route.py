...
def get_all(engine):
    ...
    :rtype: ``list`` of :py:class:`v1_6_0.web.vo.NetworkRoute`
    """
...
def add(engine, network_route=None):
    ...
    :type network_route: :py:class:`v1_6_0.web.vo.NetworkRoute`
    """
...
def lookup(engine, network_route_lookup_parameters):
    ...
    :type network_route_lookup_parameters:
        :py:class:`v1_6_0.web.vo.NetworkRouteLookupParameters`
    :rtype: :py:class:`v1_6_0.web.vo.NetworkRoute`
    """
