...
class NfsConfig(TypedObject):
    """
    *(extends* :py:class:`v1_11_0.web.vo.TypedObject` *)* Get and set global
    NFS properties.
    """
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._mount_version[0] is not None and obj._mount_version[0] is not obj.__undef__:
            ...
            assert obj._mount_version[0] in ['DEFAULT', 'NFSv3', 'NFSv4'], "Expected enum ['DEFAULT', 'NFSv3', 'NFSv4'] but got %s" % obj._mount_version[0]
    ...
    def mount_version(self):
        ...
        Delphix Engine. *(permitted values: DEFAULT, NFSv3, NFSv4)*
