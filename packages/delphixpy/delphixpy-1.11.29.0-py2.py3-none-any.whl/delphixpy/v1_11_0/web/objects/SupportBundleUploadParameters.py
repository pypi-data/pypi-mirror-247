...
from delphixpy.v1_11_0.web.objects.BaseSupportBundleParameters import BaseSupportBundleParameters
...
class SupportBundleUploadParameters(BaseSupportBundleParameters):
    """
    *(extends* :py:class:`v1_11_0.web.vo.BaseSupportBundleParameters` *)*
