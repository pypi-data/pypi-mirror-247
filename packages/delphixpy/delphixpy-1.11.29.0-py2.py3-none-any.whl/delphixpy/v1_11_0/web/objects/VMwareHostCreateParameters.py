...
from delphixpy.v1_11_0.web.objects.HostCreateParameters import HostCreateParameters
...
class VMwareHostCreateParameters(HostCreateParameters):
    """
    *(extends* :py:class:`v1_11_0.web.vo.HostCreateParameters` *)* The
    ...
    def host(self):
        ...
        :rtype: :py:class:`v1_11_0.web.vo.VMwareHost`
        """
        return self._host[0]
