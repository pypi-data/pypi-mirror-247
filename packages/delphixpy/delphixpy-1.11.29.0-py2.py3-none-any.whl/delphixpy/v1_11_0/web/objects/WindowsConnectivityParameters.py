...
from delphixpy.v1_11_0.web.objects.ConnectivityParameters import ConnectivityParameters
...
class WindowsConnectivityParameters(ConnectivityParameters):
    """
    *(extends* :py:class:`v1_11_0.web.vo.ConnectivityParameters` *)* Parameters
