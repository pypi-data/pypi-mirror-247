...
from delphixpy.v1_11_0.web.objects.OracleFileSpecification import OracleFileSpecification
...
class OracleDatafileTempfileSpecification(OracleFileSpecification):
    """
    *(extends* :py:class:`v1_11_0.web.vo.OracleFileSpecification` *)* Describes
