...
from delphixpy.v1_11_0.web.objects.OracleCustomEnvVarPair import OracleCustomEnvVarPair
...
class OracleCustomEnvVarRACPair(OracleCustomEnvVarPair):
    """
    *(extends* :py:class:`v1_11_0.web.vo.OracleCustomEnvVarPair` *)* Dictates a
