...
def get(engine, ref):
    ...
    :param ref: Reference to a :py:class:`delphixpy.v1_11_20.web.objects.JSWeek
        lyOperationCount.JSWeeklyOperationCount` object
    :type ref: ``str``
    :rtype: :py:class:`v1_11_20.web.vo.JSWeeklyOperationCount`
    """
...
def get_all(engine, usage_object=None):
    ...
    :rtype: ``list`` of :py:class:`v1_11_20.web.vo.JSWeeklyOperationCount`
    """
