...
Package "job"
"""
from delphixpy.v1_11_20.web.job import retention
...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_11_20.web.objects.Job.Job` object
    :type ref: ``str``
...
def get_all(engine, job_state=None, job_type=None, target=None, from_date=None, to_date=None, page_size=None, page_offset=None, add_events=None, search_text=None, max_total=None):
    ...
    :type max_total: ``int``
    :rtype: ``list`` of :py:class:`v1_11_20.web.vo.Job`
    """
...
def update(engine, ref, job=None):
    ...
    :type job: :py:class:`v1_11_20.web.vo.Job`
    """
    url = "/resources/json/delphix/job/%s" % ref
