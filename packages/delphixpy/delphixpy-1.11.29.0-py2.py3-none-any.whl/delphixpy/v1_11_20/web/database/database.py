...
Package "database"
"""
from delphixpy.v1_11_20.web.database import performanceHistory
from urllib.parse import urlencode
from delphixpy.v1_11_20 import response_validator
...
def get(engine, ref):
    ...
    :type engine: :py:class:`delphixpy.v1_11_20.delphix_engine.DelphixEngine`
    :param ref: Reference to a
        :py:class:`delphixpy.v1_11_20.web.objects.Container.Container` object
    :type ref: ``str``
    :rtype: :py:class:`v1_11_20.web.vo.Container`
    """
...
def get_all(engine, provision_container=None, group=None, no_js_data_source=None, no_js_container_data_source=None, valid_for_secure_replication=None, cdb_container=None):
    ...
    :rtype: ``list`` of :py:class:`v1_11_20.web.vo.Container`
    """
...
def update(engine, ref, container=None):
    ...
    :type container: :py:class:`v1_11_20.web.vo.Container`
    """
    url = "/resources/json/delphix/database/%s" % ref
...
def delete(engine, ref, delete_parameters=None):
    ...
    :type delete_parameters: :py:class:`v1_11_20.web.vo.DeleteParameters`
    """
...
def refresh(engine, ref, refresh_parameters):
    ...
    :type refresh_parameters: :py:class:`v1_11_20.web.vo.RefreshParameters`
    """
...
def rollback(engine, ref, rollback_parameters):
    ...
    :type rollback_parameters: :py:class:`v1_11_20.web.vo.RollbackParameters`
    """
...
def deprovision(engine, ref, reprovision_parameters):
    ...
    :type reprovision_parameters:
        :py:class:`v1_11_20.web.vo.ReprovisionParameters`
    :rtype: ``dict``
    """
...
def switch_timeflow(engine, ref, switch_timeflow_parameters):
    ...
    :type switch_timeflow_parameters:
        :py:class:`v1_11_20.web.vo.SwitchTimeflowParameters`
    """
...
def sync(engine, ref, sync_parameters=None):
    ...
    :type sync_parameters: :py:class:`v1_11_20.web.vo.SyncParameters`
    """
...
def detach_source(engine, ref, detach_source_parameters):
    ...
    :type detach_source_parameters:
        :py:class:`v1_11_20.web.vo.DetachSourceParameters`
    """
...
def attach_source(engine, ref, attach_source_parameters):
    ...
    :type attach_source_parameters:
        :py:class:`v1_11_20.web.vo.AttachSourceParameters`
    :rtype: ``str``
    """
...
def connection_info(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_11_20.web.objects.Container.Container` object
    :type ref: ``str``
    :rtype: :py:class:`v1_11_20.web.vo.SourceConnectionInfo`
    """
...
def purge_logs(engine, ref, purge_logs_parameters):
    ...
    :type purge_logs_parameters:
        :py:class:`v1_11_20.web.vo.PurgeLogsParameters`
    :rtype: :py:class:`v1_11_20.web.vo.PurgeLogsResult`
    """
...
def add_live_source(engine, ref, add_live_source_parameters):
    ...
    :type add_live_source_parameters:
        :py:class:`v1_11_20.web.vo.AddLiveSourceParameters`
    """
...
def add_live_source_defaults(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_11_20.web.objects.Container.Container` object
    :type ref: ``str``
    :rtype: :py:class:`v1_11_20.web.vo.AddLiveSourceParameters`
    """
...
def create_transformation(engine, ref, create_transformation_parameters):
    ...
    :type create_transformation_parameters:
        :py:class:`v1_11_20.web.vo.CreateTransformationParameters`
    :rtype: ``str``
    """
...
def timeflow_snapshot_day_range(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_11_20.web.objects.Container.Container` object
    :type ref: ``str``
    :rtype: ``list`` of :py:class:`v1_11_20.web.vo.TimeflowSnapshotDayRange`
    """
...
def provision(engine, provision_parameters):
    ...
    :type provision_parameters: :py:class:`v1_11_20.web.vo.ProvisionParameters`
    :rtype: ``str``
    """
...
def provision_defaults(engine, timeflow_point_parameters):
    ...
    :type timeflow_point_parameters:
        :py:class:`v1_11_20.web.vo.TimeflowPointParameters`
    :rtype: :py:class:`v1_11_20.web.vo.ProvisionParameters`
    """
...
def create_empty(engine, empty_dataset_creation_parameters):
    ...
    :type empty_dataset_creation_parameters:
        :py:class:`v1_11_20.web.vo.EmptyDatasetCreationParameters`
    :rtype: ``str``
    """
...
def link(engine, link_parameters):
    ...
    :type link_parameters: :py:class:`v1_11_20.web.vo.LinkParameters`
    :rtype: ``str``
    """
...
def link_defaults(engine, config=None):
    ...
    :type config: ``str``
    :rtype: :py:class:`v1_11_20.web.vo.LinkParameters`
    """
...
def export(engine, export_parameters):
    ...
    :type export_parameters: :py:class:`v1_11_20.web.vo.ExportParameters`
    """
...
def file_mapping(engine, file_mapping_parameters):
    ...
    :type file_mapping_parameters:
        :py:class:`v1_11_20.web.vo.FileMappingParameters`
    :rtype: :py:class:`v1_11_20.web.vo.FileMappingResult`
    """
...
def oracle_supported_character_sets(engine):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_11_20.delphix_engine.DelphixEngine`
    :rtype: ``list`` of :py:class:`v1_11_20.web.vo.OracleCharacterSet`
    """
...
def batch_delete(engine, batch_container_delete_parameters):
    ...
    :type batch_container_delete_parameters:
        :py:class:`v1_11_20.web.vo.BatchContainerDeleteParameters`
    """
...
def batch_refresh(engine, batch_container_refresh_parameters):
    ...
    :type batch_container_refresh_parameters:
        :py:class:`v1_11_20.web.vo.BatchContainerRefreshParameters`
    """
