...
def create(engine, network_throughput_test_parameters):
    ...
    :type network_throughput_test_parameters:
        :py:class:`v1_11_20.web.vo.NetworkThroughputTestParameters`
    :rtype: ``str``
    """
...
def get(engine, ref):
    ...
    :type ref: ``str``
    :rtype: :py:class:`v1_11_20.web.vo.NetworkThroughputTest`
    """
...
def get_all(engine, ascending=None):
    ...
    :type ascending: ``bool``
    :rtype: ``list`` of :py:class:`v1_11_20.web.vo.NetworkThroughputTest`
    """
    url = "/resources/json/delphix/network/test/throughput"
