...
from delphixpy.v1_11_20.web.objects.MSSqlBaseClusterRepository import MSSqlBaseClusterRepository
...
class MSSqlFailoverClusterRepository(MSSqlBaseClusterRepository):
    """
    *(extends* :py:class:`v1_11_20.web.vo.MSSqlBaseClusterRepository` *)* The
    ...
    def drives(self):
        ...
        :rtype: ``list`` of
            :py:class:`v1_11_20.web.vo.MSSqlFailoverClusterDriveLetter`
        """
