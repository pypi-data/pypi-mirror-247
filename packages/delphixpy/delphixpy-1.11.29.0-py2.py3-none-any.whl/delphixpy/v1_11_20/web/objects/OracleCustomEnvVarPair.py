...
from delphixpy.v1_11_20.web.objects.OracleCustomEnvVar import OracleCustomEnvVar
...
class OracleCustomEnvVarPair(OracleCustomEnvVar):
    """
    *(extends* :py:class:`v1_11_20.web.vo.OracleCustomEnvVar` *)* Dictates a
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._var_name[0] is not None and obj._var_name[0] is not obj.__undef__:
            assert isinstance(obj._var_name[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._var_name[0], type(obj._var_name[0])))
        ...
        if obj._var_value[0] is not None and obj._var_value[0] is not obj.__undef__:
            assert isinstance(obj._var_value[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._var_value[0], type(obj._var_value[0])))
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        def dictify(obj, prop_is_list_or_vo=False):
            if isinstance(obj, list):
                ...
                return obj
        if "var_name" == "type" or (self.var_name is not self.__undef__ and (not (dirty and not self._var_name[1]) or self.is_dirty_list(self.var_name, self._var_name) or belongs_to_parent)):
            dct["varName"] = dictify(self.var_name)
        if "var_value" == "type" or (self.var_value is not self.__undef__ and (not (dirty and not self._var_value[1]) or self.is_dirty_list(self.var_value, self._var_value) or belongs_to_parent)):
