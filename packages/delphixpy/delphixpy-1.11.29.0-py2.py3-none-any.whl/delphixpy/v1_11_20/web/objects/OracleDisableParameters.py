...
from delphixpy.v1_11_20.web.objects.SourceDisableParameters import SourceDisableParameters
...
class OracleDisableParameters(SourceDisableParameters):
    """
    *(extends* :py:class:`v1_11_20.web.vo.SourceDisableParameters` *)* The
