...
from delphixpy.v1_11_20.web.objects.SourceUpgradeParameters import SourceUpgradeParameters
...
class MSSqlLinkedSourceUpgradeParameters(SourceUpgradeParameters):
    """
    *(extends* :py:class:`v1_11_20.web.vo.SourceUpgradeParameters` *)* The
