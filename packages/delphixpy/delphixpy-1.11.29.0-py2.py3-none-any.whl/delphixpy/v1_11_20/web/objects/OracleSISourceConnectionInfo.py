...
from delphixpy.v1_11_20.web.objects.OracleSourceConnectionInfo import OracleSourceConnectionInfo
...
class OracleSISourceConnectionInfo(OracleSourceConnectionInfo):
    """
    *(extends* :py:class:`v1_11_20.web.vo.OracleSourceConnectionInfo` *)*
