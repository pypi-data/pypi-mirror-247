...
from delphixpy.v1_11_20.web.objects.AbstractVaultCredential import AbstractVaultCredential
...
class CyberArkVaultCredential(AbstractVaultCredential):
    """
    *(extends* :py:class:`v1_11_20.web.vo.AbstractVaultCredential` *)* The
