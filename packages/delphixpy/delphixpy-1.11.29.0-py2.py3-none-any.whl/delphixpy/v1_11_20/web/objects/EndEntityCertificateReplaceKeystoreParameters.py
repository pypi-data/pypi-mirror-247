...
#     /delphix-end-entity-certificate-replace-keystore-parameters.json
#
# Do not edit this file manually!
#

from delphixpy.v1_11_20.web.objects.EndEntityCertificateReplaceParameters import EndEntityCertificateReplaceParameters
...
class EndEntityCertificateReplaceKeystoreParameters(EndEntityCertificateReplaceParameters):
    """
    *(extends*
    :py:class:`v1_11_20.web.vo.EndEntityCertificateReplaceParameters` *)* The
    parameters for replacing an end-entity certificate with a certificate and
    key pair from a keystore.
    """
    def __init__(self, undef_enabled=True):
        super().__init__()
        self._type = ("EndEntityCertificateReplaceKeystoreParameters", True)
    ...
    def __eq__(self, other):
        if other is None:
            return False
        if not isinstance(other, EndEntityCertificateReplaceKeystoreParameters):
            return False
