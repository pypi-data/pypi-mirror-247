...
from delphixpy.v1_11_20.web.objects.NetworkTestParameters import NetworkTestParameters
...
class NetworkLatencyTestParameters(NetworkTestParameters):
    """
    *(extends* :py:class:`v1_11_20.web.vo.NetworkTestParameters` *)* Parameters
