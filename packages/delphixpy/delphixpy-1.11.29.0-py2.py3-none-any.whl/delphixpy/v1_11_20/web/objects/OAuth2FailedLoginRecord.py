...
from delphixpy.v1_11_20.web.objects.FailedLoginRecord import FailedLoginRecord
...
class OAuth2FailedLoginRecord(FailedLoginRecord):
    """
    *(extends* :py:class:`v1_11_20.web.vo.FailedLoginRecord` *)* Represents an
    failed OAuth2 login.
    """
    def __init__(self, undef_enabled=True):
        super().__init__()
        self._type = ("OAuth2FailedLoginRecord", True)
    ...
    def __eq__(self, other):
        if other is None:
            return False
        if not isinstance(other, OAuth2FailedLoginRecord):
            return False
