...
def create(engine, fluentd_config=None):
    ...
    :type fluentd_config: :py:class:`v1_11_20.web.vo.FluentdConfig`
    :rtype: ``str``
    """
...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_11_20.web.objects.FluentdConfig.FluentdConfig`
        object
    :type ref: ``str``
    :rtype: :py:class:`v1_11_20.web.vo.FluentdConfig`
    """
...
def get_all(engine):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_11_20.delphix_engine.DelphixEngine`
    :rtype: ``list`` of :py:class:`v1_11_20.web.vo.FluentdConfig`
    """
    url = "/resources/json/delphix/service/fluentd/configuration"
    response = engine.get(url)
    result = response_validator.validate(response, engine)
