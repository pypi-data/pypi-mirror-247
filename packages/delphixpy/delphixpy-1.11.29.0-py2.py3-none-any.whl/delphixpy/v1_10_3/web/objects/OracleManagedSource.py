...
from delphixpy.v1_10_3.web.objects.OracleSource import OracleSource
...
class OracleManagedSource(OracleSource):
    """
    *(extends* :py:class:`v1_10_3.web.vo.OracleSource` *)* Common properties
    ...
    def is_dirty(self):
        return any([self._mount_base[1], self._config_params[1], self._config_template[1], self._node_listeners[1]])
    ...
    def __eq__(self, other):
        ...
        return super().__eq__(other) and \
               ...
               self.node_listeners == other.node_listeners
