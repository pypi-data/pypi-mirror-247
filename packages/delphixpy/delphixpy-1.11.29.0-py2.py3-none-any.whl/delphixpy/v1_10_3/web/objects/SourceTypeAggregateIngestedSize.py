...
class SourceTypeAggregateIngestedSize(TypedObject):
    """
    *(extends* :py:class:`v1_10_3.web.vo.TypedObject` *)* An aggregation for a
    type of source.
    """
    ...
    def is_dirty(self):
        return any([self._aggregate_size[1], self._container_type[1], self._aggregate_label[1]])
    ...
    def __eq__(self, other):
        ...
        return super().__eq__(other) and \
               ...
               self.aggregate_label == other.aggregate_label
