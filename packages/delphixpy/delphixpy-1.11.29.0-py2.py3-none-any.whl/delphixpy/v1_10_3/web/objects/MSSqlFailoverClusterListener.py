...
from delphixpy.v1_10_3.web.objects.MSSqlBaseClusterListener import MSSqlBaseClusterListener
...
class MSSqlFailoverClusterListener(MSSqlBaseClusterListener):
    """
    *(extends* :py:class:`v1_10_3.web.vo.MSSqlBaseClusterListener` *)* The
