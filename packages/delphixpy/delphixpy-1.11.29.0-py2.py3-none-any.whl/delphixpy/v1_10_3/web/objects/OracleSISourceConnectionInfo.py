...
from delphixpy.v1_10_3.web.objects.OracleSourceConnectionInfo import OracleSourceConnectionInfo
...
class OracleSISourceConnectionInfo(OracleSourceConnectionInfo):
    """
    *(extends* :py:class:`v1_10_3.web.vo.OracleSourceConnectionInfo` *)*
