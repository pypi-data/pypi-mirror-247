...
from delphixpy.v1_10_3.web.objects.SourceRuntime import SourceRuntime
...
class OracleBaseSourceRuntime(SourceRuntime):
    """
    *(extends* :py:class:`v1_10_3.web.vo.SourceRuntime` *)* Runtime (non-
    ...
    def active_instances(self):
        ...
        :rtype: ``list`` of :py:class:`v1_10_3.web.vo.OracleActiveInstance`
        """
    ...
    def database_stats(self):
        ...
        :rtype: ``list`` of
            :py:class:`v1_10_3.web.vo.OracleDatabaseStatsSection`
        """
