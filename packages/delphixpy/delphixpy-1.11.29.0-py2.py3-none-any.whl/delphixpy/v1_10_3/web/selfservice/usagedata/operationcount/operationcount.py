...
def get(engine, ref):
    ...
    :param ref: Reference to a :py:class:`delphixpy.v1_10_3.web.objects.JSWeekl
        yOperationCount.JSWeeklyOperationCount` object
    :type ref: ``str``
    :rtype: :py:class:`v1_10_3.web.vo.JSWeeklyOperationCount`
    """
...
def get_all(engine, usage_object=None):
    ...
    :rtype: ``list`` of :py:class:`v1_10_3.web.vo.JSWeeklyOperationCount`
    """
