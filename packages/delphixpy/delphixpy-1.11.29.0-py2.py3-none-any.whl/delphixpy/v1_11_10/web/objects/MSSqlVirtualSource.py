...
from delphixpy.v1_11_10.web.objects.MSSqlSource import MSSqlSource
...
class MSSqlVirtualSource(MSSqlSource):
    """
    *(extends* :py:class:`v1_11_10.web.vo.MSSqlSource` *)* A virtual MSSQL
    source.
    """
    ...
    def is_dirty(self):
        return any([self._pre_script[1], self._post_script[1], self._operations[1], self._mount_base[1], self._file_mapping_rules[1], self._config_params[1], self._allow_auto_vdb_restart_on_host_reboot[1], self._enable_cdc_on_provision[1]])
    ...
    def __eq__(self, other):
        ...
        return super().__eq__(other) and \
               ...
               self.enable_cdc_on_provision == other.enable_cdc_on_provision
    ...
    def operations(self):
        ...
        :rtype: :py:class:`v1_11_10.web.vo.VirtualSourceOperations`
        """
