...
from delphixpy.v1_11_10.web.objects.MSSqlSourceSyncStrategy import MSSqlSourceSyncStrategy
...
class MSSqlExternalManagedSourceSyncStrategy(MSSqlSourceSyncStrategy):
    """
    *(extends* :py:class:`v1_11_10.web.vo.MSSqlSourceSyncStrategy` *)* MSSQL
    ...
    def is_dirty(self):
        return any([self._validated_sync_mode[1], self._shared_backup_locations[1], self._mssql_netbackup_config[1], self._mssql_commvault_config[1]])
    ...
    def mssql_netbackup_config(self):
        ...
        :rtype: :py:class:`v1_11_10.web.vo.MSSqlNetbackupConfig`
        """
    ...
    def mssql_commvault_config(self):
        ...
        :rtype: :py:class:`v1_11_10.web.vo.MSSqlCommvaultConfig`
        """
