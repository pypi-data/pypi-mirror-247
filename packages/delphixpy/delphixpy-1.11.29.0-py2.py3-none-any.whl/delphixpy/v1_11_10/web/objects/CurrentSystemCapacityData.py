...
from delphixpy.v1_11_10.web.objects.BaseSystemCapacityData import BaseSystemCapacityData
...
class CurrentSystemCapacityData(BaseSystemCapacityData):
    """
    *(extends* :py:class:`v1_11_10.web.vo.BaseSystemCapacityData` *)* Capacity
