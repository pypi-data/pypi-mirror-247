...
from delphixpy.v1_11_10.web.objects.OracleCustomEnvVarPair import OracleCustomEnvVarPair
...
class OracleCustomEnvVarRACPair(OracleCustomEnvVarPair):
    """
    *(extends* :py:class:`v1_11_10.web.vo.OracleCustomEnvVarPair` *)* Dictates
