...
from delphixpy.v1_11_10.web.objects.AbstractVaultCredential import AbstractVaultCredential
...
class CyberArkVaultCredential(AbstractVaultCredential):
    """
    *(extends* :py:class:`v1_11_10.web.vo.AbstractVaultCredential` *)* The
