...
class JSBranchCreateParameters(TypedObject):
    ...
    *(extends* :py:class:`v1_11_10.web.vo.TypedObject` *)* The parameters used
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "data_container" == "type" or (self.data_container is not self.__undef__ and (not (dirty and not self._data_container[1]) or self.is_dirty_list(self.data_container, self._data_container) or belongs_to_parent)):
    ...
    def timeline_point_parameters(self):
        ...
        :rtype: :py:class:`v1_11_10.web.vo.JSTimelinePointParameters`
        """
