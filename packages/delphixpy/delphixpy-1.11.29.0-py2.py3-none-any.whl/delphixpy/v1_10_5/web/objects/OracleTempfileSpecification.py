...
from delphixpy.v1_10_5.web.objects.OracleDatafileTempfileSpecification import OracleDatafileTempfileSpecification
...
class OracleTempfileSpecification(OracleDatafileTempfileSpecification):
    """
    *(extends* :py:class:`v1_10_5.web.vo.OracleDatafileTempfileSpecification`
