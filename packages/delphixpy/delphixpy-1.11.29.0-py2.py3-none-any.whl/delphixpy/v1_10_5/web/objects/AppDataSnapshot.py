...
class AppDataSnapshot(TimeflowSnapshot):
    """
    *(extends* :py:class:`v1_10_5.web.vo.TimeflowSnapshot` *)* Snapshot of an
    AppData TimeFlow.
    """
    ...
    def first_change_point(self):
        ...
        :rtype: :py:class:`v1_10_5.web.vo.AppDataTimeflowPoint`
        """
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_10_5.web.vo.AppDataSnapshotRuntime`
        """
