...
from delphixpy.v1_10_5.web.objects.JSTimelinePointParameters import JSTimelinePointParameters
...
class JSTimelinePointBookmarkInput(JSTimelinePointParameters):
    """
    *(extends* :py:class:`v1_10_5.web.vo.JSTimelinePointParameters` *)*
