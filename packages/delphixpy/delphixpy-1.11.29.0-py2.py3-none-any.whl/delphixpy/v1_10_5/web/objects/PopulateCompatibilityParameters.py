...
from delphixpy.v1_10_5.web.objects.CompatibleRepositoriesParameters import CompatibleRepositoriesParameters
...
class PopulateCompatibilityParameters(CompatibleRepositoriesParameters):
    """
    *(extends* :py:class:`v1_10_5.web.vo.CompatibleRepositoriesParameters` *)*
