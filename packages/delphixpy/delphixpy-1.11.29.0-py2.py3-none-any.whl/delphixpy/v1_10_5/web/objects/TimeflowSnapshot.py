...
class TimeflowSnapshot(ReadonlyNamedUserObject):
    """
    *(extends* :py:class:`v1_10_5.web.vo.ReadonlyNamedUserObject` *)* Snapshot
    ...
    def first_change_point(self):
        ...
        :rtype: :py:class:`v1_10_5.web.vo.TimeflowPoint`
        """
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_10_5.web.vo.SnapshotRuntime`
        """
