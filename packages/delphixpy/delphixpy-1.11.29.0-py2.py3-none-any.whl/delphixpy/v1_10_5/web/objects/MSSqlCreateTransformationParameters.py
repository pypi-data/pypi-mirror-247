...
from delphixpy.v1_10_5.web.objects.CreateTransformationParameters import CreateTransformationParameters
...
class MSSqlCreateTransformationParameters(CreateTransformationParameters):
    """
    *(extends* :py:class:`v1_10_5.web.vo.CreateTransformationParameters` *)*
    ...
    def container(self):
        ...
        :rtype: :py:class:`v1_10_5.web.vo.MSSqlDatabaseContainer`
        """
