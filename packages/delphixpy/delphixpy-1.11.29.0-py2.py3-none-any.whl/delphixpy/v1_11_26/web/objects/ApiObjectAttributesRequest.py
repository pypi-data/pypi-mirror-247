...
class ApiObjectAttributesRequest(TypedObject):
    """
    *(extends* :py:class:`v1_11_26.web.vo.TypedObject` *)* Types of API user
    objects and attribute names requested.
    """
    def __init__(self, undef_enabled=True):
        super().__init__()
        self._type = ("ApiObjectAttributesRequest", True)
        self._types = (self.__undef__, True)
        self._extra_attributes = (self.__undef__, True)
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if "extraAttributes" not in data:
            raise ValueError("Missing required property \"extraAttributes\".")
        obj._extra_attributes = []
        for item in data.get("extraAttributes") or []:
            obj._extra_attributes.append(factory.create_object(item))
            factory.validate_type(obj._extra_attributes[-1], "ApiObjectExtraAttributes")
        obj._extra_attributes = (obj._extra_attributes, dirty)
        return obj
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "extra_attributes" == "type" or (self.extra_attributes is not self.__undef__ and (not (dirty and not self._extra_attributes[1]) or self.is_dirty_list(self.extra_attributes, self._extra_attributes) or belongs_to_parent)):
            dct["extraAttributes"] = dictify(self.extra_attributes, prop_is_list_or_vo=True)
        return dct
    ...
    def force_dirty(self):
        ...
        self._extra_attributes = (self._extra_attributes[0], True)

    def is_dirty(self):
        return any([self._types[1], self._extra_attributes[1]])
    ...
    def extra_attributes(self):
        """
        Map from types to list of additional attributes to retrieve.

        :rtype: ``list`` of
            :py:class:`v1_11_26.web.vo.ApiObjectExtraAttributes`
        """
        return self._extra_attributes[0]

    @extra_attributes.setter
    def extra_attributes(self, value):
        self._extra_attributes = (value, True)
