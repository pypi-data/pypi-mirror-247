...
from delphixpy.v1_11_26.web.objects.SnapshotRuntime import SnapshotRuntime
...
class OracleSnapshotRuntime(SnapshotRuntime):
    """
    *(extends* :py:class:`v1_11_26.web.vo.SnapshotRuntime` *)* Runtime (non-
    ...
    def missing_logs(self):
        ...
        :rtype: ``list`` of :py:class:`v1_11_26.web.vo.OracleLog`
        """
