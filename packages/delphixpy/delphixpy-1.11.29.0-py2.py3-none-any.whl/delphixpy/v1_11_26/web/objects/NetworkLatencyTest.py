...
from delphixpy.v1_11_26.web.objects.NetworkTest import NetworkTest
...
class NetworkLatencyTest(NetworkTest):
    """
    *(extends* :py:class:`v1_11_26.web.vo.NetworkTest` *)* Round-trip latency
    ...
    def parameters(self):
        ...
        :rtype: :py:class:`v1_11_26.web.vo.NetworkLatencyTestParameters`
        """
