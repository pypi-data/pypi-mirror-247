...
from delphixpy.v1_11_26.web.objects.Operation import Operation
...
class SourceOperation(Operation):
    """
    *(extends* :py:class:`v1_11_26.web.vo.Operation` *)* A user-specifiable
    ...
    def credentials_env_vars_list(self):
        ...
        :rtype: ``list`` of :py:class:`v1_11_26.web.vo.CredentialsEnvVars`
        """
