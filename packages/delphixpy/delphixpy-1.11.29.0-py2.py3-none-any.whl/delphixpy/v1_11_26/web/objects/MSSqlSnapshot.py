...
class MSSqlSnapshot(TimeflowSnapshot):
    """
    *(extends* :py:class:`v1_11_26.web.vo.TimeflowSnapshot` *)* Provisionable
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_11_26.web.vo.MSSqlSnapshotRuntime`
        """
    ...
    def additional_database_parameters(self):
        ...
        :rtype: :py:class:`v1_11_26.web.vo.MSSqlAdditionalDatabaseParameters`
        """
