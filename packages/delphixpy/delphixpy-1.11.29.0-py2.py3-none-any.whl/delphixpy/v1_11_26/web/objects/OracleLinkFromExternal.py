...
from delphixpy.v1_11_26.web.objects.OracleBaseExternalLinkData import OracleBaseExternalLinkData
...
class OracleLinkFromExternal(OracleBaseExternalLinkData):
    """
    *(extends* :py:class:`v1_11_26.web.vo.OracleBaseExternalLinkData` *)*
