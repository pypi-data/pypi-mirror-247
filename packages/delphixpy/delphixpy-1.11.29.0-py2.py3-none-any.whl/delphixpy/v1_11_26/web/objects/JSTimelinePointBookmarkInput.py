...
from delphixpy.v1_11_26.web.objects.JSTimelinePointParameters import JSTimelinePointParameters
...
class JSTimelinePointBookmarkInput(JSTimelinePointParameters):
    """
    *(extends* :py:class:`v1_11_26.web.vo.JSTimelinePointParameters` *)*
