...
from delphixpy.v1_11_26.web.objects.NetworkTestParameters import NetworkTestParameters
...
class NetworkLatencyTestParameters(NetworkTestParameters):
    """
    *(extends* :py:class:`v1_11_26.web.vo.NetworkTestParameters` *)* Parameters
