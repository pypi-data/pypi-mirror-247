...
from delphixpy.v1_11_26.web.objects.BaseConsumerCapacityData import BaseConsumerCapacityData
...
class CurrentConsumerCapacityData(BaseConsumerCapacityData):
    """
    *(extends* :py:class:`v1_11_26.web.vo.BaseConsumerCapacityData` *)* Current
