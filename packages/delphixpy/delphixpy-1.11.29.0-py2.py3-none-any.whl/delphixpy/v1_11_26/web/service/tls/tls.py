...
Package "service.tls"
"""
from delphixpy.v1_11_26.web.service.tls import caCertificate
...
def get(engine):
    ...
    :rtype: :py:class:`v1_11_26.web.vo.CertificateConfig`
    """
...
def set(engine, certificate_config=None):
    ...
    :type certificate_config: :py:class:`v1_11_26.web.vo.CertificateConfig`
    """
    url = "/resources/json/delphix/service/tls"
