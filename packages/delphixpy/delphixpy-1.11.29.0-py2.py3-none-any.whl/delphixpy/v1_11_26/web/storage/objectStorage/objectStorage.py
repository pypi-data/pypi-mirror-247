...
def get(engine):
    ...
    :rtype: :py:class:`v1_11_26.web.vo.ObjectStore`
    """
...
def set(engine, object_store=None):
    ...
    :type object_store: :py:class:`v1_11_26.web.vo.ObjectStore`
    """
    url = "/resources/json/delphix/storage/objectStorage"
...
def test_connection(engine, object_store_test):
    ...
    :type object_store_test: :py:class:`v1_11_26.web.vo.ObjectStoreTest`
    """
