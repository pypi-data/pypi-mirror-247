...
def create(engine, iscsi_target=None):
    ...
    :type iscsi_target: :py:class:`v1_11_26.web.vo.IscsiTarget`
    :rtype: ``str``
    """
...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_11_26.web.objects.IscsiTarget.IscsiTarget`
        object
    :type ref: ``str``
    :rtype: :py:class:`v1_11_26.web.vo.IscsiTarget`
    """
...
def get_all(engine):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_11_26.delphix_engine.DelphixEngine`
    :rtype: ``list`` of :py:class:`v1_11_26.web.vo.IscsiTarget`
    """
    url = "/resources/json/delphix/storage/iscsi/target"
    response = engine.get(url)
    result = response_validator.validate(response, engine)
...
def discover(engine, iscsi_target_discover_parameters):
    ...
    :type iscsi_target_discover_parameters:
        :py:class:`v1_11_26.web.vo.IscsiTargetDiscoverParameters`
    :rtype: ``list`` of ``str``
    """
