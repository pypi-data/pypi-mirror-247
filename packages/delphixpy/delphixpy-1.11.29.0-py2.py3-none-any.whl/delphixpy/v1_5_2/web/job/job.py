...
def get(engine, ref):
    ...
    :param ref: Reference to a :py:class:`delphixpy.v1_5_2.web.objects.Job.Job`
        object
    :type ref: ``str``
    :rtype: :py:class:`v1_5_2.web.vo.Job`
    """
...
def get_all(engine, add_events=None, from_date=None, job_state=None, page_offset=None, page_size=None, target=None, to_date=None):
    ...
    :type to_date: ``str``
    :rtype: ``list`` of :py:class:`v1_5_2.web.vo.Job`
    """
...
def update(engine, ref, job=None):
    ...
    :type job: :py:class:`v1_5_2.web.vo.Job`
    """
    url = "/resources/json/delphix/job/%s" % ref
