...
from delphixpy.v1_5_2.web.objects.JSTimelinePointTimeParameters import JSTimelinePointTimeParameters
...
class JSTimelinePointTimeInput(JSTimelinePointTimeParameters):
    """
    *(extends* :py:class:`v1_5_2.web.vo.JSTimelinePointTimeParameters` *)*
    Specifies a point in time on the Jet Stream timeline for a specific data
    layout. Latest provisionable points before the specified time will be used.
    """
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._source_data_layout[0] is not None and obj._source_data_layout[0] is not obj.__undef__:
            assert isinstance(obj._source_data_layout[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._source_data_layout[0], type(obj._source_data_layout[0])))
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        def dictify(obj, prop_is_list_or_vo=False):
            if isinstance(obj, list):
                ...
                return obj
        if "source_data_layout" == "type" or (self.source_data_layout is not self.__undef__ and (not (dirty and not self._source_data_layout[1]) or self.is_dirty_list(self.source_data_layout, self._source_data_layout) or belongs_to_parent)):
    ...
    def is_dirty(self):
        return any([self._source_data_layout[1], self._time[1]])
    ...
    def __eq__(self, other):
        ...
        return super().__eq__(other) and \
               self.source_data_layout == other.source_data_layout and \
    ...
    def time(self):
        """
        A point in time on the data layout's timeline.
