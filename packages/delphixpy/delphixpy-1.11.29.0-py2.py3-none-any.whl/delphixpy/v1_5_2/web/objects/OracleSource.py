...
from delphixpy.v1_5_2.web.objects.Source import Source
...
class OracleSource(Source):
    """
    *(extends* :py:class:`v1_5_2.web.vo.Source` *)* An Oracle source.
    """
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_5_2.web.vo.OracleBaseSourceRuntime`
        """
