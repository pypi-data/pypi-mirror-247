...
from delphixpy.v1_5_2.web.objects.CompatibleRepositoriesParameters import CompatibleRepositoriesParameters
...
class XPPCompatibilityParameters(CompatibleRepositoriesParameters):
    """
    *(extends* :py:class:`v1_5_2.web.vo.CompatibleRepositoriesParameters` *)*
