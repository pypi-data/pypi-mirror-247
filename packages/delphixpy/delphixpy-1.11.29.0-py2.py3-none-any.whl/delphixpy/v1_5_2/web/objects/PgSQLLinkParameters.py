...
class PgSQLLinkParameters(LinkParameters):
    """
    *(extends* :py:class:`v1_5_2.web.vo.LinkParameters` *)* PostgreSQL specific
    ...
    def container(self):
        ...
        :rtype: :py:class:`v1_5_2.web.vo.PgSQLDatabaseContainer`
        """
    ...
    def source(self):
        ...
        :rtype: :py:class:`v1_5_2.web.vo.PgSQLLinkedSource`
        """
