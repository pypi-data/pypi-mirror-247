...
from delphixpy.v1_5_2.web.objects.VirtualDatasetCreationParameters import VirtualDatasetCreationParameters
...
class ProvisionParameters(VirtualDatasetCreationParameters):
    """
    *(extends* :py:class:`v1_5_2.web.vo.VirtualDatasetCreationParameters` *)*
