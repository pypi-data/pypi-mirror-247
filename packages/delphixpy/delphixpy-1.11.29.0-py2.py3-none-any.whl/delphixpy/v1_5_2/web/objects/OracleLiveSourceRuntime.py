...
from delphixpy.v1_5_2.web.objects.OracleBaseSourceRuntime import OracleBaseSourceRuntime
...
class OracleLiveSourceRuntime(OracleBaseSourceRuntime):
    """
    *(extends* :py:class:`v1_5_2.web.vo.OracleBaseSourceRuntime` *)* Runtime
