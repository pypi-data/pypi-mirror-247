...
from delphixpy.v1_5_2.web.objects.TimeflowSnapshot import TimeflowSnapshot
...
class MySQLSnapshot(TimeflowSnapshot):
    """
    *(extends* :py:class:`v1_5_2.web.vo.TimeflowSnapshot` *)* Provisionable
    ...
    def is_dirty(self):
        return any([self._first_change_point[1], self._internal_version[1], self._latest_change_point[1], self._runtime[1]])
    ...
    def first_change_point(self):
        ...
        :rtype: :py:class:`v1_5_2.web.vo.MySQLTimeflowPoint`
        """
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_5_2.web.vo.MySQLSnapshotRuntime`
        """
