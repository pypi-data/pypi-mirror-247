...
from delphixpy.v1_5_2.web.objects.TimeflowPointParameters import TimeflowPointParameters
...
class TimeflowPointTimestamp(TimeflowPointParameters):
    """
    *(extends* :py:class:`v1_5_2.web.vo.TimeflowPointParameters` *)* TimeFlow
