...
class ToolkitParameter(TypedObject):
    """
    *(extends* :py:class:`v1_5_2.web.vo.TypedObject` *)* Specifies input
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._environment_variable[0] is not None and obj._environment_variable[0] is not obj.__undef__:
            assert isinstance(obj._environment_variable[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._environment_variable[0], type(obj._environment_variable[0])))
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "environment_variable" == "type" or (self.environment_variable is not self.__undef__ and (not (dirty and not self._environment_variable[1]) or self.is_dirty_list(self.environment_variable, self._environment_variable) or belongs_to_parent)):
    ...
    def parameter(self):
        ...
        :rtype: :py:class:`v1_5_2.web.vo.DynamicParameter`
        """
