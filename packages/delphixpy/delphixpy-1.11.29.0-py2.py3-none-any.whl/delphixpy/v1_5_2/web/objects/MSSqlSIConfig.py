...
from delphixpy.v1_5_2.web.objects.MSSqlDBConfig import MSSqlDBConfig
...
class MSSqlSIConfig(MSSqlDBConfig):
    """
    *(extends* :py:class:`v1_5_2.web.vo.MSSqlDBConfig` *)* Configuration
    ...
    def instance(self):
        ...
        :rtype: :py:class:`v1_5_2.web.vo.MSSqlInstanceConfig`
        """
