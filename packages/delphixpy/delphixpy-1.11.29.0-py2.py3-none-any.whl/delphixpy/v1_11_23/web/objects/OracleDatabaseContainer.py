...
from delphixpy.v1_11_23.web.objects.DatabaseContainer import DatabaseContainer
...
class OracleDatabaseContainer(DatabaseContainer):
    """
    *(extends* :py:class:`v1_11_23.web.vo.DatabaseContainer` *)* Data container
    ...
    def __init__(self, undef_enabled=True):
        ...
        self._rac_max_instance_lag = (self.__undef__, True)
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._content_type[0] is not None and obj._content_type[0] is not obj.__undef__:
            assert isinstance(obj._content_type[0], str), ("Expected one of ['string'], but got %s of type %s" % (obj._content_type[0], type(obj._content_type[0])))
        ...
        obj._rac_max_instance_lag = (data.get("racMaxInstanceLag", obj.__undef__), dirty)
        if obj._rac_max_instance_lag[0] is not None and obj._rac_max_instance_lag[0] is not obj.__undef__:
            assert isinstance(obj._rac_max_instance_lag[0], int), ("Expected one of ['integer'], but got %s of type %s" % (obj._rac_max_instance_lag[0], type(obj._rac_max_instance_lag[0])))
            common.validate_format(obj._rac_max_instance_lag[0], "None", None, None)
        return obj
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "performance_mode" == "type" or (self.performance_mode is not self.__undef__ and (not (dirty and not self._performance_mode[1]) or self.is_dirty_list(self.performance_mode, self._performance_mode) or belongs_to_parent)):
        ...
        if "rac_max_instance_lag" == "type" or (self.rac_max_instance_lag is not self.__undef__ and (not (dirty and not self._rac_max_instance_lag[1]) or self.is_dirty_list(self.rac_max_instance_lag, self._rac_max_instance_lag) or belongs_to_parent)):
            dct["racMaxInstanceLag"] = dictify(self.rac_max_instance_lag)
        elif belongs_to_parent and self.rac_max_instance_lag is self.__undef__:
            dct["racMaxInstanceLag"] = 3
        return dct
    ...
    def force_dirty(self):
        ...
        self._rac_max_instance_lag = (self._rac_max_instance_lag[0], True)

    def is_dirty(self):
        return any([self._diagnose_no_logging_faults[1], self._runtime[1], self._pre_provisioning_enabled[1], self._sourcing_policy[1], self._physical_standby[1], self._live_source[1], self._content_type[1], self._performance_mode[1], self._rac_max_instance_lag[1]])
    ...
    def __eq__(self, other):
        ...
        return super().__eq__(other) and \
               ...
               self.rac_max_instance_lag == other.rac_max_instance_lag
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_11_23.web.vo.OracleDBContainerRuntime`
        """
    ...
    def sourcing_policy(self):
        ...
        :rtype: :py:class:`v1_11_23.web.vo.OracleBaseSourcingPolicy`
        """
    ...
    @property
    def rac_max_instance_lag(self):
        """
        *(default value: 3)* Maximum number of log sequences that a node can
        lag behind on RAC before considering instance offline.

        :rtype: ``int``
        """
        return self._rac_max_instance_lag[0]

    @rac_max_instance_lag.setter
    def rac_max_instance_lag(self, value):
        self._rac_max_instance_lag = (value, True)
