...
from delphixpy.v1_11_23.web.objects.OracleBaseSourceRuntime import OracleBaseSourceRuntime
...
class OracleLiveSourceRuntime(OracleBaseSourceRuntime):
    """
    *(extends* :py:class:`v1_11_23.web.vo.OracleBaseSourceRuntime` *)* Runtime
