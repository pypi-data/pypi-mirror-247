...
#     /delphix-azure-vault-test-parameters.json
#
# Do not edit this file manually!
#

from delphixpy.v1_11_23.web.objects.PasswordVaultTestParameters import PasswordVaultTestParameters
...
class AzureVaultTestParameters(PasswordVaultTestParameters):
    """
    *(extends* :py:class:`v1_11_23.web.vo.PasswordVaultTestParameters` *)*
    Azure password vault test configuration.
    """
    def __init__(self, undef_enabled=True):
        super().__init__()
        self._type = ("AzureVaultTestParameters", True)
    ...
    def __eq__(self, other):
        if other is None:
            return False
        if not isinstance(other, AzureVaultTestParameters):
            return False
    ...
    def azure_authentication(self):
        ...
        :rtype: :py:class:`v1_11_23.web.vo.AzureAuthentication`
        """
