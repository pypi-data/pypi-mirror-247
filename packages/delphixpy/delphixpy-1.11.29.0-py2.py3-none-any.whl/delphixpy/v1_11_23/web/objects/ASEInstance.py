...
from delphixpy.v1_11_23.web.objects.SourceRepository import SourceRepository
...
class ASEInstance(SourceRepository):
    """
    *(extends* :py:class:`v1_11_23.web.vo.SourceRepository` *)* The SAP ASE
    source repository.
    """
    ...
    def is_dirty(self):
        return any([self._instance_name[1], self._installation_path[1], self._ports[1], self._instance_owner[1], self._instance_owner_uid[1], self._instance_owner_gid[1], self._page_size[1], self._service_principal_name[1], self._db_user[1], self._isql_path[1], self._dump_history_file[1], self._credentials[1], self._discovered[1]])
