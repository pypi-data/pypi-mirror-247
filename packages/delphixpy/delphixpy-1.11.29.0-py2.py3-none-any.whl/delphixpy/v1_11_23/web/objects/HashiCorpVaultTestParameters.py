...
from delphixpy.v1_11_23.web.objects.HostedVaultTestParameters import HostedVaultTestParameters
...
class HashiCorpVaultTestParameters(HostedVaultTestParameters):
    """
    *(extends* :py:class:`v1_11_23.web.vo.HostedVaultTestParameters` *)*
