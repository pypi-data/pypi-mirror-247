...
from delphixpy.v1_11_23.web.objects.Datapoint import Datapoint
...
class CpuUtilDatapoint(Datapoint):
    """
    *(extends* :py:class:`v1_11_23.web.vo.Datapoint` *)* An analytics datapoint
    ...
    def is_dirty(self):
        return any([self._idle[1], self._kernel[1], self._user[1]])
