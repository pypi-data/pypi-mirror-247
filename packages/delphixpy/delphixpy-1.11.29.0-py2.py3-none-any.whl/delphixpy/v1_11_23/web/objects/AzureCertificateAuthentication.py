...
#     /delphix-azure-certificate-authentication.json
#
...
class AzureCertificateAuthentication(AzureAuthentication):
    """
    *(extends* :py:class:`v1_11_23.web.vo.AzureAuthentication` *)* Client
    certificate for authenticating to an Azure vault.
    """
    def __init__(self, undef_enabled=True):
        super().__init__()
        self._type = ("AzureCertificateAuthentication", True)
    ...
    def is_dirty(self):
        return any([self._client_certificate[1]])
    ...
    def __eq__(self, other):
        if other is None:
            return False
        if not isinstance(other, AzureCertificateAuthentication):
            return False
    ...
    def client_certificate(self):
        ...
        :rtype: :py:class:`v1_11_23.web.vo.ClientCertificate`
        """
