...
from delphixpy.v1_11_3.web.objects.JSDataLayoutCreateParameters import JSDataLayoutCreateParameters
...
class JSDataContainerCreateParameters(JSDataLayoutCreateParameters):
    """
    *(extends* :py:class:`v1_11_3.web.vo.JSDataLayoutCreateParameters` *)* The
