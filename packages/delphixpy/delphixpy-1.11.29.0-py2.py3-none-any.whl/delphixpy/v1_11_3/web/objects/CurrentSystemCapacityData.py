...
from delphixpy.v1_11_3.web.objects.BaseSystemCapacityData import BaseSystemCapacityData
...
class CurrentSystemCapacityData(BaseSystemCapacityData):
    """
    *(extends* :py:class:`v1_11_3.web.vo.BaseSystemCapacityData` *)* Capacity
