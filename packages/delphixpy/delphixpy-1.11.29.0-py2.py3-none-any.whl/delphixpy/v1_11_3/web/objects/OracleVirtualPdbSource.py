...
from delphixpy.v1_11_3.web.objects.OracleVirtualSource import OracleVirtualSource
...
class OracleVirtualPdbSource(OracleVirtualSource):
    """
    *(extends* :py:class:`v1_11_3.web.vo.OracleVirtualSource` *)* A virtual
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._parent_tde_keystore_path[0] is not None and obj._parent_tde_keystore_path[0] is not obj.__undef__:
            ...
            common.validate_format(obj._parent_tde_keystore_path[0], "unixpath", None, 512)
        return obj
    ...
    def is_dirty(self):
        return any([self._archivelog_mode[1], self._config_params[1], self._config_template[1], self._node_listeners[1], self._redo_log_size_in_mb[1], self._redo_log_groups[1], self._parent_tde_keystore_path[1]])
    ...
    def __eq__(self, other):
        ...
        return super().__eq__(other) and \
               ...
               self.parent_tde_keystore_path == other.parent_tde_keystore_path
