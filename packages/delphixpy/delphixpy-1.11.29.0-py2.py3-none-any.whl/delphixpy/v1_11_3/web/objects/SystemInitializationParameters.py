...
class SystemInitializationParameters(TypedObject):
    """
    *(extends* :py:class:`v1_11_3.web.vo.TypedObject` *)* Parameters used for
    ...
    def is_dirty(self):
        return any([self._default_user[1], self._default_password[1], self._default_email[1], self._devices[1]])
