...
def create(engine, database_template=None):
    ...
    :type database_template: :py:class:`v1_11_2.web.vo.DatabaseTemplate`
    :rtype: ``str``
    """
...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_11_2.web.objects.DatabaseTemplate.DatabaseTempl
        ate` object
    :type ref: ``str``
    :rtype: :py:class:`v1_11_2.web.vo.DatabaseTemplate`
    """
...
def get_all(engine):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_11_2.delphix_engine.DelphixEngine`
    :rtype: ``list`` of :py:class:`v1_11_2.web.vo.DatabaseTemplate`
    """
    url = "/resources/json/delphix/database/template"
    response = engine.get(url)
    result = response_validator.validate(response, engine)
...
def config(engine):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_11_2.delphix_engine.DelphixEngine`
    :rtype: ``list`` of :py:class:`v1_11_2.web.vo.DatabaseTemplateConfig`
    """
