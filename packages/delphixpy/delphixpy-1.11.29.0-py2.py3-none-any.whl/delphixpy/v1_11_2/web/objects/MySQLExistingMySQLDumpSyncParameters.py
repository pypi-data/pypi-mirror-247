...
from delphixpy.v1_11_2.web.objects.MySQLExistingBackupSyncParameters import MySQLExistingBackupSyncParameters
...
class MySQLExistingMySQLDumpSyncParameters(MySQLExistingBackupSyncParameters):
    """
    *(extends* :py:class:`v1_11_2.web.vo.MySQLExistingBackupSyncParameters` *)*
