...
class OracleBaseLinkData(LinkData):
    """
    *(extends* :py:class:`v1_11_2.web.vo.LinkData` *)* Represents common
    ...
    def sync_parameters(self):
        ...
        :rtype: :py:class:`v1_11_2.web.vo.OracleSyncParameters`
        """
