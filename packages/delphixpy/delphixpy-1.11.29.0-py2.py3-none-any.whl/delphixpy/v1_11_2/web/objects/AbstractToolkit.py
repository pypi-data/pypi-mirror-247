...
class AbstractToolkit(NamedUserObject):
    """
    *(extends* :py:class:`v1_11_2.web.vo.NamedUserObject` *)* An installed
    toolkit.
    """
    ...
    def build_api(self):
        ...
        :rtype: :py:class:`v1_11_2.web.vo.APIVersion`
        """
    ...
    def messages(self):
        ...
        :rtype: ``list`` of :py:class:`v1_11_2.web.vo.ToolkitLocale`
        """
