...
from delphixpy.v1_11_2.web.objects.VMwareSource import VMwareSource
...
class VMwareVirtualSource(VMwareSource):
    """
    *(extends* :py:class:`v1_11_2.web.vo.VMwareSource` *)* A virtual VMware
    source.
    """
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_11_2.web.vo.VMwareSourceRuntime`
        """
