...
class OracleBaseProvisionParameters(ProvisionParameters):
    """
    *(extends* :py:class:`v1_11_2.web.vo.ProvisionParameters` *)* Parameters
    ...
    def container(self):
        ...
        :rtype: :py:class:`v1_11_2.web.vo.OracleDatabaseContainer`
        """
    ...
    def source_config(self):
        ...
        :rtype: :py:class:`v1_11_2.web.vo.OracleBaseDBConfig`
        """
