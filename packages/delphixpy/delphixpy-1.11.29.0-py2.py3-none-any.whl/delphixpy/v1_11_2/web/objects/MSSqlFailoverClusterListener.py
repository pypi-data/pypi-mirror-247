...
from delphixpy.v1_11_2.web.objects.MSSqlBaseClusterListener import MSSqlBaseClusterListener
...
class MSSqlFailoverClusterListener(MSSqlBaseClusterListener):
    """
    *(extends* :py:class:`v1_11_2.web.vo.MSSqlBaseClusterListener` *)* The
