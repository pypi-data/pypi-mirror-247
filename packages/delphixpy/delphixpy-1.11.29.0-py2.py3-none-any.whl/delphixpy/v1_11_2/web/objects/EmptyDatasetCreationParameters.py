...
from delphixpy.v1_11_2.web.objects.VirtualDatasetCreationParameters import VirtualDatasetCreationParameters
...
class EmptyDatasetCreationParameters(VirtualDatasetCreationParameters):
    """
    *(extends* :py:class:`v1_11_2.web.vo.VirtualDatasetCreationParameters` *)*
