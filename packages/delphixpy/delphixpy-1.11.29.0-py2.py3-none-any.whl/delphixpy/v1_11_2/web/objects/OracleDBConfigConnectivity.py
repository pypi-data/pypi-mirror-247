...
from delphixpy.v1_11_2.web.objects.AbstractSourceConfigConnectivity import AbstractSourceConfigConnectivity
...
class OracleDBConfigConnectivity(AbstractSourceConfigConnectivity):
    """
    *(extends* :py:class:`v1_11_2.web.vo.AbstractSourceConfigConnectivity` *)*
