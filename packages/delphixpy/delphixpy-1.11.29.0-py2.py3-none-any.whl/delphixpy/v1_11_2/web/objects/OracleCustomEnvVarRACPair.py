...
from delphixpy.v1_11_2.web.objects.OracleCustomEnvVarPair import OracleCustomEnvVarPair
...
class OracleCustomEnvVarRACPair(OracleCustomEnvVarPair):
    """
    *(extends* :py:class:`v1_11_2.web.vo.OracleCustomEnvVarPair` *)* Dictates a
