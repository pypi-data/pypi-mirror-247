...
def create(engine, saml_service_provider=None):
    ...
    :type saml_service_provider: :py:class:`v1_8_1.web.vo.SamlServiceProvider`
    :rtype: ``str``
    """
...
def get(engine, ref):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_8_1.delphix_engine.DelphixEngine`
    :param ref: Reference to a :py:class:`delphixpy.v1_8_1.web.objects.SamlServ
        iceProvider.SamlServiceProvider` object
    :type ref: ``str``
    :rtype: :py:class:`v1_8_1.web.vo.SamlServiceProvider`
    """
...
def get_all(engine):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_8_1.delphix_engine.DelphixEngine`
    :rtype: ``list`` of :py:class:`v1_8_1.web.vo.SamlServiceProvider`
    """
    url = "/resources/json/delphix/service/saml/serviceprovider"
    response = engine.get(url)
    result = response_validator.validate(response, engine)
...
def saml_authn_request(engine, saml_auth_parameters=None):
    ...
    :type saml_auth_parameters: :py:class:`v1_8_1.web.vo.SamlAuthParameters`
    :rtype: ``str``
    """
