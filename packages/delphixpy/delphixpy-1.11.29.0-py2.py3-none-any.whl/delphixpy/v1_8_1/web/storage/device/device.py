...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_8_1.web.objects.StorageDevice.StorageDevice`
        object
    :type ref: ``str``
    :rtype: :py:class:`v1_8_1.web.vo.StorageDevice`
    """
...
def get_all(engine):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_8_1.delphix_engine.DelphixEngine`
    :rtype: ``list`` of :py:class:`v1_8_1.web.vo.StorageDevice`
    """
...
def remove_verify(engine, ref):
    ...
    :param ref: Reference to a
        ...
        object
    :type ref: ``str``
    :rtype: :py:class:`v1_8_1.web.vo.StorageDeviceRemovalVerifyResult`
    """
...
def initialize(engine, storage_initialization_parameters):
    """
    Initialize storage on the data node.

    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_8_1.delphix_engine.DelphixEngine`
    :param storage_initialization_parameters: Payload object.
    :type storage_initialization_parameters:
        :py:class:`v1_8_1.web.vo.StorageInitializationParameters`
    """
    url = "/resources/json/delphix/storage/device/initialize"
    response = engine.post(url, storage_initialization_parameters.to_dict(dirty=True) if storage_initialization_parameters else None)
    result = response_validator.validate(response, engine)
    raw_result = getattr(engine, 'raw_result', False)
    return response_validator.parse_result(result, undef_enabled=True, return_types=None, returns_list=None, raw_result=raw_result)
