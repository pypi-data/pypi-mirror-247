...
class MSSqlLinkData(LinkData):
    ...
    *(extends* :py:class:`v1_8_1.web.vo.LinkData` *)* MSSQL specific parameters
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "delphix_managed" == "type" or (self.delphix_managed is not self.__undef__ and (not (dirty and not self._delphix_managed[1]) or self.is_dirty_list(self.delphix_managed, self._delphix_managed) or belongs_to_parent)):
