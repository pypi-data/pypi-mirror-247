from qianqiuyun.sdk import util
import influxdb_client                                      # influxdb2.*
from influxdb_client.client.write_api import SYNCHRONOUS    # influxdb2.*
from influxdb import InfluxDBClient


_globalorg = util.get_env('ENV_TSDB_ORG', "qianqiu") 
_globalusername = util.get_env('ENV_TSDB_USERNAME', "root") 
_globalpassword = util.get_env('ENV_TSDB_PASSWORD', "qianqiu@#20222")
_globalurl = util.get_env('ENV_TSDB_URL', "http://" + util.get_host_with_ns('influxdb') + ":8086") 
