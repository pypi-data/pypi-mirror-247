...
**gemseo-fmu** depends on software with compatible
...
**gemseo-fmu** source code includes software with
compatible licenses that are listed below.

# External application

Some external applications are used by **gemseo-fmu**,
...
Some icons and fonts are used by **gemseo-fmu** or its documentation.
