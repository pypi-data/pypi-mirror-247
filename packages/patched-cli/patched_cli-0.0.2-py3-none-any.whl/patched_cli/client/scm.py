...
class ScmPlatformClientProtocol(Protocol):
    ...
    def create_pr(self, slug: str, title: str, body: str, original_branch: str, feature_branch: str
                  ) -> PullRequestProtocol:
        ...
...
class GithubClient:
    ...
    def find_pr(self, slug, original_branch: str, feature_branch: str) -> PullRequestProtocol | None:
        ...
        return GithubPullRequest(page[0])
...
class GitlabClient:
    ...
    def create_pr(self, slug: str, title: str, body: str, original_branch: str,
                  feature_branch: str) -> PullRequestProtocol:
...
class GitlabClientClickType(click.ParamType):
    name = ""
