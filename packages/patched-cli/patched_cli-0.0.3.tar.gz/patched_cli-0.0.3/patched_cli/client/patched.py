...
class PatchedClient(click.ParamType):
    ...
    def __init__(self, url: str, access_token: str):
        ...
        self.client = httpx.Client(base_url=url,
                                   ...
                                   limits=httpx.Limits(max_keepalive_connections=None, max_connections=100, keepalive_expiry=None),
    ...
    def test_token(self) -> bool:
        try:
            response = self.client.post("/token/test", json={})
        ...
        return not response.is_error and response.json()["msg"] == "ok"
    ...
    def create_pr(self, repo_slug: str, path: str, diff_text: str, original_branch: str, next_branch: str,
        ...
        response = self.client.post("/create_pr",
