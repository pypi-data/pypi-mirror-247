...
class OculusTouch:
    ...
    def Sleep(self, length: float = 0.1) -> None:
        """Calls `time.sleep()`. Useful for sleeping between polls.
    ...
    def Reached(self, axis: OculusTouchAxisEnum, value: float) -> int:
        """Returns whether a specified axis has reached a specified threshold value in between the last poll.
    ...
    def GetTouchDownList(self) -> list[OculusTouchButtonEnum]:
        ...
        Returns:
            list[OculusTouchButtonEnum]: List of buttons currently being touched.
        """
    ...
    def GetTouchPressedList(self) -> list[OculusTouchButtonEnum]:
        ...
        Returns:
            list[OculusTouchButtonEnum]: List of buttons whose capacitors were touched.
        """
    ...
    def GetTouchReleasedList(self) -> list[OculusTouchButtonEnum]:
        ...
        Returns:
            list[OculusTouchButtonEnum]: List of buttons whose capacitors were released.
        """
