...
-   `make` (default: 'center') (type: str[auto]) : Make the string printed with the center `center` or to the right `right`
...
1.2.6
-----
-   Updated the progress bar function and changed it to OOP form and not a generator
-   Updated justify function
-   Class (OOP) function naming now begins with Init_
-   New module `textwrap`
-   Bugs fixed
