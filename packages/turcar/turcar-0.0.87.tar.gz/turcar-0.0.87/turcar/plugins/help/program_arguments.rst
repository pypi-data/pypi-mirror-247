...
When you are editing *my_program.py* and press F5, turcar constructs a magic command
``%Run my_program.py`` and sends it to the shell, which asks turcar's back-end to run
that script.
