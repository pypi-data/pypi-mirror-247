...
but this may intimidate some beginners. turcar tries make things easeir and allows running Flask programs
...
Details
-------
turcar will start the development server approximately like this:
...
``threaded=False`` is used because turcar's debugger supports only single-threaded programs,
...
In this case turcar won't add anything to your code.
