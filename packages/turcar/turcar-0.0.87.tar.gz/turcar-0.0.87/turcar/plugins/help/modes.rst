Different modes
===============
*Tools → Options → General* allows switching turcar's user interface to one of three different modes.
...
* View menu gets an extra item *Full screen* which puts turcar to full screen.
