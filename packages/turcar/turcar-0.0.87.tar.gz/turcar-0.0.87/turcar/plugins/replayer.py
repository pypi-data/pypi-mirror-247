...
from turcar import turcar_USER_DIR, codeview, get_workbench, ui_utils
from turcar.base_file_browser import BaseLocalFileBrowser
from turcar.languages import tr
from turcar.plugins.coloring import SyntaxColorer
from turcar.ui_utils import CommonDialog, lookup_style_option
...
class ReplayerFileBrowser(BaseLocalFileBrowser):
    def __init__(self, master, log_frame):
        ...
        user_logs_path = os.path.join(turcar_USER_DIR, "user_logs")
