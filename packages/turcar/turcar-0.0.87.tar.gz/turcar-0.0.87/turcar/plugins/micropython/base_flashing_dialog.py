...
from turcar.ui_utils import AdvancedLabel, MappingCombobox, set_text_if_different
from turcar.workdlg import WorkDialog
...
class BaseFlashingDialog(WorkDialog, ABC):
    ...
    def start_work(self):
        from turcar.plugins.micropython import BareMetalMicroPythonProxy
