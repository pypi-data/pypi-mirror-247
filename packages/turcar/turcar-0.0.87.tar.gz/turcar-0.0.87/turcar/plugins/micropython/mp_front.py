...
from turcar import get_runner, get_shell, get_workbench, running, ui_utils
from turcar.common import CommandToBackend, EOFCommand, ImmediateCommand, InlineCommand
from turcar.languages import tr
from turcar.misc_utils import list_volumes
from turcar.plugins.backend_config_page import (
    BackendDetailsConfigPage,
    BaseSshProxyConfigPage,
    get_ssh_password,
)
from turcar.running import SubprocessProxy
from turcar.ui_utils import create_string_var, create_url_label, ems_to_pixels
...
class BareMetalMicroPythonProxy(MicroPythonProxy):
    ...
    def get_pip_gui_class(self):
        from turcar.plugins.micropython.pip_gui import MicroPythonPipDialog
    ...
    def _get_backend_launcher_path(self) -> str:
        import turcar.plugins.micropython.bare_metal_backend

        return turcar.plugins.micropython.bare_metal_backend.__file__
    ...
    def open_custom_system_shell(self):
        ...
        terminal.run_in_terminal(
            [
                ...
                "turcar.plugins.micropython.miniterm_wrapper",
                "--exit-char",
                "20",
                "--menu-char",
                "29",
...
class LocalMicroPythonProxy(MicroPythonProxy):
    ...
    def _get_launcher_with_args(self):
        import turcar.plugins.micropython.os_mp_backend

        cmd = [
            turcar.plugins.micropython.os_mp_backend.__file__,
            repr(
                {
