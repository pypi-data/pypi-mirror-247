...
from turcar import get_runner, get_shell, get_workbench
from turcar.common import ImmediateCommand, ToplevelCommand
from turcar.plugins.backend_config_page import BaseSshProxyConfigPage, get_ssh_password
...
class SshCPythonProxy(SubprocessProxy):
    ...
    def get_pip_gui_class(self):
        from turcar.plugins.cpython_ssh.cps_pip_gui import SshCPythonPipDialog
