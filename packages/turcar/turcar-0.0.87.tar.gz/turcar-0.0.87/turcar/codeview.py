...
from turcar import get_workbench, roughparse, tktextext, ui_utils
from turcar.common import TextRange
from turcar.tktextext import EnhancedText
from turcar.ui_utils import EnhancedTextWithLogging, ask_string, scrollbar_style
...
class CodeViewText(EnhancedTextWithLogging, SyntaxText):
    ...
    def on_secondary_click(self, event=None):
        ...
        try:
            from turcar.plugins.debugger import get_current_debugger
