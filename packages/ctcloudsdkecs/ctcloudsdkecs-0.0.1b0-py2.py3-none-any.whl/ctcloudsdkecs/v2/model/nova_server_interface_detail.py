...
class NovaServerInterfaceDetail:
    ...
    def __init__(self, fixed_ips=None, mac_addr=None, net_id=None, port_id=None, port_state=None):
        ...
        :param fixed_ips: The param of the NovaServerInterfaceDetail
        :type fixed_ips: list[:class:`ctcloudsdkecs.v2.NovaServerInterfaceFixedIp`]
        :param mac_addr: The param of the NovaServerInterfaceDetail
        :type mac_addr: str
        :param net_id: The param of the NovaServerInterfaceDetail
        :type net_id: str
        :param port_id: The param of the NovaServerInterfaceDetail
        :type port_id: str
        :param port_state: The param of the NovaServerInterfaceDetail
        :type port_state: str
        """
    ...
    def fixed_ips(self):
        ...
        :rtype: list[:class:`ctcloudsdkecs.v2.NovaServerInterfaceFixedIp`]
        """
