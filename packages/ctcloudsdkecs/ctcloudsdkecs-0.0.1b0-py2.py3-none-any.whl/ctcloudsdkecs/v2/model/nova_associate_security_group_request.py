...
class NovaAssociateSecurityGroupRequest:
    ...
    def __init__(self, server_id=None, body=None):
        ...
        :param server_id: The param of the NovaAssociateSecurityGroupRequest
        :type server_id: str
        :param body: The param of the NovaAssociateSecurityGroupRequest
        :type body: :class:`ctcloudsdkecs.v2.NovaAssociateSecurityGroupRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`ctcloudsdkecs.v2.NovaAssociateSecurityGroupRequestBody`
        """
        return self._body
