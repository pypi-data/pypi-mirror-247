...
class DisassociateServerVirtualIpOption:
    ...
    def __init__(self, subnet_id=None, ip_address=None, reverse_binding=None):
        ...
        :param subnet_id: The param of the DisassociateServerVirtualIpOption
        :type subnet_id: str
        :param ip_address: The param of the DisassociateServerVirtualIpOption
        :type ip_address: str
        :param reverse_binding: The param of the DisassociateServerVirtualIpOption
