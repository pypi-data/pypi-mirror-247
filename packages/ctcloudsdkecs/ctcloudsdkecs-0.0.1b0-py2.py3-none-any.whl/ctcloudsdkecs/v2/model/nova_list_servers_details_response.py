...
class NovaListServersDetailsResponse(SdkResponse):
    ...
    def __init__(self, servers=None, servers_links=None):
        ...
        :param servers: The param of the NovaListServersDetailsResponse
        :type servers: list[:class:`ctcloudsdkecs.v2.NovaServer`]
        :param servers_links: The param of the NovaListServersDetailsResponse
        :type servers_links: list[:class:`ctcloudsdkecs.v2.PageLink`]
        """
    ...
    def servers(self):
        ...
        :rtype: list[:class:`ctcloudsdkecs.v2.NovaServer`]
        """
    ...
    def servers_links(self):
        ...
        :rtype: list[:class:`ctcloudsdkecs.v2.PageLink`]
        """
