...
class MigrateServerRequestBody:
    ...
    def __init__(self, migrate=None):
        ...
        :param migrate: The param of the MigrateServerRequestBody
        :type migrate: :class:`ctcloudsdkecs.v2.MigrateServerOption`
        """
    ...
    def migrate(self):
        ...
        :rtype: :class:`ctcloudsdkecs.v2.MigrateServerOption`
        """
