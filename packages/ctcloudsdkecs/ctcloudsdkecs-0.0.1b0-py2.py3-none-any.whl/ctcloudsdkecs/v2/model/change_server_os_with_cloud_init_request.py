...
class ChangeServerOsWithCloudInitRequest:
    ...
    def __init__(self, server_id=None, body=None):
        ...
        :param server_id: The param of the ChangeServerOsWithCloudInitRequest
        :type server_id: str
        :param body: The param of the ChangeServerOsWithCloudInitRequest
        :type body: :class:`ctcloudsdkecs.v2.ChangeServerOsWithCloudInitRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`ctcloudsdkecs.v2.ChangeServerOsWithCloudInitRequestBody`
        """
        return self._body
