...
class AssociateServerVirtualIpRequest:
    ...
    def __init__(self, nic_id=None, body=None):
        ...
        :param nic_id: The param of the AssociateServerVirtualIpRequest
        :type nic_id: str
        :param body: The param of the AssociateServerVirtualIpRequest
        :type body: :class:`ctcloudsdkecs.v2.AssociateServerVirtualIpRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`ctcloudsdkecs.v2.AssociateServerVirtualIpRequestBody`
        """
        return self._body
