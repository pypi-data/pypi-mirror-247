...
class ResizePostPaidServerRequest:
    ...
    openapi_types = {
        'server_id': 'str',
        'body': 'ResizePostPaidServerRequestBody'
    }
    ...
    def __init__(self, server_id=None, body=None):
        ...
        :param server_id: The param of the ResizePostPaidServerRequest
        :type server_id: str
        :param body: The param of the ResizePostPaidServerRequest
        :type body: :class:`ctcloudsdkecs.v2.ResizePostPaidServerRequestBody`
        """
    ...
    def server_id(self):
        ...
        :return: The server_id of this ResizePostPaidServerRequest.
        :rtype: str
        """
    ...
    def body(self):
        ...
        :rtype: :class:`ctcloudsdkecs.v2.ResizePostPaidServerRequestBody`
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ResizePostPaidServerRequest):
            return False
