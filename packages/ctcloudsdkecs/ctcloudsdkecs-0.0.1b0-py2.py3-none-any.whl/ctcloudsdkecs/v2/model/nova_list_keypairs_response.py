...
class NovaListKeypairsResponse(SdkResponse):
    ...
    def __init__(self, keypairs=None):
        ...
        :param keypairs: The param of the NovaListKeypairsResponse
        :type keypairs: list[:class:`ctcloudsdkecs.v2.NovaListKeypairsResult`]
        """
    ...
    def keypairs(self):
        ...
        :rtype: list[:class:`ctcloudsdkecs.v2.NovaListKeypairsResult`]
        """
