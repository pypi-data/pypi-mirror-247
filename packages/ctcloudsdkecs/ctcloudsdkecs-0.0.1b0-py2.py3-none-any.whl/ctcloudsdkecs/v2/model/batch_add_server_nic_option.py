...
class BatchAddServerNicOption:
    ...
    def __init__(self, subnet_id=None, security_groups=None, ip_address=None, ipv6_enable=None, ipv6_bandwidth=None):
        ...
        :param subnet_id: The param of the BatchAddServerNicOption
        :type subnet_id: str
        :param security_groups: The param of the BatchAddServerNicOption
        :type security_groups: list[:class:`ctcloudsdkecs.v2.ServerNicSecurityGroup`]
        :param ip_address: The param of the BatchAddServerNicOption
        :type ip_address: str
        :param ipv6_enable: The param of the BatchAddServerNicOption
        :type ipv6_enable: bool
        :param ipv6_bandwidth: The param of the BatchAddServerNicOption
        :type ipv6_bandwidth: :class:`ctcloudsdkecs.v2.Ipv6Bandwidth`
        """
    ...
    def security_groups(self):
        ...
        :rtype: list[:class:`ctcloudsdkecs.v2.ServerNicSecurityGroup`]
        """
    ...
    def ipv6_bandwidth(self):
        ...
        :rtype: :class:`ctcloudsdkecs.v2.Ipv6Bandwidth`
        """
