...
class PrePaidServerNic:
    ...
    def __init__(self, subnet_id=None, ip_address=None, ipv6_enable=None, ipv6_bandwidth=None):
        ...
        :param subnet_id: The param of the PrePaidServerNic
        :type subnet_id: str
        :param ip_address: The param of the PrePaidServerNic
        :type ip_address: str
        :param ipv6_enable: The param of the PrePaidServerNic
        :type ipv6_enable: bool
        :param ipv6_bandwidth: The param of the PrePaidServerNic
        :type ipv6_bandwidth: :class:`ctcloudsdkecs.v2.PrePaidServerIpv6Bandwidth`
        """
    ...
    def ipv6_bandwidth(self):
        ...
        :rtype: :class:`ctcloudsdkecs.v2.PrePaidServerIpv6Bandwidth`
        """
