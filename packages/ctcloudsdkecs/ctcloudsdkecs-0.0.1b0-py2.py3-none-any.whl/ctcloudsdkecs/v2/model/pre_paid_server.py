...
class PrePaidServer:
    ...
    def __init__(self, auto_terminate_time=None, image_ref=None, flavor_ref=None, name=None, user_data=None, admin_pass=None, key_name=None, vpcid=None, nics=None, publicip=None, count=None, is_auto_rename=None, root_volume=None, data_volumes=None, security_groups=None, availability_zone=None, batch_create_in_multi_az=None, extendparam=None, metadata=None, osscheduler_hints=None, tags=None, server_tags=None, description=None):
        ...
        :type nics: list[:class:`ctcloudsdkecs.v2.PrePaidServerNic`]
        :param publicip: The param of the PrePaidServer
        :type publicip: :class:`ctcloudsdkecs.v2.PrePaidServerPublicip`
        ...
        :type root_volume: :class:`ctcloudsdkecs.v2.PrePaidServerRootVolume`
        :param data_volumes: The param of the PrePaidServer
        :type data_volumes: list[:class:`ctcloudsdkecs.v2.PrePaidServerDataVolume`]
        :param security_groups: The param of the PrePaidServer
        :type security_groups: list[:class:`ctcloudsdkecs.v2.PrePaidServerSecurityGroup`]
        ...
        :type extendparam: :class:`ctcloudsdkecs.v2.PrePaidServerExtendParam`
        :param metadata: The param of the PrePaidServer
        :type metadata: dict(str, str)
        :param osscheduler_hints: The param of the PrePaidServer
        :type osscheduler_hints: :class:`ctcloudsdkecs.v2.PrePaidServerSchedulerHints`
        :param tags: The param of the PrePaidServer
        :type tags: list[str]
        :param server_tags: The param of the PrePaidServer
        :type server_tags: list[:class:`ctcloudsdkecs.v2.PrePaidServerTag`]
    ...
    def nics(self):
        ...
        :rtype: list[:class:`ctcloudsdkecs.v2.PrePaidServerNic`]
        """
        return self._nics
    ...
    def publicip(self):
        ...
        :rtype: :class:`ctcloudsdkecs.v2.PrePaidServerPublicip`
        """
    ...
    def root_volume(self):
        ...
        :rtype: :class:`ctcloudsdkecs.v2.PrePaidServerRootVolume`
        """
    ...
    def data_volumes(self):
        ...
        :rtype: list[:class:`ctcloudsdkecs.v2.PrePaidServerDataVolume`]
        """
    ...
    def security_groups(self):
        ...
        :rtype: list[:class:`ctcloudsdkecs.v2.PrePaidServerSecurityGroup`]
        """
    ...
    def extendparam(self):
        ...
        :rtype: :class:`ctcloudsdkecs.v2.PrePaidServerExtendParam`
        """
    ...
    def osscheduler_hints(self):
        ...
        :rtype: :class:`ctcloudsdkecs.v2.PrePaidServerSchedulerHints`
        """
    ...
    def server_tags(self):
        ...
        :rtype: list[:class:`ctcloudsdkecs.v2.PrePaidServerTag`]
        """
