...
class NovaAttachInterfaceOption:
    ...
    def __init__(self, fixed_ips=None, net_id=None, port_id=None):
        ...
        :param fixed_ips: The param of the NovaAttachInterfaceOption
        :type fixed_ips: list[:class:`ctcloudsdkecs.v2.NovaAttachInterfaceFixedIp`]
        :param net_id: The param of the NovaAttachInterfaceOption
        :type net_id: str
        :param port_id: The param of the NovaAttachInterfaceOption
        :type port_id: str
        """
    ...
    def fixed_ips(self):
        ...
        :rtype: list[:class:`ctcloudsdkecs.v2.NovaAttachInterfaceFixedIp`]
        """
