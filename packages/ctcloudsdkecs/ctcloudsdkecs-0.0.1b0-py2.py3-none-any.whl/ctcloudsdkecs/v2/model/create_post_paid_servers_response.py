...
class CreatePostPaidServersResponse(SdkResponse):
    ...
    def __init__(self, job_id=None, server_ids=None):
        ...
        :param job_id: The param of the CreatePostPaidServersResponse
        :type job_id: str
        :param server_ids: The param of the CreatePostPaidServersResponse
    ...
    def job_id(self):
        ...
        :return: The job_id of this CreatePostPaidServersResponse.
        :rtype: str
        """
        return self._job_id
    ...
    def server_ids(self):
        ...
        :return: The server_ids of this CreatePostPaidServersResponse.
        :rtype: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreatePostPaidServersResponse):
            return False
