...
class NovaAssociateSecurityGroupRequestBody:
    ...
    def __init__(self, add_security_group=None):
        ...
        :param add_security_group: The param of the NovaAssociateSecurityGroupRequestBody
        :type add_security_group: :class:`ctcloudsdkecs.v2.NovaAddSecurityGroupOption`
        """
    ...
    def add_security_group(self):
        ...
        :rtype: :class:`ctcloudsdkecs.v2.NovaAddSecurityGroupOption`
        """
