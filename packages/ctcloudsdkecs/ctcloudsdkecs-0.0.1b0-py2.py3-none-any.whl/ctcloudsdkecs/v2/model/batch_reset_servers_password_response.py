...
class BatchResetServersPasswordResponse(SdkResponse):
    ...
    def __init__(self, response=None):
        ...
        :param response: The param of the BatchResetServersPasswordResponse
        :type response: list[:class:`ctcloudsdkecs.v2.ServerId`]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchResetServersPasswordResponse):
            return False
