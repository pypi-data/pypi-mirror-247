...
class ResetServerPasswordRequest:
    ...
    def __init__(self, server_id=None, body=None):
        ...
        :param server_id: The param of the ResetServerPasswordRequest
        :type server_id: str
        :param body: The param of the ResetServerPasswordRequest
        :type body: :class:`ctcloudsdkecs.v2.ResetServerPasswordRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`ctcloudsdkecs.v2.ResetServerPasswordRequestBody`
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ResetServerPasswordRequest):
            return False
