...
class ServerExtendVolumeAttachment:
    ...
    def __init__(self, id=None, delete_on_termination=None, boot_index=None, device=None):
        ...
        :param id: The param of the ServerExtendVolumeAttachment
        :type id: str
        :param delete_on_termination: The param of the ServerExtendVolumeAttachment
        :type delete_on_termination: str
        :param boot_index: The param of the ServerExtendVolumeAttachment
        :type boot_index: str
        :param device: The param of the ServerExtendVolumeAttachment
        :type device: str
        """
