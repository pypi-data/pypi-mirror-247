...
class ListServerInterfacesResponse(SdkResponse):
    ...
    def __init__(self, attachable_quantity=None, interface_attachments=None):
        ...
        :param attachable_quantity: The param of the ListServerInterfacesResponse
        :type attachable_quantity: :class:`ctcloudsdkecs.v2.InterfaceAttachableQuantity`
        :param interface_attachments: The param of the ListServerInterfacesResponse
        :type interface_attachments: list[:class:`ctcloudsdkecs.v2.InterfaceAttachment`]
        """
    ...
    def attachable_quantity(self):
        ...
        :rtype: :class:`ctcloudsdkecs.v2.InterfaceAttachableQuantity`
        """
    ...
    def interface_attachments(self):
        ...
        :rtype: list[:class:`ctcloudsdkecs.v2.InterfaceAttachment`]
        """
