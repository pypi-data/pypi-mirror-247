...
class ServerLimits:
    ...
    def __init__(self, max_image_meta=None, max_personality=None, max_personality_size=None, max_security_group_rules=None, max_security_groups=None, max_server_group_members=None, max_server_groups=None, max_server_meta=None, max_total_cores=None, max_total_floating_ips=None, max_total_instances=None, max_total_keypairs=None, max_total_ram_size=None, total_cores_used=None, total_floating_ips_used=None, total_instances_used=None, total_ram_used=None, total_security_groups_used=None, total_server_groups_used=None, max_total_spot_instances=None, max_total_spot_cores=None, max_total_spot_ram_size=None, total_spot_instances_used=None, total_spot_cores_used=None, total_spot_ram_used=None, limit_by_flavor=None):
        ...
        :param max_image_meta: The param of the ServerLimits
        :type max_image_meta: int
        :param max_personality: The param of the ServerLimits
        :type max_personality: int
        :param max_personality_size: The param of the ServerLimits
        :type max_personality_size: int
        :param max_security_group_rules: The param of the ServerLimits
        :type max_security_group_rules: int
        :param max_security_groups: The param of the ServerLimits
        :type max_security_groups: int
        :param max_server_group_members: The param of the ServerLimits
        :type max_server_group_members: int
        :param max_server_groups: The param of the ServerLimits
        :type max_server_groups: int
        :param max_server_meta: The param of the ServerLimits
        :type max_server_meta: int
        :param max_total_cores: The param of the ServerLimits
        :type max_total_cores: int
        :param max_total_floating_ips: The param of the ServerLimits
        :type max_total_floating_ips: int
        :param max_total_instances: The param of the ServerLimits
        :type max_total_instances: int
        :param max_total_keypairs: The param of the ServerLimits
        :type max_total_keypairs: int
        :param max_total_ram_size: The param of the ServerLimits
        :type max_total_ram_size: int
        :param total_cores_used: The param of the ServerLimits
        :type total_cores_used: int
        :param total_floating_ips_used: The param of the ServerLimits
        :type total_floating_ips_used: int
        :param total_instances_used: The param of the ServerLimits
        :type total_instances_used: int
        :param total_ram_used: The param of the ServerLimits
        :type total_ram_used: int
        :param total_security_groups_used: The param of the ServerLimits
        :type total_security_groups_used: int
        :param total_server_groups_used: The param of the ServerLimits
        :type total_server_groups_used: int
        :param max_total_spot_instances: The param of the ServerLimits
        :type max_total_spot_instances: int
        :param max_total_spot_cores: The param of the ServerLimits
        :type max_total_spot_cores: int
        :param max_total_spot_ram_size: The param of the ServerLimits
        :type max_total_spot_ram_size: int
        :param total_spot_instances_used: The param of the ServerLimits
        :type total_spot_instances_used: int
        :param total_spot_cores_used: The param of the ServerLimits
        :type total_spot_cores_used: int
        :param total_spot_ram_used: The param of the ServerLimits
        :type total_spot_ram_used: int
        :param limit_by_flavor: The param of the ServerLimits
        :type limit_by_flavor: list[:class:`ctcloudsdkecs.v2.ProjectFlavorLimit`]
        """
    ...
    def limit_by_flavor(self):
        ...
        :rtype: list[:class:`ctcloudsdkecs.v2.ProjectFlavorLimit`]
        """
