...
class UpdateServerResponse(SdkResponse):
    ...
    def __init__(self, server=None):
        ...
        :param server: The param of the UpdateServerResponse
        :type server: :class:`ctcloudsdkecs.v2.UpdateServerResult`
        """
    ...
    def server(self):
        ...
        :rtype: :class:`ctcloudsdkecs.v2.UpdateServerResult`
        """
        return self._server
