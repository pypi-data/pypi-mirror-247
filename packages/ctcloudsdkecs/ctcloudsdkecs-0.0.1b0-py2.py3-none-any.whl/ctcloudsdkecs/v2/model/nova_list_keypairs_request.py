...
class NovaListKeypairsRequest:
    ...
    def __init__(self, limit=None, marker=None, open_stack_api_version=None):
        ...
        :param limit: The param of the NovaListKeypairsRequest
        :type limit: int
        :param marker: The param of the NovaListKeypairsRequest
        :type marker: str
        :param open_stack_api_version: The param of the NovaListKeypairsRequest
