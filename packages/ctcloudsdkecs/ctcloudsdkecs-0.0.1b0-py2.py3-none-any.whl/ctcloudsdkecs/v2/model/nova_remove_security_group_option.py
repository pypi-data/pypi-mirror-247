...
class NovaRemoveSecurityGroupOption:
    ...
    def __init__(self, name=None):
        ...
        :param name: The param of the NovaRemoveSecurityGroupOption
        :type name: str
        """
    ...
    def name(self):
        ...
        :return: The name of this NovaRemoveSecurityGroupOption.
        :rtype: str
        """
        return self._name
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NovaRemoveSecurityGroupOption):
            return False
