...
class ShowServerRemoteConsoleRequest:
    ...
    def __init__(self, server_id=None, body=None):
        ...
        :param server_id: The param of the ShowServerRemoteConsoleRequest
        :type server_id: str
        :param body: The param of the ShowServerRemoteConsoleRequest
        :type body: :class:`ctcloudsdkecs.v2.ShowServerRemoteConsoleRequestBody`
        """
    ...
    def server_id(self):
        ...
        :return: The server_id of this ShowServerRemoteConsoleRequest.
        :rtype: str
        """
    ...
    def server_id(self, server_id):
        ...
        :param server_id: The server_id of this ShowServerRemoteConsoleRequest.
        :type server_id: str
        """
    ...
    def body(self):
        ...
        :rtype: :class:`ctcloudsdkecs.v2.ShowServerRemoteConsoleRequestBody`
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowServerRemoteConsoleRequest):
            return False
