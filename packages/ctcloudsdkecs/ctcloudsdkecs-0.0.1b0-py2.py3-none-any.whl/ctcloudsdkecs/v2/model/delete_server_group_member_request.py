...
class DeleteServerGroupMemberRequest:
    ...
    def __init__(self, server_group_id=None, body=None):
        ...
        :param server_group_id: The param of the DeleteServerGroupMemberRequest
        :type server_group_id: str
        :param body: The param of the DeleteServerGroupMemberRequest
        :type body: :class:`ctcloudsdkecs.v2.DeleteServerGroupMemberRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`ctcloudsdkecs.v2.DeleteServerGroupMemberRequestBody`
        """
        return self._body
