...
class CreatePostPaidServersRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: The param of the CreatePostPaidServersRequest
        :type body: :class:`ctcloudsdkecs.v2.CreatePostPaidServersRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`ctcloudsdkecs.v2.CreatePostPaidServersRequestBody`
        """
        return self._body
