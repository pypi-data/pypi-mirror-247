...
class NovaAvailabilityZone:
    ...
    def __init__(self, hosts=None, zone_name=None, zone_state=None):
        ...
        :param hosts: The param of the NovaAvailabilityZone
        :type hosts: list[str]
        :param zone_name: The param of the NovaAvailabilityZone
        :type zone_name: str
        :param zone_state: The param of the NovaAvailabilityZone
        :type zone_state: :class:`ctcloudsdkecs.v2.NovaAvailabilityZoneState`
        """
    ...
    def zone_state(self):
        ...
        :rtype: :class:`ctcloudsdkecs.v2.NovaAvailabilityZoneState`
        """
