...
class ChangeServerOsWithCloudInitRequestBody:
    ...
    def __init__(self, os_change=None):
        ...
        :param os_change: The param of the ChangeServerOsWithCloudInitRequestBody
        :type os_change: :class:`ctcloudsdkecs.v2.ChangeServerOsWithCloudInitOption`
        """
    ...
    def os_change(self):
        ...
        :rtype: :class:`ctcloudsdkecs.v2.ChangeServerOsWithCloudInitOption`
        """
