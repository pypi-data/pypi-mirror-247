...
class BatchUpdateServersNameRequest:
    ...
    openapi_types = {
        'body': 'BatchUpdateServersNameRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: The param of the BatchUpdateServersNameRequest
        :type body: :class:`ctcloudsdkecs.v2.BatchUpdateServersNameRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`ctcloudsdkecs.v2.BatchUpdateServersNameRequestBody`
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchUpdateServersNameRequest):
            return False
