...
class DetachServerVolumeRequest:
    ...
    def __init__(self, server_id=None, volume_id=None, delete_flag=None):
        ...
        :param server_id: The param of the DetachServerVolumeRequest
        :type server_id: str
        :param volume_id: The param of the DetachServerVolumeRequest
        :type volume_id: str
        :param delete_flag: The param of the DetachServerVolumeRequest
