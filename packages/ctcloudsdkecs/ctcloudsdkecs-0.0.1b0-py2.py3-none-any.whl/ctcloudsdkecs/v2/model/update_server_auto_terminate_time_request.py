...
class UpdateServerAutoTerminateTimeRequest:
    ...
    openapi_types = {
        'server_id': 'str',
        'body': 'UpdateServerAutoTerminateTimeRequestBody'
    }
    ...
    def __init__(self, server_id=None, body=None):
        ...
        :param server_id: The param of the UpdateServerAutoTerminateTimeRequest
        :type server_id: str
        :param body: The param of the UpdateServerAutoTerminateTimeRequest
        :type body: :class:`ctcloudsdkecs.v2.UpdateServerAutoTerminateTimeRequestBody`
        """
    ...
    def server_id(self):
        ...
        :return: The server_id of this UpdateServerAutoTerminateTimeRequest.
        :rtype: str
        """
    ...
    def body(self):
        ...
        :rtype: :class:`ctcloudsdkecs.v2.UpdateServerAutoTerminateTimeRequestBody`
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateServerAutoTerminateTimeRequest):
            return False
