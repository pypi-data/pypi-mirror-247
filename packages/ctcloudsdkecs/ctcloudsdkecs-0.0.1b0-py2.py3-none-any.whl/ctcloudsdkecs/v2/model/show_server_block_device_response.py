...
class ShowServerBlockDeviceResponse(SdkResponse):
    ...
    def __init__(self, volume_attachment=None):
        ...
        :param volume_attachment: The param of the ShowServerBlockDeviceResponse
        :type volume_attachment: :class:`ctcloudsdkecs.v2.ServerBlockDevice`
        """
    ...
    def volume_attachment(self):
        ...
        :rtype: :class:`ctcloudsdkecs.v2.ServerBlockDevice`
        """
