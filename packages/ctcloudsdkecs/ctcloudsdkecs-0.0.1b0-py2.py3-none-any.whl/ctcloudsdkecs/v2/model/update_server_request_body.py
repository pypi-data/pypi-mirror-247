...
class UpdateServerRequestBody:
    ...
    def __init__(self, server=None):
        ...
        :param server: The param of the UpdateServerRequestBody
        :type server: :class:`ctcloudsdkecs.v2.UpdateServerOption`
        """
    ...
    def server(self):
        ...
        :rtype: :class:`ctcloudsdkecs.v2.UpdateServerOption`
        """
        return self._server
