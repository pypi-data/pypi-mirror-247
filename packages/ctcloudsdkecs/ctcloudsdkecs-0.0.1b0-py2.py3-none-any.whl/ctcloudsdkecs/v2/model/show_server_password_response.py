...
class ShowServerPasswordResponse(SdkResponse):
    ...
    def __init__(self, password=None):
        ...
        :param password: The param of the ShowServerPasswordResponse
        :type password: str
        """
    ...
    def password(self):
        ...
        :return: The password of this ShowServerPasswordResponse.
        :rtype: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowServerPasswordResponse):
            return False
