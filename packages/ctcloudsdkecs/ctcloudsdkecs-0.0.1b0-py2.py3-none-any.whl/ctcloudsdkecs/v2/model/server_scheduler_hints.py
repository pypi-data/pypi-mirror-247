...
class ServerSchedulerHints:
    ...
    def __init__(self, group=None, tenancy=None, dedicated_host_id=None):
        ...
        :param group: The param of the ServerSchedulerHints
        :type group: list[str]
        :param tenancy: The param of the ServerSchedulerHints
        :type tenancy: list[str]
        :param dedicated_host_id: The param of the ServerSchedulerHints
