...
class PostPaidServerEip:
    ...
    def __init__(self, iptype=None, bandwidth=None, extendparam=None):
        ...
        :type bandwidth: :class:`ctcloudsdkecs.v2.PostPaidServerEipBandwidth`
        :param extendparam: The param of the PostPaidServerEip
        :type extendparam: :class:`ctcloudsdkecs.v2.PostPaidServerEipExtendParam`
        """
    ...
    def bandwidth(self):
        ...
        :rtype: :class:`ctcloudsdkecs.v2.PostPaidServerEipBandwidth`
        """
    ...
    def extendparam(self):
        ...
        :rtype: :class:`ctcloudsdkecs.v2.PostPaidServerEipExtendParam`
        """
