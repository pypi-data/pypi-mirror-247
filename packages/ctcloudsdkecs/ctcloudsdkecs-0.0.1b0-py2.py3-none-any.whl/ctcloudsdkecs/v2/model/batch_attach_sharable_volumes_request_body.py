...
class BatchAttachSharableVolumesRequestBody:
    ...
    def __init__(self, serverinfo=None):
        ...
        :param serverinfo: The param of the BatchAttachSharableVolumesRequestBody
        :type serverinfo: list[:class:`ctcloudsdkecs.v2.BatchAttachSharableVolumesOption`]
        """
    ...
    def serverinfo(self):
        ...
        :rtype: list[:class:`ctcloudsdkecs.v2.BatchAttachSharableVolumesOption`]
        """
