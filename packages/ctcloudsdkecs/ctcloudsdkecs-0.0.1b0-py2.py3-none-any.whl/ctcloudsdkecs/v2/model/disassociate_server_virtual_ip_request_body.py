...
class DisassociateServerVirtualIpRequestBody:
    ...
    def __init__(self, nic=None):
        ...
        :param nic: The param of the DisassociateServerVirtualIpRequestBody
        :type nic: :class:`ctcloudsdkecs.v2.DisassociateServerVirtualIpOption`
        """
    ...
    def nic(self):
        ...
        :rtype: :class:`ctcloudsdkecs.v2.DisassociateServerVirtualIpOption`
        """
        return self._nic
