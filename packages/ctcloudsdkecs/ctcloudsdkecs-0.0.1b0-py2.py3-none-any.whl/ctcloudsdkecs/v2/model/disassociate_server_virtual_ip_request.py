...
class DisassociateServerVirtualIpRequest:
    ...
    def __init__(self, nic_id=None, body=None):
        ...
        :param nic_id: The param of the DisassociateServerVirtualIpRequest
        :type nic_id: str
        :param body: The param of the DisassociateServerVirtualIpRequest
        :type body: :class:`ctcloudsdkecs.v2.DisassociateServerVirtualIpRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`ctcloudsdkecs.v2.DisassociateServerVirtualIpRequestBody`
        """
        return self._body
