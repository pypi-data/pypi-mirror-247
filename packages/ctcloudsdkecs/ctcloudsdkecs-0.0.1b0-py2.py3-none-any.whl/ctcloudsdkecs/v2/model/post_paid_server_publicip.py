...
class PostPaidServerPublicip:
    ...
    def __init__(self, id=None, eip=None, delete_on_termination=None):
        ...
        :param id: The param of the PostPaidServerPublicip
        :type id: str
        :param eip: The param of the PostPaidServerPublicip
        :type eip: :class:`ctcloudsdkecs.v2.PostPaidServerEip`
        :param delete_on_termination: The param of the PostPaidServerPublicip
    ...
    def eip(self):
        ...
        :rtype: :class:`ctcloudsdkecs.v2.PostPaidServerEip`
        """
        return self._eip
