...
class DeleteServersRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: The param of the DeleteServersRequest
        :type body: :class:`ctcloudsdkecs.v2.DeleteServersRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`ctcloudsdkecs.v2.DeleteServersRequestBody`
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteServersRequest):
            return False
