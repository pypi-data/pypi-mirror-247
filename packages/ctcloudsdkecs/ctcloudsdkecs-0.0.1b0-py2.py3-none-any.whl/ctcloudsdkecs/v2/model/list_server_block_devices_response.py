...
class ListServerBlockDevicesResponse(SdkResponse):
    ...
    def __init__(self, attachable_quantity=None, volume_attachments=None):
        ...
        :param attachable_quantity: The param of the ListServerBlockDevicesResponse
        :type attachable_quantity: :class:`ctcloudsdkecs.v2.BlockDeviceAttachableQuantity`
        :param volume_attachments: The param of the ListServerBlockDevicesResponse
        :type volume_attachments: list[:class:`ctcloudsdkecs.v2.ServerBlockDevice`]
        """
    ...
    def attachable_quantity(self):
        ...
        :rtype: :class:`ctcloudsdkecs.v2.BlockDeviceAttachableQuantity`
        """
    ...
    def volume_attachments(self):
        ...
        :rtype: list[:class:`ctcloudsdkecs.v2.ServerBlockDevice`]
        """
