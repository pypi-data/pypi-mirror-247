...
class BatchCreateServerTagsRequestBody:
    ...
    def __init__(self, action=None, tags=None):
        ...
        :param action: The param of the BatchCreateServerTagsRequestBody
        :type action: str
        :param tags: The param of the BatchCreateServerTagsRequestBody
    ...
    @property
    def tags(self):
        """Gets the tags of this BatchCreateServerTagsRequestBody.
    ...
    @tags.setter
    def tags(self, tags):
        """Sets the tags of this BatchCreateServerTagsRequestBody.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchCreateServerTagsRequestBody):
            return False
