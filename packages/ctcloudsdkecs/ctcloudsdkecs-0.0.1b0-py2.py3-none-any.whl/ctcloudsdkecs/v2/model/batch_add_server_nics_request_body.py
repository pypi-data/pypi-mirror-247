...
class BatchAddServerNicsRequestBody:
    ...
    def __init__(self, nics=None):
        ...
        :param nics: The param of the BatchAddServerNicsRequestBody
        :type nics: list[:class:`ctcloudsdkecs.v2.BatchAddServerNicOption`]
        """
    ...
    def nics(self):
        ...
        :rtype: list[:class:`ctcloudsdkecs.v2.BatchAddServerNicOption`]
        """
        return self._nics
