...
class ReinstallServerWithCloudInitRequest:
    ...
    def __init__(self, server_id=None, body=None):
        ...
        :param server_id: The param of the ReinstallServerWithCloudInitRequest
        :type server_id: str
        :param body: The param of the ReinstallServerWithCloudInitRequest
        :type body: :class:`ctcloudsdkecs.v2.ReinstallServerWithCloudInitRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`ctcloudsdkecs.v2.ReinstallServerWithCloudInitRequestBody`
        """
        return self._body
