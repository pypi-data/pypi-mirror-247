...
class ChangeServerOsWithoutCloudInitRequestBody:
    ...
    def __init__(self, os_change=None):
        ...
        :param os_change: The param of the ChangeServerOsWithoutCloudInitRequestBody
        :type os_change: :class:`ctcloudsdkecs.v2.ChangeServerOsWithoutCloudInitOption`
        """
    ...
    def os_change(self):
        ...
        :rtype: :class:`ctcloudsdkecs.v2.ChangeServerOsWithoutCloudInitOption`
        """
