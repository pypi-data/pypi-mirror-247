...
class BatchStartServersRequestBody:
    ...
    def __init__(self, os_start=None):
        ...
        :param os_start: The param of the BatchStartServersRequestBody
        :type os_start: :class:`ctcloudsdkecs.v2.BatchStartServersOption`
        """
    ...
    def os_start(self):
        ...
        :rtype: :class:`ctcloudsdkecs.v2.BatchStartServersOption`
        """
