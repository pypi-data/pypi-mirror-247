...
class AddServerGroupMemberRequest:
    ...
    def __init__(self, server_group_id=None, body=None):
        ...
        :param server_group_id: The param of the AddServerGroupMemberRequest
        :type server_group_id: str
        :param body: The param of the AddServerGroupMemberRequest
        :type body: :class:`ctcloudsdkecs.v2.AddServerGroupMemberRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`ctcloudsdkecs.v2.AddServerGroupMemberRequestBody`
        """
        return self._body
