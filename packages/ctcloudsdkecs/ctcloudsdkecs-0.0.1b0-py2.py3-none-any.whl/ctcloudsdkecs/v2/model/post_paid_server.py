...
class PostPaidServer:
    ...
    def __init__(self, auto_terminate_time=None, admin_pass=None, availability_zone=None, batch_create_in_multi_az=None, count=None, data_volumes=None, extendparam=None, flavor_ref=None, image_ref=None, is_auto_rename=None, key_name=None, metadata=None, name=None, nics=None, osscheduler_hints=None, publicip=None, root_volume=None, security_groups=None, server_tags=None, tags=None, user_data=None, vpcid=None, description=None):
        ...
        :type data_volumes: list[:class:`ctcloudsdkecs.v2.PostPaidServerDataVolume`]
        :param extendparam: The param of the PostPaidServer
        :type extendparam: :class:`ctcloudsdkecs.v2.PostPaidServerExtendParam`
        ...
        :type nics: list[:class:`ctcloudsdkecs.v2.PostPaidServerNic`]
        :param osscheduler_hints: The param of the PostPaidServer
        :type osscheduler_hints: :class:`ctcloudsdkecs.v2.PostPaidServerSchedulerHints`
        :param publicip: The param of the PostPaidServer
        :type publicip: :class:`ctcloudsdkecs.v2.PostPaidServerPublicip`
        :param root_volume: The param of the PostPaidServer
        :type root_volume: :class:`ctcloudsdkecs.v2.PostPaidServerRootVolume`
        :param security_groups: The param of the PostPaidServer
        :type security_groups: list[:class:`ctcloudsdkecs.v2.PostPaidServerSecurityGroup`]
        :param server_tags: The param of the PostPaidServer
        :type server_tags: list[:class:`ctcloudsdkecs.v2.PostPaidServerTag`]
    ...
    def data_volumes(self):
        ...
        :rtype: list[:class:`ctcloudsdkecs.v2.PostPaidServerDataVolume`]
        """
    ...
    def extendparam(self):
        ...
        :rtype: :class:`ctcloudsdkecs.v2.PostPaidServerExtendParam`
        """
    ...
    def nics(self):
        ...
        :rtype: list[:class:`ctcloudsdkecs.v2.PostPaidServerNic`]
        """
        return self._nics
    ...
    def osscheduler_hints(self):
        ...
        :rtype: :class:`ctcloudsdkecs.v2.PostPaidServerSchedulerHints`
        """
    ...
    def publicip(self):
        ...
        :rtype: :class:`ctcloudsdkecs.v2.PostPaidServerPublicip`
        """
    ...
    def root_volume(self):
        ...
        :rtype: :class:`ctcloudsdkecs.v2.PostPaidServerRootVolume`
        """
    ...
    def security_groups(self):
        ...
        :rtype: list[:class:`ctcloudsdkecs.v2.PostPaidServerSecurityGroup`]
        """
    ...
    def server_tags(self):
        ...
        :rtype: list[:class:`ctcloudsdkecs.v2.PostPaidServerTag`]
        """
