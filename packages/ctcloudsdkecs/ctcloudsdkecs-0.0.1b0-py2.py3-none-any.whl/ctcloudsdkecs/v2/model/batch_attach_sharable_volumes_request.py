...
class BatchAttachSharableVolumesRequest:
    ...
    def __init__(self, volume_id=None, body=None):
        ...
        :param volume_id: The param of the BatchAttachSharableVolumesRequest
        :type volume_id: str
        :param body: The param of the BatchAttachSharableVolumesRequest
        :type body: :class:`ctcloudsdkecs.v2.BatchAttachSharableVolumesRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`ctcloudsdkecs.v2.BatchAttachSharableVolumesRequestBody`
        """
        return self._body
