...
class NovaDisassociateSecurityGroupRequestBody:
    ...
    def __init__(self, remove_security_group=None):
        ...
        :param remove_security_group: The param of the NovaDisassociateSecurityGroupRequestBody
        :type remove_security_group: :class:`ctcloudsdkecs.v2.NovaRemoveSecurityGroupOption`
        """
    ...
    def remove_security_group(self):
        ...
        :rtype: :class:`ctcloudsdkecs.v2.NovaRemoveSecurityGroupOption`
        """
