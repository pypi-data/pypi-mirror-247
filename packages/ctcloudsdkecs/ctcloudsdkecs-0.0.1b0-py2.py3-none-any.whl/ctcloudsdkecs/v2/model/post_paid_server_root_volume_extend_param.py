...
class PostPaidServerRootVolumeExtendParam:
    ...
    def __init__(self, resource_spec_code=None, resource_type=None, snapshot_id=None):
        ...
        :param resource_spec_code: The param of the PostPaidServerRootVolumeExtendParam
        :type resource_spec_code: str
        :param resource_type: The param of the PostPaidServerRootVolumeExtendParam
        :type resource_type: str
        :param snapshot_id: The param of the PostPaidServerRootVolumeExtendParam
