...
class NovaListServerSecurityGroupsResponse(SdkResponse):
    ...
    def __init__(self, security_groups=None):
        ...
        :param security_groups: The param of the NovaListServerSecurityGroupsResponse
        :type security_groups: list[:class:`ctcloudsdkecs.v2.NovaSecurityGroup`]
        """
    ...
    def security_groups(self):
        ...
        :rtype: list[:class:`ctcloudsdkecs.v2.NovaSecurityGroup`]
        """
