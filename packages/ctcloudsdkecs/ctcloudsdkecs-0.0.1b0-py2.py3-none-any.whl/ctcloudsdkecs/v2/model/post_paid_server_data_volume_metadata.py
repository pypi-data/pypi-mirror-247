...
class PostPaidServerDataVolumeMetadata:
    ...
    def __init__(self, system__encrypted=None, system__cmkid=None):
        ...
        :param system__encrypted: The param of the PostPaidServerDataVolumeMetadata
        :type system__encrypted: str
        :param system__cmkid: The param of the PostPaidServerDataVolumeMetadata
    ...
    def system__encrypted(self):
        """Gets the system__encrypted of this PostPaidServerDataVolumeMetadata.

        :return: The system__encrypted of this PostPaidServerDataVolumeMetadata.
        :rtype: str
        """
    ...
    def system__encrypted(self, system__encrypted):
        """Sets the system__encrypted of this PostPaidServerDataVolumeMetadata.
    ...
    def system__cmkid(self):
        """Gets the system__cmkid of this PostPaidServerDataVolumeMetadata.

        :return: The system__cmkid of this PostPaidServerDataVolumeMetadata.
        :rtype: str
        """
    ...
    def system__cmkid(self, system__cmkid):
        """Sets the system__cmkid of this PostPaidServerDataVolumeMetadata.
