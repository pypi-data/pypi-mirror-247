...
class InterfaceAttachment:
    ...
    def __init__(self, fixed_ips=None, mac_addr=None, net_id=None, port_id=None, port_state=None, delete_on_termination=None, driver_mode=None, min_rate=None, multiqueue_num=None, pci_address=None):
        ...
        :param fixed_ips: The param of the InterfaceAttachment
        :type fixed_ips: list[:class:`ctcloudsdkecs.v2.ServerInterfaceFixedIp`]
        :param mac_addr: The param of the InterfaceAttachment
        :type mac_addr: str
        :param net_id: The param of the InterfaceAttachment
        :type net_id: str
        :param port_id: The param of the InterfaceAttachment
        :type port_id: str
        :param port_state: The param of the InterfaceAttachment
        :type port_state: str
        :param delete_on_termination: The param of the InterfaceAttachment
        :type delete_on_termination: bool
        :param driver_mode: The param of the InterfaceAttachment
        :type driver_mode: str
        :param min_rate: The param of the InterfaceAttachment
        :type min_rate: int
        :param multiqueue_num: The param of the InterfaceAttachment
        :type multiqueue_num: int
        :param pci_address: The param of the InterfaceAttachment
    ...
    def fixed_ips(self):
        ...
        :rtype: list[:class:`ctcloudsdkecs.v2.ServerInterfaceFixedIp`]
        """
