...
class ListServerGroupsResponse(SdkResponse):
    ...
    def __init__(self, server_groups=None, page_info=None):
        ...
        :param server_groups: The param of the ListServerGroupsResponse
        :type server_groups: list[:class:`ctcloudsdkecs.v2.ListServerGroupsResult`]
        :param page_info: The param of the ListServerGroupsResponse
        :type page_info: :class:`ctcloudsdkecs.v2.ListServerGroupsPageInfoResult`
        """
    ...
    def server_groups(self):
        ...
        :rtype: list[:class:`ctcloudsdkecs.v2.ListServerGroupsResult`]
        """
    ...
    def page_info(self):
        ...
        :rtype: :class:`ctcloudsdkecs.v2.ListServerGroupsPageInfoResult`
        """
