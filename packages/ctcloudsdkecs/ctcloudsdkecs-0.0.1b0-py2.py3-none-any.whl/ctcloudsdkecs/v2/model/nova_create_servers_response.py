...
class NovaCreateServersResponse(SdkResponse):
    ...
    def __init__(self, server=None):
        ...
        :param server: The param of the NovaCreateServersResponse
        :type server: :class:`ctcloudsdkecs.v2.NovaCreateServersResult`
        """
    ...
    def server(self):
        ...
        :rtype: :class:`ctcloudsdkecs.v2.NovaCreateServersResult`
        """
        return self._server
