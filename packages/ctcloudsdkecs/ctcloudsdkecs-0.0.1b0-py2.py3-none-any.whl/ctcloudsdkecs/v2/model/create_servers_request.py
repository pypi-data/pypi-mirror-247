...
class CreateServersRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: The param of the CreateServersRequest
        :type body: :class:`ctcloudsdkecs.v2.CreateServersRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`ctcloudsdkecs.v2.CreateServersRequestBody`
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateServersRequest):
            return False
