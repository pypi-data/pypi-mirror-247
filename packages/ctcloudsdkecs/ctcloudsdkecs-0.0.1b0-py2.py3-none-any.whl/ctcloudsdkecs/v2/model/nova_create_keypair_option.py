...
class NovaCreateKeypairOption:
    ...
    def __init__(self, public_key=None, type=None, name=None, user_id=None):
        ...
        :param public_key: The param of the NovaCreateKeypairOption
        :type public_key: str
        :param type: The param of the NovaCreateKeypairOption
        :type type: str
        :param name: The param of the NovaCreateKeypairOption
        :type name: str
        :param user_id: The param of the NovaCreateKeypairOption
        :type user_id: str
        """
