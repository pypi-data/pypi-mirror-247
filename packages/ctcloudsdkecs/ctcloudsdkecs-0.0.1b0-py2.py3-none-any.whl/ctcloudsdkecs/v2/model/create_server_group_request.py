...
class CreateServerGroupRequest:
    ...
    openapi_types = {
        'body': 'CreateServerGroupRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: The param of the CreateServerGroupRequest
        :type body: :class:`ctcloudsdkecs.v2.CreateServerGroupRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`ctcloudsdkecs.v2.CreateServerGroupRequestBody`
        """
        return self._body
