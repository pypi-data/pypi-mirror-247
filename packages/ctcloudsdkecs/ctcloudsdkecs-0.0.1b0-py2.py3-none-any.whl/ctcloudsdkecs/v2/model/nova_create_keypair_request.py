...
class NovaCreateKeypairRequest:
    ...
    def __init__(self, open_stack_api_version=None, body=None):
        ...
        :param open_stack_api_version: The param of the NovaCreateKeypairRequest
        :type open_stack_api_version: str
        :param body: The param of the NovaCreateKeypairRequest
        :type body: :class:`ctcloudsdkecs.v2.NovaCreateKeypairRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`ctcloudsdkecs.v2.NovaCreateKeypairRequestBody`
        """
        return self._body
