...
class AssociateServerVirtualIpResponse(SdkResponse):
    ...
    def __init__(self, port_id=None):
        ...
        :param port_id: The param of the AssociateServerVirtualIpResponse
        :type port_id: str
        """
    ...
    def port_id(self):
        ...
        :return: The port_id of this AssociateServerVirtualIpResponse.
        :rtype: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AssociateServerVirtualIpResponse):
            return False
