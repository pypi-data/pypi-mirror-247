...
class MigrateServerRequest:
    ...
    def __init__(self, server_id=None, body=None):
        ...
        :param server_id: The param of the MigrateServerRequest
        :type server_id: str
        :param body: The param of the MigrateServerRequest
        :type body: :class:`ctcloudsdkecs.v2.MigrateServerRequestBody`
        """
    ...
    def server_id(self):
        ...
        :return: The server_id of this MigrateServerRequest.
        :rtype: str
        """
    ...
    def server_id(self, server_id):
        ...
        :param server_id: The server_id of this MigrateServerRequest.
        :type server_id: str
        """
    ...
    def body(self):
        ...
        :rtype: :class:`ctcloudsdkecs.v2.MigrateServerRequestBody`
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MigrateServerRequest):
            return False
