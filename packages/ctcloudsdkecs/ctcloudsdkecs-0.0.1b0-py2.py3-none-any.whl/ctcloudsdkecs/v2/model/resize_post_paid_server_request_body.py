...
class ResizePostPaidServerRequestBody:
    ...
    def __init__(self, resize=None, dry_run=None):
        ...
        :param resize: The param of the ResizePostPaidServerRequestBody
        :type resize: :class:`ctcloudsdkecs.v2.ResizePostPaidServerOption`
        :param dry_run: The param of the ResizePostPaidServerRequestBody
        :type dry_run: bool
        """
    ...
    def resize(self):
        ...
        :rtype: :class:`ctcloudsdkecs.v2.ResizePostPaidServerOption`
        """
        return self._resize
