...
class ReinstallServerWithoutCloudInitRequestBody:
    ...
    openapi_types = {
        'os_reinstall': 'ReinstallServerWithoutCloudInitOption'
    }
    ...
    def __init__(self, os_reinstall=None):
        ...
        :param os_reinstall: The param of the ReinstallServerWithoutCloudInitRequestBody
        :type os_reinstall: :class:`ctcloudsdkecs.v2.ReinstallServerWithoutCloudInitOption`
        """
    ...
    def os_reinstall(self):
        ...
        :rtype: :class:`ctcloudsdkecs.v2.ReinstallServerWithoutCloudInitOption`
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ReinstallServerWithoutCloudInitRequestBody):
            return False
