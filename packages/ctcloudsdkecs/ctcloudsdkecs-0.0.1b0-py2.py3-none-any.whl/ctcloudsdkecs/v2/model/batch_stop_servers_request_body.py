...
class BatchStopServersRequestBody:
    ...
    def __init__(self, os_stop=None):
        ...
        :param os_stop: The param of the BatchStopServersRequestBody
        :type os_stop: :class:`ctcloudsdkecs.v2.BatchStopServersOption`
        """
    ...
    def os_stop(self):
        ...
        :rtype: :class:`ctcloudsdkecs.v2.BatchStopServersOption`
        """
