...
class NovaSecurityGroupCommonRule:
    ...
    def __init__(self, from_port=None, group=None, id=None, ip_protocol=None, ip_range=None, parent_group_id=None, to_port=None):
        ...
        :type group: :class:`ctcloudsdkecs.v2.NovaSecurityGroupCommonGroup`
        ...
        :type ip_range: :class:`ctcloudsdkecs.v2.NovaSecurityGroupCommonIpRange`
    ...
    def group(self):
        ...
        :rtype: :class:`ctcloudsdkecs.v2.NovaSecurityGroupCommonGroup`
        """
        return self._group
    ...
    def ip_range(self):
        ...
        :rtype: :class:`ctcloudsdkecs.v2.NovaSecurityGroupCommonIpRange`
        """
