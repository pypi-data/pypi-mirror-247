...
class NovaCreateServersRequest:
    ...
    def __init__(self, open_stack_api_version=None, body=None):
        ...
        :param open_stack_api_version: The param of the NovaCreateServersRequest
        :type open_stack_api_version: str
        :param body: The param of the NovaCreateServersRequest
        :type body: :class:`ctcloudsdkecs.v2.NovaCreateServersRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`ctcloudsdkecs.v2.NovaCreateServersRequestBody`
        """
        return self._body
