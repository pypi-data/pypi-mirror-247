...
class BatchResetServersPasswordRequest:
    ...
    openapi_types = {
        'body': 'BatchResetServersPasswordRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: The param of the BatchResetServersPasswordRequest
        :type body: :class:`ctcloudsdkecs.v2.BatchResetServersPasswordRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`ctcloudsdkecs.v2.BatchResetServersPasswordRequestBody`
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchResetServersPasswordRequest):
            return False
