...
class NovaServerFault:
    ...
    def __init__(self, code=None, created=None, message=None, details=None):
        ...
        :param code: The param of the NovaServerFault
        :type code: int
        :param created: The param of the NovaServerFault
        :type created: str
        :param message: The param of the NovaServerFault
        :type message: str
        :param details: The param of the NovaServerFault
        :type details: str
        """
