...
class NovaSimpleKeypair:
    ...
    def __init__(self, fingerprint=None, name=None, public_key=None, type=None):
        ...
        :param fingerprint: The param of the NovaSimpleKeypair
        :type fingerprint: str
        :param name: The param of the NovaSimpleKeypair
        :type name: str
        :param public_key: The param of the NovaSimpleKeypair
        :type public_key: str
        :param type: The param of the NovaSimpleKeypair
        :type type: str
        """
