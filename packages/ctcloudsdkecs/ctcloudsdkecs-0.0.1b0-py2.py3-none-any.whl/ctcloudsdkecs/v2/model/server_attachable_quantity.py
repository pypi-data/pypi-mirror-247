...
class ServerAttachableQuantity:
    ...
    def __init__(self, free_scsi=None, free_blk=None, free_disk=None, free_nic=None):
        ...
        :param free_scsi: The param of the ServerAttachableQuantity
        :type free_scsi: int
        :param free_blk: The param of the ServerAttachableQuantity
        :type free_blk: int
        :param free_disk: The param of the ServerAttachableQuantity
        :type free_disk: int
        :param free_nic: The param of the ServerAttachableQuantity
        :type free_nic: int
        """
