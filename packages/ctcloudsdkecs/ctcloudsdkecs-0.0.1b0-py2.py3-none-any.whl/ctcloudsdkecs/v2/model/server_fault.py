...
class ServerFault:
    ...
    def __init__(self, code=None, created=None, message=None, details=None):
        ...
        :param code: The param of the ServerFault
        :type code: int
        :param created: The param of the ServerFault
        :type created: str
        :param message: The param of the ServerFault
        :type message: str
        :param details: The param of the ServerFault
        :type details: str
        """
