...
class BatchCreateServerTagsRequest:
    ...
    openapi_types = {
        'server_id': 'str',
        'body': 'BatchCreateServerTagsRequestBody'
    }
    ...
    def __init__(self, server_id=None, body=None):
        ...
        :param server_id: The param of the BatchCreateServerTagsRequest
        :type server_id: str
        :param body: The param of the BatchCreateServerTagsRequest
        :type body: :class:`ctcloudsdkecs.v2.BatchCreateServerTagsRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`ctcloudsdkecs.v2.BatchCreateServerTagsRequestBody`
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchCreateServerTagsRequest):
            return False
