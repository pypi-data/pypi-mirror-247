...
class AttachServerVolumeRequest:
    ...
    def __init__(self, server_id=None, body=None):
        ...
        :param server_id: The param of the AttachServerVolumeRequest
        :type server_id: str
        :param body: The param of the AttachServerVolumeRequest
        :type body: :class:`ctcloudsdkecs.v2.AttachServerVolumeRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`ctcloudsdkecs.v2.AttachServerVolumeRequestBody`
        """
        return self._body
