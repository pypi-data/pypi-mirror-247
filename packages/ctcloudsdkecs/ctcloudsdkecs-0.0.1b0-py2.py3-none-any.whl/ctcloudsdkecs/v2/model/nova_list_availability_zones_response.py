...
class NovaListAvailabilityZonesResponse(SdkResponse):
    ...
    def __init__(self, availability_zone_info=None):
        ...
        :param availability_zone_info: The param of the NovaListAvailabilityZonesResponse
        :type availability_zone_info: list[:class:`ctcloudsdkecs.v2.NovaAvailabilityZone`]
        """
    ...
    def availability_zone_info(self):
        ...
        :rtype: list[:class:`ctcloudsdkecs.v2.NovaAvailabilityZone`]
        """
