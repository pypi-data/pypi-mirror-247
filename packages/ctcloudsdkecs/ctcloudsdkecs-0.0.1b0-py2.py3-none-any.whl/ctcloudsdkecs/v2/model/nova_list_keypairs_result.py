...
class NovaListKeypairsResult:
    ...
    def __init__(self, keypair=None):
        ...
        :param keypair: The param of the NovaListKeypairsResult
        :type keypair: :class:`ctcloudsdkecs.v2.NovaSimpleKeypair`
        """
    ...
    def keypair(self):
        ...
        :rtype: :class:`ctcloudsdkecs.v2.NovaSimpleKeypair`
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NovaListKeypairsResult):
            return False
