...
class BatchRebootServersRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: The param of the BatchRebootServersRequest
        :type body: :class:`ctcloudsdkecs.v2.BatchRebootServersRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`ctcloudsdkecs.v2.BatchRebootServersRequestBody`
        """
        return self._body
