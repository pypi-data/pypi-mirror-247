...
class BatchDeleteServerNicsRequestBody:
    ...
    def __init__(self, nics=None):
        ...
        :param nics: The param of the BatchDeleteServerNicsRequestBody
        :type nics: list[:class:`ctcloudsdkecs.v2.BatchDeleteServerNicOption`]
        """
    ...
    def nics(self):
        ...
        :rtype: list[:class:`ctcloudsdkecs.v2.BatchDeleteServerNicOption`]
        """
        return self._nics
