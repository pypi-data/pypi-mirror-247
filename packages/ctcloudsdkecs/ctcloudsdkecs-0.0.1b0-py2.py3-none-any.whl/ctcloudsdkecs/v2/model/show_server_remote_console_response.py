...
class ShowServerRemoteConsoleResponse(SdkResponse):
    ...
    def __init__(self, remote_console=None):
        ...
        :param remote_console: The param of the ShowServerRemoteConsoleResponse
        :type remote_console: :class:`ctcloudsdkecs.v2.ServerRemoteConsole`
        """
    ...
    def remote_console(self):
        ...
        :rtype: :class:`ctcloudsdkecs.v2.ServerRemoteConsole`
        """
