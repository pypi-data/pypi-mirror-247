...
class BlockDeviceAttachableQuantity:
    ...
    def __init__(self, free_scsi=None, free_blk=None, free_disk=None):
        ...
        :param free_scsi: The param of the BlockDeviceAttachableQuantity
        :type free_scsi: int
        :param free_blk: The param of the BlockDeviceAttachableQuantity
        :type free_blk: int
        :param free_disk: The param of the BlockDeviceAttachableQuantity
        :type free_disk: int
        """
