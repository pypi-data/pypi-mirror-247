...
class SubJob:
    ...
    def __init__(self, status=None, entities=None, job_id=None, job_type=None, begin_time=None, end_time=None, error_code=None, fail_reason=None):
        ...
        :param status: The param of the SubJob
        :type status: str
        :param entities: The param of the SubJob
        :type entities: :class:`ctcloudsdkecs.v2.SubJobEntities`
        :param job_id: The param of the SubJob
        :type job_id: str
        :param job_type: The param of the SubJob
        :type job_type: str
        :param begin_time: The param of the SubJob
        :type begin_time: str
        :param end_time: The param of the SubJob
        :type end_time: str
        :param error_code: The param of the SubJob
        :type error_code: str
        :param fail_reason: The param of the SubJob
    ...
    def entities(self):
        ...
        :rtype: :class:`ctcloudsdkecs.v2.SubJobEntities`
        """
