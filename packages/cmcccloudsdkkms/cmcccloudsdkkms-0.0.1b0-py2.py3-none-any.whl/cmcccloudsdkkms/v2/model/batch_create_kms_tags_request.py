...
class BatchCreateKmsTagsRequest:
    ...
    def __init__(self, key_id=None, body=None):
        ...
        :param key_id: The param of the BatchCreateKmsTagsRequest
        :type key_id: str
        :param body: The param of the BatchCreateKmsTagsRequest
        :type body: :class:`cmcccloudsdkkms.v2.BatchCreateKmsTagsRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`cmcccloudsdkkms.v2.BatchCreateKmsTagsRequestBody`
        """
        return self._body
