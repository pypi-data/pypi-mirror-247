...
class ListKmsByTagsRequest:
    ...
    def __init__(self, resource_instances=None, body=None):
        ...
        :param resource_instances: The param of the ListKmsByTagsRequest
        :type resource_instances: str
        :param body: The param of the ListKmsByTagsRequest
        :type body: :class:`cmcccloudsdkkms.v2.ListKmsByTagsRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`cmcccloudsdkkms.v2.ListKmsByTagsRequestBody`
        """
        return self._body
