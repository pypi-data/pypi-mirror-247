...
class ValidateSignatureRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: The param of the ValidateSignatureRequest
        :type body: :class:`cmcccloudsdkkms.v2.VerifyRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`cmcccloudsdkkms.v2.VerifyRequestBody`
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ValidateSignatureRequest):
            return False
