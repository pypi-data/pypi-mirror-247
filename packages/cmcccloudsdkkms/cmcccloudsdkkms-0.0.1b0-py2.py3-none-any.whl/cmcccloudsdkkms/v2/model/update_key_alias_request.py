...
class UpdateKeyAliasRequest:
    ...
    openapi_types = {
        'body': 'UpdateKeyAliasRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: The param of the UpdateKeyAliasRequest
        :type body: :class:`cmcccloudsdkkms.v2.UpdateKeyAliasRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`cmcccloudsdkkms.v2.UpdateKeyAliasRequestBody`
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateKeyAliasRequest):
            return False
