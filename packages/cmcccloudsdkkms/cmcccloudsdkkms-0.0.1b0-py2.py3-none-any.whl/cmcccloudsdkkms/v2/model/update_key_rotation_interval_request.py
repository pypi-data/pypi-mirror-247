...
class UpdateKeyRotationIntervalRequest:
    ...
    openapi_types = {
        'body': 'UpdateKeyRotationIntervalRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: The param of the UpdateKeyRotationIntervalRequest
        :type body: :class:`cmcccloudsdkkms.v2.UpdateKeyRotationIntervalRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`cmcccloudsdkkms.v2.UpdateKeyRotationIntervalRequestBody`
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateKeyRotationIntervalRequest):
            return False
