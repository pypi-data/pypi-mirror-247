...
class CreateGrantRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: The param of the CreateGrantRequest
        :type body: :class:`cmcccloudsdkkms.v2.CreateGrantRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`cmcccloudsdkkms.v2.CreateGrantRequestBody`
        """
        return self._body
