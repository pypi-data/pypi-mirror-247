...
class CreateParametersForImportRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: The param of the CreateParametersForImportRequest
        :type body: :class:`cmcccloudsdkkms.v2.GetParametersForImportRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`cmcccloudsdkkms.v2.GetParametersForImportRequestBody`
        """
        return self._body
