...
class DeleteKeyRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: The param of the DeleteKeyRequest
        :type body: :class:`cmcccloudsdkkms.v2.ScheduleKeyDeletionRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`cmcccloudsdkkms.v2.ScheduleKeyDeletionRequestBody`
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteKeyRequest):
            return False
