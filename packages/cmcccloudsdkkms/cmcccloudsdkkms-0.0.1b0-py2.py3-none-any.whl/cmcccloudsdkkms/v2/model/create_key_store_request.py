...
class CreateKeyStoreRequest:
    ...
    openapi_types = {
        'body': 'CreateKeyStoreRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: The param of the CreateKeyStoreRequest
        :type body: :class:`cmcccloudsdkkms.v2.CreateKeyStoreRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`cmcccloudsdkkms.v2.CreateKeyStoreRequestBody`
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateKeyStoreRequest):
            return False
