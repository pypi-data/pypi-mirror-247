...
class CancelSelfGrantRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: The param of the CancelSelfGrantRequest
        :type body: :class:`cmcccloudsdkkms.v2.RevokeGrantRequestBody`
        """
    ...
    @property
    def body(self):
        """Gets the body of this CancelSelfGrantRequest.

        :return: The body of this CancelSelfGrantRequest.
        :rtype: :class:`cmcccloudsdkkms.v2.RevokeGrantRequestBody`
        """
        return self._body

    @body.setter
    def body(self, body):
        """Sets the body of this CancelSelfGrantRequest.
