...
class CreateParametersForImportResponse(SdkResponse):
    ...
    def __init__(self, key_id=None, import_token=None, expiration_time=None, public_key=None):
        ...
        :param key_id: The param of the CreateParametersForImportResponse
        :type key_id: str
        :param import_token: The param of the CreateParametersForImportResponse
        :type import_token: str
        :param expiration_time: The param of the CreateParametersForImportResponse
        :type expiration_time: int
        :param public_key: The param of the CreateParametersForImportResponse
        :type public_key: str
        """
