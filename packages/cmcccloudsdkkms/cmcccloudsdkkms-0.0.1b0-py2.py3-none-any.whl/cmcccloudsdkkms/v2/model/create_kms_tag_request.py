...
class CreateKmsTagRequest:
    ...
    def __init__(self, key_id=None, body=None):
        ...
        :param key_id: The param of the CreateKmsTagRequest
        :type key_id: str
        :param body: The param of the CreateKmsTagRequest
        :type body: :class:`cmcccloudsdkkms.v2.CreateKmsTagRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`cmcccloudsdkkms.v2.CreateKmsTagRequestBody`
        """
        return self._body
