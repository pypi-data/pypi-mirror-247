...
class CreateKeyRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: The param of the CreateKeyRequest
        :type body: :class:`cmcccloudsdkkms.v2.CreateKeyRequestBody`
        """
    ...
    @property
    def body(self):
        """Gets the body of this CreateKeyRequest.

        :return: The body of this CreateKeyRequest.
        :rtype: :class:`cmcccloudsdkkms.v2.CreateKeyRequestBody`
        """
        return self._body

    @body.setter
    def body(self, body):
        """Sets the body of this CreateKeyRequest.
