...
class DecryptDataResponse(SdkResponse):
    ...
    def __init__(self, key_id=None, plain_text=None, plain_text_base64=None):
        ...
        :param key_id: The param of the DecryptDataResponse
        :type key_id: str
        :param plain_text: The param of the DecryptDataResponse
        :type plain_text: str
        :param plain_text_base64: The param of the DecryptDataResponse
