...
class CreateDatakeyResponse(SdkResponse):
    ...
    def __init__(self, key_id=None, plain_text=None, cipher_text=None):
        ...
        :param key_id: The param of the CreateDatakeyResponse
        :type key_id: str
        :param plain_text: The param of the CreateDatakeyResponse
        :type plain_text: str
        :param cipher_text: The param of the CreateDatakeyResponse
