...
class EncryptDatakeyResponse(SdkResponse):
    ...
    def __init__(self, key_id=None, cipher_text=None, datakey_length=None):
        ...
        :param key_id: The param of the EncryptDatakeyResponse
        :type key_id: str
        :param cipher_text: The param of the EncryptDatakeyResponse
        :type cipher_text: str
        :param datakey_length: The param of the EncryptDatakeyResponse
