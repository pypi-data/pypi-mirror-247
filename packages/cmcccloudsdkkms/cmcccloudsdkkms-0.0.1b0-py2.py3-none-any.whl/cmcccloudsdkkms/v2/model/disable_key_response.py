...
class DisableKeyResponse(SdkResponse):
    ...
    def __init__(self, key_info=None):
        ...
        :param key_info: The param of the DisableKeyResponse
        :type key_info: :class:`cmcccloudsdkkms.v2.KeyStatusInfo`
        """
        
        super(DisableKeyResponse, self).__init__()
    ...
    def key_info(self):
        ...
        :rtype: :class:`cmcccloudsdkkms.v2.KeyStatusInfo`
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DisableKeyResponse):
            return False
