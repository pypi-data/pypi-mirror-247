...
class UpdateKeyDescriptionResponse(SdkResponse):
    ...
    def __init__(self, key_info=None):
        ...
        :param key_info: The param of the UpdateKeyDescriptionResponse
        :type key_info: :class:`cmcccloudsdkkms.v2.KeyDescriptionInfo`
        """
    ...
    def key_info(self):
        ...
        :rtype: :class:`cmcccloudsdkkms.v2.KeyDescriptionInfo`
        """
