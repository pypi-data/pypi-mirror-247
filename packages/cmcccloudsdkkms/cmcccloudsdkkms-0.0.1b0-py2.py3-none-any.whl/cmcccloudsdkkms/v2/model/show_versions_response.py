...
class ShowVersionsResponse(SdkResponse):
    ...
    def __init__(self, versions=None):
        ...
        :param versions: The param of the ShowVersionsResponse
        :type versions: list[:class:`cmcccloudsdkkms.v2.ApiVersionDetail`]
        """
    ...
    def versions(self):
        ...
        :rtype: list[:class:`cmcccloudsdkkms.v2.ApiVersionDetail`]
        """
