...
class CreateKmsTagRequestBody:
    ...
    def __init__(self, tag=None, sequence=None):
        ...
        :param tag: The param of the CreateKmsTagRequestBody
        :type tag: :class:`cmcccloudsdkkms.v2.TagItem`
        :param sequence: The param of the CreateKmsTagRequestBody
        :type sequence: str
        """
    ...
    def tag(self):
        ...
        :rtype: :class:`cmcccloudsdkkms.v2.TagItem`
        """
        return self._tag
