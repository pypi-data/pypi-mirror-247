...
class ListRetirableGrantsRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: The param of the ListRetirableGrantsRequest
        :type body: :class:`cmcccloudsdkkms.v2.ListRetirableGrantsRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`cmcccloudsdkkms.v2.ListRetirableGrantsRequestBody`
        """
        return self._body
