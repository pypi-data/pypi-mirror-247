...
class ListGrantsRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: The param of the ListGrantsRequest
        :type body: :class:`cmcccloudsdkkms.v2.ListGrantsRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`cmcccloudsdkkms.v2.ListGrantsRequestBody`
        """
        return self._body
