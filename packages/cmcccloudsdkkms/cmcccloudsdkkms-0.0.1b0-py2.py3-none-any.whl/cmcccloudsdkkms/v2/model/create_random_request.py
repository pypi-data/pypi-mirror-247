...
class CreateRandomRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: The param of the CreateRandomRequest
        :type body: :class:`cmcccloudsdkkms.v2.GenRandomRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`cmcccloudsdkkms.v2.GenRandomRequestBody`
        """
        return self._body
