...
class KeyDetails:
    ...
    def __init__(self, key_id=None, domain_id=None, key_alias=None, realm=None, key_spec=None, key_usage=None, key_description=None, creation_date=None, scheduled_deletion_date=None, key_state=None, default_key_flag=None, key_type=None, expiration_time=None, origin=None, key_rotation_enabled=None, sys_enterprise_project_id=None, keystore_id=None, key_label=None):
        ...
        :param key_id: The param of the KeyDetails
        :type key_id: str
        :param domain_id: The param of the KeyDetails
        :type domain_id: str
        :param key_alias: The param of the KeyDetails
        :type key_alias: str
        :param realm: The param of the KeyDetails
        :type realm: str
        :param key_spec: The param of the KeyDetails
        :type key_spec: str
        :param key_usage: The param of the KeyDetails
        :type key_usage: str
        :param key_description: The param of the KeyDetails
        :type key_description: str
        :param creation_date: The param of the KeyDetails
        :type creation_date: str
        :param scheduled_deletion_date: The param of the KeyDetails
        :type scheduled_deletion_date: str
        :param key_state: The param of the KeyDetails
        :type key_state: str
        :param default_key_flag: The param of the KeyDetails
        :type default_key_flag: str
        :param key_type: The param of the KeyDetails
        :type key_type: str
        :param expiration_time: The param of the KeyDetails
        :type expiration_time: str
        :param origin: The param of the KeyDetails
        :type origin: str
        :param key_rotation_enabled: The param of the KeyDetails
        :type key_rotation_enabled: str
        :param sys_enterprise_project_id: The param of the KeyDetails
        :type sys_enterprise_project_id: str
        :param keystore_id: The param of the KeyDetails
        :type keystore_id: str
        :param key_label: The param of the KeyDetails
        :type key_label: str
        """
