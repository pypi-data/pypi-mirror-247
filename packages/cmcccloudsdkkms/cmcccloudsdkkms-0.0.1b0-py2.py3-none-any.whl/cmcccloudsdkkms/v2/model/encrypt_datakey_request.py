...
class EncryptDatakeyRequest:
    ...
    openapi_types = {
        'body': 'EncryptDatakeyRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: The param of the EncryptDatakeyRequest
        :type body: :class:`cmcccloudsdkkms.v2.EncryptDatakeyRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`cmcccloudsdkkms.v2.EncryptDatakeyRequestBody`
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EncryptDatakeyRequest):
            return False
