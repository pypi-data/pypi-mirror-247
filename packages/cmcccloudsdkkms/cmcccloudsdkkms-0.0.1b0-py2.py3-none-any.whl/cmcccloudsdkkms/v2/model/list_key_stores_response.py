...
class ListKeyStoresResponse(SdkResponse):
    ...
    def __init__(self, total=None, keystores=None):
        ...
        :param total: The param of the ListKeyStoresResponse
        :type total: int
        :param keystores: The param of the ListKeyStoresResponse
        :type keystores: list[:class:`cmcccloudsdkkms.v2.KeystoreDetails`]
        """
    ...
    def keystores(self):
        ...
        :rtype: list[:class:`cmcccloudsdkkms.v2.KeystoreDetails`]
        """
