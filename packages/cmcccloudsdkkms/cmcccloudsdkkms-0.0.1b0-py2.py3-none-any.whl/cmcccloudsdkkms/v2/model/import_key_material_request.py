...
class ImportKeyMaterialRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: The param of the ImportKeyMaterialRequest
        :type body: :class:`cmcccloudsdkkms.v2.ImportKeyMaterialRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`cmcccloudsdkkms.v2.ImportKeyMaterialRequestBody`
        """
        return self._body
