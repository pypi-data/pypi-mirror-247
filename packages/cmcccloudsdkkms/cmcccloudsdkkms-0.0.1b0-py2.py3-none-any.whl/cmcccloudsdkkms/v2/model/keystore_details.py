...
class KeystoreDetails:
    ...
    def __init__(self, keystore_id=None, domain_id=None, keystore_alias=None, keystore_type=None, hsm_cluster_id=None, create_time=None):
        ...
        :param keystore_id: The param of the KeystoreDetails
        :type keystore_id: str
        :param domain_id: The param of the KeystoreDetails
        :type domain_id: str
        :param keystore_alias: The param of the KeystoreDetails
        :type keystore_alias: str
        :param keystore_type: The param of the KeystoreDetails
        :type keystore_type: str
        :param hsm_cluster_id: The param of the KeystoreDetails
        :type hsm_cluster_id: str
        :param create_time: The param of the KeystoreDetails
