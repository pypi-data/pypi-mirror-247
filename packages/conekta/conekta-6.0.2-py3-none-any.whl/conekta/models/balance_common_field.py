...
class BalanceCommonField(BaseModel):
    ...
    """ # noqa: E501
    amount: Optional[StrictInt] = Field(default=None, description="The balance's amount")
    currency: Optional[StrictStr] = Field(default=None, description="The balance's currency")
