...
class WebhookKeysApi:
    ...
    def create_webhook_key(
        ...
        webhook_key_request: Optional[WebhookKeyRequest] = None,
        ...
        _param = self._create_webhook_key_serialize(
            accept_language=accept_language,
            webhook_key_request=webhook_key_request,
    ...
    @validate_call
    def create_webhook_key_with_http_info(
        self,
        accept_language: Annotated[Optional[StrictStr], Field(description="Use for knowing which language to use")] = None,
        webhook_key_request: Optional[WebhookKeyRequest] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def create_webhook_key_without_preload_content(
        self,
        accept_language: Annotated[Optional[StrictStr], Field(description="Use for knowing which language to use")] = None,
        webhook_key_request: Optional[WebhookKeyRequest] = None,
        _request_timeout: Union[
    ...
    def _create_webhook_key_serialize(
        self,
        accept_language,
        webhook_key_request,
        _request_auth,
        ...
        if webhook_key_request is not None:
            _body_params = webhook_key_request
    ...
    def delete_webhook_key(
        ...
        _param = self._delete_webhook_key_serialize(
            id=id,
            accept_language=accept_language,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def delete_webhook_key_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Identifier of the resource")],
        accept_language: Annotated[Optional[StrictStr], Field(description="Use for knowing which language to use")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def delete_webhook_key_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Identifier of the resource")],
        accept_language: Annotated[Optional[StrictStr], Field(description="Use for knowing which language to use")] = None,
        _request_timeout: Union[
    ...
    def _delete_webhook_key_serialize(
        self,
        id,
        accept_language,
        _request_auth,
    ...
    def get_webhook_key(
        ...
        _param = self._get_webhook_key_serialize(
            id=id,
            accept_language=accept_language,
    ...
    @validate_call
    def get_webhook_key_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Identifier of the resource")],
        accept_language: Annotated[Optional[StrictStr], Field(description="Use for knowing which language to use")] = None,
        x_child_company_id: Annotated[Optional[StrictStr], Field(description="In the case of a holding company, the company id of the child company to which will process the request.")] = None,
    ...
    def _get_webhook_key_serialize(
        self,
        id,
        accept_language,
        x_child_company_id,
    ...
    def get_webhook_keys(
        ...
        _param = self._get_webhook_keys_serialize(
            accept_language=accept_language,
            x_child_company_id=x_child_company_id,
            limit=limit,
            search=search,
    ...
    @validate_call
    def get_webhook_keys_with_http_info(
        self,
        accept_language: Annotated[Optional[StrictStr], Field(description="Use for knowing which language to use")] = None,
        x_child_company_id: Annotated[Optional[StrictStr], Field(description="In the case of a holding company, the company id of the child company to which will process the request.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=1)]], Field(description="The numbers of items to return, the maximum value is 250")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetWebhookKeysResponse]:
        """Get List of Webhook Keys
    ...
    @validate_call
    def get_webhook_keys_without_preload_content(
        self,
        accept_language: Annotated[Optional[StrictStr], Field(description="Use for knowing which language to use")] = None,
        x_child_company_id: Annotated[Optional[StrictStr], Field(description="In the case of a holding company, the company id of the child company to which will process the request.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=1)]], Field(description="The numbers of items to return, the maximum value is 250")] = None,
    ...
    def _get_webhook_keys_serialize(
        self,
        accept_language,
        x_child_company_id,
        limit,
    ...
    def update_webhook_key(
        ...
        id: Annotated[StrictStr, Field(description="Identifier of the resource")],
        accept_language: Annotated[Optional[StrictStr], Field(description="Use for knowing which language to use")] = None,
        webhook_key_update_request: Optional[WebhookKeyUpdateRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._update_webhook_key_serialize(
            id=id,
            accept_language=accept_language,
            webhook_key_update_request=webhook_key_update_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def update_webhook_key_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Identifier of the resource")],
        accept_language: Annotated[Optional[StrictStr], Field(description="Use for knowing which language to use")] = None,
        webhook_key_update_request: Optional[WebhookKeyUpdateRequest] = None,
    ...
    def _update_webhook_key_serialize(
        self,
        id,
        accept_language,
        ...
        # process the form parameters
        # process the body parameter
        if webhook_key_update_request is not None:
            _body_params = webhook_key_update_request
