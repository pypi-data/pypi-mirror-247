...
option disabled, the literal characters '&lt;br&gt;' will be rendered. '''
    ...
    def importing_cards_added(self, count: int) -> str:
        r''' {$count} cards added. '''
        return self._translate(20, 11, {"count": count})
    ...
    def importing_empty_first_field(self, val: FluentVariable) -> str:
        ...
        return self._translate(20, 21, {"val": val})
...
- ``: Create a new note. '''
    ...
    def importing_existing_notes_skipped(self, count: int) -> str:
        ...
        return self._translate(20, 25, {"count": count})
    ...
    def importing_failed_to_import_media_file(self, debug_info: str) -> str:
        ...
        return self._translate(20, 28, {"debugInfo": debug_info})
    ...
    def importing_field_of_file_is(self, val: FluentVariable) -> str:
        ...
        return self._translate(20, 30, {"val": val})
...
do this automatically. '''
    ...
    def importing_fields_separated_by(self, val: FluentVariable) -> str:
        ...
        return self._translate(20, 33, {"val": val})
    ...
    def importing_first_field_matched(self, val: FluentVariable) -> str:
        ...
        return self._translate(20, 38, {"val": val})
...
Otherwise, all cards will be imported as new cards. '''
    ...
    def importing_map_to(self, val: FluentVariable) -> str:
        r''' Map to {$val} '''
        return self._translate(20, 53, {"val": val})
...
Warning: This will require a one-way sync, and may mark existing notes as modified. '''
    ...
    def importing_notes_found_in_file2(self, notes: int) -> str:
        ...
        return self._translate(20, 76, {"notes": notes})
...
mapping tool. '''
    ...
    def importing_rows_had_num1d_fields_expected_num2d(self, row: str, found: FluentVariable, expected: FluentVariable) -> str:
        ...
        return self._translate(20, 91, {"row": row, "found": found, "expected": expected})
    ...
    def importing_unable_to_import_filename(self, filename: str) -> str:
        ...
        return self._translate(20, 109, {"filename": filename})
...
Please select  before proceeding. '''
    ...
    def statistics_card_stability_subtitle(self, ) -> str:
        r''' The delay at which you're 90% likely to remember. '''
...
class LegacyTranslationEnum:
    ...
    IMPORTING_CARDS_ADDED = (20, 11)
    IMPORTING_CHANGE = (20, 12)
    IMPORTING_COLON = (20, 13)
    IMPORTING_COMMA = (20, 14)
    IMPORTING_CONFLICTING_NOTES_SKIPPED = (20, 15)
    IMPORTING_CONFLICTING_NOTES_SKIPPED2 = (20, 16)
    IMPORTING_DECK_HELP = (20, 17)
    IMPORTING_DETAILS = (20, 18)
    IMPORTING_DUPLICATE = (20, 19)
    IMPORTING_DUPLICATE_NOTE_ADDED = (20, 20)
    IMPORTING_EMPTY_FIRST_FIELD = (20, 21)
    IMPORTING_EXISTING_NOTE_SKIPPED = (20, 22)
    IMPORTING_EXISTING_NOTES = (20, 23)
    IMPORTING_EXISTING_NOTES_HELP = (20, 24)
    IMPORTING_EXISTING_NOTES_SKIPPED = (20, 25)
    IMPORTING_EXTRACTING = (20, 26)
    IMPORTING_FAILED_DEBUG_INFO = (20, 27)
    IMPORTING_FAILED_TO_IMPORT_MEDIA_FILE = (20, 28)
    IMPORTING_FIELD_MAPPING = (20, 29)
    IMPORTING_FIELD_OF_FILE_IS = (20, 30)
    IMPORTING_FIELD_SEPARATOR = (20, 31)
    IMPORTING_FIELD_SEPARATOR_HELP = (20, 32)
    IMPORTING_FIELDS_SEPARATED_BY = (20, 33)
    IMPORTING_FILE = (20, 34)
    IMPORTING_FILE_EMPTY = (20, 35)
    IMPORTING_FILE_MUST_CONTAIN_FIELD_COLUMN = (20, 36)
    IMPORTING_FILE_VERSION_UNKNOWN_TRYING_IMPORT_ANYWAY = (20, 37)
    IMPORTING_FIRST_FIELD_MATCHED = (20, 38)
    IMPORTING_GATHERING = (20, 39)
    IMPORTING_IDENTICAL = (20, 40)
    IMPORTING_IGNORE_FIELD = (20, 41)
    IMPORTING_IGNORE_LINES_WHERE_FIRST_FIELD_MATCHES = (20, 42)
    IMPORTING_IGNORED = (20, 43)
    IMPORTING_IMPORT_EVEN_IF_EXISTING_NOTE_HAS = (20, 44)
    IMPORTING_IMPORT_LOG = (20, 45)
    IMPORTING_IMPORT_OPTIONS = (20, 46)
    IMPORTING_IMPORTING_COLLECTION = (20, 47)
    IMPORTING_IMPORTING_COMPLETE = (20, 48)
    IMPORTING_IMPORTING_FILE = (20, 49)
    IMPORTING_INCLUDE_REVIEWS = (20, 50)
    IMPORTING_INCLUDE_REVIEWS_HELP = (20, 51)
    IMPORTING_INVALID_FILE_PLEASE_RESTORE_FROM_BACKUP = (20, 52)
    IMPORTING_MAP_TO = (20, 53)
    IMPORTING_MAP_TO_TAGS = (20, 54)
    IMPORTING_MAPPED_TO = (20, 55)
    IMPORTING_MAPPED_TO_TAGS = (20, 56)
    IMPORTING_MATCH_SCOPE = (20, 57)
    IMPORTING_MATCH_SCOPE_HELP = (20, 58)
    IMPORTING_MERGE_NOTETYPES = (20, 59)
    IMPORTING_MERGE_NOTETYPES_HELP = (20, 60)
    IMPORTING_MNEMOSYNE_20_DECK_DB = (20, 61)
    IMPORTING_MULTICHARACTER_SEPARATORS_ARE_NOT_SUPPORTED_PLEASE = (20, 62)
    IMPORTING_NO_NOTES_IN_FILE = (20, 63)
    IMPORTING_NOTE_ADDED = (20, 64)
    IMPORTING_NOTE_IMPORTED = (20, 65)
    IMPORTING_NOTE_SKIPPED_DUE_TO_EMPTY_FIRST_FIELD = (20, 66)
    IMPORTING_NOTE_SKIPPED_DUE_TO_MISSING_DECK = (20, 67)
    IMPORTING_NOTE_SKIPPED_DUE_TO_MISSING_NOTETYPE = (20, 68)
    IMPORTING_NOTE_SKIPPED_UPDATE_DUE_TO_NOTETYPE = (20, 69)
    IMPORTING_NOTE_UNCHANGED = (20, 70)
    IMPORTING_NOTE_UPDATED = (20, 71)
    IMPORTING_NOTE_UPDATED_AS_FILE_HAD_NEWER = (20, 72)
    IMPORTING_NOTES_ADDED = (20, 73)
    IMPORTING_NOTES_ADDED_FROM_FILE = (20, 74)
    IMPORTING_NOTES_FOUND_IN_FILE = (20, 75)
    IMPORTING_NOTES_FOUND_IN_FILE2 = (20, 76)
    IMPORTING_NOTES_SKIPPED_AS_THEYRE_ALREADY_IN = (20, 77)
    IMPORTING_NOTES_SKIPPED_UPDATE_DUE_TO_NOTETYPE = (20, 78)
    IMPORTING_NOTES_THAT_COULD_NOT_BE_IMPORTED = (20, 79)
    IMPORTING_NOTES_UPDATED = (20, 80)
    IMPORTING_NOTES_UPDATED_AS_FILE_HAD_NEWER = (20, 81)
    IMPORTING_NOTETYPE_AND_DECK = (20, 82)
    IMPORTING_NOTETYPE_HELP = (20, 83)
    IMPORTING_PACKAGED_ANKI_DECKCOLLECTION_APKG_COLPKG_ZIP = (20, 84)
    IMPORTING_PAUKER_18_LESSON_PAUGZ = (20, 85)
    IMPORTING_PIPE = (20, 86)
    IMPORTING_PRESERVE = (20, 87)
    IMPORTING_PROCESSED_CARDS = (20, 88)
    IMPORTING_PROCESSED_MEDIA_FILE = (20, 89)
    IMPORTING_PROCESSED_NOTES = (20, 90)
    IMPORTING_ROWS_HAD_NUM1D_FIELDS_EXPECTED_NUM2D = (20, 91)
    IMPORTING_SELECTED_FILE_WAS_NOT_IN_UTF8 = (20, 92)
    IMPORTING_SEMICOLON = (20, 93)
    IMPORTING_SHOW = (20, 94)
    IMPORTING_SKIPPED = (20, 95)
    IMPORTING_STATUS = (20, 96)
    IMPORTING_SUPERMEMO_XML_EXPORT_XML = (20, 97)
    IMPORTING_TAB = (20, 98)
    IMPORTING_TAG_ALL_NOTES = (20, 99)
    IMPORTING_TAG_ALL_NOTES_HELP = (20, 100)
    IMPORTING_TAG_MODIFIED_NOTES = (20, 101)
    IMPORTING_TAG_UPDATED_NOTES = (20, 102)
    IMPORTING_TAG_UPDATED_NOTES_HELP = (20, 103)
    IMPORTING_TEXT_SEPARATED_BY_TABS_OR_SEMICOLONS = (20, 104)
    IMPORTING_THE_FIRST_FIELD_OF_THE_NOTE = (20, 105)
    IMPORTING_THE_PROVIDED_FILE_IS_NOT_A = (20, 106)
    IMPORTING_THIS_FILE_DOES_NOT_APPEAR_TO = (20, 107)
    IMPORTING_THIS_WILL_DELETE_YOUR_EXISTING_COLLECTION = (20, 108)
    IMPORTING_UNABLE_TO_IMPORT_FILENAME = (20, 109)
    IMPORTING_UNABLE_TO_IMPORT_FROM_A_READONLY = (20, 110)
    IMPORTING_UNKNOWN_FILE_FORMAT = (20, 111)
    IMPORTING_UPDATE = (20, 112)
    IMPORTING_UPDATE_ALWAYS = (20, 113)
    IMPORTING_UPDATE_EXISTING_NOTES_WHEN_FIRST_FIELD = (20, 114)
    IMPORTING_UPDATE_IF_NEWER = (20, 115)
    IMPORTING_UPDATE_NEVER = (20, 116)
    IMPORTING_UPDATE_NOTES = (20, 117)
    IMPORTING_UPDATE_NOTES_HELP = (20, 118)
    IMPORTING_UPDATE_NOTETYPES = (20, 119)
    IMPORTING_UPDATE_NOTETYPES_HELP = (20, 120)
    IMPORTING_UPDATED = (20, 121)
    IMPORTING_UPDATES = (20, 122)
    IMPORTING_WITH_DECK_CONFIGS = (20, 123)
    IMPORTING_WITH_DECK_CONFIGS_HELP = (20, 124)
    KEYBOARD_CTRL = (21, 0)
    KEYBOARD_SHIFT = (21, 1)
