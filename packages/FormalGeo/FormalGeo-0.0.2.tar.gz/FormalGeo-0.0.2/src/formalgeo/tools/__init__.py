...
__all__ = [
    ...
    "get_used_pid_and_theorem", "draw_solution_tree_and_theorem_dag"
]
...
from formalgeo.tools.output import get_used_pid_and_theorem, draw_solution_tree_and_theorem_dag
