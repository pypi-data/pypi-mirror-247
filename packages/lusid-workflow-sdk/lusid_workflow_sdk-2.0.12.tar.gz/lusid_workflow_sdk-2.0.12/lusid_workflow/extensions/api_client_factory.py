...
from lusid_workflow.extensions.retry import (
    RetryingRestWrapper,
...
from lusid_workflow.extensions.tcp_keep_alive_connector import (
...
class SyncApiClientFactory:
    ...
    def build(
        ...
        ----------
        metaclass : Type[T]
            A lusid_workflow.api class.


        Returns
        -------
        T
            An instance of the lusid_workflow.api class with a configured ApiClient
        """
