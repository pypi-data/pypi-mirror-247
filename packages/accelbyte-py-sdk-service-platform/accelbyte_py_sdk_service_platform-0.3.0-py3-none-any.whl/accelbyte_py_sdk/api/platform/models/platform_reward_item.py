...
class PlatformRewardItem(Model):
    """Platform reward item (PlatformRewardItem)
    ...
    def with_item_type(self, value: str) -> PlatformRewardItem:
    ...
    def create_from_any(
        ...
        PlatformRewardItem, List[PlatformRewardItem], Dict[Any, PlatformRewardItem]
    ]:
        if many:
