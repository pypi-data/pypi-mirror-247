...
class RegionDataItemDTO(Model):
    """Region data DTO Object, it's used when create/update item (RegionDataItemDTO)
    ...
    def with_currency_code(self, value: str) -> RegionDataItemDTO:
        self.currency_code = value
        return self

    def with_currency_namespace(self, value: str) -> RegionDataItemDTO:
    ...
    def with_price(self, value: int) -> RegionDataItemDTO:
        self.price = value
        return self

    def with_discount_amount(self, value: int) -> RegionDataItemDTO:
        self.discount_amount = value
        return self

    def with_discount_expire_at(self, value: str) -> RegionDataItemDTO:
        self.discount_expire_at = value
        return self

    def with_discount_percentage(self, value: int) -> RegionDataItemDTO:
        self.discount_percentage = value
        return self

    def with_discount_purchase_at(self, value: str) -> RegionDataItemDTO:
        self.discount_purchase_at = value
        return self

    def with_expire_at(self, value: str) -> RegionDataItemDTO:
        self.expire_at = value
        return self

    def with_purchase_at(self, value: str) -> RegionDataItemDTO:
        self.purchase_at = value
        return self

    def with_trial_price(self, value: int) -> RegionDataItemDTO:
    ...
    def create_from_any(
        ...
        RegionDataItemDTO, List[RegionDataItemDTO], Dict[Any, RegionDataItemDTO]
    ]:
        if many:
