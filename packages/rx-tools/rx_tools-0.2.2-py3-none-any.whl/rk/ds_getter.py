...
class ds_getter:
    ...
    def __init__(self, q2bin, trig, year, version, partition, kind, sel):
        ...
        self._l_kind    = ['sign', 'ctrl', 'ctrl_pi', 'psi2', 'data', 'cmb', 'bp_x', 'bd_x', 'bs_x', 'bdks', 'bpks', 'bdkpi', 'bpkkk', 'bpkpipi']
    ...
    def _get_sample(self):
        ...
        if   self._kind == 'bp_x': 
            ...
            proc = 'bsXcHs'
        elif self._kind in ['data', 'cmb', 'sign', 'ctrl', 'ctrl_pi', 'psi2', 'bdks', 'bpks', 'bdkpi', 'bdkpi', 'bpkkk', 'bpkpipi']:
            proc = self._kind
        else:
