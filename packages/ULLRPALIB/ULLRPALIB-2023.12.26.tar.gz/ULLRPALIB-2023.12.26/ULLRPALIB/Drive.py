...
def record_complete_execution(auto_number,execution_start=None):
    ...
    execution_row = pd.DataFrame({
        'Automatización': "{:0>4}".format(auto_number),
        ...
        'Notas': f'Ejecución rutinaria de la automatización {"{:0>4}".format(auto_number)}' if routine_check else None
    },index=[0])
