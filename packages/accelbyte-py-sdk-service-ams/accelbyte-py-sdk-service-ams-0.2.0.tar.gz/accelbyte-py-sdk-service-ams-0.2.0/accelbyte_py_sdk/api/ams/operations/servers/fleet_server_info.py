...
class FleetServerInfo(Operation):
    ...
    def with_namespace(self, value: str) -> FleetServerInfo:
        self.namespace = value
        return self

    def with_server_id(self, value: str) -> FleetServerInfo:
    ...
    def parse_response(
        ...
        Union[None, ApiFleetServerInfoResponse],
        ...
        if code == 200:
            return ApiFleetServerInfoResponse.create_from_dict(content), None
        if code == 401:
    ...
    @classmethod
    def create(cls, namespace: str, server_id: str, **kwargs) -> FleetServerInfo:
        instance = cls()
