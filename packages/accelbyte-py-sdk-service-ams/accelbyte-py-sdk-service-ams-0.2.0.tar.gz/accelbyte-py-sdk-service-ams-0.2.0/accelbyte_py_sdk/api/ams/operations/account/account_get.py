...
class AccountGet(Operation):
    ...
    def with_namespace(self, value: str) -> AccountGet:
    ...
    @classmethod
    def create(cls, namespace: str, **kwargs) -> AccountGet:
        instance = cls()
        instance.namespace = namespace
        return instance

    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> AccountGet:
        instance = cls()
