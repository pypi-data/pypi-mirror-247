...
class FleetClaimByID(Operation):
    ...
    def with_body(self, value: ApiFleetClaimReq) -> FleetClaimByID:
        self.body = value
        return self

    def with_fleet_id(self, value: str) -> FleetClaimByID:
        self.fleet_id = value
        return self

    def with_namespace(self, value: str) -> FleetClaimByID:
    ...
    @classmethod
    def create(
        cls, body: ApiFleetClaimReq, fleet_id: str, namespace: str, **kwargs
    ) -> FleetClaimByID:
        instance = cls()
        instance.body = body
