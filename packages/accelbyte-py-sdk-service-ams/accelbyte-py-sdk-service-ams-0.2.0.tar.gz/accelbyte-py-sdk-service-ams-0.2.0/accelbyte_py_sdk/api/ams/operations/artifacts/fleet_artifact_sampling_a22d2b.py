...
class FleetArtifactSamplingRulesSet(Operation):
    ...
    def with_fleet_id(self, value: str) -> FleetArtifactSamplingRulesSet:
        self.fleet_id = value
        return self

    def with_namespace(self, value: str) -> FleetArtifactSamplingRulesSet:
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = ApiFleetArtifactsSampleRules()
    ...
    @classmethod
    def create(
        cls, body: ApiFleetArtifactsSampleRules, fleet_id: str, namespace: str, **kwargs
    ) -> FleetArtifactSamplingRulesSet:
        instance = cls()
        instance.body = body
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ApiFleetArtifactsSampleRules.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = ApiFleetArtifactsSampleRules()
