...
class ApiAccountLinkResponse(Model):
    ...
    def with_namespaces(self, value: List[str]) -> ApiAccountLinkResponse:
    ...
    def create_many_from_dict(
        cls, dict_: dict, include_empty: bool = False
    ) -> Dict[str, ApiAccountLinkResponse]:
        return (
    ...
    def create_from_any(
        ...
        ApiAccountLinkResponse,
        List[ApiAccountLinkResponse],
        Dict[Any, ApiAccountLinkResponse],
    ]:
        if many:
