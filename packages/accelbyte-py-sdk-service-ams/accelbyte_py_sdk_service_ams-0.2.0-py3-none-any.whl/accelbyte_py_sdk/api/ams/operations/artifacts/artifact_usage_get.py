...
class ArtifactUsageGet(Operation):
    ...
    def with_namespace(self, value: str) -> ArtifactUsageGet:
    ...
    def parse_response(
        ...
        Union[None, ApiArtifactUsageResponse],
        ...
        if code == 200:
            return ApiArtifactUsageResponse.create_from_dict(content), None
        if code == 401:
    ...
    @classmethod
    def create(cls, namespace: str, **kwargs) -> ArtifactUsageGet:
        instance = cls()
