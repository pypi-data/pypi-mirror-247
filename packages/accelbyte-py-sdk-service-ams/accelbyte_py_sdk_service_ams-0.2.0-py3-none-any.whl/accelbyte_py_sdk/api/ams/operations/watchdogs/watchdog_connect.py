...
class WatchdogConnect(Operation):
    ...
    def with_namespace(self, value: str) -> WatchdogConnect:
        self.namespace = value
        return self

    def with_watchdog_id(self, value: str) -> WatchdogConnect:
    ...
    @classmethod
    def create(cls, namespace: str, watchdog_id: str, **kwargs) -> WatchdogConnect:
        instance = cls()
