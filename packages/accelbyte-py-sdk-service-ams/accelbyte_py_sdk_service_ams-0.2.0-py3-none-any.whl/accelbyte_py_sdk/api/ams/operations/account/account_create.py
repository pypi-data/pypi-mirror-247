...
class AccountCreate(Operation):
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = ApiAccountCreateRequest()
    ...
    def parse_response(
        ...
        Union[None, ApiAccountCreateResponse],
        ...
        if code == 201:
            return ApiAccountCreateResponse.create_from_dict(content), None
        if code == 401:
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            ...
            instance.body = ApiAccountCreateRequest()
