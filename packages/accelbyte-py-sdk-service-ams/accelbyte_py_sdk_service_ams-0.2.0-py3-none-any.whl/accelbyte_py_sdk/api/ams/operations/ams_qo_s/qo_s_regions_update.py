...
class QoSRegionsUpdate(Operation):
    ...
    def with_body(self, value: ApiUpdateServerRequest) -> QoSRegionsUpdate:
        self.body = value
        return self

    def with_namespace(self, value: str) -> QoSRegionsUpdate:
        self.namespace = value
        return self

    def with_region(self, value: str) -> QoSRegionsUpdate:
        self.region = value
        return self
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = ApiUpdateServerRequest()
    ...
    @classmethod
    def create(
        cls, body: ApiUpdateServerRequest, namespace: str, region: str, **kwargs
    ) -> QoSRegionsUpdate:
        instance = cls()
        instance.body = body
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ApiUpdateServerRequest.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = ApiUpdateServerRequest()
