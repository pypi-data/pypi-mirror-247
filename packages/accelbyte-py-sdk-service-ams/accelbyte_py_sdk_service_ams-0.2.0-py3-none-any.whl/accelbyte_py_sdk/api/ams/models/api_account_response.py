...
class ApiAccountResponse(Model):
    """Api account response (api.AccountResponse)
    ...
    def with_id(self, value: str) -> ApiAccountResponse:
        self.id_ = value
        return self

    def with_limits(self, value: ApiAccountLimits) -> ApiAccountResponse:
        self.limits = value
        return self

    def with_name(self, value: str) -> ApiAccountResponse:
        self.name = value
        return self

    def with_namespaces(self, value: List[str]) -> ApiAccountResponse:
