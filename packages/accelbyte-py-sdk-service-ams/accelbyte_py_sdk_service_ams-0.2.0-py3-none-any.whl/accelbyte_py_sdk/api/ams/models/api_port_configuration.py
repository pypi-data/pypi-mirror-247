...
class ApiPortConfiguration(Model):
    """Api port configuration (api.PortConfiguration)
    ...
    def with_name(self, value: str) -> ApiPortConfiguration:
        self.name = value
        return self

    def with_protocol(self, value: str) -> ApiPortConfiguration:
        self.protocol = value
        return self
