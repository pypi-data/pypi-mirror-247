...
class FeedbackManager:
    ...
    error_no_correct_token_for_init = error_message(
        "No access to git releases. Use a Workspace admin token. See https://www.tinybird.co/docs/guides/working-with-git.html"
    )
...
**    $ tb datasource rm {datasource}"""
    ...
    warning_confirm_drop_prefix = prompt_message(
        'Do you want to remove all pipes and Data Sources with prefix "{prefix}"?'
    )
