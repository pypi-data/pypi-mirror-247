...
setup(
    ...
    description="Filters out false positives from the novel section of the output from miRDeep2",  # Optional
    ...
    url="https://github.com/jontejj/mirdeepsquared",  # Optional
    # This should be your name or the name of the organization which owns the
    # project.
    author="Jonatan Jönsson",  # Optional
    # This should be a valid email address corresponding to the author listed
    # above.
    author_email="jontejj@gmail.com",  # Optional
    ...
    project_urls={  # Optional
        "Bug Reports": "https://github.com/jontejj/mirdeepsquared/issues",
        "Say Thanks!": "https://saythanks.io/to/jontejj",
        "Source": "https://github.com/jontejj/mirdeepsquared/",
    },
)
