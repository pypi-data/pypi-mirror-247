...
class SpeechSynthesizer:
    def __init__(
        ...
        # # in bytes(e.g. 2)
        self.tts_endpoint_url = tts_endpoint_url
        ...
        self._retry_bg_tasks: asyncio.Task[None]
    ...
    async def _init_connection(self):
        ...
        while True:
            try:
                ...
                self.websocket = await get_wrapped_ws(self.tts_endpoint_url)
    ...
    def send(self, synthesis_command: SynthesisCommand) -> None:
        self._raise_if_error_set()
        self._send_queue.put_nowait(synthesis_command)

    def finish(self) -> None:
        self._send_queue.put_nowait(StopCommand())
