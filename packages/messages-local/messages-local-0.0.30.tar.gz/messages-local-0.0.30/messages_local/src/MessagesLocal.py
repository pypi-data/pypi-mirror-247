...
# from ses_email_message.ses_email import EmailMessageAwsSesLocal
    ...
    def send_sync(self, to_recipients: List[dict] = None, cc_recipients: List[dict] = None, bcc_recipients: List[dict] = None,
        ...
        for recipient in to_recipients:
            ...
            if message_recipient_channel_id == MessageType.SMS.value and \
                ...
                message_local.__class__ = WhatsAppMessage
                ...
                message_local.__class__ = None  # TODO: add email class
            else:
                # TODO We need to add to the message Recipient country, message plain text length after template, message HTML length after template, number of attachments, attachments' types and sizes.
            ...
            message_local.__init__(original_body=body, importance=importance, to_recipients=to_recipients)
            message_local.send()
