...
class Catalog:
    ...
    def pull_dataset(  # noqa: PLR0911, C901
        ...
        *,
        ...
        # TODO maybe convert dataset_info into DatasetRecord
        ...
        custom_column_types = DatasetRecord.parse_custom_column_types(
            version_info["custom_column_types"]
        )
        custom_columns = [
        ...
        try:
            rows_responses = studio_client.dataset_rows(remote_dataset_name, version)
        except Exception:
            self.remove_dataset(shadow_dataset.name)  # cleaning up
            raise

        for rows_response in rows_responses:
