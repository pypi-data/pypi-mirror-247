...
extern Graph *CreateGraphFromEdgeList
    Proto((int * edge_list, int *matching, int nr, int nc, int nn, int just_read_file));

extern int GetNumberNodesFromEdgeList
    Proto((int * edge_list, int nn));

extern void InitializeMatching
    Proto((int * edge_list, int * matching, int nn));
