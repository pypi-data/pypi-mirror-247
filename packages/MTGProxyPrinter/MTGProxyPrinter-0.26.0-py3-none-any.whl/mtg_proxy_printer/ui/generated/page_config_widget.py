...
# Form implementation generated from reading ui file '/tmp/build-via-sdist-dky9auix/MTGProxyPrinter-0.26.0/mtg_proxy_printer/resources/ui/page_config_widget.ui'
#
...
class Ui_PageConfigWidget(object):
    def setupUi(self, PageConfigWidget):
        ...
        self.column_spacing = QtWidgets.QSpinBox(PageConfigWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.column_spacing.setMaximum(10000)
        self.column_spacing.setObjectName("column_spacing")
        self.gridLayout.addWidget(self.column_spacing, 26, 3, 1, 1)
        ...
        self.row_spacing.valueChanged['int'].connect(PageConfigWidget.validate_paper_size_settings) # type: ignore
        self.row_spacing.valueChanged['int'].connect(PageConfigWidget.page_layout_setting_changed) # type: ignore
        self.column_spacing.valueChanged['int'].connect(PageConfigWidget.validate_paper_size_settings) # type: ignore
        self.column_spacing.valueChanged['int'].connect(PageConfigWidget.page_layout_setting_changed) # type: ignore
