...
T = TypeVar("T", bound="PolarsConnectionSettingsV2Response200PolarsCloudOptions")


@_attrs_define
class PolarsConnectionSettingsV2Response200PolarsCloudOptions:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        polars_connection_settings_v2_response_200_polars_cloud_options = cls(
            aws_endpoint_url=aws_endpoint_url,
            aws_region=aws_region,
            aws_allow_http=aws_allow_http,
        ...
        polars_connection_settings_v2_response_200_polars_cloud_options.additional_properties = d
        return polars_connection_settings_v2_response_200_polars_cloud_options
