...
def kangroll_tf_001_v1_to_v4(v1, v2, mln_iterations=100, debug_mode=False):
    # 初始化17维的权重矩阵 W
    W_v3 = np.zeros((4, 17))
    ...
    def V3_simulate_MLN(H3, iterations):
        tau1, B1, tau2, B2 = H3
        u1_values = layer_one(0, tau1, B1, iterations)
...
MLN_output, NL_final = kangroll_tf_001_v1_to_v4(v1_example, v2_example, mln_iterations=100, debug_mode=True)  #True #False

#实际上V3-MLN_out,就是下一轮的初值。
