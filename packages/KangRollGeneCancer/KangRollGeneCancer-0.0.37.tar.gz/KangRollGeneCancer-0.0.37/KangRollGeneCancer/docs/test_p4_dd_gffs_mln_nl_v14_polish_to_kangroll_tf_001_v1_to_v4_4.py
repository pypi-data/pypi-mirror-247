...
for i in range(30):
    # 调用函数
    MLN_output, NL_final = kangroll_tf_001_v1_to_v4(v1_example, v2_example, u_ini_example, mln_iterations=100, debug_mode=False) #False True
...
plt.title('Combined Time Series of the Three Iterations')
plt.xlabel('Month')
plt.ylabel('Value')
plt.legend()
plt.grid(True)
