...
def validate(args, data_loader, encoder, decoders):
    ...
    return img_auc, pix_auc, img_scores, file_names
...
def test(args):
    ...
    img_auc, pix_auc, img_scores, file_names = validate(args, test_loader, encoder, decoders)
    origin_scores = []
    ...
    return img_auc, pix_auc, origin_scores