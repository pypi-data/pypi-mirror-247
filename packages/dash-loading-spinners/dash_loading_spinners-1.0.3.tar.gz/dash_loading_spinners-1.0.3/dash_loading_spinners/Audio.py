...
- thickness (number; default 10):
    The thickness of the bars (in px). The gaps between the bars will
    be half the thickness of the bar itself.
...
- width (number; default 80):
    ...
    _type = 'Audio'
    @_explicitize_args
    def __init__(self, children=None, id=Component.UNDEFINED, fullscreen_style=Component.UNDEFINED, fullscreenClassName=Component.UNDEFINED, color=Component.UNDEFINED, height=Component.UNDEFINED, width=Component.UNDEFINED, thickness=Component.UNDEFINED, fullscreen=Component.UNDEFINED, debounce=Component.UNDEFINED, show_initially=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'color', 'debounce', 'fullscreen', 'fullscreenClassName', 'fullscreen_style', 'height', 'show_initially', 'thickness', 'width']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'color', 'debounce', 'fullscreen', 'fullscreenClassName', 'fullscreen_style', 'height', 'show_initially', 'thickness', 'width']
