...
class iPlot():
    ...
    def addSADHI(self, path, color = None):
        self.gerenciador.addSADHI(path, color)
    ...
    def add_frame(self, figure, formula, lin = 1, col = 1, grafico = "plot"):

        self.mapaNomeFiguras[figure].createFrame(formula, lin, col, self.gerenciador, grafico)
