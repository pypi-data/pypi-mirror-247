...
class RequestHandler:
	...
	def start_query(self,request,**J):
		B=request;C=_get_data(B);F=C.get(_H,'');G=C.get('bindings')or{};H=lookup_request_session(B);D=[]
	...
	def streaming_open_channel(self,request,**I):G='VARIANT';F='BINARY';E='variant';D='logical_type';C='physical_type';B='type';H=_get_data(request);A={_B:_A,_E:0,'client_sequencer':1,'row_sequencer':1,'encryption_key':ENCRYPTION_KEY,'encryption_key_id':123,'table_columns':[{_G:'record_metadata',B:E,C:F,D:G},{_G:'record_content',B:E,C:F,D:G}],_D:{}};A.update(H);return A
