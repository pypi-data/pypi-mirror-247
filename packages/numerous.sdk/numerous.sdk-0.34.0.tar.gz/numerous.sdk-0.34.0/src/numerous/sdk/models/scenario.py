...
class Scenario:
    ...
    def from_document(
        ...
        components = get_components_from_scenario_document(data, input_sources_mapping)
        ...
        return Scenario(
            ...
            jobs={
                job_id: Job.from_document(job_id, job_data)
...
def _collect_input_variables(components: Iterable[Component]) -> list[InputVariable]:
    ...
    for component in list(components):
        ...
        input_variables += _collect_input_variables(component.components.values())
