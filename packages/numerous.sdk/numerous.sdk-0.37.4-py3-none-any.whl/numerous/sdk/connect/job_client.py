    ...
    def emit(self, record: logging.LogRecord) -> None:
        ...
        self._spm_client.PushExecutionLogEntries(
            spm_pb2.LogEntries(
                ...
                log_entries=[self.format(record)],
...
class JobClient:
    ...
    def __exit__(
        ...
        self.close(
            ...
            and (not isinstance(exc_value, SystemExit) or exc_value.code != 0)
        )
        return None
    ...
    def connect() -> "JobClient":
        ...
        try:
            ...
            return JobClient._from_numerous_repository()
    ...
    def close(self, error_occured: bool = False) -> None:
        """Close the JobClient.
        ...
        self._set_completed_job_status(error_occured)
