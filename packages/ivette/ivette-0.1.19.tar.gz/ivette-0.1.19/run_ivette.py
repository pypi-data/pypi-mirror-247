...
from ivette.IO_module import print_color
from ivette.supabase_module import cancel_all_jobs, downloadFile, update_job, upsert_server
from test.tested_system_info import system_info
...
def main():
    ...
    group.add_argument(
        "--cancel", help="Calcel a job", metavar="jobId")
