...
from ivette.supabase_module import get_next_job, upsert_server
...
def setUp():
    ...
    interval = 30  # seconds
    print(f"\n>  Checking for jobs every {interval} seconds.")
    upsert_server(system_info(), "online")
