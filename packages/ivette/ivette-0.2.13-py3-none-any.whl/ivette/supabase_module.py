...
def update_job(job_id: str, status='done', nproc=0, species_id: str | None = None, *, thermo_data: ThermoData | None = None):
...
def upsert_server(system_info: SystemInfo, status: str):
    ...
    try:
        ...
        # TODO: These exceptions must be handled
        return
    except httpx.ReadTimeout:
        return
    except httpx.ConnectError:
