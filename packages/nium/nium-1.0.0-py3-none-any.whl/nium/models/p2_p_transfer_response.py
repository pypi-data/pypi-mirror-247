...
class P2PTransferResponse(BaseModel):
    ...
    retrieval_reference_number: Optional[StrictStr] = Field(None, alias="retrievalReferenceNumber", description="Unique auth code generated for the transaction by the card issuance platform. This field shall be deprecated in future. Clients should use systemReferenceNumber.")
    status: Optional[StrictStr] = Field(None, description="The status value can be Pending or Approved.")
    success: Optional[StrictBool] = Field(None, description="This flag is used to specify if the transfer was successful or not.")
    ...
    __properties = ["message", "retrievalReferenceNumber", "status", "success", "systemReferenceNumber"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> P2PTransferResponse:
        """Create an instance of P2PTransferResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> P2PTransferResponse:
        """Create an instance of P2PTransferResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return P2PTransferResponse.parse_obj(obj)

        _obj = P2PTransferResponse.parse_obj({
