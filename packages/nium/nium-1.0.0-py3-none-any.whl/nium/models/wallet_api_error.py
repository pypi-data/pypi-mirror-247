...
class WalletApiError(BaseModel):
    """
    WalletApiError
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WalletApiError:
        """Create an instance of WalletApiError from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WalletApiError:
        """Create an instance of WalletApiError from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WalletApiError.parse_obj(obj)

        _obj = WalletApiError.parse_obj({
