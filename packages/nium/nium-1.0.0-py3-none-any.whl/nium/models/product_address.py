...
class ProductAddress(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProductAddress:
        """Create an instance of ProductAddress from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProductAddress:
        """Create an instance of ProductAddress from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProductAddress.parse_obj(obj)

        _obj = ProductAddress.parse_obj({
