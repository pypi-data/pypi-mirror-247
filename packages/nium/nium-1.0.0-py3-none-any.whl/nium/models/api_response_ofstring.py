...
class ApiResponseOfstring(BaseModel):
    """
    ApiResponseOfstring
    """
    body: Optional[StrictStr] = Field(None, description="This field will return the response message from the server.")
    code: Optional[StrictStr] = Field(None, description="This field will return the HTTP status code with its interpretation.")
    errors: Optional[conlist(StrictStr)] = Field(None, description="Error description if any.")
    ...
    __properties = ["body", "code", "errors", "message", "status"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiResponseOfstring:
        """Create an instance of ApiResponseOfstring from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiResponseOfstring:
        """Create an instance of ApiResponseOfstring from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiResponseOfstring.parse_obj(obj)

        _obj = ApiResponseOfstring.parse_obj({
            "body": obj.get("body"),
            "code": obj.get("code"),
