...
class ApiResponseOfWalletRefundResponseDTO(BaseModel):
    """
    ApiResponseOfWalletRefundResponseDTO
    """
    body: Optional[WalletRefundResponseDTO] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiResponseOfWalletRefundResponseDTO:
        """Create an instance of ApiResponseOfWalletRefundResponseDTO from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiResponseOfWalletRefundResponseDTO:
        """Create an instance of ApiResponseOfWalletRefundResponseDTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiResponseOfWalletRefundResponseDTO.parse_obj(obj)

        _obj = ApiResponseOfWalletRefundResponseDTO.parse_obj({
            "body": WalletRefundResponseDTO.from_dict(obj.get("body")) if obj.get("body") is not None else None,
            "code": obj.get("code"),
