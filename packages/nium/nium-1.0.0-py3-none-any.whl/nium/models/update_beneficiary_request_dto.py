...
class UpdateBeneficiaryRequestDTO(BaseModel):
    """
    ...
    autosweep_payout_account: Optional[StrictBool] = Field(None, alias="autosweepPayoutAccount")
    beneficiary_account_number: Optional[StrictStr] = Field(None, alias="beneficiaryAccountNumber", description="This field accepts an account number as a beneficiary detail.")
    beneficiary_account_type: Optional[StrictStr] = Field(None, alias="beneficiaryAccountType", description="This field accepts the bank account type of the beneficiary. The account_type can be either Individual or Company.")
    ...
    beneficiary_alias: Optional[StrictStr] = Field(None, alias="beneficiaryAlias", description="This field accepts the beneficiary alias")
    ...
    beneficiary_bank_code: Optional[StrictStr] = Field(None, alias="beneficiaryBankCode", description="This field accepts the bank code of the beneficiary.")
    beneficiary_bank_name: Optional[StrictStr] = Field(None, alias="beneficiaryBankName", description="This field accepts the bank name of the beneficiary.")
    ...
    beneficiary_country_code: StrictStr = Field(..., alias="beneficiaryCountryCode", description="This field accepts the 2-letter [ISO-2 country code](https://nium-documents.s3-eu-west-1.amazonaws.com/spend-documents/Country+Code.pdf) of the beneficiary/bank.")
    ...
    beneficiary_identification_value: Optional[StrictStr] = Field(None, alias="beneficiaryIdentificationValue", description="This is an identification document number for the beneficiary.")
    ...
    destination_country: Optional[StrictStr] = Field(None, alias="destinationCountry", description="This field accepts the [ISO-2 country code](https://nium-documents.s3-eu-west-1.amazonaws.com/spend-documents/Country+Code.pdf) for the payout bank.")
    destination_currency: StrictStr = Field(..., alias="destinationCurrency", description="This field accepts the 3-letter [ISO-4217 destination currency code](https://www.iso.org/iso-4217-currency-codes.html) of the payout as per the destination country from supported corridors.")
    ...
    payout_method: StrictStr = Field(..., alias="payoutMethod", description="This field accepts the payout method for the remittance payout.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateBeneficiaryRequestDTO:
        """Create an instance of UpdateBeneficiaryRequestDTO from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateBeneficiaryRequestDTO:
        """Create an instance of UpdateBeneficiaryRequestDTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateBeneficiaryRequestDTO.parse_obj(obj)

        _obj = UpdateBeneficiaryRequestDTO.parse_obj({
