...
class CorporateDocumentUploadApplicantDetailsDTO(BaseModel):
    """
    ...
    __properties = ["documentDetails", "referenceId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CorporateDocumentUploadApplicantDetailsDTO:
        """Create an instance of CorporateDocumentUploadApplicantDetailsDTO from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CorporateDocumentUploadApplicantDetailsDTO:
        """Create an instance of CorporateDocumentUploadApplicantDetailsDTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CorporateDocumentUploadApplicantDetailsDTO.parse_obj(obj)

        _obj = CorporateDocumentUploadApplicantDetailsDTO.parse_obj({
