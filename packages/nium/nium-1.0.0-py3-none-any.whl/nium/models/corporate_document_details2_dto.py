...
class CorporateDocumentDetails2DTO(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CorporateDocumentDetails2DTO:
        """Create an instance of CorporateDocumentDetails2DTO from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CorporateDocumentDetails2DTO:
        """Create an instance of CorporateDocumentDetails2DTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CorporateDocumentDetails2DTO.parse_obj(obj)

        _obj = CorporateDocumentDetails2DTO.parse_obj({
