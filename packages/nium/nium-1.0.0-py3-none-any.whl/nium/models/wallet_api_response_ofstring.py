...
class WalletApiResponseOfstring(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WalletApiResponseOfstring:
        """Create an instance of WalletApiResponseOfstring from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WalletApiResponseOfstring:
        """Create an instance of WalletApiResponseOfstring from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WalletApiResponseOfstring.parse_obj(obj)

        _obj = WalletApiResponseOfstring.parse_obj({
            "body": obj.get("body"),
            "code": obj.get("code"),
