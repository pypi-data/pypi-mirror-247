...
class CustomerWalletBalanceApi:
    ...
    def wallet_balance(self, client_hash_id : Annotated[StrictStr, Field(..., description="Unique client identifier generated and shared before API handshake.")], customer_hash_id : Annotated[StrictStr, Field(..., description="Unique customer identifier generated on customer creation.")], wallet_hash_id : Annotated[StrictStr, Field(..., description="Unique wallet identifier generated simultaneously with customer creation.")], x_request_id : Annotated[Optional[StrictStr], Field(description="Enter a unique UUID value.")] = None, **kwargs) -> List[WalletBalanceResponseDTO]:  # noqa: E501
        ...
        :rtype: List[WalletBalanceResponseDTO]
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the wallet_balance_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.wallet_balance_with_http_info(client_hash_id, customer_hash_id, wallet_hash_id, x_request_id, **kwargs)  # noqa: E501

    @validate_arguments
    def wallet_balance_with_http_info(self, client_hash_id : Annotated[StrictStr, Field(..., description="Unique client identifier generated and shared before API handshake.")], customer_hash_id : Annotated[StrictStr, Field(..., description="Unique customer identifier generated on customer creation.")], wallet_hash_id : Annotated[StrictStr, Field(..., description="Unique wallet identifier generated simultaneously with customer creation.")], x_request_id : Annotated[Optional[StrictStr], Field(description="Enter a unique UUID value.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Wallet Balance  # noqa: E501
        ...
        >>> thread = api.wallet_balance_with_http_info(client_hash_id, customer_hash_id, wallet_hash_id, x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(List[WalletBalanceResponseDTO], status_code(int), headers(HTTPHeaderDict))
        """
        ...
        _response_types_map = {
            '200': "List[WalletBalanceResponseDTO]",
            '400': "WalletApiError",
            '401': "str",
            '403': "str",
            '404': "WalletApiError",
        ...
        return self.api_client.call_api(
            '/api/v1/client/{clientHashId}/customer/{customerHashId}/wallet/{walletHashId}', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
