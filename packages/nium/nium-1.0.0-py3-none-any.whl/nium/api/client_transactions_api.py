...
class ClientTransactionsApi:
    ...
    def client_transactions(self, client_hash_id : Annotated[StrictStr, Field(..., description="Unique client identifier generated and shared before API handshake.")], auth_code : Annotated[Optional[StrictStr], Field(description="This parameter can be used to filter the transactions based on the authorization code. In case of fund wallet transactions you can provide the systemReferenceNumber as value.")] = None, auth_currency : Annotated[Optional[StrictStr], Field(description="This parameter can filter the transactions based on auth currency and accepts 3-letter [ISO-4217 transaction currency code](https://docs.nium.com/apis/docs/currency-and-country-codes).")] = None, business_transaction : Annotated[Optional[StrictBool], Field(description="This parameter can filter the transactions based on businessTransaction flag.")] = None, card_hash_id : Annotated[Optional[StrictStr], Field(description="This field can apply the filter based on the unique card identifier generated during new/add-on card issuance.")] = None, child_customer_hash_id : Annotated[Optional[StrictStr], Field(description="This field contains the unique child customer identifier generated when new child customer created.")] = None, customer_hash_id : Annotated[Optional[StrictStr], Field(description="Unique identifier generated with customer creation.")] = None, end_date : Annotated[Optional[StrictStr], Field(description="End date for fetching the transaction details. The format for endDate is YYYY-MM-DD.")] = None, mcc : Annotated[Optional[StrictStr], Field(description="This parameter can filter the transactions based on 4-digit Merchant Category Codes.")] = None, merchant_categories : Annotated[Optional[StrictStr], Field(description="This parameter describes the merchant's type of business product or service, also known as the Merchant Category Code (MCC) such as Airlines, Restaurants etc.")] = None, merchant_city : Annotated[Optional[StrictStr], Field(description="This parameter can filter the transactions based on the merchant city field.")] = None, merchant_countries : Annotated[Optional[StrictStr], Field(description="This parameter can filter the transactions based on comma-separated list of 2-letter ISO merchant countries.")] = None, merchant_country : Annotated[Optional[StrictStr], Field(description="This parameter can filter the transactions based on the merchant country field.")] = None, merchant_name : Annotated[Optional[StrictStr], Field(description="This parameter can filter the transactions based on the merchant name field.")] = None, order : Annotated[Optional[StrictStr], Field(description="The sort order for the results.")] = None, page : Annotated[Optional[StrictInt], Field(description="This API may have lot of data in response and supports pagination. Entire response data is divided into pages with size as the upper limit on the number of data. Integer values from 0 onwards are acceptable.\\nDefault page is 0.")] = None, payment_instrument_hash_id : Annotated[Optional[StrictStr], Field(description="This parameter can filter the transactions based on comma-separated paymentInstrumentHashId.")] = None, var_property : Annotated[Optional[StrictStr], Field(description="Property")] = None, settlement_date : Annotated[Optional[StrictStr], Field(description="This parameter can filter the transactions based on the settlement date of the transaction in format yyyyMMdd.")] = None, settlement_status : Annotated[Optional[StrictStr], Field(description="This parameter can filter the transactions based on settlement status. The detailed list of possible values is available in the response of this API.")] = None, size : Annotated[Optional[StrictInt], Field(description="This will decide the number of elements per page. Typical values can be 1-20.")] = None, start_date : Annotated[Optional[StrictStr], Field(description="From date for fetching the transaction details. The format for startDate is YYYY-MM-DD.")] = None, status : Annotated[Optional[StrictStr], Field(description="This parameter can filter the transactions based on status. The detailed list of possible values is available in the response of this API.")] = None, system_trace_audit_number : Annotated[Optional[StrictStr], Field(description="This parameter can filter the transactions based on systemTraceAuditNumber.")] = None, tag_key : Annotated[Optional[StrictStr], Field(description="This parameter can filter the transactions, based on the exact value of tagKey defined against transactions. This can be used as an independent search parameter.")] = None, tag_value : Annotated[Optional[StrictStr], Field(description="This parameter can filter the transactions, based on the approximating value of tagValue(that may be mapped for a tagKey defined against transactions). This can be used as an independent search parameter.")] = None, transaction_currency : Annotated[Optional[StrictStr], Field(description="This field contains the 3-letter [ISO-4217 transaction currency code](https://www.iso.org/iso-4217-currency-codes.html).")] = None, transaction_type : Annotated[Optional[StrictStr], Field(description="This field contains the transaction can be one of the complete list of transactions mentioned in [Glossary of Transaction Types](https://docs.nium.com/baas/get-transactions#glossary-of-transaction-types).")] = None, transactions_labels_key : Annotated[Optional[StrictStr], Field(description="This parameter can filter the transactions based on transactionsLabelsKey.")] = None, transactions_labels_value : Annotated[Optional[StrictStr], Field(description="This parameter can filter the transactions based on transactionsLabelsValue.")] = None, wallet_hash_id : Annotated[Optional[StrictStr], Field(description="Unique wallet identifier generated simultaneously with customer creation.")] = None, x_request_id : Annotated[Optional[StrictStr], Field(description="Enter a unique UUID value.")] = None, **kwargs) -> ClientTransactionsResponseDTO:  # noqa: E501
        ...
        :type business_transaction: bool
        ...
        :param customer_hash_id: Unique identifier generated with customer creation.
        ...
        :rtype: ClientTransactionsResponseDTO
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the client_transactions_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.client_transactions_with_http_info(client_hash_id, auth_code, auth_currency, business_transaction, card_hash_id, child_customer_hash_id, customer_hash_id, end_date, mcc, merchant_categories, merchant_city, merchant_countries, merchant_country, merchant_name, order, page, payment_instrument_hash_id, var_property, settlement_date, settlement_status, size, start_date, status, system_trace_audit_number, tag_key, tag_value, transaction_currency, transaction_type, transactions_labels_key, transactions_labels_value, wallet_hash_id, x_request_id, **kwargs)  # noqa: E501

    @validate_arguments
    def client_transactions_with_http_info(self, client_hash_id : Annotated[StrictStr, Field(..., description="Unique client identifier generated and shared before API handshake.")], auth_code : Annotated[Optional[StrictStr], Field(description="This parameter can be used to filter the transactions based on the authorization code. In case of fund wallet transactions you can provide the systemReferenceNumber as value.")] = None, auth_currency : Annotated[Optional[StrictStr], Field(description="This parameter can filter the transactions based on auth currency and accepts 3-letter [ISO-4217 transaction currency code](https://docs.nium.com/apis/docs/currency-and-country-codes).")] = None, business_transaction : Annotated[Optional[StrictBool], Field(description="This parameter can filter the transactions based on businessTransaction flag.")] = None, card_hash_id : Annotated[Optional[StrictStr], Field(description="This field can apply the filter based on the unique card identifier generated during new/add-on card issuance.")] = None, child_customer_hash_id : Annotated[Optional[StrictStr], Field(description="This field contains the unique child customer identifier generated when new child customer created.")] = None, customer_hash_id : Annotated[Optional[StrictStr], Field(description="Unique identifier generated with customer creation.")] = None, end_date : Annotated[Optional[StrictStr], Field(description="End date for fetching the transaction details. The format for endDate is YYYY-MM-DD.")] = None, mcc : Annotated[Optional[StrictStr], Field(description="This parameter can filter the transactions based on 4-digit Merchant Category Codes.")] = None, merchant_categories : Annotated[Optional[StrictStr], Field(description="This parameter describes the merchant's type of business product or service, also known as the Merchant Category Code (MCC) such as Airlines, Restaurants etc.")] = None, merchant_city : Annotated[Optional[StrictStr], Field(description="This parameter can filter the transactions based on the merchant city field.")] = None, merchant_countries : Annotated[Optional[StrictStr], Field(description="This parameter can filter the transactions based on comma-separated list of 2-letter ISO merchant countries.")] = None, merchant_country : Annotated[Optional[StrictStr], Field(description="This parameter can filter the transactions based on the merchant country field.")] = None, merchant_name : Annotated[Optional[StrictStr], Field(description="This parameter can filter the transactions based on the merchant name field.")] = None, order : Annotated[Optional[StrictStr], Field(description="The sort order for the results.")] = None, page : Annotated[Optional[StrictInt], Field(description="This API may have lot of data in response and supports pagination. Entire response data is divided into pages with size as the upper limit on the number of data. Integer values from 0 onwards are acceptable.\\nDefault page is 0.")] = None, payment_instrument_hash_id : Annotated[Optional[StrictStr], Field(description="This parameter can filter the transactions based on comma-separated paymentInstrumentHashId.")] = None, var_property : Annotated[Optional[StrictStr], Field(description="Property")] = None, settlement_date : Annotated[Optional[StrictStr], Field(description="This parameter can filter the transactions based on the settlement date of the transaction in format yyyyMMdd.")] = None, settlement_status : Annotated[Optional[StrictStr], Field(description="This parameter can filter the transactions based on settlement status. The detailed list of possible values is available in the response of this API.")] = None, size : Annotated[Optional[StrictInt], Field(description="This will decide the number of elements per page. Typical values can be 1-20.")] = None, start_date : Annotated[Optional[StrictStr], Field(description="From date for fetching the transaction details. The format for startDate is YYYY-MM-DD.")] = None, status : Annotated[Optional[StrictStr], Field(description="This parameter can filter the transactions based on status. The detailed list of possible values is available in the response of this API.")] = None, system_trace_audit_number : Annotated[Optional[StrictStr], Field(description="This parameter can filter the transactions based on systemTraceAuditNumber.")] = None, tag_key : Annotated[Optional[StrictStr], Field(description="This parameter can filter the transactions, based on the exact value of tagKey defined against transactions. This can be used as an independent search parameter.")] = None, tag_value : Annotated[Optional[StrictStr], Field(description="This parameter can filter the transactions, based on the approximating value of tagValue(that may be mapped for a tagKey defined against transactions). This can be used as an independent search parameter.")] = None, transaction_currency : Annotated[Optional[StrictStr], Field(description="This field contains the 3-letter [ISO-4217 transaction currency code](https://www.iso.org/iso-4217-currency-codes.html).")] = None, transaction_type : Annotated[Optional[StrictStr], Field(description="This field contains the transaction can be one of the complete list of transactions mentioned in [Glossary of Transaction Types](https://docs.nium.com/baas/get-transactions#glossary-of-transaction-types).")] = None, transactions_labels_key : Annotated[Optional[StrictStr], Field(description="This parameter can filter the transactions based on transactionsLabelsKey.")] = None, transactions_labels_value : Annotated[Optional[StrictStr], Field(description="This parameter can filter the transactions based on transactionsLabelsValue.")] = None, wallet_hash_id : Annotated[Optional[StrictStr], Field(description="Unique wallet identifier generated simultaneously with customer creation.")] = None, x_request_id : Annotated[Optional[StrictStr], Field(description="Enter a unique UUID value.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Client Transactions  # noqa: E501
        ...
        >>> thread = api.client_transactions_with_http_info(client_hash_id, auth_code, auth_currency, business_transaction, card_hash_id, child_customer_hash_id, customer_hash_id, end_date, mcc, merchant_categories, merchant_city, merchant_countries, merchant_country, merchant_name, order, page, payment_instrument_hash_id, var_property, settlement_date, settlement_status, size, start_date, status, system_trace_audit_number, tag_key, tag_value, transaction_currency, transaction_type, transactions_labels_key, transactions_labels_value, wallet_hash_id, x_request_id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ClientTransactionsResponseDTO, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method client_transactions" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        if _params.get('wallet_hash_id') is not None:  # noqa: E501
            _query_params.append(('walletHashId', _params['wallet_hash_id']))
        ...
        _response_types_map = {
            '200': "ClientTransactionsResponseDTO",
            '400': "WalletApiError",
            '401': "str",
            '403': "str",
            '404': "WalletApiError",
        ...
        return self.api_client.call_api(
            '/api/v1/client/{clientHashId}/transactions', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
