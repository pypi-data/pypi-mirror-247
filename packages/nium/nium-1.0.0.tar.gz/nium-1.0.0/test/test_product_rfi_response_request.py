...
from nium.models.product_rfi_response_request import ProductRfiResponseRequest  # noqa: E501

class TestProductRfiResponseRequest(unittest.TestCase):
    """ProductRfiResponseRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProductRfiResponseRequest:
        """Test ProductRfiResponseRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProductRfiResponseRequest`
        """
        model = ProductRfiResponseRequest()  # noqa: E501
        if include_optional:
            return ProductRfiResponseRequest(
                business_info = nium.models.business_details2.BusinessDetails2(
                    additional_info = {
                        'key' : ''
                        }, 
    ...
    def testProductRfiResponseRequest(self):
        """Test ProductRfiResponseRequest"""
