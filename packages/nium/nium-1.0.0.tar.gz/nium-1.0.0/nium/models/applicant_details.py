...
class ApplicantDetails(BaseModel):
    ...
    ApplicantDetails
    """
    additional_info: Optional[Dict[str, StrictStr]] = Field(None, alias="additionalInfo", description="This object accepts the applicant's additional information.  AU: NA EU: Required UK: NA SG: NA")
    address: Optional[ProductAddress] = None
    birth_country: Optional[StrictStr] = Field(None, alias="birthCountry", description="This field accepts the 2-letter [ISO Alpha-2 country code](https://nium-documents.s3-eu-west-1.amazonaws.com/spend-documents/Country+Code.pdf) as an applicant's birth country.  AU: NA EU: Required UK: NA SG: NA")
    contact_details: Optional[ContactDetails] = Field(None, alias="contactDetails")
    date_of_birth: Optional[StrictStr] = Field(None, alias="dateOfBirth", description="This field accepts the date of birth of the applicant in yyyy-MM-dd format.  AU: Required EU: Required UK: Required SG: Optional")
    document_details: Optional[conlist(ProductDocumentDetail)] = Field(None, alias="documentDetails", description="This array accepts the applicant document details. This field is required only if the documents are being uploaded.  AU: Optional EU: Required UK: Optional SG: Optional")
    first_name: Optional[StrictStr] = Field(None, alias="firstName", description="This field accepts the first name of the applicant. Maximum character limit: 40  AU: Required EU: Required UK: Required SG: Optional")
    gender: Optional[StrictStr] = Field(None, description="This field accepts the gender of the applicant. The acceptable values are: Male Female  AU: Required EU: NA UK: NA SG: NA")
    kyc_mode: Optional[StrictStr] = Field(None, alias="kycMode", description="This object accepts the desired mode to do the KYC of the individual applicant.  AU: Optional EU: Optional UK: Optional SG: Optional")
    last_name: Optional[StrictStr] = Field(None, alias="lastName", description="This field accepts the last name of the applicant. Maximum character limit: 40  AU: Required EU: Required UK: Required SG: Optional")
    middle_name: Optional[StrictStr] = Field(None, alias="middleName", description="This field accepts the middle name of the applicant. Maximum character limit: 40  AU: Optional EU: Optional UK: Optional SG: Optional")
    nationality: Optional[StrictStr] = Field(None, description="This field accepts the 2-letter [ISO Alpha-2 country code](https://nium-documents.s3-eu-west-1.amazonaws.com/spend-documents/Country+Code.pdf) for the nationality of the applicant.  AU: Required EU: Required UK: Required SG: Required")
    ...
    professional_details: Optional[conlist(ProductProfessionalDetails)] = Field(None, alias="professionalDetails", description="This array accepts the professional details of the applicant.  AU: Required EU: Required UK: Required SG: Required")
    reference_id: Optional[StrictStr] = Field(None, alias="referenceId", description="This field accepts the unique reference ID for the Applicant provided by client.  AU: Optional EU: Optional UK: Optional SG: Optional")
    tax_details: Optional[conlist(ProductTaxDetails)] = Field(None, alias="taxDetails", description="This array accepts the applicant's tax details.  AU: NA EU: Optional UK: NA SG: NA")
    __properties = ["additionalInfo", "address", "birthCountry", "contactDetails", "dateOfBirth", "documentDetails", "firstName", "gender", "kycMode", "lastName", "middleName", "nationality", "occupation", "professionalDetails", "referenceId", "taxDetails"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApplicantDetails:
        """Create an instance of ApplicantDetails from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApplicantDetails:
        """Create an instance of ApplicantDetails from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApplicantDetails.parse_obj(obj)

        _obj = ApplicantDetails.parse_obj({
