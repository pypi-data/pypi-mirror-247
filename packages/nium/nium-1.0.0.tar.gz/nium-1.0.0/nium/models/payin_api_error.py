...
class PayinApiError(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PayinApiError:
        """Create an instance of PayinApiError from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PayinApiError:
        """Create an instance of PayinApiError from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PayinApiError.parse_obj(obj)

        _obj = PayinApiError.parse_obj({
