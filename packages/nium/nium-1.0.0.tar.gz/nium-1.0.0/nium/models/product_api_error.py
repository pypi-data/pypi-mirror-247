...
class ProductApiError(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProductApiError:
        """Create an instance of ProductApiError from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProductApiError:
        """Create an instance of ProductApiError from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProductApiError.parse_obj(obj)

        _obj = ProductApiError.parse_obj({
