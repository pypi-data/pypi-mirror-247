...
class CorporateRegisteredAddress(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CorporateRegisteredAddress:
        """Create an instance of CorporateRegisteredAddress from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CorporateRegisteredAddress:
        """Create an instance of CorporateRegisteredAddress from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CorporateRegisteredAddress.parse_obj(obj)

        _obj = CorporateRegisteredAddress.parse_obj({
