...
class Addresses(BaseModel):
    ...
    registered_address: Optional[RegisteredAddress] = Field(None, alias="registeredAddress")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Addresses:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Addresses:
        """Create an instance of Addresses from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Addresses.parse_obj(obj)

        _obj = Addresses.parse_obj({
            "business_address": BusinessAddress.from_dict(obj.get("businessAddress")) if obj.get("businessAddress") is not None else None,
            "registered_address": RegisteredAddress.from_dict(obj.get("registeredAddress")) if obj.get("registeredAddress") is not None else None
        })
        return _obj
