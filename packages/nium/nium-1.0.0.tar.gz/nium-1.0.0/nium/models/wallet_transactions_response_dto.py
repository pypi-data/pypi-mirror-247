...
class WalletTransactionsResponseDTO(BaseModel):
    """
    WalletTransactionsResponseDTO
    """
    content: Optional[conlist(TransactionResponseDTO)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WalletTransactionsResponseDTO:
        """Create an instance of WalletTransactionsResponseDTO from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WalletTransactionsResponseDTO:
        """Create an instance of WalletTransactionsResponseDTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WalletTransactionsResponseDTO.parse_obj(obj)

        _obj = WalletTransactionsResponseDTO.parse_obj({
