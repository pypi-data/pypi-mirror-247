...
class AddCardResponseDTO(BaseModel):
    """
    AddCardResponseDTO
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AddCardResponseDTO:
        """Create an instance of AddCardResponseDTO from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AddCardResponseDTO:
        """Create an instance of AddCardResponseDTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AddCardResponseDTO.parse_obj(obj)

        _obj = AddCardResponseDTO.parse_obj({
