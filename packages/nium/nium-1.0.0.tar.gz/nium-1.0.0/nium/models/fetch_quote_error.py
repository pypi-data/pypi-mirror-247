...
class FetchQuoteError(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FetchQuoteError:
        """Create an instance of FetchQuoteError from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FetchQuoteError:
        """Create an instance of FetchQuoteError from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FetchQuoteError.parse_obj(obj)

        _obj = FetchQuoteError.parse_obj({
            "code": obj.get("code"),
