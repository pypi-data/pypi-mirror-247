...
class DatasourceType(Enum):
    ...
    DatabaseSource = "bitfount.DatabaseSource"
    DataFrameSource = "bitfount.DataFrameSource"
    DICOMSource = "bitfount.DICOMSource"
    ExcelSource = "bitfount.ExcelSource"
    DropColsDataview = "bitfount.DropColsDataview"
    SQLDataView = "bitfount.SQLDataView"
