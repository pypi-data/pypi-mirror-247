...
from turcar.codeview import CodeView
from turcar.config_ui import ConfigurationPage
from turcar.languages import tr
from turcar.shell import BaseShellText
from turcar.ui_utils import create_string_var, scrollbar_style
...
class ThemeAndFontConfigurationPage(ConfigurationPage):
    ...
    def _init_previews(self):
        ...
        ttk.Label(
            self,
            text=tr("NB! Some style elements change only after restarting turcar!"),
