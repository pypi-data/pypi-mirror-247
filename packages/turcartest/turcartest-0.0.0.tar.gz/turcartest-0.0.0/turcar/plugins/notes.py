...
from turcar import turcar_USER_DIR, get_workbench, ui_utils
from turcar.languages import tr
from turcar.tktextext import EnhancedText, TextFrame
from turcar.ui_utils import TextMenu
...
class NotesView(TextFrame):
    def __init__(self, master):
        self.filename = os.path.join(turcar_USER_DIR, "user_notes.txt")
        super().__init__(
        ...
        if not os.path.isfile(self.filename):
            self.text.insert(
                ...
                tr(
                    ...
                    + "and loaded when you open turcar next time.\n\n"
