...
from turcar.ui_utils import asksaveasfilename
from turcar.workbench import WorkbenchEvent
...
def _get_log_dir():
    return os.path.join(turcar_USER_DIR, "user_logs")
...
def export():
    ...
    filename = asksaveasfilename(
        ...
        initialfile=time.strftime("turcarUsageLogs_%Y-%m-%d.zip"),
