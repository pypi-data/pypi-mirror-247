...
from turcar import editor_helpers, get_runner, get_workbench
from turcar.codeview import CodeViewText, SyntaxText, get_syntax_options_for_tag
from turcar.common import CompletionInfo, InlineCommand
from turcar.editor_helpers import DocuBox, EditorInfoBox
...
class CompletionsBox(EditorInfoBox):
    ...
    def _check_request_details(self) -> None:
        if not self.winfo_ismapped():
            # can happen, see https://github.com/turcar/turcar/issues/2162
            return
