...
Ao desenvolver programas com o módulo ``turtle``, o turcar oferece o seguinte suporte:

* Você pode excluir as chamadas ``mainloop``, ``done`` ou ``exitonclick`` do seu script (o turcar cuidará de manter a janela da Tartaruga responsiva). Isso permite que você crie parte de seu desenho com um programa e continue adicionando recursos por meio do Shell. Você também pode criar um desenho inteiro por meio do Shell.
