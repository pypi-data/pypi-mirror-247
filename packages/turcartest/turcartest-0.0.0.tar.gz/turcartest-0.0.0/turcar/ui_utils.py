...
from turcar import get_workbench, misc_utils, tktextext
from turcar.common import TextRange
from turcar.custom_notebook import CustomNotebook, CustomNotebookPage, CustomNotebookTab
from turcar.languages import get_button_padding, tr
...
from turcar.tktextext import TweakableText
...
class CommonDialog(tk.Toplevel):
    def __init__(self, master=None, skip_tk_dialog_attributes=False, **kw):
        assert master
        super().__init__(master=master, class_="turcar", **kw)
...
def _check_dialog_parent(options):
    ...
    if running_on_mac_os():
        ...
        # but this is deprecated in Catalina (https://github.com/turcar/turcar/issues/840)
...
def handle_mistreated_latin_shortcuts(registry, event):
    ...
    # See: https://bitbucket.org/plas/turcar/issues/422/edit-keyboard-shortcuts-ctrl-c-ctrl-v-etc
