...
class AuthorizationForm(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyromodz.raw.base.account.AuthorizationForm`.
    ...
    Parameters:
        required_types (List of :obj:`SecureRequiredType <pyromodz.raw.base.SecureRequiredType>`):
            N/A

        values (List of :obj:`SecureValue <pyromodz.raw.base.SecureValue>`):
            N/A

        errors (List of :obj:`SecureValueError <pyromodz.raw.base.SecureValueError>`):
            N/A
