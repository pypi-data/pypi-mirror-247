...
class BoostsStatus(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyromodz.raw.base.premium.BoostsStatus`.
    ...
    Parameters:
        ...
        premium_audience (:obj:`StatsPercentValue <pyromodz.raw.base.StatsPercentValue>`, *optional*):
            N/A

        prepaid_giveaways (List of :obj:`PrepaidGiveaway <pyromodz.raw.base.PrepaidGiveaway>`, *optional*):
            N/A
