...
class InputChatUploadedPhoto(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyromodz.raw.base.InputChatPhoto`.
    ...
    Parameters:
        file (:obj:`InputFile <pyromodz.raw.base.InputFile>`, *optional*):
            N/A

        video (:obj:`InputFile <pyromodz.raw.base.InputFile>`, *optional*):
            N/A

        video_start_ts (``float`` ``64-bit``, *optional*):
            N/A

        video_emoji_markup (:obj:`VideoSize <pyromodz.raw.base.VideoSize>`, *optional*):
            N/A
