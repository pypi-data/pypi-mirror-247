...
class ExportedChatlistInvite(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyromodz.raw.base.chatlists.ExportedChatlistInvite`.
    ...
    Parameters:
        filter (:obj:`DialogFilter <pyromodz.raw.base.DialogFilter>`):
            N/A

        invite (:obj:`ExportedChatlistInvite <pyromodz.raw.base.ExportedChatlistInvite>`):
            N/A
