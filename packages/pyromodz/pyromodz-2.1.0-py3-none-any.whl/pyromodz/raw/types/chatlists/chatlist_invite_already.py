...
class ChatlistInviteAlready(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyromodz.raw.base.chatlists.ChatlistInvite`.
    ...
    Parameters:
        ...
        missing_peers (List of :obj:`Peer <pyromodz.raw.base.Peer>`):
            N/A

        already_peers (List of :obj:`Peer <pyromodz.raw.base.Peer>`):
            N/A
