...
class PhoneCall(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyromodz.raw.base.PhoneCall`.
    ...
    Parameters:
        ...
        protocol (:obj:`PhoneCallProtocol <pyromodz.raw.base.PhoneCallProtocol>`):
            N/A

        connections (List of :obj:`PhoneConnection <pyromodz.raw.base.PhoneConnection>`):
            N/A
