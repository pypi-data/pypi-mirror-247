...
class InputMediaUploadedDocument(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyromodz.raw.base.InputMedia`.
    ...
    Parameters:
        file (:obj:`InputFile <pyromodz.raw.base.InputFile>`):
            N/A

        mime_type (``str``):
            N/A

        attributes (List of :obj:`DocumentAttribute <pyromodz.raw.base.DocumentAttribute>`):
            N/A
        ...
        thumb (:obj:`InputFile <pyromodz.raw.base.InputFile>`, *optional*):
            N/A

        stickers (List of :obj:`InputDocument <pyromodz.raw.base.InputDocument>`, *optional*):
            N/A
