...
class ChannelAdminLogEventActionChangeBackgroundEmoji(TLObject):  # type: ignore
    """Telegram API type.
    ...
    ID = 0x445fc434
    QUALNAME = "types.ChannelAdminLogEventActionChangeBackgroundEmoji"
    ...
    @staticmethod
    def read(b: BytesIO, *args: Any) -> "ChannelAdminLogEventActionChangeBackgroundEmoji":
        # No flags
        ...
        return ChannelAdminLogEventActionChangeBackgroundEmoji(prev_value=prev_value, new_value=new_value)
