...
class MegagroupStats(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyromodz.raw.base.stats.MegagroupStats`.
    ...
    Parameters:
        ...
        members (:obj:`StatsAbsValueAndPrev <pyromodz.raw.base.StatsAbsValueAndPrev>`):
            N/A

        messages (:obj:`StatsAbsValueAndPrev <pyromodz.raw.base.StatsAbsValueAndPrev>`):
            N/A

        viewers (:obj:`StatsAbsValueAndPrev <pyromodz.raw.base.StatsAbsValueAndPrev>`):
            N/A

        posters (:obj:`StatsAbsValueAndPrev <pyromodz.raw.base.StatsAbsValueAndPrev>`):
            N/A

        growth_graph (:obj:`StatsGraph <pyromodz.raw.base.StatsGraph>`):
            N/A

        members_graph (:obj:`StatsGraph <pyromodz.raw.base.StatsGraph>`):
            N/A

        new_members_by_source_graph (:obj:`StatsGraph <pyromodz.raw.base.StatsGraph>`):
            N/A

        languages_graph (:obj:`StatsGraph <pyromodz.raw.base.StatsGraph>`):
            N/A

        messages_graph (:obj:`StatsGraph <pyromodz.raw.base.StatsGraph>`):
            N/A

        actions_graph (:obj:`StatsGraph <pyromodz.raw.base.StatsGraph>`):
            N/A

        top_hours_graph (:obj:`StatsGraph <pyromodz.raw.base.StatsGraph>`):
            N/A

        weekdays_graph (:obj:`StatsGraph <pyromodz.raw.base.StatsGraph>`):
            N/A

        top_posters (List of :obj:`StatsGroupTopPoster <pyromodz.raw.base.StatsGroupTopPoster>`):
            N/A

        top_admins (List of :obj:`StatsGroupTopAdmin <pyromodz.raw.base.StatsGroupTopAdmin>`):
            N/A

        top_inviters (List of :obj:`StatsGroupTopInviter <pyromodz.raw.base.StatsGroupTopInviter>`):
            N/A
