...
class PageBlockRelatedArticles(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyromodz.raw.base.PageBlock`.
    ...
    Parameters:
        title (:obj:`RichText <pyromodz.raw.base.RichText>`):
            N/A

        articles (List of :obj:`PageRelatedArticle <pyromodz.raw.base.PageRelatedArticle>`):
            N/A
