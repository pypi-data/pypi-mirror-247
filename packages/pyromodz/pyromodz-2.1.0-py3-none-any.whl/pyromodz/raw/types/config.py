...
class Config(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyromodz.raw.base.Config`.
    ...
    Parameters:
        ...
        dc_options (List of :obj:`DcOption <pyromodz.raw.base.DcOption>`):
            N/A
        ...
        reactions_default (:obj:`Reaction <pyromodz.raw.base.Reaction>`, *optional*):
            N/A
