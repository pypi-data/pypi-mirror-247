...
class SearchResultsPositions(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyromodz.raw.base.messages.SearchResultsPositions`.
    ...
    Parameters:
        ...
        positions (List of :obj:`SearchResultsPosition <pyromodz.raw.base.SearchResultsPosition>`):
            N/A
