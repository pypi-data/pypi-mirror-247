...
class AttachMenuBot(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyromodz.raw.base.AttachMenuBot`.
    ...
    Parameters:
        ...
        icons (List of :obj:`AttachMenuBotIcon <pyromodz.raw.base.AttachMenuBotIcon>`):
            N/A
        ...
        peer_types (List of :obj:`AttachMenuPeerType <pyromodz.raw.base.AttachMenuPeerType>`, *optional*):
            N/A
