...
class GroupCall(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyromodz.raw.base.phone.GroupCall`.
    ...
    Parameters:
        call (:obj:`GroupCall <pyromodz.raw.base.GroupCall>`):
            N/A

        participants (List of :obj:`GroupCallParticipant <pyromodz.raw.base.GroupCallParticipant>`):
            N/A
