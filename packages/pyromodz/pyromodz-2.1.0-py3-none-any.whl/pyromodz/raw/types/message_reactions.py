...
class MessageReactions(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyromodz.raw.base.MessageReactions`.
    ...
    Parameters:
        results (List of :obj:`ReactionCount <pyromodz.raw.base.ReactionCount>`):
            N/A
        ...
        recent_reactions (List of :obj:`MessagePeerReaction <pyromodz.raw.base.MessagePeerReaction>`, *optional*):
            N/A
