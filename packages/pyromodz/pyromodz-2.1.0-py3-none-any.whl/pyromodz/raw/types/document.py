...
class Document(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyromodz.raw.base.Document`.
    ...
    Parameters:
        ...
        thumbs (List of :obj:`PhotoSize <pyromodz.raw.base.PhotoSize>`, *optional*):
            N/A

        video_thumbs (List of :obj:`VideoSize <pyromodz.raw.base.VideoSize>`, *optional*):
            N/A
