...
class ImportedContacts(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyromodz.raw.base.contacts.ImportedContacts`.
    ...
    Parameters:
        imported (List of :obj:`ImportedContact <pyromodz.raw.base.ImportedContact>`):
            N/A

        popular_invites (List of :obj:`PopularContact <pyromodz.raw.base.PopularContact>`):
            N/A
