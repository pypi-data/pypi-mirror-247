...
class MediaAreaSuggestedReaction(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyromodz.raw.base.MediaArea`.
    ...
    Parameters:
        coordinates (:obj:`MediaAreaCoordinates <pyromodz.raw.base.MediaAreaCoordinates>`):
            N/A

        reaction (:obj:`Reaction <pyromodz.raw.base.Reaction>`):
            N/A
