...
class SentCode(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyromodz.raw.base.auth.SentCode`.
    ...
    Parameters:
        type (:obj:`auth.SentCodeType <pyromodz.raw.base.auth.SentCodeType>`):
            N/A

        phone_code_hash (``str``):
            N/A

        next_type (:obj:`auth.CodeType <pyromodz.raw.base.auth.CodeType>`, *optional*):
            N/A
