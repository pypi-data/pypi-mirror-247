...
class DifferenceSlice(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyromodz.raw.base.updates.Difference`.
    ...
    Parameters:
        new_messages (List of :obj:`Message <pyromodz.raw.base.Message>`):
            N/A

        new_encrypted_messages (List of :obj:`EncryptedMessage <pyromodz.raw.base.EncryptedMessage>`):
            N/A

        other_updates (List of :obj:`Update <pyromodz.raw.base.Update>`):
            N/A
        ...
        intermediate_state (:obj:`updates.State <pyromodz.raw.base.updates.State>`):
            N/A
