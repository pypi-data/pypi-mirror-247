...
class PremiumPromo(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyromodz.raw.base.help.PremiumPromo`.
    ...
    Parameters:
        ...
        status_entities (List of :obj:`MessageEntity <pyromodz.raw.base.MessageEntity>`):
            N/A

        video_sections (List of ``str``):
            N/A

        videos (List of :obj:`Document <pyromodz.raw.base.Document>`):
            N/A

        period_options (List of :obj:`PremiumSubscriptionOption <pyromodz.raw.base.PremiumSubscriptionOption>`):
            N/A
