...
class InputStorePaymentPremiumGiveaway(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyromodz.raw.base.InputStorePaymentPurpose`.
    ...
    Parameters:
        boost_peer (:obj:`InputPeer <pyromodz.raw.base.InputPeer>`):
            N/A
        ...
        additional_peers (List of :obj:`InputPeer <pyromodz.raw.base.InputPeer>`, *optional*):
            N/A
