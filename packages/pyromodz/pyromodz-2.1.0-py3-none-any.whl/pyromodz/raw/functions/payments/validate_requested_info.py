...
class ValidateRequestedInfo(TLObject):  # type: ignore
    ...
    Parameters:
        invoice (:obj:`InputInvoice <pyromodz.raw.base.InputInvoice>`):
            N/A

        info (:obj:`PaymentRequestedInfo <pyromodz.raw.base.PaymentRequestedInfo>`):
            N/A
    ...
    Returns:
        :obj:`payments.ValidatedRequestedInfo <pyromodz.raw.base.payments.ValidatedRequestedInfo>`
    """
