...
class VerifyEmail(TLObject):  # type: ignore
    ...
    Parameters:
        purpose (:obj:`EmailVerifyPurpose <pyromodz.raw.base.EmailVerifyPurpose>`):
            N/A

        verification (:obj:`EmailVerification <pyromodz.raw.base.EmailVerification>`):
            N/A

    Returns:
        :obj:`account.EmailVerified <pyromodz.raw.base.account.EmailVerified>`
    """
