...
class UpdatePasswordSettings(TLObject):  # type: ignore
    ...
    Parameters:
        password (:obj:`InputCheckPasswordSRP <pyromodz.raw.base.InputCheckPasswordSRP>`):
            N/A

        new_settings (:obj:`account.PasswordInputSettings <pyromodz.raw.base.account.PasswordInputSettings>`):
            N/A
