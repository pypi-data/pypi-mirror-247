...
class InitConnection(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        query (Any function from :obj:`~pyromodz.raw.functions`):
            N/A

        proxy (:obj:`InputClientProxy <pyromodz.raw.base.InputClientProxy>`, *optional*):
            N/A

        params (:obj:`JSONValue <pyromodz.raw.base.JSONValue>`, *optional*):
            N/A

    Returns:
        Any object from :obj:`~pyromodz.raw.types`
    """
