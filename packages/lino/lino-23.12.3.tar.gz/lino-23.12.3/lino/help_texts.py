...
help_texts = {
    ...
    'lino.api.selenium.Tour' : _("""Generates a directory of screenshots images and their index.rst file."""),
    'lino.api.selenium.Tour.screenshots' : _("""A list of tuples (name, desc), where desc is another tuple (imgname, caption, before, after)."""),
    'lino.api.selenium.Tour.stabilize' : _("""Wait until the screen has become stable. This measn that the browser has processed all Javascript, including ExtJS.onReady, that all AJAX requests have finised."""),
    'lino.api.selenium.Tour.make' : _("""Make the tour. Open a selenium driver, start the development server in background, run the main_func, write the index.rst files."""),
    ...
    'lino.mixins.periods.CombinedDateTime' : _("""Mixin for models which have at least one couple of date and time fields which form a kind of editable timestamp field."""),
    ...
    'lino.modlib.changes.ChangesByObject' : _("""Slave Table showing the direct changes related to the current object."""),
    ...
    'lino.modlib.changes.ChangesByMaster' : _("""Slave Table showing the changes related to the current object, including those applied to "child" objects."""),
    ...
    'lino.modlib.extjs.Plugin.autorefresh_seconds' : _("""Number of seconds to wait between two refreshes when autorefresh is activated. Default is 60. Set this to 0 in order to deactivate the autorefresh button."""),
    ...
    'lino.modlib.memo.parser.Parser.add_suggester' : _("""trigger is a short text, usually one character, like "@" or "#", which will trigger a list of autocomplete suggestions to pop up."""),
    ...
    'lino.utils.diag.Analyzer.show_db_overview' : _("""Return a reStructredText-formatted "database overview" report. Used by test cases in tested documents."""),
    ...
    'lino.utils.mldbc.fields.BabelTextField' : _("""Define a variable number of clones of the "master" field, one for each language . See mldbc."""),
    ...
    'lino.core.model.Model.obj2href' : _("""Return a html representation of a pointer to the given database object."""),
    'lino.core.model.Model.as_summary_row' : _("""Return a raw HTML string representing this object in a data view as a single paragraph."""),
    'lino.core.model.Model.summary_row' : _("""Yield a sequence of ElementTree elements that represent this database object in a summary panel."""),
    ...
    'lino.core.model.Model.detail_link' : _("""A simple text representation of this database row as a clickable link that opens the detail window."""),
    ...
    'lino.core.model.Model.workflow_state_field' : _("""Optional default value for workflow_state_field of all data views based on this Model."""),
    'lino.core.model.Model.workflow_owner_field' : _("""Optional default value for lino.core.table.Table.workflow_owner_field on all tables based on this Model."""),
    ...
    'lino.modlib.linod.Procedure' : _("""Is basically a Job which contains a function func to run at default interval given by every_unit and every_value."""),
    ...
    'lino.modlib.linod.BackgroundTask' : _("""Django model used to represent a background task."""),
    'lino.modlib.linod.BackgroundTask.procedure' : _("""Pointer to an instance of Procedure."""),
    'lino.modlib.linod.BackgroundTask.start_datetime' : _("""Tells at what time exactly this job started."""),
    'lino.modlib.linod.BackgroundTask.message' : _("""Stores information about the job, mostly logs."""),
    'lino.modlib.linod.BackgroundTask.disabled' : _("""Tells whether the task should be ignored."""),
    'lino.modlib.linod.BackgroundTask.log_level' : _("""The logging level to apply when running this task."""),
    'lino.modlib.linod.BackgroundTask.run' : _("""Performs a routine job."""),
    'lino.modlib.linod.BackgroundTasks' : _("""The default actor for the BackgroundTask model."""),
    'lino.modlib.linod.RunJob' : _("""Manually run this task immediately."""),
    'lino.modlib.publisher.PublisherBuildMethod' : _("""This deserves better documentation."""),
    'lino.modlib.publisher.Publishable' : _("""This deserves better documentation."""),
    'lino.modlib.publisher.PreviewPublication' : _("""This deserves better documentation."""),
    ...
    'lino.modlib.comments.Comment.owner' : _("""The topic this comment is about. This field is a Generic Foreign Key, i.e. users can basically comment on any database object. It is however the application developer who decides where comments can be created and how they are being displayed."""),
    ...
    'lino.modlib.comments.Commentable' : _("""Mixin for models whose instances can be discussion topic of comments."""),
    ...
    'lino.modlib.comments.Commentable.get_comment_group' : _("""Return either None or a database object that represents the commenting group where this comment is being done."""),
    ...
    'lino.modlib.gkfs.ContentTypes' : _("""Lino installs this as the default data view for django.contrib.ContentType."""),
    ...
    'lino.modlib.notify.Message.emit_notification' : _("""Emit a notification message to each the given recipients, respecting their individual user preferences."""),
    ...
    'lino.modlib.printing.Printable.get_printable_demo_objects' : _("""Return an iterable of database objects for which Lino should generate a printable excerpt."""),
    ...
    'lino.modlib.printing.CachedPrintable.do_print' : _("""The action used to print this object. This is an instance of DirectPrintAction or CachedPrintAction by default. And if lino_xl.lib.excerpts is installed, then set_excerpts_actions possibly replaces do_print by a lino_xl.lib.excerpts.CreateExcerpt instance."""),
    ...
    'lino.modlib.system.RecurrenceSet' : _("""Mixin for models that express a set of repeating ("recurrent") events. Example usage can be found in specs.cal.automatic_events."""),
    ...
    'lino.modlib.system.Genders' : _("""Defines the two possible choices "male" and "female" for the gender of a person."""),
    ...
    'lino.modlib.users.User.username' : _("""Must be either unique or empty. Users with an empty username cannot sign in."""),
    ...
    'lino.modlib.users.User.initials' : _("""The nickname or initials of this user. This does not need to be unique but should be reasonably identifying."""),
    ...
    'lino.modlib.users.User.verification_code' : _("""A random string set for every new user. Used for online registration. When this is non empty, is_verified() returns False and the verify action is available."""),
    ...
    'lino.modlib.users.User.get_full_name' : _("""Return the first_name plus the last_name, with a space in between. If both fields are empty, return the initials or the username."""),
    ...
    'lino.modlib.users.UserType' : _("""Base class for all user types. Any instance if this represents a possible user type."""),
    ...
    'lino.modlib.users.UserPlan.run_start_plan' : _("""Return the database object for this plan and user. or create"""),
