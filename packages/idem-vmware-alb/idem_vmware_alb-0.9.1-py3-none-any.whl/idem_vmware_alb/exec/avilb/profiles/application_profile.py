"""Exec module for managing Profiles Application Profiles. """
...
async def get(
    ...
    Args:
        resource_id(str):
            profiles.application_profile unique ID.
    ...
    Examples:
        ...
        .. code-block:: sls
            ...
            unmanaged_resource:
              exec.run:
                - path: avilb.profiles.application_profile.get
                - kwargs:
                  resource_id: value
        ...
        .. code-block:: bash
            ...
            idem exec avilb.profiles.application_profile.get resource_id=value
    """
    ...
    get = await hub.tool.avilb.session.request(
        ctx,
        method="get",
        path="/applicationprofile/{uuid}?include_name".format(**{"uuid": resource_id})
        if resource_id
        else "/applicationprofile",
...
async def list_(hub, ctx) -> Dict[str, Any]:
    ...
    Examples:
        ...
        .. code-block:: sls
            ...
            unmanaged_resources:
              exec.run:
                - path: avilb.profiles.application_profile.list
                - kwargs:
        ...
        .. code-block:: bash
            ...
            idem exec avilb.profiles.application_profile.list
...
async def create(
    ...
    Examples:
        ...
        .. code-block:: bash
            ...
            idem exec avilb.profiles.application_profile.create type=value
    """
...
async def update(
    ...
    Examples:
        ...
        .. code-block:: bash
            ...
            idem exec avilb.profiles.application_profile.update resource_id=value, type=value
    """
    ...
    if payload:
        update = await hub.tool.avilb.session.request(
            ctx,
            method="put",
            path="/applicationprofile/{uuid}".format(**{"uuid": resource_id}),
            query_params={},
            data=payload,
        )
...
async def delete(hub, ctx, resource_id: str, name: str = None) -> Dict[str, Any]:
    ...
    Examples:
        ...
        .. code-block:: sls
            ...
            resource_is_absent:
              avilb.profiles.application_profile.absent:
                - resource_id: value
        ...
        .. code-block:: bash
            ...
            idem exec avilb.profiles.application_profile.delete resource_id=value
    """
