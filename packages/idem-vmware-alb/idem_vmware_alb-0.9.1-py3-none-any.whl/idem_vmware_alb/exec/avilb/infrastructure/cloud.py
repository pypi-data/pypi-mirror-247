"""Exec module for managing Infrastructure Clouds. """
...
async def get(
    ...
    Args:
        resource_id(str):
            infrastructure.cloud unique ID.
    ...
    Examples:
        ...
        .. code-block:: sls
            ...
            unmanaged_resource:
              exec.run:
                - path: avilb.infrastructure.cloud.get
                - kwargs:
                  resource_id: value
        ...
        .. code-block:: bash
            ...
            idem exec avilb.infrastructure.cloud.get resource_id=value
    """
    ...
    get = await hub.tool.avilb.session.request(
        ctx,
        method="get",
        path="/cloud/{uuid}?include_name".format(**{"uuid": resource_id})
        if resource_id
        else "/cloud",
...
async def list_(hub, ctx) -> Dict[str, Any]:
    ...
    Examples:
        ...
        .. code-block:: sls
            ...
            unmanaged_resources:
              exec.run:
                - path: avilb.infrastructure.cloud.list
                - kwargs:
        ...
        .. code-block:: bash
            ...
            idem exec avilb.infrastructure.cloud.list
...
async def create(
    ...
    Examples:
        ...
        .. code-block:: bash
            ...
            idem exec avilb.infrastructure.cloud.create vtype=value
    """
    ...
    result["comment"].append(
        f"Created avilb.infrastructure.cloud '{name}'",
    )
...
async def update(
    ...
    Examples:
        ...
        .. code-block:: bash
            ...
            idem exec avilb.infrastructure.cloud.update resource_id=value, vtype=value
    """
...
async def delete(hub, ctx, resource_id: str, name: str = None) -> Dict[str, Any]:
    ...
    Examples:
        ...
        .. code-block:: sls
            ...
            resource_is_absent:
              avilb.infrastructure.cloud.absent:
                - resource_id: value
        ...
        .. code-block:: bash
            ...
            idem exec avilb.infrastructure.cloud.delete resource_id=value
    """
