"""Exec module for managing Applications Virtual Services. """
...
async def get(
    ...
    Args:
        resource_id(str):
            applications.virtual_service unique ID.
    ...
    Examples:
        ...
        .. code-block:: sls
            ...
            unmanaged_resource:
              exec.run:
                - path: avilb.applications.virtual_service.get
                - kwargs:
                  resource_id: value
        ...
        .. code-block:: bash
            ...
            idem exec avilb.applications.virtual_service.get resource_id=value
    """
    ...
    get = await hub.tool.avilb.session.request(
        ctx,
        method="get",
        path="/virtualservice/{uuid}?include_name".format(**{"uuid": resource_id})
        if resource_id
        else "/virtualservice",
...
async def list_(hub, ctx) -> Dict[str, Any]:
    ...
    Examples:
        ...
        .. code-block:: sls
            ...
            unmanaged_resources:
              exec.run:
                - path: avilb.applications.virtual_service.list
                - kwargs:
                  x_avi_version: value
        ...
        .. code-block:: bash
            ...
            idem exec avilb.applications.virtual_service.list
...
async def create(
    ...
    Examples:
        ...
        .. code-block:: bash
            ...
            idem exec avilb.applications.virtual_service.create
    """
...
async def update(
    ...
    Examples:
        ...
        .. code-block:: bash
            ...
            idem exec avilb.applications.virtual_service.update resource_id=value, x_avi_version=value
    """
...
async def delete(hub, ctx, resource_id: str, name: str = None) -> Dict[str, Any]:
    ...
    Examples:
        ...
        .. code-block:: sls
            ...
            resource_is_absent:
              avilb.applications.virtual_service.absent:
                - resource_id: value
        ...
        .. code-block:: bash
            ...
            idem exec avilb.applications.virtual_service.delete resource_id=value
    """
