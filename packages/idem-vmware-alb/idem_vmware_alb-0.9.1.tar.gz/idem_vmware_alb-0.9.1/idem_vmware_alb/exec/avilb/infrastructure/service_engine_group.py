"""Exec module for managing Infrastructure Service Engine Groups. """
...
async def get(
    ...
    Args:
        resource_id(str):
            infrastructure.service_engine_group unique ID.
    ...
    Examples:
        ...
        .. code-block:: sls
            ...
            unmanaged_resource:
              exec.run:
                - path: avilb.infrastructure.service_engine_group.get
                - kwargs:
                  resource_id: value
        ...
        .. code-block:: bash
            ...
            idem exec avilb.infrastructure.service_engine_group.get resource_id=value
    """
    ...
    get = await hub.tool.avilb.session.request(
        ctx,
        method="get",
        path="/serviceenginegroup/{uuid}?include_name".format(**{"uuid": resource_id})
        if resource_id
        else "/serviceenginegroup",
...
async def list_(hub, ctx) -> Dict[str, Any]:
    ...
    Examples:
        ...
        .. code-block:: sls
            ...
            unmanaged_resources:
              exec.run:
                - path: avilb.infrastructure.service_engine_group.list
                - kwargs:
        ...
        .. code-block:: bash
            ...
            idem exec avilb.infrastructure.service_engine_group.list
...
async def create(
    ...
    Examples:
        ...
        .. code-block:: bash
            ...
            idem exec avilb.infrastructure.service_engine_group.create x_avi_version=value
    """
...
async def update(
    ...
    Examples:
        ...
        .. code-block:: bash
            ...
            idem exec avilb.infrastructure.service_engine_group.update resource_id=value
    """
    ...
    if payload:
        update = await hub.tool.avilb.session.request(
            ctx,
            method="put",
            path="/serviceenginegroup/{uuid}".format(**{"uuid": resource_id}),
            query_params={},
            data=payload,
        )
...
async def delete(hub, ctx, resource_id: str, name: str = None) -> Dict[str, Any]:
    ...
    Examples:
        ...
        .. code-block:: sls
            ...
            resource_is_absent:
              avilb.infrastructure.service_engine_group.absent:
                - resource_id: value
        ...
        .. code-block:: bash
            ...
            idem exec avilb.infrastructure.service_engine_group.delete resource_id=value
    """
