...
class Engine:
    ...
    def load_model(self):
        ...
        model_path = os.path.join(os.getenv('LOCAL_PATH'),self._config["translation_engine_server"]["model"])
        tokenizer_path = os.path.join(os.getenv('LOCAL_PATH'),self._config["translation_engine_server"]["tokenizer"])
