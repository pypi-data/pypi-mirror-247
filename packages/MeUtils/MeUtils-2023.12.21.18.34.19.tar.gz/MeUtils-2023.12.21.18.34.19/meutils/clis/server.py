...
@cli.command()
def gunicorn_run(
        app: Optional[str] = None,  # aiapi.views.apps:app /Users/betterme/PycharmProjects/AI/aiapi/aiapi/views/apps.py
        port: int = 8501,
        workers: int = 3,
    ...
    """
    project_dir = project_dir or Path(app).parent
    app = f"{Path(app).name}:app"
