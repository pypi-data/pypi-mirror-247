...
class PartitionManager(FileManager): 
    ...
    def readSubFolder(self, file_location:str=None, source:str='VASP', verbose=False):
        ...
        for root, dirs, files in os.walk(file_location):
            ...
            #if self.file_exists(file_location_edited):
            try:
                ...
                # Optionally, you can store or log the traceback for further investigation
                error_traceback = traceback.format_exc()
                # Do something with error_traceback, like logging it to a file or database   
