...
knowledge_base_path = ("explanation_text/explanation_generators/explanation_generator_geoguesser/knowledge_base"
                       "/countries/")
...
def get_prefiltered_information(location, part, similarity_threshold=0.6, max_text_length=200):
    ...
    return filter_and_sort_sentences(full_location_text, part_synonyms_variants, max_text_length)


def get_full_information_of_country(country):
    try:
        with open(knowledge_base_path + country.lower().capitalize() + ".txt", 'r', encoding='utf-8') as file:
            return file.read()
...
# print(get_filtered_information("brazil", "car"))
# print(get_filtered_information("germany", "road"))
# print(get_filtered_information("peru", "house"))
# print(get_filtered_information("spain", "traffic_light"))
