...
from explanation_text.explanation_generator_utils import validate_and_parse_image
...
class ExplanationGenerator:
    ...
    def __init__(self, api_token="", google_api_token="", mode="ExplanationGeneratorV1",
                 minimum_relevance=10,
                 maximum_part_count=5):
        """
        ...
        self.maximum_part_count = maximum_part_count

    def generate_explanation(self, image, return_time=False):
        """
        ...
        # Validate input
        label_list, object_list = validate_and_parse_image(image_copy,
                                                           self.minimum_relevance, self.maximum_part_count)
        full_explanation = {}
        ...
        if self.mode == str.lower('OverviewBasic'):
            ...
            overview_text = generate_gg_overview(object_list, label_list, self.api_token)
        else:
        ...
        for single_object in object_list:
            ...
            if self.mode == str.lower('SentenceConstruction'):
                ...
                medium_text = generate_gg_medium(single_object, self.api_token)
            else:
            ...
            if self.mode == str.lower('SentenceConstruction'):
                ...
                detailed_text = generate_gg_detailed(medium_text, single_object, self.api_token, self.google_api_token)
