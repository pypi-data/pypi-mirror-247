...
from data_aggregator_sdk.constants.enums import IntervalSelectValue, EncryptionType, ResourceKind, NetworkTypeEnum, \
    ...
    SignalModulation, DownlinkTaskStatus, IntegrationV0MessageEvent, JournalDataType, SensorType
...
class ApiDeviceUptimeResponse(JsonApiResponsePayload):
    ...
    channel_id: Optional[UUID4] = Field(title='Device Channel Identifier', description='device channel unique identifier')
    date: datetime = Field(title='Date', description='date')
...
class ApiDeviceSensorResponse(JsonApiResponsePayload):
    ...
    value: Optional[float] = Field(title="Value", description="Device Sensor value")
