...
class UserTensorSwapOrders(BaseModel):
    user_tswap_orders: List["UserTensorSwapOrdersUserTswapOrders"] = Field(
        alias="userTswapOrders"
    )


class UserTensorSwapOrdersUserTswapOrders(BaseModel):
    pool: "UserTensorSwapOrdersUserTswapOrdersPool"


class UserTensorSwapOrdersUserTswapOrdersPool(BaseModel):
    address: str
    ...
    nfts_for_sale: List["UserTensorSwapOrdersUserTswapOrdersPoolNftsForSale"] = Field(
        alias="nftsForSale"
    )
