...
class CollectionStats(BaseModel):
    instrument_tv_2: Optional["CollectionStatsInstrumentTv2"] = Field(
        alias="instrumentTV2"
    )


class CollectionStatsInstrumentTv2(BaseModel):
    id: str
    slug: str
    slug_me: Optional[str] = Field(alias="slugMe")
    slug_display: Optional[str] = Field(alias="slugDisplay")
    stats_v_2: Optional["CollectionStatsInstrumentTv2StatsV2"] = Field(alias="statsV2")
    first_list_date: Optional[Any] = Field(alias="firstListDate")
    name: str


class CollectionStatsInstrumentTv2StatsV2(BaseModel):
