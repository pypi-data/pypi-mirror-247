...
class TransactionsClient(BaseClient):
    ...
    def tcomp_bid_tx_for_collection(
        self,
        owner: str,
        price: Any,
        quantity: float,
    ...
    def tswap_deposit_withdraw_nft_tx(
    ...
    def tswap_deposit_withdraw_sol_tx(
    ...
    def tswap_close_pool_tx(self, pool: str, **kwargs: Any) -> TswapClosePoolTx:
        query = gql(
            """
    ...
    def tswap_edit_single_listing_tx(
        self, mint: str, owner: str, price: Any, **kwargs: Any
    ...
    def tswap_buy_single_listing_tx(
        self, buyer: str, max_price: Any, mint: str, owner: str, **kwargs: Any
