...
class FMeasure:
    ...
    def __init__(self,
        ...
        self.__arg_info_matrix.append(["beta", self.beta, True, (float)])
    ...
    def __validate(self):
        ...
        self.__awu._validate_dataframe_has_argument_columns(self.obs_column, "obs_column", self.data, "data", False)
        
        self.__awu._validate_input_columns_not_empty(self.predict_column, "predict_column")
        self.__awu._validate_dataframe_has_argument_columns(self.predict_column, "predict_column", self.data, "data", False)
    ...
    def __form_tdml_query(self):
        ...
        if self.beta is not None and self.beta != 1.0:
            self.__func_other_arg_sql_names.append("Beta")
            self.__func_other_args.append(UtilFuncs._teradata_collapse_arglist(self.beta, "'"))
