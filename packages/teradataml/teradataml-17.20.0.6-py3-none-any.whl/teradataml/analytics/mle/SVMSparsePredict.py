...
class SVMSparsePredict:
    ...
    def __validate(self):
        ...
        # Cannot use output_responses and output_class_num together
        if self.output_responses is not None and self.output_class_num is not None:
            raise TeradataMlException(
                Messages.get_message(MessageCodes.EITHER_THIS_OR_THAT_ARGUMENT, "output_responses",
                                     "output_class_num"),
