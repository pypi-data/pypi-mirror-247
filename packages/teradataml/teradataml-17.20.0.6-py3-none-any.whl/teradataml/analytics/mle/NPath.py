...
class NPath:
    ...
    def __init__(self,
        ...
        PARAMETERS:
            ...
            pattern:
                ...
                operators and parentheses. teradataml DataFrame describes the
                simplest patterns, which you can combine to form more complex
                patterns. When patterns have multiple operators, the function applies
                ...
                Feature.
                teradataml DataFrame also shows operator precedence.
            ...
            symbols:
                ...
                For example:
                    Symbols
                    (
                     input.pagetype = "homepage" AS H,
                     input.pagetype = "thankyou" AS T,
                     input1.adname = "xmaspromo" AS X,
                     input1.adname = "realtorpromo" AS R
                    )
                The mapping from teradataml DataFrame name to its corresponding SQL name is as
                shown below:
                    * data1: input
                    * data2: input1
                    * data3: input2
            ...
            data2:
                Optional Argument.
                Specifies the additional optional input teradataml DataFrame
                containing the input data set.
            ...
            data2_order_column:
                Optional Argument. Required when data2 is provided.
            ...
            data3_order_column:
                Optional Argument. Required when data3 is provided.
        ...
        EXAMPLES:
            ...
            result = NPath(data1=clickstream,
                           ...
                           filter = "FIRST(clicktime OF ANY (home)) < FIRST(clicktime of any(checkout))"
                           )
    ...
    def __form_tdml_query(self):
        ...
        self.__func_other_arg_json_datatypes.append("SQLEXPR")
