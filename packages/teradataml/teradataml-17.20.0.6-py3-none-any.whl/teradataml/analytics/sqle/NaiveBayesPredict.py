...
class NaiveBayesPredict:
    ...
    def __init__(self,
        ...
        self.__arg_info_matrix.append(["responses", self.responses, False, (str, list)])
    ...
    def __form_tdml_query(self):
        ...
        if len(__numeric_columns) > 0:
            ...
            numerical_columns_list = UtilFuncs._teradata_collapse_arglist(__numeric_columns, "'")
        ...
        if len(__categorical_columns) > 0:
            ...
            categorical_columns_list = UtilFuncs._teradata_collapse_arglist(__categorical_columns, "'")
