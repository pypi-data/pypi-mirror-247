...
class GLMPredict:
    ...
    def __form_tdml_query(self):
        ...
        # Process modeldata
        modeldata_order_columns = ['attribute', 'predictor', 'category', 'estimate']
        modeldata_order_columns = UtilFuncs._teradata_collapse_arglist(modeldata_order_columns, "\"")
        ...
        self.__func_input_order_by_cols.append(modeldata_order_columns)
