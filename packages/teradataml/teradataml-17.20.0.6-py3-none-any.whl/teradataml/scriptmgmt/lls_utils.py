...
def create_env(env_name=None, base_env=None, desc=None, template=None):
    """
    DESCRIPTION:
    ...
    PARAMETERS:
        ...
        base_env:
            ...
            Note:
                *   When "base_env" is not provided, latest available Python
                    base environment is used. To check available base
                    environments use list_base_envs().
            Types: str
