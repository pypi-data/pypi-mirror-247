...
class _ProgressBar:
    ...
    def update(self, msg=None):
        ...
        with self._lock:
            ...
            self.completed_jobs = len(self.queue)
    ...
    def __show(self):
        """
        DESCRIPTION:
            Internal method to display updated message and progress state. 
        ...
        if self.verbose > 0:
            ...
            if self.blank_space_len == 0:
                # Update the blank space size based on last displayed message.
