...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BASECPPFLAGS': '',
 'BASEMODLIBS': '',
 'BINDIR': '/usr/local/opt/python@3.11/Frameworks/Python.framework/Versions/3.11/bin',
 'BINLIBDEST': '/usr/local/opt/python@3.11/Frameworks/Python.framework/Versions/3.11/lib/python3.11',
 'BLDLIBRARY': '',
 ...
 'CONFIGURE_CFLAGS': '-isysroot '
                     '/Library/Developer/CommandLineTools/SDKs/MacOSX13.sdk',
 'CONFIGURE_CFLAGS_NODIST': '-I/usr/local/include -flto -std=c11 -Wextra '
 ...
 'CONFIGURE_LDFLAGS': '-isysroot '
                      '/Library/Developer/CommandLineTools/SDKs/MacOSX13.sdk',
 'CONFIGURE_LDFLAGS_NODIST': '-L/usr/local/lib -Wl,-rpath,/usr/local/lib -flto '
                             '-Wl,-export_dynamic -g',
 'CONFIGURE_LDFLAGS_NOLTO': '-flto=thin',
 'CONFIG_ARGS': "'--prefix=/usr/local/opt/python@3.11' "
                "'--enable-ipv6' "
                "'--datarootdir=/usr/local/opt/python@3.11/share' "
                "'--datadir=/usr/local/opt/python@3.11/share' "
                ...
                "'--with-lto' "
                "'--enable-framework=/usr/local/opt/python@3.11/Frameworks' "
                "'--with-dtrace' '--with-dbmliborder=ndbm' "
                "'MACOSX_DEPLOYMENT_TARGET=13' 'CFLAGS=-isysroot "
                "/Library/Developer/CommandLineTools/SDKs/MacOSX13.sdk' "
                "'CFLAGS_NODIST=-I/usr/local/include' 'LDFLAGS=-isysroot "
                "/Library/Developer/CommandLineTools/SDKs/MacOSX13.sdk' "
                "'LDFLAGS_NODIST=-L/usr/local/lib -Wl,-rpath,/usr/local/lib' "
                "'CPPFLAGS=-I/usr/local/include' "
                "'py_cv_module__tkinter=disabled' "
                "'PKG_CONFIG_PATH=/usr/local/opt/openssl@3/lib/pkgconfig:/usr/local/opt/readline/lib/pkgconfig:/usr/local/opt/sqlite/lib/pkgconfig:/usr/local/opt/xz/lib/pkgconfig' "
                "'PKG_CONFIG_LIBDIR=/usr/lib/pkgconfig:/usr/local/Homebrew/Library/Homebrew/os/mac/pkgconfig/13' "
                "'CC=clang'",
 'CONFINCLUDEDIR': '/usr/local/opt/python@3.11/Frameworks/Python.framework/Versions/3.11/include',
 'CONFINCLUDEPY': '/usr/local/opt/python@3.11/Frameworks/Python.framework/Versions/3.11/include/python3.11',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/private/tmp/pythonA3.11-20231102-5460-kg96a6/Python-3.11.6/coverage.info',
 'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
 'COVERAGE_REPORT': '/private/tmp/pythonA3.11-20231102-5460-kg96a6/Python-3.11.6/lcov-report',
 ...
 'DESTDIRS': '/usr/local/opt/python@3.11/Frameworks/Python.framework/Versions/3.11 '
             '/usr/local/opt/python@3.11/Frameworks/Python.framework/Versions/3.11/lib '
             '/usr/local/opt/python@3.11/Frameworks/Python.framework/Versions/3.11/lib/python3.11 '
             '/usr/local/opt/python@3.11/Frameworks/Python.framework/Versions/3.11/lib/python3.11/lib-dynload',
 'DESTLIB': '/usr/local/opt/python@3.11/Frameworks/Python.framework/Versions/3.11/lib/python3.11',
 'DESTPATH': '',
 'DESTSHARED': '/usr/local/opt/python@3.11/Frameworks/Python.framework/Versions/3.11/lib/python3.11/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/usr/local/opt/python@3.11/Frameworks/Python.framework/Versions/3.11/include '
                   '/usr/local/opt/python@3.11/Frameworks/Python.framework/Versions/3.11/include '
                   '/usr/local/opt/python@3.11/Frameworks/Python.framework/Versions/3.11/include/python3.11 '
                   '/usr/local/opt/python@3.11/Frameworks/Python.framework/Versions/3.11/include/python3.11',
 'INCLUDEDIR': '/usr/local/opt/python@3.11/Frameworks/Python.framework/Versions/3.11/include',
 'INCLUDEPY': '/usr/local/opt/python@3.11/Frameworks/Python.framework/Versions/3.11/include/python3.11',
 ...
 'LDVERSION': '3.11',
 'LIBC': '',
 'LIBDEST': '/usr/local/opt/python@3.11/Frameworks/Python.framework/Versions/3.11/lib/python3.11',
 'LIBDIR': '/usr/local/opt/python@3.11/Frameworks/Python.framework/Versions/3.11/lib',
 'LIBEXPAT_A': 'Modules/expat/libexpat.a',
 'LIBEXPAT_CFLAGS': '-Wsign-compare -Wunreachable-code -fno-common -dynamic '
                    '-DNDEBUG -g -fwrapv -O3 -Wall -isysroot '
                    '/Library/Developer/CommandLineTools/SDKs/MacOSX13.sdk '
                    '-I/usr/local/include -flto -std=c11 -Wextra '
                    '-Wno-unused-parameter -Wno-missing-field-initializers '
                    '-Wstrict-prototypes -Werror=implicit-function-declaration '
                    '-fvisibility=hidden -fprofile-instr-use=code.profclangd '
                    '-I./Include/internal -I. -I./Include -I/usr/local/include',
 'LIBEXPAT_HEADERS': '\\',
 'LIBEXPAT_OBJS': '\\',
 'LIBFFI_INCLUDEDIR': '',
 'LIBM': '',
 'LIBMPDEC_A': 'Modules/_decimal/libmpdec/libmpdec.a',
 'LIBMPDEC_CFLAGS': '-DCONFIG_64=1 -DASM=1 -Wsign-compare -Wunreachable-code '
 ...
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/usr/local/opt/python@3.11/Frameworks/Python.framework/Versions/3.11/lib/pkgconfig',
 'LIBPL': '/usr/local/opt/python@3.11/Frameworks/Python.framework/Versions/3.11/lib/python3.11/config-3.11-darwin',
 'LIBPYTHON': '',
 ...
 'MACHDEP': 'darwin',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/usr/local/opt/python@3.11/Frameworks/Python.framework/Versions/3.11/lib/python3.11',
 'MACOSX_DEPLOYMENT_TARGET': '13',
 'MAINCC': 'clang',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 0,
 'MAKESETUP': './Modules/makesetup',
 'MANDIR': '/usr/local/opt/python@3.11/share/man',
 ...
 'MODULE__LZMA_CFLAGS': '-I/usr/local/Cellar/xz/5.4.4/include',
 'MODULE__LZMA_LDFLAGS': '-L/usr/local/Cellar/xz/5.4.4/lib -llzma',
 ...
 'MODULE__SQLITE3_CFLAGS': '-I/usr/local/opt/sqlite/include '
                           '-I./Modules/_sqlite',
 ...
 'PYTHONFRAMEWORKINSTALLDIR': '/usr/local/opt/python@3.11/Frameworks/Python.framework',
 'PYTHONFRAMEWORKPREFIX': '/usr/local/opt/python@3.11/Frameworks',
 'PYTHONPATH': '',
 ...
 'PY_CFLAGS': '-Wsign-compare -Wunreachable-code -fno-common -dynamic -DNDEBUG '
              ...
              '/Library/Developer/CommandLineTools/SDKs/MacOSX13.sdk',
 'PY_CFLAGS_NODIST': '-I/usr/local/include -flto -std=c11 -Wextra '
                     '-Wno-unused-parameter -Wno-missing-field-initializers '
                     '-Wstrict-prototypes '
                     '-Werror=implicit-function-declaration '
                     '-fvisibility=hidden -fprofile-instr-use=code.profclangd '
 ...
 'PY_CORE_LDFLAGS': '-isysroot '
                    '/Library/Developer/CommandLineTools/SDKs/MacOSX13.sdk '
                    '-L/usr/local/lib -Wl,-rpath,/usr/local/lib -flto '
                    '-Wl,-export_dynamic -g',
 ...
 'PY_LDFLAGS': '-isysroot '
               '/Library/Developer/CommandLineTools/SDKs/MacOSX13.sdk',
 'PY_LDFLAGS_NODIST': '-L/usr/local/lib -Wl,-rpath,/usr/local/lib -flto '
                      '-Wl,-export_dynamic -g',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'DYLD_FRAMEWORK_PATH=/private/tmp/pythonA3.11-20231102-5460-kg96a6/Python-3.11.6',
 'SCRIPTDIR': '/usr/local/opt/python@3.11/Frameworks/Python.framework/Versions/3.11/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SHELL': '/bin/sh',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'DYLD_FRAMEWORK_PATH=/private/tmp/pythonA3.11-20231102-5460-kg96a6/Python-3.11.6 '
               './python.exe -E',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'DYLD_FRAMEWORK_PATH=/private/tmp/pythonA3.11-20231102-5460-kg96a6/Python-3.11.6 '
 ...
 'VERSION': '3.11',
 'WASM_ASSETS_DIR': './usr/local/opt/python@3.11/Frameworks/Python.framework/Versions/3.11',
 'WASM_STDLIB': './usr/local/opt/python@3.11/Frameworks/Python.framework/Versions/3.11/lib/python3.11/os.py',
 'WHEEL_PKG_DIR': '',
 'WINDOW_HAS_FLAGS': 1,
 ...
 'abs_builddir': '/private/tmp/pythonA3.11-20231102-5460-kg96a6/Python-3.11.6',
 'abs_srcdir': '/private/tmp/pythonA3.11-20231102-5460-kg96a6/Python-3.11.6',
 'datarootdir': '/usr/local/opt/python@3.11/share',
 'exec_prefix': '/usr/local/opt/python@3.11/Frameworks/Python.framework/Versions/3.11',
