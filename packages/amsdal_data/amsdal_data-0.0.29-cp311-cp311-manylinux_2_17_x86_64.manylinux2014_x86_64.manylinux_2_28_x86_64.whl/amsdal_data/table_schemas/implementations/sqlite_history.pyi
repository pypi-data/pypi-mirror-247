...
class SqliteHistoricalTableSchemaService(SqlStatementsMixin, TableSchemaServiceBase):
    ...
    def register_table(self, table_schema: TableSchema, *, is_internal_table: bool = ...) -> tuple[str, bool]: ...
    ...
    def create_table(self, table_name: str, table_schema: TableSchema, *, is_internal_table: bool = ...) -> None: ...
