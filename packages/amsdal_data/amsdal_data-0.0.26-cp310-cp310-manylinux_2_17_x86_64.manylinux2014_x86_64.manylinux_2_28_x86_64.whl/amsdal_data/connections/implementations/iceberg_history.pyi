...
class IcebergHistoricalConnection(HistoricalConnectionBase):
    ...
    @staticmethod
    def _to_sql_type(type_: Any) -> IcebergDataTypes | ComplexType: ...
    @property
    def table_schema_manager(self) -> TableSchemaServiceBase: ...
    @property
    def connection(self) -> SparkSession: ...
    _configs: Incomplete
    def connect(self, app_name: str = ..., catalog_name: str = ..., namespace_name: str = ..., spark_master: str | None = ..., spark_remote: str | None = ..., log_level: str = ..., configs: dict[str, str] | None = ..., **kwargs: Any) -> None:
        """
    ...
    def execute(self, stm: str, values: dict[str, Any] | None = ...) -> DataFrame: ...
    def get_full_table_name(self, address: Address) -> str: ...
    def _table_name_with_catalog(self, table_name: str) -> str: ...
    def _get_metadata_fields(self, join_table: str = ..., fields_rename_prefix: str = ..., *, needs_rename: bool = ..., with_references: bool = ...) -> str: ...
    ...
    def __select_statement(self, select_only: str, table_name: str, main_table_name: str, metadata_join_table: str, conditions: Q | None = ..., *, is_internal_table: bool) -> tuple[str, dict[str, Any]]: ...
    def _build_select_statement(self, address: Address, query_specifier: QuerySpecifier | None = ..., conditions: Q | None = ..., pagination: NumberPaginator | CursorPaginator | None = ..., order_by: list[OrderBy] | None = ...) -> tuple[str, dict[str, Any]]: ...
    def _build_count_statement(self, address: Address, conditions: Q | None = ...) -> tuple[str, dict[str, Any]]: ...
    ...
    def _query(self, address: Address, class_version: str | Versions, query_specifier: QuerySpecifier | None = ..., query: Q | None = ..., pagination: NumberPaginator | CursorPaginator | None = ..., order_by: list[OrderBy] | None = ...) -> list[dict[str, Any]]: ...
    def count(self, address: Address, conditions: Q | None = ...) -> int: ...
    def _get_conditions_statement(self, conditions: Q, *, is_grouped: bool = ...) -> tuple[str, dict[str, Any]]: ...
