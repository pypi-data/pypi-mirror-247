...
class SqlStatementsMixin:
    def _build_create_table_statement(self, table_name: str, table_schema: TableSchema, *, is_internal_table: bool = ..., is_historical_table: bool = ...) -> str: ...
    ...
    def _build_columns_from_schema(self, table_schema: TableSchema, *, is_internal_table: bool = ..., is_historical_table: bool = ...) -> list[SqlTableColumn]: ...
    @staticmethod
