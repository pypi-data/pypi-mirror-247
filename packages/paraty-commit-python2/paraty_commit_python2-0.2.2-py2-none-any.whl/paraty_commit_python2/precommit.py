...
def main():
    ...
    package_name = 'paraty_commit_python2'
    ...
    print(Style.BRIGHT + Fore.GREEN + "Package Path: " + package_path)
    print(Style.BRIGHT + Fore.GREEN + "Project Path: " + project_path)
    ...
    for file in files:
        ...
        print(Fore.GREEN + "Added file: " + file)

    execute_command("pip2 install pre-commit==1.21.0")
