...
class check:
    ...
    def hsl(h: float, s: float, l: float):
        ...
        if round(h) in range(0,361) and round(s) in range(0,101) and round(l) in range(0,101):
            return True
        else:
            return False
    ...
    def hsv(h: float, s: float, v: float):
        ...
        if round(h) in range(0,361) and round(s) in range(0,101) and round(v) in range(0,101):
            return True
        else:
            return False
...
class validate:
    ...
    def hex(hex: str):
        ...
        try:
            ...
            raise ValueError('Hex should only contain numbers 0 to 9 and letters A to F')
        else:
