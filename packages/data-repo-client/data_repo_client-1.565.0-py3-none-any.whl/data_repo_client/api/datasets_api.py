...
class DatasetsApi(object):
    ...
    def create_snapshot_request_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/repository/v1/datasets/{id}/createSnapshotRequest', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def update_dataset_snapshot_builder_settings(self, id, snapshot_builder_settings, **kwargs):  # noqa: E501
        """update_dataset_snapshot_builder_settings  # noqa: E501

        Updates the settings for using the dataset in the snapshot builder.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_dataset_snapshot_builder_settings(id, snapshot_builder_settings, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str id: The UUID of the dataset. (required)
        :param SnapshotBuilderSettings snapshot_builder_settings: New settings for the dataset to use for snapshot building (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.update_dataset_snapshot_builder_settings_with_http_info(id, snapshot_builder_settings, **kwargs)  # noqa: E501

    def update_dataset_snapshot_builder_settings_with_http_info(self, id, snapshot_builder_settings, **kwargs):  # noqa: E501
        """update_dataset_snapshot_builder_settings  # noqa: E501

        Updates the settings for using the dataset in the snapshot builder.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_dataset_snapshot_builder_settings_with_http_info(id, snapshot_builder_settings, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_dataset_snapshot_builder_settings" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'id' is set
        if self.api_client.client_side_validation and ('id' not in local_var_params or  # noqa: E501
                                                        local_var_params['id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `id` when calling `update_dataset_snapshot_builder_settings`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('snapshot_builder_settings' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `snapshot_builder_settings` when calling `update_dataset_snapshot_builder_settings`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/repository/v1/datasets/{id}/snapshotBuilder/settings', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
