...
*DatasetsApi* | [**create_snapshot_request**](docs/DatasetsApi.md#create_snapshot_request) | **POST** /api/repository/v1/datasets/{id}/createSnapshotRequest | 
