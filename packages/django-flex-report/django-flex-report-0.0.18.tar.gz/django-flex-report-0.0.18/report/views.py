...
from django.views.generic.edit import CreateView, DeleteView, FormMixin, FormView, ModelFormMixin, UpdateView
...
class ColumnCreateView(BaseView, CreateView):
    ...
    def form_valid(self, form):
        ...
        return super().form_valid(cleaned_form)
...
class TemplateUpsertViewBase(BaseView, TemplateObjectMixin, DetailView):
    ...
    def form_valid(self, form):
        ...
        if model_user_path_forms.is_valid():
            ...
            try:
                self.object.model.model_class().objects.filter(**{model_user_path: self.request.user})
