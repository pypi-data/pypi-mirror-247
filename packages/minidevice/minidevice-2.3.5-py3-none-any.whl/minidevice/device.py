...
class MiniDevice:
    def __init__(self, serial=None, capMethod: Union[ADBtouch, Minicap, DroidCast] = None,
                 touchMethod: Union[ADBtouch, Minitouch] = None, screenshotTimeout=30) -> None:
        """设备操作类
        ...
        Args:
            ...
            screenshotTimeout (int, optional):截图延迟，使用1/fps得到，作用是在该时间内返回同一张图片，防止截取同一个画面导致的性能损失 单位ms. Defaults to 30.
        """
