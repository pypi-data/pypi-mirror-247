    ...
    try:
        ...
        if match:
            ...
            if message.grouped_id is not None and message.media:
                ...
                await app.copy_media_group(tm.message.chat_id, chat.username, message.id, captions=caption)
            else:
                from test_tele.live_pyrogram import APP as app
                await app.copy_message(tm.message.chat_id, chat.username, message.id, captions=caption)
