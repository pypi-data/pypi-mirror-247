...
class BotMessages(BaseModel):
    ...
    bot_help: str = (
        ...
        **HELP**
        ...
        `/get`   : Forward (to you) any messages from public channel
        `/report`: Send a message containing bug/error of the bot to the Admin
        ...
        **Gelbooru**
        ...
        Command: `@ttloli_bot`
        Usage: TAG_1.. TAG_N
        Note: TAG = replace "space" with underscore '_'
        ...
        **Pixiv** [BETA]
        ...
        Mode: `-r18` | `-safe`, `-no_ai`
        Note: TAGS = no need to replace "space" with underscore
        
        **Example** 
        `@ttloli_bot highres one_piece`
        `@ttloli_bot !px virtual youtuber -r18`
        `@ttloli_bot !px id:99370414 -safe -no_ai`
        `@ttloli_bot !px 113746840`

        Other functions: **Media Downloader**
...
class BotConfig(BaseModel):
    ...
    bot_name: str = "@ttloli_bot" # nanti kosongin kalo mau didistribusi
