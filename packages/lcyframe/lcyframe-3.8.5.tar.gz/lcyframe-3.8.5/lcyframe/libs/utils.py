...
def verify_domain(domain, mtype=1):
    ...
    mtype:
        1判断是否为合法域名；
            https://7w.7.wx.baidu.com >> True
            https://7w.7.wx.baidu.com&a=1 >> True
            https://7w.7.wx.baidu.com/abc >> True
            https:/7w.7.wx.baidu.com/abc >> False
        2提取域名有效部分：
            https://7w.7.wx.baidu.com >> 7w.7.wx.baidu.com
    :return:
    """
