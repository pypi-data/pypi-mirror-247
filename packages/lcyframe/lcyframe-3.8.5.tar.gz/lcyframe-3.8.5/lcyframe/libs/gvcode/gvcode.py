...
class VFCode:
    ...
    def __init__(
            ...
            lines_width: int = 3,
            lines_count: int = 6,
            lines_background_value: Optional[str] = None,
            mask: bool = False,
        ...
        self.lines_background_value = lines_background_value
        self.mask = mask
    ...
    def img_blur(self, img: Image) -> None:
        ...
        if self.draw_lines:
            for i in range(self.lines_count):
                ...
                y1 = randint(0, height)
                y2 = randint(0, height)
                draw.line((x1, y1, x2, y2), fill=self.lines_background_value or self.random_color(), width=self.lines_width)
