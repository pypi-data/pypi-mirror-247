...
from djangoldp.permissions import AnonymousReadOnly, ReadOnly, ReadAndCreate, ACLPermissions, InheritPermissions
...
class Community(Model):
    ...
    class Meta(Model.Meta):
        ...
        auto_author = 'owner'
        permission_classes = [AnonymousReadOnly, ReadAndCreate|ACLPermissions]
        permission_roles = {
...
LDPUser._meta.serializer_fields.append('communityContainer')
LDPUser.communityContainer = lambda self: {'@id': f'{self.urlid}communities/'}
