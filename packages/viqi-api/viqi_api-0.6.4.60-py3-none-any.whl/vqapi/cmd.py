...
def bisque_session(parser: argparse.ArgumentParser = None, args: argparse.Namespace | list[str] = None, root_logger = None) -> VQSession:
    """
    ...
    if pargs.host and pargs.user and pargs.password:
        ...
        print(f"connecting {pargs.host} with {pargs.user} and {pargs.password}")
