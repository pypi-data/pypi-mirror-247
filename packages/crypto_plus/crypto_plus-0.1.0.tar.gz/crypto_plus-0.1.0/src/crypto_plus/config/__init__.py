...
_external_files = [Path(sys.prefix, "etc", "crypto_plus", "settings.yml")]


settings = Dynaconf(
    # Set env `CRYPTO_PLUS_FOO='bar'`，use `settings.FOO` .
    envvar_prefix="CRYPTO_PLUS",
