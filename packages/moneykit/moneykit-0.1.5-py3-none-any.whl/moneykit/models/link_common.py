...
class LinkCommon(BaseModel):
    ...
    institution_id: StrictStr = Field(
        description="The unique ID for the institution this link is connected to."
    )
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of LinkCommon from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of LinkCommon from a dict"""
        if obj is None:
            return None
