...
class InstitutionErrorNotFoundResponse(BaseModel):
    """
    InstitutionErrorNotFoundResponse
    """  # noqa: E501

    error_code: Optional[StrictStr] = "institution_error.not_found"
    error_message: Optional[StrictStr] = "Institution not found"
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of InstitutionErrorNotFoundResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of InstitutionErrorNotFoundResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                else "institution_error.not_found",
