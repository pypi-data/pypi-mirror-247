...
class InvestmentsProductSettings(BaseModel):
    """
    InvestmentsProductSettings
    """  # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["required", "prefetch", "product"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of InvestmentsProductSettings from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of InvestmentsProductSettings from a dict"""
        if obj is None:
            return None
