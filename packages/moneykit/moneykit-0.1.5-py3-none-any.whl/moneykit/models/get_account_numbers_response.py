...
class GetAccountNumbersResponse(BaseModel):
    """
    GetAccountNumbersResponse
    """  # noqa: E501

    accounts: List[AccountWithAccountNumbers]
    link: LinkCommon
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["accounts", "link"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of GetAccountNumbersResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of GetAccountNumbersResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "accounts": [
                    AccountWithAccountNumbers.from_dict(_item)
