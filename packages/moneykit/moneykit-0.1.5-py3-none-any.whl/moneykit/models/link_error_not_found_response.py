...
class LinkErrorNotFoundResponse(BaseModel):
    """
    LinkErrorNotFoundResponse
    """  # noqa: E501

    error_code: Optional[StrictStr] = "link_error.not_found"
    error_message: Optional[StrictStr] = "Link not found."
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of LinkErrorNotFoundResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of LinkErrorNotFoundResponse from a dict"""
        if obj is None:
            return None
