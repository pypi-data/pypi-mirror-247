...
class ProductsApi:
    ...
    def refresh_products(
        ...
        refresh_products_request: RefreshProductsRequest,
        ...
        :type refresh_products_request: RefreshProductsRequest
        ...
        _param = self._refresh_products_serialize(
            id=id,
    ...
    @validate_call
    def refresh_products_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The unique ID for this link.")],
        refresh_products_request: RefreshProductsRequest,
        moneykit_version: Optional[StrictStr] = None,
    ...
    def _refresh_products_serialize(
        ...
        if refresh_products_request is not None:
            _body_params = refresh_products_request
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/links/{id}/products",
