...
class WebhooksApi:
    ...
    @validate_call
    def trigger_test_link_webhook_event(
        self,
        ...
        :type id: str
        :param webhook_test_link_request: (required)
        :type webhook_test_link_request: WebhookTestLinkRequest
        ...
        _param = self._trigger_test_link_webhook_event_serialize(
            id=id,
            webhook_test_link_request=webhook_test_link_request,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "WebhookTestLinkResponse",
            "401": "Response401TriggerTestLinkWebhookEventWebhooksTestLinkIdPost",
            ...
            "400": "LinkErrorBadConfigResponse",
        }
    ...
    @validate_call
    def trigger_test_link_webhook_event_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The unique ID for this link.")],
        webhook_test_link_request: WebhookTestLinkRequest,
        moneykit_version: Optional[StrictStr] = None,
    ...
    @validate_call
    def trigger_test_link_webhook_event_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The unique ID for this link.")],
        webhook_test_link_request: WebhookTestLinkRequest,
        moneykit_version: Optional[StrictStr] = None,
    ...
    def _trigger_test_link_webhook_event_serialize(
        self,
        id,
        webhook_test_link_request,
        moneykit_version,
        _request_auth,
        _content_type,
        _headers,
        ...
        if webhook_test_link_request is not None:
            _body_params = webhook_test_link_request
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/webhooks/test/link/{id}",
