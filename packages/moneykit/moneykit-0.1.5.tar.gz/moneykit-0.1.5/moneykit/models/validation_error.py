...
class ValidationError(BaseModel):
    ...
    location: List[ValidationErrorLocationInner]
    message: StrictStr
    type: StrictStr
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["location", "message", "type"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate(
            {
                "location": [
                    ValidationErrorLocationInner.from_dict(_item)
                    for _item in obj.get("location")
                ]
