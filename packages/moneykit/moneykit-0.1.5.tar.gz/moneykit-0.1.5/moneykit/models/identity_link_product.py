...
class IdentityLinkProduct(BaseModel):
    """
    IdentityLinkProduct
    """  # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of IdentityLinkProduct from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of IdentityLinkProduct from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "settings": IdentityProductSettings.from_dict(obj.get("settings"))
