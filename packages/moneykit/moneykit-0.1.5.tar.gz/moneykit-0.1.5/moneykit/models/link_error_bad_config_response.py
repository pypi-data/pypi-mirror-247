...
class LinkErrorBadConfigResponse(BaseModel):
    """
    Bad link configuration.
    """  # noqa: E501

    error_code: Optional[StrictStr] = "link_error.bad_config"
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of LinkErrorBadConfigResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of LinkErrorBadConfigResponse from a dict"""
        if obj is None:
            return None
