...
class LinkSessionCustomerUser(BaseModel):
    ...
    id: Annotated[str, Field(min_length=4, strict=True, max_length=150)] = Field(
        description="Your own unique ID for this user.  Typically this will be a UUID or primary key         from your application."
    )
    email: Optional[LinkSessionCustomerUserEmail] = None
    phone: Optional[LinkSessionCustomerUserPhone] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "email", "phone"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate(
            {
                "id": obj.get("id"),
                "email": LinkSessionCustomerUserEmail.from_dict(obj.get("email"))
                if obj.get("email") is not None
                else None,
                "phone": LinkSessionCustomerUserPhone.from_dict(obj.get("phone"))
