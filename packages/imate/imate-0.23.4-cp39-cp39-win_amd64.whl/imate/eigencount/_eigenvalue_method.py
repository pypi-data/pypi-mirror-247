...
def eigenvalue_method(
    ...
    eigencount : float or numpy.array
    ...
    **Dense matrix:**
    ...
    .. code-block:: python
        ...
        >>> # Import packages
        >>> from imate import toeplitz, eigencount
        ...
        >>> eigencount(A, method='eigenvalue', assume_matrix='sym')
        138.62943611198907
    ...
    **Precomputed Eigenvalues:**
    ...
    .. code-block:: python
        ...
        >>> eigencount(A, method='eigenvalue', eigenvalues=eigenvalues)
        138.62943611198907

    Pre-computing eigenvalues can be useful if :func:`imate.eigencount`
    ...
    **Print Information:**
    ...
    .. code-block:: python
        ...
        >>> ld, info = eigencount(A, method='eigenvalue', return_info=True)
        >>> print(ld)
        138.6294361119891
    ...
    **Sparse matrix:**
    ...
    check_arguments(A, eigenvalues, gram, p, interval, return_info,
    ...
    lambda_min = interval[0]
    lambda_max = interval[1]
    lambda_ = eigenvalues[not_nan]**p
    indicator = numpy.ones_like(lambda_)
    indicator[lambda_ < lambda_min] = 0.0
    indicator[lambda_ > lambda_max] = 0.0
    trace = numpy.sum(indicator)
