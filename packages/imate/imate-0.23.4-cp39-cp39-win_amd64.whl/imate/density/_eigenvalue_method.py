...
def eigenvalue_method(
    ...
    **Computational Complexity:**
    ...
    to test randomized methods of computing trace-exponential.
    ...
    **Dense matrix:**
    ...
    Compute the trace-exponential of a sample sparse Toeplitz matrix created
    ...
    .. code-block:: python
        ...
        >>> density(A, method='eigenvalue', assume_matrix='sym')
        138.62943611198907
    ...
    **Precomputed Eigenvalues:**
    ...
    .. code-block:: python
        ...
        >>> density(A, method='eigenvalue', eigenvalues=eigenvalues)
        138.62943611198907

    Pre-computing eigenvalues can be useful if :func:`imate.density`
    function should be called repeatedly for the same matrix `A` but other
    parameters may change, such as `p`.
    ...
    **Print Information:**
    ...
    .. code-block:: python
        ...
        >>> ld, info = density(A, method='eigenvalue', return_info=True)
        >>> print(ld)
        138.6294361119891
    ...
    **Sparse matrix:**
    ...
    .. code-block:: python
        ...
        >>> trlinrac(A, method='eigenvalue', assume_matrix='sym',
        ...          non_zero_eig_fraction=0.9)
        2451.2640192906174
    """

    # Checking input arguments
    check_arguments(A, eigenvalues, gram, p, mu, sigma, return_info,
    ...
    if eigenvalues is None:
        ...
        if p >= 0:
            # when p is positive, the largest eigenvalues weight more
            which_eigenvalues = 'LM'
        else:
            # when p is negative, the smallest eigenvalues weight more
