...
def eigenvalue_method(
    ...
    **Dense matrix:**
    ...
    .. code-block:: python
        ...
        >>> trlinfrac(A, method='eigenvalue', assume_matrix='sym')
        138.62943611198907
    ...
    **Precomputed Eigenvalues:**
    ...
    .. code-block:: python
        ...
        >>> trlinfrac(A, method='eigenvalue', eigenvalues=eigenvalues)
        138.62943611198907

    Pre-computing eigenvalues can be useful if :func:`imate.trlinfrac` function
    ...
    **Print Information:**
    ...
    .. code-block:: python
        ...
        >>> ld, info = trlinfrac(A, method='eigenvalue', return_info=True)
        >>> print(ld)
        138.6294361119891
    ...
    **Sparse matrix:**
    ...
    check_arguments(A, eigenvalues, gram, p, coeff, return_info, assume_matrix,
