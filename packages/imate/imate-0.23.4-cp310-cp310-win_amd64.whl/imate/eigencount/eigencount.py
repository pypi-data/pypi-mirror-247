...
def eigencount(
    ...
    A : numpy.ndarray, scipy.sparse, :class:`imate.Matrix`, or \
        ...
        :ref:`slq method <imate.eigencount.slq>`. If ``method=cholesky``, the
    ...
    method : {'eigenvalue', 'slq'}, default='eigenvalue'
        ...
        * :ref:`eigenvalue <imate.eigencount.eigenvalue>`
        * :ref:`slq <imate.eigencount.slq>`
    ...
    * :ref:`eigenvalue <imate.eigencount.eigenvalue>`: uses spectral
      decomposition.
      Suitable for small matrices (:math:`n < 2^{12}`). The solution is exact.
    * :ref:`slq <imate.eigencount.slq>`: uses stochastic Lanczos quadrature
    ...
    **Output information:**
    ...
    .. code-block:: python
        ...
        >>> ld, info = eigencount(A, return_info=True)
        >>> print(ld)
        138.6294361119891
    ...
    **Matrix operator:**
    ...
    :ref:`slq method <imate.eigencount.slq>`.
    ...
    **Affine matrix operator:**
    ...
    in :ref:`slq method <imate.eigencount.slq>`.
    ...
    .. code-block:: python
        ...
        >>> eigencount(Aop, method='slq', parameters=t)
        array([ 68.71411681, 135.88356906, 163.44156683])
    """

    if method == 'eigenvalue':
        return eigenvalue_method(A, gram=gram, p=p, interval=interval,
                                 return_info=return_info, **options)

    elif method == 'slq':
        return slq_method(A, gram=gram, p=p, interval=interval,
                          return_info=return_info, **options)
