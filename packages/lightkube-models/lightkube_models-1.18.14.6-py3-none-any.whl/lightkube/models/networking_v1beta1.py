...
class HTTPIngressPath(DictMixin):
    """HTTPIngressPath associates a path with a backend. Incoming urls matching the
      ...
      * **pathType** ``Optional[str]`` - PathType determines the interpretation of the Path matching. PathType can be
...
class IngressBackend(DictMixin):
    """IngressBackend describes all endpoints for a given service and port.
      ...
      * **resource** ``Optional[core_v1.TypedLocalObjectReference]`` - Resource is an ObjectRef to another Kubernetes resource in the namespace of
        ...
        not be specified.
      * **serviceName** ``Optional[str]`` - Specifies the name of the referenced service.
      * **servicePort** ``Optional[util_intstr.IntOrString]`` - Specifies the port of the referenced service.
    """
...
class IngressClassSpec(DictMixin):
    """IngressClassSpec provides information about the class of an Ingress.
      ...
      * **controller** ``Optional[str]`` - Controller refers to the name of the controller that should handle this class.
        ...
        field is immutable.
      * **parameters** ``Optional[core_v1.TypedLocalObjectReference]`` - Parameters is a link to a custom resource containing additional configuration
