...
class IngressBackend(DictMixin):
    """IngressBackend describes all endpoints for a given service and port.
      ...
      * **resource** ``Optional[core_v1.TypedLocalObjectReference]`` - *(optional)* Resource is an ObjectRef to another Kubernetes resource in the namespace of
        ...
        not be specified.
      * **serviceName** ``Optional[str]`` - *(optional)* Specifies the name of the referenced service.
      * **servicePort** ``Optional[util_intstr.IntOrString]`` - *(optional)* Specifies the port of the referenced service.
    """
    resource: 'Optional[core_v1.TypedLocalObjectReference]' = None
    serviceName: 'Optional[str]' = None
    servicePort: 'Optional[util_intstr.IntOrString]' = None
