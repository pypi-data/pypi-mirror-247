...
class LifecycleHandler(DictMixin):
    """LifecycleHandler defines a specific action that should be taken in a lifecycle
      ...
      * **tcpSocket** ``Optional[TCPSocketAction]`` - Deprecated. TCPSocket is NOT supported as a LifecycleHandler and kept for the
...
class PersistentVolumeClaimSpec(DictMixin):
    """PersistentVolumeClaimSpec describes the common attributes of storage devices
      ...
      * **dataSource** ``Optional[TypedLocalObjectReference]`` - dataSource field can be used to specify either: * An existing VolumeSnapshot
        ...
        field.
      * **dataSourceRef** ``Optional[TypedLocalObjectReference]`` - dataSourceRef specifies the object from which to populate the volume with
        ...
        * While DataSource ignores disallowed values (dropping them), DataSourceRef
        ...
        enabled.
      * **resources** ``Optional[ResourceRequirements]`` - resources represents the minimum resources the volume should have. If
...
class PersistentVolumeClaimStatus(DictMixin):
    """PersistentVolumeClaimStatus is the current status of a persistent volume
      ...
      * **accessModes** ``Optional[List[str]]`` - accessModes contains the actual access modes the volume backing the PVC has.
        More info:
        https://kubernetes.io/docs/concepts/storage/persistent-volumes#access-modes-1
      * **allocatedResources** ``Optional[dict]`` - allocatedResources is the storage resource within AllocatedResources tracks
      ...
      * **resizeStatus** ``Optional[str]`` - resizeStatus stores status of resize operation. ResizeStatus is not set by
...
class PodStatus(DictMixin):
    """PodStatus represents information about the status of a pod. Status may trail
      ...
      * **conditions** ``Optional[List[PodCondition]]`` - Current service state of pod. More info:
        https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#pod-conditions
      * **containerStatuses** ``Optional[List[ContainerStatus]]`` - The list has one entry per container in the manifest. More info:
...
class Probe(DictMixin):
    """Probe describes a health check to be performed against a container to
      ...
      * **grpc** ``Optional[GRPCAction]`` - GRPC specifies an action involving a GRPC port. This is a beta field and
      ...
      * **successThreshold** ``Optional[int]`` - Minimum consecutive successes for the probe to be considered successful after
        ...
        value is 1.
      * **tcpSocket** ``Optional[TCPSocketAction]`` - TCPSocket specifies an action involving a TCP port.
...
class ProjectedVolumeSource(DictMixin):
    """Represents a projected volume source
      ...
      * **sources** ``Optional[List[VolumeProjection]]`` - sources is the list of volume projections
    """
    defaultMode: 'Optional[int]' = None
