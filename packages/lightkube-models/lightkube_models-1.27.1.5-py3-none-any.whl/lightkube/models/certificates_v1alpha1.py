...
class ClusterTrustBundle(DictMixin):
    """ClusterTrustBundle is a cluster-scoped container for X.509 trust anchors (root
      ...
      * **metadata** ``Optional[meta_v1.ObjectMeta]`` - *(optional)* metadata contains the object metadata.
    """
...
class ClusterTrustBundleList(DictMixin):
    """ClusterTrustBundleList is a collection of ClusterTrustBundle objects
      ...
      * **kind** ``Optional[str]`` - *(optional)* Kind is a string value representing the REST resource this object represents.
        ...
        Cannot be updated. In CamelCase. More info:
        https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      * **metadata** ``Optional[meta_v1.ListMeta]`` - *(optional)* metadata contains the list metadata.
    """
...
class ClusterTrustBundleSpec(DictMixin):
    """ClusterTrustBundleSpec contains the signer and trust anchors.
      ...
      * **signerName** ``Optional[str]`` - *(optional)* signerName indicates the associated signer, if any.
