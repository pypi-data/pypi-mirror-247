...
class HorizontalPodAutoscaler(DictMixin):
    """configuration of a horizontal pod autoscaler.
      ...
      * **spec** ``Optional[HorizontalPodAutoscalerSpec]`` - *(optional)* spec defines the behaviour of autoscaler. More info:
...
class HorizontalPodAutoscalerSpec(DictMixin):
    """specification of a horizontal pod autoscaler.
      ...
      * **targetCPUUtilizationPercentage** ``Optional[int]`` - *(optional)* targetCPUUtilizationPercentage is the target average CPU utilization
...
class HorizontalPodAutoscalerStatus(DictMixin):
    """current status of a horizontal pod autoscaler
      ...
      * **desiredReplicas** ``int`` - desiredReplicas is the  desired number of replicas of pods managed by this
        autoscaler.
      * **currentCPUUtilizationPercentage** ``Optional[int]`` - *(optional)* currentCPUUtilizationPercentage is the current average CPU utilization over
...
class Scale(DictMixin):
    """Scale represents a scaling request for a resource.
      ...
      * **metadata** ``Optional[meta_v1.ObjectMeta]`` - *(optional)* Standard object metadata; More info:
        https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata.
      * **spec** ``Optional[ScaleSpec]`` - *(optional)* spec defines the behavior of the scale. More info:
        https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status.
      * **status** ``Optional[ScaleStatus]`` - *(optional)* status is the current status of the scale. More info:
        https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status.
        Read-only.
    """
    apiVersion: 'Optional[str]' = None
...
class ScaleSpec(DictMixin):
    """ScaleSpec describes the attributes of a scale subresource.
      ...
      * **replicas** ``Optional[int]`` - *(optional)* replicas is the desired number of instances for the scaled object.
    """
...
class ScaleStatus(DictMixin):
    """ScaleStatus represents the current status of a scale subresource.
      ...
      * **selector** ``Optional[str]`` - *(optional)* selector is the label query over pods that should match the replicas count.
