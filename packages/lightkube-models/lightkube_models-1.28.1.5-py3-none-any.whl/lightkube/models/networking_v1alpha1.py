...
class ClusterCIDR(DictMixin):
    """ClusterCIDR represents a single configuration for per-Node Pod CIDR
      ...
      * **spec** ``Optional[ClusterCIDRSpec]`` - *(optional)* spec is the desired state of the ClusterCIDR. More info:
...
class ClusterCIDRSpec(DictMixin):
    """ClusterCIDRSpec defines the desired state of ClusterCIDR.
      ...
      * **ipv4** ``Optional[str]`` - *(optional)* ipv4 defines an IPv4 IP block in CIDR notation(e.g. "10.0.0.0/8"). At least
        one of ipv4 and ipv6 must be specified. This field is immutable.
      * **ipv6** ``Optional[str]`` - *(optional)* ipv6 defines an IPv6 IP block in CIDR notation(e.g. "2001:db8::/64"). At least
        one of ipv4 and ipv6 must be specified. This field is immutable.
      * **nodeSelector** ``Optional[core_v1.NodeSelector]`` - *(optional)* nodeSelector defines which nodes the config is applicable to. An empty or nil
...
class IPAddress(DictMixin):
    """IPAddress represents a single IP of a single IP Family. The object is designed
      ...
      * **metadata** ``Optional[meta_v1.ObjectMeta]`` - *(optional)* Standard object's metadata. More info:
        https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
      * **spec** ``Optional[IPAddressSpec]`` - *(optional)* spec is the desired state of the IPAddress. More info:
        https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
    """
    apiVersion: 'Optional[str]' = None
    kind: 'Optional[str]' = None
...
class IPAddressSpec(DictMixin):
    """IPAddressSpec describe the attributes in an IP Address.
      ...
      * **parentRef** ``Optional[ParentReference]`` - *(optional)* ParentRef references the resource that an IPAddress is attached to. An
...
class ParentReference(DictMixin):
    """ParentReference describes a reference to a parent object.
      ...
      * **group** ``Optional[str]`` - *(optional)* Group is the group of the object being referenced.
      * **name** ``Optional[str]`` - *(optional)* Name is the name of the object being referenced.
      * **namespace** ``Optional[str]`` - *(optional)* Namespace is the namespace of the object being referenced.
      * **resource** ``Optional[str]`` - *(optional)* Resource is the resource of the object being referenced.
      * **uid** ``Optional[str]`` - *(optional)* UID is the uid of the object being referenced.
    """
