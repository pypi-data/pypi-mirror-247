...
class AggregationRule(DictMixin):
    """AggregationRule describes how to locate ClusterRoles to aggregate into the
      ...
      * **clusterRoleSelectors** ``Optional[List[meta_v1.LabelSelector]]`` - *(optional)* ClusterRoleSelectors holds a list of selectors which will be used to find
...
class ClusterRole(DictMixin):
    """ClusterRole is a cluster level, logical grouping of PolicyRules that can be
      ...
      * **aggregationRule** ``Optional[AggregationRule]`` - *(optional)* AggregationRule is an optional field that describes how to build the Rules for
      ...
      * **rules** ``Optional[List[PolicyRule]]`` - *(optional)* Rules holds all the PolicyRules for this ClusterRole
    """
...
class ClusterRoleBinding(DictMixin):
    """ClusterRoleBinding references a ClusterRole, but not contain it.  It can
      ...
      ClusterRoleBinding, and will no longer be served in v1.20.
      ...
      * **kind** ``Optional[str]`` - *(optional)* Kind is a string value representing the REST resource this object represents.
        ...
        https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      * **metadata** ``Optional[meta_v1.ObjectMeta]`` - *(optional)* Standard object's metadata.
      * **subjects** ``Optional[List[Subject]]`` - *(optional)* Subjects holds references to the objects the role applies to.
    """
    roleRef: 'RoleRef'
    apiVersion: 'Optional[str]' = None
    kind: 'Optional[str]' = None
...
class ClusterRoleBindingList(DictMixin):
    """ClusterRoleBindingList is a collection of ClusterRoleBindings. Deprecated in
      v1.17 in favor of rbac.authorization.k8s.io/v1 ClusterRoleBindings, and will
      ...
      * **kind** ``Optional[str]`` - *(optional)* Kind is a string value representing the REST resource this object represents.
        ...
        Cannot be updated. In CamelCase. More info:
        https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      * **metadata** ``Optional[meta_v1.ListMeta]`` - *(optional)* Standard object's metadata.
    """
...
class PolicyRule(DictMixin):
    """PolicyRule holds information that describes a policy rule, but does not
      ...
      * **nonResourceURLs** ``Optional[List[str]]`` - *(optional)* NonResourceURLs is a set of partial urls that a user should have access to.
        *s are allowed, but only as the full, final step in the path This name is
        intentionally different than the internal type so that the DefaultConvert
      ...
      * **resources** ``Optional[List[str]]`` - *(optional)* Resources is a list of resources this rule applies to.  ResourceAll represents
        all resources.
    """
    verbs: 'List[str]'
...
class Role(DictMixin):
    """Role is a namespaced, logical grouping of PolicyRules that can be referenced
      ...
      rbac.authorization.k8s.io/v1 Role, and will no longer be served in v1.20.
      ...
      * **kind** ``Optional[str]`` - *(optional)* Kind is a string value representing the REST resource this object represents.
        ...
        https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      * **metadata** ``Optional[meta_v1.ObjectMeta]`` - *(optional)* Standard object's metadata.
      * **rules** ``Optional[List[PolicyRule]]`` - *(optional)* Rules holds all the PolicyRules for this Role
    """
    apiVersion: 'Optional[str]' = None
    kind: 'Optional[str]' = None
    metadata: 'Optional[meta_v1.ObjectMeta]' = None
...
class Subject(DictMixin):
    """Subject contains a reference to the object or user identities a role binding
      ...
      * **apiVersion** ``Optional[str]`` - *(optional)* APIVersion holds the API group and version of the referenced subject. Defaults
        to "v1" for ServiceAccount subjects. Defaults to
        "rbac.authorization.k8s.io/v1alpha1" for User and Group subjects.
      * **namespace** ``Optional[str]`` - *(optional)* Namespace of the referenced object.  If the object kind is non-namespace, such
