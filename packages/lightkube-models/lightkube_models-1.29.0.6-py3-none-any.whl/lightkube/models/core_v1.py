...
class PersistentVolumeClaimSpec(DictMixin):
    """PersistentVolumeClaimSpec describes the common attributes of storage devices
      ...
      * **resources** ``Optional[VolumeResourceRequirements]`` - resources represents the minimum resources the volume should have. If
...
class PersistentVolumeSpec(DictMixin):
    """PersistentVolumeSpec is the specification of a persistent volume.
      ...
      * **volumeAttributesClassName** ``Optional[str]`` - Name of VolumeAttributesClass to which this persistent volume belongs. Empty
        ...
        process. This is an alpha field and requires enabling VolumeAttributesClass
        feature.
