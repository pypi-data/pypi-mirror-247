...
class CSIDriverSpec(DictMixin):
    """CSIDriverSpec is the specification of a CSIDriver.
      ...
      * **fsGroupPolicy** ``Optional[str]`` - Defines if the underlying volume supports changing ownership and permission of
      ...
      * **podInfoOnMount** ``Optional[bool]`` - If set to true, podInfoOnMount indicates this CSI volume driver requires
      ...
      * **storageCapacity** ``Optional[bool]`` - If set to true, storageCapacity indicates that the CSI volume driver wants pod
