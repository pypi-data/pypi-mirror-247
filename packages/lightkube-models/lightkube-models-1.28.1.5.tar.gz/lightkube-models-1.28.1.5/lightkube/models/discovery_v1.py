...
class EndpointPort(DictMixin):
    """EndpointPort represents a Port used by an EndpointSlice
      ...
      * **name** ``Optional[str]`` - *(optional)* name represents the name of this port. All ports in an EndpointSlice must have
      ...
      * **port** ``Optional[int]`` - *(optional)* port represents the port number of the endpoint. If this is not specified,
        ports are not restricted and must be interpreted in the context of the
        specific consumer.
      * **protocol** ``Optional[str]`` - *(optional)* protocol represents the IP protocol for this port. Must be UDP, TCP, or SCTP.
        Default is TCP.
    """
