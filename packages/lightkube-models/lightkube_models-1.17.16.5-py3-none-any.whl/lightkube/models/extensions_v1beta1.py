...
class AllowedHostPath(DictMixin):
    """AllowedHostPath defines the host volume conditions that will be enabled by a
      ...
      * **pathPrefix** ``Optional[str]`` - *(optional)* pathPrefix is the path prefix that the host volume must match. It does not
      ...
      * **readOnly** ``Optional[bool]`` - *(optional)* when set to true, will allow host volumes matching the pathPrefix only if all
...
class DaemonSet(DictMixin):
    """DEPRECATED - This group version of DaemonSet is deprecated by
      ...
      * **spec** ``Optional[DaemonSetSpec]`` - *(optional)* The desired behavior of this daemon set. More info:
        https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
      * **status** ``Optional[DaemonSetStatus]`` - *(optional)* The current status of this daemon set. This data may be out of date by some
...
class DaemonSetSpec(DictMixin):
    """DaemonSetSpec is the specification of a daemon set.
      ...
      * **minReadySeconds** ``Optional[int]`` - *(optional)* The minimum number of seconds for which a newly created DaemonSet pod should
        be ready without any of its container crashing, for it to be considered
        available. Defaults to 0 (pod will be considered available as soon as it is
        ready).
      * **revisionHistoryLimit** ``Optional[int]`` - *(optional)* The number of old history to retain to allow rollback. This is a pointer to
        distinguish between explicit zero and not specified. Defaults to 10.
      * **selector** ``Optional[meta_v1.LabelSelector]`` - *(optional)* A label query over pods that are managed by the daemon set. Must match in
        order to be controlled. If empty, defaulted to labels on Pod template. More
        info:
        https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/#label-selectors
      * **templateGeneration** ``Optional[int]`` - *(optional)* DEPRECATED. A sequence number representing a specific generation of the
        template. Populated by the system. It can be set only during the creation.
      * **updateStrategy** ``Optional[DaemonSetUpdateStrategy]`` - *(optional)* An update strategy to replace existing DaemonSet pods with new pods.
    """
    ...
    templateGeneration: 'Optional[int]' = None
...
class DaemonSetStatus(DictMixin):
    """DaemonSetStatus represents the current status of a daemon set.
      ...
      * **collisionCount** ``Optional[int]`` - *(optional)* Count of hash collisions for the DaemonSet. The DaemonSet controller uses this
        field as a collision avoidance mechanism when it needs to create the name for
        the newest ControllerRevision.
      * **conditions** ``Optional[List[DaemonSetCondition]]`` - *(optional)* Represents the latest available observations of a DaemonSet's current state.
      * **numberAvailable** ``Optional[int]`` - *(optional)* The number of nodes that should be running the daemon pod and have one or more
        of the daemon pod running and available (ready for at least
        spec.minReadySeconds)
      * **numberUnavailable** ``Optional[int]`` - *(optional)* The number of nodes that should be running the daemon pod and have none of the
        daemon pod running and available (ready for at least spec.minReadySeconds)
      * **observedGeneration** ``Optional[int]`` - *(optional)* The most recent generation observed by the daemon set controller.
      * **updatedNumberScheduled** ``Optional[int]`` - *(optional)* The total number of nodes that are running updated daemon pod
    """
...
class DaemonSetUpdateStrategy(DictMixin):
    """
      ...
      * **rollingUpdate** ``Optional[RollingUpdateDaemonSet]`` - *(optional)* Rolling update config params. Present only if type = "RollingUpdate".
      * **type** ``Optional[str]`` - *(optional)* Type of daemon set update. Can be "RollingUpdate" or "OnDelete". Default is
        OnDelete.
    """
...
class Deployment(DictMixin):
    """DEPRECATED - This group version of Deployment is deprecated by
      ...
      * **kind** ``Optional[str]`` - *(optional)* Kind is a string value representing the REST resource this object represents.
        ...
        Cannot be updated. In CamelCase. More info:
        https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      * **metadata** ``Optional[meta_v1.ObjectMeta]`` - *(optional)* Standard object metadata.
      * **spec** ``Optional[DeploymentSpec]`` - *(optional)* Specification of the desired behavior of the Deployment.
      * **status** ``Optional[DeploymentStatus]`` - *(optional)* Most recently observed status of the Deployment.
    """
    apiVersion: 'Optional[str]' = None
    kind: 'Optional[str]' = None
    metadata: 'Optional[meta_v1.ObjectMeta]' = None
...
class DeploymentCondition(DictMixin):
    """DeploymentCondition describes the state of a deployment at a certain point.
      ...
      * **lastTransitionTime** ``Optional[meta_v1.Time]`` - *(optional)* Last time the condition transitioned from one status to another.
      * **lastUpdateTime** ``Optional[meta_v1.Time]`` - *(optional)* The last time this condition was updated.
      * **message** ``Optional[str]`` - *(optional)* A human readable message indicating details about the transition.
      * **reason** ``Optional[str]`` - *(optional)* The reason for the condition's last transition.
    """
    status: 'str'
...
class DeploymentList(DictMixin):
    """DeploymentList is a list of Deployments.
      ...
      * **kind** ``Optional[str]`` - *(optional)* Kind is a string value representing the REST resource this object represents.
        ...
        Cannot be updated. In CamelCase. More info:
        https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      * **metadata** ``Optional[meta_v1.ListMeta]`` - *(optional)* Standard list metadata.
    """
...
class DeploymentRollback(DictMixin):
    """DEPRECATED. DeploymentRollback stores the information required to rollback a
      ...
      * **kind** ``Optional[str]`` - *(optional)* Kind is a string value representing the REST resource this object represents.
        ...
        Cannot be updated. In CamelCase. More info:
        https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      * **updatedAnnotations** ``Optional[dict]`` - *(optional)* The annotations to be updated to a deployment
    """
    name: 'str'
...
class DeploymentSpec(DictMixin):
    """DeploymentSpec is the specification of the desired behavior of the Deployment.
      ...
      * **paused** ``Optional[bool]`` - *(optional)* Indicates that the deployment is paused and will not be processed by the
        deployment controller.
      * **progressDeadlineSeconds** ``Optional[int]`` - *(optional)* The maximum time in seconds for a deployment to make progress before it is
      ...
      * **replicas** ``Optional[int]`` - *(optional)* Number of desired pods. This is a pointer to distinguish between explicit zero
        and not specified. Defaults to 1.
      * **revisionHistoryLimit** ``Optional[int]`` - *(optional)* The number of old ReplicaSets to retain to allow rollback. This is a pointer
        ...
        RelicaSets".
      * **rollbackTo** ``Optional[RollbackConfig]`` - *(optional)* DEPRECATED. The config this deployment is rolling back to. Will be cleared
        after rollback is done.
      * **selector** ``Optional[meta_v1.LabelSelector]`` - *(optional)* Label selector for pods. Existing ReplicaSets whose pods are selected by this
        will be the ones affected by this deployment.
      * **strategy** ``Optional[DeploymentStrategy]`` - *(optional)* The deployment strategy to use to replace existing pods with new ones.
    """
    template: 'core_v1.PodTemplateSpec'
    minReadySeconds: 'Optional[int]' = None
...
class DeploymentStatus(DictMixin):
    """DeploymentStatus is the most recently observed status of the Deployment.
      ...
      * **availableReplicas** ``Optional[int]`` - *(optional)* Total number of available pods (ready for at least minReadySeconds) targeted
        by this deployment.
      * **collisionCount** ``Optional[int]`` - *(optional)* Count of hash collisions for the Deployment. The Deployment controller uses
        this field as a collision avoidance mechanism when it needs to create the name
        for the newest ReplicaSet.
      * **conditions** ``Optional[List[DeploymentCondition]]`` - *(optional)* Represents the latest available observations of a deployment's current state.
      * **observedGeneration** ``Optional[int]`` - *(optional)* The generation observed by the deployment controller.
      * **readyReplicas** ``Optional[int]`` - *(optional)* Total number of ready pods targeted by this deployment.
      * **replicas** ``Optional[int]`` - *(optional)* Total number of non-terminated pods targeted by this deployment (their labels
        match the selector).
      * **unavailableReplicas** ``Optional[int]`` - *(optional)* Total number of unavailable pods targeted by this deployment. This is the
      ...
      * **updatedReplicas** ``Optional[int]`` - *(optional)* Total number of non-terminated pods targeted by this deployment that have the
...
class DeploymentStrategy(DictMixin):
    """DeploymentStrategy describes how to replace existing pods with new ones.
      ...
      * **rollingUpdate** ``Optional[RollingUpdateDeployment]`` - *(optional)* Rolling update config params. Present only if DeploymentStrategyType =
        RollingUpdate.
      * **type** ``Optional[str]`` - *(optional)* Type of deployment. Can be "Recreate" or "RollingUpdate". Default is
        RollingUpdate.
    """
...
class FSGroupStrategyOptions(DictMixin):
    """FSGroupStrategyOptions defines the strategy type and options used to create
      ...
      * **ranges** ``Optional[List[IDRange]]`` - *(optional)* ranges are the allowed ranges of fs groups.  If you would like to force a
        single fs group then supply a single range with the same start and end.
        Required for MustRunAs.
      * **rule** ``Optional[str]`` - *(optional)* rule is the strategy that will dictate what FSGroup is used in the
        SecurityContext.
    """
...
class HTTPIngressPath(DictMixin):
    """HTTPIngressPath associates a path regex with a backend. Incoming urls matching
      ...
      * **backend** ``IngressBackend`` - Backend defines the referenced service endpoint to which the traffic will be
        forwarded to.
      * **path** ``Optional[str]`` - *(optional)* Path is an extended POSIX regex as defined by IEEE Std 1003.1, (i.e this
...
class IPBlock(DictMixin):
    """DEPRECATED 1.9 - This group version of IPBlock is deprecated by
      ...
      * **except_** ``Optional[List[str]]`` - *(optional)* Except is a slice of CIDRs that should not be included within an IP Block
...
class Ingress(DictMixin):
    """Ingress is a collection of rules that allow inbound connections to reach the
      ...
      * **metadata** ``Optional[meta_v1.ObjectMeta]`` - *(optional)* Standard object's metadata. More info:
        https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
      * **spec** ``Optional[IngressSpec]`` - *(optional)* Spec is the desired state of the Ingress. More info:
        https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
      * **status** ``Optional[IngressStatus]`` - *(optional)* Status is the current state of the Ingress. More info:
        https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
    """
    apiVersion: 'Optional[str]' = None
    kind: 'Optional[str]' = None
...
class IngressList(DictMixin):
    """IngressList is a collection of Ingress.
      ...
      * **kind** ``Optional[str]`` - *(optional)* Kind is a string value representing the REST resource this object represents.
        ...
        Cannot be updated. In CamelCase. More info:
        https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      * **metadata** ``Optional[meta_v1.ListMeta]`` - *(optional)* Standard object's metadata. More info:
        https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
    """
    items: 'List[Ingress]'
    apiVersion: 'Optional[str]' = None
...
class IngressRule(DictMixin):
    """IngressRule represents the rules mapping the paths under a specified host to
      ...
      * **host** ``Optional[str]`` - *(optional)* Host is the fully qualified domain name of a network host, as defined by RFC
      ...
      * **http** ``Optional[HTTPIngressRuleValue]`` - *(optional)* 
    """
...
class IngressSpec(DictMixin):
    """IngressSpec describes the Ingress the user wishes to exist.
      ...
      * **backend** ``Optional[IngressBackend]`` - *(optional)* A default backend capable of servicing requests that don't match any rule. At
        ...
        default.
      * **rules** ``Optional[List[IngressRule]]`` - *(optional)* A list of host rules used to configure the Ingress. If unspecified, or no rule
        matches, all traffic is sent to the default backend.
      * **tls** ``Optional[List[IngressTLS]]`` - *(optional)* TLS configuration. Currently the Ingress only supports a single TLS port, 443.
...
class IngressStatus(DictMixin):
    """IngressStatus describe the current state of the Ingress.
      ...
      * **loadBalancer** ``Optional[core_v1.LoadBalancerStatus]`` - *(optional)* LoadBalancer contains the current status of the load-balancer.
    """
...
class IngressTLS(DictMixin):
    """IngressTLS describes the transport layer security associated with an Ingress.
      ...
      * **hosts** ``Optional[List[str]]`` - *(optional)* Hosts are a list of hosts included in the TLS certificate. The values in this
        ...
        unspecified.
      * **secretName** ``Optional[str]`` - *(optional)* SecretName is the name of the secret used to terminate SSL traffic on 443.
...
class NetworkPolicy(DictMixin):
    """DEPRECATED 1.9 - This group version of NetworkPolicy is deprecated by
      ...
      * **metadata** ``Optional[meta_v1.ObjectMeta]`` - *(optional)* Standard object's metadata. More info:
        https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
      * **spec** ``Optional[NetworkPolicySpec]`` - *(optional)* Specification of the desired behavior for this NetworkPolicy.
    """
    apiVersion: 'Optional[str]' = None
    kind: 'Optional[str]' = None
    metadata: 'Optional[meta_v1.ObjectMeta]' = None
...
class NetworkPolicyEgressRule(DictMixin):
    """DEPRECATED 1.9 - This group version of NetworkPolicyEgressRule is deprecated
      ...
      * **ports** ``Optional[List[NetworkPolicyPort]]`` - *(optional)* List of destination ports for outgoing traffic. Each item in this list is
      ...
      * **to** ``Optional[List[NetworkPolicyPeer]]`` - *(optional)* List of destinations for outgoing traffic of pods selected for this rule.
...
class NetworkPolicyIngressRule(DictMixin):
    """DEPRECATED 1.9 - This group version of NetworkPolicyIngressRule is deprecated
      ...
      * **from_** ``Optional[List[NetworkPolicyPeer]]`` - *(optional)* List of sources which should be able to access the pods selected for this
        ...
        in the from list.
      * **ports** ``Optional[List[NetworkPolicyPort]]`` - *(optional)* List of ports which should be made accessible on the pods selected for this
...
class NetworkPolicyPeer(DictMixin):
    """DEPRECATED 1.9 - This group version of NetworkPolicyPeer is deprecated by
      ...
      * **ipBlock** ``Optional[IPBlock]`` - *(optional)* IPBlock defines policy on a particular IPBlock. If this field is set then
        neither of the other fields can be.
      * **namespaceSelector** ``Optional[meta_v1.LabelSelector]`` - *(optional)* Selects Namespaces using cluster-scoped labels. This field follows standard
      ...
      * **podSelector** ``Optional[meta_v1.LabelSelector]`` - *(optional)* This is a label selector which selects Pods. This field follows standard label
...
class NetworkPolicyPort(DictMixin):
    """DEPRECATED 1.9 - This group version of NetworkPolicyPort is deprecated by
      ...
      * **port** ``Optional[util_intstr.IntOrString]`` - *(optional)* If specified, the port on the given protocol.  This can either be a numerical
        ...
        will be matched.
      * **protocol** ``Optional[str]`` - *(optional)* Optional.  The protocol (TCP, UDP, or SCTP) which traffic must match. If not
...
class NetworkPolicySpec(DictMixin):
    """DEPRECATED 1.9 - This group version of NetworkPolicySpec is deprecated by
      ...
      * **podSelector** ``meta_v1.LabelSelector`` - Selects the pods to which this NetworkPolicy object applies.  The array of
        ...
        namespace.
      * **egress** ``Optional[List[NetworkPolicyEgressRule]]`` - *(optional)* List of egress rules to be applied to the selected pods. Outgoing traffic is
      ...
      * **ingress** ``Optional[List[NetworkPolicyIngressRule]]`` - *(optional)* List of ingress rules to be applied to the selected pods. Traffic is allowed
        ...
        default).
      * **policyTypes** ``Optional[List[str]]`` - *(optional)* List of rule types that the NetworkPolicy relates to. Valid options are
...
class PodSecurityPolicy(DictMixin):
    """PodSecurityPolicy governs the ability to make requests that affect the
      ...
      * **metadata** ``Optional[meta_v1.ObjectMeta]`` - *(optional)* Standard object's metadata. More info:
        https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
      * **spec** ``Optional[PodSecurityPolicySpec]`` - *(optional)* spec defines the policy enforced.
    """
    apiVersion: 'Optional[str]' = None
    kind: 'Optional[str]' = None
    metadata: 'Optional[meta_v1.ObjectMeta]' = None
...
class PodSecurityPolicySpec(DictMixin):
    """PodSecurityPolicySpec defines the policy enforced. Deprecated: use
      ...
      * **allowPrivilegeEscalation** ``Optional[bool]`` - *(optional)* allowPrivilegeEscalation determines if a pod can request to allow privilege
        escalation. If unspecified, defaults to true.
      * **allowedCSIDrivers** ``Optional[List[AllowedCSIDriver]]`` - *(optional)* AllowedCSIDrivers is a whitelist of inline CSI drivers that must be explicitly
      ...
      * **allowedCapabilities** ``Optional[List[str]]`` - *(optional)* allowedCapabilities is a list of capabilities that can be requested to add to
      ...
      * **allowedFlexVolumes** ``Optional[List[AllowedFlexVolume]]`` - *(optional)* allowedFlexVolumes is a whitelist of allowed Flexvolumes.  Empty or nil
      ...
      * **allowedHostPaths** ``Optional[List[AllowedHostPath]]`` - *(optional)* allowedHostPaths is a white list of allowed host paths. Empty indicates that
        all host paths may be used.
      * **allowedProcMountTypes** ``Optional[List[str]]`` - *(optional)* AllowedProcMountTypes is a whitelist of allowed ProcMountTypes. Empty or nil
        indicates that only the DefaultProcMountType may be used. This requires the
        ProcMountType feature flag to be enabled.
      * **allowedUnsafeSysctls** ``Optional[List[str]]`` - *(optional)* allowedUnsafeSysctls is a list of explicitly allowed unsafe sysctls, defaults
        ...
        "foo.bar", "foo.baz", etc.
      * **defaultAddCapabilities** ``Optional[List[str]]`` - *(optional)* defaultAddCapabilities is the default set of capabilities that will be added
      ...
      * **defaultAllowPrivilegeEscalation** ``Optional[bool]`` - *(optional)* defaultAllowPrivilegeEscalation controls the default setting for whether a
        process can gain more privileges than its parent process.
      * **forbiddenSysctls** ``Optional[List[str]]`` - *(optional)* forbiddenSysctls is a list of explicitly forbidden sysctls, defaults to none.
        ...
        "foo.bar", "foo.baz", etc.
      * **hostIPC** ``Optional[bool]`` - *(optional)* hostIPC determines if the policy allows the use of HostIPC in the pod spec.
      * **hostNetwork** ``Optional[bool]`` - *(optional)* hostNetwork determines if the policy allows the use of HostNetwork in the pod
        spec.
      * **hostPID** ``Optional[bool]`` - *(optional)* hostPID determines if the policy allows the use of HostPID in the pod spec.
      * **hostPorts** ``Optional[List[HostPortRange]]`` - *(optional)* hostPorts determines which host port ranges are allowed to be exposed.
      * **privileged** ``Optional[bool]`` - *(optional)* privileged determines if a pod can request to be run as privileged.
      * **readOnlyRootFilesystem** ``Optional[bool]`` - *(optional)* readOnlyRootFilesystem when set to true will force containers to run with a
      ...
      * **requiredDropCapabilities** ``Optional[List[str]]`` - *(optional)* requiredDropCapabilities are the capabilities that will be dropped from the
        container.  These are required to be dropped and cannot be added.
      * **runAsGroup** ``Optional[RunAsGroupStrategyOptions]`` - *(optional)* RunAsGroup is the strategy that will dictate the allowable RunAsGroup values
      ...
      * **runtimeClass** ``Optional[RuntimeClassStrategyOptions]`` - *(optional)* runtimeClass is the strategy that will dictate the allowable RuntimeClasses
        ...
        gate being enabled.
      * **volumes** ``Optional[List[str]]`` - *(optional)* volumes is a white list of allowed volume plugins. Empty indicates that no
...
class ReplicaSet(DictMixin):
    """DEPRECATED - This group version of ReplicaSet is deprecated by
      ...
      * **kind** ``Optional[str]`` - *(optional)* Kind is a string value representing the REST resource this object represents.
        ...
        Cannot be updated. In CamelCase. More info:
        https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      * **metadata** ``Optional[meta_v1.ObjectMeta]`` - *(optional)* If the Labels of a ReplicaSet are empty, they are defaulted to be the same as
        the Pod(s) that the ReplicaSet manages. Standard object's metadata. More info:
        https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
      * **spec** ``Optional[ReplicaSetSpec]`` - *(optional)* Spec defines the specification of the desired behavior of the ReplicaSet. More
        info:
        https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
      * **status** ``Optional[ReplicaSetStatus]`` - *(optional)* Status is the most recently observed status of the ReplicaSet. This data may
...
class ReplicaSetSpec(DictMixin):
    """ReplicaSetSpec is the specification of a ReplicaSet.
      ...
      * **selector** ``Optional[meta_v1.LabelSelector]`` - *(optional)* Selector is a label query over pods that should match the replica count. If
        ...
        https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/#label-selectors
      * **template** ``Optional[core_v1.PodTemplateSpec]`` - *(optional)* Template is the object that describes the pod that will be created if
...
class ReplicaSetStatus(DictMixin):
    """ReplicaSetStatus represents the current status of a ReplicaSet.
      ...
      * **availableReplicas** ``Optional[int]`` - *(optional)* The number of available replicas (ready for at least minReadySeconds) for this
        replica set.
      * **conditions** ``Optional[List[ReplicaSetCondition]]`` - *(optional)* Represents the latest available observations of a replica set's current state.
      ...
      * **observedGeneration** ``Optional[int]`` - *(optional)* ObservedGeneration reflects the generation of the most recently observed
        ReplicaSet.
      * **readyReplicas** ``Optional[int]`` - *(optional)* The number of ready replicas for this replica set.
    """
    replicas: 'int'
    availableReplicas: 'Optional[int]' = None
...
class RollbackConfig(DictMixin):
    """DEPRECATED.
      ...
      * **revision** ``Optional[int]`` - *(optional)* The revision to rollback to. If set to 0, rollback to the last revision.
    """
...
class RollingUpdateDaemonSet(DictMixin):
    """Spec to control the desired behavior of daemon set rolling update.
      ...
      * **maxUnavailable** ``Optional[util_intstr.IntOrString]`` - *(optional)* The maximum number of DaemonSet pods that can be unavailable during the
...
class RollingUpdateDeployment(DictMixin):
    """Spec to control the desired behavior of rolling update.
      ...
      * **maxSurge** ``Optional[util_intstr.IntOrString]`` - *(optional)* The maximum number of pods that can be scheduled above the desired number of
      ...
      * **maxUnavailable** ``Optional[util_intstr.IntOrString]`` - *(optional)* The maximum number of pods that can be unavailable during the update. Value
...
class RunAsGroupStrategyOptions(DictMixin):
    """RunAsGroupStrategyOptions defines the strategy type and any options used to
      ...
      * **rule** ``str`` - rule is the strategy that will dictate the allowable RunAsGroup values that
        may be set.
      * **ranges** ``Optional[List[IDRange]]`` - *(optional)* ranges are the allowed ranges of gids that may be used. If you would like to
...
class RunAsUserStrategyOptions(DictMixin):
    """RunAsUserStrategyOptions defines the strategy type and any options used to
      ...
      * **rule** ``str`` - rule is the strategy that will dictate the allowable RunAsUser values that may
        be set.
      * **ranges** ``Optional[List[IDRange]]`` - *(optional)* ranges are the allowed ranges of uids that may be used. If you would like to
...
class RuntimeClassStrategyOptions(DictMixin):
    """RuntimeClassStrategyOptions define the strategy that will dictate the
      ...
      * **defaultRuntimeClassName** ``Optional[str]`` - *(optional)* defaultRuntimeClassName is the default RuntimeClassName to set on the pod. The
...
class SELinuxStrategyOptions(DictMixin):
    """SELinuxStrategyOptions defines the strategy type and any options used to
      ...
      * **seLinuxOptions** ``Optional[core_v1.SELinuxOptions]`` - *(optional)* seLinuxOptions required to run as; required for MustRunAs More info:
...
class Scale(DictMixin):
    """represents a scaling request for a resource.
      ...
      * **kind** ``Optional[str]`` - *(optional)* Kind is a string value representing the REST resource this object represents.
        ...
        Cannot be updated. In CamelCase. More info:
        https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      * **metadata** ``Optional[meta_v1.ObjectMeta]`` - *(optional)* Standard object metadata; More info:
        https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata.
      * **spec** ``Optional[ScaleSpec]`` - *(optional)* defines the behavior of the scale. More info:
        https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status.
      * **status** ``Optional[ScaleStatus]`` - *(optional)* current status of the scale. More info:
        https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status.
        Read-only.
    """
    apiVersion: 'Optional[str]' = None
...
class ScaleSpec(DictMixin):
    """describes the attributes of a scale subresource
      ...
      * **replicas** ``Optional[int]`` - *(optional)* desired number of instances for the scaled object.
    """
    replicas: 'Optional[int]' = None
...
class ScaleStatus(DictMixin):
    """represents the current status of a scale subresource.
      ...
      * **selector** ``Optional[dict]`` - *(optional)* label query over pods that should match the replicas count. More info:
        http://kubernetes.io/docs/user-guide/labels#label-selectors
      * **targetSelector** ``Optional[str]`` - *(optional)* label selector for pods that should match the replicas count. This is a
...
class SupplementalGroupsStrategyOptions(DictMixin):
    """SupplementalGroupsStrategyOptions defines the strategy type and options used
      ...
      * **ranges** ``Optional[List[IDRange]]`` - *(optional)* ranges are the allowed ranges of supplemental groups.  If you would like to
        force a single supplemental group then supply a single range with the same
        start and end. Required for MustRunAs.
      * **rule** ``Optional[str]`` - *(optional)* rule is the strategy that will dictate what supplemental groups is used in the
        SecurityContext.
    """
    ranges: 'Optional[List[IDRange]]' = None
    rule: 'Optional[str]' = None
