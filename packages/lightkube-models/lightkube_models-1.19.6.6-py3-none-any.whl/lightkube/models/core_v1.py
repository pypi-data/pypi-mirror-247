...
class ServiceSpec(DictMixin):
    """ServiceSpec describes the attributes that a user creates on a service.
      ...
      * **topologyKeys** ``Optional[List[str]]`` - topologyKeys is a preference-order list of topology keys which implementations
...
class Volume(DictMixin):
    """Volume represents a named volume in a pod that may be accessed by any
      ...
      * **ephemeral** ``Optional[EphemeralVolumeSource]`` - Ephemeral represents a volume that is handled by a cluster storage driver
