...
class ParamRef(DictMixin):
    """ParamRef references a parameter resource
      ...
      * **name** ``Optional[str]`` - *(optional)* Name of the resource being referenced.
      * **namespace** ``Optional[str]`` - *(optional)* Namespace of the referenced resource. Should be empty for the cluster-scoped
        resources
    """
