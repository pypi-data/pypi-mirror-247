...
class CSIDriver(DictMixin):
    """CSIDriver captures information about a Container Storage Interface (CSI)
      volume driver deployed on the cluster. CSI drivers do not need to create the
      CSIDriver object directly. Instead they may use the cluster-driver-registrar
      sidecar container. When deployed with a CSI driver it automatically creates a
      CSIDriver object representing the driver. Kubernetes attach detach controller
      ...
      * **metadata** ``Optional[meta_v1.ObjectMeta]`` - *(optional)* Standard object metadata. metadata.Name indicates the name of the CSI driver
...
class CSIDriverSpec(DictMixin):
    """CSIDriverSpec is the specification of a CSIDriver.
      ...
      * **attachRequired** ``Optional[bool]`` - *(optional)* attachRequired indicates this CSI volume driver requires an attach operation
      ...
      * **fsGroupPolicy** ``Optional[str]`` - *(optional)* Defines if the underlying volume supports changing ownership and permission of
        the volume before being mounted. Refer to the specific FSGroupPolicy values
        for additional details. This field is alpha-level, and is only honored by
        servers that enable the CSIVolumeFSGroupPolicy feature gate.
        This field is immutable.
      * **podInfoOnMount** ``Optional[bool]`` - *(optional)* If set to true, podInfoOnMount indicates this CSI volume driver requires
        ...
        This field is immutable.
      * **requiresRepublish** ``Optional[bool]`` - *(optional)* RequiresRepublish indicates the CSI driver wants `NodePublishVolume` being
        ...
        feature is enabled.
      * **storageCapacity** ``Optional[bool]`` - *(optional)* If set to true, storageCapacity indicates that the CSI volume driver wants pod
      ...
      * **tokenRequests** ``Optional[List[TokenRequest]]`` - *(optional)* TokenRequests indicates the CSI driver needs pods' service account tokens it
        ...
        This is a beta feature and only available when the CSIServiceAccountToken
        feature is enabled.
      * **volumeLifecycleModes** ``Optional[List[str]]`` - *(optional)* VolumeLifecycleModes defines what kind of volumes this CSI volume driver
...
class CSINode(DictMixin):
    """DEPRECATED - This group version of CSINode is deprecated by
      storage/v1/CSINode. See the release notes for more information. CSINode holds
      information about all CSI drivers installed on a node. CSI drivers do not need
      to create the CSINode object directly. As long as they use the
      node-driver-registrar sidecar container, the kubelet will automatically
      ...
      * **kind** ``Optional[str]`` - *(optional)* Kind is a string value representing the REST resource this object represents.
        ...
        Cannot be updated. In CamelCase. More info:
        https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      * **metadata** ``Optional[meta_v1.ObjectMeta]`` - *(optional)* metadata.name must be the Kubernetes node name.
    """
    spec: 'CSINodeSpec'
    apiVersion: 'Optional[str]' = None
    kind: 'Optional[str]' = None
...
class CSINodeDriver(DictMixin):
    """CSINodeDriver holds information about the specification of one CSI driver
      ...
      * **nodeID** ``str`` - nodeID of the node from the driver point of view. This field enables
        ...
        field is required.
      * **allocatable** ``Optional[VolumeNodeResources]`` - *(optional)* allocatable represents the volume resources of a node that are available for
        scheduling.
      * **topologyKeys** ``Optional[List[str]]`` - *(optional)* topologyKeys is the list of keys supported by the driver. When a driver is
...
class CSIStorageCapacity(DictMixin):
    """CSIStorageCapacity stores the result of one CSI GetCapacity call. For a given
      ...
      * **apiVersion** ``Optional[str]`` - *(optional)* APIVersion defines the versioned schema of this representation of an object.
        ...
        may reject unrecognized values. More info:
        https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
      * **capacity** ``Optional[resource.Quantity]`` - *(optional)* Capacity is the value reported by the CSI driver in its GetCapacityResponse
      ...
      * **kind** ``Optional[str]`` - *(optional)* Kind is a string value representing the REST resource this object represents.
        ...
        Cannot be updated. In CamelCase. More info:
        https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      * **maximumVolumeSize** ``Optional[resource.Quantity]`` - *(optional)* MaximumVolumeSize is the value reported by the CSI driver in its
        ...
        claim.
      * **metadata** ``Optional[meta_v1.ObjectMeta]`` - *(optional)* Standard object's metadata. The name has no particular meaning. It must be be
        ...
        More info:
        https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
      * **nodeTopology** ``Optional[meta_v1.LabelSelector]`` - *(optional)* NodeTopology defines which nodes have access to the storage for which capacity
...
class StorageClass(DictMixin):
    """StorageClass describes the parameters for a class of storage for which
      ...
      * **allowVolumeExpansion** ``Optional[bool]`` - *(optional)* AllowVolumeExpansion shows whether the storage class allow volume expand
      * **allowedTopologies** ``Optional[List[core_v1.TopologySelectorTerm]]`` - *(optional)* Restrict the node topologies where volumes can be dynamically provisioned.
      ...
      * **metadata** ``Optional[meta_v1.ObjectMeta]`` - *(optional)* Standard object's metadata. More info:
        https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
      * **mountOptions** ``Optional[List[str]]`` - *(optional)* Dynamically provisioned PersistentVolumes of this storage class are created
        with these mountOptions, e.g. ["ro", "soft"]. Not validated - mount of the PVs
        will simply fail if one is invalid.
      * **parameters** ``Optional[dict]`` - *(optional)* Parameters holds the parameters for the provisioner that should create volumes
        of this storage class.
      * **reclaimPolicy** ``Optional[str]`` - *(optional)* Dynamically provisioned PersistentVolumes of this storage class are created
        with this reclaimPolicy. Defaults to Delete.
      * **volumeBindingMode** ``Optional[str]`` - *(optional)* VolumeBindingMode indicates how PersistentVolumeClaims should be provisioned
...
class TokenRequest(DictMixin):
    """TokenRequest contains parameters of a service account token.
      ...
      * **expirationSeconds** ``Optional[int]`` - *(optional)* ExpirationSeconds is the duration of validity of the token in
...
class VolumeAttachment(DictMixin):
    """VolumeAttachment captures the intent to attach or detach the specified volume
      ...
      * **metadata** ``Optional[meta_v1.ObjectMeta]`` - *(optional)* Standard object metadata. More info:
        https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
      * **status** ``Optional[VolumeAttachmentStatus]`` - *(optional)* Status of the VolumeAttachment request. Populated by the entity completing the
...
class VolumeAttachmentSource(DictMixin):
    """VolumeAttachmentSource represents a volume that should be attached. Right now
      ...
      * **inlineVolumeSpec** ``Optional[core_v1.PersistentVolumeSpec]`` - *(optional)* inlineVolumeSpec contains all the information necessary to attach a persistent
      ...
      * **persistentVolumeName** ``Optional[str]`` - *(optional)* Name of the persistent volume to attach.
    """
...
class VolumeAttachmentStatus(DictMixin):
    """VolumeAttachmentStatus is the status of a VolumeAttachment request.
      ...
      * **attachError** ``Optional[VolumeError]`` - *(optional)* The last error encountered during attach operation, if any. This field must
        only be set by the entity completing the attach operation, i.e. the
        external-attacher.
      * **attachmentMetadata** ``Optional[dict]`` - *(optional)* Upon successful attach, this field is populated with any information returned
      ...
      * **detachError** ``Optional[VolumeError]`` - *(optional)* The last error encountered during detach operation, if any. This field must
...
class VolumeError(DictMixin):
    """VolumeError captures an error encountered during a volume operation.
      ...
      * **message** ``Optional[str]`` - *(optional)* String detailing the error encountered during Attach or Detach operation. This
        string may be logged, so it should not contain sensitive information.
      * **time** ``Optional[meta_v1.Time]`` - *(optional)* Time the error was encountered.
    """
...
class VolumeNodeResources(DictMixin):
    """VolumeNodeResources is a set of resource limits for scheduling of volumes.
      ...
      * **count** ``Optional[int]`` - *(optional)* Maximum number of unique volumes managed by the CSI driver that can be used on
        ...
        shared among multiple pods on the same node. If this field is nil, then the
