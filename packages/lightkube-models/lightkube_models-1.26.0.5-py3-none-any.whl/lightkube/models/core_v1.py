...
class ContainerStatus(DictMixin):
    """ContainerStatus contains details for the current status of this container.
      ...
      * **containerID** ``Optional[str]`` - *(optional)* Container's ID in the format '<type>://<container_id>'.
      * **lastState** ``Optional[ContainerState]`` - *(optional)* Details about the container's last termination condition.
      * **started** ``Optional[bool]`` - *(optional)* Specifies whether the container has passed its startup probe. Initialized as
      ...
      * **state** ``Optional[ContainerState]`` - *(optional)* Details about the container's current condition.
    """
    image: 'str'
    imageID: 'str'
    name: 'str'
...
class Probe(DictMixin):
    """Probe describes a health check to be performed against a container to
      ...
      * **grpc** ``Optional[GRPCAction]`` - *(optional)* GRPC specifies an action involving a GRPC port. This is a beta field and
