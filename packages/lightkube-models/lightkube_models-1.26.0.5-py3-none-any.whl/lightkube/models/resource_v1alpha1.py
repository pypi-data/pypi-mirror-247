...
class AllocationResult(DictMixin):
    """AllocationResult contains attributed of an allocated resource.
      ...
      * **resourceHandle** ``Optional[str]`` - *(optional)* ResourceHandle contains arbitrary data returned by the driver after a
...
class PodScheduling(DictMixin):
    """PodScheduling objects hold information that is needed to schedule a Pod with
      ...
      * **status** ``Optional[PodSchedulingStatus]`` - *(optional)* Status describes where resources for the Pod can be allocated.
    """
...
class ResourceClaimStatus(DictMixin):
    """ResourceClaimStatus tracks whether the resource has been allocated and what
      ...
      * **allocation** ``Optional[AllocationResult]`` - *(optional)* Allocation is set by the resource driver once a resource has been allocated
