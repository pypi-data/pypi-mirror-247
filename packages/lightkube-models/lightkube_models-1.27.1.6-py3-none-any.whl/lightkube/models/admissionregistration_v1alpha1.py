...
class ParamRef(DictMixin):
    """ParamRef references a parameter resource
      ...
      * **name** ``Optional[str]`` - Name of the resource being referenced.
      * **namespace** ``Optional[str]`` - Namespace of the referenced resource. Should be empty for the cluster-scoped
        resources
    """
