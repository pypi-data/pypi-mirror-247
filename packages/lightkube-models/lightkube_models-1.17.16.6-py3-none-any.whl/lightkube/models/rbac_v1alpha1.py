...
class PolicyRule(DictMixin):
    """PolicyRule holds information that describes a policy rule, but does not
      ...
      * **resources** ``Optional[List[str]]`` - Resources is a list of resources this rule applies to.  ResourceAll represents
        all resources.
    """
    verbs: 'List[str]'
...
class Subject(DictMixin):
    """Subject contains a reference to the object or user identities a role binding
      ...
      * **apiVersion** ``Optional[str]`` - APIVersion holds the API group and version of the referenced subject. Defaults
