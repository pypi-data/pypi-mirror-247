"use strict";
(self["webpackChunkjupyterlab_asksmce_voat"] = self["webpackChunkjupyterlab_asksmce_voat"] || []).push([["lib_index_js"],{
...
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "fb29b6ad8cd60b9112b8c9b51c8b3b5ad3b87e8e128700a4b9033bbf7d3978c0.png");
...
/* harmony import */ var _mui_material_Dialog__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @mui/material/Dialog */ "./node_modules/@mui/material/esm/Dialog/Dialog.js");
...
/* harmony import */ var _widgets_ChatlasWidget__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./widgets/ChatlasWidget */ "./lib/widgets/ChatlasWidget.js");
/* harmony import */ var _widgets_GetSupportFormWidget__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./widgets/GetSupportFormWidget */ "./lib/widgets/GetSupportFormWidget.js");
/* harmony import */ var _widgets_AboutWidget__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./widgets/AboutWidget */ "./lib/widgets/AboutWidget.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./utils */ "./lib/utils.js");
/* harmony import */ var _style_IconsStyle__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./style/IconsStyle */ "./lib/style/IconsStyle.js");
...
const plugin = {
    id: PLUGIN_ID,
    requires: [_jupyterlab_mainmenu__WEBPACK_IMPORTED_MODULE_1__.IMainMenu, _jupyterlab_settingregistry__WEBPACK_IMPORTED_MODULE_5__.ISettingRegistry, _jupyterlab_launcher__WEBPACK_IMPORTED_MODULE_3__.ILauncher],
    autoStart: true,
    activate
};
let atlasId = '';
async function activate(app, mainMenu, settings, launcher) {
    ...
    Promise.all([app.restored, settings.load(PLUGIN_ID)])
        ...
        //await saveSetting(setting, 'ec30b07b-6f09-4529-ba28-9cb7ed23b8e0')
        await (0,_utils__WEBPACK_IMPORTED_MODULE_6__.saveSetting)(setting, '59e9d968-9c6a-45b3-aa07-cbdc5207e406');
        atlasId = (0,_utils__WEBPACK_IMPORTED_MODULE_6__.loadSetting)(setting);
    }).catch((reason) => {
    ...
    app.commands.addCommand(openChatlas, {
        ...
        icon: (args) => (args["isPalette"] ? undefined : _style_IconsStyle__WEBPACK_IMPORTED_MODULE_7__.getHelpIcon),
        execute: async () => {
            const content = new _widgets_ChatlasWidget__WEBPACK_IMPORTED_MODULE_8__.ChatlasWidget(atlasId);
    ...
    app.commands.addCommand(getSupport, {
        ...
        execute: async () => {
            console.log(`TreeURL => ${JSON.stringify(_jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_0__.PageConfig.getOption('treeUrl'))}`);
            console.log(`BaseURL => ${JSON.stringify(_jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_0__.PageConfig.getOption('baseUrl'))}`);
            console.log(`AppURL => ${JSON.stringify(_jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_0__.PageConfig.getOption('appUrl'))}`);
            const content = new _widgets_GetSupportFormWidget__WEBPACK_IMPORTED_MODULE_9__.GetSupportFormWidget({ username: "frivas" });
            content.title.label = 'Contact Support';
            _lumino_widgets__WEBPACK_IMPORTED_MODULE_4__.Widget.attach(content, document.body);
        }
    });
    app.commands.addCommand(aboutVoiceAtlas, {
        ...
        execute: async () => {
            const { aboutBody, aboutTitle } = (0,_widgets_AboutWidget__WEBPACK_IMPORTED_MODULE_10__.aboutVoiceAtlasDialog)();
            const result = await (0,_jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_2__.showDialog)({
                title: aboutTitle,
                body: aboutBody,
                buttons: [
                    _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_2__.Dialog.createButton({
                        label: 'Dismiss',
...
const getHelpIcon = new _jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_0__.LabIcon({ name: 'getHelp', svgstr: _style_icons8_get_help_svg__WEBPACK_IMPORTED_MODULE_1__["default"] });
const ossLogo = new _jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_0__.LabIcon({ name: 'ossLogo', svgstr: _style_OSS_Logo_Draft_svg__WEBPACK_IMPORTED_MODULE_2__["default"] });
const ossOriginal = new _jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_0__.LabIcon({ name: 'ossOriginal', svgstr: _style_OSS_original_svg__WEBPACK_IMPORTED_MODULE_3__["default"] });
...
/* harmony import */ var lodash_isempty__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! lodash.isempty */ "webpack/sharing/consume/default/lodash.isempty/lodash.isempty");
/* harmony import */ var lodash_isempty__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(lodash_isempty__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _widgets_EditSettingsWidget__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./widgets/EditSettingsWidget */ "./lib/widgets/EditSettingsWidget.js");
...
function loadSetting(setting) {
    ...
    let atlasId = setting.get('atlasId-asksmce').composite;
    return atlasId;
}
async function saveSetting(setting, atlasId) {
    // Read the settings and convert to the correct type
    await setting.set('atlasId-asksmce', atlasId);
    return atlasId;
}
async function configureNewAtlas(settings, pluginId) {
    ...
    let currentAtlasID = await Promise.all([settings.load(pluginId)])
        ...
        jupyterlab_toastify__WEBPACK_IMPORTED_MODULE_1__.INotification.error(`Could not get the configuration. Please contact the administrator.`, { autoClose: 3000 });
    ...
    const newAtlasID = await (0,_jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_0__.showDialog)({
        body: new _widgets_EditSettingsWidget__WEBPACK_IMPORTED_MODULE_3__.EditSettingsWidget(currentAtlasID || ""),
    ...
    if (lodash_isempty__WEBPACK_IMPORTED_MODULE_2___default()(newAtlasID.value)) {
        jupyterlab_toastify__WEBPACK_IMPORTED_MODULE_1__.INotification.error(`Please, insert a valid Atlas Id. Visit help.voiceatlas.com for more information.`, { autoClose: 3000 });
        return;
    }
    ...
    await Promise.all([settings.load(pluginId)])
        ...
        jupyterlab_toastify__WEBPACK_IMPORTED_MODULE_1__.INotification.success('Success', {
            autoClose: 3000
        });
        return newAtlasID.value;
    }).catch((reason) => {
        jupyterlab_toastify__WEBPACK_IMPORTED_MODULE_1__.INotification.error(`Could not save the configuration. Please contact the administrator.`, {
            autoClose: 3000
        });
...
function aboutVoiceAtlasDialog() {
    ...
    const aboutTitle = (react__WEBPACK_IMPORTED_MODULE_0__.createElement("span", { className: "jp-About-header" },
        react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: "jp-About-header-info" },
            react__WEBPACK_IMPORTED_MODULE_0__.createElement("img", { src: _style_OSS_original_png__WEBPACK_IMPORTED_MODULE_1__["default"], height: "auto", width: "196px" }),
            versionInfo)));
    ...
    const copyright = (react__WEBPACK_IMPORTED_MODULE_0__.createElement("span", { className: "jp-About-copyright" },
        '© 2019-2023 Voice Atlas by Navteca LLC',
        react__WEBPACK_IMPORTED_MODULE_0__.createElement("br", null),
        '© 2023 Open Science Studio by Navteca LLC'));
...
//# sourceMappingURL=lib_index_js.01fe8cb86d5e8f9e21ae.js.map