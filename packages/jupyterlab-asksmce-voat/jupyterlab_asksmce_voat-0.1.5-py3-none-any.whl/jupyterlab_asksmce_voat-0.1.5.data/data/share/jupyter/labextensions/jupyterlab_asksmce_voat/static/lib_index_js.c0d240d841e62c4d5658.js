...
async function activate(app, mainMenu, settings, launcher) {
    ...
    app.commands.addCommand(getSupport, {
        ...
        execute: async () => {
            console.log(`hubUser => ${JSON.stringify(_jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_0__.PageConfig.getOption('hubUser'))}`);
            console.log(`Server Root => ${JSON.stringify(_jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_0__.PageConfig.getOption('serverRoot'))}`);
...
//# sourceMappingURL=lib_index_js.c0d240d841e62c4d5658.js.map