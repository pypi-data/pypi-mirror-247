...
class LabJack(SingleCommDevice):
    ...
    def __init__(self, com, dev_config=None) -> None:
        ...
        self.configured_pulse_addresses: list[Union[str, labjack.TSeriesDIOChannel]] = (
            []
        )
    ...
    def set_ain_thermocouple(
        ...
        cjc_type: Union[str, CjcType] = (CjcType.internal),  # type: ignore
        vrange: Union[Real, AInRange] = (AInRange.ONE_HUNDREDTH),  # type: ignore
        resolution: int = 10,
        unit: Union[str, TemperatureUnit] = (TemperatureUnit.K),  # type: ignore
    ) -> None:
        """
    ...
    def config_high_pulse(
        self,
        address: Union[str, labjack.TSeriesDIOChannel],
        t_start: Number,
        t_width: Number,
        n_pulses: int = 1,
    ) -> None:
    ...
    def disable_pulses(
        self, *addresses: Optional[Union[str, labjack.TSeriesDIOChannel]]
    ) -> None:
        """
