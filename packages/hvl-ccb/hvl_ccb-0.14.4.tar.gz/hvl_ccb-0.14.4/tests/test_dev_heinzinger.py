...
def test_heinzinger_number_of_recordings(started_heinzinger_device):
...
def test_heinzinger_instantiation(com_config, dev_config):
...
def test_heinzinger_stop(started_heinzinger_device):
    com, heinzinger = started_heinzinger_device
    com.put_text("0.0")
    heinzinger.stop()
...
def test_heinzinger_reset_interface(started_heinzinger_device):
    com, heinzinger = started_heinzinger_device
...
def test_heinzinger_output_status_property(started_heinzinger_device):
    com, heinzinger = started_heinzinger_device
...
def test_heinzinger_com_error(com_config, dev_config):
    ...
    with pytest.raises(SerialCommunicationIOError):
        heinzinger.number_of_recordings
    with pytest.raises(SerialCommunicationIOError):
...
def test_heinzinger_deprecation_warning(started_heinzinger_device):
    com, heinzinger = started_heinzinger_device
...
def test_heinzinger_start(start_heinzinger_device, com_config, device_data):
...
def test_heinzinger_not_recognized(start_heinzinger_device):
    with pytest.raises(HeinzingerDeviceNotRecognizedError):
        next(start_heinzinger_device("ABC 600-3000pos 375214277"))


def test_heinzinger_set_max_voltage(start_heinzinger_device):
...
def test_pnc_set_max_current(start_heinzinger_device):
    started_heinzinger = start_heinzinger_device("PNC 600-3000pos 375214277")
    com, heinzinger = next(started_heinzinger)
...
def test_pnc_set_negative(start_heinzinger_device):
    started_heinzinger = start_heinzinger_device("PNC 600-3000pos 375214277")
    com, heinzinger = next(started_heinzinger)
...
def test_heinzinger_set_voltage(start_heinzinger_device, device_data):
    started_heinzinger = start_heinzinger_device(device_data[0])
    com, heinzinger = next(started_heinzinger)
...
def test_heinzinger_set_current(start_heinzinger_device, device_data):
    started_heinzinger = start_heinzinger_device(device_data[0])
    com, heinzinger = next(started_heinzinger)
