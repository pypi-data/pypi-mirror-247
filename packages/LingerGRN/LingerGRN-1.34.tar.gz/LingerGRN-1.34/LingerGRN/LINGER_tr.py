...
def load_data(GRNdir,Input_dir,outdir):
...
import pandas as pd
import numpy as np
def training(GRNdir,Input_dir,method,outdir,activef):
    if method=='LINGER':
        hidden_size  = 64
        hidden_size2 = 16
        output_size = 1
        ...
        Exp,idx,Opn,adj_matrix_all,Target,data_merge,TF_match=load_data(GRNdir,Input_dir,outdir)
