...
def test_sa_timezone_response(fixture_api_sa_work_no_download_dir):
    response = fixture_api_sa_work_no_download_dir.get_timezone_id(output_choice=OutputChoices.json_response_in_memory)
