...
def title_with_date(header=None, date_int=None, language=GlobalCalling.looq.language):
    ...
    Args:
        header (str): Text to be placed before the date
        date_int (list): Date(s) interval to be used in the title
    ...
    Examples:
        >>> title_with_date(header="Vendas", date_int=["2020-01-01", "2020-01-31"], language="pt-br")
        >>> "Vendas de 01/01/2020 a 31/01/2020"
    """
    if language == "pt-br":
        var_day = " dia "
        var_from = " de "
