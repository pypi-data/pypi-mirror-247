...
from kakaimagededup.handlers.search.retrieval import get_cosine_similarity
from kakaimagededup.utils.data_generator import img_dataloader
from kakaimagededup.utils.models import CustomModel, MobilenetV3, DEFAULT_MODEL_NAME
from kakaimagededup.utils.general_utils import (
    generate_relative_names,
    get_files_to_remove,
    save_json,
)
from kakaimagededup.utils.image_utils import (
...
class CNN:
    ...
    def encode_image(
        ...
        Example:
        ```
        from kakaimagededup.methods import CNN
        myencoder = CNN()
