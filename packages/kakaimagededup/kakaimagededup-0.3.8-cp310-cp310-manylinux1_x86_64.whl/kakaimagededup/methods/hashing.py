...
from kakaimagededup.handlers.search.retrieval import HashEval
from kakaimagededup.utils.general_utils import (
    get_files_to_remove,
    save_json,
    parallelise,
    generate_files,
...
from kakaimagededup.utils.image_utils import load_image, preprocess_image, check_image_array_hash
...
class Hashing:
    ...
    def encode_image(
        ...
        Example:
        ```
        from kakaimagededup.methods import <hash-method>
...
class AHash(Hashing):
    ...
    from kakaimagededup.methods import AHash
    ahasher = AHash()
...
class DHash(Hashing):
    ...
    from kakaimagededup.methods import DHash
    dhasher = DHash()
...
class WHash(Hashing):
    ...
    from kakaimagededup.methods import WHash
    whasher = WHash()
