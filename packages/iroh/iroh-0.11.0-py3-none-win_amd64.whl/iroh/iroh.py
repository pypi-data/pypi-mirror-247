...
def _uniffi_check_api_checksums(lib):
    ...
    if lib.uniffi_iroh_checksum_method_authorid_to_string() != 42389:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_checksum_method_connectiontype_as_direct() != 41690:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_checksum_method_connectiontype_as_mixed() != 41300:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_checksum_method_connectiontype_as_relay() != 47022:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_checksum_method_connectiontype_type() != 1057:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_checksum_method_directaddrinfo_addr() != 49936:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_iroh_checksum_method_irohnode_status() != 32660:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_checksum_method_irohnode_tags_delete() != 21632:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_iroh_checksum_method_nodeaddr_equal() != 45841:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_checksum_method_nodestatusresponse_listen_addrs() != 44280:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
...
_UniffiLib.uniffi_iroh_fn_method_connectiontype_as_direct.restype = ctypes.c_void_p
...
_UniffiLib.uniffi_iroh_fn_method_connectiontype_as_relay.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_iroh_fn_method_directaddrinfo_addr.restype = ctypes.c_void_p
...
class ConnectionType:
    ...
    def as_direct(self, ) -> "SocketAddr":
        '''Return the [`SocketAddr`] if this is a direct connection'''
        return _UniffiConverterTypeSocketAddr.lift(
...
class IrohNode:
    ...
    def doc_drop(self, doc_id: "NamespaceId"):
        '''
    ...
    _UniffiConverterTypeIrohError,_UniffiLib.uniffi_iroh_fn_method_irohnode_doc_drop,self._pointer,
        _UniffiConverterTypeNamespaceId.lower(doc_id))
    ...
    def doc_open(self, id: "NamespaceId") -> "typing.Optional[Doc]":
        '''
        Get a [`Doc`].
    ...
    _UniffiConverterTypeIrohError,_UniffiLib.uniffi_iroh_fn_method_irohnode_doc_open,self._pointer,
        _UniffiConverterTypeNamespaceId.lower(id))
        )
...
class NodeStatusResponse:
    ...
    def listen_addrs(self, ) -> "typing.List[SocketAddr]":
...
class ConnectionTypeMixed:
    ...
    addr: "SocketAddr";derp_region: "int";

    @typing.no_type_check
    def __init__(self, addr: "SocketAddr", derp_region: "int"):
        self.addr = addr
        '''Address of the node'''
        self.derp_region = derp_region
    ...
    def __str__(self):
        return "ConnectionTypeMixed(addr={}, derp_region={})".format(self.addr, self.derp_region)
...
class _UniffiConverterTypeConnectionTypeMixed(_UniffiConverterRustBuffer):
    ...
    def read(buf):
        return ConnectionTypeMixed(
            addr=_UniffiConverterTypeSocketAddr.read(buf),
            derp_region=_UniffiConverterUInt16.read(buf),
        )

    @staticmethod
    def write(value, buf):
        _UniffiConverterTypeSocketAddr.write(value.addr, buf)
        _UniffiConverterUInt16.write(value.derp_region, buf)
...
class ListTagsResponse:
    ...
    name: "Tag";format: "BlobFormat";hash: "Hash";

    @typing.no_type_check
    def __init__(self, name: "Tag", format: "BlobFormat", hash: "Hash"):
        self.name = name
        '''The tag'''
        self.format = format
...
class _UniffiConverterTypeListTagsResponse(_UniffiConverterRustBuffer):
    ...
    def read(buf):
        return ListTagsResponse(
            name=_UniffiConverterTypeTag.read(buf),
            format=_UniffiConverterTypeBlobFormat.read(buf),
            hash=_UniffiConverterTypeHash.read(buf),
        )
    ...
    @staticmethod
    def write(value, buf):
        _UniffiConverterTypeTag.write(value.name, buf)
        _UniffiConverterTypeBlobFormat.write(value.format, buf)
        _UniffiConverterTypeHash.write(value.hash, buf)
