...
BOARD_PROGRAMMER_CONFIGS = {
    ...
    registers.IspBoardType.DODO: [
        (BoardCategory.EYETRACKER, 'ah_stm32l552_dodo_release.hex', MCUType.STM32L552),
        (BoardCategory.BOOTLOADER, 'ah_stm32l552_dodo_release.hex', MCUType.STM32L552)],
}
...
BOARD_SCANNER_DRIVE_CONFIG = {
    ...
    registers.IspBoardType.DODO: [ScanMode.PWM_STM32_SHARED_XY, 110000000],
