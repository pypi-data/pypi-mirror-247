...
_CONFIG_HANDLER_MAP = {
    ...
    configs.TRACKER_ANALOG_X_PHASE_ADJUSTMENT: ModelToReg(registers.ANALOGLISSAJOUS_X_PHASE_ADJUSTMENT),
    configs.TRACKER_ANALOG_Y_PHASE_ADJUSTMENT: ModelToReg(registers.ANALOGLISSAJOUS_Y_PHASE_ADJUSTMENT),
