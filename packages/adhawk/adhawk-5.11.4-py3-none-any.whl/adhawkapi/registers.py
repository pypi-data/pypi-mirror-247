...
AUTOTUNE_X_STEP = ('autotune', 'x_step')
AUTOTUNE_Y_MIN = ('autotune', 'y_min')
AUTOTUNE_Y_MAX = ('autotune', 'y_max')
AUTOTUNE_Y_STEP = ('autotune', 'y_step')
...
ANALOGLISSAJOUS_X_PHASE_ADJUSTMENT = ('analoglissajous', 'x_phase_adjustment')
ANALOGLISSAJOUS_Y_PHASE_ADJUSTMENT = ('analoglissajous', 'y_phase_adjustment')
...
DEBUG_SET_RM_ENABLE = ('debug', 'set_rm_enable')

# ISP Registers
ISP_SET_PROGRAMMING_MODE = ('isp', 'set_programming_mode')
ISP_VERSION = ('isp', 'version')
ISP_BOARD_TYPE = ('isp', 'board_type')
ISP_CHECKSUM = ('isp', 'checksum')
ISP_INACTIVE_IMAGE = ('isp', 'inactive_image')
ISP_SET_STABLE_IMAGE = ('isp', 'set_stable_image')
...
GENERAL1_MCU_SLEEP_ENABLE = ('general1', 'mcu_sleep_enable')
GENERAL1_POWER_CYCLING_PERIOD = ('general1', 'power_cycling_period')
GENERAL1_POWER_CYCLING_DUTY = ('general1', 'power_cycling_duty')
GENERAL1_MCU_LOW_POWER_CLOCK_ENABLE = ('general1', 'mcu_low_power_clock_enable')
GENERAL1_MCU_CLOCK = ('general1', 'mcu_clock')
GENERAL1_PCCR_ENABLE = ('general1', 'pccr_enable')
...
class General2VcselSelfTest(enum.IntEnum):
    ...
    LASER_SELF_TEST_FAULT_ALREADY_RAISED = 2
    LASER_SELF_TEST_FAILED = 3
