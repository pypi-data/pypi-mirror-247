...
class PowerFlowViewable(_0.APIBase):
    ...
    @property
    def draw_style(self) -> '_4070.PowerFlowDrawStyle':
        ...
        if _4070.PowerFlowDrawStyle.TYPE not in temp.__class__.__mro__:
            raise CastException('Failed to cast draw_style to PowerFlowDrawStyle. Expected: {}.'.format(temp.__class__.__qualname__))
