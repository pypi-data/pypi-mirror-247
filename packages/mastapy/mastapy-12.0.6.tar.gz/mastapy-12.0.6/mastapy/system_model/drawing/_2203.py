...
from mastapy.system_model.drawing import _2215
...
class ConcentricPartGroupCombinationSystemDeflectionShaftResults(_0.APIBase):
    ...
    @property
    def shaft_system_deflection(self) -> '_2755.ShaftSystemDeflection':
    ...
    @property
    def node_results(self) -> 'List[_2215.ShaftDeflectionDrawingNodeItem]':
