...
_BEARING_RACE_NODE_LINK = python_net_import('SMT.MastaAPI.SystemModel.FE', 'BearingRaceNodeLink')
...
class BearingRaceNodeLink(_0.APIBase):
    ...
    @property
    def race_position(self) -> '_2324.BearingRacePosition':
        ...
        return constructor.new_from_mastapy_type(_2324.BearingRacePosition)(value) if value is not None else None
