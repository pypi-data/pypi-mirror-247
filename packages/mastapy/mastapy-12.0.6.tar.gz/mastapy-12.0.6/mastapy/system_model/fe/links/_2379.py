...
from mastapy.system_model.fe.links import _2381
...
class GearMeshFELink(_2381.MultiAngleConnectionFELink):
    """GearMeshFELink
    ...
    def use_active_mesh_node_for_reference_fe_substructure_node_for_misalignments(self, value: 'bool'):
        self.wrapped.UseActiveMeshNodeForReferenceFESubstructureNodeForMisalignments = bool(value) if value is not None else False
