...
from mastapy.system_model.optimization import _2194
...
class CylindricalGearSetOptimizer(_0.APIBase):
    ...
    def create_new_design(self) -> 'bool':
        ...
        temp = self.wrapped.CreateNewDesign
    ...
    def create_new_design(self, value: 'bool'):
        self.wrapped.CreateNewDesign = bool(value) if value is not None else False

    @property
    def new_design_name(self) -> 'str':
        """str: 'NewDesignName' is the original name of this property."""

        temp = self.wrapped.NewDesignName
    ...
    def new_design_name(self, value: 'str'):
        self.wrapped.NewDesignName = str(value) if value is not None else ''

    @property
    def constraints(self) -> 'List[_2194.MeasuredAndFactorViewModel]':
