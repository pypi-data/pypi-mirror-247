...
class TorqueConverterPumpCompoundParametricStudyTool(_4429.CouplingHalfCompoundParametricStudyTool):
    """TorqueConverterPumpCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4380.TorqueConverterPumpParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4380.TorqueConverterPumpParametricStudyTool]':
