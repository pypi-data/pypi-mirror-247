...
class ExternalCADModelCompoundParametricStudyTool(_4415.ComponentCompoundParametricStudyTool):
    """ExternalCADModelCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4302.ExternalCADModelParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4302.ExternalCADModelParametricStudyTool]':
