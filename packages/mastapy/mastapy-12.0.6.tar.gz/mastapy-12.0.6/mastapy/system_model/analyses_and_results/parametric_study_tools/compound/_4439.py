...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4437, _4438, _4450
...
class CylindricalGearSetCompoundParametricStudyTool(_4450.GearSetCompoundParametricStudyTool):
    """CylindricalGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4292.CylindricalGearSetParametricStudyTool]':
    ...
    @property
    def cylindrical_gears_compound_parametric_study_tool(self) -> 'List[_4437.CylindricalGearCompoundParametricStudyTool]':
    ...
    @property
    def cylindrical_meshes_compound_parametric_study_tool(self) -> 'List[_4438.CylindricalGearMeshCompoundParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4292.CylindricalGearSetParametricStudyTool]':
