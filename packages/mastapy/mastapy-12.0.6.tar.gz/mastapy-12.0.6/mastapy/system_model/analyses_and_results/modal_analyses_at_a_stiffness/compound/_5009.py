...
class MountableComponentCompoundModalAnalysisAtAStiffness(_4957.ComponentCompoundModalAnalysisAtAStiffness):
    """MountableComponentCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4880.MountableComponentModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4880.MountableComponentModalAnalysisAtAStiffness]':
