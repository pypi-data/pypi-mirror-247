...
class CycloidalDiscCompoundModalAnalysisAtAStiffness(_4933.AbstractShaftCompoundModalAnalysisAtAStiffness):
    """CycloidalDiscCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4847.CycloidalDiscModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4847.CycloidalDiscModalAnalysisAtAStiffness]':
