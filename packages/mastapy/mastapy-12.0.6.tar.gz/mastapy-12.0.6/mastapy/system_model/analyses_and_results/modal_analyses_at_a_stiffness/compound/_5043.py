...
class StraightBevelPlanetGearCompoundModalAnalysisAtAStiffness(_5037.StraightBevelDiffGearCompoundModalAnalysisAtAStiffness):
    """StraightBevelPlanetGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4914.StraightBevelPlanetGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4914.StraightBevelPlanetGearModalAnalysisAtAStiffness]':
