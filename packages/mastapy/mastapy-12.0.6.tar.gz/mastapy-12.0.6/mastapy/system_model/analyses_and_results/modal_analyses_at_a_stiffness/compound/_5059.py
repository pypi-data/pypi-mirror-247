...
class ZerolBevelGearMeshCompoundModalAnalysisAtAStiffness(_4949.BevelGearMeshCompoundModalAnalysisAtAStiffness):
    """ZerolBevelGearMeshCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4929.ZerolBevelGearMeshModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4929.ZerolBevelGearMeshModalAnalysisAtAStiffness]':
