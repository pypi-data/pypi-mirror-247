...
class FaceGearCompoundModalAnalysisAtAStiffness(_4990.GearCompoundModalAnalysisAtAStiffness):
    """FaceGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4857.FaceGearModalAnalysisAtAStiffness]':
        """List[FaceGearModalAnalysisAtAStiffness]: 'ComponentAnalysisCasesReady' is the original name of this property.
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4857.FaceGearModalAnalysisAtAStiffness]':
        """List[FaceGearModalAnalysisAtAStiffness]: 'ComponentAnalysisCases' is the original name of this property.
