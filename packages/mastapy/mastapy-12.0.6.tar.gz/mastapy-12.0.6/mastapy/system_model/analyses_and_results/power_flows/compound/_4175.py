...
class GuideDxfModelCompoundPowerFlow(_4139.ComponentCompoundPowerFlow):
    """GuideDxfModelCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4043.GuideDxfModelPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4043.GuideDxfModelPowerFlow]':
