...
class ShaftHubConnectionCompoundPowerFlow(_4150.ConnectorCompoundPowerFlow):
    """ShaftHubConnectionCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4079.ShaftHubConnectionPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4079.ShaftHubConnectionPowerFlow]':
