...
class BeltConnectionCompoundPowerFlow(_4179.InterMountableComponentConnectionCompoundPowerFlow):
    """BeltConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3990.BeltConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3990.BeltConnectionPowerFlow]':
