...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4176, _4177, _4120
...
class HypoidGearSetCompoundPowerFlow(_4120.AGMAGleasonConicalGearSetCompoundPowerFlow):
    """HypoidGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4046.HypoidGearSetPowerFlow]':
    ...
    @property
    def hypoid_gears_compound_power_flow(self) -> 'List[_4176.HypoidGearCompoundPowerFlow]':
    ...
    @property
    def hypoid_meshes_compound_power_flow(self) -> 'List[_4177.HypoidGearMeshCompoundPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4046.HypoidGearSetPowerFlow]':
