...
class BearingCompoundPowerFlow(_4150.ConnectorCompoundPowerFlow):
    """BearingCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3989.BearingPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3989.BearingPowerFlow]':
