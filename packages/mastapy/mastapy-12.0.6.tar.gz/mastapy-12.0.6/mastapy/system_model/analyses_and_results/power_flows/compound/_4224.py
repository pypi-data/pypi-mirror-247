...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4222, _4223, _4132
...
class StraightBevelGearSetCompoundPowerFlow(_4132.BevelGearSetCompoundPowerFlow):
    """StraightBevelGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4094.StraightBevelGearSetPowerFlow]':
    ...
    @property
    def straight_bevel_gears_compound_power_flow(self) -> 'List[_4222.StraightBevelGearCompoundPowerFlow]':
    ...
    @property
    def straight_bevel_meshes_compound_power_flow(self) -> 'List[_4223.StraightBevelGearMeshCompoundPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4094.StraightBevelGearSetPowerFlow]':
