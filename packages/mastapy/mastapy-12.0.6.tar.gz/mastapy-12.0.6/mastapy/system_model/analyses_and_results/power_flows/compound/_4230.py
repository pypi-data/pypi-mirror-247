...
class SynchroniserSleeveCompoundPowerFlow(_4229.SynchroniserPartCompoundPowerFlow):
    """SynchroniserSleeveCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4100.SynchroniserSleevePowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4100.SynchroniserSleevePowerFlow]':
