...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4125, _4126, _4132
...
class BevelDifferentialGearSetCompoundPowerFlow(_4132.BevelGearSetCompoundPowerFlow):
    """BevelDifferentialGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3994.BevelDifferentialGearSetPowerFlow]':
    ...
    @property
    def bevel_differential_gears_compound_power_flow(self) -> 'List[_4125.BevelDifferentialGearCompoundPowerFlow]':
    ...
    @property
    def bevel_differential_meshes_compound_power_flow(self) -> 'List[_4126.BevelDifferentialGearMeshCompoundPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3994.BevelDifferentialGearSetPowerFlow]':
