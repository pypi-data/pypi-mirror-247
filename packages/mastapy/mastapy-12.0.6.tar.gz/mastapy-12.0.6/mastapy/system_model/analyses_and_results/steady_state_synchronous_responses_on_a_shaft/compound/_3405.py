...
class PartCompoundSteadyStateSynchronousResponseOnAShaft(_7476.PartCompoundAnalysis):
    """PartCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3275.PartSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3275.PartSteadyStateSynchronousResponseOnAShaft]':
