...
class ConceptCouplingCompoundSteadyStateSynchronousResponseOnAShaft(_3363.CouplingCompoundSteadyStateSynchronousResponseOnAShaft):
    """ConceptCouplingCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3224.ConceptCouplingSteadyStateSynchronousResponseOnAShaft]':
        """List[ConceptCouplingSteadyStateSynchronousResponseOnAShaft]: 'AssemblyAnalysisCasesReady' is the original name of this property.
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3224.ConceptCouplingSteadyStateSynchronousResponseOnAShaft]':
        """List[ConceptCouplingSteadyStateSynchronousResponseOnAShaft]: 'AssemblyAnalysisCases' is the original name of this property.
