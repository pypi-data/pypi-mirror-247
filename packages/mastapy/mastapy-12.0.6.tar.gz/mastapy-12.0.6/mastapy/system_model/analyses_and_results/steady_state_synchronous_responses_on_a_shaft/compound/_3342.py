...
class BevelGearCompoundSteadyStateSynchronousResponseOnAShaft(_3330.AGMAGleasonConicalGearCompoundSteadyStateSynchronousResponseOnAShaft):
    """BevelGearCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3214.BevelGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3214.BevelGearSteadyStateSynchronousResponseOnAShaft]':
