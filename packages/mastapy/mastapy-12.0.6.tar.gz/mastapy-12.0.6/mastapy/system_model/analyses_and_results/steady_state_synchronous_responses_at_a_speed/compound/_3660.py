...
class MassDiscCompoundSteadyStateSynchronousResponseAtASpeed(_3707.VirtualComponentCompoundSteadyStateSynchronousResponseAtASpeed):
    """MassDiscCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3530.MassDiscSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3530.MassDiscSteadyStateSynchronousResponseAtASpeed]':
