...
class WormGearMeshCompoundModalAnalysisAtASpeed(_5249.GearMeshCompoundModalAnalysisAtASpeed):
    """WormGearMeshCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5184.WormGearMeshModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5184.WormGearMeshModalAnalysisAtASpeed]':
