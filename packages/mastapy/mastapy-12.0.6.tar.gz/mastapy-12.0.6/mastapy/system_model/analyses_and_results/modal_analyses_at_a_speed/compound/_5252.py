...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _5194
...
class HypoidGearCompoundModalAnalysisAtASpeed(_5194.AGMAGleasonConicalGearCompoundModalAnalysisAtASpeed):
    """HypoidGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5124.HypoidGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5124.HypoidGearModalAnalysisAtASpeed]':
