...
class ComponentCompoundModalAnalysisAtASpeed(_5269.PartCompoundModalAnalysisAtASpeed):
    """ComponentCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5086.ComponentModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5086.ComponentModalAnalysisAtASpeed]':
