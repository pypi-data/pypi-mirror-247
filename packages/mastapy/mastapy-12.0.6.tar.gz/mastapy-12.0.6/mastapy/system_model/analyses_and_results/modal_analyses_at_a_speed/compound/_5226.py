...
class ConnectorCompoundModalAnalysisAtASpeed(_5267.MountableComponentCompoundModalAnalysisAtASpeed):
    """ConnectorCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5097.ConnectorModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5097.ConnectorModalAnalysisAtASpeed]':
