...
class ConceptCouplingCompoundModalAnalysisAtASpeed(_5227.CouplingCompoundModalAnalysisAtASpeed):
    """ConceptCouplingCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5089.ConceptCouplingModalAnalysisAtASpeed]':
        """List[ConceptCouplingModalAnalysisAtASpeed]: 'AssemblyAnalysisCasesReady' is the original name of this property.
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5089.ConceptCouplingModalAnalysisAtASpeed]':
        """List[ConceptCouplingModalAnalysisAtASpeed]: 'AssemblyAnalysisCases' is the original name of this property.
