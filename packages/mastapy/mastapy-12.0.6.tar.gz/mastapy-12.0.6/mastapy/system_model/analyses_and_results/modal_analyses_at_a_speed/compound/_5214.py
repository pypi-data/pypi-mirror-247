...
class CoaxialConnectionCompoundModalAnalysisAtASpeed(_5287.ShaftToMountableComponentConnectionCompoundModalAnalysisAtASpeed):
    """CoaxialConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5085.CoaxialConnectionModalAnalysisAtASpeed]':
        """List[CoaxialConnectionModalAnalysisAtASpeed]: 'ConnectionAnalysisCasesReady' is the original name of this property.
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5085.CoaxialConnectionModalAnalysisAtASpeed]':
        """List[CoaxialConnectionModalAnalysisAtASpeed]: 'ConnectionAnalysisCases' is the original name of this property.
