...
class PartCompoundModalAnalysisAtASpeed(_7476.PartCompoundAnalysis):
    """PartCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5140.PartModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5140.PartModalAnalysisAtASpeed]':
