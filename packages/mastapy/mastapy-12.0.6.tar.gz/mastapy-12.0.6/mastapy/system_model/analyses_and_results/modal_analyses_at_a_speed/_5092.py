...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _5091, _5090, _5121
...
class ConceptGearSetModalAnalysisAtASpeed(_5121.GearSetModalAnalysisAtASpeed):
    """ConceptGearSetModalAnalysisAtASpeed
    ...
    @property
    def concept_gears_modal_analysis_at_a_speed(self) -> 'List[_5091.ConceptGearModalAnalysisAtASpeed]':
    ...
    @property
    def concept_meshes_modal_analysis_at_a_speed(self) -> 'List[_5090.ConceptGearMeshModalAnalysisAtASpeed]':
