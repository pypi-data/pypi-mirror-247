...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4683
...
class CVTCompoundModalAnalysis(_4683.BeltDriveCompoundModalAnalysis):
    """CVTCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4561.CVTModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4561.CVTModalAnalysis]':
