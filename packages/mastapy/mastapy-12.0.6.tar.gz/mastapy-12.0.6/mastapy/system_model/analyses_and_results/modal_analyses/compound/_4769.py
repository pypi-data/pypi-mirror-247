...
class ShaftHubConnectionCompoundModalAnalysis(_4709.ConnectorCompoundModalAnalysis):
    """ShaftHubConnectionCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4623.ShaftHubConnectionModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4623.ShaftHubConnectionModalAnalysis]':
