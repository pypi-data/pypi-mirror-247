...
class ConceptGearCompoundModalAnalysis(_4731.GearCompoundModalAnalysis):
    """ConceptGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4549.ConceptGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4549.ConceptGearModalAnalysis]':
