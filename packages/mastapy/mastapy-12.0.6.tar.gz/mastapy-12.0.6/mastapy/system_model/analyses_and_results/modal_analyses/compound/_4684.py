...
class BevelDifferentialGearCompoundModalAnalysis(_4689.BevelGearCompoundModalAnalysis):
    """BevelDifferentialGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4531.BevelDifferentialGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4531.BevelDifferentialGearModalAnalysis]':
