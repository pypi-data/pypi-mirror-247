...
class PartToPartShearCouplingCompoundModalAnalysis(_4710.CouplingCompoundModalAnalysis):
    """PartToPartShearCouplingCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4610.PartToPartShearCouplingModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4610.PartToPartShearCouplingModalAnalysis]':
