...
class FlexiblePinAssemblyCompoundModalAnalysis(_4771.SpecialisedAssemblyCompoundModalAnalysis):
    """FlexiblePinAssemblyCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4579.FlexiblePinAssemblyModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4579.FlexiblePinAssemblyModalAnalysis]':
