...
class RingPinsToDiscConnectionCompoundModalAnalysis(_4738.InterMountableComponentConnectionCompoundModalAnalysis):
    """RingPinsToDiscConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4618.RingPinsToDiscConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4618.RingPinsToDiscConnectionModalAnalysis]':
