...
class PlanetCarrierCompoundModalAnalysis(_4750.MountableComponentCompoundModalAnalysis):
    """PlanetCarrierCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4613.PlanetCarrierModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4613.PlanetCarrierModalAnalysis]':
