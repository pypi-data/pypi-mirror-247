...
class CylindricalGearCompoundModalAnalysis(_4731.GearCompoundModalAnalysis):
    """CylindricalGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4568.CylindricalGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4568.CylindricalGearModalAnalysis]':
