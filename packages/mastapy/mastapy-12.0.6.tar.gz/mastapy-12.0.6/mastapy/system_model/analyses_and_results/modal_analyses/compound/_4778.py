...
class StraightBevelDiffGearCompoundModalAnalysis(_4689.BevelGearCompoundModalAnalysis):
    """StraightBevelDiffGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4635.StraightBevelDiffGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4635.StraightBevelDiffGearModalAnalysis]':
