...
class BoltCompoundModalAnalysis(_4698.ComponentCompoundModalAnalysis):
    """BoltCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4539.BoltModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4539.BoltModalAnalysis]':
