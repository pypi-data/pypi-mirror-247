...
class PartToPartShearCouplingCompoundStabilityAnalysis(_3883.CouplingCompoundStabilityAnalysis):
    """PartToPartShearCouplingCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3797.PartToPartShearCouplingStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3797.PartToPartShearCouplingStabilityAnalysis]':
