...
class PowerLoadCompoundStabilityAnalysis(_3968.VirtualComponentCompoundStabilityAnalysis):
    """PowerLoadCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3802.PowerLoadStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3802.PowerLoadStabilityAnalysis]':
