...
class BevelDifferentialGearCompoundStabilityAnalysis(_3862.BevelGearCompoundStabilityAnalysis):
    """BevelDifferentialGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3727.BevelDifferentialGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3727.BevelDifferentialGearStabilityAnalysis]':
