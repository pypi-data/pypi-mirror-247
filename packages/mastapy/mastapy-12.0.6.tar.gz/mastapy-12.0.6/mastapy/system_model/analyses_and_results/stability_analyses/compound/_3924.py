...
class OilSealCompoundStabilityAnalysis(_3882.ConnectorCompoundStabilityAnalysis):
    """OilSealCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3793.OilSealStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3793.OilSealStabilityAnalysis]':
