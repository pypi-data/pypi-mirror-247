...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3853
...
class RootAssemblyCompoundStabilityAnalysis(_3853.AssemblyCompoundStabilityAnalysis):
    """RootAssemblyCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3809.RootAssemblyStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3809.RootAssemblyStabilityAnalysis]':
