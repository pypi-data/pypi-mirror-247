...
class ZerolBevelGearMeshCompoundStabilityAnalysis(_3863.BevelGearMeshCompoundStabilityAnalysis):
    """ZerolBevelGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3843.ZerolBevelGearMeshStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3843.ZerolBevelGearMeshStabilityAnalysis]':
