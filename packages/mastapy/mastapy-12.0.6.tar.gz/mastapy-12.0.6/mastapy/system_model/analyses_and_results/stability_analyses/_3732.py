...
_BEVEL_GEAR_STABILITY_ANALYSIS = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.StabilityAnalyses', 'BevelGearStabilityAnalysis')
...
class BevelGearStabilityAnalysis(_3720.AGMAGleasonConicalGearStabilityAnalysis):
    """BevelGearStabilityAnalysis
    ...
    def __init__(self, instance_to_wrap: 'BevelGearStabilityAnalysis.TYPE'):
