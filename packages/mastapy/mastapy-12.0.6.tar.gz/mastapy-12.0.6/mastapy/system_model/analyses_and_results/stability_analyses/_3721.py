...
from mastapy.system_model.analyses_and_results.stability_analyses import (
    _3722, _3724, _3726, _3733,
    _3734, _3757, _3737, _3742,
    _3744, _3758, _3761, _3763,
    _3771, _3769, _3772, _3778,
    _3785, _3788, _3790, _3791,
    _3793, _3797, _3800, _3801,
    _3802, _3804, _3806, _3810,
    _3811, _3815, _3819, _3823,
    _3826, _3833, _3836, _3838,
    _3841, _3844, _3714
)
...
class AssemblyStabilityAnalysis(_3714.AbstractAssemblyStabilityAnalysis):
    """AssemblyStabilityAnalysis
    ...
    @property
    def bearings(self) -> 'List[_3722.BearingStabilityAnalysis]':
    ...
    @property
    def belt_drives(self) -> 'List[_3724.BeltDriveStabilityAnalysis]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_3726.BevelDifferentialGearSetStabilityAnalysis]':
    ...
    @property
    def bolted_joints(self) -> 'List[_3733.BoltedJointStabilityAnalysis]':
    ...
    @property
    def bolts(self) -> 'List[_3734.BoltStabilityAnalysis]':
    ...
    @property
    def cv_ts(self) -> 'List[_3757.CVTStabilityAnalysis]':
    ...
    @property
    def clutches(self) -> 'List[_3737.ClutchStabilityAnalysis]':
    ...
    @property
    def concept_couplings(self) -> 'List[_3742.ConceptCouplingStabilityAnalysis]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_3744.ConceptGearSetStabilityAnalysis]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_3758.CycloidalAssemblyStabilityAnalysis]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_3761.CycloidalDiscStabilityAnalysis]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_3763.CylindricalGearSetStabilityAnalysis]':
    ...
    @property
    def fe_parts(self) -> 'List[_3771.FEPartStabilityAnalysis]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_3769.FaceGearSetStabilityAnalysis]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_3772.FlexiblePinAssemblyStabilityAnalysis]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_3778.HypoidGearSetStabilityAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_3785.KlingelnbergCycloPalloidHypoidGearSetStabilityAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_3788.KlingelnbergCycloPalloidSpiralBevelGearSetStabilityAnalysis]':
    ...
    @property
    def mass_discs(self) -> 'List[_3790.MassDiscStabilityAnalysis]':
    ...
    @property
    def measurement_components(self) -> 'List[_3791.MeasurementComponentStabilityAnalysis]':
    ...
    @property
    def oil_seals(self) -> 'List[_3793.OilSealStabilityAnalysis]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_3797.PartToPartShearCouplingStabilityAnalysis]':
    ...
    @property
    def planet_carriers(self) -> 'List[_3800.PlanetCarrierStabilityAnalysis]':
    ...
    @property
    def point_loads(self) -> 'List[_3801.PointLoadStabilityAnalysis]':
    ...
    @property
    def power_loads(self) -> 'List[_3802.PowerLoadStabilityAnalysis]':
    ...
    @property
    def ring_pins(self) -> 'List[_3804.RingPinsStabilityAnalysis]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_3806.RollingRingAssemblyStabilityAnalysis]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_3810.ShaftHubConnectionStabilityAnalysis]':
    ...
    @property
    def shafts(self) -> 'List[_3811.ShaftStabilityAnalysis]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_3815.SpiralBevelGearSetStabilityAnalysis]':
    ...
    @property
    def spring_dampers(self) -> 'List[_3819.SpringDamperStabilityAnalysis]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_3823.StraightBevelDiffGearSetStabilityAnalysis]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_3826.StraightBevelGearSetStabilityAnalysis]':
    ...
    @property
    def synchronisers(self) -> 'List[_3833.SynchroniserStabilityAnalysis]':
    ...
    @property
    def torque_converters(self) -> 'List[_3836.TorqueConverterStabilityAnalysis]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_3838.UnbalancedMassStabilityAnalysis]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_3841.WormGearSetStabilityAnalysis]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_3844.ZerolBevelGearSetStabilityAnalysis]':
