...
from mastapy.math_utility.measured_vectors import _1529
...
class CVTPulleySystemDeflection(_2744.PulleySystemDeflection):
    """CVTPulleySystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4023.CVTPulleyPowerFlow':
    ...
    @property
    def fixed_sheave_contact_results(self) -> 'List[_1529.NodeResults]':
    ...
    @property
    def moving_sheave_contact_results(self) -> 'List[_1529.NodeResults]':
