...
class BevelDifferentialPlanetGearCompoundSystemDeflection(_2813.BevelDifferentialGearCompoundSystemDeflection):
    """BevelDifferentialPlanetGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2655.BevelDifferentialPlanetGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2655.BevelDifferentialPlanetGearSystemDeflection]':
