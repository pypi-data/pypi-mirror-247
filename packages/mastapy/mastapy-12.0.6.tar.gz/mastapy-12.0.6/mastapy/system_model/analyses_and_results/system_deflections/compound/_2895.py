...
class RollingRingCompoundSystemDeflection(_2841.CouplingHalfCompoundSystemDeflection):
    """RollingRingCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2750.RollingRingSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2750.RollingRingSystemDeflection]':
