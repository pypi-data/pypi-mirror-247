...
class PlanetCarrierCompoundSystemDeflection(_2880.MountableComponentCompoundSystemDeflection):
    """PlanetCarrierCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2741.PlanetCarrierSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2741.PlanetCarrierSystemDeflection]':
