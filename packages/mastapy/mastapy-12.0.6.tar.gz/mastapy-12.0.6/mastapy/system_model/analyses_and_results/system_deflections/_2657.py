...
class BevelGearMeshSystemDeflection(_2645.AGMAGleasonConicalGearMeshSystemDeflection):
    """BevelGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3997.BevelGearMeshPowerFlow':
