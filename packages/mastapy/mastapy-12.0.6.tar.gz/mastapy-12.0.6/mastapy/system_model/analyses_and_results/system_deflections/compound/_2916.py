...
class StraightBevelSunGearCompoundSystemDeflection(_2909.StraightBevelDiffGearCompoundSystemDeflection):
    """StraightBevelSunGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2771.StraightBevelSunGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2771.StraightBevelSunGearSystemDeflection]':
