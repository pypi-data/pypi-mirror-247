...
class PlanetaryConnectionSystemDeflection(_2756.ShaftToMountableComponentConnectionSystemDeflection):
    """PlanetaryConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4065.PlanetaryConnectionPowerFlow':
