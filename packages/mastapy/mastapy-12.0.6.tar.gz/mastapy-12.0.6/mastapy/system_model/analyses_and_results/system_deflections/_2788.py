...
from mastapy.system_model.analyses_and_results.system_deflections import _2789, _2787, _2711
...
class WormGearSetSystemDeflection(_2711.GearSetSystemDeflection):
    """WormGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4110.WormGearSetPowerFlow':
    ...
    @property
    def worm_gears_system_deflection(self) -> 'List[_2789.WormGearSystemDeflection]':
    ...
    @property
    def worm_meshes_system_deflection(self) -> 'List[_2787.WormGearMeshSystemDeflection]':
