...
class GearCompoundSystemDeflection(_2880.MountableComponentCompoundSystemDeflection):
    """GearCompoundSystemDeflection
    ...
    @property
    def duty_cycle_rating(self) -> '_352.GearDutyCycleRating':
    ...
    @property
    def duty_cycle_rating_of_type_worm_gear_duty_cycle_rating(self) -> '_366.WormGearDutyCycleRating':
    ...
    @property
    def duty_cycle_rating_of_type_face_gear_duty_cycle_rating(self) -> '_439.FaceGearDutyCycleRating':
    ...
    @property
    def duty_cycle_rating_of_type_cylindrical_gear_duty_cycle_rating(self) -> '_449.CylindricalGearDutyCycleRating':
    ...
    @property
    def duty_cycle_rating_of_type_conical_gear_duty_cycle_rating(self) -> '_531.ConicalGearDutyCycleRating':
    ...
    @property
    def duty_cycle_rating_of_type_concept_gear_duty_cycle_rating(self) -> '_541.ConceptGearDutyCycleRating':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2712.GearSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2712.GearSystemDeflection]':
