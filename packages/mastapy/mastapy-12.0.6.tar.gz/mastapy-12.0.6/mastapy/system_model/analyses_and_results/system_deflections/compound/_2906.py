...
class SpringDamperCompoundSystemDeflection(_2839.CouplingCompoundSystemDeflection):
    """SpringDamperCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2763.SpringDamperSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2763.SpringDamperSystemDeflection]':
