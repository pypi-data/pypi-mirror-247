...
_BEVEL_GEAR_HARMONIC_ANALYSIS_OF_SINGLE_EXCITATION = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.HarmonicAnalysesSingleExcitation', 'BevelGearHarmonicAnalysisOfSingleExcitation')
...
class BevelGearHarmonicAnalysisOfSingleExcitation(_5947.AGMAGleasonConicalGearHarmonicAnalysisOfSingleExcitation):
    """BevelGearHarmonicAnalysisOfSingleExcitation
    ...
    def __init__(self, instance_to_wrap: 'BevelGearHarmonicAnalysisOfSingleExcitation.TYPE'):
