...
class ModalAnalysisForHarmonicAnalysis(_2591.ModalAnalysis):
    """ModalAnalysisForHarmonicAnalysis
    ...
    @property
    def harmonic_analysis_settings(self) -> '_5704.HarmonicAnalysisOptions':
        ...
        if _5704.HarmonicAnalysisOptions.TYPE not in temp.__class__.__mro__:
            raise CastException('Failed to cast harmonic_analysis_settings to HarmonicAnalysisOptions. Expected: {}.'.format(temp.__class__.__qualname__))
