...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _5962
...
class BoltedJointCompoundHarmonicAnalysisOfSingleExcitation(_6171.SpecialisedAssemblyCompoundHarmonicAnalysisOfSingleExcitation):
    """BoltedJointCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5962.BoltedJointHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5962.BoltedJointHarmonicAnalysisOfSingleExcitation]':
