...
class CylindricalPlanetGearCompoundHarmonicAnalysisOfSingleExcitation(_6120.CylindricalGearCompoundHarmonicAnalysisOfSingleExcitation):
    """CylindricalPlanetGearCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5993.CylindricalPlanetGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5993.CylindricalPlanetGearHarmonicAnalysisOfSingleExcitation]':
