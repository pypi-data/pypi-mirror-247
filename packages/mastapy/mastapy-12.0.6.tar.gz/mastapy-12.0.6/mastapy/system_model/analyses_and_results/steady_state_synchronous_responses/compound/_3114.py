...
class CylindricalGearCompoundSteadyStateSynchronousResponse(_3125.GearCompoundSteadyStateSynchronousResponse):
    """CylindricalGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2983.CylindricalGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2983.CylindricalGearSteadyStateSynchronousResponse]':
