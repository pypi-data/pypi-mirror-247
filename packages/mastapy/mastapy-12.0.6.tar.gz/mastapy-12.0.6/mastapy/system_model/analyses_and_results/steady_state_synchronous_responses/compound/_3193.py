...
class ZerolBevelGearCompoundSteadyStateSynchronousResponse(_3083.BevelGearCompoundSteadyStateSynchronousResponse):
    """ZerolBevelGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3066.ZerolBevelGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3066.ZerolBevelGearSteadyStateSynchronousResponse]':
