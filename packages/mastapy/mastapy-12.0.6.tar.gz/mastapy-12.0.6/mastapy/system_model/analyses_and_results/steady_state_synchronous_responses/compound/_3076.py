...
class BeltConnectionCompoundSteadyStateSynchronousResponse(_3132.InterMountableComponentConnectionCompoundSteadyStateSynchronousResponse):
    """BeltConnectionCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2943.BeltConnectionSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2943.BeltConnectionSteadyStateSynchronousResponse]':
