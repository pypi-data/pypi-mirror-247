...
class ConnectionSteadyStateSynchronousResponse(_7471.ConnectionStaticLoadAnalysisCase):
    """ConnectionSteadyStateSynchronousResponse
    ...
    @property
    def steady_state_synchronous_response(self) -> '_3040.SteadyStateSynchronousResponse':
