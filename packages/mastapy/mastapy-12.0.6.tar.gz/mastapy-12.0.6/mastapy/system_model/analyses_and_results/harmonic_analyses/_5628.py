...
from mastapy.system_model.analyses_and_results.harmonic_analyses import (
    _5629, _5631, _5634, _5640,
    _5641, _5663, _5644, _5650,
    _5653, _5665, _5667, _5671,
    _5690, _5689, _5691, _5709,
    _5716, _5719, _5698, _5720,
    _5721, _5723, _5727, _5731,
    _5732, _5733, _5736, _5738,
    _5743, _5742, _5750, _5753,
    _5756, _5759, _5763, _5767,
    _5771, _5775, _5778, _5620
)
...
class AssemblyHarmonicAnalysis(_5620.AbstractAssemblyHarmonicAnalysis):
    """AssemblyHarmonicAnalysis
    ...
    @property
    def bearings(self) -> 'List[_5629.BearingHarmonicAnalysis]':
    ...
    @property
    def belt_drives(self) -> 'List[_5631.BeltDriveHarmonicAnalysis]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_5634.BevelDifferentialGearSetHarmonicAnalysis]':
    ...
    @property
    def bolted_joints(self) -> 'List[_5640.BoltedJointHarmonicAnalysis]':
    ...
    @property
    def bolts(self) -> 'List[_5641.BoltHarmonicAnalysis]':
    ...
    @property
    def cv_ts(self) -> 'List[_5663.CVTHarmonicAnalysis]':
    ...
    @property
    def clutches(self) -> 'List[_5644.ClutchHarmonicAnalysis]':
    ...
    @property
    def concept_couplings(self) -> 'List[_5650.ConceptCouplingHarmonicAnalysis]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_5653.ConceptGearSetHarmonicAnalysis]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_5665.CycloidalAssemblyHarmonicAnalysis]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_5667.CycloidalDiscHarmonicAnalysis]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_5671.CylindricalGearSetHarmonicAnalysis]':
    ...
    @property
    def fe_parts(self) -> 'List[_5690.FEPartHarmonicAnalysis]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_5689.FaceGearSetHarmonicAnalysis]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_5691.FlexiblePinAssemblyHarmonicAnalysis]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_5709.HypoidGearSetHarmonicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_5716.KlingelnbergCycloPalloidHypoidGearSetHarmonicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_5719.KlingelnbergCycloPalloidSpiralBevelGearSetHarmonicAnalysis]':
    ...
    @property
    def loaded_gear_sets(self) -> 'List[_5698.GearSetHarmonicAnalysis]':
    ...
    @property
    def mass_discs(self) -> 'List[_5720.MassDiscHarmonicAnalysis]':
    ...
    @property
    def measurement_components(self) -> 'List[_5721.MeasurementComponentHarmonicAnalysis]':
    ...
    @property
    def oil_seals(self) -> 'List[_5723.OilSealHarmonicAnalysis]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_5727.PartToPartShearCouplingHarmonicAnalysis]':
    ...
    @property
    def planet_carriers(self) -> 'List[_5731.PlanetCarrierHarmonicAnalysis]':
    ...
    @property
    def point_loads(self) -> 'List[_5732.PointLoadHarmonicAnalysis]':
    ...
    @property
    def power_loads(self) -> 'List[_5733.PowerLoadHarmonicAnalysis]':
    ...
    @property
    def ring_pins(self) -> 'List[_5736.RingPinsHarmonicAnalysis]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_5738.RollingRingAssemblyHarmonicAnalysis]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_5743.ShaftHubConnectionHarmonicAnalysis]':
    ...
    @property
    def shafts(self) -> 'List[_5742.ShaftHarmonicAnalysis]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_5750.SpiralBevelGearSetHarmonicAnalysis]':
    ...
    @property
    def spring_dampers(self) -> 'List[_5753.SpringDamperHarmonicAnalysis]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_5756.StraightBevelDiffGearSetHarmonicAnalysis]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_5759.StraightBevelGearSetHarmonicAnalysis]':
    ...
    @property
    def synchronisers(self) -> 'List[_5763.SynchroniserHarmonicAnalysis]':
    ...
    @property
    def torque_converters(self) -> 'List[_5767.TorqueConverterHarmonicAnalysis]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_5771.UnbalancedMassHarmonicAnalysis]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_5775.WormGearSetHarmonicAnalysis]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_5778.ZerolBevelGearSetHarmonicAnalysis]':
