...
class AbstractShaftCompoundHarmonicAnalysis(_5816.AbstractShaftOrHousingCompoundHarmonicAnalysis):
    """AbstractShaftCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5622.AbstractShaftHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5622.AbstractShaftHarmonicAnalysis]':
