...
class FaceGearCompoundHarmonicAnalysis(_5872.GearCompoundHarmonicAnalysis):
    """FaceGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5687.FaceGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5687.FaceGearHarmonicAnalysis]':
