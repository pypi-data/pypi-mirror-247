...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5687, _5688, _5698
...
class FaceGearSetHarmonicAnalysis(_5698.GearSetHarmonicAnalysis):
    """FaceGearSetHarmonicAnalysis
    ...
    @property
    def gears_harmonic_analysis(self) -> 'List[_5687.FaceGearHarmonicAnalysis]':
    ...
    @property
    def face_gears_harmonic_analysis(self) -> 'List[_5687.FaceGearHarmonicAnalysis]':
    ...
    @property
    def meshes_harmonic_analysis(self) -> 'List[_5688.FaceGearMeshHarmonicAnalysis]':
    ...
    @property
    def face_meshes_harmonic_analysis(self) -> 'List[_5688.FaceGearMeshHarmonicAnalysis]':
