...
class StraightBevelDiffGearCompoundHarmonicAnalysis(_5830.BevelGearCompoundHarmonicAnalysis):
    """StraightBevelDiffGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5754.StraightBevelDiffGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5754.StraightBevelDiffGearHarmonicAnalysis]':
