...
class BevelGearMeshHarmonicAnalysis(_5626.AGMAGleasonConicalGearMeshHarmonicAnalysis):
    """BevelGearMeshHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2657.BevelGearMeshSystemDeflection':
