...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5757, _5758, _5639
...
class StraightBevelGearSetHarmonicAnalysis(_5639.BevelGearSetHarmonicAnalysis):
    """StraightBevelGearSetHarmonicAnalysis
    ...
    @property
    def gears_harmonic_analysis(self) -> 'List[_5757.StraightBevelGearHarmonicAnalysis]':
    ...
    @property
    def straight_bevel_gears_harmonic_analysis(self) -> 'List[_5757.StraightBevelGearHarmonicAnalysis]':
    ...
    @property
    def meshes_harmonic_analysis(self) -> 'List[_5758.StraightBevelGearMeshHarmonicAnalysis]':
    ...
    @property
    def straight_bevel_meshes_harmonic_analysis(self) -> 'List[_5758.StraightBevelGearMeshHarmonicAnalysis]':
