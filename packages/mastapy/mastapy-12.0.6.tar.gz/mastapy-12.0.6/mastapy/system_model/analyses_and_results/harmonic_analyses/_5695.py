...
class GearMeshHarmonicAnalysis(_5710.InterMountableComponentConnectionHarmonicAnalysis):
    """GearMeshHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2710.GearMeshSystemDeflection':
