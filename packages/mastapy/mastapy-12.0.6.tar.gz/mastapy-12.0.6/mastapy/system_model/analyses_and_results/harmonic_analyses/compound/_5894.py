...
class PartToPartShearCouplingCompoundHarmonicAnalysis(_5851.CouplingCompoundHarmonicAnalysis):
    """PartToPartShearCouplingCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5727.PartToPartShearCouplingHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5727.PartToPartShearCouplingHarmonicAnalysis]':
