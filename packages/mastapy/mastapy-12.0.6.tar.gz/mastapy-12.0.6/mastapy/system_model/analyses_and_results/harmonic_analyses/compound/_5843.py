...
class ConceptGearCompoundHarmonicAnalysis(_5872.GearCompoundHarmonicAnalysis):
    """ConceptGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5651.ConceptGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5651.ConceptGearHarmonicAnalysis]':
