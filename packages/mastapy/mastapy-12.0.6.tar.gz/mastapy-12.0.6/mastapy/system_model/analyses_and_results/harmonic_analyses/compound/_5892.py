...
class OilSealCompoundHarmonicAnalysis(_5850.ConnectorCompoundHarmonicAnalysis):
    """OilSealCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5723.OilSealHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5723.OilSealHarmonicAnalysis]':
