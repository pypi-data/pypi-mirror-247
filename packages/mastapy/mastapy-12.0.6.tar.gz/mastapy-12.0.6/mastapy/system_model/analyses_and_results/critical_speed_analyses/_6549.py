...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6547, _6548, _6546
...
class KlingelnbergCycloPalloidHypoidGearSetCriticalSpeedAnalysis(_6546.KlingelnbergCycloPalloidConicalGearSetCriticalSpeedAnalysis):
    """KlingelnbergCycloPalloidHypoidGearSetCriticalSpeedAnalysis
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_critical_speed_analysis(self) -> 'List[_6547.KlingelnbergCycloPalloidHypoidGearCriticalSpeedAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_critical_speed_analysis(self) -> 'List[_6548.KlingelnbergCycloPalloidHypoidGearMeshCriticalSpeedAnalysis]':
