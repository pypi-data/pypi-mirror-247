...
from mastapy.system_model.part_model.gears import (
    _2479, _2469, _2471, _2473,
    _2474, _2475, _2490, _2492,
    _2494, _2496, _2499, _2501,
...
_CONICAL_GEAR_CRITICAL_SPEED_ANALYSIS = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.CriticalSpeedAnalyses', 'ConicalGearCriticalSpeedAnalysis')
...
class ConicalGearCriticalSpeedAnalysis(_6536.GearCriticalSpeedAnalysis):
    """ConicalGearCriticalSpeedAnalysis
    ...
    def __init__(self, instance_to_wrap: 'ConicalGearCriticalSpeedAnalysis.TYPE'):
        super().__init__(instance_to_wrap)
        self._freeze()

    @property
    def component_design(self) -> '_2479.ConicalGear':
    ...
    @property
    def planetaries(self) -> 'List[ConicalGearCriticalSpeedAnalysis]':
        """List[ConicalGearCriticalSpeedAnalysis]: 'Planetaries' is the original name of this property.
