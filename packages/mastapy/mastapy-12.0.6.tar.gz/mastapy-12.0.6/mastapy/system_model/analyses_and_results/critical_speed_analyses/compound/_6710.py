...
class SpringDamperConnectionCompoundCriticalSpeedAnalysis(_6645.CouplingConnectionCompoundCriticalSpeedAnalysis):
    """SpringDamperConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6580.SpringDamperConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6580.SpringDamperConnectionCriticalSpeedAnalysis]':
