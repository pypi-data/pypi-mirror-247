...
_GUIDE_DXF_MODEL_CRITICAL_SPEED_ANALYSIS = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.CriticalSpeedAnalyses', 'GuideDxfModelCriticalSpeedAnalysis')
...
class GuideDxfModelCriticalSpeedAnalysis(_6501.ComponentCriticalSpeedAnalysis):
    """GuideDxfModelCriticalSpeedAnalysis
    ...
    def __init__(self, instance_to_wrap: 'GuideDxfModelCriticalSpeedAnalysis.TYPE'):
