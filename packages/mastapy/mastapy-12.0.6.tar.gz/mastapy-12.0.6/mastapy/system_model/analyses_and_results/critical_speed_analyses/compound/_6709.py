...
class SpringDamperCompoundCriticalSpeedAnalysis(_6644.CouplingCompoundCriticalSpeedAnalysis):
    """SpringDamperCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6581.SpringDamperCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6581.SpringDamperCriticalSpeedAnalysis]':
