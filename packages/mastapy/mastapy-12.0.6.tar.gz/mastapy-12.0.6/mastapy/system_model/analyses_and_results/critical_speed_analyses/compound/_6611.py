...
class AGMAGleasonConicalGearCompoundCriticalSpeedAnalysis(_6639.ConicalGearCompoundCriticalSpeedAnalysis):
    """AGMAGleasonConicalGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6480.AGMAGleasonConicalGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6480.AGMAGleasonConicalGearCriticalSpeedAnalysis]':
