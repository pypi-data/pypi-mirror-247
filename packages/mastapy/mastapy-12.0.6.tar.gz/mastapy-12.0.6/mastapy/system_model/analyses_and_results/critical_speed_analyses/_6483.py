...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import (
    _6484, _6486, _6489, _6496,
    _6495, _6519, _6498, _6503,
    _6507, _6521, _6523, _6527,
    _6534, _6533, _6535, _6542,
    _6549, _6552, _6553, _6554,
    _6556, _6559, _6563, _6564,
    _6565, _6567, _6569, _6574,
    _6573, _6579, _6581, _6585,
    _6588, _6591, _6596, _6599,
    _6603, _6606, _6476
)
...
class AssemblyCriticalSpeedAnalysis(_6476.AbstractAssemblyCriticalSpeedAnalysis):
    """AssemblyCriticalSpeedAnalysis
    ...
    @property
    def bearings(self) -> 'List[_6484.BearingCriticalSpeedAnalysis]':
    ...
    @property
    def belt_drives(self) -> 'List[_6486.BeltDriveCriticalSpeedAnalysis]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_6489.BevelDifferentialGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def bolted_joints(self) -> 'List[_6496.BoltedJointCriticalSpeedAnalysis]':
    ...
    @property
    def bolts(self) -> 'List[_6495.BoltCriticalSpeedAnalysis]':
    ...
    @property
    def cv_ts(self) -> 'List[_6519.CVTCriticalSpeedAnalysis]':
    ...
    @property
    def clutches(self) -> 'List[_6498.ClutchCriticalSpeedAnalysis]':
    ...
    @property
    def concept_couplings(self) -> 'List[_6503.ConceptCouplingCriticalSpeedAnalysis]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_6507.ConceptGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_6521.CycloidalAssemblyCriticalSpeedAnalysis]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_6523.CycloidalDiscCriticalSpeedAnalysis]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_6527.CylindricalGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def fe_parts(self) -> 'List[_6534.FEPartCriticalSpeedAnalysis]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_6533.FaceGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_6535.FlexiblePinAssemblyCriticalSpeedAnalysis]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_6542.HypoidGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_6549.KlingelnbergCycloPalloidHypoidGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_6552.KlingelnbergCycloPalloidSpiralBevelGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def mass_discs(self) -> 'List[_6553.MassDiscCriticalSpeedAnalysis]':
    ...
    @property
    def measurement_components(self) -> 'List[_6554.MeasurementComponentCriticalSpeedAnalysis]':
    ...
    @property
    def oil_seals(self) -> 'List[_6556.OilSealCriticalSpeedAnalysis]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_6559.PartToPartShearCouplingCriticalSpeedAnalysis]':
    ...
    @property
    def planet_carriers(self) -> 'List[_6563.PlanetCarrierCriticalSpeedAnalysis]':
    ...
    @property
    def point_loads(self) -> 'List[_6564.PointLoadCriticalSpeedAnalysis]':
    ...
    @property
    def power_loads(self) -> 'List[_6565.PowerLoadCriticalSpeedAnalysis]':
    ...
    @property
    def ring_pins(self) -> 'List[_6567.RingPinsCriticalSpeedAnalysis]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_6569.RollingRingAssemblyCriticalSpeedAnalysis]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_6574.ShaftHubConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def shafts(self) -> 'List[_6573.ShaftCriticalSpeedAnalysis]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_6579.SpiralBevelGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def spring_dampers(self) -> 'List[_6581.SpringDamperCriticalSpeedAnalysis]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_6585.StraightBevelDiffGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_6588.StraightBevelGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def synchronisers(self) -> 'List[_6591.SynchroniserCriticalSpeedAnalysis]':
    ...
    @property
    def torque_converters(self) -> 'List[_6596.TorqueConverterCriticalSpeedAnalysis]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_6599.UnbalancedMassCriticalSpeedAnalysis]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_6603.WormGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_6606.ZerolBevelGearSetCriticalSpeedAnalysis]':
