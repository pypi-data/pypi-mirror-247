...
_MOUNTABLE_COMPONENT_CRITICAL_SPEED_ANALYSIS = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.CriticalSpeedAnalyses', 'MountableComponentCriticalSpeedAnalysis')
...
class MountableComponentCriticalSpeedAnalysis(_6501.ComponentCriticalSpeedAnalysis):
    """MountableComponentCriticalSpeedAnalysis
    ...
    def __init__(self, instance_to_wrap: 'MountableComponentCriticalSpeedAnalysis.TYPE'):
