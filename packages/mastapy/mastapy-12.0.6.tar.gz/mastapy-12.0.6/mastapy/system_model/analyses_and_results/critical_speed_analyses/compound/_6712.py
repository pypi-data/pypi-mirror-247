...
class StraightBevelDiffGearCompoundCriticalSpeedAnalysis(_6623.BevelGearCompoundCriticalSpeedAnalysis):
    """StraightBevelDiffGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6583.StraightBevelDiffGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6583.StraightBevelDiffGearCriticalSpeedAnalysis]':
