...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6494
from mastapy._internal import constructor, conversion
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6613
...
class BevelGearSetCompoundCriticalSpeedAnalysis(_6613.AGMAGleasonConicalGearSetCompoundCriticalSpeedAnalysis):
    """BevelGearSetCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6494.BevelGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6494.BevelGearSetCriticalSpeedAnalysis]':
