...
from mastapy.system_model.analyses_and_results.system_deflections import _2643, _2689, _2755
...
class AbstractShaftAdvancedTimeSteppingAnalysisForModulation(_6939.AbstractShaftOrHousingAdvancedTimeSteppingAnalysisForModulation):
    """AbstractShaftAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2643.AbstractShaftSystemDeflection':
