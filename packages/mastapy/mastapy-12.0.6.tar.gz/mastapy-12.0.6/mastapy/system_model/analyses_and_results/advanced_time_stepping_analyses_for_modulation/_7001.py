...
class GearSetAdvancedTimeSteppingAnalysisForModulation(_7040.SpecialisedAssemblyAdvancedTimeSteppingAnalysisForModulation):
    """GearSetAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def eignenmodes_indexed_by_mode_id(self) -> 'List[_1474.Eigenmodes]':
