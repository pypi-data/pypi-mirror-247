...
_SPIRAL_BEVEL_GEAR_MESH_ADVANCED_TIME_STEPPING_ANALYSIS_FOR_MODULATION = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.AdvancedTimeSteppingAnalysesForModulation', 'SpiralBevelGearMeshAdvancedTimeSteppingAnalysisForModulation')
...
class SpiralBevelGearMeshAdvancedTimeSteppingAnalysisForModulation(_6958.BevelGearMeshAdvancedTimeSteppingAnalysisForModulation):
    """SpiralBevelGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    def __init__(self, instance_to_wrap: 'SpiralBevelGearMeshAdvancedTimeSteppingAnalysisForModulation.TYPE'):
