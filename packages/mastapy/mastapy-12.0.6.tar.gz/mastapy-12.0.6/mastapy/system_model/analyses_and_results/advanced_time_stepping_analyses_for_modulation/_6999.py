...
class GearAdvancedTimeSteppingAnalysisForModulation(_7019.MountableComponentAdvancedTimeSteppingAnalysisForModulation):
    """GearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2712.GearSystemDeflection':
