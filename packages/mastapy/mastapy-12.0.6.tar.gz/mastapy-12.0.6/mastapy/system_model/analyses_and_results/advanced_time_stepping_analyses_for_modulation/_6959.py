...
class BevelGearSetAdvancedTimeSteppingAnalysisForModulation(_6946.AGMAGleasonConicalGearSetAdvancedTimeSteppingAnalysisForModulation):
    """BevelGearSetAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2658.BevelGearSetSystemDeflection':
