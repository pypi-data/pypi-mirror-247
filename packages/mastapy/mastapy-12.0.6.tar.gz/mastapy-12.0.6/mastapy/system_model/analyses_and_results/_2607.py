...
from mastapy.utility.report import _1722
...
class DesignEntityAnalysis(_0.APIBase):
    ...
    @property
    def active_report_as_text(self) -> '_1722.CustomReport':
    ...
    @property
    def component_design(self) -> '_2165.DesignEntity':
    ...
    @property
    def component_design_of_type_connection(self) -> '_2231.Connection':
    ...
    @property
    def component_design_of_type_part(self) -> '_2425.Part':
