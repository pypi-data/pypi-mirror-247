...
class OilSealAdvancedSystemDeflection(_7239.ConnectorAdvancedSystemDeflection):
    """OilSealAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2735.OilSealSystemDeflection]':
