...
class StraightBevelGearCompoundAdvancedSystemDeflection(_7352.BevelGearCompoundAdvancedSystemDeflection):
    """StraightBevelGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7314.StraightBevelGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7314.StraightBevelGearAdvancedSystemDeflection]':
