...
class ConnectorCompoundAdvancedSystemDeflection(_7413.MountableComponentCompoundAdvancedSystemDeflection):
    """ConnectorCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7239.ConnectorAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7239.ConnectorAdvancedSystemDeflection]':
