...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7365, _7366, _7396
...
class ConceptGearSetCompoundAdvancedSystemDeflection(_7396.GearSetCompoundAdvancedSystemDeflection):
    """ConceptGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7234.ConceptGearSetAdvancedSystemDeflection]':
    ...
    @property
    def concept_gears_compound_advanced_system_deflection(self) -> 'List[_7365.ConceptGearCompoundAdvancedSystemDeflection]':
    ...
    @property
    def concept_meshes_compound_advanced_system_deflection(self) -> 'List[_7366.ConceptGearMeshCompoundAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7234.ConceptGearSetAdvancedSystemDeflection]':
