...
from mastapy.math_utility.convergence import _1543, _1542
...
class ConnectionAdvancedSystemDeflection(_7471.ConnectionStaticLoadAnalysisCase):
    """ConnectionAdvancedSystemDeflection
    ...
    @property
    def advanced_system_deflection(self) -> '_7204.AdvancedSystemDeflection':
    ...
    @property
    def data_logger(self) -> '_1543.DataLogger':
        ...
        if _1543.DataLogger.TYPE not in temp.__class__.__mro__:
            raise CastException('Failed to cast data_logger to DataLogger. Expected: {}.'.format(temp.__class__.__qualname__))
