...
class DatumCompoundAdvancedSystemDeflection(_7361.ComponentCompoundAdvancedSystemDeflection):
    """DatumCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7256.DatumAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7256.DatumAdvancedSystemDeflection]':
