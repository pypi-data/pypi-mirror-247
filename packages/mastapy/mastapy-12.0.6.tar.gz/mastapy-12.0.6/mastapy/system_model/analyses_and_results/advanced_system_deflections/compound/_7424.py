...
class PulleyCompoundAdvancedSystemDeflection(_7375.CouplingHalfCompoundAdvancedSystemDeflection):
    """PulleyCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7294.PulleyAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7294.PulleyAdvancedSystemDeflection]':
