...
class InterMountableComponentConnectionCompoundAdvancedSystemDeflection(_7371.ConnectionCompoundAdvancedSystemDeflection):
    """InterMountableComponentConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7270.InterMountableComponentConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7270.InterMountableComponentConnectionAdvancedSystemDeflection]':
