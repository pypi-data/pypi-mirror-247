...
class SpiralBevelGearMeshCompoundAdvancedSystemDeflection(_7353.BevelGearMeshCompoundAdvancedSystemDeflection):
    """SpiralBevelGearMeshCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7306.SpiralBevelGearMeshAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7306.SpiralBevelGearMeshAdvancedSystemDeflection]':
