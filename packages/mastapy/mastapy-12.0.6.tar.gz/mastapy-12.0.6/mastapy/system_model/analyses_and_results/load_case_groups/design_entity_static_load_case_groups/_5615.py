...
TReal = TypeVar('TReal', bound='_2401.Component')
TComponentStaticLoad = TypeVar('TComponentStaticLoad', bound='_6769.ComponentLoadCase')


class ComponentStaticLoadCaseGroup(_5619.PartStaticLoadCaseGroup, Generic[TReal, TComponentStaticLoad]):
    """ComponentStaticLoadCaseGroup
