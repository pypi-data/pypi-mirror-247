...
class ZerolBevelGearCompoundDynamicAnalysis(_6357.BevelGearCompoundDynamicAnalysis):
    """ZerolBevelGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6338.ZerolBevelGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6338.ZerolBevelGearDynamicAnalysis]':
