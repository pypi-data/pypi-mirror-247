...
class PartToPartShearCouplingHalfCompoundDynamicAnalysis(_6380.CouplingHalfCompoundDynamicAnalysis):
    """PartToPartShearCouplingHalfCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6294.PartToPartShearCouplingHalfDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6294.PartToPartShearCouplingHalfDynamicAnalysis]':
