...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6350
...
class CVTBeltConnectionCompoundDynamicAnalysis(_6350.BeltConnectionCompoundDynamicAnalysis):
    """CVTBeltConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6251.CVTBeltConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6251.CVTBeltConnectionDynamicAnalysis]':
