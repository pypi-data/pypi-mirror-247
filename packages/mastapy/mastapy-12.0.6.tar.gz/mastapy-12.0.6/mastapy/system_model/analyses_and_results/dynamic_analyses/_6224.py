...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6222, _6223, _6229
...
class BevelDifferentialGearSetDynamicAnalysis(_6229.BevelGearSetDynamicAnalysis):
    """BevelDifferentialGearSetDynamicAnalysis
    ...
    @property
    def bevel_differential_gears_dynamic_analysis(self) -> 'List[_6222.BevelDifferentialGearDynamicAnalysis]':
    ...
    @property
    def bevel_differential_meshes_dynamic_analysis(self) -> 'List[_6223.BevelDifferentialGearMeshDynamicAnalysis]':
