...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6311, _6312, _6229
...
class SpiralBevelGearSetDynamicAnalysis(_6229.BevelGearSetDynamicAnalysis):
    """SpiralBevelGearSetDynamicAnalysis
    ...
    @property
    def spiral_bevel_gears_dynamic_analysis(self) -> 'List[_6311.SpiralBevelGearDynamicAnalysis]':
    ...
    @property
    def spiral_bevel_meshes_dynamic_analysis(self) -> 'List[_6312.SpiralBevelGearMeshDynamicAnalysis]':
