...
class MeasurementComponentCompoundDynamicAnalysis(_6463.VirtualComponentCompoundDynamicAnalysis):
    """MeasurementComponentCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6288.MeasurementComponentDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6288.MeasurementComponentDynamicAnalysis]':
