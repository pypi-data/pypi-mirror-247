...
class BevelDifferentialGearCompoundDynamicAnalysis(_6357.BevelGearCompoundDynamicAnalysis):
    """BevelDifferentialGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6222.BevelDifferentialGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6222.BevelDifferentialGearDynamicAnalysis]':
