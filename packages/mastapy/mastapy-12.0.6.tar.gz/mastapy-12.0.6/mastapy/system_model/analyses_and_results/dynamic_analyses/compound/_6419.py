...
class OilSealCompoundDynamicAnalysis(_6377.ConnectorCompoundDynamicAnalysis):
    """OilSealCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6290.OilSealDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6290.OilSealDynamicAnalysis]':
