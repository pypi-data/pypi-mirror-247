...
class StraightBevelDiffGearMeshCompoundMultibodyDynamicsAnalysis(_5488.BevelGearMeshCompoundMultibodyDynamicsAnalysis):
    """StraightBevelDiffGearMeshCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5438.StraightBevelDiffGearMeshMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5438.StraightBevelDiffGearMeshMultibodyDynamicsAnalysis]':
