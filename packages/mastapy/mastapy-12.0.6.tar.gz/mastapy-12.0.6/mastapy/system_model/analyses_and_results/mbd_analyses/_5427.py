...
from mastapy.system_model.analyses_and_results.mbd_analyses.reporting import _5467, _5469
...
class ShaftHubConnectionMultibodyDynamicsAnalysis(_5358.ConnectorMultibodyDynamicsAnalysis):
    """ShaftHubConnectionMultibodyDynamicsAnalysis
    ...
    @property
    def peak_dynamic_force_angular(self) -> '_5469.DynamicTorqueVector3DResult':
