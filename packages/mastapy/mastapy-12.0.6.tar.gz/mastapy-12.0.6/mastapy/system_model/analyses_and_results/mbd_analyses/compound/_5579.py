...
class StraightBevelGearCompoundMultibodyDynamicsAnalysis(_5487.BevelGearCompoundMultibodyDynamicsAnalysis):
    """StraightBevelGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5442.StraightBevelGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5442.StraightBevelGearMultibodyDynamicsAnalysis]':
