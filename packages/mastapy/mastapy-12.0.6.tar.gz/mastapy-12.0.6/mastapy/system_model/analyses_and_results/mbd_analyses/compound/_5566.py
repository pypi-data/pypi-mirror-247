...
class ShaftCompoundMultibodyDynamicsAnalysis(_5472.AbstractShaftCompoundMultibodyDynamicsAnalysis):
    """ShaftCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5428.ShaftMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5428.ShaftMultibodyDynamicsAnalysis]':
