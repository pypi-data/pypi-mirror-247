...
class BevelDifferentialGearCompoundMultibodyDynamicsAnalysis(_5487.BevelGearCompoundMultibodyDynamicsAnalysis):
    """BevelDifferentialGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5333.BevelDifferentialGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5333.BevelDifferentialGearMultibodyDynamicsAnalysis]':
