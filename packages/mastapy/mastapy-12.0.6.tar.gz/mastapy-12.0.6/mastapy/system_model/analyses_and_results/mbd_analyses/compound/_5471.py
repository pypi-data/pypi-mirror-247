...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5319
...
class AbstractAssemblyCompoundMultibodyDynamicsAnalysis(_5550.PartCompoundMultibodyDynamicsAnalysis):
    """AbstractAssemblyCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5319.AbstractAssemblyMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5319.AbstractAssemblyMultibodyDynamicsAnalysis]':
