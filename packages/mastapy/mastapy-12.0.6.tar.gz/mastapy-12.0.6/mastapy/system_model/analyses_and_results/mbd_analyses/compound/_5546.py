...
class MassDiscCompoundMultibodyDynamicsAnalysis(_5593.VirtualComponentCompoundMultibodyDynamicsAnalysis):
    """MassDiscCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5402.MassDiscMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5402.MassDiscMultibodyDynamicsAnalysis]':
