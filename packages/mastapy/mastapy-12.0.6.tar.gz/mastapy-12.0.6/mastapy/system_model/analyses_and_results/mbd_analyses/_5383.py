...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5382, _5380, _5431
...
class GearSetMultibodyDynamicsAnalysis(_5431.SpecialisedAssemblyMultibodyDynamicsAnalysis):
    """GearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5382.GearMultibodyDynamicsAnalysis]':
    ...
    @property
    def meshes(self) -> 'List[_5380.GearMeshMultibodyDynamicsAnalysis]':
