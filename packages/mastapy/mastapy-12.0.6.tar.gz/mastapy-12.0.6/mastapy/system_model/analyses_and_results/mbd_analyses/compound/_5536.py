...
class InterMountableComponentConnectionCompoundMultibodyDynamicsAnalysis(_5506.ConnectionCompoundMultibodyDynamicsAnalysis):
    """InterMountableComponentConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5392.InterMountableComponentConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5392.InterMountableComponentConnectionMultibodyDynamicsAnalysis]':
