...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5340
...
class BoltedJointCompoundMultibodyDynamicsAnalysis(_5569.SpecialisedAssemblyCompoundMultibodyDynamicsAnalysis):
    """BoltedJointCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5340.BoltedJointMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5340.BoltedJointMultibodyDynamicsAnalysis]':
