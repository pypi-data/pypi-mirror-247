...
from mastapy.system_model.analyses_and_results.static_loads import _6777, _6822
...
class ConicalGearLoadCase(_6822.GearLoadCase):
    """ConicalGearLoadCase
    ...
    @property
    def gear_manufacture_errors(self) -> '_6777.ConicalGearManufactureError':
    ...
    @property
    def planetaries(self) -> 'List[ConicalGearLoadCase]':
        """List[ConicalGearLoadCase]: 'Planetaries' is the original name of this property.
