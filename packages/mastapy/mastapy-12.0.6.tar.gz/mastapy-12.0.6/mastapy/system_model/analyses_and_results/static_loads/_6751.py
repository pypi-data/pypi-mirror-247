...
from mastapy.system_model.analyses_and_results.static_loads import (
    _6752, _6754, _6757, _6763,
    _6764, _6787, _6765, _6767,
    _6772, _6775, _6789, _6791,
    _6797, _6819, _6818, _6820,
    _6824, _6839, _6849, _6852,
    _6853, _6854, _6858, _6863,
    _6867, _6870, _6871, _6875,
    _6876, _6877, _6881, _6882,
    _6741, _6887, _6890, _6893,
    _6896, _6900, _6905, _6912,
    _6916, _6919, _6739
)
...
class AssemblyLoadCase(_6739.AbstractAssemblyLoadCase):
    """AssemblyLoadCase
    ...
    @property
    def bearings(self) -> 'List[_6752.BearingLoadCase]':
    ...
    @property
    def belt_drives(self) -> 'List[_6754.BeltDriveLoadCase]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_6757.BevelDifferentialGearSetLoadCase]':
    ...
    @property
    def bolted_joints(self) -> 'List[_6763.BoltedJointLoadCase]':
    ...
    @property
    def bolts(self) -> 'List[_6764.BoltLoadCase]':
    ...
    @property
    def cv_ts(self) -> 'List[_6787.CVTLoadCase]':
    ...
    @property
    def clutch_connections(self) -> 'List[_6765.ClutchConnectionLoadCase]':
    ...
    @property
    def clutches(self) -> 'List[_6767.ClutchLoadCase]':
    ...
    @property
    def concept_couplings(self) -> 'List[_6772.ConceptCouplingLoadCase]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_6775.ConceptGearSetLoadCase]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_6789.CycloidalAssemblyLoadCase]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_6791.CycloidalDiscLoadCase]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_6797.CylindricalGearSetLoadCase]':
    ...
    @property
    def fe_parts(self) -> 'List[_6819.FEPartLoadCase]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_6818.FaceGearSetLoadCase]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_6820.FlexiblePinAssemblyLoadCase]':
    ...
    @property
    def gear_meshes(self) -> 'List[_6824.GearMeshLoadCase]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_6839.HypoidGearSetLoadCase]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_6849.KlingelnbergCycloPalloidHypoidGearSetLoadCase]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_6852.KlingelnbergCycloPalloidSpiralBevelGearSetLoadCase]':
    ...
    @property
    def mass_discs(self) -> 'List[_6853.MassDiscLoadCase]':
    ...
    @property
    def measurement_components(self) -> 'List[_6854.MeasurementComponentLoadCase]':
    ...
    @property
    def oil_seals(self) -> 'List[_6858.OilSealLoadCase]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_6863.PartToPartShearCouplingLoadCase]':
    ...
    @property
    def planet_carriers(self) -> 'List[_6867.PlanetCarrierLoadCase]':
    ...
    @property
    def point_loads(self) -> 'List[_6870.PointLoadLoadCase]':
    ...
    @property
    def ring_pins(self) -> 'List[_6875.RingPinsLoadCase]':
    ...
    @property
    def ring_pins_to_cycloidal_disc_connections(self) -> 'List[_6876.RingPinsToDiscConnectionLoadCase]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_6877.RollingRingAssemblyLoadCase]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_6881.ShaftHubConnectionLoadCase]':
    ...
    @property
    def shafts(self) -> 'List[_6882.ShaftLoadCase]':
    ...
    @property
    def shafts_and_housings(self) -> 'List[_6741.AbstractShaftOrHousingLoadCase]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_6887.SpiralBevelGearSetLoadCase]':
    ...
    @property
    def spring_dampers(self) -> 'List[_6890.SpringDamperLoadCase]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_6893.StraightBevelDiffGearSetLoadCase]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_6896.StraightBevelGearSetLoadCase]':
    ...
    @property
    def synchronisers(self) -> 'List[_6900.SynchroniserLoadCase]':
    ...
    @property
    def torque_converters(self) -> 'List[_6905.TorqueConverterLoadCase]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_6912.UnbalancedMassLoadCase]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_6916.WormGearSetLoadCase]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_6919.ZerolBevelGearSetLoadCase]':
