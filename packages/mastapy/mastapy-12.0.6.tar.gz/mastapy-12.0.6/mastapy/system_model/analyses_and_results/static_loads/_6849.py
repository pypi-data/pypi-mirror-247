...
from mastapy.system_model.analyses_and_results.static_loads import _6847, _6848, _6846
...
class KlingelnbergCycloPalloidHypoidGearSetLoadCase(_6846.KlingelnbergCycloPalloidConicalGearSetLoadCase):
    """KlingelnbergCycloPalloidHypoidGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6847.KlingelnbergCycloPalloidHypoidGearLoadCase]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_load_case(self) -> 'List[_6847.KlingelnbergCycloPalloidHypoidGearLoadCase]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_load_case(self) -> 'List[_6848.KlingelnbergCycloPalloidHypoidGearMeshLoadCase]':
