...
class ConnectionLoadCase(_2605.ConnectionAnalysis):
    """ConnectionLoadCase
    ...
    @property
    def static_load_case(self) -> '_6737.StaticLoadCase':
        ...
        if _6737.StaticLoadCase.TYPE not in temp.__class__.__mro__:
            raise CastException('Failed to cast static_load_case to StaticLoadCase. Expected: {}.'.format(temp.__class__.__qualname__))
