...
class SpeedTorqueLoadCase(_1326.ElectricMachineLoadCase):
    """SpeedTorqueLoadCase
    ...
    @property
    def load_specification(self) -> '_1339.SpecifyTorqueOrCurrent':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1339.SpecifyTorqueOrCurrent)(value) if value is not None else None

    @load_specification.setter
    def load_specification(self, value: '_1339.SpecifyTorqueOrCurrent'):
        value = conversion.mp_to_pn_enum(value)
