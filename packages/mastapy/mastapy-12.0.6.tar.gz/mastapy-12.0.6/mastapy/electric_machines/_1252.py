...
from mastapy.electric_machines import _1248, _1251
...
class ElectricMachineSetup(_0.APIBase):
    ...
    @property
    def number_of_air_gap_elements(self) -> 'int':
        """int: 'NumberOfAirGapElements' is the original name of this property.
    ...
    @property
    def eccentricity(self) -> '_1248.Eccentricity':
    ...
    @property
    def meshing_options(self) -> '_1251.ElectricMachineMeshingOptions':
