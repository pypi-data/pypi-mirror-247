...
from mastapy.gears.gear_designs.cylindrical import _997
from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _635, _649
...
class PlungeShaverGeneration(_0.APIBase):
    ...
    @property
    def calculated_conjugate_face_width(self) -> '_1455.Range':
        ...
        if _1455.Range.TYPE not in temp.__class__.__mro__:
            raise CastException('Failed to cast calculated_conjugate_face_width to Range. Expected: {}.'.format(temp.__class__.__qualname__))
    ...
    @property
    def crossed_axis_calculation_details(self) -> '_997.CrossedAxisCylindricalGearPairLineContact':
    ...
    @property
    def calculation_errors(self) -> 'List[_635.CalculationError]':
    ...
    @property
    def points_of_interest_on_the_shaver(self) -> 'List[_649.ShaverPointOfInterest]':
