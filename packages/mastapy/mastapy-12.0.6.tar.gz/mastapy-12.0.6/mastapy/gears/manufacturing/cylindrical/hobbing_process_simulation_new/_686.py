...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _653, _687
...
class WormGrindingLeadCalculation(_687.WormGrindingProcessCalculation):
    """WormGrindingLeadCalculation
