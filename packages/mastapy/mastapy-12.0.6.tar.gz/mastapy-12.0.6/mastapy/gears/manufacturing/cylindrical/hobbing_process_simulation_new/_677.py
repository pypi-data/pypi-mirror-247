...
class ProcessProfileCalculation(_0.APIBase):
    ...
    @property
    def left_flank_accuracy_calculation(self) -> '_655.CalculateProfileDeviationAccuracy':
    ...
    @property
    def right_flank_accuracy_calculation(self) -> '_655.CalculateProfileDeviationAccuracy':
