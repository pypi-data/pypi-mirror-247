...
class AGMAScuffingResultsRow(_477.ScuffingResultsRow):
    """AGMAScuffingResultsRow
    ...
    @property
    def central_film_thickness_isothermal(self) -> 'float':
        """float: 'CentralFilmThicknessIsothermal' is the original name of this property."""
    ...
    def central_film_thickness_isothermal(self, value: 'float'):
        self.wrapped.CentralFilmThicknessIsothermal = float(value) if value is not None else 0.0

    @property
    def central_film_thickness_with_inlet_shear_heating(self) -> 'float':
        """float: 'CentralFilmThicknessWithInletShearHeating' is the original name of this property."""
    ...
    def central_film_thickness_with_inlet_shear_heating(self, value: 'float'):
        self.wrapped.CentralFilmThicknessWithInletShearHeating = float(value) if value is not None else 0.0
    ...
    def dimensionless_central_film_thickness(self, value: 'float'):
        self.wrapped.DimensionlessCentralFilmThickness = float(value) if value is not None else 0.0
    ...
    @property
    def hertzian_stress(self) -> 'float':
        """float: 'HertzianStress' is the original name of this property."""
    ...
    def hertzian_stress(self, value: 'float'):
    ...
    def mean_coefficient_of_friction(self, value: 'float'):
        self.wrapped.MeanCoefficientOfFriction = float(value) if value is not None else 0.0
    ...
    def semi_width_of_hertzian_contact_band(self, value: 'float'):
        self.wrapped.SemiWidthOfHertzianContactBand = float(value) if value is not None else 0.0

    @property
    def slideto_roll_ratio(self) -> 'float':
        """float: 'SlidetoRollRatio' is the original name of this property."""
    ...
    def slideto_roll_ratio(self, value: 'float'):
    ...
    @property
    def specific_film_thickness_with_filter_cutoff_wave_length_isothermal(self) -> 'float':
        """float: 'SpecificFilmThicknessWithFilterCutoffWaveLengthIsothermal' is the original name of this property."""
    ...
    @specific_film_thickness_with_filter_cutoff_wave_length_isothermal.setter
    def specific_film_thickness_with_filter_cutoff_wave_length_isothermal(self, value: 'float'):
        self.wrapped.SpecificFilmThicknessWithFilterCutoffWaveLengthIsothermal = float(value) if value is not None else 0.0

    @property
    def specific_film_thickness_with_filter_cutoff_wave_length_with_inlet_shear_heating(self) -> 'float':
        """float: 'SpecificFilmThicknessWithFilterCutoffWaveLengthWithInletShearHeating' is the original name of this property."""

        temp = self.wrapped.SpecificFilmThicknessWithFilterCutoffWaveLengthWithInletShearHeating
    ...
    @specific_film_thickness_with_filter_cutoff_wave_length_with_inlet_shear_heating.setter
    def specific_film_thickness_with_filter_cutoff_wave_length_with_inlet_shear_heating(self, value: 'float'):
        self.wrapped.SpecificFilmThicknessWithFilterCutoffWaveLengthWithInletShearHeating = float(value) if value is not None else 0.0
    ...
    @property
    def thermal_loading_parameter(self) -> 'float':
        """float: 'ThermalLoadingParameter' is the original name of this property."""
    ...
    def thermal_loading_parameter(self, value: 'float'):
        self.wrapped.ThermalLoadingParameter = float(value) if value is not None else 0.0

    @property
    def thermal_reduction_factor(self) -> 'float':
        """float: 'ThermalReductionFactor' is the original name of this property."""
    ...
    def thermal_reduction_factor(self, value: 'float'):
