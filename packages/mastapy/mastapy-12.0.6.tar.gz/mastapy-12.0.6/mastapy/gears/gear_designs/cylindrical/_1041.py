...
from mastapy.gears.gear_designs.cylindrical import _995, _1040
...
class GearSetManufacturingConfigurationSetup(_0.APIBase):
    ...
    @property
    def create_new_suitable_cutters(self) -> '_995.CreateNewSuitableCutterOption':
        ...
        return constructor.new_from_mastapy_type(_995.CreateNewSuitableCutterOption)(value) if value is not None else None

    @create_new_suitable_cutters.setter
    def create_new_suitable_cutters(self, value: '_995.CreateNewSuitableCutterOption'):
    ...
    @property
    def use_as_design_mode_geometry(self) -> '_995.CreateNewSuitableCutterOption':
    ...
    def use_as_design_mode_geometry(self, value: '_995.CreateNewSuitableCutterOption'):
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.UseAsDesignModeGeometry = value

    @property
    def gears(self) -> 'List[_1040.GearManufacturingConfigSetupViewModel]':
