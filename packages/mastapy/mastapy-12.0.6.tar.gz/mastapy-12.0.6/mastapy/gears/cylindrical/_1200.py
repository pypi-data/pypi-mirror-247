...
_CYLINDRICAL_GEAR_WORST_LTCA_CONTACT_CHART_DATA_AS_TEXT_FILE = python_net_import('SMT.MastaAPI.Gears.Cylindrical', 'CylindricalGearWorstLTCAContactChartDataAsTextFile')
...
class CylindricalGearWorstLTCAContactChartDataAsTextFile(_0.APIBase):
    ...
    def __init__(self, instance_to_wrap: 'CylindricalGearWorstLTCAContactChartDataAsTextFile.TYPE'):
    ...
    @property
    def depth_of_max_shear_stress(self) -> 'str':
        """str: 'DepthOfMaxShearStress' is the original name of this property.
    ...
    @property
    def force_per_unit_length(self) -> 'str':
        """str: 'ForcePerUnitLength' is the original name of this property.
    ...
    @property
    def gap_between_loaded_flanks_transverse(self) -> 'str':
        """str: 'GapBetweenLoadedFlanksTransverse' is the original name of this property.
    ...
    @property
    def hertzian_contact_half_width(self) -> 'str':
        """str: 'HertzianContactHalfWidth' is the original name of this property.
    ...
    def max_pressure(self) -> 'str':
        """str: 'MaxPressure' is the original name of this property.
    ...
    @property
    def max_shear_stress(self) -> 'str':
        """str: 'MaxShearStress' is the original name of this property.
    ...
    @property
    def total_deflection_for_mesh(self) -> 'str':
        """str: 'TotalDeflectionForMesh' is the original name of this property.
