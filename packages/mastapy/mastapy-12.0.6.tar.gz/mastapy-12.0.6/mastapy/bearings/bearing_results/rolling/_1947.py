...
from mastapy.bearings.bearing_results.rolling import _1946, _1949, _1966
...
class LoadedAngularContactBallBearingRow(_1966.LoadedBallBearingRow):
    """LoadedAngularContactBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1946.LoadedAngularContactBallBearingResults':
