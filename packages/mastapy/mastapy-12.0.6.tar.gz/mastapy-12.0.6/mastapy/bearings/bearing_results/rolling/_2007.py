...
from mastapy.bearings.bearing_results.rolling import _2006, _1993
...
class LoadedSphericalRollerThrustBearingRow(_1993.LoadedRollerBearingRow):
    """LoadedSphericalRollerThrustBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_2006.LoadedSphericalRollerThrustBearingResults':
