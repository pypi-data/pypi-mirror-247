...
from mastapy.bearings.bearing_results.rolling import _1957
...
class LoadedAxialThrustNeedleRollerBearingResults(_1957.LoadedAxialThrustCylindricalRollerBearingResults):
    """LoadedAxialThrustNeedleRollerBearingResults
