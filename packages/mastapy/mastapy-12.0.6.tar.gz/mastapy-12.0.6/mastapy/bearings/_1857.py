...
from mastapy.bearings import (
    _1860, _1858, _1833, _1849
)
from mastapy.math_utility import _1455
from mastapy._internal.python_net import python_net_import
from mastapy.utility.databases import _1797
...
class RollingBearingDatabase(_1797.SQLDatabase['_1858.RollingBearingKey', '_2127.RollingBearing']):
    """RollingBearingDatabase
    ...
    def add_to_database(self, bearing: '_2127.RollingBearing'):
    ...
    def create_bearing(self, type_: '_1860.RollingBearingType', designation: Optional['str'] = 'None') -> '_2127.RollingBearing':
    ...
    def create_bearing_with_type_name(self, type_: 'str', designation: Optional['str'] = 'None') -> '_2127.RollingBearing':
        """ 'CreateBearing' is the original name of this method.
    ...
    def create_key(self, type_: '_1860.RollingBearingType', designation: Optional['str'] = 'None') -> '_1858.RollingBearingKey':
    ...
    def create_key_with_type_name(self, type_: 'str', designation: Optional['str'] = 'None') -> '_1858.RollingBearingKey':
        """ 'CreateKey' is the original name of this method.
    ...
    def remove_from_database(self, bearing: '_2127.RollingBearing'):
    ...
    def search_for_rolling_bearing_with_catalog(self, catalog: '_1833.BearingCatalog') -> 'List[_2127.RollingBearing]':
    ...
    def search_for_rolling_bearing_with_name_and_catalog(self, designation: 'str', catalog: '_1833.BearingCatalog') -> '_2127.RollingBearing':
        """ 'SearchForRollingBearing' is the original name of this method.
    ...
    def search_for_rolling_bearing_with_name_catalog_and_type(self, designation: 'str', catalog: '_1833.BearingCatalog', type_: '_1860.RollingBearingType') -> 'List[_2127.RollingBearing]':
        """ 'SearchForRollingBearing' is the original name of this method.
    ...
    def search_for_rolling_bearing(self, designation: 'str', catalog: '_1833.BearingCatalog', type_: '_1860.RollingBearingType', bore_range: '_1455.Range', outer_diameter_range: '_1455.Range', width_range: '_1455.Range', dynamic_capacity_range: '_1455.Range', number_of_rows: 'int', material_type: '_1849.HybridSteelAll') -> 'List[_2127.RollingBearing]':
        """ 'SearchForRollingBearing' is the original name of this method.
