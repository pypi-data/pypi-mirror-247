...
from mastapy.math_utility.optimisation import _1517
...
class ParetoOptimisationStrategyChartInformation(_0.APIBase):
    ...
    def select_chart_type(self) -> 'ParetoOptimisationStrategyChartInformation.ScatterOrBarChart':
        ...
        return constructor.new_from_mastapy_type(ParetoOptimisationStrategyChartInformation.ScatterOrBarChart)(value) if value is not None else None
    ...
    @property
    def bars(self) -> 'List[_1517.ParetoOptimisationStrategyBars]':
