...
class DesignEntityExcitationDescription(_0.APIBase):
    ...
    def excitation_frequency(self, value: 'float'):
        self.wrapped.ExcitationFrequency = float(value) if value is not None else 0.0
    ...
    def harmonic_index(self, value: 'int'):
        self.wrapped.HarmonicIndex = int(value) if value is not None else 0
    ...
    def order(self, value: 'float'):
        self.wrapped.Order = float(value) if value is not None else 0.0
