...
from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _641, _650
...
class PlungeShaverCalculation(_0.APIBase):
    ...
    @property
    def inputs(self) -> '_641.PlungeShaverCalculationInputs':
    ...
    @property
    def simulation_of_ideal_shaver_conjugate_to_the_designed_gear(self) -> '_650.VirtualPlungeShaverOutputs':
        ...
        temp = self.wrapped.SimulationOfIdealShaverConjugateToTheDesignedGear
