...
from mastapy.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import _757, _744
...
class AxialShaverRedressing(_757.ShaverRedressing['_744.ConventionalShavingDynamics']):
    """AxialShaverRedressing
