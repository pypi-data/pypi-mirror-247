...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _654, _687
...
class WormGrindingProcessPitchCalculation(_687.WormGrindingProcessCalculation):
    """WormGrindingProcessPitchCalculation
