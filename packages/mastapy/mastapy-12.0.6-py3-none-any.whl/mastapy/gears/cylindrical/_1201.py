...
_CYLINDRICAL_GEAR_WORST_LTCA_CONTACT_CHARTS = python_net_import('SMT.MastaAPI.Gears.Cylindrical', 'CylindricalGearWorstLTCAContactCharts')
...
class CylindricalGearWorstLTCAContactCharts(_0.APIBase):
    ...
    def __init__(self, instance_to_wrap: 'CylindricalGearWorstLTCAContactCharts.TYPE'):
