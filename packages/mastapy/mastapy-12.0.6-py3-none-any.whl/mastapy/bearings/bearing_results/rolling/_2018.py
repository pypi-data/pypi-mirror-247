...
from mastapy.bearings.bearing_results.rolling import _2017, _1966
...
class LoadedThrustBallBearingRow(_1966.LoadedBallBearingRow):
    """LoadedThrustBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_2017.LoadedThrustBallBearingResults':
