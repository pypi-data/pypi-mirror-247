...
_SKF_AUTHENTICATION = python_net_import('SMT.MastaAPI.Bearings.BearingResults.Rolling.SkfModule', 'SKFAuthentication')
...
class SKFAuthentication(_0.APIBase):
    ...
    def __init__(self, instance_to_wrap: 'SKFAuthentication.TYPE'):
        super().__init__(instance_to_wrap)
        self._freeze()

    @property
    def authentication_expiry_date(self) -> 'str':
        """str: 'AuthenticationExpiryDate' is the original name of this property.
