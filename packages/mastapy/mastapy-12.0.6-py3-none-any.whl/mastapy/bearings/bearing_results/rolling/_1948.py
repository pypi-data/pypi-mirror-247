...
from mastapy.bearings.bearing_results.rolling import _1945
...
class LoadedAngularContactThrustBallBearingElement(_1945.LoadedAngularContactBallBearingElement):
    """LoadedAngularContactThrustBallBearingElement
