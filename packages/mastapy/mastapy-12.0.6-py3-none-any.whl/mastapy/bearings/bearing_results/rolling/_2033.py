...
from mastapy.bearings.bearing_results import _1909
...
class RollingBearingFrictionCoefficients(_1554.IndependentReportablePropertiesBase['RollingBearingFrictionCoefficients']):
    """RollingBearingFrictionCoefficients
    ...
    def use_user_specified_f1_for_din732(self) -> 'bool':
        ...
        temp = self.wrapped.UseUserSpecifiedF1ForDIN732
    ...
    def use_user_specified_f1_for_din732(self, value: 'bool'):
        self.wrapped.UseUserSpecifiedF1ForDIN732 = bool(value) if value is not None else False
    ...
    def user_specified_f1_for_din732(self) -> 'float':
        ...
        temp = self.wrapped.UserSpecifiedF1ForDIN732
    ...
    def user_specified_f1_for_din732(self, value: 'float'):
        self.wrapped.UserSpecifiedF1ForDIN732 = float(value) if value is not None else 0.0
    ...
    @property
    def iso14179_dynamic_equivalent_load_factors(self) -> '_1909.EquivalentLoadFactors':
    ...
    @property
    def iso14179_static_equivalent_load_factors(self) -> '_1909.EquivalentLoadFactors':
