...
from mastapy.bearings.bearing_results.rolling import _1999, _1966
...
class LoadedSelfAligningBallBearingRow(_1966.LoadedBallBearingRow):
    """LoadedSelfAligningBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1999.LoadedSelfAligningBallBearingResults':
