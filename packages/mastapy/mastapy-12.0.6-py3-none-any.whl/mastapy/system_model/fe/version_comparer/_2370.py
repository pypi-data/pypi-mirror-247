...
from mastapy.system_model.fe.version_comparer import _2373
from mastapy import _0
from mastapy._internal.python_net import python_net_import

_DESIGN_RESULTS = python_net_import('SMT.MastaAPI.SystemModel.FE.VersionComparer', 'DesignResults')
...
class DesignResults(_0.APIBase):
    ...
    @property
    def load_cases(self) -> 'List[_2373.LoadCaseResults]':
