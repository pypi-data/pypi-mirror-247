...
class CycloidalAssemblyCreationOptions(_0.APIBase):
    ...
    def __init__(self, instance_to_wrap: 'CycloidalAssemblyCreationOptions.TYPE'):
    ...
    def number_of_discs(self) -> 'int':
        """int: 'NumberOfDiscs' is the original name of this property."""
    ...
    def number_of_discs(self, value: 'int'):
