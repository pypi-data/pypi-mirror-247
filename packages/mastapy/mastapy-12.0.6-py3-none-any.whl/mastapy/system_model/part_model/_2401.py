...
from mastapy.math_utility import _1465, _1466
from mastapy.system_model.connections_and_sockets import (
    _2229, _2231, _2255, _2250
)
from mastapy.system_model.part_model import _2402, _2425
...
class Component(_2425.Part):
    ...
    @property
    def component_connections(self) -> 'List[_2229.ComponentConnection]':
    ...
    def can_delete_connection(self, connection: '_2231.Connection') -> 'bool':
    ...
    def connect_to(self, component: 'Component') -> '_2402.ComponentsConnectedResult':
    ...
    def connect_to_socket(self, socket: '_2255.Socket') -> '_2402.ComponentsConnectedResult':
        """ 'ConnectTo' is the original name of this method.
    ...
    def create_coordinate_system_editor(self) -> '_1466.CoordinateSystemEditor':
    ...
    def diameter_at_middle_of_connection(self, connection: '_2231.Connection') -> 'float':
    ...
    def diameter_of_socket_for(self, connection: '_2231.Connection') -> 'float':
    ...
    def possible_sockets_to_connect_with_component(self, component: 'Component') -> 'List[_2255.Socket]':
    ...
    def possible_sockets_to_connect_with(self, socket: '_2255.Socket') -> 'List[_2255.Socket]':
        """ 'PossibleSocketsToConnectWith' is the original name of this method.
    ...
    def set_position_and_axis_of_component_and_connected_components(self, origin: 'Vector3D', z_axis: 'Vector3D') -> '_2250.RealignmentResult':
    ...
    def set_position_and_rotation_of_component_and_connected_components(self, new_coordinate_system: '_1465.CoordinateSystem3D') -> '_2250.RealignmentResult':
    ...
    def set_position_of_component_and_connected_components(self, position: 'Vector3D') -> '_2250.RealignmentResult':
    ...
    def socket_named(self, socket_name: 'str') -> '_2255.Socket':
    ...
    def try_connect_to(self, component: 'Component', hint_offset: Optional['float'] = float('nan')) -> '_2402.ComponentsConnectedResult':
