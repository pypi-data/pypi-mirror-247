...
class FlexiblePinAssembly(_2433.SpecialisedAssembly):
    """FlexiblePinAssembly
    ...
    @property
    def planet_gear(self) -> '_2481.CylindricalGear':
        ...
        if _2481.CylindricalGear.TYPE not in temp.__class__.__mro__:
            raise CastException('Failed to cast planet_gear to CylindricalGear. Expected: {}.'.format(temp.__class__.__qualname__))
