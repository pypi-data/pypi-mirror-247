...
class ComponentCompoundSteadyStateSynchronousResponseAtASpeed(_3664.PartCompoundSteadyStateSynchronousResponseAtASpeed):
    """ComponentCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3480.ComponentSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3480.ComponentSteadyStateSynchronousResponseAtASpeed]':
