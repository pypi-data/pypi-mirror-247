...
class GearCompoundSteadyStateSynchronousResponseAtASpeed(_3662.MountableComponentCompoundSteadyStateSynchronousResponseAtASpeed):
    """GearCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3515.GearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3515.GearSteadyStateSynchronousResponseAtASpeed]':
