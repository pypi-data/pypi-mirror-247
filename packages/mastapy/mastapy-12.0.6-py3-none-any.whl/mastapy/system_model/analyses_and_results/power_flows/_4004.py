...
from mastapy.system_model.analyses_and_results.power_flows import _4002, _4020
...
class ClutchPowerFlow(_4020.CouplingPowerFlow):
    """ClutchPowerFlow
    ...
    @property
    def clutch_connection(self) -> '_4002.ClutchConnectionPowerFlow':
