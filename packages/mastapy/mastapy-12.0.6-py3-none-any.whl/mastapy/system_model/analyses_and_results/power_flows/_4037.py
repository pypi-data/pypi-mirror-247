...
from mastapy.system_model.analyses_and_results.power_flows import _4036, _4035, _4042
...
class FaceGearSetPowerFlow(_4042.GearSetPowerFlow):
    """FaceGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_4036.FaceGearPowerFlow]':
    ...
    @property
    def face_gears_power_flow(self) -> 'List[_4036.FaceGearPowerFlow]':
    ...
    @property
    def meshes_power_flow(self) -> 'List[_4035.FaceGearMeshPowerFlow]':
    ...
    @property
    def face_meshes_power_flow(self) -> 'List[_4035.FaceGearMeshPowerFlow]':
