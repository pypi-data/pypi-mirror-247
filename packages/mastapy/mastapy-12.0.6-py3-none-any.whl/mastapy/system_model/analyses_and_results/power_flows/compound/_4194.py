...
class PartToPartShearCouplingCompoundPowerFlow(_4151.CouplingCompoundPowerFlow):
    """PartToPartShearCouplingCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4064.PartToPartShearCouplingPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4064.PartToPartShearCouplingPowerFlow]':
