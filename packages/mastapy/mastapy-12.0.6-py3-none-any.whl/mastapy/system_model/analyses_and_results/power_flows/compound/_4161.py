...
class CylindricalGearCompoundPowerFlow(_4172.GearCompoundPowerFlow):
    """CylindricalGearCompoundPowerFlow
    ...
    @property
    def cylindrical_gear_duty_cycle_rating(self) -> '_449.CylindricalGearDutyCycleRating':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4030.CylindricalGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4030.CylindricalGearPowerFlow]':
