...
class SpringDamperCompoundPowerFlow(_4151.CouplingCompoundPowerFlow):
    """SpringDamperCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4088.SpringDamperPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4088.SpringDamperPowerFlow]':
