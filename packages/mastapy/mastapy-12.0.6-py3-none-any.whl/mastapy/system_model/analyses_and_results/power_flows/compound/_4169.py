...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4167, _4168, _4174
...
class FaceGearSetCompoundPowerFlow(_4174.GearSetCompoundPowerFlow):
    """FaceGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4037.FaceGearSetPowerFlow]':
    ...
    @property
    def face_gears_compound_power_flow(self) -> 'List[_4167.FaceGearCompoundPowerFlow]':
    ...
    @property
    def face_meshes_compound_power_flow(self) -> 'List[_4168.FaceGearMeshCompoundPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4037.FaceGearSetPowerFlow]':
