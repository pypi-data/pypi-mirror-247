...
class ZerolBevelGearCompoundParametricStudyTool(_4406.BevelGearCompoundParametricStudyTool):
    """ZerolBevelGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4388.ZerolBevelGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4388.ZerolBevelGearParametricStudyTool]':
