...
class BearingCompoundParametricStudyTool(_4426.ConnectorCompoundParametricStudyTool):
    """BearingCompoundParametricStudyTool
    ...
    @property
    def bearing_duty_cycle_results(self) -> '_1912.LoadedBearingDutyCycle':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4251.BearingParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4251.BearingParametricStudyTool]':
