...
class AbstractShaftCompoundParametricStudyTool(_4392.AbstractShaftOrHousingCompoundParametricStudyTool):
    """AbstractShaftCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4245.AbstractShaftParametricStudyTool]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4245.AbstractShaftParametricStudyTool]':
