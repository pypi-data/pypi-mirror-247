...
class PartParametricStudyTool(_7475.PartAnalysisCase):
    """PartParametricStudyTool
    ...
    @property
    def design_of_experiments_chart(self) -> '_1822.NDChartDefinition':
        ...
        if _1822.NDChartDefinition.TYPE not in temp.__class__.__mro__:
            raise CastException('Failed to cast design_of_experiments_chart to NDChartDefinition. Expected: {}.'.format(temp.__class__.__qualname__))

        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)(temp) if temp is not None else None

    @property
    def design_of_experiments_chart_of_type_bubble_chart_definition(self) -> '_1816.BubbleChartDefinition':
        """BubbleChartDefinition: 'DesignOfExperimentsChart' is the original name of this property.
        ...
        if _1816.BubbleChartDefinition.TYPE not in temp.__class__.__mro__:
            raise CastException('Failed to cast design_of_experiments_chart to BubbleChartDefinition. Expected: {}.'.format(temp.__class__.__qualname__))

        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)(temp) if temp is not None else None

    @property
    def design_of_experiments_chart_of_type_parallel_coordinates_chart_definition(self) -> '_1823.ParallelCoordinatesChartDefinition':
        """ParallelCoordinatesChartDefinition: 'DesignOfExperimentsChart' is the original name of this property.
        ...
        if _1823.ParallelCoordinatesChartDefinition.TYPE not in temp.__class__.__mro__:
            raise CastException('Failed to cast design_of_experiments_chart to ParallelCoordinatesChartDefinition. Expected: {}.'.format(temp.__class__.__qualname__))

        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)(temp) if temp is not None else None

    @property
    def design_of_experiments_chart_of_type_scatter_chart_definition(self) -> '_1825.ScatterChartDefinition':
        """ScatterChartDefinition: 'DesignOfExperimentsChart' is the original name of this property.
        ...
        if _1825.ScatterChartDefinition.TYPE not in temp.__class__.__mro__:
            raise CastException('Failed to cast design_of_experiments_chart to ScatterChartDefinition. Expected: {}.'.format(temp.__class__.__qualname__))

        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)(temp) if temp is not None else None

    @property
    def design_of_experiments_chart_of_type_three_d_chart_definition(self) -> '_1828.ThreeDChartDefinition':
        """ThreeDChartDefinition: 'DesignOfExperimentsChart' is the original name of this property.
        ...
        if _1828.ThreeDChartDefinition.TYPE not in temp.__class__.__mro__:
            raise CastException('Failed to cast design_of_experiments_chart to ThreeDChartDefinition. Expected: {}.'.format(temp.__class__.__qualname__))

        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)(temp) if temp is not None else None

    @property
    def design_of_experiments_chart_of_type_three_d_vector_chart_definition(self) -> '_1829.ThreeDVectorChartDefinition':
        """ThreeDVectorChartDefinition: 'DesignOfExperimentsChart' is the original name of this property.
        ...
        if _1829.ThreeDVectorChartDefinition.TYPE not in temp.__class__.__mro__:
            raise CastException('Failed to cast design_of_experiments_chart to ThreeDVectorChartDefinition. Expected: {}.'.format(temp.__class__.__qualname__))

        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)(temp) if temp is not None else None

    @property
    def design_of_experiments_chart_of_type_two_d_chart_definition(self) -> '_1830.TwoDChartDefinition':
        """TwoDChartDefinition: 'DesignOfExperimentsChart' is the original name of this property.
        ...
        if _1830.TwoDChartDefinition.TYPE not in temp.__class__.__mro__:
            raise CastException('Failed to cast design_of_experiments_chart to TwoDChartDefinition. Expected: {}.'.format(temp.__class__.__qualname__))

        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)(temp) if temp is not None else None

    @property
    def linear_sweep_chart_2d(self) -> '_1830.TwoDChartDefinition':
        ...
        if _1830.TwoDChartDefinition.TYPE not in temp.__class__.__mro__:
            raise CastException('Failed to cast linear_sweep_chart_2d to TwoDChartDefinition. Expected: {}.'.format(temp.__class__.__qualname__))

        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)(temp) if temp is not None else None

    @property
    def linear_sweep_chart_3d(self) -> '_1828.ThreeDChartDefinition':
