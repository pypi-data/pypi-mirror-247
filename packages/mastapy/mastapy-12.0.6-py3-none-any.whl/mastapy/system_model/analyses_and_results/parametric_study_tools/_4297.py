...
class DutyCycleResultsForAllComponents(_0.APIBase):
    ...
    @property
    def results_for_all_gear_sets(self) -> '_4298.DutyCycleResultsForAllGearSets':
    ...
    @property
    def results_for_root_assembly(self) -> '_4299.DutyCycleResultsForRootAssembly':
        """DutyCycleResultsForRootAssembly: 'ResultsForRootAssembly' is the original name of this property.
    ...
    @property
    def results_for_all_bearings(self) -> 'List[_4300.DutyCycleResultsForSingleBearing]':
    ...
    @property
    def results_for_all_shafts(self) -> 'List[_4301.DutyCycleResultsForSingleShaft]':
