...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _5188, _5187, _5079
...
class ZerolBevelGearSetModalAnalysisAtASpeed(_5079.BevelGearSetModalAnalysisAtASpeed):
    """ZerolBevelGearSetModalAnalysisAtASpeed
    ...
    @property
    def zerol_bevel_gears_modal_analysis_at_a_speed(self) -> 'List[_5188.ZerolBevelGearModalAnalysisAtASpeed]':
    ...
    @property
    def zerol_bevel_meshes_modal_analysis_at_a_speed(self) -> 'List[_5187.ZerolBevelGearMeshModalAnalysisAtASpeed]':
