...
class RingPinsCompoundModalAnalysisAtASpeed(_5267.MountableComponentCompoundModalAnalysisAtASpeed):
    """RingPinsCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5150.RingPinsModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5150.RingPinsModalAnalysisAtASpeed]':
