...
class GuideDxfModelCompoundModalAnalysisAtASpeed(_5215.ComponentCompoundModalAnalysisAtASpeed):
    """GuideDxfModelCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5122.GuideDxfModelModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5122.GuideDxfModelModalAnalysisAtASpeed]':
