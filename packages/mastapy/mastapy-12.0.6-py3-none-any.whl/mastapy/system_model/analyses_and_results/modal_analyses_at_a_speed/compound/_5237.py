...
class CylindricalGearCompoundModalAnalysisAtASpeed(_5248.GearCompoundModalAnalysisAtASpeed):
    """CylindricalGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5109.CylindricalGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5109.CylindricalGearModalAnalysisAtASpeed]':
