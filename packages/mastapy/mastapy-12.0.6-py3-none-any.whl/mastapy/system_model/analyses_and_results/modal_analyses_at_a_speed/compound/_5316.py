...
class ZerolBevelGearCompoundModalAnalysisAtASpeed(_5206.BevelGearCompoundModalAnalysisAtASpeed):
    """ZerolBevelGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5188.ZerolBevelGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5188.ZerolBevelGearModalAnalysisAtASpeed]':
