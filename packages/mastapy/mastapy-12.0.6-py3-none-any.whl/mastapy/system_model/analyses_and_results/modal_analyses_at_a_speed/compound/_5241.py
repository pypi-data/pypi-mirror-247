...
class DatumCompoundModalAnalysisAtASpeed(_5215.ComponentCompoundModalAnalysisAtASpeed):
    """DatumCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5112.DatumModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5112.DatumModalAnalysisAtASpeed]':
