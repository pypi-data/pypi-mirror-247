...
class InterMountableComponentConnectionCompoundModalAnalysisAtASpeed(_5225.ConnectionCompoundModalAnalysisAtASpeed):
    """InterMountableComponentConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5126.InterMountableComponentConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5126.InterMountableComponentConnectionModalAnalysisAtASpeed]':
