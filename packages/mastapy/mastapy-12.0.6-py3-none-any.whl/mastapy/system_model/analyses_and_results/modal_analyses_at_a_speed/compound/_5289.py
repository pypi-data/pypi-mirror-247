...
class SpiralBevelGearCompoundModalAnalysisAtASpeed(_5206.BevelGearCompoundModalAnalysisAtASpeed):
    """SpiralBevelGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5161.SpiralBevelGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5161.SpiralBevelGearModalAnalysisAtASpeed]':
