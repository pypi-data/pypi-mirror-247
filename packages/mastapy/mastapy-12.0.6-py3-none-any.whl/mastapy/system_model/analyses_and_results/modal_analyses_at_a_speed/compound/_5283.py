...
class RollingRingConnectionCompoundModalAnalysisAtASpeed(_5255.InterMountableComponentConnectionCompoundModalAnalysisAtASpeed):
    """RollingRingConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5153.RollingRingConnectionModalAnalysisAtASpeed]':
        """List[RollingRingConnectionModalAnalysisAtASpeed]: 'ConnectionAnalysisCasesReady' is the original name of this property.
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5153.RollingRingConnectionModalAnalysisAtASpeed]':
        """List[RollingRingConnectionModalAnalysisAtASpeed]: 'ConnectionAnalysisCases' is the original name of this property.
