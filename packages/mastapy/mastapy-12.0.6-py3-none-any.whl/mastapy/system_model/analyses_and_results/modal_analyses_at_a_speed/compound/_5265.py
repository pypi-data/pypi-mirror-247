...
class MassDiscCompoundModalAnalysisAtASpeed(_5312.VirtualComponentCompoundModalAnalysisAtASpeed):
    """MassDiscCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5136.MassDiscModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5136.MassDiscModalAnalysisAtASpeed]':
