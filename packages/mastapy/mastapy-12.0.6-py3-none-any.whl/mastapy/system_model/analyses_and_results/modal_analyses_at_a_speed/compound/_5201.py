...
class BevelDifferentialGearCompoundModalAnalysisAtASpeed(_5206.BevelGearCompoundModalAnalysisAtASpeed):
    """BevelDifferentialGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5073.BevelDifferentialGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5073.BevelDifferentialGearModalAnalysisAtASpeed]':
