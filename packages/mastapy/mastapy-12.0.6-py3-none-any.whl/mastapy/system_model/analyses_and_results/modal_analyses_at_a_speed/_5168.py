...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _5167, _5166, _5079
...
class StraightBevelDiffGearSetModalAnalysisAtASpeed(_5079.BevelGearSetModalAnalysisAtASpeed):
    """StraightBevelDiffGearSetModalAnalysisAtASpeed
    ...
    @property
    def straight_bevel_diff_gears_modal_analysis_at_a_speed(self) -> 'List[_5167.StraightBevelDiffGearModalAnalysisAtASpeed]':
    ...
    @property
    def straight_bevel_diff_meshes_modal_analysis_at_a_speed(self) -> 'List[_5166.StraightBevelDiffGearMeshModalAnalysisAtASpeed]':
