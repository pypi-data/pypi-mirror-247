...
class CoaxialConnectionCompoundAdvancedSystemDeflection(_7433.ShaftToMountableComponentConnectionCompoundAdvancedSystemDeflection):
    """CoaxialConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7227.CoaxialConnectionAdvancedSystemDeflection]':
        """List[CoaxialConnectionAdvancedSystemDeflection]: 'ConnectionAnalysisCasesReady' is the original name of this property.
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7227.CoaxialConnectionAdvancedSystemDeflection]':
        """List[CoaxialConnectionAdvancedSystemDeflection]: 'ConnectionAnalysisCases' is the original name of this property.
