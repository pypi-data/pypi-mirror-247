...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import (
    _7344, _7346, _7349, _7356,
    _7355, _7377, _7357, _7362,
    _7367, _7379, _7381, _7385,
    _7392, _7391, _7393, _7400,
    _7407, _7410, _7411, _7412,
    _7414, _7416, _7421, _7422,
    _7423, _7425, _7427, _7432,
    _7431, _7437, _7438, _7443,
    _7446, _7449, _7453, _7457,
    _7461, _7464, _7336
)
...
class AssemblyCompoundAdvancedSystemDeflection(_7336.AbstractAssemblyCompoundAdvancedSystemDeflection):
    """AssemblyCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7210.AssemblyAdvancedSystemDeflection]':
    ...
    @property
    def bearings(self) -> 'List[_7344.BearingCompoundAdvancedSystemDeflection]':
    ...
    @property
    def belt_drives(self) -> 'List[_7346.BeltDriveCompoundAdvancedSystemDeflection]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_7349.BevelDifferentialGearSetCompoundAdvancedSystemDeflection]':
    ...
    @property
    def bolted_joints(self) -> 'List[_7356.BoltedJointCompoundAdvancedSystemDeflection]':
    ...
    @property
    def bolts(self) -> 'List[_7355.BoltCompoundAdvancedSystemDeflection]':
    ...
    @property
    def cv_ts(self) -> 'List[_7377.CVTCompoundAdvancedSystemDeflection]':
    ...
    @property
    def clutches(self) -> 'List[_7357.ClutchCompoundAdvancedSystemDeflection]':
    ...
    @property
    def concept_couplings(self) -> 'List[_7362.ConceptCouplingCompoundAdvancedSystemDeflection]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_7367.ConceptGearSetCompoundAdvancedSystemDeflection]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_7379.CycloidalAssemblyCompoundAdvancedSystemDeflection]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_7381.CycloidalDiscCompoundAdvancedSystemDeflection]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_7385.CylindricalGearSetCompoundAdvancedSystemDeflection]':
    ...
    @property
    def fe_parts(self) -> 'List[_7392.FEPartCompoundAdvancedSystemDeflection]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_7391.FaceGearSetCompoundAdvancedSystemDeflection]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_7393.FlexiblePinAssemblyCompoundAdvancedSystemDeflection]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_7400.HypoidGearSetCompoundAdvancedSystemDeflection]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_7407.KlingelnbergCycloPalloidHypoidGearSetCompoundAdvancedSystemDeflection]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_7410.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundAdvancedSystemDeflection]':
    ...
    @property
    def mass_discs(self) -> 'List[_7411.MassDiscCompoundAdvancedSystemDeflection]':
    ...
    @property
    def measurement_components(self) -> 'List[_7412.MeasurementComponentCompoundAdvancedSystemDeflection]':
    ...
    @property
    def oil_seals(self) -> 'List[_7414.OilSealCompoundAdvancedSystemDeflection]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_7416.PartToPartShearCouplingCompoundAdvancedSystemDeflection]':
    ...
    @property
    def planet_carriers(self) -> 'List[_7421.PlanetCarrierCompoundAdvancedSystemDeflection]':
    ...
    @property
    def point_loads(self) -> 'List[_7422.PointLoadCompoundAdvancedSystemDeflection]':
    ...
    @property
    def power_loads(self) -> 'List[_7423.PowerLoadCompoundAdvancedSystemDeflection]':
    ...
    @property
    def ring_pins(self) -> 'List[_7425.RingPinsCompoundAdvancedSystemDeflection]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_7427.RollingRingAssemblyCompoundAdvancedSystemDeflection]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_7432.ShaftHubConnectionCompoundAdvancedSystemDeflection]':
    ...
    @property
    def shafts(self) -> 'List[_7431.ShaftCompoundAdvancedSystemDeflection]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_7437.SpiralBevelGearSetCompoundAdvancedSystemDeflection]':
    ...
    @property
    def spring_dampers(self) -> 'List[_7438.SpringDamperCompoundAdvancedSystemDeflection]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_7443.StraightBevelDiffGearSetCompoundAdvancedSystemDeflection]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_7446.StraightBevelGearSetCompoundAdvancedSystemDeflection]':
    ...
    @property
    def synchronisers(self) -> 'List[_7449.SynchroniserCompoundAdvancedSystemDeflection]':
    ...
    @property
    def torque_converters(self) -> 'List[_7453.TorqueConverterCompoundAdvancedSystemDeflection]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_7457.UnbalancedMassCompoundAdvancedSystemDeflection]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_7461.WormGearSetCompoundAdvancedSystemDeflection]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_7464.ZerolBevelGearSetCompoundAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7210.AssemblyAdvancedSystemDeflection]':
