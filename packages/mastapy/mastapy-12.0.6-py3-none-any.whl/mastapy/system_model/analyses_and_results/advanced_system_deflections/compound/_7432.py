...
class ShaftHubConnectionCompoundAdvancedSystemDeflection(_7372.ConnectorCompoundAdvancedSystemDeflection):
    """ShaftHubConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7302.ShaftHubConnectionAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7302.ShaftHubConnectionAdvancedSystemDeflection]':
