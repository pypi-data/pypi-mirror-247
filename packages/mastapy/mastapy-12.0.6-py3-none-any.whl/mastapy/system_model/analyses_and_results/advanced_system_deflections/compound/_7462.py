...
class ZerolBevelGearCompoundAdvancedSystemDeflection(_7352.BevelGearCompoundAdvancedSystemDeflection):
    """ZerolBevelGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7333.ZerolBevelGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7333.ZerolBevelGearAdvancedSystemDeflection]':
