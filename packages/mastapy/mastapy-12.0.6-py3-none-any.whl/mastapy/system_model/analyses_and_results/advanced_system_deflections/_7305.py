...
class SpiralBevelGearAdvancedSystemDeflection(_7219.BevelGearAdvancedSystemDeflection):
    """SpiralBevelGearAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2760.SpiralBevelGearSystemDeflection]':
