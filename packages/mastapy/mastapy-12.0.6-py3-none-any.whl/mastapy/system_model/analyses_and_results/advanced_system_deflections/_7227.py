...
class CoaxialConnectionAdvancedSystemDeflection(_7303.ShaftToMountableComponentConnectionAdvancedSystemDeflection):
    """CoaxialConnectionAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2665.CoaxialConnectionSystemDeflection]':
