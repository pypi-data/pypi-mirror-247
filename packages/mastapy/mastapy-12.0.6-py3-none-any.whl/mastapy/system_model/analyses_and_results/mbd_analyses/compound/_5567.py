...
class ShaftHubConnectionCompoundMultibodyDynamicsAnalysis(_5507.ConnectorCompoundMultibodyDynamicsAnalysis):
    """ShaftHubConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5427.ShaftHubConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5427.ShaftHubConnectionMultibodyDynamicsAnalysis]':
