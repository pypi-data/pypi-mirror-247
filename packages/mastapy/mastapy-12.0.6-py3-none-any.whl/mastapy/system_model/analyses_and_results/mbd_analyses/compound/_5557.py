...
class PointLoadCompoundMultibodyDynamicsAnalysis(_5593.VirtualComponentCompoundMultibodyDynamicsAnalysis):
    """PointLoadCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5416.PointLoadMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5416.PointLoadMultibodyDynamicsAnalysis]':
