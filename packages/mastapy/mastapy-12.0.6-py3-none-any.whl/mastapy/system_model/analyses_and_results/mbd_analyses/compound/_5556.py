...
class PlanetCarrierCompoundMultibodyDynamicsAnalysis(_5548.MountableComponentCompoundMultibodyDynamicsAnalysis):
    """PlanetCarrierCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5415.PlanetCarrierMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5415.PlanetCarrierMultibodyDynamicsAnalysis]':
