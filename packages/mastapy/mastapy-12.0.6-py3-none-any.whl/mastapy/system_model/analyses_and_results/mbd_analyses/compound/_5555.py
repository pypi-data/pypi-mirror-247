...
class PlanetaryGearSetCompoundMultibodyDynamicsAnalysis(_5520.CylindricalGearSetCompoundMultibodyDynamicsAnalysis):
    """PlanetaryGearSetCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5414.PlanetaryGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5414.PlanetaryGearSetMultibodyDynamicsAnalysis]':
