...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5594, _5595, _5531
...
class WormGearSetCompoundMultibodyDynamicsAnalysis(_5531.GearSetCompoundMultibodyDynamicsAnalysis):
    """WormGearSetCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5461.WormGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def worm_gears_compound_multibody_dynamics_analysis(self) -> 'List[_5594.WormGearCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def worm_meshes_compound_multibody_dynamics_analysis(self) -> 'List[_5595.WormGearMeshCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5461.WormGearSetMultibodyDynamicsAnalysis]':
