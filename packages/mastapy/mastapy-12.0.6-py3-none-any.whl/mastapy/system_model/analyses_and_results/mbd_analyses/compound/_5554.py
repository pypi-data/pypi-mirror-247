...
class PlanetaryConnectionCompoundMultibodyDynamicsAnalysis(_5568.ShaftToMountableComponentConnectionCompoundMultibodyDynamicsAnalysis):
    """PlanetaryConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5413.PlanetaryConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5413.PlanetaryConnectionMultibodyDynamicsAnalysis]':
