...
class PartToPartShearCouplingCompoundMultibodyDynamicsAnalysis(_5508.CouplingCompoundMultibodyDynamicsAnalysis):
    """PartToPartShearCouplingCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5412.PartToPartShearCouplingMultibodyDynamicsAnalysis]':
        """List[PartToPartShearCouplingMultibodyDynamicsAnalysis]: 'AssemblyAnalysisCasesReady' is the original name of this property.
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5412.PartToPartShearCouplingMultibodyDynamicsAnalysis]':
        """List[PartToPartShearCouplingMultibodyDynamicsAnalysis]: 'AssemblyAnalysisCases' is the original name of this property.
