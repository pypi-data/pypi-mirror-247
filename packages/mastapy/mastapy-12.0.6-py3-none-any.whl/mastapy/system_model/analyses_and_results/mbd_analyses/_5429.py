...
_SHAFT_TO_MOUNTABLE_COMPONENT_CONNECTION_MULTIBODY_DYNAMICS_ANALYSIS = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses', 'ShaftToMountableComponentConnectionMultibodyDynamicsAnalysis')
...
class ShaftToMountableComponentConnectionMultibodyDynamicsAnalysis(_5322.AbstractShaftToMountableComponentConnectionMultibodyDynamicsAnalysis):
    """ShaftToMountableComponentConnectionMultibodyDynamicsAnalysis
