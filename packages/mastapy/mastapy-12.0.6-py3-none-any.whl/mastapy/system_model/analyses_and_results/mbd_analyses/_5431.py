...
_SPECIALISED_ASSEMBLY_MULTIBODY_DYNAMICS_ANALYSIS = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses', 'SpecialisedAssemblyMultibodyDynamicsAnalysis')
...
class SpecialisedAssemblyMultibodyDynamicsAnalysis(_5319.AbstractAssemblyMultibodyDynamicsAnalysis):
    """SpecialisedAssemblyMultibodyDynamicsAnalysis
