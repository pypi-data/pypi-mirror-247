...
class FlexiblePinAssemblyCompoundSteadyStateSynchronousResponseOnAShaft(_3424.SpecialisedAssemblyCompoundSteadyStateSynchronousResponseOnAShaft):
    """FlexiblePinAssemblyCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3253.FlexiblePinAssemblySteadyStateSynchronousResponseOnAShaft]':
        """List[FlexiblePinAssemblySteadyStateSynchronousResponseOnAShaft]: 'AssemblyAnalysisCasesReady' is the original name of this property.
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3253.FlexiblePinAssemblySteadyStateSynchronousResponseOnAShaft]':
        """List[FlexiblePinAssemblySteadyStateSynchronousResponseOnAShaft]: 'AssemblyAnalysisCases' is the original name of this property.
