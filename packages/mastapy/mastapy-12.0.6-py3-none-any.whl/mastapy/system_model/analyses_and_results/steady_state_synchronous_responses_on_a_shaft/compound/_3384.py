...
class GearCompoundSteadyStateSynchronousResponseOnAShaft(_3403.MountableComponentCompoundSteadyStateSynchronousResponseOnAShaft):
    """GearCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3256.GearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3256.GearSteadyStateSynchronousResponseOnAShaft]':
