...
class ConnectionCompoundSteadyStateSynchronousResponseOnAShaft(_7469.ConnectionCompoundAnalysis):
    """ConnectionCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3231.ConnectionSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3231.ConnectionSteadyStateSynchronousResponseOnAShaft]':
