...
class ShaftHubConnectionCompoundModalAnalysisAtAStiffness(_4968.ConnectorCompoundModalAnalysisAtAStiffness):
    """ShaftHubConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4898.ShaftHubConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4898.ShaftHubConnectionModalAnalysisAtAStiffness]':
