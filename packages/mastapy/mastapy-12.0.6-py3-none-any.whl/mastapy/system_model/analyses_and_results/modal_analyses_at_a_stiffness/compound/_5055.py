...
class WormGearCompoundModalAnalysisAtAStiffness(_4990.GearCompoundModalAnalysisAtAStiffness):
    """WormGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4927.WormGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4927.WormGearModalAnalysisAtAStiffness]':
