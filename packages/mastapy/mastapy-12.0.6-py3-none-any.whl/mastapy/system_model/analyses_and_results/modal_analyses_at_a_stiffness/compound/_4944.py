...
class BevelDifferentialGearMeshCompoundModalAnalysisAtAStiffness(_4949.BevelGearMeshCompoundModalAnalysisAtAStiffness):
    """BevelDifferentialGearMeshCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4813.BevelDifferentialGearMeshModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4813.BevelDifferentialGearMeshModalAnalysisAtAStiffness]':
