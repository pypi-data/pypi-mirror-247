...
class AbstractShaftOrHousingCompoundModalAnalysisAtAStiffness(_4957.ComponentCompoundModalAnalysisAtAStiffness):
    """AbstractShaftOrHousingCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4804.AbstractShaftOrHousingModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4804.AbstractShaftOrHousingModalAnalysisAtAStiffness]':
