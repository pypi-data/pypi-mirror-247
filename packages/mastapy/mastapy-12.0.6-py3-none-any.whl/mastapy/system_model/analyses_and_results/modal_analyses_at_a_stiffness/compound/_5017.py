...
class PlanetCarrierCompoundModalAnalysisAtAStiffness(_5009.MountableComponentCompoundModalAnalysisAtAStiffness):
    """PlanetCarrierCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4888.PlanetCarrierModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4888.PlanetCarrierModalAnalysisAtAStiffness]':
