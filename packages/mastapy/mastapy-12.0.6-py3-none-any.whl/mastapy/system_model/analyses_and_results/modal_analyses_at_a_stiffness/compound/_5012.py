...
class PartToPartShearCouplingCompoundModalAnalysisAtAStiffness(_4969.CouplingCompoundModalAnalysisAtAStiffness):
    """PartToPartShearCouplingCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4885.PartToPartShearCouplingModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4885.PartToPartShearCouplingModalAnalysisAtAStiffness]':
