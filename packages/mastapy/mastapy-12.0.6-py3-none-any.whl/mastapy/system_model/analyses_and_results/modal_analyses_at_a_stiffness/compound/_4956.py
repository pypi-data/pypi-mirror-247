...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4826
...
class CoaxialConnectionCompoundModalAnalysisAtAStiffness(_5029.ShaftToMountableComponentConnectionCompoundModalAnalysisAtAStiffness):
    """CoaxialConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4826.CoaxialConnectionModalAnalysisAtAStiffness]':
        """List[CoaxialConnectionModalAnalysisAtAStiffness]: 'ConnectionAnalysisCasesReady' is the original name of this property.
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4826.CoaxialConnectionModalAnalysisAtAStiffness]':
        """List[CoaxialConnectionModalAnalysisAtAStiffness]: 'ConnectionAnalysisCases' is the original name of this property.
