...
_BEVEL_GEAR_CRITICAL_SPEED_ANALYSIS = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.CriticalSpeedAnalyses', 'BevelGearCriticalSpeedAnalysis')
...
class BevelGearCriticalSpeedAnalysis(_6480.AGMAGleasonConicalGearCriticalSpeedAnalysis):
    """BevelGearCriticalSpeedAnalysis
    ...
    def __init__(self, instance_to_wrap: 'BevelGearCriticalSpeedAnalysis.TYPE'):
