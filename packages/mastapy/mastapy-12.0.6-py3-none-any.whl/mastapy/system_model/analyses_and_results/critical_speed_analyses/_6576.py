...
_SPECIALISED_ASSEMBLY_CRITICAL_SPEED_ANALYSIS = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.CriticalSpeedAnalyses', 'SpecialisedAssemblyCriticalSpeedAnalysis')
...
class SpecialisedAssemblyCriticalSpeedAnalysis(_6476.AbstractAssemblyCriticalSpeedAnalysis):
    """SpecialisedAssemblyCriticalSpeedAnalysis
    ...
    def __init__(self, instance_to_wrap: 'SpecialisedAssemblyCriticalSpeedAnalysis.TYPE'):
