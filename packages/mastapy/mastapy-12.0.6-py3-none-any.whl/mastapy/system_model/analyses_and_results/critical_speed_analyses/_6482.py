...
_AGMA_GLEASON_CONICAL_GEAR_SET_CRITICAL_SPEED_ANALYSIS = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.CriticalSpeedAnalyses', 'AGMAGleasonConicalGearSetCriticalSpeedAnalysis')
...
class AGMAGleasonConicalGearSetCriticalSpeedAnalysis(_6510.ConicalGearSetCriticalSpeedAnalysis):
    """AGMAGleasonConicalGearSetCriticalSpeedAnalysis
    ...
    def __init__(self, instance_to_wrap: 'AGMAGleasonConicalGearSetCriticalSpeedAnalysis.TYPE'):
