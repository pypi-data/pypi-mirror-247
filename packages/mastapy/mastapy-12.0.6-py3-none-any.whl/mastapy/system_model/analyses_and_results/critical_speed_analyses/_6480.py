...
_AGMA_GLEASON_CONICAL_GEAR_CRITICAL_SPEED_ANALYSIS = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.CriticalSpeedAnalyses', 'AGMAGleasonConicalGearCriticalSpeedAnalysis')
...
class AGMAGleasonConicalGearCriticalSpeedAnalysis(_6508.ConicalGearCriticalSpeedAnalysis):
    """AGMAGleasonConicalGearCriticalSpeedAnalysis
    ...
    def __init__(self, instance_to_wrap: 'AGMAGleasonConicalGearCriticalSpeedAnalysis.TYPE'):
