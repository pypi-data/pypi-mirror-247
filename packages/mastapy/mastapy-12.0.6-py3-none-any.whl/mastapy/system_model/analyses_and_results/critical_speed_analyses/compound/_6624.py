...
class BevelGearMeshCompoundCriticalSpeedAnalysis(_6612.AGMAGleasonConicalGearMeshCompoundCriticalSpeedAnalysis):
    """BevelGearMeshCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6493.BevelGearMeshCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6493.BevelGearMeshCriticalSpeedAnalysis]':
