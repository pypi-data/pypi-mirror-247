...
class StraightBevelPlanetGearCompoundCriticalSpeedAnalysis(_6712.StraightBevelDiffGearCompoundCriticalSpeedAnalysis):
    """StraightBevelPlanetGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6589.StraightBevelPlanetGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6589.StraightBevelPlanetGearCriticalSpeedAnalysis]':
