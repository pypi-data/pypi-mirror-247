...
class SpringDamperHalfCompoundCriticalSpeedAnalysis(_6646.CouplingHalfCompoundCriticalSpeedAnalysis):
    """SpringDamperHalfCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6582.SpringDamperHalfCriticalSpeedAnalysis]':
        """List[SpringDamperHalfCriticalSpeedAnalysis]: 'ComponentAnalysisCasesReady' is the original name of this property.
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6582.SpringDamperHalfCriticalSpeedAnalysis]':
        """List[SpringDamperHalfCriticalSpeedAnalysis]: 'ComponentAnalysisCases' is the original name of this property.
