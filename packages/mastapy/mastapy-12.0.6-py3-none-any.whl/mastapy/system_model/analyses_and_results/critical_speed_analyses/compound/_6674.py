...
class KlingelnbergCycloPalloidConicalGearMeshCompoundCriticalSpeedAnalysis(_6640.ConicalGearMeshCompoundCriticalSpeedAnalysis):
    """KlingelnbergCycloPalloidConicalGearMeshCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6545.KlingelnbergCycloPalloidConicalGearMeshCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6545.KlingelnbergCycloPalloidConicalGearMeshCriticalSpeedAnalysis]':
