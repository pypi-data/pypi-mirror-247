...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6730, _6731, _6667
...
class WormGearSetCompoundCriticalSpeedAnalysis(_6667.GearSetCompoundCriticalSpeedAnalysis):
    """WormGearSetCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6603.WormGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def worm_gears_compound_critical_speed_analysis(self) -> 'List[_6730.WormGearCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def worm_meshes_compound_critical_speed_analysis(self) -> 'List[_6731.WormGearMeshCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6603.WormGearSetCriticalSpeedAnalysis]':
