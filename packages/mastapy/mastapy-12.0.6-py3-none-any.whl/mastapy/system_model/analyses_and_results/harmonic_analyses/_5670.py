...
class CylindricalGearMeshHarmonicAnalysis(_5695.GearMeshHarmonicAnalysis):
    """CylindricalGearMeshHarmonicAnalysis
    ...
    @property
    def advanced_system_deflection_results(self) -> '_7252.CylindricalGearMeshAdvancedSystemDeflection':
