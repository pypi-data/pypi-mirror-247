...
class AGMAGleasonConicalGearSetHarmonicAnalysis(_5656.ConicalGearSetHarmonicAnalysis):
    """AGMAGleasonConicalGearSetHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2646.AGMAGleasonConicalGearSetSystemDeflection':
