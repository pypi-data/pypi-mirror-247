...
class GuideDxfModelCompoundHarmonicAnalysis(_5839.ComponentCompoundHarmonicAnalysis):
    """GuideDxfModelCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5700.GuideDxfModelHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5700.GuideDxfModelHarmonicAnalysis]':
