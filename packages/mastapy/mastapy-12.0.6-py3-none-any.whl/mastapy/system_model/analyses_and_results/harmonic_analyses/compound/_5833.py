...
class BoltCompoundHarmonicAnalysis(_5839.ComponentCompoundHarmonicAnalysis):
    """BoltCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5641.BoltHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5641.BoltHarmonicAnalysis]':
