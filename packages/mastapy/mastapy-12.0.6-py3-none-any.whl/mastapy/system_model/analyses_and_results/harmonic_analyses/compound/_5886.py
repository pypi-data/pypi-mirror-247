...
class KlingelnbergCycloPalloidSpiralBevelGearCompoundHarmonicAnalysis(_5880.KlingelnbergCycloPalloidConicalGearCompoundHarmonicAnalysis):
    """KlingelnbergCycloPalloidSpiralBevelGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5717.KlingelnbergCycloPalloidSpiralBevelGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5717.KlingelnbergCycloPalloidSpiralBevelGearHarmonicAnalysis]':
