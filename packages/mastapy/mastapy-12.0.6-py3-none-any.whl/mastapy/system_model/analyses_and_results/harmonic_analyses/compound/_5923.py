...
class StraightBevelGearMeshCompoundHarmonicAnalysis(_5831.BevelGearMeshCompoundHarmonicAnalysis):
    """StraightBevelGearMeshCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5758.StraightBevelGearMeshHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5758.StraightBevelGearMeshHarmonicAnalysis]':
