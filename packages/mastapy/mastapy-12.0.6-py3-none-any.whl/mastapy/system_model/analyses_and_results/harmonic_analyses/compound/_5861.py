...
class CylindricalGearCompoundHarmonicAnalysis(_5872.GearCompoundHarmonicAnalysis):
    """CylindricalGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5669.CylindricalGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5669.CylindricalGearHarmonicAnalysis]':
