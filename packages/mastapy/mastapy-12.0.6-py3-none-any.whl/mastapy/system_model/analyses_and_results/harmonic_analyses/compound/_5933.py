...
class TorqueConverterPumpCompoundHarmonicAnalysis(_5853.CouplingHalfCompoundHarmonicAnalysis):
    """TorqueConverterPumpCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5768.TorqueConverterPumpHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5768.TorqueConverterPumpHarmonicAnalysis]':
