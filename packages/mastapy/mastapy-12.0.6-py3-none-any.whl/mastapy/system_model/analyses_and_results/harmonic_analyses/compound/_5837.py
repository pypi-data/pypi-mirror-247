...
class ClutchHalfCompoundHarmonicAnalysis(_5853.CouplingHalfCompoundHarmonicAnalysis):
    """ClutchHalfCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5643.ClutchHalfHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5643.ClutchHalfHarmonicAnalysis]':
