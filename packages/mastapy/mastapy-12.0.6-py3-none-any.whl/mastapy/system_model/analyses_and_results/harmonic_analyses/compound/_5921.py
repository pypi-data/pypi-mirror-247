...
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5919, _5920, _5832
...
class StraightBevelDiffGearSetCompoundHarmonicAnalysis(_5832.BevelGearSetCompoundHarmonicAnalysis):
    """StraightBevelDiffGearSetCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5756.StraightBevelDiffGearSetHarmonicAnalysis]':
    ...
    @property
    def straight_bevel_diff_gears_compound_harmonic_analysis(self) -> 'List[_5919.StraightBevelDiffGearCompoundHarmonicAnalysis]':
    ...
    @property
    def straight_bevel_diff_meshes_compound_harmonic_analysis(self) -> 'List[_5920.StraightBevelDiffGearMeshCompoundHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5756.StraightBevelDiffGearSetHarmonicAnalysis]':
