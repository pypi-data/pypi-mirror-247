...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5776, _5777, _5639
...
class ZerolBevelGearSetHarmonicAnalysis(_5639.BevelGearSetHarmonicAnalysis):
    """ZerolBevelGearSetHarmonicAnalysis
    ...
    @property
    def gears_harmonic_analysis(self) -> 'List[_5776.ZerolBevelGearHarmonicAnalysis]':
    ...
    @property
    def zerol_bevel_gears_harmonic_analysis(self) -> 'List[_5776.ZerolBevelGearHarmonicAnalysis]':
    ...
    @property
    def meshes_harmonic_analysis(self) -> 'List[_5777.ZerolBevelGearMeshHarmonicAnalysis]':
    ...
    @property
    def zerol_bevel_meshes_harmonic_analysis(self) -> 'List[_5777.ZerolBevelGearMeshHarmonicAnalysis]':
