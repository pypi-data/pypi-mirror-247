...
class HarmonicAnalysisResultsBrokenDownBySurfaceWithinAHarmonic(_5797.HarmonicAnalysisResultsBrokenDownByLocationWithinAHarmonic):
    """HarmonicAnalysisResultsBrokenDownBySurfaceWithinAHarmonic
    ...
    @property
    def airborne_sound_power(self) -> '_5808.ResultsForResponseOfAComponentOrSurfaceInAHarmonic':
    ...
    @property
    def maximum_normal_velocity(self) -> '_5808.ResultsForResponseOfAComponentOrSurfaceInAHarmonic':
    ...
    @property
    def root_mean_squared_normal_acceleration(self) -> '_5808.ResultsForResponseOfAComponentOrSurfaceInAHarmonic':
    ...
    @property
    def root_mean_squared_normal_displacement(self) -> '_5808.ResultsForResponseOfAComponentOrSurfaceInAHarmonic':
    ...
    @property
    def root_mean_squared_normal_velocity(self) -> '_5808.ResultsForResponseOfAComponentOrSurfaceInAHarmonic':
    ...
    @property
    def sound_intensity(self) -> '_5808.ResultsForResponseOfAComponentOrSurfaceInAHarmonic':
    ...
    @property
    def sound_pressure(self) -> '_5808.ResultsForResponseOfAComponentOrSurfaceInAHarmonic':
