...
_RESULT_NODE_SELECTION = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.HarmonicAnalyses.Results', 'ResultNodeSelection')
...
class ResultNodeSelection(_0.APIBase):
    ...
    def add_to_selected_group(self):
        """ 'AddToSelectedGroup' is the original name of this method."""

        self.wrapped.AddToSelectedGroup()

    def remove_from_selected_group(self):
        """ 'RemoveFromSelectedGroup' is the original name of this method."""
