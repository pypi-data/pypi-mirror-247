...
from mastapy.system_model.analyses_and_results.static_loads import _6803, _6812
...
class ElectricMachineHarmonicLoadDataFromMotorPackages(_6803.ElectricMachineHarmonicLoadData, Generic[T]):
    """ElectricMachineHarmonicLoadDataFromMotorPackages
