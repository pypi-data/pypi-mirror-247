...
from mastapy.system_model.analyses_and_results.static_loads import _6891, _6892, _6762
...
class StraightBevelDiffGearSetLoadCase(_6762.BevelGearSetLoadCase):
    """StraightBevelDiffGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6891.StraightBevelDiffGearLoadCase]':
    ...
    @property
    def straight_bevel_diff_gears_load_case(self) -> 'List[_6891.StraightBevelDiffGearLoadCase]':
    ...
    @property
    def straight_bevel_diff_meshes_load_case(self) -> 'List[_6892.StraightBevelDiffGearMeshLoadCase]':
