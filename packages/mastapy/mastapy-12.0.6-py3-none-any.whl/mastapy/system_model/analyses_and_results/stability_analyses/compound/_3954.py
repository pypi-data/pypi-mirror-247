...
class StraightBevelGearCompoundStabilityAnalysis(_3862.BevelGearCompoundStabilityAnalysis):
    """StraightBevelGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3827.StraightBevelGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3827.StraightBevelGearStabilityAnalysis]':
