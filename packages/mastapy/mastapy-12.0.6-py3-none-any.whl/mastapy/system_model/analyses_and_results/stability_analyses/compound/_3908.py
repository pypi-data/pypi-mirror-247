...
class HypoidGearCompoundStabilityAnalysis(_3850.AGMAGleasonConicalGearCompoundStabilityAnalysis):
    """HypoidGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3779.HypoidGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3779.HypoidGearStabilityAnalysis]':
