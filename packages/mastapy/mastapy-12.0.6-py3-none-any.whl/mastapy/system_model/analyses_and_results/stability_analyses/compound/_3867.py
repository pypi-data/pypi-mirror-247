...
from mastapy.system_model.analyses_and_results.stability_analyses import _3737
...
class ClutchCompoundStabilityAnalysis(_3883.CouplingCompoundStabilityAnalysis):
    """ClutchCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3737.ClutchStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3737.ClutchStabilityAnalysis]':
