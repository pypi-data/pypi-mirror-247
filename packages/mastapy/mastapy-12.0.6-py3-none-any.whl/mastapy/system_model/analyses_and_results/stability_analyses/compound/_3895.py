...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3893, _3894, _3906
...
class CylindricalGearSetCompoundStabilityAnalysis(_3906.GearSetCompoundStabilityAnalysis):
    """CylindricalGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3763.CylindricalGearSetStabilityAnalysis]':
    ...
    @property
    def cylindrical_gears_compound_stability_analysis(self) -> 'List[_3893.CylindricalGearCompoundStabilityAnalysis]':
    ...
    @property
    def cylindrical_meshes_compound_stability_analysis(self) -> 'List[_3894.CylindricalGearMeshCompoundStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3763.CylindricalGearSetStabilityAnalysis]':
