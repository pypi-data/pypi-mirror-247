...
class ShaftCompoundStabilityAnalysis(_3847.AbstractShaftCompoundStabilityAnalysis):
    """ShaftCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3811.ShaftStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3811.ShaftStabilityAnalysis]':
