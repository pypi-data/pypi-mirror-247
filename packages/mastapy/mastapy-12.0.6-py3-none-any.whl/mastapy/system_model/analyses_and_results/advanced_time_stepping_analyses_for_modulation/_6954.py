...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _6952, _6953, _6959
...
class BevelDifferentialGearSetAdvancedTimeSteppingAnalysisForModulation(_6959.BevelGearSetAdvancedTimeSteppingAnalysisForModulation):
    """BevelDifferentialGearSetAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def bevel_differential_gears_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_6952.BevelDifferentialGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def bevel_differential_meshes_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_6953.BevelDifferentialGearMeshAdvancedTimeSteppingAnalysisForModulation]':
