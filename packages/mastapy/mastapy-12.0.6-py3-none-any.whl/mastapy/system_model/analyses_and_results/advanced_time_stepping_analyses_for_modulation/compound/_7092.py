...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _6962
...
class ClutchCompoundAdvancedTimeSteppingAnalysisForModulation(_7108.CouplingCompoundAdvancedTimeSteppingAnalysisForModulation):
    """ClutchCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6962.ClutchAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6962.ClutchAdvancedTimeSteppingAnalysisForModulation]':
