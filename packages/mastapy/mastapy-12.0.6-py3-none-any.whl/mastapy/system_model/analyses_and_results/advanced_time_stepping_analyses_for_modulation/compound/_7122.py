...
class DatumCompoundAdvancedTimeSteppingAnalysisForModulation(_7096.ComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    """DatumCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6992.DatumAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6992.DatumAdvancedTimeSteppingAnalysisForModulation]':
