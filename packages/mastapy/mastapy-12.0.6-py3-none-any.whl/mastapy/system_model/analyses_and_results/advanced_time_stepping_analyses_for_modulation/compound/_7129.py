...
class GearCompoundAdvancedTimeSteppingAnalysisForModulation(_7148.MountableComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    """GearCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6999.GearAdvancedTimeSteppingAnalysisForModulation]':
        """List[GearAdvancedTimeSteppingAnalysisForModulation]: 'ComponentAnalysisCases' is the original name of this property.
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6999.GearAdvancedTimeSteppingAnalysisForModulation]':
        """List[GearAdvancedTimeSteppingAnalysisForModulation]: 'ComponentAnalysisCasesReady' is the original name of this property.
