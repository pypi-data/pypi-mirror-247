...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _7065, _7066, _7001
...
class WormGearSetAdvancedTimeSteppingAnalysisForModulation(_7001.GearSetAdvancedTimeSteppingAnalysisForModulation):
    """WormGearSetAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def worm_gears_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7065.WormGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def worm_meshes_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7066.WormGearMeshAdvancedTimeSteppingAnalysisForModulation]':
