...
from mastapy.system_model.analyses_and_results.system_deflections import _2648, _2751
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import (
    _6949, _6951, _6954, _6961,
    _6960, _6981, _6962, _6967,
    _6972, _6984, _6985, _6990,
    _6997, _6996, _6998, _7006,
    _7013, _7016, _7017, _7018,
    _7020, _7022, _7027, _7028,
    _7029, _7031, _7034, _7038,
    _7037, _7043, _7044, _7049,
    _7052, _7055, _7059, _7063,
    _7067, _7070, _6937
)
...
class AssemblyAdvancedTimeSteppingAnalysisForModulation(_6937.AbstractAssemblyAdvancedTimeSteppingAnalysisForModulation):
    """AssemblyAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2648.AssemblySystemDeflection':
    ...
    @property
    def bearings(self) -> 'List[_6949.BearingAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def belt_drives(self) -> 'List[_6951.BeltDriveAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_6954.BevelDifferentialGearSetAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def bolted_joints(self) -> 'List[_6961.BoltedJointAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def bolts(self) -> 'List[_6960.BoltAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def cv_ts(self) -> 'List[_6981.CVTAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def clutches(self) -> 'List[_6962.ClutchAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def concept_couplings(self) -> 'List[_6967.ConceptCouplingAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_6972.ConceptGearSetAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_6984.CycloidalAssemblyAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_6985.CycloidalDiscAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_6990.CylindricalGearSetAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def fe_parts(self) -> 'List[_6997.FEPartAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_6996.FaceGearSetAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_6998.FlexiblePinAssemblyAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_7006.HypoidGearSetAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_7013.KlingelnbergCycloPalloidHypoidGearSetAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_7016.KlingelnbergCycloPalloidSpiralBevelGearSetAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def mass_discs(self) -> 'List[_7017.MassDiscAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def measurement_components(self) -> 'List[_7018.MeasurementComponentAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def oil_seals(self) -> 'List[_7020.OilSealAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_7022.PartToPartShearCouplingAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def planet_carriers(self) -> 'List[_7027.PlanetCarrierAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def point_loads(self) -> 'List[_7028.PointLoadAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def power_loads(self) -> 'List[_7029.PowerLoadAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def ring_pins(self) -> 'List[_7031.RingPinsAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_7034.RollingRingAssemblyAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_7038.ShaftHubConnectionAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def shafts(self) -> 'List[_7037.ShaftAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_7043.SpiralBevelGearSetAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def spring_dampers(self) -> 'List[_7044.SpringDamperAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_7049.StraightBevelDiffGearSetAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_7052.StraightBevelGearSetAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def synchronisers(self) -> 'List[_7055.SynchroniserAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def torque_converters(self) -> 'List[_7059.TorqueConverterAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_7063.UnbalancedMassAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_7067.WormGearSetAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_7070.ZerolBevelGearSetAdvancedTimeSteppingAnalysisForModulation]':
