...
class StraightBevelGearMeshSystemDeflection(_2657.BevelGearMeshSystemDeflection):
    """StraightBevelGearMeshSystemDeflection
    ...
    @property
    def rating(self) -> '_389.StraightBevelGearMeshRating':
    ...
    @property
    def power_flow_results(self) -> '_4092.StraightBevelGearMeshPowerFlow':
