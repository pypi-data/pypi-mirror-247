...
class TorqueConverterPumpCompoundSystemDeflection(_2841.CouplingHalfCompoundSystemDeflection):
    """TorqueConverterPumpCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2780.TorqueConverterPumpSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2780.TorqueConverterPumpSystemDeflection]':
