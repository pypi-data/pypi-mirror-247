...
class FaceGearCompoundSystemDeflection(_2861.GearCompoundSystemDeflection):
    """FaceGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2707.FaceGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2707.FaceGearSystemDeflection]':
