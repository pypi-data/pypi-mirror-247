...
class BeltDriveCompoundSystemDeflection(_2902.SpecialisedAssemblyCompoundSystemDeflection):
    """BeltDriveCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2651.BeltDriveSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2651.BeltDriveSystemDeflection]':
