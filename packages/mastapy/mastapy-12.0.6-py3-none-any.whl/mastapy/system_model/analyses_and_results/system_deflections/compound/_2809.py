...
from mastapy.system_model.analyses_and_results.system_deflections.compound import (
    _2810, _2812, _2815, _2822,
    _2821, _2843, _2823, _2828,
    _2833, _2845, _2847, _2851,
    _2859, _2858, _2860, _2867,
    _2874, _2877, _2878, _2879,
    _2881, _2883, _2888, _2889,
    _2890, _2892, _2894, _2900,
    _2898, _2905, _2906, _2911,
    _2914, _2917, _2921, _2925,
    _2929, _2932, _2802
)
...
class AssemblyCompoundSystemDeflection(_2802.AbstractAssemblyCompoundSystemDeflection):
    """AssemblyCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2648.AssemblySystemDeflection]':
    ...
    @property
    def bearings(self) -> 'List[_2810.BearingCompoundSystemDeflection]':
    ...
    @property
    def belt_drives(self) -> 'List[_2812.BeltDriveCompoundSystemDeflection]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_2815.BevelDifferentialGearSetCompoundSystemDeflection]':
    ...
    @property
    def bolted_joints(self) -> 'List[_2822.BoltedJointCompoundSystemDeflection]':
    ...
    @property
    def bolts(self) -> 'List[_2821.BoltCompoundSystemDeflection]':
    ...
    @property
    def cv_ts(self) -> 'List[_2843.CVTCompoundSystemDeflection]':
    ...
    @property
    def clutches(self) -> 'List[_2823.ClutchCompoundSystemDeflection]':
    ...
    @property
    def concept_couplings(self) -> 'List[_2828.ConceptCouplingCompoundSystemDeflection]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_2833.ConceptGearSetCompoundSystemDeflection]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_2845.CycloidalAssemblyCompoundSystemDeflection]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_2847.CycloidalDiscCompoundSystemDeflection]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_2851.CylindricalGearSetCompoundSystemDeflection]':
    ...
    @property
    def fe_parts(self) -> 'List[_2859.FEPartCompoundSystemDeflection]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_2858.FaceGearSetCompoundSystemDeflection]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_2860.FlexiblePinAssemblyCompoundSystemDeflection]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_2867.HypoidGearSetCompoundSystemDeflection]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_2874.KlingelnbergCycloPalloidHypoidGearSetCompoundSystemDeflection]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_2877.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundSystemDeflection]':
    ...
    @property
    def mass_discs(self) -> 'List[_2878.MassDiscCompoundSystemDeflection]':
    ...
    @property
    def measurement_components(self) -> 'List[_2879.MeasurementComponentCompoundSystemDeflection]':
    ...
    @property
    def oil_seals(self) -> 'List[_2881.OilSealCompoundSystemDeflection]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_2883.PartToPartShearCouplingCompoundSystemDeflection]':
    ...
    @property
    def planet_carriers(self) -> 'List[_2888.PlanetCarrierCompoundSystemDeflection]':
    ...
    @property
    def point_loads(self) -> 'List[_2889.PointLoadCompoundSystemDeflection]':
    ...
    @property
    def power_loads(self) -> 'List[_2890.PowerLoadCompoundSystemDeflection]':
    ...
    @property
    def ring_pins(self) -> 'List[_2892.RingPinsCompoundSystemDeflection]':
    ...
    @property
    def rolling_bearings(self) -> 'List[_2810.BearingCompoundSystemDeflection]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_2894.RollingRingAssemblyCompoundSystemDeflection]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_2900.ShaftHubConnectionCompoundSystemDeflection]':
    ...
    @property
    def shafts(self) -> 'List[_2898.ShaftCompoundSystemDeflection]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_2905.SpiralBevelGearSetCompoundSystemDeflection]':
    ...
    @property
    def spring_dampers(self) -> 'List[_2906.SpringDamperCompoundSystemDeflection]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_2911.StraightBevelDiffGearSetCompoundSystemDeflection]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_2914.StraightBevelGearSetCompoundSystemDeflection]':
    ...
    @property
    def synchronisers(self) -> 'List[_2917.SynchroniserCompoundSystemDeflection]':
    ...
    @property
    def torque_converters(self) -> 'List[_2921.TorqueConverterCompoundSystemDeflection]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_2925.UnbalancedMassCompoundSystemDeflection]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_2929.WormGearSetCompoundSystemDeflection]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_2932.ZerolBevelGearSetCompoundSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2648.AssemblySystemDeflection]':
