...
class ConnectorCompoundSystemDeflection(_2880.MountableComponentCompoundSystemDeflection):
    """ConnectorCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2679.ConnectorSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2679.ConnectorSystemDeflection]':
