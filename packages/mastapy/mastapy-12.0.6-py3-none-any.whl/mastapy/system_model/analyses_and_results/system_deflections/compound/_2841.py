...
class CouplingHalfCompoundSystemDeflection(_2880.MountableComponentCompoundSystemDeflection):
    """CouplingHalfCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2681.CouplingHalfSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2681.CouplingHalfSystemDeflection]':
