...
class PartToPartShearCouplingHalfCompoundSystemDeflection(_2841.CouplingHalfCompoundSystemDeflection):
    """PartToPartShearCouplingHalfCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2738.PartToPartShearCouplingHalfSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2738.PartToPartShearCouplingHalfSystemDeflection]':
