...
from mastapy.utility_gui.charts import _1820
...
class FlexibleGearChart(_0.APIBase):
    ...
    def planets(self) -> 'list_with_selected_item.ListWithSelectedItem_CylindricalGearSystemDeflection':
        ...
        return constructor.new_from_mastapy_type(list_with_selected_item.ListWithSelectedItem_CylindricalGearSystemDeflection)(temp) if temp is not None else None
    ...
    @property
    def chart(self) -> '_1820.LegacyChartMathChartDefinition':
        """LegacyChartMathChartDefinition: 'Chart' is the original name of this property.
