...
class VirtualComponentSystemDeflection(_2733.MountableComponentSystemDeflection):
    """VirtualComponentSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4107.VirtualComponentPowerFlow':
