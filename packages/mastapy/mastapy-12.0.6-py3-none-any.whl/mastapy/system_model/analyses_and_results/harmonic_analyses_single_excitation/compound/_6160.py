...
class PowerLoadCompoundHarmonicAnalysisOfSingleExcitation(_6195.VirtualComponentCompoundHarmonicAnalysisOfSingleExcitation):
    """PowerLoadCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6031.PowerLoadHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6031.PowerLoadHarmonicAnalysisOfSingleExcitation]':
