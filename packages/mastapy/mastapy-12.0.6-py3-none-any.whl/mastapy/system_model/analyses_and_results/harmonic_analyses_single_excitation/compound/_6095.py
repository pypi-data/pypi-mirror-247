...
class ClutchConnectionCompoundHarmonicAnalysisOfSingleExcitation(_6111.CouplingConnectionCompoundHarmonicAnalysisOfSingleExcitation):
    """ClutchConnectionCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5964.ClutchConnectionHarmonicAnalysisOfSingleExcitation]':
        """List[ClutchConnectionHarmonicAnalysisOfSingleExcitation]: 'ConnectionAnalysisCasesReady' is the original name of this property.
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5964.ClutchConnectionHarmonicAnalysisOfSingleExcitation]':
        """List[ClutchConnectionHarmonicAnalysisOfSingleExcitation]: 'ConnectionAnalysisCases' is the original name of this property.
