...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6320, _6321, _6229
...
class StraightBevelGearSetDynamicAnalysis(_6229.BevelGearSetDynamicAnalysis):
    """StraightBevelGearSetDynamicAnalysis
    ...
    @property
    def straight_bevel_gears_dynamic_analysis(self) -> 'List[_6320.StraightBevelGearDynamicAnalysis]':
    ...
    @property
    def straight_bevel_meshes_dynamic_analysis(self) -> 'List[_6321.StraightBevelGearMeshDynamicAnalysis]':
