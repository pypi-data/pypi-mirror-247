...
from mastapy.system_model.analyses_and_results.analysis_cases import _7470
...
class ConnectionDynamicAnalysis(_7470.ConnectionFEAnalysis):
    """ConnectionDynamicAnalysis
    ...
    @property
    def dynamic_analysis(self) -> '_2582.DynamicAnalysis':
        ...
        if _2582.DynamicAnalysis.TYPE not in temp.__class__.__mro__:
            raise CastException('Failed to cast dynamic_analysis to DynamicAnalysis. Expected: {}.'.format(temp.__class__.__qualname__))
