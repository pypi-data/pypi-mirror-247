...
class CylindricalGearMeshCompoundDynamicAnalysis(_6400.GearMeshCompoundDynamicAnalysis):
    """CylindricalGearMeshCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6259.CylindricalGearMeshDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6259.CylindricalGearMeshDynamicAnalysis]':
