...
class CVTPulleyCompoundDynamicAnalysis(_6429.PulleyCompoundDynamicAnalysis):
    """CVTPulleyCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6253.CVTPulleyDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6253.CVTPulleyDynamicAnalysis]':
