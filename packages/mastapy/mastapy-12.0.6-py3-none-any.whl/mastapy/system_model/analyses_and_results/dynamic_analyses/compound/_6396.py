...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6394, _6395, _6401
...
class FaceGearSetCompoundDynamicAnalysis(_6401.GearSetCompoundDynamicAnalysis):
    """FaceGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6267.FaceGearSetDynamicAnalysis]':
    ...
    @property
    def face_gears_compound_dynamic_analysis(self) -> 'List[_6394.FaceGearCompoundDynamicAnalysis]':
    ...
    @property
    def face_meshes_compound_dynamic_analysis(self) -> 'List[_6395.FaceGearMeshCompoundDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6267.FaceGearSetDynamicAnalysis]':
