...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import (
    _6349, _6351, _6354, _6361,
    _6360, _6382, _6362, _6367,
    _6372, _6384, _6386, _6390,
    _6397, _6396, _6398, _6405,
    _6412, _6415, _6416, _6417,
    _6419, _6421, _6426, _6427,
    _6428, _6430, _6432, _6437,
    _6436, _6442, _6443, _6448,
    _6451, _6454, _6458, _6462,
    _6466, _6469, _6341
)
...
class AssemblyCompoundDynamicAnalysis(_6341.AbstractAssemblyCompoundDynamicAnalysis):
    """AssemblyCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6218.AssemblyDynamicAnalysis]':
    ...
    @property
    def bearings(self) -> 'List[_6349.BearingCompoundDynamicAnalysis]':
    ...
    @property
    def belt_drives(self) -> 'List[_6351.BeltDriveCompoundDynamicAnalysis]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_6354.BevelDifferentialGearSetCompoundDynamicAnalysis]':
    ...
    @property
    def bolted_joints(self) -> 'List[_6361.BoltedJointCompoundDynamicAnalysis]':
    ...
    @property
    def bolts(self) -> 'List[_6360.BoltCompoundDynamicAnalysis]':
    ...
    @property
    def cv_ts(self) -> 'List[_6382.CVTCompoundDynamicAnalysis]':
    ...
    @property
    def clutches(self) -> 'List[_6362.ClutchCompoundDynamicAnalysis]':
    ...
    @property
    def concept_couplings(self) -> 'List[_6367.ConceptCouplingCompoundDynamicAnalysis]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_6372.ConceptGearSetCompoundDynamicAnalysis]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_6384.CycloidalAssemblyCompoundDynamicAnalysis]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_6386.CycloidalDiscCompoundDynamicAnalysis]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_6390.CylindricalGearSetCompoundDynamicAnalysis]':
    ...
    @property
    def fe_parts(self) -> 'List[_6397.FEPartCompoundDynamicAnalysis]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_6396.FaceGearSetCompoundDynamicAnalysis]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_6398.FlexiblePinAssemblyCompoundDynamicAnalysis]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_6405.HypoidGearSetCompoundDynamicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_6412.KlingelnbergCycloPalloidHypoidGearSetCompoundDynamicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_6415.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundDynamicAnalysis]':
    ...
    @property
    def mass_discs(self) -> 'List[_6416.MassDiscCompoundDynamicAnalysis]':
    ...
    @property
    def measurement_components(self) -> 'List[_6417.MeasurementComponentCompoundDynamicAnalysis]':
    ...
    @property
    def oil_seals(self) -> 'List[_6419.OilSealCompoundDynamicAnalysis]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_6421.PartToPartShearCouplingCompoundDynamicAnalysis]':
    ...
    @property
    def planet_carriers(self) -> 'List[_6426.PlanetCarrierCompoundDynamicAnalysis]':
    ...
    @property
    def point_loads(self) -> 'List[_6427.PointLoadCompoundDynamicAnalysis]':
    ...
    @property
    def power_loads(self) -> 'List[_6428.PowerLoadCompoundDynamicAnalysis]':
    ...
    @property
    def ring_pins(self) -> 'List[_6430.RingPinsCompoundDynamicAnalysis]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_6432.RollingRingAssemblyCompoundDynamicAnalysis]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_6437.ShaftHubConnectionCompoundDynamicAnalysis]':
    ...
    @property
    def shafts(self) -> 'List[_6436.ShaftCompoundDynamicAnalysis]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_6442.SpiralBevelGearSetCompoundDynamicAnalysis]':
    ...
    @property
    def spring_dampers(self) -> 'List[_6443.SpringDamperCompoundDynamicAnalysis]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_6448.StraightBevelDiffGearSetCompoundDynamicAnalysis]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_6451.StraightBevelGearSetCompoundDynamicAnalysis]':
    ...
    @property
    def synchronisers(self) -> 'List[_6454.SynchroniserCompoundDynamicAnalysis]':
    ...
    @property
    def torque_converters(self) -> 'List[_6458.TorqueConverterCompoundDynamicAnalysis]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_6462.UnbalancedMassCompoundDynamicAnalysis]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_6466.WormGearSetCompoundDynamicAnalysis]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_6469.ZerolBevelGearSetCompoundDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6218.AssemblyDynamicAnalysis]':
