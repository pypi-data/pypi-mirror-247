...
class ExternalCADModelCompoundDynamicAnalysis(_6366.ComponentCompoundDynamicAnalysis):
    """ExternalCADModelCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6264.ExternalCADModelDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6264.ExternalCADModelDynamicAnalysis]':
