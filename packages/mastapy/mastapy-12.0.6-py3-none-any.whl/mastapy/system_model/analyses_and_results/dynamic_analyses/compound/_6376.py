...
class ConnectionCompoundDynamicAnalysis(_7469.ConnectionCompoundAnalysis):
    """ConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6246.ConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6246.ConnectionDynamicAnalysis]':
