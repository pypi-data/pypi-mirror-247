...
class RingPinsToDiscConnectionCompoundDynamicAnalysis(_6406.InterMountableComponentConnectionCompoundDynamicAnalysis):
    """RingPinsToDiscConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6302.RingPinsToDiscConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6302.RingPinsToDiscConnectionDynamicAnalysis]':
