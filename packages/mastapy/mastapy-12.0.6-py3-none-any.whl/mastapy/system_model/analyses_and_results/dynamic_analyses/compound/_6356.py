...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6226
...
class BevelDifferentialSunGearCompoundDynamicAnalysis(_6352.BevelDifferentialGearCompoundDynamicAnalysis):
    """BevelDifferentialSunGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6226.BevelDifferentialSunGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6226.BevelDifferentialSunGearDynamicAnalysis]':
