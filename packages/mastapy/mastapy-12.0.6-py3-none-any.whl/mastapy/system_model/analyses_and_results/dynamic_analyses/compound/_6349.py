...
class BearingCompoundDynamicAnalysis(_6377.ConnectorCompoundDynamicAnalysis):
    """BearingCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6219.BearingDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6219.BearingDynamicAnalysis]':
