...
class ClutchConnectionCompoundDynamicAnalysis(_6379.CouplingConnectionCompoundDynamicAnalysis):
    """ClutchConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6232.ClutchConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6232.ClutchConnectionDynamicAnalysis]':
