...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6464, _6465, _6401
...
class WormGearSetCompoundDynamicAnalysis(_6401.GearSetCompoundDynamicAnalysis):
    """WormGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6337.WormGearSetDynamicAnalysis]':
    ...
    @property
    def worm_gears_compound_dynamic_analysis(self) -> 'List[_6464.WormGearCompoundDynamicAnalysis]':
    ...
    @property
    def worm_meshes_compound_dynamic_analysis(self) -> 'List[_6465.WormGearMeshCompoundDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6337.WormGearSetDynamicAnalysis]':
