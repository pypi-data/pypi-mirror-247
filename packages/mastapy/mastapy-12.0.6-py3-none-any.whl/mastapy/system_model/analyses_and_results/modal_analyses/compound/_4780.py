...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4778, _4779, _4691
...
class StraightBevelDiffGearSetCompoundModalAnalysis(_4691.BevelGearSetCompoundModalAnalysis):
    """StraightBevelDiffGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4636.StraightBevelDiffGearSetModalAnalysis]':
    ...
    @property
    def straight_bevel_diff_gears_compound_modal_analysis(self) -> 'List[_4778.StraightBevelDiffGearCompoundModalAnalysis]':
    ...
    @property
    def straight_bevel_diff_meshes_compound_modal_analysis(self) -> 'List[_4779.StraightBevelDiffGearMeshCompoundModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4636.StraightBevelDiffGearSetModalAnalysis]':
