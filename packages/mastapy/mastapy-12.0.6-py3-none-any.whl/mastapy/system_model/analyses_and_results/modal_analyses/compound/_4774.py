...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4772, _4773, _4691
...
class SpiralBevelGearSetCompoundModalAnalysis(_4691.BevelGearSetCompoundModalAnalysis):
    """SpiralBevelGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4630.SpiralBevelGearSetModalAnalysis]':
    ...
    @property
    def spiral_bevel_gears_compound_modal_analysis(self) -> 'List[_4772.SpiralBevelGearCompoundModalAnalysis]':
    ...
    @property
    def spiral_bevel_meshes_compound_modal_analysis(self) -> 'List[_4773.SpiralBevelGearMeshCompoundModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4630.SpiralBevelGearSetModalAnalysis]':
