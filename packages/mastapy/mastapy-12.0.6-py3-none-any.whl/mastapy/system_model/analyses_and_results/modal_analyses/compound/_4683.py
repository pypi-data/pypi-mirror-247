...
class BeltDriveCompoundModalAnalysis(_4771.SpecialisedAssemblyCompoundModalAnalysis):
    """BeltDriveCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4529.BeltDriveModalAnalysis]':
        """List[BeltDriveModalAnalysis]: 'AssemblyAnalysisCasesReady' is the original name of this property.
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4529.BeltDriveModalAnalysis]':
        """List[BeltDriveModalAnalysis]: 'AssemblyAnalysisCases' is the original name of this property.
