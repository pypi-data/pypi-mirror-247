...
class PulleyCompoundModalAnalysis(_4712.CouplingHalfCompoundModalAnalysis):
    """PulleyCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4616.PulleyModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4616.PulleyModalAnalysis]':
