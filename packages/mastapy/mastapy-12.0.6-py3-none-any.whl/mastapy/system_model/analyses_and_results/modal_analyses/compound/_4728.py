...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4726, _4727, _4733
...
class FaceGearSetCompoundModalAnalysis(_4733.GearSetCompoundModalAnalysis):
    """FaceGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4577.FaceGearSetModalAnalysis]':
    ...
    @property
    def face_gears_compound_modal_analysis(self) -> 'List[_4726.FaceGearCompoundModalAnalysis]':
    ...
    @property
    def face_meshes_compound_modal_analysis(self) -> 'List[_4727.FaceGearMeshCompoundModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4577.FaceGearSetModalAnalysis]':
