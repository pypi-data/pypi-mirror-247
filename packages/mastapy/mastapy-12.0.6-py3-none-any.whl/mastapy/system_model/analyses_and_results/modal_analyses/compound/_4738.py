...
class InterMountableComponentConnectionCompoundModalAnalysis(_4708.ConnectionCompoundModalAnalysis):
    """InterMountableComponentConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4588.InterMountableComponentConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4588.InterMountableComponentConnectionModalAnalysis]':
