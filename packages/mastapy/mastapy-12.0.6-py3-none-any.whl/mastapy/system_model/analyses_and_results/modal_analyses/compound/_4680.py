...
from mastapy.system_model.analyses_and_results.modal_analyses import _4526
from mastapy.system_model.analyses_and_results.modal_analyses.compound import (
    _4681, _4683, _4686, _4693,
    _4692, _4714, _4694, _4699,
    _4704, _4716, _4718, _4722,
    _4729, _4728, _4730, _4737,
    _4744, _4747, _4748, _4749,
    _4751, _4753, _4758, _4759,
    _4760, _4762, _4764, _4769,
    _4768, _4774, _4775, _4780,
...
class AssemblyCompoundModalAnalysis(_4673.AbstractAssemblyCompoundModalAnalysis):
    """AssemblyCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4526.AssemblyModalAnalysis]':
    ...
    @property
    def bearings(self) -> 'List[_4681.BearingCompoundModalAnalysis]':
    ...
    @property
    def belt_drives(self) -> 'List[_4683.BeltDriveCompoundModalAnalysis]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_4686.BevelDifferentialGearSetCompoundModalAnalysis]':
    ...
    @property
    def bolted_joints(self) -> 'List[_4693.BoltedJointCompoundModalAnalysis]':
    ...
    @property
    def bolts(self) -> 'List[_4692.BoltCompoundModalAnalysis]':
    ...
    @property
    def cv_ts(self) -> 'List[_4714.CVTCompoundModalAnalysis]':
    ...
    @property
    def clutches(self) -> 'List[_4694.ClutchCompoundModalAnalysis]':
    ...
    @property
    def concept_couplings(self) -> 'List[_4699.ConceptCouplingCompoundModalAnalysis]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_4704.ConceptGearSetCompoundModalAnalysis]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_4716.CycloidalAssemblyCompoundModalAnalysis]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_4718.CycloidalDiscCompoundModalAnalysis]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_4722.CylindricalGearSetCompoundModalAnalysis]':
    ...
    @property
    def fe_parts(self) -> 'List[_4729.FEPartCompoundModalAnalysis]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_4728.FaceGearSetCompoundModalAnalysis]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_4730.FlexiblePinAssemblyCompoundModalAnalysis]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_4737.HypoidGearSetCompoundModalAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_4744.KlingelnbergCycloPalloidHypoidGearSetCompoundModalAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_4747.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundModalAnalysis]':
    ...
    @property
    def mass_discs(self) -> 'List[_4748.MassDiscCompoundModalAnalysis]':
    ...
    @property
    def measurement_components(self) -> 'List[_4749.MeasurementComponentCompoundModalAnalysis]':
    ...
    @property
    def oil_seals(self) -> 'List[_4751.OilSealCompoundModalAnalysis]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_4753.PartToPartShearCouplingCompoundModalAnalysis]':
    ...
    @property
    def planet_carriers(self) -> 'List[_4758.PlanetCarrierCompoundModalAnalysis]':
    ...
    @property
    def point_loads(self) -> 'List[_4759.PointLoadCompoundModalAnalysis]':
    ...
    @property
    def power_loads(self) -> 'List[_4760.PowerLoadCompoundModalAnalysis]':
    ...
    @property
    def ring_pins(self) -> 'List[_4762.RingPinsCompoundModalAnalysis]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_4764.RollingRingAssemblyCompoundModalAnalysis]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_4769.ShaftHubConnectionCompoundModalAnalysis]':
    ...
    @property
    def shafts(self) -> 'List[_4768.ShaftCompoundModalAnalysis]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_4774.SpiralBevelGearSetCompoundModalAnalysis]':
    ...
    @property
    def spring_dampers(self) -> 'List[_4775.SpringDamperCompoundModalAnalysis]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_4780.StraightBevelDiffGearSetCompoundModalAnalysis]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_4783.StraightBevelGearSetCompoundModalAnalysis]':
    ...
    @property
    def synchronisers(self) -> 'List[_4786.SynchroniserCompoundModalAnalysis]':
    ...
    @property
    def torque_converters(self) -> 'List[_4790.TorqueConverterCompoundModalAnalysis]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_4794.UnbalancedMassCompoundModalAnalysis]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_4798.WormGearSetCompoundModalAnalysis]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_4801.ZerolBevelGearSetCompoundModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4526.AssemblyModalAnalysis]':
