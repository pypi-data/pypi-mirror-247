...
class DatumCompoundModalAnalysis(_4698.ComponentCompoundModalAnalysis):
    """DatumCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4571.DatumModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4571.DatumModalAnalysis]':
