...
class RollingRingConnectionCompoundModalAnalysis(_4738.InterMountableComponentConnectionCompoundModalAnalysis):
    """RollingRingConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4620.RollingRingConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4620.RollingRingConnectionModalAnalysis]':
