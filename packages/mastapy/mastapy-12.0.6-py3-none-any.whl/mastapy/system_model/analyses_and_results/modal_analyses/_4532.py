...
from mastapy.system_model.analyses_and_results.modal_analyses import _4531, _4530, _4537
...
class BevelDifferentialGearSetModalAnalysis(_4537.BevelGearSetModalAnalysis):
    """BevelDifferentialGearSetModalAnalysis
    ...
    @property
    def bevel_differential_gears_modal_analysis(self) -> 'List[_4531.BevelDifferentialGearModalAnalysis]':
    ...
    @property
    def bevel_differential_meshes_modal_analysis(self) -> 'List[_4530.BevelDifferentialGearMeshModalAnalysis]':
