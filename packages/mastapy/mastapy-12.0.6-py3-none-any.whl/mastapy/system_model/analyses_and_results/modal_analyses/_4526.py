...
from mastapy.system_model.analyses_and_results.modal_analyses import (
    _4527, _4529, _4532, _4538,
    _4539, _4561, _4542, _4547,
    _4550, _4563, _4565, _4569,
    _4578, _4577, _4579, _4587,
    _4594, _4597, _4598, _4599,
    _4605, _4610, _4613, _4614,
    _4615, _4617, _4619, _4623,
    _4624, _4630, _4633, _4636,
    _4639, _4643, _4647, _4650,
    _4657, _4660, _4519
)
from mastapy.system_model.analyses_and_results.modal_analyses.reporting import _4661
...
class AssemblyModalAnalysis(_4519.AbstractAssemblyModalAnalysis):
    """AssemblyModalAnalysis
    ...
    @property
    def bearings(self) -> 'List[_4527.BearingModalAnalysis]':
    ...
    @property
    def belt_drives(self) -> 'List[_4529.BeltDriveModalAnalysis]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_4532.BevelDifferentialGearSetModalAnalysis]':
    ...
    @property
    def bolted_joints(self) -> 'List[_4538.BoltedJointModalAnalysis]':
    ...
    @property
    def bolts(self) -> 'List[_4539.BoltModalAnalysis]':
    ...
    @property
    def cv_ts(self) -> 'List[_4561.CVTModalAnalysis]':
    ...
    @property
    def calculate_full_fe_results_by_mode(self) -> 'List[_4661.CalculateFullFEResultsForMode]':
    ...
    @property
    def clutches(self) -> 'List[_4542.ClutchModalAnalysis]':
    ...
    @property
    def concept_couplings(self) -> 'List[_4547.ConceptCouplingModalAnalysis]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_4550.ConceptGearSetModalAnalysis]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_4563.CycloidalAssemblyModalAnalysis]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_4565.CycloidalDiscModalAnalysis]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_4569.CylindricalGearSetModalAnalysis]':
    ...
    @property
    def fe_parts(self) -> 'List[_4578.FEPartModalAnalysis]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_4577.FaceGearSetModalAnalysis]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_4579.FlexiblePinAssemblyModalAnalysis]':
    ...
    @property
    def full_fe_meshes_for_calculating_modes(self) -> 'List[_4578.FEPartModalAnalysis]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_4587.HypoidGearSetModalAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_4594.KlingelnbergCycloPalloidHypoidGearSetModalAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_4597.KlingelnbergCycloPalloidSpiralBevelGearSetModalAnalysis]':
    ...
    @property
    def mass_discs(self) -> 'List[_4598.MassDiscModalAnalysis]':
    ...
    @property
    def measurement_components(self) -> 'List[_4599.MeasurementComponentModalAnalysis]':
    ...
    @property
    def oil_seals(self) -> 'List[_4605.OilSealModalAnalysis]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_4610.PartToPartShearCouplingModalAnalysis]':
    ...
    @property
    def planet_carriers(self) -> 'List[_4613.PlanetCarrierModalAnalysis]':
    ...
    @property
    def point_loads(self) -> 'List[_4614.PointLoadModalAnalysis]':
    ...
    @property
    def power_loads(self) -> 'List[_4615.PowerLoadModalAnalysis]':
    ...
    @property
    def ring_pins(self) -> 'List[_4617.RingPinsModalAnalysis]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_4619.RollingRingAssemblyModalAnalysis]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_4623.ShaftHubConnectionModalAnalysis]':
    ...
    @property
    def shafts(self) -> 'List[_4624.ShaftModalAnalysis]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_4630.SpiralBevelGearSetModalAnalysis]':
    ...
    @property
    def spring_dampers(self) -> 'List[_4633.SpringDamperModalAnalysis]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_4636.StraightBevelDiffGearSetModalAnalysis]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_4639.StraightBevelGearSetModalAnalysis]':
    ...
    @property
    def synchronisers(self) -> 'List[_4643.SynchroniserModalAnalysis]':
    ...
    @property
    def torque_converters(self) -> 'List[_4647.TorqueConverterModalAnalysis]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_4650.UnbalancedMassModalAnalysis]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_4657.WormGearSetModalAnalysis]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_4660.ZerolBevelGearSetModalAnalysis]':
