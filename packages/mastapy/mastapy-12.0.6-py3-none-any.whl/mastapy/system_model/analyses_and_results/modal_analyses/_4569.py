...
from mastapy.system_model.analyses_and_results.modal_analyses import _4568, _4567, _4583
...
class CylindricalGearSetModalAnalysis(_4583.GearSetModalAnalysis):
    """CylindricalGearSetModalAnalysis
    ...
    @property
    def cylindrical_gears_modal_analysis(self) -> 'List[_4568.CylindricalGearModalAnalysis]':
    ...
    @property
    def cylindrical_meshes_modal_analysis(self) -> 'List[_4567.CylindricalGearMeshModalAnalysis]':
