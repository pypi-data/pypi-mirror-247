...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3006, _3004, _3002
...
class KlingelnbergCycloPalloidHypoidGearSetSteadyStateSynchronousResponse(_3002.KlingelnbergCycloPalloidConicalGearSetSteadyStateSynchronousResponse):
    """KlingelnbergCycloPalloidHypoidGearSetSteadyStateSynchronousResponse
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_steady_state_synchronous_response(self) -> 'List[_3006.KlingelnbergCycloPalloidHypoidGearSteadyStateSynchronousResponse]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_steady_state_synchronous_response(self) -> 'List[_3004.KlingelnbergCycloPalloidHypoidGearMeshSteadyStateSynchronousResponse]':
