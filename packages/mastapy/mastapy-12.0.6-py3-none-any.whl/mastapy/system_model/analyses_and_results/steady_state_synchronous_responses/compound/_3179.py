...
class StraightBevelSunGearCompoundSteadyStateSynchronousResponse(_3172.StraightBevelDiffGearCompoundSteadyStateSynchronousResponse):
    """StraightBevelSunGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3050.StraightBevelSunGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3050.StraightBevelSunGearSteadyStateSynchronousResponse]':
