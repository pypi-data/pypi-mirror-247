...
class ConceptCouplingCompoundSteadyStateSynchronousResponse(_3104.CouplingCompoundSteadyStateSynchronousResponse):
    """ConceptCouplingCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2962.ConceptCouplingSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2962.ConceptCouplingSteadyStateSynchronousResponse]':
