...
class ClockDivider(_ods_ir.OpView):
  OPERATION_NAME = "seq.clock_div"

  _ODS_REGIONS = (0, True)

  def __init__(self, clockIn, pow2, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
    operands.append(_get_op_result_or_value(clockIn))
    _ods_context = _ods_get_default_loc_context(loc)
    attributes["pow2"] = (pow2 if (
    issubclass(type(pow2), _ods_ir.Attribute) or
    not _ods_ir.AttrBuilder.contains('I8Attr')) else
      _ods_ir.AttrBuilder.get('I8Attr')(pow2, context=_ods_context))
...
def clock_div(clock_in, pow2, *, loc=None, ip=None) -> _ods_ir.OpResult:
  return _get_op_result_or_op_results(ClockDivider(clockIn=clock_in, pow2=pow2, loc=loc, ip=ip))
...
def clock_gate(input, enable, *, test_enable=None, inner_sym=None, loc=None, ip=None) -> _ods_ir.OpResult:
  return _get_op_result_or_op_results(ClockGateOp(input=input, enable=enable, test_enable=test_enable, inner_sym=inner_sym, loc=loc, ip=ip))
...
class ClockMuxOp(_ods_ir.OpView):
  ...
  def __init__(self, cond, trueClock, falseClock, *, loc=None, ip=None):
    ...
    operands.append(_get_op_result_or_value(trueClock))
    operands.append(_get_op_result_or_value(falseClock))
    _ods_context = _ods_get_default_loc_context(loc)
    _ods_successors = None
    super().__init__(self.build_generic(attributes=attributes, operands=operands, successors=_ods_successors, regions=regions, loc=loc, ip=ip))
...
def clock_mux(cond, true_clock, false_clock, *, loc=None, ip=None) -> _ods_ir.OpResult:
  return _get_op_result_or_op_results(ClockMuxOp(cond=cond, trueClock=true_clock, falseClock=false_clock, loc=loc, ip=ip))
...
class CompRegClockEnabledOp(_ods_ir.OpView):
  ...
  def __init__(self, input, clk, clockEnable, *, name=None, reset=None, resetValue=None, powerOnValue=None, inner_sym=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
    ...
    operands.append(_get_op_result_or_value(reset) if reset is not None else None)
    operands.append(_get_op_result_or_value(resetValue) if resetValue is not None else None)
    operands.append(_get_op_result_or_value(powerOnValue) if powerOnValue is not None else None)
    _ods_context = _ods_get_default_loc_context(loc)
...
def compreg_ce(input, clk, clock_enable, *, name=None, reset=None, reset_value=None, power_on_value=None, inner_sym=None, loc=None, ip=None) -> _ods_ir.OpResult:
  return _get_op_result_or_op_results(CompRegClockEnabledOp(input=input, clk=clk, clockEnable=clock_enable, name=name, reset=reset, resetValue=reset_value, powerOnValue=power_on_value, inner_sym=inner_sym, loc=loc, ip=ip))
...
class CompRegOp(_ods_ir.OpView):
  ...
  def __init__(self, input, clk, *, name=None, reset=None, resetValue=None, powerOnValue=None, inner_sym=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def compreg(input, clk, *, name=None, reset=None, reset_value=None, power_on_value=None, inner_sym=None, loc=None, ip=None) -> _ods_ir.OpResult:
  return _get_op_result_or_op_results(CompRegOp(input=input, clk=clk, name=name, reset=reset, resetValue=reset_value, powerOnValue=power_on_value, inner_sym=inner_sym, loc=loc, ip=ip))
...
def const_clock(value, *, loc=None, ip=None) -> _ods_ir.OpResult:
  return _get_op_result_or_op_results(ConstClockOp(value=value, loc=loc, ip=ip))
...
def fifo(output, full, empty, almost_full, almost_empty, input, rd_en, wr_en, clk, rst, depth, *, almost_full_threshold=None, almost_empty_threshold=None, loc=None, ip=None) -> _Sequence[_ods_ir.OpResult]:
  return _get_op_result_or_op_results(FIFOOp(output=output, full=full, empty=empty, almostFull=almost_full, almostEmpty=almost_empty, input=input, rdEn=rd_en, wrEn=wr_en, clk=clk, rst=rst, depth=depth, almostFullThreshold=almost_full_threshold, almostEmptyThreshold=almost_empty_threshold, loc=loc, ip=ip))
...
def firmem(memory, read_latency, write_latency, ruw, wuw, *, name=None, inner_sym=None, init=None, prefix=None, output_file=None, loc=None, ip=None) -> _ods_ir.OpResult:
  return _get_op_result_or_op_results(FirMemOp(memory=memory, readLatency=read_latency, writeLatency=write_latency, ruw=ruw, wuw=wuw, name=name, inner_sym=inner_sym, init=init, prefix=prefix, output_file=output_file, loc=loc, ip=ip))
...
def firmem_read_port(memory, address, clock, *, enable=None, loc=None, ip=None) -> _ods_ir.OpResult:
  return _get_op_result_or_op_results(FirMemReadOp(memory=memory, address=address, clock=clock, enable=enable, loc=loc, ip=ip))
...
def firmem_read_write_port(memory, address, clock, write_data, mode, *, enable=None, mask=None, loc=None, ip=None) -> _ods_ir.OpResult:
  return _get_op_result_or_op_results(FirMemReadWriteOp(memory=memory, address=address, clock=clock, writeData=write_data, mode=mode, enable=enable, mask=mask, loc=loc, ip=ip))
...
def firmem_write_port(memory, address, clock, data, *, enable=None, mask=None, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(FirMemWriteOp(memory=memory, address=address, clock=clock, data=data, enable=enable, mask=mask, loc=loc, ip=ip))
...
class FirRegOp(_ods_ir.OpView):
  ...
  def __init__(self, next, clk, name, *, inner_sym=None, preset=None, reset=None, resetValue=None, isAsync=None, loc=None, ip=None):
    ...
    attributes = {}
    regions = None
    operands.append(_get_op_result_or_value(next))
    operands.append(_get_op_result_or_value(clk))
    ...
    if preset is not None: attributes["preset"] = (preset if (
        issubclass(type(preset), _ods_ir.Attribute) or
...
def firreg(next, clk, name, *, inner_sym=None, preset=None, reset=None, reset_value=None, is_async=None, loc=None, ip=None) -> _ods_ir.OpResult:
  return _get_op_result_or_op_results(FirRegOp(next=next, clk=clk, name=name, inner_sym=inner_sym, preset=preset, reset=reset, resetValue=reset_value, isAsync=is_async, loc=loc, ip=ip))
...
def from_clock(input, *, loc=None, ip=None) -> _ods_ir.OpResult:
  return _get_op_result_or_op_results(FromClockOp(input=input, loc=loc, ip=ip))
...
def hlmem(handle, clk, rst, sym_name, *, loc=None, ip=None) -> _ods_ir.OpResult:
  return _get_op_result_or_op_results(HLMemOp(handle=handle, clk=clk, rst=rst, sym_name=sym_name, loc=loc, ip=ip))
...
def read(read_data, memory, addresses, latency, *, rd_en=None, loc=None, ip=None) -> _ods_ir.OpResult:
  return _get_op_result_or_op_results(ReadPortOp(readData=read_data, memory=memory, addresses=addresses, latency=latency, rdEn=rd_en, loc=loc, ip=ip))
...
def to_clock(input, *, loc=None, ip=None) -> _ods_ir.OpResult:
  return _get_op_result_or_op_results(ToClockOp(input=input, loc=loc, ip=ip))
...
def write(memory, addresses, in_data, wr_en, latency, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(WritePortOp(memory=memory, addresses=addresses, inData=in_data, wrEn=wr_en, latency=latency, loc=loc, ip=ip))
