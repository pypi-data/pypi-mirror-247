...
class AppIDHierNodeOp(_ods_ir.OpView):
  ...
  def __init__(self, appID, moduleRef, *, loc=None, ip=None):
    ...
    issubclass(type(appID), _ods_ir.Attribute) or
    ...
    issubclass(type(moduleRef), _ods_ir.Attribute) or
...
class CompressedManifestOp(_ods_ir.OpView):
  ...
  def __init__(self, compressedManifest, *, loc=None, ip=None):
    ...
    issubclass(type(compressedManifest), _ods_ir.Attribute) or
...
class CosimFromHostEndpointOp(_ods_ir.OpView):
  ...
  def __init__(self, fromHost, clk, rst, name, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def cosim_from_host(from_host, clk, rst, name, *, loc=None, ip=None) -> _ods_ir.OpResult:
  return _get_op_result_or_op_results(CosimFromHostEndpointOp(fromHost=from_host, clk=clk, rst=rst, name=name, loc=loc, ip=ip))
...
class CosimToHostEndpointOp(_ods_ir.OpView):
  ...
  def __init__(self, clk, rst, toHost, name, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def cosim_to_host(clk, rst, to_host, name, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(CosimToHostEndpointOp(clk=clk, rst=rst, toHost=to_host, name=name, loc=loc, ip=ip))
...
def bundle_pack(bundle, from_channels, to_channels, *, loc=None, ip=None) -> _Sequence[_ods_ir.OpResult]:
...
def stage(output, clk, rst, input, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def service_req_to_client(to_client, service_port, app_id, *, loc=None, ip=None) -> _ods_ir.OpResult:
  return _get_op_result_or_op_results(RequestToClientConnectionOp(toClient=to_client, servicePort=service_port, appID=app_id, loc=loc, ip=ip))
...
class RequestToServerConnectionOp(_ods_ir.OpView):
  ...
  def __init__(self, servicePort, toServer, appID, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def service_req_to_server(service_port, to_server, app_id, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(RequestToServerConnectionOp(servicePort=service_port, toServer=to_server, appID=app_id, loc=loc, ip=ip))
...
class ServiceImplClientRecordOp(_ods_ir.OpView):
  ...
  def __init__(self, relAppIDPath, servicePort, bundleType, implDetails, *, loc=None, ip=None):
    ...
    issubclass(type(relAppIDPath), _ods_ir.Attribute) or
    ...
    issubclass(type(bundleType), _ods_ir.Attribute) or
    ...
    issubclass(type(implDetails), _ods_ir.Attribute) or
...
class ServiceImplRecordOp(_ods_ir.OpView):
  ...
  def __init__(self, appID, serviceImplName, implDetails, *, service=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def manifest_service_impl(app_id, service_impl_name, impl_details, *, service=None, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(ServiceImplRecordOp(appID=app_id, serviceImplName=service_impl_name, implDetails=impl_details, service=service, loc=loc, ip=ip))
...
class ServiceImplementConnReqOp(_ods_ir.OpView):
  ...
  def __init__(self, toClient, servicePort, relativeAppIDPath, *, loc=None, ip=None):
    ...
    issubclass(type(relativeAppIDPath), _ods_ir.Attribute) or
    not _ods_ir.AttrBuilder.contains('AppIDArrayAttr')) else
...
class ServiceImplementReqOp(_ods_ir.OpView):
  ...
  def __init__(self, outputs, appID, impl_type, inputs, *, service_symbol=None, impl_opts=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def service_impl_req(outputs, app_id, impl_type, inputs, *, service_symbol=None, impl_opts=None, loc=None, ip=None) -> _ods_ir.OpResult:
  return _get_op_result_or_op_results(ServiceImplementReqOp(outputs=outputs, appID=app_id, impl_type=impl_type, inputs=inputs, service_symbol=service_symbol, impl_opts=impl_opts, loc=loc, ip=ip))
...
def service_instance(result, app_id, impl_type, inputs, *, service_symbol=None, impl_opts=None, loc=None, ip=None) -> _ods_ir.OpResult:
...
class ServiceRequestRecordOp(_ods_ir.OpView):
  ...
  def __init__(self, requestor, servicePort, direction, bundleType, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
    ...
    issubclass(type(requestor), _ods_ir.Attribute) or
    not _ods_ir.AttrBuilder.contains('AppIDAttr')) else
    ...
    not _ods_ir.AttrBuilder.contains('BundleDirection')) else
      _ods_ir.AttrBuilder.get('BundleDirection')(direction, context=_ods_context))
    attributes["bundleType"] = (bundleType if (
    issubclass(type(bundleType), _ods_ir.Attribute) or
    not _ods_ir.AttrBuilder.contains('anonymous_446')) else
      _ods_ir.AttrBuilder.get('anonymous_446')(bundleType, context=_ods_context))
...
def manifest_req(requestor, service_port, direction, bundle_type, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(ServiceRequestRecordOp(requestor=requestor, servicePort=service_port, direction=direction, bundleType=bundle_type, loc=loc, ip=ip))
...
class SymbolMetadataOp(_ods_ir.OpView):
  ...
  def __init__(self, symbolRef, *, name=None, repo=None, commitHash=None, version=None, summary=None, loc=None, ip=None):
    ...
    issubclass(type(symbolRef), _ods_ir.Attribute) or
    not _ods_ir.AttrBuilder.contains('FlatSymbolRefAttr')) else
    ...
    if summary is not None: attributes["summary"] = (summary if (
        issubclass(type(summary), _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('StrAttr')) else
...
def service_to_client(inner_sym, to_client_type, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(ToClientOp(inner_sym=inner_sym, toClientType=to_client_type, loc=loc, ip=ip))
...
class ToServerOp(_ods_ir.OpView):
  ...
  def __init__(self, inner_sym, toServerType, *, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_446')) else
      _ods_ir.AttrBuilder.get('anonymous_446')(toServerType, context=_ods_context))
    _ods_successors = None
    super().__init__(self.build_generic(attributes=attributes, results=results, operands=operands, successors=_ods_successors, regions=regions, loc=loc, ip=ip))
...
def service_to_server(inner_sym, to_server_type, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(ToServerOp(inner_sym=inner_sym, toServerType=to_server_type, loc=loc, ip=ip))
...
def bundle_unpack(to_channels, bundle, from_channels, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def unwrap_fifo(chan_input, rden, *, loc=None, ip=None) -> _Sequence[_ods_ir.OpResult]:
...
def unwrap_vr(raw_output, valid, chan_input, ready, *, loc=None, ip=None) -> _Sequence[_ods_ir.OpResult]:
...
def window_unwrap(window, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def wrap_fifo(chan_output, rden, data, empty, *, loc=None, ip=None) -> _Sequence[_ods_ir.OpResult]:
...
def wrap_vr(chan_output, ready, raw_input, valid, *, loc=None, ip=None) -> _Sequence[_ods_ir.OpResult]:
