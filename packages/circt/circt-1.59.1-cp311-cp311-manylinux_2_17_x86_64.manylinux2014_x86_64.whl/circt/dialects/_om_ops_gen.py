...
def any_cast(input, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def basepath_create(base_path, target, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def class_extern_field(sym_name, type_, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(ClassExternFieldOp(sym_name=sym_name, type_=type_, loc=loc, ip=ip))
...
def class_field(sym_name, value, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(ClassFieldOp(sym_name=sym_name, value=value, loc=loc, ip=ip))
...
def constant(value, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def path_empty(*, loc=None, ip=None) -> _ods_ir.OpResult:
...
def frozenbasepath_create(base_path, path, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def frozenpath_empty(*, loc=None, ip=None) -> _ods_ir.OpResult:
...
def frozenpath_create(target_kind, base_path, path, module, ref, field, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def map_create(result, inputs, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def path_create(target_kind, base_path, target, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def tuple_create(inputs, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def tuple_get(input, index, *, loc=None, ip=None) -> _ods_ir.OpResult:
