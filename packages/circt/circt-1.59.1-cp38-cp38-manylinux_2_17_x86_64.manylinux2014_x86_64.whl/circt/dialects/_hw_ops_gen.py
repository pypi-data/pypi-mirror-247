...
def array_get(input, index, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def enum_cmp(lhs, rhs, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
class HWModuleExternOp(_ods_ir.OpView):
  ...
  def __init__(self, sym_name, module_type, parameters, *, per_port_attrs=None, port_locs=None, verilogName=None, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_568')) else
      _ods_ir.AttrBuilder.get('anonymous_568')(module_type, context=_ods_context))
...
def instance(results_, instance_name, module_name, inputs, arg_names, result_names, parameters, *, inner_sym=None, loc=None, ip=None) -> _ods_ir.OpResult:
...
def param_value(value, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def struct_explode(result, input, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def struct_inject(input, field_index, new_value, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def union_extract(input, field_index, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def wire(input, *, name=None, inner_sym=None, loc=None, ip=None) -> _ods_ir.OpResult:
