...
def format_verilog_string(format_string, substitutions, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def has_been_reset(clock, reset, async_, *, loc=None, ip=None) -> _ods_ir.OpResult:
