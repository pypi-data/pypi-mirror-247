...
def add(inputs, *, two_state=None, loc=None, ip=None) -> _ods_ir.OpResult:
  return _get_op_result_or_op_results(AddOp(inputs=inputs, twoState=two_state, loc=loc, ip=ip))
...
def and_(inputs, *, two_state=None, loc=None, ip=None) -> _ods_ir.OpResult:
  return _get_op_result_or_op_results(AndOp(inputs=inputs, twoState=two_state, loc=loc, ip=ip))
...
def concat(inputs, *, loc=None, ip=None) -> _ods_ir.OpResult:
  return _get_op_result_or_op_results(ConcatOp(inputs=inputs, loc=loc, ip=ip))
...
def divs(lhs, rhs, *, two_state=None, loc=None, ip=None) -> _ods_ir.OpResult:
  return _get_op_result_or_op_results(DivSOp(lhs=lhs, rhs=rhs, twoState=two_state, loc=loc, ip=ip))
...
def divu(lhs, rhs, *, two_state=None, loc=None, ip=None) -> _ods_ir.OpResult:
  return _get_op_result_or_op_results(DivUOp(lhs=lhs, rhs=rhs, twoState=two_state, loc=loc, ip=ip))
...
def extract(result, input, low_bit, *, loc=None, ip=None) -> _ods_ir.OpResult:
  return _get_op_result_or_op_results(ExtractOp(result=result, input=input, lowBit=low_bit, loc=loc, ip=ip))
...
def icmp(predicate, lhs, rhs, *, two_state=None, loc=None, ip=None) -> _ods_ir.OpResult:
  return _get_op_result_or_op_results(ICmpOp(predicate=predicate, lhs=lhs, rhs=rhs, twoState=two_state, loc=loc, ip=ip))
...
def mods(lhs, rhs, *, two_state=None, loc=None, ip=None) -> _ods_ir.OpResult:
  return _get_op_result_or_op_results(ModSOp(lhs=lhs, rhs=rhs, twoState=two_state, loc=loc, ip=ip))
...
def modu(lhs, rhs, *, two_state=None, loc=None, ip=None) -> _ods_ir.OpResult:
  return _get_op_result_or_op_results(ModUOp(lhs=lhs, rhs=rhs, twoState=two_state, loc=loc, ip=ip))
...
def mul(inputs, *, two_state=None, loc=None, ip=None) -> _ods_ir.OpResult:
  return _get_op_result_or_op_results(MulOp(inputs=inputs, twoState=two_state, loc=loc, ip=ip))
...
def mux(cond, true_value, false_value, *, two_state=None, loc=None, ip=None) -> _ods_ir.OpResult:
  return _get_op_result_or_op_results(MuxOp(cond=cond, trueValue=true_value, falseValue=false_value, twoState=two_state, loc=loc, ip=ip))
...
def or_(inputs, *, two_state=None, loc=None, ip=None) -> _ods_ir.OpResult:
  return _get_op_result_or_op_results(OrOp(inputs=inputs, twoState=two_state, loc=loc, ip=ip))
...
def parity(input, *, two_state=None, loc=None, ip=None) -> _ods_ir.OpResult:
  return _get_op_result_or_op_results(ParityOp(input=input, twoState=two_state, loc=loc, ip=ip))
...
def replicate(result, input, *, loc=None, ip=None) -> _ods_ir.OpResult:
  return _get_op_result_or_op_results(ReplicateOp(result=result, input=input, loc=loc, ip=ip))
...
def shl(lhs, rhs, *, two_state=None, loc=None, ip=None) -> _ods_ir.OpResult:
  return _get_op_result_or_op_results(ShlOp(lhs=lhs, rhs=rhs, twoState=two_state, loc=loc, ip=ip))
...
def shrs(lhs, rhs, *, two_state=None, loc=None, ip=None) -> _ods_ir.OpResult:
  return _get_op_result_or_op_results(ShrSOp(lhs=lhs, rhs=rhs, twoState=two_state, loc=loc, ip=ip))
...
def shru(lhs, rhs, *, two_state=None, loc=None, ip=None) -> _ods_ir.OpResult:
  return _get_op_result_or_op_results(ShrUOp(lhs=lhs, rhs=rhs, twoState=two_state, loc=loc, ip=ip))
...
def sub(lhs, rhs, *, two_state=None, loc=None, ip=None) -> _ods_ir.OpResult:
  return _get_op_result_or_op_results(SubOp(lhs=lhs, rhs=rhs, twoState=two_state, loc=loc, ip=ip))
...
def truth_table(inputs, lookup_table, *, loc=None, ip=None) -> _ods_ir.OpResult:
  return _get_op_result_or_op_results(TruthTableOp(inputs=inputs, lookupTable=lookup_table, loc=loc, ip=ip))
...
def xor(inputs, *, two_state=None, loc=None, ip=None) -> _ods_ir.OpResult:
  return _get_op_result_or_op_results(XorOp(inputs=inputs, twoState=two_state, loc=loc, ip=ip))
