...
def add(inputs, *, loc=None, ip=None) -> _ods_ir.OpResult:
  return _get_op_result_or_op_results(AddOp(inputs=inputs, loc=loc, ip=ip))
...
class ConstantOp(_ods_ir.OpView):
  ...
  def __init__(self, rawValue, *, loc=None, ip=None):
    ...
    issubclass(type(rawValue), _ods_ir.Attribute) or
...
def constant(raw_value, *, loc=None, ip=None) -> _ods_ir.OpResult:
  return _get_op_result_or_op_results(ConstantOp(rawValue=raw_value, loc=loc, ip=ip))
...
def div(inputs, *, loc=None, ip=None) -> _ods_ir.OpResult:
  return _get_op_result_or_op_results(DivOp(inputs=inputs, loc=loc, ip=ip))
...
def cast(out, in_, *, loc=None, ip=None) -> _ods_ir.OpResult:
  return _get_op_result_or_op_results(CastOp(out=out, in_=in_, loc=loc, ip=ip))
...
def icmp(predicate, lhs, rhs, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def mul(inputs, *, loc=None, ip=None) -> _ods_ir.OpResult:
  return _get_op_result_or_op_results(MulOp(inputs=inputs, loc=loc, ip=ip))
...
def sub(inputs, *, loc=None, ip=None) -> _ods_ir.OpResult:
  return _get_op_result_or_op_results(SubOp(inputs=inputs, loc=loc, ip=ip))
