...
class AlwaysFFOp(_ods_ir.OpView):
  ...
  def __init__(self, clockEdge, clock, *, resetStyle=None, resetEdge=None, reset=None, loc=None, ip=None):
    ...
    issubclass(type(clockEdge), _ods_ir.Attribute) or
    ...
    if resetStyle is not None: attributes["resetStyle"] = (resetStyle if (
        issubclass(type(resetStyle), _ods_ir.Attribute) or
    ...
    if resetEdge is not None: attributes["resetEdge"] = (resetEdge if (
        issubclass(type(resetEdge), _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('EventControlAttr')) else
...
class AlwaysOp(_ods_ir.OpView):
  ...
  def __init__(self, events, clocks, *, loc=None, ip=None):
    ...
    issubclass(type(events), _ods_ir.Attribute) or
    not _ods_ir.AttrBuilder.contains('anonymous_502')) else
      _ods_ir.AttrBuilder.get('anonymous_502')(events, context=_ods_context))
    _ods_successors = None
    super().__init__(self.build_generic(attributes=attributes, results=results, operands=operands, successors=_ods_successors, regions=regions, loc=loc, ip=ip))
...
def array_index_inout(input, index, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def constantStr(str, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def indexed_part_select_inout(input, base, width, *, decrement=None, loc=None, ip=None) -> _ods_ir.OpResult:
...
def indexed_part_select(input, base, width, *, decrement=None, loc=None, ip=None) -> _ods_ir.OpResult:
...
def interface_instance(result, name, *, inner_sym=None, loc=None, ip=None) -> _ods_ir.OpResult:
...
def localparam(value, name, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def macro_ref(result, macro_name, inputs, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def macro_ref_se(result, macro_name, inputs, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def read_inout(input, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def system_sampled(expression, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def struct_field_inout(input, field, *, loc=None, ip=None) -> _ods_ir.OpResult:
