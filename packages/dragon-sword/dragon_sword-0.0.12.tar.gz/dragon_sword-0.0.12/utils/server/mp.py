...
from utils.system import is_linux, cur_pid
from utils.call import call_async
from .sync import QM, SemM, RLockM, LockM
...
class TaskParam:
    ...
    def parse(cls, args, kwargs):
        ...
        return args, kwargs, log_q, init, end, global_conf, qs, sems, locks, rlocks
...
class MpDecorator:
    ...
    def __call__(self, *args, **kwargs):
        ...
        args, kwargs, log_q, init, end, global_conf, qs, sems, locks, rlocks = TaskParam.parse(args, kwargs)
        init_log(global_conf=global_conf, log_q=log_q)
        init_sync(qs, sems, locks, rlocks)
...
class _MultiM:
    def __init__(self):
        ...
        self._killer: GracefulKiller | None = None
