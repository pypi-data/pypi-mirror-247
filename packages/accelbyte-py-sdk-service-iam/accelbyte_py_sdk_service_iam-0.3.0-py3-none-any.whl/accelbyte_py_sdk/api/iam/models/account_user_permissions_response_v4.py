...
class AccountUserPermissionsResponseV4(Model):
    """Account user permissions response V4 (account.UserPermissionsResponseV4)
    ...
    def with_action(self, value: int) -> AccountUserPermissionsResponseV4:
        self.action = value
        return self

    def with_resource(self, value: str) -> AccountUserPermissionsResponseV4:
        self.resource = value
        return self

    def with_sched_action(self, value: int) -> AccountUserPermissionsResponseV4:
        self.sched_action = value
        return self

    def with_sched_cron(self, value: str) -> AccountUserPermissionsResponseV4:
        self.sched_cron = value
        return self

    def with_sched_range(self, value: List[str]) -> AccountUserPermissionsResponseV4:
    ...
    def create_many_from_dict(
        cls, dict_: dict, include_empty: bool = False
    ) -> Dict[str, AccountUserPermissionsResponseV4]:
        return (
    ...
    ) -> List[AccountUserPermissionsResponseV4]:
        return (
    ...
    def create_from_any(
        ...
        AccountUserPermissionsResponseV4,
        List[AccountUserPermissionsResponseV4],
        Dict[Any, AccountUserPermissionsResponseV4],
    ]:
        if many:
