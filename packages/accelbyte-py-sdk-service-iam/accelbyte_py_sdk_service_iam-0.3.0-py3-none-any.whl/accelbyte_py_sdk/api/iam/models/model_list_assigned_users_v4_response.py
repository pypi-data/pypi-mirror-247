...
class ModelListAssignedUsersV4Response(Model):
    ...
    def with_data(
        self, value: List[ModelAssignedUserV4Response]
    ...
    def create_from_dict(
        ...
        if "data" in dict_ and dict_["data"] is not None:
            instance.data = [
                ModelAssignedUserV4Response.create_from_dict(
    ...
    def create_many_from_dict(
        cls, dict_: dict, include_empty: bool = False
    ) -> Dict[str, ModelListAssignedUsersV4Response]:
        return (
    ...
    ) -> List[ModelListAssignedUsersV4Response]:
        return (
    ...
    def create_from_any(
        ...
        ModelListAssignedUsersV4Response,
        List[ModelListAssignedUsersV4Response],
        Dict[Any, ModelListAssignedUsersV4Response],
    ]:
        if many:
