...
class ModelLoginHistoriesResponse(Model):
    ...
    def with_data(
        self, value: List[ModelUserLoginHistoryResponse]
    ...
    def create_from_dict(
        ...
        if "Data" in dict_ and dict_["Data"] is not None:
            instance.data = [
                ModelUserLoginHistoryResponse.create_from_dict(
    ...
    def create_many_from_dict(
        cls, dict_: dict, include_empty: bool = False
    ) -> Dict[str, ModelLoginHistoriesResponse]:
        return (
    ...
    ) -> List[ModelLoginHistoriesResponse]:
        return (
    ...
    def create_from_any(
        ...
        ModelLoginHistoriesResponse,
        List[ModelLoginHistoriesResponse],
        Dict[Any, ModelLoginHistoriesResponse],
    ]:
        if many:
