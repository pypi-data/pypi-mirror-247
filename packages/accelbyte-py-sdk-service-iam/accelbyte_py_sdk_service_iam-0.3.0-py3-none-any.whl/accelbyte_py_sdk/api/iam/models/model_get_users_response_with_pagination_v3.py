...
class ModelGetUsersResponseWithPaginationV3(Model):
    """Model get users response with pagination V3 (model.GetUsersResponseWithPaginationV3)
    ...
    def create_many_from_dict(
        cls, dict_: dict, include_empty: bool = False
    ) -> Dict[str, ModelGetUsersResponseWithPaginationV3]:
        return (
    ...
    ) -> List[ModelGetUsersResponseWithPaginationV3]:
        return (
    ...
    def create_from_any(
        ...
        ModelGetUsersResponseWithPaginationV3,
        List[ModelGetUsersResponseWithPaginationV3],
        Dict[Any, ModelGetUsersResponseWithPaginationV3],
    ]:
        if many:
