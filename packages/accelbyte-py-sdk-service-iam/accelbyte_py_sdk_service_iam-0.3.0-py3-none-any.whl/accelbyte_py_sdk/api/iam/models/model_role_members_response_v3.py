...
class ModelRoleMembersResponseV3(Model):
    """Model role members response V3 (model.RoleMembersResponseV3)

    Properties:
        data: (data) REQUIRED List[AccountcommonRoleMemberV3]
    ...
    data: List[AccountcommonRoleMemberV3]  # REQUIRED
    ...
    def create(
        cls,
        data: List[AccountcommonRoleMemberV3],
    ...
    def create_many_from_dict(
        cls, dict_: dict, include_empty: bool = False
    ) -> Dict[str, ModelRoleMembersResponseV3]:
        return (
    ...
    ) -> List[ModelRoleMembersResponseV3]:
        return (
    ...
    def create_from_any(
        ...
        ModelRoleMembersResponseV3,
        List[ModelRoleMembersResponseV3],
        Dict[Any, ModelRoleMembersResponseV3],
    ]:
        if many:
