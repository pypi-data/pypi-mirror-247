...
class AccountcommonPermissionsV3(Model):
    """Accountcommon permissions V3 (accountcommon.PermissionsV3)
    ...
    @classmethod
    def create(
        cls, permissions: List[AccountcommonPermissionV3], **kwargs
    ) -> AccountcommonPermissionsV3:
        instance = cls()
    ...
    def create_many_from_dict(
        cls, dict_: dict, include_empty: bool = False
    ) -> Dict[str, AccountcommonPermissionsV3]:
        return (
    ...
    ) -> List[AccountcommonPermissionsV3]:
        return (
    ...
    def create_from_any(
        ...
        AccountcommonPermissionsV3,
        List[AccountcommonPermissionsV3],
        Dict[Any, AccountcommonPermissionsV3],
    ]:
        if many:
