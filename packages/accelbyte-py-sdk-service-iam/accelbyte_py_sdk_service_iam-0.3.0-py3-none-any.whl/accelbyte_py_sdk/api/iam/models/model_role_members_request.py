...
class ModelRoleMembersRequest(Model):
    """Model role members request (model.RoleMembersRequest)
    ...
    @classmethod
    def create(
        cls, members: List[AccountcommonRoleMember], **kwargs
    ) -> ModelRoleMembersRequest:
        instance = cls()
    ...
    def create_many_from_dict(
        cls, dict_: dict, include_empty: bool = False
    ) -> Dict[str, ModelRoleMembersRequest]:
        return (
    ...
    def create_from_any(
        ...
        ModelRoleMembersRequest,
        List[ModelRoleMembersRequest],
        Dict[Any, ModelRoleMembersRequest],
    ]:
        if many:
