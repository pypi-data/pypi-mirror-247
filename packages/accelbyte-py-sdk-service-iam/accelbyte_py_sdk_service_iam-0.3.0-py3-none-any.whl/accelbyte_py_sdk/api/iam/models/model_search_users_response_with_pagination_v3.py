...
class ModelSearchUsersResponseWithPaginationV3(Model):
    ...
    def with_data(
        self, value: List[ModelUserResponseV3]
    ...
    def with_total_data(self, value: int) -> ModelSearchUsersResponseWithPaginationV3:
    ...
    def create_from_dict(
        ...
        if "data" in dict_ and dict_["data"] is not None:
            instance.data = [
                ModelUserResponseV3.create_from_dict(i0, include_empty=include_empty)
    ...
    def create_many_from_dict(
        cls, dict_: dict, include_empty: bool = False
    ) -> Dict[str, ModelSearchUsersResponseWithPaginationV3]:
        return (
    ...
    ) -> List[ModelSearchUsersResponseWithPaginationV3]:
        return (
    ...
    def create_from_any(
        ...
        ModelSearchUsersResponseWithPaginationV3,
        List[ModelSearchUsersResponseWithPaginationV3],
        Dict[Any, ModelSearchUsersResponseWithPaginationV3],
    ]:
        if many:
