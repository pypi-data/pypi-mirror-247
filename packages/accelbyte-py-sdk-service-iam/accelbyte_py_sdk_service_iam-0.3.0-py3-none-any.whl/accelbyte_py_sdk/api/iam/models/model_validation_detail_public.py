...
class ModelValidationDetailPublic(Model):
    """Model validation detail public (model.ValidationDetailPublic)
    ...
    Properties:
        ...
        description: (description) REQUIRED AccountcommonInputValidationDescription
    ...
    def with_allow_digit(self, value: bool) -> ModelValidationDetailPublic:
        self.allow_digit = value
        return self

    def with_allow_letter(self, value: bool) -> ModelValidationDetailPublic:
        self.allow_letter = value
        return self

    def with_allow_space(self, value: bool) -> ModelValidationDetailPublic:
        self.allow_space = value
        return self

    def with_allow_unicode(self, value: bool) -> ModelValidationDetailPublic:
        self.allow_unicode = value
        return self

    def with_blocked_word(self, value: List[str]) -> ModelValidationDetailPublic:
    ...
    def with_is_custom_regex(self, value: bool) -> ModelValidationDetailPublic:
        self.is_custom_regex = value
        return self

    def with_letter_case(self, value: str) -> ModelValidationDetailPublic:
        self.letter_case = value
        return self

    def with_max_length(self, value: int) -> ModelValidationDetailPublic:
        self.max_length = value
        return self

    def with_max_repeating_alpha_num(self, value: int) -> ModelValidationDetailPublic:
    ...
    def with_min_char_type(self, value: int) -> ModelValidationDetailPublic:
        self.min_char_type = value
        return self

    def with_min_length(self, value: int) -> ModelValidationDetailPublic:
        self.min_length = value
        return self

    def with_regex(self, value: str) -> ModelValidationDetailPublic:
        self.regex = value
        return self
    ...
    def create(
        ...
        description: AccountcommonInputValidationDescription,
