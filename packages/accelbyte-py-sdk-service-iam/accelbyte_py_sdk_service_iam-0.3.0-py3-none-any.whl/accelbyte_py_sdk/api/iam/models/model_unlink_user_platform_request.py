...
class ModelUnlinkUserPlatformRequest(Model):
    """Model unlink user platform request (model.UnlinkUserPlatformRequest)
    ...
    @classmethod
    def create(
        cls, platform_namespace: Optional[str] = None, **kwargs
    ...
    def create_many_from_dict(
        cls, dict_: dict, include_empty: bool = False
    ) -> Dict[str, ModelUnlinkUserPlatformRequest]:
        return (
    ...
    ) -> List[ModelUnlinkUserPlatformRequest]:
        return (
    ...
    def create_from_any(
        ...
        ModelUnlinkUserPlatformRequest,
        List[ModelUnlinkUserPlatformRequest],
        Dict[Any, ModelUnlinkUserPlatformRequest],
    ]:
        if many:
