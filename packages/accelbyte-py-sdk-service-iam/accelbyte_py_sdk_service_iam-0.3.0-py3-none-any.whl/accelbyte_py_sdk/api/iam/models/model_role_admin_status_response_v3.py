...
class ModelRoleAdminStatusResponseV3(Model):
    """Model role admin status response V3 (model.RoleAdminStatusResponseV3)
    ...
    @classmethod
    def create(cls, admin_role: bool, **kwargs) -> ModelRoleAdminStatusResponseV3:
        instance = cls()
    ...
    def create_many_from_dict(
        cls, dict_: dict, include_empty: bool = False
    ) -> Dict[str, ModelRoleAdminStatusResponseV3]:
        return (
    ...
    ) -> List[ModelRoleAdminStatusResponseV3]:
        return (
    ...
    def create_from_any(
        ...
        ModelRoleAdminStatusResponseV3,
        List[ModelRoleAdminStatusResponseV3],
        Dict[Any, ModelRoleAdminStatusResponseV3],
    ]:
        if many:
