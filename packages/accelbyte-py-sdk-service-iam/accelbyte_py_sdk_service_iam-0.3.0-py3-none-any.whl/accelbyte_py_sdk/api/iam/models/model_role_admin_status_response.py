...
class ModelRoleAdminStatusResponse(Model):
    ...
    @classmethod
    def create(cls, admin_role: bool, **kwargs) -> ModelRoleAdminStatusResponse:
        instance = cls()
    ...
    def create_many_from_dict(
        cls, dict_: dict, include_empty: bool = False
    ) -> Dict[str, ModelRoleAdminStatusResponse]:
        return (
    ...
    ) -> List[ModelRoleAdminStatusResponse]:
        return (
    ...
    def create_from_any(
        ...
        ModelRoleAdminStatusResponse,
        List[ModelRoleAdminStatusResponse],
        Dict[Any, ModelRoleAdminStatusResponse],
    ]:
        if many:
