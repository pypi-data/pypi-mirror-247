...
class ModelInputValidationData(Model):
    ...
    @classmethod
    def create(
        cls, field: str, validation: ModelValidationDetail, **kwargs
    ...
    def create_from_dict(
        ...
        if "validation" in dict_ and dict_["validation"] is not None:
            instance.validation = ModelValidationDetail.create_from_dict(
    ...
    def create_many_from_dict(
        cls, dict_: dict, include_empty: bool = False
    ) -> Dict[str, ModelInputValidationData]:
        return (
    ...
    def create_from_any(
        ...
        ModelInputValidationData,
        List[ModelInputValidationData],
        Dict[Any, ModelInputValidationData],
    ]:
        if many:
