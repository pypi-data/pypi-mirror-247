...
class OauthmodelTokenResponseV3(Model):
    """Oauthmodel token response V3 (oauthmodel.TokenResponseV3)
    ...
    def with_access_token(self, value: str) -> OauthmodelTokenResponseV3:
    ...
    def with_namespace(self, value: str) -> OauthmodelTokenResponseV3:
    ...
    def with_platform_user_id(self, value: str) -> OauthmodelTokenResponseV3:
    ...
    def create_many_from_dict(
        cls, dict_: dict, include_empty: bool = False
    ) -> Dict[str, OauthmodelTokenResponseV3]:
        return (
    ...
    ) -> List[OauthmodelTokenResponseV3]:
        return (
    ...
    def create_from_any(
        ...
        OauthmodelTokenResponseV3,
        List[OauthmodelTokenResponseV3],
        Dict[Any, OauthmodelTokenResponseV3],
    ]:
        if many:
