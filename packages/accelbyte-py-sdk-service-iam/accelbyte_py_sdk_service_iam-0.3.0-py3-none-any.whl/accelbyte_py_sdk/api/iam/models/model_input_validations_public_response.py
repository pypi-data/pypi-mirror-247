...
class ModelInputValidationsPublicResponse(Model):
    ...
    def with_data(
        self, value: List[ModelInputValidationDataPublic]
    ...
    @classmethod
    def create(
        cls, data: List[ModelInputValidationDataPublic], version: int, **kwargs
    ) -> ModelInputValidationsPublicResponse:
        instance = cls()
        instance.data = data
    ...
    def create_from_dict(
        ...
        if "data" in dict_ and dict_["data"] is not None:
            instance.data = [
                ModelInputValidationDataPublic.create_from_dict(
    ...
    def create_many_from_dict(
        cls, dict_: dict, include_empty: bool = False
    ) -> Dict[str, ModelInputValidationsPublicResponse]:
        return (
    ...
    ) -> List[ModelInputValidationsPublicResponse]:
        return (
    ...
    def create_from_any(
        ...
        ModelInputValidationsPublicResponse,
        List[ModelInputValidationsPublicResponse],
        Dict[Any, ModelInputValidationsPublicResponse],
    ]:
        if many:
