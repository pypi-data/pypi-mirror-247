...
class AdminLinkPlatformAccount(Operation):
    ...
    _url: str = "/iam/v3/admin/namespaces/{namespace}/users/{userId}/platforms/link"
    _method: str = "POST"
    ...
    def with_namespace(self, value: str) -> AdminLinkPlatformAccount:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> AdminLinkPlatformAccount:
        self.user_id = value
        return self
