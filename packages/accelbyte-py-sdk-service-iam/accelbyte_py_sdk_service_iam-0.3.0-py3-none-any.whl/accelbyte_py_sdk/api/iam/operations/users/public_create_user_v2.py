...
class PublicCreateUserV2(Operation):
    ...
    **Endpoint migration guide**
    ...
    def with_body(self, value: ModelUserCreateRequest) -> PublicCreateUserV2:
        self.body = value
        return self

    def with_namespace(self, value: str) -> PublicCreateUserV2:
    ...
    @classmethod
    def create(
        cls, body: ModelUserCreateRequest, namespace: str, **kwargs
    ) -> PublicCreateUserV2:
        instance = cls()
        instance.body = body
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelUserCreateRequest.create_from_dict(
