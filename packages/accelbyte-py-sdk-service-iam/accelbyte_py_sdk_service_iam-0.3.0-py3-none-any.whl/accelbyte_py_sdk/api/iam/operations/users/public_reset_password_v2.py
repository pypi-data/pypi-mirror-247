...
class PublicResetPasswordV2(Operation):
    ...
    **Endpoint migration guide**
    ...
    _url: str = "/iam/v2/public/namespaces/{namespace}/users/resetPassword"
    _method: str = "POST"
    ...
    def with_body(self, value: ModelResetPasswordRequest) -> PublicResetPasswordV2:
        self.body = value
        return self

    def with_namespace(self, value: str) -> PublicResetPasswordV2:
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = ModelResetPasswordRequest()
    ...
    @classmethod
    def create(
        cls, body: ModelResetPasswordRequest, namespace: str, **kwargs
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelResetPasswordRequest.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = ModelResetPasswordRequest()
