...
class AdminVerifyUserWithoutVerificationCodeV3(Operation):
    ...
    _url: str = "/iam/v3/admin/namespaces/{namespace}/users/{userId}/verify"
    _method: str = "PUT"
    _consumes: List[str] = []
    ...
    def with_namespace(self, value: str) -> AdminVerifyUserWithoutVerificationCodeV3:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> AdminVerifyUserWithoutVerificationCodeV3:
        self.user_id = value
        return self
