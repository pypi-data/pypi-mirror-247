...
class DeleteUser(Operation):
    ...
    def with_namespace(self, value: str) -> DeleteUser:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> DeleteUser:
        self.user_id = value
        return self
    ...
    @classmethod
    def create(cls, namespace: str, user_id: str, **kwargs) -> DeleteUser:
        instance = cls()
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> DeleteUser:
        instance = cls()
