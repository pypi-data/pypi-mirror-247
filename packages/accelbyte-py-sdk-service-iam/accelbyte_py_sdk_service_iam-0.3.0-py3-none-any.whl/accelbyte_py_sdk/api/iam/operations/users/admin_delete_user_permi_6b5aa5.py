...
class AdminDeleteUserPermissionBulkV3(Operation):
    ...
    def with_body(
        self, value: List[ModelPermissionDeleteRequest]
    ) -> AdminDeleteUserPermissionBulkV3:
        self.body = value
        return self

    def with_namespace(self, value: str) -> AdminDeleteUserPermissionBulkV3:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> AdminDeleteUserPermissionBulkV3:
        self.user_id = value
        return self
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = [
                ModelPermissionDeleteRequest.create_from_dict(
