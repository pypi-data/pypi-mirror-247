...
class AdminResetPasswordV2(Operation):
    ...
    **Endpoint migration guide**
    ...
    _url: str = "/iam/v2/admin/namespaces/{namespace}/users/{userId}/password"
    _method: str = "PUT"
    ...
    def with_body(self, value: ModelUserPasswordUpdateRequest) -> AdminResetPasswordV2:
        self.body = value
        return self

    def with_namespace(self, value: str) -> AdminResetPasswordV2:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> AdminResetPasswordV2:
        self.user_id = value
        return self
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = ModelUserPasswordUpdateRequest()
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelUserPasswordUpdateRequest.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = ModelUserPasswordUpdateRequest()
