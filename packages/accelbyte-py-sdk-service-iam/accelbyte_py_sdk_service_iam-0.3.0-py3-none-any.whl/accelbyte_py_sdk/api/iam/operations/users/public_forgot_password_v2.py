...
class PublicForgotPasswordV2(Operation):
    ...
    **Special note for publisher-game scenario:** Game Client should provide game namespace path parameter and Publisher Client should provide publisher namespace path parameter.
    ...
    _url: str = "/iam/v2/public/namespaces/{namespace}/users/forgotPassword"
    _method: str = "POST"
    ...
    def with_namespace(self, value: str) -> PublicForgotPasswordV2:
    ...
    @classmethod
    def create(
        cls, body: ModelSendVerificationCodeRequest, namespace: str, **kwargs
    ) -> PublicForgotPasswordV2:
        instance = cls()
        instance.body = body
