...
class AdminUpdateAgeRestrictionConfigV2(Operation):
    ...
    **Endpoint migration guide**
    ...
    _url: str = "/iam/v2/admin/namespaces/{namespace}/agerestrictions"
    _method: str = "PATCH"
    ...
    body: ModelAgeRestrictionRequest  # REQUIRED in [body]
    ...
    def with_body(
        self, value: ModelAgeRestrictionRequest
    ) -> AdminUpdateAgeRestrictionConfigV2:
        self.body = value
        return self

    def with_namespace(self, value: str) -> AdminUpdateAgeRestrictionConfigV2:
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = ModelAgeRestrictionRequest()
    ...
    @classmethod
    def create(
        cls, body: ModelAgeRestrictionRequest, namespace: str, **kwargs
    ) -> AdminUpdateAgeRestrictionConfigV2:
        instance = cls()
        instance.body = body
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelAgeRestrictionRequest.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = ModelAgeRestrictionRequest()
