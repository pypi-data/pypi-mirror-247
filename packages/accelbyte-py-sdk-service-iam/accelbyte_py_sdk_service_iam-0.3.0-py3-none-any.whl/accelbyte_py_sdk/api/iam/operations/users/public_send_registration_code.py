...
class PublicSendRegistrationCode(Operation):
    ...
    def with_body(
        self, value: ModelSendRegisterVerificationCodeRequest
    ) -> PublicSendRegistrationCode:
        self.body = value
        return self

    def with_namespace(self, value: str) -> PublicSendRegistrationCode:
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = ModelSendRegisterVerificationCodeRequest()
    ...
    @classmethod
    def create(
        cls, body: ModelSendRegisterVerificationCodeRequest, namespace: str, **kwargs
    ) -> PublicSendRegistrationCode:
        instance = cls()
        instance.body = body
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelSendRegisterVerificationCodeRequest.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = ModelSendRegisterVerificationCodeRequest()
