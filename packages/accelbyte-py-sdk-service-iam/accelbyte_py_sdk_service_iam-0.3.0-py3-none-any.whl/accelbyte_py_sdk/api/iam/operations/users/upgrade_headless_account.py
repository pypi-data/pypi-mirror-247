...
class UpgradeHeadlessAccount(Operation):
    ...
    _url: str = "/iam/namespaces/{namespace}/users/{userId}/upgradeHeadlessAccount"
    _method: str = "POST"
    ...
    body: ModelUpgradeHeadlessAccountRequest  # REQUIRED in [body]
    ...
    def with_body(
        self, value: ModelUpgradeHeadlessAccountRequest
    ) -> UpgradeHeadlessAccount:
        self.body = value
        return self

    def with_namespace(self, value: str) -> UpgradeHeadlessAccount:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> UpgradeHeadlessAccount:
        self.user_id = value
        return self
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = ModelUpgradeHeadlessAccountRequest()
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelUpgradeHeadlessAccountRequest.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = ModelUpgradeHeadlessAccountRequest()
