...
class AdminDeleteUserPermissionV3(Operation):
    ...
    _url: str = "/iam/v3/admin/namespaces/{namespace}/users/{userId}/permissions/{resource}/{action}"
    _method: str = "DELETE"
    _consumes: List[str] = []
    ...
    def with_action(self, value: int) -> AdminDeleteUserPermissionV3:
        self.action = value
        return self

    def with_namespace(self, value: str) -> AdminDeleteUserPermissionV3:
        self.namespace = value
        return self

    def with_resource(self, value: str) -> AdminDeleteUserPermissionV3:
        self.resource = value
        return self

    def with_user_id(self, value: str) -> AdminDeleteUserPermissionV3:
        self.user_id = value
        return self
