...
class PublicListJusticePlatformAccountsV3(Operation):
    ...
    _url: str = "/iam/v3/public/namespaces/{namespace}/users/{userId}/platforms/justice"
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    def with_namespace(self, value: str) -> PublicListJusticePlatformAccountsV3:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> PublicListJusticePlatformAccountsV3:
        self.user_id = value
        return self
    ...
    def parse_response(
        ...
        Union[None, List[ModelGetUserMappingV3]],
        ...
        if code == 200:
            return [ModelGetUserMappingV3.create_from_dict(i) for i in content], None
        if code == 400:
