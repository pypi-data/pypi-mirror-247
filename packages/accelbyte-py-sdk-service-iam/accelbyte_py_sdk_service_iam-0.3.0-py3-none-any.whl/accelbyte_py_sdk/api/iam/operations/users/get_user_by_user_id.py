...
class GetUserByUserID(Operation):
    ...
    def with_namespace(self, value: str) -> GetUserByUserID:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> GetUserByUserID:
        self.user_id = value
        return self
    ...
    @classmethod
    def create(cls, namespace: str, user_id: str, **kwargs) -> GetUserByUserID:
        instance = cls()
