...
class PublicCreateUserV3(Operation):
    ...
    def with_body(self, value: ModelUserCreateRequestV3) -> PublicCreateUserV3:
        self.body = value
        return self

    def with_namespace(self, value: str) -> PublicCreateUserV3:
    ...
    @classmethod
    def create(
        cls, body: ModelUserCreateRequestV3, namespace: str, **kwargs
    ) -> PublicCreateUserV3:
        instance = cls()
        instance.body = body
