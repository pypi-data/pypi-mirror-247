...
class UpdatePassword(Operation):
    ...
    _url: str = "/iam/namespaces/{namespace}/users/{userId}/password"
    _method: str = "PUT"
    ...
    def with_body(self, value: ModelUserPasswordUpdateRequest) -> UpdatePassword:
        self.body = value
        return self

    def with_namespace(self, value: str) -> UpdatePassword:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> UpdatePassword:
        self.user_id = value
        return self
