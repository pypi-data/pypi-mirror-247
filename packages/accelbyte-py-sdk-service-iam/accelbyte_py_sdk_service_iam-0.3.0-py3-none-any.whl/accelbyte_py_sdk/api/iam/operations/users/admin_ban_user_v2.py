...
class AdminBanUserV2(Operation):
    ...
    **Endpoint migration guide**
    ...
    def with_body(self, value: ModelBanCreateRequest) -> AdminBanUserV2:
        self.body = value
        return self

    def with_namespace(self, value: str) -> AdminBanUserV2:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> AdminBanUserV2:
        self.user_id = value
        return self
