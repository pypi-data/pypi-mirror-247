...
class AdminGetUserBanV2(Operation):
    ...
    **Endpoint migration guide**
    ...
    _url: str = "/iam/v2/admin/namespaces/{namespace}/users/{userId}/bans"
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    def with_namespace(self, value: str) -> AdminGetUserBanV2:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> AdminGetUserBanV2:
        self.user_id = value
        return self

    def with_active_only(self, value: bool) -> AdminGetUserBanV2:
    ...
    @classmethod
    def create(
        cls, namespace: str, user_id: str, active_only: Optional[bool] = None, **kwargs
    ) -> AdminGetUserBanV2:
        instance = cls()
