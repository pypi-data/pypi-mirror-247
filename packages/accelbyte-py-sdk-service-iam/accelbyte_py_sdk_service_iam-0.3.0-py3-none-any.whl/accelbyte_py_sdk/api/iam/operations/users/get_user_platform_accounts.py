...
class GetUserPlatformAccounts(Operation):
    ...
    _url: str = "/iam/namespaces/{namespace}/users/{userId}/platforms"
    _method: str = "GET"
    ...
    def with_namespace(self, value: str) -> GetUserPlatformAccounts:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> GetUserPlatformAccounts:
        self.user_id = value
        return self
    ...
    def parse_response(
        ...
        Union[None, List[AccountcommonUserLinkedPlatform]],
        ...
        if code == 200:
            return [
                AccountcommonUserLinkedPlatform.create_from_dict(i) for i in content
            ], None
        if code == 400:
    ...
    @classmethod
    def create(cls, namespace: str, user_id: str, **kwargs) -> GetUserPlatformAccounts:
        instance = cls()
