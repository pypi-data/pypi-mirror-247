...
class PublicUpdatePasswordV2(Operation):
    ...
    **Endpoint migration guide**
    ...
    _url: str = "/iam/v2/public/namespaces/{namespace}/users/{userId}/password"
    _method: str = "PUT"
    ...
    def with_body(
        self, value: ModelUserPasswordUpdateRequest
    ) -> PublicUpdatePasswordV2:
        self.body = value
        return self

    def with_namespace(self, value: str) -> PublicUpdatePasswordV2:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> PublicUpdatePasswordV2:
        self.user_id = value
        return self
