...
class PublicDisableMyBackupCodesV4(Operation):
    ...
    _url: str = "/iam/v4/public/namespaces/{namespace}/users/me/mfa/backupCode/disable"
    _method: str = "DELETE"
    _consumes: List[str] = []
    ...
    def with_namespace(self, value: str) -> PublicDisableMyBackupCodesV4:
    ...
    @classmethod
    def create(cls, namespace: str, **kwargs) -> PublicDisableMyBackupCodesV4:
        instance = cls()
