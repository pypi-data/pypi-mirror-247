...
class PublicUpdateUserEmailAddressV4(Operation):
    ...
    _url: str = "/iam/v4/public/namespaces/{namespace}/users/me/email"
    _method: str = "PUT"
    ...
    def with_body(
        self, value: ModelEmailUpdateRequestV4
    ) -> PublicUpdateUserEmailAddressV4:
        self.body = value
        return self

    def with_namespace(self, value: str) -> PublicUpdateUserEmailAddressV4:
    ...
    @classmethod
    def create(
        cls, body: ModelEmailUpdateRequestV4, namespace: str, **kwargs
    ) -> PublicUpdateUserEmailAddressV4:
        instance = cls()
        instance.body = body
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelEmailUpdateRequestV4.create_from_dict(
