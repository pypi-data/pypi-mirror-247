...
class PublicMakeFactorMyDefaultV4(Operation):
    ...
    def with_factor(self, value: str) -> PublicMakeFactorMyDefaultV4:
        self.factor = value
        return self

    def with_namespace(self, value: str) -> PublicMakeFactorMyDefaultV4:
    ...
    @classmethod
    def create(
        cls, factor: str, namespace: str, **kwargs
