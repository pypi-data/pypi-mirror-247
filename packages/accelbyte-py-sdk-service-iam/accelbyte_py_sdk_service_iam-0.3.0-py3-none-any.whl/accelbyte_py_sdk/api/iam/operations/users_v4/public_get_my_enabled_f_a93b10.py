...
class PublicGetMyEnabledFactorsV4(Operation):
    ...
    _url: str = "/iam/v4/public/namespaces/{namespace}/users/me/mfa/factor"
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    def with_namespace(self, value: str) -> PublicGetMyEnabledFactorsV4:
    ...
    def parse_response(
        ...
        Union[None, ModelEnabledFactorsResponseV4],
        ...
        if code == 200:
            return ModelEnabledFactorsResponseV4.create_from_dict(content), None
        if code == 400:
    ...
    @classmethod
    def create(cls, namespace: str, **kwargs) -> PublicGetMyEnabledFactorsV4:
        instance = cls()
