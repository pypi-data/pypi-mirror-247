...
class AdminUpdateUserV4(Operation):
    ...
    **Response body logic when user updating email address:**
    ...
    _url: str = "/iam/v4/admin/namespaces/{namespace}/users/{userId}"
    _method: str = "PUT"
    ...
    def with_body(self, value: ModelUserUpdateRequestV3) -> AdminUpdateUserV4:
        self.body = value
        return self

    def with_namespace(self, value: str) -> AdminUpdateUserV4:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> AdminUpdateUserV4:
        self.user_id = value
        return self
