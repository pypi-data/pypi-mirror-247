...
class DeleteClientByNamespace(Operation):
    ...
    **Endpoint migration guide**
    ...
    _url: str = "/iam/namespaces/{namespace}/clients/{clientId}"
    _method: str = "DELETE"
    ...
    def with_client_id(self, value: str) -> DeleteClientByNamespace:
        self.client_id = value
        return self

    def with_namespace(self, value: str) -> DeleteClientByNamespace:
