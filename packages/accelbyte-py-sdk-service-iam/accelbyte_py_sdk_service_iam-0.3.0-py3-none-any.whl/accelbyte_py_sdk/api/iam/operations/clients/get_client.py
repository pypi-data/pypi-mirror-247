...
class GetClient(Operation):
    ...
    **Endpoint migration guide**
    ...
    def with_client_id(self, value: str) -> GetClient:
    ...
    def parse_response(
        ...
        Union[None, ClientmodelClientResponse],
    ...
    @classmethod
    def create(cls, client_id: str, **kwargs) -> GetClient:
        instance = cls()
        instance.client_id = client_id
        return instance

    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> GetClient:
        instance = cls()
