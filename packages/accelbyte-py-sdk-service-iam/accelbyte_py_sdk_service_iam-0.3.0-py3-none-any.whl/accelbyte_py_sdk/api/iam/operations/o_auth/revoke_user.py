...
class RevokeUser(Operation):
    ...
    _url: str = "/iam/oauth/namespaces/{namespace}/users/{userId}/revoke"
    _method: str = "POST"
    ...
    def with_namespace(self, value: str) -> RevokeUser:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> RevokeUser:
        self.user_id = value
        return self
    ...
    @classmethod
    def create(cls, namespace: str, user_id: str, **kwargs) -> RevokeUser:
        instance = cls()
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> RevokeUser:
        instance = cls()
