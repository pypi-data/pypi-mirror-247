...
class GetRoleAdminStatus(Operation):
    ...
    def with_role_id(self, value: str) -> GetRoleAdminStatus:
        self.role_id = value
        return self
    ...
    def parse_response(
        ...
        Union[None, ModelRoleAdminStatusResponse],
        ...
        if code == 200:
            return ModelRoleAdminStatusResponse.create_from_dict(content), None
        if code == 400:
    ...
    @classmethod
    def create(cls, role_id: str, **kwargs) -> GetRoleAdminStatus:
        instance = cls()
