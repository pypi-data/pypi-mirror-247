...
class AdminListAssignedUsersV4(Operation):
    ...
    def with_role_id(self, value: str) -> AdminListAssignedUsersV4:
        self.role_id = value
        return self

    def with_after(self, value: str) -> AdminListAssignedUsersV4:
        self.after = value
        return self

    def with_before(self, value: str) -> AdminListAssignedUsersV4:
        self.before = value
        return self

    def with_limit(self, value: int) -> AdminListAssignedUsersV4:
        self.limit = value
        return self
    ...
    def parse_response(
        ...
        Union[None, ModelListAssignedUsersV4Response],
        ...
        if code == 200:
            return ModelListAssignedUsersV4Response.create_from_dict(content), None
        if code == 400:
