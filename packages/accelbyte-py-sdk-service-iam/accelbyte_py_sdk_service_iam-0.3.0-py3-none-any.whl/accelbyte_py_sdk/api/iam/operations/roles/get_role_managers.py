...
class GetRoleManagers(Operation):
    ...
    def with_role_id(self, value: str) -> GetRoleManagers:
        self.role_id = value
        return self
    ...
    def parse_response(
        ...
        Union[None, ModelRoleManagersResponse],
        ...
        if code == 200:
            return ModelRoleManagersResponse.create_from_dict(content), None
        if code == 400:
    ...
    @classmethod
    def create(cls, role_id: str, **kwargs) -> GetRoleManagers:
        instance = cls()
