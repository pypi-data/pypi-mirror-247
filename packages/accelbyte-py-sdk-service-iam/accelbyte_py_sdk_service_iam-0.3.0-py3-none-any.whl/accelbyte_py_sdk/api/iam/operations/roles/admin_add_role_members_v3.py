...
class AdminAddRoleMembersV3(Operation):
    ...
    def with_body(self, value: ModelRoleMembersRequestV3) -> AdminAddRoleMembersV3:
        self.body = value
        return self

    def with_role_id(self, value: str) -> AdminAddRoleMembersV3:
        self.role_id = value
        return self
    ...
    @classmethod
    def create(
        cls, body: ModelRoleMembersRequestV3, role_id: str, **kwargs
