...
class RemoveRoleMembers(Operation):
    ...
    def with_body(self, value: ModelRoleMembersRequest) -> RemoveRoleMembers:
        self.body = value
        return self

    def with_role_id(self, value: str) -> RemoveRoleMembers:
        self.role_id = value
        return self
    ...
    @classmethod
    def create(
        cls, body: ModelRoleMembersRequest, role_id: str, **kwargs
    ) -> RemoveRoleMembers:
        instance = cls()
        instance.body = body
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelRoleMembersRequest.create_from_dict(
