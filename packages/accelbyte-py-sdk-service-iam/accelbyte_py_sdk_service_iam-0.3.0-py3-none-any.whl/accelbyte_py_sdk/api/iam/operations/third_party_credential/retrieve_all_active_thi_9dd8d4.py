...
class RetrieveAllActiveThirdPartyLoginPlatformCredentialV3(Operation):
    ...
    _url: str = "/iam/v3/admin/namespaces/{namespace}/platforms/all/clients/active"
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    def parse_response(
        ...
        Union[None, List[ModelThirdPartyLoginPlatformCredentialResponse]],
        ...
        if code == 200:
            return [
                ModelThirdPartyLoginPlatformCredentialResponse.create_from_dict(i)
                for i in content
            ], None
        if code == 401:
