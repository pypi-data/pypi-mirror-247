...
class GetCountryLocationV3(Operation):
    ...
    _url: str = "/iam/v3/location/country"
    _method: str = "GET"
    _consumes: List[str] = [""]
    ...
    def parse_response(
        ...
        Union[None, OauthmodelCountryLocationResponse], Union[None, HttpResponse]
    ]:
        ...
        if code == 200:
            return OauthmodelCountryLocationResponse.create_from_dict(content), None
    ...
    @classmethod
    def create(cls, **kwargs) -> GetCountryLocationV3:
        instance = cls()
        return instance
