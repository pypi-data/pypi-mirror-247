...
class AdminBanDeviceV4(Operation):
    ...
    def with_body(self, value: ModelDeviceBanRequestV4) -> AdminBanDeviceV4:
        self.body = value
        return self

    def with_namespace(self, value: str) -> AdminBanDeviceV4:
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = ModelDeviceBanRequestV4()
    ...
    @classmethod
    def create(
        cls, body: ModelDeviceBanRequestV4, namespace: str, **kwargs
    ) -> AdminBanDeviceV4:
        instance = cls()
        instance.body = body
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelDeviceBanRequestV4.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = ModelDeviceBanRequestV4()
