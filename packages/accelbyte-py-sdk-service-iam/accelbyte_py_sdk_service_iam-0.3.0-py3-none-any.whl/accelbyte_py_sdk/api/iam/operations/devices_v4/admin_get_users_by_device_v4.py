...
class AdminGetUsersByDeviceV4(Operation):
    ...
    _url: str = "/iam/v4/admin/namespaces/{namespace}/devices/{deviceId}/users"
    _method: str = "GET"
    ...
    def with_device_id(self, value: str) -> AdminGetUsersByDeviceV4:
        self.device_id = value
        return self

    def with_namespace(self, value: str) -> AdminGetUsersByDeviceV4:
    ...
    def parse_response(
        ...
        Union[None, ModelDeviceUsersResponseV4],
        ...
        if code == 200:
            return ModelDeviceUsersResponseV4.create_from_dict(content), None
        if code == 400:
    ...
    @classmethod
    def create(
        cls, device_id: str, namespace: str, **kwargs
