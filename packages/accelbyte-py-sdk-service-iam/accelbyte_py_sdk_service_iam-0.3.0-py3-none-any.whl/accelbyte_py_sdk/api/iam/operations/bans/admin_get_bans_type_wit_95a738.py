...
class AdminGetBansTypeWithNamespaceV3(Operation):
    ...
    _url: str = "/iam/v3/admin/namespaces/{namespace}/bantypes"
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    def with_namespace(self, value: str) -> AdminGetBansTypeWithNamespaceV3:
    ...
    def parse_response(
        ...
        Union[None, AccountcommonBansV3], Union[None, HttpResponse, RestErrorResponse]
    ]:
