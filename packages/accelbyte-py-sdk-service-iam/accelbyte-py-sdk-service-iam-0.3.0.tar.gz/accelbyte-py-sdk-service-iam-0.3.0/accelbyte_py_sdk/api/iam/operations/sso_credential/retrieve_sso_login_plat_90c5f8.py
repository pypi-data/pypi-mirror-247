...
class RetrieveSSOLoginPlatformCredential(Operation):
    ...
    def with_namespace(self, value: str) -> RetrieveSSOLoginPlatformCredential:
        self.namespace = value
        return self

    def with_platform_id(self, value: str) -> RetrieveSSOLoginPlatformCredential:
    ...
    def parse_response(
        ...
        Union[None, ModelSSOPlatformCredentialResponse],
