...
class AdminDeleteUserRolesV3(Operation):
    ...
    def with_body(self, value: List[str]) -> AdminDeleteUserRolesV3:
        self.body = value
        return self

    def with_namespace(self, value: str) -> AdminDeleteUserRolesV3:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> AdminDeleteUserRolesV3:
        self.user_id = value
        return self
