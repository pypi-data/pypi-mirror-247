...
class PublicGetPublisherUserV3(Operation):
    ...
    **Restriction:**
    ...
    _url: str = "/iam/v3/public/namespaces/{namespace}/users/{userId}/publisher"
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    def with_namespace(self, value: str) -> PublicGetPublisherUserV3:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> PublicGetPublisherUserV3:
        self.user_id = value
        return self
    ...
    @classmethod
    def create(cls, namespace: str, user_id: str, **kwargs) -> PublicGetPublisherUserV3:
        instance = cls()
