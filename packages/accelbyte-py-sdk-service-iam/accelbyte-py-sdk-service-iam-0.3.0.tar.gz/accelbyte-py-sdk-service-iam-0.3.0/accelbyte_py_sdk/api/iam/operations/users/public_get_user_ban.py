...
class PublicGetUserBan(Operation):
    ...
    **Endpoint migration guide**
    ...
    def with_namespace(self, value: str) -> PublicGetUserBan:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> PublicGetUserBan:
        self.user_id = value
        return self

    def with_active_only(self, value: bool) -> PublicGetUserBan:
