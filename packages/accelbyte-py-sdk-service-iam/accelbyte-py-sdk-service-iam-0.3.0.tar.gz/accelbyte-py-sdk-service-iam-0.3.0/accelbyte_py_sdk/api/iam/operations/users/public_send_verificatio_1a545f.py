...
class PublicSendVerificationLinkV3(Operation):
    ...
    _url: str = "/iam/v3/public/users/me/verify_link/request"
    _method: str = "POST"
    ...
    body: ModelSendVerificationLinkRequest  # REQUIRED in [body]
    ...
    def with_body(
        self, value: ModelSendVerificationLinkRequest
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = ModelSendVerificationLinkRequest()
        return result
    ...
    @classmethod
    def create(
        cls, body: ModelSendVerificationLinkRequest, **kwargs
    ) -> PublicSendVerificationLinkV3:
        instance = cls()
        instance.body = body
        return instance
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelSendVerificationLinkRequest.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = ModelSendVerificationLinkRequest()
        return instance
