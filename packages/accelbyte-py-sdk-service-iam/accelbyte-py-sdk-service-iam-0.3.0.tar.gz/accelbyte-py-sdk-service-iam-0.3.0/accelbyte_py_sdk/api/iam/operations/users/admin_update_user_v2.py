...
class AdminUpdateUserV2(Operation):
    ...
    **Several case of updating email address**
    ...
    def with_body(self, value: ModelUserUpdateRequest) -> AdminUpdateUserV2:
        self.body = value
        return self

    def with_namespace(self, value: str) -> AdminUpdateUserV2:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> AdminUpdateUserV2:
        self.user_id = value
        return self
