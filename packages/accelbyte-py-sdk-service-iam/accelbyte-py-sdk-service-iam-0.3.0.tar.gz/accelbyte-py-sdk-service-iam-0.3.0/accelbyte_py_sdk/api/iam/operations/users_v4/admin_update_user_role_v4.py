...
class AdminUpdateUserRoleV4(Operation):
    ...
    def with_body(self, value: ModelAddUserRoleV4Request) -> AdminUpdateUserRoleV4:
        self.body = value
        return self

    def with_namespace(self, value: str) -> AdminUpdateUserRoleV4:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> AdminUpdateUserRoleV4:
        self.user_id = value
        return self
    ...
    @classmethod
    def create(
        cls, body: ModelAddUserRoleV4Request, namespace: str, user_id: str, **kwargs
