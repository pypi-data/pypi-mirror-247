...
class AddUserRole(Operation):
    ...
    _url: str = "/iam/namespaces/{namespace}/users/{userId}/roles/{roleId}"
    _method: str = "POST"
    _consumes: List[str] = ["application/json", "text/plain"]
    ...
    def with_namespace(self, value: str) -> AddUserRole:
        self.namespace = value
        return self

    def with_role_id(self, value: str) -> AddUserRole:
        self.role_id = value
        return self

    def with_user_id(self, value: str) -> AddUserRole:
        self.user_id = value
        return self
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> AddUserRole:
        instance = cls()
