...
class BanUser(Operation):
    ...
    _url: str = "/iam/namespaces/{namespace}/users/{userId}/ban"
    _method: str = "POST"
    ...
    def with_body(self, value: ModelBanCreateRequest) -> BanUser:
        self.body = value
        return self

    def with_namespace(self, value: str) -> BanUser:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> BanUser:
        self.user_id = value
        return self
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = ModelBanCreateRequest()
    ...
    @classmethod
    def create(
        cls, body: ModelBanCreateRequest, namespace: str, user_id: str, **kwargs
    ) -> BanUser:
        instance = cls()
        instance.body = body
