...
class AdminCreateUserRolesV2(Operation):
    ...
    **Endpoint migration guide**
    ...
    _url: str = "/iam/v2/admin/namespaces/{namespace}/users/{userId}/roles"
    _method: str = "POST"
    ...
    def with_body(self, value: List[str]) -> AdminCreateUserRolesV2:
        self.body = value
        return self

    def with_namespace(self, value: str) -> AdminCreateUserRolesV2:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> AdminCreateUserRolesV2:
        self.user_id = value
        return self
    ...
    @classmethod
    def create(
        cls, body: List[str], namespace: str, user_id: str, **kwargs
