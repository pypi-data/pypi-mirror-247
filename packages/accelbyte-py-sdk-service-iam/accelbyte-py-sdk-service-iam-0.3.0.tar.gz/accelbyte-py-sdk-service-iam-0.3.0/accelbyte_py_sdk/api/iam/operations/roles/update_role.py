...
class UpdateRole(Operation):
    ...
    body: ModelRoleUpdateRequest  # REQUIRED in [body]
    ...
    def with_body(self, value: ModelRoleUpdateRequest) -> UpdateRole:
        self.body = value
        return self

    def with_role_id(self, value: str) -> UpdateRole:
        self.role_id = value
        return self
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = ModelRoleUpdateRequest()
    ...
    @classmethod
    def create(cls, body: ModelRoleUpdateRequest, role_id: str, **kwargs) -> UpdateRole:
        instance = cls()
        instance.body = body
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> UpdateRole:
        instance = cls()
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelRoleUpdateRequest.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = ModelRoleUpdateRequest()
