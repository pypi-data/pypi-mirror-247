...
class AdminResetPasswordV3(Operation):
    ...
    _url: str = "/iam/v3/admin/namespaces/{namespace}/users/{userId}/password"
    _method: str = "PUT"
    ...
    def with_namespace(self, value: str) -> AdminResetPasswordV3:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> AdminResetPasswordV3:
        self.user_id = value
        return self
