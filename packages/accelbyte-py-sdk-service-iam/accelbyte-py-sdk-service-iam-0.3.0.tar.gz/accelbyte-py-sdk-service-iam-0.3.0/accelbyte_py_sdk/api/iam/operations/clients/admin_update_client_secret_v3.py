...
class AdminUpdateClientSecretV3(Operation):
    ...
    _url: str = "/iam/v3/admin/namespaces/{namespace}/{clientId}/secret"
    _method: str = "PUT"
    ...
    body: ClientmodelV3ClientUpdateSecretRequest  # REQUIRED in [body]
    ...
    def with_body(
        self, value: ClientmodelV3ClientUpdateSecretRequest
    ) -> AdminUpdateClientSecretV3:
        self.body = value
        return self

    def with_client_id(self, value: str) -> AdminUpdateClientSecretV3:
        self.client_id = value
        return self

    def with_namespace(self, value: str) -> AdminUpdateClientSecretV3:
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = ClientmodelV3ClientUpdateSecretRequest()
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ClientmodelV3ClientUpdateSecretRequest.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = ClientmodelV3ClientUpdateSecretRequest()
