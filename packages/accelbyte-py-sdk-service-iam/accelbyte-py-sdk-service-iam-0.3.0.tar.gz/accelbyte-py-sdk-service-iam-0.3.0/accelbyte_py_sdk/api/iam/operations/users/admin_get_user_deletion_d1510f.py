...
class AdminGetUserDeletionStatusV3(Operation):
    ...
    def with_namespace(self, value: str) -> AdminGetUserDeletionStatusV3:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> AdminGetUserDeletionStatusV3:
        self.user_id = value
        return self
    ...
    def parse_response(
        ...
        Union[None, ModelUserDeletionStatusResponse],
        ...
        if code == 200:
            return ModelUserDeletionStatusResponse.create_from_dict(content), None
        if code == 401:
