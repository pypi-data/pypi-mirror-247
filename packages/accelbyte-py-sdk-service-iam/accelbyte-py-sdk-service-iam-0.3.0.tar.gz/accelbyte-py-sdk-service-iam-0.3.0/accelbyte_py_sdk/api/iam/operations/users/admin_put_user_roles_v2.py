...
class AdminPutUserRolesV2(Operation):
    ...
    **Endpoint migration guide**
    ...
    def with_body(self, value: List[str]) -> AdminPutUserRolesV2:
        self.body = value
        return self

    def with_namespace(self, value: str) -> AdminPutUserRolesV2:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> AdminPutUserRolesV2:
        self.user_id = value
        return self
