...
class AdminGetUserByEmailAddressV3(Operation):
    ...
    _url: str = "/iam/v3/admin/namespaces/{namespace}/users"
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    email_address: str  # OPTIONAL in [query]
    ...
    def with_namespace(self, value: str) -> AdminGetUserByEmailAddressV3:
        self.namespace = value
        return self

    def with_email_address(self, value: str) -> AdminGetUserByEmailAddressV3:
    ...
    @classmethod
    def create(
        cls, namespace: str, email_address: Optional[str] = None, **kwargs
