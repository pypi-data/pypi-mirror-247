...
class GetListCountryAgeRestriction(Operation):
    ...
    **Endpoint migration guide**
    ...
    _url: str = "/iam/v2/admin/namespaces/{namespace}/countries/agerestrictions"
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    def with_namespace(self, value: str) -> GetListCountryAgeRestriction:
    ...
    def parse_response(
        ...
        Union[None, List[AccountcommonCountryAgeRestriction]],
