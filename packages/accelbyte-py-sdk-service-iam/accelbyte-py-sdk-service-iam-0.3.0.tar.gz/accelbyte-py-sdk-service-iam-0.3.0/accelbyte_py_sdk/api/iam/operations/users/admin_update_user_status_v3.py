...
class AdminUpdateUserStatusV3(Operation):
    ...
    _url: str = "/iam/v3/admin/namespaces/{namespace}/users/{userId}/status"
    _method: str = "PATCH"
    ...
    body: ModelUpdateUserStatusRequest  # REQUIRED in [body]
    ...
    def with_body(self, value: ModelUpdateUserStatusRequest) -> AdminUpdateUserStatusV3:
        self.body = value
        return self

    def with_namespace(self, value: str) -> AdminUpdateUserStatusV3:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> AdminUpdateUserStatusV3:
        self.user_id = value
        return self
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = ModelUpdateUserStatusRequest()
    ...
    @classmethod
    def create(
        cls, body: ModelUpdateUserStatusRequest, namespace: str, user_id: str, **kwargs
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelUpdateUserStatusRequest.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = ModelUpdateUserStatusRequest()
