...
class AdminGetDeviceBansV4(Operation):
    ...
    _url: str = "/iam/v4/admin/namespaces/{namespace}/devices/{deviceId}/bans"
    _method: str = "GET"
    ...
    device_id: str  # REQUIRED in [path]
    ...
    def with_device_id(self, value: str) -> AdminGetDeviceBansV4:
        self.device_id = value
        return self

    def with_namespace(self, value: str) -> AdminGetDeviceBansV4:
    ...
    def parse_response(
        ...
        Union[None, ModelDeviceBansResponseV4],
        ...
        if code == 200:
            return ModelDeviceBansResponseV4.create_from_dict(content), None
        if code == 400:
    ...
    @classmethod
    def create(cls, device_id: str, namespace: str, **kwargs) -> AdminGetDeviceBansV4:
        instance = cls()
