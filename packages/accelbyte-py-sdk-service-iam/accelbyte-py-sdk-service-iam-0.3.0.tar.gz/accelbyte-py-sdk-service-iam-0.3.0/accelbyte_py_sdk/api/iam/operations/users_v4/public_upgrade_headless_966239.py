...
class PublicUpgradeHeadlessAccountV4(Operation):
    ...
    _url: str = "/iam/v4/public/namespaces/{namespace}/users/me/headless/verify"
    _method: str = "POST"
    ...
    def with_body(
        self, value: AccountUpgradeHeadlessAccountRequestV4
    ) -> PublicUpgradeHeadlessAccountV4:
        self.body = value
        return self

    def with_namespace(self, value: str) -> PublicUpgradeHeadlessAccountV4:
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = AccountUpgradeHeadlessAccountRequestV4()
    ...
    def parse_response(
        ...
        Union[None, AccountUserResponseV4], Union[None, HttpResponse, RestErrorResponse]
    ]:
    ...
    @classmethod
    def create(
        cls, body: AccountUpgradeHeadlessAccountRequestV4, namespace: str, **kwargs
    ) -> PublicUpgradeHeadlessAccountV4:
        instance = cls()
        instance.body = body
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = AccountUpgradeHeadlessAccountRequestV4.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = AccountUpgradeHeadlessAccountRequestV4()
