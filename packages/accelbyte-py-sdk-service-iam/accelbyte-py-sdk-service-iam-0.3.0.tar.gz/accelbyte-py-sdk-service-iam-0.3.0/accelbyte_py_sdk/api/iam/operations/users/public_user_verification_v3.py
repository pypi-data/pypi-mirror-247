...
class PublicUserVerificationV3(Operation):
    ...
    def with_body(
        self, value: ModelUserVerificationRequestV3
    ...
    @classmethod
    def create(
        cls, body: ModelUserVerificationRequestV3, namespace: str, **kwargs
    ) -> PublicUserVerificationV3:
        instance = cls()
        instance.body = body
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelUserVerificationRequestV3.create_from_dict(
