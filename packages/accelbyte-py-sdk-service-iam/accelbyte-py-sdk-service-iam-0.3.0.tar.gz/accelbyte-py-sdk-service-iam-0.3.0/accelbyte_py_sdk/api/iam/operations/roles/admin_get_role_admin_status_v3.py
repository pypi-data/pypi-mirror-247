...
class AdminGetRoleAdminStatusV3(Operation):
    ...
    def with_role_id(self, value: str) -> AdminGetRoleAdminStatusV3:
        self.role_id = value
        return self
    ...
    def parse_response(
        ...
        Union[None, ModelRoleAdminStatusResponseV3],
        ...
        if code == 200:
            return ModelRoleAdminStatusResponseV3.create_from_dict(content), None
        if code == 400:
    ...
    @classmethod
    def create(cls, role_id: str, **kwargs) -> AdminGetRoleAdminStatusV3:
        instance = cls()
