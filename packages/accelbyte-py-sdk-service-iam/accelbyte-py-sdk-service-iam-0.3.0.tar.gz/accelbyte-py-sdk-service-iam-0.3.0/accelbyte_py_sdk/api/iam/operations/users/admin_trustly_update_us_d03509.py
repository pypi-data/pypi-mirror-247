...
class AdminTrustlyUpdateUserIdentity(Operation):
    ...
    _url: str = "/iam/v3/admin/namespaces/{namespace}/users/{userId}/trustly/identity"
    _method: str = "PATCH"
    ...
    body: ModelUserIdentityUpdateRequestV3  # REQUIRED in [body]
    ...
    def with_body(
        self, value: ModelUserIdentityUpdateRequestV3
    ) -> AdminTrustlyUpdateUserIdentity:
        self.body = value
        return self

    def with_namespace(self, value: str) -> AdminTrustlyUpdateUserIdentity:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> AdminTrustlyUpdateUserIdentity:
        self.user_id = value
        return self
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = ModelUserIdentityUpdateRequestV3()
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelUserIdentityUpdateRequestV3.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = ModelUserIdentityUpdateRequestV3()
