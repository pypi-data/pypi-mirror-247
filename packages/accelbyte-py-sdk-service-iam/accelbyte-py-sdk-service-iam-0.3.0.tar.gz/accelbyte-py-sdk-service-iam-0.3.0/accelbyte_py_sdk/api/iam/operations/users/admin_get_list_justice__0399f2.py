...
class AdminGetListJusticePlatformAccounts(Operation):
    ...
    _url: str = "/iam/v3/admin/namespaces/{namespace}/users/{userId}/platforms/justice"
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    def with_namespace(self, value: str) -> AdminGetListJusticePlatformAccounts:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> AdminGetListJusticePlatformAccounts:
        self.user_id = value
        return self
