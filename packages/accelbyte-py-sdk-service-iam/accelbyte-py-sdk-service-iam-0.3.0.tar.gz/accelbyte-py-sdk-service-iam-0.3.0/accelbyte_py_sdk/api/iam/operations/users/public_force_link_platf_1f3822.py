...
class PublicForceLinkPlatformWithProgression(Operation):
    ...
    _url: str = "/iam/v3/public/namespaces/{namespace}/users/{userId}/platforms/linkWithProgression"
    _method: str = "POST"
    ...
    body: ModelLinkPlatformAccountWithProgressionRequest  # REQUIRED in [body]
    ...
    def with_body(
        self, value: ModelLinkPlatformAccountWithProgressionRequest
    ) -> PublicForceLinkPlatformWithProgression:
        self.body = value
        return self

    def with_namespace(self, value: str) -> PublicForceLinkPlatformWithProgression:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> PublicForceLinkPlatformWithProgression:
        self.user_id = value
        return self
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = ModelLinkPlatformAccountWithProgressionRequest()
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = (
                ModelLinkPlatformAccountWithProgressionRequest.create_from_dict(
                    dict_["body"], include_empty=include_empty
                )
            )
        elif include_empty:
            instance.body = ModelLinkPlatformAccountWithProgressionRequest()
