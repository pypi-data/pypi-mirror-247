...
class AdminUpdateUserDeletionStatusV3(Operation):
    ...
    _url: str = "/iam/v3/admin/namespaces/{namespace}/users/{userId}/deletion/status"
    _method: str = "PATCH"
    ...
    body: ModelUpdateUserDeletionStatusRequest  # REQUIRED in [body]
    ...
    def with_body(
        self, value: ModelUpdateUserDeletionStatusRequest
    ) -> AdminUpdateUserDeletionStatusV3:
        self.body = value
        return self

    def with_namespace(self, value: str) -> AdminUpdateUserDeletionStatusV3:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> AdminUpdateUserDeletionStatusV3:
        self.user_id = value
        return self
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = ModelUpdateUserDeletionStatusRequest()
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelUpdateUserDeletionStatusRequest.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = ModelUpdateUserDeletionStatusRequest()
