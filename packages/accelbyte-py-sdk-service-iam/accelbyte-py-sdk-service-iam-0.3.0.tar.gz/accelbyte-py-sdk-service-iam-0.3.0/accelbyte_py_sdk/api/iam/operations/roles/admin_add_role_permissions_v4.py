...
class AdminAddRolePermissionsV4(Operation):
    ...
    def with_body(self, value: AccountcommonPermissionsV3) -> AdminAddRolePermissionsV4:
        self.body = value
        return self

    def with_role_id(self, value: str) -> AdminAddRolePermissionsV4:
        self.role_id = value
        return self
    ...
    @classmethod
    def create(
        cls, body: AccountcommonPermissionsV3, role_id: str, **kwargs
