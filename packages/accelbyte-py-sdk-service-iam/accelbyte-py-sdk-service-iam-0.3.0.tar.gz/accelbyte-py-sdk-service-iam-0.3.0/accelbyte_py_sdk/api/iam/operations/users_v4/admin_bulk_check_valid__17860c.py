...
class AdminBulkCheckValidUserIDV4(Operation):
    ...
    def with_body(
        self, value: ModelCheckValidUserIDRequestV4
    ...
    def parse_response(
        ...
        Union[None, ModelListValidUserIDResponseV4],
    ...
    @classmethod
    def create(
        cls, body: ModelCheckValidUserIDRequestV4, namespace: str, **kwargs
    ) -> AdminBulkCheckValidUserIDV4:
        instance = cls()
        instance.body = body
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelCheckValidUserIDRequestV4.create_from_dict(
