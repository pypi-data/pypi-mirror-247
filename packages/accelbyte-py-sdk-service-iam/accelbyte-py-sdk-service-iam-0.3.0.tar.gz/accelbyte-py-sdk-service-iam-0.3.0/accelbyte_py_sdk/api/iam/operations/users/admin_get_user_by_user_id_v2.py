...
class AdminGetUserByUserIdV2(Operation):
    ...
    **Endpoint migration guide**
    ...
    def with_namespace(self, value: str) -> AdminGetUserByUserIdV2:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> AdminGetUserByUserIdV2:
        self.user_id = value
        return self
    ...
    @classmethod
    def create(cls, namespace: str, user_id: str, **kwargs) -> AdminGetUserByUserIdV2:
        instance = cls()
