...
class PublicGenerateMyAuthenticatorKeyV4(Operation):
    ...
    _url: str = "/iam/v4/public/namespaces/{namespace}/users/me/mfa/authenticator/key"
    _method: str = "POST"
    _consumes: List[str] = []
    ...
    def with_namespace(self, value: str) -> PublicGenerateMyAuthenticatorKeyV4:
    ...
    @classmethod
    def create(cls, namespace: str, **kwargs) -> PublicGenerateMyAuthenticatorKeyV4:
        instance = cls()
