...
class PublicGetUserInformationV3(Operation):
    ...
    _url: str = "/iam/v3/public/namespaces/{namespace}/users/{userId}/information"
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    def with_namespace(self, value: str) -> PublicGetUserInformationV3:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> PublicGetUserInformationV3:
        self.user_id = value
        return self
    ...
    def parse_response(
        ...
        Union[None, AccountcommonUserInformationV3],
        ...
        if code == 200:
            return AccountcommonUserInformationV3.create_from_dict(content), None
        if code == 401:
