...
class PublicGetCountryListV3(Operation):
    ...
    _url: str = "/iam/v3/public/namespaces/{namespace}/countries"
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    def with_namespace(self, value: str) -> PublicGetCountryListV3:
    ...
    @classmethod
    def create(cls, namespace: str, **kwargs) -> PublicGetCountryListV3:
        instance = cls()
