...
class AdminBulkUpdateUserAccountTypeV4(Operation):
    ...
    _url: str = "/iam/v4/admin/namespaces/{namespace}/users/bulk/accountType"
    _method: str = "PATCH"
    ...
    body: ModelBulkAccountTypeUpdateRequestV4  # REQUIRED in [body]
    ...
    def with_body(
        self, value: ModelBulkAccountTypeUpdateRequestV4
    ) -> AdminBulkUpdateUserAccountTypeV4:
        self.body = value
        return self

    def with_namespace(self, value: str) -> AdminBulkUpdateUserAccountTypeV4:
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = ModelBulkAccountTypeUpdateRequestV4()
    ...
    @classmethod
    def create(
        cls, body: ModelBulkAccountTypeUpdateRequestV4, namespace: str, **kwargs
    ) -> AdminBulkUpdateUserAccountTypeV4:
        instance = cls()
        instance.body = body
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelBulkAccountTypeUpdateRequestV4.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = ModelBulkAccountTypeUpdateRequestV4()
