...
class RemoveRoleManagers(Operation):
    ...
    def with_body(self, value: ModelRoleManagersRequest) -> RemoveRoleManagers:
        self.body = value
        return self

    def with_role_id(self, value: str) -> RemoveRoleManagers:
        self.role_id = value
        return self
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = ModelRoleManagersRequest()
    ...
    @classmethod
    def create(
        cls, body: ModelRoleManagersRequest, role_id: str, **kwargs
    ) -> RemoveRoleManagers:
        instance = cls()
        instance.body = body
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelRoleManagersRequest.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = ModelRoleManagersRequest()
