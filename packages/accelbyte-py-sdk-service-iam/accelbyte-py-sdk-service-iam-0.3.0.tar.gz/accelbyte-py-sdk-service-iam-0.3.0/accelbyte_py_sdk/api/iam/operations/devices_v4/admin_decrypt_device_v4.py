...
class AdminDecryptDeviceV4(Operation):
    ...
    _url: str = "/iam/v4/admin/namespaces/{namespace}/devices/{deviceId}/decrypt"
    _method: str = "GET"
    ...
    def with_device_id(self, value: str) -> AdminDecryptDeviceV4:
        self.device_id = value
        return self

    def with_namespace(self, value: str) -> AdminDecryptDeviceV4:
    ...
    def parse_response(
        ...
        Union[None, ModelDeviceIDDecryptResponseV4],
        ...
        if code == 200:
            return ModelDeviceIDDecryptResponseV4.create_from_dict(content), None
        if code == 400:
    ...
    @classmethod
    def create(cls, device_id: str, namespace: str, **kwargs) -> AdminDecryptDeviceV4:
        instance = cls()
