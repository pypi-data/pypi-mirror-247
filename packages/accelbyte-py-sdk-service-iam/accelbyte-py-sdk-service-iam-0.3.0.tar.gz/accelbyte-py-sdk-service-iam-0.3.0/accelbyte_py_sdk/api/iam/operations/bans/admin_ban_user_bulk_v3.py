...
class AdminBanUserBulkV3(Operation):
    ...
    body: ModelBulkBanCreateRequestV3  # REQUIRED in [body]
    ...
    def with_body(self, value: ModelBulkBanCreateRequestV3) -> AdminBanUserBulkV3:
        self.body = value
        return self

    def with_namespace(self, value: str) -> AdminBanUserBulkV3:
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = ModelBulkBanCreateRequestV3()
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelBulkBanCreateRequestV3.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = ModelBulkBanCreateRequestV3()
