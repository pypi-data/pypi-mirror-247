...
class AdminUnbanUserBulkV3(Operation):
    ...
    _url: str = "/iam/v3/admin/namespaces/{namespace}/bans/users/disabled"
    _method: str = "PATCH"
    ...
    body: ModelBulkUnbanCreateRequestV3  # REQUIRED in [body]
    ...
    def with_body(self, value: ModelBulkUnbanCreateRequestV3) -> AdminUnbanUserBulkV3:
        self.body = value
        return self

    def with_namespace(self, value: str) -> AdminUnbanUserBulkV3:
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = ModelBulkUnbanCreateRequestV3()
    ...
    def parse_response(
        ...
        Union[None, ModelListBulkUserBanResponseV3],
        ...
        if code == 201:
            return ModelListBulkUserBanResponseV3.create_from_dict(content), None
        if code == 400:
    ...
    @classmethod
    def create(
        cls, body: ModelBulkUnbanCreateRequestV3, namespace: str, **kwargs
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelBulkUnbanCreateRequestV3.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = ModelBulkUnbanCreateRequestV3()
