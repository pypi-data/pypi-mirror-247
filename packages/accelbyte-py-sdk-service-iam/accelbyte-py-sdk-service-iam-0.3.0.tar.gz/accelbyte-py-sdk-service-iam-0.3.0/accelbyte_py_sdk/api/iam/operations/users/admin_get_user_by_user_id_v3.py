...
class AdminGetUserByUserIdV3(Operation):
    ...
    def with_namespace(self, value: str) -> AdminGetUserByUserIdV3:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> AdminGetUserByUserIdV3:
        self.user_id = value
        return self
    ...
    @classmethod
    def create(cls, namespace: str, user_id: str, **kwargs) -> AdminGetUserByUserIdV3:
        instance = cls()
