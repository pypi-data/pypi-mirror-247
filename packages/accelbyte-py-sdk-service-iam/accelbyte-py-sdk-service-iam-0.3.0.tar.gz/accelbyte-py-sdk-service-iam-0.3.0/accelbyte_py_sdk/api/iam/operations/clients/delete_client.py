...
class DeleteClient(Operation):
    ...
    **Endpoint migration guide**
    ...
    def with_client_id(self, value: str) -> DeleteClient:
    ...
    @classmethod
    def create(cls, client_id: str, **kwargs) -> DeleteClient:
        instance = cls()
        instance.client_id = client_id
        return instance

    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> DeleteClient:
        instance = cls()
