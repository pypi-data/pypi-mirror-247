...
class AdminDeleteUserInformationV3(Operation):
    ...
    _url: str = "/iam/v3/admin/namespaces/{namespace}/users/{userId}/information"
    _method: str = "DELETE"
    _consumes: List[str] = []
    ...
    def with_namespace(self, value: str) -> AdminDeleteUserInformationV3:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> AdminDeleteUserInformationV3:
        self.user_id = value
        return self
