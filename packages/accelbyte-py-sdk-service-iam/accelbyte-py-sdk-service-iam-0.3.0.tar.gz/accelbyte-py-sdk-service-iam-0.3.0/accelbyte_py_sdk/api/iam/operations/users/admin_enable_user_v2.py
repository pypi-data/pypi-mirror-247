...
class AdminEnableUserV2(Operation):
    ...
    **Endpoint migration guide**
    ...
    _url: str = "/iam/v2/admin/namespaces/{namespace}/users/{userId}/enable"
    _method: str = "PUT"
    _consumes: List[str] = ["*/*"]
    ...
    def with_namespace(self, value: str) -> AdminEnableUserV2:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> AdminEnableUserV2:
        self.user_id = value
        return self
    ...
    @classmethod
    def create(cls, namespace: str, user_id: str, **kwargs) -> AdminEnableUserV2:
        instance = cls()
