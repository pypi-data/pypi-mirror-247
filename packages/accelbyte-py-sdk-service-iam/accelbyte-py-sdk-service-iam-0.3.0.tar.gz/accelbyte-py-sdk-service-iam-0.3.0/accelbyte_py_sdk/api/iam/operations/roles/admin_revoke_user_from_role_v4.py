...
class AdminRevokeUserFromRoleV4(Operation):
    ...
    def with_body(self, value: ModelRevokeUserV4Request) -> AdminRevokeUserFromRoleV4:
        self.body = value
        return self

    def with_role_id(self, value: str) -> AdminRevokeUserFromRoleV4:
        self.role_id = value
        return self
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = ModelRevokeUserV4Request()
    ...
    @classmethod
    def create(
        cls, body: ModelRevokeUserV4Request, role_id: str, **kwargs
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelRevokeUserV4Request.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = ModelRevokeUserV4Request()
