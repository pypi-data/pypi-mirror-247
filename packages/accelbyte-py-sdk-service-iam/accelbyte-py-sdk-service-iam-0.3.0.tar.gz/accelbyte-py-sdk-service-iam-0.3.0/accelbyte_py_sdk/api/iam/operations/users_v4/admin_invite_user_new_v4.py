...
class AdminInviteUserNewV4(Operation):
    ...
    _url: str = "/iam/v4/admin/users/invite"
    _method: str = "POST"
    ...
    def with_body(self, value: ModelInviteUserRequestV4) -> AdminInviteUserNewV4:
        self.body = value
        return self
    ...
    @classmethod
    def create(cls, body: ModelInviteUserRequestV4, **kwargs) -> AdminInviteUserNewV4:
        instance = cls()
        instance.body = body
        return instance
