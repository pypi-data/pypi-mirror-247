...
class PublicEnableMyBackupCodesV4(Operation):
    ...
    _url: str = "/iam/v4/public/namespaces/{namespace}/users/me/mfa/backupCode/enable"
    _method: str = "POST"
    _consumes: List[str] = []
    ...
    def with_namespace(self, value: str) -> PublicEnableMyBackupCodesV4:
    ...
    def parse_response(
        ...
        Union[None, ModelBackupCodesResponseV4],
    ...
    @classmethod
    def create(cls, namespace: str, **kwargs) -> PublicEnableMyBackupCodesV4:
        instance = cls()
