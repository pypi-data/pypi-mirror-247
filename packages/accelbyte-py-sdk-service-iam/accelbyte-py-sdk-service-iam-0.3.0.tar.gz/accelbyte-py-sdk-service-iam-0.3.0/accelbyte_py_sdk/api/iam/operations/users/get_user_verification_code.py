...
class GetUserVerificationCode(Operation):
    ...
    _url: str = "/iam/v3/admin/namespaces/{namespace}/users/{userId}/codes"
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    def with_namespace(self, value: str) -> GetUserVerificationCode:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> GetUserVerificationCode:
        self.user_id = value
        return self
    ...
    @classmethod
    def create(cls, namespace: str, user_id: str, **kwargs) -> GetUserVerificationCode:
        instance = cls()
