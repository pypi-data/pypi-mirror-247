...
class EnableUser(Operation):
    ...
    _url: str = "/iam/namespaces/{namespace}/users/{userId}/enable"
    _method: str = "PUT"
    _consumes: List[str] = ["*/*"]
    ...
    def with_namespace(self, value: str) -> EnableUser:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> EnableUser:
        self.user_id = value
        return self
    ...
    @classmethod
    def create(cls, namespace: str, user_id: str, **kwargs) -> EnableUser:
        instance = cls()
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> EnableUser:
        instance = cls()
