...
class PublicListUserAllPlatformAccountsDistinctV3(Operation):
    ...
    _url: str = "/iam/v3/public/namespaces/{namespace}/users/{userId}/distinctPlatforms"
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    def with_namespace(self, value: str) -> PublicListUserAllPlatformAccountsDistinctV3:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> PublicListUserAllPlatformAccountsDistinctV3:
        self.user_id = value
        return self
    ...
    def parse_response(
        ...
        Union[None, AccountcommonDistinctPlatformResponseV3],
        ...
        if code == 200:
            return (
                AccountcommonDistinctPlatformResponseV3.create_from_dict(content),
                None,
            )
        if code == 400:
