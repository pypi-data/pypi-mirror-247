...
class AdminGetDevicesByUserV4(Operation):
    ...
    _url: str = "/iam/v4/admin/namespaces/{namespace}/devices"
    _method: str = "GET"
    ...
    def with_namespace(self, value: str) -> AdminGetDevicesByUserV4:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> AdminGetDevicesByUserV4:
        self.user_id = value
        return self
    ...
    def parse_response(
        ...
        Union[None, ModelDevicesResponseV4],
        ...
        if code == 200:
            return ModelDevicesResponseV4.create_from_dict(content), None
        if code == 400:
    ...
    @classmethod
    def create(
        cls, namespace: str, user_id: Optional[str] = None, **kwargs
