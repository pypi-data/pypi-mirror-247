...
class GetListBanReason(Operation):
    ...
    def parse_response(
        ...
        Union[None, AccountcommonBanReasons],
        ...
        if code == 200:
            return AccountcommonBanReasons.create_from_dict(content), None
        if code == 401:
    ...
    @classmethod
    def create(cls, **kwargs) -> GetListBanReason:
        instance = cls()
        return instance
