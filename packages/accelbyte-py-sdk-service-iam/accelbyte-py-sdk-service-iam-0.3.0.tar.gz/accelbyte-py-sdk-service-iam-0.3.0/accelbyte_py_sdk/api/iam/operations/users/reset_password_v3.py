...
class ResetPasswordV3(Operation):
    ...
    _url: str = "/iam/v3/public/namespaces/{namespace}/users/reset"
    _method: str = "POST"
    ...
    def with_body(self, value: ModelResetPasswordRequestV3) -> ResetPasswordV3:
        self.body = value
        return self

    def with_namespace(self, value: str) -> ResetPasswordV3:
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "body") and self.body:
            ...
            result["body"] = ModelResetPasswordRequestV3()
    ...
    @classmethod
    def create(
        cls, body: ModelResetPasswordRequestV3, namespace: str, **kwargs
    ) -> ResetPasswordV3:
        instance = cls()
        instance.body = body
    ...
    def create_from_dict(
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ModelResetPasswordRequestV3.create_from_dict(
                dict_["body"], include_empty=include_empty
            )
        elif include_empty:
            instance.body = ModelResetPasswordRequestV3()
