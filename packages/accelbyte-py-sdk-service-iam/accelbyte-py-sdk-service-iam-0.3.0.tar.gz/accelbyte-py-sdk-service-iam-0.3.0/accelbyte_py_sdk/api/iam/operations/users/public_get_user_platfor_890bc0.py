...
class PublicGetUserPlatformAccountsV3(Operation):
    ...
    _url: str = "/iam/v3/public/namespaces/{namespace}/users/{userId}/platforms"
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    def with_namespace(self, value: str) -> PublicGetUserPlatformAccountsV3:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> PublicGetUserPlatformAccountsV3:
        self.user_id = value
        return self

    def with_after(self, value: str) -> PublicGetUserPlatformAccountsV3:
        self.after = value
        return self

    def with_before(self, value: str) -> PublicGetUserPlatformAccountsV3:
        self.before = value
        return self

    def with_limit(self, value: int) -> PublicGetUserPlatformAccountsV3:
        self.limit = value
        return self

    def with_platform_id(self, value: str) -> PublicGetUserPlatformAccountsV3:
