...
class ModelRoleNamesResponseV3(Model):
    ...
    @classmethod
    def create(
        cls, data: List[str], paging: AccountcommonPaginationV3, **kwargs
    ...
    def create_many_from_dict(
        cls, dict_: dict, include_empty: bool = False
    ) -> Dict[str, ModelRoleNamesResponseV3]:
        return (
    ...
    def create_from_any(
        ...
        ModelRoleNamesResponseV3,
        List[ModelRoleNamesResponseV3],
        Dict[Any, ModelRoleNamesResponseV3],
    ]:
        if many:
