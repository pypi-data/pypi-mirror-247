...
class ModelCheckValidUserIDRequestV4(Model):
    ...
    @classmethod
    def create(cls, user_ids: List[str], **kwargs) -> ModelCheckValidUserIDRequestV4:
        instance = cls()
    ...
    def create_many_from_dict(
        cls, dict_: dict, include_empty: bool = False
    ) -> Dict[str, ModelCheckValidUserIDRequestV4]:
        return (
    ...
    ) -> List[ModelCheckValidUserIDRequestV4]:
        return (
    ...
    def create_from_any(
        ...
        ModelCheckValidUserIDRequestV4,
        List[ModelCheckValidUserIDRequestV4],
        Dict[Any, ModelCheckValidUserIDRequestV4],
    ]:
        if many:
