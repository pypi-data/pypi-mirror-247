...
class ModelListValidUserIDResponseV4(Model):
    ...
    def with_data(
        self, value: List[ModelValidUserIDResponseV4]
    ...
    @classmethod
    def create(
        cls, data: List[ModelValidUserIDResponseV4], **kwargs
    ) -> ModelListValidUserIDResponseV4:
        instance = cls()
        instance.data = data
        return instance
    ...
    def create_from_dict(
        ...
        if "data" in dict_ and dict_["data"] is not None:
            instance.data = [
                ModelValidUserIDResponseV4.create_from_dict(
    ...
    def create_many_from_dict(
        cls, dict_: dict, include_empty: bool = False
    ) -> Dict[str, ModelListValidUserIDResponseV4]:
        return (
    ...
    ) -> List[ModelListValidUserIDResponseV4]:
        return (
    ...
    def create_from_any(
        ...
        ModelListValidUserIDResponseV4,
        List[ModelListValidUserIDResponseV4],
        Dict[Any, ModelListValidUserIDResponseV4],
    ]:
        if many:
