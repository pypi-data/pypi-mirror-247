...
class ModelValidationDetail(Model):
    """Model validation detail (model.ValidationDetail)
    ...
    def with_allow_all_special_characters(self, value: bool) -> ModelValidationDetail:
        self.allow_all_special_characters = value
        return self

    def with_allow_digit(self, value: bool) -> ModelValidationDetail:
        self.allow_digit = value
        return self

    def with_allow_letter(self, value: bool) -> ModelValidationDetail:
        self.allow_letter = value
        return self

    def with_allow_space(self, value: bool) -> ModelValidationDetail:
    ...
    def with_is_custom_regex(self, value: bool) -> ModelValidationDetail:
        self.is_custom_regex = value
        return self

    def with_letter_case(self, value: str) -> ModelValidationDetail:
        self.letter_case = value
        return self

    def with_max_length(self, value: int) -> ModelValidationDetail:
        self.max_length = value
        return self

    def with_max_repeating_alpha_num(self, value: int) -> ModelValidationDetail:
        self.max_repeating_alpha_num = value
        return self

    def with_max_repeating_special_character(self, value: int) -> ModelValidationDetail:
        self.max_repeating_special_character = value
        return self

    def with_min_char_type(self, value: int) -> ModelValidationDetail:
        self.min_char_type = value
        return self

    def with_min_length(self, value: int) -> ModelValidationDetail:
        self.min_length = value
        return self

    def with_regex(self, value: str) -> ModelValidationDetail:
        self.regex = value
        return self

    def with_special_character_location(self, value: str) -> ModelValidationDetail:
        self.special_character_location = value
        return self

    def with_special_characters(self, value: List[str]) -> ModelValidationDetail:
