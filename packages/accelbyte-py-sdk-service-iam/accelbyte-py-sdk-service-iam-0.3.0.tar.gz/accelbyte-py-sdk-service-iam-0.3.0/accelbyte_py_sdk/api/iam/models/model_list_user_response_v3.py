...
class ModelListUserResponseV3(Model):
    """Model list user response V3 (model.ListUserResponseV3)
    ...
    @classmethod
    def create(
        cls, data: List[ModelUserResponseV3], **kwargs
    ...
    def create_many_from_dict(
        cls, dict_: dict, include_empty: bool = False
    ) -> Dict[str, ModelListUserResponseV3]:
        return (
    ...
    def create_from_any(
        ...
        ModelListUserResponseV3,
        List[ModelListUserResponseV3],
        Dict[Any, ModelListUserResponseV3],
    ]:
        if many:
