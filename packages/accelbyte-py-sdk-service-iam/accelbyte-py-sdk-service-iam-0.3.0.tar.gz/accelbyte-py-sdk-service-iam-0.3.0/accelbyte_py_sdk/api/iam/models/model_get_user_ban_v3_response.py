...
class ModelGetUserBanV3Response(Model):
    """Model get user ban V3 response (model.GetUserBanV3Response)

    Properties:
        data: (data) REQUIRED List[ModelUserBanResponseV3]
    ...
    data: List[ModelUserBanResponseV3]  # REQUIRED
    ...
    def create(
        cls,
        data: List[ModelUserBanResponseV3],
    ...
    def create_many_from_dict(
        cls, dict_: dict, include_empty: bool = False
    ) -> Dict[str, ModelGetUserBanV3Response]:
        return (
    ...
    ) -> List[ModelGetUserBanV3Response]:
        return (
    ...
    def create_from_any(
        ...
        ModelGetUserBanV3Response,
        List[ModelGetUserBanV3Response],
        Dict[Any, ModelGetUserBanV3Response],
    ]:
        if many:
