...
class ModelValidUserIDResponseV4(Model):
    ...
    @classmethod
    def create(cls, exists: bool, user_id: str, **kwargs) -> ModelValidUserIDResponseV4:
        instance = cls()
    ...
    def create_many_from_dict(
        cls, dict_: dict, include_empty: bool = False
    ) -> Dict[str, ModelValidUserIDResponseV4]:
        return (
    ...
    ) -> List[ModelValidUserIDResponseV4]:
        return (
    ...
    def create_from_any(
        ...
        ModelValidUserIDResponseV4,
        List[ModelValidUserIDResponseV4],
        Dict[Any, ModelValidUserIDResponseV4],
    ]:
        if many:
