...
class ModelAgeRestrictionRequest(Model):
    """Model age restriction request (model.AgeRestrictionRequest)
    ...
    def with_age_restriction(self, value: int) -> ModelAgeRestrictionRequest:
        self.age_restriction = value
        return self

    def with_enable(self, value: bool) -> ModelAgeRestrictionRequest:
        self.enable = value
        return self
    ...
    @classmethod
    def create(
        cls, age_restriction: int, enable: bool, **kwargs
    ) -> ModelAgeRestrictionRequest:
        instance = cls()
    ...
    def create_many_from_dict(
        cls, dict_: dict, include_empty: bool = False
    ) -> Dict[str, ModelAgeRestrictionRequest]:
        return (
    ...
    ) -> List[ModelAgeRestrictionRequest]:
        return (
    ...
    def create_from_any(
        ...
        ModelAgeRestrictionRequest,
        List[ModelAgeRestrictionRequest],
        Dict[Any, ModelAgeRestrictionRequest],
    ]:
        if many:
