...
class AccountcommonUserPlatformInfo(Model):
    ...
    @classmethod
    def create(
        cls, platform_id: str, platform_user_id: str, user_id: str, **kwargs
    ...
    def create_many_from_dict(
        cls, dict_: dict, include_empty: bool = False
    ) -> Dict[str, AccountcommonUserPlatformInfo]:
        return (
    ...
    ) -> List[AccountcommonUserPlatformInfo]:
        return (
    ...
    def create_from_any(
        ...
        AccountcommonUserPlatformInfo,
        List[AccountcommonUserPlatformInfo],
        Dict[Any, AccountcommonUserPlatformInfo],
    ]:
        if many:
