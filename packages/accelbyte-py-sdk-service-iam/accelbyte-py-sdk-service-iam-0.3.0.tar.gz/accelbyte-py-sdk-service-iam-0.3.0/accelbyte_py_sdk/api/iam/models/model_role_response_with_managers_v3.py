...
class ModelRoleResponseWithManagersV3(Model):
    ...
    def with_admin_role(self, value: bool) -> ModelRoleResponseWithManagersV3:
        self.admin_role = value
        return self

    def with_is_wildcard(self, value: bool) -> ModelRoleResponseWithManagersV3:
    ...
    def with_role_id(self, value: str) -> ModelRoleResponseWithManagersV3:
        self.role_id = value
        return self

    def with_role_name(self, value: str) -> ModelRoleResponseWithManagersV3:
    ...
    def create_many_from_dict(
        cls, dict_: dict, include_empty: bool = False
    ) -> Dict[str, ModelRoleResponseWithManagersV3]:
        return (
    ...
    ) -> List[ModelRoleResponseWithManagersV3]:
        return (
    ...
    def create_from_any(
        ...
        ModelRoleResponseWithManagersV3,
        List[ModelRoleResponseWithManagersV3],
        Dict[Any, ModelRoleResponseWithManagersV3],
    ]:
        if many:
