...
class FileHandlers:
    ...
    def construct_pcap_filter(cls, identifier_data):
        ...
        if identifier_data.c_rnti is not None and identifier_data.gnb_du_ue_f1ap_id != 'nan':
    ...
    def update_messages_with_identifier_key(cls, df, item_id):
        try:
            ...
            for identifier_data in identifiers:
                ...
                logging.debug(f"Identifier data: {identifier_data.c_rnti}")
                # Reset filter_conditions for each identifier_data
                filter_conditions = pd.Series(True, index=filtered_df.index)
                if identifier_data.c_rnti != 'nan' and identifier_data.gnb_du_ue_f1ap_id != 'nan':
                ...
                if identifier_data.gnb_cu_cp_ue_e1ap_id != 'nan' and identifier_data.gnb_cu_up_ue_e1ap_id != 'nan':
                    filter_conditions |= (
                            ((filtered_df['e1ap.GNB_CU_CP_UE_E1AP_ID'] == identifier_data.gnb_cu_cp_ue_e1ap_id) & (filtered_df['frame.time'] > identifier_data.frame_time))  |
                ...
                if identifier_data.ran_ue_ngap_id != 'nan' and identifier_data.amf_ue_ngap_id != 'nan':
                    filter_conditions |= (((filtered_df['ngap.RAN_UE_NGAP_ID'] == identifier_data.ran_ue_ngap_id) & (filtered_df['frame.time'] > identifier_data.frame_time))|
                ...
                if identifier_data.xnap_src_ran_id != 'nan':
                    filter_conditions |= ((filtered_df['xnap.NG_RANnodeUEXnAPID_src'] == identifier_data.xnap_src_ran_id) &
                                         (filtered_df['frame.time'] > identifier_data.frame_time))

                if identifier_data.xnap_trgt_ran_id != 'nan':
                    filter_conditions |= ((filtered_df['xnap.NG_RANnodeUEXnAPID_dst'] == identifier_data.xnap_trgt_ran_id) &
                            (filtered_df['frame.time'] > identifier_data.frame_time))

                if identifier_data.gnb_cu_cp_ue_e1ap_id != 'nan' and identifier_data.gnb_cu_up_ue_e1ap_id == 'nan':
                    filter_conditions |= (filtered_df[
                                              'e1ap.GNB_CU_CP_UE_E1AP_ID'] == identifier_data.gnb_cu_cp_ue_e1ap_id) \
                                         & (filtered_df['e1ap.GNB_CU_UP_UE_E1AP_ID'].isna() & (filtered_df['frame.time'] > identifier_data.frame_time))

                if identifier_data.ran_ue_ngap_id != 'nan' and identifier_data.amf_ue_ngap_id == 'nan':
                    filter_conditions |= ((filtered_df['ngap.RAN_UE_NGAP_ID'] == identifier_data.ran_ue_ngap_id) &
                                          filtered_df['ngap.AMF_UE_NGAP_ID'].isna() & (filtered_df['frame.time'] > identifier_data.frame_time))
                ...
                updated_messages.loc[:,'identifiers_id'] = identifier_data.id
                gnb_id_value = str(identifier_data.gnb_id)

                updated_messages.loc[:,'gnb_id'] = gnb_id_value
            ...
            Identifiers.objects.bulk_update(identifiers, ['f1ap_cause', 'ngap_cause'])
