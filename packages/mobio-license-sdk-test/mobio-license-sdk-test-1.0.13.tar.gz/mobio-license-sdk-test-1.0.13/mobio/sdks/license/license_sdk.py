...
class MobioLicenseSDK(object):
    ...
    def check_allowed_quantity_for_attribute(
        ...
        if not json_license:
            return True
        result = PackageUtils(json_license=json_license).check_allow_attribute_quantity(
    ...
    def check_allowed_feature_attribute(
        ...
        if not json_license:
            return True
        result = PackageUtils(json_license=json_license).check_allow_attribute_feature(
    ...
    def get_package_module_current(
        ...
        if not json_license:
            return True
        result = PackageUtils(json_license=json_license).get_license_package_by_module(module)
        return result
