...
print('======================================================')
print('======================================================')
print('imXam: v4.2.7 (2023-Dec-17)')
...
if test_iris == 1 and test_cube == 1 and test_hsg == 1:  # if test_hsg is None
    try:
...
if test_cube == 0:  # ==0 means it is a datacube file (3rd axis)
