...
class UpdateContentShareCode(Operation):
    ...
    _url: str = "/ugc/v1/public/namespaces/{namespace}/users/{userId}/channels/{channelId}/contents/{contentId}/sharecode"
    _method: str = "PATCH"
    ...
    def with_channel_id(self, value: str) -> UpdateContentShareCode:
        self.channel_id = value
        return self

    def with_content_id(self, value: str) -> UpdateContentShareCode:
        self.content_id = value
        return self

    def with_namespace(self, value: str) -> UpdateContentShareCode:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> UpdateContentShareCode:
        self.user_id = value
        return self
