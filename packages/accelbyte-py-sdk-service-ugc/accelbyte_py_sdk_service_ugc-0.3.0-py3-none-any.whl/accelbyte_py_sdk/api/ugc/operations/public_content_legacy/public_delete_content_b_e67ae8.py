...
class PublicDeleteContentByShareCode(Operation):
    ...
    _url: str = "/ugc/v1/public/namespaces/{namespace}/users/{userId}/channels/{channelId}/contents/sharecodes/{shareCode}"
    _method: str = "DELETE"
    ...
    def with_channel_id(self, value: str) -> PublicDeleteContentByShareCode:
        self.channel_id = value
        return self

    def with_namespace(self, value: str) -> PublicDeleteContentByShareCode:
        self.namespace = value
        return self

    def with_share_code(self, value: str) -> PublicDeleteContentByShareCode:
        self.share_code = value
        return self

    def with_user_id(self, value: str) -> PublicDeleteContentByShareCode:
        self.user_id = value
        return self
