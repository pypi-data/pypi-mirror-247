...
class BhaiAsync:
    ...
    async def get_answer(self, input_text: str) -> dict:
        ...
        if self.run_code and bhai_answer["code"] is not None:
            try:
                ...
                #  open to arbitrary code execution. Found in 'exec(bhai_answer['code'])'.
    ...
    async def export_conversation(self, bhai_answer, title: str = "") -> dict:
        """
        Get Share URL for specifc answer from bhai
    ...
    async def export_replit(
        ...
        **kwargs,
        ...
        >>>     token = 'xxxxxx'
        >>>     bhai = BhaiAsync(token=token)
        >>>     bhai_answer = await bhai.get_answer("Give me python code to print hello world")
