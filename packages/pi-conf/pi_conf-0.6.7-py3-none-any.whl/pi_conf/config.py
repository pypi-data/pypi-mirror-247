...
class AttrDict(dict):
    ...
    @classmethod
    def _from_dict(cls: "AttrDict", d: dict, _nested_same_class: bool = False) -> "AttrDict":
        ...
        def _from_list(l):
            ...
            for pot_dict in l:
                if isinstance(pot_dict, dict):
                    new_l.append(cls._from_dict(pot_dict, _nested_same_class=_nested_same_class))
    ...
    def from_dict(cls: "AttrDict", d: dict, _nested_same_class: bool = False) -> "AttrDict":
        ...
        Returns:
            AttrDict: the AttrDict object, or subclass
        """
        d = cls._from_dict(d, _nested_same_class=_nested_same_class)
        d.__source__ = "dict"
        return d
