...
class SFTPInterface(SalureConnect):
    ...
    def __init__(self, label: Union[str, List], debug: bool = False, local_file_directory: str = f'{basedir}/data/sftp'):
        """
        For the full documentation, see: https://leapsome.zendesk.com/hc/en-us/articles/4414678642193-SFTP-integration-
        """
        super().__init__()
        self.username, self.private_key = self._set_credentials()
