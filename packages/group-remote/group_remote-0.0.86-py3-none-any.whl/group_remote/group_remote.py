...
user_context = UserContext(user_JWT=os.getenv("JWT_SECRET_KEY"))
user_jwt = user_context.login_using_jwt()
...
class GroupsRemote:
    ...
    def get_all_groups(self):  # GET
        ...
        query_params = dict(langCode=self.logger.user_context.get_effective_profile_preferred_lang_code())
        ...
        try:
            ...
            jwt_token = user_jwt.get_user_JWT()
            header = utilities.create_http_headers(jwt_token)
