...
class ResourceExample(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            example_response ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): Example response from the downstream API. [optional]  # noqa: E501
        """
