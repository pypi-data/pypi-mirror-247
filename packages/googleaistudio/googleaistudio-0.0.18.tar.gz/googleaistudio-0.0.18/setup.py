...
setup(
    ...
    version="0.0.18",
    python_requires=">=3.8",
    description="Gemini Pro, Gemini Pro Vision, PaLM 2 and Codey. A collection of AI tools built on Google Vertex AI APIs. These are part of integrated tools, developed in LetMeDoIt AI project.",
    ...
    entry_points={
        "console_scripts": [
            ...
            f"geminiprovision=googleaistudio.geminiprovision:main",
            f"palm2=googleaistudio.palm2:main",
            f"codey=googleaistudio.codey:main",
        ],
    },
