...
from convergence.security.gateway_header_validation_filter import GatewayHeaderValidationMiddleware
from convergence.security.input_validation_filter import InputValidationMiddleware
...
class ConvergenceEndpointInfo:
    def __init__(self, url, method, authorization, is_public_endpoint):
        self.url = url
        self.method = method
        self.authorization = authorization
        self.is_public_endpoint = is_public_endpoint
...
\____/\____/_/ /_/|___/\___/_/   \__, /\___/_/ /_/\___/\___/ 
    ...
    @staticmethod
    def register_endpoint_info(url, method, authorization, is_public_endpoint):
        ConvergenceService.__endpoints_info.append(ConvergenceEndpointInfo(url, method.upper(), authorization, is_public_endpoint))
