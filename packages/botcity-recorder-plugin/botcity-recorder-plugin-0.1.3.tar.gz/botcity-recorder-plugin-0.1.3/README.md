# BotCity Recorder Plugin - Python
...
[![First Automation](https://developers.botcity.dev/github/readme/python-plugins/recorder-plugin.png)](https://documentation.botcity.dev/plugins/)
