...
class DatabaseConnection(
    ...
    def for_doc_db(
        ...
        *,
        ...
        :param database: The Document DB Cluster this connection is for. Note: Deadline officially supports only databases that are compatible with MongoDB 3.6, 4.0, 5.0.
    ...
    def for_mongo_db_instance(
        ...
        *,
        ...
        :param database: The MongoDB database to connect to. Note: Deadline officially supports only databases that are compatible with MongoDB 3.6, 4.0, 5.0.
        '''
