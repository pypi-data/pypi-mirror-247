...
from sdk.aut_properties import AutProperties
from sdk.magnifai import Magnifai
from sdk.rectangle_dto import RectangleDto
...
def test_compare():
    ...
    rs = Magnifai.compare(execution_id=EXECUTION, test_name='test sdk compare',
...
def test_compare_url():
    rs = Magnifai.compare(execution_id=EXECUTION, test_name='test sdk compare urls',
...
def test_flex_compare():
    rs = Magnifai.compare(execution_id=EXECUTION, test_name='test sdk flex compare',
                          baseline_image='tests/images/magnifai_base.png',
...
def test_flex_compare_url():
    rs = Magnifai.flex_compare(execution_id=EXECUTION, test_name='test sdk flex compare url',
                               baseline_image_url="https://upload.wikimedia.org/wikipedia/commons/b/b1/Mandriva_2009.1_KDE4.2_Bureau.png",
                               input_image_url="https://upload.wikimedia.org/wikipedia/commons/b/b1/Mandriva_2009.1_KDE4.2_Bureau.png",
                               min_similarity='90')
    assert rs.status_code == 200
...
def test_search():
    rs = Magnifai.search(execution_id=EXECUTION, test_name='test sdk search',
...
def test_search_url():
    rs = Magnifai.search(execution_id=EXECUTION, test_name='test sdk search urls',
...
def test_flex_search():
    rs = Magnifai.flex_search(execution_id=EXECUTION, test_name='test sdk search',
                              parent_image='tests/images/magnifai_base.png',
                              child_image='tests/images/magnifai_child.png', min_similarity='90')
    assert rs.status_code == 200
    response_json = json.loads(rs.text)
...
def test_flex_search_url():
    rs = Magnifai.flex_search(execution_id=EXECUTION, test_name='test sdk search urls',
                              parent_image_url="https://upload.wikimedia.org/wikipedia/commons/b/b1/Mandriva_2009.1_KDE4.2_Bureau.png",
                              child_image_url="https://upload.wikimedia.org/wikipedia/commons/b/b1/Mandriva_2009.1_KDE4.2_Bureau.png",
                              min_similarity='90')
    assert rs.status_code == 200
...
def test_locate():
    rs = Magnifai.locate(execution_id=EXECUTION, test_name='test sdk search',
...
def test_locate_url():
    rs = Magnifai.locate(execution_id=EXECUTION, test_name='test sdk search urls',
...
def test_flex_locate():
    rs = Magnifai.flex_locate(execution_id=EXECUTION, test_name='test sdk search',
                              container_image='tests/images/magnifai_base.png',
                              main_image='tests/images/magnifai_main.png',
...
def test_flex_locate_url():
    rs = Magnifai.flex_locate(execution_id=EXECUTION, test_name='test sdk search urls',
                              container_image_url="https://upload.wikimedia.org/wikipedia/commons/b/b1/Mandriva_2009.1_KDE4.2_Bureau.png",
                              main_image_url="https://upload.wikimedia.org/wikipedia/commons/b/b1/Mandriva_2009.1_KDE4.2_Bureau.png",
                              relative_image_url="https://upload.wikimedia.org/wikipedia/commons/b/b1/Mandriva_2009.1_KDE4.2_Bureau.png",
                              min_similarity='90')
