...
async def async_retry(total_tries=3, initial_wait=0.5, backoff_factor=2):
    import asyncio
    async def retry_decorator(f):
        @wraps(f)
                ...
                try:
                    ...
                    if current_attempt == 0:
                        msg = {
                            ...
                            'kwargs': kwargs,
                            'error': str(e),
                            'message': 'retry failed after {} attempts'.format(total_tries),
                        }
                        error(msg)
                    else:
                        msg = {
                            ...
                            'kwargs': kwargs,
                            'error': str(e),
                            'message': 'retrying in {} seconds...'.format(time_delay),
                        }
                        info(msg)
