...
from djangoldp_energiepartagee.models import Contribution, CONTRIBUTION_CHOICES, Paymentmethod
...
class ContributionsActorUpdateView(ContributionsView):
    def post(self, request):
        ...
        specificdata = {
            ...
            'email_title' : '[Votre adhésion] [action requise] Mettez à jour les données de vos fiches acteurs'
        }
        return self.contributionMail(request, specificdata)
