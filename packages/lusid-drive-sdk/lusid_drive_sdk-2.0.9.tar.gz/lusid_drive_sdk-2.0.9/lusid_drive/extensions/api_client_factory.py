...
from lusid_drive.extensions.retry import (
    RetryingRestWrapper,
...
from lusid_drive.extensions.tcp_keep_alive_connector import (
...
class SyncApiClientFactory:
    ...
    def build(
        ...
        ----------
        metaclass : Type[T]
            A lusid_drive.api class.


        Returns
        -------
        T
            An instance of the lusid_drive.api class with a configured ApiClient
        """
