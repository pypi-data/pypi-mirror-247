...
class ModelsMultipleEventType(Model):
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "event_type"):
            result["EventType"] = [
                i0.to_dict(include_empty=include_empty) for i0 in self.event_type
            ]
        elif include_empty:
            result["EventType"] = []
        return result
    ...
    def create_from_dict(
        ...
        if "EventType" in dict_ and dict_["EventType"] is not None:
            instance.event_type = [
                ModelsEventType.create_from_dict(i0, include_empty=include_empty)
                for i0 in dict_["EventType"]
            ]
        elif include_empty:
            instance.event_type = []
        return instance
    ...
    def create_many_from_dict(
        cls, dict_: dict, include_empty: bool = False
    ) -> Dict[str, ModelsMultipleEventType]:
        return (
    ...
    def create_from_any(
        ...
        ModelsMultipleEventType,
        List[ModelsMultipleEventType],
        Dict[Any, ModelsMultipleEventType],
    ]:
        if many:
