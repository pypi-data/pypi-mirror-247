...
class BulkDeleteFriends(Operation):
    ...
    def with_body(self, value: ModelBulkFriendsRequest) -> BulkDeleteFriends:
        self.body = value
        return self

    def with_namespace(self, value: str) -> BulkDeleteFriends:
        self.namespace = value
        return self

    def with_user_id(self, value: str) -> BulkDeleteFriends:
        self.user_id = value
        return self
    ...
    def parse_response(
        ...
        Union[None, ModelBulkFriendsResponse],
        Union[None, HttpResponse, ModelBulkFriendsResponse, RestapiErrorResponseV1],
    ]:
        ...
        if code == 200:
            return ModelBulkFriendsResponse.create_from_dict(content), None
        if code == 400:
        ...
        if code == 403:
            return None, RestapiErrorResponseV1.create_from_dict(content)
        if code == 500:
            return None, ModelBulkFriendsResponse.create_from_dict(content)
