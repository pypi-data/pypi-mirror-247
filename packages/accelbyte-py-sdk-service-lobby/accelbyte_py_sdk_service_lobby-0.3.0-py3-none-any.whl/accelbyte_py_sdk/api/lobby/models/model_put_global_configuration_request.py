...
class ModelPutGlobalConfigurationRequest(Model):
    """Model put global configuration request (model.PutGlobalConfigurationRequest)
    ...
    def with_test_game_mode(self, value: str) -> ModelPutGlobalConfigurationRequest:
    ...
    def create_many_from_dict(
        cls, dict_: dict, include_empty: bool = False
    ) -> Dict[str, ModelPutGlobalConfigurationRequest]:
        return (
    ...
    ) -> List[ModelPutGlobalConfigurationRequest]:
        return (
    ...
    def create_from_any(
        ...
        ModelPutGlobalConfigurationRequest,
        List[ModelPutGlobalConfigurationRequest],
        Dict[Any, ModelPutGlobalConfigurationRequest],
    ]:
        if many:
