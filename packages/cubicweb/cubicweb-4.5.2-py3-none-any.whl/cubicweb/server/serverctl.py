...
@callable_deprecated(
    "[3.28] instead of system_source_cnx(source, True, **args) use "
    "source_cnx(source, get_db_helper(source['db-driver']).system_database(), "
    "**args)"
)
def system_source_cnx(
    source,
    ...
    return source_cnx(source, special_privs=special_privs, interactive=interactive)
