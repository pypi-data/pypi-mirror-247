        ...
        self.assertListEqual(
            [
                (
                    ...
                    {
                        "description": "define a final relation: "
        ...
        self.assertListEqual(
            [
                (
                    ...
                    {
                        "description": "link a relation definition to its relation type",
                        "symmetric": False,
                        "name": "relation_type",
                        "final": False,
            ...
            [
                ...
                (
                    ...
                    "X from_entity SE,X to_entity OE WHERE SE eid %(se)s,ER eid %(rt)s,OE eid %(oe)s",
                    {
                        ...
                        "rt": None,
                        "oe": None,
                        "description": "groups allowed to add entities/relations of this type",
                        "composite": None,
                        "ordernum": 9999,
                        "cardinality": "**",
                    },
        ...
        self.assertListEqual(
            [
                ...
                (
                    ...
                    {
                        "x": None,
                        "value": '{"msg": null, "values": ["text/rest", "text/markdown", '
        ...
        self.assertListEqual(
            [
                (
                    ...
                    {
                        "description": "define a final relation: link a final relation type from"
