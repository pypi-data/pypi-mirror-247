...
#  - https://github.com/airbytehq/airbyte/blob/master/octavia-cli/octavia_cli/generate/templates/source_or_destination.yaml.j2
#
...
{%- endif %}
{% endfor %}
''', autoescape=jinja2.select_autoescape(), trim_blocks=False, lstrip_blocks=True)
