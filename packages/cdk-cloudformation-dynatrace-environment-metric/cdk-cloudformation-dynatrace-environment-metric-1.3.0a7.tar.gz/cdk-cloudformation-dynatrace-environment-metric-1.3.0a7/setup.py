    ...
    """
{
    ...
    "packages": [
        "cdk_cloudformation_dynatrace_environment_metric",
        "cdk_cloudformation_dynatrace_environment_metric._jsii"
    ],
    "package_data": {
        "cdk_cloudformation_dynatrace_environment_metric._jsii": [
            "dynatrace-environment-metric@1.3.0-alpha.7.jsii.tgz"
        ],
        "cdk_cloudformation_dynatrace_environment_metric": [
            "py.typed"
        ]
