...
class Client:
    ...
    def deprecated_create_iteration_attachments(
        self,
        files: list[tuple[str, tuple[str, BytesIO | IOBase]]],
        iteration_id: str,
        ...
        Returns:
            The JSON structure.
        """
        return AttachmentApi(self.auth).deprecated_create_attachments(
            files,
    ...
    def deprecated_register_dataset_from_source(
        self,
        dataset: Dataset,
        ...
        dataset_register_output = self.deprecated_register_dataset(
    ...
    def deprecated_register_dataset(
        ...
        data: DatasetRegisterOutput = GqlDatasetApi(self._gql_client, self.auth).deprecated_register_dataset(
    ...
    def deprecated_register_model(
        ...
        if model.additional_info is not None:
            self.assert_feature_flag_or_raise("mlflow")
        ...
        return GqlModelApi(self._gql_client, self.auth).deprecated_register_model(
