...
def sync(
    *,
    ...
    """Get an Analysis and the Datasets and Files it contains. You can download the Analysis data with the corresponding
    [Get a dataset](#/Datasets/getDataset) and [Get a file](#/Files/getFile) endpoints.
    """
