...
from ..models.dataset_column_metadata import DatasetColumnMetadata
from ..models.dataset_manifest_manifest_item import DatasetManifestManifestItem
...
class Dataset:
    ...
    _columns: Union[Unset, List[DatasetColumnMetadata]] = UNSET
    _id: Union[Unset, str] = UNSET
    _name: Union[Unset, str] = UNSET
    _manifest: Union[Unset, List[DatasetManifestManifestItem]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_columns() -> Union[Unset, List[DatasetColumnMetadata]]:
            columns = []
            _columns = d.pop("columns")
            for columns_item_data in _columns or []:
                columns_item = DatasetColumnMetadata.from_dict(columns_item_data, strict=False)
        ...
        try:
            ...
            if strict:
                raise
            columns = cast(Union[Unset, List[DatasetColumnMetadata]], UNSET)
        ...
        def get_manifest() -> Union[Unset, List[DatasetManifestManifestItem]]:
            manifest = []
            _manifest = d.pop("manifest")
            for manifest_item_data in _manifest or []:
                manifest_item = DatasetManifestManifestItem.from_dict(manifest_item_data, strict=False)
        ...
        try:
            ...
            if strict:
                raise
            manifest = cast(Union[Unset, List[DatasetManifestManifestItem]], UNSET)
    ...
    @property
    def columns(self) -> List[DatasetColumnMetadata]:
        if isinstance(self._columns, Unset):
            raise NotPresentError(self, "columns")
        return self._columns

    @columns.setter
    def columns(self, value: List[DatasetColumnMetadata]) -> None:
        self._columns = value
    ...
    @property
    def name(self) -> str:
        """ The user-facing name for this Dataset. """
    ...
    @property
    def manifest(self) -> List[DatasetManifestManifestItem]:
        if isinstance(self._manifest, Unset):
            raise NotPresentError(self, "manifest")
        return self._manifest

    @manifest.setter
    def manifest(self, value: List[DatasetManifestManifestItem]) -> None:
