...
T = TypeVar("T", bound="DatasetColumnTypeMetadataTarget")


@attr.s(auto_attribs=True, repr=False)
class DatasetColumnTypeMetadataTarget:
    ...
    def __repr__(self):
        ...
        return "DatasetColumnTypeMetadataTarget({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        dataset_column_type_metadata_target = cls(
            base_type_name=base_type_name,
            schema_id=schema_id,
        )

        dataset_column_type_metadata_target.additional_properties = d
        return dataset_column_type_metadata_target
