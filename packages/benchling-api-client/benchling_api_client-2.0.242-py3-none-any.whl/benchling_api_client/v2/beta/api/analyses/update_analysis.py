...
def sync(
    *,
    ...
    This endpoint can be used to attach Datasets and Files to an analysis by providing file and/or dataset
    ids inside the `datasetIds` and `fileIds` elements. This will append the datasets and files to the analysis.
