...
T = TypeVar("T", bound="DatasetColumnMetadata")
...
class DatasetColumnMetadata:
    ...
    _type: Union[Unset, DatasetColumnTypeMetadata] = UNSET
    ...
    def __repr__(self):
        ...
        return "DatasetColumnMetadata({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> Union[Unset, DatasetColumnTypeMetadata]:
            type: Union[Unset, Union[Unset, DatasetColumnTypeMetadata]] = UNSET
            _type = d.pop("type")

            if not isinstance(_type, Unset):
                type = DatasetColumnTypeMetadata.from_dict(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(Union[Unset, DatasetColumnTypeMetadata], UNSET)

        dataset_column_metadata = cls(
            display_name=display_name,
            type=type,
        )

        dataset_column_metadata.additional_properties = d
        return dataset_column_metadata
