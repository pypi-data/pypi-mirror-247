...
from luminesce.extensions.retry import (
    RetryingRestWrapper,
...
from luminesce.extensions.socket_keep_alive import keep_alive_socket_options
from luminesce.extensions.tcp_keep_alive_connector import (
...
class SyncApiClientFactory:
    ...
    def build(
        ...
        ----------
        metaclass : Type[T]
            A luminesce.api class.


        Returns
        -------
        T
            An instance of the luminesce.api class with a configured ApiClient
        """
