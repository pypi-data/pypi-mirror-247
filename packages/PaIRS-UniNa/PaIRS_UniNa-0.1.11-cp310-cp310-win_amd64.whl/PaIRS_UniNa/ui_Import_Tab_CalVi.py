...
################################################################################
## Form generated from reading UI file 'Import_Tab_CalViFOYjSv.ui'
##
...
"")
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 480, 475))
...
"padding: 2px;")
        ...
        icon5 = QIcon()
        icon5.addFile(u""+ icons_path +"browse_folder_c.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.w_InputImg.setMinimumSize(QSize(100, 0))
...
"")
        ...
        self.button_import.setIcon(icon6)
        ...
        icon7 = QIcon()
        icon7.addFile(u""+ icons_path +"down.png", QSize(), QIcon.Normal, QIcon.Off)
        self.button_down.setIcon(icon7)
        ...
        icon8 = QIcon()
        icon8.addFile(u""+ icons_path +"up.png", QSize(), QIcon.Normal, QIcon.Off)
        self.button_up.setIcon(icon8)
        ...
        icon9 = QIcon()
        icon9.addFile(u""+ icons_path +"delete.png", QSize(), QIcon.Normal, QIcon.Off)
        self.button_delete.setIcon(icon9)
        ...
        icon10 = QIcon()
        icon10.addFile(u""+ icons_path +"clean_queue.png", QSize(), QIcon.Normal, QIcon.Off)
        self.button_clean.setIcon(icon10)
        ...
        self.list_images = QTableWidget(self.w_SelectImages)
        ...
        icon11 = QIcon()
        icon11.addFile(u""+ icons_path +"resize_icon.png", QSize(), QIcon.Normal, QIcon.Off)
        self.button_resize.setIcon(icon11)
        ...
        self.w_OutputFold_Button.setMinimumSize(QSize(0, 60))
...
"padding: 2px;")
        ...
        icon12 = QIcon()
        icon12.addFile(u""+ icons_path +"browse_folder_c.png", QSize(), QIcon.Normal, QIcon.Off)
        self.button_path_out.setIcon(icon12)
...
#if QT_CONFIG(tooltip)
        self.button_import.setToolTip(QCoreApplication.translate("ImportTab_CalVi", u"Explore and import the image files", None))
#endif // QT_CONFIG(tooltip)
