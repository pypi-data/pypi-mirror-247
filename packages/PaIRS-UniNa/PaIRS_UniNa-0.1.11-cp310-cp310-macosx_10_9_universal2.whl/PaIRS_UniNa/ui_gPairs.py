...
################################################################################
## Form generated from reading UI file 'gPairsoeQTmn.ui'
##
...
class Ui_gPairs(object):
    def setupUi(self, gPairs):
        ...
        self.w_progress_Proc.setFont(font1)
        ...
        self.button_pause.setFont(font3)
        self.button_pause.setToolTipDuration(-1)
        self.button_pause.setLayoutDirection(Qt.LeftToRight)
        icon9 = QIcon()
        icon9.addFile(u""+ icons_path +"pause.png", QSize(), QIcon.Normal, QIcon.Off)
        self.button_pause.setIcon(icon9)
...
"}")
        ...
        self.button_default_sizes.setFont(font3)
        icon10 = QIcon()
        icon10.addFile(u""+ icons_path +"default_sizes.png", QSize(), QIcon.Normal, QIcon.Off)
        self.button_default_sizes.setIcon(icon10)
        ...
        self.button_dock.setFont(font3)
        icon11 = QIcon()
        icon11.addFile(u""+ icons_path +"undock_tabs.png", QSize(), QIcon.Normal, QIcon.Off)
        self.button_dock.setIcon(icon11)
        ...
        self.button_Shape.setFont(font3)
        self.button_Shape.setStyleSheet(u"")
        icon12 = QIcon()
        icon12.addFile(u""+ icons_path +"chain.png", QSize(), QIcon.Normal, QIcon.Off)
        self.button_Shape.setIcon(icon12)
        ...
        icon13 = QIcon()
        icon13.addFile(u""+ icons_path +"import_logo.png", QSize(), QIcon.Normal, QIcon.Off)
        self.button_Input.setIcon(icon13)
        ...
        icon14 = QIcon()
        icon14.addFile(u""+ icons_path +"export_logo.png", QSize(), QIcon.Normal, QIcon.Off)
        self.button_Output.setIcon(icon14)
        ...
        icon15 = QIcon()
        icon15.addFile(u""+ icons_path +"process_icon.png", QSize(), QIcon.Normal, QIcon.Off)
        self.button_Process.setIcon(icon15)
        ...
        icon16 = QIcon()
        icon16.addFile(u""+ icons_path +"terminal.png", QSize(), QIcon.Normal, QIcon.Off)
        self.button_Log.setIcon(icon16)
        ...
        icon17 = QIcon()
        icon17.addFile(u""+ icons_path +"vect_field.png", QSize(), QIcon.Normal, QIcon.Off)
        self.button_Vis.setIcon(icon17)
...
"")
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 4000, 630))
...
"}")
        ...
        self.menubar.setGeometry(QRect(0, 0, 1200, 43))
