...
class Vis_Tab(gPaIRS_Tab):
    ...
    def __init__(self,*args):
        ...
        unwanted_buttons = ['Customize'] #'Subplots','Save'
...
#*************************************************** From Parameters to UI
    ...
    def showRect(self):
        ...
        self.VISpar.xlim=self.ui.plot.axes.get_xlim()
        self.VISpar.ylim=self.ui.plot.axes.get_ylim()    
...
#*************************************************** Displaying images
    ...
    def checkSavedProc(self,i,*args):
        ...
        if i<0 and TRE.flagRun:
            if TRE.flagRun<-1:
                VISpar_prev.FlagExistMean=[TRE.flagRun>-12,TRE.flagRun<-10] #flagRun=-10: solo min, -11:min+PIV, -12:solo PIV
            else:
