...
################################################################################
## Form generated from reading UI file 'Process_Tabqzsmkf.ui'
##
...
from .addwidgets_ps import (CollapsibleBox, MyQCombo, MyQDoubleSpin, MyQLineEditNumber,
    MyQSpin, MyTabLabel, MyToolButton)
...
class Ui_ProcessTab(object):
    def setupUi(self, ProcessTab):
        ...
        ProcessTab.setMinimumSize(QSize(260, 340))
        ...
        self.hs_mode = QSpacerItem(30, 20, QSizePolicy.Fixed, QSizePolicy.Minimum)

        self.horizontalLayout_2.addItem(self.hs_mode)

        self.label_mode = QLabel(self.w_Mode)
        self.label_mode.setObjectName(u"label_mode")
        self.label_mode.setMinimumSize(QSize(60, 30))
        self.label_mode.setMaximumSize(QSize(35, 30))
        font2 = QFont()
        font2.setPointSize(10)
        font2.setItalic(True)
        self.label_mode.setFont(font2)
        self.label_mode.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)
...
"")
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, -649, 465, 1254))
        ...
        self.CollapBox_IntWind.setMinimumSize(QSize(0, 128))
        self.CollapBox_IntWind.setMaximumSize(QSize(16777215, 16777215))
        ...
        self.lay_CollapBox_IntWind.setSizeConstraint(QLayout.SetDefaultConstraint)
        ...
        self.tool_CollapBox_IntWind.setFocusPolicy(Qt.ClickFocus)
        ...
        self.tool_CollapBox_IntWind.setPopupMode(QToolButton.InstantPopup)
        self.tool_CollapBox_IntWind.setToolButtonStyle(Qt.ToolButtonTextBesideIcon)
        self.tool_CollapBox_IntWind.setArrowType(Qt.DownArrow)

        self.lay_CollapBox_IntWind.addWidget(self.tool_CollapBox_IntWind)

        self.hsp_CollapBox_IntWind = QSpacerItem(100, 20, QSizePolicy.Preferred, QSizePolicy.Minimum)

        self.lay_CollapBox_IntWind.addItem(self.hsp_CollapBox_IntWind)

        self.push_CollapBox_IntWind = MyToolButton(self.CollapBox_IntWind)
        self.push_CollapBox_IntWind.setObjectName(u"push_CollapBox_IntWind")
        self.push_CollapBox_IntWind.setMinimumSize(QSize(18, 18))
        self.push_CollapBox_IntWind.setMaximumSize(QSize(18, 18))
        self.push_CollapBox_IntWind.setFocusPolicy(Qt.ClickFocus)
        self.push_CollapBox_IntWind.setLayoutDirection(Qt.LeftToRight)
        self.push_CollapBox_IntWind.setIcon(icon2)
        self.push_CollapBox_IntWind.setIconSize(QSize(12, 12))

        self.lay_CollapBox_IntWind.addWidget(self.push_CollapBox_IntWind)
        ...
        self.w_IW.setMinimumSize(QSize(0, 96))
        font5 = QFont()
...
"QGroupBox::hover{border: 1px solid lightblue; border-radius: 6px;}")
        ...
        self.w_IW_size.setMinimumSize(QSize(0, 0))
        self.w_IW_size.setMaximumSize(QSize(16777215, 16777215))
        ...
        self.hlay_Size = QHBoxLayout()
        self.hlay_Size.setObjectName(u"hlay_Size")
        self.label_size = QLabel(self.w_Size)
...
"")
        ...
        self.check_edit_size = QLabel(self.edit_size)
...
"padding: 2px;")
        ...
        self.check_edit_size.setTextInteractionFlags(Qt.TextBrowserInteraction)
        ...
        self.hlay_Spacing = QHBoxLayout()
        self.hlay_Spacing.setObjectName(u"hlay_Spacing")
        self.label_spacing = QLabel(self.w_Spacing)
        ...
        self.hs_spacing = QSpacerItem(6, 26, QSizePolicy.Minimum, QSizePolicy.Minimum)

        self.hlay_Spacing.addItem(self.hs_spacing)

        self.check_flag_boundary = QCheckBox(self.w_Spacing)
        self.check_flag_boundary.setObjectName(u"check_flag_boundary")
        self.check_flag_boundary.setMinimumSize(QSize(0, 22))
        self.check_flag_boundary.setMaximumSize(QSize(16777215, 22))
        font7 = QFont()
        font7.setPointSize(10)
        font7.setBold(False)
        font7.setItalic(False)
        self.check_flag_boundary.setFont(font7)
        self.check_flag_boundary.setFocusPolicy(Qt.ClickFocus)
        self.check_flag_boundary.setLayoutDirection(Qt.RightToLeft)

        self.hlay_Spacing.addWidget(self.check_flag_boundary)


        self.verticalLayout_6.addLayout(self.hlay_Spacing)
...
"")
        ...
        self.check_edit_spacing = QLabel(self.edit_spacing)
...
"padding: 2px;")
        ...
        self.w_IW_size_2.setMinimumSize(QSize(0, 0))
        self.w_IW_size_2.setMaximumSize(QSize(16777215, 16777215))
        ...
        self.label_size_2 = QLabel(self.w_Size_2)
...
"")
        ...
        self.check_edit_size_2 = QLabel(self.edit_size_2)
...
"padding: 2px;")
        ...
        self.hlay_Spacing_2 = QHBoxLayout()
        ...
        self.label_spacing_2.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)

        self.hlay_Spacing_2.addWidget(self.label_spacing_2)


        self.verticalLayout_23.addLayout(self.hlay_Spacing_2)
...
"")
        ...
        self.check_edit_spacing_2 = QLabel(self.edit_spacing_2)
...
"padding: 2px;")
        ...
        self.lay_CollapBox_FinIt.setSizeConstraint(QLayout.SetDefaultConstraint)
        ...
        self.tool_CollapBox_FinIt.setFocusPolicy(Qt.ClickFocus)
        ...
        self.tool_CollapBox_FinIt.setPopupMode(QToolButton.InstantPopup)
        self.tool_CollapBox_FinIt.setToolButtonStyle(Qt.ToolButtonTextBesideIcon)
        self.tool_CollapBox_FinIt.setArrowType(Qt.DownArrow)

        self.lay_CollapBox_FinIt.addWidget(self.tool_CollapBox_FinIt)

        self.hsp_CollapBox_FinIt = QSpacerItem(100, 20, QSizePolicy.Preferred, QSizePolicy.Minimum)

        self.lay_CollapBox_FinIt.addItem(self.hsp_CollapBox_FinIt)

        self.push_CollapBox_FinIt = MyToolButton(self.CollapBox_FinIt)
        self.push_CollapBox_FinIt.setObjectName(u"push_CollapBox_FinIt")
        self.push_CollapBox_FinIt.setMinimumSize(QSize(18, 18))
        self.push_CollapBox_FinIt.setMaximumSize(QSize(18, 18))
        self.push_CollapBox_FinIt.setFocusPolicy(Qt.ClickFocus)
        self.push_CollapBox_FinIt.setLayoutDirection(Qt.LeftToRight)
        self.push_CollapBox_FinIt.setIcon(icon2)
        self.push_CollapBox_FinIt.setIconSize(QSize(12, 12))

        self.lay_CollapBox_FinIt.addWidget(self.push_CollapBox_FinIt)
...
"")
        ...
        self.label_final_iter.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)
        ...
        self.spin_final_iter.setButtonSymbols(QAbstractSpinBox.NoButtons)
        self.spin_final_iter.setCorrectionMode(QAbstractSpinBox.CorrectToNearestValue)

        self.horizontalLayout_6.addWidget(self.spin_final_iter)

        self.hs_final_iter = QSpacerItem(40, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)
        ...
        self.check_DC.setFocusPolicy(Qt.ClickFocus)
        self.check_DC.setLayoutDirection(Qt.RightToLeft)
        self.check_DC.setStyleSheet(u"border: none\n"
"")

        self.horizontalLayout_6.addWidget(self.check_DC)

        self.hs_final_iter_2 = QSpacerItem(40, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)
        ...
        self.lay_CollapBox_top.setSizeConstraint(QLayout.SetDefaultConstraint)
        ...
        self.tool_CollapBox_top.setFocusPolicy(Qt.ClickFocus)
        ...
        self.tool_CollapBox_top.setPopupMode(QToolButton.InstantPopup)
        self.tool_CollapBox_top.setToolButtonStyle(Qt.ToolButtonTextBesideIcon)
        self.tool_CollapBox_top.setArrowType(Qt.DownArrow)

        self.lay_CollapBox_top.addWidget(self.tool_CollapBox_top)

        self.hsp_CollapBox_top = QSpacerItem(100, 20, QSizePolicy.Preferred, QSizePolicy.Minimum)

        self.lay_CollapBox_top.addItem(self.hsp_CollapBox_top)

        self.push_CollapBox_top = MyToolButton(self.CollapBox_top)
        self.push_CollapBox_top.setObjectName(u"push_CollapBox_top")
        self.push_CollapBox_top.setMinimumSize(QSize(18, 18))
        self.push_CollapBox_top.setMaximumSize(QSize(18, 18))
        self.push_CollapBox_top.setFocusPolicy(Qt.ClickFocus)
        self.push_CollapBox_top.setLayoutDirection(Qt.LeftToRight)
        self.push_CollapBox_top.setIcon(icon2)
        self.push_CollapBox_top.setIconSize(QSize(12, 12))

        self.lay_CollapBox_top.addWidget(self.push_CollapBox_top)
...
"QGroupBox::hover{border: 1px solid lightblue; border-radius: 6px;}")
        self.group_top.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)
        ...
        self.combo_top.setSizeAdjustPolicy(QComboBox.AdjustToContentsOnFirstShow)
        ...
        icon6 = QIcon()
        icon6.addFile(u""+ icons_path +"pencil_bw.png", QSize(), QIcon.Normal, QIcon.Off)
        self.button_edit_custom.setIcon(icon6)
        ...
        self.combo_custom_top.setSizeAdjustPolicy(QComboBox.AdjustToContentsOnFirstShow)
        ...
        icon7 = QIcon()
        icon7.addFile(u""+ icons_path +"save.png", QSize(), QIcon.Normal, QIcon.Off)
        self.button_save_custom.setIcon(icon7)
        ...
        self.hs_top = QSpacerItem(26, 43, QSizePolicy.Expanding, QSizePolicy.Minimum)
        ...
        self.lay_CollapBox_Interp.setSizeConstraint(QLayout.SetDefaultConstraint)
        ...
        self.tool_CollapBox_Interp.setFocusPolicy(Qt.ClickFocus)
        ...
        self.tool_CollapBox_Interp.setPopupMode(QToolButton.InstantPopup)
        self.tool_CollapBox_Interp.setToolButtonStyle(Qt.ToolButtonTextBesideIcon)
        self.tool_CollapBox_Interp.setArrowType(Qt.DownArrow)

        self.lay_CollapBox_Interp.addWidget(self.tool_CollapBox_Interp)

        self.hsp_CollapBox_Interp = QSpacerItem(100, 20, QSizePolicy.Preferred, QSizePolicy.Minimum)

        self.lay_CollapBox_Interp.addItem(self.hsp_CollapBox_Interp)

        self.push_CollapBox_Interp = MyToolButton(self.CollapBox_Interp)
        self.push_CollapBox_Interp.setObjectName(u"push_CollapBox_Interp")
        self.push_CollapBox_Interp.setMinimumSize(QSize(18, 18))
        self.push_CollapBox_Interp.setMaximumSize(QSize(18, 18))
        self.push_CollapBox_Interp.setFocusPolicy(Qt.ClickFocus)
        self.push_CollapBox_Interp.setLayoutDirection(Qt.LeftToRight)
        self.push_CollapBox_Interp.setIcon(icon2)
        self.push_CollapBox_Interp.setIconSize(QSize(12, 12))

        self.lay_CollapBox_Interp.addWidget(self.push_CollapBox_Interp)
        ...
        self.combo_int_vel.setSizeAdjustPolicy(QComboBox.AdjustToContentsOnFirstShow)
        ...
        self.hs_VelInt = QSpacerItem(12, 20, QSizePolicy.Minimum, QSizePolicy.Minimum)
        ...
        self.spin_order.setButtonSymbols(QAbstractSpinBox.NoButtons)
        ...
        self.spin_VelInt_order.setButtonSymbols(QAbstractSpinBox.NoButtons)
        ...
        self.button_more_iter.setFocusPolicy(Qt.ClickFocus)
        self.button_more_iter.setIcon(icon5)
        ...
        self.combo_ImInt.setSizeAdjustPolicy(QComboBox.AdjustToContentsOnFirstShow)
        ...
        self.spin_final_it.setButtonSymbols(QAbstractSpinBox.NoButtons)
        ...
        self.hs_hlay_ImInt = QSpacerItem(40, 10, QSizePolicy.Expanding, QSizePolicy.Minimum)
        ...
        self.combo_ImInt_2.setSizeAdjustPolicy(QComboBox.AdjustToContentsOnFirstShow)
        ...
        self.hs_ImInt = QSpacerItem(12, 0, QSizePolicy.Minimum, QSizePolicy.Minimum)

        self.gridLayout_4.addItem(self.hs_ImInt, 1, 1, 1, 1)

        self.hs_ImInt_2 = QSpacerItem(12, 20, QSizePolicy.Minimum, QSizePolicy.Minimum)
        ...
        self.spin_order_2.setButtonSymbols(QAbstractSpinBox.NoButtons)
        ...
        self.lay_Validation.setSizeConstraint(QLayout.SetDefaultConstraint)
        ...
        self.tool_Validation.setFocusPolicy(Qt.ClickFocus)
        ...
        self.tool_Validation.setPopupMode(QToolButton.InstantPopup)
        self.tool_Validation.setToolButtonStyle(Qt.ToolButtonTextBesideIcon)
        self.tool_Validation.setArrowType(Qt.DownArrow)

        self.lay_Validation.addWidget(self.tool_Validation)

        self.hsp_1 = QSpacerItem(100, 20, QSizePolicy.Preferred, QSizePolicy.Minimum)

        self.lay_Validation.addItem(self.hsp_1)

        self.push_CollapBox_Validation = MyToolButton(self.CollapBox_Validation)
        self.push_CollapBox_Validation.setObjectName(u"push_CollapBox_Validation")
        self.push_CollapBox_Validation.setMinimumSize(QSize(18, 18))
        self.push_CollapBox_Validation.setMaximumSize(QSize(18, 18))
        self.push_CollapBox_Validation.setFocusPolicy(Qt.ClickFocus)
        self.push_CollapBox_Validation.setLayoutDirection(Qt.LeftToRight)
        self.push_CollapBox_Validation.setIcon(icon2)
        self.push_CollapBox_Validation.setIconSize(QSize(12, 12))

        self.lay_Validation.addWidget(self.push_CollapBox_Validation)
        ...
        self.label_MedTest_box.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)
        ...
        self.label_MedTest_type.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)

        self.verticalLayout_14.addWidget(self.label_MedTest_type)

        self.combo_MedTest_type = MyQCombo(self.w_MedTest_type)
        self.combo_MedTest_type.addItem("")
        self.combo_MedTest_type.addItem("")
        self.combo_MedTest_type.setObjectName(u"combo_MedTest_type")
        self.combo_MedTest_type.setMinimumSize(QSize(85, 0))
        self.combo_MedTest_type.setMaximumSize(QSize(16777215, 24))
        self.combo_MedTest_type.setFont(font)

        self.verticalLayout_14.addWidget(self.combo_MedTest_type)
        ...
        self.label_MedTest_ker.setMinimumSize(QSize(65, 20))
        self.label_MedTest_ker.setMaximumSize(QSize(16777215, 20))
        self.label_MedTest_ker.setFont(font6)
        self.label_MedTest_ker.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)

        self.verticalLayout_15.addWidget(self.label_MedTest_ker)

        self.spin_MedTest_ker = MyQSpin(self.w_MedTest_ker)
        self.spin_MedTest_ker.setObjectName(u"spin_MedTest_ker")
        self.spin_MedTest_ker.setEnabled(True)
        self.spin_MedTest_ker.setMinimumSize(QSize(65, 24))
        self.spin_MedTest_ker.setMaximumSize(QSize(1000000, 24))
        self.spin_MedTest_ker.setFont(font)
        self.spin_MedTest_ker.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)
        self.spin_MedTest_ker.setButtonSymbols(QAbstractSpinBox.NoButtons)
        self.spin_MedTest_ker.setCorrectionMode(QAbstractSpinBox.CorrectToNearestValue)
        self.spin_MedTest_ker.setValue(1)

        self.verticalLayout_15.addWidget(self.spin_MedTest_ker)
        ...
        self.label_MedTest_alfa.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)

        self.verticalLayout_16.addWidget(self.label_MedTest_alfa)

        self.spin_MedTest_alfa = MyQDoubleSpin(self.w_MedTest_alfa)
        self.spin_MedTest_alfa.setObjectName(u"spin_MedTest_alfa")
        self.spin_MedTest_alfa.setMinimumSize(QSize(55, 24))
        self.spin_MedTest_alfa.setMaximumSize(QSize(1000000, 24))
        self.spin_MedTest_alfa.setFont(font)
        self.spin_MedTest_alfa.setButtonSymbols(QAbstractSpinBox.NoButtons)
        self.spin_MedTest_alfa.setCorrectionMode(QAbstractSpinBox.CorrectToNearestValue)
        self.spin_MedTest_alfa.setSingleStep(0.010000000000000)
        self.spin_MedTest_alfa.setValue(2.000000000000000)

        self.verticalLayout_16.addWidget(self.spin_MedTest_alfa)
        ...
        self.label_MedTest_eps.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)

        self.verticalLayout_17.addWidget(self.label_MedTest_eps)

        self.spin_MedTest_eps = MyQDoubleSpin(self.w_MedTest_eps)
        self.spin_MedTest_eps.setObjectName(u"spin_MedTest_eps")
        self.spin_MedTest_eps.setMinimumSize(QSize(55, 24))
        self.spin_MedTest_eps.setMaximumSize(QSize(1000000, 24))
        self.spin_MedTest_eps.setFont(font)
        self.spin_MedTest_eps.setButtonSymbols(QAbstractSpinBox.NoButtons)
        self.spin_MedTest_eps.setCorrectionMode(QAbstractSpinBox.CorrectToNearestValue)
        self.spin_MedTest_eps.setSingleStep(0.010000000000000)
        self.spin_MedTest_eps.setValue(0.100000000000000)

        self.verticalLayout_17.addWidget(self.spin_MedTest_eps)
        ...
        self.label_SNTest.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)
        ...
        self.label_SNTest_thres.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)

        self.verticalLayout_20.addWidget(self.label_SNTest_thres)

        self.spin_SNTest_thres = MyQDoubleSpin(self.w_SNTest_thres)
        self.spin_SNTest_thres.setObjectName(u"spin_SNTest_thres")
        self.spin_SNTest_thres.setMinimumSize(QSize(0, 0))
        self.spin_SNTest_thres.setMaximumSize(QSize(1000000, 24))
        self.spin_SNTest_thres.setFont(font)
        self.spin_SNTest_thres.setButtonSymbols(QAbstractSpinBox.NoButtons)
        self.spin_SNTest_thres.setCorrectionMode(QAbstractSpinBox.CorrectToNearestValue)
        self.spin_SNTest_thres.setMinimum(1.000000000000000)
        self.spin_SNTest_thres.setSingleStep(0.010000000000000)
        self.spin_SNTest_thres.setValue(1.250000000000000)

        self.verticalLayout_20.addWidget(self.spin_SNTest_thres)
        ...
        self.label_CPTest.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)
        ...
        self.label_CPTest_thres.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)

        self.verticalLayout_62.addWidget(self.label_CPTest_thres)

        self.spin_CPTest_thres = MyQDoubleSpin(self.w_CPTest_thres)
        self.spin_CPTest_thres.setObjectName(u"spin_CPTest_thres")
        self.spin_CPTest_thres.setMinimumSize(QSize(0, 0))
        self.spin_CPTest_thres.setMaximumSize(QSize(1000000, 24))
        self.spin_CPTest_thres.setFont(font)
        self.spin_CPTest_thres.setButtonSymbols(QAbstractSpinBox.NoButtons)
        self.spin_CPTest_thres.setCorrectionMode(QAbstractSpinBox.CorrectToNearestValue)
        self.spin_CPTest_thres.setMinimum(0.000000000000000)
        self.spin_CPTest_thres.setMaximum(1.000000000000000)
        self.spin_CPTest_thres.setSingleStep(0.010000000000000)
        self.spin_CPTest_thres.setValue(1.000000000000000)

        self.verticalLayout_62.addWidget(self.spin_CPTest_thres)
        ...
        self.label_Nogueira.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)
        ...
        self.label_Nog_tol.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)

        self.verticalLayout_22.addWidget(self.label_Nog_tol)

        self.spin_Nog_tol = MyQDoubleSpin(self.w_Nog_tol)
        self.spin_Nog_tol.setObjectName(u"spin_Nog_tol")
        self.spin_Nog_tol.setMinimumSize(QSize(55, 24))
        self.spin_Nog_tol.setMaximumSize(QSize(1000000, 24))
        self.spin_Nog_tol.setFont(font)
        self.spin_Nog_tol.setButtonSymbols(QAbstractSpinBox.NoButtons)
        self.spin_Nog_tol.setCorrectionMode(QAbstractSpinBox.CorrectToNearestValue)
        self.spin_Nog_tol.setMaximum(1.000000000000000)
        self.spin_Nog_tol.setSingleStep(0.010000000000000)
        self.spin_Nog_tol.setValue(0.250000000000000)

        self.verticalLayout_22.addWidget(self.spin_Nog_tol)
        ...
        self.label_Nog_numvec.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)

        self.verticalLayout_25.addWidget(self.label_Nog_numvec)

        self.spin_Nog_numvec = MyQDoubleSpin(self.w_Nog_numvec)
        self.spin_Nog_numvec.setObjectName(u"spin_Nog_numvec")
        self.spin_Nog_numvec.setMinimumSize(QSize(55, 24))
        self.spin_Nog_numvec.setMaximumSize(QSize(1000000, 24))
        self.spin_Nog_numvec.setFont(font)
        self.spin_Nog_numvec.setButtonSymbols(QAbstractSpinBox.NoButtons)
        self.spin_Nog_numvec.setCorrectionMode(QAbstractSpinBox.CorrectToNearestValue)
        self.spin_Nog_numvec.setMaximum(1.000000000000000)
        self.spin_Nog_numvec.setSingleStep(0.010000000000000)
        self.spin_Nog_numvec.setValue(0.100000000000000)

        self.verticalLayout_25.addWidget(self.spin_Nog_numvec)
        ...
        self.label_MinVal.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)

        self.verticalLayout_27.addWidget(self.label_MinVal)

        self.spin_MinVal = MyQDoubleSpin(self.w_MinVal)
        self.spin_MinVal.setObjectName(u"spin_MinVal")
        self.spin_MinVal.setMinimumSize(QSize(0, 0))
        self.spin_MinVal.setMaximumSize(QSize(1000000, 24))
        self.spin_MinVal.setFont(font)
        self.spin_MinVal.setButtonSymbols(QAbstractSpinBox.NoButtons)
        self.spin_MinVal.setCorrectionMode(QAbstractSpinBox.CorrectToNearestValue)
        self.spin_MinVal.setMaximum(4294967296.000000000000000)
        self.spin_MinVal.setSingleStep(0.100000000000000)
        self.spin_MinVal.setValue(5.000000000000000)

        self.verticalLayout_27.addWidget(self.spin_MinVal)
        ...
        self.label_MinStD.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)

        self.verticalLayout_28.addWidget(self.label_MinStD)

        self.spin_MinStD = MyQDoubleSpin(self.w_MinStD)
        self.spin_MinStD.setObjectName(u"spin_MinStD")
        self.spin_MinStD.setMinimumSize(QSize(0, 0))
        self.spin_MinStD.setMaximumSize(QSize(1000000, 24))
        self.spin_MinStD.setFont(font)
        self.spin_MinStD.setButtonSymbols(QAbstractSpinBox.NoButtons)
        self.spin_MinStD.setCorrectionMode(QAbstractSpinBox.CorrectToNearestValue)
        self.spin_MinStD.setSingleStep(0.100000000000000)
        self.spin_MinStD.setValue(1.500000000000000)

        self.verticalLayout_28.addWidget(self.spin_MinStD)
        ...
        self.label_Correction_type.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)

        self.verticalLayout_30.addWidget(self.label_Correction_type)

        self.combo_Correction_type = MyQCombo(self.w_Correction_type)
        self.combo_Correction_type.addItem("")
        self.combo_Correction_type.addItem("")
        self.combo_Correction_type.addItem("")
        self.combo_Correction_type.setObjectName(u"combo_Correction_type")
        self.combo_Correction_type.setFont(font)

        self.verticalLayout_30.addWidget(self.combo_Correction_type)
        ...
        self.check_second_peak = QCheckBox(self.w_Correction_opt)
        self.check_second_peak.setObjectName(u"check_second_peak")
        self.check_second_peak.setMaximumSize(QSize(16777215, 22))
        self.check_second_peak.setFont(font)
        self.check_second_peak.setFocusPolicy(Qt.ClickFocus)
        self.check_second_peak.setLayoutDirection(Qt.RightToLeft)
        self.check_second_peak.setStyleSheet(u"border: none\n"
"")

        self.verticalLayout_31.addWidget(self.check_second_peak)

        self.check_Hart = QCheckBox(self.w_Correction_opt)
        self.check_Hart.setObjectName(u"check_Hart")
        self.check_Hart.setMaximumSize(QSize(16777215, 22))
        self.check_Hart.setFont(font)
        self.check_Hart.setFocusPolicy(Qt.ClickFocus)
        self.check_Hart.setLayoutDirection(Qt.RightToLeft)
        self.check_Hart.setStyleSheet(u"border: none\n"
"")

        self.verticalLayout_31.addWidget(self.check_Hart)
        ...
        self.CollapBox_Windowing.setMinimumSize(QSize(0, 250))
        ...
        self.lay_Windowing.setSizeConstraint(QLayout.SetDefaultConstraint)
        ...
        self.tool_Windowing.setFocusPolicy(Qt.ClickFocus)
        ...
        self.tool_Windowing.setPopupMode(QToolButton.InstantPopup)
        self.tool_Windowing.setToolButtonStyle(Qt.ToolButtonTextBesideIcon)
        self.tool_Windowing.setArrowType(Qt.DownArrow)

        self.lay_Windowing.addWidget(self.tool_Windowing)

        self.hsp_Windowing = QSpacerItem(100, 20, QSizePolicy.Preferred, QSizePolicy.Minimum)

        self.lay_Windowing.addItem(self.hsp_Windowing)

        self.push_CollapBox_Windowing = MyToolButton(self.CollapBox_Windowing)
        self.push_CollapBox_Windowing.setObjectName(u"push_CollapBox_Windowing")
        self.push_CollapBox_Windowing.setMinimumSize(QSize(18, 18))
        self.push_CollapBox_Windowing.setMaximumSize(QSize(18, 18))
        self.push_CollapBox_Windowing.setFocusPolicy(Qt.ClickFocus)
        self.push_CollapBox_Windowing.setLayoutDirection(Qt.LeftToRight)
        self.push_CollapBox_Windowing.setIcon(icon2)
        self.push_CollapBox_Windowing.setIconSize(QSize(12, 12))

        self.lay_Windowing.addWidget(self.push_CollapBox_Windowing)
        ...
        self.Windowing.setMinimumSize(QSize(0, 210))
        ...
        self.label_Wind_Vel_type.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)
        ...
        self.combo_par_tophat.setSizeAdjustPolicy(QComboBox.AdjustToContents)
        ...
        self.spin_par_Gauss.setButtonSymbols(QAbstractSpinBox.NoButtons)
        ...
        self.label_Wind_halfwidth.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)
        ...
        self.spin_Wind_halfwidth.setButtonSymbols(QAbstractSpinBox.NoButtons)
        self.spin_Wind_halfwidth.setCorrectionMode(QAbstractSpinBox.CorrectToNearestValue)
        ...
        self.label_Wind_Corr_type.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)
        ...
        self.combo_par_tophat_2.setSizeAdjustPolicy(QComboBox.AdjustToContents)
        ...
        self.spin_par_Gauss_2.setButtonSymbols(QAbstractSpinBox.NoButtons)
        ...
        self.label_type_of_DCs.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)

        self.verticalLayout.addWidget(self.label_type_of_DCs)

        self.combo_type_of_DCs = MyQCombo(self.w_type_of_DCs)
        self.combo_type_of_DCs.addItem("")
        self.combo_type_of_DCs.addItem("")
        self.combo_type_of_DCs.setObjectName(u"combo_type_of_DCs")
        self.combo_type_of_DCs.setMinimumSize(QSize(0, 24))
        self.combo_type_of_DCs.setFont(font)

        self.verticalLayout.addWidget(self.combo_type_of_DCs)
        ...
        self.label_adaptative_iter.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)

        self.horizontalLayout_19.addWidget(self.label_adaptative_iter)

        self.spin_adaptative_iter = MyQSpin(self.w_adaptative_iter)
        self.spin_adaptative_iter.setObjectName(u"spin_adaptative_iter")
        self.spin_adaptative_iter.setMinimumSize(QSize(55, 0))
        self.spin_adaptative_iter.setMaximumSize(QSize(66, 22))
        self.spin_adaptative_iter.setFont(font)
        self.spin_adaptative_iter.setButtonSymbols(QAbstractSpinBox.NoButtons)
        self.spin_adaptative_iter.setCorrectionMode(QAbstractSpinBox.CorrectToNearestValue)

        self.horizontalLayout_19.addWidget(self.spin_adaptative_iter)
        ...
        self.label_min_Corr.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)

        self.verticalLayout_60.addWidget(self.label_min_Corr)

        self.spin_min_Corr = MyQDoubleSpin(self.w_min_Corr)
        self.spin_min_Corr.setObjectName(u"spin_min_Corr")
        self.spin_min_Corr.setMinimumSize(QSize(55, 24))
        self.spin_min_Corr.setMaximumSize(QSize(1000000, 24))
        self.spin_min_Corr.setFont(font)
        self.spin_min_Corr.setButtonSymbols(QAbstractSpinBox.NoButtons)
        self.spin_min_Corr.setCorrectionMode(QAbstractSpinBox.CorrectToNearestValue)
        self.spin_min_Corr.setMaximum(1.000000000000000)
        self.spin_min_Corr.setSingleStep(0.010000000000000)
        self.spin_min_Corr.setValue(0.400000000000000)

        self.verticalLayout_60.addWidget(self.spin_min_Corr)
        ...
        self.label_max_Corr.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)

        self.verticalLayout_64.addWidget(self.label_max_Corr)

        self.spin_max_Corr = MyQDoubleSpin(self.w_max_Corr)
        self.spin_max_Corr.setObjectName(u"spin_max_Corr")
        self.spin_max_Corr.setMinimumSize(QSize(55, 24))
        self.spin_max_Corr.setMaximumSize(QSize(1000000, 24))
        self.spin_max_Corr.setFont(font)
        self.spin_max_Corr.setButtonSymbols(QAbstractSpinBox.NoButtons)
        self.spin_max_Corr.setCorrectionMode(QAbstractSpinBox.CorrectToNearestValue)
        self.spin_max_Corr.setMaximum(1.000000000000000)
        self.spin_max_Corr.setSingleStep(0.010000000000000)
        self.spin_max_Corr.setValue(0.750000000000000)

        self.verticalLayout_64.addWidget(self.spin_max_Corr)
        ...
        self.label_min_Lar.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)

        self.verticalLayout_63.addWidget(self.label_min_Lar)

        self.spin_min_Lar = MyQSpin(self.w_min_Lar)
        self.spin_min_Lar.setObjectName(u"spin_min_Lar")
        self.spin_min_Lar.setMinimumSize(QSize(55, 24))
        self.spin_min_Lar.setMaximumSize(QSize(1000000, 24))
        self.spin_min_Lar.setFont(font)
        self.spin_min_Lar.setButtonSymbols(QAbstractSpinBox.NoButtons)
        self.spin_min_Lar.setCorrectionMode(QAbstractSpinBox.CorrectToNearestValue)
        self.spin_min_Lar.setMaximum(10000)
        self.spin_min_Lar.setValue(5)

        self.verticalLayout_63.addWidget(self.spin_min_Lar)
        ...
        self.label_max_Lar.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)

        self.verticalLayout_61.addWidget(self.label_max_Lar)

        self.spin_max_Lar = MyQSpin(self.w_max_Lar)
        self.spin_max_Lar.setObjectName(u"spin_max_Lar")
        self.spin_max_Lar.setMinimumSize(QSize(55, 24))
        self.spin_max_Lar.setMaximumSize(QSize(1000000, 24))
        self.spin_max_Lar.setFont(font)
        self.spin_max_Lar.setButtonSymbols(QAbstractSpinBox.NoButtons)
        self.spin_max_Lar.setCorrectionMode(QAbstractSpinBox.CorrectToNearestValue)
        self.spin_max_Lar.setMaximum(10000)
        self.spin_max_Lar.setValue(16)

        self.verticalLayout_61.addWidget(self.spin_max_Lar)
        ...
        QWidget.setTabOrder(self.scrollArea, self.line_edit_size)
        ...
        QWidget.setTabOrder(self.radio_MedTest, self.combo_MedTest_type)
        QWidget.setTabOrder(self.combo_MedTest_type, self.spin_MedTest_ker)
        QWidget.setTabOrder(self.spin_MedTest_ker, self.spin_MedTest_alfa)
        QWidget.setTabOrder(self.spin_MedTest_alfa, self.spin_MedTest_eps)
        QWidget.setTabOrder(self.spin_MedTest_eps, self.radio_SNTest)
        QWidget.setTabOrder(self.radio_SNTest, self.spin_SNTest_thres)
        QWidget.setTabOrder(self.spin_SNTest_thres, self.radio_CPTest)
        QWidget.setTabOrder(self.radio_CPTest, self.spin_CPTest_thres)
        QWidget.setTabOrder(self.spin_CPTest_thres, self.radio_Nogueira)
        QWidget.setTabOrder(self.radio_Nogueira, self.spin_Nog_tol)
        QWidget.setTabOrder(self.spin_Nog_tol, self.spin_Nog_numvec)
        QWidget.setTabOrder(self.spin_Nog_numvec, self.spin_MinVal)
        QWidget.setTabOrder(self.spin_MinVal, self.spin_MinStD)
        QWidget.setTabOrder(self.spin_MinStD, self.combo_Correction_type)
        QWidget.setTabOrder(self.combo_Correction_type, self.combo_Wind_Vel_type)
        ...
        QWidget.setTabOrder(self.spin_Wind_halfwidth, self.combo_Wind_Corr_type)
        ...
        QWidget.setTabOrder(self.spin_par_Gauss_2, self.combo_type_of_DCs)
        QWidget.setTabOrder(self.combo_type_of_DCs, self.radio_Adaptative)
        QWidget.setTabOrder(self.radio_Adaptative, self.spin_adaptative_iter)
        QWidget.setTabOrder(self.spin_adaptative_iter, self.spin_min_Corr)
        QWidget.setTabOrder(self.spin_min_Corr, self.spin_max_Corr)
        QWidget.setTabOrder(self.spin_max_Corr, self.spin_min_Lar)
        QWidget.setTabOrder(self.spin_min_Lar, self.spin_max_Lar)
    ...
    def retranslateUi(self, ProcessTab):
...
#if QT_CONFIG(tooltip)
        self.push_CollapBox_IntWind.setToolTip(QCoreApplication.translate("ProcessTab", u"Set default options for the selected type of process", None))
#endif // QT_CONFIG(tooltip)
        self.push_CollapBox_IntWind.setText("")
        self.w_IW.setTitle("")
...
#if QT_CONFIG(tooltip)
        self.check_flag_boundary.setToolTip(QCoreApplication.translate("ProcessTab", u"If activated the first vector is placed at 1/2 of spacing from the image border", None))
#endif // QT_CONFIG(tooltip)
        self.check_flag_boundary.setText(QCoreApplication.translate("ProcessTab", u"First vector at \u2193", None))
#if QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.push_CollapBox_FinIt.setToolTip(QCoreApplication.translate("ProcessTab", u"Set default options for the selected type of process", None))
#endif // QT_CONFIG(tooltip)
        self.push_CollapBox_FinIt.setText("")
...
#if QT_CONFIG(tooltip)
        self.push_CollapBox_top.setToolTip(QCoreApplication.translate("ProcessTab", u"Back to the previous type of process", None))
#endif // QT_CONFIG(tooltip)
        self.push_CollapBox_top.setText("")
...
#if QT_CONFIG(tooltip)
        self.push_CollapBox_Interp.setToolTip(QCoreApplication.translate("ProcessTab", u"Set default options for the selected type of process", None))
#endif // QT_CONFIG(tooltip)
        self.push_CollapBox_Interp.setText("")
...
#if QT_CONFIG(tooltip)
        self.push_CollapBox_Validation.setToolTip(QCoreApplication.translate("ProcessTab", u"Set default options for the selected type of process", None))
#endif // QT_CONFIG(tooltip)
        self.push_CollapBox_Validation.setText("")
        ...
        self.combo_MedTest_type.setItemText(0, QCoreApplication.translate("ProcessTab", u"classic", None))
        self.combo_MedTest_type.setItemText(1, QCoreApplication.translate("ProcessTab", u"universal", None))

#if QT_CONFIG(tooltip)
        self.combo_MedTest_type.setToolTip(QCoreApplication.translate("ProcessTab", u"Type of median test", None))
#endif // QT_CONFIG(tooltip)
        self.label_MedTest_ker.setText(QCoreApplication.translate("ProcessTab", u"Semi-kern.", None))
#if QT_CONFIG(tooltip)
        self.spin_MedTest_ker.setToolTip(QCoreApplication.translate("ProcessTab", u"Semi-size of kernel used for the test", None))
#endif // QT_CONFIG(tooltip)
        self.label_MedTest_alfa.setText(QCoreApplication.translate("ProcessTab", u"\u03b1 thresh.", None))
#if QT_CONFIG(tooltip)
        self.spin_MedTest_alfa.setToolTip(QCoreApplication.translate("ProcessTab", u"Threshold on standard deviation", None))
#endif // QT_CONFIG(tooltip)
        self.label_MedTest_eps.setText(QCoreApplication.translate("ProcessTab", u"\u03b5 thresh.", None))
#if QT_CONFIG(tooltip)
        self.spin_MedTest_eps.setToolTip(QCoreApplication.translate("ProcessTab", u"Minimum value allowed for the standard deviation", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.spin_SNTest_thres.setToolTip(QCoreApplication.translate("ProcessTab", u"Threshold on S/N defined as ratio of the first and second largest peaks in the correlation map", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.spin_CPTest_thres.setToolTip(QCoreApplication.translate("ProcessTab", u"Minimum value of correlation peak allowed", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.spin_Nog_tol.setToolTip(QCoreApplication.translate("ProcessTab", u"Tolerance threshold", None))
#endif // QT_CONFIG(tooltip)
        self.label_Nog_numvec.setText(QCoreApplication.translate("ProcessTab", u"Number of Vectors (NV)", None))
#if QT_CONFIG(tooltip)
        self.spin_Nog_numvec.setToolTip(QCoreApplication.translate("ProcessTab", u"Number of wrong vectors", None))
#endif // QT_CONFIG(tooltip)
        self.label_MinVal.setText(QCoreApplication.translate("ProcessTab", u"Min. allowed value", None))
#if QT_CONFIG(tooltip)
        self.spin_MinVal.setToolTip(QCoreApplication.translate("ProcessTab", u"Minimum value of intensity level to consider data in the window reliable", None))
#endif // QT_CONFIG(tooltip)
        self.label_MinStD.setText(QCoreApplication.translate("ProcessTab", u"Min. allowed st.d. value", None))
#if QT_CONFIG(tooltip)
        self.spin_MinStD.setToolTip(QCoreApplication.translate("ProcessTab", u"Minimum value of st.d. of intensity levels to consider data in the window reliable", None))
#endif // QT_CONFIG(tooltip)
        self.label_Correction_type.setText(QCoreApplication.translate("ProcessTab", u"Correction type", None))
        self.combo_Correction_type.setItemText(0, QCoreApplication.translate("ProcessTab", u"average", None))
        self.combo_Correction_type.setItemText(1, QCoreApplication.translate("ProcessTab", u"distance-weighted average", None))
        self.combo_Correction_type.setItemText(2, QCoreApplication.translate("ProcessTab", u"iterative average", None))

#if QT_CONFIG(tooltip)
        self.combo_Correction_type.setToolTip(QCoreApplication.translate("ProcessTab", u"Type of correction of outliers", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.check_second_peak.setToolTip(QCoreApplication.translate("ProcessTab", u"Correct outlier with displacement related to the second largest peak in the correlation map", None))
#endif // QT_CONFIG(tooltip)
        self.check_second_peak.setText(QCoreApplication.translate("ProcessTab", u"Second correlation peak correction", None))
#if QT_CONFIG(tooltip)
        self.check_Hart.setToolTip(QCoreApplication.translate("ProcessTab", u"Hart's correction", None))
#endif // QT_CONFIG(tooltip)
        self.check_Hart.setText(QCoreApplication.translate("ProcessTab", u"Hart's correction", None))
#if QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.push_CollapBox_Windowing.setToolTip(QCoreApplication.translate("ProcessTab", u"Set default options for the selected type of process", None))
#endif // QT_CONFIG(tooltip)
        self.push_CollapBox_Windowing.setText("")
        ...
        self.combo_Wind_Vel_type.setItemText(2, QCoreApplication.translate("ProcessTab", u"Blackmann", None))
        self.combo_Wind_Vel_type.setItemText(3, QCoreApplication.translate("ProcessTab", u"Blackmann-Harris", None))
...
#if QT_CONFIG(tooltip)
        self.combo_par_Bla.setToolTip(QCoreApplication.translate("ProcessTab", u"Type of Blackmann weighting window", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.combo_par_Har.setToolTip(QCoreApplication.translate("ProcessTab", u"Type of Blackmann-Harris weighting window", None))
#endif // QT_CONFIG(tooltip)
        ...
        self.combo_Wind_Corr_type.setItemText(2, QCoreApplication.translate("ProcessTab", u"Blackmann", None))
        self.combo_Wind_Corr_type.setItemText(3, QCoreApplication.translate("ProcessTab", u"Blackmann-Harris", None))
...
#if QT_CONFIG(tooltip)
        self.combo_par_Bla_2.setToolTip(QCoreApplication.translate("ProcessTab", u"Type of Blackmann weighting window", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.combo_par_Har_2.setToolTip(QCoreApplication.translate("ProcessTab", u"Type of Blackmann-Harris weighting window", None))
#endif // QT_CONFIG(tooltip)
        ...
        self.combo_type_of_DCs.setItemText(0, QCoreApplication.translate("ProcessTab", u"sum", None))
        self.combo_type_of_DCs.setItemText(1, QCoreApplication.translate("ProcessTab", u"product", None))

#if QT_CONFIG(tooltip)
        self.combo_type_of_DCs.setToolTip(QCoreApplication.translate("ProcessTab", u"Type of estimation of double-sided direct correlations", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.spin_adaptative_iter.setToolTip(QCoreApplication.translate("ProcessTab", u"Number of final iterations (sizes and spacing from the last element in the above fields)", None))
#endif // QT_CONFIG(tooltip)
        self.label_min_Corr.setText(QCoreApplication.translate("ProcessTab", u"Min. Corr. Value", None))
#if QT_CONFIG(tooltip)
        self.spin_min_Corr.setToolTip(QCoreApplication.translate("ProcessTab", u"Minimum value of correlation peak allowed in the adaptative process", None))
#endif // QT_CONFIG(tooltip)
        self.label_max_Corr.setText(QCoreApplication.translate("ProcessTab", u"Max. Corr. Value", None))
#if QT_CONFIG(tooltip)
        self.spin_max_Corr.setToolTip(QCoreApplication.translate("ProcessTab", u"Maximum value of correlation peak allowed in the adaptative process", None))
#endif // QT_CONFIG(tooltip)
        self.label_min_Lar.setText(QCoreApplication.translate("ProcessTab", u"Min. half-width", None))
#if QT_CONFIG(tooltip)
        self.spin_min_Lar.setToolTip(QCoreApplication.translate("ProcessTab", u"Minimum value of semi-size of weighting window for the displacement field in the adaptative process", None))
#endif // QT_CONFIG(tooltip)
        self.label_max_Lar.setText(QCoreApplication.translate("ProcessTab", u"Max. half-width", None))
#if QT_CONFIG(tooltip)
        self.spin_max_Lar.setToolTip(QCoreApplication.translate("ProcessTab", u"Maximum value of semi-size of weighting window for the displacement field in the adaptative process", None))
#endif // QT_CONFIG(tooltip)
    # retranslateUi
