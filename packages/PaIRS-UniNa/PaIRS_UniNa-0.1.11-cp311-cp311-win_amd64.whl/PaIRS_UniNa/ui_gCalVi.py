...
################################################################################
## Form generated from reading UI file 'gCalViMhyReP.ui'
##
...
class Ui_gCalVi(object):
    def setupUi(self, gCalVi):
        ...
        icon9 = QIcon()
        icon9.addFile(u""+ icons_path +"default_sizes.png", QSize(), QIcon.Normal, QIcon.Off)
        self.button_default_sizes.setIcon(icon9)
        ...
        icon10 = QIcon()
        icon10.addFile(u""+ icons_path +"undock_tabs.png", QSize(), QIcon.Normal, QIcon.Off)
        self.button_dock.setIcon(icon10)
        ...
        icon11 = QIcon()
        icon11.addFile(u""+ icons_path +"import_logo.png", QSize(), QIcon.Normal, QIcon.Off)
        self.button_Input.setIcon(icon11)
        ...
        icon12 = QIcon()
        icon12.addFile(u""+ icons_path +"process_icon.png", QSize(), QIcon.Normal, QIcon.Off)
        self.button_Process.setIcon(icon12)
        ...
        icon13 = QIcon()
        icon13.addFile(u""+ icons_path +"vect_field.png", QSize(), QIcon.Normal, QIcon.Off)
        self.button_Vis.setIcon(icon13)
        ...
        icon14 = QIcon()
        icon14.addFile(u""+ icons_path +"play.png", QSize(), QIcon.Normal, QIcon.Off)
        self.button_Run.setIcon(icon14)
...
"")
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 4000, 656))
