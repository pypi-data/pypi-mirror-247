...
################################################################################
## Form generated from reading UI file 'Import_TabQTLmcZ.ui'
##
...
"padding: 2px;")
        ...
        icon6 = QIcon()
        icon6.addFile(u""+ icons_path +"browse_file_c.png", QSize(), QIcon.Normal, QIcon.Off)
...
"")
        ...
        icon7 = QIcon()
        icon7.addFile(u""+ icons_path +"resize_icon.png", QSize(), QIcon.Normal, QIcon.Off)
        self.button_resize.setIcon(icon7)
