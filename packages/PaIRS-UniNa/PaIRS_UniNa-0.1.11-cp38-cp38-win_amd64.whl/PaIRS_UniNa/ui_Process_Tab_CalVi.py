...
################################################################################
## Form generated from reading UI file 'Process_Tab_CalViyAuTkQ.ui'
##
...
class Ui_ProcessTab_CalVi(object):
    def setupUi(self, ProcessTab_CalVi):
        ...
        ProcessTab_CalVi.setMinimumSize(QSize(260, 340))
        ProcessTab_CalVi.setMaximumSize(QSize(1000, 16777215))
        font = QFont()
        font.setPointSize(11)
        ProcessTab_CalVi.setFont(font)
        icon1 = QIcon()
        icon1.addFile(u""+ icons_path +"process_icon.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.verticalLayout_65.setSizeConstraint(QLayout.SetDefaultConstraint)
        ...
        self.icon.setPixmap(QPixmap(u""+ icons_path +"process_icon.png"))
        ...
        self.hs1 = QSpacerItem(30, 20, QSizePolicy.Fixed, QSizePolicy.Minimum)
...
"")
        ...
        self.lay_CollapBox_Target.setSizeConstraint(QLayout.SetDefaultConstraint)
        ...
        self.tool_CollapBox_Target.setFocusPolicy(Qt.ClickFocus)
        ...
        self.tool_CollapBox_Target.setPopupMode(QToolButton.InstantPopup)
        self.tool_CollapBox_Target.setToolButtonStyle(Qt.ToolButtonTextBesideIcon)
        self.tool_CollapBox_Target.setArrowType(Qt.DownArrow)

        self.lay_CollapBox_Target.addWidget(self.tool_CollapBox_Target)

        self.hsp_CollapBox_Target = QSpacerItem(100, 20, QSizePolicy.Preferred, QSizePolicy.Minimum)

        self.lay_CollapBox_Target.addItem(self.hsp_CollapBox_Target)

        self.push_CollapBox_Target = MyToolButton(self.CollapBox_Target)
        self.push_CollapBox_Target.setObjectName(u"push_CollapBox_Target")
        self.push_CollapBox_Target.setMinimumSize(QSize(18, 18))
        self.push_CollapBox_Target.setMaximumSize(QSize(18, 18))
        self.push_CollapBox_Target.setFocusPolicy(Qt.ClickFocus)
        self.push_CollapBox_Target.setLayoutDirection(Qt.LeftToRight)
        self.push_CollapBox_Target.setIcon(icon2)
        self.push_CollapBox_Target.setIconSize(QSize(12, 12))

        self.lay_CollapBox_Target.addWidget(self.push_CollapBox_Target)
...
"QGroupBox::hover{border: 1px solid lightblue; border-radius: 6px;}")
        ...
        self.label_DotColor.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)
        ...
        self.label_DotTypeSearch.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)
        ...
        self.label_DotThresh.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)
        ...
        self.spin_DotThresh.setButtonSymbols(QAbstractSpinBox.NoButtons)
        self.spin_DotThresh.setCorrectionMode(QAbstractSpinBox.CorrectToNearestValue)
        ...
        self.label_DotDiam.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)
        ...
        self.spin_DotDiam.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)
        self.spin_DotDiam.setButtonSymbols(QAbstractSpinBox.NoButtons)
        self.spin_DotDiam.setCorrectionMode(QAbstractSpinBox.CorrectToNearestValue)
        ...
        self.label_TargetType.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)
        ...
        self.label_DotDx.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)
        ...
        self.spin_DotDx.setButtonSymbols(QAbstractSpinBox.NoButtons)
        self.spin_DotDx.setCorrectionMode(QAbstractSpinBox.CorrectToNearestValue)
        ...
        self.label_DotDy.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)
        ...
        self.spin_DotDy.setButtonSymbols(QAbstractSpinBox.NoButtons)
        self.spin_DotDy.setCorrectionMode(QAbstractSpinBox.CorrectToNearestValue)
        ...
        self.label_OriginXShift.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)
        ...
        self.spin_OriginXShift.setButtonSymbols(QAbstractSpinBox.NoButtons)
        self.spin_OriginXShift.setCorrectionMode(QAbstractSpinBox.CorrectToNearestValue)
        ...
        self.label_OriginYShift.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)
        ...
        self.spin_OriginYShift.setButtonSymbols(QAbstractSpinBox.NoButtons)
        self.spin_OriginYShift.setCorrectionMode(QAbstractSpinBox.CorrectToNearestValue)
        ...
        self.label_OriginZShift.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)
        ...
        self.spin_OriginZShift.setButtonSymbols(QAbstractSpinBox.NoButtons)
        self.spin_OriginZShift.setCorrectionMode(QAbstractSpinBox.CorrectToNearestValue)
        ...
        self.lay_CollapBox_CalPar.setSizeConstraint(QLayout.SetDefaultConstraint)
        ...
        self.tool_CollapBox_CalPar.setFocusPolicy(Qt.ClickFocus)
        ...
        self.tool_CollapBox_CalPar.setPopupMode(QToolButton.InstantPopup)
        self.tool_CollapBox_CalPar.setToolButtonStyle(Qt.ToolButtonTextBesideIcon)
        self.tool_CollapBox_CalPar.setArrowType(Qt.DownArrow)

        self.lay_CollapBox_CalPar.addWidget(self.tool_CollapBox_CalPar)

        self.hsp_CollapBox_CalPar = QSpacerItem(100, 20, QSizePolicy.Preferred, QSizePolicy.Minimum)

        self.lay_CollapBox_CalPar.addItem(self.hsp_CollapBox_CalPar)

        self.push_CollapBox_CalPar = MyToolButton(self.CollapBox_Calibration)
        self.push_CollapBox_CalPar.setObjectName(u"push_CollapBox_CalPar")
        self.push_CollapBox_CalPar.setMinimumSize(QSize(18, 18))
        self.push_CollapBox_CalPar.setMaximumSize(QSize(18, 18))
        self.push_CollapBox_CalPar.setFocusPolicy(Qt.ClickFocus)
        self.push_CollapBox_CalPar.setLayoutDirection(Qt.LeftToRight)
        self.push_CollapBox_CalPar.setIcon(icon2)
        self.push_CollapBox_CalPar.setIconSize(QSize(12, 12))

        self.lay_CollapBox_CalPar.addWidget(self.push_CollapBox_CalPar)
        ...
        self.combo_CalibProcType.setSizeAdjustPolicy(QComboBox.AdjustToContentsOnFirstShow)
        ...
        self.hs_CalibProc = QSpacerItem(9, 41, QSizePolicy.Expanding, QSizePolicy.Minimum)
        ...
        self.combo_CamMod.setSizeAdjustPolicy(QComboBox.AdjustToContentsOnFirstShow)
        ...
        self.hs_CamMod = QSpacerItem(9, 41, QSizePolicy.Minimum, QSizePolicy.Minimum)
        ...
        self.label_XDeg.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)
        ...
        self.spin_XDeg.setButtonSymbols(QAbstractSpinBox.NoButtons)
        self.spin_XDeg.setCorrectionMode(QAbstractSpinBox.CorrectToNearestValue)
        ...
        self.label_YDeg.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)
        ...
        self.spin_YDeg.setButtonSymbols(QAbstractSpinBox.NoButtons)
        self.spin_YDeg.setCorrectionMode(QAbstractSpinBox.CorrectToNearestValue)
        ...
        self.label_ZDeg.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)
        ...
        self.spin_ZDeg.setButtonSymbols(QAbstractSpinBox.NoButtons)
        self.spin_ZDeg.setCorrectionMode(QAbstractSpinBox.CorrectToNearestValue)
        ...
        self.label_PixAR.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)
        ...
        self.spin_PixAR.setButtonSymbols(QAbstractSpinBox.NoButtons)
        self.spin_PixAR.setCorrectionMode(QAbstractSpinBox.CorrectToNearestValue)
        ...
        self.label_PixPitch.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)
        ...
        self.spin_PixPitch.setButtonSymbols(QAbstractSpinBox.NoButtons)
        self.spin_PixPitch.setCorrectionMode(QAbstractSpinBox.CorrectToNearestValue)
        ...
        self.combo_CorrMod.setSizeAdjustPolicy(QComboBox.AdjustToContentsOnFirstShow)
        ...
        self.hs_CorrMod = QSpacerItem(9, 41, QSizePolicy.Expanding, QSizePolicy.Minimum)
        ...
        self.label_CylRad.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)
        ...
        self.spin_CylRad.setButtonSymbols(QAbstractSpinBox.NoButtons)
        self.spin_CylRad.setCorrectionMode(QAbstractSpinBox.CorrectToNearestValue)
        ...
        self.label_CylThick.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)
        ...
        self.spin_CylThick.setButtonSymbols(QAbstractSpinBox.NoButtons)
        self.spin_CylThick.setCorrectionMode(QAbstractSpinBox.CorrectToNearestValue)
        ...
        self.label_CylNRatio.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)
        ...
        self.spin_CylNRatio.setButtonSymbols(QAbstractSpinBox.NoButtons)
        self.spin_CylNRatio.setCorrectionMode(QAbstractSpinBox.CorrectToNearestValue)
        ...
        self.combo_CorrMod_Cyl.setSizeAdjustPolicy(QComboBox.AdjustToContentsOnFirstShow)
        ...
        self.hs_CalibProc_Cyl = QSpacerItem(9, 41, QSizePolicy.Minimum, QSizePolicy.Minimum)
...
#if QT_CONFIG(tooltip)
        self.push_CollapBox_Target.setToolTip(QCoreApplication.translate("ProcessTab_CalVi", u"Set default options for this section", None))
#endif // QT_CONFIG(tooltip)
        self.push_CollapBox_Target.setText("")
...
#if QT_CONFIG(tooltip)
        self.push_CollapBox_CalPar.setToolTip(QCoreApplication.translate("ProcessTab_CalVi", u"Set default options for the selected type of process", None))
#endif // QT_CONFIG(tooltip)
        self.push_CollapBox_CalPar.setText("")
...
#endif // QT_CONFIG(tooltip)
        self.label_CorrMod.setText(QCoreApplication.translate("ProcessTab_CalVi", u"Correction model", None))
