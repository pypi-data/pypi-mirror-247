...
## To Manually Invoke the Indexing Lambda
```commandline
aws --profile "echofish" sns publish --topic-arn "arn:aws:sns:us-west-2:118234403147:rudy-dev-echofish2-trigger-index" --message '{"a": "b"}'
```
