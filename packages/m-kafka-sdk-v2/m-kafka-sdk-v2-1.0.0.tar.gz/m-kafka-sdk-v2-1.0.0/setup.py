...
class Requirements(object):
    ...
    def get():
        ...
        :return:
        """
        requirements = ["requests>=2.25.1", "confluent-kafka>=1.7.0", "redisbloom>=0.4.1", "m-singleton>=0.3", "m-formatter-logging>=1.0.5"]
        return requirements
...
setup(
    ...
    version='1.0.0',  # Required, Phần này cũng không được format file.
