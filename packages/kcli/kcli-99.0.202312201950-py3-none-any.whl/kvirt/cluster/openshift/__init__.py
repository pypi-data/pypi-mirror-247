    ...
    if sno:
        ...
        with open("iso.ign", 'w') as f:
            ...
            if os.path.exists(f'{clusterdir}/macs.txt'):
                bootstrap_data = open(f'{clusterdir}/macs.txt').readlines()[0].strip().split(';')
                mac, ip, gateway, netmask, hostname, nameserver = bootstrap_data
                dev = overrides.get('sno_bootstrap_nic', mac)
