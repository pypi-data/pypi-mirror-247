...
class SearchSimilarVectorsRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["filter", b"filter", "filter_opt", b"filter_opt", "reference_vector", b"reference_vector"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["collection_name", b"collection_name", "filter", b"filter", "filter_opt", b"filter_opt", "include_distance", b"include_distance", "include_id", b"include_id", "include_vector", b"include_vector", "max_results", b"max_results", "properties", b"properties", "reference_vector", b"reference_vector"]) -> None: ...
...
class GetVectorSampleRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["collection_name", b"collection_name", "include_vector", b"include_vector", "num_samples", b"num_samples"]) -> None: ...
...
class DeleteVectorsRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["collection_name", b"collection_name", "vector_id", b"vector_id"]) -> None: ...
