...
class VectorCollectionSpec(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["description", b"description", "dimension", b"dimension", "metric", b"metric", "name", b"name", "vectorizer", b"vectorizer"]) -> None: ...
