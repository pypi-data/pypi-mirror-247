.. scingestor documentation master file, created by
   sphinx-quickstart on Thu Jul 28 17:34:20 2022.
...
Debian ``bookworm``, ``bullseye``, ``buster`` or Ubuntu ``lunar``, ``jammy``, ``focal`` packages
