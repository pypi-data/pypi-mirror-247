...
class Bot(_main_bot):  # type: ignore
    """The ezcloud bot class. This is a subclass of :class:`discord.Bot` if you use Pycord.
    ...
    **kwargs:
    ...
    async def get_application_context(self, interaction: discord.Interaction, cls=SyContext):
    ...
    def add_help_command(
        ...
        *,
        ...
        if not DPY:
            self.load_extension("ezcloud.cogs.pyc.help_setup", package="ezcloud")
    ...
    def add_status_changer(
        ...
        **kwargs:
        ...
        if not DPY:
            self.load_extension("ezcloud.cogs.pyc.status_changer_setup", package="ezcloud")
    ...
    def add_blacklist(
        ...
        *,
        ...
        if not DPY:
            self.load_extension("ezcloud.cogs.pyc.blacklist_setup", package="ezcloud")
    ...
    async def setup_hook(self):
        ...
        for ext in self.enabled_extensions:
            await self.load_extension(f".cogs.dpy.{ext}_setup", package="ezcloud")
...
class PrefixBot(Bot, commands.Bot):
    ...
    This class can be used if you want to use ezcloud with prefix commands.
...
class BridgeBot(Bot, bridge.Bot):
    ...
    This class can be used if you want to use ezcloud with bridge commands.
    This is only needed for Pycord.
    """
