...
class DeltaWriter:
    ...
    def run_maintenance(self, params: MaterializationTaskParams):
        maintenance_params = params.delta_maintenance_task_info.delta_maintenance_parameters
        table = DeltaTable(table_uri=self._table_uri)
