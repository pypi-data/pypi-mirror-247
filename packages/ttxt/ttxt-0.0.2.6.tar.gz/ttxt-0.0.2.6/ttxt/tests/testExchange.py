...
def test(exchangeName="", params={}):
    ...
    if "cancelOrder" in params and params["cancelOrder"]:
        ...
        try:
            resp = ttxtExchange.cancel_order(id=1735300085442314240, params={"symbol": tickerToTest})
...
if __name__ == "__main__":
    ...
    testingParams = {"ticker": False, "balance": False, "createOrder": False, "fetchOrder": False, 
                     "cancelOrder": False, "fetchOpenOrders": True, "setLeverage": False, "ohlcv": False}
    test(params=testingParams, exchangeName="bingx")