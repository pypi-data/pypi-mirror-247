...
from scoamp.utils.error import (FileFormatError, SubprocessError, ExitCode, err_wrapper)
...
def _update_public_model_meta(api: AmpApi, name: str, meta: dict, model_path: Path=None) -> dict:
    body_meta = {
        "src_url": meta['url'],
