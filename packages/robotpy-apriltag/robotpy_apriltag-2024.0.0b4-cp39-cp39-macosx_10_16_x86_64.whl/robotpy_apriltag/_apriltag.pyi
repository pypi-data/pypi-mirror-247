...
class AprilTag:
    ...
    ID: int
    pose: wpimath.geometry._geometry.Pose3d
...
class AprilTagField:
    ...
    Members:
      ...
      kNumFields
    """
    __members__: typing.ClassVar[dict[str, AprilTagField]]  # value = {'k2022RapidReact': <AprilTagField.k2022RapidReact: 0>, 'k2023ChargedUp': <AprilTagField.k2023ChargedUp: 1>, 'kNumFields': <AprilTagField.kNumFields: 2>}
    ...
    kNumFields: typing.ClassVar[AprilTagField]  # value = <AprilTagField.kNumFields: 2>
